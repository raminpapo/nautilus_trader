# Documentation: coinbase_intx_exec_tester.py

## File Metadata

- **Path**: `examples/live/coinbase_intx/coinbase_intx_exec_tester.py`
- **Size**: 4,818 bytes
- **Lines**: 126
- **Language**: Python
...
**Imports**: `decimal`, `nautilus_trader.adapters.coinbase_intx`, `nautilus_trader.cache.config`, `nautilus_trader.config`, `nautilus_trader.live.node`, `nautilus_trader.model.enums`, `nautilus_trader.model.identifiers`, `nautilus_trader.test_kit.strategies.tester_exec`

## Related Files

This file is located in `examples/live/coinbase_intx/`. Related files may include:
...
```bash
# For Python
pytest examples/live/coinbase_intx/coinbase_intx_exec_tester.py
...
---
*Generated on 2025-11-18T21:55:04.331887Z*
