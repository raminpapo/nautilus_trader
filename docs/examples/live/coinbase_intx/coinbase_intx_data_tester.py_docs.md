# Documentation: coinbase_intx_data_tester.py

## File Metadata

- **Path**: `examples/live/coinbase_intx/coinbase_intx_data_tester.py`
- **Size**: 4,033 bytes
- **Lines**: 113
- **Language**: Python
...
**Imports**: `nautilus_trader.adapters.coinbase_intx`, `nautilus_trader.cache.config`, `nautilus_trader.config`, `nautilus_trader.live.node`, `nautilus_trader.model.identifiers`, `nautilus_trader.test_kit.strategies.tester_data`
...
```bash
# For Python
pytest examples/live/coinbase_intx/coinbase_intx_data_tester.py
...
---
*Generated on 2025-11-18T21:55:04.330449Z*
