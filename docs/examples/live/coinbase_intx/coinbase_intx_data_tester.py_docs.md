# Documentation: `examples/live/coinbase_intx/coinbase_intx_data_tester.py`
**Generated:** 2025-11-15T19:40:03.908946Z
...
This file is located at `examples/live/coinbase_intx/coinbase_intx_data_tester.py` within the repository.
...
```python
import examples.live.coinbase_intx.coinbase_intx_data_tester
```
...
**Directory:** `examples/live/coinbase_intx`
