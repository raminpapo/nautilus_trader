# Documentation: `examples/live/bitmex/bitmex_exec_tester.py`
**Generated:** 2025-11-15T19:40:03.890821Z
...
This file is located at `examples/live/bitmex/bitmex_exec_tester.py` within the repository.
...
```python
import examples.live.bitmex.bitmex_exec_tester
```
...
**Directory:** `examples/live/bitmex`
