# Documentation: bitmex_exec_tester.py

## File Metadata

- **Path**: `examples/live/bitmex/bitmex_exec_tester.py`
- **Size**: 5,901 bytes
- **Lines**: 152
- **Language**: Python
...
**Imports**: `decimal`, `nautilus_trader.adapters.bitmex`, `nautilus_trader.config`, `nautilus_trader.live.node`, `nautilus_trader.model.enums`, `nautilus_trader.model.identifiers`, `nautilus_trader.test_kit.strategies.tester_exec`
...
```bash
# For Python
pytest examples/live/bitmex/bitmex_exec_tester.py
...
---
*Generated on 2025-11-18T21:55:04.308531Z*
