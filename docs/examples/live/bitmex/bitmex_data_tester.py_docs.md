# Documentation: `examples/live/bitmex/bitmex_data_tester.py`
**Generated:** 2025-11-15T19:40:03.889425Z
...
This file is located at `examples/live/bitmex/bitmex_data_tester.py` within the repository.
...
```python
import examples.live.bitmex.bitmex_data_tester
```
