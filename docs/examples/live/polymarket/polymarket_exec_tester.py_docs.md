# Documentation: `examples/live/polymarket/polymarket_exec_tester.py`
**Generated:** 2025-11-15T19:40:03.945356Z
...
This file is located at `examples/live/polymarket/polymarket_exec_tester.py` within the repository.
...
```python
import examples.live.polymarket.polymarket_exec_tester
```
...
**Directory:** `examples/live/polymarket`
