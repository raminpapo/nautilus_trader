# Documentation: polymarket_exec_tester.py

## File Metadata

- **Path**: `examples/live/polymarket/polymarket_exec_tester.py`
- **Size**: 8,424 bytes
- **Lines**: 188
- **Language**: Python
...
**Imports**: `decimal`, `nautilus_trader.adapters.polymarket`, `nautilus_trader.adapters.polymarket.common.symbol`, `nautilus_trader.config`, `nautilus_trader.live.node`, `nautilus_trader.model.identifiers`, `nautilus_trader.portfolio.config`, `nautilus_trader.test_kit.strategies.tester_exec`
...
```bash
# For Python
pytest examples/live/polymarket/polymarket_exec_tester.py
...
---
*Generated on 2025-11-18T21:55:04.369603Z*
