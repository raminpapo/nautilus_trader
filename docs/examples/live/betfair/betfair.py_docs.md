# Documentation: `examples/live/betfair/betfair.py`
**Generated:** 2025-11-15T19:40:03.877861Z
**File Size:** 6463 bytes
**Extension:** .py
**Type:** text
...
This file is located at `examples/live/betfair/betfair.py` within the repository.
...
```python
import examples.live.betfair.betfair
```
...
**Directory:** `examples/live/betfair`
