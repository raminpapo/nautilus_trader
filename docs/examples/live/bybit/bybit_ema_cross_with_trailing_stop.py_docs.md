# Documentation: `examples/live/bybit/bybit_ema_cross_with_trailing_stop.py`
**Generated:** 2025-11-15T19:40:03.900331Z
...
This file is located at `examples/live/bybit/bybit_ema_cross_with_trailing_stop.py` within the repository.
...
```python
import examples.live.bybit.bybit_ema_cross_with_trailing_stop
```
