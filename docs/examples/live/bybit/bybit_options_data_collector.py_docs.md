# Documentation: `examples/live/bybit/bybit_options_data_collector.py`
**Generated:** 2025-11-15T19:40:03.905785Z
**File Size:** 33311 bytes
**Extension:** .py
**Type:** text
...
This file is located at `examples/live/bybit/bybit_options_data_collector.py` within the repository.

**Classes defined:** BybitOptionsDataCollectorConfig, BybitOptionsDataCollector

**Functions defined:** __init__, _setup_file_logging, _initialize_spot_data_storage, on_start, _discover_options, _initialize_options_data_storage, _validate_instruments, _initialize_order_books, _subscribe_to_data_streams, _get_expiry_groups and 14 more
...
#### `BybitOptionsDataCollectorConfig`

**Inherits from:** StrategyConfig, frozen=True


#### `BybitOptionsDataCollector`
...
#### `__init__(self, config: BybitOptionsDataCollectorConfig)`


#### `_setup_file_logging(self)`


#### `_initialize_spot_data_storage(self)`


#### `on_start(self)`


#### `_discover_options(self)`


#### `_initialize_options_data_storage(self)`


#### `_validate_instruments(self)`


#### `_initialize_order_books(self)`


#### `_subscribe_to_data_streams(self)`


#### `_get_expiry_groups(self)`
...
#### `_store_order_book_delta(self, deltas: OrderBookDeltas, instrument_key: str)`


#### `_store_quote_tick(self, tick: QuoteTick, instrument_key: str)`


#### `_update_counters(self, tick: QuoteTick, instrument_key: str)`


#### `_check_and_log_data(self)`


#### `_log_and_save_data(self)`


#### `_save_all_data_to_parquet(self)`
...
```python
from examples.live.bybit.bybit_options_data_collector import BybitOptionsDataCollectorConfig
```
