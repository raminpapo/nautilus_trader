# Documentation: bybit_options_data_collector.py
...
### Classes
- **`BybitOptionsDataCollectorConfig`**: Class defined in this file
- **`BybitOptionsDataCollector`**: Class defined in this file
...
**Classs**: `BybitOptionsDataCollector`, `BybitOptionsDataCollectorConfig`
**Functions**: `main`
**Imports**: `datetime`, `decimal`, `logging`, `nautilus_trader.adapters.bybit`, `nautilus_trader.config`, `nautilus_trader.live.node`, `nautilus_trader.model.book`, `nautilus_trader.model.data`, `nautilus_trader.model.enums`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.instruments`, `nautilus_trader.trading.config`, `nautilus_trader.trading.strategy`, `os`, `pandas`, `pathlib`, `time`, `warnings`
...
---
*Generated on 2025-11-18T21:55:04.327400Z*
