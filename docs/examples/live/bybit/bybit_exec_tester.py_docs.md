# Documentation: bybit_exec_tester.py

## File Metadata

- **Path**: `examples/live/bybit/bybit_exec_tester.py`
- **Size**: 9,042 bytes
- **Lines**: 222
- **Language**: Python
...
**Imports**: `decimal`, `nautilus_trader.adapters.bybit`, `nautilus_trader.config`, `nautilus_trader.live.config`, `nautilus_trader.live.node`, `nautilus_trader.model.identifiers`, `nautilus_trader.portfolio.config`, `nautilus_trader.test_kit.strategies.tester_exec`
...
```bash
# For Python
pytest examples/live/bybit/bybit_exec_tester.py
...
---
*Generated on 2025-11-18T21:55:04.322763Z*
