# Documentation: `examples/live/bybit/bybit_request_custom_endpoint.py`
**Generated:** 2025-11-15T19:40:03.907562Z
...
- **Path:** `examples/live/bybit/bybit_request_custom_endpoint.py`
- **Size:** 5,049 bytes
- **Lines:** 139
- **Extension:** `.py`
- **Type:** text
...
This file is located at `examples/live/bybit/bybit_request_custom_endpoint.py` within the repository.

**Classes defined:** RequestDemoStrategyConfig, RequestDemoStrategy

**Functions defined:** __init__, on_start, send_tickers_request, on_historical_data
...
#### `__init__(self, config: RequestDemoStrategyConfig)`


#### `on_start(self)`


#### `send_tickers_request(self, time_event: TimeEvent)`
...
```python
from examples.live.bybit.bybit_request_custom_endpoint import RequestDemoStrategyConfig
```
