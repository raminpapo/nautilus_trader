# Documentation: README_options_data_collector.md

## File Metadata

- **Path**: `examples/live/bybit/README_options_data_collector.md`
- **Size**: 6,338 bytes
- **Lines**: 164
- **Language**: Markdown
...
**Identifiers**: `API`, `Adjust`, `All`, `Also`, `Automatic`, `BTC`, `BTCUSDT`, `BYBIT`, `BYBIT_API_KEY`, `BYBIT_API_SECRET`, `Basic`, `Best`, `Bybit`, `BybitOptionsDataCollector`, `BybitOptionsDataCollectorConfig`, `COLLECTOR`, `Change`, `Check`, `Collect`, `Collection`, `Collector`, `Complete`, `Comprehensive`, `Configuration`, `Connection`, `Connects`, `Ctrl`, `Custom`, `Data`, `Directory` *(+63 more)*
...
---
*Generated on 2025-11-18T21:55:04.310843Z*
