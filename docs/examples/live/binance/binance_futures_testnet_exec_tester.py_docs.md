# Documentation: binance_futures_testnet_exec_tester.py

## File Metadata

- **Path**: `examples/live/binance/binance_futures_testnet_exec_tester.py`
- **Size**: 6,732 bytes
- **Lines**: 168
- **Language**: Python
...
**Imports**: `decimal`, `nautilus_trader.adapters.binance`, `nautilus_trader.config`, `nautilus_trader.live.node`, `nautilus_trader.model.identifiers`, `nautilus_trader.test_kit.strategies.tester_exec`
...
```bash
# For Python
pytest examples/live/binance/binance_futures_testnet_exec_tester.py
...
---
*Generated on 2025-11-18T21:55:04.295302Z*
