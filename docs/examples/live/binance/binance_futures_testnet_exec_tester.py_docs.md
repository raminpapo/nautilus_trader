# Documentation: `examples/live/binance/binance_futures_testnet_exec_tester.py`
**Generated:** 2025-11-15T19:40:03.880919Z
...
This file is located at `examples/live/binance/binance_futures_testnet_exec_tester.py` within the repository.
...
```python
import examples.live.binance.binance_futures_testnet_exec_tester
```
