# Documentation: `examples/live/binance/binance_spot_ema_cross.py`
**Generated:** 2025-11-15T19:40:03.883869Z
...
This file is located at `examples/live/binance/binance_spot_ema_cross.py` within the repository.
...
```python
import examples.live.binance.binance_spot_ema_cross
```
