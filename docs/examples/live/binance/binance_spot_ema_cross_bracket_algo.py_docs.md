# Documentation: `examples/live/binance/binance_spot_ema_cross_bracket_algo.py`
**Generated:** 2025-11-15T19:40:03.885285Z
**File Size:** 4985 bytes
**Extension:** .py
**Type:** text
...
This file is located at `examples/live/binance/binance_spot_ema_cross_bracket_algo.py` within the repository.
...
```python
import examples.live.binance.binance_spot_ema_cross_bracket_algo
```
