# Documentation: `examples/live/okx/okx_spot_swap_quoter.py`
**Generated:** 2025-11-15T19:40:03.942199Z
...
- **Path:** `examples/live/okx/okx_spot_swap_quoter.py`
- **Size:** 19,645 bytes
- **Lines:** 504
- **Extension:** `.py`
- **Type:** text
...
This file is located at `examples/live/okx/okx_spot_swap_quoter.py` within the repository.

**Classes defined:** SpotSwapQuoterConfig, SpotSwapQuoter

**Functions defined:** __init__, on_start, open_position_on_start, on_quote_tick, _maintain_spot_orders, _maintain_swap_orders, on_event, on_stop
...
**Inherits from:** StrategyConfig, frozen=True, kw_only=True
...
#### `__init__(self, config: SpotSwapQuoterConfig)`


#### `on_start(self)`


#### `open_position_on_start(self)`


#### `on_quote_tick(self, quote: QuoteTick)`


#### `_maintain_spot_orders(self, quote: QuoteTick)`


#### `_maintain_swap_orders(self, quote: QuoteTick)`
...
```python
from examples.live.okx.okx_spot_swap_quoter import SpotSwapQuoterConfig
```
...
**Security:** This file may contain sensitive patterns: secret, token, api_key. Ensure proper handling of secrets.
