# Documentation: `examples/live/okx/okx_exec_tester.py`
**Generated:** 2025-11-15T19:40:03.939672Z
...
This file is located at `examples/live/okx/okx_exec_tester.py` within the repository.
...
```python
import examples.live.okx.okx_exec_tester
```
