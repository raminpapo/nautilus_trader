# Documentation: okx_exec_tester.py

## File Metadata

- **Path**: `examples/live/okx/okx_exec_tester.py`
- **Size**: 10,816 bytes
- **Lines**: 263
- **Language**: Python
...
**Imports**: `decimal`, `nautilus_trader.adapters.okx`, `nautilus_trader.config`, `nautilus_trader.core.nautilus_pyo3`, `nautilus_trader.live.config`, `nautilus_trader.live.node`, `nautilus_trader.model.enums`, `nautilus_trader.model.identifiers`, `nautilus_trader.test_kit.strategies.tester_exec`
...
```bash
# For Python
pytest examples/live/okx/okx_exec_tester.py
...
---
*Generated on 2025-11-18T21:55:04.363664Z*
