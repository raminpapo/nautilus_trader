# Documentation: okx_data_tester.py

## File Metadata

- **Path**: `examples/live/okx/okx_data_tester.py`
- **Size**: 6,274 bytes
- **Lines**: 160
- **Language**: Python
...
**Imports**: `nautilus_trader.adapters.okx`, `nautilus_trader.config`, `nautilus_trader.core.nautilus_pyo3`, `nautilus_trader.live.node`, `nautilus_trader.model.data`, `nautilus_trader.model.identifiers`, `nautilus_trader.test_kit.strategies.tester_data`, `pandas`
...
```bash
# For Python
pytest examples/live/okx/okx_data_tester.py
...
---
*Generated on 2025-11-18T21:55:04.361817Z*
