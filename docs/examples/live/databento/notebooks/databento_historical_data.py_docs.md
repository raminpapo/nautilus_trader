# Documentation: `examples/live/databento/notebooks/databento_historical_data.py`
**Generated:** 2025-11-15T19:40:03.913356Z
...
- **Path:** `examples/live/databento/notebooks/databento_historical_data.py`
- **Size:** 7,088 bytes
- **Lines:** 224
- **Extension:** `.py`
- **Type:** text
...
This file is located at `examples/live/databento/notebooks/databento_historical_data.py` within the repository.

**Classes defined:** DataSubscriberConfig, DataSubscriber

**Functions defined:** __init__, on_start, on_stop, on_historical_data, on_order_book_deltas, on_order_book, on_quote_tick, on_trade_tick
...
#### `__init__(self, config: DataSubscriberConfig)`
...
```python
from examples.live.databento.notebooks.databento_historical_data import DataSubscriberConfig
```
...
**Directory:** `examples/live/databento/notebooks`
