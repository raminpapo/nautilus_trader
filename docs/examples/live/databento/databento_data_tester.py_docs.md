# Documentation: `examples/live/databento/databento_data_tester.py`
**Generated:** 2025-11-15T19:40:03.911645Z
...
This file is located at `examples/live/databento/databento_data_tester.py` within the repository.
...
```python
import examples.live.databento.databento_data_tester
```
...
**Directory:** `examples/live/databento`
