# Documentation: hyperliquid_exec_tester.py
...
**Imports**: `decimal`, `nautilus_trader.adapters.hyperliquid`, `nautilus_trader.config`, `nautilus_trader.live.node`, `nautilus_trader.model.identifiers`, `nautilus_trader.test_kit.strategies.tester_exec`
...
```bash
# For Python
pytest examples/live/hyperliquid/hyperliquid_exec_tester.py
...
---
*Generated on 2025-11-18T21:55:04.339011Z*
