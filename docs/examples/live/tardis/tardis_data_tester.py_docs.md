# Documentation: tardis_data_tester.py
...
**Imports**: `nautilus_trader.adapters.tardis`, `nautilus_trader.cache.config`, `nautilus_trader.config`, `nautilus_trader.live.node`, `nautilus_trader.model.identifiers`, `nautilus_trader.test_kit.strategies.tester_data`

## Related Files

This file is located in `examples/live/tardis/`. Related files may include:
...
```bash
# For Python
pytest examples/live/tardis/tardis_data_tester.py
...
---
*Generated on 2025-11-18T21:55:04.371430Z*
