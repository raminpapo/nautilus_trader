# Documentation: `examples/live/interactive_brokers/notebooks/run_ratio_spread_1x2_qty3.py`
**Generated:** 2025-11-15T19:40:03.925347Z
**File Size:** 15326 bytes
**Extension:** .py
**Type:** text
...
- **Path:** `examples/live/interactive_brokers/notebooks/run_ratio_spread_1x2_qty3.py`
- **Size:** 15,326 bytes
- **Lines:** 416
- **Extension:** `.py`
- **Type:** text
...
This file is located at `examples/live/interactive_brokers/notebooks/run_ratio_spread_1x2_qty3.py` within the repository.

**Classes defined:** RatioSpreadTestConfig, RatioSpreadTestStrategy

**Functions defined:** __init__, on_start, on_instrument, _place_ratio_spread_order, on_quote_tick, on_order_submitted, on_order_accepted, on_order_rejected, on_order_filled, _analyze_fill and 4 more
...
#### `RatioSpreadTestConfig`

**Inherits from:** StrategyConfig, frozen=True


#### `RatioSpreadTestStrategy`
...
#### `__init__(self, config: RatioSpreadTestConfig)`
...
#### `_place_ratio_spread_order(self, instrument)`
...
#### `_analyze_fill(self, event: OrderFilled)`


#### `_check_portfolio_state(self)`


#### `on_stop(self)`


#### `auto_stop_node(node, delay_seconds=15)`
...
```python
from examples.live.interactive_brokers.notebooks.run_ratio_spread_1x2_qty3 import RatioSpreadTestConfig
```
