# Documentation: run_ratio_spread_1x2_qty3.py
...
### Functions
- **`auto_stop_node()`**: Function defined in this file

### Classes
- **`RatioSpreadTestConfig`**: Class defined in this file
- **`RatioSpreadTestStrategy`**: Class defined in this file
...
**Classs**: `RatioSpreadTestConfig`, `RatioSpreadTestStrategy`
**Functions**: `auto_stop_node`
**Imports**: `ibapi.common`, `nautilus_trader.adapters.interactive_brokers.common`, `nautilus_trader.adapters.interactive_brokers.config`, `nautilus_trader.adapters.interactive_brokers.factories`, `nautilus_trader.common.enums`, `nautilus_trader.config`, `nautilus_trader.live.node`, `nautilus_trader.model.enums`, `nautilus_trader.model.events`, `nautilus_trader.model.identifiers`, `nautilus_trader.trading.config`, `nautilus_trader.trading.strategy`, `os`, `threading`, `time`
...
---
*Generated on 2025-11-18T21:55:04.348028Z*
