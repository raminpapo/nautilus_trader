# Documentation: `examples/live/interactive_brokers/notebooks/test_simple_conditions.py`
**Generated:** 2025-11-15T19:40:03.931539Z
**File Size:** 14517 bytes
**Extension:** .py
**Type:** text
...
- **Path:** `examples/live/interactive_brokers/notebooks/test_simple_conditions.py`
- **Size:** 14,517 bytes
- **Lines:** 421
- **Extension:** `.py`
- **Type:** text
...
This file is located at `examples/live/interactive_brokers/notebooks/test_simple_conditions.py` within the repository.

**Classes defined:** SimpleConditionsConfig, SimpleConditionsStrategy

**Functions defined:** __init__, on_start, test_price_condition_order, test_time_condition_order, test_volume_condition_order, test_execution_condition_order, test_margin_condition_order, test_percent_change_condition_order, on_order_submitted, on_order_accepted and 3 more
...
#### `SimpleConditionsConfig`

**Inherits from:** StrategyConfig, frozen=True


#### `SimpleConditionsStrategy`
...
#### `__init__(self, config: SimpleConditionsConfig)`


#### `on_start(self)`


#### `test_price_condition_order(self, instrument)`


#### `test_time_condition_order(self, instrument)`


#### `test_volume_condition_order(self, instrument)`


#### `test_execution_condition_order(self, instrument)`


#### `test_margin_condition_order(self, instrument)`


#### `test_percent_change_condition_order(self, instrument)`
...
```python
from examples.live.interactive_brokers.notebooks.test_simple_conditions import SimpleConditionsConfig
```
...
**Directory:** `examples/live/interactive_brokers/notebooks`
