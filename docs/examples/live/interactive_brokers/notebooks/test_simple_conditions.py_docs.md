# Documentation: test_simple_conditions.py
...
### Classes
- **`SimpleConditionsConfig`**: Class defined in this file
- **`SimpleConditionsStrategy`**: Class defined in this file
...
**Classs**: `SimpleConditionsConfig`, `SimpleConditionsStrategy`
**Imports**: `datetime`, `nautilus_trader.adapters.interactive_brokers.common`, `nautilus_trader.adapters.interactive_brokers.config`, `nautilus_trader.adapters.interactive_brokers.factories`, `nautilus_trader.common.config`, `nautilus_trader.config`, `nautilus_trader.core.uuid`, `nautilus_trader.live.config`, `nautilus_trader.live.node`, `nautilus_trader.model`, `nautilus_trader.model.enums`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.orders`, `nautilus_trader.trading`, `nautilus_trader.trading.config`, `os`

## Related Files

This file is located in `examples/live/interactive_brokers/notebooks/`. Related files may include:
...
```bash
# For Python
pytest examples/live/interactive_brokers/notebooks/test_simple_conditions.py
...
---
*Generated on 2025-11-18T21:55:04.354562Z*
