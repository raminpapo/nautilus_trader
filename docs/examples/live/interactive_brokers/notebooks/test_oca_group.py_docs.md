# Documentation: `examples/live/interactive_brokers/notebooks/test_oca_group.py`
**Generated:** 2025-11-15T19:40:03.929185Z
...
This file is located at `examples/live/interactive_brokers/notebooks/test_oca_group.py` within the repository.

**Classes defined:** Strat_oca_test_config, Strat_oca_test

**Functions defined:** __init__, on_start, create_oca_orders, test_oca_modification
...
#### `__init__(self, config: Strat_oca_test_config)`


#### `on_start(self)`


#### `create_oca_orders(self, instrument_id)`


#### `test_oca_modification(self, instrument_id)`
...
```python
from examples.live.interactive_brokers.notebooks.test_oca_group import Strat_oca_test_config
```
