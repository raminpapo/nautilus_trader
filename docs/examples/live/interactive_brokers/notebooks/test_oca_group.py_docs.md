# Documentation: test_oca_group.py

## File Metadata

- **Path**: `examples/live/interactive_brokers/notebooks/test_oca_group.py`
- **Size**: 9,207 bytes
- **Lines**: 247
- **Language**: Python
...
### Classes
- **`Strat_oca_test_config`**: Class defined in this file
- **`Strat_oca_test`**: Class defined in this file
...
**Classs**: `Strat_oca_test`, `Strat_oca_test_config`
**Imports**: `datetime`, `nautilus_trader.adapters.interactive_brokers.common`, `nautilus_trader.adapters.interactive_brokers.config`, `nautilus_trader.adapters.interactive_brokers.factories`, `nautilus_trader.common.config`, `nautilus_trader.config`, `nautilus_trader.live.config`, `nautilus_trader.live.node`, `nautilus_trader.model`, `nautilus_trader.model.enums`, `nautilus_trader.model.identifiers`, `nautilus_trader.trading`, `nautilus_trader.trading.config`, `os`, `pandas`, `sys`
...
```bash
# For Python
pytest examples/live/interactive_brokers/notebooks/test_oca_group.py
...
---
*Generated on 2025-11-18T21:55:04.352088Z*
