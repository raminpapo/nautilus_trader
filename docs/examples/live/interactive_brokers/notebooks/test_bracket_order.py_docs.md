# Documentation: `examples/live/interactive_brokers/notebooks/test_bracket_order.py`
**Generated:** 2025-11-15T19:40:03.927223Z
**File Size:** 8665 bytes
**Extension:** .py
**Type:** text
...
This file is located at `examples/live/interactive_brokers/notebooks/test_bracket_order.py` within the repository.

**Classes defined:** Strat_mre_config, Strat_mre

**Functions defined:** __init__, on_start, buy_bracket, modify_sl, get_sl_order
...
#### `__init__(self, config: Strat_mre_config)`


#### `on_start(self)`


#### `buy_bracket(self, instrument_id, low)`


#### `modify_sl(self, instrument_id, low)`


#### `get_sl_order(self, instrument_id)`
...
```python
from examples.live.interactive_brokers.notebooks.test_bracket_order import Strat_mre_config
```
