# Documentation: test_bracket_order.py

## File Metadata

- **Path**: `examples/live/interactive_brokers/notebooks/test_bracket_order.py`
- **Size**: 8,665 bytes
- **Lines**: 237
- **Language**: Python
...
### Classes
- **`Strat_mre_config`**: Class defined in this file
- **`Strat_mre`**: Class defined in this file
...
**Classs**: `Strat_mre`, `Strat_mre_config`
**Imports**: `datetime`, `nautilus_trader.adapters.interactive_brokers.common`, `nautilus_trader.adapters.interactive_brokers.config`, `nautilus_trader.adapters.interactive_brokers.factories`, `nautilus_trader.common.config`, `nautilus_trader.config`, `nautilus_trader.live.config`, `nautilus_trader.live.node`, `nautilus_trader.model`, `nautilus_trader.model.enums`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.orders`, `nautilus_trader.trading`, `nautilus_trader.trading.config`, `os`, `pandas`, `sys`
...
```bash
# For Python
pytest examples/live/interactive_brokers/notebooks/test_bracket_order.py
...
---
*Generated on 2025-11-18T21:55:04.350048Z*
