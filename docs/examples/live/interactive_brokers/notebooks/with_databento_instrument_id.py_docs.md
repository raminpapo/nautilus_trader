# Documentation: `examples/live/interactive_brokers/notebooks/with_databento_instrument_id.py`
**Generated:** 2025-11-15T19:40:03.933617Z
**File Size:** 11681 bytes
**Extension:** .py
**Type:** text
...
This file is located at `examples/live/interactive_brokers/notebooks/with_databento_instrument_id.py` within the repository.

**Classes defined:** DemoStrategyConfig, DemoStrategy

**Functions defined:** __init__, on_start, on_instrument, on_bar, on_position_opened, on_stop, show_portfolio_info, auto_stop_node, stop_after_delay
...
#### `show_portfolio_info(self, intro_message: str = "")`
...
```python
from examples.live.interactive_brokers.notebooks.with_databento_instrument_id import DemoStrategyConfig
```
