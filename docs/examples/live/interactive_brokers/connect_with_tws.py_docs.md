# Documentation: `examples/live/interactive_brokers/connect_with_tws.py`
**Generated:** 2025-11-15T19:40:03.920842Z
...
This file is located at `examples/live/interactive_brokers/connect_with_tws.py` within the repository.
...
```python
import examples.live.interactive_brokers.connect_with_tws
```
