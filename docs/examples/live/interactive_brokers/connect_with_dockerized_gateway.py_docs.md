# Documentation: `examples/live/interactive_brokers/connect_with_dockerized_gateway.py`
**Generated:** 2025-11-15T19:40:03.919347Z
...
This file is located at `examples/live/interactive_brokers/connect_with_dockerized_gateway.py` within the repository.
...
```python
import examples.live.interactive_brokers.connect_with_dockerized_gateway
```
