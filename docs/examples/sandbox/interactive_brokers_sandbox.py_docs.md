# Documentation: interactive_brokers_sandbox.py

## File Metadata

- **Path**: `examples/sandbox/interactive_brokers_sandbox.py`
- **Size**: 5,105 bytes
- **Lines**: 135
- **Language**: Python
...
**Imports**: `decimal`, `nautilus_trader.adapters.interactive_brokers.common`, `nautilus_trader.adapters.interactive_brokers.config`, `nautilus_trader.adapters.interactive_brokers.factories`, `nautilus_trader.adapters.sandbox.config`, `nautilus_trader.adapters.sandbox.factory`, `nautilus_trader.config`, `nautilus_trader.examples.strategies.ema_cross`, `nautilus_trader.live.node`, `nautilus_trader.model.data`, `nautilus_trader.persistence.catalog`
...
---
*Generated on 2025-11-18T21:55:04.395385Z*
