...
**Imports**: `nautilus_trader.common.enums`, `nautilus_trader.config`, `nautilus_trader.core.datetime`, `nautilus_trader.model.data`, `nautilus_trader.model.instruments`, `nautilus_trader.trading.strategy`, `types`
...
```bash
# For Python
pytest examples/backtest/example_11_messaging_with_actor_signals/strategy.py
...
---
*Generated on 2025-11-18T21:55:04.261391Z*
