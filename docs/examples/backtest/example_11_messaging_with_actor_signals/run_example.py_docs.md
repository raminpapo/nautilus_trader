# Documentation: `examples/backtest/example_11_messaging_with_actor_signals/run_example.py`
**Generated:** 2025-11-15T19:40:03.855383Z
...
This file is located at `examples/backtest/example_11_messaging_with_actor_signals/run_example.py` within the repository.
...
```python
import examples.backtest.example_11_messaging_with_actor_signals.run_example
```
