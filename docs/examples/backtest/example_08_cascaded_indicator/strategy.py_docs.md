# Documentation: `examples/backtest/example_08_cascaded_indicator/strategy.py`
**Generated:** 2025-11-15T19:40:03.844462Z
...
This file is located at `examples/backtest/example_08_cascaded_indicator/strategy.py` within the repository.
...
```python
from examples.backtest.example_08_cascaded_indicator.strategy import DemoStrategyConfig
```
