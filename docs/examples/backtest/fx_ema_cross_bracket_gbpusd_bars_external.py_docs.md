# Documentation: `examples/backtest/fx_ema_cross_bracket_gbpusd_bars_external.py`
**Generated:** 2025-11-15T19:40:03.860806Z
...
This file is located at `examples/backtest/fx_ema_cross_bracket_gbpusd_bars_external.py` within the repository.
...
```python
import examples.backtest.fx_ema_cross_bracket_gbpusd_bars_external
```
