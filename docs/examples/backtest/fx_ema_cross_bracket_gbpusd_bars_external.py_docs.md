# Documentation: fx_ema_cross_bracket_gbpusd_bars_external.py
...
**Imports**: `decimal`, `nautilus_trader.backtest.config`, `nautilus_trader.backtest.engine`, `nautilus_trader.backtest.models`, `nautilus_trader.backtest.modules`, `nautilus_trader.config`, `nautilus_trader.examples.strategies.ema_cross_bracket`, `nautilus_trader.model.currencies`, `nautilus_trader.model.data`, `nautilus_trader.model.enums`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.objects`, `nautilus_trader.persistence.wranglers`, `nautilus_trader.test_kit.providers`, `pandas`, `time`
...
```bash
# For Python
pytest examples/backtest/fx_ema_cross_bracket_gbpusd_bars_external.py
...
---
*Generated on 2025-11-18T21:55:04.273819Z*
