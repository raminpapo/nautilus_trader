# Documentation: `examples/backtest/crypto_ema_cross_ethusdt_trailing_stop.py`
**Generated:** 2025-11-15T19:40:03.805504Z
...
This file is located at `examples/backtest/crypto_ema_cross_ethusdt_trailing_stop.py` within the repository.
...
```python
import examples.backtest.crypto_ema_cross_ethusdt_trailing_stop
```
