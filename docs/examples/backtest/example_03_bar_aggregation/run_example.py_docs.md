...
**Imports**: `decimal`, `examples.utils.data_provider`, `nautilus_trader.backtest.engine`, `nautilus_trader.config`, `nautilus_trader.core.nautilus_pyo3`, `nautilus_trader.model`, `nautilus_trader.model.currencies`, `nautilus_trader.model.enums`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.instruments.base`, `nautilus_trader.model.objects`, `strategy`

## Related Files

This file is located in `examples/backtest/example_03_bar_aggregation/`. Related files may include:
...
```bash
# For Python
pytest examples/backtest/example_03_bar_aggregation/run_example.py
...
---
*Generated on 2025-11-18T21:55:04.225431Z*
