# Documentation: `examples/backtest/example_03_bar_aggregation/strategy.py`
**Generated:** 2025-11-15T19:40:03.824748Z
**File Size:** 5182 bytes
**Extension:** .py
**Type:** text
...
- **Path:** `examples/backtest/example_03_bar_aggregation/strategy.py`
- **Size:** 5,182 bytes
- **Lines:** 114
- **Extension:** `.py`
- **Type:** text
...
This file is located at `examples/backtest/example_03_bar_aggregation/strategy.py` within the repository.
...
```python
from examples.backtest.example_03_bar_aggregation.strategy import DemoStrategy
```
...
**Directory:** `examples/backtest/example_03_bar_aggregation`
