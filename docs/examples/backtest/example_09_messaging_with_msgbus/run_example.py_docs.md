# Documentation: `examples/backtest/example_09_messaging_with_msgbus/run_example.py`
**Generated:** 2025-11-15T19:40:03.847199Z
...
This file is located at `examples/backtest/example_09_messaging_with_msgbus/run_example.py` within the repository.
...
```python
import examples.backtest.example_09_messaging_with_msgbus.run_example
```
