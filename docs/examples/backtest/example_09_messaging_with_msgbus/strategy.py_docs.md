# Documentation: `examples/backtest/example_09_messaging_with_msgbus/strategy.py`
**Generated:** 2025-11-15T19:40:03.848955Z
...
- **Path:** `examples/backtest/example_09_messaging_with_msgbus/strategy.py`
- **Size:** 4,602 bytes
- **Lines:** 118
- **Extension:** `.py`
- **Type:** text
...
This file is located at `examples/backtest/example_09_messaging_with_msgbus/strategy.py` within the repository.

**Classes defined:** Each10thBarEvent, DemoStrategyConfig, DemoStrategy

**Functions defined:** __init__, on_start, on_bar, on_each_10th_bar, on_stop
...
#### `on_each_10th_bar(self, event: Each10thBarEvent)`
...
```python
from examples.backtest.example_09_messaging_with_msgbus.strategy import Each10thBarEvent
```
