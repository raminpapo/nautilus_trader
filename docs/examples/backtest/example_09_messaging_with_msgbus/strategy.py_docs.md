...
### Classes
- **`Each10thBarEvent`**: Class defined in this file
...
**Classs**: `DemoStrategy`, `DemoStrategyConfig`, `Each10thBarEvent`
**Imports**: `dataclasses`, `nautilus_trader.common.enums`, `nautilus_trader.config`, `nautilus_trader.core.datetime`, `nautilus_trader.core.message`, `nautilus_trader.model.data`, `nautilus_trader.model.instruments`, `nautilus_trader.trading.strategy`
...
```bash
# For Python
pytest examples/backtest/example_09_messaging_with_msgbus/strategy.py
...
---
*Generated on 2025-11-18T21:55:04.253258Z*
