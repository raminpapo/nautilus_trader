# Documentation: `examples/backtest/crypto_ema_cross_with_binance_provider.py`
**Generated:** 2025-11-15T19:40:03.806876Z
...
This file is located at `examples/backtest/crypto_ema_cross_with_binance_provider.py` within the repository.
...
```python
import examples.backtest.crypto_ema_cross_with_binance_provider
```
