# Documentation: crypto_ema_cross_with_binance_provider.py
...
**Imports**: `asyncio`, `decimal`, `nautilus_trader.adapters.binance`, `nautilus_trader.adapters.binance.common.enums`, `nautilus_trader.adapters.binance.futures.providers`, `nautilus_trader.backtest.config`, `nautilus_trader.backtest.engine`, `nautilus_trader.common.component`, `nautilus_trader.config`, `nautilus_trader.examples.strategies.ema_cross_trailing_stop`, `nautilus_trader.model.data`, `nautilus_trader.model.enums`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.objects`, `nautilus_trader.persistence.wranglers`, `nautilus_trader.test_kit.providers`, `pandas`, `time`
...
```bash
# For Python
pytest examples/backtest/crypto_ema_cross_with_binance_provider.py
...
---
*Generated on 2025-11-18T21:55:04.208170Z*
