# Documentation: databento_option_greeks.py
...
**Classs**: `OptionConfig`, `OptionStrategy`
**Imports**: `nautilus_trader.adapters.databento.data_utils`, `nautilus_trader.analysis.config`, `nautilus_trader.analysis.tearsheet`, `nautilus_trader.backtest.config`, `nautilus_trader.backtest.node`, `nautilus_trader.backtest.option_exercise`, `nautilus_trader.common.enums`, `nautilus_trader.config`, `nautilus_trader.core.datetime`, `nautilus_trader.model.data`, `nautilus_trader.model.enums`, `nautilus_trader.model.greeks_data`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.objects`, `nautilus_trader.model.tick_scheme`, `nautilus_trader.persistence.config`, `nautilus_trader.persistence.loaders`, `nautilus_trader.trading.strategy`, `numpy`
...
```bash
# For Python
pytest examples/backtest/notebooks/databento_option_greeks.py
...
---
*Generated on 2025-11-18T21:55:04.284604Z*
