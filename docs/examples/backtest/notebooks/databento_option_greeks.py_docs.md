# Documentation: `examples/backtest/notebooks/databento_option_greeks.py`
**Generated:** 2025-11-15T19:40:03.870530Z
**File Size:** 16398 bytes
**Extension:** .py
**Type:** text
...
This file is located at `examples/backtest/notebooks/databento_option_greeks.py` within the repository.

**Classes defined:** OptionConfig, OptionStrategy

**Functions defined:** __init__, on_start, on_instrument, init_portfolio, on_quote_tick, on_bar, display_greeks, submit_market_order, submit_limit_order, user_log and 1 more
...
```python
from examples.backtest.notebooks.databento_option_greeks import OptionConfig
```
