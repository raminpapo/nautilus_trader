# Documentation: databento_backtest_with_data_client.py
...
### Classes
- **`FuturesStrategyConfig`**: Class defined in this file
- **`FuturesStrategy`**: Class defined in this file
...
**Classs**: `FuturesStrategy`, `FuturesStrategyConfig`
**Imports**: `asyncio`, `nautilus_trader.adapters.databento.config`, `nautilus_trader.adapters.databento.data_utils`, `nautilus_trader.adapters.databento.factories`, `nautilus_trader.backtest.config`, `nautilus_trader.backtest.node`, `nautilus_trader.common.config`, `nautilus_trader.common.enums`, `nautilus_trader.config`, `nautilus_trader.core.datetime`, `nautilus_trader.model.data`, `nautilus_trader.model.enums`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.objects`, `nautilus_trader.persistence.config`, `nautilus_trader.trading.strategy`
...
```bash
# For Python
pytest examples/backtest/notebooks/databento_backtest_with_data_client.py
...
---
*Generated on 2025-11-18T21:55:04.280552Z*
