# Documentation: `examples/backtest/notebooks/databento_backtest_with_data_client.py`
**Generated:** 2025-11-15T19:40:03.867028Z
**File Size:** 7602 bytes
**Extension:** .py
**Type:** text
...
This file is located at `examples/backtest/notebooks/databento_backtest_with_data_client.py` within the repository.

**Classes defined:** FuturesStrategyConfig, FuturesStrategy

**Functions defined:** __init__, on_start, on_order_book_depth, on_bar, submit_market_order, user_log, on_stop
...
#### `__init__(self, config: FuturesStrategyConfig)`


#### `on_start(self)`


#### `on_order_book_depth(self, depth)`


#### `on_bar(self, bar: Bar)`


#### `submit_market_order(self, instrument_id: InstrumentId, quantity: int)`


#### `user_log(self, msg: str)`
...
```python
from examples.backtest.notebooks.databento_backtest_with_data_client import FuturesStrategyConfig
```
