# Documentation: databento_test_request_bars.py
...
### Classes
- **`TestHistoricalAggConfig`**: Class defined in this file
- **`TestHistoricalAggStrategy`**: Class defined in this file
...
**Classs**: `TestHistoricalAggConfig`, `TestHistoricalAggStrategy`
**Imports**: `nautilus_trader.adapters.databento.data_utils`, `nautilus_trader.backtest.node`, `nautilus_trader.common.enums`, `nautilus_trader.config`, `nautilus_trader.core.datetime`, `nautilus_trader.model.data`, `nautilus_trader.model.identifiers`, `nautilus_trader.persistence.config`, `nautilus_trader.trading.strategy`, `pandas`
...
```bash
# For Python
pytest examples/backtest/notebooks/databento_test_request_bars.py
...
---
*Generated on 2025-11-18T21:55:04.286868Z*
