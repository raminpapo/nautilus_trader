# Documentation: `examples/backtest/notebooks/databento_test_request_bars.py`
**Generated:** 2025-11-15T19:40:03.872705Z
**File Size:** 14154 bytes
**Extension:** .py
**Type:** text
...
This file is located at `examples/backtest/notebooks/databento_test_request_bars.py` within the repository.

**Classes defined:** TestHistoricalAggConfig, TestHistoricalAggStrategy

**Functions defined:** __init__, on_start, on_instrument, strategy_subscribe_bars, on_historical_data, on_bar, user_log, on_stop
...
#### `TestHistoricalAggConfig`

**Inherits from:** StrategyConfig, frozen=True


#### `TestHistoricalAggStrategy`
...
#### `__init__(self, config: TestHistoricalAggConfig)`


#### `on_start(self)`


#### `on_instrument(self, data)`


#### `strategy_subscribe_bars(self, uuid)`
...
```python
from examples.backtest.notebooks.databento_test_request_bars import TestHistoricalAggConfig
```
