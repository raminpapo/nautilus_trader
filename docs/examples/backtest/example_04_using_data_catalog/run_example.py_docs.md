...
**Imports**: `decimal`, `examples.utils.data_provider`, `nautilus_trader.backtest.engine`, `nautilus_trader.common.component`, `nautilus_trader.common.enums`, `nautilus_trader.config`, `nautilus_trader.core.nautilus_pyo3`, `nautilus_trader.model`, `nautilus_trader.model.currencies`, `nautilus_trader.model.enums`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.instruments.base`, `nautilus_trader.model.objects`, `nautilus_trader.persistence.catalog.parquet`, `strategy`
...
```bash
# For Python
pytest examples/backtest/example_04_using_data_catalog/run_example.py
...
---
*Generated on 2025-11-18T21:55:04.231135Z*
