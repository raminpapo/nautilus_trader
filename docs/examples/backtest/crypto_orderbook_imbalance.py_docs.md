# Documentation: `examples/backtest/crypto_orderbook_imbalance.py`
**Generated:** 2025-11-15T19:40:03.808212Z
...
This file is located at `examples/backtest/crypto_orderbook_imbalance.py` within the repository.
...
```python
import examples.backtest.crypto_orderbook_imbalance
```
