# Documentation: `examples/backtest/databento_ema_cross_long_only_aapl_bars.py`
**Generated:** 2025-11-15T19:40:03.811225Z
...
This file is located at `examples/backtest/databento_ema_cross_long_only_aapl_bars.py` within the repository.
...
```python
import examples.backtest.databento_ema_cross_long_only_aapl_bars
```
