# Documentation: databento_ema_cross_long_only_spy_trades.py
...
```bash
# For Python
pytest examples/backtest/databento_ema_cross_long_only_spy_trades.py
...
---
*Generated on 2025-11-18T21:55:04.213494Z*
