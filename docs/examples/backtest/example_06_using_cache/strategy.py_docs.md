# Documentation: `examples/backtest/example_06_using_cache/strategy.py`
**Generated:** 2025-11-15T19:40:03.836872Z
**File Size:** 14036 bytes
**Extension:** .py
**Type:** text
...
- **Path:** `examples/backtest/example_06_using_cache/strategy.py`
- **Size:** 14,036 bytes
- **Lines:** 334
- **Extension:** `.py`
- **Type:** text
...
This file is located at `examples/backtest/example_06_using_cache/strategy.py` within the repository.

**Classes defined:** DataContainer, CacheDemoStrategy

**Functions defined:** __init__, __str__, __init__, on_start, on_bar, on_position_opened, on_stop, demonstrate_cache_methods
...
#### `demonstrate_cache_methods(self)`
...
```python
from examples.backtest.example_06_using_cache.strategy import DataContainer
```
...
**Directory:** `examples/backtest/example_06_using_cache`
