...
### Classes
- **`DataContainer`**: Class defined in this file
- **`CacheDemoStrategy`**: Class defined in this file
...
**Classs**: `CacheDemoStrategy`, `DataContainer`
**Imports**: `nautilus_trader.common.enums`, `nautilus_trader.model.data`, `nautilus_trader.model.enums`, `nautilus_trader.model.events`, `nautilus_trader.trading.strategy`, `pickle`
...
```bash
# For Python
pytest examples/backtest/example_06_using_cache/strategy.py
...
---
*Generated on 2025-11-18T21:55:04.241490Z*
