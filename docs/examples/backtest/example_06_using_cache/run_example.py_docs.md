...
This file is located in `examples/backtest/example_06_using_cache/`. Related files may include:
...
```bash
# For Python
pytest examples/backtest/example_06_using_cache/run_example.py
...
---
*Generated on 2025-11-18T21:55:04.239112Z*
