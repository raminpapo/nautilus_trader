# Documentation: fx_market_maker_gbpusd_bars.py
...
**Imports**: `datetime`, `decimal`, `nautilus_trader.backtest.config`, `nautilus_trader.backtest.engine`, `nautilus_trader.backtest.models`, `nautilus_trader.backtest.modules`, `nautilus_trader.examples.strategies.volatility_market_maker`, `nautilus_trader.model.currencies`, `nautilus_trader.model.data`, `nautilus_trader.model.enums`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.objects`, `nautilus_trader.persistence.wranglers`, `nautilus_trader.test_kit.providers`, `pandas`, `time`
...
```bash
# For Python
pytest examples/backtest/fx_market_maker_gbpusd_bars.py
...
---
*Generated on 2025-11-18T21:55:04.276806Z*
