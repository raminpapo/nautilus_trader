# Documentation: `examples/backtest/fx_market_maker_gbpusd_bars.py`
**Generated:** 2025-11-15T19:40:03.863649Z
...
This file is located at `examples/backtest/fx_market_maker_gbpusd_bars.py` within the repository.
...
```python
import examples.backtest.fx_market_maker_gbpusd_bars
```
