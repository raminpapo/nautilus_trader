# Documentation: `examples/backtest/fx_ema_cross_audusd_bars_from_ticks.py`
**Generated:** 2025-11-15T19:40:03.858126Z
...
This file is located at `examples/backtest/fx_ema_cross_audusd_bars_from_ticks.py` within the repository.
...
```python
import examples.backtest.fx_ema_cross_audusd_bars_from_ticks
```
