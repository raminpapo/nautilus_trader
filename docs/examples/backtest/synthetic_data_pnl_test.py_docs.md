# Documentation: `examples/backtest/synthetic_data_pnl_test.py`
**Generated:** 2025-11-15T19:40:03.876068Z
**File Size:** 8692 bytes
**Extension:** .py
**Type:** text
...
This file is located at `examples/backtest/synthetic_data_pnl_test.py` within the repository.

**Classes defined:** MinimalStrategyConfig, MinimalStrategy

**Functions defined:** create_6E_instrument, __init__, on_start, on_bar, on_stop
...
#### `create_6E_instrument(venue: Venue)`


#### `__init__(self, config: MinimalStrategyConfig)`
...
```python
from examples.backtest.synthetic_data_pnl_test import MinimalStrategyConfig
```
