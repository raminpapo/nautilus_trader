# Documentation: synthetic_data_pnl_test.py
...
### Functions
- **`create_6E_instrument()`**: Function defined in this file

### Classes
- **`MinimalStrategyConfig`**: Class defined in this file
- **`MinimalStrategy`**: Class defined in this file
...
**Classs**: `MinimalStrategy`, `MinimalStrategyConfig`
**Functions**: `create_6E_instrument`
**Imports**: `datetime`, `decimal`, `nautilus_trader.backtest.engine`, `nautilus_trader.backtest.models`, `nautilus_trader.config`, `nautilus_trader.core.datetime`, `nautilus_trader.model.currencies`, `nautilus_trader.model.data`, `nautilus_trader.model.enums`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.instruments`, `nautilus_trader.model.objects`, `nautilus_trader.trading.strategy`
...
```bash
# For Python
pytest examples/backtest/synthetic_data_pnl_test.py
...
---
*Generated on 2025-11-18T21:55:04.290086Z*
