# Documentation: `examples/backtest/example_01_load_bars_from_custom_csv/run_example.py`
**Generated:** 2025-11-15T19:40:03.816099Z
...
This file is located at `examples/backtest/example_01_load_bars_from_custom_csv/run_example.py` within the repository.
...
```python
import examples.backtest.example_01_load_bars_from_custom_csv.run_example
```
