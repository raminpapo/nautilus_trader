# Documentation: `examples/backtest/fx_ema_cross_bracket_gbpusd_bars_internal.py`
**Generated:** 2025-11-15T19:40:03.862248Z
**File Size:** 5116 bytes
**Extension:** .py
**Type:** text
...
This file is located at `examples/backtest/fx_ema_cross_bracket_gbpusd_bars_internal.py` within the repository.
...
```python
import examples.backtest.fx_ema_cross_bracket_gbpusd_bars_internal
```
