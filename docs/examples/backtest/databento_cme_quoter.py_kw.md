# Keywords: databento_cme_quoter.py

## File Path
`examples/backtest/databento_cme_quoter.py`
...
- **Type**: import
- **File**: [examples/backtest/databento_cme_quoter.py](../databento_cme_quoter.py_docs.md)
...
### nautilus_trader.examples.strategies.simpler_quoter
...
---
*Generated on 2025-11-18T21:55:04.210897Z*
