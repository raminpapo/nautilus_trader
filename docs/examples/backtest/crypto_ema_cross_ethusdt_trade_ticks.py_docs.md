# Documentation: `examples/backtest/crypto_ema_cross_ethusdt_trade_ticks.py`
**Generated:** 2025-11-15T19:40:03.804184Z
...
This file is located at `examples/backtest/crypto_ema_cross_ethusdt_trade_ticks.py` within the repository.
...
```python
import examples.backtest.crypto_ema_cross_ethusdt_trade_ticks
```
