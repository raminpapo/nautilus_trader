# Documentation: crypto_ema_cross_ethusdt_trade_ticks.py
...
**Imports**: `decimal`, `nautilus_trader.adapters.binance`, `nautilus_trader.backtest.config`, `nautilus_trader.backtest.engine`, `nautilus_trader.config`, `nautilus_trader.examples.algorithms.twap`, `nautilus_trader.examples.strategies.ema_cross_twap`, `nautilus_trader.model.currencies`, `nautilus_trader.model.data`, `nautilus_trader.model.enums`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.objects`, `nautilus_trader.persistence.wranglers`, `nautilus_trader.test_kit.providers`, `pandas`, `time`
...
```bash
# For Python
pytest examples/backtest/crypto_ema_cross_ethusdt_trade_ticks.py
...
---
*Generated on 2025-11-18T21:55:04.205310Z*
