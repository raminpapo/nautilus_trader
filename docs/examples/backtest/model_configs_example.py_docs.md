# Documentation: `examples/backtest/model_configs_example.py`
**Generated:** 2025-11-15T19:40:03.865227Z
...
This file is located at `examples/backtest/model_configs_example.py` within the repository.
...
```python
import examples.backtest.model_configs_example
```
