# Documentation: model_configs_example.py
...
**Imports**: `nautilus_trader.backtest.config`, `nautilus_trader.backtest.node`, `nautilus_trader.config`, `nautilus_trader.model.data`, `nautilus_trader.model.identifiers`
...
```bash
# For Python
pytest examples/backtest/model_configs_example.py
...
---
*Generated on 2025-11-18T21:55:04.278819Z*
