# Documentation: databento_cme_quoter.py
...
**Imports**: `nautilus_trader.adapters.databento`, `nautilus_trader.backtest.config`, `nautilus_trader.backtest.engine`, `nautilus_trader.config`, `nautilus_trader.examples.strategies.simpler_quoter`, `nautilus_trader.model.currencies`, `nautilus_trader.model.enums`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.objects`, `nautilus_trader.test_kit.providers`, `pandas`, `pathlib`, `time`
...
```bash
# For Python
pytest examples/backtest/databento_cme_quoter.py
...
---
*Generated on 2025-11-18T21:55:04.210864Z*
