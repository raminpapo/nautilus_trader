# Documentation: `examples/backtest/databento_ema_cross_long_only_tsla_trades.py`
**Generated:** 2025-11-15T19:40:03.813938Z
...
This file is located at `examples/backtest/databento_ema_cross_long_only_tsla_trades.py` within the repository.
...
```python
import examples.backtest.databento_ema_cross_long_only_tsla_trades
```
