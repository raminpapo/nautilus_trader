...
**Imports**: `nautilus_trader.common.enums`, `nautilus_trader.model.data`, `nautilus_trader.model.enums`, `nautilus_trader.model.events`, `nautilus_trader.model.instruments.base`, `nautilus_trader.trading.config`, `nautilus_trader.trading.strategy`
...
```bash
# For Python
pytest examples/backtest/example_05_using_portfolio/strategy.py
...
---
*Generated on 2025-11-18T21:55:04.236560Z*
