# Documentation: `examples/backtest/example_05_using_portfolio/strategy.py`
**Generated:** 2025-11-15T19:40:03.832415Z
**File Size:** 6121 bytes
**Extension:** .py
**Type:** text
...
- **Path:** `examples/backtest/example_05_using_portfolio/strategy.py`
- **Size:** 6,121 bytes
- **Lines:** 148
- **Extension:** `.py`
- **Type:** text
...
This file is located at `examples/backtest/example_05_using_portfolio/strategy.py` within the repository.

**Classes defined:** DemoStrategyConfig, DemoStrategy

**Functions defined:** __init__, on_start, on_bar, on_position_opened, on_stop, show_portfolio_info
...
```python
from examples.backtest.example_05_using_portfolio.strategy import DemoStrategyConfig
```
