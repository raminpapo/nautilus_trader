# Documentation: polymarket_simple_quoter.py
...
**Imports**: `asyncio`, `decimal`, `nautilus_trader.adapters.polymarket`, `nautilus_trader.backtest.config`, `nautilus_trader.backtest.engine`, `nautilus_trader.examples.strategies.orderbook_imbalance`, `nautilus_trader.model.currencies`, `nautilus_trader.model.enums`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.objects`, `pandas`, `time`
...
```bash
# For Python
pytest examples/backtest/polymarket_simple_quoter.py
...
---
*Generated on 2025-11-18T21:55:04.288377Z*
