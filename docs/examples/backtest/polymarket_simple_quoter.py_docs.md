# Documentation: `examples/backtest/polymarket_simple_quoter.py`
**Generated:** 2025-11-15T19:40:03.874311Z
**File Size:** 5659 bytes
**Extension:** .py
**Type:** text
...
This file is located at `examples/backtest/polymarket_simple_quoter.py` within the repository.
...
```python
import examples.backtest.polymarket_simple_quoter
```
