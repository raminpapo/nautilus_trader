...
- **Path**: `examples/backtest/example_07_using_indicators/strategy.py`
- **Size**: 5,457 bytes
- **Lines**: 125
- **Language**: Python
...
**Classs**: `DemoStrategy`
**Imports**: `collections`, `datetime`, `nautilus_trader.common.enums`, `nautilus_trader.indicators`, `nautilus_trader.model.data`, `nautilus_trader.trading.strategy`

## Related Files

This file is located in `examples/backtest/example_07_using_indicators/`. Related files may include:
...
```bash
# For Python
pytest examples/backtest/example_07_using_indicators/strategy.py
...
---
*Generated on 2025-11-18T21:55:04.245447Z*
