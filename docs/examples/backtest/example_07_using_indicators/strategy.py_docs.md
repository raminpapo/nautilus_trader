# Documentation: `examples/backtest/example_07_using_indicators/strategy.py`
**Generated:** 2025-11-15T19:40:03.840600Z
...
This file is located at `examples/backtest/example_07_using_indicators/strategy.py` within the repository.
...
```python
from examples.backtest.example_07_using_indicators.strategy import DemoStrategy
```
