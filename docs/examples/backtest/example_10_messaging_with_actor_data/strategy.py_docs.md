# Documentation: `examples/backtest/example_10_messaging_with_actor_data/strategy.py`
**Generated:** 2025-11-15T19:40:03.853118Z
...
- **Path:** `examples/backtest/example_10_messaging_with_actor_data/strategy.py`
- **Size:** 5,756 bytes
- **Lines:** 147
- **Extension:** `.py`
- **Type:** text
...
This file is located at `examples/backtest/example_10_messaging_with_actor_data/strategy.py` within the repository.

**Classes defined:** Last10BarsStats, Last10BarsStatsSerializable, DemoStrategyConfig, DemoStrategy

**Functions defined:** __init__, on_start, on_bar, on_data, on_stop
...
```python
from examples.backtest.example_10_messaging_with_actor_data.strategy import Last10BarsStats
```
...
**Directory:** `examples/backtest/example_10_messaging_with_actor_data`
