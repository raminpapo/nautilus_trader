...
### Classes
- **`Last10BarsStats`**: Class defined in this file
- **`Last10BarsStatsSerializable`**: Class defined in this file
...
**Classs**: `DemoStrategy`, `DemoStrategyConfig`, `Last10BarsStats`, `Last10BarsStatsSerializable`
**Imports**: `nautilus_trader.common.enums`, `nautilus_trader.config`, `nautilus_trader.core.data`, `nautilus_trader.core.datetime`, `nautilus_trader.model`, `nautilus_trader.model.custom`, `nautilus_trader.model.data`, `nautilus_trader.model.instruments`, `nautilus_trader.trading.strategy`
...
```bash
# For Python
pytest examples/backtest/example_10_messaging_with_actor_data/strategy.py
...
---
*Generated on 2025-11-18T21:55:04.257506Z*
