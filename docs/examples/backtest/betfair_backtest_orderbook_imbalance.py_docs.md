# Documentation: `examples/backtest/betfair_backtest_orderbook_imbalance.py`
**Generated:** 2025-11-15T19:40:03.802728Z
...
This file is located at `examples/backtest/betfair_backtest_orderbook_imbalance.py` within the repository.
...
```python
import examples.backtest.betfair_backtest_orderbook_imbalance
```
