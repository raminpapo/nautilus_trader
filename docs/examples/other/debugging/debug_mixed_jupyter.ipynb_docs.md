# Documentation: debug_mixed_jupyter.ipynb

## File Metadata

- **Path**: `examples/other/debugging/debug_mixed_jupyter.ipynb`
- **Size**: 3,721 bytes
- **Lines**: 129
- **Language**: Unknown
...
**Identifiers**: `ALL`, `Also`, `Catalog`, `Code`, `Create`, `Created`, `Debugging`, `EURUSD`, `Example`, `Initialize`, `InstrumentId`, `Jupyter`, `Mixed`, `PID`, `Parquet`, `ParquetDataCatalog`, `Price`, `Python`, `Quantity`, `QuoteTick`, `Rust`, `SIM`, `See`, `Set`, `Setup`, `Testing`, `This`, `VSCode`, `You`

## Related Files

This file is located in `examples/other/debugging/`. Related files may include:
...
---
*Generated on 2025-11-18T21:55:04.372985Z*
