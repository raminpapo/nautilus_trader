# Documentation: `examples/other/minimal_reproducible_example/run_example.py`
**Generated:** 2025-11-15T19:40:03.950760Z
**File Size:** 6721 bytes
**Extension:** .py
**Type:** text
...
This file is located at `examples/other/minimal_reproducible_example/run_example.py` within the repository.

**Functions defined:** generate_artificial_bars, run_backtest
...
#### `generate_artificial_bars(instrument: Instrument, bar_type: BarType)`
...
```python
from examples.other.minimal_reproducible_example.run_example import generate_artificial_bars
```
...
**Directory:** `examples/other/minimal_reproducible_example`
