...
- **Path**: `examples/other/minimal_reproducible_example/run_example.py`
- **Size**: 6,721 bytes
- **Lines**: 176
- **Language**: Python
...
### Functions
- **`generate_artificial_bars()`**: Function defined in this file
...
**Functions**: `generate_artificial_bars`, `run_backtest`
**Imports**: `datetime`, `decimal`, `nautilus_trader.backtest.config`, `nautilus_trader.backtest.engine`, `nautilus_trader.config`, `nautilus_trader.core.datetime`, `nautilus_trader.data.config`, `nautilus_trader.model`, `nautilus_trader.model.currencies`, `nautilus_trader.model.enums`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.instruments`, `nautilus_trader.model.objects`, `nautilus_trader.test_kit.providers`, `strategy`

## Related Files

This file is located in `examples/other/minimal_reproducible_example/`. Related files may include:
...
---
*Generated on 2025-11-18T21:55:04.377642Z*
