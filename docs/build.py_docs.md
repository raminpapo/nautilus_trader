...
### Functions
- **`_set_feature_flags()`**: Function defined in this file
- **`_build_rust_libs()`**: Function defined in this file
- **`_build_extensions()`**: Function defined in this file
- **`_build_distribution()`**: Function defined in this file
- **`_copy_build_dir_to_project()`**: Function defined in this file
- **`_copy_rust_dylibs_to_project()`**: Function defined in this file
- **`_get_nautilus_version()`**: Function defined in this file
- **`_get_clang_version()`**: Function defined in this file
- **`_get_rustc_version()`**: Function defined in this file
- **`_ensure_windows_python_import_lib()`**: Function defined in this file
- **`_strip_unneeded_symbols()`**: Function defined in this file
- **`show_rustanalyzer_settings()`**: Function defined in this file
- **`build()`**: Function defined in this file
- **`print_env_var_if_exists()`**: Function defined in this file
...
**Functions**: `_build_distribution`, `_build_extensions`, `_build_rust_libs`, `_copy_build_dir_to_project`, `_copy_rust_dylibs_to_project`, `_ensure_windows_python_import_lib`, `_get_clang_version`, `_get_nautilus_version`, `_get_rustc_version`, `_set_feature_flags`, `_strip_unneeded_symbols`, `build`, `print_env_var_if_exists`, `show_rustanalyzer_settings`
**Imports**: `Cython.Build`, `Cython.Compiler`, `Cython.Compiler.Version`, `datetime`, `itertools`, `numpy`, `os`, `packaging.version`, `pathlib`, `platform`, `re`, `setuptools`, `shutil`, `subprocess`, `sys`, `sysconfig`
...
---
*Generated on 2025-11-18T21:54:58.922470Z*
