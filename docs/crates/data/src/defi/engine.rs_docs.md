# Documentation: `crates/data/src/defi/engine.rs`
**Generated:** 2025-11-15T19:40:01.988307Z
**File Size:** 35277 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/data/src/defi/engine.rs` within the repository.

**Classes defined:** DataEngine

**Functions defined:** get_event_block_position, convert_and_sort_buffered_events, subscribed_blocks, subscribed_pools, subscribed_pool_swaps, subscribed_pool_liquidity_updates, subscribed_pool_fee_collects, subscribed_pool_flash, execute_defi_subscribe, execute_defi_unsubscribe and 24 more
...
#### `get_event_block_position(event: &DexPoolData)`


#### `convert_and_sort_buffered_events(buffered_events: Vec<DefiData>)`


#### `subscribed_blocks(&self)`


#### `subscribed_pools(&self)`


#### `subscribed_pool_swaps(&self)`


#### `subscribed_pool_liquidity_updates(&self)`


#### `subscribed_pool_fee_collects(&self)`


#### `subscribed_pool_flash(&self)`
...
#### `execute_defi_request(&mut self, req: &DefiRequestCommand)`


#### `process_defi_data(&mut self, data: DefiData)`


#### `subscribe_pool_updater_topics(
        &self,
        instrument_id: InstrumentId,
        handler: ShareableMessageHandler,
    )`
...
#### `apply_buffered_events_to_profiler(
        profiler: &mut PoolProfiler,
        events: Vec<DexPoolData>,
        snapshot_block: &BlockPosition,
        instrument_id: InstrumentId,
...
#### `setup_pool_updater(&mut self, instrument_id: &InstrumentId, client_id: Option<&ClientId>)`
...
#### `test_dex(test_chain: Arc<nautilus_model::defi::Chain>)`
...
#### `test_get_event_block_position_swap(
        test_instrument_id: InstrumentId,
        test_chain: Arc<nautilus_model::defi::Chain>,
        test_dex: Arc<Dex>,
    )`
...
#### `test_get_event_block_position_liquidity_update(
        test_instrument_id: InstrumentId,
        test_chain: Arc<nautilus_model::defi::Chain>,
        test_dex: Arc<Dex>,
    )`
...
#### `test_get_event_block_position_fee_collect(
        test_instrument_id: InstrumentId,
        test_chain: Arc<nautilus_model::defi::Chain>,
        test_dex: Arc<Dex>,
    )`
...
#### `test_get_event_block_position_flash(
        test_instrument_id: InstrumentId,
        test_chain: Arc<nautilus_model::defi::Chain>,
        test_dex: Arc<Dex>,
    )`
...
#### `test_convert_and_sort_empty_events()`


#### `test_convert_and_sort_filters_non_pool_events(
        test_instrument_id: InstrumentId,
        test_chain: Arc<nautilus_model::defi::Chain>,
        test_dex: Arc<Dex>,
    )`
...
#### `test_convert_and_sort_already_sorted(
        test_instrument_id: InstrumentId,
        test_chain: Arc<nautilus_model::defi::Chain>,
        test_dex: Arc<Dex>,
    )`
...
#### `test_convert_and_sort_reverse_order(
        test_instrument_id: InstrumentId,
        test_chain: Arc<nautilus_model::defi::Chain>,
        test_dex: Arc<Dex>,
    )`
...
#### `test_convert_and_sort_mixed_blocks(
        test_instrument_id: InstrumentId,
        test_chain: Arc<nautilus_model::defi::Chain>,
        test_dex: Arc<Dex>,
    )`
...
#### `test_convert_and_sort_mixed_event_types(
        test_instrument_id: InstrumentId,
        test_chain: Arc<nautilus_model::defi::Chain>,
        test_dex: Arc<Dex>,
    )`
