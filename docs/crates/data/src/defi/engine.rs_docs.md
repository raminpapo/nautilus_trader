...
- **Path**: `crates/data/src/defi/engine.rs`
- **Size**: 35,277 bytes
- **Lines**: 966
- **Language**: Rust
...
### Functions
- **`get_event_block_position()`**: Function defined in this file
- **`convert_and_sort_buffered_events()`**: Function defined in this file
- **`subscribed_blocks()`**: Function defined in this file
- **`subscribed_pools()`**: Function defined in this file
- **`subscribed_pool_swaps()`**: Function defined in this file
- **`subscribed_pool_liquidity_updates()`**: Function defined in this file
- **`subscribed_pool_fee_collects()`**: Function defined in this file
- **`subscribed_pool_flash()`**: Function defined in this file
- **`execute_defi_subscribe()`**: Function defined in this file
- **`execute_defi_unsubscribe()`**: Function defined in this file
- **`execute_defi_request()`**: Function defined in this file
- **`process_defi_data()`**: Function defined in this file
- **`subscribe_pool_updater_topics()`**: Function defined in this file
- **`apply_buffered_events_to_profiler()`**: Function defined in this file
- **`setup_pool_updater()`**: Function defined in this file
- **`test_instrument_id()`**: Function defined in this file
- **`test_chain()`**: Function defined in this file
- **`test_dex()`**: Function defined in this file
- **`create_test_swap()`**: Function defined in this file
- **`create_test_liquidity_update()`**: Function defined in this file
...
**Functions**: `apply_buffered_events_to_profiler`, `convert_and_sort_buffered_events`, `create_test_fee_collect`, `create_test_flash`, `create_test_liquidity_update`, `create_test_swap`, `execute_defi_request`, `execute_defi_subscribe`, `execute_defi_unsubscribe`, `get_event_block_position`, `process_defi_data`, `setup_pool_updater`, `subscribe_pool_updater_topics`, `subscribed_blocks`, `subscribed_pool_fee_collects`, `subscribed_pool_flash`, `subscribed_pool_liquidity_updates`, `subscribed_pool_swaps`, `subscribed_pools`, `test_chain`, `test_convert_and_sort_already_sorted`, `test_convert_and_sort_empty_events`, `test_convert_and_sort_filters_non_pool_events`, `test_convert_and_sort_mixed_blocks`, `test_convert_and_sort_mixed_event_types`, `test_convert_and_sort_reverse_order`, `test_convert_and_sort_same_block_and_tx_different_log_index`, `test_convert_and_sort_single_event`, `test_dex`, `test_get_event_block_position_fee_collect` *(+4 more)*
**Impls**: `DataEngine`

## Related Files

This file is located in `crates/data/src/defi/`. Related files may include:
...
---
*Generated on 2025-11-18T21:55:01.512659Z*
