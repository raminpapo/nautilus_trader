...
- **`subscribe_pool()`**: Function defined in this file
- **`subscribe_pool_swaps()`**: Function defined in this file
- **`subscribe_pool_liquidity_updates()`**: Function defined in this file
- **`subscribe_pool_fee_collects()`**: Function defined in this file
- **`subscribe_pool_flash_events()`**: Function defined in this file
- **`unsubscribe_pool()`**: Function defined in this file
- **`unsubscribe_pool_swaps()`**: Function defined in this file
- **`unsubscribe_pool_liquidity_updates()`**: Function defined in this file
- **`unsubscribe_pool_fee_collects()`**: Function defined in this file
- **`unsubscribe_pool_flash_events()`**: Function defined in this file
- **`request_pool_snapshot()`**: Function defined in this file
- **`log_command_error()`**: Function defined in this file
...
**Functions**: `execute_defi_request`, `execute_defi_subscribe`, `execute_defi_unsubscribe`, `log_command_error`, `request_pool_snapshot`, `subscribe_blocks`, `subscribe_pool`, `subscribe_pool_fee_collects`, `subscribe_pool_flash_events`, `subscribe_pool_liquidity_updates`, `subscribe_pool_swaps`, `unsubscribe_blocks`, `unsubscribe_pool`, `unsubscribe_pool_fee_collects`, `unsubscribe_pool_flash_events`, `unsubscribe_pool_liquidity_updates`, `unsubscribe_pool_swaps`
**Impls**: `DataClientAdapter`
...
---
*Generated on 2025-11-18T21:55:01.505793Z*
