...
This file is part of the NautilusTrader repository. It defines 103 function(s) and 1 class(es).
...
*...and 83 more functions*

### Classes
- **`DataClientAdapter`**: Class defined in this file
...
**Functions**: `client_id`, `connect`, `deref`, `deref_mut`, `disconnect`, `dispose`, `execute_subscribe`, `execute_unsubscribe`, `fmt`, `get_client`, `is_connected`, `is_disconnected`, `log_command_error`, `log_not_implemented`, `new`, `request_bars`, `request_book_depth`, `request_book_snapshot`, `request_data`, `request_instrument`, `request_instruments`, `request_pool_snapshot`, `request_quotes`, `request_trades`, `reset`, `start`, `stop`, `subscribe`, `subscribe_bars`, `subscribe_blocks` *(+38 more)*
**Impls**: `DataClientAdapter`, `Debug`, `Deref`, `DerefMut`, `blocks`
**Structs**: `DataClientAdapter`
**Traits**: `DataClient`
...
---
*Generated on 2025-11-18T21:55:01.502376Z*
