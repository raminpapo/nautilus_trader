# Documentation: `crates/data/src/client.rs`
**Generated:** 2025-11-15T19:40:01.980971Z
**File Size:** 46433 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/data/src/client.rs` within the repository.

**Classes defined:** DataClientAdapter, blocks, Deref, DerefMut, Debug, DataClientAdapter

**Functions defined:** client_id, venue, start, stop, reset, dispose, connect, disconnect, is_connected, is_disconnected and 93 more
...
#### `subscribe(&mut self, cmd: &SubscribeCustomData)`


#### `subscribe_instruments(&mut self, cmd: &SubscribeInstruments)`
...
#### `subscribe_instrument_close(&mut self, cmd: &SubscribeInstrumentClose)`
...
#### `unsubscribe(&mut self, cmd: &UnsubscribeCustomData)`


#### `unsubscribe_instruments(&mut self, cmd: &UnsubscribeInstruments)`


#### `unsubscribe_instrument(&mut self, cmd: &UnsubscribeInstrument)`
