# Documentation: `crates/data/src/engine/mod.rs`
**Generated:** 2025-11-15T19:40:01.999993Z
**File Size:** 53369 bytes
**Extension:** .rs
**Type:** text
...
- **Path:** `crates/data/src/engine/mod.rs`
- **Size:** 53,369 bytes
- **Lines:** 1,411
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/data/src/engine/mod.rs` within the repository.

**Classes defined:** DataEngine, blocks, DataEngine

**Functions defined:** new, get_clock, get_cache, cache_rc, register_catalog, register_client, deregister_client, register_default_client, start, stop and 61 more
...
#### `register_catalog(&mut self, catalog: ParquetDataCatalog, name: Option<String>)`


#### `register_client(&mut self, client: DataClientAdapter, routing: Option<Venue>)`


#### `deregister_client(&mut self, client_id: &ClientId)`


#### `register_default_client(&mut self, client: DataClientAdapter)`
...
#### `collect_subscriptions(&self, get_subs: F)`


#### `get_clients(&self)`


#### `get_clients_mut(&mut self)`
...
#### `subscribed_book_deltas(&self)`


#### `subscribed_book_snapshots(&self)`
...
#### `subscribed_mark_prices(&self)`


#### `subscribed_index_prices(&self)`


#### `subscribed_funding_rates(&self)`
...
#### `execute(&mut self, cmd: &DataCommand)`


#### `execute_subscribe(&mut self, cmd: &SubscribeCommand)`


#### `execute_unsubscribe(&mut self, cmd: &UnsubscribeCommand)`


#### `execute_request(&mut self, req: &RequestCommand)`


#### `process(&mut self, data: &dyn Any)`


#### `process_data(&mut self, data: Data)`


#### `response(&self, resp: DataResponse)`
...
#### `handle_depth10(&mut self, depth: OrderBookDepth10)`
...
#### `handle_instrument_close(&mut self, close: InstrumentClose)`
