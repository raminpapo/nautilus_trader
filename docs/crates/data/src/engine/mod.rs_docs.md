...
This file is part of the NautilusTrader repository. It defines 71 function(s) and 1 class(es).
...
- **`get_cache()`**: Function defined in this file
- **`cache_rc()`**: Function defined in this file
- **`register_catalog()`**: Function defined in this file
...
- **`registered_clients()`**: Function defined in this file
- **`collect_subscriptions()`**: Function defined in this file
- **`get_clients()`**: Function defined in this file
- **`get_clients_mut()`**: Function defined in this file
- **`get_client()`**: Function defined in this file
- **`get_default_client()`**: Function defined in this file

*...and 51 more functions*

### Classes
- **`DataEngine`**: Class defined in this file
...
**Enums**: `instance`
**Functions**: `cache_rc`, `check_connected`, `check_disconnected`, `collect_subscriptions`, `create_bar_aggregator`, `deregister_client`, `dispose`, `execute`, `execute_request`, `execute_subscribe`, `execute_unsubscribe`, `get_cache`, `get_client`, `get_clients`, `get_clients_mut`, `get_clock`, `get_default_client`, `handle_bar`, `handle_bars`, `handle_delta`, `handle_deltas`, `handle_depth10`, `handle_funding_rate`, `handle_index_price`, `handle_instrument`, `handle_instrument_close`, `handle_instrument_response`, `handle_instruments`, `handle_mark_price`, `handle_quote` *(+41 more)*
**Impls**: `DataEngine`, `blocks`
**Structs**: `DataEngine`
...
---
*Generated on 2025-11-18T21:55:01.533067Z*
