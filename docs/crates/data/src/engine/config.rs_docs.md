# Documentation: `crates/data/src/engine/config.rs`
**Generated:** 2025-11-15T19:40:01.993205Z
...
- **Path:** `crates/data/src/engine/config.rs`
- **Size:** 3,870 bytes
- **Lines:** 92
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/data/src/engine/config.rs` within the repository.

**Classes defined:** DataEngineConfig, DataEngineConfig, Default

**Functions defined:** new, default
