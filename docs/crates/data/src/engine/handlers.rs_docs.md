# Documentation: `crates/data/src/engine/handlers.rs`
**Generated:** 2025-11-15T19:40:01.994797Z
...
This file is located at `crates/data/src/engine/handlers.rs` within the repository.

**Classes defined:** BarQuoteHandler, BarTradeHandler, BarBarHandler, BarQuoteHandler, MessageHandler, BarTradeHandler, MessageHandler, BarBarHandler, MessageHandler

**Functions defined:** new, id, handle, as_any, new, id, handle, as_any, new, id and 2 more
...
#### `new(aggregator: Rc<RefCell<Box<dyn BarAggregator>>>, bar_type: BarType)`
