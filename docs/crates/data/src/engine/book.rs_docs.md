# Documentation: `crates/data/src/engine/book.rs`
**Generated:** 2025-11-15T19:40:01.991655Z
...
This file is located at `crates/data/src/engine/book.rs` within the repository.

**Classes defined:** BookSnapshotInfo, BookUpdater, BookSnapshotter, BookUpdater, MessageHandler, BookSnapshotter

**Functions defined:** new, id, handle, as_any, new, snapshot, publish_order_book
...
#### `new(snap_info: BookSnapshotInfo, cache: Rc<RefCell<Cache>>)`


#### `snapshot(&self, _event: TimeEvent)`
