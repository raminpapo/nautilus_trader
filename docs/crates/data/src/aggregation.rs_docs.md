# Documentation: aggregation.rs

## File Metadata

- **Path**: `crates/data/src/aggregation.rs`
- **Size**: 96,154 bytes
- **Lines**: 2,648
- **Language**: Rust
...
This file is part of the NautilusTrader repository. It defines 113 function(s) and 8 class(es).

## Detailed Walkthrough

### Functions
- **`bar_type()`**: Function defined in this file
- **`is_running()`**: Function defined in this file
- **`set_is_running()`**: Function defined in this file
...
- **`update_bar()`**: Function defined in this file
- **`stop()`**: Function defined in this file
- **`set_historical_mode()`**: Function defined in this file
- **`set_historical_events()`**: Function defined in this file
- **`set_clock()`**: Function defined in this file
- **`build_bar()`**: Function defined in this file
- **`start_timer()`**: Function defined in this file
- **`set_aggregator_weak()`**: Function defined in this file
...
### Classes
- **`BarBuilder`**: Class defined in this file
- **`BarAggregatorCore`**: Class defined in this file
- **`TickBarAggregator`**: Class defined in this file
- **`VolumeBarAggregator`**: Class defined in this file
- **`ValueBarAggregator`**: Class defined in this file
- **`RenkoBarAggregator`**: Class defined in this file
- **`TimeBarAggregator`**: Class defined in this file
...
**Functions**: `apply_update`, `as_any`, `as_any_mut`, `bar_type`, `build`, `build_and_send`, `build_bar`, `build_now`, `build_now_and_send`, `fmt`, `get_cumulative_value`, `handle_bar`, `handle_quote`, `handle_trade`, `is_running`, `new`, `postprocess_historical_events`, `preprocess_historical_events`, `reset`, `set_aggregator_weak`, `set_clock`, `set_clock_internal`, `set_historical_events`, `set_historical_events_internal`, `set_historical_mode`, `set_is_running`, `start_timer`, `start_timer_internal`, `stop`, `test_bar_builder_build_when_no_updates_panics` *(+34 more)*
**Impls**: `BarAggregator`, `BarAggregatorCore`, `BarBuilder`, `Debug`, `RenkoBarAggregator`, `TickBarAggregator`, `TimeBarAggregator`, `ValueBarAggregator`, `VolumeBarAggregator`, `dyn`
**Structs**: `BarAggregatorCore`, `BarBuilder`, `RenkoBarAggregator`, `TickBarAggregator`, `TimeBarAggregator`, `ValueBarAggregator`, `VolumeBarAggregator`, `name`
**Traits**: `BarAggregator`, `and`, `method`

## Related Files

This file is located in `crates/data/src/`. Related files may include:
...
---
*Generated on 2025-11-18T21:55:01.490211Z*
