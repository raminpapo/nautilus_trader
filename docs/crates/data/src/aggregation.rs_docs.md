# Documentation: `crates/data/src/aggregation.rs`
**Generated:** 2025-11-15T19:40:01.973954Z
**File Size:** 96154 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/data/src/aggregation.rs` within the repository.

**Classes defined:** BarBuilder, BarAggregatorCore, TickBarAggregator, VolumeBarAggregator, ValueBarAggregator, RenkoBarAggregator, TimeBarAggregator, name, dyn, BarBuilder and 17 more

**Functions defined:** bar_type, is_running, set_is_running, update, handle_quote, handle_trade, handle_bar, update_bar, stop, set_historical_mode and 103 more
...
#### `set_is_running(&mut self, value: bool)`


#### `update(&mut self, price: Price, size: Quantity, ts_init: UnixNanos)`
...
#### `update_bar(&mut self, bar: Bar, volume: Quantity, ts_init: UnixNanos)`


#### `stop(&mut self)`


#### `set_historical_mode(&mut self, _historical_mode: bool, _handler: Box<dyn FnMut(Bar)`


#### `set_historical_events(&mut self, _events: Vec<TimeEvent>)`


#### `set_clock(&mut self, _clock: Rc<RefCell<dyn Clock>>)`


#### `build_bar(&mut self, _event: TimeEvent)`


#### `start_timer(&mut self, _aggregator_rc: Option<Rc<RefCell<Box<dyn BarAggregator>>>>)`


#### `set_aggregator_weak(&mut self, _weak: Weak<RefCell<Box<dyn BarAggregator>>>)`
...
#### `new(bar_type: BarType, price_precision: u8, size_precision: u8)`
...
#### `build(&mut self, ts_event: UnixNanos, ts_init: UnixNanos)`
...
#### `apply_update(&mut self, price: Price, size: Quantity, ts_init: UnixNanos)`


#### `build_now_and_send(&mut self)`


#### `build_and_send(&mut self, ts_event: UnixNanos, ts_init: UnixNanos)`
