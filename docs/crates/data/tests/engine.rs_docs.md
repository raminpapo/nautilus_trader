...
- **Path**: `crates/data/tests/engine.rs`
- **Size**: 100,737 bytes
- **Lines**: 3,474
- **Language**: Rust
...
This file is part of the NautilusTrader repository. It defines 61 function(s).
...
- **`stub_msgbus()`**: Function defined in this file
- **`data_engine()`**: Function defined in this file
- **`data_client()`**: Function defined in this file
- **`register_mock_client()`**: Function defined in this file
- **`test_register_default_client_twice_panics()`**: Function defined in this file
- **`test_register_client_duplicate_id_panics()`**: Function defined in this file
- **`test_register_and_deregister_client()`**: Function defined in this file
- **`test_register_default_client()`**: Function defined in this file
- **`test_execute_subscribe_custom_data()`**: Function defined in this file
- **`test_execute_subscribe_book_deltas()`**: Function defined in this file
- **`test_execute_subscribe_book_snapshots()`**: Function defined in this file
- **`test_execute_subscribe_instrument()`**: Function defined in this file
- **`test_execute_subscribe_quotes()`**: Function defined in this file
- **`test_execute_subscribe_trades()`**: Function defined in this file
- **`test_execute_subscribe_bars()`**: Function defined in this file
- **`test_execute_subscribe_mark_prices()`**: Function defined in this file
...
**Functions**: `cache`, `client_id`, `clock`, `data_client`, `data_engine`, `register_mock_client`, `stub_msgbus`, `test_execute_defi_request_pool_snapshot`, `test_execute_request_bars`, `test_execute_request_book_snapshot`, `test_execute_request_data`, `test_execute_request_instrument`, `test_execute_request_instruments`, `test_execute_request_order_book_depth`, `test_execute_request_quotes`, `test_execute_request_trades`, `test_execute_subscribe_bars`, `test_execute_subscribe_blocks`, `test_execute_subscribe_book_deltas`, `test_execute_subscribe_book_snapshots`, `test_execute_subscribe_custom_data`, `test_execute_subscribe_funding_rates`, `test_execute_subscribe_index_prices`, `test_execute_subscribe_instrument`, `test_execute_subscribe_mark_prices`, `test_execute_subscribe_pool_fee_collects`, `test_execute_subscribe_pool_flash_events`, `test_execute_subscribe_pool_liquidity_updates`, `test_execute_subscribe_pool_swaps`, `test_execute_subscribe_quotes` *(+31 more)*
...
```bash
# For Python
pytest crates/data/tests/engine.rs
...
---
*Generated on 2025-11-18T21:55:01.566953Z*
