...
- **Path**: `crates/data/tests/client.rs`
- **Size**: 59,376 bytes
- **Lines**: 1,972
- **Language**: Rust
...
- **`test_custom_data_subscription()`**: Function defined in this file
- **`test_instrument_subscription()`**: Function defined in this file
- **`test_instruments_subscription()`**: Function defined in this file
- **`test_book_deltas_subscription()`**: Function defined in this file
- **`test_book_depth10_subscription()`**: Function defined in this file
- **`test_book_snapshots_subscription()`**: Function defined in this file
- **`test_quote_subscription()`**: Function defined in this file
- **`test_trades_subscription()`**: Function defined in this file
- **`test_mark_price_subscription()`**: Function defined in this file
- **`test_index_price_subscription()`**: Function defined in this file
- **`test_funding_rate_subscription()`**: Function defined in this file
- **`test_bars_subscription()`**: Function defined in this file
- **`test_instrument_status_subscription()`**: Function defined in this file
- **`test_instrument_close_subscription()`**: Function defined in this file
- **`test_custom_data_unsubscribe_noop()`**: Function defined in this file
- **`test_custom_data_unsubscribe_idempotent()`**: Function defined in this file
...
**Functions**: `cache`, `client_id`, `clock`, `test_bars_subscription`, `test_bars_unsubscribe_idempotent`, `test_bars_unsubscribe_noop`, `test_book_deltas_subscription`, `test_book_deltas_unsubscribe_idempotent`, `test_book_deltas_unsubscribe_noop`, `test_book_depth10_subscription`, `test_book_depth10_unsubscribe_idempotent`, `test_book_depth10_unsubscribe_noop`, `test_book_snapshots_subscription`, `test_book_snapshots_unsubscribe_idempotent`, `test_book_snapshots_unsubscribe_noop`, `test_custom_data_subscription`, `test_custom_data_unsubscribe_idempotent`, `test_custom_data_unsubscribe_noop`, `test_defi_blocks_subscription`, `test_defi_blocks_unsubscribe_idempotent`, `test_defi_blocks_unsubscribe_noop`, `test_defi_pool_swaps_subscription`, `test_defi_pool_swaps_unsubscribe_idempotent`, `test_defi_pool_swaps_unsubscribe_noop`, `test_funding_rate_subscription`, `test_funding_rates_unsubscribe_idempotent`, `test_funding_rates_unsubscribe_noop`, `test_index_price_subscription`, `test_index_prices_unsubscribe_idempotent`, `test_index_prices_unsubscribe_noop` *(+30 more)*

## Related Files

This file is located in `crates/data/tests/`. Related files may include:
...
```bash
# For Python
pytest crates/data/tests/client.rs
...
---
*Generated on 2025-11-18T21:55:01.546678Z*
