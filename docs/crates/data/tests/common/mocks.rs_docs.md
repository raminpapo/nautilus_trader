# Documentation: `crates/data/tests/common/mocks.rs`
**Generated:** 2025-11-15T19:40:02.012725Z
...
This file is located at `crates/data/tests/common/mocks.rs` within the repository.

**Classes defined:** MockDataClient, MockDataClient, DataClient, Send, Sync

**Functions defined:** new, new_with_recorder, client_id, venue, start, stop, reset, dispose, connect, disconnect and 51 more
...
**Directory:** `crates/data/tests/common`
