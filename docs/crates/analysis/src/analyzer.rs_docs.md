...
This file is part of the NautilusTrader repository. It defines 60 function(s) and 3 class(es).
...
- **`register_statistic()`**: Function defined in this file
- **`deregister_statistic()`**: Function defined in this file
- **`deregister_statistics()`**: Function defined in this file
- **`reset()`**: Function defined in this file
- **`currencies()`**: Function defined in this file
- **`statistic()`**: Function defined in this file
- **`returns()`**: Function defined in this file
- **`calculate_statistics()`**: Function defined in this file
- **`add_positions()`**: Function defined in this file
- **`add_trade()`**: Function defined in this file
- **`add_return()`**: Function defined in this file
- **`realized_pnls()`**: Function defined in this file
- **`total_pnl()`**: Function defined in this file
- **`total_pnl_percentage()`**: Function defined in this file
- **`get_performance_stats_pnls()`**: Function defined in this file
- **`get_performance_stats_returns()`**: Function defined in this file
- **`get_performance_stats_general()`**: Function defined in this file
- **`get_max_length_name()`**: Function defined in this file

*...and 40 more functions*

### Classes
- **`PortfolioAnalyzer`**: Class defined in this file
- **`MockStatistic`**: Class defined in this file
- **`MockAccount`**: Class defined in this file
...
**Functions**: `account_type`, `add_positions`, `add_return`, `add_trade`, `apply`, `balance`, `balance_free`, `balance_locked`, `balance_total`, `balances`, `balances_free`, `balances_locked`, `balances_total`, `base_currency`, `calculate_balance_locked`, `calculate_commission`, `calculate_from_positions`, `calculate_from_realized_pnls`, `calculate_from_returns`, `calculate_pnls`, `calculate_statistics`, `calculated_account_state`, `create_mock_position`, `currencies`, `default`, `deregister_statistic`, `deregister_statistics`, `event_count`, `events`, `get_max_length_name` *(+28 more)*
**Impls**: `Account`, `Default`, `MockStatistic`, `PortfolioAnalyzer`, `PortfolioStatistic`
**Structs**: `MockAccount`, `MockStatistic`, `PortfolioAnalyzer`
...
---
*Generated on 2025-11-18T21:55:00.780356Z*
