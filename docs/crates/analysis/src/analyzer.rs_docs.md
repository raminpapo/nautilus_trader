# Documentation: `crates/analysis/src/analyzer.rs`
**Generated:** 2025-11-15T19:40:01.519549Z
**File Size:** 29134 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/analysis/src/analyzer.rs` within the repository.

**Classes defined:** PortfolioAnalyzer, MockStatistic, MockAccount, Default, PortfolioAnalyzer, MockStatistic, PortfolioStatistic, Account

**Functions defined:** default, new, register_statistic, deregister_statistic, deregister_statistics, reset, currencies, statistic, returns, calculate_statistics and 50 more
...
#### `register_statistic(&mut self, statistic: Statistic)`


#### `deregister_statistic(&mut self, statistic: Statistic)`


#### `deregister_statistics(&mut self)`
...
#### `statistic(&self, name: &str)`


#### `returns(&self)`


#### `calculate_statistics(&mut self, account: &dyn Account, positions: &[Position])`


#### `add_positions(&mut self, positions: &[Position])`


#### `add_trade(&mut self, position_id: &PositionId, pnl: &Money)`


#### `add_return(&mut self, timestamp: UnixNanos, value: f64)`


#### `realized_pnls(&self, currency: Option<&Currency>)`
...
#### `get_stats_returns_formatted(&self)`


#### `get_stats_general_formatted(&self)`
...
#### `calculate_from_realized_pnls(&self, pnls: &[f64])`
...
#### `balance_total(&self, _: Option<Currency>)`


#### `balance_free(&self, _: Option<Currency>)`


#### `balances_free(&self)`


#### `balance_locked(&self, _: Option<Currency>)`
