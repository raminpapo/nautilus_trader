# Documentation: `crates/analysis/src/python/statistics/winner_max.rs`
**Generated:** 2025-11-15T19:40:01.548474Z
...
- **Path:** `crates/analysis/src/python/statistics/winner_max.rs`
- **Size:** 1,993 bytes
- **Lines:** 56
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/analysis/src/python/statistics/winner_max.rs` within the repository.

**Classes defined:** MaxWinner
...
#### `py_calculate_from_returns(&mut self, returns: BTreeMap<u64, f64>)`
