...
- **Path**: `crates/analysis/src/python/analyzer.rs`
- **Size**: 13,303 bytes
- **Lines**: 358
- **Language**: Rust
...
- **`py_currencies()`**: Function defined in this file
- **`py_get_performance_stats_returns()`**: Function defined in this file
- **`py_get_performance_stats_pnls()`**: Function defined in this file
- **`py_get_performance_stats_general()`**: Function defined in this file
- **`py_add_return()`**: Function defined in this file
- **`py_reset()`**: Function defined in this file
- **`py_register_statistic()`**: Function defined in this file
- **`py_deregister_statistic()`**: Function defined in this file
- **`py_deregister_statistics()`**: Function defined in this file
- **`py_add_positions()`**: Function defined in this file
- **`py_add_trade()`**: Function defined in this file
- **`py_statistic()`**: Function defined in this file
- **`py_returns()`**: Function defined in this file
- **`py_realized_pnls()`**: Function defined in this file
- **`py_total_pnl()`**: Function defined in this file
- **`py_total_pnl_percentage()`**: Function defined in this file
- **`py_get_stats_pnls_formatted()`**: Function defined in this file
- **`py_get_stats_returns_formatted()`**: Function defined in this file
...
**Functions**: `__repr__`, `py_add_positions`, `py_add_return`, `py_add_trade`, `py_currencies`, `py_deregister_statistic`, `py_deregister_statistics`, `py_get_performance_stats_general`, `py_get_performance_stats_pnls`, `py_get_performance_stats_returns`, `py_get_stats_general_formatted`, `py_get_stats_pnls_formatted`, `py_get_stats_returns_formatted`, `py_new`, `py_realized_pnls`, `py_register_statistic`, `py_reset`, `py_returns`, `py_statistic`, `py_total_pnl`, `py_total_pnl_percentage`
**Impls**: `PortfolioAnalyzer`
...
---
*Generated on 2025-11-18T21:55:00.785604Z*
