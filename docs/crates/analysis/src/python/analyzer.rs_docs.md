# Documentation: `crates/analysis/src/python/analyzer.rs`
**Generated:** 2025-11-15T19:40:01.523252Z
**File Size:** 13303 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/analysis/src/python/analyzer.rs` within the repository.

**Classes defined:** PortfolioAnalyzer

**Functions defined:** py_new, __repr__, py_currencies, py_get_performance_stats_returns, py_get_performance_stats_pnls, py_get_performance_stats_general, py_add_return, py_reset, py_register_statistic, py_deregister_statistic and 11 more
...
#### `py_get_performance_stats_returns(&self)`


#### `py_get_performance_stats_pnls(
        &self,
        currency: Option<&Currency>,
        unrealized_pnl: Option<&Money>,
    )`
...
#### `py_get_performance_stats_general(&self)`


#### `py_add_return(&mut self, timestamp: u64, value: f64)`


#### `py_reset(&mut self)`


#### `py_register_statistic(&mut self, py: Python, statistic: Py<PyAny>)`


#### `py_deregister_statistic(&mut self, py: Python, statistic: Py<PyAny>)`


#### `py_deregister_statistics(&mut self)`


#### `py_add_positions(&mut self, py: Python, positions: Vec<Py<PyAny>>)`


#### `py_add_trade(&mut self, position_id: &PositionId, realized_pnl: &Money)`


#### `py_statistic(&self, name: &str)`


#### `py_returns(&self, py: Python)`


#### `py_realized_pnls(&self, py: Python, currency: Option<&Currency>)`
...
#### `py_get_stats_returns_formatted(&self)`


#### `py_get_stats_general_formatted(&self)`
