# Documentation: `crates/analysis/src/statistic.rs`
**Generated:** 2025-11-15T19:40:01.551074Z
**File Size:** 4236 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/analysis/src/statistic.rs` within the repository.

**Functions defined:** name, calculate_from_returns, calculate_from_realized_pnls, calculate_from_orders, calculate_from_positions, check_valid_returns, downsample_to_daily_bins, calculate_std
...
#### `calculate_from_orders(&self, orders: Vec<Box<dyn Order>>)`


#### `calculate_from_positions(&self, positions: &[Position])`


#### `check_valid_returns(&self, returns: &Returns)`


#### `downsample_to_daily_bins(&self, returns: &Returns)`


#### `calculate_std(&self, returns: &Returns)`
