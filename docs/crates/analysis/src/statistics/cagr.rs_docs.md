# Documentation: `crates/analysis/src/statistics/cagr.rs`
**Generated:** 2025-11-15T19:40:01.553085Z
**File Size:** 7321 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/analysis/src/statistics/cagr.rs` within the repository.

**Classes defined:** CAGR, CAGR, PortfolioStatistic

**Functions defined:** new, name, calculate_from_returns, create_returns, test_name, test_empty_returns, test_positive_cagr, test_cagr_half_year, test_negative_returns, test_multiple_trades_per_day and 1 more
