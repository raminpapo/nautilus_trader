# Documentation: cagr.rs

## File Metadata

- **Path**: `crates/analysis/src/statistics/cagr.rs`
- **Size**: 7,315 bytes
- **Lines**: 211
- **Language**: Rust
...
- **`test_positive_cagr()`**: Function defined in this file
- **`test_cagr_half_year()`**: Function defined in this file
- **`test_negative_returns()`**: Function defined in this file
- **`test_multiple_trades_per_day()`**: Function defined in this file
- **`test_intraday_trading()`**: Function defined in this file

### Classes
- **`CAGR`**: Class defined in this file
...
**Functions**: `calculate_from_returns`, `create_returns`, `name`, `new`, `test_cagr_half_year`, `test_empty_returns`, `test_intraday_trading`, `test_multiple_trades_per_day`, `test_name`, `test_negative_returns`, `test_positive_cagr`
**Impls**: `CAGR`, `PortfolioStatistic`
**Structs**: `CAGR`
...
---
*Generated on 2025-11-18T21:55:00.833109Z*
