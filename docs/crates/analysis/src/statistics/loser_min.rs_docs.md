...
- **`test_single_negative()`**: Function defined in this file
- **`test_name()`**: Function defined in this file

### Classes
- **`MinLoser`**: Class defined in this file
...
**Functions**: `calculate_from_positions`, `calculate_from_realized_pnls`, `calculate_from_returns`, `fmt`, `name`, `test_all_negative`, `test_all_positive`, `test_empty_pnls`, `test_mixed_pnls`, `test_name`, `test_single_negative`, `test_with_zero`
...
---
*Generated on 2025-11-18T21:55:00.849728Z*
