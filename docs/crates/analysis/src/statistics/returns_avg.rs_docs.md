...
- **`test_all_zero()`**: Function defined in this file
- **`test_mixed_non_zero()`**: Function defined in this file
- **`test_name()`**: Function defined in this file

### Classes
- **`ReturnsAverage`**: Class defined in this file
...
**Functions**: `calculate_from_positions`, `calculate_from_realized_pnls`, `calculate_from_returns`, `create_returns`, `fmt`, `name`, `test_all_zero`, `test_empty_returns`, `test_mixed_non_zero`, `test_name`
**Impls**: `Display`, `PortfolioStatistic`
**Structs**: `ReturnsAverage`
...
---
*Generated on 2025-11-18T21:55:00.858850Z*
