# Documentation: `crates/analysis/src/statistics/returns_avg_win.rs`
**Generated:** 2025-11-15T19:40:01.571267Z
**File Size:** 4297 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/analysis/src/statistics/returns_avg_win.rs` within the repository.

**Classes defined:** ReturnsAverageWin, Display, PortfolioStatistic

**Functions defined:** fmt, name, calculate_from_returns, calculate_from_realized_pnls, calculate_from_positions, create_returns, test_empty_returns, test_all_negative, test_all_positive, test_mixed_returns and 1 more
