# Documentation: risk_return_ratio.rs
...
- **`test_valid_risk_return_ratio()`**: Function defined in this file
- **`test_name()`**: Function defined in this file

### Classes
- **`RiskReturnRatio`**: Class defined in this file
...
**Functions**: `calculate_from_positions`, `calculate_from_realized_pnls`, `calculate_from_returns`, `create_returns`, `fmt`, `name`, `test_empty_returns`, `test_name`, `test_valid_risk_return_ratio`, `test_zero_std_dev`
**Impls**: `Display`, `PortfolioStatistic`
**Structs**: `RiskReturnRatio`
...
---
*Generated on 2025-11-18T21:55:00.867429Z*
