# Documentation: expectancy.rs

## File Metadata

- **Path**: `crates/analysis/src/statistics/expectancy.rs`
- **Size**: 5,748 bytes
- **Lines**: 165
- **Language**: Rust
...
- **`test_empty_pnl_list()`**: Function defined in this file
- **`test_all_winners()`**: Function defined in this file
- **`test_all_losers()`**: Function defined in this file
- **`test_mixed_pnls()`**: Function defined in this file
- **`test_single_trade()`**: Function defined in this file
- **`test_name()`**: Function defined in this file

### Classes
- **`Expectancy`**: Class defined in this file
...
**Functions**: `calculate_from_positions`, `calculate_from_realized_pnls`, `calculate_from_returns`, `fmt`, `name`, `test_all_losers`, `test_all_winners`, `test_empty_pnl_list`, `test_mixed_pnls`, `test_name`, `test_single_trade`
...
---
*Generated on 2025-11-18T21:55:00.839275Z*
