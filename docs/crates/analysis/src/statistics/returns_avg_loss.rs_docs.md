# Documentation: returns_avg_loss.rs
...
### Classes
- **`ReturnsAverageLoss`**: Class defined in this file
...
**Functions**: `calculate_from_positions`, `calculate_from_realized_pnls`, `calculate_from_returns`, `create_returns`, `fmt`, `name`, `test_all_negative`, `test_all_positive`, `test_empty_returns`, `test_mixed_returns`, `test_name`, `test_with_zero`
**Impls**: `Display`, `PortfolioStatistic`
**Structs**: `ReturnsAverageLoss`
...
---
*Generated on 2025-11-18T21:55:00.860900Z*
