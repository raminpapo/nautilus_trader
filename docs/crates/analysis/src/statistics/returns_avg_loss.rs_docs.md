# Documentation: `crates/analysis/src/statistics/returns_avg_loss.rs`
**Generated:** 2025-11-15T19:40:01.569918Z
...
- **Path:** `crates/analysis/src/statistics/returns_avg_loss.rs`
- **Size:** 4,730 bytes
- **Lines:** 143
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/analysis/src/statistics/returns_avg_loss.rs` within the repository.

**Classes defined:** ReturnsAverageLoss, Display, PortfolioStatistic

**Functions defined:** fmt, name, calculate_from_returns, calculate_from_realized_pnls, calculate_from_positions, create_returns, test_empty_returns, test_all_positive, test_all_negative, test_mixed_returns and 2 more
