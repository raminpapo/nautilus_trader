# Documentation: calmar_ratio.rs

## File Metadata

- **Path**: `crates/analysis/src/statistics/calmar_ratio.rs`
- **Size**: 5,672 bytes
- **Lines**: 175
- **Language**: Rust
...
- **`test_no_drawdown()`**: Function defined in this file
- **`test_positive_ratio()`**: Function defined in this file
- **`test_high_calmar_better()`**: Function defined in this file

### Classes
- **`CalmarRatio`**: Class defined in this file
...
**Functions**: `calculate_from_returns`, `create_returns`, `name`, `new`, `test_empty_returns`, `test_high_calmar_better`, `test_name`, `test_no_drawdown`, `test_positive_ratio`
**Impls**: `CalmarRatio`, `PortfolioStatistic`
**Structs**: `CalmarRatio`
...
---
*Generated on 2025-11-18T21:55:00.835687Z*
