# Documentation: `crates/analysis/src/statistics/max_drawdown.rs`
**Generated:** 2025-11-15T19:40:01.564475Z
...
- **Path:** `crates/analysis/src/statistics/max_drawdown.rs`
- **Size:** 5,090 bytes
- **Lines:** 163
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/analysis/src/statistics/max_drawdown.rs` within the repository.

**Classes defined:** MaxDrawdown, MaxDrawdown, PortfolioStatistic

**Functions defined:** new, name, calculate_from_returns, create_returns, test_name, test_empty_returns, test_no_drawdown, test_simple_drawdown, test_multiple_drawdowns, test_initial_loss
...
#### `calculate_from_returns(&self, returns: &BTreeMap<UnixNanos, f64>)`
