...
- **`test_simple_drawdown()`**: Function defined in this file
- **`test_multiple_drawdowns()`**: Function defined in this file
- **`test_initial_loss()`**: Function defined in this file

### Classes
- **`MaxDrawdown`**: Class defined in this file
...
**Functions**: `calculate_from_returns`, `create_returns`, `name`, `new`, `test_empty_returns`, `test_initial_loss`, `test_multiple_drawdowns`, `test_name`, `test_no_drawdown`, `test_simple_drawdown`
**Impls**: `MaxDrawdown`, `PortfolioStatistic`
**Structs**: `MaxDrawdown`
...
---
*Generated on 2025-11-18T21:55:00.852235Z*
