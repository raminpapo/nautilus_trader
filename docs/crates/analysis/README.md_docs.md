...
- **Path**: `crates/analysis/README.md`
- **Size**: 3,137 bytes
- **Lines**: 57
- **Language**: Markdown
...
**Identifiers**: `Agreement`, `All`, `Builds`, `CLA`, `Contributions`, `Contributor`, `Documentation`, `Enables`, `Extensive`, `Feature`, `Flexible`, `For`, `GNU`, `General`, `GitHub`, `Lesser`, `License`, `Ltd`, `Nautech`, `NautilusTrader`, `Platform`, `PnL`, `Portfolio`, `Pty`, `Public`, `PyO3`, `Python`, `Rust`, `See`, `Support` *(+3 more)*
...
---
*Generated on 2025-11-18T21:55:00.774986Z*
