...
- **`determine_machine_id()`**: Function defined in this file
- **`initialize_logging()`**: Function defined in this file
- **`initialize_clock()`**: Function defined in this file
- **`initialize_cache()`**: Function defined in this file
- **`cancel_timers()`**: Function defined in this file
- **`generate_timestamp_ns()`**: Function defined in this file
- **`environment()`**: Function defined in this file
- **`name()`**: Function defined in this file
- **`trader_id()`**: Function defined in this file
- **`machine_id()`**: Function defined in this file
...
- **`ts_shutdown()`**: Function defined in this file
...
### Classes
- **`NautilusKernel`**: Class defined in this file
...
**Functions**: `await_engines_connected`, `await_execution_reconciliation`, `await_portfolio_initialized`, `await_trader_residuals`, `builder`, `cache`, `cancel_all_tasks`, `cancel_timers`, `check_engines_connected`, `check_engines_disconnected`, `check_portfolio_initialized`, `clock`, `connect_clients`, `data_engine`, `determine_machine_id`, `disconnect_clients`, `dispose`, `environment`, `exec_engine`, `flush_writer`, `generate_timestamp_ns`, `initialize_cache`, `initialize_clock`, `initialize_logging`, `initialize_portfolio`, `instance_id`, `load_state`, `machine_id`, `msgbus`, `name` *(+15 more)*
**Impls**: `NautilusKernel`
**Structs**: `NautilusKernel`
...
---
*Generated on 2025-11-18T21:55:04.164145Z*
