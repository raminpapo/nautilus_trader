# Documentation: `crates/system/src/kernel.rs`
**Generated:** 2025-11-15T19:40:03.766649Z
...
This file is located at `crates/system/src/kernel.rs` within the repository.

**Classes defined:** NautilusKernel, NautilusKernel

**Functions defined:** builder, new, determine_machine_id, initialize_logging, initialize_clock, initialize_cache, cancel_timers, generate_timestamp_ns, environment, name and 35 more
...
#### `initialize_clock(environment: &Environment)`


#### `initialize_cache(cache_config: Option<CacheConfig>)`


#### `cancel_timers(&self)`


#### `generate_timestamp_ns(&self)`
...
#### `connect_clients(&mut self)`


#### `disconnect_clients(&mut self)`


#### `stop_clients(&self)`


#### `initialize_portfolio(&self)`


#### `await_engines_connected(&self)`


#### `await_execution_reconciliation(&self)`


#### `await_portfolio_initialized(&self)`


#### `await_trader_residuals(&self)`


#### `check_engines_connected(&self)`


#### `check_engines_disconnected(&self)`


#### `check_portfolio_initialized(&self)`
