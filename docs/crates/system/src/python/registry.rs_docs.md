...
- **Path**: `crates/system/src/python/registry.rs`
- **Size**: 6,074 bytes
- **Lines**: 175
- **Language**: Rust
...
- **`register_factory_extractor()`**: Function defined in this file
- **`register_config_extractor()`**: Function defined in this file
- **`extract_factory()`**: Function defined in this file
- **`extract_config()`**: Function defined in this file
- **`default()`**: Function defined in this file
- **`get_global_pyo3_registry()`**: Function defined in this file

### Classes
- **`FactoryRegistry`**: Class defined in this file
...
**Functions**: `default`, `extract_config`, `extract_factory`, `get_global_pyo3_registry`, `new`, `register_config_extractor`, `register_factory_extractor`
**Impls**: `Default`, `FactoryRegistry`
**Structs**: `FactoryRegistry`
**Traits**: `object`, `objects`

## Related Files

This file is located in `crates/system/src/python/`. Related files may include:
...
---
*Generated on 2025-11-18T21:55:04.169319Z*
