# Documentation: trader.rs

## File Metadata

- **Path**: `crates/system/src/trader.rs`
- **Size**: 33,910 bytes
- **Lines**: 1,027
- **Language**: Rust
...
This file is part of the NautilusTrader repository. It defines 61 function(s) and 3 class(es).
...
- **`state()`**: Function defined in this file
- **`ts_created()`**: Function defined in this file
- **`ts_started()`**: Function defined in this file
- **`ts_stopped()`**: Function defined in this file
- **`actor_count()`**: Function defined in this file
- **`strategy_count()`**: Function defined in this file
- **`exec_algorithm_count()`**: Function defined in this file
- **`component_count()`**: Function defined in this file
- **`actor_ids()`**: Function defined in this file
- **`strategy_ids()`**: Function defined in this file
- **`exec_algorithm_ids()`**: Function defined in this file
- **`create_component_clock()`**: Function defined in this file
- **`add_actor()`**: Function defined in this file
- **`add_actor_from_factory()`**: Function defined in this file
- **`add_registered_actor()`**: Function defined in this file

*...and 41 more functions*

### Classes
- **`Trader`**: Class defined in this file
- **`TestDataActor`**: Class defined in this file
- **`MockComponent`**: Class defined in this file
...
**Functions**: `actor_count`, `actor_ids`, `add_actor`, `add_actor_from_factory`, `add_actor_id_for_lifecycle`, `add_exec_algorithm`, `add_registered_actor`, `add_strategy`, `component_count`, `component_id`, `create_component_clock`, `create_trader_components`, `deref`, `deref_mut`, `dispose_components`, `environment`, `exec_algorithm_count`, `exec_algorithm_ids`, `fmt`, `initialize`, `instance_id`, `new`, `on_dispose`, `on_reset`, `on_start`, `on_stop`, `register`, `reset_components`, `start_components`, `state` *(+19 more)*
**Impls**: `Component`, `DataActor`, `Debug`, `Deref`, `DerefMut`, `MockComponent`, `TestDataActor`, `Trader`
**Structs**: `MockComponent`, `TestDataActor`, `Trader`
...
---
*Generated on 2025-11-18T21:55:04.175182Z*
