# Documentation: `crates/system/src/trader.rs`
**Generated:** 2025-11-15T19:40:03.775104Z
**File Size:** 33910 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/system/src/trader.rs` within the repository.

**Classes defined:** Trader, TestDataActor, MockComponent, Debug, Trader, Component, TestDataActor, DataActor, Deref, DerefMut and 2 more

**Functions defined:** fmt, new, trader_id, instance_id, environment, state, ts_created, ts_started, ts_stopped, actor_count and 51 more
...
#### `add_actor_id_for_lifecycle(&mut self, actor_id: ActorId)`


#### `add_strategy(&mut self, mut strategy: Box<dyn Component>)`
...
#### `validate_component_registration(&self)`


#### `start_components(&mut self)`


#### `stop_components(&mut self)`


#### `reset_components(&mut self)`


#### `dispose_components(&mut self)`
...
#### `transition_state(&mut self, trigger: ComponentTrigger)`
