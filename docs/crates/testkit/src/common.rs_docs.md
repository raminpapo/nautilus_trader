# Documentation: `crates/testkit/src/common.rs`
**Generated:** 2025-11-15T19:40:03.780549Z
...
This file is located at `crates/testkit/src/common.rs` within the repository.

**Functions defined:** get_test_data_file_path, get_nautilus_test_data_file_path, get_test_data_large_checksums_filepath, ensure_test_data_exists, get_tardis_deribit_book_l2_path, get_tardis_binance_snapshot5_path, get_tardis_binance_snapshot25_path, get_tardis_huobi_quotes_path, get_tardis_bitmex_trades_path
...
#### `get_test_data_file_path(path: &str)`


#### `get_nautilus_test_data_file_path(filename: &str)`
...
#### `get_tardis_deribit_book_l2_path()`


#### `get_tardis_binance_snapshot5_path()`


#### `get_tardis_binance_snapshot25_path()`


#### `get_tardis_huobi_quotes_path()`


#### `get_tardis_bitmex_trades_path()`
