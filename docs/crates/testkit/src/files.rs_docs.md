...
- **Path**: `crates/testkit/src/files.rs`
- **Size**: 24,342 bytes
- **Lines**: 729
- **Language**: Rust
...
- **`execute_with_retry_blocking()`**: Function defined in this file
- **`ensure_file_exists_or_download_http()`**: Function defined in this file
- **`ensure_file_exists_or_download_http_with_timeout()`**: Function defined in this file
- **`ensure_file_exists_or_download_http_with_config()`**: Function defined in this file
- **`download_file()`**: Function defined in this file
- **`calculate_sha256()`**: Function defined in this file
- **`verify_sha256_checksum()`**: Function defined in this file
- **`update_sha256_checksums()`**: Function defined in this file
- **`test_retry_config()`**: Function defined in this file
- **`setup_test_server()`**: Function defined in this file
- **`test_file_already_exists()`**: Function defined in this file
- **`test_download_file_success()`**: Function defined in this file
- **`test_download_file_not_found()`**: Function defined in this file
- **`test_network_error()`**: Function defined in this file
- **`test_retry_then_success_on_500()`**: Function defined in this file
- **`test_retry_then_success_on_429()`**: Function defined in this file
- **`test_no_retry_on_404()`**: Function defined in this file
- **`test_calculate_sha256()`**: Function defined in this file
- **`test_verify_sha256_checksum()`**: Function defined in this file
...
**Enums**: `DownloadError`
**Functions**: `calculate_sha256`, `download_file`, `ensure_file_exists_or_download_http`, `ensure_file_exists_or_download_http_with_config`, `ensure_file_exists_or_download_http_with_timeout`, `execute_with_retry_blocking`, `fmt`, `setup_test_server`, `test_calculate_sha256`, `test_download_file_not_found`, `test_download_file_success`, `test_file_already_exists`, `test_network_error`, `test_no_retry_on_404`, `test_retry_config`, `test_retry_then_success_on_429`, `test_retry_then_success_on_500`, `test_verify_sha256_checksum`, `update_sha256_checksums`, `verify_sha256_checksum`
**Impls**: `Display`, `Fn`, `std`
...
```bash
# For Python
pytest crates/testkit/src/files.rs
...
---
*Generated on 2025-11-18T21:55:04.184002Z*
