# Documentation: `crates/testkit/src/files.rs`
**Generated:** 2025-11-15T19:40:03.783549Z
**File Size:** 24339 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/testkit/src/files.rs` within the repository.

**Classes defined:** Display, std, Fn

**Functions defined:** fmt, execute_with_retry_blocking, ensure_file_exists_or_download_http, ensure_file_exists_or_download_http_with_timeout, ensure_file_exists_or_download_http_with_config, download_file, calculate_sha256, verify_sha256_checksum, update_sha256_checksums, test_retry_config and 10 more
...
#### `calculate_sha256(filepath: &Path)`


#### `verify_sha256_checksum(filepath: &Path, checksums: &Path)`


#### `update_sha256_checksums(
    filepath: &Path,
    checksums_file: &Path,
    new_checksum: &str,
)`
...
#### `test_retry_then_success_on_500()`


#### `test_retry_then_success_on_429()`
