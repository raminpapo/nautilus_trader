# Documentation: `crates/network/src/ratelimiter/mod.rs`
**Generated:** 2025-11-15T19:40:03.237067Z
**File Size:** 16340 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/network/src/ratelimiter/mod.rs` within the repository.

**Classes defined:** InMemoryState, RateLimiter, InMemoryState

**Functions defined:** measure_and_replace_one, measure_and_replace, measure_and_replace, fmt, new_with_quota, advance_clock, add_quota_for_key, check_key, until_key_ready, await_keys_ready and 8 more
...
#### `measure_and_replace_one(&self, mut f: F)`


#### `measure_and_replace(&self, key: &Self::Key, f: F)`
...
#### `new_with_quota(base_quota: Option<Quota>, keyed_quotas: Vec<(K, Quota)`


#### `advance_clock(&self, by: Duration)`


#### `add_quota_for_key(&self, key: K, value: Quota)`


#### `check_key(&self, key: &K)`


#### `until_key_ready(&self, key: &K)`


#### `await_keys_ready(&self, keys: Option<Vec<K>>)`
