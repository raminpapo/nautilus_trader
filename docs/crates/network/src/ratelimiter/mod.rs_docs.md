...
- **Path**: `crates/network/src/ratelimiter/mod.rs`
- **Size**: 16,340 bytes
- **Lines**: 444
- **Language**: Rust
...
### Functions
- **`measure_and_replace_one()`**: Function defined in this file
- **`measure_and_replace()`**: Function defined in this file
- **`measure_and_replace()`**: Function defined in this file
- **`fmt()`**: Function defined in this file
- **`new_with_quota()`**: Function defined in this file
- **`advance_clock()`**: Function defined in this file
- **`add_quota_for_key()`**: Function defined in this file
- **`check_key()`**: Function defined in this file
- **`until_key_ready()`**: Function defined in this file
- **`await_keys_ready()`**: Function defined in this file
- **`initialize_mock_rate_limiter()`**: Function defined in this file
- **`test_default_quota()`**: Function defined in this file
- **`test_custom_key_quota()`**: Function defined in this file
- **`test_multiple_keys()`**: Function defined in this file
- **`test_quota_reset()`**: Function defined in this file
- **`test_different_quotas()`**: Function defined in this file
- **`test_await_keys_ready()`**: Function defined in this file
- **`test_gcra_boundary_exact_replenishment()`**: Function defined in this file

### Classes
- **`InMemoryState`**: Class defined in this file
- **`RateLimiter`**: Class defined in this file
...
**Functions**: `add_quota_for_key`, `advance_clock`, `await_keys_ready`, `check_key`, `fmt`, `initialize_mock_rate_limiter`, `measure_and_replace`, `measure_and_replace_one`, `new_with_quota`, `test_await_keys_ready`, `test_custom_key_quota`, `test_default_quota`, `test_different_quotas`, `test_gcra_boundary_exact_replenishment`, `test_multiple_keys`, `test_quota_reset`, `until_key_ready`
**Impls**: `Debug`, `InMemoryState`, `RateLimiter`, `StateStore`
**Structs**: `InMemoryState`, `RateLimiter`
**Traits**: `StateStore`
...
---
*Generated on 2025-11-18T21:55:03.385587Z*
