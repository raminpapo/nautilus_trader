# Documentation: `crates/network/src/ratelimiter/quota.rs`
**Generated:** 2025-11-15T19:40:03.241065Z
...
This file is located at `crates/network/src/ratelimiter/quota.rs` within the repository.

**Classes defined:** Quota, Quota, Quota, Quota

**Functions defined:** per_second, per_minute, per_hour, with_period, allow_burst, new, replenish_interval, burst_size, burst_size_replenished_in, from_gcra_parameters and 2 more
...
#### `per_second(max_burst: NonZeroU32)`


#### `per_minute(max_burst: NonZeroU32)`


#### `per_hour(max_burst: NonZeroU32)`


#### `with_period(replenish_1_per: Duration)`


#### `allow_burst(self, max_burst: NonZeroU32)`


#### `new(max_burst: NonZeroU32, replenish_all_per: Duration)`


#### `replenish_interval(&self)`


#### `burst_size(&self)`


#### `burst_size_replenished_in(&self)`


#### `from_gcra_parameters(t: Nanos, tau: Nanos)`
