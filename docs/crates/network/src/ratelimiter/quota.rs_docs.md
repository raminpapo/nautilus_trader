# Documentation: quota.rs

## File Metadata

- **Path**: `crates/network/src/ratelimiter/quota.rs`
- **Size**: 9,194 bytes
- **Lines**: 245
- **Language**: Rust
...
### Functions
- **`per_second()`**: Function defined in this file
- **`per_minute()`**: Function defined in this file
- **`per_hour()`**: Function defined in this file
- **`with_period()`**: Function defined in this file
- **`allow_burst()`**: Function defined in this file
- **`new()`**: Function defined in this file
- **`replenish_interval()`**: Function defined in this file
- **`burst_size()`**: Function defined in this file
- **`burst_size_replenished_in()`**: Function defined in this file
- **`from_gcra_parameters()`**: Function defined in this file
- **`time_multiples()`**: Function defined in this file
- **`period_error_cases()`**: Function defined in this file

### Classes
- **`Quota`**: Class defined in this file
...
**Functions**: `allow_burst`, `burst_size`, `burst_size_replenished_in`, `from_gcra_parameters`, `new`, `per_hour`, `per_minute`, `per_second`, `period_error_cases`, `replenish_interval`, `time_multiples`, `with_period`
**Impls**: `Quota`
**Structs**: `Quota`
...
---
*Generated on 2025-11-18T21:55:03.391396Z*
