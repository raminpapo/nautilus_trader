# Documentation: `crates/network/src/ratelimiter/gcra.rs`
**Generated:** 2025-11-15T19:40:03.234057Z
...
This file is located at `crates/network/src/ratelimiter/gcra.rs` within the repository.

**Classes defined:** StateSnapshot, NotUntil, Gcra, StateSnapshot, Gcra

**Functions defined:** new, quota, remaining_burst_capacity, new, earliest_possible, wait_time_from, quota, fmt, new, starting_state
...
#### `new(t: Nanos, tau: Nanos, time_of_measurement: Nanos, tat: Nanos)`


#### `quota(&self)`


#### `remaining_burst_capacity(&self)`


#### `new(state: StateSnapshot, start: P)`


#### `earliest_possible(&self)`


#### `wait_time_from(&self, from: P)`
