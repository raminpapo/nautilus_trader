# Documentation: gcra.rs

## File Metadata

- **Path**: `crates/network/src/ratelimiter/gcra.rs`
- **Size**: 5,544 bytes
- **Lines**: 163
- **Language**: Rust
...
- **`quota()`**: Function defined in this file
- **`remaining_burst_capacity()`**: Function defined in this file
- **`new()`**: Function defined in this file
- **`earliest_possible()`**: Function defined in this file
- **`wait_time_from()`**: Function defined in this file
- **`quota()`**: Function defined in this file
- **`fmt()`**: Function defined in this file
- **`new()`**: Function defined in this file
- **`starting_state()`**: Function defined in this file
- **`test_and_update()`**: Function defined in this file

### Classes
- **`StateSnapshot`**: Class defined in this file
- **`NotUntil`**: Class defined in this file
- **`Gcra`**: Class defined in this file
...
**Functions**: `earliest_possible`, `fmt`, `new`, `quota`, `remaining_burst_capacity`, `starting_state`, `test_and_update`, `wait_time_from`
**Impls**: `Display`, `Gcra`, `NotUntil`, `StateSnapshot`
**Structs**: `Gcra`, `NotUntil`, `StateSnapshot`
...
---
*Generated on 2025-11-18T21:55:03.381699Z*
