...
- **`advance()`**: Function defined in this file
...
- **`saturating_sub()`**: Function defined in this file
- **`now()`**: Function defined in this file
- **`fake_clock_parallel_advances()`**: Function defined in this file
- **`duration_addition_coverage()`**: Function defined in this file

### Classes
- **`FakeRelativeClock`**: Class defined in this file
- **`MonotonicClock`**: Class defined in this file
...
**Functions**: `add`, `advance`, `duration_addition_coverage`, `duration_since`, `eq`, `fake_clock_parallel_advances`, `now`, `saturating_sub`
**Impls**: `Add`, `Clock`, `FakeRelativeClock`, `PartialEq`, `Reference`
**Structs**: `FakeRelativeClock`, `MonotonicClock`
**Traits**: `Clock`, `Reference`
...
---
*Generated on 2025-11-18T21:55:03.379477Z*
