# Documentation: fix.rs

## File Metadata

- **Path**: `crates/network/src/socket/fix.rs`
- **Size**: 12,496 bytes
- **Lines**: 342
- **Language**: Rust
...
### Functions
- **`process_fix_buffer()`**: Function defined in this file
- **`find_message_end()`**: Function defined in this file
- **`test_process_empty_buffer()`**: Function defined in this file
- **`test_process_incomplete_message()`**: Function defined in this file
- **`test_process_complete_message()`**: Function defined in this file
- **`test_process_message_with_garbage_prefix()`**: Function defined in this file
- **`test_process_partial_checksum()`**: Function defined in this file
- **`test_process_multiple_messages_single_call()`**: Function defined in this file
- **`test_process_message_with_invalid_checksum()`**: Function defined in this file
- **`test_process_message_with_multiple_checksums()`**: Function defined in this file
- **`test_process_large_buffer()`**: Function defined in this file
...
**Functions**: `find_message_end`, `process_fix_buffer`, `test_process_complete_message`, `test_process_empty_buffer`, `test_process_incomplete_message`, `test_process_large_buffer`, `test_process_message_with_garbage_prefix`, `test_process_message_with_invalid_checksum`, `test_process_message_with_multiple_checksums`, `test_process_multiple_messages_single_call`, `test_process_partial_checksum`
...
---
*Generated on 2025-11-18T21:55:03.425321Z*
