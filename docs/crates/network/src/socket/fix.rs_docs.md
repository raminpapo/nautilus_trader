# Documentation: `crates/network/src/socket/fix.rs`
**Generated:** 2025-11-15T19:40:03.260088Z
...
This file is located at `crates/network/src/socket/fix.rs` within the repository.

**Functions defined:** process_fix_buffer, find_message_end, test_process_empty_buffer, test_process_incomplete_message, test_process_complete_message, test_process_message_with_garbage_prefix, test_process_partial_checksum, test_process_multiple_messages_single_call, test_process_message_with_invalid_checksum, test_process_message_with_multiple_checksums and 1 more
...
#### `process_fix_buffer(buf: &mut Vec<u8>, handler: &TcpMessageHandler)`


#### `find_message_end(buf: &[u8])`
