...
- **Path**: `crates/network/src/socket/client.rs`
- **Size**: 63,378 bytes
- **Lines**: 1,759
- **Language**: Rust
...
This file is part of the NautilusTrader repository. It defines 41 function(s) and 2 class(es).

## Detailed Walkthrough

### Functions
- **`connect_url()`**: Function defined in this file
- **`parse_socket_url()`**: Function defined in this file
- **`tls_connect_with_server()`**: Function defined in this file
- **`reconnect()`**: Function defined in this file
- **`is_alive()`**: Function defined in this file
- **`spawn_read_task()`**: Function defined in this file
- **`spawn_write_task()`**: Function defined in this file
- **`spawn_heartbeat_task()`**: Function defined in this file
...
- **`connection_mode()`**: Function defined in this file
- **`is_active()`**: Function defined in this file
- **`is_reconnecting()`**: Function defined in this file
- **`is_disconnecting()`**: Function defined in this file
- **`is_closed()`**: Function defined in this file
- **`close()`**: Function defined in this file
- **`send_bytes()`**: Function defined in this file
- **`spawn_controller_task()`**: Function defined in this file

*...and 21 more functions*

### Classes
- **`SocketClientInner`**: Class defined in this file
- **`SocketClient`**: Class defined in this file
...
**Functions**: `bind_test_server`, `clean_drop`, `close`, `connect`, `connect_url`, `connection_mode`, `drop`, `fmt`, `is_active`, `is_alive`, `is_closed`, `is_disconnecting`, `is_reconnecting`, `parse_socket_url`, `reconnect`, `run_echo_server`, `send_bytes`, `spawn_controller_task`, `spawn_heartbeat_task`, `spawn_read_task`, `spawn_write_task`, `test_basic_send_receive`, `test_heartbeat`, `test_ipv6_loopback_connection`, `test_parse_socket_url_default_ports`, `test_parse_socket_url_ipv6`, `test_parse_socket_url_ipv6_with_zone`, `test_parse_socket_url_raw_address`, `test_parse_socket_url_unknown_scheme_uses_mode`, `test_parse_socket_url_with_scheme` *(+10 more)*
**Impls**: `CleanDrop`, `Debug`, `Drop`, `SocketClient`, `SocketClientInner`
**Structs**: `SocketClient`, `SocketClientInner`
...
---
*Generated on 2025-11-18T21:55:03.418775Z*
