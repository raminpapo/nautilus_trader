# Documentation: `crates/network/src/socket/client.rs`
**Generated:** 2025-11-15T19:40:03.255586Z
**File Size:** 62768 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/network/src/socket/client.rs` within the repository.

**Classes defined:** SocketClientInner, SocketClient, SocketClientInner, Drop, CleanDrop, Debug, SocketClient, Drop

**Functions defined:** connect_url, parse_socket_url, tls_connect_with_server, reconnect, is_alive, spawn_read_task, spawn_write_task, spawn_heartbeat_task, drop, clean_drop and 31 more
...
#### `connect_url(config: SocketConfig)`


#### `parse_socket_url(url: &str, mode: Mode)`
...
#### `connect(
        config: SocketConfig,
        post_connection: Option<Arc<dyn Fn()`
...
#### `run_echo_server(mut socket: TcpStream)`
