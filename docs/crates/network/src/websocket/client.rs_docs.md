# Documentation: `crates/network/src/websocket/client.rs`
**Generated:** 2025-11-15T19:40:03.274701Z
**File Size:** 77082 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/network/src/websocket/client.rs` within the repository.

**Classes defined:** wrapped, can, WebSocketClientInner, WebSocketClient, TestServer, TestCallback, WebSocketClientInner, Drop, CleanDrop, Debug and 6 more

**Functions defined:** new_with_writer, connect_url, connect_with_server, connect_with_server, reconnect, is_alive, spawn_message_handler_task, spawn_write_task, spawn_heartbeat_task, drop and 40 more
...
#### `connect_url(config: WebSocketConfig)`
...
#### `connect(
        config: WebSocketConfig,
        post_reconnection: Option<Arc<dyn Fn()`


#### `connection_mode(&self)`


#### `connection_mode_atomic(&self)`
