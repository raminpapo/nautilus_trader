...
- **Path**: `crates/network/src/websocket/client.rs`
- **Size**: 77,082 bytes
- **Lines**: 2,090
- **Language**: Rust
...
### Functions
- **`new_with_writer()`**: Function defined in this file
- **`connect_url()`**: Function defined in this file
- **`connect_with_server()`**: Function defined in this file
- **`connect_with_server()`**: Function defined in this file
- **`reconnect()`**: Function defined in this file
- **`is_alive()`**: Function defined in this file
- **`spawn_message_handler_task()`**: Function defined in this file
...
- **`fmt()`**: Function defined in this file
- **`connect_stream()`**: Function defined in this file
- **`connect()`**: Function defined in this file
- **`connection_mode()`**: Function defined in this file
- **`connection_mode_atomic()`**: Function defined in this file
...
### Classes
- **`wrapped`**: Class defined in this file
- **`can`**: Class defined in this file
- **`WebSocketClientInner`**: Class defined in this file
- **`WebSocketClient`**: Class defined in this file
- **`TestServer`**: Class defined in this file
...
**Functions**: `clean_drop`, `connect`, `connect_stream`, `connect_url`, `connect_with_server`, `connection_mode`, `connection_mode_atomic`, `disconnect`, `drop`, `fmt`, `is_active`, `is_alive`, `is_closed`, `is_disconnected`, `is_disconnecting`, `is_reconnecting`, `new_with_writer`, `on_request`, `reconnect`, `send_bytes`, `send_close_message`, `send_pong`, `send_text`, `setup`, `setup_test_client`, `spawn_controller_task`, `spawn_heartbeat_task`, `spawn_message_handler_task`, `spawn_write_task`, `test_concurrent_writers` *(+16 more)*
**Impls**: `Callback`, `CleanDrop`, `Debug`, `Drop`, `TestServer`, `WebSocketClient`, `WebSocketClientInner`
**Structs**: `TestCallback`, `TestServer`, `WebSocketClient`, `WebSocketClientInner`, `can`, `wrapped`
...
---
*Generated on 2025-11-18T21:55:03.450438Z*
