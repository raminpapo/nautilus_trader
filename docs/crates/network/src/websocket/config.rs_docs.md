# Documentation: `crates/network/src/websocket/config.rs`
**Generated:** 2025-11-15T19:40:03.277023Z
**File Size:** 5572 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/network/src/websocket/config.rs` within the repository.

**Classes defined:** WebSocketConfig, Debug, Clone
