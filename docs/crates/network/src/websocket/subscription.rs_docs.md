...
This file is part of the NautilusTrader repository. It defines 78 function(s) and 1 class(es).

## Detailed Walkthrough

### Functions
- **`new()`**: Function defined in this file
- **`delimiter()`**: Function defined in this file
- **`confirmed()`**: Function defined in this file
- **`pending_subscribe()`**: Function defined in this file
- **`pending_unsubscribe()`**: Function defined in this file
- **`len()`**: Function defined in this file
- **`is_empty()`**: Function defined in this file
- **`mark_subscribe()`**: Function defined in this file
- **`mark_unsubscribe()`**: Function defined in this file
- **`confirm_subscribe()`**: Function defined in this file
- **`confirm_unsubscribe()`**: Function defined in this file
- **`mark_failure()`**: Function defined in this file
- **`pending_subscribe_topics()`**: Function defined in this file
- **`pending_unsubscribe_topics()`**: Function defined in this file
- **`all_topics()`**: Function defined in this file
- **`topics_from_map()`**: Function defined in this file
- **`add_reference()`**: Function defined in this file
- **`remove_reference()`**: Function defined in this file
- **`get_reference_count()`**: Function defined in this file
- **`clear()`**: Function defined in this file

*...and 58 more functions*

### Classes
- **`SubscriptionState`**: Class defined in this file


## Keywords and Identifiers

Total unique keywords extracted: 81


**Enums**: `Operation`
**Functions**: `add_reference`, `all_topics`, `apply_op`, `apply_operation`, `check_invariants`, `check_topic_exclusivity`, `clear`, `confirm_subscribe`, `confirm_unsubscribe`, `confirmed`, `delimiter`, `get_reference_count`, `is_empty`, `is_tracked`, `len`, `mark_failure`, `mark_subscribe`, `mark_unsubscribe`, `new`, `operation_strategy`, `pending_subscribe`, `pending_subscribe_topics`, `pending_unsubscribe`, `pending_unsubscribe_topics`, `prop_all_topics_is_union`, `prop_clear_resets_completely`, `prop_invariants_hold_after_operations`, `prop_reference_counting_consistency`, `prop_topic_mutual_exclusivity`, `remove_reference` *(+48 more)*
**Impls**: `Strategy`, `SubscriptionState`
**Structs**: `SubscriptionState`
...
---
*Generated on 2025-11-18T21:55:03.472454Z*
