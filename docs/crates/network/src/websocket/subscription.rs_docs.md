# Documentation: `crates/network/src/websocket/subscription.rs`
**Generated:** 2025-11-15T19:40:03.286940Z
**File Size:** 64748 bytes
**Extension:** .rs
**Type:** text
...
- **Path:** `crates/network/src/websocket/subscription.rs`
- **Size:** 64,748 bytes
- **Lines:** 1,727
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/network/src/websocket/subscription.rs` within the repository.

**Classes defined:** SubscriptionState, SubscriptionState, Strategy, Strategy

**Functions defined:** new, delimiter, confirmed, pending_subscribe, pending_unsubscribe, len, is_empty, mark_subscribe, mark_unsubscribe, confirm_subscribe and 68 more
...
#### `mark_subscribe(&self, topic: &str)`


#### `mark_unsubscribe(&self, topic: &str)`


#### `confirm_subscribe(&self, topic: &str)`


#### `confirm_unsubscribe(&self, topic: &str)`


#### `mark_failure(&self, topic: &str)`


#### `pending_subscribe_topics(&self)`


#### `pending_unsubscribe_topics(&self)`


#### `all_topics(&self)`


#### `topics_from_map(&self, map: &DashMap<Ustr, AHashSet<Ustr>>)`


#### `add_reference(&self, topic: &str)`


#### `remove_reference(&self, topic: &str)`


#### `get_reference_count(&self, topic: &str)`


#### `clear(&self)`


#### `split_topic(topic: &str, delimiter: char)`


#### `track_topic(map: &DashMap<Ustr, AHashSet<Ustr>>, channel: &str, symbol: Option<&str>)`


#### `untrack_topic(map: &DashMap<Ustr, AHashSet<Ustr>>, channel: &str, symbol: Option<&str>)`


#### `is_tracked(map: &DashMap<Ustr, AHashSet<Ustr>>, channel: &str, symbol: Option<&str>)`
