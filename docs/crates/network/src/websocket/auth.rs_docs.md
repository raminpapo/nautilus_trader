# Documentation: auth.rs

## File Metadata

- **Path**: `crates/network/src/websocket/auth.rs`
- **Size**: 25,418 bytes
- **Lines**: 770
- **Language**: Rust
...
This file is part of the NautilusTrader repository. It defines 32 function(s) and 2 class(es).

## Detailed Walkthrough

### Functions
- **`new()`**: Function defined in this file
- **`begin()`**: Function defined in this file
- **`succeed()`**: Function defined in this file
- **`fail()`**: Function defined in this file
- **`wait_for_result()`**: Function defined in this file
- **`default()`**: Function defined in this file
- **`from()`**: Function defined in this file
- **`test_successful_authentication()`**: Function defined in this file
- **`test_failed_authentication()`**: Function defined in this file
- **`test_authentication_timeout()`**: Function defined in this file
- **`test_begin_supersedes_previous_sender()`**: Function defined in this file
- **`test_succeed_without_pending_auth()`**: Function defined in this file
- **`test_fail_without_pending_auth()`**: Function defined in this file
- **`test_multiple_sequential_authentications()`**: Function defined in this file
- **`test_channel_closed_before_result()`**: Function defined in this file
- **`test_concurrent_auth_attempts()`**: Function defined in this file
- **`test_default_trait()`**: Function defined in this file
- **`test_clone_trait()`**: Function defined in this file
- **`test_debug_trait()`**: Function defined in this file
- **`test_timeout_clears_sender()`**: Function defined in this file

*...and 12 more functions*

### Classes
- **`AuthTracker`**: Class defined in this file
- **`TestError`**: Class defined in this file
...
**Functions**: `begin`, `default`, `fail`, `from`, `new`, `succeed`, `test_authentication_timeout`, `test_begin_supersedes_previous_sender`, `test_channel_closed_before_result`, `test_clone_trait`, `test_concurrent_auth_attempts`, `test_concurrent_succeed_fail_calls`, `test_debug_trait`, `test_default_trait`, `test_double_fail_is_safe`, `test_double_succeed_is_safe`, `test_fail_after_succeed_is_ignored`, `test_fail_clears_sender`, `test_fail_without_pending_auth`, `test_failed_authentication`, `test_multiple_sequential_authentications`, `test_no_sender_leaks`, `test_rapid_begin_succeed_cycles`, `test_reconnect_flow_blocks_on_auth_failure`, `test_reconnect_flow_waits_for_auth`, `test_state_machine_transitions`, `test_succeed_after_fail_is_ignored`, `test_succeed_clears_sender`, `test_succeed_without_pending_auth`, `test_successful_authentication` *(+2 more)*
**Impls**: `AuthTracker`, `Default`, `From`, `Into`
**Structs**: `AuthTracker`, `TestError`
...
---
*Generated on 2025-11-18T21:55:03.436872Z*
