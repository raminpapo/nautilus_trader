# Documentation: `crates/network/src/websocket/auth.rs`
**Generated:** 2025-11-15T19:40:03.267544Z
**File Size:** 25418 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/network/src/websocket/auth.rs` within the repository.

**Classes defined:** AuthTracker, TestError, AuthTracker, Into, Default, From

**Functions defined:** new, begin, succeed, fail, wait_for_result, default, from, test_successful_authentication, test_failed_authentication, test_authentication_timeout and 22 more
...
#### `fail(&self, error: impl Into<String>)`
