# Documentation: backoff.rs

## File Metadata

- **Path**: `crates/network/src/backoff.rs`
- **Size**: 16,890 bytes
- **Lines**: 467
- **Language**: Rust
...
- **`next_duration()`**: Function defined in this file
- **`reset()`**: Function defined in this file
- **`current_delay()`**: Function defined in this file
- **`test_no_jitter_exponential_growth()`**: Function defined in this file
- **`test_reset()`**: Function defined in this file
- **`test_jitter_within_bounds()`**: Function defined in this file
- **`test_factor_less_than_two()`**: Function defined in this file
- **`test_max_delay_is_respected()`**: Function defined in this file
- **`test_current_delay_getter()`**: Function defined in this file
- **`test_validation_zero_initial_delay()`**: Function defined in this file
- **`test_validation_max_less_than_initial()`**: Function defined in this file
- **`test_validation_factor_too_small()`**: Function defined in this file
- **`test_validation_factor_too_large()`**: Function defined in this file
- **`test_validation_delay_max_exceeds_u64_max_nanos()`**: Function defined in this file
- **`test_immediate_first()`**: Function defined in this file
- **`test_reset_restores_immediate_first()`**: Function defined in this file
- **`test_jitter_never_exceeds_max_delay()`**: Function defined in this file

### Classes
- **`ExponentialBackoff`**: Class defined in this file
- **`computes`**: Class defined in this file
...
**Functions**: `current_delay`, `new`, `next_duration`, `reset`, `test_current_delay_getter`, `test_factor_less_than_two`, `test_immediate_first`, `test_jitter_never_exceeds_max_delay`, `test_jitter_within_bounds`, `test_max_delay_is_respected`, `test_no_jitter_exponential_growth`, `test_reset`, `test_reset_restores_immediate_first`, `test_validation_delay_max_exceeds_u64_max_nanos`, `test_validation_factor_too_large`, `test_validation_factor_too_small`, `test_validation_max_less_than_initial`, `test_validation_zero_initial_delay`
**Impls**: `ExponentialBackoff`
**Structs**: `ExponentialBackoff`, `computes`
...
---
*Generated on 2025-11-18T21:55:03.339368Z*
