# Documentation: `crates/network/src/http/client.rs`
**Generated:** 2025-11-15T19:40:03.207018Z
**File Size:** 25999 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/network/src/http/client.rs` within the repository.

**Classes defined:** is, HttpClient, InnerHttpClient, HttpClient, InnerHttpClient, Default

**Functions defined:** new, request, request_with_params, request_with_ustr_keys, get, post, patch, delete, send_request, send_request_with_query and 23 more
...
#### `to_response(&self, response: Response)`
