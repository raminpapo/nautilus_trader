...
- **Path**: `crates/network/src/http/client.rs`
- **Size**: 26,033 bytes
- **Lines**: 810
- **Language**: Rust
...
This file is part of the NautilusTrader repository. It defines 33 function(s) and 3 class(es).

## Detailed Walkthrough

### Functions
- **`new()`**: Function defined in this file
- **`request()`**: Function defined in this file
- **`request_with_params()`**: Function defined in this file
- **`request_with_ustr_keys()`**: Function defined in this file
- **`get()`**: Function defined in this file
- **`post()`**: Function defined in this file
- **`patch()`**: Function defined in this file
- **`delete()`**: Function defined in this file
- **`send_request()`**: Function defined in this file
- **`send_request_with_query()`**: Function defined in this file
- **`send_request_internal()`**: Function defined in this file
- **`to_response()`**: Function defined in this file
- **`default()`**: Function defined in this file
- **`encode_url_params()`**: Function defined in this file
- **`get_unique_port()`**: Function defined in this file
- **`create_router()`**: Function defined in this file
- **`start_test_server()`**: Function defined in this file
- **`test_get()`**: Function defined in this file
- **`test_post()`**: Function defined in this file
- **`test_post_with_body()`**: Function defined in this file

*...and 13 more functions*

### Classes
- **`is`**: Class defined in this file
- **`HttpClient`**: Class defined in this file
- **`InnerHttpClient`**: Class defined in this file
...
**Functions**: `create_router`, `default`, `delete`, `encode_url_params`, `get`, `get_unique_port`, `new`, `patch`, `post`, `request`, `request_with_params`, `request_with_ustr_keys`, `send_request`, `send_request_internal`, `send_request_with_query`, `start_test_server`, `test_delete`, `test_get`, `test_http_client_delete`, `test_http_client_get`, `test_http_client_patch`, `test_http_client_post`, `test_http_client_with_empty_proxy_string`, `test_http_client_with_malformed_proxy`, `test_http_client_with_socks5_proxy`, `test_http_client_with_valid_proxy`, `test_http_client_without_proxy`, `test_not_found`, `test_patch`, `test_post` *(+3 more)*
**Impls**: `Default`, `HttpClient`, `InnerHttpClient`
**Structs**: `HttpClient`, `InnerHttpClient`, `is`
...
---
*Generated on 2025-11-18T21:55:03.346178Z*
