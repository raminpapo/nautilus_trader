# Documentation: `crates/network/src/http/types.rs`
**Generated:** 2025-11-15T19:40:03.211186Z
...
This file is located at `crates/network/src/http/types.rs` within the repository.

**Classes defined:** HttpStatus, encapsulates, HttpResponse, HttpStatus, TryFrom, From

**Functions defined:** new, as_u16, as_str, is_informational, is_success, is_redirection, is_client_error, is_server_error, try_from, from
