...
- **Path**: `crates/network/src/http/types.rs`
- **Size**: 4,496 bytes
- **Lines**: 152
- **Language**: Rust
...
This file is part of the NautilusTrader repository. It defines 10 function(s) and 3 class(es).

## Detailed Walkthrough

### Functions
- **`new()`**: Function defined in this file
- **`as_u16()`**: Function defined in this file
- **`as_str()`**: Function defined in this file
- **`is_informational()`**: Function defined in this file
- **`is_success()`**: Function defined in this file
- **`is_redirection()`**: Function defined in this file
- **`is_client_error()`**: Function defined in this file
- **`is_server_error()`**: Function defined in this file
- **`try_from()`**: Function defined in this file
- **`from()`**: Function defined in this file

### Classes
- **`HttpStatus`**: Class defined in this file
- **`encapsulates`**: Class defined in this file
- **`HttpResponse`**: Class defined in this file
...
**Enums**: `HttpMethod`
**Functions**: `as_str`, `as_u16`, `from`, `is_client_error`, `is_informational`, `is_redirection`, `is_server_error`, `is_success`, `new`, `try_from`
**Impls**: `From`, `HttpStatus`, `TryFrom`
**Structs**: `HttpResponse`, `HttpStatus`, `encapsulates`
...
---
*Generated on 2025-11-18T21:55:03.352260Z*
