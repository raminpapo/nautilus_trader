# Documentation: `crates/network/src/tls.rs`
**Generated:** 2025-11-15T19:40:03.264291Z
...
- **Path:** `crates/network/src/tls.rs`
- **Size:** 7,983 bytes
- **Lines:** 239
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/network/src/tls.rs` within the repository.

**Functions defined:** wrap_stream, wrap_stream, tcp_tls, domain, create_tls_config_from_certs_dir, load_private_key, load_certs
...
#### `wrap_stream(socket: S, mode: Mode)`
...
**Security:** This file may contain sensitive patterns: private_key, auth. Ensure proper handling of secrets.
