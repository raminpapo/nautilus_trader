...
### Functions
- **`wrap_stream()`**: Function defined in this file
- **`wrap_stream()`**: Function defined in this file
- **`tcp_tls()`**: Function defined in this file
- **`domain()`**: Function defined in this file
- **`create_tls_config_from_certs_dir()`**: Function defined in this file
- **`load_private_key()`**: Function defined in this file
- **`load_certs()`**: Function defined in this file
...
**Enums**: `Connector`
**Functions**: `create_tls_config_from_certs_dir`, `domain`, `load_certs`, `load_private_key`, `tcp_tls`, `wrap_stream`
...
---
*Generated on 2025-11-18T21:55:03.431425Z*
