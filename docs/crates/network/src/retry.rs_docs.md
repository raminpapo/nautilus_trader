# Documentation: `crates/network/src/retry.rs`
**Generated:** 2025-11-15T19:40:03.246483Z
**File Size:** 64073 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/network/src/retry.rs` within the repository.

**Classes defined:** RetryConfig, RetryManager, Default, Fn, Fn, Fn, Fn, Fn, Fn

**Functions defined:** default, new, execute_with_retry_inner, execute_with_retry, execute_with_retry_with_cancel, create_default_retry_manager, create_http_retry_manager, create_websocket_retry_manager, should_retry_test_error, create_test_error and 32 more
...
#### `should_retry_test_error(error: &TestError)`


#### `create_test_error(msg: String)`


#### `yield_until(mut condition: F)`


#### `advance_until(mut condition: F)`
