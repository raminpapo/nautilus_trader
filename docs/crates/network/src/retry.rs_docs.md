# Documentation: retry.rs

## File Metadata

- **Path**: `crates/network/src/retry.rs`
- **Size**: 67,838 bytes
- **Lines**: 1,880
- **Language**: Rust
...
This file is part of the NautilusTrader repository. It defines 46 function(s) and 2 class(es).
...
- **`budget_exceeded_msg()`**: Function defined in this file
- **`execute_with_retry_inner()`**: Function defined in this file
- **`execute_with_retry()`**: Function defined in this file
- **`execute_with_retry_with_cancel()`**: Function defined in this file
- **`create_default_retry_manager()`**: Function defined in this file
- **`create_http_retry_manager()`**: Function defined in this file
- **`create_websocket_retry_manager()`**: Function defined in this file
- **`should_retry_test_error()`**: Function defined in this file
- **`create_test_error()`**: Function defined in this file
- **`yield_until()`**: Function defined in this file
- **`advance_until()`**: Function defined in this file
- **`test_retry_config_default()`**: Function defined in this file
- **`test_retry_manager_success_first_attempt()`**: Function defined in this file
- **`test_retry_manager_non_retryable_error()`**: Function defined in this file
- **`test_retry_manager_retryable_error_exhausted()`**: Function defined in this file
- **`test_timeout_path()`**: Function defined in this file
- **`test_max_elapsed_time_budget()`**: Function defined in this file
- **`test_budget_exceeded_message_format()`**: Function defined in this file

*...and 26 more functions*

### Classes
- **`RetryConfig`**: Class defined in this file
- **`RetryManager`**: Class defined in this file
...
**Enums**: `TestError`
**Functions**: `advance_until`, `budget_exceeded_msg`, `create_default_retry_manager`, `create_http_retry_manager`, `create_test_error`, `create_websocket_retry_manager`, `default`, `execute_with_retry`, `execute_with_retry_inner`, `execute_with_retry_with_cancel`, `new`, `should_retry_test_error`, `test_budget_clamp_prevents_overshoot`, `test_budget_exceeded_edge_cases`, `test_budget_exceeded_message_format`, `test_budget_exceeded_no_overflow`, `test_cancellation_during_operation_execution`, `test_cancellation_during_retry_delay`, `test_cancellation_error_message`, `test_cancellation_stops_immediately`, `test_http_retry_manager_config`, `test_immediate_first_property`, `test_immediate_first_retry`, `test_jitter_applied`, `test_jitter_bounds`, `test_max_elapsed_always_respected`, `test_max_elapsed_stops_early`, `test_max_elapsed_time_budget`, `test_mixed_errors_retry_behavior`, `test_non_retryable_stops_immediately` *(+16 more)*
**Impls**: `Default`, `Fn`, `RetryManager`
**Structs**: `RetryConfig`, `RetryManager`
...
---
*Generated on 2025-11-18T21:55:03.400652Z*
