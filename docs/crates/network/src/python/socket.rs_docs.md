...
- **`py_mode()`**: Function defined in this file
- **`py_reconnect()`**: Function defined in this file
...
**Functions**: `py_close`, `py_connect`, `py_is_active`, `py_is_closed`, `py_is_disconnecting`, `py_is_reconnecting`, `py_mode`, `py_new`, `py_reconnect`, `py_send`
**Impls**: `SocketClient`, `SocketConfig`
...
---
*Generated on 2025-11-18T21:55:03.371757Z*
