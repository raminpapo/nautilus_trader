# Documentation: `crates/network/src/python/socket.rs`
**Generated:** 2025-11-15T19:40:03.226158Z
...
- **Path:** `crates/network/src/python/socket.rs`
- **Size:** 11,743 bytes
- **Lines:** 309
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/network/src/python/socket.rs` within the repository.

**Classes defined:** SocketConfig, SocketClient

**Functions defined:** py_new, py_connect, py_is_active, py_is_reconnecting, py_is_disconnecting, py_is_closed, py_mode, py_reconnect, py_close, py_send
...
#### `py_mode(slf: PyRef<'_, Self>)`


#### `py_reconnect(slf: PyRef<'_, Self>, py: Python<'py>)`


#### `py_close(slf: PyRef<'_, Self>, py: Python<'py>)`
