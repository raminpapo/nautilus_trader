# Documentation: `crates/network/src/python/websocket.rs`
**Generated:** 2025-11-15T19:40:03.229425Z
**File Size:** 21253 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/network/src/python/websocket.rs` within the repository.

**Classes defined:** TestServer, TestCallback, WebSocketConfig, WebSocketClient, Callback, TestServer, Drop

**Functions defined:** to_websocket_pyerr, py_new, py_connect, py_disconnect, py_is_active, py_is_reconnecting, py_is_disconnecting, py_is_closed, py_send, py_send_text and 7 more
...
#### `to_websocket_pyerr(e: tokio_tungstenite::tungstenite::Error)`
...
#### `py_disconnect(slf: PyRef<'_, Self>, py: Python<'py>)`


#### `py_is_active(slf: PyRef<'_, Self>)`


#### `py_is_reconnecting(slf: PyRef<'_, Self>)`


#### `py_is_disconnecting(slf: PyRef<'_, Self>)`


#### `py_is_closed(slf: PyRef<'_, Self>)`
