# Documentation: `crates/network/src/python/http.rs`
**Generated:** 2025-11-15T19:40:03.221946Z
**File Size:** 30085 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/network/src/python/http.rs` within the repository.

**Classes defined:** HttpClientError, HttpMethod, HttpResponse, HttpClient

**Functions defined:** into_py_err, __hash__, py_new, py_status, py_headers, py_body, py_new, py_request, py_get, py_post and 30 more
