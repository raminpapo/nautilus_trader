# Documentation: property_backoff.rs

## File Metadata

- **Path**: `crates/network/tests/property_backoff.rs`
- **Size**: 12,852 bytes
- **Lines**: 343
- **Language**: Rust
...
### Functions
- **`backoff_params_strategy()`**: Function defined in this file
- **`backoff_grows_exponentially_to_max()`**: Function defined in this file
- **`jitter_within_bounds()`**: Function defined in this file
- **`reset_restores_initial_state()`**: Function defined in this file
- **`immediate_first_behavior()`**: Function defined in this file
- **`eventually_reaches_maximum()`**: Function defined in this file
- **`deterministic_base_progression()`**: Function defined in this file
- **`factor_bounds_respected()`**: Function defined in this file
...
**Functions**: `backoff_grows_exponentially_to_max`, `backoff_params_strategy`, `deterministic_base_progression`, `eventually_reaches_maximum`, `factor_bounds_respected`, `immediate_first_behavior`, `jitter_within_bounds`, `reset_restores_initial_state`
**Impls**: `Strategy`

## Related Files

This file is located in `crates/network/tests/`. Related files may include:
...
```bash
# For Python
pytest crates/network/tests/property_backoff.rs
...
---
*Generated on 2025-11-18T21:55:03.478933Z*
