# Documentation: `crates/network/tests/property_backoff.rs`
**Generated:** 2025-11-15T19:40:03.291635Z
**File Size:** 12852 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/network/tests/property_backoff.rs` within the repository.

**Classes defined:** Strategy

**Functions defined:** backoff_params_strategy, backoff_grows_exponentially_to_max, jitter_within_bounds, reset_restores_initial_state, immediate_first_behavior, eventually_reaches_maximum, deterministic_base_progression, factor_bounds_respected
...
#### `backoff_params_strategy()`


#### `backoff_grows_exponentially_to_max(
        (initial, max, factor, jitter_ms, immediate_first)`
...
#### `immediate_first_behavior(
        (initial, max, factor, jitter_ms, _)`


#### `eventually_reaches_maximum(
        (initial, max, factor, jitter_ms, immediate_first)`


#### `deterministic_base_progression(
        (initial, max, factor, _jitter_ms, immediate_first)`
...
**Directory:** `crates/network/tests`
