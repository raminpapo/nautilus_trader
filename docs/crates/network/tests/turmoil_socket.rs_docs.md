# Documentation: `crates/network/tests/turmoil_socket.rs`
**Generated:** 2025-11-15T19:40:03.295927Z
...
This file is located at `crates/network/tests/turmoil_socket.rs` within the repository.

**Functions defined:** socket_config, echo_server, test_turmoil_real_socket_basic_connect, test_turmoil_real_socket_reconnection, test_turmoil_real_socket_network_partition
...
#### `test_turmoil_real_socket_basic_connect(socket_config: SocketConfig)`


#### `test_turmoil_real_socket_reconnection(mut socket_config: SocketConfig)`


#### `test_turmoil_real_socket_network_partition(mut socket_config: SocketConfig)`
