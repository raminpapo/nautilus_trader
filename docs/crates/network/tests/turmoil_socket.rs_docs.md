# Documentation: turmoil_socket.rs

## File Metadata

- **Path**: `crates/network/tests/turmoil_socket.rs`
- **Size**: 7,812 bytes
- **Lines**: 245
- **Language**: Rust
...
### Functions
- **`socket_config()`**: Function defined in this file
- **`echo_server()`**: Function defined in this file
- **`test_turmoil_real_socket_basic_connect()`**: Function defined in this file
- **`test_turmoil_real_socket_reconnection()`**: Function defined in this file
- **`test_turmoil_real_socket_network_partition()`**: Function defined in this file
...
**Functions**: `echo_server`, `socket_config`, `test_turmoil_real_socket_basic_connect`, `test_turmoil_real_socket_network_partition`, `test_turmoil_real_socket_reconnection`
...
```bash
# For Python
pytest crates/network/tests/turmoil_socket.rs
...
---
*Generated on 2025-11-18T21:55:03.485259Z*
