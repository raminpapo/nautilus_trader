# Documentation: `crates/network/tests/turmoil_websocket.rs`
**Generated:** 2025-11-15T19:40:03.297993Z
...
This file is located at `crates/network/tests/turmoil_websocket.rs` within the repository.

**Functions defined:** websocket_config, ws_echo_server, test_turmoil_real_websocket_basic_connect, test_turmoil_real_websocket_reconnection, test_turmoil_real_websocket_network_partition
...
#### `test_turmoil_real_websocket_basic_connect(websocket_config: WebSocketConfig)`


#### `test_turmoil_real_websocket_reconnection(mut websocket_config: WebSocketConfig)`


#### `test_turmoil_real_websocket_network_partition(mut websocket_config: WebSocketConfig)`
