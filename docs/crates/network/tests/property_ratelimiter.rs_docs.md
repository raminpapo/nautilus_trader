# Documentation: property_ratelimiter.rs

## File Metadata

- **Path**: `crates/network/tests/property_ratelimiter.rs`
- **Size**: 15,242 bytes
- **Lines**: 386
- **Language**: Rust
...
### Functions
- **`rate_limiter_respects_quota_bounds()`**: Function defined in this file
- **`rate_limiter_consistent_across_keys()`**: Function defined in this file
- **`quota_calculations_bounded()`**: Function defined in this file
- **`rate_limiter_handles_rapid_requests()`**: Function defined in this file
- **`default_quota_behavior()`**: Function defined in this file
- **`custom_period_quota_behavior()`**: Function defined in this file
- **`gcra_boundary_exact_replenishment()`**: Function defined in this file
...
**Functions**: `custom_period_quota_behavior`, `default_quota_behavior`, `gcra_boundary_exact_replenishment`, `quota_calculations_bounded`, `rate_limiter_consistent_across_keys`, `rate_limiter_handles_rapid_requests`, `rate_limiter_respects_quota_bounds`
...
```bash
# For Python
pytest crates/network/tests/property_ratelimiter.rs
...
---
*Generated on 2025-11-18T21:55:03.482415Z*
