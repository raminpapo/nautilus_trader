# Documentation: `crates/network/tests/property_ratelimiter.rs`
**Generated:** 2025-11-15T19:40:03.294073Z
**File Size:** 15242 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/network/tests/property_ratelimiter.rs` within the repository.

**Functions defined:** rate_limiter_respects_quota_bounds, rate_limiter_consistent_across_keys, quota_calculations_bounded, rate_limiter_handles_rapid_requests, default_quota_behavior, custom_period_quota_behavior, gcra_boundary_exact_replenishment
...
#### `rate_limiter_respects_quota_bounds(
        rate in 1u32..=100u32,
        key in "[a-z]{1,10}",
        request_count in 1usize..=200
    )`
...
#### `rate_limiter_consistent_across_keys(
        keys in prop::collection::hash_set("[a-z]{3,8}", 2..=10)`


#### `quota_calculations_bounded(
        rate in 1u32..=10000u32
    )`


#### `rate_limiter_handles_rapid_requests(
        rate in 1u32..=50u32,
        request_count in 1usize..=150
    )`


#### `default_quota_behavior(
        default_rate in 1u32..=20u32,
        key_rate in 1u32..=20u32,
        key in "[a-z]{1,8}"
    )`
...
#### `custom_period_quota_behavior(
        period_ms in 1u64..=5000u64,
        burst_size in 1u32..=10u32
    )`


#### `gcra_boundary_exact_replenishment(
        rate in 1u32..=20u32
    )`
