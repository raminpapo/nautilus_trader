# Documentation: arrow.rs

## File Metadata

- **Path**: `crates/serialization/src/python/arrow.rs`
- **Size**: 10,367 bytes
- **Lines**: 289
- **Language**: Rust
...
### Functions
- **`arrow_record_batch_to_pybytes()`**: Function defined in this file
- **`get_arrow_schema_map()`**: Function defined in this file
- **`pyobjects_to_arrow_record_batch_bytes()`**: Function defined in this file
- **`py_book_deltas_to_arrow_record_batch_bytes()`**: Function defined in this file
- **`py_book_depth10_to_arrow_record_batch_bytes()`**: Function defined in this file
- **`py_quotes_to_arrow_record_batch_bytes()`**: Function defined in this file
- **`py_trades_to_arrow_record_batch_bytes()`**: Function defined in this file
- **`py_bars_to_arrow_record_batch_bytes()`**: Function defined in this file
- **`py_mark_prices_to_arrow_record_batch_bytes()`**: Function defined in this file
- **`py_index_prices_to_arrow_record_batch_bytes()`**: Function defined in this file
- **`py_instrument_closes_to_arrow_record_batch_bytes()`**: Function defined in this file
...
**Functions**: `arrow_record_batch_to_pybytes`, `get_arrow_schema_map`, `py_bars_to_arrow_record_batch_bytes`, `py_book_deltas_to_arrow_record_batch_bytes`, `py_book_depth10_to_arrow_record_batch_bytes`, `py_index_prices_to_arrow_record_batch_bytes`, `py_instrument_closes_to_arrow_record_batch_bytes`, `py_mark_prices_to_arrow_record_batch_bytes`, `py_quotes_to_arrow_record_batch_bytes`, `py_trades_to_arrow_record_batch_bytes`, `pyobjects_to_arrow_record_batch_bytes`
...
---
*Generated on 2025-11-18T21:55:04.133118Z*
