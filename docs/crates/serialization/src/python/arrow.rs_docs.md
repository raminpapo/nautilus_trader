# Documentation: `crates/serialization/src/python/arrow.rs`
**Generated:** 2025-11-15T19:40:03.742308Z
**File Size:** 10367 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/serialization/src/python/arrow.rs` within the repository.

**Functions defined:** arrow_record_batch_to_pybytes, get_arrow_schema_map, pyobjects_to_arrow_record_batch_bytes, py_book_deltas_to_arrow_record_batch_bytes, py_book_depth10_to_arrow_record_batch_bytes, py_quotes_to_arrow_record_batch_bytes, py_trades_to_arrow_record_batch_bytes, py_bars_to_arrow_record_batch_bytes, py_mark_prices_to_arrow_record_batch_bytes, py_index_prices_to_arrow_record_batch_bytes and 1 more
...
#### `arrow_record_batch_to_pybytes(py: Python, batch: RecordBatch)`


#### `get_arrow_schema_map(py: Python<'_>, cls: &Bound<'_, PyType>)`
...
#### `py_bars_to_arrow_record_batch_bytes(py: Python, data: Vec<Bar>)`
