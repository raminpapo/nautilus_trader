# Documentation: `crates/serialization/src/capnp/conversions.rs`
**Generated:** 2025-11-15T19:40:03.735876Z
**File Size:** 191586 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/serialization/src/capnp/conversions.rs` within the repository.

**Functions defined:** write_capnp, write_capnp, write_capnp, read_optional_from_capnp, to_capnp, from_capnp, decimal_to_parts, decimal_from_parts, to_capnp, from_capnp and 203 more
...
#### `decimal_to_parts(value: &Decimal)`


#### `decimal_from_parts(lo: u64, mid: u64, hi: u64, flags: u32)`
...
#### `currency_type_to_capnp(value: CurrencyType)`


#### `currency_type_from_capnp(value: enums_capnp::CurrencyType)`


#### `account_type_to_capnp(value: AccountType)`


#### `account_type_from_capnp(value: enums_capnp::AccountType)`


#### `aggressor_side_to_capnp(value: AggressorSide)`


#### `aggressor_side_from_capnp(value: enums_capnp::AggressorSide)`


*... and 163 more functions*
