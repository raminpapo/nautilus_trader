# Documentation: conversions.rs

## File Metadata

- **Path**: `crates/serialization/src/capnp/conversions.rs`
- **Size**: 191,620 bytes
- **Lines**: 5,282
- **Language**: Rust
...
This file is part of the NautilusTrader repository. It defines 213 function(s).

## Detailed Walkthrough

### Functions
- **`write_capnp()`**: Function defined in this file
- **`write_capnp()`**: Function defined in this file
- **`write_capnp()`**: Function defined in this file
- **`read_optional_from_capnp()`**: Function defined in this file
- **`to_capnp()`**: Function defined in this file
- **`from_capnp()`**: Function defined in this file
- **`decimal_to_parts()`**: Function defined in this file
- **`decimal_from_parts()`**: Function defined in this file
- **`to_capnp()`**: Function defined in this file
- **`from_capnp()`**: Function defined in this file
- **`to_capnp()`**: Function defined in this file
- **`from_capnp()`**: Function defined in this file
...
*...and 193 more functions*


## Keywords and Identifiers

Total unique keywords extracted: 102


**Functions**: `account_type_from_capnp`, `account_type_to_capnp`, `aggregation_source_from_capnp`, `aggregation_source_to_capnp`, `aggressor_side_from_capnp`, `aggressor_side_to_capnp`, `asset_class_from_capnp`, `asset_class_to_capnp`, `bar_aggregation_from_capnp`, `bar_aggregation_to_capnp`, `book_action_from_capnp`, `book_action_to_capnp`, `book_type_from_capnp`, `book_type_to_capnp`, `contingency_type_from_capnp`, `contingency_type_to_capnp`, `currency_type_from_capnp`, `currency_type_to_capnp`, `decimal_from_parts`, `decimal_to_parts`, `deserialize_account_balance`, `deserialize_currency`, `deserialize_instrument_id`, `deserialize_margin_balance`, `deserialize_money`, `deserialize_price`, `deserialize_quantity`, `from_capnp`, `instrument_class_from_capnp`, `instrument_class_to_capnp` *(+69 more)*
**Impls**: `CapnpWriteExt`, `FromCapnp`, `ToCapnp`
**Traits**: `CapnpWriteExt`
...
---
*Generated on 2025-11-18T21:55:04.126149Z*
