# Documentation: index_price.rs

## File Metadata

- **Path**: `crates/serialization/src/arrow/index_price.rs`
- **Size**: 10,933 bytes
- **Lines**: 294
- **Language**: Rust
...
**Functions**: `decode_batch`, `decode_data_batch`, `encode_batch`, `get_schema`, `metadata`, `parse_metadata`, `test_decode_batch`, `test_encode_batch`, `test_get_schema`, `test_get_schema_map`
...
---
*Generated on 2025-11-18T21:55:04.089304Z*
