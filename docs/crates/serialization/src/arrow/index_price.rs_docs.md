# Documentation: `crates/serialization/src/arrow/index_price.rs`
**Generated:** 2025-11-15T19:40:03.711761Z
**File Size:** 10933 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/serialization/src/arrow/index_price.rs` within the repository.

**Classes defined:** ArrowSchemaProvider, EncodeToRecordBatch, DecodeFromRecordBatch, DecodeDataFromRecordBatch

**Functions defined:** get_schema, parse_metadata, encode_batch, metadata, decode_batch, decode_data_batch, test_get_schema, test_get_schema_map, test_encode_batch, test_decode_batch
...
#### `parse_metadata(metadata: &HashMap<String, String>)`
