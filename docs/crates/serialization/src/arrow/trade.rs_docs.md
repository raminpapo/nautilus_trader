...
- **Path**: `crates/serialization/src/arrow/trade.rs`
- **Size**: 15,545 bytes
- **Lines**: 405
- **Language**: Rust
...
- **`test_encode_trade_tick()`**: Function defined in this file
...
**Enums**: `value`
**Functions**: `decode_batch`, `decode_data_batch`, `encode_batch`, `get_schema`, `metadata`, `parse_metadata`, `test_decode_batch`, `test_encode_trade_tick`, `test_get_schema`, `test_get_schema_map`
...
---
*Generated on 2025-11-18T21:55:04.101712Z*
