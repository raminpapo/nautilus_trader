# Documentation: `crates/serialization/src/arrow/mod.rs`
**Generated:** 2025-11-15T19:40:03.716353Z
...
This file is located at `crates/serialization/src/arrow/mod.rs` within the repository.

**Functions defined:** get_raw_price, get_raw_quantity, get_schema, get_schema_map, encode_batch, metadata, chunk_metadata, decode_batch, decode_data_batch, write and 10 more
...
#### `get_raw_price(bytes: &[u8])`


#### `get_raw_quantity(bytes: &[u8])`
...
#### `write(&mut self, record_batch: &RecordBatch)`
...
#### `bars_to_arrow_record_batch_bytes(data: Vec<Bar>)`
