...
- **Path**: `crates/serialization/src/arrow/mod.rs`
- **Size**: 13,480 bytes
- **Lines**: 421
- **Language**: Rust
...
### Functions
- **`get_raw_price()`**: Function defined in this file
- **`get_raw_quantity()`**: Function defined in this file
- **`get_schema()`**: Function defined in this file
- **`get_schema_map()`**: Function defined in this file
- **`encode_batch()`**: Function defined in this file
- **`metadata()`**: Function defined in this file
- **`chunk_metadata()`**: Function defined in this file
- **`decode_batch()`**: Function defined in this file
- **`decode_data_batch()`**: Function defined in this file
- **`write()`**: Function defined in this file
- **`write()`**: Function defined in this file
- **`extract_column()`**: Function defined in this file
- **`book_deltas_to_arrow_record_batch_bytes()`**: Function defined in this file
- **`book_depth10_to_arrow_record_batch_bytes()`**: Function defined in this file
- **`quotes_to_arrow_record_batch_bytes()`**: Function defined in this file
- **`trades_to_arrow_record_batch_bytes()`**: Function defined in this file
- **`bars_to_arrow_record_batch_bytes()`**: Function defined in this file
- **`mark_prices_to_arrow_record_batch_bytes()`**: Function defined in this file
- **`index_prices_to_arrow_record_batch_bytes()`**: Function defined in this file
- **`instrument_closes_to_arrow_record_batch_bytes()`**: Function defined in this file
...
**Enums**: `DataStreamingError`, `EncodingError`
**Functions**: `bars_to_arrow_record_batch_bytes`, `book_deltas_to_arrow_record_batch_bytes`, `book_depth10_to_arrow_record_batch_bytes`, `chunk_metadata`, `decode_batch`, `decode_data_batch`, `encode_batch`, `extract_column`, `get_raw_price`, `get_raw_quantity`, `get_schema`, `get_schema_map`, `index_prices_to_arrow_record_batch_bytes`, `instrument_closes_to_arrow_record_batch_bytes`, `mark_prices_to_arrow_record_batch_bytes`, `metadata`, `quotes_to_arrow_record_batch_bytes`, `trades_to_arrow_record_batch_bytes`, `write`
**Impls**: `WriteStream`
**Traits**: `ArrowSchemaProvider`, `DecodeDataFromRecordBatch`, `DecodeFromRecordBatch`, `EncodeToRecordBatch`, `WriteStream`

## Related Files

This file is located in `crates/serialization/src/arrow/`. Related files may include:
...
---
*Generated on 2025-11-18T21:55:04.095300Z*
