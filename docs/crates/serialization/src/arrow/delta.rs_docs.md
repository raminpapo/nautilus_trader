...
- **Path**: `crates/serialization/src/arrow/delta.rs`
- **Size**: 18,220 bytes
- **Lines**: 456
- **Language**: Rust
...
**Enums**: `value`
**Functions**: `chunk_metadata`, `decode_batch`, `decode_data_batch`, `encode_batch`, `get_schema`, `metadata`, `parse_metadata`, `test_decode_batch`, `test_encode_batch`, `test_get_schema`, `test_get_schema_map`
...
---
*Generated on 2025-11-18T21:55:04.082309Z*
