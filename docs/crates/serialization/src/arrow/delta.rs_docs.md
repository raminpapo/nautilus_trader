# Documentation: `crates/serialization/src/arrow/delta.rs`
**Generated:** 2025-11-15T19:40:03.706287Z
**File Size:** 18220 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/serialization/src/arrow/delta.rs` within the repository.

**Classes defined:** ArrowSchemaProvider, EncodeToRecordBatch, DecodeFromRecordBatch, DecodeDataFromRecordBatch

**Functions defined:** get_schema, parse_metadata, encode_batch, metadata, chunk_metadata, decode_batch, decode_data_batch, test_get_schema, test_get_schema_map, test_encode_batch and 1 more
