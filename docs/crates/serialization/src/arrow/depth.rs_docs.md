# Documentation: `crates/serialization/src/arrow/depth.rs`
**Generated:** 2025-11-15T19:40:03.709408Z
**File Size:** 24499 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/serialization/src/arrow/depth.rs` within the repository.

**Classes defined:** ArrowSchemaProvider, EncodeToRecordBatch, DecodeFromRecordBatch, DecodeDataFromRecordBatch

**Functions defined:** get_field_data, get_schema, parse_metadata, encode_batch, metadata, decode_batch, decode_data_batch, test_get_schema, test_get_schema_map, test_encode_batch and 1 more
...
#### `get_schema(metadata: Option<HashMap<String, String>>)`
...
#### `test_encode_batch(stub_depth10: OrderBookDepth10)`


#### `test_decode_batch(stub_depth10: OrderBookDepth10)`
...
**Directory:** `crates/serialization/src/arrow`
