...
- **Path**: `crates/serialization/src/arrow/depth.rs`
- **Size**: 24,499 bytes
- **Lines**: 647
- **Language**: Rust
...
### Functions
- **`get_field_data()`**: Function defined in this file
- **`get_schema()`**: Function defined in this file
- **`parse_metadata()`**: Function defined in this file
...
- **`test_get_schema()`**: Function defined in this file
- **`test_get_schema_map()`**: Function defined in this file
- **`test_encode_batch()`**: Function defined in this file
- **`test_decode_batch()`**: Function defined in this file
...
**Functions**: `decode_batch`, `decode_data_batch`, `encode_batch`, `get_field_data`, `get_schema`, `metadata`, `parse_metadata`, `test_decode_batch`, `test_encode_batch`, `test_get_schema`, `test_get_schema_map`
**Impls**: `ArrowSchemaProvider`, `DecodeDataFromRecordBatch`, `DecodeFromRecordBatch`, `EncodeToRecordBatch`
...
---
*Generated on 2025-11-18T21:55:04.086608Z*
