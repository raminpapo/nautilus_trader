# Documentation: test_enums_capnp.rs

## File Metadata

- **Path**: `crates/serialization/tests/test_enums_capnp.rs`
- **Size**: 12,780 bytes
- **Lines**: 360
- **Language**: Rust
...
### Functions
- **`test_account_type_roundtrip()`**: Function defined in this file
- **`test_aggressor_side_roundtrip()`**: Function defined in this file
- **`test_asset_class_roundtrip()`**: Function defined in this file
- **`test_instrument_class_roundtrip()`**: Function defined in this file
- **`test_option_kind_roundtrip()`**: Function defined in this file
- **`test_order_side_roundtrip()`**: Function defined in this file
- **`test_order_type_roundtrip()`**: Function defined in this file
- **`test_order_status_roundtrip()`**: Function defined in this file
- **`test_time_in_force_roundtrip()`**: Function defined in this file
- **`test_trigger_type_roundtrip()`**: Function defined in this file
- **`test_contingency_type_roundtrip()`**: Function defined in this file
- **`test_position_side_roundtrip()`**: Function defined in this file
- **`test_liquidity_side_roundtrip()`**: Function defined in this file
- **`test_book_action_roundtrip()`**: Function defined in this file
- **`test_book_type_roundtrip()`**: Function defined in this file
- **`test_record_flag_roundtrip()`**: Function defined in this file
- **`test_aggregation_source_roundtrip()`**: Function defined in this file
- **`test_price_type_roundtrip()`**: Function defined in this file
- **`test_bar_aggregation_roundtrip()`**: Function defined in this file
- **`test_trailing_offset_type_roundtrip()`**: Function defined in this file
...
**Enums**: `types`
**Functions**: `test_account_type_roundtrip`, `test_aggregation_source_roundtrip`, `test_aggressor_side_roundtrip`, `test_asset_class_roundtrip`, `test_bar_aggregation_roundtrip`, `test_book_action_roundtrip`, `test_book_type_roundtrip`, `test_contingency_type_roundtrip`, `test_currency_type_roundtrip`, `test_instrument_class_roundtrip`, `test_instrument_close_type_roundtrip`, `test_liquidity_side_roundtrip`, `test_market_status_action_roundtrip`, `test_oms_type_roundtrip`, `test_option_kind_roundtrip`, `test_order_side_roundtrip`, `test_order_status_roundtrip`, `test_order_type_roundtrip`, `test_position_side_roundtrip`, `test_price_type_roundtrip`, `test_record_flag_roundtrip`, `test_time_in_force_roundtrip`, `test_trailing_offset_type_roundtrip`, `test_trigger_type_roundtrip`
...
```bash
# For Python
pytest crates/serialization/tests/test_enums_capnp.rs
...
---
*Generated on 2025-11-18T21:55:04.138122Z*
