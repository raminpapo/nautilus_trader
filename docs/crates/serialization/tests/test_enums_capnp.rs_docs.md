# Documentation: `crates/serialization/tests/test_enums_capnp.rs`
**Generated:** 2025-11-15T19:40:03.745581Z
**File Size:** 12780 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/serialization/tests/test_enums_capnp.rs` within the repository.

**Functions defined:** test_account_type_roundtrip, test_aggressor_side_roundtrip, test_asset_class_roundtrip, test_instrument_class_roundtrip, test_option_kind_roundtrip, test_order_side_roundtrip, test_order_type_roundtrip, test_order_status_roundtrip, test_time_in_force_roundtrip, test_trigger_type_roundtrip and 14 more
...
#### `test_account_type_roundtrip(#[case] value: AccountType)`


#### `test_aggressor_side_roundtrip(#[case] value: AggressorSide)`


#### `test_asset_class_roundtrip(#[case] value: AssetClass)`


#### `test_instrument_class_roundtrip(#[case] value: InstrumentClass)`


#### `test_option_kind_roundtrip(#[case] value: OptionKind)`


#### `test_order_side_roundtrip(#[case] value: OrderSide)`


#### `test_order_type_roundtrip(#[case] value: OrderType)`


#### `test_order_status_roundtrip(#[case] value: OrderStatus)`


#### `test_time_in_force_roundtrip(#[case] value: TimeInForce)`


#### `test_trigger_type_roundtrip(#[case] value: TriggerType)`


#### `test_contingency_type_roundtrip(#[case] value: ContingencyType)`


#### `test_position_side_roundtrip(#[case] value: PositionSide)`


#### `test_liquidity_side_roundtrip(#[case] value: LiquiditySide)`


#### `test_book_action_roundtrip(#[case] value: BookAction)`


#### `test_book_type_roundtrip(#[case] value: BookType)`


#### `test_record_flag_roundtrip(#[case] value: RecordFlag)`


#### `test_aggregation_source_roundtrip(#[case] value: AggregationSource)`


#### `test_price_type_roundtrip(#[case] value: PriceType)`


#### `test_bar_aggregation_roundtrip(#[case] value: BarAggregation)`


#### `test_trailing_offset_type_roundtrip(#[case] value: TrailingOffsetType)`


#### `test_oms_type_roundtrip(#[case] value: OmsType)`


#### `test_currency_type_roundtrip(#[case] value: CurrencyType)`


#### `test_instrument_close_type_roundtrip(#[case] value: InstrumentCloseType)`


#### `test_market_status_action_roundtrip(#[case] value: MarketStatusAction)`
