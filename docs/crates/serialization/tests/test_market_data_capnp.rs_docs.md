# Documentation: `crates/serialization/tests/test_market_data_capnp.rs`
**Generated:** 2025-11-15T19:40:03.751414Z
**File Size:** 37288 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/serialization/tests/test_market_data_capnp.rs` within the repository.

**Functions defined:** test_quote_tick_roundtrip, test_trade_tick_roundtrip, test_trade_tick_all_aggressor_sides, test_mark_price_update_roundtrip, test_index_price_update_roundtrip, test_funding_rate_update_with_next_funding_time, test_funding_rate_update_without_next_funding_time, test_funding_rate_update_with_large_decimal, test_instrument_close_all_types, test_instrument_status_all_actions and 14 more
...
#### `test_quote_tick_roundtrip()`


#### `test_trade_tick_roundtrip()`


#### `test_trade_tick_all_aggressor_sides(#[case] aggressor_side: AggressorSide)`
...
#### `test_funding_rate_update_with_next_funding_time()`


#### `test_funding_rate_update_without_next_funding_time()`


#### `test_funding_rate_update_with_large_decimal()`


#### `test_instrument_close_all_types(#[case] close_type: InstrumentCloseType)`


#### `test_instrument_status_all_actions(#[case] action: MarketStatusAction)`


#### `test_instrument_status_with_no_optional_fields()`


#### `test_instrument_status_with_empty_strings()`


#### `test_bar_specification_all_combinations(
    #[case] step: usize,
    #[case] aggregation: BarAggregation,
    #[case] price_type: PriceType,
)`
...
#### `test_bar_type_all_aggregation_sources(#[case] aggregation_source: AggregationSource)`
...
#### `test_bar_with_hour_aggregation()`


#### `test_bar_with_tick_aggregation()`


#### `test_bar_with_volume_aggregation()`


#### `test_book_order_all_sides(#[case] side: OrderSide)`


#### `test_order_book_delta_all_actions(#[case] action: BookAction)`


#### `test_order_book_deltas_with_multiple_deltas()`


#### `test_order_book_depth10_roundtrip()`
