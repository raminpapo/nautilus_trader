# Documentation: test_market_data_capnp.rs

## File Metadata

- **Path**: `crates/serialization/tests/test_market_data_capnp.rs`
- **Size**: 37,288 bytes
- **Lines**: 1,093
- **Language**: Rust
...
### Functions
- **`test_quote_tick_roundtrip()`**: Function defined in this file
- **`test_trade_tick_roundtrip()`**: Function defined in this file
- **`test_trade_tick_all_aggressor_sides()`**: Function defined in this file
- **`test_mark_price_update_roundtrip()`**: Function defined in this file
- **`test_index_price_update_roundtrip()`**: Function defined in this file
- **`test_funding_rate_update_with_next_funding_time()`**: Function defined in this file
- **`test_funding_rate_update_without_next_funding_time()`**: Function defined in this file
- **`test_funding_rate_update_with_large_decimal()`**: Function defined in this file
- **`test_instrument_close_all_types()`**: Function defined in this file
- **`test_instrument_status_all_actions()`**: Function defined in this file
- **`test_instrument_status_with_no_optional_fields()`**: Function defined in this file
- **`test_instrument_status_with_empty_strings()`**: Function defined in this file
- **`test_bar_specification_all_combinations()`**: Function defined in this file
- **`test_bar_type_all_aggregation_sources()`**: Function defined in this file
- **`test_bar_type_with_different_instruments()`**: Function defined in this file
- **`test_bar_roundtrip()`**: Function defined in this file
- **`test_bar_with_hour_aggregation()`**: Function defined in this file
- **`test_bar_with_tick_aggregation()`**: Function defined in this file
- **`test_bar_with_volume_aggregation()`**: Function defined in this file
- **`test_book_order_all_sides()`**: Function defined in this file
...
**Functions**: `test_bar_roundtrip`, `test_bar_specification_all_combinations`, `test_bar_type_all_aggregation_sources`, `test_bar_type_with_different_instruments`, `test_bar_with_hour_aggregation`, `test_bar_with_tick_aggregation`, `test_bar_with_volume_aggregation`, `test_book_order_all_sides`, `test_funding_rate_update_with_large_decimal`, `test_funding_rate_update_with_next_funding_time`, `test_funding_rate_update_without_next_funding_time`, `test_index_price_update_roundtrip`, `test_instrument_close_all_types`, `test_instrument_status_all_actions`, `test_instrument_status_with_empty_strings`, `test_instrument_status_with_no_optional_fields`, `test_mark_price_update_roundtrip`, `test_order_book_delta_all_actions`, `test_order_book_deltas_with_multiple_deltas`, `test_order_book_depth10_roundtrip`, `test_order_book_depth10_with_partial_levels`, `test_quote_tick_roundtrip`, `test_trade_tick_all_aggressor_sides`, `test_trade_tick_roundtrip`
...
```bash
# For Python
pytest crates/serialization/tests/test_market_data_capnp.rs
...
---
*Generated on 2025-11-18T21:55:04.147553Z*
