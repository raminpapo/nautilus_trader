# Documentation: test_identifiers_capnp.rs

## File Metadata

- **Path**: `crates/serialization/tests/test_identifiers_capnp.rs`
- **Size**: 11,980 bytes
- **Lines**: 356
- **Language**: Rust
...
### Functions
- **`test_trader_id_roundtrip()`**: Function defined in this file
- **`test_strategy_id_roundtrip()`**: Function defined in this file
- **`test_actor_id_roundtrip()`**: Function defined in this file
- **`test_account_id_roundtrip()`**: Function defined in this file
- **`test_client_id_roundtrip()`**: Function defined in this file
- **`test_client_order_id_roundtrip()`**: Function defined in this file
- **`test_venue_order_id_roundtrip()`**: Function defined in this file
- **`test_trade_id_roundtrip()`**: Function defined in this file
- **`test_position_id_roundtrip()`**: Function defined in this file
- **`test_exec_algorithm_id_roundtrip()`**: Function defined in this file
- **`test_component_id_roundtrip()`**: Function defined in this file
- **`test_order_list_id_roundtrip()`**: Function defined in this file
- **`test_symbol_roundtrip()`**: Function defined in this file
- **`test_venue_roundtrip()`**: Function defined in this file
- **`test_instrument_id_roundtrip()`**: Function defined in this file
...
**Functions**: `test_account_id_roundtrip`, `test_actor_id_roundtrip`, `test_client_id_roundtrip`, `test_client_order_id_roundtrip`, `test_component_id_roundtrip`, `test_exec_algorithm_id_roundtrip`, `test_instrument_id_roundtrip`, `test_order_list_id_roundtrip`, `test_position_id_roundtrip`, `test_strategy_id_roundtrip`, `test_symbol_roundtrip`, `test_trade_id_roundtrip`, `test_trader_id_roundtrip`, `test_venue_order_id_roundtrip`, `test_venue_roundtrip`
...
```bash
# For Python
pytest crates/serialization/tests/test_identifiers_capnp.rs
...
---
*Generated on 2025-11-18T21:55:04.141120Z*
