# Documentation: `crates/serialization/tests/test_identifiers_capnp.rs`
**Generated:** 2025-11-15T19:40:03.747707Z
**File Size:** 11980 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/serialization/tests/test_identifiers_capnp.rs` within the repository.

**Functions defined:** test_trader_id_roundtrip, test_strategy_id_roundtrip, test_actor_id_roundtrip, test_account_id_roundtrip, test_client_id_roundtrip, test_client_order_id_roundtrip, test_venue_order_id_roundtrip, test_trade_id_roundtrip, test_position_id_roundtrip, test_exec_algorithm_id_roundtrip and 5 more
...
#### `test_trader_id_roundtrip()`


#### `test_strategy_id_roundtrip()`


#### `test_actor_id_roundtrip()`


#### `test_account_id_roundtrip()`


#### `test_client_id_roundtrip()`


#### `test_client_order_id_roundtrip()`


#### `test_venue_order_id_roundtrip()`


#### `test_trade_id_roundtrip()`


#### `test_position_id_roundtrip()`
