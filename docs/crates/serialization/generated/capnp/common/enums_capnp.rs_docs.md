# Documentation: enums_capnp.rs

## File Metadata

- **Path**: `crates/serialization/generated/capnp/common/enums_capnp.rs`
- **Size**: 102,011 bytes
- **Lines**: 2,371
- **Language**: Rust
...
This file is part of the NautilusTrader repository. It defines 130 function(s).
...
- **`from()`**: Function defined in this file
- **`get_annotation_types()`**: Function defined in this file
- **`introspect()`**: Function defined in this file
- **`from()`**: Function defined in this file
- **`try_from()`**: Function defined in this file
- **`from()`**: Function defined in this file
...
**Enums**: `AccountType`, `AggregationSource`, `AggressorSide`, `AssetClass`, `BarAggregation`, `BookAction`, `BookType`, `ContingencyType`, `CurrencyType`, `InstrumentClass`, `InstrumentCloseType`, `LiquiditySide`, `MarketStatusAction`, `OmsType`, `OptionKind`, `OrderBookDeltaType`, `OrderSide`, `OrderStatus`, `OrderType`, `PositionAdjustmentType`, `PositionSide`, `PriceType`, `RecordFlag`, `TimeInForce`, `TrailingOffsetType`, `TriggerType`
**Functions**: `from`, `get_annotation_types`, `introspect`, `try_from`
**Impls**: `From`
...
---
*Generated on 2025-11-18T21:55:03.854641Z*
