# Documentation: identifiers_capnp.rs
...
This file is part of the NautilusTrader repository. It defines 443 function(s) and 60 class(es).
...
- **`get_value()`**: Function defined in this file
- **`has_value()`**: Function defined in this file
- **`from()`**: Function defined in this file
- **`from()`**: Function defined in this file
...
**Functions**: `clone`, `fmt`, `from`, `get_annotation_types`, `get_field_types`, `get_from_pointer`, `get_symbol`, `get_value`, `get_venue`, `has_symbol`, `has_value`, `has_venue`, `imbue`, `imbue_mut`, `init_pointer`, `init_symbol`, `init_value`, `init_venue`, `into_internal_struct_reader`, `into_reader`, `introspect`, `new`, `reborrow`, `reborrow_as_reader`, `set_pointer_builder`, `set_symbol`, `set_value`, `set_venue`, `total_size`
**Impls**: `Pipeline`
...
---
*Generated on 2025-11-18T21:55:03.875478Z*
