...
This file is part of the NautilusTrader repository. It defines 119 function(s) and 16 class(es).
...
**Functions**: `clone`, `fmt`, `from`, `get_annotation_types`, `get_entries`, `get_field_types`, `get_from_pointer`, `get_key`, `get_value`, `has_entries`, `has_key`, `has_value`, `imbue`, `imbue_mut`, `init_entries`, `init_key`, `init_pointer`, `init_value`, `into_internal_struct_reader`, `into_reader`, `introspect`, `new`, `reborrow`, `reborrow_as_reader`, `set_entries`, `set_key`, `set_pointer_builder`, `set_value`, `total_size`
**Impls**: `Pipeline`
...
---
*Generated on 2025-11-18T21:55:03.839972Z*
