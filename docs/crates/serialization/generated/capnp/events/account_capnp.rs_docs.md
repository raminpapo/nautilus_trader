# Documentation: account_capnp.rs
...
This file is part of the NautilusTrader repository. It defines 76 function(s) and 4 class(es).

## Detailed Walkthrough

### Functions
- **`introspect()`**: Function defined in this file
- **`clone()`**: Function defined in this file
- **`from()`**: Function defined in this file
- **`from()`**: Function defined in this file
- **`fmt()`**: Function defined in this file
- **`get_from_pointer()`**: Function defined in this file
- **`into_internal_struct_reader()`**: Function defined in this file
- **`imbue()`**: Function defined in this file
- **`reborrow()`**: Function defined in this file
- **`total_size()`**: Function defined in this file
- **`get_account_id()`**: Function defined in this file
- **`has_account_id()`**: Function defined in this file
- **`get_account_type()`**: Function defined in this file
- **`get_base_currency()`**: Function defined in this file
- **`has_base_currency()`**: Function defined in this file
- **`get_balances()`**: Function defined in this file
- **`has_balances()`**: Function defined in this file
- **`get_margins()`**: Function defined in this file
- **`has_margins()`**: Function defined in this file
- **`get_is_reported()`**: Function defined in this file

*...and 56 more functions*

### Classes
- **`Owned`**: Class defined in this file
- **`Reader`**: Class defined in this file
- **`Builder`**: Class defined in this file
- **`Pipeline`**: Class defined in this file
...
**Functions**: `clone`, `fmt`, `from`, `get_account_id`, `get_account_type`, `get_annotation_types`, `get_balances`, `get_base_currency`, `get_event_id`, `get_field_types`, `get_from_pointer`, `get_is_reported`, `get_margins`, `get_ts_event`, `get_ts_init`, `has_account_id`, `has_balances`, `has_base_currency`, `has_event_id`, `has_margins`, `has_ts_event`, `has_ts_init`, `imbue`, `imbue_mut`, `init_account_id`, `init_balances`, `init_base_currency`, `init_event_id`, `init_margins`, `init_pointer` *(+19 more)*
**Impls**: `Pipeline`
**Structs**: `Builder`, `Owned`, `Pipeline`, `Reader`

## Related Files

This file is located in `crates/serialization/generated/capnp/events/`. Related files may include:
...
---
*Generated on 2025-11-18T21:55:03.947482Z*
