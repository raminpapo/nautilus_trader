# Documentation: `crates/serialization/generated/capnp/events/position_capnp.rs`
**Generated:** 2025-11-15T19:40:03.684202Z
**File Size:** 233095 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/serialization/generated/capnp/events/position_capnp.rs` within the repository.

**Classes defined:** Owned, Reader, Builder, Pipeline, Owned, Reader, Builder, Pipeline, Owned, Reader and 32 more

**Functions defined:** introspect, clone, from, from, fmt, get_from_pointer, into_internal_struct_reader, imbue, reborrow, total_size and 691 more
...
#### `get_opening_order_id(self)`


#### `has_opening_order_id(&self)`
