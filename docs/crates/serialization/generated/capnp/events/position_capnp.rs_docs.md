# Documentation: position_capnp.rs

## File Metadata

- **Path**: `crates/serialization/generated/capnp/events/position_capnp.rs`
- **Size**: 233,095 bytes
- **Lines**: 4,834
- **Language**: Rust
...
pub mod position_opened {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 284] = [
      ::capnp::word(0, 0, 0, 0, 5, 0, 6, 0),
      ::capnp::word(141, 86, 172, 228, 86, 118, 79, 184),
...
pub mod position_changed {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 380] = [
      ::capnp::word(0, 0, 0, 0, 5, 0, 6, 0),
      ::capnp::word(21, 129, 64, 75, 254, 52, 7, 174),
...
pub mod position_closed {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 428] = [
      ::capnp::word(0, 0, 0, 0, 5, 0, 6, 0),
      ::capnp::word(5, 38, 201, 97, 67, 200, 24, 222),
...
This file is part of the NautilusTrader repository. It defines 701 function(s) and 24 class(es).
...
Total unique keywords extracted: 139


**Enums**: `Which`
**Functions**: `clone`, `fmt`, `from`, `get_account_id`, `get_adjustment_type`, `get_annotation_types`, `get_avg_px_close`, `get_avg_px_open`, `get_closing_order_id`, `get_currency`, `get_duration`, `get_entry`, `get_event_id`, `get_field_types`, `get_from_pointer`, `get_instrument_id`, `get_last_px`, `get_last_qty`, `get_opening_order_id`, `get_peak_quantity`, `get_pnl_change`, `get_position_id`, `get_quantity`, `get_quantity_change`, `get_realized_pnl`, `get_realized_return`, `get_reason`, `get_side`, `get_signed_qty`, `get_strategy_id` *(+104 more)*
**Impls**: `Pipeline`
...
---
*Generated on 2025-11-18T21:55:04.052292Z*
