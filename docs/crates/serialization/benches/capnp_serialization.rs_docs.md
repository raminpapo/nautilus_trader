# Documentation: capnp_serialization.rs

## File Metadata

- **Path**: `crates/serialization/benches/capnp_serialization.rs`
- **Size**: 13,039 bytes
- **Lines**: 372
- **Language**: Rust
...
- **`create_order_book_deltas()`**: Function defined in this file
- **`bench_quote_tick_serialize()`**: Function defined in this file
- **`bench_quote_tick_deserialize()`**: Function defined in this file
- **`bench_trade_tick_serialize()`**: Function defined in this file
- **`bench_trade_tick_deserialize()`**: Function defined in this file
- **`bench_bar_serialize()`**: Function defined in this file
- **`bench_bar_deserialize()`**: Function defined in this file
- **`bench_order_book_deltas_serialize_1()`**: Function defined in this file
- **`bench_order_book_deltas_serialize_10()`**: Function defined in this file
- **`bench_order_book_deltas_serialize_100()`**: Function defined in this file
- **`bench_order_book_deltas_deserialize_1()`**: Function defined in this file
- **`bench_order_book_deltas_deserialize_10()`**: Function defined in this file
- **`bench_order_book_deltas_deserialize_100()`**: Function defined in this file
...
**Functions**: `bench_bar_deserialize`, `bench_bar_serialize`, `bench_order_book_deltas_deserialize_1`, `bench_order_book_deltas_deserialize_10`, `bench_order_book_deltas_deserialize_100`, `bench_order_book_deltas_serialize_1`, `bench_order_book_deltas_serialize_10`, `bench_order_book_deltas_serialize_100`, `bench_quote_tick_deserialize`, `bench_quote_tick_serialize`, `bench_trade_tick_deserialize`, `bench_trade_tick_serialize`, `create_bar`, `create_order_book_deltas`, `create_quote_tick`, `create_trade_tick`
...
---
*Generated on 2025-11-18T21:55:03.676821Z*
