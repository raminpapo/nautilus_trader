# Documentation: order.capnp

## File Metadata

- **Path**: `crates/serialization/schemas/capnp/events/order.capnp`
- **Size**: 9,586 bytes
- **Lines**: 291
- **Language**: Unknown
...
**Identifiers**: `AccountId`, `Base`, `Bool`, `Cap`, `ClientOrderId`, `Common`, `ContingencyType`, `Currency`, `Decimal`, `Enums`, `ExecAlgorithmId`, `Identifiers`, `InstrumentId`, `LiquiditySide`, `List`, `Money`, `Nautilus`, `Optional`, `Order`, `OrderAccepted`, `OrderCancelRejected`, `OrderCanceled`, `OrderDenied`, `OrderEmulated`, `OrderEvent`, `OrderEventHeader`, `OrderExpired`, `OrderFilled`, `OrderInitialized`, `OrderListId` *(+26 more)*
...
---
*Generated on 2025-11-18T21:55:04.069159Z*
