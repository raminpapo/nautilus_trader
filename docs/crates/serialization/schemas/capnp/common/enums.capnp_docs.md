# Documentation: enums.capnp

## File Metadata

- **Path**: `crates/serialization/schemas/capnp/common/enums.capnp`
- **Size**: 3,861 bytes
- **Lines**: 235
- **Language**: Unknown
...
**Identifiers**: `AccountType`, `AggregationSource`, `AggressorSide`, `AssetClass`, `BarAggregation`, `BookAction`, `BookType`, `Cancel`, `Cancels`, `Cap`, `ContingencyType`, `Contract`, `CurrencyType`, `Date`, `Day`, `Difference`, `Fill`, `Good`, `Immediate`, `InstrumentClass`, `InstrumentCloseType`, `Kill`, `Last`, `Level`, `LiquiditySide`, `Market`, `MarketStatusAction`, `Message`, `Nautilus`, `OmsType` *(+20 more)*
...
---
*Generated on 2025-11-18T21:55:04.060906Z*
