# Documentation: data.capnp

## File Metadata

- **Path**: `crates/serialization/schemas/capnp/commands/data.capnp`
- **Size**: 8,358 bytes
- **Lines**: 339
- **Language**: Unknown
...
**Identifiers**: `Bar`, `BarType`, `BarsResponse`, `Base`, `BookResponse`, `BookType`, `Cap`, `ClientId`, `Common`, `CustomDataResponse`, `Data`, `DataCommand`, `DataCommandHeader`, `DataResponse`, `DataResponseHeader`, `Enums`, `Identifiers`, `InstrumentId`, `InstrumentResponse`, `InstrumentsResponse`, `List`, `Market`, `Nautilus`, `Proto`, `QuoteTick`, `QuotesResponse`, `Raw`, `Request`, `RequestBars`, `RequestBookDepth` *(+49 more)*

## Related Files

This file is located in `crates/serialization/schemas/capnp/commands/`. Related files may include:
...
---
*Generated on 2025-11-18T21:55:04.055677Z*
