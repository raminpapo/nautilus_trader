# Documentation: trading.capnp

## File Metadata

- **Path**: `crates/serialization/schemas/capnp/commands/trading.capnp`
- **Size**: 6,774 bytes
- **Lines**: 220
- **Language**: Unknown
...
**Identifiers**: `AccountId`, `Advanced`, `Base`, `BatchCancelOrders`, `Bool`, `CancelAllOrders`, `CancelOrder`, `Cap`, `ClientId`, `ClientOrderId`, `Commissions`, `Common`, `Contingency`, `ContingencyType`, `Core`, `Currencies`, `Currency`, `Decimal`, `Enums`, `ExecAlgorithmId`, `Execution`, `Flags`, `Float64`, `Identifiers`, `Instrument`, `InstrumentClass`, `InstrumentId`, `LiquiditySide`, `List`, `Many` *(+47 more)*
...
---
*Generated on 2025-11-18T21:55:04.058116Z*
