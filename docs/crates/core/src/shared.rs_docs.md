# Documentation: `crates/core/src/shared.rs`
**Generated:** 2025-11-15T19:40:01.939915Z
...
This file is located at `crates/core/src/shared.rs` within the repository.

**Classes defined:** SharedCell, WeakCell

**Functions defined:** clone, new, downgrade, borrow, borrow_mut, strong_count, weak_count, from, from, deref and 5 more
...
#### `from(inner: Rc<RefCell<T>>)`


#### `from(shared: SharedCell<T>)`
...
#### `from(inner: Weak<RefCell<T>>)`


#### `from(cell: WeakCell<T>)`
