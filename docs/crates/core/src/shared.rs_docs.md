...
- **`downgrade()`**: Function defined in this file
- **`borrow()`**: Function defined in this file
- **`borrow_mut()`**: Function defined in this file
- **`strong_count()`**: Function defined in this file
- **`weak_count()`**: Function defined in this file
- **`from()`**: Function defined in this file
- **`from()`**: Function defined in this file
- **`deref()`**: Function defined in this file
- **`clone()`**: Function defined in this file
- **`upgrade()`**: Function defined in this file
- **`is_dropped()`**: Function defined in this file
- **`from()`**: Function defined in this file
- **`from()`**: Function defined in this file

### Classes
- **`SharedCell`**: Class defined in this file
- **`WeakCell`**: Class defined in this file
...
**Functions**: `borrow`, `borrow_mut`, `clone`, `deref`, `downgrade`, `from`, `is_dropped`, `new`, `strong_count`, `upgrade`, `weak_count`
**Impls**: `Clone`, `From`, `SharedCell`, `WeakCell`, `std`
**Structs**: `SharedCell`, `WeakCell`
...
---
*Generated on 2025-11-18T21:55:01.440744Z*
