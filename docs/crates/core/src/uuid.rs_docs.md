# Documentation: `crates/core/src/uuid.rs`
**Generated:** 2025-11-15T19:40:01.948224Z
**File Size:** 14217 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/core/src/uuid.rs` within the repository.

**Classes defined:** UUID4, UUID4, FromStr, From, From, From, Default, Debug, Display, Serialize

**Functions defined:** new, to_cstr, as_bytes, validate_v4, from_validated_uuid, from_str, from, from, from, default and 24 more
...
#### `validate_v4(uuid: &Uuid)`


#### `from_validated_uuid(uuid: &Uuid)`
...
#### `test_from_str_with_non_version_4_uuid_panics()`


#### `test_case_insensitive_parsing()`


#### `test_invalid_version(#[case] uuid_string: &str)`


#### `test_non_rfc4122_variant()`


#### `test_invalid_uuid_cases(#[case] invalid_uuid: &str)`
