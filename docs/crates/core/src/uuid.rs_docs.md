# Documentation: uuid.rs

## File Metadata

- **Path**: `crates/core/src/uuid.rs`
- **Size**: 14,217 bytes
- **Lines**: 444
- **Language**: Rust
...
- **`to_cstr()`**: Function defined in this file
- **`as_bytes()`**: Function defined in this file
- **`validate_v4()`**: Function defined in this file
- **`from_validated_uuid()`**: Function defined in this file
...
- **`test_uuid_format()`**: Function defined in this file
- **`test_from_str_with_non_version_4_uuid_panics()`**: Function defined in this file
- **`test_case_insensitive_parsing()`**: Function defined in this file
- **`test_invalid_version()`**: Function defined in this file
- **`test_non_rfc4122_variant()`**: Function defined in this file

*...and 14 more functions*

### Classes
- **`UUID4`**: Class defined in this file
...
**Functions**: `as_bytes`, `default`, `deserialize`, `fmt`, `from`, `from_str`, `from_validated_uuid`, `new`, `serialize`, `test_as_bytes`, `test_as_bytes_round_trip`, `test_case_insensitive_parsing`, `test_debug`, `test_default`, `test_deserialize_json`, `test_display`, `test_equality`, `test_from_str`, `test_from_str_with_non_version_4_uuid_panics`, `test_from_uuid`, `test_hash_consistency`, `test_invalid_uuid_cases`, `test_invalid_version`, `test_new`, `test_non_rfc4122_variant`, `test_serialize_deserialize_round_trip`, `test_serialize_json`, `test_to_cstr`, `test_uuid_format`, `to_cstr` *(+1 more)*
**Impls**: `Debug`, `Default`, `Deserialize`, `Display`, `From`, `FromStr`, `Serialize`, `UUID4`
**Structs**: `UUID4`
...
---
*Generated on 2025-11-18T21:55:01.452558Z*
