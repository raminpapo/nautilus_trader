# Documentation: `crates/core/src/correctness.rs`
**Generated:** 2025-11-15T19:40:01.873952Z
...
- **Path:** `crates/core/src/correctness.rs`
- **Size:** 29,413 bytes
- **Lines:** 986
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/core/src/correctness.rs` within the repository.

**Functions defined:** check_predicate_true, check_predicate_false, check_equal, check_equal_u8, check_equal_usize, check_positive_u64, check_positive_u128, check_positive_i64, check_positive_i128, check_non_negative_f64 and 53 more
...
#### `check_predicate_true(predicate: bool, fail_msg: &str)`


#### `check_predicate_false(predicate: bool, fail_msg: &str)`
...
#### `check_equal_u8(lhs: u8, rhs: u8, lhs_param: &str, rhs_param: &str)`
...
#### `check_positive_u64(value: u64, param: &str)`


#### `check_positive_u128(value: u128, param: &str)`


#### `check_positive_i64(value: i64, param: &str)`


#### `check_positive_i128(value: i128, param: &str)`


#### `check_non_negative_f64(value: f64, param: &str)`


#### `check_in_range_inclusive_u8(value: u8, l: u8, r: u8, param: &str)`


#### `check_in_range_inclusive_u64(value: u64, l: u64, r: u64, param: &str)`


#### `check_in_range_inclusive_i64(value: i64, l: i64, r: i64, param: &str)`


#### `check_in_range_inclusive_f64(value: f64, l: f64, r: f64, param: &str)`
...
#### `check_slice_empty(slice: &[T], param: &str)`


#### `check_slice_not_empty(slice: &[T], param: &str)`


#### `check_map_empty(map: &M, param: &str)`


#### `check_map_not_empty(map: &M, param: &str)`
...
#### `check_positive_decimal(value: Decimal, param: &str)`


#### `test_check_predicate_true(#[case] predicate: bool, #[case] expected: bool)`


#### `test_check_predicate_false(#[case] predicate: bool, #[case] expected: bool)`


#### `test_check_nonempty_string_with_valid_values(#[case] s: &str)`


#### `test_check_nonempty_string_with_invalid_values(#[case] s: &str)`


#### `test_check_valid_string_ascii_with_valid_value(#[case] s: &str)`


#### `test_check_valid_string_ascii_with_invalid_values(#[case] s: &str)`


#### `test_check_valid_string_utf8_with_valid_values(#[case] s: &str)`


#### `test_check_valid_string_utf8_with_invalid_values(#[case] s: &str)`


#### `test_check_valid_string_ascii_optional_with_valid_value(#[case] s: Option<&str>)`


#### `test_check_string_contains_when_does_contain(#[case] s: &str, #[case] pat: &str)`


#### `test_check_string_contains_when_does_not_contain(#[case] s: &str, #[case] pat: &str)`
...
#### `test_check_positive_u64_when_positive(#[case] value: u64, #[case] param: &str)`


#### `test_check_positive_u64_when_not_positive(#[case] value: u64, #[case] param: &str)`


#### `test_check_positive_i64_when_positive(#[case] value: i64, #[case] param: &str)`


#### `test_check_positive_i64_when_not_positive(#[case] value: i64, #[case] param: &str)`


#### `test_check_non_negative_f64_when_not_negative(#[case] value: f64, #[case] param: &str)`


#### `test_check_non_negative_f64_when_negative(#[case] value: f64, #[case] param: &str)`
