# Documentation: `crates/core/src/serialization.rs`
**Generated:** 2025-11-15T19:40:01.937872Z
**File Size:** 8343 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/core/src/serialization.rs` within the repository.

**Classes defined:** BoolVisitor, TestStruct, SerializableTestStruct, Visitor, Serializable

**Functions defined:** from_json_bytes, to_json_bytes, from_msgpack_bytes, to_msgpack_bytes, expecting, visit_bool, visit_u64, from_bool_as_u8, test_deserialize_bool_as_u8_with_boolean, test_deserialize_bool_as_u8_with_u64 and 7 more
...
#### `from_json_bytes(data: &[u8])`


#### `to_json_bytes(&self)`


#### `from_msgpack_bytes(data: &[u8])`


#### `to_msgpack_bytes(&self)`


#### `expecting(&self, formatter: &mut std::fmt::Formatter<'_>)`


#### `visit_bool(self, value: bool)`


#### `visit_u64(self, value: u64)`


#### `from_bool_as_u8(deserializer: D)`


#### `test_deserialize_bool_as_u8_with_boolean(#[case] json_str: &str, #[case] expected: u8)`


#### `test_deserialize_bool_as_u8_with_u64(#[case] json_str: &str, #[case] expected: u8)`


#### `test_deserialize_bool_as_u8_with_invalid_integer()`


#### `test_serializable_json_roundtrip()`


#### `test_serializable_msgpack_roundtrip()`


#### `test_serializable_json_invalid_data()`


#### `test_serializable_msgpack_invalid_data()`


#### `test_serializable_json_empty_values()`
