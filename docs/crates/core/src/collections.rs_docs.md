# Documentation: `crates/core/src/collections.rs`
**Generated:** 2025-11-15T19:40:01.868138Z
**File Size:** 8896 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/core/src/collections.rs` within the repository.

**Functions defined:** contains, is_empty, contains, is_empty, contains, is_empty, contains, is_empty, contains_key, is_empty and 17 more
...
#### `contains_key(&self, key: &Self::Key)`


#### `is_empty(&self)`


#### `contains_key(&self, k: &K)`
...
#### `into_ustr_vec(iter: I)`


#### `test_hashset_setlike()`


#### `test_indexset_setlike()`


#### `test_into_ustr_vec_from_strings()`


#### `test_into_ustr_vec_from_str_slices()`


#### `test_ahashset_setlike()`


#### `test_hashmap_maplike()`


#### `test_indexmap_maplike()`


#### `test_ahashmap_maplike()`


#### `test_trait_object_setlike()`


#### `test_trait_object_maplike()`
