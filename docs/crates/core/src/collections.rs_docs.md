# Documentation: collections.rs

## File Metadata

- **Path**: `crates/core/src/collections.rs`
- **Size**: 8,896 bytes
- **Lines**: 332
- **Language**: Rust
...
- **`contains()`**: Function defined in this file
- **`is_empty()`**: Function defined in this file
- **`contains_key()`**: Function defined in this file
- **`is_empty()`**: Function defined in this file
- **`contains_key()`**: Function defined in this file
- **`is_empty()`**: Function defined in this file
- **`contains_key()`**: Function defined in this file
...
- **`contains_key()`**: Function defined in this file
- **`is_empty()`**: Function defined in this file
- **`into_ustr_vec()`**: Function defined in this file
- **`test_hashset_setlike()`**: Function defined in this file
- **`test_indexset_setlike()`**: Function defined in this file
- **`test_into_ustr_vec_from_strings()`**: Function defined in this file
...
**Functions**: `contains`, `contains_key`, `into_ustr_vec`, `is_empty`, `test_ahashmap_maplike`, `test_ahashset_setlike`, `test_hashmap_maplike`, `test_hashset_setlike`, `test_indexmap_maplike`, `test_indexset_setlike`, `test_into_ustr_vec_from_str_slices`, `test_into_ustr_vec_from_strings`, `test_trait_object_maplike`, `test_trait_object_setlike`
**Impls**: `MapLike`, `SetLike`
**Traits**: `MapLike`, `SetLike`
...
---
*Generated on 2025-11-18T21:55:01.344712Z*
