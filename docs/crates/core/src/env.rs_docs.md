# Documentation: env.rs

## File Metadata

- **Path**: `crates/core/src/env.rs`
- **Size**: 5,098 bytes
- **Lines**: 137
- **Language**: Rust
...
### Functions
- **`get_env_var()`**: Function defined in this file
- **`get_or_env_var()`**: Function defined in this file
- **`test_get_env_var_success()`**: Function defined in this file
- **`test_get_env_var_not_set()`**: Function defined in this file
- **`test_get_env_var_error_message_format()`**: Function defined in this file
- **`test_get_or_env_var_with_some_value()`**: Function defined in this file
- **`test_get_or_env_var_with_none_and_env_var_set()`**: Function defined in this file
- **`test_get_or_env_var_with_none_and_env_var_not_set()`**: Function defined in this file
- **`test_get_or_env_var_empty_string_value()`**: Function defined in this file
- **`test_get_or_env_var_priority()`**: Function defined in this file
...
**Functions**: `get_env_var`, `get_or_env_var`, `test_get_env_var_error_message_format`, `test_get_env_var_not_set`, `test_get_env_var_success`, `test_get_or_env_var_empty_string_value`, `test_get_or_env_var_priority`, `test_get_or_env_var_with_none_and_env_var_not_set`, `test_get_or_env_var_with_none_and_env_var_set`, `test_get_or_env_var_with_some_value`
...
---
*Generated on 2025-11-18T21:55:01.370640Z*
