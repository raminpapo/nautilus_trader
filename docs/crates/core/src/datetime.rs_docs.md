# Documentation: `crates/core/src/datetime.rs`
**Generated:** 2025-11-15T19:40:01.878727Z
**File Size:** 27237 bytes
**Extension:** .rs
**Type:** text
...
- **Path:** `crates/core/src/datetime.rs`
- **Size:** 27,237 bytes
- **Lines:** 739
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/core/src/datetime.rs` within the repository.

**Functions defined:** secs_to_nanos, secs_to_millis, millis_to_nanos, micros_to_nanos, nanos_to_secs, nanos_to_millis, nanos_to_micros, unix_nanos_to_iso8601, iso8601_to_unix_nanos, unix_nanos_to_iso8601_millis and 42 more
...
#### `unix_nanos_to_iso8601(unix_nanos: UnixNanos)`


#### `iso8601_to_unix_nanos(date_string: String)`


#### `unix_nanos_to_iso8601_millis(unix_nanos: UnixNanos)`


#### `floor_to_nearest_microsecond(unix_nanos: u64)`


#### `last_weekday_nanos(year: i32, month: u32, day: u32)`


#### `is_within_last_24_hours(timestamp_ns: UnixNanos)`


#### `subtract_n_months(datetime: DateTime<Utc>, n: u32)`


#### `add_n_months(datetime: DateTime<Utc>, n: u32)`


#### `subtract_n_months_nanos(unix_nanos: UnixNanos, n: u32)`


#### `add_n_months_nanos(unix_nanos: UnixNanos, n: u32)`


#### `add_n_years(datetime: DateTime<Utc>, n: u32)`


#### `subtract_n_years(datetime: DateTime<Utc>, n: u32)`


#### `add_n_years_nanos(unix_nanos: UnixNanos, n: u32)`


#### `subtract_n_years_nanos(unix_nanos: UnixNanos, n: u32)`


#### `last_day_of_month(year: i32, month: u32)`


#### `is_leap_year(year: i32)`


#### `test_secs_to_nanos(#[case] value: f64, #[case] expected: u64)`


#### `test_secs_to_millis(#[case] value: f64, #[case] expected: u64)`


#### `test_last_day_of_month_invalid_month()`


#### `test_millis_to_nanos(#[case] value: f64, #[case] expected: u64)`


#### `test_micros_to_nanos(#[case] value: f64, #[case] expected: u64)`


#### `test_nanos_to_secs(#[case] value: u64, #[case] expected: f64)`


#### `test_nanos_to_millis(#[case] value: u64, #[case] expected: u64)`


#### `test_nanos_to_micros(#[case] value: u64, #[case] expected: u64)`


#### `test_unix_nanos_to_iso8601(#[case] nanos: u64, #[case] expected: &str)`


#### `test_unix_nanos_to_iso8601_millis(#[case] nanos: u64, #[case] expected: &str)`


#### `test_last_closest_weekday_nanos_with_valid_date(
        #[case] year: i32,
        #[case] month: u32,
        #[case] day: u32,
        #[case] expected: u64,
...
#### `test_last_closest_weekday_nanos_with_invalid_date()`


#### `test_last_closest_weekday_nanos_with_nonexistent_date()`


#### `test_last_closest_weekday_nanos_with_invalid_conversion()`


#### `test_is_within_last_24_hours_when_now()`


#### `test_is_within_last_24_hours_when_two_days_ago()`


#### `test_is_within_last_24_hours_when_future()`


#### `test_subtract_n_months(
        #[case] input: DateTime<Utc>,
        #[case] months: u32,
        #[case] expected: DateTime<Utc>,
    )`
...
#### `test_subtract_n_years_overflow()`


#### `test_add_n_years_nanos_overflow()`


#### `test_last_day_of_month(#[case] year: i32, #[case] month: u32, #[case] expected: u32)`


#### `test_is_leap_year(#[case] year: i32, #[case] expected: bool)`


#### `test_iso8601_to_unix_nanos(#[case] input: &str, #[case] expected: u64)`


#### `test_iso8601_to_unix_nanos_invalid(#[case] input: &str)`
