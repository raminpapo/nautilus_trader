...
This file is part of the NautilusTrader repository. It defines 52 function(s).
...
- **`unix_nanos_to_iso8601()`**: Function defined in this file
- **`iso8601_to_unix_nanos()`**: Function defined in this file
- **`unix_nanos_to_iso8601_millis()`**: Function defined in this file
- **`floor_to_nearest_microsecond()`**: Function defined in this file
- **`last_weekday_nanos()`**: Function defined in this file
- **`is_within_last_24_hours()`**: Function defined in this file
- **`subtract_n_months()`**: Function defined in this file
- **`add_n_months()`**: Function defined in this file
- **`subtract_n_months_nanos()`**: Function defined in this file
- **`add_n_months_nanos()`**: Function defined in this file
- **`add_n_years()`**: Function defined in this file
- **`subtract_n_years()`**: Function defined in this file
- **`add_n_years_nanos()`**: Function defined in this file
...
**Functions**: `add_n_months`, `add_n_months_nanos`, `add_n_years`, `add_n_years_nanos`, `floor_to_nearest_microsecond`, `is_leap_year`, `is_within_last_24_hours`, `iso8601_to_unix_nanos`, `last_day_of_month`, `last_weekday_nanos`, `micros_to_nanos`, `millis_to_nanos`, `nanos_to_micros`, `nanos_to_millis`, `nanos_to_secs`, `secs_to_millis`, `secs_to_nanos`, `subtract_n_months`, `subtract_n_months_nanos`, `subtract_n_years`, `subtract_n_years_nanos`, `test_add_n_months`, `test_add_n_years_nanos_normal_case`, `test_add_n_years_nanos_overflow`, `test_add_n_years_nanos_prevents_negative_timestamp`, `test_add_n_years_overflow`, `test_is_leap_year`, `test_is_within_last_24_hours_when_future`, `test_is_within_last_24_hours_when_now`, `test_is_within_last_24_hours_when_two_days_ago` *(+22 more)*
...
---
*Generated on 2025-11-18T21:55:01.365692Z*
