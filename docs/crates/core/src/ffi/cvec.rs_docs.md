# Documentation: cvec.rs

## File Metadata

- **Path**: `crates/core/src/ffi/cvec.rs`
- **Size**: 7,052 bytes
- **Lines**: 184
- **Language**: Rust
...
This file is part of the NautilusTrader repository. It defines 6 function(s) and 4 class(es).

## Detailed Walkthrough

### Functions
- **`empty()`**: Function defined in this file
- **`from()`**: Function defined in this file
- **`fmt()`**: Function defined in this file
- **`cvec_new()`**: Function defined in this file
- **`access_values_test()`**: Function defined in this file
- **`empty_vec_should_give_null_ptr()`**: Function defined in this file

### Classes
- **`that`**: Class defined in this file
- **`that`**: Class defined in this file
- **`CVec`**: Class defined in this file
- **`and`**: Class defined in this file
...
**Functions**: `access_values_test`, `cvec_new`, `empty`, `empty_vec_should_give_null_ptr`, `fmt`, `from`
**Impls**: `CVec`, `Display`, `From`, `Send`, `is`
**Structs**: `CVec`, `and`, `that`
...
---
*Generated on 2025-11-18T21:55:01.373834Z*
