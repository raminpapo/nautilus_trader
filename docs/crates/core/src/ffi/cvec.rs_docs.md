# Documentation: `crates/core/src/ffi/cvec.rs`
**Generated:** 2025-11-15T19:40:01.884456Z
**File Size:** 7056 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/core/src/ffi/cvec.rs` within the repository.

**Classes defined:** that, that, CVec, and, is, Send, CVec, Display

**Functions defined:** empty, from, fmt, cvec_new, access_values_test, empty_vec_should_give_null_ptr
