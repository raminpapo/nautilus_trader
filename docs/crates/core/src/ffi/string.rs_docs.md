# Documentation: string.rs

## File Metadata

- **Path**: `crates/core/src/ffi/string.rs`
- **Size**: 8,421 bytes
- **Lines**: 270
- **Language**: Rust
...
### Functions
- **`pystr_to_string()`**: Function defined in this file
- **`cstr_to_ustr()`**: Function defined in this file
- **`cstr_to_bytes()`**: Function defined in this file
- **`optional_cstr_to_ustr()`**: Function defined in this file
- **`cstr_as_str()`**: Function defined in this file
- **`optional_cstr_to_str()`**: Function defined in this file
- **`str_to_cstr()`**: Function defined in this file
- **`cstr_drop()`**: Function defined in this file
- **`test_pystr_to_string()`**: Function defined in this file
- **`test_pystr_to_string_with_null_ptr()`**: Function defined in this file
- **`test_cstr_as_str()`**: Function defined in this file
- **`test_cstr_to_bytes()`**: Function defined in this file
- **`test_cstr_to_bytes_with_null_ptr()`**: Function defined in this file
- **`test_optional_cstr_to_str_with_null_ptr()`**: Function defined in this file
- **`test_optional_cstr_to_str_with_valid_ptr()`**: Function defined in this file
- **`test_string_to_cstr()`**: Function defined in this file
- **`test_cstr_drop()`**: Function defined in this file
...
**Functions**: `cstr_as_str`, `cstr_drop`, `cstr_to_bytes`, `cstr_to_ustr`, `optional_cstr_to_str`, `optional_cstr_to_ustr`, `pystr_to_string`, `str_to_cstr`, `test_cstr_as_str`, `test_cstr_drop`, `test_cstr_to_bytes`, `test_cstr_to_bytes_with_null_ptr`, `test_optional_cstr_to_str_with_null_ptr`, `test_optional_cstr_to_str_with_valid_ptr`, `test_pystr_to_string`, `test_pystr_to_string_with_null_ptr`, `test_string_to_cstr`
...
---
*Generated on 2025-11-18T21:55:01.384310Z*
