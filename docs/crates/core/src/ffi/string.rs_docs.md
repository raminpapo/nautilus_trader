# Documentation: `crates/core/src/ffi/string.rs`
**Generated:** 2025-11-15T19:40:01.895372Z
...
This file is located at `crates/core/src/ffi/string.rs` within the repository.

**Functions defined:** pystr_to_string, cstr_to_ustr, cstr_to_bytes, optional_cstr_to_ustr, cstr_as_str, optional_cstr_to_str, str_to_cstr, cstr_drop, test_pystr_to_string, test_pystr_to_string_with_null_ptr and 7 more
...
#### `pystr_to_string(ptr: *mut ffi::PyObject)`


#### `cstr_to_ustr(ptr: *const c_char)`


#### `cstr_to_bytes(ptr: *const c_char)`


#### `optional_cstr_to_ustr(ptr: *const c_char)`


#### `cstr_as_str(ptr: *const c_char)`


#### `optional_cstr_to_str(ptr: *const c_char)`


#### `str_to_cstr(s: &str)`


#### `cstr_drop(ptr: *const c_char)`


#### `test_pystr_to_string()`


#### `test_pystr_to_string_with_null_ptr()`
