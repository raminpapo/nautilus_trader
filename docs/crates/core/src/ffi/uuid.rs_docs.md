...
- **Path**: `crates/core/src/ffi/uuid.rs`
- **Size**: 4,880 bytes
- **Lines**: 137
- **Language**: Rust
...
### Functions
- **`uuid4_new()`**: Function defined in this file
- **`uuid4_from_cstr()`**: Function defined in this file
- **`uuid4_to_cstr()`**: Function defined in this file
- **`uuid4_eq()`**: Function defined in this file
- **`uuid4_hash()`**: Function defined in this file
- **`test_new()`**: Function defined in this file
- **`test_from_cstr()`**: Function defined in this file
- **`test_to_cstr()`**: Function defined in this file
- **`test_eq()`**: Function defined in this file
...
**Functions**: `test_eq`, `test_from_cstr`, `test_hash`, `test_new`, `test_to_cstr`, `uuid4_eq`, `uuid4_from_cstr`, `uuid4_hash`, `uuid4_new`, `uuid4_to_cstr`
...
---
*Generated on 2025-11-18T21:55:01.387691Z*
