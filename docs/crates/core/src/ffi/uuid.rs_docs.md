# Documentation: `crates/core/src/ffi/uuid.rs`
**Generated:** 2025-11-15T19:40:01.898098Z
...
This file is located at `crates/core/src/ffi/uuid.rs` within the repository.

**Functions defined:** uuid4_new, uuid4_from_cstr, uuid4_to_cstr, uuid4_eq, uuid4_hash, test_new, test_from_cstr, test_to_cstr, test_eq, test_hash
...
#### `uuid4_from_cstr(ptr: *const c_char)`


#### `uuid4_to_cstr(uuid: &UUID4)`


#### `uuid4_eq(lhs: &UUID4, rhs: &UUID4)`


#### `uuid4_hash(uuid: &UUID4)`
