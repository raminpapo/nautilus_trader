# Documentation: `crates/core/src/ffi/parsing.rs`
**Generated:** 2025-11-15T19:40:01.892247Z
...
This file is located at `crates/core/src/ffi/parsing.rs` within the repository.

**Functions defined:** bytes_to_string_vec, string_vec_to_bytes, optional_bytes_to_json, optional_bytes_to_str_map, optional_bytes_to_str_vec, precision_from_cstr, min_increment_precision_from_cstr, u8_as_bool, test_optional_bytes_to_json_null, test_optional_bytes_to_json_empty and 7 more
...
#### `bytes_to_string_vec(ptr: *const c_char)`


#### `string_vec_to_bytes(strings: &[String])`


#### `optional_bytes_to_json(ptr: *const c_char)`


#### `optional_bytes_to_str_map(ptr: *const c_char)`


#### `optional_bytes_to_str_vec(ptr: *const c_char)`


#### `precision_from_cstr(ptr: *const c_char)`


#### `min_increment_precision_from_cstr(ptr: *const c_char)`


#### `u8_as_bool(value: u8)`


#### `test_optional_bytes_to_json_null()`


#### `test_optional_bytes_to_json_empty()`


#### `test_string_vec_to_bytes_valid()`


#### `test_string_vec_to_bytes_empty()`
...
#### `test_optional_bytes_to_json_valid()`


#### `test_optional_bytes_to_json_invalid()`


#### `test_precision_from_cstr(#[case] input: &str, #[case] expected: u8)`
