...
### Functions
- **`linear_weight()`**: Function defined in this file
- **`linear_weighting()`**: Function defined in this file
- **`pos_search()`**: Function defined in this file
- **`quad_polynomial()`**: Function defined in this file
- **`quadratic_interpolation()`**: Function defined in this file
- **`test_linear_weight_valid_cases()`**: Function defined in this file
- **`test_linear_weight_zero_divisor()`**: Function defined in this file
- **`test_linear_weight_near_equal_values()`**: Function defined in this file
- **`test_linear_weight_with_small_differences()`**: Function defined in this file
- **`test_linear_weight_just_above_epsilon()`**: Function defined in this file
- **`test_linear_weighting()`**: Function defined in this file
- **`test_pos_search()`**: Function defined in this file
- **`test_pos_search_edge_cases()`**: Function defined in this file
- **`test_pos_search_empty_slice()`**: Function defined in this file
- **`test_quad_polynomial_linear_case()`**: Function defined in this file
- **`test_quad_polynomial_parabola()`**: Function defined in this file
- **`test_quad_polynomial_duplicate_x()`**: Function defined in this file
- **`test_quad_polynomial_near_equal_x_values()`**: Function defined in this file
- **`test_quad_polynomial_with_small_differences()`**: Function defined in this file
- **`test_quad_polynomial_just_above_epsilon()`**: Function defined in this file
...
**Functions**: `linear_weight`, `linear_weighting`, `pos_search`, `quad_polynomial`, `quadratic_interpolation`, `test_linear_weight_just_above_epsilon`, `test_linear_weight_near_equal_values`, `test_linear_weight_valid_cases`, `test_linear_weight_with_small_differences`, `test_linear_weight_zero_divisor`, `test_linear_weighting`, `test_pos_search`, `test_pos_search_edge_cases`, `test_pos_search_empty_slice`, `test_quad_polynomial_duplicate_x`, `test_quad_polynomial_just_above_epsilon`, `test_quad_polynomial_linear_case`, `test_quad_polynomial_near_equal_x_values`, `test_quad_polynomial_parabola`, `test_quad_polynomial_with_small_differences`, `test_quadratic_interpolation_boundary_conditions`, `test_quadratic_interpolation_exact_points`, `test_quadratic_interpolation_insufficient_points`, `test_quadratic_interpolation_intermediate_values`, `test_quadratic_interpolation_mismatched_lengths`
...
---
*Generated on 2025-11-18T21:55:01.394610Z*
