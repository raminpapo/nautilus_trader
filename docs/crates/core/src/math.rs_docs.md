# Documentation: `crates/core/src/math.rs`
**Generated:** 2025-11-15T19:40:01.903770Z
...
This file is located at `crates/core/src/math.rs` within the repository.

**Functions defined:** linear_weight, linear_weighting, pos_search, quad_polynomial, quadratic_interpolation, test_linear_weight_valid_cases, test_linear_weight_zero_divisor, test_linear_weight_near_equal_values, test_linear_weight_with_small_differences, test_linear_weight_just_above_epsilon and 15 more
...
#### `linear_weight(x1: f64, x2: f64, x: f64)`


#### `linear_weighting(y1: f64, y2: f64, x1_diff: f64)`


#### `pos_search(x: f64, xs: &[f64])`


#### `quad_polynomial(x: f64, x0: f64, x1: f64, x2: f64, y0: f64, y1: f64, y2: f64)`


#### `quadratic_interpolation(x: f64, xs: &[f64], ys: &[f64])`


#### `test_linear_weight_valid_cases(
        #[case] x1: f64,
        #[case] x2: f64,
        #[case] x: f64,
        #[case] expected: f64,
...
#### `test_linear_weight_zero_divisor()`


#### `test_linear_weight_near_equal_values()`


#### `test_linear_weight_with_small_differences()`


#### `test_linear_weight_just_above_epsilon()`
...
#### `test_pos_search(#[case] x: f64, #[case] xs: &[f64], #[case] expected: usize)`


#### `test_pos_search_edge_cases()`


#### `test_pos_search_empty_slice()`


#### `test_quad_polynomial_linear_case()`


#### `test_quad_polynomial_parabola()`


#### `test_quad_polynomial_duplicate_x()`


#### `test_quad_polynomial_near_equal_x_values()`


#### `test_quad_polynomial_with_small_differences()`


#### `test_quad_polynomial_just_above_epsilon()`


#### `test_quadratic_interpolation_boundary_conditions()`


#### `test_quadratic_interpolation_exact_points()`


#### `test_quadratic_interpolation_intermediate_values()`


#### `test_quadratic_interpolation_insufficient_points()`


#### `test_quadratic_interpolation_mismatched_lengths()`
