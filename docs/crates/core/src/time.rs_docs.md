...
This file is part of the NautilusTrader repository. It defines 35 function(s) and 2 class(es).

## Detailed Walkthrough

### Functions
- **`get_atomic_clock_realtime()`**: Function defined in this file
- **`get_atomic_clock_static()`**: Function defined in this file
- **`duration_since_unix_epoch()`**: Function defined in this file
- **`nanos_since_unix_epoch()`**: Function defined in this file
- **`deref()`**: Function defined in this file
- **`default()`**: Function defined in this file
- **`new()`**: Function defined in this file
- **`get_time_ns()`**: Function defined in this file
- **`get_time_us()`**: Function defined in this file
- **`get_time_ms()`**: Function defined in this file
- **`get_time()`**: Function defined in this file
- **`set_time()`**: Function defined in this file
- **`increment_time()`**: Function defined in this file
- **`time_since_epoch()`**: Function defined in this file
- **`make_realtime()`**: Function defined in this file
- **`make_static()`**: Function defined in this file
- **`test_global_clocks_initialization()`**: Function defined in this file
- **`test_mode_switching()`**: Function defined in this file
- **`test_set_time_panics_in_realtime_mode()`**: Function defined in this file
- **`test_increment_time_panics_in_realtime_mode()`**: Function defined in this file

*...and 15 more functions*

### Classes
- **`uses`**: Class defined in this file
- **`AtomicTime`**: Class defined in this file
...
**Functions**: `default`, `deref`, `duration_since_unix_epoch`, `get_atomic_clock_realtime`, `get_atomic_clock_static`, `get_time`, `get_time_ms`, `get_time_ns`, `get_time_us`, `increment_time`, `make_realtime`, `make_static`, `nanos_since_unix_epoch`, `new`, `set_time`, `test_acquire_release_contract_increment_time`, `test_acquire_release_contract_static_mode`, `test_duration_since_unix_epoch`, `test_global_clocks_initialization`, `test_increment_time`, `test_increment_time_overflow_errors`, `test_increment_time_panics_in_realtime_mode`, `test_mode_switching`, `test_mode_switching_concurrent`, `test_nanos_since_unix_epoch_vs_system_time`, `test_set_time_panics_in_realtime_mode`, `test_static_time_is_stable`, `test_time_since_epoch_monotonicity`, `test_time_since_epoch_overflow_panics`, `test_time_since_epoch_strictly_increasing_concurrent` *(+5 more)*
**Impls**: `AtomicTime`, `Default`, `Deref`
**Structs**: `AtomicTime`, `uses`
...
---
*Generated on 2025-11-18T21:55:01.448948Z*
