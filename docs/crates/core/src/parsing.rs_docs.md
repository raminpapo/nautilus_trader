# Documentation: `crates/core/src/parsing.rs`
**Generated:** 2025-11-15T19:40:01.916802Z
**File Size:** 10449 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/core/src/parsing.rs` within the repository.

**Functions defined:** clamp_precision_with_log, parse_scientific_exponent, precision_from_str, min_increment_precision_from_str, bytes_to_usize, test_precision_from_str, test_min_increment_precision_from_str, test_bytes_to_usize_empty, test_bytes_to_usize_invalid, test_bytes_to_usize_valid and 11 more
...
#### `clamp_precision_with_log(len: usize, context: &str, input: &str)`


#### `parse_scientific_exponent(exponent_str: &str, strict: bool)`


#### `precision_from_str(s: &str)`


#### `min_increment_precision_from_str(s: &str)`


#### `bytes_to_usize(bytes: &[u8])`


#### `test_precision_from_str(#[case] s: &str, #[case] expected: u8)`


#### `test_min_increment_precision_from_str(#[case] s: &str, #[case] expected: u8)`
...
#### `test_precision_from_str_large_exponent_clamped()`


#### `test_precision_from_str_very_large_exponent_clamped()`


#### `test_precision_from_str_invalid_exponent_not_numeric()`


#### `test_precision_from_str_malformed_scientific_notation()`


#### `test_precision_from_str_edge_case_max_u8()`


#### `test_precision_from_str_just_above_max_u8()`


#### `test_precision_from_str_u32_overflow()`


#### `test_precision_from_str_u64_overflow()`


#### `test_min_increment_precision_from_str_large_exponent()`


#### `test_min_increment_precision_from_str_very_large_exponent()`


#### `test_min_increment_precision_from_str_consistency()`
