# Documentation: parsing.rs

## File Metadata

- **Path**: `crates/core/src/parsing.rs`
- **Size**: 10,449 bytes
- **Lines**: 312
- **Language**: Rust
...
### Functions
- **`clamp_precision_with_log()`**: Function defined in this file
- **`parse_scientific_exponent()`**: Function defined in this file
- **`precision_from_str()`**: Function defined in this file
- **`min_increment_precision_from_str()`**: Function defined in this file
- **`bytes_to_usize()`**: Function defined in this file
- **`test_precision_from_str()`**: Function defined in this file
- **`test_min_increment_precision_from_str()`**: Function defined in this file
- **`test_bytes_to_usize_empty()`**: Function defined in this file
- **`test_bytes_to_usize_invalid()`**: Function defined in this file
- **`test_bytes_to_usize_valid()`**: Function defined in this file
- **`test_precision_from_str_large_exponent_clamped()`**: Function defined in this file
- **`test_precision_from_str_very_large_exponent_clamped()`**: Function defined in this file
- **`test_precision_from_str_invalid_exponent_not_numeric()`**: Function defined in this file
- **`test_precision_from_str_malformed_scientific_notation()`**: Function defined in this file
- **`test_precision_from_str_edge_case_max_u8()`**: Function defined in this file
- **`test_precision_from_str_just_above_max_u8()`**: Function defined in this file
- **`test_precision_from_str_u32_overflow()`**: Function defined in this file
- **`test_precision_from_str_u64_overflow()`**: Function defined in this file
- **`test_min_increment_precision_from_str_large_exponent()`**: Function defined in this file
- **`test_min_increment_precision_from_str_very_large_exponent()`**: Function defined in this file
...
**Functions**: `bytes_to_usize`, `clamp_precision_with_log`, `min_increment_precision_from_str`, `parse_scientific_exponent`, `precision_from_str`, `test_bytes_to_usize_empty`, `test_bytes_to_usize_invalid`, `test_bytes_to_usize_valid`, `test_min_increment_precision_from_str`, `test_min_increment_precision_from_str_consistency`, `test_min_increment_precision_from_str_large_exponent`, `test_min_increment_precision_from_str_very_large_exponent`, `test_precision_from_str`, `test_precision_from_str_edge_case_max_u8`, `test_precision_from_str_invalid_exponent_not_numeric`, `test_precision_from_str_just_above_max_u8`, `test_precision_from_str_large_exponent_clamped`, `test_precision_from_str_malformed_scientific_notation`, `test_precision_from_str_u32_overflow`, `test_precision_from_str_u64_overflow`, `test_precision_from_str_very_large_exponent_clamped`
...
---
*Generated on 2025-11-18T21:55:01.413180Z*
