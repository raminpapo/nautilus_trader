# Documentation: `crates/core/src/python/serialization.rs`
**Generated:** 2025-11-15T19:40:01.931871Z
...
This file is located at `crates/core/src/python/serialization.rs` within the repository.

**Functions defined:** from_dict_pyo3, to_dict_pyo3
...
#### `from_dict_pyo3(py: Python<'_>, values: Py<PyDict>)`


#### `to_dict_pyo3(py: Python<'_>, value: &T)`
