# Documentation: `crates/core/src/python/mod.rs`
**Generated:** 2025-11-15T19:40:01.926467Z
...
This file is located at `crates/core/src/python/mod.rs` within the repository.

**Classes defined:** Display, Display, Display

**Functions defined:** clone_py_object, into_py_any_unwrap, get_pytype_name, to_pyvalue_err, to_pytype_err, to_pyruntime_err, py_is_pycapsule, core
...
#### `clone_py_object(obj: &Py<PyAny>)`


#### `into_py_any_unwrap(self, py: Python<'py>)`


#### `get_pytype_name(obj: &Bound<'py, PyAny>)`


#### `to_pyvalue_err(e: impl Display)`


#### `to_pytype_err(e: impl Display)`


#### `to_pyruntime_err(e: impl Display)`


#### `py_is_pycapsule(obj: Py<PyAny>)`


#### `core(_: Python<'_>, m: &Bound<'_, PyModule>)`
