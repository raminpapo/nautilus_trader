...
- **Path**: `crates/core/src/python/uuid.rs`
- **Size**: 6,820 bytes
- **Lines**: 206
- **Language**: Rust
...
- **`ensure_python_initialized()`**: Function defined in this file
- **`test_setstate_rejects_invalid_uuid_bytes()`**: Function defined in this file
- **`test_setstate_rejects_missing_null_terminator()`**: Function defined in this file
- **`test_setstate_accepts_valid_state()`**: Function defined in this file
...
**Functions**: `__getstate__`, `__hash__`, `__reduce__`, `__repr__`, `__richcmp__`, `__setstate__`, `__str__`, `_safe_constructor`, `ensure_python_initialized`, `py_from_str`, `py_new`, `py_value`, `test_setstate_accepts_valid_state`, `test_setstate_rejects_invalid_uuid_bytes`, `test_setstate_rejects_missing_null_terminator`
**Impls**: `UUID4`
...
---
*Generated on 2025-11-18T21:55:01.432724Z*
