# Documentation: `crates/core/src/python/uuid.rs`
**Generated:** 2025-11-15T19:40:01.933955Z
**File Size:** 6790 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/core/src/python/uuid.rs` within the repository.

**Classes defined:** UUID4

**Functions defined:** py_new, __setstate__, __getstate__, __reduce__, _safe_constructor, __richcmp__, __hash__, __repr__, __str__, py_value and 5 more
...
#### `__setstate__(&mut self, py: Python<'_>, state: Py<PyAny>)`


#### `__getstate__(&self, py: Python<'_>)`


#### `__reduce__(&self, py: Python<'_>)`
...
#### `test_setstate_rejects_invalid_uuid_bytes()`


#### `test_setstate_rejects_missing_null_terminator()`


#### `test_setstate_accepts_valid_state()`
