# Documentation: `crates/core/src/python/datetime.rs`
**Generated:** 2025-11-15T19:40:01.922389Z
...
This file is located at `crates/core/src/python/datetime.rs` within the repository.

**Functions defined:** py_secs_to_nanos, py_secs_to_millis, py_millis_to_nanos, py_micros_to_nanos, py_nanos_to_secs, py_nanos_to_millis, py_nanos_to_micros, py_unix_nanos_to_iso8601, py_last_weekday_nanos, py_is_within_last_24_hours and 2 more
...
#### `py_secs_to_nanos(secs: f64)`


#### `py_secs_to_millis(secs: f64)`


#### `py_millis_to_nanos(millis: f64)`


#### `py_micros_to_nanos(micros: f64)`


#### `py_nanos_to_secs(nanos: u64)`


#### `py_nanos_to_millis(nanos: u64)`


#### `py_nanos_to_micros(nanos: u64)`
...
#### `py_last_weekday_nanos(year: i32, month: u32, day: u32)`


#### `py_is_within_last_24_hours(timestamp_ns: u64)`
