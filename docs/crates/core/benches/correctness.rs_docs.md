...
- **Path**: `crates/core/benches/correctness.rs`
- **Size**: 4,104 bytes
- **Lines**: 117
- **Language**: Rust
...
### Functions
- **`bench_check_predicate_true()`**: Function defined in this file
- **`bench_check_predicate_false()`**: Function defined in this file
- **`bench_check_valid_string_ascii()`**: Function defined in this file
- **`bench_check_valid_string_ascii_optional()`**: Function defined in this file
- **`bench_check_string_contains()`**: Function defined in this file
- **`bench_check_equal()`**: Function defined in this file
- **`bench_check_in_range_inclusive_u8()`**: Function defined in this file
- **`bench_check_in_range_inclusive_u64()`**: Function defined in this file
- **`bench_check_map_empty()`**: Function defined in this file
- **`bench_check_map_not_empty()`**: Function defined in this file
- **`bench_check_key_in_map()`**: Function defined in this file
- **`bench_check_key_not_in_map()`**: Function defined in this file
- **`bench_check_index_map_in()`**: Function defined in this file
- **`bench_check_index_map_not_in()`**: Function defined in this file
- **`bench_check_member_in_set()`**: Function defined in this file
- **`bench_check_member_not_in_set()`**: Function defined in this file
...
**Functions**: `bench_check_equal`, `bench_check_in_range_inclusive_u64`, `bench_check_in_range_inclusive_u8`, `bench_check_index_map_in`, `bench_check_index_map_not_in`, `bench_check_key_in_map`, `bench_check_key_not_in_map`, `bench_check_map_empty`, `bench_check_map_not_empty`, `bench_check_member_in_set`, `bench_check_member_not_in_set`, `bench_check_predicate_false`, `bench_check_predicate_true`, `bench_check_string_contains`, `bench_check_valid_string_ascii`, `bench_check_valid_string_ascii_optional`
...
---
*Generated on 2025-11-18T21:55:01.332121Z*
