# Documentation: test_catalog.rs

## File Metadata

- **Path**: `crates/persistence/tests/test_catalog.rs`
- **Size**: 79,410 bytes
- **Lines**: 2,553
- **Language**: Rust
...
This file is part of the NautilusTrader repository. It defines 94 function(s) and 1 class(es).

## Detailed Walkthrough

### Functions
- **`test_quote_tick_query()`**: Function defined in this file
- **`test_quote_tick_query_with_filter()`**: Function defined in this file
- **`test_quote_tick_multiple_query()`**: Function defined in this file
- **`test_trade_tick_query()`**: Function defined in this file
- **`test_bar_query()`**: Function defined in this file
- **`test_datafusion_parquet_round_trip()`**: Function defined in this file
- **`create_temp_catalog()`**: Function defined in this file
- **`audusd_sim_id()`**: Function defined in this file
- **`ethusdt_binance_id()`**: Function defined in this file
...
- **`create_order_book_delta()`**: Function defined in this file
- **`create_order_book_depth10()`**: Function defined in this file
- **`create_mark_price_update()`**: Function defined in this file
- **`create_index_price_update()`**: Function defined in this file
- **`test_rust_write_2_bars_to_catalog()`**: Function defined in this file
- **`test_rust_append_data_to_catalog()`**: Function defined in this file
- **`test_rust_consolidate_catalog()`**: Function defined in this file
- **`test_rust_consolidate_catalog_with_time_range()`**: Function defined in this file

*...and 74 more functions*

### Classes
- **`DummyData`**: Class defined in this file


## Keywords and Identifiers

Total unique keywords extracted: 96


**Functions**: `audusd_sim_id`, `create_bar`, `create_index_price_update`, `create_mark_price_update`, `create_order_book_delta`, `create_order_book_depth10`, `create_quote_tick`, `create_quote_ticks_for_instrument`, `create_temp_catalog`, `create_trade_tick`, `ethusdt_binance_id`, `test_bar_query`, `test_catalog_query_multiple_instruments_table_naming`, `test_check_ascending_timestamps_error`, `test_consolidate_catalog_by_period_basic`, `test_consolidate_catalog_by_period_default_parameters`, `test_consolidate_catalog_by_period_empty_catalog`, `test_consolidate_catalog_by_period_with_time_range`, `test_consolidate_data_by_period_basic`, `test_consolidate_data_by_period_different_periods`, `test_consolidate_data_by_period_empty_data`, `test_consolidate_data_by_period_ensure_contiguous_files_false`, `test_consolidate_data_by_period_invalid_type`, `test_consolidate_data_by_period_multiple_instruments`, `test_consolidate_data_by_period_with_time_range`, `test_consolidation_preserves_data_integrity`, `test_consolidation_workflow_end_to_end`, `test_datafusion_parquet_round_trip`, `test_delete_catalog_range_complete_deletion`, `test_delete_catalog_range_empty_catalog` *(+64 more)*
**Impls**: `nautilus_model`
**Structs**: `DummyData`

## Related Files

This file is located in `crates/persistence/tests/`. Related files may include:
...
```bash
# For Python
pytest crates/persistence/tests/test_catalog.rs
...
---
*Generated on 2025-11-18T21:55:03.584767Z*
