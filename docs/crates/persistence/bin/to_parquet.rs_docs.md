# Documentation: `crates/persistence/bin/to_parquet.rs`
**Generated:** 2025-11-15T19:40:03.306875Z
...
- **Path:** `crates/persistence/bin/to_parquet.rs`
- **Size:** 4,730 bytes
- **Lines:** 125
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/persistence/bin/to_parquet.rs` within the repository.

**Functions defined:** determine_data_type, main, process_data
...
#### `determine_data_type(file_name: &str)`


#### `main()`


#### `process_data(json_path: &PathBuf)`
...
**Directory:** `crates/persistence/bin`
