# Documentation: parquet.rs

## File Metadata

- **Path**: `crates/persistence/src/parquet.rs`
- **Size**: 33,006 bytes
- **Lines**: 902
- **Language**: Rust
...
### Functions
- **`write_batch_to_parquet()`**: Function defined in this file
- **`write_batches_to_parquet()`**: Function defined in this file
- **`write_batches_to_object_store()`**: Function defined in this file
- **`combine_parquet_files()`**: Function defined in this file
- **`combine_parquet_files_from_object_store()`**: Function defined in this file
- **`min_max_from_parquet_metadata()`**: Function defined in this file
- **`min_max_from_parquet_metadata_object_store()`**: Function defined in this file
- **`create_object_store_from_path()`**: Function defined in this file
- **`normalize_path_to_uri()`**: Function defined in this file
- **`is_absolute_path()`**: Function defined in this file
- **`path_to_file_uri()`**: Function defined in this file
- **`create_local_store()`**: Function defined in this file
- **`create_s3_store()`**: Function defined in this file
- **`create_gcs_store()`**: Function defined in this file
- **`create_azure_store()`**: Function defined in this file
- **`create_abfs_store()`**: Function defined in this file
- **`create_http_store()`**: Function defined in this file
- **`parse_url_and_path()`**: Function defined in this file
- **`extract_host()`**: Function defined in this file
- **`test_create_object_store_from_path_local()`**: Function defined in this file
...
**Functions**: `combine_parquet_files`, `combine_parquet_files_from_object_store`, `create_abfs_store`, `create_azure_store`, `create_gcs_store`, `create_http_store`, `create_local_store`, `create_object_store_from_path`, `create_s3_store`, `extract_host`, `is_absolute_path`, `min_max_from_parquet_metadata`, `min_max_from_parquet_metadata_object_store`, `normalize_path_to_uri`, `parse_url_and_path`, `path_to_file_uri`, `test_create_object_store_from_path_azure`, `test_create_object_store_from_path_empty_options`, `test_create_object_store_from_path_gcs`, `test_create_object_store_from_path_local`, `test_create_object_store_from_path_s3`, `test_extract_host`, `test_is_absolute_path`, `test_normalize_path_to_uri`, `test_parse_url_and_path`, `test_path_to_file_uri`, `write_batch_to_parquet`, `write_batches_to_object_store`, `write_batches_to_parquet`
...
---
*Generated on 2025-11-18T21:55:03.551602Z*
