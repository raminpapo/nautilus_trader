# Documentation: `crates/persistence/src/parquet.rs`
**Generated:** 2025-11-15T19:40:03.342753Z
**File Size:** 33012 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/persistence/src/parquet.rs` within the repository.

**Functions defined:** write_batch_to_parquet, write_batches_to_parquet, write_batches_to_object_store, combine_parquet_files, combine_parquet_files_from_object_store, min_max_from_parquet_metadata, min_max_from_parquet_metadata_object_store, create_object_store_from_path, normalize_path_to_uri, is_absolute_path and 19 more
...
#### `normalize_path_to_uri(path: &str)`


#### `is_absolute_path(path: &str)`


#### `path_to_file_uri(path: &str)`
...
#### `parse_url_and_path(uri: &str)`


#### `extract_host(url: &url::Url, error_msg: &str)`


#### `test_create_object_store_from_path_local()`


#### `test_create_object_store_from_path_s3()`


#### `test_create_object_store_from_path_azure()`


#### `test_create_object_store_from_path_gcs()`


#### `test_create_object_store_from_path_empty_options()`


#### `test_parse_url_and_path()`


#### `test_extract_host()`


#### `test_normalize_path_to_uri()`


#### `test_is_absolute_path()`


#### `test_path_to_file_uri()`
