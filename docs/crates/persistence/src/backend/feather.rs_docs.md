# Documentation: `crates/persistence/src/backend/feather.rs`
**Generated:** 2025-11-15T19:40:03.328918Z
**File Size:** 19447 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/persistence/src/backend/feather.rs` within the repository.

**Classes defined:** FileWriterPath, FeatherBuffer, FeatherWriter, FeatherBuffer, FeatherWriter

**Functions defined:** new, write_record_batch, take_buffer, should_rotate, new, write, rotate_writer, create_writer, flush, should_write and 5 more
...
#### `new(schema: &Schema, rotation_config: RotationConfig)`


#### `write_record_batch(&mut self, batch: &RecordBatch)`


#### `take_buffer(&mut self)`
...
#### `create_writer(&mut self, path: FileWriterPath, data: &T)`
...
#### `get_writer_path(&self, data: &T)`


#### `test_writer_manager_keys()`


#### `test_file_writer_round_trip()`
