# Documentation: feather.rs

## File Metadata

- **Path**: `crates/persistence/src/backend/feather.rs`
- **Size**: 19,447 bytes
- **Lines**: 528
- **Language**: Rust
...
This file is part of the NautilusTrader repository. It defines 15 function(s) and 3 class(es).

## Detailed Walkthrough

### Functions
- **`new()`**: Function defined in this file
- **`write_record_batch()`**: Function defined in this file
- **`take_buffer()`**: Function defined in this file
- **`should_rotate()`**: Function defined in this file
- **`new()`**: Function defined in this file
- **`write()`**: Function defined in this file
- **`rotate_writer()`**: Function defined in this file
- **`create_writer()`**: Function defined in this file
- **`flush()`**: Function defined in this file
- **`should_write()`**: Function defined in this file
- **`regen_writer_path()`**: Function defined in this file
- **`get_writer_path()`**: Function defined in this file
- **`test_writer_manager_keys()`**: Function defined in this file
- **`test_file_writer_round_trip()`**: Function defined in this file
- **`test_round_trip()`**: Function defined in this file

### Classes
- **`FileWriterPath`**: Class defined in this file
- **`FeatherBuffer`**: Class defined in this file
- **`FeatherWriter`**: Class defined in this file
...
**Enums**: `RotationConfig`
**Functions**: `create_writer`, `flush`, `get_writer_path`, `new`, `regen_writer_path`, `rotate_writer`, `should_rotate`, `should_write`, `take_buffer`, `test_file_writer_round_trip`, `test_round_trip`, `test_writer_manager_keys`, `write`, `write_record_batch`
**Impls**: `FeatherBuffer`, `FeatherWriter`
**Structs**: `FeatherBuffer`, `FeatherWriter`, `FileWriterPath`
...
---
*Generated on 2025-11-18T21:55:03.532308Z*
