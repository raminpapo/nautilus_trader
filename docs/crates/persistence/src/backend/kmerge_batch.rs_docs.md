# Documentation: `crates/persistence/src/backend/kmerge_batch.rs`
**Generated:** 2025-11-15T19:40:03.331483Z
...
This file is located at `crates/persistence/src/backend/kmerge_batch.rs` within the repository.

**Classes defined:** EagerStream, ElementBatchIter, KMerge, OrdComparator, SortedNestedVec, Strategy

**Functions defined:** from_stream_with_runtime, next, drop, new_from_iter, new, push_iter, clear, next, compare, compare and 8 more
...
#### `from_stream_with_runtime(stream: S, runtime: Arc<Runtime>)`
...
#### `new_from_iter(mut iter: I)`


#### `new(cmp: C)`


#### `push_iter(&mut self, s: I)`
...
#### `sorted_nested_vec_strategy()`


#### `prop_kmerge_equivalent_to_sort(
            all_data in prop::collection::vec(sorted_nested_vec_strategy()`


#### `prop_kmerge_preserves_sort_order(
            all_data in prop::collection::vec(sorted_nested_vec_strategy()`


#### `prop_kmerge_handles_empty_iterators(
            data in sorted_nested_vec_strategy()`
