# Documentation: kmerge_batch.rs

## File Metadata

- **Path**: `crates/persistence/src/backend/kmerge_batch.rs`
- **Size**: 13,199 bytes
- **Lines**: 388
- **Language**: Rust
...
This file is part of the NautilusTrader repository. It defines 18 function(s) and 5 class(es).

## Detailed Walkthrough

### Functions
- **`from_stream_with_runtime()`**: Function defined in this file
- **`next()`**: Function defined in this file
- **`drop()`**: Function defined in this file
- **`new_from_iter()`**: Function defined in this file
- **`new()`**: Function defined in this file
- **`push_iter()`**: Function defined in this file
- **`clear()`**: Function defined in this file
- **`next()`**: Function defined in this file
- **`compare()`**: Function defined in this file
- **`compare()`**: Function defined in this file
- **`test1()`**: Function defined in this file
- **`test2()`**: Function defined in this file
- **`test3()`**: Function defined in this file
- **`test5()`**: Function defined in this file
- **`sorted_nested_vec_strategy()`**: Function defined in this file
- **`prop_kmerge_equivalent_to_sort()`**: Function defined in this file
- **`prop_kmerge_preserves_sort_order()`**: Function defined in this file
- **`prop_kmerge_handles_empty_iterators()`**: Function defined in this file

### Classes
- **`EagerStream`**: Class defined in this file
- **`ElementBatchIter`**: Class defined in this file
- **`KMerge`**: Class defined in this file
- **`OrdComparator`**: Class defined in this file
- **`SortedNestedVec`**: Class defined in this file
...
**Functions**: `clear`, `compare`, `drop`, `from_stream_with_runtime`, `new`, `new_from_iter`, `next`, `prop_kmerge_equivalent_to_sort`, `prop_kmerge_handles_empty_iterators`, `prop_kmerge_preserves_sort_order`, `push_iter`, `sorted_nested_vec_strategy`, `test1`, `test2`, `test3`, `test5`
**Impls**: `Compare`, `Drop`, `EagerStream`, `ElementBatchIter`, `Iterator`, `KMerge`, `Strategy`
**Structs**: `EagerStream`, `ElementBatchIter`, `KMerge`, `OrdComparator`, `SortedNestedVec`
...
---
*Generated on 2025-11-18T21:55:03.535537Z*
