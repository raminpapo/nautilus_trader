# Documentation: catalog.rs

## File Metadata

- **Path**: `crates/persistence/src/backend/catalog.rs`
- **Size**: 85,177 bytes
- **Lines**: 2,352
- **Language**: Rust
...
This file is part of the NautilusTrader repository. It defines 49 function(s) and 1 class(es).
...
- **`from_uri()`**: Function defined in this file
- **`get_base_path()`**: Function defined in this file
- **`reset_session()`**: Function defined in this file
- **`write_data_enum()`**: Function defined in this file
- **`write_to_parquet()`**: Function defined in this file
- **`write_to_json()`**: Function defined in this file
- **`check_ascending_timestamps()`**: Function defined in this file
- **`data_to_record_batches()`**: Function defined in this file
- **`extend_file_name()`**: Function defined in this file
- **`list_parquet_files()`**: Function defined in this file
- **`reconstruct_full_uri()`**: Function defined in this file
- **`join_paths()`**: Function defined in this file
- **`is_remote_uri()`**: Function defined in this file
- **`query()`**: Function defined in this file
- **`query_typed_data()`**: Function defined in this file
- **`query_files()`**: Function defined in this file
- **`get_missing_intervals_for_request()`**: Function defined in this file
- **`query_last_timestamp()`**: Function defined in this file

*...and 29 more functions*

### Classes
- **`ParquetDataCatalog`**: Class defined in this file
...
**Enums**: `to`, `variants`
**Functions**: `are_intervals_contiguous`, `are_intervals_disjoint`, `check_ascending_timestamps`, `data_to_record_batches`, `execute_async`, `extend_file_name`, `extract_identifier_from_path`, `extract_path_components`, `extract_sql_safe_filename`, `file_timestamp_to_iso_timestamp`, `fmt`, `from_uri`, `get_base_path`, `get_directory_intervals`, `get_interval_set`, `get_intervals`, `get_missing_intervals_for_request`, `interval_to_tuple`, `is_remote_uri`, `iso_timestamp_to_file_timestamp`, `iso_to_unix_nanos`, `join_paths`, `list_parquet_files`, `local_to_object_store_path`, `make_local_path`, `make_object_store_path`, `make_object_store_path_owned`, `make_path`, `make_sql_safe_identifier`, `move_file` *(+18 more)*
**Impls**: `CatalogPathPrefix`, `Debug`, `ParquetDataCatalog`
**Structs**: `ParquetDataCatalog`
**Traits**: `CatalogPathPrefix`, `enables`, `for`, `should`
...
---
*Generated on 2025-11-18T21:55:03.515638Z*
