# Documentation: `crates/persistence/src/backend/session.rs`
**Generated:** 2025-11-15T19:40:03.335172Z
**File Size:** 12094 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/persistence/src/backend/session.rs` within the repository.

**Classes defined:** TsInitComparator, DataBackendSession, DataQueryResult, DataBackendSession, Send, DataQueryResult, Iterator, Drop, Send

**Functions defined:** compare, new, register_object_store, register_object_store_from_uri, write_data, add_file, add_batch_stream, get_query_result, clear_registered_tables, build_query and 5 more
...
#### `new(chunk_size: usize)`


#### `register_object_store(&mut self, url: &Url, object_store: Arc<dyn ObjectStore>)`


#### `register_object_store_from_uri(
        &mut self,
        uri: &str,
        storage_options: Option<std::collections::HashMap<String, String>>,
    )`
...
#### `add_batch_stream(&mut self, stream: SendableRecordBatchStream)`


#### `get_query_result(&mut self)`


#### `clear_registered_tables(&mut self)`
...
#### `new(result: QueryResult, size: usize)`


#### `set_chunk(&mut self, data: Vec<Data>)`
