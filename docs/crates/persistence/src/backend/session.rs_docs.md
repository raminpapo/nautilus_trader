# Documentation: session.rs

## File Metadata

- **Path**: `crates/persistence/src/backend/session.rs`
- **Size**: 12,094 bytes
- **Lines**: 355
- **Language**: Rust
...
- **`register_object_store()`**: Function defined in this file
- **`register_object_store_from_uri()`**: Function defined in this file
- **`write_data()`**: Function defined in this file
- **`add_file()`**: Function defined in this file
- **`add_batch_stream()`**: Function defined in this file
- **`get_query_result()`**: Function defined in this file
- **`clear_registered_tables()`**: Function defined in this file
- **`build_query()`**: Function defined in this file
- **`new()`**: Function defined in this file
- **`set_chunk()`**: Function defined in this file
- **`drop_chunk()`**: Function defined in this file
- **`next()`**: Function defined in this file
- **`drop()`**: Function defined in this file

### Classes
- **`TsInitComparator`**: Class defined in this file
- **`DataBackendSession`**: Class defined in this file
- **`DataQueryResult`**: Class defined in this file
...
**Functions**: `add_batch_stream`, `add_file`, `build_query`, `clear_registered_tables`, `compare`, `drop`, `drop_chunk`, `get_query_result`, `new`, `next`, `register_object_store`, `register_object_store_from_uri`, `set_chunk`, `write_data`
**Impls**: `Compare`, `DataBackendSession`, `DataQueryResult`, `Drop`, `Iterator`, `Send`
**Structs**: `DataBackendSession`, `DataQueryResult`, `TsInitComparator`
...
---
*Generated on 2025-11-18T21:55:03.540063Z*
