# Documentation: catalog_operations.rs

## File Metadata

- **Path**: `crates/persistence/src/backend/catalog_operations.rs`
- **Size**: 70,465 bytes
- **Lines**: 1,777
- **Language**: Rust
...
This file is part of the NautilusTrader repository. It defines 19 function(s) and 5 class(es).

## Detailed Walkthrough

### Functions
- **`consolidate_catalog()`**: Function defined in this file
- **`consolidate_data()`**: Function defined in this file
- **`consolidate_directory()`**: Function defined in this file
- **`consolidate_catalog_by_period()`**: Function defined in this file
- **`extract_data_cls_and_identifier_from_path()`**: Function defined in this file
- **`consolidate_data_by_period()`**: Function defined in this file
- **`consolidate_data_by_period_generic()`**: Function defined in this file
- **`prepare_consolidation_queries()`**: Function defined in this file
- **`group_contiguous_intervals()`**: Function defined in this file
- **`file_exists()`**: Function defined in this file
- **`delete_file()`**: Function defined in this file
- **`reset_all_file_names()`**: Function defined in this file
- **`reset_data_file_names()`**: Function defined in this file
- **`reset_file_names()`**: Function defined in this file
- **`find_leaf_data_directories()`**: Function defined in this file
- **`delete_data_range()`**: Function defined in this file
- **`delete_catalog_range()`**: Function defined in this file
- **`delete_data_range_generic()`**: Function defined in this file
- **`prepare_delete_operations()`**: Function defined in this file

### Classes
- **`encapsulates`**: Class defined in this file
- **`is`**: Class defined in this file
- **`ConsolidationQuery`**: Class defined in this file
- **`encapsulates`**: Class defined in this file
- **`DeleteOperation`**: Class defined in this file
...
**Functions**: `consolidate_catalog`, `consolidate_catalog_by_period`, `consolidate_data`, `consolidate_data_by_period`, `consolidate_data_by_period_generic`, `consolidate_directory`, `delete_catalog_range`, `delete_data_range`, `delete_data_range_generic`, `delete_file`, `extract_data_cls_and_identifier_from_path`, `file_exists`, `find_leaf_data_directories`, `group_contiguous_intervals`, `prepare_consolidation_queries`, `prepare_delete_operations`, `reset_all_file_names`, `reset_data_file_names`, `reset_file_names`
**Impls**: `ParquetDataCatalog`
**Structs**: `ConsolidationQuery`, `DeleteOperation`, `encapsulates`, `is`

## Related Files

This file is located in `crates/persistence/src/backend/`. Related files may include:
...
---
*Generated on 2025-11-18T21:55:03.527822Z*
