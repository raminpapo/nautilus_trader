# Documentation: `crates/persistence/src/backend/catalog_operations.rs`
**Generated:** 2025-11-15T19:40:03.325435Z
**File Size:** 70465 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/persistence/src/backend/catalog_operations.rs` within the repository.

**Classes defined:** encapsulates, is, ConsolidationQuery, encapsulates, DeleteOperation, ParquetDataCatalog

**Functions defined:** consolidate_catalog, consolidate_data, consolidate_directory, consolidate_catalog_by_period, extract_data_cls_and_identifier_from_path, consolidate_data_by_period, consolidate_data_by_period_generic, prepare_consolidation_queries, group_contiguous_intervals, file_exists and 9 more
...
#### `extract_data_cls_and_identifier_from_path(
        &self,
        path: &str,
    )`
...
#### `consolidate_data_by_period_generic(
        &mut self,
        identifier: Option<String>,
        period_nanos: Option<u64>,
        start: Option<UnixNanos>,
...
#### `group_contiguous_intervals(&self, intervals: &[(u64, u64)`
...
#### `reset_file_names(&self, directory: &str)`


#### `find_leaf_data_directories(&self)`
