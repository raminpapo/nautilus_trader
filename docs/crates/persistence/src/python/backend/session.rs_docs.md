...
### Functions
- **`new_session()`**: Function defined in this file
- **`py_add_file()`**: Function defined in this file
- **`to_query_result()`**: Function defined in this file
- **`py_register_object_store_from_uri()`**: Function defined in this file
...
**Enums**: `NautilusDataType`
**Functions**: `__iter__`, `__next__`, `new_session`, `py_add_file`, `py_register_object_store_from_uri`, `to_query_result`
**Impls**: `DataBackendSession`, `DataQueryResult`

## Related Files

This file is located in `crates/persistence/src/python/backend/`. Related files may include:
...
---
*Generated on 2025-11-18T21:55:03.555393Z*
