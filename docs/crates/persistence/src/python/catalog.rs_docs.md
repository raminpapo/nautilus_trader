# Documentation: `crates/persistence/src/python/catalog.rs`
**Generated:** 2025-11-15T19:40:03.350076Z
...
This file is located at `crates/persistence/src/python/catalog.rs` within the repository.

**Classes defined:** ParquetDataCatalogV2, ParquetDataCatalogV2

**Functions defined:** new, write_data, write_quote_ticks, write_trade_ticks, write_order_book_deltas, write_bars, write_order_book_depths, write_mark_price_updates, write_index_price_updates, extend_file_name and 19 more
...
#### `write_data(mut slf: PyRefMut<'_, Self>, data_type: NautilusDataType, data: Vec<Data>)`
...
#### `delete_catalog_range(&mut self, start: Option<u64>, end: Option<u64>)`
...
**Directory:** `crates/persistence/src/python`
