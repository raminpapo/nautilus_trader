...
- **Path**: `crates/persistence/src/python/catalog.rs`
- **Size**: 35,746 bytes
- **Lines**: 896
- **Language**: Rust
...
- **`write_data()`**: Function defined in this file
- **`write_quote_ticks()`**: Function defined in this file
- **`write_trade_ticks()`**: Function defined in this file
- **`write_order_book_deltas()`**: Function defined in this file
- **`write_bars()`**: Function defined in this file
- **`write_order_book_depths()`**: Function defined in this file
- **`write_mark_price_updates()`**: Function defined in this file
- **`write_index_price_updates()`**: Function defined in this file
...
### Classes
- **`ParquetDataCatalogV2`**: Class defined in this file
...
**Functions**: `consolidate_catalog`, `consolidate_catalog_by_period`, `consolidate_data`, `consolidate_data_by_period`, `delete_catalog_range`, `delete_data_range`, `extend_file_name`, `get_intervals`, `get_missing_intervals_for_request`, `new`, `query_bars`, `query_files`, `query_index_price_updates`, `query_last_timestamp`, `query_mark_price_updates`, `query_order_book_deltas`, `query_order_book_depths`, `query_quote_ticks`, `query_trade_ticks`, `reset_all_file_names`, `reset_data_file_names`, `write_bars`, `write_data`, `write_index_price_updates`, `write_mark_price_updates`, `write_order_book_deltas`, `write_order_book_depths`, `write_quote_ticks`, `write_trade_ticks`
**Impls**: `ParquetDataCatalogV2`
**Structs**: `ParquetDataCatalogV2`
...
---
*Generated on 2025-11-18T21:55:03.561206Z*
