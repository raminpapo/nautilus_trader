# Documentation: `crates/persistence/src/python/wranglers/delta.rs`
**Generated:** 2025-11-15T19:40:03.354549Z
...
- **Path:** `crates/persistence/src/python/wranglers/delta.rs`
- **Size:** 2,993 bytes
- **Lines:** 87
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/persistence/src/python/wranglers/delta.rs` within the repository.

**Classes defined:** OrderBookDeltaDataWrangler, OrderBookDeltaDataWrangler

**Functions defined:** py_new, instrument_id, price_precision, size_precision, process_record_batch_bytes
...
#### `py_new(instrument_id: &str, price_precision: u8, size_precision: u8)`
...
#### `process_record_batch_bytes(&self, data: &[u8])`
...
**Directory:** `crates/persistence/src/python/wranglers`
