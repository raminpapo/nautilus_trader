# Documentation: test_cache_database_postgres.rs

## File Metadata

- **Path**: `crates/infrastructure/tests/test_cache_database_postgres.rs`
- **Size**: 27,463 bytes
- **Lines**: 783
- **Language**: Rust
...
### Functions
- **`assert_entirely_equal()`**: Function defined in this file
- **`test_add_general_object_adds_to_cache()`**: Function defined in this file
- **`test_add_currency_and_instruments()`**: Function defined in this file
- **`test_truncate()`**: Function defined in this file
- **`test_add_order_and_load_indexes()`**: Function defined in this file
- **`test_update_order_for_open_order()`**: Function defined in this file
- **`test_add_and_update_account()`**: Function defined in this file
- **`test_add_quote()`**: Function defined in this file
- **`test_add_trade()`**: Function defined in this file
- **`test_add_bar()`**: Function defined in this file
- **`test_add_signal()`**: Function defined in this file
- **`test_add_custom_data()`**: Function defined in this file
- **`test_add_order_snapshot()`**: Function defined in this file
- **`test_add_position_snapshot()`**: Function defined in this file
...
**Functions**: `assert_entirely_equal`, `test_add_and_update_account`, `test_add_bar`, `test_add_currency_and_instruments`, `test_add_custom_data`, `test_add_general_object_adds_to_cache`, `test_add_order_and_load_indexes`, `test_add_order_snapshot`, `test_add_position_snapshot`, `test_add_quote`, `test_add_signal`, `test_add_trade`, `test_truncate`, `test_update_order_for_open_order`
...
```bash
# For Python
pytest crates/infrastructure/tests/test_cache_database_postgres.rs
...
---
*Generated on 2025-11-18T21:55:02.079938Z*
