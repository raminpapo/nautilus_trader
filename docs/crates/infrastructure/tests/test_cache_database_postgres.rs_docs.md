# Documentation: `crates/infrastructure/tests/test_cache_database_postgres.rs`
**Generated:** 2025-11-15T19:40:02.369910Z
**File Size:** 27463 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/infrastructure/tests/test_cache_database_postgres.rs` within the repository.

**Functions defined:** assert_entirely_equal, test_add_general_object_adds_to_cache, test_add_currency_and_instruments, test_truncate, test_add_order_and_load_indexes, test_update_order_for_open_order, test_add_and_update_account, test_add_quote, test_add_trade, test_add_bar and 4 more
...
#### `assert_entirely_equal(a: T, b: T)`


#### `test_add_general_object_adds_to_cache()`


#### `test_add_currency_and_instruments()`


#### `test_truncate()`


#### `test_add_order_and_load_indexes()`


#### `test_update_order_for_open_order()`


#### `test_add_and_update_account()`
...
#### `test_add_order_snapshot()`


#### `test_add_position_snapshot()`
