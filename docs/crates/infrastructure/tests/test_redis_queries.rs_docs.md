# Documentation: `crates/infrastructure/tests/test_redis_queries.rs`
**Generated:** 2025-11-15T19:40:02.377541Z
**File Size:** 15761 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/infrastructure/tests/test_redis_queries.rs` within the repository.

**Functions defined:** get_redis_connection, setup_test_database, test_scan_keys_empty_database, test_scan_keys_with_matching_keys, test_scan_keys_handles_large_dataset, test_read_bulk_empty_keys, test_read_bulk_single_key, test_read_bulk_multiple_keys, test_read_bulk_with_missing_keys, test_read_bulk_performance_vs_individual and 7 more
...
#### `test_scan_keys_empty_database()`


#### `test_scan_keys_with_matching_keys()`


#### `test_scan_keys_handles_large_dataset()`


#### `test_read_bulk_empty_keys()`


#### `test_read_bulk_single_key()`


#### `test_read_bulk_multiple_keys()`


#### `test_read_bulk_with_missing_keys()`


#### `test_read_bulk_performance_vs_individual()`


#### `test_load_currencies_empty()`


#### `test_load_currencies_with_bulk_loading()`


#### `test_serialize_deserialize_payload()`


#### `test_read_bulk_handles_very_large_keys()`


#### `test_scan_keys_with_special_characters()`


#### `test_load_currency_single()`


#### `test_load_currency_not_found()`
...
**Directory:** `crates/infrastructure/tests`
