# Documentation: test_redis_queries.rs

## File Metadata

- **Path**: `crates/infrastructure/tests/test_redis_queries.rs`
- **Size**: 15,761 bytes
- **Lines**: 479
- **Language**: Rust
...
### Functions
- **`get_redis_connection()`**: Function defined in this file
- **`setup_test_database()`**: Function defined in this file
- **`test_scan_keys_empty_database()`**: Function defined in this file
- **`test_scan_keys_with_matching_keys()`**: Function defined in this file
- **`test_scan_keys_handles_large_dataset()`**: Function defined in this file
- **`test_read_bulk_empty_keys()`**: Function defined in this file
- **`test_read_bulk_single_key()`**: Function defined in this file
- **`test_read_bulk_multiple_keys()`**: Function defined in this file
- **`test_read_bulk_with_missing_keys()`**: Function defined in this file
- **`test_read_bulk_performance_vs_individual()`**: Function defined in this file
- **`test_load_currencies_empty()`**: Function defined in this file
- **`test_load_currencies_with_bulk_loading()`**: Function defined in this file
- **`test_serialize_deserialize_payload()`**: Function defined in this file
- **`test_read_bulk_handles_very_large_keys()`**: Function defined in this file
- **`test_scan_keys_with_special_characters()`**: Function defined in this file
- **`test_load_currency_single()`**: Function defined in this file
- **`test_load_currency_not_found()`**: Function defined in this file
...
**Functions**: `get_redis_connection`, `setup_test_database`, `test_load_currencies_empty`, `test_load_currencies_with_bulk_loading`, `test_load_currency_not_found`, `test_load_currency_single`, `test_read_bulk_empty_keys`, `test_read_bulk_handles_very_large_keys`, `test_read_bulk_multiple_keys`, `test_read_bulk_performance_vs_individual`, `test_read_bulk_single_key`, `test_read_bulk_with_missing_keys`, `test_scan_keys_empty_database`, `test_scan_keys_handles_large_dataset`, `test_scan_keys_with_matching_keys`, `test_scan_keys_with_special_characters`, `test_serialize_deserialize_payload`

## Related Files

This file is located in `crates/infrastructure/tests/`. Related files may include:
...
```bash
# For Python
pytest crates/infrastructure/tests/test_redis_queries.rs
...
---
*Generated on 2025-11-18T21:55:02.091912Z*
