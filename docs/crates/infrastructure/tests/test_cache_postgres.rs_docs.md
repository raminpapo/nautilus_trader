# Documentation: test_cache_postgres.rs

## File Metadata

- **Path**: `crates/infrastructure/tests/test_cache_postgres.rs`
- **Size**: 11,669 bytes
- **Lines**: 299
- **Language**: Rust
...
- **`test_cache_instruments()`**: Function defined in this file
- **`test_cache_orders()`**: Function defined in this file
- **`test_cache_accounts()`**: Function defined in this file
- **`test_order_cancel_rejected_insert_and_load()`**: Function defined in this file
- **`test_order_modify_rejected_insert_and_load()`**: Function defined in this file
...
**Functions**: `get_cache`, `test_cache_accounts`, `test_cache_instruments`, `test_cache_orders`, `test_order_cancel_rejected_insert_and_load`, `test_order_modify_rejected_insert_and_load`
...
```bash
# For Python
pytest crates/infrastructure/tests/test_cache_postgres.rs
...
---
*Generated on 2025-11-18T21:55:02.083408Z*
