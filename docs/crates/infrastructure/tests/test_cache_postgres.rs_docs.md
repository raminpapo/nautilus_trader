# Documentation: `crates/infrastructure/tests/test_cache_postgres.rs`
**Generated:** 2025-11-15T19:40:02.372283Z
**File Size:** 11669 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/infrastructure/tests/test_cache_postgres.rs` within the repository.

**Functions defined:** get_cache, test_cache_instruments, test_cache_orders, test_cache_accounts, test_order_cancel_rejected_insert_and_load, test_order_modify_rejected_insert_and_load
...
#### `get_cache(cache_database: Option<Box<dyn CacheDatabaseAdapter>>)`


#### `test_cache_instruments()`
