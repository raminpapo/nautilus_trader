# Documentation: `crates/infrastructure/tests/test_cache_redis.rs`
**Generated:** 2025-11-15T19:40:02.374978Z
...
This file is located at `crates/infrastructure/tests/test_cache_redis.rs` within the repository.

**Functions defined:** get_redis_cache_adapter, test_delete_order, test_delete_position, test_flush_database, test_delete_operations_are_idempotent, test_delete_order_cleans_up_indexes, test_delete_position_cleans_up_indexes, test_debug_real_index_deletion
...
#### `test_delete_operations_are_idempotent()`


#### `test_delete_order_cleans_up_indexes()`


#### `test_delete_position_cleans_up_indexes()`


#### `test_debug_real_index_deletion()`
