# Documentation: test_cache_redis.rs

## File Metadata

- **Path**: `crates/infrastructure/tests/test_cache_redis.rs`
- **Size**: 20,014 bytes
- **Lines**: 551
- **Language**: Rust
...
### Functions
- **`get_redis_cache_adapter()`**: Function defined in this file
- **`test_delete_order()`**: Function defined in this file
- **`test_delete_position()`**: Function defined in this file
- **`test_flush_database()`**: Function defined in this file
- **`test_delete_operations_are_idempotent()`**: Function defined in this file
- **`test_delete_order_cleans_up_indexes()`**: Function defined in this file
- **`test_delete_position_cleans_up_indexes()`**: Function defined in this file
- **`test_debug_real_index_deletion()`**: Function defined in this file
...
**Functions**: `get_redis_cache_adapter`, `test_debug_real_index_deletion`, `test_delete_operations_are_idempotent`, `test_delete_order`, `test_delete_order_cleans_up_indexes`, `test_delete_position`, `test_delete_position_cleans_up_indexes`, `test_flush_database`
...
```bash
# For Python
pytest crates/infrastructure/tests/test_cache_redis.rs
...
---
*Generated on 2025-11-18T21:55:02.087281Z*
