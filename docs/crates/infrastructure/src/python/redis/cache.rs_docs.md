# Documentation: `crates/infrastructure/src/python/redis/cache.rs`
**Generated:** 2025-11-15T19:40:02.307321Z
...
- **Path:** `crates/infrastructure/src/python/redis/cache.rs`
- **Size:** 8,205 bytes
- **Lines:** 209
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/infrastructure/src/python/redis/cache.rs` within the repository.

**Classes defined:** RedisCacheDatabase

**Functions defined:** py_new, py_close, py_flushdb, py_keys, py_load_all, py_read, py_read_bulk, py_insert, py_update, py_delete and 3 more
...
#### `py_keys(&mut self, pattern: &str)`


#### `py_load_all(&mut self)`


#### `py_read(&mut self, py: Python, key: &str)`


#### `py_read_bulk(&mut self, py: Python, keys: Vec<String>)`


#### `py_insert(&mut self, key: String, payload: Vec<Vec<u8>>)`


#### `py_update(&mut self, key: String, payload: Vec<Vec<u8>>)`


#### `py_delete(&mut self, key: String, payload: Option<Vec<Vec<u8>>>)`


#### `py_delete_order(&mut self, client_order_id: &str)`


#### `py_delete_position(&mut self, position_id: &str)`


#### `py_delete_account_event(&mut self, account_id: &str, event_id: &str)`
