...
- **Path**: `crates/infrastructure/src/sql/models/instruments.rs`
- **Size**: 41,368 bytes
- **Lines**: 1,040
- **Language**: Rust
...
This file is part of the NautilusTrader repository. It defines 12 function(s) and 12 class(es).
...
### Classes
- **`InstrumentAnyModel`**: Class defined in this file
- **`BettingInstrumentModel`**: Class defined in this file
- **`BinaryOptionModel`**: Class defined in this file
- **`CryptoFutureModel`**: Class defined in this file
- **`CryptoOptionModel`**: Class defined in this file
- **`CryptoPerpetualModel`**: Class defined in this file
- **`CurrencyPairModel`**: Class defined in this file
- **`EquityModel`**: Class defined in this file
- **`FuturesContractModel`**: Class defined in this file
- **`FuturesSpreadModel`**: Class defined in this file
- **`OptionContractModel`**: Class defined in this file
- **`OptionSpreadModel`**: Class defined in this file
...
**Functions**: `from_row`
**Impls**: `FromRow`
**Structs**: `BettingInstrumentModel`, `BinaryOptionModel`, `CryptoFutureModel`, `CryptoOptionModel`, `CryptoPerpetualModel`, `CurrencyPairModel`, `EquityModel`, `FuturesContractModel`, `FuturesSpreadModel`, `InstrumentAnyModel`, `OptionContractModel`, `OptionSpreadModel`
...
---
*Generated on 2025-11-18T21:55:02.053662Z*
