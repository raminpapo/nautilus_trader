# Documentation: `crates/infrastructure/src/sql/models/enums.rs`
**Generated:** 2025-11-15T19:40:02.343621Z
**File Size:** 11986 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/infrastructure/src/sql/models/enums.rs` within the repository.

**Classes defined:** CurrencyTypeModel, PriceTypeModel, BarAggregationModel, AssetClassModel, TrailingOffsetTypeModel, AggressorSideModel, AggregationSourceModel, sqlx, sqlx, sqlx and 11 more

**Functions defined:** encode_by_ref, decode, type_info, compatible, encode_by_ref, decode, type_info, compatible, encode_by_ref, decode and 18 more
...
#### `decode(value: <Postgres as Database>::ValueRef<'r>)`


#### `type_info()`


#### `compatible(ty: &sqlx::postgres::PgTypeInfo)`
