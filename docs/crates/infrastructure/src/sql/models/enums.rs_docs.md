...
- **Path**: `crates/infrastructure/src/sql/models/enums.rs`
- **Size**: 11,986 bytes
- **Lines**: 313
- **Language**: Rust
...
This file is part of the NautilusTrader repository. It defines 28 function(s) and 7 class(es).
...
- **`compatible()`**: Function defined in this file
- **`encode_by_ref()`**: Function defined in this file
- **`decode()`**: Function defined in this file
- **`type_info()`**: Function defined in this file
- **`compatible()`**: Function defined in this file
...
### Classes
- **`CurrencyTypeModel`**: Class defined in this file
- **`PriceTypeModel`**: Class defined in this file
- **`BarAggregationModel`**: Class defined in this file
- **`AssetClassModel`**: Class defined in this file
- **`TrailingOffsetTypeModel`**: Class defined in this file
- **`AggressorSideModel`**: Class defined in this file
- **`AggregationSourceModel`**: Class defined in this file
...
**Functions**: `compatible`, `decode`, `encode_by_ref`, `type_info`
**Impls**: `sqlx`
**Structs**: `AggregationSourceModel`, `AggressorSideModel`, `AssetClassModel`, `BarAggregationModel`, `CurrencyTypeModel`, `PriceTypeModel`, `TrailingOffsetTypeModel`
...
---
*Generated on 2025-11-18T21:55:02.045311Z*
