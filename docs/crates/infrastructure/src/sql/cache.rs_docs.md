...
- **Path**: `crates/infrastructure/src/sql/cache.rs`
- **Size**: 40,246 bytes
- **Lines**: 1,083
- **Language**: Rust
...
- **`get_pg_cache_database()`**: Function defined in this file
...
- **`load_index_order_position()`**: Function defined in this file
- **`load_index_order_client()`**: Function defined in this file
...
### Classes
- **`PostgresCacheDatabase`**: Class defined in this file
...
**Enums**: `DatabaseQuery`
**Functions**: `add`, `add_account`, `add_bar`, `add_currency`, `add_custom_data`, `add_instrument`, `add_order`, `add_order_book`, `add_order_snapshot`, `add_position`, `add_position_snapshot`, `add_quote`, `add_signal`, `add_synthetic`, `add_trade`, `close`, `connect`, `delete_account_event`, `delete_actor`, `delete_order`, `delete_position`, `delete_strategy`, `drain_buffer`, `flush`, `get_pg_cache_database`, `heartbeat`, `index_order_position`, `index_venue_order_id`, `load`, `load_account` *(+31 more)*
**Impls**: `CacheDatabaseAdapter`, `PostgresCacheDatabase`
**Structs**: `PostgresCacheDatabase`
...
---
*Generated on 2025-11-18T21:55:02.035165Z*
