# Documentation: queries.rs

## File Metadata

- **Path**: `crates/infrastructure/src/sql/queries.rs`
- **Size**: 53,488 bytes
- **Lines**: 1,260
- **Language**: Rust
...
### Functions
- **`truncate()`**: Function defined in this file
- **`add()`**: Function defined in this file
- **`load()`**: Function defined in this file
- **`add_currency()`**: Function defined in this file
- **`load_currencies()`**: Function defined in this file
- **`load_currency()`**: Function defined in this file
- **`add_instrument()`**: Function defined in this file
- **`load_instrument()`**: Function defined in this file
- **`load_instruments()`**: Function defined in this file
- **`add_order()`**: Function defined in this file
- **`add_order_snapshot()`**: Function defined in this file
- **`load_order_snapshot()`**: Function defined in this file
- **`add_position_snapshot()`**: Function defined in this file
- **`load_position_snapshot()`**: Function defined in this file
- **`check_if_order_initialized_exists()`**: Function defined in this file
- **`check_if_account_event_exists()`**: Function defined in this file
- **`add_order_event()`**: Function defined in this file
- **`load_order_events()`**: Function defined in this file
- **`load_order()`**: Function defined in this file
- **`load_orders()`**: Function defined in this file

*...and 15 more functions*

### Classes
- **`DatabaseQueries`**: Class defined in this file
...
**Functions**: `add`, `add_account`, `add_bar`, `add_currency`, `add_custom_data`, `add_instrument`, `add_order`, `add_order_event`, `add_order_snapshot`, `add_position_snapshot`, `add_quote`, `add_signal`, `add_trade`, `check_if_account_event_exists`, `check_if_order_initialized_exists`, `load`, `load_account`, `load_account_events`, `load_accounts`, `load_bars`, `load_currencies`, `load_currency`, `load_custom_data`, `load_distinct_order_event_client_ids`, `load_instrument`, `load_instruments`, `load_order`, `load_order_events`, `load_order_snapshot`, `load_orders` *(+5 more)*
**Impls**: `DatabaseQueries`
**Structs**: `DatabaseQueries`

## Related Files

This file is located in `crates/infrastructure/src/sql/`. Related files may include:
...
---
*Generated on 2025-11-18T21:55:02.075086Z*
