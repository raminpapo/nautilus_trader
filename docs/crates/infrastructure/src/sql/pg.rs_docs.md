# Documentation: `crates/infrastructure/src/sql/pg.rs`
**Generated:** 2025-11-15T19:40:02.360724Z
...
This file is located at `crates/infrastructure/src/sql/pg.rs` within the repository.

**Classes defined:** PostgresConnectOptions, PostgresConnectOptions, Default, From

**Functions defined:** new, connection_string, default_administrator, default, from, get_postgres_connect_options, connect_pg, get_schema_dir, init_postgres, drop_postgres
...
#### `from(opt: PostgresConnectOptions)`
...
#### `connect_pg(options: PgConnectOptions)`
...
#### `drop_postgres(pg: &PgPool, database: String)`
