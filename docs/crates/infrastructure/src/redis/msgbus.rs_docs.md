# Documentation: msgbus.rs

## File Metadata

- **Path**: `crates/infrastructure/src/redis/msgbus.rs`
- **Size**: 37,449 bytes
- **Lines**: 1,095
- **Language**: Rust
...
This file is part of the NautilusTrader repository. It defines 28 function(s) and 1 class(es).
...
- **`publish()`**: Function defined in this file
- **`close()`**: Function defined in this file
- **`get_stream_receiver()`**: Function defined in this file
- **`stream()`**: Function defined in this file
- **`close_async()`**: Function defined in this file
- **`publish_messages()`**: Function defined in this file
- **`drain_buffer()`**: Function defined in this file
- **`stream_messages()`**: Function defined in this file
- **`decode_bus_message()`**: Function defined in this file
- **`run_heartbeat()`**: Function defined in this file
- **`create_heartbeat_msg()`**: Function defined in this file
- **`test_decode_bus_message_valid()`**: Function defined in this file
- **`test_decode_bus_message_missing_fields()`**: Function defined in this file
- **`test_decode_bus_message_invalid_topic_format()`**: Function defined in this file
- **`test_decode_bus_message_invalid_payload_format()`**: Function defined in this file
- **`test_decode_bus_message_invalid_stream_msg_format()`**: Function defined in this file
- **`redis_connection()`**: Function defined in this file

*...and 8 more functions*

### Classes
- **`RedisMessageBusDatabase`**: Class defined in this file
...
**Functions**: `close`, `close_async`, `create_heartbeat_msg`, `decode_bus_message`, `drain_buffer`, `fmt`, `get_stream_receiver`, `is_closed`, `new`, `publish`, `publish_messages`, `redis_connection`, `run_heartbeat`, `stream`, `stream_messages`, `test_close`, `test_decode_bus_message_invalid_payload_format`, `test_decode_bus_message_invalid_stream_msg_format`, `test_decode_bus_message_invalid_topic_format`, `test_decode_bus_message_missing_fields`, `test_decode_bus_message_valid`, `test_heartbeat_task`, `test_publish_messages`, `test_stream_messages`, `test_stream_messages_interleaved_at_different_rates`, `test_stream_messages_multiple_streams`, `test_stream_messages_terminate_signal`, `test_stream_messages_when_receiver_closed`
**Impls**: `Debug`, `MessageBusDatabaseAdapter`, `RedisMessageBusDatabase`, `Stream`
**Structs**: `RedisMessageBusDatabase`
**Traits**: `method`

## Related Files

This file is located in `crates/infrastructure/src/redis/`. Related files may include:
...
---
*Generated on 2025-11-18T21:55:02.023529Z*
