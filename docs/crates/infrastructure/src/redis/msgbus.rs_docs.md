# Documentation: `crates/infrastructure/src/redis/msgbus.rs`
**Generated:** 2025-11-15T19:40:02.328044Z
**File Size:** 37449 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/infrastructure/src/redis/msgbus.rs` within the repository.

**Classes defined:** RedisMessageBusDatabase, Debug, MessageBusDatabaseAdapter, RedisMessageBusDatabase, Stream

**Functions defined:** fmt, new, is_closed, publish, close, get_stream_receiver, stream, close_async, publish_messages, drain_buffer and 18 more
...
#### `publish(&self, topic: Ustr, payload: Bytes)`
...
#### `decode_bus_message(stream_msg: &redis::Value)`
...
#### `test_stream_messages_terminate_signal(#[future] redis_connection: ConnectionManager)`
...
#### `test_stream_messages(#[future] redis_connection: ConnectionManager)`


#### `test_publish_messages(#[future] redis_connection: ConnectionManager)`


#### `test_stream_messages_multiple_streams(#[future] redis_connection: ConnectionManager)`
