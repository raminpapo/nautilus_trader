# Documentation: `crates/infrastructure/src/redis/mod.rs`
**Generated:** 2025-11-15T19:40:02.323635Z
...
This file is located at `crates/infrastructure/src/redis/mod.rs` within the repository.

**Functions defined:** await_handle, get_redis_url, create_redis_connection, flush_redis, get_stream_key, get_redis_version, parse_redis_version, test_get_redis_url_default_values, test_get_redis_url_password_only, test_get_redis_url_full_config_with_ssl and 5 more
...
#### `await_handle(handle: Option<tokio::task::JoinHandle<()`


#### `get_redis_url(config: DatabaseConfig)`
...
#### `parse_redis_version(version_str: &str)`
...
**Security:** This file may contain sensitive patterns: password, secret, credential, auth. Ensure proper handling of secrets.
