# Documentation: `crates/infrastructure/src/redis/queries.rs`
**Generated:** 2025-11-15T19:40:02.332146Z
**File Size:** 31273 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/infrastructure/src/redis/queries.rs` within the repository.

**Classes defined:** DatabaseQueries, DatabaseQueries

**Functions defined:** serialize_payload, deserialize_payload, scan_keys, read_bulk, read, load_all, load_currencies, load_instruments, load_synthetics, load_accounts and 18 more
...
#### `read_index(conn: &mut ConnectionManager, key: &str)`


#### `read_string(conn: &mut ConnectionManager, key: &str)`


#### `read_set(conn: &mut ConnectionManager, key: &str)`


#### `read_hset(conn: &mut ConnectionManager, key: &str)`


#### `read_list(conn: &mut ConnectionManager, key: &str)`


#### `get_index_key(key: &str)`


#### `is_timestamp_field(key: &str)`


#### `convert_timestamps(value: &mut Value)`


#### `convert_timestamp_strings(value: &mut Value)`
