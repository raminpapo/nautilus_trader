...
- **Path**: `crates/infrastructure/src/redis/cache.rs`
- **Size**: 40,222 bytes
- **Lines**: 1,281
- **Language**: Rust
...
This file is part of the NautilusTrader repository. It defines 97 function(s) and 3 class(es).
...
- **`new()`**: Function defined in this file
- **`get_encoding()`**: Function defined in this file
- **`get_trader_key()`**: Function defined in this file
- **`close()`**: Function defined in this file
- **`flushdb()`**: Function defined in this file
- **`keys()`**: Function defined in this file
...
- **`delete()`**: Function defined in this file
- **`delete_order()`**: Function defined in this file
- **`delete_position()`**: Function defined in this file
- **`delete_account_event()`**: Function defined in this file
- **`process_commands()`**: Function defined in this file
...
### Classes
- **`DatabaseCommand`**: Class defined in this file
- **`RedisCacheDatabase`**: Class defined in this file
- **`RedisCacheDatabaseAdapter`**: Class defined in this file


## Keywords and Identifiers

Total unique keywords extracted: 93


**Enums**: `DatabaseOperation`
**Functions**: `add`, `add_account`, `add_bar`, `add_currency`, `add_custom_data`, `add_instrument`, `add_order`, `add_order_book`, `add_order_snapshot`, `add_position`, `add_position_snapshot`, `add_quote`, `add_signal`, `add_synthetic`, `add_trade`, `close`, `delete`, `delete_account_event`, `delete_actor`, `delete_from_index`, `delete_order`, `delete_position`, `delete_strategy`, `delete_string`, `drain_buffer`, `flush`, `flushdb`, `fmt`, `get_collection_key`, `get_encoding` *(+57 more)*
**Impls**: `CacheDatabaseAdapter`, `DatabaseCommand`, `Debug`, `RedisCacheDatabase`
**Structs**: `DatabaseCommand`, `RedisCacheDatabase`, `RedisCacheDatabaseAdapter`
...
---
*Generated on 2025-11-18T21:55:02.012611Z*
