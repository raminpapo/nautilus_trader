# Documentation: greeks.md

## File Metadata

- **Path**: `crates/common/examples/greeks.md`
- **Size**: 4,446 bytes
- **Lines**: 150
- **Language**: Markdown
...
**Identifiers**: `Actor`, `Any`, `Arc`, `Basic`, `Bus`, `Cache`, `Caching`, `Calculate`, `Calculating`, `Calculator`, `Clock`, `Components`, `Create`, `Data`, `DataActor`, `DataActorConfig`, `DataActorCore`, `Example`, `Features`, `Full`, `Greeks`, `GreeksCalculator`, `GreeksData`, `Handle`, `InstrumentId`, `Integration`, `Key`, `LiveClock`, `Message`, `MessagingSwitchboard` *(+21 more)*
...
---
*Generated on 2025-11-18T21:55:00.965318Z*
