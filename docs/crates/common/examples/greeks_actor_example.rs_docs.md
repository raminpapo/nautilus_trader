# Documentation: greeks_actor_example.rs

## File Metadata

- **Path**: `crates/common/examples/greeks_actor_example.rs`
- **Size**: 7,028 bytes
- **Lines**: 226
- **Language**: Rust
...
- **`calculate_instrument_greeks()`**: Function defined in this file
- **`calculate_portfolio_greeks()`**: Function defined in this file
- **`subscribe_to_greeks()`**: Function defined in this file
...
### Classes
- **`GreeksActor`**: Class defined in this file
...
**Functions**: `calculate_instrument_greeks`, `calculate_portfolio_greeks`, `deref`, `deref_mut`, `main`, `new`, `on_data`, `on_start`, `on_stop`, `subscribe_to_greeks`
**Impls**: `DataActor`, `Deref`, `DerefMut`, `GreeksActor`
**Structs**: `GreeksActor`

## Related Files

This file is located in `crates/common/examples/`. Related files may include:
...
---
*Generated on 2025-11-18T21:55:00.967753Z*
