# Documentation: `crates/common/examples/greeks_actor_example.rs`
**Generated:** 2025-11-15T19:40:01.637840Z
...
This file is located at `crates/common/examples/greeks_actor_example.rs` within the repository.

**Classes defined:** GreeksActor, GreeksActor, Deref, DerefMut, DataActor

**Functions defined:** new, calculate_instrument_greeks, calculate_portfolio_greeks, subscribe_to_greeks, deref, deref_mut, on_start, on_stop, on_data, main
...
#### `subscribe_to_greeks(&self, underlying: &str)`
...
#### `on_data(&mut self, data: &dyn std::any::Any)`
...
**Directory:** `crates/common/examples`
