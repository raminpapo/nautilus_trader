...
- **Path**: `crates/common/src/enums.rs`
- **Size**: 10,638 bytes
- **Lines**: 375
- **Language**: Rust
...
### Functions
- **`variant_name()`**: Function defined in this file
- **`as_ansi()`**: Function defined in this file
...
**Enums**: `ComponentState`, `ComponentTrigger`, `Environment`, `LogColor`, `LogFormat`, `LogLevel`, `SerializationEncoding`
**Functions**: `as_ansi`, `from`, `variant_name`
**Impls**: `ComponentState`, `From`, `LogColor`
...
---
*Generated on 2025-11-18T21:55:01.100500Z*
