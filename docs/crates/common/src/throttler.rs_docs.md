# Documentation: `crates/common/src/throttler.rs`
**Generated:** 2025-11-15T19:40:01.848741Z
**File Size:** 26068 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/common/src/throttler.rs` within the repository.

**Classes defined:** RateLimit, Throttler, ThrottlerProcess, TestThrottler, RateLimit, TestThrottler, Strategy, Strategy

**Functions defined:** new, id, handle, as_any, fmt, new, set_timer, delta_next, reset, used and 29 more
...
#### `new(limit: usize, interval_ns: u64)`


#### `id(&self)`


#### `handle(&mut self, _msg: &dyn Any)`
...
#### `set_timer(&mut self, callback: Option<TimeEventCallback>)`
...
#### `send_msg(&mut self, msg: T)`


#### `limit_msg(&mut self, msg: T)`
...
#### `handle(&self, _message: &dyn Any)`


#### `as_any(&self)`


#### `throttler_resume(actor_id: Ustr)`
...
#### `test_buffering_send_to_limit_becomes_throttled(test_throttler_buffered: TestThrottler)`


#### `test_buffering_used_when_sent_to_limit_returns_one(test_throttler_buffered: TestThrottler)`
...
#### `test_buffering_send_message_after_buffering_message(test_throttler_buffered: TestThrottler)`
...
#### `test_dropping_send_sends_message_to_handler(test_throttler_unbuffered: TestThrottler)`


#### `test_dropping_send_to_limit_drops_message(test_throttler_unbuffered: TestThrottler)`
...
#### `test_dropping_send_message_after_dropping_message(test_throttler_unbuffered: TestThrottler)`
...
#### `test_throttler_with_inputs(inputs: Vec<ThrottlerInput>, test_throttler: TestThrottler)`
