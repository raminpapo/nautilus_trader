# Documentation: throttler.rs

## File Metadata

- **Path**: `crates/common/src/throttler.rs`
- **Size**: 26,068 bytes
- **Lines**: 817
- **Language**: Rust
...
This file is part of the NautilusTrader repository. It defines 39 function(s) and 4 class(es).
...
- **`delta_next()`**: Function defined in this file
- **`reset()`**: Function defined in this file
- **`used()`**: Function defined in this file
- **`qsize()`**: Function defined in this file
- **`to_actor()`**: Function defined in this file
- **`send_msg()`**: Function defined in this file
- **`limit_msg()`**: Function defined in this file
- **`send()`**: Function defined in this file
- **`new()`**: Function defined in this file
- **`get_timer_callback()`**: Function defined in this file
- **`id()`**: Function defined in this file
- **`handle()`**: Function defined in this file
- **`as_any()`**: Function defined in this file
...
### Classes
- **`RateLimit`**: Class defined in this file
- **`Throttler`**: Class defined in this file
- **`ThrottlerProcess`**: Class defined in this file
- **`TestThrottler`**: Class defined in this file
...
**Enums**: `ThrottlerInput`
**Functions**: `as_any`, `delta_next`, `fmt`, `get_throttler`, `get_timer_callback`, `handle`, `id`, `limit_msg`, `new`, `prop_test`, `qsize`, `reset`, `send`, `send_msg`, `set_timer`, `test_buffering_refresh_when_at_limit_sends_remaining_items`, `test_buffering_send_message_after_buffering_message`, `test_buffering_send_message_after_halfway_after_buffering_message`, `test_buffering_send_to_limit_becomes_throttled`, `test_buffering_used_before_limit_when_halfway_returns_half`, `test_buffering_used_when_half_interval_from_limit_returns_one`, `test_buffering_used_when_sent_to_limit_returns_one`, `test_dropping_advance_time_when_at_limit_dropped_message`, `test_dropping_send_message_after_dropping_message`, `test_dropping_send_sends_message_to_handler`, `test_dropping_send_to_limit_drops_message`, `test_throttler_buffered`, `test_throttler_unbuffered`, `test_throttler_with_inputs`, `throttler_input_strategy` *(+4 more)*
**Impls**: `Actor`, `Debug`, `MessageHandler`, `RateLimit`, `Strategy`, `TestThrottler`, `Throttler`, `ThrottlerProcess`
**Structs**: `RateLimit`, `TestThrottler`, `Throttler`, `ThrottlerProcess`
...
---
*Generated on 2025-11-18T21:55:01.313266Z*
