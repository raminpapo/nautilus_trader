# Documentation: clock.rs

## File Metadata

- **Path**: `crates/common/src/clock.rs`
- **Size**: 66,277 bytes
- **Lines**: 2,021
- **Language**: Rust
...
This file is part of the NautilusTrader repository. It defines 109 function(s) and 6 class(es).

## Detailed Walkthrough

### Functions
- **`utc_now()`**: Function defined in this file
- **`timestamp_ns()`**: Function defined in this file
- **`timestamp_us()`**: Function defined in this file
- **`timestamp_ms()`**: Function defined in this file
- **`timestamp()`**: Function defined in this file
- **`timer_names()`**: Function defined in this file
- **`timer_count()`**: Function defined in this file
- **`timer_exists()`**: Function defined in this file
- **`register_default_handler()`**: Function defined in this file
- **`get_handler()`**: Function defined in this file
- **`set_time_alert()`**: Function defined in this file
- **`set_time_alert_ns()`**: Function defined in this file
- **`set_timer()`**: Function defined in this file
- **`set_timer_ns()`**: Function defined in this file
- **`next_time_ns()`**: Function defined in this file
- **`cancel_timer()`**: Function defined in this file
- **`cancel_timers()`**: Function defined in this file
- **`reset()`**: Function defined in this file
- **`as_any()`**: Function defined in this file
- **`as_any_mut()`**: Function defined in this file

*...and 89 more functions*

### Classes
- **`TestClock`**: Class defined in this file
- **`LiveClock`**: Class defined in this file
- **`to`**: Class defined in this file
- **`TimeEventStream`**: Class defined in this file
- **`TestCallback`**: Class defined in this file
- **`CollectingSender`**: Class defined in this file


## Keywords and Identifiers

Total unique keywords extracted: 87


**Functions**: `advance_time`, `advance_to_time_on_heap`, `as_any`, `as_any_mut`, `cancel_timer`, `cancel_timers`, `clear_expired_timers`, `default`, `deref`, `from`, `get_handler`, `get_timers`, `match_handlers`, `new`, `next`, `next_time_ns`, `poll_next`, `register_default_handler`, `reset`, `send`, `set_time_alert`, `set_time_alert_ns`, `set_timer`, `set_timer_ns`, `test_allow_past_bar_aggregation_use_case`, `test_allow_past_false_rejects_when_next_event_in_past`, `test_allow_past_false_with_fire_immediately_true`, `test_allow_past_parameter_false`, `test_allow_past_parameter_true`, `test_cancel_all_timers` *(+42 more)*
**Impls**: `Clock`, `CollectingSender`, `Default`, `Deref`, `From`, `Iterator`, `LiveClock`, `Stream`, `TestCallback`, `TestClock`, `TimeEventSender`, `TimeEventStream`, `dyn`
**Structs**: `CollectingSender`, `LiveClock`, `TestCallback`, `TestClock`, `TimeEventStream`, `to`
**Traits**: `Clock`, `documentation`
...
---
*Generated on 2025-11-18T21:55:01.079484Z*
