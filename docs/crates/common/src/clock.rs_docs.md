# Documentation: `crates/common/src/clock.rs`
**Generated:** 2025-11-15T19:40:01.702367Z
**File Size:** 66284 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/common/src/clock.rs` within the repository.

**Classes defined:** TestClock, LiveClock, to, TimeEventStream, TestCallback, CollectingSender, dyn, TestClock, Iterator, Default and 12 more

**Functions defined:** utc_now, timestamp_ns, timestamp_us, timestamp_ms, timestamp, timer_names, timer_count, timer_exists, register_default_handler, get_handler and 99 more
...
#### `timer_exists(&self, name: &Ustr)`


#### `register_default_handler(&mut self, callback: TimeEventCallback)`


#### `get_handler(&self, event: TimeEvent)`
...
#### `next_time_ns(&self, name: &str)`


#### `cancel_timer(&mut self, name: &str)`


#### `cancel_timers(&mut self)`
...
#### `advance_time(&mut self, to_time_ns: UnixNanos, set_time: bool)`


#### `advance_to_time_on_heap(&mut self, to_time_ns: UnixNanos)`


#### `match_handlers(&self, events: Vec<TimeEvent>)`
...
#### `new(sender: Option<Arc<dyn TimeEventSender>>)`


#### `get_timers(&self)`


#### `clear_expired_timers(&mut self)`
