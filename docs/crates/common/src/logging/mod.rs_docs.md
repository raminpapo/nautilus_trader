...
- **Path**: `crates/common/src/logging/mod.rs`
- **Size**: 12,170 bytes
- **Lines**: 363
- **Language**: Rust
...
- **`init_tracing()`**: Function defined in this file
- **`init_logging()`**: Function defined in this file
- **`map_log_level_to_filter()`**: Function defined in this file
- **`parse_level_filter_str()`**: Function defined in this file
- **`parse_component_levels()`**: Function defined in this file
- **`log_task_started()`**: Function defined in this file
- **`log_task_stopped()`**: Function defined in this file
- **`log_task_awaiting()`**: Function defined in this file
- **`log_task_aborted()`**: Function defined in this file
- **`log_task_error()`**: Function defined in this file
- **`test_parse_level_filter_str_case_insensitive()`**: Function defined in this file
- **`test_parse_level_filter_str_invalid_returns_error()`**: Function defined in this file
- **`test_parse_component_levels_valid()`**: Function defined in this file
...
**Functions**: `init_logging`, `init_tracing`, `log_task_aborted`, `log_task_awaiting`, `log_task_error`, `log_task_started`, `log_task_stopped`, `logging_clock_set_realtime_mode`, `logging_clock_set_static_mode`, `logging_clock_set_static_time`, `logging_is_colored`, `logging_is_initialized`, `logging_set_bypass`, `logging_shutdown`, `map_log_level_to_filter`, `parse_component_levels`, `parse_level_filter_str`, `test_parse_component_levels_invalid_level_returns_error`, `test_parse_component_levels_non_string_value_returns_error`, `test_parse_component_levels_none_returns_empty`, `test_parse_component_levels_valid`, `test_parse_level_filter_str_case_insensitive`, `test_parse_level_filter_str_invalid_returns_error`
...
---
*Generated on 2025-11-18T21:55:01.160379Z*
