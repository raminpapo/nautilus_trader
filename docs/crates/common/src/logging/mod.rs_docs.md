# Documentation: `crates/common/src/logging/mod.rs`
**Generated:** 2025-11-15T19:40:01.749749Z
...
This file is located at `crates/common/src/logging/mod.rs` within the repository.

**Functions defined:** logging_is_initialized, logging_set_bypass, logging_shutdown, logging_is_colored, logging_clock_set_realtime_mode, logging_clock_set_static_mode, logging_clock_set_static_time, init_tracing, init_logging, map_log_level_to_filter and 13 more
...
#### `logging_clock_set_static_time(time_ns: u64)`
...
#### `map_log_level_to_filter(log_level: LogLevel)`


#### `parse_level_filter_str(s: &str)`
...
#### `log_task_awaiting(task_name: &str)`


#### `log_task_aborted(task_name: &str)`


#### `log_task_error(task_name: &str, e: &anyhow::Error)`
...
#### `test_parse_level_filter_str_invalid_returns_error(#[case] invalid_input: &str)`
...
**Directory:** `crates/common/src/logging`
