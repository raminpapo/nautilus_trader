# Documentation: headers.rs

## File Metadata

- **Path**: `crates/common/src/logging/headers.rs`
- **Size**: 6,844 bytes
- **Lines**: 166
- **Language**: Rust
...
### Functions
- **`log_header()`**: Function defined in this file
- **`log_rust_versioning()`**: Function defined in this file
- **`log_python_versioning()`**: Function defined in this file
- **`python_available()`**: Function defined in this file
- **`log_sysinfo()`**: Function defined in this file
- **`header_sepr()`**: Function defined in this file
- **`header_line()`**: Function defined in this file
- **`bytes_to_gib()`**: Function defined in this file
- **`python_package_version()`**: Function defined in this file
- **`python_version()`**: Function defined in this file
...
**Functions**: `bytes_to_gib`, `header_line`, `header_sepr`, `log_header`, `log_python_versioning`, `log_rust_versioning`, `log_sysinfo`, `python_available`, `python_package_version`, `python_version`
...
---
*Generated on 2025-11-18T21:55:01.140619Z*
