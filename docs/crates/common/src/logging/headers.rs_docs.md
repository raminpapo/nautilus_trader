# Documentation: `crates/common/src/logging/headers.rs`
**Generated:** 2025-11-15T19:40:01.740701Z
**File Size:** 7588 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/common/src/logging/headers.rs` within the repository.

**Functions defined:** log_header, log_rust_versioning, log_python_versioning, python_available, log_sysinfo, header_sepr, header_line, bytes_to_gib, python_package_version, python_version
...
#### `log_header(trader_id: TraderId, machine_id: &str, instance_id: UUID4, component: Ustr)`


#### `log_rust_versioning(c: Ustr)`


#### `log_python_versioning(c: Ustr)`


#### `python_available()`


#### `log_sysinfo(component: Ustr)`


#### `header_sepr(c: Ustr, s: &str)`


#### `header_line(c: Ustr, s: &str)`


#### `bytes_to_gib(b: u64)`


#### `python_package_version(package: &str)`
