# Documentation: `crates/common/src/logging/writer.rs`
**Generated:** 2025-11-15T19:40:01.752288Z
...
This file is located at `crates/common/src/logging/writer.rs` within the repository.

**Classes defined:** StdoutWriter, StderrWriter, FileRotateConfig, FileWriterConfig, FileWriter, StdoutWriter, LogWriter, StderrWriter, LogWriter, Default and 4 more

**Functions defined:** write, flush, enabled, new, write, flush, enabled, new, write, flush and 17 more
...
#### `write(&mut self, line: &str)`


#### `flush(&mut self)`


#### `enabled(&self, line: &LogLine)`


#### `new(level: LevelFilter, is_colored: bool)`
...
#### `should_rotate_file(&self, next_line_size: u64)`


#### `rotate_file(&mut self)`


#### `cleanup_backups(rotate_config: &mut FileRotateConfig)`
...
#### `strip_nonprinting_except_newline(s: &str)`


#### `strip_ansi_codes(s: &str)`


#### `test_file_writer_with_rotation_creates_new_timestamped_file()`


#### `test_strip_nonprinting_except_newline(#[case] input: &str, #[case] expected: &str)`


#### `test_strip_ansi_codes(#[case] input: &str, #[case] expected: &str)`
