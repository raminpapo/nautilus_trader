# Documentation: writer.rs

## File Metadata

- **Path**: `crates/common/src/logging/writer.rs`
- **Size**: 15,309 bytes
- **Lines**: 492
- **Language**: Rust
...
This file is part of the NautilusTrader repository. It defines 27 function(s) and 5 class(es).
...
- **`new()`**: Function defined in this file
- **`new()`**: Function defined in this file
- **`create_log_file_path()`**: Function defined in this file
- **`should_rotate_file()`**: Function defined in this file
- **`rotate_file()`**: Function defined in this file
- **`cleanup_backups()`**: Function defined in this file
- **`write()`**: Function defined in this file

*...and 7 more functions*

### Classes
- **`StdoutWriter`**: Class defined in this file
- **`StderrWriter`**: Class defined in this file
- **`FileRotateConfig`**: Class defined in this file
- **`FileWriterConfig`**: Class defined in this file
- **`FileWriter`**: Class defined in this file
...
**Functions**: `cleanup_backups`, `create_log_file_path`, `default`, `enabled`, `flush`, `from`, `new`, `rotate_file`, `should_rotate_file`, `strip_ansi_codes`, `strip_nonprinting_except_newline`, `test_file_writer_with_rotation_creates_new_timestamped_file`, `test_strip_ansi_codes`, `test_strip_nonprinting_except_newline`, `write`
**Impls**: `Default`, `FileWriter`, `FileWriterConfig`, `From`, `LogWriter`, `StderrWriter`, `StdoutWriter`
**Structs**: `FileRotateConfig`, `FileWriter`, `FileWriterConfig`, `StderrWriter`, `StdoutWriter`
**Traits**: `LogWriter`
...
---
*Generated on 2025-11-18T21:55:01.164624Z*
