...
This file is part of the NautilusTrader repository. It defines 206 function(s) and 2 class(es).
...
- **`py_new()`**: Function defined in this file
- **`actor_path()`**: Function defined in this file
- **`config_path()`**: Function defined in this file
- **`config()`**: Function defined in this file
- **`deref()`**: Function defined in this file
- **`deref_mut()`**: Function defined in this file
- **`new()`**: Function defined in this file
- **`set_python_instance()`**: Function defined in this file
- **`set_actor_id()`**: Function defined in this file
- **`set_log_events()`**: Function defined in this file
- **`set_log_commands()`**: Function defined in this file
- **`mem_address()`**: Function defined in this file
- **`is_registered()`**: Function defined in this file
...
*...and 186 more functions*

### Classes
- **`PyDataActor`**: Class defined in this file
- **`TestDataActor`**: Class defined in this file


## Keywords and Identifiers

Total unique keywords extracted: 192


**Functions**: `actor_path`, `bar_type`, `cache`, `client_id`, `clock`, `config`, `config_path`, `create_registered_actor`, `create_unregistered_actor`, `data_type`, `deref`, `deref_mut`, `get_call_count`, `is_registered`, `mem_address`, `new`, `on_bar`, `on_block`, `on_book`, `on_book_deltas`, `on_data`, `on_degrade`, `on_dispose`, `on_fault`, `on_funding_rate`, `on_historical_bars`, `on_historical_data`, `on_historical_index_prices`, `on_historical_mark_prices`, `on_historical_quotes` *(+154 more)*
**Impls**: `DataActor`, `DataActorConfig`, `Deref`, `DerefMut`, `ImportableActorConfig`, `PyDataActor`, `TestDataActor`
**Structs**: `PyDataActor`, `TestDataActor`
**Traits**: `method`
...
---
*Generated on 2025-11-18T21:55:01.256037Z*
