# Documentation: `crates/common/src/python/actor.rs`
**Generated:** 2025-11-15T19:40:01.810776Z
...
- **Path:** `crates/common/src/python/actor.rs`
- **Size:** 78,932 bytes
- **Lines:** 2,379
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/common/src/python/actor.rs` within the repository.

**Classes defined:** PyDataActor, TestDataActor, DataActorConfig, ImportableActorConfig, Deref, DerefMut, PyDataActor, DataActor, PyDataActor, TestDataActor and 3 more

**Functions defined:** py_new, py_new, actor_path, config_path, config, deref, deref_mut, new, set_python_instance, set_actor_id and 196 more
...
#### `py_new(actor_id: Option<ActorId>, log_events: bool, log_commands: bool)`


#### `py_new(actor_path: String, config_path: String, config: Py<PyDict>)`
...
#### `new(config: Option<DataActorConfig>)`


#### `set_python_instance(&mut self, py_obj: Py<PyAny>)`


#### `set_actor_id(&mut self, actor_id: ActorId)`


#### `set_log_events(&mut self, log_events: bool)`


#### `set_log_commands(&mut self, log_commands: bool)`
...
#### `on_historical_data(&mut self, _data: &dyn Any)`
...
#### `py_new(config: Option<DataActorConfig>)`


#### `py_clock(&self)`


*... and 156 more functions*
