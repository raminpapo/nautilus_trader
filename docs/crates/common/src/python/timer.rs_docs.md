# Documentation: `crates/common/src/python/timer.rs`
**Generated:** 2025-11-15T19:40:01.832480Z
...
This file is located at `crates/common/src/python/timer.rs` within the repository.

**Classes defined:** TimeEventHandler_Py, TestTimeEventSender, From, TimeEvent, TimeEventSender

**Functions defined:** from, py_new, __setstate__, __getstate__, __reduce__, _safe_constructor, __richcmp__, __repr__, py_name, py_event_id and 7 more
...
#### `from(value: TimeEventHandlerV2)`


#### `py_new(name: &str, event_id: UUID4, ts_event: u64, ts_init: u64)`
...
#### `receive_event(_py: Python, _event: TimeEvent)`


#### `send(&self, _handler: crate::timer::TimeEventHandlerV2)`
