...
This file is part of the NautilusTrader repository. It defines 79 function(s) and 1 class(es).

## Detailed Walkthrough

### Functions
- **`from_rc()`**: Function defined in this file
- **`py_instrument()`**: Function defined in this file
- **`py_quote()`**: Function defined in this file
- **`py_trade()`**: Function defined in this file
- **`py_bar()`**: Function defined in this file
- **`py_order_book()`**: Function defined in this file
- **`py_pool()`**: Function defined in this file
- **`py_pool_profiler()`**: Function defined in this file
- **`py_new()`**: Function defined in this file
- **`__str__()`**: Function defined in this file
- **`__repr__()`**: Function defined in this file
- **`encoding()`**: Function defined in this file
- **`timestamps_as_iso8601()`**: Function defined in this file
- **`buffer_interval_ms()`**: Function defined in this file
- **`use_trader_prefix()`**: Function defined in this file
- **`use_instance_id()`**: Function defined in this file
- **`flush_on_start()`**: Function defined in this file
- **`drop_instruments_on_reset()`**: Function defined in this file
- **`tick_capacity()`**: Function defined in this file
- **`bar_capacity()`**: Function defined in this file

*...and 59 more functions*

### Classes
- **`PyCache`**: Class defined in this file


## Keywords and Identifiers

Total unique keywords extracted: 73


**Functions**: `__repr__`, `__str__`, `bar_capacity`, `buffer_interval_ms`, `drop_instruments_on_reset`, `encoding`, `flush_on_start`, `from_rc`, `py_add_bar`, `py_add_currency`, `py_add_instrument`, `py_add_order`, `py_add_pool`, `py_add_pool_profiler`, `py_add_position`, `py_add_quote`, `py_add_trade`, `py_bar`, `py_bar_count`, `py_bars`, `py_book_update_count`, `py_dispose`, `py_funding_rate`, `py_has_bars`, `py_has_order_book`, `py_has_quote_ticks`, `py_has_trade_ticks`, `py_index_price`, `py_index_prices`, `py_instrument` *(+40 more)*
**Impls**: `Cache`, `CacheConfig`, `PyCache`
**Structs**: `PyCache`
...
---
*Generated on 2025-11-18T21:55:01.261408Z*
