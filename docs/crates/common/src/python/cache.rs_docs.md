# Documentation: `crates/common/src/python/cache.rs`
**Generated:** 2025-11-15T19:40:01.814499Z
...
- **Path:** `crates/common/src/python/cache.rs`
- **Size:** 19,090 bytes
- **Lines:** 633
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/common/src/python/cache.rs` within the repository.

**Classes defined:** PyCache, PyCache, PyCache, CacheConfig, Cache

**Functions defined:** from_rc, py_instrument, py_quote, py_trade, py_bar, py_order_book, py_pool, py_pool_profiler, py_new, __str__ and 69 more
...
#### `py_quote(&self, instrument_id: InstrumentId)`


#### `py_trade(&self, instrument_id: InstrumentId)`


#### `py_bar(&self, bar_type: BarType)`


#### `py_order_book(&self, instrument_id: InstrumentId)`


#### `py_pool(&self, instrument_id: InstrumentId)`


#### `py_pool_profiler(&self, instrument_id: InstrumentId)`
...
#### `timestamps_as_iso8601(&self)`


#### `buffer_interval_ms(&self)`


#### `use_trader_prefix(&self)`


#### `use_instance_id(&self)`


#### `flush_on_start(&self)`


#### `drop_instruments_on_reset(&self)`
...
#### `save_market_data(&self)`


#### `py_new(config: Option<CacheConfig>)`
...
#### `py_add_currency(&mut self, currency: Currency)`


#### `py_add_instrument(&mut self, py: Python, instrument: Py<PyAny>)`
...
#### `py_instrument_ids(&self, venue: Option<Venue>)`


#### `py_instruments(&self, py: Python, venue: Option<Venue>)`
...
#### `py_order(&self, py: Python, client_order_id: ClientOrderId)`


#### `py_order_exists(&self, client_order_id: ClientOrderId)`


#### `py_is_order_open(&self, client_order_id: ClientOrderId)`


#### `py_is_order_closed(&self, client_order_id: ClientOrderId)`
...
#### `py_position(&self, py: Python, position_id: PositionId)`


#### `py_position_exists(&self, position_id: PositionId)`


#### `py_is_position_open(&self, position_id: PositionId)`


#### `py_is_position_closed(&self, position_id: PositionId)`
...
#### `py_add_quote(&mut self, quote: QuoteTick)`


#### `py_add_trade(&mut self, trade: TradeTick)`


#### `py_add_bar(&mut self, bar: Bar)`
