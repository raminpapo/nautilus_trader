# Documentation: `crates/common/src/python/logging.rs`
**Generated:** 2025-11-15T19:40:01.825577Z
...
This file is located at `crates/common/src/python/logging.rs` within the repository.

**Classes defined:** PyLogger, LoggerConfig, FileWriterConfig, PyLogger, PyLogger

**Functions defined:** py_from_spec, py_new, py_init_tracing, py_init_logging, py_logger_flush, parse_component_levels, py_logger_log, py_log_header, py_log_sysinfo, py_logging_clock_set_static_mode and 13 more
...
#### `py_logger_log(level: LogLevel, color: LogColor, component: &str, message: &str)`


#### `py_log_header(trader_id: TraderId, machine_id: &str, instance_id: UUID4, component: &str)`


#### `py_log_sysinfo(component: &str)`
...
#### `py_logging_clock_set_static_time(time_ns: u64)`
...
#### `py_trace(&self, message: &str, color: Option<LogColor>)`


#### `py_debug(&self, message: &str, color: Option<LogColor>)`


#### `py_info(&self, message: &str, color: Option<LogColor>)`


#### `py_warning(&self, message: &str, color: Option<LogColor>)`


#### `py_error(&self, message: &str, color: Option<LogColor>)`


#### `py_exception(&self, py: Python, message: &str, color: Option<LogColor>)`


#### `py_flush(&self)`


#### `_log(&self, level: LogLevel, color: Option<LogColor>, message: &str)`
