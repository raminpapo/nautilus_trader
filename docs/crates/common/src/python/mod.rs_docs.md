# Documentation: `crates/common/src/python/mod.rs`
**Generated:** 2025-11-15T19:40:01.827187Z
...
- **Path:** `crates/common/src/python/mod.rs`
- **Size:** 4,056 bytes
- **Lines:** 88
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/common/src/python/mod.rs` within the repository.

**Functions defined:** common
...
#### `common(_: Python<'_>, m: &Bound<'_, PyModule>)`
