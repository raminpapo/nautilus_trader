# Documentation: `crates/common/src/python/clock.rs`
**Generated:** 2025-11-15T19:40:01.817577Z
**File Size:** 17243 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/common/src/python/clock.rs` within the repository.

**Classes defined:** PyClock, DummySender, PyClock, PyClock, TimeEventSender

**Functions defined:** py_register_default_handler, py_set_time_alert, py_set_time_alert_ns, py_set_timer, py_set_timer_ns, py_next_time_ns, py_cancel_timer, py_cancel_timers, from_rc, new_test and 22 more
...
#### `py_register_default_handler(&mut self, callback: Py<PyAny>)`
...
#### `py_next_time_ns(&self, name: &str)`


#### `py_cancel_timer(&mut self, name: &str)`


#### `py_cancel_timers(&mut self)`


#### `from_rc(rc: Rc<RefCell<dyn Clock>>)`
...
#### `test_test_clock_raw_set_timer_ns(mut test_clock: TestClock)`


#### `test_test_clock_cancel_timer(mut test_clock: TestClock)`


#### `test_test_clock_cancel_timers(mut test_clock: TestClock)`


#### `test_test_clock_advance_within_stop_time_py(mut test_clock: TestClock)`


#### `test_test_clock_advance_time_to_stop_time_with_set_time_true(mut test_clock: TestClock)`


#### `test_test_clock_advance_time_to_stop_time_with_set_time_false(mut test_clock: TestClock)`
