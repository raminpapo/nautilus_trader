...
- **Path**: `crates/common/src/python/clock.rs`
- **Size**: 17,241 bytes
- **Lines**: 537
- **Language**: Rust
...
### Functions
- **`py_register_default_handler()`**: Function defined in this file
- **`py_set_time_alert()`**: Function defined in this file
- **`py_set_time_alert_ns()`**: Function defined in this file
- **`py_set_timer()`**: Function defined in this file
- **`py_set_timer_ns()`**: Function defined in this file
- **`py_next_time_ns()`**: Function defined in this file
- **`py_cancel_timer()`**: Function defined in this file
- **`py_cancel_timers()`**: Function defined in this file
- **`from_rc()`**: Function defined in this file
- **`new_test()`**: Function defined in this file
- **`new_live()`**: Function defined in this file
- **`inner()`**: Function defined in this file
- **`inner_mut()`**: Function defined in this file
- **`ensure_sender()`**: Function defined in this file
- **`send()`**: Function defined in this file
- **`test_clock()`**: Function defined in this file
- **`test_callback()`**: Function defined in this file
- **`test_py_callback()`**: Function defined in this file
- **`test_test_clock_py_set_time_alert()`**: Function defined in this file
- **`test_test_clock_py_set_timer()`**: Function defined in this file

*...and 12 more functions*

### Classes
- **`PyClock`**: Class defined in this file
- **`DummySender`**: Class defined in this file
...
**Functions**: `ensure_sender`, `from_rc`, `inner`, `inner_mut`, `new_live`, `new_test`, `py_cancel_timer`, `py_cancel_timers`, `py_next_time_ns`, `py_register_default_handler`, `py_set_time_alert`, `py_set_time_alert_ns`, `py_set_timer`, `py_set_timer_ns`, `send`, `test_callback`, `test_clock`, `test_live_clock_py_set_time_alert`, `test_live_clock_py_set_time_alert_ns`, `test_live_clock_py_set_timer`, `test_live_clock_py_set_timer_ns`, `test_py_callback`, `test_test_clock_advance_time_to_stop_time_with_set_time_false`, `test_test_clock_advance_time_to_stop_time_with_set_time_true`, `test_test_clock_advance_within_stop_time_py`, `test_test_clock_cancel_timer`, `test_test_clock_cancel_timers`, `test_test_clock_py_set_time_alert`, `test_test_clock_py_set_time_alert_ns`, `test_test_clock_py_set_timer` *(+2 more)*
**Impls**: `PyClock`, `TimeEventSender`
**Structs**: `DummySender`, `PyClock`
**Traits**: `object`
...
---
*Generated on 2025-11-18T21:55:01.266851Z*
