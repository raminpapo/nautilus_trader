...
### Functions
- **`get_defi_blocks_topic()`**: Function defined in this file
- **`get_defi_pool_topic()`**: Function defined in this file
- **`get_defi_pool_swaps_topic()`**: Function defined in this file
- **`get_defi_liquidity_topic()`**: Function defined in this file
- **`get_defi_collect_topic()`**: Function defined in this file
- **`get_defi_flash_topic()`**: Function defined in this file
- **`get_defi_blocks_topic()`**: Function defined in this file
- **`get_defi_pool_topic()`**: Function defined in this file
- **`get_defi_pool_swaps_topic()`**: Function defined in this file
- **`get_defi_pool_liquidity_topic()`**: Function defined in this file
- **`get_defi_pool_collect_topic()`**: Function defined in this file
- **`get_defi_pool_flash_topic()`**: Function defined in this file

### Classes
- **`DefiSwitchboard`**: Class defined in this file
...
**Functions**: `get_defi_blocks_topic`, `get_defi_collect_topic`, `get_defi_flash_topic`, `get_defi_liquidity_topic`, `get_defi_pool_collect_topic`, `get_defi_pool_flash_topic`, `get_defi_pool_liquidity_topic`, `get_defi_pool_swaps_topic`, `get_defi_pool_topic`
**Impls**: `MessagingSwitchboard`
**Structs**: `DefiSwitchboard`
...
---
*Generated on 2025-11-18T21:55:01.097286Z*
