...
- **Path**: `crates/common/src/messages/defi/mod.rs`
- **Size**: 10,172 bytes
- **Lines**: 308
- **Language**: Rust
...
**Enums**: `DefiDataCommand`, `DefiRequestCommand`, `DefiSubscribeCommand`, `DefiUnsubscribeCommand`
**Functions**: `as_any`, `blockchain`, `client_id`, `command_id`, `eq`, `request_id`, `ts_init`, `venue`
**Impls**: `DefiDataCommand`, `DefiRequestCommand`, `DefiSubscribeCommand`, `DefiUnsubscribeCommand`, `PartialEq`
**Traits**: `object`
...
---
*Generated on 2025-11-18T21:55:01.185100Z*
