# Documentation: `crates/common/src/messages/defi/mod.rs`
**Generated:** 2025-11-15T19:40:01.764981Z
**File Size:** 10172 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/common/src/messages/defi/mod.rs` within the repository.

**Classes defined:** PartialEq, DefiDataCommand, PartialEq, DefiSubscribeCommand, PartialEq, DefiUnsubscribeCommand, PartialEq, DefiRequestCommand

**Functions defined:** eq, as_any, command_id, client_id, venue, ts_init, eq, as_any, blockchain, command_id and 16 more
