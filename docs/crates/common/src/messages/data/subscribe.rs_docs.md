...
- **Path**: `crates/common/src/messages/data/subscribe.rs`
- **Size**: 13,224 bytes
- **Lines**: 501
- **Language**: Rust
...
### Classes
- **`SubscribeCustomData`**: Class defined in this file
- **`SubscribeInstrument`**: Class defined in this file
- **`SubscribeInstruments`**: Class defined in this file
- **`SubscribeBookDeltas`**: Class defined in this file
- **`SubscribeBookDepth10`**: Class defined in this file
- **`SubscribeBookSnapshots`**: Class defined in this file
- **`SubscribeQuotes`**: Class defined in this file
- **`SubscribeTrades`**: Class defined in this file
- **`SubscribeBars`**: Class defined in this file
- **`SubscribeMarkPrices`**: Class defined in this file
- **`SubscribeIndexPrices`**: Class defined in this file
- **`SubscribeFundingRates`**: Class defined in this file
- **`SubscribeInstrumentStatus`**: Class defined in this file
- **`SubscribeInstrumentClose`**: Class defined in this file
...
**Functions**: `new`
**Impls**: `SubscribeBars`, `SubscribeBookDeltas`, `SubscribeBookDepth10`, `SubscribeBookSnapshots`, `SubscribeCustomData`, `SubscribeFundingRates`, `SubscribeIndexPrices`, `SubscribeInstrument`, `SubscribeInstrumentClose`, `SubscribeInstrumentStatus`, `SubscribeInstruments`, `SubscribeMarkPrices`, `SubscribeQuotes`, `SubscribeTrades`
**Structs**: `SubscribeBars`, `SubscribeBookDeltas`, `SubscribeBookDepth10`, `SubscribeBookSnapshots`, `SubscribeCustomData`, `SubscribeFundingRates`, `SubscribeIndexPrices`, `SubscribeInstrument`, `SubscribeInstrumentClose`, `SubscribeInstrumentStatus`, `SubscribeInstruments`, `SubscribeMarkPrices`, `SubscribeQuotes`, `SubscribeTrades`
...
---
*Generated on 2025-11-18T21:55:01.178554Z*
