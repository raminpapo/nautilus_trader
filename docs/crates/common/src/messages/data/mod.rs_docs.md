...
- **Path**: `crates/common/src/messages/data/mod.rs`
- **Size**: 15,532 bytes
- **Lines**: 410
- **Language**: Rust
...
- **`venue()`**: Function defined in this file
- **`ts_init()`**: Function defined in this file
- **`check_client_id_or_venue()`**: Function defined in this file
- **`eq()`**: Function defined in this file
- **`as_any()`**: Function defined in this file
...
**Enums**: `DataCommand`, `DataResponse`, `RequestCommand`, `SubscribeCommand`, `UnsubscribeCommand`
**Functions**: `as_any`, `check_client_id_or_venue`, `client_id`, `command_id`, `correlation_id`, `eq`, `request_id`, `ts_init`, `venue`
**Impls**: `DataCommand`, `DataResponse`, `PartialEq`, `RequestCommand`, `SubscribeCommand`, `UnsubscribeCommand`
**Traits**: `object`
...
---
*Generated on 2025-11-18T21:55:01.169786Z*
