# Documentation: `crates/common/src/messages/data/mod.rs`
**Generated:** 2025-11-15T19:40:01.754918Z
...
This file is located at `crates/common/src/messages/data/mod.rs` within the repository.

**Classes defined:** DataCommand, PartialEq, SubscribeCommand, PartialEq, UnsubscribeCommand, PartialEq, RequestCommand, DataResponse

**Functions defined:** as_any, eq, as_any, command_id, client_id, venue, ts_init, eq, as_any, command_id and 12 more
...
#### `check_client_id_or_venue(client_id: &Option<ClientId>, venue: &Option<Venue>)`
