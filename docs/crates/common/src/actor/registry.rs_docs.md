# Documentation: `crates/common/src/actor/registry.rs`
**Generated:** 2025-11-15T19:40:01.653617Z
**File Size:** 5410 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/common/src/actor/registry.rs` within the repository.

**Classes defined:** ActorRegistry, Debug, Default, ActorRegistry

**Functions defined:** fmt, default, new, insert, get, len, is_empty, remove, contains, get_actor_registry and 7 more
...
#### `insert(&self, id: Ustr, actor: Rc<UnsafeCell<dyn Actor>>)`
...
#### `contains(&self, id: &Ustr)`


#### `get_actor_registry()`


#### `register_actor(actor: T)`


#### `get_actor(id: &Ustr)`


#### `get_actor_unchecked(id: &Ustr)`


#### `try_get_actor_unchecked(id: &Ustr)`


#### `actor_exists(id: &Ustr)`
