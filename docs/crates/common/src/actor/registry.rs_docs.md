# Documentation: registry.rs

## File Metadata

- **Path**: `crates/common/src/actor/registry.rs`
- **Size**: 5,410 bytes
- **Lines**: 167
- **Language**: Rust
...
- **`get_actor_registry()`**: Function defined in this file
- **`register_actor()`**: Function defined in this file
- **`get_actor()`**: Function defined in this file
- **`get_actor_unchecked()`**: Function defined in this file
- **`try_get_actor_unchecked()`**: Function defined in this file
- **`actor_exists()`**: Function defined in this file
- **`actor_count()`**: Function defined in this file
- **`clear_actor_registry()`**: Function defined in this file

### Classes
- **`ActorRegistry`**: Class defined in this file
...
**Functions**: `actor_count`, `actor_exists`, `clear_actor_registry`, `contains`, `default`, `fmt`, `get`, `get_actor`, `get_actor_registry`, `get_actor_unchecked`, `insert`, `is_empty`, `len`, `new`, `register_actor`, `remove`, `try_get_actor_unchecked`
**Impls**: `ActorRegistry`, `Debug`, `Default`
**Structs**: `ActorRegistry`
...
---
*Generated on 2025-11-18T21:55:00.993176Z*
