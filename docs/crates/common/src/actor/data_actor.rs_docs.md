...
This file is part of the NautilusTrader repository. It defines 190 function(s) and 3 class(es).

## Detailed Walkthrough

### Functions
- **`default()`**: Function defined in this file
- **`on_save()`**: Function defined in this file
- **`on_load()`**: Function defined in this file
- **`on_start()`**: Function defined in this file
- **`on_stop()`**: Function defined in this file
- **`on_resume()`**: Function defined in this file
- **`on_reset()`**: Function defined in this file
- **`on_dispose()`**: Function defined in this file
- **`on_degrade()`**: Function defined in this file
- **`on_fault()`**: Function defined in this file
- **`on_time_event()`**: Function defined in this file
- **`on_data()`**: Function defined in this file
- **`on_signal()`**: Function defined in this file
- **`on_instrument()`**: Function defined in this file
- **`on_book_deltas()`**: Function defined in this file
- **`on_book()`**: Function defined in this file
- **`on_quote()`**: Function defined in this file
- **`on_trade()`**: Function defined in this file
- **`on_bar()`**: Function defined in this file
- **`on_mark_price()`**: Function defined in this file

*...and 170 more functions*

### Classes
- **`DataActorConfig`**: Class defined in this file
- **`ImportableActorConfig`**: Class defined in this file
- **`DataActorCore`**: Class defined in this file


## Keywords and Identifiers

Total unique keywords extracted: 155


**Functions**: `actor_id`, `add_subscription`, `as_any`, `cache`, `cache_rc`, `check_registered`, `check_timestamps`, `clock`, `clock_rc`, `clock_ref`, `component_id`, `default`, `default_actor_id`, `deregister_warning_event`, `fmt`, `handle`, `handle_bar`, `handle_bars_response`, `handle_block`, `handle_book`, `handle_book_deltas`, `handle_book_response`, `handle_data`, `handle_data_response`, `handle_funding_rate`, `handle_historical_data`, `handle_index_price`, `handle_instrument`, `handle_instrument_close`, `handle_instrument_response` *(+116 more)*
**Impls**: `Actor`, `Component`, `DataActorCore`, `Debug`, `Default`, `blocks`
**Structs**: `DataActorConfig`, `DataActorCore`, `ImportableActorConfig`
**Traits**: `DataActor`

## Related Files

This file is located in `crates/common/src/actor/`. Related files may include:
...
---
*Generated on 2025-11-18T21:55:00.985944Z*
