# Documentation: `crates/common/src/actor/data_actor.rs`
**Generated:** 2025-11-15T19:40:01.648414Z
**File Size:** 99261 bytes
**Extension:** .rs
**Type:** text
...
- **Path:** `crates/common/src/actor/data_actor.rs`
- **Size:** 99,261 bytes
- **Lines:** 3,270
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/common/src/actor/data_actor.rs` within the repository.

**Classes defined:** DataActorConfig, ImportableActorConfig, DataActorCore, blocks, Default, Debug, DataActorCore

**Functions defined:** default, on_save, on_load, on_start, on_stop, on_resume, on_reset, on_dispose, on_degrade, on_fault and 180 more
...
#### `on_load(&mut self, state: IndexMap<String, Vec<u8>>)`
...
#### `on_time_event(&mut self, event: &TimeEvent)`


#### `on_data(&mut self, data: &dyn Any)`


#### `on_signal(&mut self, signal: &Signal)`


#### `on_instrument(&mut self, instrument: &InstrumentAny)`


#### `on_book_deltas(&mut self, deltas: &OrderBookDeltas)`


#### `on_book(&mut self, order_book: &OrderBook)`


#### `on_quote(&mut self, quote: &QuoteTick)`


#### `on_trade(&mut self, tick: &TradeTick)`


#### `on_bar(&mut self, bar: &Bar)`


#### `on_mark_price(&mut self, mark_price: &MarkPriceUpdate)`


#### `on_index_price(&mut self, index_price: &IndexPriceUpdate)`


#### `on_funding_rate(&mut self, funding_rate: &FundingRateUpdate)`


#### `on_instrument_status(&mut self, data: &InstrumentStatus)`


#### `on_instrument_close(&mut self, update: &InstrumentClose)`


#### `on_order_filled(&mut self, event: &OrderFilled)`


#### `on_block(&mut self, block: &Block)`


#### `on_pool(&mut self, pool: &Pool)`


#### `on_pool_swap(&mut self, swap: &PoolSwap)`


#### `on_pool_liquidity_update(&mut self, update: &PoolLiquidityUpdate)`


#### `on_pool_fee_collect(&mut self, collect: &PoolFeeCollect)`


#### `on_pool_flash(&mut self, flash: &PoolFlash)`


#### `on_historical_data(&mut self, data: &dyn Any)`


#### `on_historical_quotes(&mut self, quotes: &[QuoteTick])`


#### `on_historical_trades(&mut self, trades: &[TradeTick])`


#### `on_historical_bars(&mut self, bars: &[Bar])`


#### `on_historical_mark_prices(&mut self, mark_prices: &[MarkPriceUpdate])`
...
#### `handle_time_event(&mut self, event: &TimeEvent)`


#### `handle_data(&mut self, data: &dyn Any)`


#### `handle_signal(&mut self, signal: &Signal)`


#### `handle_instrument(&mut self, instrument: &InstrumentAny)`


#### `handle_book_deltas(&mut self, deltas: &OrderBookDeltas)`
...
#### `handle_mark_price(&mut self, mark_price: &MarkPriceUpdate)`


#### `handle_index_price(&mut self, index_price: &IndexPriceUpdate)`


#### `handle_funding_rate(&mut self, funding_rate: &FundingRateUpdate)`


#### `handle_instrument_status(&mut self, status: &InstrumentStatus)`
