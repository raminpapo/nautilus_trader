# Documentation: `crates/common/src/actor/tests.rs`
**Generated:** 2025-11-15T19:40:01.660235Z
**File Size:** 54489 bytes
**Extension:** .rs
**Type:** text
...
- **Path:** `crates/common/src/actor/tests.rs`
- **Size:** 54,489 bytes
- **Lines:** 1,856
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/common/src/actor/tests.rs` within the repository.

**Classes defined:** TestDataActor, DummyActor, SaveLoadActor, Deref, DerefMut, DataActor, TestDataActor, DummyActor, Actor, SaveLoadActor and 3 more

**Functions defined:** deref, deref_mut, on_start, on_time_event, on_instrument, on_data, on_book_deltas, on_book, on_quote, on_trade and 76 more
...
#### `on_book(&mut self, book: &OrderBook)`


#### `on_quote(&mut self, quote: &QuoteTick)`


#### `on_trade(&mut self, trade: &TradeTick)`
...
#### `on_instrument_status(&mut self, status: &InstrumentStatus)`


#### `on_instrument_close(&mut self, close: &InstrumentClose)`
...
#### `new(config: DataActorConfig)`


#### `custom_function(&mut self)`
...
#### `handle(&mut self, _msg: &dyn std::any::Any)`
...
#### `register_dummy(name: &str)`


#### `test_register_and_get(#[case] name: &str)`
