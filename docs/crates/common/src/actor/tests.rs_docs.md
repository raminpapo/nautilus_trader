...
This file is part of the NautilusTrader repository. It defines 87 function(s) and 3 class(es).
...
- **`on_historical_quotes()`**: Function defined in this file
- **`on_historical_trades()`**: Function defined in this file
- **`on_historical_bars()`**: Function defined in this file
- **`on_historical_data()`**: Function defined in this file
- **`on_mark_price()`**: Function defined in this file
- **`on_index_price()`**: Function defined in this file
- **`on_funding_rate()`**: Function defined in this file
- **`on_instrument_status()`**: Function defined in this file
- **`on_instrument_close()`**: Function defined in this file

*...and 67 more functions*

### Classes
- **`TestDataActor`**: Class defined in this file
- **`DummyActor`**: Class defined in this file
- **`SaveLoadActor`**: Class defined in this file


## Keywords and Identifiers

Total unique keywords extracted: 90


**Functions**: `as_any`, `cache`, `clock`, `custom_function`, `deref`, `deref_mut`, `handle`, `id`, `new`, `on_bar`, `on_block`, `on_book`, `on_book_deltas`, `on_data`, `on_funding_rate`, `on_historical_bars`, `on_historical_data`, `on_historical_quotes`, `on_historical_trades`, `on_index_price`, `on_instrument`, `on_instrument_close`, `on_instrument_status`, `on_load`, `on_mark_price`, `on_pool`, `on_pool_liquidity_update`, `on_pool_swap`, `on_quote`, `on_save` *(+53 more)*
**Impls**: `Actor`, `DataActor`, `Deref`, `DerefMut`, `DummyActor`, `SaveLoadActor`, `TestDataActor`
**Structs**: `DummyActor`, `SaveLoadActor`, `TestDataActor`
...
```bash
# For Python
pytest crates/common/src/actor/tests.rs
...
---
*Generated on 2025-11-18T21:55:01.005908Z*
