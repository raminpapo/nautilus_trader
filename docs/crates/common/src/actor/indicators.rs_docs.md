# Documentation: indicators.rs

## File Metadata

- **Path**: `crates/common/src/actor/indicators.rs`
- **Size**: 4,324 bytes
- **Lines**: 119
- **Language**: Rust
...
- **`register_indicator_for_quotes()`**: Function defined in this file
- **`register_indicator_for_trades()`**: Function defined in this file
- **`register_indicator_for_bars()`**: Function defined in this file

### Classes
- **`Indicators`**: Class defined in this file
...
**Functions**: `is_initialized`, `register_indicator_for_bars`, `register_indicator_for_quotes`, `register_indicator_for_trades`
**Impls**: `Indicators`
**Structs**: `Indicators`
...
---
*Generated on 2025-11-18T21:55:00.989270Z*
