# Documentation: `crates/common/src/runtime.rs`
**Generated:** 2025-11-15T19:40:01.837546Z
...
- **Path:** `crates/common/src/runtime.rs`
- **Size:** 3,864 bytes
- **Lines:** 100
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/common/src/runtime.rs` within the repository.

**Functions defined:** initialize_runtime, get_runtime, shutdown_runtime
...
#### `shutdown_runtime(wait: Duration)`
