...
- **Path**: `crates/common/src/greeks.rs`
- **Size**: 48,517 bytes
- **Lines**: 1,315
- **Language**: Rust
...
This file is part of the NautilusTrader repository. It defines 40 function(s) and 4 class(es).

## Detailed Walkthrough

### Functions
- **`from_fn()`**: Function defined in this file
- **`from_closure()`**: Function defined in this file
- **`call()`**: Function defined in this file
- **`to_greeks_filter()`**: Function defined in this file
- **`fmt()`**: Function defined in this file
- **`calculate()`**: Function defined in this file
- **`fmt()`**: Function defined in this file
- **`calculate()`**: Function defined in this file
- **`new()`**: Function defined in this file
- **`instrument_greeks()`**: Function defined in this file
- **`modify_greeks()`**: Function defined in this file
- **`portfolio_greeks()`**: Function defined in this file
- **`subscribe_greeks()`**: Function defined in this file
- **`create_test_calculator()`**: Function defined in this file
- **`test_greeks_calculator_creation()`**: Function defined in this file
- **`test_greeks_calculator_debug()`**: Function defined in this file
- **`test_greeks_calculator_has_python_bindings()`**: Function defined in this file
- **`test_instrument_greeks_params_builder_default()`**: Function defined in this file
- **`test_instrument_greeks_params_builder_custom_values()`**: Function defined in this file
- **`test_instrument_greeks_params_debug()`**: Function defined in this file

*...and 20 more functions*

### Classes
- **`InstrumentGreeksParams`**: Class defined in this file
- **`PortfolioGreeksParams`**: Class defined in this file
- **`GreeksCalculator`**: Class defined in this file
- **`compiles`**: Class defined in this file
...
**Enums**: `GreeksFilterCallback`
**Functions**: `calculate`, `call`, `create_test_calculator`, `filter_fn`, `filter_high_delta`, `filter_positive_delta`, `fmt`, `from_closure`, `from_fn`, `instrument_greeks`, `modify_greeks`, `new`, `portfolio_greeks`, `subscribe_greeks`, `test_builders_with_all_boolean_flags`, `test_builders_with_all_shocks`, `test_builders_with_empty_beta_weights`, `test_greeks_calculator_creation`, `test_greeks_calculator_debug`, `test_greeks_calculator_has_python_bindings`, `test_greeks_filter_callback_clone`, `test_greeks_filter_callback_closure`, `test_greeks_filter_callback_function`, `test_greeks_filter_to_greeks_filter_conversion`, `test_instrument_greeks_params_builder_custom_values`, `test_instrument_greeks_params_builder_default`, `test_instrument_greeks_params_builder_fluent_chaining`, `test_instrument_greeks_params_builder_missing_required_field`, `test_instrument_greeks_params_debug`, `test_portfolio_greeks_params_builder_custom_values` *(+7 more)*
**Impls**: `Debug`, `GreeksCalculator`, `GreeksFilterCallback`, `InstrumentGreeksParams`, `PortfolioGreeksParams`, `std`
**Structs**: `GreeksCalculator`, `InstrumentGreeksParams`, `PortfolioGreeksParams`, `compiles`
...
---
*Generated on 2025-11-18T21:55:01.134932Z*
