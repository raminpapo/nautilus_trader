...
- **Path**: `crates/common/src/factories.rs`
- **Size**: 11,645 bytes
- **Lines**: 349
- **Language**: Rust
...
- **`set_client_order_id_count()`**: Function defined in this file
- **`set_order_list_id_count()`**: Function defined in this file
- **`generate_client_order_id()`**: Function defined in this file
- **`generate_order_list_id()`**: Function defined in this file
- **`reset_factory()`**: Function defined in this file
- **`market()`**: Function defined in this file
- **`order_factory()`**: Function defined in this file
- **`test_generate_client_order_id()`**: Function defined in this file
- **`test_generate_order_list_id()`**: Function defined in this file
- **`test_set_client_order_id_count()`**: Function defined in this file
- **`test_set_order_list_id_count()`**: Function defined in this file
- **`test_reset_factory()`**: Function defined in this file
- **`order_factory_with_uuids()`**: Function defined in this file
- **`order_factory_with_hyphens_removed()`**: Function defined in this file
- **`order_factory_with_uuids_and_hyphens_removed()`**: Function defined in this file
- **`test_generate_client_order_id_with_uuids()`**: Function defined in this file
- **`test_generate_client_order_id_with_hyphens_removed()`**: Function defined in this file
- **`test_generate_client_order_id_with_uuids_and_hyphens_removed()`**: Function defined in this file
- **`test_market_order()`**: Function defined in this file

### Classes
- **`OrderFactory`**: Class defined in this file
...
**Functions**: `generate_client_order_id`, `generate_order_list_id`, `market`, `new`, `order_factory`, `order_factory_with_hyphens_removed`, `order_factory_with_uuids`, `order_factory_with_uuids_and_hyphens_removed`, `reset_factory`, `set_client_order_id_count`, `set_order_list_id_count`, `test_generate_client_order_id`, `test_generate_client_order_id_with_hyphens_removed`, `test_generate_client_order_id_with_uuids`, `test_generate_client_order_id_with_uuids_and_hyphens_removed`, `test_generate_order_list_id`, `test_market_order`, `test_reset_factory`, `test_set_client_order_id_count`, `test_set_order_list_id_count`
**Impls**: `OrderFactory`
**Structs**: `OrderFactory`
...
---
*Generated on 2025-11-18T21:55:01.103502Z*
