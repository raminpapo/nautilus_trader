# Documentation: `crates/common/src/factories.rs`
**Generated:** 2025-11-15T19:40:01.717600Z
**File Size:** 11645 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/common/src/factories.rs` within the repository.

**Classes defined:** OrderFactory, OrderFactory

**Functions defined:** new, set_client_order_id_count, set_order_list_id_count, generate_client_order_id, generate_order_list_id, reset_factory, market, order_factory, test_generate_client_order_id, test_generate_order_list_id and 10 more
...
#### `set_client_order_id_count(&mut self, count: usize)`


#### `set_order_list_id_count(&mut self, count: usize)`


#### `generate_client_order_id(&mut self)`


#### `generate_order_list_id(&mut self)`


#### `reset_factory(&mut self)`
...
#### `test_generate_client_order_id(mut order_factory: OrderFactory)`


#### `test_generate_order_list_id(mut order_factory: OrderFactory)`


#### `test_set_client_order_id_count(mut order_factory: OrderFactory)`


#### `test_set_order_list_id_count(mut order_factory: OrderFactory)`


#### `test_reset_factory(mut order_factory: OrderFactory)`
...
#### `test_generate_client_order_id_with_uuids(mut order_factory_with_uuids: OrderFactory)`
...
#### `test_market_order(mut order_factory: OrderFactory)`
