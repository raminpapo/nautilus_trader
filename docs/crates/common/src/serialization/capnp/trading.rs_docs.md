# Documentation: trading.rs

## File Metadata

- **Path**: `crates/common/src/serialization/capnp/trading.rs`
- **Size**: 21,015 bytes
- **Lines**: 622
- **Language**: Rust
...
### Functions
- **`populate_trading_command_header()`**: Function defined in this file
...
- **`to_capnp()`**: Function defined in this file
- **`to_capnp()`**: Function defined in this file
- **`command_id()`**: Function defined in this file
- **`ts_init()`**: Function defined in this file
- **`client_id()`**: Function defined in this file
- **`test_cancel_order_serialization()`**: Function defined in this file
- **`test_cancel_all_orders_serialization()`**: Function defined in this file
- **`test_batch_cancel_orders_serialization()`**: Function defined in this file
- **`test_modify_order_serialization()`**: Function defined in this file
- **`test_query_order_serialization()`**: Function defined in this file
- **`test_query_account_serialization()`**: Function defined in this file
- **`test_submit_order_serialization()`**: Function defined in this file
...
**Functions**: `client_id`, `command_id`, `populate_trading_command_header`, `test_batch_cancel_orders_serialization`, `test_cancel_all_orders_serialization`, `test_cancel_order_serialization`, `test_modify_order_serialization`, `test_query_account_serialization`, `test_query_order_serialization`, `test_submit_order_list_serialization`, `test_submit_order_serialization`, `test_trading_command_enum_serialization`, `to_capnp`, `ts_init`
**Impls**: `ToCapnp`

## Related Files

This file is located in `crates/common/src/serialization/capnp/`. Related files may include:
...
---
*Generated on 2025-11-18T21:55:01.302726Z*
