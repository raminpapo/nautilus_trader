# Documentation: `crates/common/src/serialization/capnp/trading.rs`
**Generated:** 2025-11-15T19:40:01.841626Z
**File Size:** 21023 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/common/src/serialization/capnp/trading.rs` within the repository.

**Functions defined:** populate_trading_command_header, to_capnp, to_capnp, to_capnp, to_capnp, to_capnp, to_capnp, to_capnp, to_capnp, to_capnp and 12 more
...
#### `to_capnp(&self, mut builder: Self::Builder)`
...
#### `test_cancel_order_serialization(command_id: UUID4, ts_init: UnixNanos)`


#### `test_cancel_all_orders_serialization(command_id: UUID4, ts_init: UnixNanos)`


#### `test_batch_cancel_orders_serialization(command_id: UUID4, ts_init: UnixNanos)`


#### `test_modify_order_serialization(command_id: UUID4, ts_init: UnixNanos)`


#### `test_query_order_serialization(command_id: UUID4, ts_init: UnixNanos)`


#### `test_query_account_serialization(command_id: UUID4, ts_init: UnixNanos)`


#### `test_submit_order_serialization(command_id: UUID4, ts_init: UnixNanos, client_id: ClientId)`
...
#### `test_trading_command_enum_serialization(command_id: UUID4, ts_init: UnixNanos)`
...
**Directory:** `crates/common/src/serialization/capnp`
