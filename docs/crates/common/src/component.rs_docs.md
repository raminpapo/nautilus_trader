# Documentation: component.rs

## File Metadata

- **Path**: `crates/common/src/component.rs`
- **Size**: 18,666 bytes
- **Lines**: 564
- **Language**: Rust
...
### Functions
- **`component_id()`**: Function defined in this file
- **`state()`**: Function defined in this file
- **`transition_state()`**: Function defined in this file
- **`is_ready()`**: Function defined in this file
- **`not_running()`**: Function defined in this file
- **`is_running()`**: Function defined in this file
- **`is_stopped()`**: Function defined in this file
- **`is_degraded()`**: Function defined in this file
- **`is_faulted()`**: Function defined in this file
- **`is_disposed()`**: Function defined in this file
...
- **`resume()`**: Function defined in this file
- **`degrade()`**: Function defined in this file
- **`fault()`**: Function defined in this file
...
### Classes
- **`ComponentRegistry`**: Class defined in this file
...
**Functions**: `clear_component_registry`, `component_id`, `default`, `degrade`, `dispose`, `dispose_component`, `fault`, `fmt`, `get`, `get_component`, `get_component_registry`, `initialize`, `insert`, `is_degraded`, `is_disposed`, `is_faulted`, `is_ready`, `is_running`, `is_stopped`, `log_error`, `new`, `not_running`, `on_degrade`, `on_dispose`, `on_fault`, `on_reset`, `on_resume`, `on_start`, `on_stop`, `register` *(+13 more)*
**Impls**: `ComponentRegistry`, `ComponentState`, `Debug`, `Default`
**Structs**: `ComponentRegistry`
**Traits**: `Component`
...
---
*Generated on 2025-11-18T21:55:01.083967Z*
