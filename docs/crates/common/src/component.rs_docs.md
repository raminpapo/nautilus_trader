# Documentation: `crates/common/src/component.rs`
**Generated:** 2025-11-15T19:40:01.706118Z
**File Size:** 18666 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/common/src/component.rs` within the repository.

**Classes defined:** ComponentRegistry, ComponentState, Debug, Default, ComponentRegistry

**Functions defined:** component_id, state, transition_state, is_ready, not_running, is_running, is_stopped, is_degraded, is_faulted, is_disposed and 33 more
...
#### `log_error(e: &anyhow::Error)`


#### `transition(&mut self, trigger: &ComponentTrigger)`
...
#### `insert(&self, id: Ustr, component: Rc<UnsafeCell<dyn Component>>)`
...
#### `register_component(component: T)`


#### `register_component_actor(component: T)`


#### `register_component_actor_by_ref(component: &T)`


#### `start_component(id: &Ustr)`


#### `stop_component(id: &Ustr)`


#### `reset_component(id: &Ustr)`


#### `dispose_component(id: &Ustr)`


#### `get_component(id: &Ustr)`
