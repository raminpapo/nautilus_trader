# Documentation: `crates/common/src/xrate.rs`
**Generated:** 2025-11-15T19:40:01.856198Z
**File Size:** 12737 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/common/src/xrate.rs` within the repository.

**Functions defined:** get_exchange_rate, setup_test_quotes, test_invalid_pair_string, test_same_currency, test_direct_pair, test_inverse_pair, test_cross_pair_through_usd, test_no_conversion_path, test_empty_quotes, test_unequal_quotes_length and 3 more
...
#### `test_direct_pair(price_type: PriceType, expected: f64)`
