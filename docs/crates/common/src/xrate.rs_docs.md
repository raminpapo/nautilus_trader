...
- **Path**: `crates/common/src/xrate.rs`
- **Size**: 12,735 bytes
- **Lines**: 376
- **Language**: Rust
...
### Functions
- **`get_exchange_rate()`**: Function defined in this file
- **`setup_test_quotes()`**: Function defined in this file
- **`test_invalid_pair_string()`**: Function defined in this file
- **`test_same_currency()`**: Function defined in this file
- **`test_direct_pair()`**: Function defined in this file
- **`test_inverse_pair()`**: Function defined in this file
- **`test_cross_pair_through_usd()`**: Function defined in this file
- **`test_no_conversion_path()`**: Function defined in this file
- **`test_empty_quotes()`**: Function defined in this file
- **`test_unequal_quotes_length()`**: Function defined in this file
- **`test_invalid_price_type()`**: Function defined in this file
- **`test_cycle_handling()`**: Function defined in this file
- **`test_multiple_paths()`**: Function defined in this file
...
**Functions**: `get_exchange_rate`, `setup_test_quotes`, `test_cross_pair_through_usd`, `test_cycle_handling`, `test_direct_pair`, `test_empty_quotes`, `test_invalid_pair_string`, `test_invalid_price_type`, `test_inverse_pair`, `test_multiple_paths`, `test_no_conversion_path`, `test_same_currency`, `test_unequal_quotes_length`
...
---
*Generated on 2025-11-18T21:55:01.325798Z*
