...
- **`get_client_order_id_generator()`**: Function defined in this file
- **`test_init()`**: Function defined in this file
- **`test_init_with_initial_count()`**: Function defined in this file
- **`test_generate_client_order_id_from_start()`**: Function defined in this file
- **`test_generate_client_order_id_from_initial()`**: Function defined in this file
- **`test_generate_client_order_id_with_hyphens_removed()`**: Function defined in this file
- **`test_generate_uuid_client_order_id()`**: Function defined in this file
- **`test_generate_uuid_client_order_id_with_hyphens_removed()`**: Function defined in this file
- **`test_reset()`**: Function defined in this file

### Classes
- **`ClientOrderIdGenerator`**: Class defined in this file
...
**Functions**: `count`, `generate`, `get_client_order_id_generator`, `new`, `reset`, `set_count`, `test_generate_client_order_id_from_initial`, `test_generate_client_order_id_from_start`, `test_generate_client_order_id_with_hyphens_removed`, `test_generate_uuid_client_order_id`, `test_generate_uuid_client_order_id_with_hyphens_removed`, `test_init`, `test_init_with_initial_count`, `test_reset`
**Impls**: `ClientOrderIdGenerator`
**Structs**: `ClientOrderIdGenerator`
...
---
*Generated on 2025-11-18T21:55:01.120134Z*
