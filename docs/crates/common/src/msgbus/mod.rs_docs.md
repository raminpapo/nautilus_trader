# Documentation: `crates/common/src/msgbus/mod.rs`
**Generated:** 2025-11-15T19:40:01.795252Z
**File Size:** 9645 bytes
**Extension:** .rs
**Type:** text
...
- **Path:** `crates/common/src/msgbus/mod.rs`
- **Size:** 9,645 bytes
- **Lines:** 289
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/common/src/msgbus/mod.rs` within the repository.

**Functions defined:** set_message_bus, get_message_bus, send_any, send, send_response, publish_data, response, register_response_handler, publish, register and 5 more
...
#### `set_message_bus(msgbus: Rc<RefCell<MessageBus>>)`


#### `get_message_bus()`


#### `send_any(endpoint: MStr<Endpoint>, message: &dyn Any)`


#### `send(endpoint: MStr<Endpoint>, message: T)`


#### `send_response(correlation_id: &UUID4, message: &DataResponse)`


#### `publish_data(topic: &Ustr, message: Data)`


#### `response(correlation_id: &UUID4, message: &dyn Any)`


#### `register_response_handler(correlation_id: &UUID4, handler: ShareableMessageHandler)`


#### `publish(topic: MStr<Topic>, message: &dyn Any)`


#### `register(endpoint: MStr<Endpoint>, handler: ShareableMessageHandler)`


#### `deregister(endpoint: MStr<Endpoint>)`


#### `subscribe(pattern: MStr<Pattern>, handler: ShareableMessageHandler, priority: Option<u8>)`


#### `subscribe_topic(topic: MStr<Topic>, handler: ShareableMessageHandler, priority: Option<u8>)`


#### `unsubscribe(pattern: MStr<Pattern>, handler: ShareableMessageHandler)`


#### `unsubscribe_topic(topic: MStr<Topic>, handler: ShareableMessageHandler)`
