# Documentation: `crates/common/src/msgbus/switchboard.rs`
**Generated:** 2025-11-15T19:40:01.800018Z
**File Size:** 19291 bytes
**Extension:** .rs
**Type:** text
...
- **Path:** `crates/common/src/msgbus/switchboard.rs`
- **Size:** 19,291 bytes
- **Lines:** 604
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/common/src/msgbus/switchboard.rs` within the repository.

**Classes defined:** MessagingSwitchboard, Default, MessagingSwitchboard

**Functions defined:** get_custom_topic, get_instruments_topic, get_instrument_topic, get_book_deltas_topic, get_book_depth10_topic, get_book_snapshots_topic, get_quotes_topic, get_trades_topic, get_bars_topic, get_mark_price_topic and 46 more
...
#### `get_custom_topic(data_type: &DataType)`


#### `get_instruments_topic(venue: Venue)`


#### `get_instrument_topic(instrument_id: InstrumentId)`


#### `get_book_deltas_topic(instrument_id: InstrumentId)`


#### `get_book_depth10_topic(instrument_id: InstrumentId)`
...
#### `get_quotes_topic(instrument_id: InstrumentId)`


#### `get_trades_topic(instrument_id: InstrumentId)`


#### `get_bars_topic(bar_type: BarType)`


#### `get_mark_price_topic(instrument_id: InstrumentId)`


#### `get_index_price_topic(instrument_id: InstrumentId)`


#### `get_funding_rate_topic(instrument_id: InstrumentId)`


#### `get_instrument_status_topic(instrument_id: InstrumentId)`


#### `get_instrument_close_topic(instrument_id: InstrumentId)`


#### `get_order_fills_topic(instrument_id: InstrumentId)`


#### `get_order_snapshots_topic(client_order_id: ClientOrderId)`


#### `get_positions_snapshots_topic(position_id: PositionId)`


#### `get_event_orders_topic(strategy_id: StrategyId)`


#### `get_event_positions_topic(strategy_id: StrategyId)`
...
#### `get_custom_topic(&mut self, data_type: &DataType)`


#### `get_instruments_topic(&mut self, venue: Venue)`


#### `get_instrument_topic(&mut self, instrument_id: InstrumentId)`


#### `get_book_deltas_topic(&mut self, instrument_id: InstrumentId)`


#### `get_book_depth10_topic(&mut self, instrument_id: InstrumentId)`
...
#### `get_quotes_topic(&mut self, instrument_id: InstrumentId)`


#### `get_trades_topic(&mut self, instrument_id: InstrumentId)`


#### `get_bars_topic(&mut self, bar_type: BarType)`


#### `get_mark_price_topic(&mut self, instrument_id: InstrumentId)`


#### `get_index_price_topic(&mut self, instrument_id: InstrumentId)`


#### `get_funding_rate_topic(&mut self, instrument_id: InstrumentId)`


#### `get_instrument_status_topic(&mut self, instrument_id: InstrumentId)`


#### `get_instrument_close_topic(&mut self, instrument_id: InstrumentId)`


#### `get_order_fills_topic(&mut self, instrument_id: InstrumentId)`


#### `get_order_snapshots_topic(&mut self, client_order_id: ClientOrderId)`


#### `get_positions_snapshots_topic(&mut self, position_id: PositionId)`


#### `get_event_orders_topic(&mut self, strategy_id: StrategyId)`


#### `get_event_positions_topic(&mut self, strategy_id: StrategyId)`
...
#### `test_get_custom_topic(mut switchboard: MessagingSwitchboard)`
