...
This file is part of the NautilusTrader repository. It defines 56 function(s) and 1 class(es).

## Detailed Walkthrough

### Functions
- **`get_custom_topic()`**: Function defined in this file
- **`get_instruments_topic()`**: Function defined in this file
- **`get_instrument_topic()`**: Function defined in this file
- **`get_book_deltas_topic()`**: Function defined in this file
- **`get_book_depth10_topic()`**: Function defined in this file
- **`get_book_snapshots_topic()`**: Function defined in this file
- **`get_quotes_topic()`**: Function defined in this file
- **`get_trades_topic()`**: Function defined in this file
- **`get_bars_topic()`**: Function defined in this file
- **`get_mark_price_topic()`**: Function defined in this file
- **`get_index_price_topic()`**: Function defined in this file
- **`get_funding_rate_topic()`**: Function defined in this file
- **`get_instrument_status_topic()`**: Function defined in this file
- **`get_instrument_close_topic()`**: Function defined in this file
- **`get_order_fills_topic()`**: Function defined in this file
- **`get_order_snapshots_topic()`**: Function defined in this file
- **`get_positions_snapshots_topic()`**: Function defined in this file
- **`get_event_orders_topic()`**: Function defined in this file
- **`get_event_positions_topic()`**: Function defined in this file
- **`default()`**: Function defined in this file

*...and 36 more functions*

### Classes
- **`MessagingSwitchboard`**: Class defined in this file
...
**Functions**: `data_engine_execute`, `data_engine_process`, `data_engine_queue_execute`, `data_engine_response`, `default`, `exec_engine_execute`, `exec_engine_process`, `get_bars_topic`, `get_book_deltas_topic`, `get_book_depth10_topic`, `get_book_snapshots_topic`, `get_custom_topic`, `get_event_orders_topic`, `get_event_positions_topic`, `get_funding_rate_topic`, `get_index_price_topic`, `get_instrument_close_topic`, `get_instrument_status_topic`, `get_instrument_topic`, `get_instruments_topic`, `get_mark_price_topic`, `get_order_fills_topic`, `get_order_snapshots_topic`, `get_positions_snapshots_topic`, `get_quotes_topic`, `get_trades_topic`, `instrument_id`, `switchboard`, `test_get_bars_topic`, `test_get_book_deltas_topic` *(+7 more)*
**Impls**: `Default`, `MessagingSwitchboard`
**Structs**: `MessagingSwitchboard`
...
---
*Generated on 2025-11-18T21:55:01.239534Z*
