# Documentation: `crates/common/src/msgbus/stubs.rs`
**Generated:** 2025-11-15T19:40:01.797315Z
...
This file is located at `crates/common/src/msgbus/stubs.rs` within the repository.

**Classes defined:** StubMessageHandler, CallCheckMessageHandler, MessageSavingHandler, Debug, MessageHandler, CallCheckMessageHandler, MessageHandler

**Functions defined:** fmt, id, handle, as_any, get_stub_shareable_handler, was_called, id, handle, as_any, get_call_check_shareable_handler and 7 more
...
#### `get_stub_shareable_handler(id: Option<Ustr>)`
...
#### `get_call_check_shareable_handler(id: Option<Ustr>)`


#### `check_handler_was_called(call_check_handler: ShareableMessageHandler)`
...
#### `get_message_saving_handler(id: Option<Ustr>)`


#### `get_saved_messages(handler: ShareableMessageHandler)`
