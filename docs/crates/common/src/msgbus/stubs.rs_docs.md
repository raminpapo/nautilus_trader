...
- **Path**: `crates/common/src/msgbus/stubs.rs`
- **Size**: 5,992 bytes
- **Lines**: 196
- **Language**: Rust
...
- **`get_stub_shareable_handler()`**: Function defined in this file
- **`was_called()`**: Function defined in this file
- **`id()`**: Function defined in this file
- **`handle()`**: Function defined in this file
- **`as_any()`**: Function defined in this file
- **`get_call_check_shareable_handler()`**: Function defined in this file
- **`check_handler_was_called()`**: Function defined in this file
- **`get_messages()`**: Function defined in this file
- **`id()`**: Function defined in this file
- **`handle()`**: Function defined in this file
- **`as_any()`**: Function defined in this file
- **`get_message_saving_handler()`**: Function defined in this file
- **`get_saved_messages()`**: Function defined in this file

### Classes
- **`StubMessageHandler`**: Class defined in this file
- **`CallCheckMessageHandler`**: Class defined in this file
- **`MessageSavingHandler`**: Class defined in this file
...
**Functions**: `as_any`, `check_handler_was_called`, `fmt`, `get_call_check_shareable_handler`, `get_message_saving_handler`, `get_messages`, `get_saved_messages`, `get_stub_shareable_handler`, `handle`, `id`, `was_called`
**Impls**: `CallCheckMessageHandler`, `Debug`, `MessageHandler`, `MessageSavingHandler`
**Structs**: `CallCheckMessageHandler`, `MessageSavingHandler`, `StubMessageHandler`
...
---
*Generated on 2025-11-18T21:55:01.235526Z*
