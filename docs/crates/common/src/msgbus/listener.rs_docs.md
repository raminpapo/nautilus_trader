# Documentation: listener.rs

## File Metadata

- **Path**: `crates/common/src/msgbus/listener.rs`
- **Size**: 7,339 bytes
- **Lines**: 240
- **Language**: Rust
...
- **`test_new_listener()`**: Function defined in this file
- **`test_close_listener()`**: Function defined in this file
- **`test_publish_and_receive()`**: Function defined in this file
- **`test_multiple_messages()`**: Function defined in this file
- **`test_stream_receiver_already_taken()`**: Function defined in this file
- **`test_publish_after_close()`**: Function defined in this file

### Classes
- **`MessageBusListener`**: Class defined in this file
...
**Functions**: `close`, `default`, `get_stream_receiver`, `is_closed`, `new`, `publish`, `stream`, `test_close_listener`, `test_multiple_messages`, `test_new_listener`, `test_publish_after_close`, `test_publish_and_receive`, `test_stream_receiver_already_taken`
**Impls**: `Default`, `MessageBusListener`, `Stream`
**Structs**: `MessageBusListener`
...
---
*Generated on 2025-11-18T21:55:01.225843Z*
