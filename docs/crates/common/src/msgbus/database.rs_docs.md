...
- **Path**: `crates/common/src/msgbus/database.rs`
- **Size**: 11,017 bytes
- **Lines**: 283
- **Language**: Rust
...
- **`test_default_database_config()`**: Function defined in this file
- **`test_deserialize_database_config()`**: Function defined in this file
- **`test_default_message_bus_config()`**: Function defined in this file
- **`test_deserialize_message_bus_config()`**: Function defined in this file
...
**Functions**: `close`, `default`, `is_closed`, `new`, `publish`, `test_default_database_config`, `test_default_message_bus_config`, `test_deserialize_database_config`, `test_deserialize_message_bus_config`
**Impls**: `Default`
**Structs**: `DatabaseConfig`, `MessageBusConfig`
**Traits**: `MessageBusDatabaseAdapter`
...
---
*Generated on 2025-11-18T21:55:01.220463Z*
