...
- **Path**: `crates/common/src/msgbus/tests.rs`
- **Size**: 18,533 bytes
- **Lines**: 551
- **Language**: Rust
...
This file is part of the NautilusTrader repository. It defines 29 function(s) and 1 class(es).

## Detailed Walkthrough

### Functions
- **`test_new()`**: Function defined in this file
- **`test_endpoints_when_no_endpoints()`**: Function defined in this file
- **`test_topics_when_no_subscriptions()`**: Function defined in this file
- **`test_is_subscribed_when_no_subscriptions()`**: Function defined in this file
- **`test_get_response_handler_when_no_handler()`**: Function defined in this file
- **`test_get_response_handler_when_already_registered()`**: Function defined in this file
- **`test_get_response_handler_when_registered()`**: Function defined in this file
- **`test_is_registered_when_no_registrations()`**: Function defined in this file
- **`test_register_endpoint()`**: Function defined in this file
- **`test_endpoint_send()`**: Function defined in this file
- **`test_deregsiter_endpoint()`**: Function defined in this file
- **`test_subscribe()`**: Function defined in this file
- **`test_unsubscribe()`**: Function defined in this file
- **`test_matching_subscriptions()`**: Function defined in this file
- **`test_is_matching()`**: Function defined in this file
- **`convert_pattern_to_regex()`**: Function defined in this file
- **`test_convert_pattern_to_regex()`**: Function defined in this file
- **`generate_pattern_from_topic()`**: Function defined in this file
- **`test_matching_backtracking()`**: Function defined in this file
- **`test_subscription_pattern_matching()`**: Function defined in this file

*...and 9 more functions*

### Classes
- **`SimpleSubscriptionModel`**: Class defined in this file
...
**Functions**: `convert_pattern_to_regex`, `create_topic`, `generate_pattern_from_topic`, `generate_test_patterns`, `is_subscribed`, `matching_subscriptions`, `new`, `subscribe`, `subscription_count`, `subscription_model_fuzz_testing`, `test_convert_pattern_to_regex`, `test_deregsiter_endpoint`, `test_endpoint_send`, `test_endpoints_when_no_endpoints`, `test_get_response_handler_when_already_registered`, `test_get_response_handler_when_no_handler`, `test_get_response_handler_when_registered`, `test_is_matching`, `test_is_registered_when_no_registrations`, `test_is_subscribed_when_no_subscriptions`, `test_matching_backtracking`, `test_matching_subscriptions`, `test_new`, `test_register_endpoint`, `test_subscribe`, `test_subscription_pattern_matching`, `test_topics_when_no_subscriptions`, `test_unsubscribe`, `unsubscribe`
**Impls**: `SimpleSubscriptionModel`
**Structs**: `SimpleSubscriptionModel`
...
```bash
# For Python
pytest crates/common/src/msgbus/tests.rs
...
---
*Generated on 2025-11-18T21:55:01.243928Z*
