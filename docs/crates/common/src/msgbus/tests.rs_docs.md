# Documentation: `crates/common/src/msgbus/tests.rs`
**Generated:** 2025-11-15T19:40:01.802949Z
**File Size:** 18533 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/common/src/msgbus/tests.rs` within the repository.

**Classes defined:** SimpleSubscriptionModel, SimpleSubscriptionModel

**Functions defined:** test_new, test_endpoints_when_no_endpoints, test_topics_when_no_subscriptions, test_is_subscribed_when_no_subscriptions, test_get_response_handler_when_no_handler, test_get_response_handler_when_already_registered, test_get_response_handler_when_registered, test_is_registered_when_no_registrations, test_register_endpoint, test_endpoint_send and 19 more
...
#### `test_is_matching(#[case] topic: &str, #[case] pattern: &str, #[case] expected: bool)`


#### `convert_pattern_to_regex(pattern: &str)`


#### `test_convert_pattern_to_regex(#[case] pat: &str, #[case] regex: &str)`


#### `generate_pattern_from_topic(topic: &str, rng: &mut StdRng)`
...
#### `subscribe(&mut self, pattern: &str, handler_id: &str)`


#### `unsubscribe(&mut self, pattern: &str, handler_id: &str)`


#### `is_subscribed(&self, pattern: &str, handler_id: &str)`


#### `matching_subscriptions(&self, topic: &str)`
...
#### `generate_test_patterns(rng: &mut StdRng)`


#### `create_topic(rng: &mut StdRng)`
