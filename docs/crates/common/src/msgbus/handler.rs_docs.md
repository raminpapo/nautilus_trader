# Documentation: `crates/common/src/msgbus/handler.rs`
**Generated:** 2025-11-15T19:40:01.788028Z
...
This file is located at `crates/common/src/msgbus/handler.rs` within the repository.

**Classes defined:** TypedMessageHandler, ShareableMessageHandler, PartialEq, Eq, ShareableMessageHandler, Debug, From

**Functions defined:** id, handle, as_any, eq, from, id, handle, as_any, with_any, id and 6 more
...
#### `generate_handler_id(callback: &F)`
...
#### `from(value: Rc<dyn MessageHandler>)`
