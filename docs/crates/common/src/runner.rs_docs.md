# Documentation: `crates/common/src/runner.rs`
**Generated:** 2025-11-15T19:40:01.835713Z
**File Size:** 7634 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/common/src/runner.rs` within the repository.

**Classes defined:** SyncDataCommandSender, DataCommandSender

**Functions defined:** execute, execute, get_data_cmd_sender, set_data_cmd_sender, send, get_time_event_sender, try_get_time_event_sender, set_time_event_sender, get_data_event_sender, set_data_event_sender and 5 more
...
#### `set_data_cmd_sender(sender: Arc<dyn DataCommandSender>)`
...
#### `set_time_event_sender(sender: Arc<dyn TimeEventSender>)`


#### `get_data_event_sender()`


#### `set_data_event_sender(sender: tokio::sync::mpsc::UnboundedSender<DataEvent>)`
...
#### `set_exec_event_sender(sender: tokio::sync::mpsc::UnboundedSender<ExecutionEvent>)`


#### `get_trading_cmd_sender()`


#### `set_exec_cmd_sender(sender: Arc<dyn TradingCommandSender>)`
