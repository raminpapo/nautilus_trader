...
- **Path**: `crates/common/src/runner.rs`
- **Size**: 7,634 bytes
- **Lines**: 234
- **Language**: Rust
...
- **`execute()`**: Function defined in this file
- **`get_data_cmd_sender()`**: Function defined in this file
- **`set_data_cmd_sender()`**: Function defined in this file
- **`send()`**: Function defined in this file
- **`get_time_event_sender()`**: Function defined in this file
- **`try_get_time_event_sender()`**: Function defined in this file
- **`set_time_event_sender()`**: Function defined in this file
- **`get_data_event_sender()`**: Function defined in this file
- **`set_data_event_sender()`**: Function defined in this file
- **`execute()`**: Function defined in this file
- **`get_exec_event_sender()`**: Function defined in this file
- **`set_exec_event_sender()`**: Function defined in this file
- **`get_trading_cmd_sender()`**: Function defined in this file
- **`set_exec_cmd_sender()`**: Function defined in this file

### Classes
- **`SyncDataCommandSender`**: Class defined in this file
...
**Functions**: `execute`, `get_data_cmd_sender`, `get_data_event_sender`, `get_exec_event_sender`, `get_time_event_sender`, `get_trading_cmd_sender`, `send`, `set_data_cmd_sender`, `set_data_event_sender`, `set_exec_cmd_sender`, `set_exec_event_sender`, `set_time_event_sender`, `try_get_time_event_sender`
**Impls**: `DataCommandSender`
**Structs**: `SyncDataCommandSender`
**Traits**: `DataCommandSender`, `TimeEventSender`, `TradingCommandSender`
...
---
*Generated on 2025-11-18T21:55:01.293631Z*
