...
This file is part of the NautilusTrader repository. It defines 105 function(s).

## Detailed Walkthrough

### Functions
- **`cache()`**: Function defined in this file
- **`test_build_index_when_empty()`**: Function defined in this file
- **`test_check_integrity_when_empty()`**: Function defined in this file
- **`test_check_residuals_when_empty()`**: Function defined in this file
- **`test_clear_index_when_empty()`**: Function defined in this file
- **`test_reset_when_empty()`**: Function defined in this file
- **`test_dispose_when_empty()`**: Function defined in this file
- **`test_flush_db_when_empty()`**: Function defined in this file
- **`test_cache_general_when_no_database()`**: Function defined in this file
- **`test_cache_orders_when_no_database()`**: Function defined in this file
- **`test_order_when_empty()`**: Function defined in this file
- **`test_order_when_initialized()`**: Function defined in this file
- **`test_order_when_submitted()`**: Function defined in this file
- **`test_order_when_rejected()`**: Function defined in this file
- **`test_order_when_accepted()`**: Function defined in this file
- **`test_client_order_ids_filtering()`**: Function defined in this file
- **`test_position_ids_filtering()`**: Function defined in this file
- **`make_pair()`**: Function defined in this file
- **`test_order_when_filled()`**: Function defined in this file
- **`test_get_general_when_empty()`**: Function defined in this file
...
Total unique keywords extracted: 105


**Functions**: `cache`, `make_pair`, `test_add_funding_rate`, `test_add_funding_rate_updates_existing`, `test_add_general_when_value`, `test_add_pool`, `test_add_pool_profiler`, `test_audit_own_order_books_removes_closed`, `test_audit_own_order_books_with_inflight_orders`, `test_bar_when_empty`, `test_bar_when_some`, `test_bars_when_empty`, `test_bars_when_some`, `test_build_index_when_empty`, `test_cache_account_for_venue_return_correct`, `test_cache_account_for_venue_returns_empty`, `test_cache_accounts_when_no_accounts_returns_empty`, `test_cache_accounts_when_no_database`, `test_cache_add_account`, `test_cache_currencies_when_no_database`, `test_cache_general_when_no_database`, `test_cache_instruments_when_no_database`, `test_cache_orders_when_no_database`, `test_cache_positions_when_no_database`, `test_cache_synthetics_when_no_database`, `test_check_integrity_when_empty`, `test_check_residuals_when_empty`, `test_clear_index_when_empty`, `test_clear_mark_xrate`, `test_clear_mark_xrates` *(+75 more)*

## Related Files

This file is located in `crates/common/src/cache/`. Related files may include:
...
```bash
# For Python
pytest crates/common/src/cache/tests.rs
...
---
*Generated on 2025-11-18T21:55:01.063042Z*
