# Documentation: `crates/common/src/cache/tests.rs`
**Generated:** 2025-11-15T19:40:01.693021Z
**File Size:** 72970 bytes
**Extension:** .rs
**Type:** text
...
- **Path:** `crates/common/src/cache/tests.rs`
- **Size:** 72,970 bytes
- **Lines:** 2,229
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/common/src/cache/tests.rs` within the repository.

**Functions defined:** cache, test_build_index_when_empty, test_check_integrity_when_empty, test_check_residuals_when_empty, test_clear_index_when_empty, test_reset_when_empty, test_dispose_when_empty, test_flush_db_when_empty, test_cache_general_when_no_database, test_cache_orders_when_no_database and 95 more
...
#### `test_build_index_when_empty(mut cache: Cache)`


#### `test_check_integrity_when_empty(mut cache: Cache)`


#### `test_check_residuals_when_empty(cache: Cache)`


#### `test_clear_index_when_empty(mut cache: Cache)`


#### `test_reset_when_empty(mut cache: Cache)`


#### `test_dispose_when_empty(mut cache: Cache)`


#### `test_flush_db_when_empty(mut cache: Cache)`


#### `test_cache_general_when_no_database(mut cache: Cache)`


#### `test_cache_orders_when_no_database(mut cache: Cache)`


#### `test_order_when_empty(cache: Cache)`


#### `test_order_when_initialized(mut cache: Cache, audusd_sim: CurrencyPair)`


#### `test_order_when_submitted(mut cache: Cache, audusd_sim: CurrencyPair)`


#### `test_order_when_rejected(mut cache: Cache, audusd_sim: CurrencyPair)`


#### `test_order_when_accepted(mut cache: Cache, audusd_sim: CurrencyPair)`


#### `test_client_order_ids_filtering(mut cache: Cache)`


#### `test_position_ids_filtering(mut cache: Cache)`


#### `make_pair(id_str: &str)`


#### `test_order_when_filled(mut cache: Cache, audusd_sim: CurrencyPair)`


#### `test_get_general_when_empty(cache: Cache)`


#### `test_add_general_when_value(mut cache: Cache)`


#### `test_orders_for_position(mut cache: Cache, audusd_sim: CurrencyPair)`


#### `test_correct_order_indexing(mut cache: Cache)`


#### `test_cache_positions_when_no_database(mut cache: Cache)`


#### `test_position_when_empty(cache: Cache)`


#### `test_position_when_some(mut cache: Cache, audusd_sim: CurrencyPair)`


#### `test_cache_currencies_when_no_database(mut cache: Cache)`


#### `test_cache_instruments_when_no_database(mut cache: Cache)`


#### `test_instrument_when_empty(cache: Cache, audusd_sim: CurrencyPair)`


#### `test_instrument_when_some(mut cache: Cache, audusd_sim: CurrencyPair)`


#### `test_instruments_when_empty(cache: Cache)`


#### `test_instruments_when_some(mut cache: Cache)`


#### `test_cache_synthetics_when_no_database(mut cache: Cache)`


#### `test_synthetic_when_empty(cache: Cache)`


#### `test_synthetic_when_some(mut cache: Cache)`


#### `test_order_book_when_empty(cache: Cache, audusd_sim: CurrencyPair)`


#### `test_order_book_when_some(mut cache: Cache, audusd_sim: CurrencyPair)`


#### `test_order_book_mut_when_empty(mut cache: Cache, audusd_sim: CurrencyPair)`


#### `test_order_book_mut_when_some(mut cache: Cache, audusd_sim: CurrencyPair)`


#### `test_pool()`


#### `test_pool_when_empty(cache: Cache, test_pool: Pool)`


#### `test_pool_when_some(mut cache: Cache, test_pool: Pool)`


#### `test_pool_mut_when_empty(mut cache: Cache, test_pool: Pool)`


#### `test_pool_mut_when_some(mut cache: Cache, test_pool: Pool)`


#### `test_add_pool(mut cache: Cache, test_pool: Pool)`


#### `test_pool_ids_when_empty(cache: Cache, test_pool: Pool)`


#### `test_pool_ids_when_some(mut cache: Cache, test_pool: Pool)`


#### `test_pools_when_empty(cache: Cache, test_pool: Pool)`


#### `test_pools_when_some(mut cache: Cache, test_pool: Pool)`


#### `test_pool_profiler(test_pool: Pool)`
