# Documentation: `crates/common/src/cache/database.rs`
**Generated:** 2025-11-15T19:40:01.665299Z
...
This file is located at `crates/common/src/cache/database.rs` within the repository.

**Classes defined:** CacheMap

**Functions defined:** close, flush, load_all, load, load_currencies, load_instruments, load_synthetics, load_accounts, load_orders, load_positions and 51 more
...
#### `add_greeks(&self, greeks: &GreeksData)`


#### `add_yield_curve(&self, yield_curve: &YieldCurveData)`
