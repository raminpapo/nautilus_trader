...
- **Path**: `crates/common/src/cache/database.rs`
- **Size**: 15,769 bytes
- **Lines**: 513
- **Language**: Rust
...
- **`load_greeks()`**: Function defined in this file
- **`load_yield_curves()`**: Function defined in this file
...
### Classes
- **`CacheMap`**: Class defined in this file
...
**Functions**: `add`, `add_account`, `add_bar`, `add_currency`, `add_custom_data`, `add_greeks`, `add_instrument`, `add_order`, `add_order_book`, `add_order_snapshot`, `add_position`, `add_position_snapshot`, `add_quote`, `add_signal`, `add_synthetic`, `add_trade`, `add_yield_curve`, `close`, `delete_account_event`, `delete_actor`, `delete_order`, `delete_position`, `delete_strategy`, `flush`, `heartbeat`, `index_order_position`, `index_venue_order_id`, `load`, `load_account`, `load_accounts` *(+31 more)*
**Structs**: `CacheMap`
**Traits**: `CacheDatabaseAdapter`
...
---
*Generated on 2025-11-18T21:55:01.012003Z*
