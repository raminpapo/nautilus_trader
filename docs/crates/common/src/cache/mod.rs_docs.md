# Documentation: `crates/common/src/cache/mod.rs`
**Generated:** 2025-11-15T19:40:01.679730Z
**File Size:** 120026 bytes
**Extension:** .rs
**Type:** text
...
- **Path:** `crates/common/src/cache/mod.rs`
- **Size:** 120,026 bytes
- **Lines:** 3,441
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/common/src/cache/mod.rs` within the repository.

**Classes defined:** Cache, Debug, Default, Cache

**Functions defined:** fmt, default, new, memory_address, cache_general, cache_all, cache_currencies, cache_instruments, cache_synthetics, cache_accounts and 154 more
...
#### `cache_general(&mut self)`


#### `cache_all(&mut self)`


#### `cache_currencies(&mut self)`


#### `cache_instruments(&mut self)`


#### `cache_synthetics(&mut self)`


#### `cache_accounts(&mut self)`


#### `cache_orders(&mut self)`


#### `cache_positions(&mut self)`


#### `build_index(&mut self)`


#### `has_backing(&self)`


#### `calculate_unrealized_pnl(&self, position: &Position)`


#### `check_integrity(&mut self)`


#### `check_residuals(&self)`


#### `purge_closed_orders(&mut self, ts_now: UnixNanos, buffer_secs: u64)`


#### `purge_closed_positions(&mut self, ts_now: UnixNanos, buffer_secs: u64)`


#### `purge_order(&mut self, client_order_id: ClientOrderId)`


#### `purge_position(&mut self, position_id: PositionId)`


#### `purge_account_events(&mut self, ts_now: UnixNanos, lookback_secs: u64)`


#### `clear_index(&mut self)`
...
#### `add(&mut self, key: &str, value: Bytes)`


#### `add_order_book(&mut self, book: OrderBook)`


#### `add_own_order_book(&mut self, own_book: OwnOrderBook)`


#### `add_mark_price(&mut self, mark_price: MarkPriceUpdate)`


#### `add_index_price(&mut self, index_price: IndexPriceUpdate)`


#### `add_funding_rate(&mut self, funding_rate: FundingRateUpdate)`


#### `add_quote(&mut self, quote: QuoteTick)`


#### `add_quotes(&mut self, quotes: &[QuoteTick])`


#### `add_trade(&mut self, trade: TradeTick)`


#### `add_trades(&mut self, trades: &[TradeTick])`


#### `add_bar(&mut self, bar: Bar)`


#### `add_bars(&mut self, bars: &[Bar])`


#### `add_greeks(&mut self, greeks: GreeksData)`


#### `greeks(&self, instrument_id: &InstrumentId)`


#### `add_yield_curve(&mut self, yield_curve: YieldCurveData)`


#### `yield_curve(&self, key: &str)`


#### `add_currency(&mut self, currency: Currency)`


#### `add_instrument(&mut self, instrument: InstrumentAny)`


#### `add_synthetic(&mut self, synthetic: SyntheticInstrument)`


#### `add_account(&mut self, account: AccountAny)`
...
#### `add_position(&mut self, position: Position, _oms_type: OmsType)`
