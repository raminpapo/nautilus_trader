...
This file is part of the NautilusTrader repository. It defines 164 function(s) and 1 class(es).
...
- **`memory_address()`**: Function defined in this file
- **`cache_general()`**: Function defined in this file
- **`cache_all()`**: Function defined in this file
- **`cache_currencies()`**: Function defined in this file
- **`cache_instruments()`**: Function defined in this file
- **`cache_synthetics()`**: Function defined in this file
- **`cache_accounts()`**: Function defined in this file
- **`cache_orders()`**: Function defined in this file
- **`cache_positions()`**: Function defined in this file
- **`build_index()`**: Function defined in this file
- **`has_backing()`**: Function defined in this file
- **`calculate_unrealized_pnl()`**: Function defined in this file
- **`check_integrity()`**: Function defined in this file
- **`check_residuals()`**: Function defined in this file
- **`purge_closed_orders()`**: Function defined in this file
- **`purge_closed_positions()`**: Function defined in this file
- **`purge_order()`**: Function defined in this file

*...and 144 more functions*

### Classes
- **`Cache`**: Class defined in this file


## Keywords and Identifiers

Total unique keywords extracted: 167


**Functions**: `account`, `account_for_venue`, `account_id`, `accounts`, `actor_ids`, `add`, `add_account`, `add_bar`, `add_bars`, `add_currency`, `add_funding_rate`, `add_greeks`, `add_index_price`, `add_instrument`, `add_mark_price`, `add_order`, `add_order_book`, `add_own_order_book`, `add_position`, `add_position_id`, `add_quote`, `add_quotes`, `add_synthetic`, `add_trade`, `add_trades`, `add_venue_order_id`, `add_yield_curve`, `audit_own_order_books`, `bar`, `bar_count` *(+134 more)*
**Impls**: `Cache`, `Debug`, `Default`
**Structs**: `Cache`
...
---
*Generated on 2025-11-18T21:55:01.041688Z*
