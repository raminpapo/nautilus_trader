# Documentation: `crates/common/src/cache/quote.rs`
**Generated:** 2025-11-15T19:40:01.684354Z
**File Size:** 17195 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/common/src/cache/quote.rs` within the repository.

**Classes defined:** QuoteCache, QuoteCache, Default

**Functions defined:** new, get, insert, remove, contains, len, is_empty, clear, process, default and 16 more
...
#### `get(&self, instrument_id: &InstrumentId)`


#### `insert(&mut self, instrument_id: InstrumentId, quote: QuoteTick)`


#### `remove(&mut self, instrument_id: &InstrumentId)`


#### `contains(&self, instrument_id: &InstrumentId)`
...
#### `make_quote(instrument_id: InstrumentId, _bid: f64, _ask: f64)`
