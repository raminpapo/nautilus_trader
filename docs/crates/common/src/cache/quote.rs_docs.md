...
- **Path**: `crates/common/src/cache/quote.rs`
- **Size**: 17,195 bytes
- **Lines**: 531
- **Language**: Rust
...
- **`remove()`**: Function defined in this file
...
- **`make_quote()`**: Function defined in this file
- **`test_new_cache_is_empty()`**: Function defined in this file
- **`test_insert_and_get()`**: Function defined in this file
- **`test_insert_returns_previous_value()`**: Function defined in this file
- **`test_remove()`**: Function defined in this file
- **`test_remove_nonexistent()`**: Function defined in this file
- **`test_clear()`**: Function defined in this file
- **`test_multiple_instruments()`**: Function defined in this file
- **`test_default()`**: Function defined in this file
- **`test_clone()`**: Function defined in this file

*...and 6 more functions*

### Classes
- **`QuoteCache`**: Class defined in this file
...
**Functions**: `clear`, `contains`, `default`, `get`, `insert`, `is_empty`, `len`, `make_quote`, `new`, `process`, `remove`, `test_clear`, `test_clone`, `test_default`, `test_insert_and_get`, `test_insert_returns_previous_value`, `test_multiple_instruments`, `test_new_cache_is_empty`, `test_process_clear_removes_cached_values`, `test_process_complete_quote`, `test_process_multiple_instruments`, `test_process_partial_quote_with_cache`, `test_process_partial_quote_without_cache`, `test_process_updates_cache`, `test_remove`, `test_remove_nonexistent`
**Impls**: `Default`, `QuoteCache`
**Structs**: `QuoteCache`
...
---
*Generated on 2025-11-18T21:55:01.046010Z*
