...
### Functions
- **`component_state_to_cstr()`**: Function defined in this file
- **`component_state_from_cstr()`**: Function defined in this file
- **`component_trigger_to_cstr()`**: Function defined in this file
- **`component_trigger_from_cstr()`**: Function defined in this file
- **`log_level_to_cstr()`**: Function defined in this file
- **`log_level_from_cstr()`**: Function defined in this file
- **`log_color_to_cstr()`**: Function defined in this file
- **`log_color_from_cstr()`**: Function defined in this file
...
**Enums**: `from`, `string`, `variant`
**Functions**: `component_state_from_cstr`, `component_state_to_cstr`, `component_trigger_from_cstr`, `component_trigger_to_cstr`, `log_color_from_cstr`, `log_color_to_cstr`, `log_level_from_cstr`, `log_level_to_cstr`
...
---
*Generated on 2025-11-18T21:55:01.109241Z*
