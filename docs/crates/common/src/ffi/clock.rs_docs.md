...
- **Path**: `crates/common/src/ffi/clock.rs`
- **Size**: 14,588 bytes
- **Lines**: 494
- **Language**: Rust
...
This file is part of the NautilusTrader repository. It defines 35 function(s) and 4 class(es).
...
- **`test_clock_new()`**: Function defined in this file
- **`test_clock_drop()`**: Function defined in this file
- **`test_clock_register_default_handler()`**: Function defined in this file
- **`test_clock_set_time()`**: Function defined in this file
- **`test_clock_timestamp()`**: Function defined in this file
- **`test_clock_timestamp_ms()`**: Function defined in this file
- **`test_clock_timestamp_us()`**: Function defined in this file
- **`test_clock_timestamp_ns()`**: Function defined in this file
- **`test_clock_timer_names()`**: Function defined in this file
- **`test_clock_timer_count()`**: Function defined in this file
- **`test_clock_set_time_alert()`**: Function defined in this file
- **`test_clock_set_timer()`**: Function defined in this file
- **`test_clock_advance_time()`**: Function defined in this file
- **`vec_time_event_handlers_drop()`**: Function defined in this file
- **`test_clock_next_time()`**: Function defined in this file
- **`test_clock_cancel_timer()`**: Function defined in this file
- **`test_clock_cancel_timers()`**: Function defined in this file
- **`deref()`**: Function defined in this file
...
- **`TestClock_API`**: Class defined in this file
- **`wraps`**: Class defined in this file
- **`LiveClock_API`**: Class defined in this file
...
---
*Generated on 2025-11-18T21:55:01.107185Z*
