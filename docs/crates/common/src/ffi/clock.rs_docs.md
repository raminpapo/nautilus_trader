# Documentation: `crates/common/src/ffi/clock.rs`
**Generated:** 2025-11-15T19:40:01.720173Z
**File Size:** 14588 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/common/src/ffi/clock.rs` within the repository.

**Classes defined:** wraps, TestClock_API, wraps, LiveClock_API, Deref, DerefMut, Deref, DerefMut

**Functions defined:** deref, deref_mut, test_clock_new, test_clock_drop, test_clock_register_default_handler, test_clock_set_time, test_clock_timestamp, test_clock_timestamp_ms, test_clock_timestamp_us, test_clock_timestamp_ns and 25 more
...
#### `test_clock_drop(clock: TestClock_API)`
...
#### `test_clock_set_time(clock: &TestClock_API, to_time_ns: u64)`


#### `test_clock_timestamp(clock: &TestClock_API)`


#### `test_clock_timestamp_ms(clock: &TestClock_API)`


#### `test_clock_timestamp_us(clock: &TestClock_API)`


#### `test_clock_timestamp_ns(clock: &TestClock_API)`


#### `test_clock_timer_names(clock: &TestClock_API)`


#### `test_clock_timer_count(clock: &mut TestClock_API)`
...
#### `vec_time_event_handlers_drop(v: CVec)`
...
#### `test_clock_cancel_timers(clock: &mut TestClock_API)`
...
#### `live_clock_drop(clock: LiveClock_API)`
...
#### `live_clock_timestamp(clock: &mut LiveClock_API)`


#### `live_clock_timestamp_ms(clock: &mut LiveClock_API)`


#### `live_clock_timestamp_us(clock: &mut LiveClock_API)`


#### `live_clock_timestamp_ns(clock: &mut LiveClock_API)`


#### `live_clock_timer_names(clock: &LiveClock_API)`


#### `live_clock_timer_count(clock: &mut LiveClock_API)`
...
#### `live_clock_cancel_timers(clock: &mut LiveClock_API)`
