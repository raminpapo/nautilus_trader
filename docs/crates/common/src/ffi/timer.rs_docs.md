# Documentation: `crates/common/src/ffi/timer.rs`
**Generated:** 2025-11-15T19:40:01.727140Z
**File Size:** 9525 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/common/src/ffi/timer.rs` within the repository.

**Classes defined:** TimeEventHandler, would, From, Drop, Clone, Drop, From

**Functions defined:** registry, registry_lock, registry_size, cleanup_callback_registry, from, drop, clone, drop, registry_clears_after_handler_drop, from and 3 more
...
#### `time_event_to_cstr(event: &TimeEvent)`


#### `dummy(v: TimeEventHandler)`
