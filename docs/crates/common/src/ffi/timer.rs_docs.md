...
- **Path**: `crates/common/src/ffi/timer.rs`
- **Size**: 9,517 bytes
- **Lines**: 281
- **Language**: Rust
...
### Functions
- **`registry()`**: Function defined in this file
- **`registry_lock()`**: Function defined in this file
- **`registry_size()`**: Function defined in this file
- **`cleanup_callback_registry()`**: Function defined in this file
- **`from()`**: Function defined in this file
- **`drop()`**: Function defined in this file
- **`clone()`**: Function defined in this file
- **`drop()`**: Function defined in this file
- **`registry_clears_after_handler_drop()`**: Function defined in this file
- **`from()`**: Function defined in this file
- **`time_event_new()`**: Function defined in this file
- **`time_event_to_cstr()`**: Function defined in this file
- **`dummy()`**: Function defined in this file

### Classes
- **`TimeEventHandler`**: Class defined in this file
- **`would`**: Class defined in this file
...
**Functions**: `cleanup_callback_registry`, `clone`, `drop`, `dummy`, `from`, `registry`, `registry_clears_after_handler_drop`, `registry_lock`, `registry_size`, `time_event_new`, `time_event_to_cstr`
**Impls**: `Clone`, `Drop`, `From`
**Structs**: `TimeEventHandler`, `would`
...
---
*Generated on 2025-11-18T21:55:01.117674Z*
