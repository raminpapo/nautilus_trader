# Documentation: `crates/common/src/ffi/logging.rs`
**Generated:** 2025-11-15T19:40:01.723545Z
...
This file is located at `crates/common/src/ffi/logging.rs` within the repository.

**Classes defined:** wraps, LogGuard_API, Deref, DerefMut

**Functions defined:** deref, deref_mut, logging_init, logger_log, logging_log_header, logging_log_sysinfo, logger_flush, logger_drop, logging_is_initialized, logging_set_bypass and 5 more
...
#### `logging_log_sysinfo(component_ptr: *const c_char)`


#### `logger_flush()`


#### `logger_drop(log_guard: LogGuard_API)`
