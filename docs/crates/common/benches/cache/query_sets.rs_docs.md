# Documentation: `crates/common/benches/cache/query_sets.rs`
**Generated:** 2025-11-15T19:40:01.632032Z
...
- **Path:** `crates/common/benches/cache/query_sets.rs`
- **Size:** 2,920 bytes
- **Lines:** 81
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/common/benches/cache/query_sets.rs` within the repository.

**Functions defined:** build_populated_cache, bench_set_intersections
...
#### `bench_set_intersections(c: &mut Criterion)`
