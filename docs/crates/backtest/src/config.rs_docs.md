# Documentation: `crates/backtest/src/config.rs`
**Generated:** 2025-11-15T19:40:01.591927Z
**File Size:** 16479 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/backtest/src/config.rs` within the repository.

**Classes defined:** BacktestEngineConfig, BacktestVenueConfig, BacktestDataConfig, BacktestRunConfig, BacktestEngineConfig, NautilusKernelConfig, Default, BacktestVenueConfig, BacktestDataConfig, BacktestRunConfig

**Functions defined:** new, environment, trader_id, load_state, save_state, logging, instance_id, timeout_connection, timeout_reconciliation, timeout_portfolio and 14 more
