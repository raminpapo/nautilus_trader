...
- **Path**: `crates/backtest/src/config.rs`
- **Size**: 16,479 bytes
- **Lines**: 446
- **Language**: Rust
...
**Functions**: `cache`, `data_engine`, `default`, `delay_post_stop`, `environment`, `exec_engine`, `instance_id`, `load_state`, `logging`, `msgbus`, `new`, `portfolio`, `risk_engine`, `save_state`, `streaming`, `timeout_connection`, `timeout_disconnection`, `timeout_portfolio`, `timeout_reconciliation`, `timeout_shutdown`, `trader_id`
**Impls**: `BacktestDataConfig`, `BacktestEngineConfig`, `BacktestRunConfig`, `BacktestVenueConfig`, `Default`, `NautilusKernelConfig`
**Structs**: `BacktestDataConfig`, `BacktestEngineConfig`, `BacktestRunConfig`, `BacktestVenueConfig`
...
```bash
# For Python
pytest crates/backtest/src/config.rs
...
---
*Generated on 2025-11-18T21:55:00.894399Z*
