# Documentation: `crates/backtest/src/engine.rs`
**Generated:** 2025-11-15T19:40:01.599672Z
...
This file is located at `crates/backtest/src/engine.rs` within the repository.

**Classes defined:** BacktestEngine, Debug, BacktestEngine

**Functions defined:** fmt, new, add_venue, change_fill_model, add_instrument, add_data, add_actor, add_actors, add_strategy, add_strategies and 21 more
...
#### `new(config: BacktestEngineConfig)`
...
#### `change_fill_model(&mut self, venue: Venue, fill_model: FillModel)`
...
#### `add_strategy(&mut self)`


#### `add_strategies(&mut self)`


#### `add_exec_algorithm(&mut self)`


#### `add_exec_algorithms(&mut self)`
...
#### `clear_strategies(&mut self)`


#### `clear_exec_algorithms(&mut self)`
...
#### `advance_time(&mut self, _ts_now: UnixNanos)`
...
#### `add_data_client_if_not_exists(&mut self, client_id: ClientId)`
...
#### `add_market_data_client_if_not_exists(&mut self, venue: Venue)`


#### `get_backtest_engine(config: Option<BacktestEngineConfig>)`


#### `test_engine_venue_and_instrument_initialization(crypto_perpetual_ethusdt: CryptoPerpetual)`
