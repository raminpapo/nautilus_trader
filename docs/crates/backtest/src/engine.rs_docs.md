...
- **Path**: `crates/backtest/src/engine.rs`
- **Size**: 19,222 bytes
- **Lines**: 597
- **Language**: Rust
...
This file is part of the NautilusTrader repository. It defines 31 function(s) and 1 class(es).
...
- **`add_venue()`**: Function defined in this file
- **`change_fill_model()`**: Function defined in this file
- **`add_instrument()`**: Function defined in this file
- **`add_data()`**: Function defined in this file
- **`add_actor()`**: Function defined in this file
- **`add_actors()`**: Function defined in this file
- **`add_strategy()`**: Function defined in this file
- **`add_strategies()`**: Function defined in this file
- **`add_exec_algorithm()`**: Function defined in this file
- **`add_exec_algorithms()`**: Function defined in this file
- **`reset()`**: Function defined in this file
- **`clear_data()`**: Function defined in this file
- **`clear_strategies()`**: Function defined in this file
- **`clear_exec_algorithms()`**: Function defined in this file
- **`dispose()`**: Function defined in this file
- **`run()`**: Function defined in this file
- **`end()`**: Function defined in this file
- **`get_result()`**: Function defined in this file

*...and 11 more functions*

### Classes
- **`BacktestEngine`**: Class defined in this file
...
**Functions**: `add_actor`, `add_actors`, `add_data`, `add_data_client_if_not_exists`, `add_exec_algorithm`, `add_exec_algorithms`, `add_instrument`, `add_market_data_client_if_not_exists`, `add_strategies`, `add_strategy`, `add_venue`, `advance_time`, `change_fill_model`, `clear_data`, `clear_exec_algorithms`, `clear_strategies`, `dispose`, `end`, `fmt`, `get_backtest_engine`, `get_result`, `log_post_run`, `log_pre_run`, `log_run`, `new`, `next`, `process_raw_time_event_handlers`, `reset`, `run`, `should_skip_time_event` *(+1 more)*
**Impls**: `BacktestEngine`, `Debug`
**Structs**: `BacktestEngine`
...
```bash
# For Python
pytest crates/backtest/src/engine.rs
...
---
*Generated on 2025-11-18T21:55:00.905692Z*
