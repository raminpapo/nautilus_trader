# Documentation: `crates/backtest/src/accumulator.rs`
**Generated:** 2025-11-15T19:40:01.589556Z
...
This file is located at `crates/backtest/src/accumulator.rs` within the repository.

**Classes defined:** TimeEventAccumulator, TimeEventAccumulator, Default

**Functions defined:** new, advance_clock, drain, default, test_accumulator_drain_sorted
...
#### `advance_clock(&mut self, clock: &mut TestClock, to_time_ns: UnixNanos, set_time: bool)`
