# Documentation: accumulator.rs

## File Metadata

- **Path**: `crates/backtest/src/accumulator.rs`
- **Size**: 4,673 bytes
- **Lines**: 122
- **Language**: Rust
...
- **`drain()`**: Function defined in this file
- **`default()`**: Function defined in this file
- **`test_accumulator_drain_sorted()`**: Function defined in this file

### Classes
- **`TimeEventAccumulator`**: Class defined in this file
...
**Functions**: `advance_clock`, `default`, `drain`, `new`, `test_accumulator_drain_sorted`
**Impls**: `Default`, `TimeEventAccumulator`
**Structs**: `TimeEventAccumulator`
...
```bash
# For Python
pytest crates/backtest/src/accumulator.rs
...
---
*Generated on 2025-11-18T21:55:00.890534Z*
