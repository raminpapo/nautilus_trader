...
This file is part of the NautilusTrader repository. It defines 48 function(s) and 2 class(es).

## Detailed Walkthrough

### Functions
- **`new()`**: Function defined in this file
- **`cmp()`**: Function defined in this file
- **`partial_cmp()`**: Function defined in this file
- **`fmt()`**: Function defined in this file
- **`new()`**: Function defined in this file
- **`register_client()`**: Function defined in this file
- **`set_fill_model()`**: Function defined in this file
- **`set_latency_model()`**: Function defined in this file
- **`initialize_account()`**: Function defined in this file
...
- **`get_matching_engine()`**: Function defined in this file
- **`get_matching_engines()`**: Function defined in this file
- **`get_books()`**: Function defined in this file
...
### Classes
- **`InflightCommand`**: Class defined in this file
- **`SimulatedExchange`**: Class defined in this file
...
**Functions**: `add_instrument`, `adjust_account`, `best_ask_price`, `best_bid_price`, `cmp`, `create_submit_order_command`, `fmt`, `generate_fresh_account_state`, `generate_inflight_command`, `get_account`, `get_book`, `get_books`, `get_exchange`, `get_matching_engine`, `get_matching_engines`, `get_open_ask_orders`, `get_open_bid_orders`, `get_open_orders`, `initialize_account`, `new`, `partial_cmp`, `process`, `process_bar`, `process_instrument_status`, `process_order_book_delta`, `process_order_book_deltas`, `process_quote_tick`, `process_trade_tick`, `process_trading_command`, `register_client` *(+17 more)*
**Impls**: `Debug`, `InflightCommand`, `Ord`, `PartialOrd`, `SimulatedExchange`
**Structs**: `InflightCommand`, `SimulatedExchange`
...
```bash
# For Python
pytest crates/backtest/src/exchange.rs
...
---
*Generated on 2025-11-18T21:55:00.914201Z*
