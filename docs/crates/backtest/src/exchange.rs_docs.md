# Documentation: `crates/backtest/src/exchange.rs`
**Generated:** 2025-11-15T19:40:01.604537Z
**File Size:** 51991 bytes
**Extension:** .rs
**Type:** text
...
- **Path:** `crates/backtest/src/exchange.rs`
- **Size:** 51,991 bytes
- **Lines:** 1,467
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/backtest/src/exchange.rs` within the repository.

**Classes defined:** InflightCommand, SimulatedExchange, InflightCommand, Ord, PartialOrd, Debug, SimulatedExchange

**Functions defined:** new, cmp, partial_cmp, fmt, new, register_client, set_fill_model, set_latency_model, initialize_account, add_instrument and 38 more
...
#### `new(ts: UnixNanos, counter: u32, command: TradingCommand)`
...
#### `register_client(&mut self, client: Rc<dyn ExecutionClient>)`


#### `set_fill_model(&mut self, fill_model: FillModel)`


#### `set_latency_model(&mut self, latency_model: LatencyModel)`


#### `initialize_account(&mut self)`


#### `add_instrument(&mut self, instrument: InstrumentAny)`


#### `best_bid_price(&self, instrument_id: InstrumentId)`


#### `best_ask_price(&self, instrument_id: InstrumentId)`


#### `get_book(&self, instrument_id: InstrumentId)`
...
#### `get_open_orders(&self, instrument_id: Option<InstrumentId>)`


#### `get_open_bid_orders(&self, instrument_id: Option<InstrumentId>)`


#### `get_open_ask_orders(&self, instrument_id: Option<InstrumentId>)`


#### `get_account(&self)`


#### `adjust_account(&mut self, adjustment: Money)`


#### `send(&mut self, command: TradingCommand)`


#### `generate_inflight_command(&mut self, command: &TradingCommand)`


#### `process_order_book_delta(&mut self, delta: OrderBookDelta)`


#### `process_order_book_deltas(&mut self, deltas: OrderBookDeltas)`


#### `process_quote_tick(&mut self, quote: &QuoteTick)`


#### `process_trade_tick(&mut self, trade: &TradeTick)`


#### `process_bar(&mut self, bar: Bar)`


#### `process_instrument_status(&mut self, status: InstrumentStatus)`


#### `process(&mut self, ts_now: UnixNanos)`


#### `reset(&mut self)`


#### `process_trading_command(&mut self, command: TradingCommand)`


#### `generate_fresh_account_state(&self)`
...
#### `create_submit_order_command(ts_init: UnixNanos)`


#### `test_venue_mismatch_between_exchange_and_instrument(
        crypto_perpetual_ethusdt: CryptoPerpetual,
    )`


#### `test_cash_account_trading_futures_or_perpetuals(crypto_perpetual_ethusdt: CryptoPerpetual)`


#### `test_exchange_process_quote_tick(crypto_perpetual_ethusdt: CryptoPerpetual)`


#### `test_exchange_process_trade_tick(crypto_perpetual_ethusdt: CryptoPerpetual)`


#### `test_exchange_process_bar_last_bar_spec(crypto_perpetual_ethusdt: CryptoPerpetual)`


#### `test_exchange_process_bar_bid_ask_bar_spec(crypto_perpetual_ethusdt: CryptoPerpetual)`


#### `test_exchange_process_orderbook_delta(crypto_perpetual_ethusdt: CryptoPerpetual)`


#### `test_exchange_process_orderbook_deltas(crypto_perpetual_ethusdt: CryptoPerpetual)`


#### `test_exchange_process_instrument_status(crypto_perpetual_ethusdt: CryptoPerpetual)`


#### `test_accounting()`


#### `test_inflight_commands_binary_heap_ordering_respecting_timestamp_counter()`


#### `test_process_without_latency_model(crypto_perpetual_ethusdt: CryptoPerpetual)`


#### `test_process_with_latency_model(crypto_perpetual_ethusdt: CryptoPerpetual)`
