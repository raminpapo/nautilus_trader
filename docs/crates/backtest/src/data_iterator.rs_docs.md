# Documentation: data_iterator.rs

## File Metadata

- **Path**: `crates/backtest/src/data_iterator.rs`
- **Size**: 8,662 bytes
- **Lines**: 264
- **Language**: Rust
...
- **`remove_data()`**: Function defined in this file
- **`set_index()`**: Function defined in this file
- **`next()`**: Function defined in this file
- **`is_done()`**: Function defined in this file
- **`rebuild_heap()`**: Function defined in this file
- **`quote()`**: Function defined in this file
- **`test_single_stream()`**: Function defined in this file
- **`test_two_stream_merge()`**: Function defined in this file

### Classes
- **`to`**: Class defined in this file
- **`HeapEntry`**: Class defined in this file
- **`BacktestDataIterator`**: Class defined in this file
...
**Functions**: `add_data`, `cmp`, `is_done`, `new`, `next`, `partial_cmp`, `quote`, `rebuild_heap`, `remove_data`, `set_index`, `test_single_stream`, `test_two_stream_merge`
**Impls**: `BacktestDataIterator`, `Ord`, `PartialOrd`
**Structs**: `BacktestDataIterator`, `HeapEntry`, `to`
...
```bash
# For Python
pytest crates/backtest/src/data_iterator.rs
...
---
*Generated on 2025-11-18T21:55:00.900256Z*
