# Documentation: `crates/backtest/src/data_iterator.rs`
**Generated:** 2025-11-15T19:40:01.596203Z
**File Size:** 8666 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/backtest/src/data_iterator.rs` within the repository.

**Classes defined:** to, HeapEntry, BacktestDataIterator, Ord, PartialOrd, BacktestDataIterator

**Functions defined:** cmp, partial_cmp, new, add_data, remove_data, set_index, next, is_done, rebuild_heap, quote and 2 more
...
#### `add_data(&mut self, name: &str, mut data: Vec<Data>, append_data: bool)`


#### `remove_data(&mut self, name: &str, complete_remove: bool)`


#### `set_index(&mut self, name: &str, index: usize)`
