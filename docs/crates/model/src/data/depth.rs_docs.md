...
This file is part of the NautilusTrader repository. It defines 36 function(s) and 1 class(es).
...
- **`get_fields()`**: Function defined in this file
- **`fmt()`**: Function defined in this file
- **`ts_init()`**: Function defined in this file
- **`create_test_book_order()`**: Function defined in this file
- **`create_test_depth10()`**: Function defined in this file
- **`create_empty_depth10()`**: Function defined in this file
- **`test_order_book_depth10_new()`**: Function defined in this file
- **`test_order_book_depth10_new_with_all_parameters()`**: Function defined in this file
- **`test_order_book_depth10_fixed_array_sizes()`**: Function defined in this file
- **`test_order_book_depth10_array_indexing()`**: Function defined in this file
- **`test_order_book_depth10_bid_ask_ordering()`**: Function defined in this file
- **`test_order_book_depth10_clone()`**: Function defined in this file
- **`test_order_book_depth10_copy()`**: Function defined in this file
- **`test_order_book_depth10_debug()`**: Function defined in this file
- **`test_order_book_depth10_partial_eq()`**: Function defined in this file
- **`test_order_book_depth10_eq_consistency()`**: Function defined in this file
- **`test_order_book_depth10_hash()`**: Function defined in this file
- **`test_order_book_depth10_hash_different_objects()`**: Function defined in this file

*...and 16 more functions*

### Classes
- **`OrderBookDepth10`**: Class defined in this file
...
**Functions**: `assert_serializable`, `create_empty_depth10`, `create_test_book_order`, `create_test_depth10`, `fmt`, `get_fields`, `get_metadata`, `new`, `test_display`, `test_new`, `test_order_book_depth10_array_indexing`, `test_order_book_depth10_bid_ask_ordering`, `test_order_book_depth10_clone`, `test_order_book_depth10_copy`, `test_order_book_depth10_debug`, `test_order_book_depth10_different_instruments`, `test_order_book_depth10_display`, `test_order_book_depth10_display_format`, `test_order_book_depth10_empty_values`, `test_order_book_depth10_eq_consistency`, `test_order_book_depth10_fixed_array_sizes`, `test_order_book_depth10_get_fields`, `test_order_book_depth10_get_fields_order`, `test_order_book_depth10_get_metadata`, `test_order_book_depth10_has_ts_init`, `test_order_book_depth10_hash`, `test_order_book_depth10_hash_different_objects`, `test_order_book_depth10_max_values`, `test_order_book_depth10_new`, `test_order_book_depth10_new_with_all_parameters` *(+6 more)*
**Impls**: `Display`, `HasTsInit`, `OrderBookDepth10`, `Serializable`
**Structs**: `OrderBookDepth10`
**Traits**: `by`, `is`
...
---
*Generated on 2025-11-18T21:55:02.250832Z*
