# Documentation: `crates/model/src/data/depth.rs`
**Generated:** 2025-11-15T19:40:02.483956Z
**File Size:** 31534 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/model/src/data/depth.rs` within the repository.

**Classes defined:** OrderBookDepth10, OrderBookDepth10, Display, Serializable, HasTsInit

**Functions defined:** new, get_metadata, get_fields, fmt, ts_init, create_test_book_order, create_test_depth10, create_empty_depth10, test_order_book_depth10_new, test_order_book_depth10_new_with_all_parameters and 26 more
...
#### `test_order_book_depth10_with_stub(stub_depth10: OrderBookDepth10)`


#### `test_new(stub_depth10: OrderBookDepth10)`


#### `test_display(stub_depth10: OrderBookDepth10)`
