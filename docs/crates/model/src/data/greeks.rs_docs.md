...
- **Path**: `crates/model/src/data/greeks.rs`
- **Size**: 40,548 bytes
- **Lines**: 1,326
- **Language**: Rust
...
This file is part of the NautilusTrader repository. It defines 62 function(s) and 5 class(es).

## Detailed Walkthrough

### Functions
- **`norm_pdf()`**: Function defined in this file
- **`black_scholes_greeks()`**: Function defined in this file
- **`imply_vol()`**: Function defined in this file
- **`imply_vol_and_greeks()`**: Function defined in this file
- **`new()`**: Function defined in this file
- **`from_delta()`**: Function defined in this file
...
- **`ts_init()`**: Function defined in this file
- **`new()`**: Function defined in this file
- **`get_rate()`**: Function defined in this file
- **`fmt()`**: Function defined in this file
- **`ts_init()`**: Function defined in this file
...
### Classes
- **`BlackScholesGreeksResult`**: Class defined in this file
- **`ImplyVolAndGreeksResult`**: Class defined in this file
- **`GreeksData`**: Class defined in this file
- **`PortfolioGreeks`**: Class defined in this file
- **`YieldCurveData`**: Class defined in this file
...
**Functions**: `add`, `black_scholes_greeks`, `create_test_greeks_data`, `create_test_portfolio_greeks`, `create_test_yield_curve`, `default`, `fmt`, `from`, `from_delta`, `get_rate`, `imply_vol`, `imply_vol_and_greeks`, `mul`, `new`, `norm_pdf`, `test_black_scholes_greeks_basic_call`, `test_black_scholes_greeks_basic_put`, `test_black_scholes_greeks_deep_itm_call`, `test_black_scholes_greeks_deep_otm_call`, `test_black_scholes_greeks_extreme_values`, `test_black_scholes_greeks_high_volatility`, `test_black_scholes_greeks_result_clone_and_copy`, `test_black_scholes_greeks_result_creation`, `test_black_scholes_greeks_result_debug`, `test_black_scholes_greeks_with_multiplier`, `test_black_scholes_greeks_zero_time`, `test_greeks_accuracy_call`, `test_greeks_accuracy_put`, `test_greeks_data_clone`, `test_greeks_data_default` *(+24 more)*
**Impls**: `Add`, `Default`, `Display`, `From`, `GreeksData`, `HasTsInit`, `Mul`, `PortfolioGreeks`, `YieldCurveData`
**Structs**: `BlackScholesGreeksResult`, `GreeksData`, `ImplyVolAndGreeksResult`, `PortfolioGreeks`, `YieldCurveData`
...
---
*Generated on 2025-11-18T21:55:02.262416Z*
