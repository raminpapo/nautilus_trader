# Documentation: `crates/model/src/data/greeks.rs`
**Generated:** 2025-11-15T19:40:02.492331Z
**File Size:** 40548 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/model/src/data/greeks.rs` within the repository.

**Classes defined:** BlackScholesGreeksResult, ImplyVolAndGreeksResult, GreeksData, PortfolioGreeks, YieldCurveData, GreeksData, Default, Display, Mul, HasTsInit and 10 more

**Functions defined:** norm_pdf, black_scholes_greeks, imply_vol, imply_vol_and_greeks, new, from_delta, default, fmt, mul, ts_init and 52 more
...
#### `imply_vol(s: f64, r: f64, b: f64, is_call: bool, k: f64, t: f64, price: f64)`
...
#### `get_rate(&self, expiry_in_years: f64)`
