# Documentation: `crates/model/src/data/bet.rs`
**Generated:** 2025-11-15T19:40:02.470644Z
**File Size:** 32849 bytes
**Extension:** .rs
**Type:** text
...
- **Path:** `crates/model/src/data/bet.rs`
- **Size:** 32,849 bytes
- **Lines:** 937
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/model/src/data/bet.rs` within the repository.

**Classes defined:** Bet, BetPosition, Bet, Display, Default, BetPosition, Display

**Functions defined:** new, price, stake, side, from_stake_or_liability, from_stake, from_liability, exposure, liability, profit and 78 more
...
#### `new(price: Decimal, stake: Decimal, side: BetSide)`
...
#### `from_stake_or_liability(price: Decimal, volume: Decimal, side: BetSide)`


#### `from_stake(price: Decimal, stake: Decimal, side: BetSide)`


#### `from_liability(price: Decimal, liability: Decimal, side: BetSide)`
...
#### `outcome_win_payoff(&self)`


#### `outcome_lose_payoff(&self)`


#### `hedging_stake(&self, price: Decimal)`


#### `hedging_bet(&self, price: Decimal)`
...
#### `add_bet(&mut self, bet: Bet)`


#### `position_increase(&mut self, bet: &Bet)`


#### `position_decrease(&mut self, bet: &Bet)`


#### `unrealized_pnl(&self, price: Decimal)`


#### `total_pnl(&self, price: Decimal)`


#### `flattening_bet(&self, price: Decimal)`
...
#### `calc_bets_pnl(bets: &[Bet])`


#### `probability_to_bet(probability: Decimal, volume: Decimal, side: OrderSideSpecified)`
