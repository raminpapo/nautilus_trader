...
This file is part of the NautilusTrader repository. It defines 88 function(s) and 2 class(es).
...
- **`stake()`**: Function defined in this file
- **`side()`**: Function defined in this file
- **`from_stake_or_liability()`**: Function defined in this file
- **`from_stake()`**: Function defined in this file
- **`from_liability()`**: Function defined in this file
- **`exposure()`**: Function defined in this file
- **`liability()`**: Function defined in this file
- **`profit()`**: Function defined in this file
- **`outcome_win_payoff()`**: Function defined in this file
- **`outcome_lose_payoff()`**: Function defined in this file
- **`hedging_stake()`**: Function defined in this file
- **`hedging_bet()`**: Function defined in this file
- **`fmt()`**: Function defined in this file
- **`default()`**: Function defined in this file
- **`price()`**: Function defined in this file
- **`exposure()`**: Function defined in this file
- **`realized_pnl()`**: Function defined in this file
- **`bets()`**: Function defined in this file

*...and 68 more functions*

### Classes
- **`Bet`**: Class defined in this file
- **`BetPosition`**: Class defined in this file


## Keywords and Identifiers

Total unique keywords extracted: 88


**Functions**: `add_bet`, `as_bet`, `bets`, `calc_bets_pnl`, `dec_str`, `default`, `exposure`, `flattening_bet`, `fmt`, `from_liability`, `from_stake`, `from_stake_or_liability`, `hedging_bet`, `hedging_stake`, `inverse_probability_to_bet`, `liability`, `new`, `outcome_lose_payoff`, `outcome_win_payoff`, `position_decrease`, `position_increase`, `price`, `probability_to_bet`, `profit`, `realized_pnl`, `reset`, `side`, `stake`, `test_as_bet`, `test_bet_creation` *(+54 more)*
**Impls**: `Bet`, `BetPosition`, `Default`, `Display`
**Structs**: `Bet`, `BetPosition`
...
---
*Generated on 2025-11-18T21:55:02.229119Z*
