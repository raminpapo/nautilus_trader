...
- **Path**: `crates/model/src/data/deltas.rs`
- **Size**: 27,261 bytes
- **Lines**: 849
- **Language**: Rust
...
This file is part of the NautilusTrader repository. It defines 41 function(s) and 3 class(es).
...
- **`new()`**: Function defined in this file
- **`into_inner()`**: Function defined in this file
...
- **`create_test_deltas()`**: Function defined in this file
- **`create_test_deltas_multiple()`**: Function defined in this file
- **`test_order_book_deltas_new()`**: Function defined in this file
- **`test_order_book_deltas_new_checked_valid()`**: Function defined in this file
- **`test_order_book_deltas_new_checked_empty_deltas()`**: Function defined in this file
- **`test_order_book_deltas_new_empty_deltas_panics()`**: Function defined in this file
- **`test_order_book_deltas_uses_last_delta_properties()`**: Function defined in this file
- **`test_order_book_deltas_hash_different_objects()`**: Function defined in this file
- **`test_order_book_deltas_hash_uses_instrument_id_and_sequence()`**: Function defined in this file

*...and 21 more functions*

### Classes
- **`OrderBookDeltas`**: Class defined in this file
- **`wraps`**: Class defined in this file
- **`OrderBookDeltas_API`**: Class defined in this file
...
**Functions**: `create_test_delta`, `create_test_deltas`, `create_test_deltas_multiple`, `deref`, `deref_mut`, `eq`, `fmt`, `hash`, `into_inner`, `new`, `new_checked`, `test_display_with_stub`, `test_new`, `test_order_book_deltas_api_clone`, `test_order_book_deltas_api_debug`, `test_order_book_deltas_api_deref`, `test_order_book_deltas_api_deref_mut`, `test_order_book_deltas_api_into_inner`, `test_order_book_deltas_api_new`, `test_order_book_deltas_api_serialization`, `test_order_book_deltas_clone`, `test_order_book_deltas_debug`, `test_order_book_deltas_different_action_types`, `test_order_book_deltas_display`, `test_order_book_deltas_display_format`, `test_order_book_deltas_has_ts_init`, `test_order_book_deltas_hash_different_objects`, `test_order_book_deltas_hash_uses_instrument_id_and_sequence`, `test_order_book_deltas_large_number_of_deltas`, `test_order_book_deltas_max_values` *(+10 more)*
**Impls**: `Deref`, `DerefMut`, `Display`, `Eq`, `HasTsInit`, `Hash`, `OrderBookDeltas`, `OrderBookDeltas_API`, `PartialEq`, `Serializable`
**Structs**: `OrderBookDeltas`, `OrderBookDeltas_API`, `wraps`
...
---
*Generated on 2025-11-18T21:55:02.243452Z*
