# Documentation: `crates/model/src/data/deltas.rs`
**Generated:** 2025-11-15T19:40:02.479674Z
**File Size:** 27261 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/model/src/data/deltas.rs` within the repository.

**Classes defined:** OrderBookDeltas, wraps, OrderBookDeltas_API, OrderBookDeltas, PartialEq, Eq, Hash, Serializable, Display, HasTsInit and 3 more

**Functions defined:** new, new_checked, eq, hash, fmt, ts_init, new, into_inner, deref, deref_mut and 31 more
...
#### `new(instrument_id: InstrumentId, deltas: Vec<OrderBookDelta>)`
...
#### `test_order_book_deltas_with_stub(stub_deltas: OrderBookDeltas)`


#### `test_display_with_stub(stub_deltas: OrderBookDeltas)`
