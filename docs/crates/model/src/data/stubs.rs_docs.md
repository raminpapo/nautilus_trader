# Documentation: `crates/model/src/data/stubs.rs`
**Generated:** 2025-11-15T19:40:02.509783Z
**File Size:** 12073 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/model/src/data/stubs.rs` within the repository.

**Classes defined:** OrderBookDeltaTestBuilder, Default, Default, Default, OrderBookDeltaTestBuilder

**Functions defined:** default, default, default, stub_delta, stub_deltas, stub_depth10, stub_book_order, quote_ethusdt_binance, quote_audusd, stub_trade_ethusdt_buyer and 13 more
...
#### `book_action(&mut self, action: BookAction)`


#### `get_book_action(&self)`


#### `book_order(&mut self, book_order: BookOrder)`


#### `get_book_order(&self)`


#### `flags(&mut self, flags: u8)`


#### `get_flags(&self)`


#### `sequence(&mut self, sequence: u64)`
