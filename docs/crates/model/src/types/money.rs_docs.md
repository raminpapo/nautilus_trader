# Documentation: `crates/model/src/types/money.rs`
**Generated:** 2025-11-15T19:40:03.167274Z
**File Size:** 42560 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/model/src/types/money.rs` within the repository.

**Classes defined:** Money, Money, FromStr, From, From, Hash, PartialEq, PartialOrd, Ord, Neg and 14 more

**Functions defined:** new_checked, new, from_raw, zero, is_zero, as_f64, as_f64, as_decimal, to_formatted_string, from_decimal and 69 more
...
#### `new_checked(amount: f64, currency: Currency)`


#### `new(amount: f64, currency: Currency)`


#### `from_raw(raw: MoneyRaw, currency: Currency)`
...
#### `to_formatted_string(&self)`


#### `from_decimal(decimal: Decimal, currency: Currency)`
...
#### `sub_assign(&mut self, other: Self)`
...
#### `check_positive_money(value: Money, param: &str)`
