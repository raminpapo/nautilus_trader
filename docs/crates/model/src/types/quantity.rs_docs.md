# Documentation: `crates/model/src/types/quantity.rs`
**Generated:** 2025-11-15T19:40:03.183142Z
**File Size:** 52153 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/model/src/types/quantity.rs` within the repository.

**Classes defined:** Quantity, Quantity, From, From, From, From, From, From, Hash, PartialEq and 22 more

**Functions defined:** new_checked, non_zero_checked, new, non_zero, from_raw, saturating_sub, zero, is_undefined, is_zero, is_positive and 106 more
...
#### `non_zero_checked(value: f64, precision: u8)`


#### `new(value: f64, precision: u8)`


#### `non_zero(value: f64, precision: u8)`


#### `from_raw(raw: QuantityRaw, precision: u8)`
...
#### `check_positive_quantity(value: Quantity, param: &str)`
