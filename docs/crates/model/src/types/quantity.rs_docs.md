...
- **Path**: `crates/model/src/types/quantity.rs`
- **Size**: 52,151 bytes
- **Lines**: 1,518
- **Language**: Rust
...
This file is part of the NautilusTrader repository. It defines 116 function(s) and 1 class(es).

## Detailed Walkthrough

### Functions
- **`new_checked()`**: Function defined in this file
- **`non_zero_checked()`**: Function defined in this file
- **`new()`**: Function defined in this file
- **`non_zero()`**: Function defined in this file
...
### Classes
- **`Quantity`**: Class defined in this file
...
**Functions**: `add`, `add_assign`, `as_decimal`, `as_f64`, `check_positive_quantity`, `cmp`, `decimal_compatible`, `deref`, `deserialize`, `eq`, `fmt`, `from`, `from_decimal`, `from_raw`, `from_str`, `ge`, `gt`, `hash`, `is_positive`, `is_undefined`, `is_zero`, `le`, `lt`, `mul`, `mul_assign`, `new`, `new_checked`, `non_zero`, `non_zero_checked`, `partial_cmp` *(+70 more)*
**Impls**: `Add`, `Debug`, `Deref`, `Deserialize`, `Display`, `From`, `FromStr`, `Hash`, `Mul`, `Ord`, `PartialEq`, `PartialOrd`, `Quantity`, `Serialize`, `Strategy`, `Sub`
**Structs**: `Quantity`
...
---
*Generated on 2025-11-18T21:55:03.306199Z*
