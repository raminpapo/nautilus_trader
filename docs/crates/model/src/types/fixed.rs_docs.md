...
### Functions
- **`check_fixed_precision()`**: Function defined in this file
- **`f64_to_fixed_i64()`**: Function defined in this file
- **`f64_to_fixed_i128()`**: Function defined in this file
- **`f64_to_fixed_u64()`**: Function defined in this file
- **`f64_to_fixed_u128()`**: Function defined in this file
- **`fixed_i64_to_f64()`**: Function defined in this file
- **`fixed_i128_to_f64()`**: Function defined in this file
- **`fixed_u64_to_f64()`**: Function defined in this file
- **`fixed_u128_to_f64()`**: Function defined in this file
- **`test_precision_boundaries()`**: Function defined in this file
- **`test_precision_boundaries()`**: Function defined in this file
- **`test_basic_roundtrip()`**: Function defined in this file
- **`test_large_value_roundtrip()`**: Function defined in this file
- **`test_precision_specific_values_basic()`**: Function defined in this file
- **`test_max_precision_values()`**: Function defined in this file
- **`test_unsigned_basic_roundtrip()`**: Function defined in this file
- **`test_valid_precision()`**: Function defined in this file
- **`test_invalid_precision()`**: Function defined in this file
- **`test_invalid_precision()`**: Function defined in this file
- **`test_f64_to_fixed_i128_to_fixed()`**: Function defined in this file
...
**Functions**: `check_fixed_precision`, `f64_to_fixed_i128`, `f64_to_fixed_i64`, `f64_to_fixed_u128`, `f64_to_fixed_u64`, `fixed_i128_to_f64`, `fixed_i64_to_f64`, `fixed_u128_to_f64`, `fixed_u64_to_f64`, `test_basic_roundtrip`, `test_f64_to_fixed_i128`, `test_f64_to_fixed_i128_to_fixed`, `test_f64_to_fixed_i128_with_precision`, `test_f64_to_fixed_i64`, `test_f64_to_fixed_i64_to_fixed`, `test_f64_to_fixed_i64_with_precision`, `test_f64_to_fixed_u128_to_fixed`, `test_f64_to_fixed_u64`, `test_f64_to_fixed_u64_to_fixed`, `test_fixed_i128_to_f64`, `test_fixed_i64_to_f64`, `test_fixed_u128_to_f64`, `test_fixed_u64_to_f64`, `test_invalid_precision`, `test_large_value_roundtrip`, `test_max_precision_values`, `test_precision_boundaries`, `test_precision_specific_values`, `test_precision_specific_values_basic`, `test_rounding` *(+3 more)*
...
---
*Generated on 2025-11-18T21:55:03.266545Z*
