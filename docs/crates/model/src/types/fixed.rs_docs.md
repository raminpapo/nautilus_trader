# Documentation: `crates/model/src/types/fixed.rs`
**Generated:** 2025-11-15T19:40:03.160708Z
**File Size:** 25620 bytes
**Extension:** .rs
**Type:** text
...
- **Path:** `crates/model/src/types/fixed.rs`
- **Size:** 25,620 bytes
- **Lines:** 750
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/model/src/types/fixed.rs` within the repository.

**Functions defined:** check_fixed_precision, f64_to_fixed_i64, f64_to_fixed_i128, f64_to_fixed_u64, f64_to_fixed_u128, fixed_i64_to_f64, fixed_i128_to_f64, fixed_u64_to_f64, fixed_u128_to_f64, test_precision_boundaries and 32 more
...
#### `check_fixed_precision(precision: u8)`


#### `f64_to_fixed_i64(value: f64, precision: u8)`


#### `f64_to_fixed_i128(value: f64, precision: u8)`


#### `f64_to_fixed_u64(value: f64, precision: u8)`


#### `f64_to_fixed_u128(value: f64, precision: u8)`


#### `fixed_i64_to_f64(value: i64)`


#### `fixed_i128_to_f64(value: i128)`


#### `fixed_u64_to_f64(value: u64)`


#### `fixed_u128_to_f64(value: u128)`
...
#### `test_basic_roundtrip(#[case] value: f64)`


#### `test_large_value_roundtrip(#[case] value: f64)`


#### `test_precision_specific_values_basic(#[case] precision: u8, #[case] value: f64)`


#### `test_max_precision_values()`


#### `test_unsigned_basic_roundtrip(#[case] value: f64)`


#### `test_valid_precision(#[case] precision: u8)`
...
#### `test_f64_to_fixed_i128_to_fixed(#[case] precision: u8, #[case] value: f64)`


#### `test_f64_to_fixed_u128_to_fixed(#[case] precision: u8, #[case] value: f64)`


#### `test_f64_to_fixed_i128_with_precision(#[case] precision: u8, #[case] value: f64)`


#### `test_f64_to_fixed_i128(#[case] precision: u8, #[case] value: f64)`


#### `test_f64_to_fixed_u64(#[case] precision: u8, #[case] value: f64)`


#### `test_fixed_i128_to_f64(
        #[values(1, -1, 2, -2, 10, -10, 100, -100, 1_000, -1_000, -10_000, -100_000)`
...
#### `test_rounding(#[case] precision: u8, #[case] input: f64, #[case] expected: f64)`
...
#### `test_f64_to_fixed_i64_to_fixed(#[case] precision: u8, #[case] value: f64)`


#### `test_f64_to_fixed_u64_to_fixed(#[case] precision: u8, #[case] value: f64)`
...
#### `test_f64_to_fixed_i64(#[case] precision: u8, #[case] value: f64, #[case] expected: i64)`


#### `test_f64_to_fixed_u64(#[case] precision: u8, #[case] value: f64, #[case] expected: u64)`


#### `test_fixed_i64_to_f64(
        #[values(1, -1, 2, -2, 10, -10, 100, -100, 1_000, -1_000)`
