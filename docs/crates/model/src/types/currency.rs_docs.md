...
- **Path**: `crates/model/src/types/currency.rs`
- **Size**: 17,089 bytes
- **Lines**: 504
- **Language**: Rust
...
- **`try_from_str()`**: Function defined in this file
- **`is_fiat()`**: Function defined in this file
- **`is_crypto()`**: Function defined in this file
- **`is_commodity_backed()`**: Function defined in this file
- **`get_or_create_crypto()`**: Function defined in this file
...
- **`test_invalid_currency_code()`**: Function defined in this file
- **`test_invalid_precision()`**: Function defined in this file

*...and 18 more functions*

### Classes
- **`Currency`**: Class defined in this file
...
**Functions**: `deserialize`, `eq`, `fmt`, `from`, `from_str`, `get_or_create_crypto`, `hash`, `is_commodity_backed`, `is_crypto`, `is_fiat`, `new`, `new_checked`, `register`, `serialize`, `test_currency_partial_eq_only_checks_code`, `test_debug`, `test_display`, `test_equality`, `test_get_or_create_crypto_existing`, `test_get_or_create_crypto_idempotent`, `test_get_or_create_crypto_new`, `test_get_or_create_crypto_with_ustr`, `test_invalid_currency_code`, `test_invalid_precision`, `test_is_commodity_backed`, `test_is_crypto`, `test_is_fiat`, `test_is_fiat_unknown_currency`, `test_new_for_crypto`, `test_new_for_fiat` *(+6 more)*
**Impls**: `Currency`, `Debug`, `Deserialize`, `Display`, `FromStr`, `Hash`, `PartialEq`, `Serialize`
**Structs**: `Currency`
...
---
*Generated on 2025-11-18T21:55:03.260533Z*
