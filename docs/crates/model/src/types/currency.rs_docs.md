# Documentation: `crates/model/src/types/currency.rs`
**Generated:** 2025-11-15T19:40:03.157419Z
**File Size:** 17089 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/model/src/types/currency.rs` within the repository.

**Classes defined:** Currency, Currency, PartialEq, Hash, Debug, Display, FromStr, Serialize

**Functions defined:** register, try_from_str, is_fiat, is_crypto, is_commodity_backed, eq, hash, fmt, fmt, from_str and 25 more
...
#### `register(currency: Self, overwrite: bool)`
