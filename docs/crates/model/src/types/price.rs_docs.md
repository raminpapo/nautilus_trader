# Documentation: `crates/model/src/types/price.rs`
**Generated:** 2025-11-15T19:40:03.174617Z
**File Size:** 44692 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/model/src/types/price.rs` within the repository.

**Classes defined:** Price, Price, FromStr, From, From, From, From, Hash, PartialEq, PartialOrd and 18 more

**Functions defined:** new_checked, new, from_raw, zero, max, min, is_undefined, is_zero, is_positive, as_f64 and 89 more
...
#### `new_checked(value: f64, precision: u8)`


#### `new(value: f64, precision: u8)`


#### `from_raw(raw: PriceRaw, precision: u8)`
...
#### `from_decimal(decimal: Decimal, precision: u8)`
...
#### `deserialize(_deserializer: D)`


#### `check_positive_price(value: Price, param: &str)`


#### `decode_raw_price_i64(value: i64)`
