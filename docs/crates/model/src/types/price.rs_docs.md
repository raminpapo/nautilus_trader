...
- **Path**: `crates/model/src/types/price.rs`
- **Size**: 44,690 bytes
- **Lines**: 1,298
- **Language**: Rust
...
This file is part of the NautilusTrader repository. It defines 99 function(s) and 1 class(es).
...
- **`min()`**: Function defined in this file
- **`is_undefined()`**: Function defined in this file
- **`is_zero()`**: Function defined in this file
- **`is_positive()`**: Function defined in this file
...
### Classes
- **`Price`**: Class defined in this file


## Keywords and Identifiers

Total unique keywords extracted: 108


**Functions**: `add`, `add_assign`, `as_decimal`, `as_f64`, `check_positive_price`, `cmp`, `decode_raw_price_i64`, `deref`, `deserialize`, `eq`, `float_precision_strategy`, `float_precision_upper_bound`, `fmt`, `from`, `from_decimal`, `from_raw`, `from_str`, `ge`, `gt`, `hash`, `is_positive`, `is_undefined`, `is_zero`, `le`, `lt`, `max`, `min`, `mul`, `neg`, `new` *(+59 more)*
**Impls**: `Add`, `AddAssign`, `Debug`, `Deref`, `Deserialize`, `Display`, `From`, `FromStr`, `Hash`, `Mul`, `Neg`, `Ord`, `PartialEq`, `PartialOrd`, `Price`, `Serialize`, `Strategy`, `Sub`, `SubAssign`
**Structs**: `Price`
...
---
*Generated on 2025-11-18T21:55:03.290769Z*
