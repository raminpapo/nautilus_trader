...
- **Path**: `crates/model/src/instruments/mod.rs`
- **Size**: 40,826 bytes
- **Lines**: 1,277
- **Language**: Rust
...
This file is part of the NautilusTrader repository. It defines 115 function(s) and 1 class(es).

## Detailed Walkthrough

### Functions
- **`validate_instrument_common()`**: Function defined in this file
- **`next_bid_price()`**: Function defined in this file
- **`next_ask_price()`**: Function defined in this file
...
- **`tick_scheme()`**: Function defined in this file
...
### Classes
- **`FixedTickScheme`**: Class defined in this file


## Keywords and Identifiers

Total unique keywords extracted: 115


**Enums**: `TickScheme`
**Functions**: `_min_price_increment_precision`, `activation_ns`, `asset_class`, `base_currency`, `base_qty_rounding`, `base_qty_rounding_high_dp`, `base_quantity_linear`, `calculate_base_quantity`, `calculate_notional_value`, `check_positive_money_negative`, `check_positive_money_ok`, `check_positive_money_zero`, `cost_currency`, `default_increment_precision`, `default_price_increment`, `eq`, `exchange`, `expiration_ns`, `fixed_tick_boundary`, `fixed_tick_multiple_steps`, `fixed_tick_negative`, `fixed_tick_scheme_prices`, `fmt`, `from_str`, `id`, `instrument_class`, `into_any`, `is_inverse`, `is_quanto`, `is_quanto_flag` *(+77 more)*
**Impls**: `Display`, `Eq`, `FixedTickScheme`, `FromStr`, `PartialEq`, `TickSchemeRule`
**Structs**: `FixedTickScheme`
**Traits**: `Instrument`, `TickSchemeRule`
...
---
*Generated on 2025-11-18T21:55:02.717885Z*
