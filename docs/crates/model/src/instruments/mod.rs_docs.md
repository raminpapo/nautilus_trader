# Documentation: `crates/model/src/instruments/mod.rs`
**Generated:** 2025-11-15T19:40:02.809993Z
**File Size:** 40826 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/model/src/instruments/mod.rs` within the repository.

**Classes defined:** FixedTickScheme, PartialEq, Eq, FixedTickScheme, TickSchemeRule, Display, TickSchemeRule, Display, FromStr, Display

**Functions defined:** validate_instrument_common, next_bid_price, next_ask_price, eq, new, next_bid_price, next_ask_price, fmt, next_bid_price, next_ask_price and 105 more
...
#### `next_bid_price(&self, value: f64, n: i32, precision: u8)`


#### `next_ask_price(&self, value: f64, n: i32, precision: u8)`
