# Documentation: `crates/model/src/instruments/option_spread.rs`
**Generated:** 2025-11-15T19:40:02.815963Z
**File Size:** 10962 bytes
**Extension:** .rs
**Type:** text
...
- **Path:** `crates/model/src/instruments/option_spread.rs`
- **Size:** 10,962 bytes
- **Lines:** 384
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/model/src/instruments/option_spread.rs` within the repository.

**Classes defined:** OptionSpread, OptionSpread, PartialEq, Eq, Hash, Instrument
...
#### `test_equality(option_spread: OptionSpread)`
