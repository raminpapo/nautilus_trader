# Documentation: `crates/model/src/instruments/synthetic.rs`
**Generated:** 2025-11-15T19:40:02.822237Z
**File Size:** 10287 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/model/src/instruments/synthetic.rs` within the repository.

**Classes defined:** SyntheticInstrument, Fields, Serialize, SyntheticInstrument, PartialEq, Eq, Hash

**Functions defined:** serialize, deserialize, new_checked, new, is_valid_formula, change_formula, calculate_from_map, calculate, eq, hash and 3 more
...
#### `is_valid_formula(&self, formula: &str)`


#### `change_formula(&mut self, formula: String)`


#### `calculate_from_map(&mut self, inputs: &HashMap<String, f64>)`


#### `calculate(&mut self, inputs: &[f64])`
