...
- **Path**: `crates/model/src/instruments/synthetic.rs`
- **Size**: 10,287 bytes
- **Lines**: 306
- **Language**: Rust
...
- **`is_valid_formula()`**: Function defined in this file
- **`change_formula()`**: Function defined in this file
- **`calculate_from_map()`**: Function defined in this file
- **`calculate()`**: Function defined in this file
- **`eq()`**: Function defined in this file
- **`hash()`**: Function defined in this file
- **`test_calculate_from_map()`**: Function defined in this file
- **`test_calculate()`**: Function defined in this file
- **`test_change_formula()`**: Function defined in this file

### Classes
- **`SyntheticInstrument`**: Class defined in this file
- **`Fields`**: Class defined in this file
...
**Functions**: `calculate`, `calculate_from_map`, `change_formula`, `deserialize`, `eq`, `hash`, `is_valid_formula`, `new`, `new_checked`, `serialize`, `test_calculate`, `test_calculate_from_map`, `test_change_formula`
**Impls**: `Deserialize`, `Eq`, `Hash`, `PartialEq`, `Serialize`, `SyntheticInstrument`
**Structs**: `Fields`, `SyntheticInstrument`
...
---
*Generated on 2025-11-18T21:55:02.735956Z*
