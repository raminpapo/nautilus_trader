# Documentation: `crates/model/src/instruments/crypto_perpetual.rs`
**Generated:** 2025-11-15T19:40:02.795025Z
**File Size:** 11407 bytes
**Extension:** .rs
**Type:** text
...
- **Path:** `crates/model/src/instruments/crypto_perpetual.rs`
- **Size:** 11,407 bytes
- **Lines:** 400
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/model/src/instruments/crypto_perpetual.rs` within the repository.

**Classes defined:** CryptoPerpetual, CryptoPerpetual, PartialEq, Eq, Hash, Instrument

**Functions defined:** new_checked, new, eq, hash, into_any, id, raw_symbol, asset_class, instrument_class, underlying and 29 more
...
#### `test_equality(crypto_perpetual_ethusdt: CryptoPerpetual)`
