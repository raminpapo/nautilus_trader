...
- **Path**: `crates/model/src/instruments/stubs.rs`
- **Size**: 22,799 bytes
- **Lines**: 739
- **Language**: Rust
...
- **`crypto_future_btcusdt()`**: Function defined in this file
- **`ethbtc_quanto()`**: Function defined in this file
- **`xbtusd_inverse_perp()`**: Function defined in this file
- **`crypto_option_btc_deribit()`**: Function defined in this file
- **`crypto_perpetual_ethusdt()`**: Function defined in this file
- **`xbtusd_bitmex()`**: Function defined in this file
- **`ethusdt_bitmex()`**: Function defined in this file
- **`currency_pair_btcusdt()`**: Function defined in this file
- **`currency_pair_ethusdt()`**: Function defined in this file
- **`default_fx_ccy()`**: Function defined in this file
- **`audusd_sim()`**: Function defined in this file
- **`gbpusd_sim()`**: Function defined in this file
- **`usdjpy_idealpro()`**: Function defined in this file
- **`equity_aapl()`**: Function defined in this file
- **`futures_contract_es()`**: Function defined in this file
- **`futures_spread_es()`**: Function defined in this file
- **`option_contract_appl()`**: Function defined in this file
- **`option_spread()`**: Function defined in this file
- **`betting()`**: Function defined in this file
...
**Functions**: `audusd_sim`, `betting`, `binary_option`, `crypto_future_btcusdt`, `crypto_option_btc_deribit`, `crypto_perpetual_ethusdt`, `currency_pair_btcusdt`, `currency_pair_ethusdt`, `default`, `default_fx_ccy`, `equity_aapl`, `ethbtc_quanto`, `ethusdt_bitmex`, `futures_contract_es`, `futures_spread_es`, `gbpusd_sim`, `option_contract_appl`, `option_spread`, `usdjpy_idealpro`, `xbtusd_bitmex`, `xbtusd_inverse_perp`
**Impls**: `Default`
...
---
*Generated on 2025-11-18T21:55:02.732336Z*
