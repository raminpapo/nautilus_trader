# Documentation: `crates/model/src/instruments/option_contract.rs`
**Generated:** 2025-11-15T19:40:02.813053Z
**File Size:** 11265 bytes
**Extension:** .rs
**Type:** text
...
- **Path:** `crates/model/src/instruments/option_contract.rs`
- **Size:** 11,265 bytes
- **Lines:** 391
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/model/src/instruments/option_contract.rs` within the repository.

**Classes defined:** OptionContract, OptionContract, PartialEq, Eq, Hash, Instrument

**Functions defined:** new_checked, new, eq, hash, into_any, id, raw_symbol, asset_class, instrument_class, underlying and 25 more
...
#### `test_equality(option_contract_appl: OptionContract)`
