# Documentation: `crates/model/src/orders/stop_market.rs`
**Generated:** 2025-11-15T19:40:02.911507Z
**File Size:** 24989 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/model/src/orders/stop_market.rs` within the repository.

**Classes defined:** StopMarketOrder, StopMarketOrder, Deref, DerefMut, Order, Display, From

**Functions defined:** new_checked, new, deref, deref_mut, into_any, status, trader_id, strategy_id, instrument_id, symbol and 71 more
