# Documentation: `crates/model/src/orders/market_if_touched.rs`
**Generated:** 2025-11-15T19:40:02.895239Z
**File Size:** 22964 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/model/src/orders/market_if_touched.rs` within the repository.

**Classes defined:** MarketIfTouchedOrder, MarketIfTouchedOrder, Deref, DerefMut, Order, From, Display

**Functions defined:** new_checked, new, deref, deref_mut, into_any, status, trader_id, strategy_id, instrument_id, symbol and 67 more
