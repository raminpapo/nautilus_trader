# Documentation: market_to_limit.rs

## File Metadata

- **Path**: `crates/model/src/orders/market_to_limit.rs`
- **Size**: 22,809 bytes
- **Lines**: 763
- **Language**: Rust
...
### Classes
- **`MarketToLimitOrder`**: Class defined in this file
...
**Impls**: `Deref`, `DerefMut`, `Display`, `From`, `MarketToLimitOrder`, `Order`
**Structs**: `MarketToLimitOrder`
...
---
*Generated on 2025-11-18T21:55:02.864091Z*
