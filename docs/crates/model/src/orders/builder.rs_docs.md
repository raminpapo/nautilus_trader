...
- **Path**: `crates/model/src/orders/builder.rs`
- **Size**: 26,047 bytes
- **Lines**: 759
- **Language**: Rust
...
This file is part of the NautilusTrader repository. It defines 72 function(s) and 1 class(es).

## Detailed Walkthrough

### Functions
- **`new()`**: Function defined in this file
- **`submit()`**: Function defined in this file
- **`kind()`**: Function defined in this file
- **`trader_id()`**: Function defined in this file
- **`get_trader_id()`**: Function defined in this file
- **`strategy_id()`**: Function defined in this file
- **`get_strategy_id()`**: Function defined in this file
- **`instrument_id()`**: Function defined in this file
- **`get_instrument_id()`**: Function defined in this file
...
**Functions**: `build`, `client_order_id`, `contingency_type`, `currency`, `display_qty`, `emulation_trigger`, `exec_algorithm_id`, `exec_algorithm_params`, `exec_spawn_id`, `expire_time`, `get_client_order_id`, `get_contingency_type`, `get_currency`, `get_display_qty`, `get_emulation_trigger`, `get_exec_algorithm_id`, `get_exec_algorithm_params`, `get_exec_spawn_id`, `get_expire_time`, `get_init_id`, `get_instrument_id`, `get_limit_offset`, `get_linked_order_ids`, `get_liquidity_side`, `get_order_list_id`, `get_parent_order_id`, `get_post_only`, `get_price`, `get_quantity`, `get_quote_quantity` *(+42 more)*
**Impls**: `OrderTestBuilder`
**Structs**: `OrderTestBuilder`
...
---
*Generated on 2025-11-18T21:55:02.834826Z*
