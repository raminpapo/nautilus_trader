...
- **Path**: `crates/model/src/orders/limit.rs`
- **Size**: 22,140 bytes
- **Lines**: 767
- **Language**: Rust
...
### Classes
- **`LimitOrder`**: Class defined in this file
...
**Functions**: `account_id`, `apply`, `avg_px`, `client_order_id`, `commissions`, `contingency_type`, `deref`, `deref_mut`, `display_qty`, `emulation_trigger`, `eq`, `events`, `exec_algorithm_id`, `exec_algorithm_params`, `exec_spawn_id`, `expire_time`, `filled_qty`, `fmt`, `from`, `has_price`, `init_id`, `instrument_id`, `into_any`, `is_post_only`, `is_quote_quantity`, `is_reduce_only`, `is_triggered`, `last_trade_id`, `leaves_qty`, `limit_offset` *(+52 more)*
**Impls**: `Deref`, `DerefMut`, `Display`, `From`, `LimitOrder`, `Order`, `PartialEq`
**Structs**: `LimitOrder`
...
---
*Generated on 2025-11-18T21:55:02.842141Z*
