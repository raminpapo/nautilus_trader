# Documentation: `crates/model/src/orders/limit.rs`
**Generated:** 2025-11-15T19:40:02.883118Z
...
This file is located at `crates/model/src/orders/limit.rs` within the repository.

**Classes defined:** LimitOrder, LimitOrder, Deref, DerefMut, PartialEq, Order, Display, From

**Functions defined:** new_checked, new, deref, deref_mut, eq, into_any, status, trader_id, strategy_id, instrument_id and 72 more
