# Documentation: `crates/model/src/orders/market.rs`
**Generated:** 2025-11-15T19:40:02.891767Z
**File Size:** 20401 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/model/src/orders/market.rs` within the repository.

**Classes defined:** MarketOrder, MarketOrder, Deref, DerefMut, PartialEq, Order, Display, From

**Functions defined:** new_checked, new, deref, deref_mut, eq, into_any, status, trader_id, strategy_id, instrument_id and 69 more
