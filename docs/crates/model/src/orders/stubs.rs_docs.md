# Documentation: `crates/model/src/orders/stubs.rs`
**Generated:** 2025-11-15T19:40:02.913559Z
...
This file is located at `crates/model/src/orders/stubs.rs` within the repository.

**Classes defined:** TestOrderEventStubs, TestOrderStubs, TestOrdersGenerator, TestOrderEventStubs, TestOrderStubs, TestOrdersGenerator

**Functions defined:** submitted, accepted, canceled, filled, make_accepted_order, make_filled_order, new, set_orders_per_instrument, add_venue_and_total_instruments, generate_order and 2 more
...
#### `submitted(order: &OrderAny, account_id: AccountId)`
...
#### `make_accepted_order(order: &OrderAny)`
...
#### `set_orders_per_instrument(&mut self, total_orders: u32)`


#### `add_venue_and_total_instruments(&mut self, venue: Venue, total_instruments: u32)`


#### `generate_order(&self, instrument_id: InstrumentId, client_order_id_index: u32)`
