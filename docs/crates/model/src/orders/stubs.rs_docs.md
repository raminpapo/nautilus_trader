...
- **Path**: `crates/model/src/orders/stubs.rs`
- **Size**: 8,506 bytes
- **Lines**: 257
- **Language**: Rust
...
### Functions
- **`submitted()`**: Function defined in this file
- **`accepted()`**: Function defined in this file
- **`canceled()`**: Function defined in this file
- **`filled()`**: Function defined in this file
- **`make_accepted_order()`**: Function defined in this file
- **`make_filled_order()`**: Function defined in this file
- **`new()`**: Function defined in this file
- **`set_orders_per_instrument()`**: Function defined in this file
- **`add_venue_and_total_instruments()`**: Function defined in this file
- **`generate_order()`**: Function defined in this file
- **`build()`**: Function defined in this file
- **`create_order_list_sample()`**: Function defined in this file

### Classes
- **`TestOrderEventStubs`**: Class defined in this file
- **`TestOrderStubs`**: Class defined in this file
- **`TestOrdersGenerator`**: Class defined in this file
...
**Functions**: `accepted`, `add_venue_and_total_instruments`, `build`, `canceled`, `create_order_list_sample`, `filled`, `generate_order`, `make_accepted_order`, `make_filled_order`, `new`, `set_orders_per_instrument`, `submitted`
**Impls**: `TestOrderEventStubs`, `TestOrderStubs`, `TestOrdersGenerator`
**Structs**: `TestOrderEventStubs`, `TestOrderStubs`, `TestOrdersGenerator`
...
---
*Generated on 2025-11-18T21:55:02.886458Z*
