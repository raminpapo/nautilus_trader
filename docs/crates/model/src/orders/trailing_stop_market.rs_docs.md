# Documentation: `crates/model/src/orders/trailing_stop_market.rs`
**Generated:** 2025-11-15T19:40:02.920620Z
**File Size:** 27933 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/model/src/orders/trailing_stop_market.rs` within the repository.

**Classes defined:** TrailingStopMarketOrder, TrailingStopMarketOrder, Deref, DerefMut, Order, Display, From

**Functions defined:** new_checked, new, has_activation_price, set_activated, deref, deref_mut, into_any, status, trader_id, strategy_id and 72 more
