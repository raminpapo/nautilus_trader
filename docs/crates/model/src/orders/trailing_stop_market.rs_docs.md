# Documentation: trailing_stop_market.rs

## File Metadata

- **Path**: `crates/model/src/orders/trailing_stop_market.rs`
- **Size**: 27,933 bytes
- **Lines**: 860
- **Language**: Rust
...
This file is part of the NautilusTrader repository. It defines 82 function(s) and 1 class(es).
...
### Classes
- **`TrailingStopMarketOrder`**: Class defined in this file
...
**Functions**: `account_id`, `apply`, `avg_px`, `client_order_id`, `commissions`, `contingency_type`, `deref`, `deref_mut`, `display_qty`, `emulation_trigger`, `events`, `exec_algorithm_id`, `exec_algorithm_params`, `exec_spawn_id`, `expire_time`, `filled_qty`, `fmt`, `from`, `has_activation_price`, `has_price`, `init_id`, `instrument_id`, `into_any`, `is_post_only`, `is_quote_quantity`, `is_reduce_only`, `is_triggered`, `last_trade_id`, `leaves_qty`, `limit_offset` *(+52 more)*
**Impls**: `Deref`, `DerefMut`, `Display`, `From`, `Order`, `TrailingStopMarketOrder`
**Structs**: `TrailingStopMarketOrder`
...
---
*Generated on 2025-11-18T21:55:02.897411Z*
