# Documentation: `crates/model/src/orders/any.rs`
**Generated:** 2025-11-15T19:40:02.877935Z
**File Size:** 22261 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/model/src/orders/any.rs` within the repository.

**Classes defined:** OrderAny, PartialEq, Eq, Display, TryFrom, From, TryFrom, From, TryFrom, From and 6 more

**Functions defined:** from_events, init_event, eq, fmt, try_from, from, try_from, from, try_from, from and 18 more
...
#### `from_events(events: Vec<OrderEventAny>)`
...
#### `try_from(order: OrderAny)`


#### `from(order: PassiveOrderAny)`


#### `try_from(order: OrderAny)`


#### `from(order: StopOrderAny)`


#### `try_from(order: OrderAny)`


#### `from(order: LimitOrderAny)`
