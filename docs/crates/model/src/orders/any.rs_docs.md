...
- **Path**: `crates/model/src/orders/any.rs`
- **Size**: 22,277 bytes
- **Lines**: 591
- **Language**: Rust
...
- **`init_event()`**: Function defined in this file
...
- **`try_from()`**: Function defined in this file
- **`from()`**: Function defined in this file
- **`to_any()`**: Function defined in this file
- **`eq()`**: Function defined in this file
- **`limit_px()`**: Function defined in this file
- **`eq()`**: Function defined in this file
- **`stop_px()`**: Function defined in this file
- **`eq()`**: Function defined in this file
- **`test_order_any_equality()`**: Function defined in this file
- **`test_order_any_conversion_from_events()`**: Function defined in this file
- **`test_order_any_from_events_empty_error()`**: Function defined in this file
- **`test_order_any_from_events_wrong_first_event()`**: Function defined in this file
...
**Enums**: `LimitOrderAny`, `OrderAny`, `PassiveOrderAny`, `StopOrderAny`
**Functions**: `eq`, `fmt`, `from`, `from_events`, `init_event`, `limit_px`, `stop_px`, `test_limit_order_any_conversion`, `test_limit_order_any_limit_price`, `test_order_any_conversion_from_events`, `test_order_any_equality`, `test_order_any_from_events_empty_error`, `test_order_any_from_events_wrong_first_event`, `test_passive_order_any_conversion`, `test_passive_order_any_to_any`, `test_stop_order_any_conversion`, `test_stop_order_any_stop_price`, `test_trailing_stop_limit_order_conversion`, `test_trailing_stop_market_order_conversion`, `to_any`, `try_from`
**Impls**: `Display`, `Eq`, `From`, `LimitOrderAny`, `OrderAny`, `PartialEq`, `PassiveOrderAny`, `StopOrderAny`, `TryFrom`

## Related Files

This file is located in `crates/model/src/orders/`. Related files may include:
...
---
*Generated on 2025-11-18T21:55:02.829978Z*
