# Documentation: `crates/model/src/orders/list.rs`
**Generated:** 2025-11-15T19:40:02.888638Z
**File Size:** 7654 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/model/src/orders/list.rs` within the repository.

**Classes defined:** OrderList, OrderList, PartialEq, Display

**Functions defined:** new, eq, fmt, test_new_and_display, test_order_list_creation_with_mismatched_instrument_id, test_order_list_creation_with_empty_orders, test_order_list_equality, test_order_list_inequality
...
#### `test_new_and_display(audusd_sim: CurrencyPair)`


#### `test_order_list_creation_with_mismatched_instrument_id(audusd_sim: CurrencyPair)`


#### `test_order_list_creation_with_empty_orders(audusd_sim: CurrencyPair)`


#### `test_order_list_equality(audusd_sim: CurrencyPair)`


#### `test_order_list_inequality(audusd_sim: CurrencyPair)`
