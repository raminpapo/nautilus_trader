...
- **Path**: `crates/model/src/orders/mod.rs`
- **Size**: 46,061 bytes
- **Lines**: 1,197
- **Language**: Rust
...
This file is part of the NautilusTrader repository. It defines 138 function(s) and 1 class(es).

## Detailed Walkthrough

### Functions
- **`cancellable_order_statuses_set()`**: Function defined in this file
- **`ustr_indexmap_to_str()`**: Function defined in this file
- **`str_indexmap_to_ustr()`**: Function defined in this file
- **`check_display_qty()`**: Function defined in this file
- **`check_time_in_force()`**: Function defined in this file
- **`transition()`**: Function defined in this file
- **`into_any()`**: Function defined in this file
- **`status()`**: Function defined in this file
...
- **`position_id()`**: Function defined in this file
- **`account_id()`**: Function defined in this file
- **`last_trade_id()`**: Function defined in this file
- **`order_side()`**: Function defined in this file
- **`order_type()`**: Function defined in this file

*...and 118 more functions*

### Classes
- **`OrderCore`**: Class defined in this file


## Keywords and Identifiers

Total unique keywords extracted: 141


**Enums**: `OrderError`
**Functions**: `accepted`, `account_id`, `activation_price`, `apply`, `avg_px`, `cancel_rejected`, `canceled`, `cancellable_order_statuses_set`, `check_display_qty`, `check_time_in_force`, `client_order_id`, `closing_side`, `commission`, `commissions`, `commissions_vec`, `contingency_type`, `denied`, `display_qty`, `emulated`, `emulation_trigger`, `event_count`, `events`, `exec_algorithm_id`, `exec_algorithm_params`, `exec_spawn_id`, `expire_time`, `expired`, `filled`, `filled_qty`, `from` *(+105 more)*
**Impls**: `From`, `OrderCore`, `OrderStatus`
**Structs**: `OrderCore`
**Traits**: `Order`, `fn`
...
---
*Generated on 2025-11-18T21:55:02.871650Z*
