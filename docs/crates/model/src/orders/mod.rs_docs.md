# Documentation: `crates/model/src/orders/mod.rs`
**Generated:** 2025-11-15T19:40:02.904087Z
**File Size:** 46061 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/model/src/orders/mod.rs` within the repository.

**Classes defined:** OrderCore, OrderStatus, OrderCore

**Functions defined:** cancellable_order_statuses_set, ustr_indexmap_to_str, str_indexmap_to_ustr, check_display_qty, check_time_in_force, transition, into_any, status, trader_id, strategy_id and 128 more
...
#### `ustr_indexmap_to_str(h: IndexMap<Ustr, Ustr>)`


#### `str_indexmap_to_ustr(h: IndexMap<String, String>)`
...
#### `transition(&mut self, event: &OrderEventAny)`
