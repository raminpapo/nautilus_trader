# Documentation: limit_if_touched.rs

## File Metadata

- **Path**: `crates/model/src/orders/limit_if_touched.rs`
- **Size**: 25,622 bytes
- **Lines**: 825
- **Language**: Rust
...
### Classes
- **`LimitIfTouchedOrder`**: Class defined in this file


## Keywords and Identifiers

Total unique keywords extracted: 85


**Functions**: `account_id`, `apply`, `avg_px`, `client_order_id`, `commissions`, `contingency_type`, `deref`, `deref_mut`, `display_qty`, `emulation_trigger`, `events`, `exec_algorithm_id`, `exec_algorithm_params`, `exec_spawn_id`, `expire_time`, `filled_qty`, `fmt`, `from`, `has_price`, `init_id`, `instrument_id`, `into_any`, `is_post_only`, `is_quote_quantity`, `is_reduce_only`, `is_triggered`, `last_trade_id`, `leaves_qty`, `limit_offset`, `linked_order_ids` *(+49 more)*
**Impls**: `Deref`, `DerefMut`, `Display`, `From`, `LimitIfTouchedOrder`, `Order`
**Structs**: `LimitIfTouchedOrder`
...
---
*Generated on 2025-11-18T21:55:02.847055Z*
