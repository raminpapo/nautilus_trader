# Documentation: trailing_stop_limit.rs

## File Metadata

- **Path**: `crates/model/src/orders/trailing_stop_limit.rs`
- **Size**: 25,946 bytes
- **Lines**: 825
- **Language**: Rust
...
- **`has_activation_price()`**: Function defined in this file
- **`set_activated()`**: Function defined in this file
- **`deref()`**: Function defined in this file
- **`deref_mut()`**: Function defined in this file
- **`activation_price()`**: Function defined in this file
...
### Classes
- **`TrailingStopLimitOrder`**: Class defined in this file
...
**Functions**: `account_id`, `activation_price`, `apply`, `avg_px`, `client_order_id`, `commissions`, `contingency_type`, `deref`, `deref_mut`, `display_qty`, `emulation_trigger`, `events`, `exec_algorithm_id`, `exec_algorithm_params`, `exec_spawn_id`, `expire_time`, `filled_qty`, `fmt`, `from`, `has_activation_price`, `has_price`, `init_id`, `instrument_id`, `into_any`, `is_post_only`, `is_quote_quantity`, `is_reduce_only`, `is_triggered`, `last_trade_id`, `leaves_qty` *(+51 more)*
**Impls**: `Deref`, `DerefMut`, `Display`, `From`, `Order`, `TrailingStopLimitOrder`
**Structs**: `TrailingStopLimitOrder`
...
---
*Generated on 2025-11-18T21:55:02.891736Z*
