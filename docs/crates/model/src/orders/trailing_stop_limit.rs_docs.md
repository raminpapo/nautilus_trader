# Documentation: `crates/model/src/orders/trailing_stop_limit.rs`
**Generated:** 2025-11-15T19:40:02.916951Z
**File Size:** 25946 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/model/src/orders/trailing_stop_limit.rs` within the repository.

**Classes defined:** TrailingStopLimitOrder, TrailingStopLimitOrder, Deref, DerefMut, Order, Display, From

**Functions defined:** new_checked, new, has_activation_price, set_activated, deref, deref_mut, activation_price, into_any, status, trader_id and 71 more
