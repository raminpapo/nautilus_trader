# Documentation: `crates/model/src/ffi/data/deltas.rs`
**Generated:** 2025-11-15T19:40:02.696727Z
**File Size:** 3588 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/model/src/ffi/data/deltas.rs` within the repository.

**Functions defined:** orderbook_deltas_new, orderbook_deltas_drop, orderbook_deltas_clone, orderbook_deltas_instrument_id, orderbook_deltas_vec_deltas, orderbook_deltas_is_snapshot, orderbook_deltas_flags, orderbook_deltas_sequence, orderbook_deltas_ts_event, orderbook_deltas_ts_init and 1 more
...
#### `orderbook_deltas_drop(deltas: OrderBookDeltas_API)`


#### `orderbook_deltas_clone(deltas: &OrderBookDeltas_API)`


#### `orderbook_deltas_instrument_id(deltas: &OrderBookDeltas_API)`


#### `orderbook_deltas_vec_deltas(deltas: &OrderBookDeltas_API)`


#### `orderbook_deltas_is_snapshot(deltas: &OrderBookDeltas_API)`


#### `orderbook_deltas_flags(deltas: &OrderBookDeltas_API)`


#### `orderbook_deltas_sequence(deltas: &OrderBookDeltas_API)`


#### `orderbook_deltas_ts_event(deltas: &OrderBookDeltas_API)`


#### `orderbook_deltas_ts_init(deltas: &OrderBookDeltas_API)`


#### `orderbook_deltas_vec_drop(v: CVec)`
