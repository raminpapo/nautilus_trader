# Documentation: `crates/model/src/ffi/data/depth.rs`
**Generated:** 2025-11-15T19:40:02.698339Z
...
- **Path:** `crates/model/src/ffi/data/depth.rs`
- **Size:** 4,261 bytes
- **Lines:** 119
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/model/src/ffi/data/depth.rs` within the repository.

**Functions defined:** orderbook_depth10_new, orderbook_depth10_clone, orderbook_depth10_eq, orderbook_depth10_hash, orderbook_depth10_bids_array, orderbook_depth10_asks_array, orderbook_depth10_bid_counts_array, orderbook_depth10_ask_counts_array
...
#### `orderbook_depth10_clone(depth: &OrderBookDepth10)`


#### `orderbook_depth10_eq(lhs: &OrderBookDepth10, rhs: &OrderBookDepth10)`


#### `orderbook_depth10_hash(delta: &OrderBookDepth10)`


#### `orderbook_depth10_bids_array(depth: &OrderBookDepth10)`


#### `orderbook_depth10_asks_array(depth: &OrderBookDepth10)`


#### `orderbook_depth10_bid_counts_array(depth: &OrderBookDepth10)`


#### `orderbook_depth10_ask_counts_array(depth: &OrderBookDepth10)`
