# Documentation: `crates/model/src/ffi/data/bar.rs`
**Generated:** 2025-11-15T19:40:02.693978Z
...
This file is located at `crates/model/src/ffi/data/bar.rs` within the repository.

**Functions defined:** bar_specification_new, bar_specification_to_cstr, bar_specification_hash, bar_specification_eq, bar_specification_lt, bar_specification_le, bar_specification_gt, bar_specification_ge, bar_type_new, bar_type_new_composite and 20 more
...
#### `bar_specification_to_cstr(bar_spec: &BarSpecification)`


#### `bar_specification_hash(bar_spec: &BarSpecification)`


#### `bar_specification_eq(lhs: &BarSpecification, rhs: &BarSpecification)`


#### `bar_specification_lt(lhs: &BarSpecification, rhs: &BarSpecification)`


#### `bar_specification_le(lhs: &BarSpecification, rhs: &BarSpecification)`


#### `bar_specification_gt(lhs: &BarSpecification, rhs: &BarSpecification)`


#### `bar_specification_ge(lhs: &BarSpecification, rhs: &BarSpecification)`
...
#### `bar_type_is_standard(bar_type: &BarType)`


#### `bar_type_is_composite(bar_type: &BarType)`


#### `bar_type_standard(bar_type: &BarType)`


#### `bar_type_composite(bar_type: &BarType)`


#### `bar_type_instrument_id(bar_type: &BarType)`


#### `bar_type_spec(bar_type: &BarType)`


#### `bar_type_aggregation_source(bar_type: &BarType)`


#### `bar_type_check_parsing(ptr: *const c_char)`


#### `bar_type_from_cstr(ptr: *const c_char)`


#### `bar_type_eq(lhs: &BarType, rhs: &BarType)`


#### `bar_type_lt(lhs: &BarType, rhs: &BarType)`


#### `bar_type_le(lhs: &BarType, rhs: &BarType)`


#### `bar_type_gt(lhs: &BarType, rhs: &BarType)`


#### `bar_type_ge(lhs: &BarType, rhs: &BarType)`


#### `bar_type_hash(bar_type: &BarType)`


#### `bar_type_to_cstr(bar_type: &BarType)`
