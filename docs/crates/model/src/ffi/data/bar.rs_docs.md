...
- **Path**: `crates/model/src/ffi/data/bar.rs`
- **Size**: 7,261 bytes
- **Lines**: 266
- **Language**: Rust
...
### Functions
- **`bar_specification_new()`**: Function defined in this file
- **`bar_specification_to_cstr()`**: Function defined in this file
- **`bar_specification_hash()`**: Function defined in this file
- **`bar_specification_eq()`**: Function defined in this file
- **`bar_specification_lt()`**: Function defined in this file
- **`bar_specification_le()`**: Function defined in this file
- **`bar_specification_gt()`**: Function defined in this file
- **`bar_specification_ge()`**: Function defined in this file
- **`bar_type_new()`**: Function defined in this file
- **`bar_type_new_composite()`**: Function defined in this file
- **`bar_type_is_standard()`**: Function defined in this file
- **`bar_type_is_composite()`**: Function defined in this file
- **`bar_type_standard()`**: Function defined in this file
- **`bar_type_composite()`**: Function defined in this file
- **`bar_type_instrument_id()`**: Function defined in this file
- **`bar_type_spec()`**: Function defined in this file
- **`bar_type_aggregation_source()`**: Function defined in this file
- **`bar_type_check_parsing()`**: Function defined in this file
- **`bar_type_from_cstr()`**: Function defined in this file
- **`bar_type_eq()`**: Function defined in this file
...
**Enums**: `variant`, `variants`
**Functions**: `bar_eq`, `bar_hash`, `bar_new`, `bar_specification_eq`, `bar_specification_ge`, `bar_specification_gt`, `bar_specification_hash`, `bar_specification_le`, `bar_specification_lt`, `bar_specification_new`, `bar_specification_to_cstr`, `bar_to_cstr`, `bar_type_aggregation_source`, `bar_type_check_parsing`, `bar_type_composite`, `bar_type_eq`, `bar_type_from_cstr`, `bar_type_ge`, `bar_type_gt`, `bar_type_hash`, `bar_type_instrument_id`, `bar_type_is_composite`, `bar_type_is_standard`, `bar_type_le`, `bar_type_lt`, `bar_type_new`, `bar_type_new_composite`, `bar_type_spec`, `bar_type_standard`, `bar_type_to_cstr`
...
---
*Generated on 2025-11-18T21:55:02.550386Z*
