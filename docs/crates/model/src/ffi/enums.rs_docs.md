...
This file is part of the NautilusTrader repository. It defines 56 function(s).

## Detailed Walkthrough

### Functions
- **`account_type_to_cstr()`**: Function defined in this file
- **`account_type_from_cstr()`**: Function defined in this file
- **`aggregation_source_to_cstr()`**: Function defined in this file
- **`aggregation_source_from_cstr()`**: Function defined in this file
- **`aggressor_side_to_cstr()`**: Function defined in this file
- **`aggressor_side_from_cstr()`**: Function defined in this file
- **`asset_class_to_cstr()`**: Function defined in this file
- **`asset_class_from_cstr()`**: Function defined in this file
- **`instrument_class_to_cstr()`**: Function defined in this file
- **`instrument_class_from_cstr()`**: Function defined in this file
- **`bar_aggregation_to_cstr()`**: Function defined in this file
- **`bar_aggregation_from_cstr()`**: Function defined in this file
- **`book_action_to_cstr()`**: Function defined in this file
- **`book_action_from_cstr()`**: Function defined in this file
- **`book_type_to_cstr()`**: Function defined in this file
- **`book_type_from_cstr()`**: Function defined in this file
- **`contingency_type_to_cstr()`**: Function defined in this file
- **`contingency_type_from_cstr()`**: Function defined in this file
- **`currency_type_to_cstr()`**: Function defined in this file
- **`currency_type_from_cstr()`**: Function defined in this file
...
**Enums**: `from`, `string`
**Functions**: `account_type_from_cstr`, `account_type_to_cstr`, `aggregation_source_from_cstr`, `aggregation_source_to_cstr`, `aggressor_side_from_cstr`, `aggressor_side_to_cstr`, `asset_class_from_cstr`, `asset_class_to_cstr`, `bar_aggregation_from_cstr`, `bar_aggregation_to_cstr`, `book_action_from_cstr`, `book_action_to_cstr`, `book_type_from_cstr`, `book_type_to_cstr`, `contingency_type_from_cstr`, `contingency_type_to_cstr`, `currency_type_from_cstr`, `currency_type_to_cstr`, `instrument_class_from_cstr`, `instrument_class_to_cstr`, `instrument_close_type_from_cstr`, `instrument_close_type_to_cstr`, `liquidity_side_from_cstr`, `liquidity_side_to_cstr`, `market_status_action_from_cstr`, `market_status_action_to_cstr`, `market_status_from_cstr`, `market_status_to_cstr`, `oms_type_from_cstr`, `oms_type_to_cstr` *(+26 more)*

## Related Files

This file is located in `crates/model/src/ffi/`. Related files may include:
...
---
*Generated on 2025-11-18T21:55:02.573020Z*
