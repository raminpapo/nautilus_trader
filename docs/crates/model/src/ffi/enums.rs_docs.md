# Documentation: `crates/model/src/ffi/enums.rs`
**Generated:** 2025-11-15T19:40:02.708570Z
**File Size:** 19149 bytes
**Extension:** .rs
**Type:** text
...
- **Path:** `crates/model/src/ffi/enums.rs`
- **Size:** 19,149 bytes
- **Lines:** 620
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/model/src/ffi/enums.rs` within the repository.

**Functions defined:** account_type_to_cstr, account_type_from_cstr, aggregation_source_to_cstr, aggregation_source_from_cstr, aggressor_side_to_cstr, aggressor_side_from_cstr, asset_class_to_cstr, asset_class_from_cstr, instrument_class_to_cstr, instrument_class_from_cstr and 46 more
...
#### `account_type_to_cstr(value: AccountType)`


#### `account_type_from_cstr(ptr: *const c_char)`


#### `aggregation_source_to_cstr(value: AggregationSource)`


#### `aggregation_source_from_cstr(ptr: *const c_char)`


#### `aggressor_side_to_cstr(value: AggressorSide)`


#### `aggressor_side_from_cstr(ptr: *const c_char)`


#### `asset_class_to_cstr(value: AssetClass)`


#### `asset_class_from_cstr(ptr: *const c_char)`


#### `instrument_class_to_cstr(value: InstrumentClass)`


#### `instrument_class_from_cstr(ptr: *const c_char)`


#### `bar_aggregation_to_cstr(value: BarAggregation)`


#### `bar_aggregation_from_cstr(ptr: *const c_char)`


#### `book_action_to_cstr(value: BookAction)`


#### `book_action_from_cstr(ptr: *const c_char)`


#### `book_type_to_cstr(value: BookType)`


#### `book_type_from_cstr(ptr: *const c_char)`


#### `contingency_type_to_cstr(value: ContingencyType)`


#### `contingency_type_from_cstr(ptr: *const c_char)`


#### `currency_type_to_cstr(value: CurrencyType)`


#### `currency_type_from_cstr(ptr: *const c_char)`
...
#### `instrument_close_type_to_cstr(value: InstrumentCloseType)`


#### `liquidity_side_to_cstr(value: LiquiditySide)`


#### `liquidity_side_from_cstr(ptr: *const c_char)`


#### `market_status_to_cstr(value: MarketStatus)`


#### `market_status_from_cstr(ptr: *const c_char)`


#### `market_status_action_to_cstr(value: MarketStatusAction)`


#### `market_status_action_from_cstr(ptr: *const c_char)`


#### `oms_type_to_cstr(value: OmsType)`


#### `oms_type_from_cstr(ptr: *const c_char)`


#### `option_kind_to_cstr(value: OptionKind)`


#### `option_kind_from_cstr(ptr: *const c_char)`


#### `order_side_to_cstr(value: OrderSide)`


#### `order_side_from_cstr(ptr: *const c_char)`


#### `order_status_to_cstr(value: OrderStatus)`


#### `order_status_from_cstr(ptr: *const c_char)`


#### `order_type_to_cstr(value: OrderType)`


#### `order_type_from_cstr(ptr: *const c_char)`


#### `position_side_to_cstr(value: PositionSide)`


#### `position_side_from_cstr(ptr: *const c_char)`


#### `position_adjustment_type_to_cstr(value: PositionAdjustmentType)`
...
#### `price_type_to_cstr(value: PriceType)`


#### `price_type_from_cstr(ptr: *const c_char)`


#### `record_flag_to_cstr(value: RecordFlag)`


#### `record_flag_from_cstr(ptr: *const c_char)`


#### `time_in_force_to_cstr(value: TimeInForce)`


#### `time_in_force_from_cstr(ptr: *const c_char)`


#### `trading_state_to_cstr(value: TradingState)`


#### `trading_state_from_cstr(ptr: *const c_char)`
...
**Directory:** `crates/model/src/ffi`
