# Documentation: `crates/model/src/ffi/instruments/synthetic.rs`
**Generated:** 2025-11-15T19:40:02.735682Z
**File Size:** 6164 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/model/src/ffi/instruments/synthetic.rs` within the repository.

**Classes defined:** wraps, SyntheticInstrument_API, Deref, DerefMut

**Functions defined:** deref, deref_mut, synthetic_instrument_new, synthetic_instrument_drop, synthetic_instrument_id, synthetic_instrument_price_precision, synthetic_instrument_price_increment, synthetic_instrument_formula_to_cstr, synthetic_instrument_components_to_cstr, synthetic_instrument_components_count and 5 more
...
#### `synthetic_instrument_drop(synth: SyntheticInstrument_API)`


#### `synthetic_instrument_id(synth: &SyntheticInstrument_API)`


#### `synthetic_instrument_price_precision(synth: &SyntheticInstrument_API)`


#### `synthetic_instrument_price_increment(synth: &SyntheticInstrument_API)`
...
#### `synthetic_instrument_components_count(synth: &SyntheticInstrument_API)`


#### `synthetic_instrument_ts_event(synth: &SyntheticInstrument_API)`


#### `synthetic_instrument_ts_init(synth: &SyntheticInstrument_API)`
...
**Directory:** `crates/model/src/ffi/instruments`
