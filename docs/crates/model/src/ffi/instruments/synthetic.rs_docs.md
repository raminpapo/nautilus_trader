# Documentation: synthetic.rs

## File Metadata

- **Path**: `crates/model/src/ffi/instruments/synthetic.rs`
- **Size**: 6,164 bytes
- **Lines**: 203
- **Language**: Rust
...
- **`synthetic_instrument_new()`**: Function defined in this file
- **`synthetic_instrument_drop()`**: Function defined in this file
- **`synthetic_instrument_id()`**: Function defined in this file
- **`synthetic_instrument_price_precision()`**: Function defined in this file
- **`synthetic_instrument_price_increment()`**: Function defined in this file
- **`synthetic_instrument_formula_to_cstr()`**: Function defined in this file
- **`synthetic_instrument_components_to_cstr()`**: Function defined in this file
- **`synthetic_instrument_components_count()`**: Function defined in this file
- **`synthetic_instrument_ts_event()`**: Function defined in this file
- **`synthetic_instrument_ts_init()`**: Function defined in this file
- **`synthetic_instrument_is_valid_formula()`**: Function defined in this file
- **`synthetic_instrument_change_formula()`**: Function defined in this file
- **`synthetic_instrument_calculate()`**: Function defined in this file

### Classes
- **`wraps`**: Class defined in this file
- **`SyntheticInstrument_API`**: Class defined in this file
...
**Functions**: `deref`, `deref_mut`, `synthetic_instrument_calculate`, `synthetic_instrument_change_formula`, `synthetic_instrument_components_count`, `synthetic_instrument_components_to_cstr`, `synthetic_instrument_drop`, `synthetic_instrument_formula_to_cstr`, `synthetic_instrument_id`, `synthetic_instrument_is_valid_formula`, `synthetic_instrument_new`, `synthetic_instrument_price_increment`, `synthetic_instrument_price_precision`, `synthetic_instrument_ts_event`, `synthetic_instrument_ts_init`
**Impls**: `Deref`, `DerefMut`
**Structs**: `SyntheticInstrument_API`, `wraps`

## Related Files

This file is located in `crates/model/src/ffi/instruments/`. Related files may include:
...
---
*Generated on 2025-11-18T21:55:02.614705Z*
