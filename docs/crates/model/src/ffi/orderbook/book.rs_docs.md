...
This file is part of the NautilusTrader repository. It defines 37 function(s) and 2 class(es).
...
- **`orderbook_new()`**: Function defined in this file
- **`orderbook_drop()`**: Function defined in this file
- **`orderbook_reset()`**: Function defined in this file
- **`orderbook_instrument_id()`**: Function defined in this file
- **`orderbook_book_type()`**: Function defined in this file
- **`orderbook_sequence()`**: Function defined in this file
- **`orderbook_ts_last()`**: Function defined in this file
- **`orderbook_update_count()`**: Function defined in this file
- **`orderbook_add()`**: Function defined in this file
- **`orderbook_update()`**: Function defined in this file
- **`orderbook_delete()`**: Function defined in this file
- **`orderbook_clear()`**: Function defined in this file
- **`orderbook_clear_bids()`**: Function defined in this file
- **`orderbook_clear_asks()`**: Function defined in this file
- **`orderbook_apply_delta()`**: Function defined in this file
- **`orderbook_apply_deltas()`**: Function defined in this file
- **`orderbook_apply_depth()`**: Function defined in this file
- **`orderbook_bids()`**: Function defined in this file

*...and 17 more functions*

### Classes
- **`wraps`**: Class defined in this file
- **`OrderBook_API`**: Class defined in this file
...
**Functions**: `deref`, `deref_mut`, `orderbook_add`, `orderbook_apply_delta`, `orderbook_apply_deltas`, `orderbook_apply_depth`, `orderbook_asks`, `orderbook_best_ask_price`, `orderbook_best_ask_size`, `orderbook_best_bid_price`, `orderbook_best_bid_size`, `orderbook_bids`, `orderbook_book_type`, `orderbook_check_integrity`, `orderbook_clear`, `orderbook_clear_asks`, `orderbook_clear_bids`, `orderbook_delete`, `orderbook_drop`, `orderbook_get_avg_px_for_quantity`, `orderbook_get_quantity_for_price`, `orderbook_has_ask`, `orderbook_has_bid`, `orderbook_instrument_id`, `orderbook_midpoint`, `orderbook_new`, `orderbook_pprint_to_cstr`, `orderbook_reset`, `orderbook_sequence`, `orderbook_simulate_fills` *(+7 more)*
**Impls**: `Deref`, `DerefMut`
**Structs**: `OrderBook_API`, `wraps`
...
---
*Generated on 2025-11-18T21:55:02.620230Z*
