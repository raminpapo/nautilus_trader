# Documentation: `crates/model/src/ffi/orderbook/book.rs`
**Generated:** 2025-11-15T19:40:02.739456Z
...
- **Path:** `crates/model/src/ffi/orderbook/book.rs`
- **Size:** 10,000 bytes
- **Lines:** 330
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/model/src/ffi/orderbook/book.rs` within the repository.

**Classes defined:** wraps, OrderBook_API, Deref, DerefMut

**Functions defined:** deref, deref_mut, orderbook_new, orderbook_drop, orderbook_reset, orderbook_instrument_id, orderbook_book_type, orderbook_sequence, orderbook_ts_last, orderbook_update_count and 27 more
...
#### `orderbook_new(instrument_id: InstrumentId, book_type: BookType)`


#### `orderbook_drop(book: OrderBook_API)`


#### `orderbook_reset(book: &mut OrderBook_API)`


#### `orderbook_instrument_id(book: &OrderBook_API)`


#### `orderbook_book_type(book: &OrderBook_API)`


#### `orderbook_sequence(book: &OrderBook_API)`


#### `orderbook_ts_last(book: &OrderBook_API)`


#### `orderbook_update_count(book: &OrderBook_API)`
...
#### `orderbook_clear(book: &mut OrderBook_API, sequence: u64, ts_event: u64)`


#### `orderbook_clear_bids(book: &mut OrderBook_API, sequence: u64, ts_event: u64)`


#### `orderbook_clear_asks(book: &mut OrderBook_API, sequence: u64, ts_event: u64)`


#### `orderbook_apply_delta(book: &mut OrderBook_API, delta: &OrderBookDelta)`


#### `orderbook_apply_deltas(book: &mut OrderBook_API, deltas: &OrderBookDeltas_API)`


#### `orderbook_apply_depth(book: &mut OrderBook_API, depth: &OrderBookDepth10)`


#### `orderbook_bids(book: &mut OrderBook_API)`


#### `orderbook_asks(book: &mut OrderBook_API)`


#### `orderbook_has_bid(book: &mut OrderBook_API)`


#### `orderbook_has_ask(book: &mut OrderBook_API)`


#### `orderbook_best_bid_price(book: &mut OrderBook_API)`


#### `orderbook_best_ask_price(book: &mut OrderBook_API)`


#### `orderbook_best_bid_size(book: &mut OrderBook_API)`


#### `orderbook_best_ask_size(book: &mut OrderBook_API)`


#### `orderbook_spread(book: &mut OrderBook_API)`


#### `orderbook_midpoint(book: &mut OrderBook_API)`
...
#### `orderbook_update_quote_tick(book: &mut OrderBook_API, quote: &QuoteTick)`


#### `orderbook_update_trade_tick(book: &mut OrderBook_API, trade: &TradeTick)`


#### `orderbook_simulate_fills(book: &OrderBook_API, order: BookOrder)`


#### `orderbook_check_integrity(book: &OrderBook_API)`


#### `vec_drop_fills(v: CVec)`
