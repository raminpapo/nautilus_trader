...
### Functions
- **`money_new()`**: Function defined in this file
- **`money_from_raw()`**: Function defined in this file
- **`money_as_f64()`**: Function defined in this file
- **`money_add_assign()`**: Function defined in this file
- **`money_sub_assign()`**: Function defined in this file
...
**Functions**: `money_add_assign`, `money_as_f64`, `money_from_raw`, `money_new`, `money_sub_assign`
...
---
*Generated on 2025-11-18T21:55:02.630260Z*
