...
### Functions
- **`instrument_id_new()`**: Function defined in this file
- **`instrument_id_check_parsing()`**: Function defined in this file
- **`instrument_id_from_cstr()`**: Function defined in this file
- **`instrument_id_to_cstr()`**: Function defined in this file
- **`instrument_id_hash()`**: Function defined in this file
- **`instrument_id_is_synthetic()`**: Function defined in this file
- **`btc_usdt_perp_binance()`**: Function defined in this file
- **`audusd_sim()`**: Function defined in this file
- **`test_to_cstr()`**: Function defined in this file
- **`test_to_cstr_and_back()`**: Function defined in this file
- **`test_from_symbol_and_back()`**: Function defined in this file
...
**Functions**: `audusd_sim`, `btc_usdt_perp_binance`, `instrument_id_check_parsing`, `instrument_id_from_cstr`, `instrument_id_hash`, `instrument_id_is_synthetic`, `instrument_id_new`, `instrument_id_to_cstr`, `test_from_symbol_and_back`, `test_to_cstr`, `test_to_cstr_and_back`
...
---
*Generated on 2025-11-18T21:55:02.593400Z*
