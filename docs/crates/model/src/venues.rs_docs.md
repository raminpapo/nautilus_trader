# Documentation: venues.rs

## File Metadata

- **Path**: `crates/model/src/venues.rs`
- **Size**: 10,867 bytes
- **Lines**: 309
- **Language**: Rust
...
### Functions
- **`CBCM()`**: Function defined in this file
- **`GLBX()`**: Function defined in this file
- **`NYUM()`**: Function defined in this file
- **`XCBT()`**: Function defined in this file
- **`XCEC()`**: Function defined in this file
- **`XCME()`**: Function defined in this file
- **`XFXS()`**: Function defined in this file
- **`XNYM()`**: Function defined in this file
- **`test_venue_constants()`**: Function defined in this file
- **`test_venue_constants_uniqueness()`**: Function defined in this file
- **`test_venue_map_contains_all_venues()`**: Function defined in this file
- **`test_venue_map_values_match_constants()`**: Function defined in this file
- **`test_venue_map_lookup_nonexistent()`**: Function defined in this file
- **`test_venue_constants_lazy_initialization()`**: Function defined in this file
- **`test_all_venue_strings()`**: Function defined in this file
- **`test_venue_constants_thread_safety()`**: Function defined in this file
- **`test_venue_map_thread_safety()`**: Function defined in this file
...
**Functions**: `CBCM`, `GLBX`, `NYUM`, `XCBT`, `XCEC`, `XCME`, `XFXS`, `XNYM`, `test_all_venue_strings`, `test_venue_constants`, `test_venue_constants_lazy_initialization`, `test_venue_constants_thread_safety`, `test_venue_constants_uniqueness`, `test_venue_map_contains_all_venues`, `test_venue_map_lookup_nonexistent`, `test_venue_map_thread_safety`, `test_venue_map_values_match_constants`
**Impls**: `Venue`
...
---
*Generated on 2025-11-18T21:55:03.312884Z*
