...
- **`from_code()`**: Function defined in this file
- **`synthetic()`**: Function defined in this file
- **`is_synthetic()`**: Function defined in this file
- **`is_dex()`**: Function defined in this file
- **`parse_dex()`**: Function defined in this file
- **`fmt()`**: Function defined in this file
- **`fmt()`**: Function defined in this file
- **`validate_blockchain_venue()`**: Function defined in this file
- **`test_string_reprs()`**: Function defined in this file
- **`test_blockchain_venue_valid_dex_names()`**: Function defined in this file
- **`test_blockchain_venue_invalid_chain()`**: Function defined in this file
- **`test_blockchain_venue_empty_dex()`**: Function defined in this file
- **`test_regular_venue_with_blockchain_like_name_but_without_dex()`**: Function defined in this file

*...and 6 more functions*

### Classes
- **`Venue`**: Class defined in this file
...
**Enums**: `let`
**Functions**: `as_str`, `fmt`, `from_code`, `from_str_unchecked`, `from_ustr_unchecked`, `inner`, `is_dex`, `is_synthetic`, `new`, `new_checked`, `parse_dex`, `set_inner`, `synthetic`, `test_blockchain_venue_dex_case_sensitive`, `test_blockchain_venue_empty_dex`, `test_blockchain_venue_invalid_chain`, `test_blockchain_venue_invalid_dex`, `test_blockchain_venue_valid_dex_names`, `test_blockchain_venue_various_chain_dex_combinations`, `test_parse_dex_invalid_components`, `test_parse_dex_non_dex_venue`, `test_parse_dex_valid`, `test_regular_venue_with_blockchain_like_name_but_without_dex`, `test_string_reprs`, `validate_blockchain_venue`
**Impls**: `Debug`, `Display`, `Venue`
**Structs**: `Venue`
...
---
*Generated on 2025-11-18T21:55:02.675840Z*
