...
- **`from_bytes()`**: Function defined in this file
- **`as_cstr()`**: Function defined in this file
- **`fmt()`**: Function defined in this file
- **`fmt()`**: Function defined in this file
- **`serialize()`**: Function defined in this file
- **`deserialize()`**: Function defined in this file
- **`test_trade_id_new_valid()`**: Function defined in this file
- **`test_trade_id_new_invalid_length()`**: Function defined in this file
- **`test_trade_id_from_valid_bytes()`**: Function defined in this file
- **`test_trade_id_from_bytes_empty()`**: Function defined in this file
- **`test_trade_id_single_null_byte()`**: Function defined in this file
- **`test_trade_id_exceeds_max_length()`**: Function defined in this file
- **`test_trade_id_with_null_terminator_at_max_length()`**: Function defined in this file
- **`test_trade_id_as_cstr()`**: Function defined in this file
- **`test_trade_id_equality()`**: Function defined in this file
- **`test_string_reprs()`**: Function defined in this file
- **`test_trade_id_ordering()`**: Function defined in this file
- **`test_trade_id_serialization()`**: Function defined in this file

### Classes
- **`TradeId`**: Class defined in this file
...
**Functions**: `as_cstr`, `deserialize`, `fmt`, `from_bytes`, `new`, `new_checked`, `serialize`, `test_string_reprs`, `test_trade_id_as_cstr`, `test_trade_id_equality`, `test_trade_id_exceeds_max_length`, `test_trade_id_from_bytes_empty`, `test_trade_id_from_valid_bytes`, `test_trade_id_new_invalid_length`, `test_trade_id_new_valid`, `test_trade_id_ordering`, `test_trade_id_serialization`, `test_trade_id_single_null_byte`, `test_trade_id_with_null_terminator_at_max_length`
**Impls**: `Debug`, `Deserialize`, `Display`, `Serialize`, `TradeId`
**Structs**: `TradeId`
...
---
*Generated on 2025-11-18T21:55:02.670649Z*
