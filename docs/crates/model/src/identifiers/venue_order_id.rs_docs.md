# Documentation: `crates/model/src/identifiers/venue_order_id.rs`
**Generated:** 2025-11-15T19:40:02.781044Z
...
- **Path:** `crates/model/src/identifiers/venue_order_id.rs`
- **Size:** 3,238 bytes
- **Lines:** 101
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/model/src/identifiers/venue_order_id.rs` within the repository.

**Classes defined:** VenueOrderId, VenueOrderId, Debug, Display
...
#### `test_string_reprs(venue_order_id: VenueOrderId)`
