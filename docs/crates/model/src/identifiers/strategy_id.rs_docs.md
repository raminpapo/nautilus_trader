...
- **`external()`**: Function defined in this file
- **`is_external()`**: Function defined in this file
- **`get_tag()`**: Function defined in this file
- **`fmt()`**: Function defined in this file
- **`fmt()`**: Function defined in this file
- **`test_string_reprs()`**: Function defined in this file
- **`test_get_external()`**: Function defined in this file
- **`test_is_external()`**: Function defined in this file
- **`test_get_tag()`**: Function defined in this file

### Classes
- **`StrategyId`**: Class defined in this file
...
**Functions**: `as_str`, `external`, `fmt`, `get_tag`, `inner`, `is_external`, `new`, `new_checked`, `set_inner`, `test_get_external`, `test_get_tag`, `test_is_external`, `test_string_reprs`
**Impls**: `Debug`, `Display`, `StrategyId`
**Structs**: `StrategyId`
...
---
*Generated on 2025-11-18T21:55:02.662895Z*
