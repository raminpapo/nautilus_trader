# Documentation: `crates/model/src/identifiers/exec_algorithm_id.rs`
**Generated:** 2025-11-15T19:40:02.760435Z
...
- **Path:** `crates/model/src/identifiers/exec_algorithm_id.rs`
- **Size:** 3,341 bytes
- **Lines:** 106
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/model/src/identifiers/exec_algorithm_id.rs` within the repository.

**Classes defined:** ExecAlgorithmId, ExecAlgorithmId, Debug, Display

**Functions defined:** set_inner, inner, as_str, fmt, fmt, test_string_reprs
...
#### `test_string_reprs(exec_algorithm_id: ExecAlgorithmId)`
