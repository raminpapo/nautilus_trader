# Documentation: `crates/model/src/identifiers/instrument_id.rs`
**Generated:** 2025-11-15T19:40:02.762716Z
...
This file is located at `crates/model/src/identifiers/instrument_id.rs` within the repository.

**Classes defined:** InstrumentId, InstrumentId, InstrumentId, FromStr, From, From, Debug, Display, Serialize

**Functions defined:** new, is_synthetic, blockchain, from_str, from, from, fmt, fmt, serialize, deserialize and 15 more
...
#### `err_message(s: &str, e: String)`


#### `test_instrument_id_parse_success(instrument_id_eth_usdt_binance: InstrumentId)`
