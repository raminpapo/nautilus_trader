...
- **Path**: `crates/model/src/identifiers/instrument_id.rs`
- **Size**: 10,629 bytes
- **Lines**: 314
- **Language**: Rust
...
- **`is_synthetic()`**: Function defined in this file
- **`from_as_ref()`**: Function defined in this file
...
- **`err_message()`**: Function defined in this file
- **`test_instrument_id_parse_success()`**: Function defined in this file
- **`test_instrument_id_parse_failure_no_dot()`**: Function defined in this file
...
- **`test_blockchain_instrument_id_valid()`**: Function defined in this file
- **`test_blockchain_instrument_id_invalid_chain()`**: Function defined in this file
- **`test_blockchain_instrument_id_empty_dex()`**: Function defined in this file
- **`test_regular_venue_with_blockchain_like_name_but_without_dex()`**: Function defined in this file

*...and 6 more functions*

### Classes
- **`InstrumentId`**: Class defined in this file
...
**Functions**: `blockchain`, `deserialize`, `err_message`, `fmt`, `from`, `from_as_ref`, `from_str`, `is_synthetic`, `new`, `serialize`, `test_blockchain_extraction_tradifi_venue`, `test_blockchain_extraction_valid_dex`, `test_blockchain_instrument_id_empty_dex`, `test_blockchain_instrument_id_invalid_address_checksum`, `test_blockchain_instrument_id_invalid_address_no_prefix`, `test_blockchain_instrument_id_invalid_address_non_hex`, `test_blockchain_instrument_id_invalid_address_short`, `test_blockchain_instrument_id_invalid_chain`, `test_blockchain_instrument_id_valid`, `test_instrument_id_from_str_with_utf8_symbol`, `test_instrument_id_parse_failure_no_dot`, `test_instrument_id_parse_success`, `test_regular_venue_with_blockchain_like_name_but_without_dex`, `test_string_reprs`
**Impls**: `Debug`, `Deserialize`, `Display`, `From`, `FromStr`, `InstrumentId`, `Serialize`
**Structs**: `InstrumentId`
...
---
*Generated on 2025-11-18T21:55:02.652404Z*
