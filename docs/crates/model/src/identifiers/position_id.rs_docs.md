...
**Functions**: `as_str`, `fmt`, `inner`, `is_virtual`, `new`, `new_checked`, `set_inner`, `test_string_reprs`
**Impls**: `Debug`, `Display`, `PositionId`
**Structs**: `PositionId`
...
---
*Generated on 2025-11-18T21:55:02.660666Z*
