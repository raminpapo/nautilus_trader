# Documentation: `crates/model/src/identifiers/symbol.rs`
**Generated:** 2025-11-15T19:40:02.773431Z
...
This file is located at `crates/model/src/identifiers/symbol.rs` within the repository.

**Classes defined:** Symbol, Symbol, Debug, Display, From

**Functions defined:** set_inner, from_ustr_unchecked, inner, as_str, is_composite, root, topic, fmt, fmt, from and 5 more
...
#### `test_string_reprs(symbol_eth_perp: Symbol)`


#### `test_symbol_is_composite(#[case] input: &str, #[case] expected: bool)`


#### `test_symbol_root(#[case] input: &str, #[case] expected_root: &str)`


#### `test_symbol_topic(#[case] input: &str, #[case] expected_topic: &str)`


#### `test_symbol_with_invalid_values(#[case] input: &str)`
