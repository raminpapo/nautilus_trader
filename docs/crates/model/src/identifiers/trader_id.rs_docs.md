# Documentation: `crates/model/src/identifiers/trader_id.rs`
**Generated:** 2025-11-15T19:40:02.777188Z
...
This file is located at `crates/model/src/identifiers/trader_id.rs` within the repository.

**Classes defined:** TraderId, TraderId, Debug, Display

**Functions defined:** set_inner, inner, as_str, get_tag, fmt, fmt, test_string_reprs, test_get_tag
...
#### `test_string_reprs(trader_id: TraderId)`


#### `test_get_tag(trader_id: TraderId)`
