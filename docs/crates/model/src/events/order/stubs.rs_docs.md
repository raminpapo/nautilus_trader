...
- **Path**: `crates/model/src/events/order/stubs.rs`
- **Size**: 10,845 bytes
- **Lines**: 419
- **Language**: Rust
...
### Functions
- **`order_filled()`**: Function defined in this file
- **`order_denied_max_submitted_rate()`**: Function defined in this file
- **`order_rejected_insufficient_margin()`**: Function defined in this file
- **`order_initialized_buy_limit()`**: Function defined in this file
- **`order_submitted()`**: Function defined in this file
- **`order_triggered()`**: Function defined in this file
- **`order_emulated()`**: Function defined in this file
- **`order_released()`**: Function defined in this file
- **`order_updated()`**: Function defined in this file
- **`order_pending_update()`**: Function defined in this file
- **`order_pending_cancel()`**: Function defined in this file
- **`order_modify_rejected()`**: Function defined in this file
- **`order_accepted()`**: Function defined in this file
- **`order_cancel_rejected()`**: Function defined in this file
- **`order_expired()`**: Function defined in this file
...
**Functions**: `order_accepted`, `order_cancel_rejected`, `order_denied_max_submitted_rate`, `order_emulated`, `order_expired`, `order_filled`, `order_initialized_buy_limit`, `order_modify_rejected`, `order_pending_cancel`, `order_pending_update`, `order_rejected_insufficient_margin`, `order_released`, `order_submitted`, `order_triggered`, `order_updated`
...
---
*Generated on 2025-11-18T21:55:02.513658Z*
