# Documentation: `crates/model/src/events/order/pending_cancel.rs`
**Generated:** 2025-11-15T19:40:02.653986Z
...
- **Path:** `crates/model/src/events/order/pending_cancel.rs`
- **Size:** 8,672 bytes
- **Lines:** 328
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/model/src/events/order/pending_cancel.rs` within the repository.

**Classes defined:** OrderPendingCancel, OrderPendingCancel, Debug, Display, OrderEvent
...
#### `test_order_pending_cancel_display(order_pending_cancel: OrderPendingCancel)`
