# Documentation: `crates/model/src/events/order/triggered.rs`
**Generated:** 2025-11-15T19:40:02.671573Z
...
- **Path:** `crates/model/src/events/order/triggered.rs`
- **Size:** 8,797 bytes
- **Lines:** 332
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/model/src/events/order/triggered.rs` within the repository.

**Classes defined:** OrderTriggered, OrderTriggered, Debug, Display, OrderEvent
...
#### `test_order_triggered_display(order_triggered: OrderTriggered)`
