# Documentation: `crates/model/src/events/order/filled.rs`
**Generated:** 2025-11-15T19:40:02.644071Z
**File Size:** 23170 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/model/src/events/order/filled.rs` within the repository.

**Classes defined:** OrderFilled, OrderFilled, Default, Debug, Display, OrderEvent

**Functions defined:** new, specified_side, is_buy, is_sell, default, fmt, fmt, id, kind, order_type and 59 more
