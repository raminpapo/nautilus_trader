# Documentation: filled.rs

## File Metadata

- **Path**: `crates/model/src/events/order/filled.rs`
- **Size**: 23,170 bytes
- **Lines**: 737
- **Language**: Rust
...
This file is part of the NautilusTrader repository. It defines 69 function(s) and 1 class(es).

## Detailed Walkthrough

### Functions
- **`new()`**: Function defined in this file
- **`specified_side()`**: Function defined in this file
- **`is_buy()`**: Function defined in this file
- **`is_sell()`**: Function defined in this file
...
### Classes
- **`OrderFilled`**: Class defined in this file
...
**Functions**: `account_id`, `client_order_id`, `commission`, `contingency_type`, `create_test_order_filled`, `currency`, `default`, `display_qty`, `emulation_trigger`, `exec_algorithm_id`, `exec_spawn_id`, `expire_time`, `fmt`, `id`, `instrument_id`, `is_buy`, `is_sell`, `kind`, `last_px`, `last_qty`, `limit_offset`, `linked_order_ids`, `liquidity_side`, `new`, `order_list_id`, `order_side`, `order_type`, `parent_order_id`, `position_id`, `post_only` *(+38 more)*
**Impls**: `Debug`, `Default`, `Display`, `OrderEvent`, `OrderFilled`
**Structs**: `OrderFilled`
...
---
*Generated on 2025-11-18T21:55:02.483647Z*
