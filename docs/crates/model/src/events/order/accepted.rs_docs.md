# Documentation: `crates/model/src/events/order/accepted.rs`
**Generated:** 2025-11-15T19:40:02.626833Z
**File Size:** 15822 bytes
**Extension:** .rs
**Type:** text
...
- **Path:** `crates/model/src/events/order/accepted.rs`
- **Size:** 15,822 bytes
- **Lines:** 514
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/model/src/events/order/accepted.rs` within the repository.

**Classes defined:** OrderAccepted, OrderAccepted, Debug, Display, OrderEvent

**Functions defined:** new, fmt, fmt, id, kind, order_type, order_side, trader_id, strategy_id, instrument_id and 48 more
...
#### `test_order_accepted_display(order_accepted: OrderAccepted)`
