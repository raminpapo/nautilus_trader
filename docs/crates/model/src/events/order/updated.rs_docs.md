# Documentation: `crates/model/src/events/order/updated.rs`
**Generated:** 2025-11-15T19:40:02.674294Z
**File Size:** 10321 bytes
**Extension:** .rs
**Type:** text
...
- **Path:** `crates/model/src/events/order/updated.rs`
- **Size:** 10,321 bytes
- **Lines:** 363
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/model/src/events/order/updated.rs` within the repository.

**Classes defined:** OrderUpdated, OrderUpdated, Debug, Display, OrderEvent
...
#### `test_order_updated_display(order_updated: OrderUpdated)`
