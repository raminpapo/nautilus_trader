# Documentation: `crates/model/src/events/order/modify_rejected.rs`
**Generated:** 2025-11-15T19:40:02.651529Z
...
- **Path:** `crates/model/src/events/order/modify_rejected.rs`
- **Size:** 9,109 bytes
- **Lines:** 337
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/model/src/events/order/modify_rejected.rs` within the repository.

**Classes defined:** OrderModifyRejected, OrderModifyRejected, Debug, Display, OrderEvent

**Functions defined:** new, fmt, fmt, id, kind, order_type, order_side, trader_id, strategy_id, instrument_id and 36 more
...
#### `test_order_modified_rejected(order_modify_rejected: OrderModifyRejected)`
