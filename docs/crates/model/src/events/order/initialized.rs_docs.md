# Documentation: `crates/model/src/events/order/initialized.rs`
**Generated:** 2025-11-15T19:40:02.647332Z
**File Size:** 20633 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/model/src/events/order/initialized.rs` within the repository.

**Classes defined:** OrderInitialized, Default, OrderInitialized, Debug, Display, OrderEvent, From

**Functions defined:** default, new, fmt, fmt, id, kind, order_type, order_side, trader_id, strategy_id and 38 more
...
#### `from(order: OrderInitialized)`


#### `test_order_initialized(order_initialized_buy_limit: OrderInitialized)`
