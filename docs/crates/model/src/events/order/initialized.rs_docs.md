# Documentation: initialized.rs

## File Metadata

- **Path**: `crates/model/src/events/order/initialized.rs`
- **Size**: 20,633 bytes
- **Lines**: 622
- **Language**: Rust
...
This file is part of the NautilusTrader repository. It defines 48 function(s) and 1 class(es).
...
### Classes
- **`OrderInitialized`**: Class defined in this file
...
**Functions**: `account_id`, `client_order_id`, `commission`, `contingency_type`, `currency`, `default`, `display_qty`, `emulation_trigger`, `exec_algorithm_id`, `exec_spawn_id`, `expire_time`, `fmt`, `from`, `id`, `instrument_id`, `kind`, `last_px`, `last_qty`, `limit_offset`, `linked_order_ids`, `liquidity_side`, `new`, `order_list_id`, `order_side`, `order_type`, `parent_order_id`, `position_id`, `post_only`, `price`, `quantity` *(+17 more)*
**Impls**: `Debug`, `Default`, `Display`, `From`, `OrderEvent`, `OrderInitialized`
**Structs**: `OrderInitialized`
...
---
*Generated on 2025-11-18T21:55:02.487962Z*
