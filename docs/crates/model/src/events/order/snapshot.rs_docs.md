# Documentation: `crates/model/src/events/order/snapshot.rs`
**Generated:** 2025-11-15T19:40:02.664261Z
**File Size:** 7509 bytes
**Extension:** .rs
**Type:** text
...
- **Path:** `crates/model/src/events/order/snapshot.rs`
- **Size:** 7,509 bytes
- **Lines:** 175
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/model/src/events/order/snapshot.rs` within the repository.

**Classes defined:** OrderSnapshot, From
