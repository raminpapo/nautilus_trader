# Documentation: `crates/model/src/events/order/released.rs`
**Generated:** 2025-11-15T19:40:02.662241Z
**File Size:** 7638 bytes
**Extension:** .rs
**Type:** text
...
- **Path:** `crates/model/src/events/order/released.rs`
- **Size:** 7,638 bytes
- **Lines:** 306
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/model/src/events/order/released.rs` within the repository.

**Classes defined:** OrderReleased, OrderReleased, Debug, Display, OrderEvent
...
#### `test_order_released_display(order_released: OrderReleased)`
