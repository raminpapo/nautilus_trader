# Documentation: `crates/model/src/events/order/pending_update.rs`
**Generated:** 2025-11-15T19:40:02.656491Z
...
- **Path:** `crates/model/src/events/order/pending_update.rs`
- **Size:** 8,691 bytes
- **Lines:** 328
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/model/src/events/order/pending_update.rs` within the repository.

**Classes defined:** OrderPendingUpdate, OrderPendingUpdate, Debug, Display, OrderEvent
...
#### `test_order_pending_update_display(order_pending_update: OrderPendingUpdate)`
