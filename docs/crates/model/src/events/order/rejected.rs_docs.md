# Documentation: `crates/model/src/events/order/rejected.rs`
**Generated:** 2025-11-15T19:40:02.659628Z
**File Size:** 17816 bytes
**Extension:** .rs
**Type:** text
...
- **Path:** `crates/model/src/events/order/rejected.rs`
- **Size:** 17,816 bytes
- **Lines:** 570
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/model/src/events/order/rejected.rs` within the repository.

**Classes defined:** OrderRejected, OrderRejected, Debug, Display, OrderEvent

**Functions defined:** new, fmt, fmt, id, kind, order_type, order_side, trader_id, strategy_id, instrument_id and 50 more
