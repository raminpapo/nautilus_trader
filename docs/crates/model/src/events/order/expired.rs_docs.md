# Documentation: `crates/model/src/events/order/expired.rs`
**Generated:** 2025-11-15T19:40:02.640778Z
**File Size:** 8734 bytes
**Extension:** .rs
**Type:** text
...
- **Path:** `crates/model/src/events/order/expired.rs`
- **Size:** 8,734 bytes
- **Lines:** 330
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/model/src/events/order/expired.rs` within the repository.

**Classes defined:** OrderExpired, OrderExpired, Debug, Display, OrderEvent
...
#### `test_order_cancel_rejected(order_expired: OrderExpired)`
