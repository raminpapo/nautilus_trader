# Documentation: `crates/model/src/events/order/canceled.rs`
**Generated:** 2025-11-15T19:40:02.633928Z
...
- **Path:** `crates/model/src/events/order/canceled.rs`
- **Size:** 8,313 bytes
- **Lines:** 316
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/model/src/events/order/canceled.rs` within the repository.

**Classes defined:** OrderCanceled, OrderCanceled, Debug, Display, OrderEvent

**Functions defined:** new, fmt, fmt, id, kind, order_type, order_side, trader_id, strategy_id, instrument_id and 35 more
