# Documentation: `crates/model/src/events/order/emulated.rs`
**Generated:** 2025-11-15T19:40:02.638341Z
**File Size:** 7353 bytes
**Extension:** .rs
**Type:** text
...
- **Path:** `crates/model/src/events/order/emulated.rs`
- **Size:** 7,353 bytes
- **Lines:** 302
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/model/src/events/order/emulated.rs` within the repository.

**Classes defined:** OrderEmulated, OrderEmulated, Debug, Display, OrderEvent
...
#### `test_order_emulated(order_emulated: OrderEmulated)`
