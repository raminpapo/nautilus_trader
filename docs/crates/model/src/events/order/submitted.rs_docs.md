# Documentation: `crates/model/src/events/order/submitted.rs`
**Generated:** 2025-11-15T19:40:02.669094Z
**File Size:** 14920 bytes
**Extension:** .rs
**Type:** text
...
- **Path:** `crates/model/src/events/order/submitted.rs`
- **Size:** 14,920 bytes
- **Lines:** 495
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/model/src/events/order/submitted.rs` within the repository.

**Classes defined:** OrderSubmitted, OrderSubmitted, Debug, Display, OrderEvent
...
#### `test_order_rejected_display(order_submitted: OrderSubmitted)`
