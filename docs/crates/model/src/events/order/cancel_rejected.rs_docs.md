# Documentation: `crates/model/src/events/order/cancel_rejected.rs`
**Generated:** 2025-11-15T19:40:02.631632Z
...
- **Path:** `crates/model/src/events/order/cancel_rejected.rs`
- **Size:** 9,101 bytes
- **Lines:** 337
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/model/src/events/order/cancel_rejected.rs` within the repository.

**Classes defined:** OrderCancelRejected, OrderCancelRejected, Debug, Display, OrderEvent
...
#### `test_order_cancel_rejected(order_cancel_rejected: OrderCancelRejected)`
