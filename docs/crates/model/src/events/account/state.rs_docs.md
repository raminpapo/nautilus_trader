# Documentation: `crates/model/src/events/account/state.rs`
**Generated:** 2025-11-15T19:40:02.618417Z
...
This file is located at `crates/model/src/events/account/state.rs` within the repository.

**Classes defined:** AccountState, AccountState, Display, PartialEq

**Functions defined:** new, has_same_balances_and_margins, fmt, eq, test_equality, test_display_cash_account_state, test_display_margin_account_state, test_has_same_balances_and_margins_when_identical, test_has_same_balances_and_margins_when_different_balance_amounts, test_has_same_balances_and_margins_when_different_balance_currencies and 6 more
...
#### `has_same_balances_and_margins(&self, other: &Self)`
...
#### `test_display_cash_account_state(cash_account_state: AccountState)`


#### `test_display_margin_account_state(margin_account_state: AccountState)`
