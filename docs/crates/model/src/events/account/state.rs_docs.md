# Documentation: state.rs

## File Metadata

- **Path**: `crates/model/src/events/account/state.rs`
- **Size**: 15,200 bytes
- **Lines**: 440
- **Language**: Rust
...
- **`has_same_balances_and_margins()`**: Function defined in this file
- **`fmt()`**: Function defined in this file
- **`eq()`**: Function defined in this file
- **`test_equality()`**: Function defined in this file
- **`test_display_cash_account_state()`**: Function defined in this file
- **`test_display_margin_account_state()`**: Function defined in this file
- **`test_has_same_balances_and_margins_when_identical()`**: Function defined in this file
- **`test_has_same_balances_and_margins_when_different_balance_amounts()`**: Function defined in this file
- **`test_has_same_balances_and_margins_when_different_balance_currencies()`**: Function defined in this file
- **`test_has_same_balances_and_margins_when_missing_balance()`**: Function defined in this file
- **`test_has_same_balances_and_margins_when_different_margin_amounts()`**: Function defined in this file
- **`test_has_same_balances_and_margins_when_different_margin_instruments()`**: Function defined in this file
- **`test_has_same_balances_and_margins_when_missing_margin()`**: Function defined in this file
- **`test_has_same_balances_and_margins_with_empty_collections()`**: Function defined in this file
- **`test_has_same_balances_and_margins_with_multiple_balances_and_margins()`**: Function defined in this file

### Classes
- **`AccountState`**: Class defined in this file
...
**Functions**: `eq`, `fmt`, `has_same_balances_and_margins`, `new`, `test_display_cash_account_state`, `test_display_margin_account_state`, `test_equality`, `test_has_same_balances_and_margins_when_different_balance_amounts`, `test_has_same_balances_and_margins_when_different_balance_currencies`, `test_has_same_balances_and_margins_when_different_margin_amounts`, `test_has_same_balances_and_margins_when_different_margin_instruments`, `test_has_same_balances_and_margins_when_identical`, `test_has_same_balances_and_margins_when_missing_balance`, `test_has_same_balances_and_margins_when_missing_margin`, `test_has_same_balances_and_margins_with_empty_collections`, `test_has_same_balances_and_margins_with_multiple_balances_and_margins`
**Impls**: `AccountState`, `Display`, `PartialEq`
**Structs**: `AccountState`
...
---
*Generated on 2025-11-18T21:55:02.451643Z*
