# Documentation: closed.rs

## File Metadata

- **Path**: `crates/model/src/events/position/closed.rs`
- **Size**: 19,236 bytes
- **Lines**: 487
- **Language**: Rust
...
This file is part of the NautilusTrader repository. It defines 20 function(s) and 1 class(es).

## Detailed Walkthrough

### Functions
- **`create()`**: Function defined in this file
- **`create_test_position_closed()`**: Function defined in this file
- **`create_test_order_filled()`**: Function defined in this file
- **`test_position_closed_new()`**: Function defined in this file
- **`test_position_closed_create()`**: Function defined in this file
- **`test_position_closed_clone()`**: Function defined in this file
- **`test_position_closed_debug()`**: Function defined in this file
- **`test_position_closed_partial_eq()`**: Function defined in this file
- **`test_position_closed_flat_position()`**: Function defined in this file
- **`test_position_closed_with_closing_order_id()`**: Function defined in this file
- **`test_position_closed_without_closing_order_id()`**: Function defined in this file
- **`test_position_closed_with_realized_pnl()`**: Function defined in this file
- **`test_position_closed_loss_scenario()`**: Function defined in this file
- **`test_position_closed_duration()`**: Function defined in this file
- **`test_position_closed_timestamps()`**: Function defined in this file
- **`test_position_closed_peak_quantity()`**: Function defined in this file
- **`test_position_closed_different_currencies()`**: Function defined in this file
- **`test_position_closed_entry_sides()`**: Function defined in this file
- **`test_position_closed_prices()`**: Function defined in this file
- **`test_position_closed_without_ts_closed()`**: Function defined in this file

### Classes
- **`PositionClosed`**: Class defined in this file
...
**Functions**: `create`, `create_test_order_filled`, `create_test_position_closed`, `test_position_closed_clone`, `test_position_closed_create`, `test_position_closed_debug`, `test_position_closed_different_currencies`, `test_position_closed_duration`, `test_position_closed_entry_sides`, `test_position_closed_flat_position`, `test_position_closed_loss_scenario`, `test_position_closed_new`, `test_position_closed_partial_eq`, `test_position_closed_peak_quantity`, `test_position_closed_prices`, `test_position_closed_timestamps`, `test_position_closed_with_closing_order_id`, `test_position_closed_with_realized_pnl`, `test_position_closed_without_closing_order_id`, `test_position_closed_without_ts_closed`
**Impls**: `PositionClosed`
**Structs**: `PositionClosed`
...
---
*Generated on 2025-11-18T21:55:02.536744Z*
