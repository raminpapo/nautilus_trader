...
- **Path**: `crates/model/src/events/position/mod.rs`
- **Size**: 8,955 bytes
- **Lines**: 236
- **Language**: Rust
...
- **`test_position_event_opened_instrument_id()`**: Function defined in this file
- **`test_position_event_changed_instrument_id()`**: Function defined in this file
- **`test_position_event_closed_instrument_id()`**: Function defined in this file
- **`test_position_event_opened_account_id()`**: Function defined in this file
- **`test_position_event_changed_account_id()`**: Function defined in this file
- **`test_position_event_closed_account_id()`**: Function defined in this file
- **`test_position_event_debug_formatting()`**: Function defined in this file
- **`test_position_event_enum_variants()`**: Function defined in this file
...
**Enums**: `PositionEvent`
**Functions**: `account_id`, `create_test_position_changed`, `create_test_position_closed`, `create_test_position_opened`, `instrument_id`, `test_position_event_changed_account_id`, `test_position_event_changed_instrument_id`, `test_position_event_closed_account_id`, `test_position_event_closed_instrument_id`, `test_position_event_debug_formatting`, `test_position_event_enum_variants`, `test_position_event_opened_account_id`, `test_position_event_opened_instrument_id`
**Impls**: `PositionEvent`
...
---
*Generated on 2025-11-18T21:55:02.539472Z*
