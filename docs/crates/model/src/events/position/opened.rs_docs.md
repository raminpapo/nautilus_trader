# Documentation: opened.rs

## File Metadata

- **Path**: `crates/model/src/events/position/opened.rs`
- **Size**: 12,505 bytes
- **Lines**: 318
- **Language**: Rust
...
- **`create_test_position_opened()`**: Function defined in this file
- **`create_test_order_filled()`**: Function defined in this file
- **`test_position_opened_new()`**: Function defined in this file
- **`test_position_opened_create()`**: Function defined in this file
- **`test_position_opened_clone()`**: Function defined in this file
- **`test_position_opened_debug()`**: Function defined in this file
- **`test_position_opened_partial_eq()`**: Function defined in this file
- **`test_position_opened_with_different_sides()`**: Function defined in this file
- **`test_position_opened_different_currencies()`**: Function defined in this file
- **`test_position_opened_timestamps()`**: Function defined in this file
- **`test_position_opened_quantities()`**: Function defined in this file
- **`test_position_opened_prices()`**: Function defined in this file

### Classes
- **`PositionOpened`**: Class defined in this file
...
**Functions**: `create`, `create_test_order_filled`, `create_test_position_opened`, `test_position_opened_clone`, `test_position_opened_create`, `test_position_opened_debug`, `test_position_opened_different_currencies`, `test_position_opened_new`, `test_position_opened_partial_eq`, `test_position_opened_prices`, `test_position_opened_quantities`, `test_position_opened_timestamps`, `test_position_opened_with_different_sides`
**Impls**: `PositionOpened`
**Structs**: `PositionOpened`
...
---
*Generated on 2025-11-18T21:55:02.542854Z*
