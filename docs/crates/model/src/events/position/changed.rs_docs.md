# Documentation: changed.rs

## File Metadata

- **Path**: `crates/model/src/events/position/changed.rs`
- **Size**: 16,123 bytes
- **Lines**: 401
- **Language**: Rust
...
- **`create_test_position_changed()`**: Function defined in this file
- **`create_test_order_filled()`**: Function defined in this file
- **`test_position_changed_new()`**: Function defined in this file
- **`test_position_changed_create()`**: Function defined in this file
- **`test_position_changed_clone()`**: Function defined in this file
- **`test_position_changed_debug()`**: Function defined in this file
- **`test_position_changed_partial_eq()`**: Function defined in this file
- **`test_position_changed_with_pnl()`**: Function defined in this file
- **`test_position_changed_with_closing_prices()`**: Function defined in this file
- **`test_position_changed_peak_quantity()`**: Function defined in this file
- **`test_position_changed_different_sides()`**: Function defined in this file
- **`test_position_changed_timestamps()`**: Function defined in this file
- **`test_position_changed_quantities_relationship()`**: Function defined in this file
- **`test_position_changed_with_zero_unrealized_pnl()`**: Function defined in this file

### Classes
- **`PositionChanged`**: Class defined in this file
...
**Functions**: `create`, `create_test_order_filled`, `create_test_position_changed`, `test_position_changed_clone`, `test_position_changed_create`, `test_position_changed_debug`, `test_position_changed_different_sides`, `test_position_changed_new`, `test_position_changed_partial_eq`, `test_position_changed_peak_quantity`, `test_position_changed_quantities_relationship`, `test_position_changed_timestamps`, `test_position_changed_with_closing_prices`, `test_position_changed_with_pnl`, `test_position_changed_with_zero_unrealized_pnl`
**Impls**: `PositionChanged`
**Structs**: `PositionChanged`
...
---
*Generated on 2025-11-18T21:55:02.532054Z*
