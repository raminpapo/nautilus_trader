# Documentation: adjusted.rs

## File Metadata

- **Path**: `crates/model/src/events/position/adjusted.rs`
- **Size**: 9,946 bytes
- **Lines**: 271
- **Language**: Rust
...
- **`create_test_commission_adjustment()`**: Function defined in this file
- **`create_test_funding_adjustment()`**: Function defined in this file
- **`test_position_adjustment_commission_new()`**: Function defined in this file
- **`test_position_adjustment_funding_new()`**: Function defined in this file
- **`test_position_adjustment_clone()`**: Function defined in this file
- **`test_position_adjustment_debug()`**: Function defined in this file
- **`test_position_adjustment_partial_eq()`**: Function defined in this file
- **`test_position_adjustment_different_types()`**: Function defined in this file
- **`test_position_adjustment_timestamps()`**: Function defined in this file
- **`test_position_adjustment_serialization()`**: Function defined in this file

### Classes
- **`PositionAdjusted`**: Class defined in this file
...
**Functions**: `create_test_commission_adjustment`, `create_test_funding_adjustment`, `new`, `test_position_adjustment_clone`, `test_position_adjustment_commission_new`, `test_position_adjustment_debug`, `test_position_adjustment_different_types`, `test_position_adjustment_funding_new`, `test_position_adjustment_partial_eq`, `test_position_adjustment_serialization`, `test_position_adjustment_timestamps`
**Impls**: `PositionAdjusted`
**Structs**: `PositionAdjusted`
...
---
*Generated on 2025-11-18T21:55:02.527218Z*
