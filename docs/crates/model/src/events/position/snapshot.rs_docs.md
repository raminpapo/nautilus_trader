# Documentation: `crates/model/src/events/position/snapshot.rs`
**Generated:** 2025-11-15T19:40:02.691629Z
...
This file is located at `crates/model/src/events/position/snapshot.rs` within the repository.

**Classes defined:** PositionSnapshot, PositionSnapshot

**Functions defined:** from, create_test_position_snapshot, create_test_order_filled, test_position_snapshot_new, test_position_snapshot_from, test_position_snapshot_from_with_no_unrealized_pnl, test_position_snapshot_clone, test_position_snapshot_debug, test_position_snapshot_partial_eq, test_position_snapshot_with_commissions and 13 more
...
#### `from(position: &Position, unrealized_pnl: Option<Money>)`
...
**Directory:** `crates/model/src/events/position`
