...
- **Path**: `crates/model/src/events/position/snapshot.rs`
- **Size**: 18,964 bytes
- **Lines**: 475
- **Language**: Rust
...
- **`create_test_position_snapshot()`**: Function defined in this file
- **`create_test_order_filled()`**: Function defined in this file
- **`test_position_snapshot_new()`**: Function defined in this file
- **`test_position_snapshot_from()`**: Function defined in this file
- **`test_position_snapshot_from_with_no_unrealized_pnl()`**: Function defined in this file
- **`test_position_snapshot_clone()`**: Function defined in this file
- **`test_position_snapshot_debug()`**: Function defined in this file
- **`test_position_snapshot_partial_eq()`**: Function defined in this file
- **`test_position_snapshot_with_commissions()`**: Function defined in this file
- **`test_position_snapshot_with_empty_commissions()`**: Function defined in this file
- **`test_position_snapshot_with_different_currencies()`**: Function defined in this file
- **`test_position_snapshot_without_base_currency()`**: Function defined in this file
- **`test_position_snapshot_different_position_sides()`**: Function defined in this file
- **`test_position_snapshot_with_pnl_values()`**: Function defined in this file
- **`test_position_snapshot_without_pnl_values()`**: Function defined in this file
- **`test_position_snapshot_with_closing_data()`**: Function defined in this file
- **`test_position_snapshot_without_closing_data()`**: Function defined in this file
- **`test_position_snapshot_timestamps()`**: Function defined in this file
- **`test_position_snapshot_quantities()`**: Function defined in this file

*...and 3 more functions*

### Classes
- **`PositionSnapshot`**: Class defined in this file
...
**Functions**: `create_test_order_filled`, `create_test_position_snapshot`, `from`, `test_position_snapshot_clone`, `test_position_snapshot_debug`, `test_position_snapshot_different_position_sides`, `test_position_snapshot_from`, `test_position_snapshot_from_with_no_unrealized_pnl`, `test_position_snapshot_new`, `test_position_snapshot_partial_eq`, `test_position_snapshot_quantities`, `test_position_snapshot_serialization`, `test_position_snapshot_timestamps`, `test_position_snapshot_with_closing_data`, `test_position_snapshot_with_commissions`, `test_position_snapshot_with_different_currencies`, `test_position_snapshot_with_duration`, `test_position_snapshot_with_empty_commissions`, `test_position_snapshot_with_pnl_values`, `test_position_snapshot_without_base_currency`, `test_position_snapshot_without_closing_data`, `test_position_snapshot_without_duration`, `test_position_snapshot_without_pnl_values`
**Impls**: `PositionSnapshot`
**Structs**: `PositionSnapshot`

## Related Files

This file is located in `crates/model/src/events/position/`. Related files may include:
...
---
*Generated on 2025-11-18T21:55:02.547899Z*
