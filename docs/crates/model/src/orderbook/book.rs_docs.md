# Documentation: `crates/model/src/orderbook/book.rs`
**Generated:** 2025-11-15T19:40:02.836173Z
**File Size:** 29644 bytes
**Extension:** .rs
**Type:** text
...
- **Path:** `crates/model/src/orderbook/book.rs`
- **Size:** 29,644 bytes
- **Lines:** 850
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/model/src/orderbook/book.rs` within the repository.

**Classes defined:** OrderBook, PartialEq, Eq, Display, OrderBook, Iterator, Iterator, Iterator

**Functions defined:** eq, fmt, new, reset, add, update, delete, clear, clear_bids, clear_asks and 35 more
...
#### `new(instrument_id: InstrumentId, book_type: BookType)`


#### `reset(&mut self)`


#### `add(&mut self, order: BookOrder, flags: u8, sequence: u64, ts_event: UnixNanos)`


#### `update(&mut self, order: BookOrder, flags: u8, sequence: u64, ts_event: UnixNanos)`


#### `delete(&mut self, order: BookOrder, flags: u8, sequence: u64, ts_event: UnixNanos)`


#### `clear(&mut self, sequence: u64, ts_event: UnixNanos)`


#### `clear_bids(&mut self, sequence: u64, ts_event: UnixNanos)`


#### `clear_asks(&mut self, sequence: u64, ts_event: UnixNanos)`


#### `clear_stale_levels(&mut self, side: Option<OrderSide>)`


#### `apply_delta(&mut self, delta: &OrderBookDelta)`


#### `apply_deltas(&mut self, deltas: &OrderBookDeltas)`


#### `apply_depth(&mut self, depth: &OrderBookDepth10)`


#### `resolve_no_side_order(&self, mut order: BookOrder)`


#### `bids(&self, depth: Option<usize>)`


#### `asks(&self, depth: Option<usize>)`


#### `bids_as_map(&self, depth: Option<usize>)`


#### `asks_as_map(&self, depth: Option<usize>)`
...
#### `get_avg_px_for_quantity(&self, qty: Quantity, order_side: OrderSide)`
...
#### `get_quantity_for_price(&self, price: Price, order_side: OrderSide)`


#### `simulate_fills(&self, order: &BookOrder)`


#### `pprint(&self, num_levels: usize, group_size: Option<Decimal>)`


#### `increment(&mut self, sequence: u64, ts_event: UnixNanos)`


#### `update_quote_tick(&mut self, quote: &QuoteTick)`


#### `update_trade_tick(&mut self, trade: &TradeTick)`


#### `update_book_bid(&mut self, order: BookOrder, ts_event: UnixNanos)`


#### `update_book_ask(&mut self, order: BookOrder, ts_event: UnixNanos)`
