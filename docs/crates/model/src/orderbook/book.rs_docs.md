...
- **`clear_bids()`**: Function defined in this file
- **`clear_asks()`**: Function defined in this file
- **`clear_stale_levels()`**: Function defined in this file
- **`apply_delta()`**: Function defined in this file
- **`apply_deltas()`**: Function defined in this file
- **`apply_depth()`**: Function defined in this file
- **`resolve_no_side_order()`**: Function defined in this file
- **`bids()`**: Function defined in this file
- **`asks()`**: Function defined in this file
- **`bids_as_map()`**: Function defined in this file
- **`asks_as_map()`**: Function defined in this file
- **`group_bids()`**: Function defined in this file

*...and 25 more functions*

### Classes
- **`OrderBook`**: Class defined in this file
...
**Functions**: `add`, `apply_delta`, `apply_deltas`, `apply_depth`, `asks`, `asks_as_map`, `asks_filtered_as_map`, `best_ask_price`, `best_ask_size`, `best_bid_price`, `best_bid_size`, `bids`, `bids_as_map`, `bids_filtered_as_map`, `clear`, `clear_asks`, `clear_bids`, `clear_stale_levels`, `delete`, `eq`, `filter_quantities`, `fmt`, `get_avg_px_for_quantity`, `get_avg_px_qty_for_exposure`, `get_quantity_for_price`, `group_asks`, `group_asks_filtered`, `group_bids`, `group_bids_filtered`, `group_levels` *(+15 more)*
**Impls**: `Display`, `Eq`, `Iterator`, `OrderBook`, `PartialEq`
**Structs**: `OrderBook`
...
---
*Generated on 2025-11-18T21:55:02.753182Z*
