...
- **Path**: `crates/model/src/orderbook/level.rs`
- **Size**: 25,726 bytes
- **Lines**: 750
- **Language**: Rust
...
- **`from_order()`**: Function defined in this file
- **`side()`**: Function defined in this file
- **`len()`**: Function defined in this file
- **`is_empty()`**: Function defined in this file
- **`first()`**: Function defined in this file
- **`iter()`**: Function defined in this file
- **`get_orders()`**: Function defined in this file
- **`size()`**: Function defined in this file
- **`size_raw()`**: Function defined in this file
- **`size_decimal()`**: Function defined in this file
- **`exposure()`**: Function defined in this file
- **`exposure_raw()`**: Function defined in this file
...
- **`remove_by_id()`**: Function defined in this file
...
### Classes
- **`BookLevel`**: Class defined in this file
...
**Functions**: `add`, `add_bulk`, `cmp`, `delete`, `eq`, `exposure`, `exposure_raw`, `first`, `from_order`, `get_orders`, `is_empty`, `iter`, `len`, `new`, `partial_cmp`, `remove_by_id`, `side`, `size`, `size_decimal`, `size_raw`, `test_add_bulk_empty`, `test_add_bulk_orders`, `test_add_bulk_orders_incorrect_price`, `test_add_multiple_orders`, `test_add_order_incorrect_price_level`, `test_add_single_order`, `test_book_level_sorting`, `test_comparisons_ask_side`, `test_comparisons_bid_side`, `test_delete_nonexistent_order` *(+23 more)*
**Impls**: `BookLevel`, `Iterator`, `Ord`, `PartialEq`, `PartialOrd`
**Structs**: `BookLevel`
...
---
*Generated on 2025-11-18T21:55:02.772537Z*
