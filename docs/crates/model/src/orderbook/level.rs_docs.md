# Documentation: `crates/model/src/orderbook/level.rs`
**Generated:** 2025-11-15T19:40:02.847966Z
**File Size:** 25726 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/model/src/orderbook/level.rs` within the repository.

**Classes defined:** BookLevel, BookLevel, Iterator, PartialEq, PartialOrd, Ord

**Functions defined:** new, from_order, side, len, is_empty, first, iter, get_orders, size, size_raw and 43 more
...
#### `delete(&mut self, order: &BookOrder)`


#### `remove_by_id(&mut self, order_id: OrderId, sequence: u64, ts_event: UnixNanos)`
