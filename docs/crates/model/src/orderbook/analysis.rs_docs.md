# Documentation: `crates/model/src/orderbook/analysis.rs`
**Generated:** 2025-11-15T19:40:02.830963Z
...
- **Path:** `crates/model/src/orderbook/analysis.rs`
- **Size:** 6,041 bytes
- **Lines:** 183
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/model/src/orderbook/analysis.rs` within the repository.

**Functions defined:** get_quantity_for_price, get_avg_px_for_quantity, get_avg_px_qty_for_exposure, book_check_integrity
...
#### `get_avg_px_for_quantity(qty: Quantity, levels: &BTreeMap<BookPrice, BookLevel>)`
...
#### `book_check_integrity(book: &OrderBook)`
