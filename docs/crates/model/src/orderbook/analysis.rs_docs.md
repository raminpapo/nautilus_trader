...
### Functions
- **`get_quantity_for_price()`**: Function defined in this file
- **`get_avg_px_for_quantity()`**: Function defined in this file
- **`get_avg_px_qty_for_exposure()`**: Function defined in this file
- **`book_check_integrity()`**: Function defined in this file
...
**Functions**: `book_check_integrity`, `get_avg_px_for_quantity`, `get_avg_px_qty_for_exposure`, `get_quantity_for_price`
...
---
*Generated on 2025-11-18T21:55:02.747169Z*
