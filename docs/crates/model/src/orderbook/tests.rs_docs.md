# Documentation: `crates/model/src/orderbook/tests.rs`
**Generated:** 2025-11-15T19:40:02.871805Z
**File Size:** 184627 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/model/src/orderbook/tests.rs` within the repository.

**Classes defined:** Strategy, Strategy, Strategy, Strategy, Strategy, Strategy, Strategy, Strategy

**Functions defined:** test_book_integrity_cases, test_book_integrity_price_boundaries, test_book_integrity_quantity_sizes, test_book_display, test_book_empty_state, test_book_single_bid_state, test_book_single_ask_state, test_book_empty_book_spread, test_book_spread_with_orders, test_book_empty_book_midpoint and 103 more
...
#### `test_book_integrity_quantity_sizes(#[case] quantity: i64)`
...
#### `test_book_get_price_for_exposure(stub_depth10: OrderBookDepth10)`


#### `test_book_apply_depth(stub_depth10: OrderBookDepth10)`


#### `test_book_apply_depth_all_levels(stub_depth10: OrderBookDepth10)`
...
#### `test_book_apply_depth_updates_metadata_once(stub_depth10: OrderBookDepth10)`
...
#### `test_book_clear_stale_levels_not_crossed(#[case] side: Option<OrderSide>)`


#### `test_book_clear_stale_levels_simple_crossed(#[case] side: Option<OrderSide>)`


#### `test_book_clear_stale_levels_multiple_overlapping()`


*... and 63 more functions*
