...
- **Path**: `crates/model/src/orderbook/tests.rs`
- **Size**: 184,215 bytes
- **Lines**: 5,870
- **Language**: Rust
...
This file is part of the NautilusTrader repository. It defines 113 function(s).

## Detailed Walkthrough

### Functions
- **`test_book_integrity_cases()`**: Function defined in this file
- **`test_book_integrity_price_boundaries()`**: Function defined in this file
- **`test_book_integrity_quantity_sizes()`**: Function defined in this file
- **`test_book_display()`**: Function defined in this file
- **`test_book_empty_state()`**: Function defined in this file
- **`test_book_single_bid_state()`**: Function defined in this file
- **`test_book_single_ask_state()`**: Function defined in this file
- **`test_book_empty_book_spread()`**: Function defined in this file
- **`test_book_spread_with_orders()`**: Function defined in this file
- **`test_book_empty_book_midpoint()`**: Function defined in this file
- **`test_book_midpoint_with_orders()`**: Function defined in this file
- **`test_book_get_price_for_quantity_no_market()`**: Function defined in this file
- **`test_book_get_quantity_for_price_no_market()`**: Function defined in this file
- **`test_book_get_price_for_quantity()`**: Function defined in this file
- **`test_book_get_quantity_for_price()`**: Function defined in this file
- **`test_book_get_price_for_exposure_no_market()`**: Function defined in this file
- **`test_book_get_price_for_exposure()`**: Function defined in this file
- **`test_book_apply_depth()`**: Function defined in this file
- **`test_book_apply_depth_all_levels()`**: Function defined in this file
- **`test_book_apply_depth_empty_snapshot()`**: Function defined in this file

*...and 93 more functions*


## Keywords and Identifiers

Total unique keywords extracted: 116


**Enums**: `L1Operation`, `OrderBookOperation`
**Functions**: `book_order_strategy`, `l1_operation_strategy`, `orderbook_operation_strategy`, `orderbook_test_strategy`, `own_order`, `positive_book_order_strategy`, `positive_quantity_strategy`, `price_strategy`, `prop_test_l1_book_operations`, `prop_test_orderbook_basic_invariants`, `prop_test_orderbook_operations`, `quantity_strategy`, `sanitize_operations`, `test_apply_delta_error_when_order_not_found_for_side_resolution`, `test_apply_delta_no_order_side_with_zero_order_id_for_clear`, `test_apply_delta_resolves_side_from_asks_cache`, `test_apply_delta_resolves_side_from_bids_cache`, `test_apply_delta_skips_update_delete_when_order_not_found`, `test_apply_deltas_empty_clear_to_empty_book`, `test_apply_deltas_single_clear_no_f_last`, `test_book_apply_depth`, `test_book_apply_depth_all_levels`, `test_book_apply_depth_empty_snapshot`, `test_book_apply_depth_partial_snapshot`, `test_book_apply_depth_updates_metadata_once`, `test_book_clear_stale_levels_l1_mbp`, `test_book_clear_stale_levels_multiple_crossed_each_side`, `test_book_clear_stale_levels_multiple_crossed_side_specific`, `test_book_clear_stale_levels_multiple_overlapping`, `test_book_clear_stale_levels_not_crossed` *(+83 more)*
**Impls**: `Strategy`
...
```bash
# For Python
pytest crates/model/src/orderbook/tests.rs
...
---
*Generated on 2025-11-18T21:55:02.823894Z*
