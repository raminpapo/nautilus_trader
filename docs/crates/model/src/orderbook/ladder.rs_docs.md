...
This file is part of the NautilusTrader repository. It defines 61 function(s) and 2 class(es).
...
- **`add_bulk()`**: Function defined in this file
- **`clear()`**: Function defined in this file
- **`add()`**: Function defined in this file
- **`handle_l1_add()`**: Function defined in this file
- **`update()`**: Function defined in this file
- **`delete()`**: Function defined in this file
- **`remove_order()`**: Function defined in this file
- **`remove_level()`**: Function defined in this file
- **`sizes()`**: Function defined in this file
- **`exposures()`**: Function defined in this file
- **`top()`**: Function defined in this file
- **`simulate_fills()`**: Function defined in this file

*...and 41 more functions*

### Classes
- **`BookPrice`**: Class defined in this file
- **`BookLadder`**: Class defined in this file
...
**Functions**: `add`, `add_bulk`, `clear`, `cmp`, `delete`, `eq`, `exposures`, `fmt`, `handle_l1_add`, `is_empty`, `len`, `new`, `partial_cmp`, `remove_level`, `remove_order`, `simulate_fills`, `sizes`, `test_add_ascending_sell_orders`, `test_add_bulk_empty`, `test_add_bulk_orders`, `test_add_descending_buy_orders`, `test_add_multiple_buy_orders`, `test_add_multiple_sell_orders`, `test_add_single_order`, `test_add_to_same_price_level`, `test_book_price_ask_sorting`, `test_book_price_bid_sorting`, `test_boundary_prices`, `test_cache_consistency_after_operations`, `test_delete_buy_order` *(+29 more)*
**Impls**: `BookLadder`, `BookPrice`, `Display`, `Ord`, `PartialEq`, `PartialOrd`
**Structs**: `BookLadder`, `BookPrice`
...
---
*Generated on 2025-11-18T21:55:02.766671Z*
