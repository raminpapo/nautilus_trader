# Documentation: `crates/model/src/orderbook/ladder.rs`
**Generated:** 2025-11-15T19:40:02.844170Z
**File Size:** 46393 bytes
**Extension:** .rs
**Type:** text
...
- **Path:** `crates/model/src/orderbook/ladder.rs`
- **Size:** 46,393 bytes
- **Lines:** 1,316
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/model/src/orderbook/ladder.rs` within the repository.

**Classes defined:** BookPrice, BookLadder, BookPrice, PartialOrd, PartialEq, Ord, Display, BookLadder, Display

**Functions defined:** new, partial_cmp, eq, cmp, fmt, new, len, is_empty, add_bulk, clear and 51 more
...
#### `new(value: Price, side: OrderSideSpecified)`
...
#### `new(side: OrderSideSpecified, book_type: BookType)`
...
#### `add_bulk(&mut self, orders: Vec<BookOrder>)`


#### `clear(&mut self)`


#### `add(&mut self, order: BookOrder)`


#### `handle_l1_add(&mut self, order: &BookOrder)`


#### `update(&mut self, order: BookOrder)`


#### `delete(&mut self, order: BookOrder, sequence: u64, ts_event: UnixNanos)`


#### `remove_order(&mut self, order_id: OrderId, sequence: u64, ts_event: UnixNanos)`


#### `remove_level(&mut self, price: BookPrice)`
