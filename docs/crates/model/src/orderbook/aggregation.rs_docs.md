# Documentation: `crates/model/src/orderbook/aggregation.rs`
**Generated:** 2025-11-15T19:40:02.828440Z
**File Size:** 14844 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/model/src/orderbook/aggregation.rs` within the repository.

**Functions defined:** price_to_order_id, pre_process_order, test_price_to_order_id_deterministic, test_price_to_order_id_no_collisions, test_price_to_order_id_no_collision_across_64bit_boundary, test_price_to_order_id_handles_negative_prices, test_price_to_order_id_handles_large_values, test_price_to_order_id_multiples_of_2_pow_64, test_price_to_order_id_realistic_orderbook_prices, test_price_to_order_id_edge_case_patterns and 4 more
...
#### `price_to_order_id(price_raw: i128)`


#### `pre_process_order(book_type: BookType, mut order: BookOrder, flags: u8)`
...
#### `test_price_to_order_id_extreme_values_no_collision(#[case] price: i128)`
