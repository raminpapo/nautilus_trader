...
- **Path**: `crates/model/src/orderbook/aggregation.rs`
- **Size**: 14,838 bytes
- **Lines**: 420
- **Language**: Rust
...
- **`pre_process_order()`**: Function defined in this file
- **`test_price_to_order_id_deterministic()`**: Function defined in this file
- **`test_price_to_order_id_no_collisions()`**: Function defined in this file
- **`test_price_to_order_id_no_collision_across_64bit_boundary()`**: Function defined in this file
- **`test_price_to_order_id_handles_negative_prices()`**: Function defined in this file
- **`test_price_to_order_id_handles_large_values()`**: Function defined in this file
- **`test_price_to_order_id_multiples_of_2_pow_64()`**: Function defined in this file
- **`test_price_to_order_id_realistic_orderbook_prices()`**: Function defined in this file
- **`test_price_to_order_id_edge_case_patterns()`**: Function defined in this file
- **`test_price_to_order_id_sequential_negative_values()`**: Function defined in this file
- **`test_price_to_order_id_extreme_values_no_collision()`**: Function defined in this file
- **`test_price_to_order_id_avalanche_effect()`**: Function defined in this file
- **`test_price_to_order_id_comprehensive_collision_check()`**: Function defined in this file
...
**Functions**: `pre_process_order`, `price_to_order_id`, `test_price_to_order_id_avalanche_effect`, `test_price_to_order_id_comprehensive_collision_check`, `test_price_to_order_id_deterministic`, `test_price_to_order_id_edge_case_patterns`, `test_price_to_order_id_extreme_values_no_collision`, `test_price_to_order_id_handles_large_values`, `test_price_to_order_id_handles_negative_prices`, `test_price_to_order_id_multiples_of_2_pow_64`, `test_price_to_order_id_no_collision_across_64bit_boundary`, `test_price_to_order_id_no_collisions`, `test_price_to_order_id_realistic_orderbook_prices`, `test_price_to_order_id_sequential_negative_values`
...
---
*Generated on 2025-11-18T21:55:02.744730Z*
