# Documentation: currencies.rs

## File Metadata

- **Path**: `crates/model/src/currencies.rs`
- **Size**: 41,372 bytes
- **Lines**: 1,284
- **Language**: Rust
...
This file is part of the NautilusTrader repository. It defines 87 function(s).

## Detailed Walkthrough

### Functions
- **`AUD()`**: Function defined in this file
- **`BRL()`**: Function defined in this file
- **`CAD()`**: Function defined in this file
- **`CHF()`**: Function defined in this file
- **`CNY()`**: Function defined in this file
- **`CNH()`**: Function defined in this file
- **`CZK()`**: Function defined in this file
- **`DKK()`**: Function defined in this file
- **`EUR()`**: Function defined in this file
- **`GBP()`**: Function defined in this file
- **`HKD()`**: Function defined in this file
- **`HUF()`**: Function defined in this file
- **`ILS()`**: Function defined in this file
- **`INR()`**: Function defined in this file
- **`JPY()`**: Function defined in this file
- **`KRW()`**: Function defined in this file
- **`MXN()`**: Function defined in this file
- **`NOK()`**: Function defined in this file
- **`NZD()`**: Function defined in this file
- **`PLN()`**: Function defined in this file
...
**Functions**: `AAVE`, `ACA`, `ADA`, `APT`, `ARB`, `AUD`, `AVAX`, `BCH`, `BIO`, `BNB`, `BRL`, `BRZ`, `BSV`, `BTC`, `BTTC`, `BUSD`, `CAD`, `CAKE`, `CHF`, `CNH`, `CNY`, `CRV`, `CZK`, `DASH`, `DKK`, `DOGE`, `DOT`, `ENA`, `EOS`, `ETH` *(+57 more)*
**Impls**: `Currency`
...
---
*Generated on 2025-11-18T21:55:02.212602Z*
