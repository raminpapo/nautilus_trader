...
- **Path**: `crates/model/src/python/reports/mass_status.rs`
- **Size**: 5,756 bytes
- **Lines**: 177
- **Language**: Rust
...
- **`py_client_id()`**: Function defined in this file
...
- **`py_order_reports()`**: Function defined in this file
- **`py_fill_reports()`**: Function defined in this file
- **`py_position_reports()`**: Function defined in this file
- **`py_add_order_reports()`**: Function defined in this file
- **`py_add_fill_reports()`**: Function defined in this file
- **`py_add_position_reports()`**: Function defined in this file
...
**Functions**: `__repr__`, `__richcmp__`, `__str__`, `py_account_id`, `py_add_fill_reports`, `py_add_order_reports`, `py_add_position_reports`, `py_client_id`, `py_fill_reports`, `py_from_dict`, `py_new`, `py_order_reports`, `py_position_reports`, `py_report_id`, `py_to_dict`, `py_ts_init`, `py_venue`
**Impls**: `ExecutionMassStatus`
...
---
*Generated on 2025-11-18T21:55:03.199299Z*
