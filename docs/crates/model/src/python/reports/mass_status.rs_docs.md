# Documentation: `crates/model/src/python/reports/mass_status.rs`
**Generated:** 2025-11-15T19:40:03.120705Z
...
This file is located at `crates/model/src/python/reports/mass_status.rs` within the repository.

**Classes defined:** ExecutionMassStatus

**Functions defined:** py_new, __richcmp__, __repr__, __str__, py_client_id, py_account_id, py_venue, py_report_id, py_ts_init, py_order_reports and 7 more
...
#### `py_order_reports(&self)`


#### `py_fill_reports(&self)`


#### `py_position_reports(&self)`


#### `py_add_order_reports(&mut self, reports: Vec<OrderStatusReport>)`


#### `py_add_fill_reports(&mut self, reports: Vec<FillReport>)`


#### `py_add_position_reports(&mut self, reports: Vec<PositionStatusReport>)`
