...
- **Path**: `crates/model/src/python/reports/position.rs`
- **Size**: 5,734 bytes
- **Lines**: 190
- **Language**: Rust
...
- **`py_position_side()`**: Function defined in this file
- **`py_quantity()`**: Function defined in this file
- **`py_avg_px_open()`**: Function defined in this file
...
- **`py_is_flat()`**: Function defined in this file
- **`py_is_long()`**: Function defined in this file
- **`py_is_short()`**: Function defined in this file
...
**Functions**: `__repr__`, `__richcmp__`, `__str__`, `py_account_id`, `py_avg_px_open`, `py_from_dict`, `py_instrument_id`, `py_is_flat`, `py_is_long`, `py_is_short`, `py_new`, `py_position_side`, `py_quantity`, `py_report_id`, `py_strategy_id`, `py_to_dict`, `py_ts_init`, `py_ts_last`, `py_venue_position_id`
**Impls**: `PositionStatusReport`
...
---
*Generated on 2025-11-18T21:55:03.208363Z*
