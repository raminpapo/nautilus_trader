# Documentation: `crates/model/src/python/reports/order.rs`
**Generated:** 2025-11-15T19:40:03.124847Z
...
This file is located at `crates/model/src/python/reports/order.rs` within the repository.

**Classes defined:** OrderStatusReport

**Functions defined:** py_new, __richcmp__, __repr__, __str__, py_account_id, py_instrument_id, py_venue_order_id, py_order_side, py_order_type, py_time_in_force and 28 more
...
#### `py_limit_offset(&self)`


#### `py_trailing_offset(&self)`


#### `py_trailing_offset_type(&self)`
...
#### `py_cancel_reason(&self)`


#### `py_ts_triggered(&self)`
