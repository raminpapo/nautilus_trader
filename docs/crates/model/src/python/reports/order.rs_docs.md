...
- **Path**: `crates/model/src/python/reports/order.rs`
- **Size**: 15,708 bytes
- **Lines**: 501
- **Language**: Rust
...
- **`py_order_status()`**: Function defined in this file
- **`py_quantity()`**: Function defined in this file
- **`py_filled_qty()`**: Function defined in this file
- **`py_report_id()`**: Function defined in this file
- **`py_ts_accepted()`**: Function defined in this file
...
**Functions**: `__repr__`, `__richcmp__`, `__str__`, `py_account_id`, `py_avg_px`, `py_cancel_reason`, `py_client_order_id`, `py_contingency_type`, `py_display_qty`, `py_expire_time`, `py_filled_qty`, `py_from_dict`, `py_instrument_id`, `py_limit_offset`, `py_linked_order_ids`, `py_new`, `py_order_list_id`, `py_order_side`, `py_order_status`, `py_order_type`, `py_parent_order_id`, `py_post_only`, `py_price`, `py_quantity`, `py_reduce_only`, `py_report_id`, `py_time_in_force`, `py_to_dict`, `py_trailing_offset`, `py_trailing_offset_type` *(+8 more)*
**Impls**: `OrderStatusReport`
...
---
*Generated on 2025-11-18T21:55:03.205469Z*
