# Documentation: `crates/model/src/python/account/margin.rs`
**Generated:** 2025-11-15T19:40:02.939879Z
...
This file is located at `crates/model/src/python/account/margin.rs` within the repository.

**Classes defined:** MarginAccount

**Functions defined:** py_new, __richcmp__, id, default_leverage, py_calculate_account_state, __repr__, py_set_default_leverage, py_leverages, py_leverage, py_set_leverage and 10 more
...
#### `py_new(event: AccountState, calculate_account_state: bool)`
...
#### `default_leverage(&self)`


#### `py_calculate_account_state(&self)`


#### `__repr__(&self)`


#### `py_set_default_leverage(&mut self, default_leverage: Decimal)`


#### `py_leverages(&self, py: Python)`


#### `py_leverage(&self, instrument_id: &InstrumentId)`


#### `py_set_leverage(&mut self, instrument_id: InstrumentId, leverage: Decimal)`


#### `py_is_unleveraged(&self, instrument_id: InstrumentId)`


#### `py_initial_margins(&self, py: Python)`


#### `py_maintenance_margins(&self, py: Python)`
...
#### `py_initial_margin(&self, instrument_id: InstrumentId)`
...
#### `py_maintenance_margin(&self, instrument_id: InstrumentId)`
