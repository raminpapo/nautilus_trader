# Documentation: `crates/model/src/python/account/cash.rs`
**Generated:** 2025-11-15T19:40:02.937610Z
**File Size:** 6814 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/model/src/python/account/cash.rs` within the repository.

**Classes defined:** CashAccount

**Functions defined:** py_new, __richcmp__, id, allow_borrowing, __repr__, py_id, py_account_type, py_base_currency, py_last_event, py_event_count and 13 more
...
#### `py_balance_total(&self, currency: Option<Currency>)`


#### `py_balances_total(&self)`


#### `py_balance_free(&self, currency: Option<Currency>)`


#### `py_balances_free(&self)`


#### `py_balance_locked(&self, currency: Option<Currency>)`


#### `py_balances_locked(&self)`


#### `py_apply(&mut self, event: AccountState)`
