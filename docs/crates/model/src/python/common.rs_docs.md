# Documentation: `crates/model/src/python/common.rs`
**Generated:** 2025-11-15T19:40:02.944609Z
...
This file is located at `crates/model/src/python/common.rs` within the repository.

**Classes defined:** EnumIterator, EnumIterator, EnumIterator

**Functions defined:** __iter__, __next__, new, value_to_pydict, value_to_pyobject, commissions_from_vec, commissions_from_indexmap, test_value_to_pydict, test_value_to_pyobject_string, test_value_to_pyobject_bool and 1 more
...
#### `value_to_pydict(py: Python<'_>, val: &Value)`


#### `value_to_pyobject(py: Python<'_>, val: &Value)`


#### `commissions_from_vec(py: Python<'_>, commissions: Vec<Money>)`
