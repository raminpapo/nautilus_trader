# Documentation: `crates/model/src/python/identifiers/symbol.rs`
**Generated:** 2025-11-15T19:40:03.051638Z
...
- **Path:** `crates/model/src/python/identifiers/symbol.rs`
- **Size:** 3,712 bytes
- **Lines:** 119
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/model/src/python/identifiers/symbol.rs` within the repository.

**Classes defined:** Symbol

**Functions defined:** py_new, _safe_constructor, __setstate__, __getstate__, __reduce__, __richcmp__, __hash__, __repr__, __str__, py_from_str and 4 more
