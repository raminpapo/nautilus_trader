...
- **`py_root()`**: Function defined in this file
...
**Functions**: `__getstate__`, `__hash__`, `__reduce__`, `__repr__`, `__richcmp__`, `__setstate__`, `__str__`, `_safe_constructor`, `py_from_str`, `py_is_composite`, `py_new`, `py_root`, `py_topic`, `py_value`
**Impls**: `Symbol`
...
---
*Generated on 2025-11-18T21:55:03.100789Z*
