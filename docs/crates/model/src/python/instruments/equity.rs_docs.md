# Documentation: equity.rs

## File Metadata

- **Path**: `crates/model/src/python/instruments/equity.rs`
- **Size**: 8,099 bytes
- **Lines**: 271
- **Language**: Rust
...
- **`py_isin()`**: Function defined in this file
...
- **`py_margin_init()`**: Function defined in this file
- **`py_margin_maint()`**: Function defined in this file
- **`py_maker_fee()`**: Function defined in this file
...
**Functions**: `__hash__`, `__richcmp__`, `py_from_dict`, `py_id`, `py_info`, `py_isin`, `py_lot_size`, `py_maker_fee`, `py_margin_init`, `py_margin_maint`, `py_max_price`, `py_max_quantity`, `py_min_price`, `py_min_quantity`, `py_new`, `py_price_increment`, `py_price_precision`, `py_quote_currency`, `py_raw_symbol`, `py_size_increment`, `py_size_precision`, `py_taker_fee`, `py_to_dict`, `py_ts_event`, `py_ts_init`, `type_str`
**Impls**: `Equity`
...
---
*Generated on 2025-11-18T21:55:03.127334Z*
