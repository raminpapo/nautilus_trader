# Documentation: `crates/model/src/python/instruments/betting.rs`
**Generated:** 2025-11-15T19:40:03.056390Z
**File Size:** 13709 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/model/src/python/instruments/betting.rs` within the repository.

**Classes defined:** BettingInstrument

**Functions defined:** py_new, __hash__, __richcmp__, type_str, py_id, py_raw_symbol, py_asset_class, py_instrument_class, py_event_type_id, py_event_type_name and 33 more
...
#### `py_instrument_class(&self)`


#### `py_event_type_id(&self)`


#### `py_event_type_name(&self)`


#### `py_competition_id(&self)`


#### `py_competition_name(&self)`
...
#### `py_event_country_code(&self)`


#### `py_event_open_date(&self)`


#### `py_betting_type(&self)`
...
#### `py_market_start_time(&self)`


#### `py_selection_id(&self)`


#### `py_selection_name(&self)`


#### `py_selection_handicap(&self)`
...
#### `py_price_increment(&self)`


#### `py_size_increment(&self)`


#### `py_max_quantity(&self)`


#### `py_min_quantity(&self)`


#### `py_max_notional(&self)`


#### `py_min_notional(&self)`
...
#### `test_dict_round_trip(betting: BettingInstrument)`
