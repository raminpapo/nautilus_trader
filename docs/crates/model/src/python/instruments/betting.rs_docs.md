# Documentation: betting.rs

## File Metadata

- **Path**: `crates/model/src/python/instruments/betting.rs`
- **Size**: 13,709 bytes
- **Lines**: 441
- **Language**: Rust
...
- **`type_str()`**: Function defined in this file
- **`py_id()`**: Function defined in this file
- **`py_raw_symbol()`**: Function defined in this file
- **`py_asset_class()`**: Function defined in this file
- **`py_instrument_class()`**: Function defined in this file
- **`py_event_type_id()`**: Function defined in this file
- **`py_event_type_name()`**: Function defined in this file
- **`py_competition_id()`**: Function defined in this file
- **`py_competition_name()`**: Function defined in this file
- **`py_event_id()`**: Function defined in this file
- **`py_event_name()`**: Function defined in this file
- **`py_event_country_code()`**: Function defined in this file
- **`py_event_open_date()`**: Function defined in this file
- **`py_betting_type()`**: Function defined in this file
- **`py_market_id()`**: Function defined in this file
- **`py_market_name()`**: Function defined in this file
- **`py_market_type()`**: Function defined in this file
...
**Functions**: `__hash__`, `__richcmp__`, `py_asset_class`, `py_betting_type`, `py_competition_id`, `py_competition_name`, `py_currency`, `py_event_country_code`, `py_event_id`, `py_event_name`, `py_event_open_date`, `py_event_type_id`, `py_event_type_name`, `py_from_dict`, `py_id`, `py_info`, `py_instrument_class`, `py_maker_fee`, `py_market_id`, `py_market_name`, `py_market_start_time`, `py_market_type`, `py_max_notional`, `py_max_price`, `py_max_quantity`, `py_min_notional`, `py_min_price`, `py_min_quantity`, `py_new`, `py_price_increment` *(+13 more)*
**Impls**: `BettingInstrument`

## Related Files

This file is located in `crates/model/src/python/instruments/`. Related files may include:
...
---
*Generated on 2025-11-18T21:55:03.106812Z*
