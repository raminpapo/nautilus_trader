# Documentation: futures_spread.rs

## File Metadata

- **Path**: `crates/model/src/python/instruments/futures_spread.rs`
- **Size**: 9,719 bytes
- **Lines**: 322
- **Language**: Rust
...
- **`py_strategy_type()`**: Function defined in this file
...
**Functions**: `__hash__`, `__richcmp__`, `py_activation_ns`, `py_asset_class`, `py_currency`, `py_exchange`, `py_expiration_ns`, `py_from_dict`, `py_id`, `py_info`, `py_lot_size`, `py_maker_fee`, `py_margin_init`, `py_margin_maint`, `py_max_price`, `py_max_quantity`, `py_min_price`, `py_min_quantity`, `py_multiplier`, `py_new`, `py_price_increment`, `py_price_precision`, `py_raw_symbol`, `py_size_increment`, `py_size_precision`, `py_strategy_type`, `py_taker_fee`, `py_to_dict`, `py_ts_event`, `py_ts_init` *(+2 more)*
**Impls**: `FuturesSpread`
...
---
*Generated on 2025-11-18T21:55:03.133228Z*
