# Documentation: binary_option.rs

## File Metadata

- **Path**: `crates/model/src/python/instruments/binary_option.rs`
- **Size**: 10,957 bytes
- **Lines**: 354
- **Language**: Rust
...
- **`py_currency()`**: Function defined in this file
...
- **`py_outcome()`**: Function defined in this file
- **`py_description()`**: Function defined in this file
- **`py_max_quantity()`**: Function defined in this file
- **`py_min_quantity()`**: Function defined in this file
- **`py_max_notional()`**: Function defined in this file
- **`py_min_notional()`**: Function defined in this file
...
**Functions**: `__hash__`, `__richcmp__`, `py_activation_ns`, `py_asset_class`, `py_currency`, `py_description`, `py_expiration_ns`, `py_from_dict`, `py_id`, `py_info`, `py_maker_fee`, `py_margin_init`, `py_margin_maint`, `py_max_notional`, `py_max_price`, `py_max_quantity`, `py_min_notional`, `py_min_price`, `py_min_quantity`, `py_new`, `py_outcome`, `py_price_increment`, `py_price_precision`, `py_raw_symbol`, `py_size_increment`, `py_size_precision`, `py_taker_fee`, `py_to_dict`, `py_ts_event`, `py_ts_init` *(+2 more)*
**Impls**: `BinaryOption`
...
---
*Generated on 2025-11-18T21:55:03.110103Z*
