# Documentation: currency_pair.rs

## File Metadata

- **Path**: `crates/model/src/python/instruments/currency_pair.rs`
- **Size**: 9,317 bytes
- **Lines**: 303
- **Language**: Rust
...
- **`py_max_price()`**: Function defined in this file
- **`py_min_price()`**: Function defined in this file
...
**Functions**: `__hash__`, `__richcmp__`, `py_base_currency`, `py_from_dict`, `py_id`, `py_info`, `py_lot_size`, `py_maker_fee`, `py_margin_init`, `py_margin_maint`, `py_max_notional`, `py_max_price`, `py_max_quantity`, `py_min_notional`, `py_min_price`, `py_min_quantity`, `py_multiplier`, `py_new`, `py_price_increment`, `py_price_precision`, `py_quote_currency`, `py_raw_symbol`, `py_size_increment`, `py_size_precision`, `py_taker_fee`, `py_to_dict`, `py_ts_event`, `py_ts_init`, `type_str`
**Impls**: `CurrencyPair`
...
---
*Generated on 2025-11-18T21:55:03.124276Z*
