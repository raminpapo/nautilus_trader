# Documentation: crypto_option.rs

## File Metadata

- **Path**: `crates/model/src/python/instruments/crypto_option.rs`
- **Size**: 11,714 bytes
- **Lines**: 381
- **Language**: Rust
...
- **`py_underlying()`**: Function defined in this file
- **`py_quote_currency()`**: Function defined in this file
- **`py_settlement_currency()`**: Function defined in this file
- **`py_is_inverse()`**: Function defined in this file
- **`py_option_kind()`**: Function defined in this file
- **`py_strike_price()`**: Function defined in this file
- **`py_activation_ns()`**: Function defined in this file
- **`py_expiration_ns()`**: Function defined in this file
- **`py_price_precision()`**: Function defined in this file
- **`py_size_precision()`**: Function defined in this file
- **`py_price_increment()`**: Function defined in this file
- **`py_size_increment()`**: Function defined in this file
- **`py_multiplier()`**: Function defined in this file
- **`py_lot_size()`**: Function defined in this file
...
**Functions**: `__hash__`, `__richcmp__`, `py_activation_ns`, `py_expiration_ns`, `py_from_dict`, `py_id`, `py_info`, `py_is_inverse`, `py_lot_size`, `py_maker_fee`, `py_margin_init`, `py_margin_maint`, `py_max_notional`, `py_max_price`, `py_max_quantity`, `py_min_notional`, `py_min_price`, `py_min_quantity`, `py_multiplier`, `py_new`, `py_option_kind`, `py_price_increment`, `py_price_precision`, `py_quote_currency`, `py_raw_symbol`, `py_settlement_currency`, `py_size_increment`, `py_size_precision`, `py_strike_price`, `py_taker_fee` *(+6 more)*
**Impls**: `CryptoOption`
...
---
*Generated on 2025-11-18T21:55:03.117695Z*
