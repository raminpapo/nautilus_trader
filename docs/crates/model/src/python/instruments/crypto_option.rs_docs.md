# Documentation: `crates/model/src/python/instruments/crypto_option.rs`
**Generated:** 2025-11-15T19:40:03.064236Z
**File Size:** 11714 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/model/src/python/instruments/crypto_option.rs` within the repository.

**Classes defined:** CryptoOption

**Functions defined:** py_new, __hash__, __richcmp__, type_str, py_id, py_raw_symbol, py_underlying, py_quote_currency, py_settlement_currency, py_is_inverse and 26 more
...
#### `py_strike_price(&self)`


#### `py_activation_ns(&self)`


#### `py_expiration_ns(&self)`
...
#### `test_dict_round_trip(crypto_option_btc_deribit: CryptoOption)`
