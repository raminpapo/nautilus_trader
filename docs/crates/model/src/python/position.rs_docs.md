# Documentation: `crates/model/src/python/position.rs`
**Generated:** 2025-11-15T19:40:03.116714Z
**File Size:** 12760 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/model/src/python/position.rs` within the repository.

**Classes defined:** Position

**Functions defined:** py_new, __richcmp__, __repr__, __str__, py_trader_id, py_strategy_id, py_instrument_id, py_id, py_symbol, py_venue and 45 more
...
#### `py_new(py: Python, instrument: Py<PyAny>, fill: OrderFilled)`
...
#### `py_opening_order_id(&self)`


#### `py_closing_order_id(&self)`
...
#### `py_base_currency(&self)`


#### `py_quote_currency(&self)`


#### `py_settlement_currency(&self)`
...
#### `py_avg_px_close(&self)`


#### `py_realized_return(&self)`


#### `py_realized_pnl(&self)`
...
#### `py_client_order_ids(&self)`


#### `py_venue_order_ids(&self)`
...
#### `py_unrealized_pnl(&self, last: Price)`


#### `py_total_pnl(&self, last: Price)`


#### `py_commissions(&self)`


#### `py_apply(&mut self, fill: &OrderFilled)`


#### `py_apply_adjustment(&mut self, adjustment: PositionAdjusted)`


#### `py_purge_events_for_order(&mut self, client_order_id: ClientOrderId)`
