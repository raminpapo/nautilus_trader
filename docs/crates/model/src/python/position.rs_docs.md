...
- **Path**: `crates/model/src/python/position.rs`
- **Size**: 12,760 bytes
- **Lines**: 434
- **Language**: Rust
...
- **`py_opening_order_id()`**: Function defined in this file
- **`py_closing_order_id()`**: Function defined in this file
- **`py_entry()`**: Function defined in this file
- **`py_side()`**: Function defined in this file
- **`py_signed_qty()`**: Function defined in this file
- **`py_quantity()`**: Function defined in this file
- **`py_peak_qty()`**: Function defined in this file
...
**Functions**: `__repr__`, `__richcmp__`, `__str__`, `py_adjustments`, `py_apply`, `py_apply_adjustment`, `py_avg_px_close`, `py_avg_px_open`, `py_base_currency`, `py_calculate_pnl`, `py_client_order_ids`, `py_closing_order_id`, `py_commissions`, `py_duration_ns`, `py_entry`, `py_event_count`, `py_events`, `py_from_dict`, `py_id`, `py_instrument_id`, `py_is_closed`, `py_is_inverse`, `py_is_long`, `py_is_open`, `py_is_opposite_side`, `py_is_short`, `py_last_event`, `py_last_trade_id`, `py_multiplier`, `py_new` *(+25 more)*
**Impls**: `Position`
...
---
*Generated on 2025-11-18T21:55:03.193198Z*
