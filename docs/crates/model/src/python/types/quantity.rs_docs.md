# Documentation: `crates/model/src/python/types/quantity.rs`
**Generated:** 2025-11-15T19:40:03.138764Z
**File Size:** 13954 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/model/src/python/types/quantity.rs` within the repository.

**Classes defined:** Quantity

**Functions defined:** py_new, __reduce__, __richcmp__, __hash__, __add__, __radd__, __sub__, __rsub__, __mul__, __rmul__ and 25 more
...
#### `py_from_raw(raw: QuantityRaw, precision: u8)`
