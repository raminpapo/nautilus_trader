# Documentation: `crates/model/src/python/types/price.rs`
**Generated:** 2025-11-15T19:40:03.136090Z
...
- **Path:** `crates/model/src/python/types/price.rs`
- **Size:** 14,423 bytes
- **Lines:** 381
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/model/src/python/types/price.rs` within the repository.

**Classes defined:** Price

**Functions defined:** py_new, __reduce__, __richcmp__, __hash__, __add__, __radd__, __sub__, __rsub__, __mul__, __rmul__ and 26 more
...
#### `py_from_raw(raw: PriceRaw, precision: u8)`


#### `py_zero(precision: u8)`


#### `py_from_int(value: u64)`
