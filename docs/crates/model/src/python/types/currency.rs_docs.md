# Documentation: `crates/model/src/python/types/currency.rs`
**Generated:** 2025-11-15T19:40:03.130258Z
...
This file is located at `crates/model/src/python/types/currency.rs` within the repository.

**Classes defined:** Currency

**Functions defined:** py_new, __reduce__, _unpickle, __repr__, __str__, py_code, py_precision, py_iso4217, py_name, py_currency_type and 5 more
...
#### `py_currency_type(&self)`


#### `py_is_fiat(code: &str)`


#### `py_is_crypto(code: &str)`


#### `py_is_commodidity_backed(code: &str)`


#### `py_from_str(value: &str, strict: bool)`


#### `py_register(currency: Self, overwrite: bool)`
