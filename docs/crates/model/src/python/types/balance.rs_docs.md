# Documentation: `crates/model/src/python/types/balance.rs`
**Generated:** 2025-11-15T19:40:03.128689Z
**File Size:** 6196 bytes
**Extension:** .rs
**Type:** text
...
- **Path:** `crates/model/src/python/types/balance.rs`
- **Size:** 6,196 bytes
- **Lines:** 182
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/model/src/python/types/balance.rs` within the repository.

**Classes defined:** AccountBalance, MarginBalance

**Functions defined:** py_new, __repr__, __str__, py_from_dict, py_to_dict, py_new, __repr__, __str__, py_from_dict, py_to_dict
...
#### `py_new(total: Money, locked: Money, free: Money)`
...
#### `py_new(initial: Money, maintenance: Money, instrument: InstrumentId)`
