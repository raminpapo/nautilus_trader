# Documentation: `crates/model/src/python/defi/types.rs`
**Generated:** 2025-11-15T19:40:02.992719Z
...
This file is located at `crates/model/src/python/defi/types.rs` within the repository.

**Classes defined:** Chain, Token, Dex, Pool

**Functions defined:** py_new, __str__, __repr__, __hash__, __richcmp__, py_name, py_chain_id, py_hypersync_url, py_rpc_url, py_native_currency_decimals and 43 more
...
#### `py_new(name: Blockchain, chain_id: u32)`
...
#### `__richcmp__(&self, other: &Self, op: CompareOp)`
...
#### `py_hypersync_url(&self)`


#### `py_rpc_url(&self)`


#### `py_native_currency_decimals(&self)`


#### `py_set_rpc_url(&mut self, rpc_url: String)`


#### `py_from_chain_name(chain_name: &str)`


#### `py_from_chain_id(chain_id: u32)`
...
#### `py_factory_creation_block(&self)`


#### `py_pool_created_event(&self)`


#### `py_swap_created_event(&self)`


#### `py_mint_created_event(&self)`


#### `py_burn_created_event(&self)`
