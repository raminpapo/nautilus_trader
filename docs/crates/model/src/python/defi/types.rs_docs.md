...
- **Path**: `crates/model/src/python/defi/types.rs`
- **Size**: 9,936 bytes
- **Lines**: 412
- **Language**: Rust
...
This file is part of the NautilusTrader repository. It defines 53 function(s).
...
- **`py_chain_id()`**: Function defined in this file
- **`py_hypersync_url()`**: Function defined in this file
- **`py_rpc_url()`**: Function defined in this file
- **`py_native_currency_decimals()`**: Function defined in this file
- **`py_set_rpc_url()`**: Function defined in this file
- **`py_from_chain_name()`**: Function defined in this file
- **`py_from_chain_id()`**: Function defined in this file
- **`py_arbitrum_chain()`**: Function defined in this file
- **`py_new()`**: Function defined in this file
- **`__str__()`**: Function defined in this file
- **`__repr__()`**: Function defined in this file
- **`__hash__()`**: Function defined in this file
...
**Functions**: `__hash__`, `__repr__`, `__richcmp__`, `__str__`, `py_address`, `py_amm_type`, `py_arbitrum_chain`, `py_burn_created_event`, `py_chain`, `py_chain_id`, `py_creation_block`, `py_decimals`, `py_dex`, `py_factory`, `py_factory_creation_block`, `py_fee`, `py_from_chain_id`, `py_from_chain_name`, `py_hypersync_url`, `py_instrument_id`, `py_mint_created_event`, `py_name`, `py_native_currency_decimals`, `py_new`, `py_pool_created_event`, `py_rpc_url`, `py_set_rpc_url`, `py_swap_created_event`, `py_symbol`, `py_tick_spacing` *(+3 more)*
**Impls**: `Chain`, `Dex`, `Pool`, `Token`
...
---
*Generated on 2025-11-18T21:55:03.020112Z*
