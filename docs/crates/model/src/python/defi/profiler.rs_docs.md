# Documentation: `crates/model/src/python/defi/profiler.rs`
**Generated:** 2025-11-15T19:40:02.989109Z
...
This file is located at `crates/model/src/python/defi/profiler.rs` within the repository.

**Classes defined:** PoolProfiler

**Functions defined:** py_pool, py_instrument_id, py_is_initialized, py_current_tick, py_price_sqrt_ratio_x96, py_total_amount0_deposited, py_total_amount1_deposited, py_total_amount0_collected, py_total_amount1_collected, py_protocol_fees_token0 and 13 more
...
#### `py_current_tick(&self)`


#### `py_price_sqrt_ratio_x96(&self)`


#### `py_total_amount0_deposited(&self)`


#### `py_total_amount1_deposited(&self)`


#### `py_total_amount0_collected(&self)`


#### `py_total_amount1_collected(&self)`


#### `py_protocol_fees_token0(&self)`


#### `py_protocol_fees_token1(&self)`


#### `py_fee_protocol(&self)`


#### `py_get_active_liquidity(&self)`


#### `py_get_active_tick_count(&self)`


#### `py_get_total_tick_count(&self)`


#### `py_get_total_active_positions(&self)`


#### `py_get_total_inactive_positions(&self)`


#### `py_estimate_balance_of_token0(&self)`


#### `py_estimate_balance_of_token1(&self)`


#### `py_get_total_liquidity_all_positions(&self)`


#### `py_liquidity_utilization_rate(&self)`
