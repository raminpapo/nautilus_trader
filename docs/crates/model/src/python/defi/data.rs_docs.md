# Documentation: `crates/model/src/python/defi/data.rs`
**Generated:** 2025-11-15T19:40:02.981731Z
**File Size:** 21677 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/model/src/python/defi/data.rs` within the repository.

**Classes defined:** Block, PoolSwap, PoolLiquidityUpdate, PoolFeeCollect, PoolFlash, Transaction

**Functions defined:** py_chain, py_hash, py_number, py_parent_hash, py_miner, py_gas_limit, py_gas_used, py_base_fee_per_gas, py_blob_gas_used, py_excess_blob_gas and 101 more
...
#### `py_base_fee_per_gas(&self)`


#### `py_blob_gas_used(&self)`


#### `py_excess_blob_gas(&self)`


#### `py_l1_gas_price(&self)`


#### `py_l1_gas_used(&self)`


#### `py_l1_fee_scalar(&self)`
...
#### `py_pool_address(&self)`


#### `py_block(&self)`


#### `py_transaction_hash(&self)`


#### `py_transaction_index(&self)`
...
#### `__richcmp__(&self, other: &Self, op: pyo3::pyclass::CompareOp)`
