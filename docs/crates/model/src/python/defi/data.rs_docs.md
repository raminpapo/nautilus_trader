...
- **Path**: `crates/model/src/python/defi/data.rs`
- **Size**: 21,677 bytes
- **Lines**: 902
- **Language**: Rust
...
This file is part of the NautilusTrader repository. It defines 111 function(s).

## Detailed Walkthrough

### Functions
- **`py_chain()`**: Function defined in this file
- **`py_hash()`**: Function defined in this file
- **`py_number()`**: Function defined in this file
- **`py_parent_hash()`**: Function defined in this file
- **`py_miner()`**: Function defined in this file
- **`py_gas_limit()`**: Function defined in this file
- **`py_gas_used()`**: Function defined in this file
- **`py_base_fee_per_gas()`**: Function defined in this file
- **`py_blob_gas_used()`**: Function defined in this file
- **`py_excess_blob_gas()`**: Function defined in this file
- **`py_l1_gas_price()`**: Function defined in this file
- **`py_l1_gas_used()`**: Function defined in this file
- **`py_l1_fee_scalar()`**: Function defined in this file
- **`py_timestamp()`**: Function defined in this file
...
**Functions**: `__hash__`, `__repr__`, `__richcmp__`, `__str__`, `py_amount0`, `py_amount1`, `py_base_fee_per_gas`, `py_blob_gas_used`, `py_block`, `py_block_hash`, `py_block_number`, `py_chain`, `py_dex`, `py_excess_blob_gas`, `py_from`, `py_gas`, `py_gas_limit`, `py_gas_price`, `py_gas_used`, `py_hash`, `py_instrument_id`, `py_kind`, `py_l1_fee_scalar`, `py_l1_gas_price`, `py_l1_gas_used`, `py_log_index`, `py_miner`, `py_new`, `py_number`, `py_owner` *(+15 more)*
**Impls**: `Block`, `PoolFeeCollect`, `PoolFlash`, `PoolLiquidityUpdate`, `PoolSwap`, `Transaction`
...
---
*Generated on 2025-11-18T21:55:03.004301Z*
