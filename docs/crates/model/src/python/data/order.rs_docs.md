# Documentation: `crates/model/src/python/data/order.rs`
**Generated:** 2025-11-15T19:40:02.966057Z
**File Size:** 5680 bytes
**Extension:** .rs
**Type:** text
...
- **Path:** `crates/model/src/python/data/order.rs`
- **Size:** 5,680 bytes
- **Lines:** 192
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/model/src/python/data/order.rs` within the repository.

**Classes defined:** BookOrder

**Functions defined:** py_new, __richcmp__, __hash__, __repr__, __str__, py_side, py_price, py_size, py_order_id, py_fully_qualified_name and 10 more
...
#### `py_new(side: OrderSide, price: Price, size: Quantity, order_id: OrderId)`
...
#### `test_to_dict(stub_book_order: BookOrder)`


#### `test_from_dict(stub_book_order: BookOrder)`
