...
- **`py_order_id()`**: Function defined in this file
...
- **`test_from_dict()`**: Function defined in this file
...
**Functions**: `__hash__`, `__repr__`, `__richcmp__`, `__str__`, `py_exposure`, `py_from_dict`, `py_from_json`, `py_from_msgpack`, `py_fully_qualified_name`, `py_new`, `py_order_id`, `py_price`, `py_side`, `py_signed_size`, `py_size`, `py_to_dict`, `py_to_json_bytes`, `py_to_msgpack_bytes`, `test_from_dict`, `test_to_dict`
**Impls**: `BookOrder`
...
---
*Generated on 2025-11-18T21:55:02.985797Z*
