# Documentation: `crates/model/src/python/data/delta.rs`
**Generated:** 2025-11-15T19:40:02.954191Z
**File Size:** 11671 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/model/src/python/data/delta.rs` within the repository.

**Classes defined:** OrderBookDelta, OrderBookDelta

**Functions defined:** from_pyobject, py_new, __richcmp__, __hash__, __repr__, __str__, py_instrument_id, py_action, py_order, py_flags and 17 more
...
#### `test_to_dict(stub_delta: OrderBookDelta)`


#### `test_from_dict(stub_delta: OrderBookDelta)`


#### `test_from_pyobject(stub_delta: OrderBookDelta)`
