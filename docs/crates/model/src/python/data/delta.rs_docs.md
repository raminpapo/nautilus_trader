...
- **Path**: `crates/model/src/python/data/delta.rs`
- **Size**: 11,671 bytes
- **Lines**: 367
- **Language**: Rust
...
- **`py_order()`**: Function defined in this file
...
**Functions**: `__hash__`, `__repr__`, `__richcmp__`, `__str__`, `from_pyobject`, `py_action`, `py_as_pycapsule`, `py_flags`, `py_from_dict`, `py_from_json`, `py_from_msgpack`, `py_fully_qualified_name`, `py_get_fields`, `py_get_metadata`, `py_instrument_id`, `py_new`, `py_order`, `py_sequence`, `py_to_dict`, `py_to_json_bytes`, `py_to_msgpack_bytes`, `py_ts_event`, `py_ts_init`, `test_from_dict`, `test_from_pyobject`, `test_order_book_delta_py_new_with_zero_size_returns_error`, `test_to_dict`
**Impls**: `OrderBookDelta`
...
---
*Generated on 2025-11-18T21:55:02.962575Z*
