# Documentation: `crates/model/src/python/data/mod.rs`
**Generated:** 2025-11-15T19:40:02.964251Z
**File Size:** 10203 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/model/src/python/data/mod.rs` within the repository.

**Classes defined:** DataType

**Functions defined:** py_new, py_type_name, py_metadata, py_topic, data_to_pycapsule, drop_cvec_pycapsule, drop_cvec_pycapsule, pyobjects_to_book_deltas, pyobjects_to_quotes, pyobjects_to_trades and 5 more
...
#### `py_new(type_name: &str, metadata: Option<IndexMap<String, String>>)`
...
#### `data_to_pycapsule(py: Python, data: Data)`


#### `drop_cvec_pycapsule(capsule: &Bound<'_, PyAny>)`


#### `drop_cvec_pycapsule(_capsule: &Bound<'_, PyAny>)`


#### `pyobjects_to_book_deltas(data: Vec<Bound<'_, PyAny>>)`


#### `pyobjects_to_quotes(data: Vec<Bound<'_, PyAny>>)`


#### `pyobjects_to_trades(data: Vec<Bound<'_, PyAny>>)`


#### `pyobjects_to_bars(data: Vec<Bound<'_, PyAny>>)`


#### `pyobjects_to_mark_prices(data: Vec<Bound<'_, PyAny>>)`


#### `pyobjects_to_index_prices(data: Vec<Bound<'_, PyAny>>)`
...
#### `pyobjects_to_funding_rates(data: Vec<Bound<'_, PyAny>>)`
