# Documentation: `crates/model/src/python/data/bet.rs`
**Generated:** 2025-11-15T19:40:02.949719Z
...
This file is located at `crates/model/src/python/data/bet.rs` within the repository.

**Classes defined:** Bet, BetPosition

**Functions defined:** py_new, __richcmp__, __hash__, __repr__, __str__, py_from_stake_or_liability, py_from_stake, py_from_liability, py_price, py_stake and 24 more
...
#### `py_new(price: Decimal, stake: Decimal, side: BetSide)`
...
#### `py_from_stake(price: Decimal, stake: Decimal, side: BetSide)`


#### `py_from_liability(price: Decimal, liability: Decimal, side: BetSide)`
...
#### `py_outcome_win_payoff(&self)`


#### `py_outcome_lose_payoff(&self)`


#### `py_hedging_stake(&self, price: Decimal)`


#### `py_hedging_bet(&self, price: Decimal)`
...
#### `py_add_bet(&mut self, bet: &Bet)`


#### `py_as_bet(&self)`


#### `py_unrealized_pnl(&self, price: Decimal)`


#### `py_total_pnl(&self, price: Decimal)`


#### `py_flattening_bet(&self, price: Decimal)`


#### `py_reset(&mut self)`


#### `py_calc_bets_pnl(bets: Vec<Bet>)`
