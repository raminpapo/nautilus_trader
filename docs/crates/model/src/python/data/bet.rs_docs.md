...
- **Path**: `crates/model/src/python/data/bet.rs`
- **Size**: 7,455 bytes
- **Lines**: 274
- **Language**: Rust
...
- **`py_from_stake_or_liability()`**: Function defined in this file
- **`py_from_stake()`**: Function defined in this file
- **`py_from_liability()`**: Function defined in this file
- **`py_price()`**: Function defined in this file
- **`py_stake()`**: Function defined in this file
- **`py_side()`**: Function defined in this file
- **`py_exposure()`**: Function defined in this file
- **`py_liability()`**: Function defined in this file
- **`py_profit()`**: Function defined in this file
- **`py_outcome_win_payoff()`**: Function defined in this file
- **`py_outcome_lose_payoff()`**: Function defined in this file
- **`py_hedging_stake()`**: Function defined in this file
- **`py_hedging_bet()`**: Function defined in this file
- **`py_new()`**: Function defined in this file
- **`__repr__()`**: Function defined in this file
...
**Functions**: `__hash__`, `__repr__`, `__richcmp__`, `__str__`, `py_add_bet`, `py_as_bet`, `py_calc_bets_pnl`, `py_exposure`, `py_flattening_bet`, `py_from_liability`, `py_from_stake`, `py_from_stake_or_liability`, `py_hedging_bet`, `py_hedging_stake`, `py_inverse_probability_to_bet`, `py_liability`, `py_new`, `py_outcome_lose_payoff`, `py_outcome_win_payoff`, `py_price`, `py_probability_to_bet`, `py_profit`, `py_realized_pnl`, `py_reset`, `py_side`, `py_stake`, `py_total_pnl`, `py_unrealized_pnl`
**Impls**: `Bet`, `BetPosition`
...
---
*Generated on 2025-11-18T21:55:02.956386Z*
