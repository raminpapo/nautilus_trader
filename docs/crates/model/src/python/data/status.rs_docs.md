# Documentation: `crates/model/src/python/data/status.rs`
**Generated:** 2025-11-15T19:40:02.973674Z
...
This file is located at `crates/model/src/python/data/status.rs` within the repository.

**Classes defined:** InstrumentStatus, InstrumentStatus

**Functions defined:** from_pyobject, py_new, __richcmp__, __hash__, __repr__, __str__, py_instrument_id, py_action, py_ts_event, py_ts_init and 16 more
...
#### `py_is_short_sell_restricted(&self)`
...
#### `py_get_metadata(instrument_id: &InstrumentId)`
...
#### `test_to_dict(stub_instrument_status: InstrumentStatus)`


#### `test_from_dict(stub_instrument_status: InstrumentStatus)`


#### `test_from_pyobject(stub_instrument_status: InstrumentStatus)`
