...
- **Path**: `crates/model/src/python/data/status.rs`
- **Size**: 9,624 bytes
- **Lines**: 290
- **Language**: Rust
...
- **`py_action()`**: Function defined in this file
- **`py_ts_event()`**: Function defined in this file
- **`py_ts_init()`**: Function defined in this file
- **`py_reason()`**: Function defined in this file
- **`py_trading_event()`**: Function defined in this file
- **`py_is_trading()`**: Function defined in this file
- **`py_is_quoting()`**: Function defined in this file
- **`py_is_short_sell_restricted()`**: Function defined in this file
...
**Functions**: `__hash__`, `__repr__`, `__richcmp__`, `__str__`, `from_pyobject`, `py_action`, `py_from_dict`, `py_from_json`, `py_from_msgpack`, `py_fully_qualified_name`, `py_get_metadata`, `py_instrument_id`, `py_is_quoting`, `py_is_short_sell_restricted`, `py_is_trading`, `py_new`, `py_reason`, `py_to_dict`, `py_to_json_bytes`, `py_to_msgpack_bytes`, `py_trading_event`, `py_ts_event`, `py_ts_init`, `test_from_dict`, `test_from_pyobject`, `test_to_dict`
**Impls**: `InstrumentStatus`
...
---
*Generated on 2025-11-18T21:55:02.996724Z*
