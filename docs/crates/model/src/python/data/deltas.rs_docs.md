# Documentation: `crates/model/src/python/data/deltas.rs`
**Generated:** 2025-11-15T19:40:02.956135Z
...
This file is located at `crates/model/src/python/data/deltas.rs` within the repository.

**Classes defined:** OrderBookDeltas

**Functions defined:** py_new, __richcmp__, __hash__, __repr__, __str__, py_instrument_id, py_deltas, py_flags, py_sequence, py_ts_event and 4 more
...
#### `py_new(instrument_id: InstrumentId, deltas: Vec<OrderBookDelta>)`
...
#### `py_from_pycapsule(capsule: Bound<'_, PyAny>)`
