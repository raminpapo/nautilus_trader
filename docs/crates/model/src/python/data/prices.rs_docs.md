# Documentation: `crates/model/src/python/data/prices.rs`
**Generated:** 2025-11-15T19:40:02.968770Z
**File Size:** 17447 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/model/src/python/data/prices.rs` within the repository.

**Classes defined:** MarkPriceUpdate, MarkPriceUpdate, IndexPriceUpdate, IndexPriceUpdate

**Functions defined:** from_pyobject, py_new, __setstate__, __getstate__, __reduce__, _safe_constructor, __richcmp__, __hash__, __repr__, __str__ and 44 more
...
#### `test_mark_price_to_dict(mark_price: MarkPriceUpdate)`


#### `test_mark_price_from_dict(mark_price: MarkPriceUpdate)`
