# Documentation: `crates/model/src/python/data/trade.rs`
**Generated:** 2025-11-15T19:40:02.977291Z
**File Size:** 13821 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/model/src/python/data/trade.rs` within the repository.

**Classes defined:** TradeTick, TradeTick

**Functions defined:** from_pyobject, py_new, __setstate__, __getstate__, __reduce__, _safe_constructor, __richcmp__, __hash__, __repr__, __str__ and 21 more
...
#### `test_to_dict(stub_trade_ethusdt_buyer: TradeTick)`


#### `test_from_dict(stub_trade_ethusdt_buyer: TradeTick)`
