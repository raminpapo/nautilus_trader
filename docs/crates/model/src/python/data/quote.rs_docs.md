# Documentation: `crates/model/src/python/data/quote.rs`
**Generated:** 2025-11-15T19:40:02.971409Z
**File Size:** 15609 bytes
**Extension:** .rs
**Type:** text
...
- **Path:** `crates/model/src/python/data/quote.rs`
- **Size:** 15,609 bytes
- **Lines:** 468
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/model/src/python/data/quote.rs` within the repository.

**Classes defined:** QuoteTick, QuoteTick

**Functions defined:** from_pyobject, py_new, __setstate__, __getstate__, __reduce__, _safe_constructor, __richcmp__, __hash__, __repr__, __str__ and 24 more
...
#### `py_extract_price(&self, price_type: PriceType)`


#### `py_extract_size(&self, price_type: PriceType)`


#### `py_as_pycapsule(&self, py: Python<'_>)`
...
#### `test_to_dict(quote_ethusdt_binance: QuoteTick)`


#### `test_from_dict(quote_ethusdt_binance: QuoteTick)`


#### `test_from_pyobject(quote_ethusdt_binance: QuoteTick)`
