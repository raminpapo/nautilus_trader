...
- **Path**: `crates/model/src/python/data/bar.rs`
- **Size**: 15,533 bytes
- **Lines**: 517
- **Language**: Rust
...
This file is part of the NautilusTrader repository. It defines 48 function(s).
...
- **`py_timedelta()`**: Function defined in this file
- **`py_new()`**: Function defined in this file
- **`__richcmp__()`**: Function defined in this file
- **`__hash__()`**: Function defined in this file
- **`__repr__()`**: Function defined in this file
...
- **`py_new_composite()`**: Function defined in this file
- **`py_is_standard()`**: Function defined in this file
- **`py_is_composite()`**: Function defined in this file
- **`py_standard()`**: Function defined in this file
- **`py_composite()`**: Function defined in this file
...
**Functions**: `__hash__`, `__repr__`, `__richcmp__`, `__str__`, `from_pyobject`, `py_as_pycapsule`, `py_bar_type`, `py_close`, `py_composite`, `py_from_dict`, `py_from_json`, `py_from_msgpack`, `py_from_str`, `py_fully_qualified_name`, `py_get_fields`, `py_get_metadata`, `py_high`, `py_is_composite`, `py_is_standard`, `py_low`, `py_new`, `py_new_composite`, `py_open`, `py_standard`, `py_timedelta`, `py_to_dict`, `py_to_json_bytes`, `py_to_msgpack_bytes`, `py_ts_event`, `py_ts_init` *(+6 more)*
**Impls**: `Bar`, `BarSpecification`, `BarType`
...
---
*Generated on 2025-11-18T21:55:02.953100Z*
