# Documentation: `crates/model/src/python/data/bar.rs`
**Generated:** 2025-11-15T19:40:02.947313Z
**File Size:** 15533 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/model/src/python/data/bar.rs` within the repository.

**Classes defined:** BarSpecification, BarType, Bar, Bar

**Functions defined:** py_new, __richcmp__, __hash__, __repr__, __str__, py_fully_qualified_name, py_timedelta, py_new, __richcmp__, __hash__ and 38 more
...
#### `py_new(step: usize, aggregation: BarAggregation, price_type: PriceType)`
