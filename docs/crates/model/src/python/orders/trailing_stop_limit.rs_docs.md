...
- **Path**: `crates/model/src/python/orders/trailing_stop_limit.rs`
- **Size**: 5,899 bytes
- **Lines**: 166
- **Language**: Rust
...
use crate::{
    ...
    orders::{Order, OrderCore, TrailingStopLimitOrder, str_indexmap_to_ustr},
...
- **`py_signed_decimal_qty()`**: Function defined in this file
- **`py_would_reduce_only()`**: Function defined in this file
...
**Functions**: `py_apply`, `py_closing_side`, `py_create`, `py_events`, `py_new`, `py_opposite_side`, `py_order_type`, `py_signed_decimal_qty`, `py_status`, `py_would_reduce_only`
**Impls**: `TrailingStopLimitOrder`
...
---
*Generated on 2025-11-18T21:55:03.186272Z*
