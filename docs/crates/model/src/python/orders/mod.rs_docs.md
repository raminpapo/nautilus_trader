# Documentation: `crates/model/src/python/orders/mod.rs`
**Generated:** 2025-11-15T19:40:03.105617Z
...
- **Path:** `crates/model/src/python/orders/mod.rs`
- **Size:** 4,550 bytes
- **Lines:** 99
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/model/src/python/orders/mod.rs` within the repository.

**Functions defined:** pyobject_to_order_any, order_any_to_pyobject
...
#### `pyobject_to_order_any(py: Python, order: Py<PyAny>)`


#### `order_any_to_pyobject(py: Python, order: OrderAny)`
