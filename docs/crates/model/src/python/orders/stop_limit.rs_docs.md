# Documentation: stop_limit.rs

## File Metadata

- **Path**: `crates/model/src/python/orders/stop_limit.rs`
- **Size**: 20,393 bytes
- **Lines**: 607
- **Language**: Rust
...
This file is part of the NautilusTrader repository. It defines 50 function(s).
...
- **`py_create()`**: Function defined in this file
- **`py_opposite_side()`**: Function defined in this file
- **`py_closing_side()`**: Function defined in this file
...
- **`py_quantity()`**: Function defined in this file
- **`py_price()`**: Function defined in this file
- **`py_trigger_price()`**: Function defined in this file
- **`py_trigger_type()`**: Function defined in this file
- **`py_order_type()`**: Function defined in this file
- **`py_time_in_force()`**: Function defined in this file
- **`py_expire_time()`**: Function defined in this file
...
**Functions**: `__repr__`, `__richcmp__`, `__str__`, `py_apply`, `py_client_order_id`, `py_closing_side`, `py_contingency_type`, `py_create`, `py_display_qty`, `py_emulation_trigger`, `py_events`, `py_exec_algorithm_id`, `py_exec_algorithm_params`, `py_exec_spawn_id`, `py_expire_time`, `py_from_dict`, `py_has_price`, `py_has_trigger_price`, `py_init_event`, `py_init_id`, `py_instrument_id`, `py_is_aggressive`, `py_is_closed`, `py_is_open`, `py_is_passive`, `py_linked_order_ids`, `py_new`, `py_opposite_side`, `py_order_list_id`, `py_order_side` *(+20 more)*
**Impls**: `StopLimitOrder`

## Related Files

This file is located in `crates/model/src/python/orders/`. Related files may include:
...
---
*Generated on 2025-11-18T21:55:03.180643Z*
