# Documentation: `crates/model/src/python/orders/stop_limit.rs`
**Generated:** 2025-11-15T19:40:03.108592Z
**File Size:** 20390 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/model/src/python/orders/stop_limit.rs` within the repository.

**Classes defined:** StopLimitOrder

**Functions defined:** py_new, __richcmp__, __repr__, __str__, py_create, py_opposite_side, py_closing_side, py_status, py_trader_id, py_strategy_id and 40 more
...
#### `py_trigger_type(&self)`


#### `py_order_type(&self)`


#### `py_time_in_force(&self)`


#### `py_expire_time(&self)`


#### `py_order_status(&self)`
...
#### `py_init_event(&self, py: Python<'_>)`
...
#### `py_quote_quantity(&self)`


#### `py_display_qty(&self)`


#### `py_emulation_trigger(&self)`


#### `py_trigger_instrument_id(&self)`


#### `py_contingency_type(&self)`


#### `py_order_list_id(&self)`


#### `py_linked_order_ids(&self)`


#### `py_parent_order_id(&self)`


#### `py_exec_algorithm_id(&self)`


#### `py_exec_algorithm_params(&self)`


#### `py_exec_spawn_id(&self)`
...
#### `py_from_dict(values: &Bound<'_, PyDict>)`


#### `to_dict(&self, py: Python<'_>)`
