# Documentation: market.rs

## File Metadata

- **Path**: `crates/model/src/python/orders/market.rs`
- **Size**: 16,916 bytes
- **Lines**: 489
- **Language**: Rust
...
- **`py_commissions()`**: Function defined in this file
...
- **`py_init_id()`**: Function defined in this file
- **`py_ts_init()`**: Function defined in this file
- **`py_client_order_id()`**: Function defined in this file
- **`py_order_list_id()`**: Function defined in this file
- **`py_linked_order_ids()`**: Function defined in this file
- **`py_parent_order_id()`**: Function defined in this file
...
**Functions**: `__repr__`, `__richcmp__`, `__str__`, `py_account_id`, `py_apply`, `py_client_order_id`, `py_closing_side`, `py_commission`, `py_commissions`, `py_contingency_type`, `py_create`, `py_emulation_trigger`, `py_events`, `py_exec_algorithm_id`, `py_exec_algorithm_params`, `py_exec_spawn_id`, `py_from_dict`, `py_init_id`, `py_instrument_id`, `py_is_quote_quantity`, `py_is_reduce_only`, `py_linked_order_ids`, `py_new`, `py_opposite_side`, `py_order_list_id`, `py_order_type`, `py_parent_order_id`, `py_quantity`, `py_side`, `py_signed_decimal_qty` *(+8 more)*
**Impls**: `MarketOrder`
...
---
*Generated on 2025-11-18T21:55:03.168718Z*
