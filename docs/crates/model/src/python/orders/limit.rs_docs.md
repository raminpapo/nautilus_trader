# Documentation: `crates/model/src/python/orders/limit.rs`
**Generated:** 2025-11-15T19:40:03.096144Z
...
This file is located at `crates/model/src/python/orders/limit.rs` within the repository.

**Classes defined:** LimitOrder

**Functions defined:** py_new, __richcmp__, __repr__, __str__, py_create, py_opposite_side, py_closing_side, py_status, py_trader_id, py_strategy_id and 52 more
...
#### `py_is_post_only(&self)`


#### `py_is_reduce_only(&self)`


#### `py_is_quote_quantity(&self)`


#### `py_commission(&self, currency: &Currency)`
