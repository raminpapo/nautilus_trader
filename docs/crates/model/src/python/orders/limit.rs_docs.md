# Documentation: limit.rs

## File Metadata

- **Path**: `crates/model/src/python/orders/limit.rs`
- **Size**: 21,932 bytes
- **Lines**: 679
- **Language**: Rust
...
This file is part of the NautilusTrader repository. It defines 62 function(s).
...
- **`py_position_id()`**: Function defined in this file
- **`py_account_id()`**: Function defined in this file
- **`py_last_trade_id()`**: Function defined in this file
...
**Functions**: `__repr__`, `__richcmp__`, `__str__`, `py_account_id`, `py_apply`, `py_client_order_id`, `py_closing_side`, `py_commission`, `py_commissions`, `py_contingency_type`, `py_create`, `py_display_qty`, `py_emulation_trigger`, `py_events`, `py_exec_algorithm_id`, `py_exec_algorithm_params`, `py_exec_spawn_id`, `py_expire_time`, `py_expire_time_ns`, `py_filled_qty`, `py_from_dict`, `py_has_price`, `py_init_id`, `py_instrument_id`, `py_is_active_local`, `py_is_aggressive`, `py_is_closed`, `py_is_emulated`, `py_is_open`, `py_is_passive` *(+32 more)*
**Impls**: `LimitOrder`
...
---
*Generated on 2025-11-18T21:55:03.161786Z*
