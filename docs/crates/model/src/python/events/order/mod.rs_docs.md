# Documentation: `crates/model/src/python/events/order/mod.rs`
**Generated:** 2025-11-15T19:40:03.026373Z
...
- **Path:** `crates/model/src/python/events/order/mod.rs`
- **Size:** 5,818 bytes
- **Lines:** 129
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/model/src/python/events/order/mod.rs` within the repository.

**Functions defined:** order_event_to_pyobject, pyobject_to_order_event
...
#### `order_event_to_pyobject(py: Python, order_event: OrderEventAny)`


#### `pyobject_to_order_event(py: Python, order_event: Py<PyAny>)`
