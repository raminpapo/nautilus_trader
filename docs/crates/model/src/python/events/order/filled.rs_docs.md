...
- **Path**: `crates/model/src/python/events/order/filled.rs`
- **Size**: 8,074 bytes
- **Lines**: 272
- **Language**: Rust
...
- **`py_is_buy()`**: Function defined in this file
- **`py_is_sell()`**: Function defined in this file
...
**Functions**: `__repr__`, `__richcmp__`, `__str__`, `py_account_id`, `py_client_order_id`, `py_commission`, `py_currency`, `py_event_id`, `py_from_dict`, `py_instrument_id`, `py_is_buy`, `py_is_sell`, `py_last_px`, `py_last_qty`, `py_liquidity_side`, `py_new`, `py_order_side`, `py_order_type`, `py_position_id`, `py_reconciliation`, `py_strategy_id`, `py_to_dict`, `py_trade_id`, `py_trader_id`, `py_ts_event`, `py_ts_init`, `py_venue_order_id`
**Impls**: `OrderFilled`
...
---
*Generated on 2025-11-18T21:55:03.055205Z*
