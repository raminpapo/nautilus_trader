# Documentation: `crates/model/src/python/events/order/canceled.rs`
**Generated:** 2025-11-15T19:40:03.012456Z
**File Size:** 5107 bytes
**Extension:** .rs
**Type:** text
...
- **Path:** `crates/model/src/python/events/order/canceled.rs`
- **Size:** 5,107 bytes
- **Lines:** 162
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/model/src/python/events/order/canceled.rs` within the repository.

**Classes defined:** OrderCanceled
