# Documentation: `crates/model/src/python/events/order/initialized.rs`
**Generated:** 2025-11-15T19:40:03.024497Z
**File Size:** 11444 bytes
**Extension:** .rs
**Type:** text
...
- **Path:** `crates/model/src/python/events/order/initialized.rs`
- **Size:** 11,444 bytes
- **Lines:** 274
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/model/src/python/events/order/initialized.rs` within the repository.

**Classes defined:** OrderInitialized

**Functions defined:** py_new, __richcmp__, __repr__, __str__, py_order_type, py_from_dict, py_to_dict
