# Documentation: `crates/model/src/python/events/order/submitted.rs`
**Generated:** 2025-11-15T19:40:03.038240Z
**File Size:** 4112 bytes
**Extension:** .rs
**Type:** text
...
- **Path:** `crates/model/src/python/events/order/submitted.rs`
- **Size:** 4,112 bytes
- **Lines:** 137
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/model/src/python/events/order/submitted.rs` within the repository.

**Classes defined:** OrderSubmitted

**Functions defined:** py_new, __richcmp__, __repr__, __str__, py_from_dict, py_trader_id, py_strategy_id, py_instrument_id, py_client_order_id, py_account_id and 4 more
