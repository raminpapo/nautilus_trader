# Documentation: `crates/model/src/python/events/order/released.rs`
**Generated:** 2025-11-15T19:40:03.035248Z
...
- **Path:** `crates/model/src/python/events/order/released.rs`
- **Size:** 4,136 bytes
- **Lines:** 138
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/model/src/python/events/order/released.rs` within the repository.

**Classes defined:** OrderReleased

**Functions defined:** py_new, __richcmp__, __repr__, __str__, py_from_dict, py_trader_id, py_strategy_id, py_instrument_id, py_client_order_id, py_released_price and 4 more
