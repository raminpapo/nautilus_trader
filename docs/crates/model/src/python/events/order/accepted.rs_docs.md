# Documentation: `crates/model/src/python/events/order/accepted.rs`
**Generated:** 2025-11-15T19:40:03.007784Z
**File Size:** 4654 bytes
**Extension:** .rs
**Type:** text
...
- **Path:** `crates/model/src/python/events/order/accepted.rs`
- **Size:** 4,654 bytes
- **Lines:** 155
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/model/src/python/events/order/accepted.rs` within the repository.

**Classes defined:** OrderAccepted
