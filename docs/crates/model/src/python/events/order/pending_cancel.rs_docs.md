# Documentation: `crates/model/src/python/events/order/pending_cancel.rs`
**Generated:** 2025-11-15T19:40:03.030165Z
...
- **Path:** `crates/model/src/python/events/order/pending_cancel.rs`
- **Size:** 4,979 bytes
- **Lines:** 159
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/model/src/python/events/order/pending_cancel.rs` within the repository.

**Classes defined:** OrderPendingCancel

**Functions defined:** py_new, __richcmp__, __repr__, __str__, py_from_dict, py_trader_id, py_strategy_id, py_instrument_id, py_client_order_id, py_venue_order_id and 6 more
