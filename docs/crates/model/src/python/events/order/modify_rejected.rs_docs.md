# Documentation: `crates/model/src/python/events/order/modify_rejected.rs`
**Generated:** 2025-11-15T19:40:03.028400Z
...
- **Path:** `crates/model/src/python/events/order/modify_rejected.rs`
- **Size:** 5,509 bytes
- **Lines:** 179
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/model/src/python/events/order/modify_rejected.rs` within the repository.

**Classes defined:** OrderModifyRejected

**Functions defined:** py_new, __richcmp__, __repr__, __str__, py_from_dict, py_trader_id, py_strategy_id, py_instrument_id, py_client_order_id, py_venue_order_id and 7 more
