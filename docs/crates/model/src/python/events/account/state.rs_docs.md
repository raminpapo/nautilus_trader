# Documentation: `crates/model/src/python/events/account/state.rs`
**Generated:** 2025-11-15T19:40:03.004099Z
...
- **Path:** `crates/model/src/python/events/account/state.rs`
- **Size:** 6,783 bytes
- **Lines:** 190
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/model/src/python/events/account/state.rs` within the repository.

**Classes defined:** AccountState

**Functions defined:** py_new, account_id, account_type, base_currency, balances, margins, __richcmp__, __repr__, __str__, py_from_dict and 1 more
...
**Directory:** `crates/model/src/python/events/account`
