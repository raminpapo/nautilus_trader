...
- **`margins()`**: Function defined in this file
...
**Functions**: `__repr__`, `__richcmp__`, `__str__`, `account_id`, `account_type`, `balances`, `base_currency`, `margins`, `py_from_dict`, `py_new`, `py_to_dict`
**Impls**: `AccountState`

## Related Files

This file is located in `crates/model/src/python/events/account/`. Related files may include:
...
---
*Generated on 2025-11-18T21:55:03.033606Z*
