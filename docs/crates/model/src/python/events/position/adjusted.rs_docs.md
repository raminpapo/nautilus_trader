...
- **Path**: `crates/model/src/python/events/position/adjusted.rs`
- **Size**: 6,126 bytes
- **Lines**: 195
- **Language**: Rust
...
- **`py_adjustment_type()`**: Function defined in this file
- **`py_quantity_change()`**: Function defined in this file
- **`py_pnl_change()`**: Function defined in this file
...
**Functions**: `__repr__`, `__richcmp__`, `py_account_id`, `py_adjustment_type`, `py_event_id`, `py_from_dict`, `py_instrument_id`, `py_new`, `py_pnl_change`, `py_position_id`, `py_quantity_change`, `py_reason`, `py_strategy_id`, `py_to_dict`, `py_trader_id`, `py_ts_event`, `py_ts_init`
**Impls**: `PositionAdjusted`

## Related Files

This file is located in `crates/model/src/python/events/position/`. Related files may include:
...
---
*Generated on 2025-11-18T21:55:03.089367Z*
