# Documentation: `crates/model/src/python/mod.rs`
**Generated:** 2025-11-15T19:40:03.085486Z
**File Size:** 10610 bytes
**Extension:** .rs
**Type:** text
...
- **Path:** `crates/model/src/python/mod.rs`
- **Size:** 10,610 bytes
- **Lines:** 242
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/model/src/python/mod.rs` within the repository.

**Functions defined:** model
...
#### `model(_: Python<'_>, m: &Bound<'_, PyModule>)`
