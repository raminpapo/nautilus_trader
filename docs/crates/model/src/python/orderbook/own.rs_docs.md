# Documentation: `crates/model/src/python/orderbook/own.rs`
**Generated:** 2025-11-15T19:40:03.092853Z
**File Size:** 9012 bytes
**Extension:** .rs
**Type:** text
...
- **Path:** `crates/model/src/python/orderbook/own.rs`
- **Size:** 9,012 bytes
- **Lines:** 316
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/model/src/python/orderbook/own.rs` within the repository.

**Classes defined:** OwnBookOrder, OwnOrderBook

**Functions defined:** py_new, __richcmp__, __hash__, __repr__, __str__, py_client_order_id, py_side, py_price, py_size, py_order_type and 29 more
...
#### `py_new(instrument_id: InstrumentId)`
...
#### `py_add(&mut self, order: OwnBookOrder)`


#### `py_update(&mut self, order: OwnBookOrder)`


#### `py_delete(&mut self, order: OwnBookOrder)`


#### `py_clear(&mut self)`


#### `py_bid_client_order_ids(&self)`


#### `py_ask_client_order_ids(&self)`


#### `py_is_order_in_book(&self, client_order_id: &ClientOrderId)`


#### `py_orders_to_list(&self)`


#### `py_bids_to_list(&self)`


#### `py_asks_to_list(&self)`
...
#### `py_audit_open_orders(&mut self, open_order_ids: HashSet<ClientOrderId>)`
