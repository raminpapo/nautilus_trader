...
- **`py_signed_size()`**: Function defined in this file
- **`py_new()`**: Function defined in this file
- **`__repr__()`**: Function defined in this file
- **`__str__()`**: Function defined in this file
...
**Functions**: `__hash__`, `__repr__`, `__richcmp__`, `__str__`, `py_add`, `py_ask_client_order_ids`, `py_ask_quantity`, `py_asks_to_dict`, `py_asks_to_list`, `py_audit_open_orders`, `py_bid_client_order_ids`, `py_bid_quantity`, `py_bids_to_dict`, `py_bids_to_list`, `py_clear`, `py_client_order_id`, `py_delete`, `py_exposure`, `py_instrument_id`, `py_is_order_in_book`, `py_new`, `py_order_type`, `py_orders_to_list`, `py_pprint`, `py_price`, `py_reset`, `py_side`, `py_signed_size`, `py_size`, `py_status` *(+5 more)*
**Impls**: `OwnBookOrder`, `OwnOrderBook`
...
---
*Generated on 2025-11-18T21:55:03.156932Z*
