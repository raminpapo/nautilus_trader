...
- **Path**: `crates/model/src/enums.rs`
- **Size**: 43,424 bytes
- **Lines**: 1,673
- **Language**: Rust
...
- **`from_u16()`**: Function defined in this file
- **`from_u8()`**: Function defined in this file
- **`from_u8()`**: Function defined in this file
- **`opposite()`**: Function defined in this file
- **`from()`**: Function defined in this file
- **`from_u8()`**: Function defined in this file
- **`from_u8()`**: Function defined in this file
- **`from_u8()`**: Function defined in this file
- **`from_u16()`**: Function defined in this file
- **`as_specified()`**: Function defined in this file
- **`from_u8()`**: Function defined in this file
- **`opposite()`**: Function defined in this file
- **`as_order_side()`**: Function defined in this file
- **`cancellable_statuses_set()`**: Function defined in this file
- **`from_u8()`**: Function defined in this file
- **`as_specified()`**: Function defined in this file
- **`as_position_side()`**: Function defined in this file
- **`matches()`**: Function defined in this file
...
**Enums**: `AccountType`, `AggregationSource`, `AggressorSide`, `AssetClass`, `BarAggregation`, `BarIntervalType`, `BetSide`, `BookAction`, `BookType`, `ContingencyType`, `CurrencyType`, `InstrumentClass`, `InstrumentCloseType`, `LiquiditySide`, `MarketStatus`, `MarketStatusAction`, `OmsType`, `OptionKind`, `OrderSide`, `OrderSideSpecified`, `OrderStatus`, `OrderType`, `PositionAdjustmentType`, `PositionSide`, `PositionSideSpecified`, `PriceType`, `RecordFlag`, `TimeInForce`, `TradingState`, `TrailingOffsetType` *(+3 more)*
**Functions**: `as_order_side`, `as_position_side`, `as_specified`, `cancellable_statuses_set`, `from`, `from_u16`, `from_u8`, `matches`, `opposite`
**Impls**: `BetSide`, `From`, `FromU16`, `FromU8`, `OrderSide`, `OrderSideSpecified`, `OrderStatus`, `PositionSide`, `PositionSideSpecified`, `RecordFlag`
**Traits**: `FromU16`, `FromU8`
...
---
*Generated on 2025-11-18T21:55:02.445501Z*
