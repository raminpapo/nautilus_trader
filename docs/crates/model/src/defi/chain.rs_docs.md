# Documentation: `crates/model/src/defi/chain.rs`
**Generated:** 2025-11-15T19:40:02.519730Z
**File Size:** 28731 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/model/src/defi/chain.rs` within the repository.

**Classes defined:** Chain, Chain, Display

**Functions defined:** new, set_rpc_url, from_chain_id, from_chain_name, fmt, test_ethereum_chain, test_arbitrum_chain, test_chain_constructor, test_chain_set_rpc_url, test_chain_from_chain_id_valid and 5 more
...
#### `new(name: Blockchain, chain_id: u32)`


#### `set_rpc_url(&mut self, rpc: String)`


#### `from_chain_id(chain_id: u32)`


#### `from_chain_name(chain_name: &str)`
