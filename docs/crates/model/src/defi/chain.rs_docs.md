# Documentation: chain.rs

## File Metadata

- **Path**: `crates/model/src/defi/chain.rs`
- **Size**: 28,727 bytes
- **Lines**: 632
- **Language**: Rust
...
- **`set_rpc_url()`**: Function defined in this file
- **`from_chain_id()`**: Function defined in this file
- **`from_chain_name()`**: Function defined in this file
- **`fmt()`**: Function defined in this file
- **`test_ethereum_chain()`**: Function defined in this file
- **`test_arbitrum_chain()`**: Function defined in this file
- **`test_chain_constructor()`**: Function defined in this file
- **`test_chain_set_rpc_url()`**: Function defined in this file
- **`test_chain_from_chain_id_valid()`**: Function defined in this file
- **`test_chain_from_chain_id_invalid()`**: Function defined in this file
- **`test_chain_from_chain_name_valid()`**: Function defined in this file
- **`test_chain_from_chain_name_invalid()`**: Function defined in this file
- **`test_chain_from_chain_name_case_sensitive()`**: Function defined in this file
- **`test_chain_from_chain_name_consistency_with_id()`**: Function defined in this file

### Classes
- **`Chain`**: Class defined in this file
...
**Enums**: `Blockchain`
**Functions**: `fmt`, `from_chain_id`, `from_chain_name`, `new`, `set_rpc_url`, `test_arbitrum_chain`, `test_chain_constructor`, `test_chain_from_chain_id_invalid`, `test_chain_from_chain_id_valid`, `test_chain_from_chain_name_case_sensitive`, `test_chain_from_chain_name_consistency_with_id`, `test_chain_from_chain_name_invalid`, `test_chain_from_chain_name_valid`, `test_chain_set_rpc_url`, `test_ethereum_chain`
**Impls**: `Chain`, `Display`
**Structs**: `Chain`
...
---
*Generated on 2025-11-18T21:55:02.300867Z*
