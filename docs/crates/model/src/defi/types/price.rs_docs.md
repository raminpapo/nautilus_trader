...
- **Path**: `crates/model/src/defi/types/price.rs`
- **Size**: 8,674 bytes
- **Lines**: 246
- **Language**: Rust
...
### Functions
- **`from_wei()`**: Function defined in this file
- **`as_wei()`**: Function defined in this file
- **`test_from_wei_basic()`**: Function defined in this file
- **`test_precision_18_requires_from_wei()`**: Function defined in this file
- **`test_as_wei_basic()`**: Function defined in this file
- **`test_as_wei_wrong_precision()`**: Function defined in this file
- **`test_as_wei_negative_price()`**: Function defined in this file
- **`test_wei_round_trip()`**: Function defined in this file
- **`test_from_wei_zero()`**: Function defined in this file
- **`test_from_wei_very_large_value()`**: Function defined in this file
- **`test_from_wei_overflow()`**: Function defined in this file
- **`test_from_wei_small_amounts()`**: Function defined in this file
- **`test_from_wei_large_amounts()`**: Function defined in this file
- **`test_as_wei_precision_validation()`**: Function defined in this file
- **`test_arithmetic_operations_with_wei()`**: Function defined in this file
- **`test_comparison_operations_with_wei()`**: Function defined in this file
...
**Functions**: `as_wei`, `from_wei`, `test_arithmetic_operations_with_wei`, `test_as_wei_basic`, `test_as_wei_negative_price`, `test_as_wei_precision_validation`, `test_as_wei_wrong_precision`, `test_comparison_operations_with_wei`, `test_from_wei_basic`, `test_from_wei_large_amounts`, `test_from_wei_overflow`, `test_from_wei_small_amounts`, `test_from_wei_very_large_value`, `test_from_wei_zero`, `test_precision_18_requires_from_wei`, `test_wei_round_trip`
**Impls**: `Price`

## Related Files

This file is located in `crates/model/src/defi/types/`. Related files may include:
...
---
*Generated on 2025-11-18T21:55:02.430047Z*
