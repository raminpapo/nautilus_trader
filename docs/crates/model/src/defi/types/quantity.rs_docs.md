...
- **Path**: `crates/model/src/defi/types/quantity.rs`
- **Size**: 8,177 bytes
- **Lines**: 217
- **Language**: Rust
...
- **`test_from_wei_large_value()`**: Function defined in this file
- **`test_from_wei_small_value()`**: Function defined in this file
...
- **`test_from_wei_various_amounts()`**: Function defined in this file
...
**Functions**: `as_wei`, `from_wei`, `test_arithmetic_operations_with_wei`, `test_as_wei_basic`, `test_as_wei_precision_validation`, `test_as_wei_wrong_precision`, `test_comparison_operations_with_wei`, `test_from_wei_basic`, `test_from_wei_large_value`, `test_from_wei_overflow`, `test_from_wei_small_value`, `test_from_wei_various_amounts`, `test_from_wei_very_large_value`, `test_from_wei_zero`, `test_wei_round_trip`
**Impls**: `Quantity`
...
---
*Generated on 2025-11-18T21:55:02.433459Z*
