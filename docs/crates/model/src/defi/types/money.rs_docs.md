...
- **Path**: `crates/model/src/defi/types/money.rs`
- **Size**: 7,362 bytes
- **Lines**: 195
- **Language**: Rust
...
- **`to_wei()`**: Function defined in this file
- **`test_from_wei_one_eth()`**: Function defined in this file
- **`test_from_wei_small_amount()`**: Function defined in this file
- **`test_to_wei_one_eth()`**: Function defined in this file
- **`test_to_wei_small_amount()`**: Function defined in this file
- **`test_wei_roundtrip()`**: Function defined in this file
- **`test_from_wei_zero()`**: Function defined in this file
- **`test_from_wei_maximum_u128()`**: Function defined in this file
- **`test_from_wei_overflow()`**: Function defined in this file
- **`test_from_wei_different_tokens()`**: Function defined in this file
- **`test_arithmetic_with_wei_values()`**: Function defined in this file
- **`test_comparison_with_wei_values()`**: Function defined in this file
...
**Functions**: `from_wei`, `test_arithmetic_with_wei_values`, `test_comparison_with_wei_values`, `test_from_wei_different_tokens`, `test_from_wei_maximum_u128`, `test_from_wei_one_eth`, `test_from_wei_overflow`, `test_from_wei_small_amount`, `test_from_wei_zero`, `test_to_wei_one_eth`, `test_to_wei_small_amount`, `test_wei_roundtrip`, `to_wei`
**Impls**: `Money`
...
---
*Generated on 2025-11-18T21:55:02.426626Z*
