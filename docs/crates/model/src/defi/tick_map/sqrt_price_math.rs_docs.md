# Documentation: sqrt_price_math.rs

## File Metadata

- **Path**: `crates/model/src/defi/tick_map/sqrt_price_math.rs`
- **Size**: 29,010 bytes
- **Lines**: 796
- **Language**: Rust
...
### Functions
- **`encode_sqrt_ratio_x96()`**: Function defined in this file
- **`get_next_sqrt_price_from_amount0_rounding_up()`**: Function defined in this file
- **`get_next_sqrt_price_from_amount1_rounding_down()`**: Function defined in this file
- **`get_next_sqrt_price_from_input()`**: Function defined in this file
- **`get_next_sqrt_price_from_output()`**: Function defined in this file
- **`get_amount0_delta()`**: Function defined in this file
- **`get_amount1_delta()`**: Function defined in this file
- **`get_amounts_for_liquidity()`**: Function defined in this file
- **`expand_to_18_decimals()`**: Function defined in this file
- **`decode_sqrt_price_x96_to_price()`**: Function defined in this file
- **`decode_sqrt_price_x96_to_price_tokens_adjusted()`**: Function defined in this file
- **`test_if_get_next_sqrt_price_from_input_panic_if_price_zero()`**: Function defined in this file
- **`test_if_get_next_sqrt_price_from_input_panic_if_liquidity_zero()`**: Function defined in this file
- **`test_if_get_next_sqrt_price_from_input_panics_from_big_price()`**: Function defined in this file
- **`test_any_input_amount_cannot_underflow_the_price()`**: Function defined in this file
- **`test_returns_input_price_if_amount_in_is_zero_and_zero_for_one_true()`**: Function defined in this file
- **`test_returns_input_price_if_amount_in_is_zero_and_zero_for_one_false()`**: Function defined in this file
- **`test_returns_the_minimum_price_for_max_inputs()`**: Function defined in this file
- **`test_input_amount_of_0_1_token1()`**: Function defined in this file
- **`test_input_amount_of_0_1_token0()`**: Function defined in this file
...
**Functions**: `decode_sqrt_price_x96_to_price`, `decode_sqrt_price_x96_to_price_tokens_adjusted`, `encode_sqrt_ratio_x96`, `expand_to_18_decimals`, `get_amount0_delta`, `get_amount1_delta`, `get_amounts_for_liquidity`, `get_next_sqrt_price_from_amount0_rounding_up`, `get_next_sqrt_price_from_amount1_rounding_down`, `get_next_sqrt_price_from_input`, `get_next_sqrt_price_from_output`, `test_amount_in_greater_than_uint96_max_and_zero_for_one_true`, `test_any_input_amount_cannot_underflow_the_price`, `test_can_return_1_with_enough_amount_in_and_zero_for_one_true`, `test_decode_sqrt_price_x96_to_price_and_decimal_adjustments`, `test_encode_sqrt_ratio_x98_some_values`, `test_fails_if_output_amount_is_exactly_virtual_reserves_of_token0`, `test_fails_if_output_amount_is_exactly_virtual_reserves_of_token1`, `test_fails_if_output_amount_is_greater_than_virtual_reserves_of_token0`, `test_fails_if_output_amount_is_greater_than_virtual_reserves_of_token1`, `test_get_amount0_delta_returns_0_1_amount1_for_price_of_1_to_1_21`, `test_get_amount0_delta_returns_0_if_liquidity_is_0`, `test_get_amount0_delta_returns_0_if_prices_are_equal`, `test_get_amount0_delta_works_for_prices_that_overflow`, `test_get_amount1_delta_returns_0_1_amount1_for_price_of_1_to_1_21`, `test_get_amount1_delta_returns_0_if_liquidity_is_0`, `test_get_amount1_delta_returns_0_if_prices_are_equal`, `test_if_get_next_sqrt_price_from_input_panic_if_liquidity_zero`, `test_if_get_next_sqrt_price_from_input_panic_if_price_zero`, `test_if_get_next_sqrt_price_from_input_panics_from_big_price` *(+12 more)*
...
---
*Generated on 2025-11-18T21:55:02.407583Z*
