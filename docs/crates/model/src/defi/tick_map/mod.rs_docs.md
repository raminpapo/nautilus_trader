# Documentation: `crates/model/src/defi/tick_map/mod.rs`
**Generated:** 2025-11-15T19:40:02.584971Z
**File Size:** 22823 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/model/src/defi/tick_map/mod.rs` within the repository.

**Classes defined:** TickMap, Default, TickMap

**Functions defined:** default, new, get_tick, get_tick_or_init, get_fee_growth_inside, update_tick_data, update, cross_tick, active_tick_count, total_tick_count and 24 more
...
#### `new(tick_spacing: u32)`


#### `get_tick(&self, tick: i32)`


#### `get_tick_or_init(&mut self, tick: i32)`
...
#### `active_tick_count(&self)`


#### `total_tick_count(&self)`


#### `get_all_ticks(&self)`


#### `set_tick(&mut self, tick_data: PoolTick)`


#### `restore_tick(&mut self, tick_data: PoolTick)`


#### `clear(&mut self, tick: i32)`


#### `next_initialized_tick(&self, tick: i32, lte: bool)`


#### `is_tick_initialized(&self, tick: i32)`


#### `tick_map()`


#### `test_new_tick_maps(tick_map: TickMap)`


#### `test_get_fee_growth_inside_uninitialized_ticks(mut tick_map: TickMap)`


#### `test_get_fee_growth_inside_if_upper_tick_is_below(mut tick_map: TickMap)`


#### `test_get_fee_growth_inside_if_lower_tick_is_above(mut tick_map: TickMap)`


#### `test_get_fee_growth_inside_if_upper_and_lower_tick_are_initialized(mut tick_map: TickMap)`


#### `test_get_fee_growth_inside_with_overflow(mut tick_map: TickMap)`


#### `test_update_flips_from_zero_to_nonzero(mut tick_map: TickMap)`


#### `test_update_does_not_flip_from_nonzero_to_greater_nonzero(mut tick_map: TickMap)`


#### `test_update_flips_from_nonzero_to_zero(mut tick_map: TickMap)`


#### `test_update_does_not_flip_from_nonzero_to_lesser_nonzero(mut tick_map: TickMap)`


#### `test_update_reverts_if_total_liquidity_gross_exceeds_max()`


#### `test_update_nets_liquidity_based_on_upper_flag(mut tick_map: TickMap)`
...
#### `test_clear_deletes_all_data_in_tick(mut tick_map: TickMap)`


#### `test_cross_tick_flips_growth_variables(mut tick_map: TickMap)`
