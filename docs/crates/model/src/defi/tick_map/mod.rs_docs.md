...
- **Path**: `crates/model/src/defi/tick_map/mod.rs`
- **Size**: 22,823 bytes
- **Lines**: 632
- **Language**: Rust
...
This file is part of the NautilusTrader repository. It defines 34 function(s) and 1 class(es).
...
- **`get_tick()`**: Function defined in this file
- **`get_tick_or_init()`**: Function defined in this file
- **`get_fee_growth_inside()`**: Function defined in this file
- **`update_tick_data()`**: Function defined in this file
- **`update()`**: Function defined in this file
- **`cross_tick()`**: Function defined in this file
- **`active_tick_count()`**: Function defined in this file
- **`total_tick_count()`**: Function defined in this file
- **`get_all_ticks()`**: Function defined in this file
- **`set_tick()`**: Function defined in this file
- **`restore_tick()`**: Function defined in this file
- **`clear()`**: Function defined in this file
- **`next_initialized_tick()`**: Function defined in this file
- **`is_tick_initialized()`**: Function defined in this file
- **`tick_map()`**: Function defined in this file
- **`test_new_tick_maps()`**: Function defined in this file
- **`test_get_fee_growth_inside_uninitialized_ticks()`**: Function defined in this file
- **`test_get_fee_growth_inside_if_upper_tick_is_below()`**: Function defined in this file

*...and 14 more functions*

### Classes
- **`TickMap`**: Class defined in this file
...
**Functions**: `active_tick_count`, `clear`, `cross_tick`, `default`, `get_all_ticks`, `get_fee_growth_inside`, `get_tick`, `get_tick_or_init`, `is_tick_initialized`, `new`, `next_initialized_tick`, `restore_tick`, `set_tick`, `test_clear_deletes_all_data_in_tick`, `test_cross_tick_flips_growth_variables`, `test_get_fee_growth_inside_if_lower_tick_is_above`, `test_get_fee_growth_inside_if_upper_and_lower_tick_are_initialized`, `test_get_fee_growth_inside_if_upper_tick_is_below`, `test_get_fee_growth_inside_uninitialized_ticks`, `test_get_fee_growth_inside_with_overflow`, `test_new_tick_maps`, `test_update_assumes_all_growth_happens_below_ticks_lte_current_tick`, `test_update_does_not_flip_from_nonzero_to_greater_nonzero`, `test_update_does_not_flip_from_nonzero_to_lesser_nonzero`, `test_update_does_not_set_growth_fields_for_ticks_gt_current_tick`, `test_update_does_not_set_growth_fields_if_tick_already_initialized`, `test_update_flips_from_nonzero_to_zero`, `test_update_flips_from_zero_to_nonzero`, `test_update_nets_liquidity_based_on_upper_flag`, `test_update_reverts_if_total_liquidity_gross_exceeds_max` *(+4 more)*
**Impls**: `Default`, `TickMap`
**Structs**: `TickMap`
...
---
*Generated on 2025-11-18T21:55:02.402540Z*
