# Documentation: tick_bitmap.rs

## File Metadata

- **Path**: `crates/model/src/defi/tick_map/tick_bitmap.rs`
- **Size**: 14,572 bytes
- **Lines**: 363
- **Language**: Rust
...
### Functions
- **`tick_position()`**: Function defined in this file
- **`new()`**: Function defined in this file
- **`compress_tick()`**: Function defined in this file
- **`flip_tick()`**: Function defined in this file
- **`is_initialized()`**: Function defined in this file
- **`next_initialized_tick_within_one_word()`**: Function defined in this file
- **`tick_bitmap()`**: Function defined in this file
- **`test_tick_to_positions()`**: Function defined in this file
- **`test_flip_tick_toggle()`**: Function defined in this file
- **`test_multiple_ticks_same_word()`**: Function defined in this file
- **`test_multiple_ticks_different_words()`**: Function defined in this file
- **`test_next_initialized_tick_within_one_word_basic()`**: Function defined in this file
- **`test_next_initialized_tick_within_one_word_backward()`**: Function defined in this file
- **`test_next_initialized_tick_within_one_word_no_match()`**: Function defined in this file
- **`test_next_initialized_tick_with_negative_ticks()`**: Function defined in this file
- **`tick_bitmap_uniswapv3_testing()`**: Function defined in this file
- **`test_uniswapv3_test_cases_lte_false()`**: Function defined in this file
- **`test_uniswapv3_test_cases_lte_true()`**: Function defined in this file

### Classes
- **`TickBitmap`**: Class defined in this file
...
**Functions**: `compress_tick`, `flip_tick`, `is_initialized`, `new`, `next_initialized_tick_within_one_word`, `test_flip_tick_toggle`, `test_multiple_ticks_different_words`, `test_multiple_ticks_same_word`, `test_next_initialized_tick_with_negative_ticks`, `test_next_initialized_tick_within_one_word_backward`, `test_next_initialized_tick_within_one_word_basic`, `test_next_initialized_tick_within_one_word_no_match`, `test_tick_to_positions`, `test_uniswapv3_test_cases_lte_false`, `test_uniswapv3_test_cases_lte_true`, `tick_bitmap`, `tick_bitmap_uniswapv3_testing`, `tick_position`
**Impls**: `TickBitmap`
**Structs**: `TickBitmap`
...
---
*Generated on 2025-11-18T21:55:02.415622Z*
