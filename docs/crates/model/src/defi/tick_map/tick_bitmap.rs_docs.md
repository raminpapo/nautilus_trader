# Documentation: `crates/model/src/defi/tick_map/tick_bitmap.rs`
**Generated:** 2025-11-15T19:40:02.594011Z
...
This file is located at `crates/model/src/defi/tick_map/tick_bitmap.rs` within the repository.

**Classes defined:** TickBitmap, TickBitmap

**Functions defined:** tick_position, new, compress_tick, flip_tick, is_initialized, next_initialized_tick_within_one_word, tick_bitmap, test_tick_to_positions, test_flip_tick_toggle, test_multiple_ticks_same_word and 8 more
...
#### `tick_position(tick: i32)`


#### `new(tick_spacing: u32)`


#### `compress_tick(&self, tick: i32)`


#### `flip_tick(&mut self, tick: i32)`


#### `is_initialized(&self, tick: i32)`
...
#### `test_flip_tick_toggle(mut tick_bitmap: TickBitmap)`


#### `test_multiple_ticks_same_word(mut tick_bitmap: TickBitmap)`


#### `test_multiple_ticks_different_words(mut tick_bitmap: TickBitmap)`


#### `test_next_initialized_tick_within_one_word_basic(mut tick_bitmap: TickBitmap)`


#### `test_next_initialized_tick_within_one_word_backward(mut tick_bitmap: TickBitmap)`


#### `test_next_initialized_tick_within_one_word_no_match(tick_bitmap: TickBitmap)`


#### `test_next_initialized_tick_with_negative_ticks(mut tick_bitmap: TickBitmap)`


#### `tick_bitmap_uniswapv3_testing()`


#### `test_uniswapv3_test_cases_lte_false(tick_bitmap_uniswapv3_testing: TickBitmap)`


#### `test_uniswapv3_test_cases_lte_true(tick_bitmap_uniswapv3_testing: TickBitmap)`
