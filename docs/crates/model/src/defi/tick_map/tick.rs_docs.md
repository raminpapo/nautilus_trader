# Documentation: tick.rs

## File Metadata

- **Path**: `crates/model/src/defi/tick_map/tick.rs`
- **Size**: 10,703 bytes
- **Lines**: 296
- **Language**: Rust
...
- **`new()`**: Function defined in this file
- **`from_tick()`**: Function defined in this file
- **`update_liquidity()`**: Function defined in this file
- **`clear()`**: Function defined in this file
- **`is_active()`**: Function defined in this file
- **`update_fee_growth()`**: Function defined in this file
- **`get_max_tick()`**: Function defined in this file
- **`get_min_tick()`**: Function defined in this file
- **`test_update_liquidity_add_remove()`**: Function defined in this file
- **`test_update_liquidity_upper_tick()`**: Function defined in this file
- **`test_get_max_tick()`**: Function defined in this file
- **`test_get_min_tick()`**: Function defined in this file
- **`test_tick_spacing_symmetry()`**: Function defined in this file

### Classes
- **`CrossedTick`**: Class defined in this file
- **`PoolTick`**: Class defined in this file
...
**Functions**: `clear`, `from_tick`, `get_max_tick`, `get_min_tick`, `is_active`, `new`, `test_get_max_tick`, `test_get_min_tick`, `test_tick_spacing_symmetry`, `test_update_liquidity_add_remove`, `test_update_liquidity_upper_tick`, `update_fee_growth`, `update_liquidity`
**Impls**: `CrossedTick`, `PoolTick`
**Structs**: `CrossedTick`, `PoolTick`
...
---
*Generated on 2025-11-18T21:55:02.412030Z*
