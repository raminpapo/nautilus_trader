# Documentation: `crates/model/src/defi/tick_map/tick.rs`
**Generated:** 2025-11-15T19:40:02.591469Z
**File Size:** 10707 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/model/src/defi/tick_map/tick.rs` within the repository.

**Classes defined:** CrossedTick, PoolTick, CrossedTick, PoolTick

**Functions defined:** new, new, from_tick, update_liquidity, clear, is_active, update_fee_growth, get_max_tick, get_min_tick, test_update_liquidity_add_remove and 4 more
...
#### `new(tick: i32, zero_for_one: bool, fee_growth_0: U256, fee_growth_1: U256)`
...
#### `update_liquidity(&mut self, liquidity_delta: i128, upper: bool)`
...
#### `update_fee_growth(&mut self, fee_growth_global_0: U256, fee_growth_global_1: U256)`


#### `get_max_tick(tick_spacing: i32)`


#### `get_min_tick(tick_spacing: i32)`
