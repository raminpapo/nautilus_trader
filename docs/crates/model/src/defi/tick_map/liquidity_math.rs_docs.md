# Documentation: `crates/model/src/defi/tick_map/liquidity_math.rs`
**Generated:** 2025-11-15T19:40:02.581707Z
**File Size:** 4259 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/model/src/defi/tick_map/liquidity_math.rs` within the repository.

**Functions defined:** liquidity_math_add, tick_spacing_to_max_liquidity_per_tick, test_add, test_subtract_one, test_addition_overflow, test_subtraction_underflow_zero, test_subtraction_underflow, test_tick_spacing_to_max_liquidity
...
#### `liquidity_math_add(x: u128, y: i128)`


#### `tick_spacing_to_max_liquidity_per_tick(tick_spacing: i32)`
