# Documentation: liquidity_math.rs

## File Metadata

- **Path**: `crates/model/src/defi/tick_map/liquidity_math.rs`
- **Size**: 4,259 bytes
- **Lines**: 134
- **Language**: Rust
...
### Functions
- **`liquidity_math_add()`**: Function defined in this file
- **`tick_spacing_to_max_liquidity_per_tick()`**: Function defined in this file
- **`test_add()`**: Function defined in this file
- **`test_subtract_one()`**: Function defined in this file
- **`test_addition_overflow()`**: Function defined in this file
- **`test_subtraction_underflow_zero()`**: Function defined in this file
- **`test_subtraction_underflow()`**: Function defined in this file
- **`test_tick_spacing_to_max_liquidity()`**: Function defined in this file
...
**Functions**: `liquidity_math_add`, `test_add`, `test_addition_overflow`, `test_subtract_one`, `test_subtraction_underflow`, `test_subtraction_underflow_zero`, `test_tick_spacing_to_max_liquidity`, `tick_spacing_to_max_liquidity_per_tick`
...
---
*Generated on 2025-11-18T21:55:02.397677Z*
