# Documentation: full_math.rs

## File Metadata

- **Path**: `crates/model/src/defi/tick_map/full_math.rs`
- **Size**: 18,800 bytes
- **Lines**: 482
- **Language**: Rust
...
### Functions
- **`mul_div()`**: Function defined in this file
- **`mul_div_rounding_up()`**: Function defined in this file
- **`div_rounding_up()`**: Function defined in this file
- **`sqrt()`**: Function defined in this file
- **`truncate_to_u128()`**: Function defined in this file
- **`truncate_to_u256()`**: Function defined in this file
- **`truncate_to_i256()`**: Function defined in this file
- **`test_mul_div_reverts_denominator_zero()`**: Function defined in this file
- **`test_mul_div_reverts_output_overflow()`**: Function defined in this file
- **`test_mul_div_all_max_inputs()`**: Function defined in this file
- **`test_mul_div_accurate_without_phantom_overflow()`**: Function defined in this file
- **`test_mul_div_accurate_with_phantom_overflow()`**: Function defined in this file
- **`test_mul_div_accurate_with_phantom_overflow_repeating_decimal()`**: Function defined in this file
- **`test_mul_div_basic_cases()`**: Function defined in this file
- **`test_mul_div_rounding_up_reverts_denominator_zero()`**: Function defined in this file
- **`test_mul_div_rounding_up_reverts_output_overflow()`**: Function defined in this file
- **`test_mul_div_rounding_up_reverts_overflow_after_rounding_case_1()`**: Function defined in this file
- **`test_mul_div_rounding_up_reverts_overflow_after_rounding_case_2()`**: Function defined in this file
- **`test_mul_div_rounding_up_all_max_inputs()`**: Function defined in this file
- **`test_mul_div_rounding_up_accurate_without_phantom_overflow()`**: Function defined in this file

*...and 6 more functions*

### Classes
- **`FullMath`**: Class defined in this file
...
**Functions**: `div_rounding_up`, `mul_div`, `mul_div_rounding_up`, `sqrt`, `test_mul_div_accurate_with_phantom_overflow`, `test_mul_div_accurate_with_phantom_overflow_repeating_decimal`, `test_mul_div_accurate_without_phantom_overflow`, `test_mul_div_all_max_inputs`, `test_mul_div_basic_cases`, `test_mul_div_reverts_denominator_zero`, `test_mul_div_reverts_output_overflow`, `test_mul_div_rounding_up_accurate_with_phantom_overflow`, `test_mul_div_rounding_up_accurate_with_phantom_overflow_repeating_decimal`, `test_mul_div_rounding_up_accurate_without_phantom_overflow`, `test_mul_div_rounding_up_all_max_inputs`, `test_mul_div_rounding_up_basic_cases`, `test_mul_div_rounding_up_overflow_at_max`, `test_mul_div_rounding_up_reverts_denominator_zero`, `test_mul_div_rounding_up_reverts_output_overflow`, `test_mul_div_rounding_up_reverts_overflow_after_rounding_case_1`, `test_mul_div_rounding_up_reverts_overflow_after_rounding_case_2`, `test_truncate_to_u128_discards_upper_bits`, `test_truncate_to_u128_preserves_small_values`, `truncate_to_i256`, `truncate_to_u128`, `truncate_to_u256`
**Impls**: `FullMath`
**Structs**: `FullMath`
...
---
*Generated on 2025-11-18T21:55:02.395328Z*
