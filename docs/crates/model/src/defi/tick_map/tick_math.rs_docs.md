# Documentation: tick_math.rs

## File Metadata

- **Path**: `crates/model/src/defi/tick_map/tick_math.rs`
- **Size**: 17,809 bytes
- **Lines**: 480
- **Language**: Rust
...
### Functions
- **`get_sqrt_ratio_at_tick()`**: Function defined in this file
- **`get_tick_at_sqrt_ratio()`**: Function defined in this file
- **`test_get_sqrt_ratio_at_tick_zero()`**: Function defined in this file
- **`test_get_tick_at_sqrt_ratio()`**: Function defined in this file
- **`test_get_sqrt_ratio_at_tick_panics_above_max()`**: Function defined in this file
- **`test_get_sqrt_ratio_at_tick_panics_below_min()`**: Function defined in this file
- **`test_get_tick_at_sqrt_ratio_throws_for_too_low()`**: Function defined in this file
- **`test_get_tick_at_sqrt_ratio_throws_for_too_high()`**: Function defined in this file
- **`test_get_tick_at_sqrt_ratio_min_tick()`**: Function defined in this file
- **`test_get_tick_at_sqrt_ration_various_values()`**: Function defined in this file
- **`test_get_tick_at_sqrt_ratio_min_tick_plus_one()`**: Function defined in this file
- **`test_get_tick_at_sqrt_ratio_max_tick_minus_one()`**: Function defined in this file
- **`test_get_tick_at_sqrt_ratio_closest_to_max_tick()`**: Function defined in this file
- **`test_get_tick_at_sqrt_ratio_accuracy()`**: Function defined in this file
- **`test_get_tick_at_sqrt_ratio_specific_values()`**: Function defined in this file
- **`test_round_trip_tick_sqrt_ratio()`**: Function defined in this file
- **`test_extreme_ticks_behavior()`**: Function defined in this file
...
**Functions**: `get_sqrt_ratio_at_tick`, `get_tick_at_sqrt_ratio`, `test_extreme_ticks_behavior`, `test_get_sqrt_ratio_at_tick_panics_above_max`, `test_get_sqrt_ratio_at_tick_panics_below_min`, `test_get_sqrt_ratio_at_tick_zero`, `test_get_tick_at_sqrt_ratio`, `test_get_tick_at_sqrt_ratio_accuracy`, `test_get_tick_at_sqrt_ratio_closest_to_max_tick`, `test_get_tick_at_sqrt_ratio_max_tick_minus_one`, `test_get_tick_at_sqrt_ratio_min_tick`, `test_get_tick_at_sqrt_ratio_min_tick_plus_one`, `test_get_tick_at_sqrt_ratio_specific_values`, `test_get_tick_at_sqrt_ratio_throws_for_too_high`, `test_get_tick_at_sqrt_ratio_throws_for_too_low`, `test_get_tick_at_sqrt_ration_various_values`, `test_round_trip_tick_sqrt_ratio`
...
---
*Generated on 2025-11-18T21:55:02.420009Z*
