...
### Functions
- **`arbitrum()`**: Function defined in this file
- **`uniswap_v3()`**: Function defined in this file
- **`weth()`**: Function defined in this file
- **`usdc()`**: Function defined in this file
- **`rain_token()`**: Function defined in this file
- **`rain_pool()`**: Function defined in this file
...
**Functions**: `arbitrum`, `rain_pool`, `rain_token`, `uniswap_v3`, `usdc`, `weth`
...
---
*Generated on 2025-11-18T21:55:02.388875Z*
