# Documentation: `crates/model/src/defi/amm.rs`
**Generated:** 2025-11-15T19:40:02.515568Z
**File Size:** 12403 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/model/src/defi/amm.rs` within the repository.

**Classes defined:** Pool, Pool, Display, HasTsInit

**Functions defined:** new, to_full_spec_string, initialize, create_instrument_id, get_base_token, get_quote_token, is_base_quote_inverted, fmt, ts_init, test_pool_constructor_and_methods and 1 more
...
#### `to_full_spec_string(&self)`


#### `initialize(&mut self, sqrt_price_x96: U160)`


#### `create_instrument_id(chain: Blockchain, dex: &Dex, address: &Address)`


#### `get_base_token(&self)`


#### `get_quote_token(&self)`


#### `is_base_quote_inverted(&self)`
