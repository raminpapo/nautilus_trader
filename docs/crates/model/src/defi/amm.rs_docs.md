# Documentation: amm.rs

## File Metadata

- **Path**: `crates/model/src/defi/amm.rs`
- **Size**: 12,383 bytes
- **Lines**: 368
- **Language**: Rust
...
- **`to_full_spec_string()`**: Function defined in this file
- **`initialize()`**: Function defined in this file
- **`create_instrument_id()`**: Function defined in this file
- **`get_base_token()`**: Function defined in this file
- **`get_quote_token()`**: Function defined in this file
- **`is_base_quote_inverted()`**: Function defined in this file
- **`fmt()`**: Function defined in this file
- **`ts_init()`**: Function defined in this file
- **`test_pool_constructor_and_methods()`**: Function defined in this file
- **`test_pool_instrument_id_format()`**: Function defined in this file

### Classes
- **`Pool`**: Class defined in this file
...
**Functions**: `create_instrument_id`, `fmt`, `get_base_token`, `get_quote_token`, `initialize`, `is_base_quote_inverted`, `new`, `test_pool_constructor_and_methods`, `test_pool_instrument_id_format`, `to_full_spec_string`, `ts_init`
**Impls**: `Display`, `HasTsInit`, `Pool`
**Structs**: `Pool`
...
---
*Generated on 2025-11-18T21:55:02.293698Z*
