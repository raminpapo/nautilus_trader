# Documentation: liquidity.rs

## File Metadata

- **Path**: `crates/model/src/defi/data/liquidity.rs`
- **Size**: 5,217 bytes
- **Lines**: 156
- **Language**: Rust
...
### Classes
- **`PoolLiquidityUpdate`**: Class defined in this file
...
**Enums**: `PoolLiquidityUpdateType`
**Functions**: `fmt`, `new`
**Impls**: `Display`, `PoolLiquidityUpdate`
**Structs**: `PoolLiquidityUpdate`
...
---
*Generated on 2025-11-18T21:55:02.311583Z*
