# Documentation: swap.rs

## File Metadata

- **Path**: `crates/model/src/defi/data/swap.rs`
- **Size**: 6,715 bytes
- **Lines**: 188
- **Language**: Rust
...
### Classes
- **`RawSwapData`**: Class defined in this file
- **`PoolSwap`**: Class defined in this file
...
**Functions**: `calculate_trade_info`, `fmt`, `new`
**Impls**: `Display`, `PoolSwap`, `RawSwapData`
**Structs**: `PoolSwap`, `RawSwapData`
...
---
*Generated on 2025-11-18T21:55:02.316129Z*
