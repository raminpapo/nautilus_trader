# Documentation: `crates/model/src/defi/data/swap.rs`
**Generated:** 2025-11-15T19:40:02.531727Z
**File Size:** 6715 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/model/src/defi/data/swap.rs` within the repository.

**Classes defined:** RawSwapData, PoolSwap, RawSwapData, PoolSwap, Display

**Functions defined:** new, new, calculate_trade_info, fmt
...
#### `new(amount0: I256, amount1: I256, sqrt_price_x96: U160)`
