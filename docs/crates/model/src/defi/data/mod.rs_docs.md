# Documentation: `crates/model/src/defi/data/mod.rs`
**Generated:** 2025-11-15T19:40:02.529956Z
**File Size:** 5689 bytes
**Extension:** .rs
**Type:** text
...
- **Path:** `crates/model/src/defi/data/mod.rs`
- **Size:** 5,689 bytes
- **Lines:** 173
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/model/src/defi/data/mod.rs` within the repository.

**Classes defined:** DexPoolData, DefiData, Display, From, From, From, From, From

**Functions defined:** block_number, transaction_index, log_index, instrument_id, fmt, from, from, from, from, from
...
#### `from(value: PoolLiquidityUpdate)`


#### `from(value: PoolFeeCollect)`


#### `from(value: PoolSnapshot)`
