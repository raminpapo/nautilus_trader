...
### Functions
- **`block_number()`**: Function defined in this file
- **`transaction_index()`**: Function defined in this file
- **`log_index()`**: Function defined in this file
...
**Enums**: `DefiData`, `DexPoolData`
**Functions**: `block_number`, `fmt`, `from`, `instrument_id`, `log_index`, `transaction_index`
**Impls**: `DefiData`, `DexPoolData`, `Display`, `From`
...
---
*Generated on 2025-11-18T21:55:02.313615Z*
