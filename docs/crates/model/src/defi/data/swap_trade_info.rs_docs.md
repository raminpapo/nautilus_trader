# Documentation: `crates/model/src/defi/data/swap_trade_info.rs`
**Generated:** 2025-11-15T19:40:02.535081Z
**File Size:** 20501 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/model/src/defi/data/swap_trade_info.rs` within the repository.

**Classes defined:** SwapTradeInfo, SwapTradeInfoCalculator, SwapTradeInfo

**Functions defined:** set_spot_price_before, get_price_impact_bps, get_slippage_bps, new, zero_for_one, compute, order_side, quantity_base, quantity_quote, spot_price and 3 more
...
#### `set_spot_price_before(&mut self, price: Price)`


#### `get_price_impact_bps(&self)`


#### `get_slippage_bps(&self)`


#### `new(token0: &'a Token, token1: &'a Token, raw_swap_data: RawSwapData)`


#### `zero_for_one(&self)`


#### `compute(&self, sqrt_price_x96_before: Option<U160>)`
...
#### `test_swap_trade_info_calculator_calculations_buy(weth: Token, usdc: Token)`


#### `test_swap_trade_info_calculator_calculations_sell(weth: Token, usdc: Token)`
