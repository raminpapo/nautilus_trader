# Documentation: swap_trade_info.rs

## File Metadata

- **Path**: `crates/model/src/defi/data/swap_trade_info.rs`
- **Size**: 20,477 bytes
- **Lines**: 497
- **Language**: Rust
...
### Functions
- **`set_spot_price_before()`**: Function defined in this file
- **`get_price_impact_bps()`**: Function defined in this file
- **`get_slippage_bps()`**: Function defined in this file
- **`new()`**: Function defined in this file
- **`zero_for_one()`**: Function defined in this file
- **`compute()`**: Function defined in this file
- **`order_side()`**: Function defined in this file
- **`quantity_base()`**: Function defined in this file
- **`quantity_quote()`**: Function defined in this file
- **`spot_price()`**: Function defined in this file
- **`execution_price()`**: Function defined in this file
- **`test_swap_trade_info_calculator_calculations_buy()`**: Function defined in this file
- **`test_swap_trade_info_calculator_calculations_sell()`**: Function defined in this file

### Classes
- **`SwapTradeInfo`**: Class defined in this file
- **`SwapTradeInfoCalculator`**: Class defined in this file
...
**Functions**: `compute`, `execution_price`, `get_price_impact_bps`, `get_slippage_bps`, `new`, `order_side`, `quantity_base`, `quantity_quote`, `set_spot_price_before`, `spot_price`, `test_swap_trade_info_calculator_calculations_buy`, `test_swap_trade_info_calculator_calculations_sell`, `zero_for_one`
**Impls**: `SwapTradeInfo`, `SwapTradeInfoCalculator`
**Structs**: `SwapTradeInfo`, `SwapTradeInfoCalculator`
...
---
*Generated on 2025-11-18T21:55:02.322768Z*
