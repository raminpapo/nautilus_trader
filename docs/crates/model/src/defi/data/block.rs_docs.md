# Documentation: `crates/model/src/defi/data/block.rs`
**Generated:** 2025-11-15T19:40:02.522863Z
...
This file is located at `crates/model/src/defi/data/block.rs` within the repository.

**Classes defined:** BlockPosition, Block, BlockPosition, Block, PartialEq, Eq, Display

**Functions defined:** new, new, chain, set_chain, with_base_fee, with_blob_gas, with_l1_fee_components, eq, fmt, eth_rpc_block_response and 9 more
...
#### `new(number: u64, transaction_hash: String, index: u32, log_index: u32)`
...
#### `set_chain(&mut self, chain: Blockchain)`


#### `with_base_fee(mut self, fee: U256)`


#### `with_blob_gas(mut self, used: U256, excess: U256)`


#### `with_l1_fee_components(mut self, price: U256, gas_used: u64, scalar: u64)`
...
#### `test_ethereum_block_parsing(eth_rpc_block_response: String)`


#### `test_polygon_block_parsing(polygon_rpc_block_response: String)`


#### `test_base_block_parsing(base_rpc_block_response: String)`


#### `test_arbitrum_block_parsing(arbitrum_rpc_block_response: String)`
