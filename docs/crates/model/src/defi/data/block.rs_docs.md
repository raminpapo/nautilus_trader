# Documentation: block.rs

## File Metadata

- **Path**: `crates/model/src/defi/data/block.rs`
- **Size**: 22,112 bytes
- **Lines**: 530
- **Language**: Rust
...
- **`new()`**: Function defined in this file
- **`chain()`**: Function defined in this file
- **`set_chain()`**: Function defined in this file
- **`with_base_fee()`**: Function defined in this file
- **`with_blob_gas()`**: Function defined in this file
- **`with_l1_fee_components()`**: Function defined in this file
- **`eq()`**: Function defined in this file
- **`fmt()`**: Function defined in this file
- **`eth_rpc_block_response()`**: Function defined in this file
- **`polygon_rpc_block_response()`**: Function defined in this file
- **`base_rpc_block_response()`**: Function defined in this file
- **`arbitrum_rpc_block_response()`**: Function defined in this file
- **`test_block_set_chain()`**: Function defined in this file
- **`test_ethereum_block_parsing()`**: Function defined in this file
- **`test_polygon_block_parsing()`**: Function defined in this file
- **`test_base_block_parsing()`**: Function defined in this file
- **`test_arbitrum_block_parsing()`**: Function defined in this file
- **`test_block_builder_helpers()`**: Function defined in this file

### Classes
- **`BlockPosition`**: Class defined in this file
- **`Block`**: Class defined in this file
...
**Functions**: `arbitrum_rpc_block_response`, `base_rpc_block_response`, `chain`, `eq`, `eth_rpc_block_response`, `fmt`, `new`, `polygon_rpc_block_response`, `set_chain`, `test_arbitrum_block_parsing`, `test_base_block_parsing`, `test_block_builder_helpers`, `test_block_set_chain`, `test_ethereum_block_parsing`, `test_polygon_block_parsing`, `with_base_fee`, `with_blob_gas`, `with_l1_fee_components`
**Impls**: `Block`, `BlockPosition`, `Display`, `Eq`, `PartialEq`
**Structs**: `Block`, `BlockPosition`

## Related Files

This file is located in `crates/model/src/defi/data/`. Related files may include:
...
---
*Generated on 2025-11-18T21:55:02.305241Z*
