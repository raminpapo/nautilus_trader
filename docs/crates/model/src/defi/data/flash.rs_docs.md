# Documentation: `crates/model/src/defi/data/flash.rs`
**Generated:** 2025-11-15T19:40:02.526438Z
...
- **Path:** `crates/model/src/defi/data/flash.rs`
- **Size:** 4,279 bytes
- **Lines:** 119
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/model/src/defi/data/flash.rs` within the repository.

**Classes defined:** PoolFlash, PoolFlash, Display
