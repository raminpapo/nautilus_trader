# Documentation: transaction.rs

## File Metadata

- **Path**: `crates/model/src/defi/data/transaction.rs`
- **Size**: 13,448 bytes
- **Lines**: 350
- **Language**: Rust
...
- **`deserialize_chain()`**: Function defined in this file
- **`eth_rpc_response_eth_transfer_tx()`**: Function defined in this file
- **`eth_rpc_response_smart_contract_interaction_tx()`**: Function defined in this file
- **`test_eth_transfer_tx()`**: Function defined in this file
- **`test_smart_contract_interaction_tx()`**: Function defined in this file
- **`test_transaction_with_large_values()`**: Function defined in this file
- **`test_transaction_parsing_with_invalid_address_should_fail()`**: Function defined in this file
- **`test_transaction_parsing_with_unknown_chain_should_fail()`**: Function defined in this file
- **`test_transaction_creation_with_constructor()`**: Function defined in this file

### Classes
- **`Transaction`**: Class defined in this file
...
**Functions**: `deserialize_chain`, `eth_rpc_response_eth_transfer_tx`, `eth_rpc_response_smart_contract_interaction_tx`, `new`, `test_eth_transfer_tx`, `test_smart_contract_interaction_tx`, `test_transaction_creation_with_constructor`, `test_transaction_parsing_with_invalid_address_should_fail`, `test_transaction_parsing_with_unknown_chain_should_fail`, `test_transaction_with_large_values`
**Impls**: `Transaction`
**Structs**: `Transaction`
...
---
*Generated on 2025-11-18T21:55:02.326113Z*
