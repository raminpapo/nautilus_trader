# Documentation: `crates/model/src/defi/data/transaction.rs`
**Generated:** 2025-11-15T19:40:02.537828Z
...
This file is located at `crates/model/src/defi/data/transaction.rs` within the repository.

**Classes defined:** Transaction, Transaction

**Functions defined:** new, deserialize_chain, eth_rpc_response_eth_transfer_tx, eth_rpc_response_smart_contract_interaction_tx, test_eth_transfer_tx, test_smart_contract_interaction_tx, test_transaction_with_large_values, test_transaction_parsing_with_invalid_address_should_fail, test_transaction_parsing_with_unknown_chain_should_fail, test_transaction_creation_with_constructor
...
#### `deserialize_chain(deserializer: D)`
...
#### `test_eth_transfer_tx(eth_rpc_response_eth_transfer_tx: String)`


#### `test_smart_contract_interaction_tx(eth_rpc_response_smart_contract_interaction_tx: String)`
