# Documentation: dex.rs

## File Metadata

- **Path**: `crates/model/src/defi/dex.rs`
- **Size**: 13,197 bytes
- **Lines**: 374
- **Language**: Rust
...
### Functions
- **`from_dex_name()`**: Function defined in this file
- **`new()`**: Function defined in this file
- **`id()`**: Function defined in this file
- **`set_initialize_event()`**: Function defined in this file
- **`set_flash_event()`**: Function defined in this file
- **`fmt()`**: Function defined in this file
- **`from()`**: Function defined in this file
- **`from()`**: Function defined in this file
- **`test_dex_type_from_dex_name_valid()`**: Function defined in this file
- **`test_dex_type_from_dex_name_invalid()`**: Function defined in this file
- **`test_dex_type_from_dex_name_case_sensitive()`**: Function defined in this file
- **`test_dex_type_all_variants_mappable()`**: Function defined in this file
- **`test_dex_type_display()`**: Function defined in this file

### Classes
- **`Dex`**: Class defined in this file
...
**Enums**: `AmmType`, `DexType`
**Functions**: `fmt`, `from`, `from_dex_name`, `id`, `new`, `set_flash_event`, `set_initialize_event`, `test_dex_type_all_variants_mappable`, `test_dex_type_display`, `test_dex_type_from_dex_name_case_sensitive`, `test_dex_type_from_dex_name_invalid`, `test_dex_type_from_dex_name_valid`
**Impls**: `Dex`, `DexType`, `Display`, `From`
**Structs**: `Dex`
...
---
*Generated on 2025-11-18T21:55:02.330466Z*
