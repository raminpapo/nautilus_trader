# Documentation: `crates/model/src/defi/dex.rs`
**Generated:** 2025-11-15T19:40:02.540608Z
**File Size:** 13201 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/model/src/defi/dex.rs` within the repository.

**Classes defined:** Dex, DexType, Dex, Display, From, From

**Functions defined:** from_dex_name, new, id, set_initialize_event, set_flash_event, fmt, from, from, test_dex_type_from_dex_name_valid, test_dex_type_from_dex_name_invalid and 3 more
...
#### `set_initialize_event(&mut self, event: &str)`


#### `set_flash_event(&mut self, event: &str)`
