# Documentation: `crates/model/src/defi/hex.rs`
**Generated:** 2025-11-15T19:40:02.542843Z
**File Size:** 7844 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/model/src/defi/hex.rs` within the repository.

**Functions defined:** from_str_hex_to_u64, deserialize_hex_number, deserialize_opt_hex_u64, deserialize_opt_hex_u256, deserialize_hex_timestamp, test_from_str_hex_to_u64_valid, test_from_str_hex_to_u64_too_long, test_from_str_hex_to_u64_invalid_chars, test_deserialize_hex_timestamp, test_deserialize_opt_hex_u256_present and 1 more
...
#### `from_str_hex_to_u64(hex_string: &str)`


#### `deserialize_hex_number(deserializer: D)`


#### `deserialize_opt_hex_u64(deserializer: D)`


#### `deserialize_opt_hex_u256(deserializer: D)`


#### `deserialize_hex_timestamp(deserializer: D)`
