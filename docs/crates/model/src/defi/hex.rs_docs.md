# Documentation: hex.rs

## File Metadata

- **Path**: `crates/model/src/defi/hex.rs`
- **Size**: 7,840 bytes
- **Lines**: 206
- **Language**: Rust
...
### Functions
- **`from_str_hex_to_u64()`**: Function defined in this file
- **`deserialize_hex_number()`**: Function defined in this file
- **`deserialize_opt_hex_u64()`**: Function defined in this file
- **`deserialize_opt_hex_u256()`**: Function defined in this file
- **`deserialize_hex_timestamp()`**: Function defined in this file
- **`test_from_str_hex_to_u64_valid()`**: Function defined in this file
- **`test_from_str_hex_to_u64_too_long()`**: Function defined in this file
- **`test_from_str_hex_to_u64_invalid_chars()`**: Function defined in this file
- **`test_deserialize_hex_timestamp()`**: Function defined in this file
- **`test_deserialize_opt_hex_u256_present()`**: Function defined in this file
- **`test_deserialize_opt_hex_u256_null()`**: Function defined in this file
...
**Functions**: `deserialize_hex_number`, `deserialize_hex_timestamp`, `deserialize_opt_hex_u256`, `deserialize_opt_hex_u64`, `from_str_hex_to_u64`, `test_deserialize_hex_timestamp`, `test_deserialize_opt_hex_u256_null`, `test_deserialize_opt_hex_u256_present`, `test_from_str_hex_to_u64_invalid_chars`, `test_from_str_hex_to_u64_too_long`, `test_from_str_hex_to_u64_valid`
...
---
*Generated on 2025-11-18T21:55:02.333925Z*
