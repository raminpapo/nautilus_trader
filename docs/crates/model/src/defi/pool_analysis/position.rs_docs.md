...
- **Path**: `crates/model/src/defi/pool_analysis/position.rs`
- **Size**: 11,801 bytes
- **Lines**: 307
- **Language**: Rust
...
This file is part of the NautilusTrader repository. It defines 16 function(s) and 2 class(es).

## Detailed Walkthrough

### Functions
- **`new()`**: Function defined in this file
- **`get_position_key()`**: Function defined in this file
- **`update_liquidity()`**: Function defined in this file
- **`update_fees()`**: Function defined in this file
- **`collect_fees()`**: Function defined in this file
- **`update_amounts()`**: Function defined in this file
- **`is_empty()`**: Function defined in this file
- **`test_new_position()`**: Function defined in this file
- **`test_get_position_key()`**: Function defined in this file
- **`test_update_liquidity_positive()`**: Function defined in this file
- **`test_update_liquidity_negative()`**: Function defined in this file
- **`test_update_liquidity_negative_saturating()`**: Function defined in this file
- **`test_update_fees()`**: Function defined in this file
- **`test_collect_fees()`**: Function defined in this file
- **`test_collect_fees_more_than_owed()`**: Function defined in this file
- **`test_is_empty()`**: Function defined in this file

### Classes
- **`tracks`**: Class defined in this file
- **`PoolPosition`**: Class defined in this file
...
**Functions**: `collect_fees`, `get_position_key`, `is_empty`, `new`, `test_collect_fees`, `test_collect_fees_more_than_owed`, `test_get_position_key`, `test_is_empty`, `test_new_position`, `test_update_fees`, `test_update_liquidity_negative`, `test_update_liquidity_negative_saturating`, `test_update_liquidity_positive`, `update_amounts`, `update_fees`, `update_liquidity`
**Impls**: `PoolPosition`
**Structs**: `PoolPosition`, `tracks`
...
---
*Generated on 2025-11-18T21:55:02.344673Z*
