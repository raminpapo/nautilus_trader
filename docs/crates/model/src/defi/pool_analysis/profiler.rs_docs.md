...
- **Path**: `crates/model/src/defi/pool_analysis/profiler.rs`
- **Size**: 67,377 bytes
- **Lines**: 1,805
- **Language**: Rust
...
This file is part of the NautilusTrader repository. It defines 54 function(s) and 1 class(es).

## Detailed Walkthrough

### Functions
- **`new()`**: Function defined in this file
- **`initialize()`**: Function defined in this file
- **`check_if_initialized()`**: Function defined in this file
- **`process()`**: Function defined in this file
- **`check_if_already_processed()`**: Function defined in this file
- **`update_reporter_if_enabled()`**: Function defined in this file
- **`process_swap()`**: Function defined in this file
- **`execute_swap()`**: Function defined in this file
- **`simulate_swap_through_ticks()`**: Function defined in this file
- **`apply_swap_quote()`**: Function defined in this file
- **`quote_swap()`**: Function defined in this file
- **`swap_exact_in()`**: Function defined in this file
- **`swap_exact_out()`**: Function defined in this file
- **`swap_to_lower_sqrt_price()`**: Function defined in this file
- **`swap_to_higher_sqrt_price()`**: Function defined in this file
- **`size_for_impact_bps()`**: Function defined in this file
- **`size_for_impact_bps_detailed()`**: Function defined in this file
- **`validate_price_limit()`**: Function defined in this file
- **`process_mint()`**: Function defined in this file
- **`add_liquidity()`**: Function defined in this file

*...and 34 more functions*

### Classes
- **`PoolProfiler`**: Class defined in this file
...
**Functions**: `add_liquidity`, `apply_swap_quote`, `check_if_already_processed`, `check_if_initialized`, `cleanup_position_if_empty`, `enable_reporting`, `estimate_balance_of_token0`, `estimate_balance_of_token1`, `execute_burn`, `execute_flash`, `execute_mint`, `execute_swap`, `extract_snapshot`, `finalize_reporting`, `get_active_liquidity`, `get_active_positions`, `get_active_tick_count`, `get_active_tick_values`, `get_all_position_keys`, `get_all_positions`, `get_current_tick`, `get_position`, `get_tick`, `get_total_active_positions`, `get_total_events`, `get_total_inactive_positions`, `get_total_liquidity`, `get_total_liquidity_from_active_positions`, `get_total_tick_count`, `initialize` *(+24 more)*
**Impls**: `PoolProfiler`
**Structs**: `PoolProfiler`
...
---
*Generated on 2025-11-18T21:55:02.355407Z*
