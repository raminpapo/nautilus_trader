# Documentation: `crates/model/src/defi/pool_analysis/profiler.rs`
**Generated:** 2025-11-15T19:40:02.556060Z
**File Size:** 65499 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/model/src/defi/pool_analysis/profiler.rs` within the repository.

**Classes defined:** PoolProfiler, PoolProfiler

**Functions defined:** new, initialize, check_if_initialized, process, check_if_already_processed, update_reporter_if_enabled, process_swap, execute_swap, simulate_swap_through_ticks, apply_swap_quote and 42 more
...
#### `initialize(&mut self, price_sqrt_ratio_x96: U160)`


#### `check_if_initialized(&self)`


#### `process(&mut self, event: &DexPoolData)`


#### `check_if_already_processed(&self, block: u64, tx_idx: u32, log_idx: u32)`


#### `update_reporter_if_enabled(&mut self, current_block: u64)`


#### `process_swap(&mut self, swap: &PoolSwap)`
...
#### `apply_swap_quote(&mut self, swap_quote: &SwapQuote)`
...
#### `process_mint(&mut self, update: &PoolLiquidityUpdate)`
...
#### `process_burn(&mut self, update: &PoolLiquidityUpdate)`
...
#### `process_collect(&mut self, collect: &PoolFeeCollect)`


#### `process_flash(&mut self, flash: &PoolFlash)`
...
#### `update_flash_state(&mut self, paid0: U256, paid1: U256)`
...
#### `cleanup_position_if_empty(&mut self, position_key: &str)`


#### `liquidity_utilization_rate(&self)`


#### `validate_ticks(&self, tick_lower: i32, tick_upper: i32)`


#### `update_liquidity_analytics(&mut self)`


#### `get_active_liquidity(&self)`


#### `get_total_liquidity_from_active_positions(&self)`


#### `get_total_liquidity(&self)`


#### `restore_from_snapshot(&mut self, snapshot: PoolSnapshot)`


#### `get_active_tick_values(&self)`


#### `get_active_tick_count(&self)`
...
#### `get_active_positions(&self)`


#### `get_all_positions(&self)`


#### `get_all_position_keys(&self)`


#### `extract_snapshot(&self)`


#### `get_total_active_positions(&self)`


#### `get_total_inactive_positions(&self)`


#### `estimate_balance_of_token0(&self)`


#### `estimate_balance_of_token1(&self)`


#### `set_fee_growth_global(&mut self, fee_growth_global_0: U256, fee_growth_global_1: U256)`


#### `get_total_events(&self)`
