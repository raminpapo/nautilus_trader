# Documentation: `crates/model/src/defi/pool_analysis/tests.rs`
**Generated:** 2025-11-15T19:40:02.570426Z
**File Size:** 82607 bytes
**Extension:** .rs
**Type:** text
...
- **Path:** `crates/model/src/defi/pool_analysis/tests.rs`
- **Size:** 82,607 bytes
- **Lines:** 2,231
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/model/src/defi/pool_analysis/tests.rs` within the repository.

**Classes defined:** Position, PoolTestCase, ExpectedSwapResult

**Functions defined:** next_log_index, sqrt_price_x98, pool_definition, create_mint_event, create_burn_event, create_collect_event, create_block_position, lp_address, user_address, other_address and 51 more
...
#### `test_initialize_success(profiler: PoolProfiler)`


#### `test_initialize_already_initialized(mut profiler: PoolProfiler)`
...
#### `test_if_pool_process_fails_if_tick_lower_is_greater_than_tick_upper(mut profiler: PoolProfiler)`


#### `test_if_pool_process_fails_if_tick_are_not_multiple_of_tick_spacing(mut profiler: PoolProfiler)`


#### `test_if_pool_process_fails_if_outside_tick_bounds(mut profiler: PoolProfiler)`
...
#### `test_uni_pool_profiler_initial_state(uni_pool_profiler: PoolProfiler)`


#### `test_mint_above_current_price(mut uni_pool_profiler: PoolProfiler)`


#### `test_max_tick_with_high_leverage(mut uni_pool_profiler: PoolProfiler)`


#### `test_minting_works_for_max_tick(mut uni_pool_profiler: PoolProfiler)`


#### `test_if_removing_of_liquidity_works_after_mint(mut uni_pool_profiler: PoolProfiler)`
...
#### `test_burn_uninitialized_position(mut uni_pool_profiler: PoolProfiler)`


#### `test_position_fee_growth_and_tokens_owed_after_swaps(mut uni_pool_profiler: PoolProfiler)`
...
#### `test_mint_if_range_includes_current_price(mut uni_pool_profiler: PoolProfiler)`


#### `test_mint_for_min_and_max_ticks(mut uni_pool_profiler: PoolProfiler)`


#### `test_mint_then_burning_and_collecting(mut uni_pool_profiler: PoolProfiler)`


#### `test_mint_below_current_price_when_token1_only_changed(mut uni_pool_profiler: PoolProfiler)`


#### `test_mint_below_current_price_when_really_high_leverage(mut uni_pool_profiler: PoolProfiler)`
...
#### `test_collect_with_invalid_ticks_does_not_panic(mut uni_pool_profiler: PoolProfiler)`


#### `test_collect_works_with_multiple_lps(mut empty_low_fee_pool_profiler: PoolProfiler)`


#### `test_fee_growth_just_before_cap_binds(mut empty_low_fee_pool_profiler: PoolProfiler)`


#### `test_fee_growth_just_after_cap_binds(mut empty_low_fee_pool_profiler: PoolProfiler)`


#### `test_fee_growth_well_after_cap_binds(mut empty_low_fee_pool_profiler: PoolProfiler)`


#### `test_overflow_boundary_token0(mut empty_low_fee_pool_profiler: PoolProfiler)`


#### `test_overflow_boundary_token1(mut empty_low_fee_pool_profiler: PoolProfiler)`


#### `test_overflow_boundary_token0_and_token1(mut empty_low_fee_pool_profiler: PoolProfiler)`


#### `test_flash_increases_fee_growth_by_expected_amount(mut medium_fee_pool_profiler: PoolProfiler)`
...
**Directory:** `crates/model/src/defi/pool_analysis`
