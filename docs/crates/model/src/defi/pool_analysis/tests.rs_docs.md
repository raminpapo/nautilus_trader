...
This file is part of the NautilusTrader repository. It defines 62 function(s) and 3 class(es).

## Detailed Walkthrough

### Functions
- **`next_log_index()`**: Function defined in this file
- **`sqrt_price_x98()`**: Function defined in this file
- **`pool_definition()`**: Function defined in this file
- **`create_mint_event()`**: Function defined in this file
- **`create_burn_event()`**: Function defined in this file
- **`create_collect_event()`**: Function defined in this file
- **`create_block_position()`**: Function defined in this file
- **`lp_address()`**: Function defined in this file
- **`user_address()`**: Function defined in this file
- **`other_address()`**: Function defined in this file
- **`profiler()`**: Function defined in this file
- **`test_initial_state()`**: Function defined in this file
- **`test_initialize_success()`**: Function defined in this file
- **`test_initialize_already_initialized()`**: Function defined in this file
- **`test_if_starting_price_is_too_low()`**: Function defined in this file
- **`test_process_mint_with_fail_if_pool_not_initialized()`**: Function defined in this file
- **`test_if_pool_process_fails_if_tick_lower_is_greater_than_tick_upper()`**: Function defined in this file
- **`test_if_pool_process_fails_if_tick_are_not_multiple_of_tick_spacing()`**: Function defined in this file
- **`test_if_pool_process_fails_if_outside_tick_bounds()`**: Function defined in this file
- **`test_execute_mint_equivalence()`**: Function defined in this file

*...and 42 more functions*

### Classes
- **`Position`**: Class defined in this file
- **`PoolTestCase`**: Class defined in this file
- **`ExpectedSwapResult`**: Class defined in this file


## Keywords and Identifiers

Total unique keywords extracted: 66


**Enums**: `SwapTestCase`
**Functions**: `create_block_position`, `create_burn_event`, `create_collect_event`, `create_mint_event`, `empty_low_fee_pool_profiler`, `format_price`, `get_execution_price_string`, `low_fee_pool_profiler`, `lp_address`, `medium_fee_pool_profiler`, `next_log_index`, `other_address`, `pool_definition`, `pool_high_fee_1on1_price_2e18_max_liquidity`, `profiler`, `quote_swap`, `sqrt_price_x98`, `swap_exact_0_for_1_1e18`, `swap_exact_0_for_1_small_amount`, `swap_exact_1_for_0_small_amount`, `test_burn_uninitialized_position`, `test_collect_with_invalid_ticks_does_not_panic`, `test_collect_works_with_multiple_lps`, `test_does_not_clear_position_fee_growth_snapshot_if_no_more_liquidity`, `test_execute_burn_equivalence`, `test_execute_mint_equivalence`, `test_execute_swap_equivalence`, `test_fee_growth_just_after_cap_binds`, `test_fee_growth_just_before_cap_binds`, `test_fee_growth_well_after_cap_binds` *(+32 more)*
**Structs**: `ExpectedSwapResult`, `PoolTestCase`, `Position`

## Related Files

This file is located in `crates/model/src/defi/pool_analysis/`. Related files may include:
...
```bash
# For Python
pytest crates/model/src/defi/pool_analysis/tests.rs
...
---
*Generated on 2025-11-18T21:55:02.382497Z*
