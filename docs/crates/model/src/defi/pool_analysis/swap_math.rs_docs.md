# Documentation: swap_math.rs

## File Metadata

- **Path**: `crates/model/src/defi/pool_analysis/swap_math.rs`
- **Size**: 14,435 bytes
- **Lines**: 412
- **Language**: Rust
...
### Functions
- **`compute_swap_step()`**: Function defined in this file
- **`test_exact_amount_in_that_gets_capped_at_price_target_in_one_for_zero()`**: Function defined in this file
- **`test_exact_amount_in_that_is_fully_spent_in_one_for_zero()`**: Function defined in this file
- **`test_exact_amount_out_that_is_fully_received_in_one_for_zero()`**: Function defined in this file
- **`test_amount_out_is_capped_at_the_desired_amount_out()`**: Function defined in this file
- **`test_entire_input_amount_taken_as_fee()`**: Function defined in this file
- **`test_handles_intermediate_insufficient_liquidity_in_zero_for_one_exact_output_case()`**: Function defined in this file
- **`test_handles_intermediate_insufficient_liquidity_in_one_for_zero_exact_output_case()`**: Function defined in this file

### Classes
- **`SwapStepResult`**: Class defined in this file
...
**Functions**: `compute_swap_step`, `test_amount_out_is_capped_at_the_desired_amount_out`, `test_entire_input_amount_taken_as_fee`, `test_exact_amount_in_that_gets_capped_at_price_target_in_one_for_zero`, `test_exact_amount_in_that_is_fully_spent_in_one_for_zero`, `test_exact_amount_out_that_is_fully_received_in_one_for_zero`, `test_handles_intermediate_insufficient_liquidity_in_one_for_zero_exact_output_case`, `test_handles_intermediate_insufficient_liquidity_in_zero_for_one_exact_output_case`
**Structs**: `SwapStepResult`
...
---
*Generated on 2025-11-18T21:55:02.371156Z*
