# Documentation: `crates/model/src/defi/pool_analysis/snapshot.rs`
**Generated:** 2025-11-15T19:40:02.561211Z
**File Size:** 6583 bytes
**Extension:** .rs
**Type:** text
...
- **Path:** `crates/model/src/defi/pool_analysis/snapshot.rs`
- **Size:** 6,583 bytes
- **Lines:** 179
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/model/src/defi/pool_analysis/snapshot.rs` within the repository.

**Classes defined:** PoolSnapshot, PoolState, PoolAnalytics, PoolSnapshot, PoolState, Default, Default

**Functions defined:** new, new, default, default
...
#### `new(protocol_fees_token0: U256, protocol_fees_token1: U256, fee_protocol: u8)`
