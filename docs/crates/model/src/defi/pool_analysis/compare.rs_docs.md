# Documentation: `crates/model/src/defi/pool_analysis/compare.rs`
**Generated:** 2025-11-15T19:40:02.546164Z
...
- **Path:** `crates/model/src/defi/pool_analysis/compare.rs`
- **Size:** 6,893 bytes
- **Lines:** 187
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/model/src/defi/pool_analysis/compare.rs` within the repository.

**Functions defined:** compare_pool_profiler
...
#### `compare_pool_profiler(profiler: &PoolProfiler, snapshot: &PoolSnapshot)`
