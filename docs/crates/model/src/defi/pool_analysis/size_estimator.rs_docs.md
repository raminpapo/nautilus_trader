...
- **Path**: `crates/model/src/defi/pool_analysis/size_estimator.rs`
- **Size**: 13,394 bytes
- **Lines**: 397
- **Language**: Rust
...
This file is part of the NautilusTrader repository. It defines 8 function(s) and 3 class(es).

## Detailed Walkthrough

### Functions
- **`default()`**: Function defined in this file
- **`within_tolerance()`**: Function defined in this file
- **`accuracy_percent()`**: Function defined in this file
- **`estimate_max_size_for_impact()`**: Function defined in this file
- **`slippage_for_size_bps()`**: Function defined in this file
- **`binary_search_for_size()`**: Function defined in this file
- **`size_for_impact_bps()`**: Function defined in this file
- **`size_for_impact_bps_detailed()`**: Function defined in this file

### Classes
- **`EstimationConfig`**: Class defined in this file
- **`SizeForImpactResult`**: Class defined in this file
- **`BinarySearchState`**: Class defined in this file
...
**Functions**: `accuracy_percent`, `binary_search_for_size`, `default`, `estimate_max_size_for_impact`, `size_for_impact_bps`, `size_for_impact_bps_detailed`, `slippage_for_size_bps`, `within_tolerance`
**Impls**: `Default`, `SizeForImpactResult`
**Structs**: `BinarySearchState`, `EstimationConfig`, `SizeForImpactResult`
...
---
*Generated on 2025-11-18T21:55:02.364983Z*
