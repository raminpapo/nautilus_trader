...
- **Path**: `crates/model/src/defi/pool_analysis/quote.rs`
- **Size**: 14,847 bytes
- **Lines**: 411
- **Language**: Rust
...
- **`check_if_trade_info_initialized()`**: Function defined in this file
- **`calculate_trade_info()`**: Function defined in this file
- **`zero_for_one()`**: Function defined in this file
- **`total_fee()`**: Function defined in this file
- **`get_effective_fee_bps()`**: Function defined in this file
- **`total_crossed_ticks()`**: Function defined in this file
- **`get_output_amount()`**: Function defined in this file
- **`get_input_amount()`**: Function defined in this file
- **`get_price_impact_bps()`**: Function defined in this file
- **`get_slippage_bps()`**: Function defined in this file
- **`validate_slippage_tolerance()`**: Function defined in this file
- **`validate_exact_output()`**: Function defined in this file
- **`to_swap_event()`**: Function defined in this file
- **`test_swap_quote_sell()`**: Function defined in this file
- **`test_swap_quote_buy()`**: Function defined in this file

### Classes
- **`SwapQuote`**: Class defined in this file
...
**Functions**: `calculate_trade_info`, `check_if_trade_info_initialized`, `get_effective_fee_bps`, `get_input_amount`, `get_output_amount`, `get_price_impact_bps`, `get_slippage_bps`, `new`, `test_swap_quote_buy`, `test_swap_quote_sell`, `to_swap_event`, `total_crossed_ticks`, `total_fee`, `validate_exact_output`, `validate_slippage_tolerance`, `zero_for_one`
**Impls**: `SwapQuote`
**Structs**: `SwapQuote`
...
---
*Generated on 2025-11-18T21:55:02.359738Z*
