# Documentation: `crates/model/src/defi/pool_analysis/quote.rs`
**Generated:** 2025-11-15T19:40:02.559113Z
**File Size:** 14842 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/model/src/defi/pool_analysis/quote.rs` within the repository.

**Classes defined:** SwapQuote, SwapQuote

**Functions defined:** new, check_if_trade_info_initialized, calculate_trade_info, zero_for_one, total_fee, get_effective_fee_bps, total_crossed_ticks, get_output_amount, get_input_amount, get_price_impact_bps and 6 more
...
#### `check_if_trade_info_initialized(&mut self)`


#### `calculate_trade_info(&mut self, token0: &Token, token1: &Token)`
...
#### `get_effective_fee_bps(&self)`


#### `total_crossed_ticks(&self)`


#### `get_output_amount(&self)`


#### `get_input_amount(&self)`


#### `get_price_impact_bps(&mut self)`


#### `get_slippage_bps(&mut self)`


#### `validate_slippage_tolerance(&mut self, max_slippage_bps: u32)`


#### `validate_exact_output(&self, amount_out_requested: U256)`
...
#### `test_swap_quote_sell(rain_pool: SharedPool)`


#### `test_swap_quote_buy(rain_pool: SharedPool)`
