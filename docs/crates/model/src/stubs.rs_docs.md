...
- **Path**: `crates/model/src/stubs.rs`
- **Size**: 5,562 bytes
- **Lines**: 186
- **Language**: Rust
...
- **`stub_position_long()`**: Function defined in this file
- **`stub_position_short()`**: Function defined in this file
- **`stub_order_book_mbp_appl_xnas()`**: Function defined in this file
- **`stub_order_book_mbp()`**: Function defined in this file
...
**Functions**: `calculate_commission`, `stub_order_book_mbp`, `stub_order_book_mbp_appl_xnas`, `stub_position_long`, `stub_position_short`
...
---
*Generated on 2025-11-18T21:55:03.251496Z*
