# Documentation: `crates/model/src/accounts/any.rs`
**Generated:** 2025-11-15T19:40:02.436433Z
...
This file is located at `crates/model/src/accounts/any.rs` within the repository.

**Classes defined:** AccountAny, From, PartialEq

**Functions defined:** id, last_event, events, apply, balances, balances_locked, base_currency, from_events, calculate_pnls, calculate_commission and 3 more
...
#### `from_events(events: Vec<AccountState>)`
