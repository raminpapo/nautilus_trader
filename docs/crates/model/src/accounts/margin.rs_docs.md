...
This file is part of the NautilusTrader repository. It defines 65 function(s) and 1 class(es).

## Detailed Walkthrough

### Functions
- **`new()`**: Function defined in this file
- **`set_default_leverage()`**: Function defined in this file
- **`set_leverage()`**: Function defined in this file
- **`get_leverage()`**: Function defined in this file
- **`is_unleveraged()`**: Function defined in this file
- **`is_cash_account()`**: Function defined in this file
- **`is_margin_account()`**: Function defined in this file
- **`initial_margins()`**: Function defined in this file
- **`maintenance_margins()`**: Function defined in this file
- **`update_initial_margin()`**: Function defined in this file
- **`initial_margin()`**: Function defined in this file
- **`update_maintenance_margin()`**: Function defined in this file
- **`maintenance_margin()`**: Function defined in this file
- **`calculate_initial_margin()`**: Function defined in this file
- **`calculate_maintenance_margin()`**: Function defined in this file
- **`recalculate_balance()`**: Function defined in this file
...
### Classes
- **`MarginAccount`**: Class defined in this file
...
**Functions**: `account_type`, `apply`, `balance`, `balance_free`, `balance_locked`, `balance_total`, `balances`, `balances_free`, `balances_locked`, `balances_total`, `base_currency`, `calculate_balance_locked`, `calculate_commission`, `calculate_initial_margin`, `calculate_maintenance_margin`, `calculate_pnls`, `calculated_account_state`, `currencies`, `deref`, `deref_mut`, `eq`, `event_count`, `events`, `fmt`, `get_leverage`, `hash`, `id`, `initial_margin`, `initial_margins`, `is_cash_account` *(+33 more)*
**Impls**: `Account`, `Deref`, `DerefMut`, `Display`, `Eq`, `Hash`, `MarginAccount`, `PartialEq`
**Structs**: `MarginAccount`
...
---
*Generated on 2025-11-18T21:55:02.198289Z*
