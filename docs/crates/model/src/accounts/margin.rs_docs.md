# Documentation: `crates/model/src/accounts/margin.rs`
**Generated:** 2025-11-15T19:40:02.449323Z
**File Size:** 33163 bytes
**Extension:** .rs
**Type:** text
...
- **Path:** `crates/model/src/accounts/margin.rs`
- **Size:** 33,163 bytes
- **Lines:** 986
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/model/src/accounts/margin.rs` within the repository.

**Classes defined:** MarginAccount, MarginAccount, Deref, DerefMut, Account, PartialEq, Eq, Display, Hash

**Functions defined:** new, set_default_leverage, set_leverage, get_leverage, is_unleveraged, is_cash_account, is_margin_account, initial_margins, maintenance_margins, update_initial_margin and 55 more
...
#### `new(event: AccountState, calculate_account_state: bool)`


#### `set_default_leverage(&mut self, leverage: Decimal)`


#### `set_leverage(&mut self, instrument_id: InstrumentId, leverage: Decimal)`


#### `get_leverage(&self, instrument_id: &InstrumentId)`


#### `is_unleveraged(&self, instrument_id: InstrumentId)`
...
#### `initial_margins(&self)`


#### `maintenance_margins(&self)`


#### `update_initial_margin(&mut self, instrument_id: InstrumentId, margin_init: Money)`


#### `initial_margin(&self, instrument_id: InstrumentId)`
...
#### `maintenance_margin(&self, instrument_id: InstrumentId)`
...
#### `recalculate_balance(&mut self, currency: Currency)`
...
#### `purge_account_events(&mut self, ts_now: nautilus_core::UnixNanos, lookback_secs: u64)`
...
#### `test_display(margin_account: MarginAccount)`
...
#### `test_set_default_leverage(mut margin_account: MarginAccount)`
