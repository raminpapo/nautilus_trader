...
### Classes
- **`CashAccount`**: Class defined in this file
...
**Functions**: `account_type`, `apply`, `balance`, `balance_free`, `balance_locked`, `balance_total`, `balances`, `balances_free`, `balances_locked`, `balances_total`, `base_currency`, `calculate_balance_locked`, `calculate_commission`, `calculate_pnls`, `calculated_account_state`, `currencies`, `deref`, `deref_mut`, `eq`, `event_count`, `events`, `fmt`, `id`, `is_cash_account`, `is_margin_account`, `is_unleveraged`, `last_event`, `new`, `purge_account_events`, `recalculate_balance` *(+14 more)*
**Impls**: `Account`, `CashAccount`, `Deref`, `DerefMut`, `Display`, `Eq`, `PartialEq`
**Structs**: `CashAccount`
...
---
*Generated on 2025-11-18T21:55:02.187380Z*
