# Documentation: `crates/model/src/accounts/cash.rs`
**Generated:** 2025-11-15T19:40:02.444752Z
**File Size:** 22001 bytes
**Extension:** .rs
**Type:** text
...
- **Path:** `crates/model/src/accounts/cash.rs`
- **Size:** 22,001 bytes
- **Lines:** 661
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/model/src/accounts/cash.rs` within the repository.

**Classes defined:** CashAccount, CashAccount, Account, Deref, DerefMut, PartialEq, Eq, Display

**Functions defined:** new, is_cash_account, is_margin_account, is_unleveraged, recalculate_balance, id, account_type, base_currency, is_cash_account, is_margin_account and 36 more
...
#### `new(event: AccountState, calculate_account_state: bool, allow_borrowing: bool)`
...
#### `test_display(cash_account: CashAccount)`
...
#### `test_calculate_commission_fx_taker(cash_account_million_usd: CashAccount)`
