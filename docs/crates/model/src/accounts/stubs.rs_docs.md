# Documentation: `crates/model/src/accounts/stubs.rs`
**Generated:** 2025-11-15T19:40:02.453382Z
...
This file is located at `crates/model/src/accounts/stubs.rs` within the repository.

**Classes defined:** Default, Default

**Functions defined:** default, default, margin_account, cash_account, cash_account_million_usd, cash_account_multi, calculate_commission
...
#### `margin_account(margin_account_state: AccountState)`


#### `cash_account(cash_account_state: AccountState)`


#### `cash_account_million_usd(cash_account_state_million_usd: AccountState)`


#### `cash_account_multi(cash_account_state_multi: AccountState)`
