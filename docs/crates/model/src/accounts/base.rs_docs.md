# Documentation: `crates/model/src/accounts/base.rs`
**Generated:** 2025-11-15T19:40:02.440063Z
...
This file is located at `crates/model/src/accounts/base.rs` within the repository.

**Classes defined:** BaseAccount, BaseAccount

**Functions defined:** new, base_balance, base_balance_total, base_balances_total, base_balance_free, base_balances_free, base_balance_locked, base_balances_locked, base_last_event, update_balances and 7 more
...
#### `base_balance(&self, currency: Option<Currency>)`


#### `base_balance_total(&self, currency: Option<Currency>)`


#### `base_balances_total(&self)`


#### `base_balance_free(&self, currency: Option<Currency>)`


#### `base_balances_free(&self)`


#### `base_balance_locked(&self, currency: Option<Currency>)`


#### `base_balances_locked(&self)`


#### `base_last_event(&self)`


#### `update_balances(&mut self, balances: Vec<AccountBalance>)`


#### `update_commissions(&mut self, commission: Money)`


#### `base_apply(&mut self, event: AccountState)`


#### `base_purge_account_events(&mut self, ts_now: UnixNanos, lookback_secs: u64)`
