...
- **Path**: `crates/model/src/accounts/base.rs`
- **Size**: 14,726 bytes
- **Lines**: 417
- **Language**: Rust
...
- **`base_balance()`**: Function defined in this file
- **`base_balance_total()`**: Function defined in this file
- **`base_balances_total()`**: Function defined in this file
- **`base_balance_free()`**: Function defined in this file
- **`base_balances_free()`**: Function defined in this file
- **`base_balance_locked()`**: Function defined in this file
- **`base_balances_locked()`**: Function defined in this file
- **`base_last_event()`**: Function defined in this file
- **`update_balances()`**: Function defined in this file
- **`update_commissions()`**: Function defined in this file
- **`base_apply()`**: Function defined in this file
- **`base_purge_account_events()`**: Function defined in this file
- **`base_calculate_balance_locked()`**: Function defined in this file
- **`base_calculate_pnls()`**: Function defined in this file
- **`base_calculate_commission()`**: Function defined in this file
- **`test_base_purge_account_events_retains_latest_when_all_purged()`**: Function defined in this file

### Classes
- **`BaseAccount`**: Class defined in this file
...
**Functions**: `base_apply`, `base_balance`, `base_balance_free`, `base_balance_locked`, `base_balance_total`, `base_balances_free`, `base_balances_locked`, `base_balances_total`, `base_calculate_balance_locked`, `base_calculate_commission`, `base_calculate_pnls`, `base_last_event`, `base_purge_account_events`, `new`, `test_base_purge_account_events_retains_latest_when_all_purged`, `update_balances`, `update_commissions`
**Impls**: `BaseAccount`
**Structs**: `BaseAccount`
...
---
*Generated on 2025-11-18T21:55:02.180905Z*
