# Documentation: position.rs

## File Metadata

- **Path**: `crates/model/src/reports/position.rs`
- **Size**: 16,475 bytes
- **Lines**: 490
- **Language**: Rust
...
- **`has_venue_position_id()`**: Function defined in this file
- **`is_flat()`**: Function defined in this file
- **`is_long()`**: Function defined in this file
- **`is_short()`**: Function defined in this file
- **`fmt()`**: Function defined in this file
- **`test_position_status_report_long()`**: Function defined in this file
- **`test_position_status_report_short()`**: Function defined in this file
- **`test_position_status_report_flat()`**: Function defined in this file
- **`test_position_status_report_new_long()`**: Function defined in this file
- **`test_position_status_report_new_short()`**: Function defined in this file
- **`test_position_status_report_new_flat()`**: Function defined in this file
- **`test_position_status_report_with_generated_report_id()`**: Function defined in this file
- **`test_has_venue_position_id()`**: Function defined in this file
- **`test_is_flat()`**: Function defined in this file
- **`test_is_long()`**: Function defined in this file
- **`test_is_short()`**: Function defined in this file
- **`test_display()`**: Function defined in this file
- **`test_clone_and_equality()`**: Function defined in this file
- **`test_serialization_roundtrip()`**: Function defined in this file

*...and 6 more functions*

### Classes
- **`PositionStatusReport`**: Class defined in this file
...
**Functions**: `fmt`, `has_venue_position_id`, `is_flat`, `is_long`, `is_short`, `new`, `test_avg_px_open_none_default`, `test_avg_px_open_serialization`, `test_avg_px_open_with_different_sides`, `test_clone_and_equality`, `test_different_position_sides_not_equal`, `test_display`, `test_has_venue_position_id`, `test_is_flat`, `test_is_long`, `test_is_short`, `test_position_status_report_flat`, `test_position_status_report_long`, `test_position_status_report_new_flat`, `test_position_status_report_new_long`, `test_position_status_report_new_short`, `test_position_status_report_short`, `test_position_status_report_with_generated_report_id`, `test_serialization_roundtrip`, `test_signed_decimal_qty_calculation`, `test_with_avg_px_open`
**Impls**: `Display`, `PositionStatusReport`
**Structs**: `PositionStatusReport`
...
---
*Generated on 2025-11-18T21:55:03.249163Z*
