# Documentation: `crates/model/src/reports/mass_status.rs`
**Generated:** 2025-11-15T19:40:03.143678Z
**File Size:** 18590 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/model/src/reports/mass_status.rs` within the repository.

**Classes defined:** ExecutionMassStatus, ExecutionMassStatus, Display

**Functions defined:** new, order_reports, fill_reports, position_reports, add_order_reports, add_fill_reports, add_position_reports, fmt, test_execution_mass_status, create_test_order_report and 15 more
...
#### `position_reports(&self)`


#### `add_order_reports(&mut self, reports: Vec<OrderStatusReport>)`


#### `add_fill_reports(&mut self, reports: Vec<FillReport>)`


#### `add_position_reports(&mut self, reports: Vec<PositionStatusReport>)`
