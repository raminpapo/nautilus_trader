...
This file is part of the NautilusTrader repository. It defines 25 function(s) and 1 class(es).

## Detailed Walkthrough

### Functions
- **`new()`**: Function defined in this file
- **`order_reports()`**: Function defined in this file
- **`fill_reports()`**: Function defined in this file
- **`position_reports()`**: Function defined in this file
- **`add_order_reports()`**: Function defined in this file
- **`add_fill_reports()`**: Function defined in this file
- **`add_position_reports()`**: Function defined in this file
- **`fmt()`**: Function defined in this file
- **`test_execution_mass_status()`**: Function defined in this file
- **`create_test_order_report()`**: Function defined in this file
- **`create_test_fill_report()`**: Function defined in this file
- **`create_test_position_report()`**: Function defined in this file
- **`test_execution_mass_status_new()`**: Function defined in this file
- **`test_execution_mass_status_with_generated_report_id()`**: Function defined in this file
- **`test_add_order_reports()`**: Function defined in this file
- **`test_add_fill_reports()`**: Function defined in this file
- **`test_add_position_reports()`**: Function defined in this file
- **`test_add_multiple_fills_for_different_orders()`**: Function defined in this file
- **`test_comprehensive_mass_status()`**: Function defined in this file
- **`test_display()`**: Function defined in this file

*...and 5 more functions*

### Classes
- **`ExecutionMassStatus`**: Class defined in this file
...
**Functions**: `add_fill_reports`, `add_order_reports`, `add_position_reports`, `create_test_fill_report`, `create_test_order_report`, `create_test_position_report`, `fill_reports`, `fmt`, `new`, `order_reports`, `position_reports`, `test_add_empty_reports`, `test_add_fill_reports`, `test_add_multiple_fills_for_different_orders`, `test_add_order_reports`, `test_add_position_reports`, `test_clone_and_equality`, `test_comprehensive_mass_status`, `test_display`, `test_empty_mass_status_accessors`, `test_execution_mass_status`, `test_execution_mass_status_new`, `test_execution_mass_status_with_generated_report_id`, `test_overwrite_order_reports`, `test_serialization_roundtrip`
**Impls**: `Display`, `ExecutionMassStatus`
**Structs**: `ExecutionMassStatus`
...
---
*Generated on 2025-11-18T21:55:03.236474Z*
