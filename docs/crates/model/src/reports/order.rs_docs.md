...
- **Path**: `crates/model/src/reports/order.rs`
- **Size**: 25,822 bytes
- **Lines**: 738
- **Language**: Rust
...
This file is part of the NautilusTrader repository. It defines 33 function(s) and 1 class(es).

## Detailed Walkthrough

### Functions
- **`new()`**: Function defined in this file
- **`with_client_order_id()`**: Function defined in this file
- **`with_order_list_id()`**: Function defined in this file
- **`with_linked_order_ids()`**: Function defined in this file
- **`with_parent_order_id()`**: Function defined in this file
- **`with_venue_position_id()`**: Function defined in this file
- **`with_price()`**: Function defined in this file
- **`with_avg_px()`**: Function defined in this file
- **`with_trigger_price()`**: Function defined in this file
- **`with_trigger_type()`**: Function defined in this file
- **`with_limit_offset()`**: Function defined in this file
- **`with_trailing_offset()`**: Function defined in this file
- **`with_trailing_offset_type()`**: Function defined in this file
- **`with_display_qty()`**: Function defined in this file
- **`with_expire_time()`**: Function defined in this file
- **`with_post_only()`**: Function defined in this file
- **`with_reduce_only()`**: Function defined in this file
- **`with_cancel_reason()`**: Function defined in this file
- **`with_ts_triggered()`**: Function defined in this file
- **`with_contingency_type()`**: Function defined in this file

*...and 13 more functions*

### Classes
- **`OrderStatusReport`**: Class defined in this file
...
**Functions**: `fmt`, `new`, `test_clone_and_equality`, `test_display`, `test_order_status_report`, `test_order_status_report_builder_methods`, `test_order_status_report_different_order_types`, `test_order_status_report_different_statuses`, `test_order_status_report_new`, `test_order_status_report_partial_fill`, `test_order_status_report_with_all_timestamp_fields`, `test_order_status_report_with_generated_report_id`, `test_order_status_report_with_optional_fields`, `test_serialization_roundtrip`, `with_avg_px`, `with_cancel_reason`, `with_client_order_id`, `with_contingency_type`, `with_display_qty`, `with_expire_time`, `with_limit_offset`, `with_linked_order_ids`, `with_order_list_id`, `with_parent_order_id`, `with_post_only`, `with_price`, `with_reduce_only`, `with_trailing_offset`, `with_trailing_offset_type`, `with_trigger_price` *(+3 more)*
**Impls**: `Display`, `IntoIterator`, `OrderStatusReport`
**Structs**: `OrderStatusReport`

## Related Files

This file is located in `crates/model/src/reports/`. Related files may include:
...
---
*Generated on 2025-11-18T21:55:03.245393Z*
