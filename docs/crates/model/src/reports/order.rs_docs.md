# Documentation: `crates/model/src/reports/order.rs`
**Generated:** 2025-11-15T19:40:03.148204Z
**File Size:** 25822 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/model/src/reports/order.rs` within the repository.

**Classes defined:** OrderStatusReport, OrderStatusReport, IntoIterator, Display

**Functions defined:** new, with_client_order_id, with_order_list_id, with_linked_order_ids, with_parent_order_id, with_venue_position_id, with_price, with_avg_px, with_trigger_price, with_trigger_type and 23 more
...
#### `with_client_order_id(mut self, client_order_id: ClientOrderId)`


#### `with_order_list_id(mut self, order_list_id: OrderListId)`
...
#### `with_parent_order_id(mut self, parent_order_id: ClientOrderId)`


#### `with_venue_position_id(mut self, venue_position_id: PositionId)`


#### `with_price(mut self, price: Price)`


#### `with_avg_px(mut self, avg_px: f64)`


#### `with_trigger_price(mut self, trigger_price: Price)`


#### `with_trigger_type(mut self, trigger_type: TriggerType)`


#### `with_limit_offset(mut self, limit_offset: Decimal)`


#### `with_trailing_offset(mut self, trailing_offset: Decimal)`
...
#### `with_display_qty(mut self, display_qty: Quantity)`


#### `with_expire_time(mut self, expire_time: UnixNanos)`


#### `with_post_only(mut self, post_only: bool)`


#### `with_reduce_only(mut self, reduce_only: bool)`


#### `with_cancel_reason(mut self, cancel_reason: String)`


#### `with_ts_triggered(mut self, ts_triggered: UnixNanos)`


#### `with_contingency_type(mut self, contingency_type: ContingencyType)`
