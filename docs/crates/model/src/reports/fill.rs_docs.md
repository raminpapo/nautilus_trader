...
- **Path**: `crates/model/src/reports/fill.rs`
- **Size**: 11,570 bytes
- **Lines**: 347
- **Language**: Rust
...
- **`has_client_order_id()`**: Function defined in this file
- **`has_venue_position_id()`**: Function defined in this file
- **`fmt()`**: Function defined in this file
- **`test_fill_report()`**: Function defined in this file
- **`test_fill_report_new()`**: Function defined in this file
- **`test_fill_report_new_with_generated_report_id()`**: Function defined in this file
- **`test_has_client_order_id()`**: Function defined in this file
...
- **`test_fill_report_with_different_liquidity_sides()`**: Function defined in this file
- **`test_fill_report_with_different_order_sides()`**: Function defined in this file

### Classes
- **`FillReport`**: Class defined in this file
...
**Functions**: `fmt`, `has_client_order_id`, `has_venue_position_id`, `new`, `test_clone_and_equality`, `test_display`, `test_fill_report`, `test_fill_report_new`, `test_fill_report_new_with_generated_report_id`, `test_fill_report_with_different_liquidity_sides`, `test_fill_report_with_different_order_sides`, `test_has_client_order_id`, `test_has_venue_position_id`, `test_serialization_roundtrip`
**Impls**: `Display`, `FillReport`
**Structs**: `FillReport`
...
---
*Generated on 2025-11-18T21:55:03.232249Z*
