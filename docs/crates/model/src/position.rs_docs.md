...
This file is part of the NautilusTrader repository. It defines 81 function(s) and 1 class(es).

## Detailed Walkthrough

### Functions
- **`new()`**: Function defined in this file
- **`purge_events_for_order()`**: Function defined in this file
- **`apply()`**: Function defined in this file
- **`handle_buy_order_fill()`**: Function defined in this file
- **`handle_sell_order_fill()`**: Function defined in this file
- **`apply_adjustment()`**: Function defined in this file
- **`calculate_avg_px()`**: Function defined in this file
- **`calculate_avg_px_open_px()`**: Function defined in this file
- **`calculate_avg_px_close_px()`**: Function defined in this file
- **`calculate_points()`**: Function defined in this file
- **`calculate_points_inverse()`**: Function defined in this file
- **`calculate_return()`**: Function defined in this file
- **`calculate_pnl_raw()`**: Function defined in this file
- **`calculate_pnl()`**: Function defined in this file
- **`total_pnl()`**: Function defined in this file
- **`unrealized_pnl()`**: Function defined in this file
- **`closing_order_side()`**: Function defined in this file
- **`is_opposite_side()`**: Function defined in this file
...
Total unique keywords extracted: 86


**Functions**: `apply`, `apply_adjustment`, `calculate_avg_px`, `calculate_avg_px_close_px`, `calculate_avg_px_open_px`, `calculate_pnl`, `calculate_pnl_raw`, `calculate_points`, `calculate_points_inverse`, `calculate_return`, `client_order_ids`, `closing_order_side`, `commissions`, `eq`, `event_count`, `fmt`, `handle_buy_order_fill`, `handle_sell_order_fill`, `hash`, `is_closed`, `is_long`, `is_open`, `is_opposite_side`, `is_short`, `last_event`, `last_trade_id`, `new`, `notional_value`, `purge_events_for_order`, `symbol` *(+51 more)*
**Impls**: `Display`, `Eq`, `Hash`, `PartialEq`, `Position`
**Structs**: `Position`

## Related Files

This file is located in `crates/model/src/`. Related files may include:
...
---
*Generated on 2025-11-18T21:55:02.934591Z*
