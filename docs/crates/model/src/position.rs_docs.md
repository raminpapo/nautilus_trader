# Documentation: `crates/model/src/position.rs`
**Generated:** 2025-11-15T19:40:02.933472Z
**File Size:** 123783 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/model/src/position.rs` within the repository.

**Classes defined:** Position, Position, PartialEq, Eq, Hash, Display

**Functions defined:** new, purge_events_for_order, apply, handle_buy_order_fill, handle_sell_order_fill, apply_adjustment, calculate_avg_px, calculate_avg_px_open_px, calculate_avg_px_close_px, calculate_points and 71 more
...
#### `new(instrument: &InstrumentAny, fill: OrderFilled)`


#### `purge_events_for_order(&mut self, client_order_id: ClientOrderId)`


#### `apply(&mut self, fill: &OrderFilled)`


#### `handle_buy_order_fill(&mut self, fill: &OrderFilled)`


#### `handle_sell_order_fill(&mut self, fill: &OrderFilled)`


#### `apply_adjustment(&mut self, adjustment: PositionAdjusted)`
...
#### `calculate_avg_px_open_px(&self, last_px: f64, last_qty: f64)`


#### `calculate_avg_px_close_px(&self, last_px: f64, last_qty: f64)`


#### `calculate_points(&self, avg_px_open: f64, avg_px_close: f64)`


#### `calculate_points_inverse(&self, avg_px_open: f64, avg_px_close: f64)`


#### `calculate_return(&self, avg_px_open: f64, avg_px_close: f64)`
...
#### `calculate_pnl(&self, avg_px_open: f64, avg_px_close: f64, quantity: Quantity)`


#### `total_pnl(&self, last: Price)`


#### `unrealized_pnl(&self, last: Price)`


#### `closing_order_side(&self)`


#### `is_opposite_side(&self, side: OrderSide)`
...
#### `venue_order_ids(&self)`


#### `trade_ids(&self)`


#### `notional_value(&self, last: Price)`
...
#### `hash(&self, state: &mut H)`


#### `fmt(&self, f: &mut std::fmt::Formatter<'_>)`


#### `test_position_long_display(stub_position_long: Position)`


#### `test_position_short_display(stub_position_short: Position)`


#### `test_two_trades_with_same_trade_id_error(audusd_sim: CurrencyPair)`


#### `test_position_filled_with_buy_order(audusd_sim: CurrencyPair)`


#### `test_position_filled_with_sell_order(audusd_sim: CurrencyPair)`


#### `test_position_partial_fills_with_buy_order(audusd_sim: CurrencyPair)`


#### `test_position_partial_fills_with_two_sell_orders(audusd_sim: CurrencyPair)`


#### `test_position_filled_with_buy_order_then_sell_order(audusd_sim: CurrencyPair)`


#### `test_position_filled_with_sell_order_then_buy_order(audusd_sim: CurrencyPair)`


#### `test_position_filled_with_no_change(audusd_sim: CurrencyPair)`


#### `test_position_long_with_multiple_filled_orders(audusd_sim: CurrencyPair)`


#### `test_pnl_calculation_from_trading_technologies_example(currency_pair_ethusdt: CurrencyPair)`


#### `test_position_closed_and_reopened(audusd_sim: CurrencyPair)`
