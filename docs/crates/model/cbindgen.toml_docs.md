...
**Keys**: `after_includes`, `autogen_warning`, `exclude`, `include_version`, `includes`, `language`, `no_includes`, `rename_variants`, `sys_includes`, `tab_width`
**Sections**: `defines`, `enum`, `export`, `export.rename`
...
---
*Generated on 2025-11-18T21:55:02.166073Z*
