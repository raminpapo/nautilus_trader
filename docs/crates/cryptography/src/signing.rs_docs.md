# Documentation: `crates/cryptography/src/signing.rs`
**Generated:** 2025-11-15T19:40:01.959796Z
...
- **Path:** `crates/cryptography/src/signing.rs`
- **Size:** 6,728 bytes
- **Lines:** 189
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/cryptography/src/signing.rs` within the repository.

**Functions defined:** hmac_signature, rsa_signature, ed25519_signature, test_hmac_signature, test_rsa_signature_empty_query, test_rsa_signature_invalid_key, valid_ed25519_private_key, test_ed25519_signature
...
#### `hmac_signature(secret: &str, data: &str)`


#### `rsa_signature(private_key_pem: &str, data: &str)`


#### `ed25519_signature(private_key: &[u8], data: &str)`
...
#### `test_rsa_signature_empty_query(#[case] private_key_pem: &str, #[case] query_string: &str)`


#### `test_rsa_signature_invalid_key(#[case] private_key_pem: &str, #[case] query_string: &str)`


#### `valid_ed25519_private_key()`


#### `test_ed25519_signature(#[case] private_key_bytes: [u8; 32], #[case] query_string: &str)`
...
**Security:** This file may contain sensitive patterns: secret, private_key, auth. Ensure proper handling of secrets.
