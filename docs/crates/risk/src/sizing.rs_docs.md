# Documentation: `crates/risk/src/sizing.rs`
**Generated:** 2025-11-15T19:40:03.425564Z
**File Size:** 11151 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/risk/src/sizing.rs` within the repository.

**Functions defined:** calculate_fixed_risk_position_size, calculate_risk_ticks, calculate_riskable_money, instrument_gbpusd, test_calculate_with_zero_equity_returns_quantity_zero, test_calculate_with_zero_exchange_rate, test_calculate_with_zero_risk, test_calculate_single_unit_size, test_calculate_single_unit_with_exchange_rate, test_calculate_single_unit_size_when_risk_too_high and 4 more
...
#### `calculate_risk_ticks(entry: Price, stop_loss: Price, instrument: &InstrumentAny)`


#### `calculate_riskable_money(equity: Decimal, risk: Decimal, commission_rate: Decimal)`


#### `instrument_gbpusd()`


#### `test_calculate_with_zero_equity_returns_quantity_zero(instrument_gbpusd: InstrumentAny)`


#### `test_calculate_with_zero_exchange_rate(instrument_gbpusd: InstrumentAny)`


#### `test_calculate_with_zero_risk(instrument_gbpusd: InstrumentAny)`


#### `test_calculate_single_unit_size(instrument_gbpusd: InstrumentAny)`


#### `test_calculate_single_unit_with_exchange_rate(instrument_gbpusd: InstrumentAny)`


#### `test_calculate_single_unit_size_when_risk_too_high(instrument_gbpusd: InstrumentAny)`


#### `test_impose_hard_limit(instrument_gbpusd: InstrumentAny)`


#### `test_calculate_multiple_unit_size(instrument_gbpusd: InstrumentAny)`


#### `test_calculate_multiple_unit_size_larger_batches(instrument_gbpusd: InstrumentAny)`


#### `test_calculate_for_gbpusd_with_commission(instrument_gbpusd: InstrumentAny)`
