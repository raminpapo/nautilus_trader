# Documentation: `crates/risk/src/engine/tests.rs`
**Generated:** 2025-11-15T19:40:03.420514Z
**File Size:** 117582 bytes
**Extension:** .rs
**Type:** text
...
- **Path:** `crates/risk/src/engine/tests.rs`
- **Size:** 117,582 bytes
- **Lines:** 3,794
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/risk/src/engine/tests.rs` within the repository.

**Functions defined:** register_process_handler, test_deny_order_on_price_precision_exceeded, test_deny_order_exceeding_max_notional, process_order_event_handler, execute_order_event_handler, simple_cache, clock, max_order_submit, max_order_modify, max_notional_per_order and 70 more
...
#### `market_order_buy(instrument_eth_usdt: InstrumentAny)`


#### `market_order_sell(instrument_eth_usdt: InstrumentAny)`
...
#### `instrument_eth_usdt(crypto_perpetual_ethusdt: CryptoPerpetual)`


#### `instrument_xbtusd_bitmex(xbtusd_bitmex: CryptoPerpetual)`


#### `instrument_audusd(audusd_sim: CurrencyPair)`


#### `instrument_futures_spread(futures_spread_es: FuturesSpread)`


#### `instrument_option_spread(option_spread: OptionSpread)`
...
#### `order_submitted(order: &OrderAny)`


#### `order_accepted(order: &OrderAny, venue_order_id: Option<VenueOrderId>)`
...
#### `test_set_max_notional_per_order_changes_setting(instrument_audusd: InstrumentAny)`
