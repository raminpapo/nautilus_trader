...
This file is part of the NautilusTrader repository. It defines 80 function(s).

## Detailed Walkthrough

### Functions
- **`register_process_handler()`**: Function defined in this file
- **`test_deny_order_on_price_precision_exceeded()`**: Function defined in this file
- **`test_deny_order_exceeding_max_notional()`**: Function defined in this file
- **`process_order_event_handler()`**: Function defined in this file
- **`execute_order_event_handler()`**: Function defined in this file
- **`simple_cache()`**: Function defined in this file
- **`clock()`**: Function defined in this file
- **`max_order_submit()`**: Function defined in this file
- **`max_order_modify()`**: Function defined in this file
- **`max_notional_per_order()`**: Function defined in this file
- **`market_order_buy()`**: Function defined in this file
- **`market_order_sell()`**: Function defined in this file
- **`get_stub_submit_order()`**: Function defined in this file
- **`config_fixture()`**: Function defined in this file
- **`bitmex_cash_account_state_multi()`**: Function defined in this file
- **`get_process_order_event_handler_messages()`**: Function defined in this file
- **`get_execute_order_event_handler_messages()`**: Function defined in this file
- **`instrument_eth_usdt()`**: Function defined in this file
- **`instrument_xbtusd_bitmex()`**: Function defined in this file
- **`instrument_audusd()`**: Function defined in this file
...
**Functions**: `bitmex_cash_account_state_multi`, `clock`, `config_fixture`, `execute_order_event_handler`, `get_exec_engine`, `get_execute_order_event_handler_messages`, `get_process_order_event_handler_messages`, `get_risk_engine`, `get_stub_submit_order`, `instrument_audusd`, `instrument_eth_usdt`, `instrument_futures_spread`, `instrument_option_spread`, `instrument_xbtusd_bitmex`, `instrument_xbtusd_with_high_size_precision`, `market_order_buy`, `market_order_sell`, `max_notional_per_order`, `max_order_modify`, `max_order_submit`, `order_accepted`, `order_filled`, `order_submitted`, `process_order_event_handler`, `register_process_handler`, `simple_cache`, `test_bypass_config_risk_engine`, `test_check_orders_risk_allows_reduce_only_sell_with_cash_base_currency`, `test_check_orders_risk_allows_reduce_only_sell_with_multi_currency_cash_account`, `test_check_orders_risk_non_reduce_sell_denies_on_free_balance` *(+50 more)*

## Related Files

This file is located in `crates/risk/src/engine/`. Related files may include:
...
```bash
# For Python
pytest crates/risk/src/engine/tests.rs
...
---
*Generated on 2025-11-18T21:55:03.665169Z*
