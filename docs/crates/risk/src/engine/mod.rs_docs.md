...
- **`create_submit_order_throttler()`**: Function defined in this file
- **`create_modify_order_throttler()`**: Function defined in this file
- **`handle_submit_order_cache()`**: Function defined in this file
- **`get_existing_order()`**: Function defined in this file
- **`create_order_denied()`**: Function defined in this file
- **`create_modify_rejected()`**: Function defined in this file
- **`execute()`**: Function defined in this file
- **`process()`**: Function defined in this file
- **`set_trading_state()`**: Function defined in this file
- **`set_max_notional_per_order()`**: Function defined in this file
...
- **`check_order()`**: Function defined in this file
- **`check_order_price()`**: Function defined in this file
- **`check_order_quantity()`**: Function defined in this file
- **`check_orders_risk()`**: Function defined in this file

*...and 9 more functions*

### Classes
- **`RiskEngine`**: Class defined in this file
...
**Functions**: `check_order`, `check_order_price`, `check_order_quantity`, `check_orders_risk`, `check_price`, `check_quantity`, `create_modify_order_throttler`, `create_modify_rejected`, `create_order_denied`, `create_submit_order_throttler`, `deny_command`, `deny_order`, `deny_order_list`, `execute`, `execution_gateway`, `fmt`, `get_existing_order`, `handle_command`, `handle_event`, `handle_modify_order`, `handle_submit_order`, `handle_submit_order_cache`, `handle_submit_order_list`, `new`, `process`, `reject_modify_order`, `send_to_execution`, `set_max_notional_per_order`, `set_trading_state`
**Impls**: `Debug`, `RiskEngine`
**Structs**: `RiskEngine`
...
---
*Generated on 2025-11-18T21:55:03.641339Z*
