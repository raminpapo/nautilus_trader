...
- **`py_handle_book()`**: Function defined in this file
...
**Functions**: `__repr__`, `py_count`, `py_handle_book`, `py_has_inputs`, `py_initialized`, `py_name`, `py_new`, `py_reset`, `py_update`, `py_value`
**Impls**: `BookImbalanceRatio`

## Related Files

This file is located in `crates/indicators/src/python/book/`. Related files may include:
...
---
*Generated on 2025-11-18T21:55:01.876966Z*
