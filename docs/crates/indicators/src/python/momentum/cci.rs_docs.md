# Documentation: `crates/indicators/src/python/momentum/cci.rs`
**Generated:** 2025-11-15T19:40:02.231183Z
...
- **Path:** `crates/indicators/src/python/momentum/cci.rs`
- **Size:** 2,454 bytes
- **Lines:** 86
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/indicators/src/python/momentum/cci.rs` within the repository.

**Classes defined:** CommodityChannelIndex

**Functions defined:** py_new, __repr__, py_name, py_period, py_scalar, py_has_inputs, py_value, py_initialized, py_update_raw, py_handle_bar and 1 more
...
#### `py_new(period: usize, scalar: f64, ma_type: Option<MovingAverageType>)`
