...
- **`py_pos()`**: Function defined in this file
- **`py_neg()`**: Function defined in this file
...
**Functions**: `__repr__`, `py_handle_bar`, `py_has_inputs`, `py_initialized`, `py_name`, `py_neg`, `py_new`, `py_period`, `py_pos`, `py_reset`, `py_update_raw`
**Impls**: `DirectionalMovement`
...
---
*Generated on 2025-11-18T21:55:01.899942Z*
