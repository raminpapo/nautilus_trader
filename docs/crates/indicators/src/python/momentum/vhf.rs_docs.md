...
**Functions**: `__repr__`, `py_handle_bar`, `py_handle_quote_tick`, `py_handle_trade_tick`, `py_has_inputs`, `py_initialized`, `py_name`, `py_new`, `py_period`, `py_reset`, `py_update_raw`, `py_value`
**Impls**: `VerticalHorizontalFilter`
...
---
*Generated on 2025-11-18T21:55:01.921602Z*
