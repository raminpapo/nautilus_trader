# Documentation: `crates/indicators/src/python/momentum/vhf.rs`
**Generated:** 2025-11-15T19:40:02.252097Z
...
- **Path:** `crates/indicators/src/python/momentum/vhf.rs`
- **Size:** 2,646 bytes
- **Lines:** 90
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/indicators/src/python/momentum/vhf.rs` within the repository.

**Classes defined:** VerticalHorizontalFilter

**Functions defined:** py_new, __repr__, py_name, py_period, py_has_inputs, py_value, py_initialized, py_update_raw, py_handle_quote_tick, py_handle_trade_tick and 2 more
