...
- **`py_long_run()`**: Function defined in this file
- **`py_short_run()`**: Function defined in this file
...
**Functions**: `__repr__`, `py_fast_period`, `py_handle_bar`, `py_handle_quote_tick`, `py_handle_trade_tick`, `py_has_inputs`, `py_initialized`, `py_long_run`, `py_name`, `py_new`, `py_reset`, `py_short_run`, `py_signal_period`, `py_slow_period`, `py_update_raw`
**Impls**: `ArcherMovingAveragesTrends`
...
---
*Generated on 2025-11-18T21:55:01.882976Z*
