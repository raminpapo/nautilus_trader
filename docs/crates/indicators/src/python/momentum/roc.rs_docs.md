...
- **`py_use_log()`**: Function defined in this file
...
**Functions**: `__repr__`, `py_handle_bar`, `py_handle_quote_tick`, `py_handle_trade_tick`, `py_has_inputs`, `py_initialized`, `py_name`, `py_new`, `py_period`, `py_reset`, `py_update_raw`, `py_use_log`, `py_value`
**Impls**: `RateOfChange`
...
---
*Generated on 2025-11-18T21:55:01.914294Z*
