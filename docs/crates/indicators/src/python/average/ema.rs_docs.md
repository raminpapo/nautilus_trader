# Documentation: `crates/indicators/src/python/average/ema.rs`
**Generated:** 2025-11-15T19:40:02.207426Z
...
- **Path:** `crates/indicators/src/python/average/ema.rs`
- **Size:** 2,869 bytes
- **Lines:** 105
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/indicators/src/python/average/ema.rs` within the repository.

**Classes defined:** ExponentialMovingAverage

**Functions defined:** py_new, __repr__, py_name, py_period, py_alpha, py_count, py_value, py_has_inputs, py_initialized, py_handle_quote_tick and 4 more
