# Documentation: `crates/indicators/src/python/average/dema.rs`
**Generated:** 2025-11-15T19:40:02.205850Z
...
- **Path:** `crates/indicators/src/python/average/dema.rs`
- **Size:** 2,782 bytes
- **Lines:** 99
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/indicators/src/python/average/dema.rs` within the repository.

**Classes defined:** DoubleExponentialMovingAverage
