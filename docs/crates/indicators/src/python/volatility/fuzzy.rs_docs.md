# Documentation: `crates/indicators/src/python/volatility/fuzzy.rs`
**Generated:** 2025-11-15T19:40:02.263763Z
...
This file is located at `crates/indicators/src/python/volatility/fuzzy.rs` within the repository.

**Classes defined:** FuzzyCandle, FuzzyCandlesticks

**Functions defined:** py_new, __repr__, py_direction, py_size, py_body_size, py_upper_wick_size, py_lower_wick_size, py_new, __repr__, py_name and 12 more
...
#### `py_upper_wick_size(&self)`


#### `py_lower_wick_size(&self)`
...
#### `py_update_raw(&mut self, open: f64, high: f64, low: f64, close: f64)`
