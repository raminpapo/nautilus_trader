...
- **`py_upper()`**: Function defined in this file
- **`py_middle()`**: Function defined in this file
- **`py_lower()`**: Function defined in this file
...
**Functions**: `__repr__`, `py_atr_floor`, `py_handle_bar`, `py_has_inputs`, `py_initialized`, `py_k_multiplier`, `py_lower`, `py_middle`, `py_name`, `py_new`, `py_period`, `py_reset`, `py_update_raw`, `py_upper`, `py_use_previous`
**Impls**: `KeltnerChannel`
...
---
*Generated on 2025-11-18T21:55:01.936577Z*
