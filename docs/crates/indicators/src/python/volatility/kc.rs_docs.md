# Documentation: `crates/indicators/src/python/volatility/kc.rs`
**Generated:** 2025-11-15T19:40:02.265495Z
...
- **Path:** `crates/indicators/src/python/volatility/kc.rs`
- **Size:** 3,228 bytes
- **Lines:** 122
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/indicators/src/python/volatility/kc.rs` within the repository.

**Classes defined:** KeltnerChannel

**Functions defined:** py_new, __repr__, py_name, py_period, py_k_multiplier, py_use_previous, py_atr_floor, py_has_inputs, py_upper, py_middle and 5 more
