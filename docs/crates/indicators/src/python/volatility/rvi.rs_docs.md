# Documentation: `crates/indicators/src/python/volatility/rvi.rs`
**Generated:** 2025-11-15T19:40:02.269564Z
...
- **Path:** `crates/indicators/src/python/volatility/rvi.rs`
- **Size:** 2,881 bytes
- **Lines:** 99
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/indicators/src/python/volatility/rvi.rs` within the repository.

**Classes defined:** RelativeVolatilityIndex

**Functions defined:** py_new, __repr__, py_name, py_period, py_scalar, py_has_inputs, py_value, py_initialized, py_update_raw, py_handle_quote_tick and 3 more
...
#### `py_new(period: usize, scalar: Option<f64>, ma_type: Option<MovingAverageType>)`
