...
- **`test_handle_quote()`**: Function defined in this file
- **`test_handle_trade()`**: Function defined in this file
...
### Classes
- **`DoubleExponentialMovingAverage`**: Class defined in this file
...
**Functions**: `count`, `fmt`, `handle_bar`, `handle_quote`, `handle_trade`, `has_inputs`, `initialized`, `name`, `new`, `new_panics_on_zero_period`, `reset`, `test_counter_increments_via_handle_helpers`, `test_counters_are_in_sync`, `test_dema_initialized`, `test_handle_bar`, `test_handle_quote`, `test_handle_trade`, `test_initialized_with_required_input`, `test_inner_ema_values_are_reset`, `test_new_with_minimum_valid_period`, `test_reset`, `test_value_with_one_input`, `test_value_with_three_inputs`, `update_raw`, `value`
**Impls**: `Display`, `DoubleExponentialMovingAverage`, `Indicator`, `MovingAverage`
**Structs**: `DoubleExponentialMovingAverage`
...
---
*Generated on 2025-11-18T21:55:01.758175Z*
