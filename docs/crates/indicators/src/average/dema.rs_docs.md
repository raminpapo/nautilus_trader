# Documentation: `crates/indicators/src/average/dema.rs`
**Generated:** 2025-11-15T19:40:02.137486Z
...
- **Path:** `crates/indicators/src/average/dema.rs`
- **Size:** 10,377 bytes
- **Lines:** 322
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/indicators/src/average/dema.rs` within the repository.

**Classes defined:** DoubleExponentialMovingAverage, Display, Indicator, DoubleExponentialMovingAverage, MovingAverage

**Functions defined:** fmt, name, has_inputs, initialized, handle_quote, handle_trade, handle_bar, reset, new, value and 15 more
...
#### `test_dema_initialized(indicator_dema_10: DoubleExponentialMovingAverage)`


#### `test_value_with_one_input(mut indicator_dema_10: DoubleExponentialMovingAverage)`


#### `test_value_with_three_inputs(mut indicator_dema_10: DoubleExponentialMovingAverage)`


#### `test_initialized_with_required_input(mut indicator_dema_10: DoubleExponentialMovingAverage)`
...
#### `test_reset(mut indicator_dema_10: DoubleExponentialMovingAverage)`
...
#### `test_counters_are_in_sync(mut indicator_dema_10: DoubleExponentialMovingAverage)`


#### `test_inner_ema_values_are_reset(mut indicator_dema_10: DoubleExponentialMovingAverage)`
