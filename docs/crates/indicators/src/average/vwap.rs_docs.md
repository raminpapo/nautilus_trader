...
- **Path**: `crates/indicators/src/average/vwap.rs`
- **Size**: 11,533 bytes
- **Lines**: 371
- **Language**: Rust
...
- **`test_vwap_initialized()`**: Function defined in this file
- **`test_value_with_one_input()`**: Function defined in this file
- **`test_value_with_three_inputs_on_the_same_day()`**: Function defined in this file
- **`test_value_with_three_inputs_on_different_days()`**: Function defined in this file
...
- **`test_reset_on_exact_day_boundary()`**: Function defined in this file
- **`test_no_reset_within_same_day()`**: Function defined in this file
- **`test_zero_volume_does_not_change_value()`**: Function defined in this file
- **`test_epoch_day_floor_rounding()`**: Function defined in this file
- **`test_reset_when_timestamp_goes_backwards()`**: Function defined in this file

*...and 12 more functions*

### Classes
- **`VolumeWeightedAveragePrice`**: Class defined in this file
...
**Functions**: `fmt`, `handle_bar`, `has_inputs`, `huge_future_timestamp_saturates`, `initialized`, `name`, `nan_price_propagates`, `nan_volume_propagates`, `negative_timestamp`, `negative_volume_changes_sign`, `new`, `reset`, `test_epoch_day_floor_rounding`, `test_extreme_prices_and_volumes_do_not_overflow`, `test_first_input_zero_volume_does_not_divide_by_zero`, `test_handle_bar`, `test_handle_bar_matches_update_raw`, `test_no_reset_for_same_epoch_day`, `test_no_reset_within_same_day`, `test_reset`, `test_reset_on_exact_day_boundary`, `test_reset_when_epoch_day_changes`, `test_reset_when_timestamp_goes_backwards`, `test_value_with_one_input`, `test_value_with_ten_inputs`, `test_value_with_three_inputs_on_different_days`, `test_value_with_three_inputs_on_the_same_day`, `test_vwap_initialized`, `test_zero_volume_day_rollover_resets_and_seeds`, `test_zero_volume_does_not_change_value` *(+2 more)*
**Impls**: `Display`, `Indicator`, `VolumeWeightedAveragePrice`
**Structs**: `VolumeWeightedAveragePrice`
...
---
*Generated on 2025-11-18T21:55:01.786007Z*
