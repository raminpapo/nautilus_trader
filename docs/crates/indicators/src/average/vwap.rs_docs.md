# Documentation: `crates/indicators/src/average/vwap.rs`
**Generated:** 2025-11-15T19:40:02.157849Z
**File Size:** 11533 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/indicators/src/average/vwap.rs` within the repository.

**Classes defined:** VolumeWeightedAveragePrice, Indicator, VolumeWeightedAveragePrice, Display

**Functions defined:** name, has_inputs, initialized, handle_bar, reset, new, update_raw, fmt, test_vwap_initialized, test_value_with_one_input and 22 more
...
#### `update_raw(&mut self, price: f64, volume: f64, timestamp: f64)`


#### `fmt(&self, f: &mut Formatter<'_>)`


#### `test_vwap_initialized(indicator_vwap: VolumeWeightedAveragePrice)`


#### `test_value_with_one_input(mut indicator_vwap: VolumeWeightedAveragePrice)`
...
#### `test_value_with_ten_inputs(mut indicator_vwap: VolumeWeightedAveragePrice)`
...
#### `test_reset(mut indicator_vwap: VolumeWeightedAveragePrice)`


#### `test_reset_on_exact_day_boundary()`
...
#### `test_no_reset_for_same_epoch_day(#[case] t1: f64, #[case] t2: f64)`


#### `test_reset_when_epoch_day_changes(#[case] t1: f64, #[case] t2: f64)`
...
#### `test_extreme_prices_and_volumes_do_not_overflow(#[case] price: f64, #[case] volume: f64)`
