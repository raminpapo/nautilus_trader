# Documentation: `crates/indicators/src/average/vidya.rs`
**Generated:** 2025-11-15T19:40:02.155572Z
**File Size:** 10928 bytes
**Extension:** .rs
**Type:** text
...
- **Path:** `crates/indicators/src/average/vidya.rs`
- **Size:** 10,928 bytes
- **Lines:** 349
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/indicators/src/average/vidya.rs` within the repository.

**Classes defined:** VariableIndexDynamicAverage, Display, Indicator, VariableIndexDynamicAverage, MovingAverage

**Functions defined:** fmt, name, has_inputs, initialized, handle_quote, handle_trade, handle_bar, reset, new, value and 18 more
...
#### `update_raw(&mut self, price: f64)`


#### `test_vidya_initialized(indicator_vidya_10: VariableIndexDynamicAverage)`


#### `sma_new_with_zero_period_panics()`


#### `test_initialized_with_required_input(mut indicator_vidya_10: VariableIndexDynamicAverage)`


#### `test_value_with_one_input(mut indicator_vidya_10: VariableIndexDynamicAverage)`


#### `test_value_with_three_inputs(mut indicator_vidya_10: VariableIndexDynamicAverage)`


#### `test_value_with_ten_inputs(mut indicator_vidya_10: VariableIndexDynamicAverage)`
...
#### `test_reset(mut indicator_vidya_10: VariableIndexDynamicAverage)`


#### `reference_ma(prices: &[f64], period: usize)`


#### `test_sma_exact_rolling_mean(#[case] period: usize, #[case] prices: Vec<f64>)`


#### `test_sma_matches_reference_series()`


#### `test_vidya_alpha_bounds()`


#### `test_vidya_value_constant_when_cmo_zero()`


#### `test_vidya_handles_negative_prices()`
