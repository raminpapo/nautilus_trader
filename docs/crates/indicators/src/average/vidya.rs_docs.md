...
- **`test_vidya_initialized()`**: Function defined in this file
- **`sma_new_with_zero_period_panics()`**: Function defined in this file
...
### Classes
- **`VariableIndexDynamicAverage`**: Class defined in this file
...
**Functions**: `count`, `fmt`, `handle_bar`, `handle_quote`, `handle_trade`, `has_inputs`, `initialized`, `name`, `new`, `reference_ma`, `reset`, `sma_new_with_zero_period_panics`, `test_handle_bar`, `test_handle_quote_tick`, `test_handle_trade_tick`, `test_initialized_with_required_input`, `test_reset`, `test_sma_exact_rolling_mean`, `test_sma_matches_reference_series`, `test_value_with_one_input`, `test_value_with_ten_inputs`, `test_value_with_three_inputs`, `test_vidya_alpha_bounds`, `test_vidya_handles_negative_prices`, `test_vidya_initialized`, `test_vidya_value_constant_when_cmo_zero`, `update_raw`, `value`
**Impls**: `Display`, `Indicator`, `MovingAverage`, `VariableIndexDynamicAverage`
**Structs**: `VariableIndexDynamicAverage`
...
---
*Generated on 2025-11-18T21:55:01.782789Z*
