...
### Classes
- **`HullMovingAverage`**: Class defined in this file
...
**Functions**: `alternating_extremes_bounded`, `constant_series_yields_constant_value`, `count`, `fmt`, `get_weights`, `handle_bar`, `handle_quote`, `handle_trade`, `has_inputs`, `initialized`, `initialized_boundary`, `name`, `negative_prices_supported`, `new`, `period_one_degenerates_to_price`, `reset`, `small_periods_do_not_panic`, `test_handle_bar`, `test_handle_quote_tick`, `test_handle_trade_tick`, `test_hma_initialized`, `test_initialized_with_required_input`, `test_new_with_positive_period_constructs`, `test_new_with_zero_period_panics`, `test_price_type_defaults_to_last`, `test_price_type_propagates_to_inner_wmas`, `test_reset`, `test_value_with_one_input`, `test_value_with_ten_inputs`, `test_value_with_three_inputs` *(+2 more)*
**Impls**: `Display`, `HullMovingAverage`, `Indicator`, `MovingAverage`
**Structs**: `HullMovingAverage`
...
---
*Generated on 2025-11-18T21:55:01.764708Z*
