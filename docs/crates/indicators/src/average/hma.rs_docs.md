# Documentation: `crates/indicators/src/average/hma.rs`
**Generated:** 2025-11-15T19:40:02.142832Z
...
- **Path:** `crates/indicators/src/average/hma.rs`
- **Size:** 12,396 bytes
- **Lines:** 405
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/indicators/src/average/hma.rs` within the repository.

**Classes defined:** HullMovingAverage, Display, Indicator, HullMovingAverage, MovingAverage

**Functions defined:** fmt, name, has_inputs, initialized, handle_quote, handle_trade, handle_bar, reset, get_weights, new and 22 more
...
#### `get_weights(size: usize)`


#### `new(period: usize, price_type: Option<PriceType>)`
...
#### `test_hma_initialized(indicator_hma_10: HullMovingAverage)`


#### `test_initialized_with_required_input(mut indicator_hma_10: HullMovingAverage)`


#### `test_value_with_one_input(mut indicator_hma_10: HullMovingAverage)`


#### `test_value_with_three_inputs(mut indicator_hma_10: HullMovingAverage)`


#### `test_value_with_ten_inputs(mut indicator_hma_10: HullMovingAverage)`


#### `test_handle_quote_tick(mut indicator_hma_10: HullMovingAverage, stub_quote: QuoteTick)`


#### `test_handle_trade_tick(mut indicator_hma_10: HullMovingAverage, stub_trade: TradeTick)`
...
#### `test_reset(mut indicator_hma_10: HullMovingAverage)`


#### `test_new_with_zero_period_panics()`


#### `test_new_with_positive_period_constructs(#[case] period: usize)`


#### `test_price_type_propagates_to_inner_wmas(#[case] pt: PriceType)`


#### `test_price_type_defaults_to_last()`


#### `period_one_degenerates_to_price(#[case] price: f64)`


#### `constant_series_yields_constant_value(#[case] period: usize, #[case] constant: f64)`


#### `alternating_extremes_bounded()`


#### `initialized_boundary(#[case] period: usize)`


#### `small_periods_do_not_panic(#[case] period: usize)`
