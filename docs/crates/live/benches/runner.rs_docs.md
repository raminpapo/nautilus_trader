...
- **Path**: `crates/live/benches/runner.rs`
- **Size**: 10,075 bytes
- **Lines**: 310
- **Language**: Rust
...
- **`bench_channel_operations()`**: Function defined in this file
- **`bench_runner_components()`**: Function defined in this file
- **`bench_event_creation()`**: Function defined in this file
- **`bench_concurrent_channels()`**: Function defined in this file
- **`bench_batch_processing()`**: Function defined in this file
- **`bench_memory_usage()`**: Function defined in this file
- **`bench_select_pattern()`**: Function defined in this file
...
**Functions**: `bench_batch_processing`, `bench_channel_operations`, `bench_concurrent_channels`, `bench_event_creation`, `bench_memory_usage`, `bench_runner_components`, `bench_select_pattern`, `create_test_quote`, `create_test_trade`

## Related Files

This file is located in `crates/live/benches/`. Related files may include:
...
---
*Generated on 2025-11-18T21:55:02.098795Z*
