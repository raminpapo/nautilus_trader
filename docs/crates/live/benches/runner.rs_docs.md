# Documentation: `crates/live/benches/runner.rs`
**Generated:** 2025-11-15T19:40:02.384415Z
**File Size:** 10075 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/live/benches/runner.rs` within the repository.

**Functions defined:** create_test_quote, create_test_trade, bench_channel_operations, bench_runner_components, bench_event_creation, bench_concurrent_channels, bench_batch_processing, bench_memory_usage, bench_select_pattern
...
#### `bench_channel_operations(c: &mut Criterion)`


#### `bench_runner_components(c: &mut Criterion)`


#### `bench_event_creation(c: &mut Criterion)`


#### `bench_concurrent_channels(c: &mut Criterion)`
...
#### `bench_select_pattern(c: &mut Criterion)`
