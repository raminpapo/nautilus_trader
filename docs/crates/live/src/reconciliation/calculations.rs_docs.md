...
This file is part of the NautilusTrader repository. It defines 60 function(s) and 2 class(es).

## Detailed Walkthrough

### Functions
- **`new()`**: Function defined in this file
- **`direction()`**: Function defined in this file
- **`simulate_position()`**: Function defined in this file
- **`detect_zero_crossings()`**: Function defined in this file
- **`check_position_match()`**: Function defined in this file
- **`calculate_reconciliation_price()`**: Function defined in this file
- **`adjust_fills_for_partial_window()`**: Function defined in this file
- **`instrument()`**: Function defined in this file
- **`create_test_venue_order_id()`**: Function defined in this file
- **`test_fill_snapshot_direction()`**: Function defined in this file
- **`test_simulate_position_accumulate_long()`**: Function defined in this file
- **`test_simulate_position_close_and_flip()`**: Function defined in this file
- **`test_simulate_position_partial_close()`**: Function defined in this file
- **`test_simulate_position_multiple_partial_closes()`**: Function defined in this file
- **`test_simulate_position_short_partial_close()`**: Function defined in this file
- **`test_detect_zero_crossings()`**: Function defined in this file
- **`test_check_position_match_exact()`**: Function defined in this file
- **`test_check_position_match_within_tolerance()`**: Function defined in this file
- **`test_check_position_match_qty_mismatch()`**: Function defined in this file
- **`test_check_position_match_both_flat()`**: Function defined in this file

*...and 40 more functions*

### Classes
- **`FillSnapshot`**: Class defined in this file
- **`VenuePositionSnapshot`**: Class defined in this file
...
**Enums**: `FillAdjustmentResult`
**Functions**: `adjust_fills_for_partial_window`, `calculate_reconciliation_price`, `check_position_match`, `create_test_venue_order_id`, `detect_zero_crossings`, `direction`, `instrument`, `new`, `simulate_position`, `test_adjust_fills_complete_lifecycle_no_adjustment`, `test_adjust_fills_flat_position`, `test_adjust_fills_incomplete_lifecycle_adds_synthetic`, `test_adjust_fills_multiple_zero_crossings_mismatch`, `test_adjust_fills_no_fills`, `test_adjust_fills_short_position`, `test_adjust_fills_timestamp_underflow_protection`, `test_adjust_fills_with_flip_scenario`, `test_adjust_fills_with_zero_crossings`, `test_check_position_match_both_flat`, `test_check_position_match_edge_of_tolerance`, `test_check_position_match_exact`, `test_check_position_match_outside_tolerance`, `test_check_position_match_qty_mismatch`, `test_check_position_match_within_tolerance`, `test_check_position_match_zero_venue_avg_px`, `test_detect_zero_crossings`, `test_detect_zero_crossings_complex_lifecycle`, `test_detect_zero_crossings_empty_fills`, `test_detect_zero_crossings_long_to_short_flip`, `test_detect_zero_crossings_multiple_flips` *(+30 more)*
**Impls**: `FillSnapshot`
**Structs**: `FillSnapshot`, `VenuePositionSnapshot`

## Related Files

This file is located in `crates/live/src/reconciliation/`. Related files may include:
...
---
*Generated on 2025-11-18T21:55:02.140474Z*
