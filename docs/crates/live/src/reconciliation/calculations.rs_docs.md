# Documentation: `crates/live/src/reconciliation/calculations.rs`
**Generated:** 2025-11-15T19:40:02.411091Z
**File Size:** 51182 bytes
**Extension:** .rs
**Type:** text
...
- **Path:** `crates/live/src/reconciliation/calculations.rs`
- **Size:** 51,182 bytes
- **Lines:** 1,392
- **Extension:** `.rs`
- **Type:** text
...
mod tests {
    ...
    fn test_adjust_fills_with_zero_crossings() {
        ...
        match result {
            ...
            _ => panic!("Expected FilterToCurrentLifecycle, got {:?}", result),
        }
    }
    ...
    fn test_adjust_fills_multiple_zero_crossings_mismatch() {
        ...
        match result {
            ...
            _ => panic!("Expected ReplaceCurrentLifecycle, got {:?}", result),
        }
    }
...
This file is located at `crates/live/src/reconciliation/calculations.rs` within the repository.

**Classes defined:** FillSnapshot, VenuePositionSnapshot, FillSnapshot

**Functions defined:** new, direction, simulate_position, detect_zero_crossings, check_position_match, calculate_reconciliation_price, adjust_fills_for_partial_window, instrument, create_test_venue_order_id, test_fill_snapshot_direction and 50 more
...
#### `simulate_position(fills: &[FillSnapshot])`


#### `detect_zero_crossings(fills: &[FillSnapshot])`
...
#### `create_test_venue_order_id(value: &str)`
...
#### `test_reconciliation_price_flat_to_long(_instrument: InstrumentAny)`


#### `test_reconciliation_price_no_target_avg_px(_instrument: InstrumentAny)`


#### `test_reconciliation_price_no_quantity_change(_instrument: InstrumentAny)`


#### `test_reconciliation_price_long_position_increase(_instrument: InstrumentAny)`


#### `test_reconciliation_price_flat_to_short(_instrument: InstrumentAny)`


#### `test_reconciliation_price_long_to_flat(_instrument: InstrumentAny)`


#### `test_reconciliation_price_short_to_flat(_instrument: InstrumentAny)`


#### `test_reconciliation_price_short_position_increase(_instrument: InstrumentAny)`


#### `test_reconciliation_price_long_position_decrease(_instrument: InstrumentAny)`


#### `test_reconciliation_price_long_to_short_flip(_instrument: InstrumentAny)`


#### `test_reconciliation_price_short_to_long_flip(_instrument: InstrumentAny)`


#### `test_reconciliation_price_complex_scenario(_instrument: InstrumentAny)`


#### `test_reconciliation_price_zero_target_avg_px(_instrument: InstrumentAny)`


#### `test_reconciliation_price_negative_price(_instrument: InstrumentAny)`
...
**Directory:** `crates/live/src/reconciliation`
