# Documentation: manager.rs

## File Metadata

- **Path**: `crates/live/src/reconciliation/manager.rs`
- **Size**: 29,109 bytes
- **Lines**: 787
- **Language**: Rust
...
This file is part of the NautilusTrader repository. It defines 33 function(s) and 6 class(es).
...
- **`reconcile_execution_mass_status()`**: Function defined in this file
- **`reconcile_report()`**: Function defined in this file
- **`check_inflight_orders()`**: Function defined in this file
- **`check_open_orders()`**: Function defined in this file
- **`register_inflight()`**: Function defined in this file
- **`record_local_activity()`**: Function defined in this file
- **`clear_recon_tracking()`**: Function defined in this file
- **`claim_external_orders()`**: Function defined in this file
- **`get_order()`**: Function defined in this file
- **`get_instrument()`**: Function defined in this file
- **`reconcile_order_report()`**: Function defined in this file
- **`handle_external_order()`**: Function defined in this file
- **`create_order_accepted()`**: Function defined in this file
- **`create_order_rejected()`**: Function defined in this file
- **`create_order_triggered()`**: Function defined in this file
- **`create_order_canceled()`**: Function defined in this file
- **`create_order_canceled_simple()`**: Function defined in this file

*...and 13 more functions*

### Classes
- **`ReconciliationConfig`**: Class defined in this file
- **`ExecutionReport`**: Class defined in this file
- **`InflightCheck`**: Class defined in this file
- **`is`**: Class defined in this file
- **`must`**: Class defined in this file
- **`ReconciliationManager`**: Class defined in this file
...
**Functions**: `check_inflight_orders`, `check_open_orders`, `claim_external_orders`, `clear_recon_tracking`, `create_order_accepted`, `create_order_canceled`, `create_order_canceled_simple`, `create_order_expired`, `create_order_fill`, `create_order_rejected`, `create_order_triggered`, `create_test_manager`, `default`, `fmt`, `get_instrument`, `get_order`, `handle_external_order`, `new`, `reconcile_execution_mass_status`, `reconcile_order_report`, `reconcile_report`, `record_local_activity`, `register_inflight`, `test_check_inflight_orders_generates_rejection_after_max_retries`, `test_check_inflight_orders_skips_filtered_ids`, `test_check_inflight_orders_skips_recent_query`, `test_claim_external_orders`, `test_reconcile_execution_mass_status_with_empty`, `test_reconcile_report_removes_from_inflight`, `test_reconciliation_config_default` *(+3 more)*
**Impls**: `Debug`, `Default`, `ReconciliationManager`
**Structs**: `ExecutionReport`, `InflightCheck`, `ReconciliationConfig`, `ReconciliationManager`, `is`, `must`
...
---
*Generated on 2025-11-18T21:55:02.146468Z*
