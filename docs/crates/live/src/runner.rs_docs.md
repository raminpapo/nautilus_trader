# Documentation: `crates/live/src/runner.rs`
**Generated:** 2025-11-15T19:40:02.419861Z
**File Size:** 20596 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/live/src/runner.rs` within the repository.

**Classes defined:** AsyncDataCommandSender, AsyncTimeEventSender, AsyncTradingCommandSender, AsyncRunner, AsyncDataCommandSender, DataCommandSender, AsyncTimeEventSender, TimeEventSender, AsyncTradingCommandSender, TradingCommandSender and 4 more

**Functions defined:** new, execute, new, get_channel_sender, send, new, execute, run, default, fmt and 16 more
...
#### `new(cmd_tx: UnboundedSender<DataCommand>)`


#### `execute(&self, command: DataCommand)`


#### `new(time_tx: UnboundedSender<TimeEventHandlerV2>)`


#### `get_channel_sender(&self)`


#### `send(&self, handler: TimeEventHandlerV2)`


#### `new(cmd_tx: UnboundedSender<TradingCommand>)`
...
#### `test_channel_send_performance(#[case] count: usize)`
