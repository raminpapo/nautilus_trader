# Documentation: runner.rs

## File Metadata

- **Path**: `crates/live/src/runner.rs`
- **Size**: 20,596 bytes
- **Lines**: 583
- **Language**: Rust
...
This file is part of the NautilusTrader repository. It defines 26 function(s) and 4 class(es).

## Detailed Walkthrough

### Functions
- **`new()`**: Function defined in this file
- **`execute()`**: Function defined in this file
- **`new()`**: Function defined in this file
- **`get_channel_sender()`**: Function defined in this file
...
- **`run()`**: Function defined in this file
- **`test_quote()`**: Function defined in this file
- **`test_async_data_command_sender_creation()`**: Function defined in this file
- **`test_async_time_event_sender_creation()`**: Function defined in this file
- **`test_async_time_event_sender_get_channel()`**: Function defined in this file
- **`test_async_data_command_sender_execute()`**: Function defined in this file
- **`test_async_time_event_sender_send()`**: Function defined in this file
- **`test_runner_shutdown_signal()`**: Function defined in this file

*...and 6 more functions*

### Classes
- **`AsyncDataCommandSender`**: Class defined in this file
- **`AsyncTimeEventSender`**: Class defined in this file
- **`AsyncTradingCommandSender`**: Class defined in this file
- **`AsyncRunner`**: Class defined in this file
...
**Functions**: `default`, `execute`, `fmt`, `get_channel_sender`, `new`, `run`, `send`, `stop`, `test_async_data_command_sender_creation`, `test_async_data_command_sender_execute`, `test_async_time_event_sender_creation`, `test_async_time_event_sender_get_channel`, `test_async_time_event_sender_send`, `test_async_trading_command_sender_creation`, `test_channel_send_performance`, `test_concurrent_event_sending`, `test_execution_event_order_channel`, `test_execution_report_order_status_channel`, `test_quote`, `test_runner_closes_on_channel_drop`, `test_runner_shutdown_signal`
**Impls**: `AsyncDataCommandSender`, `AsyncRunner`, `AsyncTimeEventSender`, `AsyncTradingCommandSender`, `DataCommandSender`, `Debug`, `Default`, `TimeEventSender`, `TradingCommandSender`
**Structs**: `AsyncDataCommandSender`, `AsyncRunner`, `AsyncTimeEventSender`, `AsyncTradingCommandSender`
**Traits**: `Runner`

## Related Files

This file is located in `crates/live/src/`. Related files may include:
...
---
*Generated on 2025-11-18T21:55:02.152676Z*
