# Documentation: `crates/live/src/config.rs`
**Generated:** 2025-11-15T19:40:02.387031Z
**File Size:** 16900 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/live/src/config.rs` within the repository.

**Classes defined:** LiveDataEngineConfig, LiveRiskEngineConfig, LiveExecEngineConfig, RoutingConfig, InstrumentProviderConfig, LiveDataClientConfig, LiveExecClientConfig, LiveNodeConfig, Default, From and 7 more

**Functions defined:** default, from, default, from, default, from, default, default, environment, trader_id and 22 more
...
#### `from(_config: LiveDataEngineConfig)`


#### `default()`


#### `from(_config: LiveRiskEngineConfig)`


#### `default()`


#### `from(_config: LiveExecEngineConfig)`
...
#### `timeout_reconciliation(&self)`


#### `timeout_portfolio(&self)`


#### `timeout_disconnection(&self)`


#### `delay_post_stop(&self)`


#### `timeout_shutdown(&self)`
