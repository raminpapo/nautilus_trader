...
- **Path**: `crates/live/src/config.rs`
- **Size**: 16,900 bytes
- **Lines**: 452
- **Language**: Rust
...
This file is part of the NautilusTrader repository. It defines 32 function(s) and 8 class(es).
...
- **`LiveNodeConfig`**: Class defined in this file
...
**Functions**: `cache`, `data_engine`, `default`, `delay_post_stop`, `environment`, `exec_engine`, `from`, `instance_id`, `load_state`, `logging`, `msgbus`, `portfolio`, `risk_engine`, `save_state`, `streaming`, `test_live_data_client_config_default`, `test_live_exec_engine_config_defaults`, `test_routing_config_default`, `test_trading_node_config_as_kernel_config`, `test_trading_node_config_default`, `timeout_connection`, `timeout_disconnection`, `timeout_portfolio`, `timeout_reconciliation`, `timeout_shutdown`, `trader_id`
**Impls**: `Default`, `From`, `NautilusKernelConfig`
**Structs**: `InstrumentProviderConfig`, `LiveDataClientConfig`, `LiveDataEngineConfig`, `LiveExecClientConfig`, `LiveExecEngineConfig`, `LiveNodeConfig`, `LiveRiskEngineConfig`, `RoutingConfig`
...
---
*Generated on 2025-11-18T21:55:02.102697Z*
