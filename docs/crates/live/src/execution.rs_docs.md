# Documentation: `crates/live/src/execution.rs`
**Generated:** 2025-11-15T19:40:02.391353Z
**File Size:** 14416 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/live/src/execution.rs` within the repository.

**Classes defined:** LiveExecutionEngine, Debug, LiveExecutionEngine

**Functions defined:** fmt, new, start, stop, reconcile_execution_state, reconcile_execution_mass_status, reconcile_execution_report, handle_command, publish_event, record_local_activity and 14 more
...
#### `reconcile_execution_state(&mut self)`
...
#### `reconcile_execution_report(&mut self, report: ExecutionReport)`


#### `handle_command(&mut self, command: TradingCommand)`


#### `publish_event(&mut self, event: OrderEventAny)`


#### `record_local_activity(&mut self, event: &OrderEventAny)`
...
#### `start_continuous_tasks(&mut self)`


#### `start_inflight_check_task(&mut self, _interval_ms: u64)`


#### `start_open_check_task(&mut self, _interval_secs: f64)`


#### `get_execution_clients(&self)`
...
#### `send_order_event(&self, event: OrderEventAny)`


#### `send_order_status_report(&self, report: OrderStatusReport)`


#### `send_fill_report(&self, report: FillReport)`


#### `send_position_status_report(&self, report: PositionStatusReport)`


#### `send_mass_status(&self, mass_status: ExecutionMassStatus)`
