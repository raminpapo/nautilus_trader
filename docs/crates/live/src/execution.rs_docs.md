# Documentation: execution.rs

## File Metadata

- **Path**: `crates/live/src/execution.rs`
- **Size**: 14,416 bytes
- **Lines**: 413
- **Language**: Rust
...
- **`reconcile_execution_state()`**: Function defined in this file
- **`reconcile_execution_mass_status()`**: Function defined in this file
- **`reconcile_execution_report()`**: Function defined in this file
- **`handle_command()`**: Function defined in this file
- **`publish_event()`**: Function defined in this file
- **`record_local_activity()`**: Function defined in this file
- **`clear_reconciliation_tracking()`**: Function defined in this file
- **`start_continuous_tasks()`**: Function defined in this file
- **`start_inflight_check_task()`**: Function defined in this file
- **`start_open_check_task()`**: Function defined in this file
- **`get_execution_clients()`**: Function defined in this file
- **`is_running()`**: Function defined in this file
- **`get_message_channel()`**: Function defined in this file
- **`get_clock()`**: Function defined in this file
- **`send_order_event()`**: Function defined in this file
- **`send_order_status_report()`**: Function defined in this file

*...and 4 more functions*

### Classes
- **`LiveExecutionEngine`**: Class defined in this file
...
**Functions**: `clear_reconciliation_tracking`, `fmt`, `get_clock`, `get_execution_clients`, `get_message_channel`, `handle_command`, `is_running`, `log_send_error`, `new`, `publish_event`, `reconcile_execution_mass_status`, `reconcile_execution_report`, `reconcile_execution_state`, `record_local_activity`, `send_fill_report`, `send_mass_status`, `send_order_event`, `send_order_status_report`, `send_position_status_report`, `start`, `start_continuous_tasks`, `start_inflight_check_task`, `start_open_check_task`, `stop`
**Impls**: `Debug`, `LiveExecutionEngine`
**Structs**: `LiveExecutionEngine`
**Traits**: `LiveExecutionClientExt`, `for`
...
---
*Generated on 2025-11-18T21:55:02.109236Z*
