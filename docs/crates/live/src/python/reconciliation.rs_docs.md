# Documentation: reconciliation.rs

## File Metadata

- **Path**: `crates/live/src/python/reconciliation.rs`
- **Size**: 18,706 bytes
- **Lines**: 484
- **Language**: Rust
...
### Functions
- **`py_adjust_fills_for_partial_window()`**: Function defined in this file
- **`create_synthetic_venue_order_id()`**: Function defined in this file
- **`create_synthetic_order_report()`**: Function defined in this file
- **`create_synthetic_fill_report()`**: Function defined in this file
- **`py_tuple_from_reports()`**: Function defined in this file
- **`py_calculate_reconciliation_price()`**: Function defined in this file
...
**Functions**: `create_synthetic_fill_report`, `create_synthetic_order_report`, `create_synthetic_venue_order_id`, `py_adjust_fills_for_partial_window`, `py_calculate_reconciliation_price`, `py_tuple_from_reports`
...
---
*Generated on 2025-11-18T21:55:02.128096Z*
