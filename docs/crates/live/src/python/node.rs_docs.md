# Documentation: `crates/live/src/python/node.rs`
**Generated:** 2025-11-15T19:40:02.401253Z
**File Size:** 23003 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/live/src/python/node.rs` within the repository.

**Classes defined:** LiveNodeBuilderPy, LiveNode, LiveNodeBuilderPy

**Functions defined:** py_builder, py_environment, py_trader_id, py_instance_id, py_is_running, py_start, py_run, py_stop, py_add_actor_from_config, __repr__ and 6 more
...
#### `py_with_instance_id(&self, instance_id: UUID4)`


#### `py_with_load_state(&self, load_state: bool)`


#### `py_with_save_state(&self, save_state: bool)`
