...
- **Path**: `crates/live/src/python/node.rs`
- **Size**: 23,003 bytes
- **Lines**: 557
- **Language**: Rust
...
### Functions
- **`py_builder()`**: Function defined in this file
- **`py_environment()`**: Function defined in this file
- **`py_trader_id()`**: Function defined in this file
- **`py_instance_id()`**: Function defined in this file
- **`py_is_running()`**: Function defined in this file
- **`py_start()`**: Function defined in this file
- **`py_run()`**: Function defined in this file
- **`py_stop()`**: Function defined in this file
- **`py_add_actor_from_config()`**: Function defined in this file
- **`__repr__()`**: Function defined in this file
- **`py_with_instance_id()`**: Function defined in this file
- **`py_with_load_state()`**: Function defined in this file
- **`py_with_save_state()`**: Function defined in this file
- **`py_add_data_client()`**: Function defined in this file
- **`py_build()`**: Function defined in this file
- **`__repr__()`**: Function defined in this file

### Classes
- **`LiveNodeBuilderPy`**: Class defined in this file
...
**Functions**: `__repr__`, `py_add_actor_from_config`, `py_add_data_client`, `py_build`, `py_builder`, `py_environment`, `py_instance_id`, `py_is_running`, `py_run`, `py_start`, `py_stop`, `py_trader_id`, `py_with_instance_id`, `py_with_load_state`, `py_with_save_state`
**Impls**: `LiveNode`, `LiveNodeBuilderPy`
**Structs**: `LiveNodeBuilderPy`
**Traits**: `objects`

## Related Files

This file is located in `crates/live/src/python/`. Related files may include:
...
---
*Generated on 2025-11-18T21:55:02.123175Z*
