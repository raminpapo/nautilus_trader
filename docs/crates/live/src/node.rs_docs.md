# Documentation: `crates/live/src/node.rs`
**Generated:** 2025-11-15T19:40:02.396425Z
**File Size:** 21631 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/live/src/node.rs` within the repository.

**Classes defined:** LiveNodeHandle, LiveNode, LiveNodeBuilder, Default, LiveNodeHandle, LiveNode, LiveNodeBuilder

**Functions defined:** default, new, should_stop, is_running, stop, set_running, handle, builder, build, start and 29 more
...
#### `build(name: String, config: Option<LiveNodeConfig>)`
...
#### `add_actor(&mut self, actor: T)`


#### `add_registered_actor(&mut self, actor: T)`


#### `add_actor_from_factory(&mut self, factory: F)`
...
#### `with_instance_id(mut self, instance_id: UUID4)`


#### `with_load_state(mut self, load_state: bool)`


#### `with_save_state(mut self, save_state: bool)`


#### `with_timeout_connection(mut self, timeout_secs: u64)`


#### `with_timeout_reconciliation(mut self, timeout_secs: u64)`


#### `with_timeout_portfolio(mut self, timeout_secs: u64)`


#### `with_timeout_disconnection_secs(mut self, timeout_secs: u64)`


#### `with_delay_post_stop_secs(mut self, delay_secs: u64)`


#### `with_delay_shutdown_secs(mut self, delay_secs: u64)`
