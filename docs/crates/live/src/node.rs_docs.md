# Documentation: node.rs

## File Metadata

- **Path**: `crates/live/src/node.rs`
- **Size**: 21,631 bytes
- **Lines**: 687
- **Language**: Rust
...
This file is part of the NautilusTrader repository. It defines 39 function(s) and 3 class(es).
...
- **`should_stop()`**: Function defined in this file
- **`is_running()`**: Function defined in this file
- **`stop()`**: Function defined in this file
- **`set_running()`**: Function defined in this file
- **`handle()`**: Function defined in this file
- **`builder()`**: Function defined in this file
...
- **`kernel()`**: Function defined in this file
- **`kernel_mut()`**: Function defined in this file
...
### Classes
- **`LiveNodeHandle`**: Class defined in this file
- **`LiveNode`**: Class defined in this file
- **`LiveNodeBuilder`**: Class defined in this file
...
**Functions**: `add_actor`, `add_actor_from_factory`, `add_data_client`, `add_exec_client`, `add_registered_actor`, `build`, `builder`, `default`, `environment`, `handle`, `instance_id`, `is_running`, `kernel`, `kernel_mut`, `new`, `run`, `set_running`, `should_stop`, `start`, `stop`, `test_builder_rejects_backtest_environment`, `test_trading_node_build`, `test_trading_node_builder_creation`, `test_trading_node_builder_fluent_api`, `test_trading_node_builder_rejects_backtest`, `trader_id`, `with_delay_post_stop_secs`, `with_delay_shutdown_secs`, `with_instance_id`, `with_load_state` *(+5 more)*
**Impls**: `Default`, `LiveNode`, `LiveNodeBuilder`, `LiveNodeHandle`
**Structs**: `LiveNode`, `LiveNodeBuilder`, `LiveNodeHandle`
...
---
*Generated on 2025-11-18T21:55:02.115640Z*
