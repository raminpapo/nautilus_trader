# Documentation: `crates/pyo3/src/lib.rs`
**Generated:** 2025-11-15T19:40:03.398397Z
...
This file is located at `crates/pyo3/src/lib.rs` within the repository.

**Functions defined:** _shutdown_nautilus_runtime, _libnautilus, re_export_module_attributes, stub_info
...
#### `_shutdown_nautilus_runtime()`


#### `_libnautilus(py: Python<'_>, m: &Bound<'_, PyModule>)`
