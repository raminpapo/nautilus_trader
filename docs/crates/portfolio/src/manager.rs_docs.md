...
- **Path**: `crates/portfolio/src/manager.rs`
- **Size**: 34,289 bytes
- **Lines**: 966
- **Language**: Rust
...
- **`update_orders()`**: Function defined in this file
- **`update_positions()`**: Function defined in this file
- **`update_balance_locked()`**: Function defined in this file
- **`update_margin_init()`**: Function defined in this file
- **`update_balance_single_currency()`**: Function defined in this file
- **`update_balance_multi_currency()`**: Function defined in this file
- **`generate_account_state()`**: Function defined in this file
- **`calculate_xrate_to_base()`**: Function defined in this file
- **`test_update_balance_locked_with_base_currency_multiple_orders()`**: Function defined in this file

### Classes
- **`AccountsManager`**: Class defined in this file
...
**Functions**: `calculate_xrate_to_base`, `fmt`, `generate_account_state`, `new`, `test_update_balance_locked_with_base_currency_multiple_orders`, `update_balance_locked`, `update_balance_multi_currency`, `update_balance_single_currency`, `update_balances`, `update_margin_init`, `update_orders`, `update_positions`
**Impls**: `AccountsManager`, `Debug`
**Structs**: `AccountsManager`
...
---
*Generated on 2025-11-18T21:55:03.600256Z*
