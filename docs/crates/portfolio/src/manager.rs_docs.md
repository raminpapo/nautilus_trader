# Documentation: `crates/portfolio/src/manager.rs`
**Generated:** 2025-11-15T19:40:03.378335Z
**File Size:** 34289 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/portfolio/src/manager.rs` within the repository.

**Classes defined:** AccountsManager, Debug, AccountsManager

**Functions defined:** fmt, new, update_balances, update_orders, update_positions, update_balance_locked, update_margin_init, update_balance_single_currency, update_balance_multi_currency, generate_account_state and 2 more
...
#### `update_balance_single_currency(
        &self,
        account: AccountAny,
        fill: &OrderFilled,
        mut pnl: Money,
...
#### `generate_account_state(&self, account: AccountAny, ts_event: UnixNanos)`
...
#### `test_update_balance_locked_with_base_currency_multiple_orders()`
