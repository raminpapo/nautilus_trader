# Documentation: `crates/portfolio/src/tests.rs`
**Generated:** 2025-11-15T19:40:03.390220Z
**File Size:** 65805 bytes
**Extension:** .rs
**Type:** text
...
- **Path:** `crates/portfolio/src/tests.rs`
- **Size:** 65,805 bytes
- **Lines:** 2,182
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/portfolio/src/tests.rs` within the repository.

**Functions defined:** simple_cache, clock, venue, instrument_audusd, instrument_gbpusd, instrument_btcusdt, instrument_ethusdt, portfolio, get_cash_account, get_margin_account and 41 more
...
#### `instrument_audusd(audusd_sim: CurrencyPair)`


#### `instrument_gbpusd()`


#### `instrument_btcusdt(currency_pair_btcusdt: CurrencyPair)`


#### `instrument_ethusdt(ethusdt_bitmex: CryptoPerpetual)`
...
#### `get_cash_account(accountid: Option<&str>)`


#### `get_margin_account(accountid: Option<&str>)`
...
#### `submit_order(order: &OrderAny)`


#### `accept_order(order: &OrderAny)`


#### `fill_order(order: &OrderAny)`


#### `get_open_position(position: &Position)`


#### `get_changed_position(position: &Position)`


#### `get_close_position(position: &Position)`


#### `test_account_when_account_returns_the_account_facade(mut portfolio: Portfolio)`


#### `test_balances_locked_when_no_account_for_venue_returns_none(portfolio: Portfolio, venue: Venue)`


#### `test_margins_init_when_no_account_for_venue_returns_none(portfolio: Portfolio, venue: Venue)`


#### `test_margins_maint_when_no_account_for_venue_returns_none(portfolio: Portfolio, venue: Venue)`


#### `test_unrealized_pnl_for_instrument_when_no_instrument_returns_none(
    mut portfolio: Portfolio,
    instrument_audusd: InstrumentAny,
)`


#### `test_unrealized_pnl_for_venue_when_no_account_returns_empty_dict(
    mut portfolio: Portfolio,
    venue: Venue,
)`


#### `test_realized_pnl_for_instrument_when_no_instrument_returns_none(
    mut portfolio: Portfolio,
    instrument_audusd: InstrumentAny,
)`


#### `test_realized_pnl_for_venue_when_no_account_returns_empty_dict(
    mut portfolio: Portfolio,
    venue: Venue,
)`


#### `test_net_position_when_no_positions_returns_zero(
    portfolio: Portfolio,
    instrument_audusd: InstrumentAny,
)`


#### `test_net_exposures_when_no_positions_returns_none(portfolio: Portfolio, venue: Venue)`


#### `test_is_net_long_when_no_positions_returns_false(
    portfolio: Portfolio,
    instrument_audusd: InstrumentAny,
)`


#### `test_is_net_short_when_no_positions_returns_false(
    portfolio: Portfolio,
    instrument_audusd: InstrumentAny,
)`


#### `test_is_flat_when_no_positions_returns_true(
    portfolio: Portfolio,
    instrument_audusd: InstrumentAny,
)`


#### `test_is_completely_flat_when_no_positions_returns_true(portfolio: Portfolio)`


#### `test_open_value_when_no_account_returns_none(portfolio: Portfolio, venue: Venue)`


#### `test_update_tick(mut portfolio: Portfolio, instrument_audusd: InstrumentAny)`


#### `test_exceed_free_balance_single_currency_raises_account_balance_negative_exception(
    mut portfolio: Portfolio,
    cash_account_state: AccountState,
    instrument_audusd: InstrumentAny,
)`
...
#### `test_exceed_free_balance_multi_currency_raises_account_balance_negative_exception(
    mut portfolio: Portfolio,
    cash_account_state: AccountState,
    instrument_audusd: InstrumentAny,
)`
...
#### `test_update_orders_open_cash_account(
    mut portfolio: Portfolio,
    cash_account_state: AccountState,
    instrument_audusd: InstrumentAny,
)`
...
#### `test_update_orders_open_margin_account(
    mut portfolio: Portfolio,
    instrument_btcusdt: InstrumentAny,
)`


#### `test_order_accept_updates_margin_init(
    mut portfolio: Portfolio,
    instrument_btcusdt: InstrumentAny,
)`


#### `test_update_positions(mut portfolio: Portfolio, instrument_audusd: InstrumentAny)`


#### `test_opening_one_long_position_updates_portfolio(
    mut portfolio: Portfolio,
    instrument_audusd: InstrumentAny,
)`


#### `test_opening_one_long_position_updates_portfolio_with_bar(
    mut portfolio: Portfolio,
    instrument_audusd: InstrumentAny,
)`


#### `test_opening_one_short_position_updates_portfolio(
    mut portfolio: Portfolio,
    instrument_audusd: InstrumentAny,
)`


#### `test_opening_positions_with_multi_asset_account(
    mut portfolio: Portfolio,
    instrument_btcusdt: InstrumentAny,
    instrument_ethusdt: InstrumentAny,
)`
...
#### `test_market_value_when_insufficient_data_for_xrate_returns_none(
    mut portfolio: Portfolio,
    instrument_btcusdt: InstrumentAny,
    instrument_ethusdt: InstrumentAny,
)`
...
#### `test_opening_several_positions_updates_portfolio(
    mut portfolio: Portfolio,
    instrument_audusd: InstrumentAny,
    instrument_gbpusd: InstrumentAny,
)`
...
#### `test_modifying_position_updates_portfolio(
    mut portfolio: Portfolio,
    instrument_audusd: InstrumentAny,
)`


#### `test_closing_position_updates_portfolio(
    mut portfolio: Portfolio,
    instrument_audusd: InstrumentAny,
)`


#### `test_several_positions_with_different_instruments_updates_portfolio(
    mut portfolio: Portfolio,
    instrument_audusd: InstrumentAny,
    instrument_gbpusd: InstrumentAny,
)`
...
#### `test_realized_pnl_with_missing_exchange_rate_returns_zero_instead_of_panic(
    mut portfolio: Portfolio,
    instrument_audusd: InstrumentAny,
)`
...
**Directory:** `crates/portfolio/src`
