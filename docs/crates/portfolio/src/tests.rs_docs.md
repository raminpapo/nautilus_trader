...
This file is part of the NautilusTrader repository. It defines 51 function(s).
...
- **`instrument_btcusdt()`**: Function defined in this file
- **`instrument_ethusdt()`**: Function defined in this file
- **`portfolio()`**: Function defined in this file
- **`get_cash_account()`**: Function defined in this file
- **`get_margin_account()`**: Function defined in this file
- **`get_quote_tick()`**: Function defined in this file
- **`get_bar()`**: Function defined in this file
- **`submit_order()`**: Function defined in this file
- **`accept_order()`**: Function defined in this file
- **`fill_order()`**: Function defined in this file
- **`get_open_position()`**: Function defined in this file
- **`get_changed_position()`**: Function defined in this file
- **`get_close_position()`**: Function defined in this file
- **`test_account_when_account_returns_the_account_facade()`**: Function defined in this file
- **`test_balances_locked_when_no_account_for_venue_returns_none()`**: Function defined in this file
...
**Functions**: `accept_order`, `clock`, `fill_order`, `get_bar`, `get_cash_account`, `get_changed_position`, `get_close_position`, `get_margin_account`, `get_open_position`, `get_quote_tick`, `instrument_audusd`, `instrument_btcusdt`, `instrument_ethusdt`, `instrument_gbpusd`, `portfolio`, `simple_cache`, `submit_order`, `test_account_when_account_returns_the_account_facade`, `test_balances_locked_when_no_account_for_venue_returns_none`, `test_closing_position_updates_portfolio`, `test_exceed_free_balance_multi_currency_raises_account_balance_negative_exception`, `test_exceed_free_balance_single_currency_raises_account_balance_negative_exception`, `test_is_completely_flat_when_no_positions_returns_true`, `test_is_flat_when_no_positions_returns_true`, `test_is_net_long_when_no_positions_returns_false`, `test_is_net_short_when_no_positions_returns_false`, `test_margins_init_when_no_account_for_venue_returns_none`, `test_margins_maint_when_no_account_for_venue_returns_none`, `test_market_value_when_insufficient_data_for_xrate_returns_none`, `test_modifying_position_updates_portfolio` *(+21 more)*
...
```bash
# For Python
pytest crates/portfolio/src/tests.rs
...
---
*Generated on 2025-11-18T21:55:03.621885Z*
