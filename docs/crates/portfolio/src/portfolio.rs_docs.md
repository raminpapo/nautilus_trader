...
This file is part of the NautilusTrader repository. It defines 42 function(s) and 2 class(es).
...
- **`new()`**: Function defined in this file
- **`register_message_handlers()`**: Function defined in this file
- **`reset()`**: Function defined in this file
- **`is_initialized()`**: Function defined in this file
- **`balances_locked()`**: Function defined in this file
- **`margins_init()`**: Function defined in this file
- **`margins_maint()`**: Function defined in this file
- **`unrealized_pnls()`**: Function defined in this file
- **`realized_pnls()`**: Function defined in this file
- **`net_exposures()`**: Function defined in this file
- **`unrealized_pnl()`**: Function defined in this file
- **`realized_pnl()`**: Function defined in this file
- **`total_pnl()`**: Function defined in this file
- **`total_pnls()`**: Function defined in this file
- **`net_exposure()`**: Function defined in this file
- **`net_position()`**: Function defined in this file
- **`is_net_long()`**: Function defined in this file

*...and 22 more functions*

### Classes
- **`PortfolioState`**: Class defined in this file
- **`Portfolio`**: Class defined in this file
...
**Functions**: `balances_locked`, `calculate_realized_pnl`, `calculate_unrealized_pnl`, `calculate_xrate_to_base`, `ensure_snapshot_pnls_cached_for`, `fmt`, `get_price`, `initialize_orders`, `initialize_positions`, `is_completely_flat`, `is_flat`, `is_initialized`, `is_net_long`, `is_net_short`, `margins_init`, `margins_maint`, `net_exposure`, `net_exposures`, `net_position`, `new`, `realized_pnl`, `realized_pnls`, `register_message_handlers`, `reset`, `total_pnl`, `total_pnls`, `unrealized_pnl`, `unrealized_pnls`, `update_account`, `update_bar` *(+5 more)*
**Impls**: `Debug`, `Portfolio`, `PortfolioState`
**Structs**: `Portfolio`, `PortfolioState`
...
---
*Generated on 2025-11-18T21:55:03.611104Z*
