# Documentation: `crates/execution/src/client/base.rs`
**Generated:** 2025-11-15T19:40:02.029248Z
**File Size:** 14812 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/execution/src/client/base.rs` within the repository.

**Classes defined:** provides, ExecutionClientCore, Debug, ExecutionClientCore

**Functions defined:** fmt, new, set_connected, set_account_id, clock, cache, get_account, generate_account_state, generate_order_denied, generate_order_submitted and 15 more
...
#### `set_connected(&mut self, is_connected: bool)`
...
#### `send_account_state(&self, account_state: AccountState)`


#### `send_order_event(&self, event: OrderEventAny)`


#### `send_mass_status_report(&self, report: ExecutionMassStatus)`
...
#### `send_position_report(&self, report: PositionStatusReport)`
