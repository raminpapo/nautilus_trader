# Documentation: base.rs

## File Metadata

- **Path**: `crates/execution/src/client/base.rs`
- **Size**: 14,812 bytes
- **Lines**: 484
- **Language**: Rust
...
This file is part of the NautilusTrader repository. It defines 25 function(s) and 2 class(es).
...
- **`set_connected()`**: Function defined in this file
- **`set_account_id()`**: Function defined in this file
...
- **`generate_order_denied()`**: Function defined in this file
- **`generate_order_submitted()`**: Function defined in this file
- **`generate_order_rejected()`**: Function defined in this file
- **`generate_order_accepted()`**: Function defined in this file
- **`generate_order_modify_rejected()`**: Function defined in this file
- **`generate_order_cancel_rejected()`**: Function defined in this file
- **`generate_order_updated()`**: Function defined in this file
- **`generate_order_canceled()`**: Function defined in this file
- **`generate_order_triggered()`**: Function defined in this file
- **`generate_order_expired()`**: Function defined in this file
- **`generate_order_filled()`**: Function defined in this file
- **`send_account_state()`**: Function defined in this file

*...and 5 more functions*

### Classes
- **`provides`**: Class defined in this file
- **`ExecutionClientCore`**: Class defined in this file
...
**Functions**: `cache`, `clock`, `fmt`, `generate_account_state`, `generate_order_accepted`, `generate_order_cancel_rejected`, `generate_order_canceled`, `generate_order_denied`, `generate_order_expired`, `generate_order_filled`, `generate_order_modify_rejected`, `generate_order_rejected`, `generate_order_submitted`, `generate_order_triggered`, `generate_order_updated`, `get_account`, `new`, `send_account_state`, `send_fill_report`, `send_mass_status_report`, `send_order_event`, `send_order_status_report`, `send_position_report`, `set_account_id`, `set_connected`
**Impls**: `Debug`, `ExecutionClientCore`
**Structs**: `ExecutionClientCore`, `provides`
...
---
*Generated on 2025-11-18T21:55:01.575698Z*
