...
- **`position_id_count()`**: Function defined in this file
- **`check_integrity()`**: Function defined in this file
- **`check_connected()`**: Function defined in this file
- **`check_disconnected()`**: Function defined in this file
- **`check_residuals()`**: Function defined in this file
- **`get_external_order_claims_instruments()`**: Function defined in this file
- **`register_client()`**: Function defined in this file
- **`register_default_client()`**: Function defined in this file
- **`get_client()`**: Function defined in this file
- **`register_venue_routing()`**: Function defined in this file
- **`register_external_order_claims()`**: Function defined in this file
- **`deregister_client()`**: Function defined in this file
- **`load_cache()`**: Function defined in this file
- **`flush_db()`**: Function defined in this file
- **`process()`**: Function defined in this file
- **`execute()`**: Function defined in this file
- **`execute_command()`**: Function defined in this file
- **`handle_submit_order()`**: Function defined in this file

*...and 26 more functions*

### Classes
- **`ExecutionEngine`**: Class defined in this file
...
**Functions**: `apply_event_to_order`, `check_connected`, `check_disconnected`, `check_integrity`, `check_residuals`, `create_order_state_snapshot`, `create_position_state_snapshot`, `deny_order`, `deregister_client`, `determine_hedging_position_id`, `determine_netting_position_id`, `determine_oms_type`, `determine_position_id`, `execute`, `execute_command`, `flip_position`, `flush_db`, `fmt`, `get_client`, `get_external_order_claims_instruments`, `get_or_init_own_order_book`, `handle_batch_cancel_orders`, `handle_cancel_all_orders`, `handle_cancel_order`, `handle_event`, `handle_modify_order`, `handle_order_fill`, `handle_position_update`, `handle_query_account`, `handle_query_order` *(+16 more)*
**Impls**: `Debug`, `ExecutionEngine`
**Structs**: `ExecutionEngine`
...
---
*Generated on 2025-11-18T21:55:01.590444Z*
