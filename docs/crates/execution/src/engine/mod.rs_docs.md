# Documentation: `crates/execution/src/engine/mod.rs`
**Generated:** 2025-11-15T19:40:02.037375Z
**File Size:** 44283 bytes
**Extension:** .rs
**Type:** text
...
- **Path:** `crates/execution/src/engine/mod.rs`
- **Size:** 44,283 bytes
- **Lines:** 1,205
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/execution/src/engine/mod.rs` within the repository.

**Classes defined:** ExecutionEngine, Debug, ExecutionEngine

**Functions defined:** fmt, new, position_id_count, check_integrity, check_connected, check_disconnected, check_residuals, get_external_order_claims_instruments, register_client, register_default_client and 36 more
...
#### `position_id_count(&self, strategy_id: StrategyId)`
...
#### `check_residuals(&self)`


#### `get_external_order_claims_instruments(&self)`


#### `register_client(&mut self, client: Rc<dyn ExecutionClient>)`


#### `register_default_client(&mut self, client: Rc<dyn ExecutionClient>)`


#### `get_client(&self, client_id: &ClientId)`
...
#### `register_external_order_claims(&mut self, strategy: Strategy)`


#### `deregister_client(&mut self, client_id: ClientId)`
...
#### `process(&mut self, event: &OrderEventAny)`


#### `execute(&self, command: &TradingCommand)`


#### `execute_command(&self, command: &TradingCommand)`


#### `handle_submit_order(&self, client: Rc<dyn ExecutionClient>, cmd: &SubmitOrder)`


#### `handle_submit_order_list(&self, client: Rc<dyn ExecutionClient>, cmd: &SubmitOrderList)`


#### `handle_modify_order(&self, client: Rc<dyn ExecutionClient>, cmd: &ModifyOrder)`


#### `handle_cancel_order(&self, client: Rc<dyn ExecutionClient>, cmd: &CancelOrder)`


#### `handle_cancel_all_orders(&self, client: Rc<dyn ExecutionClient>, cmd: &CancelAllOrders)`


#### `handle_batch_cancel_orders(&self, client: Rc<dyn ExecutionClient>, cmd: &BatchCancelOrders)`


#### `handle_query_account(&self, client: Rc<dyn ExecutionClient>, cmd: &QueryAccount)`


#### `handle_query_order(&self, client: Rc<dyn ExecutionClient>, cmd: &QueryOrder)`


#### `create_order_state_snapshot(&self, order: &OrderAny)`


#### `create_position_state_snapshot(&self, position: &Position)`


#### `handle_event(&mut self, event: &OrderEventAny)`


#### `determine_oms_type(&self, fill: &OrderFilled)`
...
#### `determine_netting_position_id(&self, fill: OrderFilled)`


#### `apply_event_to_order(&self, order: &mut OrderAny, event: OrderEventAny)`


#### `handle_order_fill(&mut self, order: &OrderAny, fill: OrderFilled, oms_type: OmsType)`
...
#### `update_position(&self, position: &mut Position, fill: OrderFilled)`


#### `will_flip_position(&self, position: &Position, fill: OrderFilled)`
...
#### `set_position_id_counts(&mut self)`
...
#### `set_order_base_qty(&self, order: &mut OrderAny, base_qty: Quantity)`


#### `deny_order(&self, order: &OrderAny, reason: &str)`


#### `get_or_init_own_order_book(&self, instrument_id: &InstrumentId)`
