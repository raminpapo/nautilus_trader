...
This file is part of the NautilusTrader repository. It defines 63 function(s).

## Detailed Walkthrough

### Functions
- **`test_clock()`**: Function defined in this file
- **`test_cache()`**: Function defined in this file
- **`execution_engine()`**: Function defined in this file
- **`execution_engine_with_config()`**: Function defined in this file
- **`stub_client()`**: Function defined in this file
- **`test_register_client_success()`**: Function defined in this file
- **`test_register_venue_routing_success()`**: Function defined in this file
- **`test_deregister_client_removes_client()`**: Function defined in this file
- **`test_check_connected_when_client_connected_returns_true()`**: Function defined in this file
- **`test_check_connected_when_client_disconnected_returns_false()`**: Function defined in this file
- **`test_check_disconnected_when_client_disconnected_returns_true()`**: Function defined in this file
- **`test_check_integrity_returns_true()`**: Function defined in this file
- **`test_set_position_id_counts_updates_correctly()`**: Function defined in this file
- **`test_execution_engine_with_config_initializes_correctly()`**: Function defined in this file
- **`test_execution_engine_default_config_initializes_correctly()`**: Function defined in this file
- **`test_execute_query_order_command_succeeds()`**: Function defined in this file
- **`test_submit_order_with_duplicate_client_order_id_handles_gracefully()`**: Function defined in this file
- **`test_submit_order_for_random_venue_logs()`**: Function defined in this file
- **`test_order_filled_with_unrecognized_strategy_id()`**: Function defined in this file
- **`test_submit_bracket_order_list_with_all_duplicate_client_order_id_logs_does_not_submit()`**: Function defined in this file
...
Total unique keywords extracted: 63


**Functions**: `execution_engine`, `execution_engine_with_config`, `stub_client`, `test_add_to_existing_position_on_order_fill`, `test_cache`, `test_cancel_order_for_already_closed_order_logs_and_does_nothing`, `test_cancel_order_removes_from_own_book`, `test_canceled_order_receiving_fill_event_reopens_and_completes_order`, `test_canceled_order_receiving_partial_fill_event_reopens_and_becomes_partially_filled`, `test_check_connected_when_client_connected_returns_true`, `test_check_connected_when_client_disconnected_returns_false`, `test_check_disconnected_when_client_disconnected_returns_true`, `test_check_integrity_returns_true`, `test_clock`, `test_close_position_on_order_fill`, `test_deregister_client_removes_client`, `test_execute_query_order_command_succeeds`, `test_execution_engine_default_config_initializes_correctly`, `test_execution_engine_with_config_initializes_correctly`, `test_filled_order_removes_from_own_book`, `test_flip_position_on_flat_position_then_filled_reusing_position_id`, `test_flip_position_on_opposite_filled_same_position_buy`, `test_flip_position_on_opposite_filled_same_position_sell`, `test_flip_position_when_netting_oms`, `test_handle_duplicate_order_events_logs_error_and_does_not_apply`, `test_handle_multiple_partial_fill_events`, `test_handle_order_event_with_different_client_order_id_but_matching_venue_order_id_fails_to_apply`, `test_handle_order_event_with_random_client_order_id_and_order_id_not_cached`, `test_handle_order_fill_event`, `test_handle_order_fill_event_with_no_position_id_correctly_handles_fill` *(+33 more)*
...
```bash
# For Python
pytest crates/execution/src/engine/tests.rs
...
---
*Generated on 2025-11-18T21:55:01.646659Z*
