# Documentation: `crates/execution/src/engine/tests.rs`
**Generated:** 2025-11-15T19:40:02.065479Z
**File Size:** 272933 bytes
**Extension:** .rs
**Type:** text
...
- **Path:** `crates/execution/src/engine/tests.rs`
- **Size:** 272,933 bytes
- **Lines:** 8,288
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/execution/src/engine/tests.rs` within the repository.

**Functions defined:** test_clock, test_cache, execution_engine, execution_engine_with_config, stub_client, test_register_client_success, test_register_venue_routing_success, test_deregister_client_removes_client, test_check_connected_when_client_connected_returns_true, test_check_connected_when_client_disconnected_returns_false and 53 more
...
#### `test_check_connected_when_client_connected_returns_true(mut execution_engine: ExecutionEngine)`
...
#### `test_check_integrity_returns_true(execution_engine: ExecutionEngine)`


#### `test_set_position_id_counts_updates_correctly(mut execution_engine: ExecutionEngine)`
...
#### `test_execution_engine_default_config_initializes_correctly(execution_engine: ExecutionEngine)`


#### `test_execute_query_order_command_succeeds(execution_engine: ExecutionEngine)`
...
#### `test_submit_order_for_random_venue_logs(mut execution_engine: ExecutionEngine)`


#### `test_order_filled_with_unrecognized_strategy_id(mut execution_engine: ExecutionEngine)`
...
#### `test_submit_order_with_cleared_cache_logs_error(mut execution_engine: ExecutionEngine)`
...
#### `test_handle_order_fill_event(mut execution_engine: ExecutionEngine)`


#### `test_handle_multiple_partial_fill_events(mut execution_engine: ExecutionEngine)`


#### `test_handle_position_opening_with_position_id_none(mut execution_engine: ExecutionEngine)`


#### `test_add_to_existing_position_on_order_fill(mut execution_engine: ExecutionEngine)`


#### `test_close_position_on_order_fill(mut execution_engine: ExecutionEngine)`


#### `test_multiple_strategy_positions_opened(mut execution_engine: ExecutionEngine)`


#### `test_flip_position_on_opposite_filled_same_position_sell(mut execution_engine: ExecutionEngine)`


#### `test_flip_position_on_opposite_filled_same_position_buy(mut execution_engine: ExecutionEngine)`
...
#### `test_flip_position_when_netting_oms(mut execution_engine: ExecutionEngine)`


#### `test_handle_updated_order_event(mut execution_engine: ExecutionEngine)`
