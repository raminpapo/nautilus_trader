# Documentation: `crates/execution/src/engine/config.rs`
**Generated:** 2025-11-15T19:40:02.032862Z
**File Size:** 3162 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/execution/src/engine/config.rs` within the repository.

**Classes defined:** ExecutionEngineConfig, Default

**Functions defined:** default_true, default
