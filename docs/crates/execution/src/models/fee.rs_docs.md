# Documentation: `crates/execution/src/models/fee.rs`
**Generated:** 2025-11-15T19:40:02.103869Z
**File Size:** 9397 bytes
**Extension:** .rs
**Type:** text
...
- **Path:** `crates/execution/src/models/fee.rs`
- **Size:** 9,397 bytes
- **Lines:** 266
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/execution/src/models/fee.rs` within the repository.

**Classes defined:** FixedFeeModel, MakerTakerFeeModel, FeeModel, Default, FixedFeeModel, FeeModel, FeeModel

**Functions defined:** get_commission, get_commission, default, new, get_commission, get_commission, test_fixed_model_single_fill, test_fixed_model_multiple_fills, test_maker_taker_fee_model_maker_commission, test_maker_taker_fee_model_taker_commission
...
#### `new(commission: Money, change_commission_once: Option<bool>)`
