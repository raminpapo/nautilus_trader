...
### Functions
- **`get_commission()`**: Function defined in this file
- **`get_commission()`**: Function defined in this file
- **`default()`**: Function defined in this file
- **`new()`**: Function defined in this file
- **`get_commission()`**: Function defined in this file
- **`get_commission()`**: Function defined in this file
- **`test_fixed_model_single_fill()`**: Function defined in this file
- **`test_fixed_model_multiple_fills()`**: Function defined in this file
- **`test_maker_taker_fee_model_maker_commission()`**: Function defined in this file
- **`test_maker_taker_fee_model_taker_commission()`**: Function defined in this file

### Classes
- **`FixedFeeModel`**: Class defined in this file
- **`MakerTakerFeeModel`**: Class defined in this file
...
**Enums**: `FeeModelAny`
**Functions**: `default`, `get_commission`, `new`, `test_fixed_model_multiple_fills`, `test_fixed_model_single_fill`, `test_maker_taker_fee_model_maker_commission`, `test_maker_taker_fee_model_taker_commission`
**Impls**: `Default`, `FeeModel`, `FixedFeeModel`
**Structs**: `FixedFeeModel`, `MakerTakerFeeModel`
**Traits**: `FeeModel`
...
---
*Generated on 2025-11-18T21:55:01.706543Z*
