# Documentation: `crates/execution/src/models/fill.rs`
**Generated:** 2025-11-15T19:40:02.105984Z
**File Size:** 6520 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/execution/src/models/fill.rs` within the repository.

**Classes defined:** FillModel, FillModel, Display, Default

**Functions defined:** new, is_limit_filled, is_stop_filled, is_slipped, get_orderbook_for_fill_simulation, event_success, fmt, default, fill_model, test_fill_model_param_prob_fill_on_limit_error and 5 more
...
#### `is_limit_filled(&mut self)`


#### `is_stop_filled(&mut self)`
...
#### `event_success(&mut self, probability: f64)`
...
#### `test_fill_model_is_limit_filled(mut fill_model: FillModel)`


#### `test_fill_model_is_stop_filled(mut fill_model: FillModel)`


#### `test_fill_model_is_slipped(mut fill_model: FillModel)`
