# Documentation: `crates/execution/src/matching_engine/ids_generator.rs`
**Generated:** 2025-11-15T19:40:02.090487Z
...
This file is located at `crates/execution/src/matching_engine/ids_generator.rs` within the repository.

**Classes defined:** IdsGenerator, Debug, IdsGenerator

**Functions defined:** fmt, new, reset, get_venue_order_id, get_position_id, generate_trade_id, generate_venue_position_id, generate_venue_order_id, get_ids_generator, test_get_position_id_hedging_with_existing_position and 4 more
...
#### `get_venue_order_id(&mut self, order: &OrderAny)`
...
#### `generate_trade_id(&mut self)`


#### `generate_venue_position_id(&mut self)`


#### `generate_venue_order_id(&mut self)`
...
#### `test_get_position_id_hedging_with_generated_position(market_order_buy: OrderAny)`
...
#### `get_venue_position_id(market_order_buy: OrderAny, market_order_sell: OrderAny)`
