# Documentation: ids_generator.rs

## File Metadata

- **Path**: `crates/execution/src/matching_engine/ids_generator.rs`
- **Size**: 10,317 bytes
- **Lines**: 302
- **Language**: Rust
...
- **`get_position_id()`**: Function defined in this file
- **`generate_trade_id()`**: Function defined in this file
- **`generate_venue_position_id()`**: Function defined in this file
- **`generate_venue_order_id()`**: Function defined in this file
- **`get_ids_generator()`**: Function defined in this file
- **`test_get_position_id_hedging_with_existing_position()`**: Function defined in this file
- **`test_get_position_id_hedging_with_generated_position()`**: Function defined in this file
- **`test_get_position_id_netting()`**: Function defined in this file
- **`test_generate_venue_position_id()`**: Function defined in this file
- **`get_venue_position_id()`**: Function defined in this file

### Classes
- **`IdsGenerator`**: Class defined in this file
...
**Functions**: `fmt`, `generate_trade_id`, `generate_venue_order_id`, `generate_venue_position_id`, `get_ids_generator`, `get_position_id`, `get_venue_order_id`, `get_venue_position_id`, `new`, `reset`, `test_generate_venue_position_id`, `test_get_position_id_hedging_with_existing_position`, `test_get_position_id_hedging_with_generated_position`, `test_get_position_id_netting`
**Impls**: `Debug`, `IdsGenerator`
**Structs**: `IdsGenerator`
...
---
*Generated on 2025-11-18T21:55:01.683338Z*
