...
This file is part of the NautilusTrader repository. It defines 66 function(s) and 1 class(es).
...
- **`set_fill_model()`**: Function defined in this file
- **`best_bid_price()`**: Function defined in this file
- **`best_ask_price()`**: Function defined in this file
- **`get_book()`**: Function defined in this file
- **`get_open_bid_orders()`**: Function defined in this file
- **`get_open_ask_orders()`**: Function defined in this file
- **`get_open_orders()`**: Function defined in this file
- **`order_exists()`**: Function defined in this file
- **`process_order_book_delta()`**: Function defined in this file
- **`process_order_book_deltas()`**: Function defined in this file
- **`process_quote_tick()`**: Function defined in this file
- **`process_bar()`**: Function defined in this file
- **`process_trade_ticks_from_bar()`**: Function defined in this file
- **`process_quote_ticks_from_bar()`**: Function defined in this file
- **`process_trade_tick()`**: Function defined in this file
- **`process_status()`**: Function defined in this file
- **`process_order()`**: Function defined in this file

*...and 46 more functions*

### Classes
- **`OrderMatchingEngine`**: Class defined in this file
...
**Functions**: `accept_order`, `apply_fills`, `best_ask_price`, `best_bid_price`, `cancel_contingent_orders`, `cancel_order`, `determine_limit_price_and_volume`, `determine_market_price_and_volume`, `expire_order`, `fill_limit_order`, `fill_market_order`, `fill_order`, `fmt`, `generate_order_accepted`, `generate_order_cancel_rejected`, `generate_order_canceled`, `generate_order_expired`, `generate_order_filled`, `generate_order_modify_rejected`, `generate_order_rejected`, `generate_order_triggered`, `generate_order_updated`, `get_book`, `get_open_ask_orders`, `get_open_bid_orders`, `get_open_orders`, `iterate`, `iterate_orders`, `maybe_activate_trailing_stop`, `new` *(+36 more)*
**Impls**: `Debug`, `OrderMatchingEngine`
**Structs**: `OrderMatchingEngine`
...
---
*Generated on 2025-11-18T21:55:01.679434Z*
