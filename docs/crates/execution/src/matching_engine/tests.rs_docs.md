# Documentation: `crates/execution/src/matching_engine/tests.rs`
**Generated:** 2025-11-15T19:40:02.100131Z
**File Size:** 114694 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/execution/src/matching_engine/tests.rs` within the repository.

**Functions defined:** test_clock, order_event_handler, instrument_eth_usdt, market_order_buy, market_order_fill, market_order_sell, instrument_es, engine_config, get_order_matching_engine, get_order_matching_engine_l2 and 45 more
...
#### `get_order_event_handler_messages(event_handler: ShareableMessageHandler)`
...
#### `test_bid_ask_initialized(instrument_es: InstrumentAny)`
