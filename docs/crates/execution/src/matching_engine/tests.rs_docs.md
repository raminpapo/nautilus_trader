...
- **Path**: `crates/execution/src/matching_engine/tests.rs`
- **Size**: 114,694 bytes
- **Lines**: 3,049
- **Language**: Rust
...
This file is part of the NautilusTrader repository. It defines 55 function(s).

## Detailed Walkthrough

### Functions
- **`test_clock()`**: Function defined in this file
- **`order_event_handler()`**: Function defined in this file
- **`instrument_eth_usdt()`**: Function defined in this file
- **`market_order_buy()`**: Function defined in this file
- **`market_order_fill()`**: Function defined in this file
- **`market_order_sell()`**: Function defined in this file
- **`instrument_es()`**: Function defined in this file
- **`engine_config()`**: Function defined in this file
- **`get_order_matching_engine()`**: Function defined in this file
- **`get_order_matching_engine_l2()`**: Function defined in this file
- **`get_order_event_handler_messages()`**: Function defined in this file
- **`test_process_order_when_instrument_already_expired()`**: Function defined in this file
- **`test_process_order_when_instrument_not_active()`**: Function defined in this file
- **`test_process_order_when_invalid_quantity_precision()`**: Function defined in this file
- **`test_process_order_when_invalid_price_precision()`**: Function defined in this file
- **`test_process_order_when_invalid_trigger_price_precision()`**: Function defined in this file
- **`test_process_order_when_shorting_equity_without_margin_account()`**: Function defined in this file
- **`test_process_order_when_invalid_reduce_only()`**: Function defined in this file
- **`test_process_order_when_invalid_contingent_orders()`**: Function defined in this file
- **`test_process_order_when_closed_linked_order()`**: Function defined in this file
...
**Functions**: `engine_config`, `get_order_event_handler_messages`, `get_order_matching_engine`, `get_order_matching_engine_l2`, `instrument_es`, `instrument_eth_usdt`, `market_order_buy`, `market_order_fill`, `market_order_sell`, `order_event_handler`, `test_bid_ask_initialized`, `test_clock`, `test_expire_order`, `test_not_enough_quantity_filled_fok_order`, `test_process_batch_cancel_command`, `test_process_cancel_all_command`, `test_process_cancel_command_order_not_found`, `test_process_cancel_command_valid`, `test_process_limit_if_touched_order_immediate_trigger_and_fill`, `test_process_limit_order_matched_immediate_fill`, `test_process_limit_order_not_matched_and_canceled_fok_order`, `test_process_limit_post_only_order_that_would_be_a_taker`, `test_process_market_if_touched_order_already_triggered`, `test_process_market_order_no_market_rejected`, `test_process_market_orders_with_protection_rejeceted_and_valid`, `test_process_market_to_limit_orders_not_fully_filled`, `test_process_modify_order_rejected_not_found`, `test_process_monthly_bar_not_skipped`, `test_process_order_when_closed_linked_order`, `test_process_order_when_instrument_already_expired` *(+25 more)*
...
```bash
# For Python
pytest crates/execution/src/matching_engine/tests.rs
...
---
*Generated on 2025-11-18T21:55:01.703060Z*
