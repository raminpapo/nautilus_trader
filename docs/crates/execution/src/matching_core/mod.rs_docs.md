# Documentation: `crates/execution/src/matching_core/mod.rs`
**Generated:** 2025-11-15T19:40:02.076667Z
**File Size:** 19500 bytes
**Extension:** .rs
**Type:** text
...
- **Path:** `crates/execution/src/matching_core/mod.rs`
- **Size:** 19,500 bytes
- **Lines:** 579
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/execution/src/matching_core/mod.rs` within the repository.

**Classes defined:** OrderMatchingCore, OrderMatchingCore

**Functions defined:** new, set_fill_limit_order_handler, set_trigger_stop_order_handler, set_fill_market_order_handler, price_precision, get_order, get_orders_bid, get_orders_ask, get_orders, order_exists and 24 more
...
#### `set_fill_limit_order_handler(&mut self, handler: ShareableFillLimitOrderHandler)`


#### `set_trigger_stop_order_handler(&mut self, handler: ShareableTriggerStopOrderHandler)`


#### `set_fill_market_order_handler(&mut self, handler: ShareableFillMarketOrderHandler)`
...
#### `set_last_raw(&mut self, last: Price)`


#### `set_bid_raw(&mut self, bid: Price)`


#### `set_ask_raw(&mut self, ask: Price)`


#### `reset(&mut self)`


#### `add_order(&mut self, order: PassiveOrderAny)`


#### `delete_order(&mut self, order: &PassiveOrderAny)`


#### `iterate(&mut self)`


#### `iterate_bids(&mut self)`


#### `iterate_asks(&mut self)`


#### `iterate_orders(&mut self, orders: &[PassiveOrderAny])`


#### `match_order(&mut self, order: &PassiveOrderAny, _initial: bool)`


#### `match_limit_order(&mut self, order: &LimitOrderAny)`


#### `match_stop_order(&mut self, order: &StopOrderAny)`


#### `is_limit_matched(&self, side: OrderSideSpecified, price: Price)`


#### `is_stop_matched(&self, side: OrderSideSpecified, price: Price)`


#### `is_touch_triggered(&self, side: OrderSideSpecified, trigger_price: Price)`
...
#### `test_delete_order_when_exists(#[case] order_side: OrderSide)`
