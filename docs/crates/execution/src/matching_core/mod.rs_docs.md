...
- **`set_fill_limit_order_handler()`**: Function defined in this file
- **`set_trigger_stop_order_handler()`**: Function defined in this file
- **`set_fill_market_order_handler()`**: Function defined in this file
- **`price_precision()`**: Function defined in this file
- **`get_order()`**: Function defined in this file
- **`get_orders_bid()`**: Function defined in this file
- **`get_orders_ask()`**: Function defined in this file
- **`get_orders()`**: Function defined in this file
- **`order_exists()`**: Function defined in this file
- **`set_last_raw()`**: Function defined in this file
- **`set_bid_raw()`**: Function defined in this file
- **`set_ask_raw()`**: Function defined in this file
- **`reset()`**: Function defined in this file
- **`add_order()`**: Function defined in this file
- **`delete_order()`**: Function defined in this file
- **`iterate()`**: Function defined in this file
- **`iterate_bids()`**: Function defined in this file
- **`iterate_asks()`**: Function defined in this file
- **`iterate_orders()`**: Function defined in this file

*...and 14 more functions*

### Classes
- **`OrderMatchingCore`**: Class defined in this file
...
**Functions**: `add_order`, `create_matching_core`, `delete_order`, `get_order`, `get_orders`, `get_orders_ask`, `get_orders_bid`, `is_limit_matched`, `is_stop_matched`, `is_touch_triggered`, `iterate`, `iterate_asks`, `iterate_bids`, `iterate_orders`, `match_limit_order`, `match_order`, `match_stop_order`, `new`, `order_exists`, `price_precision`, `reset`, `set_ask_raw`, `set_bid_raw`, `set_fill_limit_order_handler`, `set_fill_market_order_handler`, `set_last_raw`, `set_trigger_stop_order_handler`, `test_add_order_ask_side`, `test_add_order_bid_side`, `test_delete_order_when_exists` *(+4 more)*
**Impls**: `OrderMatchingCore`
**Structs**: `OrderMatchingCore`
...
---
*Generated on 2025-11-18T21:55:01.657959Z*
