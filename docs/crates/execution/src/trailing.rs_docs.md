# Documentation: trailing.rs

## File Metadata

- **Path**: `crates/execution/src/trailing.rs`
- **Size**: 27,483 bytes
- **Lines**: 724
- **Language**: Rust
...
### Functions
- **`trailing_stop_calculate()`**: Function defined in this file
- **`trailing_stop_calculate_with_last()`**: Function defined in this file
- **`trailing_stop_calculate_with_bid_ask()`**: Function defined in this file
- **`test_calculate_with_invalid_order_type()`**: Function defined in this file
- **`test_calculate_with_last_price_no_last()`**: Function defined in this file
- **`test_calculate_with_bid_ask_no_bid_ask()`**: Function defined in this file
- **`test_calculate_with_unsupported_trigger_type()`**: Function defined in this file
- **`test_trailing_stop_market_last_price()`**: Function defined in this file
- **`test_trailing_stop_market_basis_points()`**: Function defined in this file
- **`test_trailing_stop_market_bid_ask()`**: Function defined in this file
- **`test_trailing_stop_market_ticks()`**: Function defined in this file
- **`test_trailing_stop_last_or_bid_ask()`**: Function defined in this file
- **`test_trailing_stop_market_last_price_move_in_favour()`**: Function defined in this file
- **`test_trailing_stop_limit_last_price_buy_improve_trigger_and_limit()`**: Function defined in this file
- **`test_trailing_stop_limit_last_price_sell_improve()`**: Function defined in this file
- **`test_no_update_when_candidate_worse()`**: Function defined in this file
- **`test_trailing_stop_limit_basis_points_buy_improve()`**: Function defined in this file
...
**Functions**: `test_calculate_with_bid_ask_no_bid_ask`, `test_calculate_with_invalid_order_type`, `test_calculate_with_last_price_no_last`, `test_calculate_with_unsupported_trigger_type`, `test_no_update_when_candidate_worse`, `test_trailing_stop_last_or_bid_ask`, `test_trailing_stop_limit_basis_points_buy_improve`, `test_trailing_stop_limit_last_price_buy_improve_trigger_and_limit`, `test_trailing_stop_limit_last_price_sell_improve`, `test_trailing_stop_market_basis_points`, `test_trailing_stop_market_bid_ask`, `test_trailing_stop_market_last_price`, `test_trailing_stop_market_last_price_move_in_favour`, `test_trailing_stop_market_ticks`, `trailing_stop_calculate`, `trailing_stop_calculate_with_bid_ask`, `trailing_stop_calculate_with_last`
...
---
*Generated on 2025-11-18T21:55:01.746163Z*
