...
- **`set_submit_order_handler()`**: Function defined in this file
- **`set_cancel_order_handler()`**: Function defined in this file
- **`set_modify_order_handler()`**: Function defined in this file
- **`get_submit_order_commands()`**: Function defined in this file
- **`cache_submit_order_command()`**: Function defined in this file
- **`pop_submit_order_command()`**: Function defined in this file
- **`reset()`**: Function defined in this file
- **`cancel_order()`**: Function defined in this file
- **`modify_order_quantity()`**: Function defined in this file
- **`create_new_submit_order()`**: Function defined in this file
- **`should_manage_order()`**: Function defined in this file
- **`handle_event()`**: Function defined in this file
- **`handle_order_rejected()`**: Function defined in this file
- **`handle_order_canceled()`**: Function defined in this file
- **`handle_order_expired()`**: Function defined in this file
- **`handle_order_updated()`**: Function defined in this file
- **`handle_order_filled()`**: Function defined in this file
- **`handle_contingencies()`**: Function defined in this file

*...and 8 more functions*

### Classes
- **`OrderManager`**: Class defined in this file
...
**Functions**: `cache_submit_order_command`, `cancel_order`, `create_new_submit_order`, `fmt`, `get_submit_order_commands`, `handle_contingencies`, `handle_contingencies_update`, `handle_event`, `handle_order_canceled`, `handle_order_expired`, `handle_order_filled`, `handle_order_rejected`, `handle_order_updated`, `handle_position_event`, `modify_order_quantity`, `new`, `pop_submit_order_command`, `reset`, `send_algo_command`, `send_emulator_command`, `send_exec_command`, `send_exec_event`, `send_risk_command`, `send_risk_event`, `set_cancel_order_handler`, `set_modify_order_handler`, `set_submit_order_handler`, `should_manage_order`
**Impls**: `Debug`, `OrderManager`
**Structs**: `OrderManager`

## Related Files

This file is located in `crates/execution/src/order_manager/`. Related files may include:
...
---
*Generated on 2025-11-18T21:55:01.733855Z*
