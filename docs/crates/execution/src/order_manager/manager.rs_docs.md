# Documentation: `crates/execution/src/order_manager/manager.rs`
**Generated:** 2025-11-15T19:40:02.121760Z
**File Size:** 21558 bytes
**Extension:** .rs
**Type:** text
...
- **Path:** `crates/execution/src/order_manager/manager.rs`
- **Size:** 21,558 bytes
- **Lines:** 581
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/execution/src/order_manager/manager.rs` within the repository.

**Classes defined:** OrderManager, Debug, OrderManager

**Functions defined:** fmt, new, set_submit_order_handler, set_cancel_order_handler, set_modify_order_handler, get_submit_order_commands, cache_submit_order_command, pop_submit_order_command, reset, cancel_order and 18 more
...
#### `set_submit_order_handler(&mut self, handler: SubmitOrderHandlerAny)`


#### `set_cancel_order_handler(&mut self, handler: CancelOrderHandlerAny)`


#### `set_modify_order_handler(&mut self, handler: ModifyOrderHandlerAny)`


#### `get_submit_order_commands(&self)`


#### `cache_submit_order_command(&mut self, command: SubmitOrder)`
...
#### `cancel_order(&mut self, order: &OrderAny)`


#### `modify_order_quantity(&mut self, order: &mut OrderAny, new_quantity: Quantity)`
...
#### `should_manage_order(&self, order: &OrderAny)`


#### `handle_event(&mut self, event: OrderEventAny)`


#### `handle_order_rejected(&mut self, rejected: OrderRejected)`


#### `handle_order_canceled(&mut self, canceled: OrderCanceled)`


#### `handle_order_expired(&mut self, expired: OrderExpired)`


#### `handle_order_updated(&mut self, updated: OrderUpdated)`


#### `handle_order_filled(&mut self, filled: OrderFilled)`


#### `handle_contingencies(&mut self, order: OrderAny)`


#### `handle_contingencies_update(&mut self, order: OrderAny)`


#### `handle_position_event(&mut self, _event: OrderEventAny)`


#### `send_emulator_command(&self, command: TradingCommand)`


#### `send_algo_command(&self, command: SubmitOrder, exec_algorithm_id: ExecAlgorithmId)`


#### `send_risk_command(&self, command: TradingCommand)`


#### `send_exec_command(&self, command: TradingCommand)`


#### `send_risk_event(&self, event: OrderEventAny)`


#### `send_exec_event(&self, event: OrderEventAny)`
...
**Directory:** `crates/execution/src/order_manager`
