# Documentation: `crates/execution/src/protection.rs`
**Generated:** 2025-11-15T19:40:02.124585Z
**File Size:** 6147 bytes
**Extension:** .rs
**Type:** text
...
- **Path:** `crates/execution/src/protection.rs`
- **Size:** 6,147 bytes
- **Lines:** 181
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/execution/src/protection.rs` within the repository.

**Functions defined:** protection_price_calculate, build_stop_order, test_calculate_with_invalid_order_type, test_calculate_requires_protection_points, test_calculate_requires_opposite_quote, test_protection_price_buy, test_protection_price_sell
...
#### `build_stop_order(order_type: OrderType, side: OrderSide)`
...
#### `test_calculate_requires_opposite_quote(#[case] side: OrderSide)`


#### `test_protection_price_buy(#[case] order_type: OrderType)`


#### `test_protection_price_sell(#[case] order_type: OrderType)`
