...
### Functions
- **`protection_price_calculate()`**: Function defined in this file
- **`build_stop_order()`**: Function defined in this file
- **`test_calculate_with_invalid_order_type()`**: Function defined in this file
- **`test_calculate_requires_protection_points()`**: Function defined in this file
- **`test_calculate_requires_opposite_quote()`**: Function defined in this file
- **`test_protection_price_buy()`**: Function defined in this file
- **`test_protection_price_sell()`**: Function defined in this file
...
**Functions**: `build_stop_order`, `protection_price_calculate`, `test_calculate_requires_opposite_quote`, `test_calculate_requires_protection_points`, `test_calculate_with_invalid_order_type`, `test_protection_price_buy`, `test_protection_price_sell`
...
---
*Generated on 2025-11-18T21:55:01.740142Z*
