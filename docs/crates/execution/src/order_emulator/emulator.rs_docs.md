...
- **`set_on_event_handler()`**: Function defined in this file
...
- **`subscribed_quotes()`**: Function defined in this file
- **`subscribed_trades()`**: Function defined in this file
- **`get_submit_order_commands()`**: Function defined in this file
- **`get_matching_core()`**: Function defined in this file
- **`on_start()`**: Function defined in this file
- **`on_event()`**: Function defined in this file
...
- **`create_matching_core()`**: Function defined in this file
- **`handle_submit_order()`**: Function defined in this file
- **`handle_submit_order_list()`**: Function defined in this file
- **`handle_modify_order()`**: Function defined in this file

*...and 14 more functions*

### Classes
- **`OrderEmulator`**: Class defined in this file
...
**Functions**: `cancel_order`, `check_monitoring`, `create_matching_core`, `execute`, `fill_limit_order`, `fill_market_order`, `fmt`, `get_matching_core`, `get_submit_order_commands`, `handle_cancel_all_orders`, `handle_cancel_order`, `handle_modify_order`, `handle_submit_order`, `handle_submit_order_list`, `iterate_orders`, `new`, `on_dispose`, `on_event`, `on_order_book_deltas`, `on_quote_tick`, `on_reset`, `on_start`, `on_stop`, `on_trade_tick`, `set_cancel_order_handler`, `set_modify_order_handler`, `set_on_event_handler`, `set_submit_order_handler`, `subscribed_quotes`, `subscribed_trades` *(+4 more)*
**Impls**: `Debug`, `OrderEmulator`
**Structs**: `OrderEmulator`
...
---
*Generated on 2025-11-18T21:55:01.723990Z*
