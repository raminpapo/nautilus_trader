# Documentation: `crates/execution/src/order_emulator/emulator.rs`
**Generated:** 2025-11-15T19:40:02.114411Z
**File Size:** 42347 bytes
**Extension:** .rs
**Type:** text
...
- **Path:** `crates/execution/src/order_emulator/emulator.rs`
- **Size:** 42,347 bytes
- **Lines:** 1,186
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/execution/src/order_emulator/emulator.rs` within the repository.

**Classes defined:** OrderEmulator, Debug, OrderEmulator

**Functions defined:** fmt, new, set_on_event_handler, set_submit_order_handler, set_cancel_order_handler, set_modify_order_handler, subscribed_quotes, subscribed_trades, get_submit_order_commands, get_matching_core and 24 more
...
#### `set_on_event_handler(&mut self, handler: ShareableMessageHandler)`
...
#### `subscribed_quotes(&self)`


#### `subscribed_trades(&self)`


#### `get_submit_order_commands(&self)`


#### `get_matching_core(&self, instrument_id: &InstrumentId)`


#### `on_start(&mut self)`


#### `on_event(&mut self, event: OrderEventAny)`
...
#### `handle_cancel_order(&mut self, command: CancelOrder)`


#### `handle_cancel_all_orders(&mut self, command: CancelAllOrders)`


#### `update_order(&mut self, order: &mut OrderAny, new_quantity: Quantity)`


#### `on_order_book_deltas(&mut self, deltas: OrderBookDeltas)`


#### `on_quote_tick(&mut self, quote: QuoteTick)`


#### `on_trade_tick(&mut self, trade: TradeTick)`


#### `iterate_orders(&mut self, instrument_id: &InstrumentId)`


#### `cancel_order(&mut self, order: &OrderAny)`


#### `check_monitoring(&mut self, strategy_id: StrategyId, position_id: Option<PositionId>)`
