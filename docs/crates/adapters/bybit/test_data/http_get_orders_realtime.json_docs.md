# Documentation: http_get_orders_realtime.json

## File Metadata

- **Path**: `crates/adapters/bybit/test_data/http_get_orders_realtime.json`
- **Size**: 2,633 bytes
- **Lines**: 98
- **Language**: JSON
...
**Identifiers**: `Buy`, `ETHUSDT`, `Full`, `GTC`, `LastPrice`, `Limit`, `New`, `None`, `Sell`
...
```bash
# For Python
pytest crates/adapters/bybit/test_data/http_get_orders_realtime.json
...
---
*Generated on 2025-11-18T21:54:59.505875Z*
