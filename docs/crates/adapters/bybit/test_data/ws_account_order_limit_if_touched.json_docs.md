# Documentation: ws_account_order_limit_if_touched.json
...
**Identifiers**: `BTCUSDT`, `Buy`, `CreateByUser`, `GTC`, `LastPrice`, `Limit`, `None`, `Stop`, `UNKNOWN`, `USDT`, `Untriggered`
...
```bash
# For Python
pytest crates/adapters/bybit/test_data/ws_account_order_limit_if_touched.json
...
---
*Generated on 2025-11-18T21:54:59.518159Z*
