# Documentation: `crates/adapters/bybit/bin/http.rs`
**Generated:** 2025-11-15T19:40:00.600551Z
...
This file is located at `crates/adapters/bybit/bin/http.rs` within the repository.

**Functions defined:** main, test_public_endpoints, test_authenticated_endpoints
...
#### `test_authenticated_endpoints(api_key: &str, api_secret: &str)`
