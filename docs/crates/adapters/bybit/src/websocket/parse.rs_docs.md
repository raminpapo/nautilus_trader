...
- **Path**: `crates/adapters/bybit/src/websocket/parse.rs`
- **Size**: 53,085 bytes
- **Lines**: 1,388
- **Language**: Rust
...
### Functions
- **`parse_topic()`**: Function defined in this file
- **`parse_kline_topic()`**: Function defined in this file
- **`parse_ws_trade_tick()`**: Function defined in this file
- **`parse_orderbook_deltas()`**: Function defined in this file
- **`parse_orderbook_quote()`**: Function defined in this file
- **`parse_ticker_linear_quote()`**: Function defined in this file
- **`parse_ticker_option_quote()`**: Function defined in this file
- **`parse_ticker_linear_funding()`**: Function defined in this file
- **`parse_millis_i64()`**: Function defined in this file
- **`parse_book_level()`**: Function defined in this file
- **`parse_ws_kline_bar()`**: Function defined in this file
- **`parse_ws_order_status_report()`**: Function defined in this file
- **`parse_ws_fill_report()`**: Function defined in this file
- **`parse_ws_position_status_report()`**: Function defined in this file
- **`parse_ws_account_state()`**: Function defined in this file
- **`sample_fee_rate()`**: Function defined in this file
- **`linear_instrument()`**: Function defined in this file
- **`option_instrument()`**: Function defined in this file
- **`parse_ws_trade_into_trade_tick()`**: Function defined in this file
- **`parse_orderbook_snapshot_into_deltas()`**: Function defined in this file
...
**Functions**: `linear_instrument`, `option_instrument`, `parse_book_level`, `parse_kline_topic`, `parse_linear_ticker_quote_to_quote_tick`, `parse_millis_i64`, `parse_option_ticker_quote_to_quote_tick`, `parse_orderbook_delta_marks_actions`, `parse_orderbook_deltas`, `parse_orderbook_quote`, `parse_orderbook_quote_produces_top_of_book`, `parse_orderbook_quote_with_delta_updates_sizes`, `parse_orderbook_snapshot_into_deltas`, `parse_ticker_linear_funding`, `parse_ticker_linear_into_funding_rate`, `parse_ticker_linear_quote`, `parse_ticker_option_quote`, `parse_topic`, `parse_ws_account_state`, `parse_ws_execution_into_fill_report`, `parse_ws_fill_report`, `parse_ws_kline_bar`, `parse_ws_kline_into_bar`, `parse_ws_order_into_order_status_report`, `parse_ws_order_limit_if_touched_preserves_type`, `parse_ws_order_market_if_touched_buy_preserves_type`, `parse_ws_order_market_if_touched_sell_preserves_type`, `parse_ws_order_partially_filled_rejected_maps_to_canceled`, `parse_ws_order_status_report`, `parse_ws_order_stop_limit_preserves_type` *(+10 more)*
...
---
*Generated on 2025-11-18T21:54:59.491666Z*
