...
- **Path**: `crates/adapters/bybit/src/websocket/messages.rs`
- **Size**: 32,137 bytes
- **Lines**: 962
- **Language**: Rust
...
This file is part of the NautilusTrader repository. It defines 6 function(s) and 36 class(es).

## Detailed Walkthrough

### Functions
- **`new()`**: Function defined in this file
- **`from_response()`**: Function defined in this file
- **`from_message()`**: Function defined in this file
- **`now()`**: Function defined in this file
- **`extract_batch_errors()`**: Function defined in this file
- **`deserialize_account_order_frame_uses_enums()`**: Function defined in this file

### Classes
- **`BybitSubscription`**: Class defined in this file
- **`BybitAuthRequest`**: Class defined in this file
- **`BybitWebSocketError`**: Class defined in this file
- **`BybitWsRequest`**: Class defined in this file
- **`BybitWsHeader`**: Class defined in this file
- **`BybitWsPlaceOrderParams`**: Class defined in this file
- **`BybitWsAmendOrderParams`**: Class defined in this file
- **`BybitWsCancelOrderParams`**: Class defined in this file
- **`BybitWsBatchCancelItem`**: Class defined in this file
- **`BybitWsBatchCancelOrderArgs`**: Class defined in this file
- **`BybitWsBatchPlaceItem`**: Class defined in this file
- **`BybitWsBatchPlaceOrderArgs`**: Class defined in this file
- **`BybitWsSubscriptionMsg`**: Class defined in this file
- **`BybitWsResponse`**: Class defined in this file
- **`BybitWsOrderResponse`**: Class defined in this file
- **`BybitBatchOrderError`**: Class defined in this file
- **`BybitWsAuthResponse`**: Class defined in this file
- **`BybitWsKline`**: Class defined in this file
- **`BybitWsKlineMsg`**: Class defined in this file
- **`BybitWsOrderbookDepth`**: Class defined in this file
...
**Enums**: `BybitWsMessage`, `NautilusWsMessage`, `contains`
**Functions**: `deserialize_account_order_frame_uses_enums`, `extract_batch_errors`, `from_message`, `from_response`, `new`, `now`
**Impls**: `BybitWebSocketError`, `BybitWsHeader`, `BybitWsOrderResponse`, `Into`
**Structs**: `BybitAuthRequest`, `BybitBatchOrderError`, `BybitSubscription`, `BybitWebSocketError`, `BybitWsAccountExecution`, `BybitWsAccountExecutionMsg`, `BybitWsAccountOrder`, `BybitWsAccountOrderMsg`, `BybitWsAccountPosition`, `BybitWsAccountPositionMsg`, `BybitWsAccountWallet`, `BybitWsAccountWalletCoin`, `BybitWsAccountWalletMsg`, `BybitWsAmendOrderParams`, `BybitWsAuthResponse`, `BybitWsBatchCancelItem`, `BybitWsBatchCancelOrderArgs`, `BybitWsBatchPlaceItem`, `BybitWsBatchPlaceOrderArgs`, `BybitWsCancelOrderParams`, `BybitWsHeader`, `BybitWsKline`, `BybitWsKlineMsg`, `BybitWsOrderResponse`, `BybitWsOrderbookDepth`, `BybitWsOrderbookDepthMsg`, `BybitWsPlaceOrderParams`, `BybitWsRequest`, `BybitWsResponse`, `BybitWsSubscriptionMsg` *(+6 more)*
...
---
*Generated on 2025-11-18T21:54:59.481838Z*
