# Documentation: `crates/adapters/bybit/src/websocket/messages.rs`
**Generated:** 2025-11-15T19:40:00.691831Z
**File Size:** 32137 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/adapters/bybit/src/websocket/messages.rs` within the repository.

**Classes defined:** BybitSubscription, BybitAuthRequest, BybitWebSocketError, BybitWsRequest, BybitWsHeader, BybitWsPlaceOrderParams, BybitWsAmendOrderParams, BybitWsCancelOrderParams, BybitWsBatchCancelItem, BybitWsBatchCancelOrderArgs and 31 more

**Functions defined:** new, from_response, from_message, now, extract_batch_errors, deserialize_account_order_frame_uses_enums
...
#### `new(code: i64, message: impl Into<String>)`


#### `from_response(response: &BybitWsResponse)`


#### `from_message(message: impl Into<String>)`


#### `now()`


#### `extract_batch_errors(&self)`


#### `deserialize_account_order_frame_uses_enums()`
