...
- **Path**: `crates/adapters/bybit/src/websocket/handler.rs`
- **Size**: 68,695 bytes
- **Lines**: 1,619
- **Language**: Rust
...
- **`is_stopped()`**: Function defined in this file
- **`send()`**: Function defined in this file
- **`generate_unique_request_id()`**: Function defined in this file
- **`find_and_remove_place_request_by_client_order_id()`**: Function defined in this file
- **`find_and_remove_cancel_request_by_client_order_id()`**: Function defined in this file
- **`find_and_remove_amend_request_by_client_order_id()`**: Function defined in this file
- **`send_with_retry()`**: Function defined in this file
- **`handle_batch_failure()`**: Function defined in this file
- **`handle_batch_response()`**: Function defined in this file
- **`process_batch_place_errors()`**: Function defined in this file
- **`process_batch_cancel_errors()`**: Function defined in this file
- **`next()`**: Function defined in this file
- **`parse_raw_message()`**: Function defined in this file
- **`classify_bybit_message()`**: Function defined in this file
- **`parse_to_nautilus_messages()`**: Function defined in this file
- **`create_test_handler()`**: Function defined in this file
- **`test_generate_unique_request_id_returns_different_ids()`**: Function defined in this file
- **`test_generate_unique_request_id_produces_valid_uuids()`**: Function defined in this file
- **`test_multiple_place_orders_use_different_request_ids()`**: Function defined in this file

*...and 3 more functions*

### Classes
- **`FeedHandler`**: Class defined in this file
...
**Enums**: `HandlerCommand`
**Functions**: `classify_bybit_message`, `create_test_handler`, `find_and_remove_amend_request_by_client_order_id`, `find_and_remove_cancel_request_by_client_order_id`, `find_and_remove_place_request_by_client_order_id`, `generate_unique_request_id`, `handle_batch_failure`, `handle_batch_response`, `is_stopped`, `new`, `next`, `parse_raw_message`, `parse_to_nautilus_messages`, `process_batch_cancel_errors`, `process_batch_place_errors`, `send`, `send_with_retry`, `test_concurrent_request_id_generation`, `test_generate_unique_request_id_produces_valid_uuids`, `test_generate_unique_request_id_returns_different_ids`, `test_multiple_amends_use_different_request_ids`, `test_multiple_cancels_use_different_request_ids`, `test_multiple_place_orders_use_different_request_ids`
**Impls**: `FeedHandler`
**Structs**: `FeedHandler`
...
---
*Generated on 2025-11-18T21:54:59.475777Z*
