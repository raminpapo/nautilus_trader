# Documentation: `crates/adapters/bybit/src/websocket/client.rs`
**Generated:** 2025-11-15T19:40:00.679984Z
**File Size:** 88946 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/adapters/bybit/src/websocket/client.rs` within the repository.

**Classes defined:** BybitWebSocketClient, Debug, Clone, BybitWebSocketClient, futures_util, Into, Into

**Functions defined:** fmt, clone, new_public, new_public_with, new_private, new_trade, connect, close, is_active, is_closed and 56 more
...
#### `new_public(url: Option<String>, heartbeat: Option<u64>)`
...
#### `batch_cancel_orders_with_req_id(
        &self,
        orders: Vec<BybitWsCancelOrderParams>,
        req_id: String,
    )`
