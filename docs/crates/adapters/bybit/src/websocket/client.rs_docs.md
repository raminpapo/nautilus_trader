...
- **Path**: `crates/adapters/bybit/src/websocket/client.rs`
- **Size**: 89,204 bytes
- **Lines**: 2,379
- **Language**: Rust
...
- **`new_public()`**: Function defined in this file
- **`new_public_with()`**: Function defined in this file
- **`new_private()`**: Function defined in this file
- **`new_trade()`**: Function defined in this file
...
- **`unsubscribe()`**: Function defined in this file
- **`stream()`**: Function defined in this file
- **`subscription_count()`**: Function defined in this file
- **`credential()`**: Function defined in this file
- **`cache_instrument()`**: Function defined in this file
- **`cache_instruments()`**: Function defined in this file
- **`instruments()`**: Function defined in this file
- **`set_account_id()`**: Function defined in this file

*...and 46 more functions*

### Classes
- **`BybitWebSocketClient`**: Class defined in this file


## Keywords and Identifiers

Total unique keywords extracted: 71


**Functions**: `account_id`, `amend_order`, `authenticate_if_required`, `batch_amend_orders`, `batch_cancel_orders`, `batch_cancel_orders_by_id`, `batch_cancel_orders_with_req_id`, `batch_place_orders`, `build_amend_order_params`, `build_place_order_params`, `cache_instrument`, `cache_instruments`, `cancel_order`, `cancel_order_by_id`, `classify_orderbook_snapshot`, `classify_ticker_linear_snapshot`, `classify_ticker_option_snapshot`, `classify_trade_snapshot`, `clone`, `close`, `connect`, `credential`, `default_headers`, `fmt`, `instruments`, `is_active`, `is_closed`, `modify_order`, `new_private`, `new_public` *(+36 more)*
**Impls**: `BybitWebSocketClient`, `Clone`, `Debug`, `Into`, `futures_util`
**Structs**: `BybitWebSocketClient`
...
---
*Generated on 2025-11-18T21:54:59.460440Z*
