...
- **Path**: `crates/adapters/bybit/src/http/models.rs`
- **Size**: 33,483 bytes
- **Lines**: 1,040
- **Language**: Rust
...
This file is part of the NautilusTrader repository. It defines 23 function(s) and 28 class(es).

## Detailed Walkthrough

### Functions
- **`symbol()`**: Function defined in this file
- **`bid1_price()`**: Function defined in this file
- **`bid1_size()`**: Function defined in this file
- **`ask1_price()`**: Function defined in this file
- **`ask1_size()`**: Function defined in this file
- **`last_price()`**: Function defined in this file
- **`high_price24h()`**: Function defined in this file
- **`low_price24h()`**: Function defined in this file
- **`turnover24h()`**: Function defined in this file
- **`volume24h()`**: Function defined in this file
- **`deserialize()`**: Function defined in this file
- **`symbol()`**: Function defined in this file
- **`taker_fee_rate()`**: Function defined in this file
- **`maker_fee_rate()`**: Function defined in this file
- **`base_coin()`**: Function defined in this file
- **`deserialize_spot_instrument_uses_enums()`**: Function defined in this file
- **`deserialize_linear_instrument_status()`**: Function defined in this file
- **`deserialize_order_response_maps_enums()`**: Function defined in this file
- **`deserialize_wallet_balance_without_optional_fields()`**: Function defined in this file
- **`deserialize_wallet_balance_from_docs()`**: Function defined in this file

*...and 3 more functions*

### Classes
- **`BybitServerTime`**: Class defined in this file
- **`BybitTickerSpot`**: Class defined in this file
- **`BybitTickerLinear`**: Class defined in this file
- **`BybitTickerOption`**: Class defined in this file
- **`BybitTickerData`**: Class defined in this file
- **`BybitKline`**: Class defined in this file
- **`BybitKlineResult`**: Class defined in this file
- **`BybitTrade`**: Class defined in this file
- **`BybitTradeResult`**: Class defined in this file
- **`BybitInstrumentSpot`**: Class defined in this file
- **`BybitInstrumentLinear`**: Class defined in this file
- **`BybitInstrumentInverse`**: Class defined in this file
- **`BybitInstrumentOption`**: Class defined in this file
- **`BybitFeeRate`**: Class defined in this file
- **`BybitCoinBalance`**: Class defined in this file
- **`BybitWalletBalance`**: Class defined in this file
- **`BybitOrder`**: Class defined in this file
- **`BybitPlaceOrderResult`**: Class defined in this file
- **`BybitCancelOrderResult`**: Class defined in this file
- **`BybitExecution`**: Class defined in this file
...
**Functions**: `ask1_price`, `ask1_size`, `base_coin`, `bid1_price`, `bid1_size`, `deserialize`, `deserialize_borrow_response`, `deserialize_linear_instrument_status`, `deserialize_no_convert_repay_response`, `deserialize_order_response_maps_enums`, `deserialize_spot_instrument_uses_enums`, `deserialize_wallet_balance_from_docs`, `deserialize_wallet_balance_without_optional_fields`, `high_price24h`, `last_price`, `low_price24h`, `maker_fee_rate`, `symbol`, `taker_fee_rate`, `test_parse_wallet_balance_with_spot_borrow`, `turnover24h`, `volume24h`
**Impls**: `BybitFeeRate`, `BybitTickerData`, `Deserialize`
**Structs**: `BybitBorrowResult`, `BybitCancelOrderResult`, `BybitCoinBalance`, `BybitExecution`, `BybitFeeRate`, `BybitInstrumentInverse`, `BybitInstrumentLinear`, `BybitInstrumentOption`, `BybitInstrumentSpot`, `BybitKline`, `BybitKlineResult`, `BybitNoConvertRepayResult`, `BybitOrder`, `BybitPlaceOrderResult`, `BybitPosition`, `BybitServerTime`, `BybitSetLeverageResult`, `BybitSetMarginModeReason`, `BybitSetMarginModeResult`, `BybitSetTradingStopResult`, `BybitSwitchModeResult`, `BybitTickerData`, `BybitTickerLinear`, `BybitTickerOption`, `BybitTickerSpot`, `BybitTrade`, `BybitTradeResult`, `BybitWalletBalance`
...
---
*Generated on 2025-11-18T21:54:59.422483Z*
