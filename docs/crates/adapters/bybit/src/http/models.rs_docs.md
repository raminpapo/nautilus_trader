# Documentation: `crates/adapters/bybit/src/http/models.rs`
**Generated:** 2025-11-15T19:40:00.652137Z
**File Size:** 31516 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/adapters/bybit/src/http/models.rs` within the repository.

**Classes defined:** BybitServerTime, BybitTickerSpot, BybitTickerLinear, BybitTickerOption, BybitTickerData, BybitKline, BybitKlineResult, BybitTrade, BybitTradeResult, BybitInstrumentSpot and 18 more

**Functions defined:** symbol, bid1_price, bid1_size, ask1_price, ask1_size, last_price, high_price24h, low_price24h, turnover24h, volume24h and 11 more
...
#### `deserialize_spot_instrument_uses_enums()`


#### `deserialize_linear_instrument_status()`


#### `deserialize_order_response_maps_enums()`


#### `deserialize_wallet_balance_without_optional_fields()`


#### `deserialize_wallet_balance_from_docs()`


#### `test_parse_wallet_balance_with_spot_borrow()`
