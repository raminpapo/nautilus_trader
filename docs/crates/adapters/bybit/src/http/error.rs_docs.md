...
- **Path**: `crates/adapters/bybit/src/http/error.rs`
- **Size**: 6,958 bytes
- **Lines**: 199
- **Language**: Rust
...
- **`from()`**: Function defined in this file
- **`from()`**: Function defined in this file
- **`test_bybit_build_error_display()`**: Function defined in this file
- **`test_bybit_http_error_from_error_response()`**: Function defined in this file
- **`test_bybit_http_error_from_json_error()`**: Function defined in this file
- **`test_bybit_http_error_from_string()`**: Function defined in this file
- **`test_unexpected_status_error()`**: Function defined in this file

### Classes
- **`BybitErrorResponse`**: Class defined in this file
...
**Enums**: `BybitBuildError`, `BybitHttpError`
**Functions**: `from`, `test_bybit_build_error_display`, `test_bybit_http_error_from_error_response`, `test_bybit_http_error_from_json_error`, `test_bybit_http_error_from_string`, `test_unexpected_status_error`
**Impls**: `From`
**Structs**: `BybitErrorResponse`
...
---
*Generated on 2025-11-18T21:54:59.415674Z*
