# Documentation: `crates/adapters/bybit/src/http/error.rs`
**Generated:** 2025-11-15T19:40:00.647509Z
**File Size:** 6960 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/adapters/bybit/src/http/error.rs` within the repository.

**Classes defined:** BybitErrorResponse, From, From, From, From

**Functions defined:** from, from, from, from, test_bybit_build_error_display, test_bybit_http_error_from_error_response, test_bybit_http_error_from_json_error, test_bybit_http_error_from_string, test_unexpected_status_error
...
#### `from(error: BybitErrorResponse)`


#### `test_bybit_build_error_display()`


#### `test_bybit_http_error_from_error_response()`


#### `test_bybit_http_error_from_json_error()`


#### `test_bybit_http_error_from_string()`
