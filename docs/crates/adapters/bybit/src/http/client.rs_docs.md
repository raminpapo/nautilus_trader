...
- **Path**: `crates/adapters/bybit/src/http/client.rs`
- **Size**: 117,648 bytes
- **Lines**: 3,404
- **Language**: Rust
...
This file is part of the NautilusTrader repository. It defines 93 function(s) and 6 class(es).
...
- **`cancel_all_requests()`**: Function defined in this file
- **`cancellation_token()`**: Function defined in this file
- **`new()`**: Function defined in this file
- **`with_credentials()`**: Function defined in this file
- **`default_headers()`**: Function defined in this file
- **`rate_limiter_quotas()`**: Function defined in this file
- **`rate_limit_keys()`**: Function defined in this file
- **`sign_request()`**: Function defined in this file
- **`send_request()`**: Function defined in this file
- **`build_path()`**: Function defined in this file
- **`get_server_time()`**: Function defined in this file
- **`get_instruments()`**: Function defined in this file
- **`get_instruments_spot()`**: Function defined in this file
- **`get_instruments_linear()`**: Function defined in this file
- **`get_instruments_inverse()`**: Function defined in this file
- **`get_instruments_option()`**: Function defined in this file
- **`get_klines()`**: Function defined in this file
- **`get_recent_trades()`**: Function defined in this file

*...and 73 more functions*

### Classes
- **`BybitRawHttpClient`**: Class defined in this file
- **`Params`**: Class defined in this file
- **`BybitHttpClient`**: Class defined in this file
- **`TestParams`**: Class defined in this file
- **`TestParams`**: Class defined in this file
...
**Functions**: `base_url`, `batch_cancel_orders`, `borrow`, `borrow_spot`, `build_path`, `cache_instrument`, `cache_instruments`, `cancel_all_orders`, `cancel_all_requests`, `cancel_order`, `cancellation_token`, `clone`, `credential`, `default`, `default_headers`, `fmt`, `generate_spot_position_reports_from_wallet`, `generate_ts_init`, `get_fee_rate`, `get_instrument`, `get_instruments`, `get_instruments_inverse`, `get_instruments_linear`, `get_instruments_option`, `get_instruments_spot`, `get_klines`, `get_open_orders`, `get_positions`, `get_recent_trades`, `get_server_time` *(+37 more)*
**Impls**: `BybitHttpClient`, `BybitRawHttpClient`, `Clone`, `Debug`, `Default`
**Structs**: `BybitHttpClient`, `BybitRawHttpClient`, `OrderParams`, `Params`, `TestParams`
...
---
*Generated on 2025-11-18T21:54:59.411856Z*
