# Documentation: `crates/adapters/bybit/src/http/client.rs`
**Generated:** 2025-11-15T19:40:00.644254Z
**File Size:** 112465 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/adapters/bybit/src/http/client.rs` within the repository.

**Classes defined:** BybitRawHttpClient, Params, BybitHttpClient, TestParams, TestParams, OrderParams, Default, Debug, BybitRawHttpClient, Clone and 3 more

**Functions defined:** default, fmt, cancel_all_requests, cancellation_token, new, with_credentials, default_headers, rate_limiter_quotas, rate_limit_keys, sign_request and 78 more
...
#### `get_instruments_linear(
        &self,
        params: &BybitInstrumentsInfoParams,
    )`


#### `get_instruments_inverse(
        &self,
        params: &BybitInstrumentsInfoParams,
    )`
...
#### `set_use_spot_position_reports(&self, use_spot_position_reports: bool)`
...
#### `instrument_from_cache(&self, symbol: &Symbol)`
