# Documentation: `crates/adapters/bybit/src/config.rs`
**Generated:** 2025-11-15T19:40:00.627062Z
**File Size:** 15799 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/adapters/bybit/src/config.rs` within the repository.

**Classes defined:** BybitDataClientConfig, BybitExecClientConfig, Default, BybitDataClientConfig, Default, BybitExecClientConfig

**Functions defined:** default, new, has_api_credentials, http_base_url, ws_public_url, ws_public_url_for, ws_private_url, requires_private_ws, default, new and 19 more
...
#### `ws_public_url_for(&self, product_type: BybitProductType)`


#### `ws_private_url(&self)`


#### `requires_private_ws(&self)`
...
#### `test_data_config_default()`


#### `test_data_config_with_credentials()`


#### `test_data_config_http_url_mainnet()`


#### `test_data_config_http_url_testnet()`


#### `test_data_config_http_url_demo()`


#### `test_data_config_http_url_override()`


#### `test_data_config_ws_public_url()`


#### `test_data_config_ws_public_url_for_spot()`


#### `test_data_config_ws_private_url()`


#### `test_data_config_ws_private_url_testnet()`


#### `test_exec_config_default()`


#### `test_exec_config_with_credentials()`


#### `test_exec_config_urls()`


#### `test_exec_config_urls_testnet()`


#### `test_exec_config_custom_urls()`
...
**Directory:** `crates/adapters/bybit/src`
