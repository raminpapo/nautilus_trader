...
- **Path**: `crates/adapters/bybit/src/config.rs`
- **Size**: 15,799 bytes
- **Lines**: 449
- **Language**: Rust
...
This file is part of the NautilusTrader repository. It defines 29 function(s) and 2 class(es).
...
- **`ws_public_url_for()`**: Function defined in this file
- **`ws_private_url()`**: Function defined in this file
- **`requires_private_ws()`**: Function defined in this file
- **`default()`**: Function defined in this file
- **`new()`**: Function defined in this file
- **`has_api_credentials()`**: Function defined in this file
- **`http_base_url()`**: Function defined in this file
- **`ws_private_url()`**: Function defined in this file
- **`ws_trade_url()`**: Function defined in this file
- **`test_data_config_default()`**: Function defined in this file
- **`test_data_config_with_credentials()`**: Function defined in this file
- **`test_data_config_http_url_mainnet()`**: Function defined in this file
- **`test_data_config_http_url_testnet()`**: Function defined in this file
- **`test_data_config_http_url_demo()`**: Function defined in this file
- **`test_data_config_http_url_override()`**: Function defined in this file

*...and 9 more functions*

### Classes
- **`BybitDataClientConfig`**: Class defined in this file
- **`BybitExecClientConfig`**: Class defined in this file
...
**Functions**: `default`, `has_api_credentials`, `http_base_url`, `new`, `requires_private_ws`, `test_data_config_default`, `test_data_config_http_url_demo`, `test_data_config_http_url_mainnet`, `test_data_config_http_url_override`, `test_data_config_http_url_testnet`, `test_data_config_with_credentials`, `test_data_config_ws_private_url`, `test_data_config_ws_private_url_testnet`, `test_data_config_ws_public_url`, `test_data_config_ws_public_url_for_spot`, `test_exec_config_custom_urls`, `test_exec_config_default`, `test_exec_config_urls`, `test_exec_config_urls_testnet`, `test_exec_config_with_credentials`, `ws_private_url`, `ws_public_url`, `ws_public_url_for`, `ws_trade_url`
**Impls**: `BybitDataClientConfig`, `BybitExecClientConfig`, `Default`
**Structs**: `BybitDataClientConfig`, `BybitExecClientConfig`

## Related Files

This file is located in `crates/adapters/bybit/src/`. Related files may include:
...
---
*Generated on 2025-11-18T21:54:59.382230Z*
