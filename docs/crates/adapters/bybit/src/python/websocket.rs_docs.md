# Documentation: `crates/adapters/bybit/src/python/websocket.rs`
**Generated:** 2025-11-15T19:40:00.672487Z
...
This file is located at `crates/adapters/bybit/src/python/websocket.rs` within the repository.

**Classes defined:** BybitWebSocketError, BybitWebSocketClient

**Functions defined:** __repr__, code, message, conn_id, topic, req_id, py_new_public, py_new_private, py_new_trade, py_is_active and 36 more
...
#### `py_subscription_count(&self)`


#### `py_masked_api_key(&self)`


#### `py_cache_instrument(&self, py: Python<'_>, instrument: Py<PyAny>)`
...
#### `call_python_with_data(callback: &Py<PyAny>, data_fn: F)`
