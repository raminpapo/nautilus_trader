...
- **Path**: `crates/adapters/bybit/src/python/websocket.rs`
- **Size**: 29,296 bytes
- **Lines**: 911
- **Language**: Rust
...
- **`py_subscribe()`**: Function defined in this file
- **`py_unsubscribe()`**: Function defined in this file
...
**Functions**: `__repr__`, `call_python`, `call_python_with_data`, `code`, `conn_id`, `message`, `py_batch_cancel_orders`, `py_batch_modify_orders`, `py_batch_place_orders`, `py_build_amend_order_params`, `py_build_place_order_params`, `py_cache_instrument`, `py_cancel_order`, `py_close`, `py_connect`, `py_is_active`, `py_is_closed`, `py_masked_api_key`, `py_modify_order`, `py_new_private`, `py_new_public`, `py_new_trade`, `py_set_account_id`, `py_submit_order`, `py_subscribe`, `py_subscribe_executions`, `py_subscribe_klines`, `py_subscribe_orderbook`, `py_subscribe_orders`, `py_subscribe_positions` *(+16 more)*
**Impls**: `BybitWebSocketClient`, `BybitWebSocketError`
...
---
*Generated on 2025-11-18T21:54:59.448744Z*
