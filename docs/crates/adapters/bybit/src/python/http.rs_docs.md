# Documentation: `crates/adapters/bybit/src/python/http.rs`
**Generated:** 2025-11-15T19:40:00.664135Z
**File Size:** 21673 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/adapters/bybit/src/python/http.rs` within the repository.

**Classes defined:** BybitHttpClient, From

**Functions defined:** py_new, py_base_url, py_api_key, py_masked_api_key, py_cache_instrument, py_cancel_all_requests, py_set_use_spot_position_reports, py_request_instruments, py_submit_order, py_modify_order and 14 more
...
#### `py_set_use_spot_position_reports(&self, use_spot_position_reports: bool)`
