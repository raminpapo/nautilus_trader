...
- **Path**: `crates/adapters/bybit/src/python/http.rs`
- **Size**: 23,107 bytes
- **Lines**: 698
- **Language**: Rust
...
- **`py_masked_api_key()`**: Function defined in this file
- **`py_cache_instrument()`**: Function defined in this file
- **`py_cancel_all_requests()`**: Function defined in this file
- **`py_set_use_spot_position_reports()`**: Function defined in this file
- **`py_set_margin_mode()`**: Function defined in this file
- **`py_set_leverage()`**: Function defined in this file
- **`py_switch_mode()`**: Function defined in this file
- **`py_get_spot_borrow_amount()`**: Function defined in this file
- **`py_borrow_spot()`**: Function defined in this file
- **`py_repay_spot_borrow()`**: Function defined in this file
- **`py_request_instruments()`**: Function defined in this file
- **`py_submit_order()`**: Function defined in this file
- **`py_modify_order()`**: Function defined in this file
- **`py_cancel_order()`**: Function defined in this file
- **`py_cancel_all_orders()`**: Function defined in this file
- **`py_query_order()`**: Function defined in this file
...
**Functions**: `from`, `py_api_key`, `py_base_url`, `py_borrow_spot`, `py_cache_instrument`, `py_cancel_all_orders`, `py_cancel_all_requests`, `py_cancel_order`, `py_get_spot_borrow_amount`, `py_masked_api_key`, `py_modify_order`, `py_new`, `py_query_order`, `py_repay_spot_borrow`, `py_request_account_state`, `py_request_bars`, `py_request_fee_rates`, `py_request_fill_reports`, `py_request_instruments`, `py_request_order_status_reports`, `py_request_position_status_reports`, `py_request_trades`, `py_set_leverage`, `py_set_margin_mode`, `py_set_use_spot_position_reports`, `py_submit_order`, `py_switch_mode`
**Impls**: `BybitHttpClient`, `From`
...
---
*Generated on 2025-11-18T21:54:59.437515Z*
