# Documentation: `crates/adapters/bybit/src/python/params.rs`
**Generated:** 2025-11-15T19:40:00.668112Z
...
- **Path:** `crates/adapters/bybit/src/python/params.rs`
- **Size:** 15,214 bytes
- **Lines:** 455
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/adapters/bybit/src/python/params.rs` within the repository.

**Classes defined:** BybitWsPlaceOrderParams, BybitWsAmendOrderParams, BybitWsPlaceOrderParams, TryFrom, From, BybitWsAmendOrderParams, TryFrom, From

**Functions defined:** py_new, try_from, from, py_new, try_from, from
...
#### `try_from(params: BybitWsPlaceOrderParams)`


#### `from(params: messages::BybitWsPlaceOrderParams)`
...
#### `try_from(params: BybitWsAmendOrderParams)`


#### `from(params: messages::BybitWsAmendOrderParams)`
