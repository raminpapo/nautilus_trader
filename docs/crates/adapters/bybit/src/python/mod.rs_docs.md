# Documentation: `crates/adapters/bybit/src/python/mod.rs`
**Generated:** 2025-11-15T19:40:00.665987Z
...
This file is located at `crates/adapters/bybit/src/python/mod.rs` within the repository.

**Functions defined:** py_bybit_extract_raw_symbol, py_bybit_bar_spec_to_interval, py_bybit_product_type_from_symbol, bybit
...
#### `py_bybit_extract_raw_symbol(symbol: &str)`


#### `py_bybit_bar_spec_to_interval(aggregation: u8, step: u64)`
...
#### `bybit(_: Python<'_>, m: &Bound<'_, PyModule>)`
