# Documentation: `crates/adapters/bybit/src/common/urls.rs`
**Generated:** 2025-11-15T19:40:00.624633Z
...
This file is located at `crates/adapters/bybit/src/common/urls.rs` within the repository.

**Functions defined:** bybit_http_base_url, ws_public_subdomain, bybit_ws_public_url, bybit_ws_private_url, bybit_ws_trade_url, resolves_public_urls, resolves_private_urls, resolves_trade_urls, resolves_http_urls
...
#### `bybit_http_base_url(environment: BybitEnvironment)`


#### `ws_public_subdomain(environment: BybitEnvironment)`
...
#### `bybit_ws_private_url(environment: BybitEnvironment)`


#### `bybit_ws_trade_url(environment: BybitEnvironment)`


#### `resolves_public_urls()`


#### `resolves_private_urls()`
