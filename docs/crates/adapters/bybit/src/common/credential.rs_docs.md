# Documentation: `crates/adapters/bybit/src/common/credential.rs`
**Generated:** 2025-11-15T19:40:00.607070Z
...
This file is located at `crates/adapters/bybit/src/common/credential.rs` within the repository.

**Classes defined:** Credential, Debug, Credential, Into, Into

**Functions defined:** fmt, new, api_key, masked_api_key, sign_websocket_auth, sign_with_payload, sign_with_payload_matches_reference_get, sign_with_payload_matches_reference_post, sign_with_empty_payload_omits_tail, sign_websocket_auth_matches_reference
...
#### `sign_websocket_auth(&self, expires: i64)`
...
#### `sign_with_payload_matches_reference_get()`


#### `sign_with_payload_matches_reference_post()`


#### `sign_with_empty_payload_omits_tail()`


#### `sign_websocket_auth_matches_reference()`
