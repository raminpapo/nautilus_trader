...
- **Path**: `crates/adapters/bybit/src/common/credential.rs`
- **Size**: 6,290 bytes
- **Lines**: 187
- **Language**: Rust
...
- **`masked_api_key()`**: Function defined in this file
- **`sign_websocket_auth()`**: Function defined in this file
- **`sign_with_payload()`**: Function defined in this file
- **`sign_with_payload_matches_reference_get()`**: Function defined in this file
- **`sign_with_payload_matches_reference_post()`**: Function defined in this file
- **`sign_with_empty_payload_omits_tail()`**: Function defined in this file
- **`sign_websocket_auth_matches_reference()`**: Function defined in this file

### Classes
- **`Credential`**: Class defined in this file
...
**Functions**: `api_key`, `fmt`, `masked_api_key`, `new`, `sign_websocket_auth`, `sign_websocket_auth_matches_reference`, `sign_with_empty_payload_omits_tail`, `sign_with_payload`, `sign_with_payload_matches_reference_get`, `sign_with_payload_matches_reference_post`
**Impls**: `Credential`, `Debug`, `Into`
**Structs**: `Credential`
...
---
*Generated on 2025-11-18T21:54:59.354527Z*
