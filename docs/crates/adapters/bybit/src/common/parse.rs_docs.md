...
- **Path**: `crates/adapters/bybit/src/common/parse.rs`
- **Size**: 51,796 bytes
- **Lines**: 1,429
- **Language**: Rust
...
### Functions
- **`deserialize_optional_decimal()`**: Function defined in this file
- **`deserialize_optional_decimal_or_zero()`**: Function defined in this file
- **`deserialize_decimal_or_zero()`**: Function defined in this file
- **`extract_raw_symbol()`**: Function defined in this file
- **`make_bybit_symbol()`**: Function defined in this file
- **`bar_spec_to_bybit_interval()`**: Function defined in this file
- **`default_margin()`**: Function defined in this file
- **`parse_spot_instrument()`**: Function defined in this file
- **`parse_linear_instrument()`**: Function defined in this file
- **`parse_inverse_instrument()`**: Function defined in this file
- **`parse_option_instrument()`**: Function defined in this file
- **`parse_trade_tick()`**: Function defined in this file
- **`parse_kline_bar()`**: Function defined in this file
- **`parse_fill_report()`**: Function defined in this file
- **`parse_position_status_report()`**: Function defined in this file
- **`parse_account_state()`**: Function defined in this file
- **`parse_price_with_precision()`**: Function defined in this file
- **`parse_quantity_with_precision()`**: Function defined in this file
...
**Functions**: `bar_spec_to_bybit_interval`, `default_margin`, `deserialize_decimal_or_zero`, `deserialize_optional_decimal`, `deserialize_optional_decimal_or_zero`, `extract_raw_symbol`, `extract_strike_from_symbol`, `get_currency`, `linear_instrument`, `make_bybit_symbol`, `parse_account_state`, `parse_decimal`, `parse_fill_report`, `parse_http_order_partially_filled_rejected_maps_to_canceled`, `parse_http_position_short_into_position_status_report`, `parse_http_trade_into_trade_tick`, `parse_inverse_instrument`, `parse_inverse_perpetual_instrument_builds_inverse_perpetual`, `parse_kline_bar`, `parse_kline_into_bar`, `parse_linear_instrument`, `parse_linear_perpetual_instrument_builds_crypto_perpetual`, `parse_millis_timestamp`, `parse_option_instrument`, `parse_option_instrument_builds_option_contract`, `parse_order_status_report`, `parse_position_status_report`, `parse_price`, `parse_price_with_precision`, `parse_quantity` *(+11 more)*
...
---
*Generated on 2025-11-18T21:54:59.373253Z*
