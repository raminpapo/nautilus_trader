# Documentation: `crates/adapters/bybit/src/common/parse.rs`
**Generated:** 2025-11-15T19:40:00.619055Z
**File Size:** 52203 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/adapters/bybit/src/common/parse.rs` within the repository.

**Functions defined:** deserialize_optional_decimal, deserialize_optional_decimal_or_zero, deserialize_decimal_or_zero, extract_raw_symbol, bar_spec_to_bybit_interval, default_margin, parse_spot_instrument, parse_linear_instrument, parse_inverse_instrument, parse_option_instrument and 30 more
...
#### `deserialize_optional_decimal(deserializer: D)`


#### `deserialize_optional_decimal_or_zero(deserializer: D)`


#### `deserialize_decimal_or_zero(deserializer: D)`


#### `extract_raw_symbol(symbol: &str)`
...
#### `parse_price(value: &str, field: &str)`


#### `parse_quantity(value: &str, field: &str)`


#### `parse_decimal(value: &str, field: &str)`


#### `parse_millis_timestamp(value: &str, field: &str)`
...
#### `extract_strike_from_symbol(symbol: &str)`
...
#### `parse_spot_instrument_builds_currency_pair()`


#### `parse_linear_perpetual_instrument_builds_crypto_perpetual()`


#### `parse_inverse_perpetual_instrument_builds_inverse_perpetual()`


#### `parse_option_instrument_builds_option_contract()`


#### `parse_http_trade_into_trade_tick()`


#### `parse_kline_into_bar()`


#### `parse_http_position_short_into_position_status_report()`


#### `parse_http_order_partially_filled_rejected_maps_to_canceled()`


#### `test_bar_spec_to_bybit_interval_minutes(
        #[case] aggregation: BarAggregation,
        #[case] step: u64,
        #[case] expected: BybitKlineInterval,
    )`
...
#### `test_bar_spec_to_bybit_interval_hours(
        #[case] aggregation: BarAggregation,
        #[case] step: u64,
        #[case] expected: BybitKlineInterval,
    )`
...
#### `test_bar_spec_to_bybit_interval_day_week_month(
        #[case] aggregation: BarAggregation,
        #[case] step: u64,
        #[case] expected: BybitKlineInterval,
    )`
...
#### `test_bar_spec_to_bybit_interval_unsupported_steps(
        #[case] aggregation: BarAggregation,
        #[case] step: u64,
    )`


#### `test_bar_spec_to_bybit_interval_unsupported_aggregation()`
