...
- **Path**: `crates/adapters/bybit/src/common/enums.rs`
- **Size**: 16,078 bytes
- **Lines**: 630
- **Language**: Rust
...
- **`suffix()`**: Function defined in this file
- **`is_spot()`**: Function defined in this file
- **`is_linear()`**: Function defined in this file
- **`is_inverse()`**: Function defined in this file
- **`is_option()`**: Function defined in this file
...
**Enums**: `BybitAccountType`, `BybitCancelType`, `BybitContractType`, `BybitCreateType`, `BybitEndpointType`, `BybitEnvironment`, `BybitExecType`, `BybitInnovationFlag`, `BybitInstrumentStatus`, `BybitKlineInterval`, `BybitMarginMode`, `BybitMarginTrading`, `BybitOptionType`, `BybitOrderSide`, `BybitOrderStatus`, `BybitOrderType`, `BybitPositionIdx`, `BybitPositionMode`, `BybitPositionSide`, `BybitProductType`, `BybitStopOrderType`, `BybitTimeInForce`, `BybitTpSlMode`, `BybitTransactionType`, `BybitTriggerDirection`, `BybitTriggerType`, `BybitUnifiedMarginStatus`, `BybitWsOrderRequestOp`
**Functions**: `as_str`, `fmt`, `from`, `is_inverse`, `is_linear`, `is_option`, `is_spot`, `suffix`
**Impls**: `BybitProductType`, `Display`, `From`
...
---
*Generated on 2025-11-18T21:54:59.358009Z*
