# Documentation: `crates/adapters/bybit/src/common/enums.rs`
**Generated:** 2025-11-15T19:40:00.609507Z
...
This file is located at `crates/adapters/bybit/src/common/enums.rs` within the repository.

**Classes defined:** BybitProductType, Display, From, From, From

**Functions defined:** as_str, suffix, is_spot, is_linear, is_inverse, is_option, fmt, from, from, from
...
#### `from(value: BybitOrderSide)`


#### `from(value: BybitOrderSide)`


#### `from(value: BybitTriggerType)`
