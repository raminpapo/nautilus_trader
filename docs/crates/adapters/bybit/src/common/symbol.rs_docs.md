...
### Functions
- **`has_valid_suffix()`**: Function defined in this file
- **`new()`**: Function defined in this file
- **`raw_symbol()`**: Function defined in this file
- **`product_type()`**: Function defined in this file
- **`to_instrument_id()`**: Function defined in this file
- **`as_ustr()`**: Function defined in this file
- **`fmt()`**: Function defined in this file
- **`try_from()`**: Function defined in this file
- **`try_from()`**: Function defined in this file
- **`new_valid_symbol_is_uppercased()`**: Function defined in this file
- **`new_invalid_symbol_errors()`**: Function defined in this file
- **`raw_symbol_strips_suffix()`**: Function defined in this file
- **`product_type_detection_matches_suffix()`**: Function defined in this file
- **`instrument_id_uses_bybit_venue()`**: Function defined in this file

### Classes
- **`BybitSymbol`**: Class defined in this file
...
**Functions**: `as_ustr`, `fmt`, `has_valid_suffix`, `instrument_id_uses_bybit_venue`, `new`, `new_invalid_symbol_errors`, `new_valid_symbol_is_uppercased`, `product_type`, `product_type_detection_matches_suffix`, `raw_symbol`, `raw_symbol_strips_suffix`, `to_instrument_id`, `try_from`
**Impls**: `BybitSymbol`, `Display`, `TryFrom`
**Structs**: `BybitSymbol`
...
---
*Generated on 2025-11-18T21:54:59.375643Z*
