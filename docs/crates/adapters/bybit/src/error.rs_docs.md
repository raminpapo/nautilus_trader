...
- **Path**: `crates/adapters/bybit/src/error.rs`
- **Size**: 19,583 bytes
- **Lines**: 561
- **Language**: Rust
...
### Functions
- **`from_rate_limit_headers()`**: Function defined in this file
- **`from_http_status()`**: Function defined in this file
- **`from_http_response()`**: Function defined in this file
- **`from_bybit_ret_code()`**: Function defined in this file
- **`is_retryable()`**: Function defined in this file
- **`is_fatal()`**: Function defined in this file
- **`retry_after()`**: Function defined in this file
- **`from()`**: Function defined in this file
- **`from()`**: Function defined in this file
- **`from()`**: Function defined in this file
- **`from()`**: Function defined in this file
- **`test_error_classification()`**: Function defined in this file
- **`test_rate_limit_parsing()`**: Function defined in this file
- **`test_bybit_ret_codes()`**: Function defined in this file
- **`test_retry_after()`**: Function defined in this file
- **`test_invalid_order_errors()`**: Function defined in this file
...
**Enums**: `BybitError`, `BybitFatalError`, `BybitNonRetryableError`, `BybitRetryableError`
**Functions**: `from`, `from_bybit_ret_code`, `from_http_response`, `from_http_status`, `from_rate_limit_headers`, `is_fatal`, `is_retryable`, `retry_after`, `test_bybit_ret_codes`, `test_error_classification`, `test_invalid_order_errors`, `test_rate_limit_parsing`, `test_retry_after`
**Impls**: `BybitError`, `From`
...
---
*Generated on 2025-11-18T21:54:59.387402Z*
