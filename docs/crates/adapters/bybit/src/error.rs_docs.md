# Documentation: `crates/adapters/bybit/src/error.rs`
**Generated:** 2025-11-15T19:40:00.630905Z
...
This file is located at `crates/adapters/bybit/src/error.rs` within the repository.

**Classes defined:** BybitError, From, From, From, From

**Functions defined:** from_rate_limit_headers, from_http_status, from_http_response, from_bybit_ret_code, is_retryable, is_fatal, retry_after, from, from, from and 6 more
...
#### `from_http_status(status: u16, message: Option<String>)`


#### `from_http_response(response: &HttpResponse)`


#### `from_bybit_ret_code(ret_code: i32, message: String)`
...
#### `test_bybit_ret_codes()`


#### `test_retry_after()`


#### `test_invalid_order_errors()`
