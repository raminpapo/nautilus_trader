# Documentation: pagination.rs

## File Metadata

- **Path**: `crates/adapters/bybit/tests/pagination.rs`
- **Size**: 21,406 bytes
- **Lines**: 625
- **Language**: Rust
...
This file is part of the NautilusTrader repository. It defines 18 function(s) and 2 class(es).

## Detailed Walkthrough

### Functions
- **`generate_kline()`**: Function defined in this file
- **`mock_klines_paginated()`**: Function defined in this file
- **`mock_instruments_info()`**: Function defined in this file
- **`start_pagination_test_server()`**: Function defined in this file
- **`init_instrument_cache()`**: Function defined in this file
- **`test_bars_chronological_order_single_page()`**: Function defined in this file
- **`test_bars_chronological_order_multiple_pages()`**: Function defined in this file
- **`test_bars_limit_returns_most_recent()`**: Function defined in this file
- **`test_open_orders_response_with_cursor()`**: Function defined in this file
- **`test_open_orders_response_empty_cursor()`**: Function defined in this file
- **`test_order_history_response_with_cursor()`**: Function defined in this file
- **`test_trade_history_response_with_cursor()`**: Function defined in this file
- **`test_position_list_response_with_cursor()`**: Function defined in this file
- **`test_pagination_loop_pattern()`**: Function defined in this file
- **`test_pagination_stops_on_empty_cursor()`**: Function defined in this file
- **`test_pagination_continues_with_valid_cursor()`**: Function defined in this file
- **`test_limit_calculation()`**: Function defined in this file
- **`test_execution_limit_calculation()`**: Function defined in this file

### Classes
- **`MockResponse`**: Class defined in this file
- **`MockResult`**: Class defined in this file
...
**Functions**: `generate_kline`, `init_instrument_cache`, `mock_instruments_info`, `mock_klines_paginated`, `start_pagination_test_server`, `test_bars_chronological_order_multiple_pages`, `test_bars_chronological_order_single_page`, `test_bars_limit_returns_most_recent`, `test_execution_limit_calculation`, `test_limit_calculation`, `test_open_orders_response_empty_cursor`, `test_open_orders_response_with_cursor`, `test_order_history_response_with_cursor`, `test_pagination_continues_with_valid_cursor`, `test_pagination_loop_pattern`, `test_pagination_stops_on_empty_cursor`, `test_position_list_response_with_cursor`, `test_trade_history_response_with_cursor`
**Structs**: `MockResponse`, `MockResult`

## Related Files

This file is located in `crates/adapters/bybit/tests/`. Related files may include:
...
```bash
# For Python
pytest crates/adapters/bybit/tests/pagination.rs
...
---
*Generated on 2025-11-18T21:54:59.548318Z*
