# Documentation: `crates/adapters/bybit/tests/pagination.rs`
**Generated:** 2025-11-15T19:40:00.738497Z
**File Size:** 21406 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/adapters/bybit/tests/pagination.rs` within the repository.

**Classes defined:** MockResponse, MockResult

**Functions defined:** generate_kline, mock_klines_paginated, mock_instruments_info, start_pagination_test_server, init_instrument_cache, test_bars_chronological_order_single_page, test_bars_chronological_order_multiple_pages, test_bars_limit_returns_most_recent, test_open_orders_response_with_cursor, test_open_orders_response_empty_cursor and 8 more
...
#### `generate_kline(timestamp_ms: i64, open: &str, high: &str, low: &str, close: &str)`


#### `mock_klines_paginated(Query(params)`


#### `mock_instruments_info(Query(_params)`


#### `start_pagination_test_server()`


#### `init_instrument_cache(client: &BybitHttpClient)`


#### `test_bars_chronological_order_single_page()`


#### `test_bars_chronological_order_multiple_pages()`


#### `test_bars_limit_returns_most_recent()`


#### `test_open_orders_response_with_cursor()`


#### `test_open_orders_response_empty_cursor()`


#### `test_order_history_response_with_cursor()`


#### `test_trade_history_response_with_cursor()`


#### `test_position_list_response_with_cursor()`


#### `test_pagination_loop_pattern()`


#### `test_pagination_stops_on_empty_cursor()`


#### `test_pagination_continues_with_valid_cursor()`


#### `test_limit_calculation()`


#### `test_execution_limit_calculation()`
