# Documentation: `crates/adapters/bybit/tests/http.rs`
**Generated:** 2025-11-15T19:40:00.735314Z
**File Size:** 45555 bytes
**Extension:** .rs
**Type:** text
...
- **Path:** `crates/adapters/bybit/tests/http.rs`
- **Size:** 45,555 bytes
- **Lines:** 1,536
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/adapters/bybit/tests/http.rs` within the repository.

**Classes defined:** TestServerState, Default, IntoResponse, IntoResponse, IntoResponse, IntoResponse

**Functions defined:** default, load_test_data, handle_get_server_time, handle_get_instruments, handle_get_klines, handle_get_trades, handle_get_orders, handle_post_order, handle_get_wallet_balance, handle_cancel_order and 35 more
...
#### `handle_get_instruments(query: Query<HashMap<String, String>>)`


#### `handle_get_klines(query: Query<HashMap<String, String>>)`


#### `handle_get_trades(query: Query<HashMap<String, String>>)`
...
#### `handle_post_order(headers: axum::http::HeaderMap, body: axum::body::Bytes)`


#### `handle_get_wallet_balance(headers: axum::http::HeaderMap)`


#### `handle_cancel_order(headers: axum::http::HeaderMap, body: axum::body::Bytes)`


#### `handle_get_positions(headers: axum::http::HeaderMap)`


#### `handle_get_fee_rate(headers: axum::http::HeaderMap)`


#### `handle_get_orders_realtime(
    query: Query<HashMap<String, String>>,
    State(state)`


#### `handle_get_orders_history_reconciliation(
    query: Query<HashMap<String, String>>,
    State(state)`


#### `create_test_router(state: TestServerState)`
...
#### `test_get_instruments_linear()`


#### `test_get_instruments_spot()`


#### `test_get_instruments_inverse()`


#### `test_get_instruments_option()`


#### `test_place_order()`


#### `test_authenticated_endpoint_requires_credentials()`


#### `test_rate_limiting_returns_error()`


#### `test_get_open_orders_with_symbol()`


#### `test_get_open_orders_without_symbol()`


#### `test_get_wallet_balance_requires_credentials()`


#### `test_get_wallet_balance_with_credentials()`


#### `test_get_positions_requires_credentials()`


#### `test_get_positions_with_credentials()`


#### `test_get_fee_rate_requires_credentials()`


#### `test_get_fee_rate_with_credentials()`


#### `create_reconciliation_test_router(state: TestServerState)`


#### `start_reconciliation_test_server()`


#### `test_request_order_status_reports_calls_both_endpoints()`


#### `test_request_order_status_reports_requires_settle_coin_for_linear()`


#### `test_order_deduplication_by_order_id()`


#### `test_request_order_status_reports_linear_queries_all_settle_coins()`


#### `test_request_order_status_reports_respects_limit_across_settle_coins()`


#### `test_request_order_status_reports_stops_before_next_coin()`


#### `test_request_order_status_reports_combines_orders_from_each_settle_coin()`
...
**Directory:** `crates/adapters/bybit/tests`
