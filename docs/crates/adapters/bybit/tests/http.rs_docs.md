...
This file is part of the NautilusTrader repository. It defines 51 function(s) and 1 class(es).
...
- **`handle_get_server_time()`**: Function defined in this file
- **`handle_get_instruments()`**: Function defined in this file
- **`handle_get_klines()`**: Function defined in this file
- **`handle_get_trades()`**: Function defined in this file
- **`handle_get_orders()`**: Function defined in this file
- **`handle_post_order()`**: Function defined in this file
- **`handle_get_wallet_balance()`**: Function defined in this file
- **`handle_cancel_order()`**: Function defined in this file
- **`handle_get_positions()`**: Function defined in this file
- **`handle_get_fee_rate()`**: Function defined in this file
- **`handle_no_convert_repay()`**: Function defined in this file
- **`handle_get_orders_realtime()`**: Function defined in this file
- **`handle_get_orders_history_reconciliation()`**: Function defined in this file
- **`create_test_router()`**: Function defined in this file
- **`start_test_server()`**: Function defined in this file
- **`test_client_creation()`**: Function defined in this file
- **`test_client_with_credentials()`**: Function defined in this file
- **`test_testnet_urls()`**: Function defined in this file
...
**Functions**: `create_reconciliation_test_router`, `create_test_router`, `default`, `handle_cancel_order`, `handle_get_fee_rate`, `handle_get_instruments`, `handle_get_klines`, `handle_get_orders`, `handle_get_orders_history_reconciliation`, `handle_get_orders_realtime`, `handle_get_positions`, `handle_get_server_time`, `handle_get_trades`, `handle_get_wallet_balance`, `handle_no_convert_repay`, `handle_post_order`, `load_test_data`, `start_reconciliation_test_server`, `start_test_server`, `test_authenticated_endpoint_requires_credentials`, `test_client_creation`, `test_client_with_credentials`, `test_custom_base_url`, `test_get_fee_rate_requires_credentials`, `test_get_fee_rate_with_credentials`, `test_get_instruments_inverse`, `test_get_instruments_linear`, `test_get_instruments_option`, `test_get_instruments_spot`, `test_get_open_orders_with_symbol` *(+21 more)*
**Impls**: `Default`, `IntoResponse`
...
```bash
# For Python
pytest crates/adapters/bybit/tests/http.rs
...
---
*Generated on 2025-11-18T21:54:59.543473Z*
