...
- **Path**: `crates/adapters/bybit/tests/websocket.rs`
- **Size**: 64,577 bytes
- **Lines**: 2,073
- **Language**: Rust
...
This file is part of the NautilusTrader repository. It defines 60 function(s) and 1 class(es).
...
- **`set_subscription_failures()`**: Function defined in this file
- **`set_auth_delay()`**: Function defined in this file
...
- **`test_public_client_connection()`**: Function defined in this file
- **`test_private_client_authentication()`**: Function defined in this file
- **`test_authentication_failure()`**: Function defined in this file
- **`test_ping_pong()`**: Function defined in this file
- **`test_subscription_lifecycle()`**: Function defined in this file
- **`test_message_routing()`**: Function defined in this file
- **`test_reconnection_flow()`**: Function defined in this file
...
Total unique keywords extracted: 62


**Functions**: `clear_subscription_events`, `create_conditional_order_params_with_reduce_only`, `create_conditional_order_params_with_side`, `create_test_router`, `default`, `handle_socket`, `handle_websocket`, `load_test_data`, `reset`, `set_auth_delay`, `set_subscription_failures`, `start_test_server`, `subscription_events`, `test_authentication_failure`, `test_buy_limit_if_touched_order_trigger_direction`, `test_buy_market_if_touched_order_trigger_direction`, `test_buy_stop_limit_order_trigger_direction`, `test_buy_stop_market_order_trigger_direction`, `test_heartbeat_timeout_reconnection`, `test_is_active_false_after_close`, `test_is_active_false_during_reconnection`, `test_is_active_lifecycle`, `test_klines_subscription_flow`, `test_login_failure_emits_error`, `test_message_routing`, `test_multiple_partial_subscription_failures`, `test_multiple_subscriptions`, `test_orderbook_subscription_flow`, `test_ping_pong`, `test_private_client_authentication` *(+30 more)*
...
```bash
# For Python
pytest crates/adapters/bybit/tests/websocket.rs
...
---
*Generated on 2025-11-18T21:54:59.556654Z*
