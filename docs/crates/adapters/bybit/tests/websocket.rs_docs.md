# Documentation: `crates/adapters/bybit/tests/websocket.rs`
**Generated:** 2025-11-15T19:40:00.744177Z
**File Size:** 64577 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/adapters/bybit/tests/websocket.rs` within the repository.

**Classes defined:** TestServerState, Default, TestServerState

**Functions defined:** default, reset, set_subscription_failures, set_auth_delay, subscription_events, clear_subscription_events, handle_websocket, handle_socket, load_test_data, create_test_router and 50 more
...
#### `set_subscription_failures(&self, topics: Vec<String>)`


#### `set_auth_delay(&self, delay_ms: u64)`
...
#### `handle_websocket(ws: WebSocketUpgrade, State(state)`


#### `handle_socket(mut socket: WebSocket, state: TestServerState)`
...
#### `wait_for_connection_count(state: &TestServerState, expected: usize, timeout: Duration)`


#### `test_public_client_connection()`


#### `test_private_client_authentication()`
...
#### `test_unauthenticated_private_subscription_fails()`


#### `test_subscription_after_reconnection()`
...
#### `test_trade_subscription_flow()`


#### `test_orderbook_subscription_flow()`


#### `test_ticker_subscription_flow()`


#### `test_klines_subscription_flow()`


#### `test_private_orders_subscription()`


#### `test_private_executions_subscription()`


#### `test_private_wallet_subscription()`
...
#### `test_sends_pong_for_text_ping_message()`


#### `test_buy_stop_market_order_trigger_direction()`


#### `test_sell_stop_market_order_trigger_direction()`


#### `test_buy_stop_limit_order_trigger_direction()`


#### `test_sell_stop_limit_order_trigger_direction()`


#### `test_buy_market_if_touched_order_trigger_direction()`


#### `test_sell_market_if_touched_order_trigger_direction()`
