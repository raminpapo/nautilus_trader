# Documentation: `crates/adapters/okx/tests/http.rs`
**Generated:** 2025-11-15T19:40:01.414939Z
**File Size:** 79311 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/adapters/okx/tests/http.rs` within the repository.

**Classes defined:** TestServerState

**Functions defined:** manifest_path, load_test_data, has_auth_headers, load_instruments_any, create_router, start_test_server, test_http_get_instruments_returns_data, test_http_get_balance_requires_credentials, test_http_get_balance_with_credentials_succeeds, test_http_get_instruments_handles_rate_limit_error and 34 more
...
#### `load_test_data(filename: &str)`


#### `has_auth_headers(headers: &HeaderMap)`


#### `load_instruments_any()`


#### `create_router(state: Arc<TestServerState>)`


#### `start_test_server(state: Arc<TestServerState>)`
...
#### `test_http_get_balance_with_credentials_succeeds()`


#### `test_http_get_instruments_handles_rate_limit_error()`


#### `test_http_get_pending_orders_requires_credentials()`


#### `test_http_get_pending_orders_returns_live_orders()`


#### `test_http_get_order_history_applies_filters()`


#### `test_http_get_order_by_client_and_exchange_ids()`


#### `test_request_trades_pagination_parameters()`


#### `test_request_trades_latest_mode()`


#### `test_request_trades_chronological_order()`


#### `test_request_trades_range_mode_pagination()`


#### `test_request_bars_range_mode_pagination()`


#### `test_request_trades_multi_page_chronological_order()`


#### `test_request_trades_overlapping_pages_chronological_order()`


#### `test_request_trades_default_limit_with_end_only()`


#### `test_request_trades_historical_with_filtered_pages()`


#### `test_request_trades_multiple_trades_same_id()`


#### `test_http_get_order_algo_pending_requires_credentials()`


#### `test_http_get_order_algo_pending_returns_data()`


#### `test_http_get_order_algo_history_returns_data()`


#### `test_http_set_position_mode_requires_credentials()`


#### `test_http_set_position_mode_returns_response()`


#### `test_http_get_position_tiers_returns_data()`


#### `test_http_get_trade_fee_requires_credentials()`


#### `test_http_get_trade_fee_returns_data()`


#### `test_http_get_positions_requires_credentials()`


#### `test_http_get_positions_returns_data()`


#### `test_http_get_fills_requires_credentials()`


#### `test_http_get_fills_returns_data()`


#### `test_http_network_error_invalid_port()`


#### `test_http_okx_error_response()`


#### `test_http_malformed_json_response()`
...
#### `test_http_invalid_response_structure()`


#### `test_http_rate_limit_error_different_code()`


#### `test_http_empty_response_data()`
...
**Directory:** `crates/adapters/okx/tests`
...
**Security:** This file may contain sensitive patterns: secret, credential, auth. Ensure proper handling of secrets.
