# Documentation: http.rs

## File Metadata

- **Path**: `crates/adapters/okx/tests/http.rs`
- **Size**: 79,320 bytes
- **Lines**: 2,388
- **Language**: Rust
...
### Functions
- **`manifest_path()`**: Function defined in this file
- **`load_test_data()`**: Function defined in this file
- **`has_auth_headers()`**: Function defined in this file
- **`load_instruments_any()`**: Function defined in this file
- **`create_router()`**: Function defined in this file
- **`start_test_server()`**: Function defined in this file
- **`test_http_get_instruments_returns_data()`**: Function defined in this file
- **`test_http_get_balance_requires_credentials()`**: Function defined in this file
- **`test_http_get_balance_with_credentials_succeeds()`**: Function defined in this file
- **`test_http_get_instruments_handles_rate_limit_error()`**: Function defined in this file
- **`test_http_get_pending_orders_requires_credentials()`**: Function defined in this file
- **`test_http_get_pending_orders_returns_live_orders()`**: Function defined in this file
- **`test_http_get_order_history_applies_filters()`**: Function defined in this file
- **`test_http_get_order_by_client_and_exchange_ids()`**: Function defined in this file
- **`test_request_trades_pagination_parameters()`**: Function defined in this file
- **`test_request_trades_latest_mode()`**: Function defined in this file
- **`test_request_trades_chronological_order()`**: Function defined in this file
- **`test_request_trades_range_mode_pagination()`**: Function defined in this file
- **`test_request_bars_range_mode_pagination()`**: Function defined in this file
- **`test_request_trades_multi_page_chronological_order()`**: Function defined in this file
...
**Functions**: `create_router`, `has_auth_headers`, `load_instruments_any`, `load_test_data`, `manifest_path`, `start_test_server`, `test_http_500_internal_server_error`, `test_http_503_service_unavailable`, `test_http_empty_response_data`, `test_http_get_balance_requires_credentials`, `test_http_get_balance_with_credentials_succeeds`, `test_http_get_fills_requires_credentials`, `test_http_get_fills_returns_data`, `test_http_get_instruments_handles_rate_limit_error`, `test_http_get_instruments_returns_data`, `test_http_get_order_algo_history_returns_data`, `test_http_get_order_algo_pending_requires_credentials`, `test_http_get_order_algo_pending_returns_data`, `test_http_get_order_by_client_and_exchange_ids`, `test_http_get_order_history_applies_filters`, `test_http_get_pending_orders_requires_credentials`, `test_http_get_pending_orders_returns_live_orders`, `test_http_get_position_tiers_returns_data`, `test_http_get_positions_requires_credentials`, `test_http_get_positions_returns_data`, `test_http_get_trade_fee_requires_credentials`, `test_http_get_trade_fee_returns_data`, `test_http_invalid_response_structure`, `test_http_malformed_json_response`, `test_http_network_error_invalid_port` *(+14 more)*
**Structs**: `TestServerState`

## Related Files

This file is located in `crates/adapters/okx/tests/`. Related files may include:
...
```bash
# For Python
pytest crates/adapters/okx/tests/http.rs
...
---
*Generated on 2025-11-18T21:55:00.617168Z*
