...
- **`value_matches_channel()`**: Function defined in this file
- **`is_private_channel()`**: Function defined in this file
- **`subscription_key()`**: Function defined in this file
- **`record_subscription_event()`**: Function defined in this file
- **`pop_fail_subscription()`**: Function defined in this file
- **`subscription_events()`**: Function defined in this file
- **`clear_subscription_events()`**: Function defined in this file
- **`control_ping_count()`**: Function defined in this file
- **`handle_ws_upgrade()`**: Function defined in this file
- **`handle_socket()`**: Function defined in this file
- **`start_ws_server()`**: Function defined in this file
- **`connect_client()`**: Function defined in this file
- **`test_websocket_connection()`**: Function defined in this file
- **`test_wait_until_active_timeout()`**: Function defined in this file
- **`test_trades_subscription_flow()`**: Function defined in this file
- **`test_reauth_and_resubscribe_after_disconnect()`**: Function defined in this file
- **`test_heartbeat_timeout_reconnection()`**: Function defined in this file
...
**Functions**: `clear_subscription_events`, `connect_client`, `control_ping_count`, `data_path`, `handle_socket`, `handle_ws_upgrade`, `is_private_channel`, `load_instruments`, `load_json`, `pop_fail_subscription`, `record_subscription_event`, `start_ws_server`, `subscription_events`, `subscription_key`, `test_auth_and_subscription_restoration_order`, `test_batch_cancel_orders_sends_message`, `test_heartbeat_timeout_reconnection`, `test_is_active_false_after_close`, `test_is_active_false_during_reconnection`, `test_is_active_lifecycle`, `test_login_failure_emits_error`, `test_multiple_partial_subscription_failures`, `test_multiple_symbols_subscription`, `test_rapid_consecutive_reconnections`, `test_reauth_and_resubscribe_after_disconnect`, `test_reconnection_race_condition`, `test_reconnection_retries_failed_subscriptions`, `test_reconnection_waits_for_delayed_auth_ack`, `test_sends_pong_for_control_ping`, `test_sends_pong_for_text_ping` *(+11 more)*
**Impls**: `TestServerState`
...
```bash
# For Python
pytest crates/adapters/okx/tests/websocket.rs
...
---
*Generated on 2025-11-18T21:55:00.631830Z*
