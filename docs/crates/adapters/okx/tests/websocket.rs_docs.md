# Documentation: `crates/adapters/okx/tests/websocket.rs`
**Generated:** 2025-11-15T19:40:01.423301Z
**File Size:** 69034 bytes
**Extension:** .rs
**Type:** text
...
- **Path:** `crates/adapters/okx/tests/websocket.rs`
- **Size:** 69,034 bytes
- **Lines:** 2,244
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/adapters/okx/tests/websocket.rs` within the repository.

**Classes defined:** for, TestWsResponse, TestServerState, TestServerState

**Functions defined:** data_path, load_json, load_instruments, value_matches_channel, is_private_channel, subscription_key, record_subscription_event, pop_fail_subscription, subscription_events, clear_subscription_events and 43 more
...
#### `value_matches_channel(value: &Value, channel: &str)`


#### `is_private_channel(channel: &str)`


#### `subscription_key(arg: &Value)`


#### `record_subscription_event(&self, arg: &Value, success: bool)`


#### `pop_fail_subscription(&self, key: &str)`


#### `subscription_events(&self)`


#### `clear_subscription_events(&self)`


#### `control_ping_count(&self)`
...
#### `handle_socket(mut socket: WebSocket, state: Arc<TestServerState>)`


#### `start_ws_server(state: Arc<TestServerState>)`


#### `connect_client(ws_url: &str)`
...
#### `test_trades_subscription_flow()`


#### `test_reauth_and_resubscribe_after_disconnect()`
...
#### `test_unsubscribe_orders_sends_request()`
...
#### `test_batch_cancel_orders_sends_message()`
...
#### `test_parse_regular_order_message()`


#### `test_parse_algo_order_message()`


#### `test_parse_liquidation_order_message()`


#### `test_parse_adl_order_message()`


#### `test_parse_trigger_order_message()`


#### `test_parse_book_snapshot_message()`


#### `test_parse_book_update_message()`


#### `test_parse_ticker_message()`


#### `test_parse_candle_message()`
...
**Security:** This file may contain sensitive patterns: secret, api_key, auth. Ensure proper handling of secrets.
