...
### Functions
- **`ccy()`**: Function defined in this file
- **`cash_bal()`**: Function defined in this file
- **`liab()`**: Function defined in this file
...
**Functions**: `cash_bal`, `ccy`, `liab`
**Impls**: `OKXBalanceDetail`
...
---
*Generated on 2025-11-18T21:55:00.435235Z*
