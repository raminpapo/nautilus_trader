# Documentation: `crates/adapters/okx/src/python/http.rs`
**Generated:** 2025-11-15T19:40:01.304996Z
**File Size:** 20935 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/adapters/okx/src/python/http.rs` within the repository.

**Classes defined:** OKXHttpClient, From

**Functions defined:** py_new, py_from_env, py_base_url, py_api_key, py_is_initialized, py_get_cached_symbols, py_cancel_all_requests, py_cache_instruments, py_cache_instrument, py_set_position_mode and 17 more
...
#### `py_is_initialized(&self)`


#### `py_get_cached_symbols(&self)`
...
#### `py_request_algo_order_status_reports(
        &self,
        py: Python<'py>,
        account_id: AccountId,
        instrument_type: Option<OKXInstrumentType>,
...
#### `py_request_algo_order_status_report(
        &self,
        py: Python<'py>,
        account_id: AccountId,
        instrument_id: InstrumentId,
...
#### `py_get_server_time(&self, py: Python<'py>)`


#### `py_get_balance(&self, py: Python<'py>)`


#### `from(error: OKXHttpError)`
