# Documentation: `crates/adapters/okx/src/python/urls.rs`
**Generated:** 2025-11-15T19:40:01.308711Z
...
This file is located at `crates/adapters/okx/src/python/urls.rs` within the repository.

**Functions defined:** get_okx_http_base_url, get_okx_ws_url_public, get_okx_ws_url_private, get_okx_ws_url_business, okx_requires_authentication
...
#### `get_okx_ws_url_public(is_demo: bool)`


#### `get_okx_ws_url_private(is_demo: bool)`


#### `get_okx_ws_url_business(is_demo: bool)`


#### `okx_requires_authentication(endpoint_type: urls::OKXEndpointType)`
