# Documentation: `crates/adapters/okx/src/python/websocket.rs`
**Generated:** 2025-11-15T19:40:01.313342Z
**File Size:** 37901 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/adapters/okx/src/python/websocket.rs` within the repository.

**Classes defined:** OKXWebSocketError, OKXWebSocketClient

**Functions defined:** code, message, conn_id, ts_event, __repr__, py_new, py_with_credentials, py_from_env, py_url, py_api_key and 53 more
...
#### `py_cancel_all_requests(&self)`


#### `py_get_subscriptions(&self, instrument_id: InstrumentId)`


#### `py_set_vip_level(&self, vip_level: OKXVipLevel)`
