...
- **Path**: `crates/adapters/okx/src/python/websocket.rs`
- **Size**: 37,901 bytes
- **Lines**: 1,187
- **Language**: Rust
...
- **`py_with_credentials()`**: Function defined in this file
...
- **`py_set_vip_level()`**: Function defined in this file
- **`py_vip_level()`**: Function defined in this file
...
**Functions**: `__repr__`, `call_python`, `call_python_with_data`, `code`, `conn_id`, `message`, `py_api_key`, `py_batch_cancel_orders`, `py_batch_modify_orders`, `py_batch_submit_orders`, `py_cache_instrument`, `py_cache_instruments`, `py_cancel_all_requests`, `py_cancel_order`, `py_close`, `py_connect`, `py_from_env`, `py_get_subscriptions`, `py_is_active`, `py_is_closed`, `py_mass_cancel_orders`, `py_modify_order`, `py_new`, `py_set_vip_level`, `py_submit_order`, `py_subscribe_account`, `py_subscribe_bars`, `py_subscribe_book`, `py_subscribe_book50_l2_tbt`, `py_subscribe_book_depth5` *(+33 more)*
**Impls**: `OKXWebSocketClient`, `OKXWebSocketError`
...
---
*Generated on 2025-11-18T21:55:00.443447Z*
