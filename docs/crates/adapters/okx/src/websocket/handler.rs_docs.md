...
- **Path**: `crates/adapters/okx/src/websocket/handler.rs`
- **Size**: 95,632 bytes
- **Lines**: 2,446
- **Language**: Rust
...
This file is part of the NautilusTrader repository. It defines 38 function(s) and 1 class(es).
...
- **`send_pong()`**: Function defined in this file
- **`next()`**: Function defined in this file
- **`is_post_only_auto_cancel()`**: Function defined in this file
- **`try_handle_post_only_auto_cancel()`**: Function defined in this file
- **`register_client_order_aliases()`**: Function defined in this file
- **`adjust_execution_report()`**: Function defined in this file
- **`update_caches_with_report()`**: Function defined in this file
- **`handle_order_response()`**: Function defined in this file
- **`handle_book_data()`**: Function defined in this file
- **`handle_account_data()`**: Function defined in this file
- **`handle_positions_data()`**: Function defined in this file
- **`handle_orders_data()`**: Function defined in this file
- **`handle_algo_orders_data()`**: Function defined in this file
- **`handle_other_channel_data()`**: Function defined in this file
...
### Classes
- **`OKXWsFeedHandler`**: Class defined in this file
...
**Enums**: `HandlerCommand`, `PendingOrderParams`
**Functions**: `adjust_execution_report`, `create_okx_timeout_error`, `generate_unique_request_id`, `get_instrument_type_and_family_from_instrument`, `handle_account_data`, `handle_algo_orders_data`, `handle_amend_order`, `handle_batch_amend_orders`, `handle_batch_cancel_orders`, `handle_batch_place_orders`, `handle_book_data`, `handle_cancel_algo_order`, `handle_cancel_order`, `handle_mass_cancel`, `handle_order_response`, `handle_orders_data`, `handle_other_channel_data`, `handle_place_algo_order`, `handle_place_order`, `handle_positions_data`, `handle_subscribe`, `handle_unsubscribe`, `is_post_only_auto_cancel`, `is_post_only_rejection`, `is_stopped`, `new`, `next`, `parse_raw_message`, `register_client_order_aliases`, `send` *(+8 more)*
**Impls**: `OKXWsFeedHandler`
**Structs**: `OKXWsFeedHandler`
...
---
*Generated on 2025-11-18T21:55:00.477187Z*
