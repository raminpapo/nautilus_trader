...
- **Path**: `crates/adapters/okx/src/websocket/parse.rs`
- **Size**: 129,106 bytes
- **Lines**: 3,719
- **Language**: Rust
...
### Functions
- **`extract_fees_from_cached_instrument()`**: Function defined in this file
- **`parse_book_msg_vec()`**: Function defined in this file
- **`parse_ticker_msg_vec()`**: Function defined in this file
- **`parse_quote_msg_vec()`**: Function defined in this file
- **`parse_trade_msg_vec()`**: Function defined in this file
- **`parse_mark_price_msg_vec()`**: Function defined in this file
- **`parse_index_price_msg_vec()`**: Function defined in this file
- **`parse_funding_rate_msg_vec()`**: Function defined in this file
- **`parse_candle_msg_vec()`**: Function defined in this file
...
- **`parse_ticker_msg()`**: Function defined in this file
- **`parse_trade_msg()`**: Function defined in this file
- **`parse_mark_price_msg()`**: Function defined in this file
- **`parse_index_price_msg()`**: Function defined in this file
- **`parse_candle_msg()`**: Function defined in this file
- **`parse_order_msg_vec()`**: Function defined in this file
- **`has_acc_fill_sz_increased()`**: Function defined in this file
...
**Functions**: `create_stub_instrument`, `create_stub_order_msg`, `extract_fees_from_cached_instrument`, `has_acc_fill_sz_increased`, `parse_algo_order_msg`, `parse_algo_order_status_report`, `parse_book10_msg`, `parse_book10_msg_vec`, `parse_book_msg`, `parse_book_msg_vec`, `parse_candle_msg`, `parse_candle_msg_vec`, `parse_fill_report`, `parse_funding_rate_msg_vec`, `parse_index_price_msg`, `parse_index_price_msg_vec`, `parse_mark_price_msg`, `parse_mark_price_msg_vec`, `parse_order_msg`, `parse_order_msg_vec`, `parse_order_status_report`, `parse_quote_msg`, `parse_quote_msg_vec`, `parse_ticker_msg`, `parse_ticker_msg_vec`, `parse_trade_msg`, `parse_trade_msg_vec`, `parse_ws_message_data`, `test_deserialize_adl_order_message`, `test_deserialize_algo_order_message` *(+50 more)*
...
---
*Generated on 2025-11-18T21:55:00.518093Z*
