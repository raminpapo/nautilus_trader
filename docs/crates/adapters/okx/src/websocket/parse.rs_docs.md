# Documentation: `crates/adapters/okx/src/websocket/parse.rs`
**Generated:** 2025-11-15T19:40:01.363206Z
**File Size:** 121567 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/adapters/okx/src/websocket/parse.rs` within the repository.

**Functions defined:** is_market_price, extract_fees_from_cached_instrument, parse_book_msg_vec, parse_ticker_msg_vec, parse_quote_msg_vec, parse_trade_msg_vec, parse_mark_price_msg_vec, parse_index_price_msg_vec, parse_funding_rate_msg_vec, parse_candle_msg_vec and 55 more
...
#### `create_stub_instrument()`


#### `create_stub_order_msg(
        fill_sz: &str,
        acc_fill_sz: Option<String>,
        order_id: &str,
        trade_id: &str,
...
#### `test_parse_books_snapshot()`


#### `test_parse_books_update()`
...
#### `test_parse_funding_rate()`


#### `test_parse_book_vec()`


#### `test_parse_ticker_vec()`


#### `test_parse_trade_vec()`


#### `test_parse_candle_vec()`


#### `test_parse_book_message()`


#### `test_parse_ws_account_message()`
...
#### `test_parse_book10_msg()`


#### `test_parse_book10_msg_vec()`


#### `test_parse_fill_report_with_fee_cache()`


#### `test_parse_fill_report_with_maker_rebates()`


#### `test_parse_fill_report_rebate_to_charge_transition()`
