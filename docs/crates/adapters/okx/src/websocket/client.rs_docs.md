# Documentation: `crates/adapters/okx/src/websocket/client.rs`
**Generated:** 2025-11-15T19:40:01.323950Z
**File Size:** 113138 bytes
**Extension:** .rs
**Type:** text
...
- **Path:** `crates/adapters/okx/src/websocket/client.rs`
- **Size:** 113,138 bytes
- **Lines:** 3,174
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/adapters/okx/src/websocket/client.rs` within the repository.

**Classes defined:** OKXWebSocketClient, Default, Debug, OKXWebSocketClient, Stream

**Functions defined:** default, fmt, new, with_credentials, from_env, cancel_all_requests, cancellation_token, url, api_key, is_active and 96 more
...
#### `cache_instruments(&self, instruments: Vec<InstrumentAny>)`


#### `cache_instrument(&self, instrument: InstrumentAny)`


#### `set_vip_level(&self, vip_level: OKXVipLevel)`
...
#### `wait_until_active(&self, timeout_secs: f64)`


#### `close(&mut self)`


#### `get_subscriptions(&self, instrument_id: InstrumentId)`


#### `generate_unique_request_id(&self)`


#### `subscribe(&self, args: Vec<OKXSubscriptionArg>)`


#### `unsubscribe(&self, args: Vec<OKXSubscriptionArg>)`
...
#### `subscribe_books_channel(
        &self,
        instrument_id: InstrumentId,
    )`


#### `subscribe_book_depth5(
        &self,
        instrument_id: InstrumentId,
    )`


#### `subscribe_book50_l2_tbt(
        &self,
        instrument_id: InstrumentId,
    )`


#### `subscribe_book_l2_tbt(
        &self,
        instrument_id: InstrumentId,
    )`


#### `subscribe_book_with_depth(
        &self,
        instrument_id: InstrumentId,
        depth: u16,
    )`
...
#### `subscribe_ticker(&self, instrument_id: InstrumentId)`
...
#### `unsubscribe_book_depth5(
        &self,
        instrument_id: InstrumentId,
    )`


#### `unsubscribe_book50_l2_tbt(
        &self,
        instrument_id: InstrumentId,
    )`


#### `unsubscribe_book_l2_tbt(
        &self,
        instrument_id: InstrumentId,
    )`
...
#### `unsubscribe_ticker(&self, instrument_id: InstrumentId)`
...
**Security:** This file may contain sensitive patterns: secret, token, api_key, credential, auth, session. Ensure proper handling of secrets.
