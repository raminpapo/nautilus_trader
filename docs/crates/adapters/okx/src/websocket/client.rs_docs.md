...
This file is part of the NautilusTrader repository. It defines 106 function(s) and 1 class(es).
...
- **`set_vip_level()`**: Function defined in this file
...
### Classes
- **`OKXWebSocketClient`**: Class defined in this file


## Keywords and Identifiers

Total unique keywords extracted: 110


**Functions**: `api_key`, `authenticate`, `batch_cancel_orders`, `batch_modify_orders`, `batch_submit_orders`, `cache_instrument`, `cache_instruments`, `cancel_algo_order`, `cancel_all_requests`, `cancel_order`, `cancellation_token`, `close`, `connect`, `default`, `fmt`, `from_env`, `generate_unique_request_id`, `get_subscriptions`, `is_active`, `is_closed`, `mass_cancel_orders`, `modify_order`, `new`, `sample_canceled_order_msg`, `send_cmd`, `set_vip_level`, `stream`, `submit_algo_order`, `submit_order`, `subscribe` *(+76 more)*
**Impls**: `Debug`, `Default`, `OKXWebSocketClient`, `Stream`
**Structs**: `OKXWebSocketClient`
...
---
*Generated on 2025-11-18T21:55:00.458564Z*
