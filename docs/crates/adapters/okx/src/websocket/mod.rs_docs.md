# Documentation: `crates/adapters/okx/src/websocket/mod.rs`
**Generated:** 2025-11-15T19:40:01.346274Z
**File Size:** 1520 bytes
**Extension:** .rs
**Type:** text
...
- **Path:** `crates/adapters/okx/src/websocket/mod.rs`
- **Size:** 1,520 bytes
- **Lines:** 36
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/adapters/okx/src/websocket/mod.rs` within the repository.
