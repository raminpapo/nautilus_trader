# Documentation: `crates/adapters/okx/src/websocket/messages.rs`
**Generated:** 2025-11-15T19:40:01.344175Z
**File Size:** 45770 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/adapters/okx/src/websocket/messages.rs` within the repository.

**Classes defined:** OKXWebSocketError, OKXWsRequest, OKXAuthentication, OKXAuthenticationArg, OKXSubscription, OKXSubscriptionArg, OKXWebSocketArg, OKXTickerMsg, OrderBookEntry, OKXBookMsg and 19 more

**Functions defined:** test_deserialize_websocket_arg, test_deserialize_subscribe_variant_direct, test_deserialize_subscribe_confirmation, test_deserialize_subscribe_with_inst_id, test_channel_serialization_for_logging, test_order_response_with_enum_operation, test_operation_enum_serialization, test_order_response_parsing, test_subscription_event_parsing, test_login_event_parsing and 10 more
...
#### `test_deserialize_websocket_arg()`


#### `test_deserialize_subscribe_variant_direct()`


#### `test_deserialize_subscribe_confirmation()`


#### `test_deserialize_subscribe_with_inst_id()`


#### `test_channel_serialization_for_logging()`


#### `test_order_response_with_enum_operation()`


#### `test_operation_enum_serialization()`


#### `test_order_response_parsing()`


#### `test_subscription_event_parsing()`


#### `test_login_event_parsing()`


#### `test_error_event_parsing()`
...
#### `test_book_data_parsing()`


#### `test_data_event_parsing()`


#### `test_nautilus_message_variants()`


#### `test_order_response_parsing_success()`


#### `test_order_response_parsing_failure()`
