# Documentation: messages.rs

## File Metadata

- **Path**: `crates/adapters/okx/src/websocket/messages.rs`
- **Size**: 45,770 bytes
- **Lines**: 1,404
- **Language**: Rust
...
This file is part of the NautilusTrader repository. It defines 20 function(s) and 29 class(es).

## Detailed Walkthrough

### Functions
- **`test_deserialize_websocket_arg()`**: Function defined in this file
- **`test_deserialize_subscribe_variant_direct()`**: Function defined in this file
- **`test_deserialize_subscribe_confirmation()`**: Function defined in this file
- **`test_deserialize_subscribe_with_inst_id()`**: Function defined in this file
- **`test_channel_serialization_for_logging()`**: Function defined in this file
- **`test_order_response_with_enum_operation()`**: Function defined in this file
- **`test_operation_enum_serialization()`**: Function defined in this file
- **`test_order_response_parsing()`**: Function defined in this file
- **`test_subscription_event_parsing()`**: Function defined in this file
- **`test_login_event_parsing()`**: Function defined in this file
- **`test_error_event_parsing()`**: Function defined in this file
- **`test_websocket_request_serialization()`**: Function defined in this file
- **`test_subscription_request_serialization()`**: Function defined in this file
- **`test_error_message_extraction()`**: Function defined in this file
- **`test_book_data_parsing()`**: Function defined in this file
- **`test_data_event_parsing()`**: Function defined in this file
- **`test_nautilus_message_variants()`**: Function defined in this file
- **`test_order_response_parsing_success()`**: Function defined in this file
- **`test_order_response_parsing_failure()`**: Function defined in this file
- **`test_message_request_serialization()`**: Function defined in this file

### Classes
- **`OKXWebSocketError`**: Class defined in this file
- **`OKXWsRequest`**: Class defined in this file
- **`OKXAuthentication`**: Class defined in this file
- **`OKXAuthenticationArg`**: Class defined in this file
- **`OKXSubscription`**: Class defined in this file
- **`OKXSubscriptionArg`**: Class defined in this file
- **`OKXWebSocketArg`**: Class defined in this file
- **`OKXTickerMsg`**: Class defined in this file
- **`OrderBookEntry`**: Class defined in this file
- **`OKXBookMsg`**: Class defined in this file
- **`OKXTradeMsg`**: Class defined in this file
- **`OKXFundingRateMsg`**: Class defined in this file
- **`OKXMarkPriceMsg`**: Class defined in this file
- **`OKXIndexPriceMsg`**: Class defined in this file
- **`OKXPriceLimitMsg`**: Class defined in this file
- **`OKXCandleMsg`**: Class defined in this file
- **`OKXOpenInterestMsg`**: Class defined in this file
- **`OKXOptionSummaryMsg`**: Class defined in this file
- **`OKXEstimatedPriceMsg`**: Class defined in this file
- **`OKXStatusMsg`**: Class defined in this file
...
**Enums**: `ExecutionReport`, `NautilusWsMessage`, `OKXWsMessage`
**Functions**: `test_book_data_parsing`, `test_channel_serialization_for_logging`, `test_data_event_parsing`, `test_deserialize_subscribe_confirmation`, `test_deserialize_subscribe_variant_direct`, `test_deserialize_subscribe_with_inst_id`, `test_deserialize_websocket_arg`, `test_error_event_parsing`, `test_error_message_extraction`, `test_login_event_parsing`, `test_message_request_serialization`, `test_nautilus_message_variants`, `test_operation_enum_serialization`, `test_order_response_parsing`, `test_order_response_parsing_failure`, `test_order_response_parsing_success`, `test_order_response_with_enum_operation`, `test_subscription_event_parsing`, `test_subscription_request_serialization`, `test_websocket_request_serialization`
**Structs**: `OKXAlgoOrderMsg`, `OKXAuthentication`, `OKXAuthenticationArg`, `OKXBookMsg`, `OKXCandleMsg`, `OKXEstimatedPriceMsg`, `OKXFundingRateMsg`, `OKXIndexPriceMsg`, `OKXMarkPriceMsg`, `OKXOpenInterestMsg`, `OKXOptionSummaryMsg`, `OKXOrderMsg`, `OKXPriceLimitMsg`, `OKXStatusMsg`, `OKXSubscription`, `OKXSubscriptionArg`, `OKXTickerMsg`, `OKXTradeMsg`, `OKXWebSocketArg`, `OKXWebSocketError`, `OKXWsRequest`, `OrderBookEntry`, `SubscribeMsg`, `WsAmendOrderParams`, `WsCancelAlgoOrderParams`, `WsCancelOrderParams`, `WsMassCancelParams`, `WsPostAlgoOrderParams`, `WsPostOrderParams`
...
---
*Generated on 2025-11-18T21:55:00.484710Z*
