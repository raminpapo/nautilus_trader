...
- **Path**: `crates/adapters/okx/src/http/client.rs`
- **Size**: 116,343 bytes
- **Lines**: 3,276
- **Language**: Rust
...
This file is part of the NautilusTrader repository. It defines 69 function(s) and 3 class(es).
...
- **`set_position_mode()`**: Function defined in this file
- **`get_position_tiers()`**: Function defined in this file
- **`get_instruments()`**: Function defined in this file
- **`get_server_time()`**: Function defined in this file
- **`get_mark_price()`**: Function defined in this file
- **`get_index_tickers()`**: Function defined in this file
- **`get_history_trades()`**: Function defined in this file
- **`get_candles()`**: Function defined in this file
- **`get_history_candles()`**: Function defined in this file

*...and 49 more functions*

### Classes
- **`OKXResponse`**: Class defined in this file
- **`OKXRawHttpClient`**: Class defined in this file
- **`OKXHttpClient`**: Class defined in this file


## Keywords and Identifiers

Total unique keywords extracted: 69


**Enums**: `Mode`
**Functions**: `api_key`, `base_url`, `cache_instrument`, `cache_instruments`, `cancel_algo_order`, `cancel_algo_order_with_domain_types`, `cancel_all_requests`, `cancellation_token`, `clone`, `collect_algo_reports`, `default`, `default_headers`, `fmt`, `from_env`, `generate_ts_init`, `get_balance`, `get_cached_symbols`, `get_candles`, `get_fills`, `get_history_candles`, `get_history_trades`, `get_index_tickers`, `get_instrument`, `get_instruments`, `get_mark_price`, `get_order`, `get_order_algo_history`, `get_order_algo_pending`, `get_orders_history`, `get_orders_pending` *(+32 more)*
**Impls**: `Clone`, `Debug`, `Default`, `OKXHttpClient`, `OKXRawHttpClient`
**Structs**: `OKXHttpClient`, `OKXRawHttpClient`, `OKXResponse`
...
---
*Generated on 2025-11-18T21:55:00.399722Z*
