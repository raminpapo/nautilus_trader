# Documentation: `crates/adapters/okx/src/http/client.rs`
**Generated:** 2025-11-15T19:40:01.284234Z
**File Size:** 116383 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/adapters/okx/src/http/client.rs` within the repository.

**Classes defined:** OKXResponse, OKXRawHttpClient, OKXHttpClient, Default, Debug, OKXRawHttpClient, Clone, Default, OKXHttpClient

**Functions defined:** default, fmt, rate_limiter_quotas, rate_limit_keys, cancel_all_requests, cancellation_token, new, with_credentials, default_headers, sign_request and 59 more
...
#### `get_order_algo_pending(
        &self,
        params: GetAlgoOrdersParams,
    )`


#### `get_order_algo_history(
        &self,
        params: GetAlgoOrdersParams,
    )`
...
#### `set_position_mode(&self, position_mode: OKXPositionMode)`
