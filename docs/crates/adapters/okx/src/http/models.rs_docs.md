...
- **Path**: `crates/adapters/okx/src/http/models.rs`
- **Size**: 32,388 bytes
- **Lines**: 948
- **Language**: Rust
...
This file is part of the NautilusTrader repository. It defines 4 function(s) and 19 class(es).

## Detailed Walkthrough

### Functions
- **`test_algo_order_request_serialization()`**: Function defined in this file
- **`test_algo_order_request_array_serialization()`**: Function defined in this file
- **`test_cancel_algo_order_request_serialization()`**: Function defined in this file
- **`test_cancel_algo_order_with_client_id_serialization()`**: Function defined in this file

### Classes
- **`OKXTrade`**: Class defined in this file
- **`OKXCandlestick`**: Class defined in this file
- **`OKXMarkPrice`**: Class defined in this file
- **`OKXIndexTicker`**: Class defined in this file
- **`OKXPositionTier`**: Class defined in this file
- **`OKXAccount`**: Class defined in this file
- **`OKXBalanceDetail`**: Class defined in this file
- **`OKXPosition`**: Class defined in this file
- **`OKXPlaceOrderResponse`**: Class defined in this file
- **`OKXOrderHistory`**: Class defined in this file
- **`OKXOrderAlgo`**: Class defined in this file
- **`OKXTransactionDetail`**: Class defined in this file
- **`OKXPositionHistory`**: Class defined in this file
- **`OKXPlaceAlgoOrderRequest`**: Class defined in this file
- **`OKXPlaceAlgoOrderResponse`**: Class defined in this file
- **`OKXCancelAlgoOrderRequest`**: Class defined in this file
- **`OKXCancelAlgoOrderResponse`**: Class defined in this file
- **`OKXServerTime`**: Class defined in this file
- **`OKXFeeRate`**: Class defined in this file
...
**Functions**: `test_algo_order_request_array_serialization`, `test_algo_order_request_serialization`, `test_cancel_algo_order_request_serialization`, `test_cancel_algo_order_with_client_id_serialization`
**Structs**: `OKXAccount`, `OKXBalanceDetail`, `OKXCancelAlgoOrderRequest`, `OKXCancelAlgoOrderResponse`, `OKXCandlestick`, `OKXFeeRate`, `OKXIndexTicker`, `OKXMarkPrice`, `OKXOrderAlgo`, `OKXOrderHistory`, `OKXPlaceAlgoOrderRequest`, `OKXPlaceAlgoOrderResponse`, `OKXPlaceOrderResponse`, `OKXPosition`, `OKXPositionHistory`, `OKXPositionTier`, `OKXServerTime`, `OKXTrade`, `OKXTransactionDetail`
...
---
*Generated on 2025-11-18T21:55:00.411540Z*
