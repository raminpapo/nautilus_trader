...
- **Path**: `crates/adapters/okx/src/http/query.rs`
- **Size**: 24,750 bytes
- **Lines**: 617
- **Language**: Rust
...
This file is part of the NautilusTrader repository. It defines 14 function(s) and 17 class(es).

## Detailed Walkthrough

### Functions
- **`serialize_string_vec()`**: Function defined in this file
- **`inst_id()`**: Function defined in this file
- **`bar()`**: Function defined in this file
- **`after_ms()`**: Function defined in this file
- **`before_ms()`**: Function defined in this file
- **`limit()`**: Function defined in this file
- **`build()`**: Function defined in this file
- **`test_optional_parameters_are_omitted_when_none()`**: Function defined in this file
- **`test_no_literal_none_strings_leak_into_query_string()`**: Function defined in this file
- **`test_cursor_nanoseconds_rejected()`**: Function defined in this file
- **`test_both_cursors_rejected()`**: Function defined in this file
- **`test_limit_exceeds_maximum_rejected()`**: Function defined in this file
- **`test_valid_millisecond_cursor_passes()`**: Function defined in this file
- **`test_valid_limit_passes()`**: Function defined in this file

### Classes
- **`corresponds`**: Class defined in this file
- **`SetPositionModeParams`**: Class defined in this file
- **`GetPositionTiersParams`**: Class defined in this file
- **`GetInstrumentsParams`**: Class defined in this file
- **`GetTradesParams`**: Class defined in this file
- **`GetCandlesticksParams`**: Class defined in this file
- **`GetCandlesticksParamsBuilder`**: Class defined in this file
- **`GetMarkPriceParams`**: Class defined in this file
- **`GetIndexTickerParams`**: Class defined in this file
- **`GetOrderHistoryParams`**: Class defined in this file
- **`GetOrderListParams`**: Class defined in this file
- **`GetAlgoOrdersParams`**: Class defined in this file
- **`GetTransactionDetailsParams`**: Class defined in this file
- **`GetPositionsParams`**: Class defined in this file
- **`GetPositionsHistoryParams`**: Class defined in this file
- **`GetOrderParams`**: Class defined in this file
- **`GetTradeFeeParams`**: Class defined in this file
...
**Functions**: `after_ms`, `bar`, `before_ms`, `build`, `inst_id`, `limit`, `serialize_string_vec`, `test_both_cursors_rejected`, `test_cursor_nanoseconds_rejected`, `test_limit_exceeds_maximum_rejected`, `test_no_literal_none_strings_leak_into_query_string`, `test_optional_parameters_are_omitted_when_none`, `test_valid_limit_passes`, `test_valid_millisecond_cursor_passes`
**Impls**: `GetCandlesticksParamsBuilder`, `Into`
**Structs**: `GetAlgoOrdersParams`, `GetCandlesticksParams`, `GetCandlesticksParamsBuilder`, `GetIndexTickerParams`, `GetInstrumentsParams`, `GetMarkPriceParams`, `GetOrderHistoryParams`, `GetOrderListParams`, `GetOrderParams`, `GetPositionTiersParams`, `GetPositionsHistoryParams`, `GetPositionsParams`, `GetTradeFeeParams`, `GetTradesParams`, `GetTransactionDetailsParams`, `SetPositionModeParams`, `corresponds`
...
---
*Generated on 2025-11-18T21:55:00.420289Z*
