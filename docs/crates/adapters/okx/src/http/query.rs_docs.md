# Documentation: `crates/adapters/okx/src/http/query.rs`
**Generated:** 2025-11-15T19:40:01.297393Z
**File Size:** 24830 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/adapters/okx/src/http/query.rs` within the repository.

**Classes defined:** corresponds, SetPositionModeParams, GetPositionTiersParams, GetInstrumentsParams, GetTradesParams, GetCandlesticksParams, GetCandlesticksParamsBuilder, GetMarkPriceParams, GetIndexTickerParams, GetOrderHistoryParams and 10 more

**Functions defined:** serialize_string_vec, inst_id, bar, after_ms, before_ms, limit, build, test_optional_parameters_are_omitted_when_none, test_no_literal_none_strings_leak_into_query_string, test_cursor_nanoseconds_rejected and 4 more
...
#### `serialize_string_vec(values: &Option<Vec<String>>, serializer: S)`


#### `inst_id(&mut self, inst_id: impl Into<String>)`


#### `bar(&mut self, bar: impl Into<String>)`


#### `after_ms(&mut self, after_ms: i64)`


#### `before_ms(&mut self, before_ms: i64)`


#### `limit(&mut self, limit: u32)`


#### `build(&mut self)`


#### `test_optional_parameters_are_omitted_when_none()`


#### `test_no_literal_none_strings_leak_into_query_string()`


#### `test_cursor_nanoseconds_rejected()`


#### `test_both_cursors_rejected()`


#### `test_limit_exceeds_maximum_rejected()`


#### `test_valid_millisecond_cursor_passes(#[case] timestamp: i64, #[case] expected: &str)`


#### `test_valid_limit_passes(#[case] limit: u32, #[case] expected: &str)`
...
**Directory:** `crates/adapters/okx/src/http`
