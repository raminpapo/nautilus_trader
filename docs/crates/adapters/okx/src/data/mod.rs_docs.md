...
This file is part of the NautilusTrader repository. It defines 53 function(s) and 1 class(es).
...
- **`vip_level()`**: Function defined in this file
- **`public_ws()`**: Function defined in this file
- **`public_ws_mut()`**: Function defined in this file
- **`business_ws()`**: Function defined in this file
- **`business_ws_mut()`**: Function defined in this file
- **`send_data()`**: Function defined in this file
- **`spawn_ws()`**: Function defined in this file
- **`bootstrap_instruments()`**: Function defined in this file
- **`contract_filter()`**: Function defined in this file
- **`handle_ws_message()`**: Function defined in this file
- **`spawn_public_stream()`**: Function defined in this file
- **`spawn_business_stream()`**: Function defined in this file
- **`spawn_stream_task()`**: Function defined in this file
- **`maybe_spawn_instrument_refresh()`**: Function defined in this file
- **`emit_funding_rates()`**: Function defined in this file
- **`upsert_instrument()`**: Function defined in this file
- **`datetime_to_unix_nanos()`**: Function defined in this file
- **`contract_filter_with_config()`**: Function defined in this file

*...and 33 more functions*

### Classes
- **`OKXDataClient`**: Class defined in this file
...
**Functions**: `bootstrap_instruments`, `business_ws`, `business_ws_mut`, `client_id`, `connect`, `contract_filter`, `contract_filter_with_config`, `contract_filter_with_config_types`, `datetime_to_unix_nanos`, `disconnect`, `dispose`, `emit_funding_rates`, `handle_ws_message`, `is_connected`, `is_disconnected`, `maybe_spawn_instrument_refresh`, `new`, `public_ws`, `public_ws_mut`, `request_bars`, `request_instrument`, `request_instruments`, `request_trades`, `reset`, `send_data`, `spawn_business_stream`, `spawn_public_stream`, `spawn_stream_task`, `spawn_ws`, `start` *(+22 more)*
**Impls**: `DataClient`, `OKXDataClient`, `futures_util`
**Structs**: `OKXDataClient`

## Related Files

This file is located in `crates/adapters/okx/src/data/`. Related files may include:
...
---
*Generated on 2025-11-18T21:55:00.366164Z*
