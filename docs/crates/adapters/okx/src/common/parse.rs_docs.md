...
- **Path**: `crates/adapters/okx/src/common/parse.rs`
- **Size**: 172,040 bytes
- **Lines**: 4,632
- **Language**: Rust
...
This file is part of the NautilusTrader repository. It defines 144 function(s) and 8 class(es).

## Detailed Walkthrough

### Functions
- **`is_market_price()`**: Function defined in this file
- **`determine_order_type()`**: Function defined in this file
- **`deserialize_empty_string_as_none()`**: Function defined in this file
- **`deserialize_empty_ustr_as_none()`**: Function defined in this file
- **`deserialize_target_currency_as_none()`**: Function defined in this file
- **`deserialize_string_to_u64()`**: Function defined in this file
- **`deserialize_optional_string_to_u64()`**: Function defined in this file
- **`deserialize_vip_level()`**: Function defined in this file
- **`get_currency_with_context()`**: Function defined in this file
- **`okx_instrument_type()`**: Function defined in this file
- **`okx_instrument_type_from_symbol()`**: Function defined in this file
- **`parse_base_quote_from_symbol()`**: Function defined in this file
- **`parse_instrument_id()`**: Function defined in this file
- **`parse_client_order_id()`**: Function defined in this file
...
- **`parse_fee()`**: Function defined in this file
- **`parse_fee_currency()`**: Function defined in this file

*...and 124 more functions*

### Classes
- **`CommonInstrumentData`**: Class defined in this file
- **`MarginAndFees`**: Class defined in this file
- **`SpotInstrumentParser`**: Class defined in this file
- **`TestStruct`**: Class defined in this file
- **`TestStruct`**: Class defined in this file
- **`TestFeeRate`**: Class defined in this file
- **`TestFeeRate`**: Class defined in this file
- **`TestFeeRate`**: Class defined in this file
...
Total unique keywords extracted: 151


**Enums**: `variants`
**Functions**: `bar_spec_as_okx_channel`, `bar_spec_as_okx_mark_price_channel`, `bar_spec_as_okx_timeframe`, `deserialize_empty_string_as_none`, `deserialize_empty_ustr_as_none`, `deserialize_optional_string_to_u64`, `deserialize_string_to_u64`, `deserialize_target_currency_as_none`, `deserialize_vip_level`, `determine_order_type`, `get_currency_with_context`, `is_market_price`, `okx_bar_type_from_timeframe`, `okx_channel_to_bar_spec`, `okx_instrument_type`, `okx_instrument_type_from_symbol`, `okx_timeframe_as_bar_spec`, `parse_account_state`, `parse_aggressor_side`, `parse_balance_field`, `parse_base_quote_from_symbol`, `parse_candlestick`, `parse_client_order_id`, `parse_common_instrument_data`, `parse_execution_type`, `parse_fee`, `parse_fee_currency`, `parse_fill_report`, `parse_funding_rate_msg`, `parse_futures_instrument` *(+113 more)*
**Impls**: `FnOnce`, `InstrumentParser`
**Structs**: `CommonInstrumentData`, `MarginAndFees`, `SpotInstrumentParser`, `TestFeeRate`, `TestStruct`
**Traits**: `InstrumentParser`
...
---
*Generated on 2025-11-18T21:55:00.350114Z*
