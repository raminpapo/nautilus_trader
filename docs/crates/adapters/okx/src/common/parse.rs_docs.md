# Documentation: `crates/adapters/okx/src/common/parse.rs`
**Generated:** 2025-11-15T19:40:01.249500Z
**File Size:** 164300 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/adapters/okx/src/common/parse.rs` within the repository.

**Classes defined:** CommonInstrumentData, MarginAndFees, SpotInstrumentParser, TestStruct, TestStruct, TestFeeRate, TestFeeRate, TestFeeRate, FnOnce, InstrumentParser

**Functions defined:** deserialize_empty_string_as_none, deserialize_empty_ustr_as_none, deserialize_target_currency_as_none, deserialize_string_to_u64, deserialize_optional_string_to_u64, deserialize_vip_level, get_currency_with_context, okx_instrument_type, okx_instrument_type_from_symbol, parse_base_quote_from_symbol and 120 more
...
#### `deserialize_empty_string_as_none(deserializer: D)`


#### `deserialize_empty_ustr_as_none(deserializer: D)`
...
#### `deserialize_string_to_u64(deserializer: D)`


#### `deserialize_optional_string_to_u64(deserializer: D)`


#### `deserialize_vip_level(deserializer: D)`


#### `get_currency_with_context(code: &str, context: Option<&str>)`


#### `okx_instrument_type(instrument: &InstrumentAny)`


#### `okx_instrument_type_from_symbol(symbol: &str)`


#### `parse_base_quote_from_symbol(symbol: &str)`


#### `parse_instrument_id(symbol: Ustr)`


#### `parse_client_order_id(value: &str)`


#### `parse_millisecond_timestamp(timestamp_ms: u64)`


#### `parse_rfc3339_timestamp(timestamp: &str)`


#### `parse_price(value: &str, precision: u8)`


#### `parse_quantity(value: &str, precision: u8)`


#### `parse_fee(value: Option<&str>, currency: Currency)`
...
#### `parse_aggressor_side(side: &Option<OKXSide>)`


#### `parse_execution_type(liquidity: &Option<OKXExecType>)`


#### `parse_position_side(current_qty: Option<i64>)`
...
#### `bar_spec_as_okx_channel(bar_spec: BarSpecification)`
...
#### `bar_spec_as_okx_timeframe(bar_spec: BarSpecification)`


#### `okx_timeframe_as_bar_spec(timeframe: &str)`
...
#### `okx_channel_to_bar_spec(channel: &OKXWsChannel)`
...
#### `parse_multiplier_product(definition: &OKXInstrument)`


#### `parse_specific_fields(
        &self,
        definition: &OKXInstrument,
        common: CommonInstrumentData,
        margin_fees: MarginAndFees,
...
#### `validate_underlying(inst_id: Ustr, uly: Ustr)`
