...
- **Path**: `crates/adapters/okx/src/common/credential.rs`
- **Size**: 7,936 bytes
- **Lines**: 225
- **Language**: Rust
...
- **`test_simple_get()`**: Function defined in this file
- **`test_get_with_query_params()`**: Function defined in this file
- **`test_post_with_json_body()`**: Function defined in this file
- **`test_post_algo_order()`**: Function defined in this file
- **`test_debug_redacts_secret()`**: Function defined in this file
...
**Functions**: `fmt`, `new`, `sign`, `sign_bytes`, `test_debug_redacts_secret`, `test_get_with_query_params`, `test_post_algo_order`, `test_post_with_json_body`, `test_simple_get`
**Impls**: `Credential`, `Debug`
**Structs**: `Credential`
...
---
*Generated on 2025-11-18T21:55:00.302601Z*
