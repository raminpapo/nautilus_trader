# Documentation: `crates/adapters/okx/src/common/credential.rs`
**Generated:** 2025-11-15T19:40:01.219912Z
...
This file is located at `crates/adapters/okx/src/common/credential.rs` within the repository.

**Classes defined:** Credential, Debug, Credential

**Functions defined:** fmt, new, sign, sign_bytes, test_simple_get, test_get_with_query_params, test_post_with_json_body, test_post_algo_order, test_debug_redacts_secret
...
#### `new(api_key: String, api_secret: String, api_passphrase: String)`


#### `sign(&self, timestamp: &str, method: &str, endpoint: &str, body: &str)`
