# Documentation: `crates/adapters/okx/src/common/consts.rs`
**Generated:** 2025-11-15T19:40:01.217901Z
...
- **Path:** `crates/adapters/okx/src/common/consts.rs`
- **Size:** 5,399 bytes
- **Lines:** 127
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/adapters/okx/src/common/consts.rs` within the repository.

**Functions defined:** should_retry_error_code
...
#### `should_retry_error_code(error_code: &str)`
