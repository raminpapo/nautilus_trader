# Documentation: `crates/adapters/okx/src/common/enums.rs`
**Generated:** 2025-11-15T19:40:01.223251Z
**File Size:** 23069 bytes
**Extension:** .rs
**Type:** text
...
- **Path:** `crates/adapters/okx/src/common/enums.rs`
- **Size:** 23,069 bytes
- **Lines:** 1,053
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/adapters/okx/src/common/enums.rs` within the repository.

**Classes defined:** From, From, From, From, From, From, From, From, From, From and 4 more

**Functions defined:** from, from, from, from, from, from, from, from, from, from and 6 more
...
#### `from(value: OrderStatus)`


#### `from(value: LiquiditySide)`


#### `from(option_type: OKXOptionType)`


#### `from(value: TriggerType)`
...
#### `from(exec: OKXExecType)`


#### `from(side: OKXPositionSide)`


#### `from(status: OKXOrderStatus)`


#### `from(ord_type: OKXOrderType)`


#### `from(value: OrderType)`


#### `from(value: PositionSide)`


#### `is_conditional_order(order_type: OrderType)`


#### `conditional_order_to_algo_type(order_type: OrderType)`
