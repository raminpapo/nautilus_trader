...
- **`conditional_order_to_algo_type()`**: Function defined in this file
...
**Enums**: `OKXAccountMode`, `OKXAlgoOrderStatus`, `OKXAlgoOrderType`, `OKXBarSize`, `OKXBookAction`, `OKXBookChannel`, `OKXCandleConfirm`, `OKXContractType`, `OKXExecType`, `OKXInstrumentStatus`, `OKXInstrumentType`, `OKXMarginMode`, `OKXOptionType`, `OKXOrderCategory`, `OKXOrderStatus`, `OKXOrderType`, `OKXPositionMode`, `OKXPositionSide`, `OKXSelfTradePreventionMode`, `OKXSide`, `OKXTakeProfitKind`, `OKXTargetCurrency`, `OKXTradeMode`, `OKXTransactionType`, `OKXTriggerType`, `OKXVipLevel`
**Functions**: `conditional_order_to_algo_type`, `from`, `is_conditional_order`
**Impls**: `From`
...
---
*Generated on 2025-11-18T21:55:00.307413Z*
