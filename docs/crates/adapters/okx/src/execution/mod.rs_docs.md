# Documentation: `crates/adapters/okx/src/execution/mod.rs`
**Generated:** 2025-11-15T19:40:01.269529Z
**File Size:** 33783 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/adapters/okx/src/execution/mod.rs` within the repository.

**Classes defined:** OKXExecutionClient, OKXExecutionClient, ExecutionClient, LiveExecutionClient, LiveExecutionClientExt, OKXExecutionClient

**Functions defined:** new, derive_trade_mode, instrument_types, ensure_instruments_initialized_async, ensure_instruments_initialized, refresh_account_state, update_account_state, is_conditional_order, submit_regular_order, submit_conditional_order and 40 more
...
#### `new(core: ExecutionClientCore, config: OKXExecClientConfig)`


#### `derive_trade_mode(account_type: AccountType, config: &OKXExecClientConfig)`


#### `instrument_types(&self)`


#### `ensure_instruments_initialized_async(&mut self)`


#### `ensure_instruments_initialized(&mut self)`


#### `refresh_account_state(&self)`


#### `update_account_state(&self)`


#### `is_conditional_order(&self, order_type: OrderType)`


#### `submit_regular_order(
        &self,
        cmd: &nautilus_common::messages::execution::SubmitOrder,
    )`
...
#### `mass_cancel_instrument(&self, instrument_id: InstrumentId)`


#### `spawn_task(&self, description: &'static str, fut: F)`


#### `abort_pending_tasks(&self)`
...
#### `start_ws_stream(&mut self)`


#### `start_ws_business_stream(&mut self)`


#### `dispatch_ws_message(message: NautilusWsMessage)`


#### `dispatch_account_state(state: AccountState)`


#### `dispatch_position_status_report(report: PositionStatusReport)`


#### `dispatch_execution_report(report: ExecutionReport)`


#### `dispatch_order_event(event: OrderEventAny)`


#### `nanos_to_datetime(value: Option<UnixNanos>)`


#### `test_batch_cancel_orders_builds_payload()`


#### `test_batch_cancel_orders_with_empty_cancels()`
...
**Directory:** `crates/adapters/okx/src/execution`
