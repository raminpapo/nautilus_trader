...
- **Path**: `crates/adapters/okx/src/execution/mod.rs`
- **Size**: 33,811 bytes
- **Lines**: 1,049
- **Language**: Rust
...
This file is part of the NautilusTrader repository. It defines 50 function(s) and 1 class(es).

## Detailed Walkthrough

### Functions
- **`new()`**: Function defined in this file
- **`derive_trade_mode()`**: Function defined in this file
- **`instrument_types()`**: Function defined in this file
- **`ensure_instruments_initialized_async()`**: Function defined in this file
- **`ensure_instruments_initialized()`**: Function defined in this file
- **`refresh_account_state()`**: Function defined in this file
- **`update_account_state()`**: Function defined in this file
- **`is_conditional_order()`**: Function defined in this file
- **`submit_regular_order()`**: Function defined in this file
- **`submit_conditional_order()`**: Function defined in this file
- **`cancel_ws_order()`**: Function defined in this file
- **`mass_cancel_instrument()`**: Function defined in this file
- **`spawn_task()`**: Function defined in this file
- **`abort_pending_tasks()`**: Function defined in this file
...
### Classes
- **`OKXExecutionClient`**: Class defined in this file
...
**Functions**: `abort_pending_tasks`, `account_id`, `batch_cancel_orders`, `cancel_all_orders`, `cancel_order`, `cancel_ws_order`, `client_id`, `connect`, `derive_trade_mode`, `disconnect`, `dispatch_account_state`, `dispatch_execution_report`, `dispatch_order_event`, `dispatch_position_status_report`, `dispatch_ws_message`, `ensure_instruments_initialized`, `ensure_instruments_initialized_async`, `generate_account_state`, `generate_fill_reports`, `generate_mass_status`, `generate_order_status_report`, `generate_order_status_reports`, `generate_position_status_reports`, `get_account`, `get_clock`, `get_message_channel`, `instrument_types`, `is_conditional_order`, `is_connected`, `mass_cancel_instrument` *(+20 more)*
**Impls**: `ExecutionClient`, `LiveExecutionClient`, `LiveExecutionClientExt`, `OKXExecutionClient`
**Structs**: `OKXExecutionClient`

## Related Files

This file is located in `crates/adapters/okx/src/execution/`. Related files may include:
...
---
*Generated on 2025-11-18T21:55:00.374109Z*
