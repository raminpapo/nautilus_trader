# Documentation: `crates/adapters/dydx/src/http/client.rs`
**Generated:** 2025-11-15T19:40:00.931223Z
**File Size:** 37056 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/adapters/dydx/src/http/client.rs` within the repository.

**Classes defined:** DydxResponse, DydxRawHttpClient, DydxHttpClient, Default, Debug, DydxRawHttpClient, Clone, Default, DydxHttpClient

**Functions defined:** default, fmt, cancel_all_requests, cancellation_token, new, is_testnet, base_url, send_request, send_post_request, get_markets and 32 more
...
#### `instrument_or_fetch(&self, symbol: Ustr)`
...
#### `is_cache_initialized(&self)`


#### `cached_instruments_count(&self)`
...
**Security:** This file may contain sensitive patterns: token, credential, auth. Ensure proper handling of secrets.
