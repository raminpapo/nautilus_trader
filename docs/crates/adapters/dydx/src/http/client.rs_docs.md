...
- **Path**: `crates/adapters/dydx/src/http/client.rs`
- **Size**: 42,463 bytes
- **Lines**: 1,203
- **Language**: Rust
...
This file is part of the NautilusTrader repository. It defines 49 function(s) and 3 class(es).
...
- **`send_post_request()`**: Function defined in this file
- **`get_markets()`**: Function defined in this file
- **`fetch_instruments()`**: Function defined in this file
- **`get_orderbook()`**: Function defined in this file
- **`get_trades()`**: Function defined in this file
- **`get_candles()`**: Function defined in this file
- **`get_subaccount()`**: Function defined in this file
- **`get_fills()`**: Function defined in this file
- **`get_orders()`**: Function defined in this file
- **`get_transfers()`**: Function defined in this file
- **`get_time()`**: Function defined in this file
- **`get_height()`**: Function defined in this file

*...and 29 more functions*

### Classes
- **`DydxResponse`**: Class defined in this file
- **`DydxRawHttpClient`**: Class defined in this file
...
**Functions**: `base_url`, `cache_instrument`, `cache_instruments`, `cached_instruments_count`, `cancel_all_requests`, `cancellation_token`, `clob_pair_id_mapping`, `clone`, `default`, `fetch_and_cache_instruments`, `fetch_instruments`, `fmt`, `get_candles`, `get_fills`, `get_height`, `get_instrument`, `get_instrument_by_clob_id`, `get_markets`, `get_orderbook`, `get_orders`, `get_subaccount`, `get_time`, `get_trades`, `get_transfers`, `instrument_or_fetch`, `instruments`, `is_cache_initialized`, `is_testnet`, `new`, `raw_client` *(+15 more)*
**Impls**: `Clone`, `Debug`, `Default`, `DydxHttpClient`, `DydxRawHttpClient`
**Structs**: `DydxHttpClient`, `DydxRawHttpClient`, `DydxResponse`
...
---
*Generated on 2025-11-18T21:54:59.873503Z*
