...
- **Path**: `crates/adapters/dydx/src/http/parse.rs`
- **Size**: 57,216 bytes
- **Lines**: 1,625
- **Language**: Rust
...
This file is part of the NautilusTrader repository. It defines 49 function(s).

## Detailed Walkthrough

### Functions
- **`validate_ticker_format()`**: Function defined in this file
- **`parse_ticker_currencies()`**: Function defined in this file
- **`validate_market_active()`**: Function defined in this file
- **`calculate_time_in_force()`**: Function defined in this file
- **`validate_conditional_order()`**: Function defined in this file
- **`parse_instrument_any()`**: Function defined in this file
- **`create_test_market()`**: Function defined in this file
- **`test_parse_instrument_any_valid()`**: Function defined in this file
- **`test_parse_instrument_any_inactive_market()`**: Function defined in this file
- **`test_parse_instrument_any_invalid_ticker()`**: Function defined in this file
- **`test_validate_ticker_format_valid()`**: Function defined in this file
- **`test_validate_ticker_format_invalid()`**: Function defined in this file
- **`test_parse_ticker_currencies_valid()`**: Function defined in this file
- **`test_parse_ticker_currencies_invalid()`**: Function defined in this file
- **`test_validate_market_active()`**: Function defined in this file
- **`test_validate_stop_limit_buy_valid()`**: Function defined in this file
- **`test_validate_stop_limit_buy_invalid()`**: Function defined in this file
- **`test_validate_stop_limit_sell_valid()`**: Function defined in this file
- **`test_validate_stop_limit_sell_invalid()`**: Function defined in this file
- **`test_validate_take_profit_sell_valid()`**: Function defined in this file
...
**Functions**: `calculate_time_in_force`, `create_test_instrument`, `create_test_market`, `parse_account_state`, `parse_fill_report`, `parse_instrument_any`, `parse_order_status`, `parse_order_status_report`, `parse_position_status_report`, `parse_ticker_currencies`, `test_calculate_tif_limit_gtc`, `test_calculate_tif_limit_post_only`, `test_calculate_tif_market`, `test_calculate_tif_stop_limit_gtc`, `test_calculate_tif_stop_limit_post_only`, `test_calculate_tif_stop_market_invalid_post_only`, `test_calculate_tif_stop_market_ioc`, `test_calculate_tif_trailing_stop`, `test_parse_fill_maker_rebate`, `test_parse_fill_report`, `test_parse_fill_zero_fee`, `test_parse_instrument_any_inactive_market`, `test_parse_instrument_any_invalid_ticker`, `test_parse_instrument_any_valid`, `test_parse_multiple_positions`, `test_parse_order_external_detection`, `test_parse_order_partial_fill_reconciliation`, `test_parse_order_status`, `test_parse_order_status_report_basic`, `test_parse_order_status_report_conditional` *(+19 more)*
...
---
*Generated on 2025-11-18T21:54:59.890561Z*
