# Documentation: `crates/adapters/dydx/src/http/parse.rs`
**Generated:** 2025-11-15T19:40:00.940730Z
...
This file is located at `crates/adapters/dydx/src/http/parse.rs` within the repository.

**Functions defined:** validate_ticker_format, parse_ticker_currencies, validate_market_active, parse_instrument_any, create_test_market, test_parse_instrument_any_valid, test_parse_instrument_any_inactive_market, test_parse_instrument_any_invalid_ticker, test_validate_ticker_format_valid, test_validate_ticker_format_invalid and 3 more
...
#### `validate_ticker_format(ticker: &str)`


#### `parse_ticker_currencies(ticker: &str)`


#### `validate_market_active(ticker: &str, status: &DydxMarketStatus)`
