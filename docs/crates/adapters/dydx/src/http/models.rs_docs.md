...
- **Path**: `crates/adapters/dydx/src/http/models.rs`
- **Size**: 19,629 bytes
- **Lines**: 611
- **Language**: Rust
...
This file is part of the NautilusTrader repository. 25 class(es).

## Detailed Walkthrough


### Classes
- **`MarketsResponse`**: Class defined in this file
- **`PerpetualMarket`**: Class defined in this file
- **`OrderbookResponse`**: Class defined in this file
- **`OrderbookLevel`**: Class defined in this file
- **`TradesResponse`**: Class defined in this file
- **`Trade`**: Class defined in this file
- **`CandlesResponse`**: Class defined in this file
- **`Candle`**: Class defined in this file
- **`SubaccountResponse`**: Class defined in this file
- **`Subaccount`**: Class defined in this file
- **`PerpetualPosition`**: Class defined in this file
- **`AssetPosition`**: Class defined in this file
- **`OrdersResponse`**: Class defined in this file
- **`Order`**: Class defined in this file
- **`FillsResponse`**: Class defined in this file
- **`Fill`**: Class defined in this file
- **`TransfersResponse`**: Class defined in this file
- **`Transfer`**: Class defined in this file
- **`TransferAccount`**: Class defined in this file
- **`TimeResponse`**: Class defined in this file
...
**Structs**: `AssetPosition`, `CancelOrderRequest`, `Candle`, `CandlesResponse`, `Fill`, `FillsResponse`, `HeightResponse`, `MarketsResponse`, `Order`, `OrderbookLevel`, `OrderbookResponse`, `OrdersResponse`, `PerpetualMarket`, `PerpetualPosition`, `PlaceOrderRequest`, `Subaccount`, `SubaccountId`, `SubaccountResponse`, `TimeResponse`, `Trade`, `TradesResponse`, `TransactionResponse`, `Transfer`, `TransferAccount`, `TransfersResponse`
...
---
*Generated on 2025-11-18T21:54:59.881417Z*
