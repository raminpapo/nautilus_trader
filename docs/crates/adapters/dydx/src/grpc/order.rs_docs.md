# Documentation: `crates/adapters/dydx/src/grpc/order.rs`
**Generated:** 2025-11-15T19:40:00.922123Z
**File Size:** 14632 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/adapters/dydx/src/grpc/order.rs` within the repository.

**Classes defined:** OrderMarketParams, OrderBuilder, OrderMarketParams, OrderBuilder, Default

**Functions defined:** quantize_price, quantize_quantity, quantize, clob_pair_id, new, market, limit, stop_limit, stop_market, take_profit_limit and 11 more
...
#### `quantize_price(&self, price: Decimal)`


#### `quantize_quantity(&self, quantity: Decimal)`


#### `quantize(value: &Decimal, fraction: &Decimal)`
...
#### `market(mut self, side: OrderSide, size: Decimal)`


#### `limit(mut self, side: OrderSide, price: Decimal, size: Decimal)`
...
#### `stop_market(mut self, side: OrderSide, trigger_price: Decimal, size: Decimal)`
...
#### `conditional(mut self)`


#### `price(mut self, price: Decimal)`


#### `size(mut self, size: Decimal)`


#### `time_in_force(mut self, tif: OrderTimeInForce)`


#### `reduce_only(mut self, reduce: bool)`


#### `until(mut self, gtof: OrderGoodUntil)`
