...
- **Path**: `crates/adapters/dydx/src/grpc/order.rs`
- **Size**: 24,470 bytes
- **Lines**: 721
- **Language**: Rust
...
This file is part of the NautilusTrader repository. It defines 44 function(s) and 2 class(es).

## Detailed Walkthrough

### Functions
- **`quantize_price()`**: Function defined in this file
- **`quantize_quantity()`**: Function defined in this file
- **`quantize()`**: Function defined in this file
- **`clob_pair_id()`**: Function defined in this file
- **`new()`**: Function defined in this file
- **`market()`**: Function defined in this file
- **`limit()`**: Function defined in this file
- **`stop_limit()`**: Function defined in this file
- **`stop_market()`**: Function defined in this file
- **`take_profit_limit()`**: Function defined in this file
- **`take_profit_market()`**: Function defined in this file
- **`long_term()`**: Function defined in this file
- **`short_term()`**: Function defined in this file
- **`conditional()`**: Function defined in this file
- **`price()`**: Function defined in this file
- **`size()`**: Function defined in this file
- **`time_in_force()`**: Function defined in this file
- **`reduce_only()`**: Function defined in this file
- **`until()`**: Function defined in this file
- **`build()`**: Function defined in this file

*...and 24 more functions*

### Classes
- **`OrderMarketParams`**: Class defined in this file
...
**Enums**: `OrderFlags`, `OrderGoodUntil`
**Functions**: `build`, `clob_pair_id`, `conditional`, `default`, `limit`, `long_term`, `market`, `new`, `price`, `quantize`, `quantize_price`, `quantize_quantity`, `reduce_only`, `sample_market_params`, `short_term`, `size`, `stop_limit`, `stop_market`, `take_profit_limit`, `take_profit_market`, `test_market_params_quantize_price`, `test_market_params_quantize_quantity`, `test_order_builder_clob_pair_id`, `test_order_builder_conditional_flag`, `test_order_builder_limit_buy`, `test_order_builder_limit_sell`, `test_order_builder_limit_with_reduce_only`, `test_order_builder_long_term_flag`, `test_order_builder_market_buy`, `test_order_builder_market_sell` *(+14 more)*
**Impls**: `Default`, `OrderBuilder`, `OrderMarketParams`
**Structs**: `OrderBuilder`, `OrderMarketParams`
...
---
*Generated on 2025-11-18T21:54:59.859283Z*
