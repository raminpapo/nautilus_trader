...
- **Path**: `crates/adapters/dydx/src/grpc/builder.rs`
- **Size**: 5,367 bytes
- **Lines**: 164
- **Language**: Rust
...
- **`calculate_fee()`**: Function defined in this file
- **`calculate_fee_from_gas()`**: Function defined in this file
- **`default_fee()`**: Function defined in this file
- **`build_transaction()`**: Function defined in this file
- **`build_for_simulation()`**: Function defined in this file
- **`fmt()`**: Function defined in this file

### Classes
- **`TxBuilder`**: Class defined in this file
...
**Functions**: `build_for_simulation`, `build_transaction`, `calculate_fee`, `calculate_fee_from_gas`, `default_fee`, `fmt`, `new`
**Impls**: `Debug`, `IntoIterator`, `TxBuilder`
**Structs**: `TxBuilder`
...
---
*Generated on 2025-11-18T21:54:59.849018Z*
