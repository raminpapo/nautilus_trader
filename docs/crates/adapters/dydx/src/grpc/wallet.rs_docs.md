# Documentation: `crates/adapters/dydx/src/grpc/wallet.rs`
**Generated:** 2025-11-15T19:40:00.925692Z
...
This file is located at `crates/adapters/dydx/src/grpc/wallet.rs` within the repository.

**Classes defined:** Wallet, Account, Subaccount, Debug, Wallet, Debug, Account, Subaccount

**Functions defined:** fmt, from_mnemonic, account_offline, derive_account, fmt, public_key, sign, set_account_info, increment_sequence, subaccount and 1 more
...
#### `account_offline(&self, index: u32)`


#### `derive_account(&self, index: u32, prefix: &str)`
...
#### `sign(&self, doc: tx::SignDoc)`


#### `set_account_info(&mut self, account_number: u64, sequence_number: u64)`


#### `increment_sequence(&mut self)`


#### `subaccount(&self, number: u32)`


#### `new(address: String, number: u32)`
