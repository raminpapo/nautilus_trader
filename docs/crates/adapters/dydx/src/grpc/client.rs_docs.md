...
- **Path**: `crates/adapters/dydx/src/grpc/client.rs`
- **Size**: 18,946 bytes
- **Lines**: 532
- **Language**: Rust
...
This file is part of the NautilusTrader repository. It defines 20 function(s) and 2 class(es).

## Detailed Walkthrough

### Functions
- **`new()`**: Function defined in this file
- **`new_with_fallback()`**: Function defined in this file
- **`reconnect_with_fallback()`**: Function defined in this file
- **`current_url()`**: Function defined in this file
- **`channel()`**: Function defined in this file
- **`query_address()`**: Function defined in this file
- **`get_account()`**: Function defined in this file
- **`get_account_balances()`**: Function defined in this file
- **`get_node_info()`**: Function defined in this file
- **`latest_block()`**: Function defined in this file
- **`latest_block_height()`**: Function defined in this file
- **`get_perpetuals()`**: Function defined in this file
- **`get_clob_pairs()`**: Function defined in this file
- **`get_subaccount()`**: Function defined in this file
- **`simulate_tx()`**: Function defined in this file
- **`broadcast_tx()`**: Function defined in this file
- **`get_tx()`**: Function defined in this file
- **`test_current_url_tracked()`**: Function defined in this file
- **`test_new_with_fallback_empty_urls()`**: Function defined in this file
- **`test_reconnect_with_fallback_empty_urls()`**: Function defined in this file

### Classes
- **`Height`**: Class defined in this file
- **`DydxGrpcClient`**: Class defined in this file
...
**Functions**: `broadcast_tx`, `channel`, `current_url`, `get_account`, `get_account_balances`, `get_clob_pairs`, `get_node_info`, `get_perpetuals`, `get_subaccount`, `get_tx`, `latest_block`, `latest_block_height`, `new`, `new_with_fallback`, `query_address`, `reconnect_with_fallback`, `simulate_tx`, `test_current_url_tracked`, `test_new_with_fallback_empty_urls`, `test_reconnect_with_fallback_empty_urls`
**Impls**: `AsRef`, `DydxGrpcClient`
**Structs**: `DydxGrpcClient`, `Height`
...
---
*Generated on 2025-11-18T21:54:59.852896Z*
