# Documentation: `crates/adapters/dydx/src/grpc/client.rs`
**Generated:** 2025-11-15T19:40:00.918018Z
**File Size:** 18946 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/adapters/dydx/src/grpc/client.rs` within the repository.

**Classes defined:** Height, DydxGrpcClient, DydxGrpcClient, AsRef, AsRef

**Functions defined:** new, new_with_fallback, reconnect_with_fallback, current_url, channel, query_address, get_account, get_account_balances, get_node_info, latest_block and 10 more
...
#### `new_with_fallback(grpc_urls: &[impl AsRef<str>])`
...
#### `query_address(&mut self, address: &str)`


#### `get_account(&mut self, address: &str)`
...
#### `get_node_info(&mut self)`


#### `latest_block(&mut self)`


#### `latest_block_height(&mut self)`


#### `get_perpetuals(&mut self)`


#### `get_clob_pairs(&mut self)`
...
#### `simulate_tx(&mut self, tx_bytes: Vec<u8>)`


#### `broadcast_tx(&mut self, tx_bytes: Vec<u8>)`


#### `get_tx(&mut self, hash: &str)`
