...
- **Path**: `crates/adapters/dydx/src/python/websocket.rs`
- **Size**: 15,219 bytes
- **Lines**: 429
- **Language**: Rust
...
### Functions
- **`to_pyvalue_err_dydx()`**: Function defined in this file
- **`py_new_public()`**: Function defined in this file
- **`py_new_private()`**: Function defined in this file
- **`py_is_connected()`**: Function defined in this file
...
- **`py_disconnect()`**: Function defined in this file
...
- **`py_subscribe_orderbook()`**: Function defined in this file
- **`py_unsubscribe_orderbook()`**: Function defined in this file
- **`py_subscribe_bars()`**: Function defined in this file
- **`py_unsubscribe_bars()`**: Function defined in this file
- **`py_subscribe_markets()`**: Function defined in this file
...
**Functions**: `py_account_id`, `py_cache_instrument`, `py_cache_instruments`, `py_connect`, `py_disconnect`, `py_is_closed`, `py_is_connected`, `py_new_private`, `py_new_public`, `py_set_account_id`, `py_subscribe_bars`, `py_subscribe_block_height`, `py_subscribe_markets`, `py_subscribe_orderbook`, `py_subscribe_subaccount`, `py_subscribe_trades`, `py_unsubscribe_bars`, `py_unsubscribe_block_height`, `py_unsubscribe_markets`, `py_unsubscribe_orderbook`, `py_unsubscribe_subaccount`, `py_unsubscribe_trades`, `py_url`, `py_wait_until_active`, `to_pyvalue_err_dydx`
**Impls**: `DydxWebSocketClient`
...
---
*Generated on 2025-11-18T21:54:59.905319Z*
