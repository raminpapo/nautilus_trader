# Documentation: `crates/adapters/dydx/src/python/websocket.rs`
**Generated:** 2025-11-15T19:40:00.953054Z
**File Size:** 15219 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/adapters/dydx/src/python/websocket.rs` within the repository.

**Classes defined:** DydxWebSocketClient

**Functions defined:** to_pyvalue_err_dydx, py_new_public, py_new_private, py_is_connected, py_set_account_id, py_account_id, py_url, py_connect, py_disconnect, py_wait_until_active and 15 more
...
#### `to_pyvalue_err_dydx(e: DydxWsError)`


#### `py_new_public(url: String, heartbeat: Option<u64>)`
...
#### `py_disconnect(&mut self, py: Python<'py>)`
...
#### `py_cache_instrument(&self, instrument: Py<PyAny>, py: Python<'_>)`


#### `py_cache_instruments(&self, instruments: Vec<Py<PyAny>>, py: Python<'_>)`
...
#### `py_subscribe_markets(&self, py: Python<'py>)`


#### `py_unsubscribe_markets(&self, py: Python<'py>)`
...
#### `py_subscribe_block_height(&self, py: Python<'py>)`


#### `py_unsubscribe_block_height(&self, py: Python<'py>)`
