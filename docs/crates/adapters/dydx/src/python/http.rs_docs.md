# Documentation: `crates/adapters/dydx/src/python/http.rs`
**Generated:** 2025-11-15T19:40:00.948832Z
...
- **Path:** `crates/adapters/dydx/src/python/http.rs`
- **Size:** 4,494 bytes
- **Lines:** 135
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/adapters/dydx/src/python/http.rs` within the repository.

**Classes defined:** DydxHttpClient

**Functions defined:** py_new, py_is_testnet, py_base_url, py_request_instruments, py_get_instrument, py_instrument_count, py_instrument_symbols, __repr__
...
#### `py_new(base_url: Option<String>, is_testnet: bool)`
...
#### `py_get_instrument(&self, py: Python<'_>, symbol: &str)`


#### `py_instrument_count(&self)`


#### `py_instrument_symbols(&self)`
