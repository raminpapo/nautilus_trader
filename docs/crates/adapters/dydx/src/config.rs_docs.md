...
- **Path**: `crates/adapters/dydx/src/config.rs`
- **Size**: 7,484 bytes
- **Lines**: 203
- **Language**: Rust
...
### Functions
- **`default_max_retries()`**: Function defined in this file
- **`default_retry_delay_initial_ms()`**: Function defined in this file
- **`default_retry_delay_max_ms()`**: Function defined in this file
- **`get_grpc_urls()`**: Function defined in this file
- **`default()`**: Function defined in this file
- **`default()`**: Function defined in this file
- **`default()`**: Function defined in this file

### Classes
- **`DydxAdapterConfig`**: Class defined in this file
...
**Functions**: `default`, `default_max_retries`, `default_retry_delay_initial_ms`, `default_retry_delay_max_ms`, `get_grpc_urls`
**Impls**: `Default`, `DydxAdapterConfig`
**Structs**: `DYDXExecClientConfig`, `DydxAdapterConfig`, `DydxDataClientConfig`
...
---
*Generated on 2025-11-18T21:54:59.792489Z*
