# Documentation: `crates/adapters/dydx/src/common/credential.rs`
**Generated:** 2025-11-15T19:40:00.898644Z
**File Size:** 9743 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/adapters/dydx/src/common/credential.rs` within the repository.

**Classes defined:** DydxCredential, name, Drop, Debug, DydxCredential

**Functions defined:** drop, fmt, from_mnemonic, from_private_key, account_id, sign, sign_bytes, public_key, test_from_mnemonic, test_from_mnemonic_with_authenticators and 4 more
...
#### `sign(&self, sign_doc: &SignDoc)`


#### `sign_bytes(&self, message: &[u8])`
