...
- **Path**: `crates/adapters/dydx/src/common/credential.rs`
- **Size**: 9,308 bytes
- **Lines**: 264
- **Language**: Rust
...
- **`sign_bytes()`**: Function defined in this file
- **`public_key()`**: Function defined in this file
- **`test_from_mnemonic()`**: Function defined in this file
- **`test_from_mnemonic_with_authenticators()`**: Function defined in this file
- **`test_from_private_key()`**: Function defined in this file
- **`test_account_id()`**: Function defined in this file
- **`test_sign_bytes()`**: Function defined in this file
- **`test_debug_redacts_key()`**: Function defined in this file

### Classes
- **`DydxCredential`**: Class defined in this file
...
**Functions**: `account_id`, `drop`, `fmt`, `from_mnemonic`, `from_private_key`, `public_key`, `sign`, `sign_bytes`, `test_account_id`, `test_debug_redacts_key`, `test_from_mnemonic`, `test_from_mnemonic_with_authenticators`, `test_from_private_key`, `test_sign_bytes`
**Impls**: `Debug`, `Drop`, `DydxCredential`
**Structs**: `DydxCredential`, `name`
...
---
*Generated on 2025-11-18T21:54:59.777158Z*
