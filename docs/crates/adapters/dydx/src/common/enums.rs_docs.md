...
- **Path**: `crates/adapters/dydx/src/common/enums.rs`
- **Size**: 18,714 bytes
- **Lines**: 724
- **Language**: Rust
...
- **`try_from_order_side()`**: Function defined in this file
- **`from()`**: Function defined in this file
- **`try_from()`**: Function defined in this file
- **`try_from_order_type()`**: Function defined in this file
- **`is_conditional()`**: Function defined in this file
- **`condition_type()`**: Function defined in this file
- **`is_market_execution()`**: Function defined in this file
- **`from()`**: Function defined in this file
- **`from()`**: Function defined in this file
- **`from()`**: Function defined in this file
- **`from()`**: Function defined in this file
- **`test_order_status_conversion()`**: Function defined in this file
- **`test_liquidity_conversion()`**: Function defined in this file
- **`test_order_type_is_conditional()`**: Function defined in this file
- **`test_condition_type_mapping()`**: Function defined in this file
- **`test_is_market_execution()`**: Function defined in this file
- **`test_order_type_to_nautilus()`**: Function defined in this file
- **`test_order_side_conversion_from_nautilus()`**: Function defined in this file
...
**Enums**: `DydxCandleResolution`, `DydxConditionType`, `DydxFillType`, `DydxLiquidity`, `DydxMarketStatus`, `DydxOrderExecution`, `DydxOrderFlags`, `DydxOrderSide`, `DydxOrderStatus`, `DydxOrderType`, `DydxPositionStatus`, `DydxTickerType`, `DydxTimeInForce`, `DydxTradeType`
**Functions**: `condition_type`, `from`, `is_conditional`, `is_market_execution`, `test_condition_type_mapping`, `test_is_market_execution`, `test_liquidity_conversion`, `test_order_side_conversion_from_nautilus`, `test_order_side_conversion_to_nautilus`, `test_order_status_conversion`, `test_order_type_conversion_from_nautilus`, `test_order_type_conversion_to_nautilus`, `test_order_type_is_conditional`, `test_order_type_to_nautilus`, `try_from`, `try_from_order_side`, `try_from_order_type`
**Impls**: `DydxOrderSide`, `DydxOrderType`, `From`, `TryFrom`
...
---
*Generated on 2025-11-18T21:54:59.782680Z*
