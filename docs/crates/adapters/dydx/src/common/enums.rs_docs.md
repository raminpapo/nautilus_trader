# Documentation: `crates/adapters/dydx/src/common/enums.rs`
**Generated:** 2025-11-15T19:40:00.900688Z
...
This file is located at `crates/adapters/dydx/src/common/enums.rs` within the repository.

**Classes defined:** From, From, From, From

**Functions defined:** from, from, from, from, test_order_status_conversion, test_liquidity_conversion
...
#### `from(value: DydxOrderStatus)`


#### `from(value: DydxPositionStatus)`


#### `from(value: DydxLiquidity)`
