# Documentation: `crates/adapters/dydx/src/common/urls.rs`
**Generated:** 2025-11-15T19:40:00.907459Z
...
- **Path:** `crates/adapters/dydx/src/common/urls.rs`
- **Size:** 2,274 bytes
- **Lines:** 66
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/adapters/dydx/src/common/urls.rs` within the repository.

**Functions defined:** http_base_url, ws_url, grpc_urls, grpc_url
...
#### `http_base_url(is_testnet: bool)`


#### `ws_url(is_testnet: bool)`


#### `grpc_urls(is_testnet: bool)`


#### `grpc_url(is_testnet: bool)`
