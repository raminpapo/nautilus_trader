...
- **Path**: `crates/adapters/dydx/src/common/consts.rs`
- **Size**: 5,712 bytes
- **Lines**: 156
- **Language**: Rust
...
### Functions
- **`should_retry_error_code()`**: Function defined in this file
- **`test_should_retry_429()`**: Function defined in this file
- **`test_should_retry_server_errors()`**: Function defined in this file
- **`test_should_not_retry_client_errors()`**: Function defined in this file
- **`test_should_not_retry_success()`**: Function defined in this file
...
**Functions**: `should_retry_error_code`, `test_should_not_retry_client_errors`, `test_should_not_retry_success`, `test_should_retry_429`, `test_should_retry_server_errors`
...
---
*Generated on 2025-11-18T21:54:59.774570Z*
