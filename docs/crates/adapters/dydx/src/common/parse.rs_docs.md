# Documentation: `crates/adapters/dydx/src/common/parse.rs`
**Generated:** 2025-11-15T19:40:00.904984Z
**File Size:** 5267 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/adapters/dydx/src/common/parse.rs` within the repository.

**Functions defined:** get_currency_with_context, get_currency, parse_price, parse_quantity, parse_decimal, test_get_currency, test_parse_instrument_id, test_parse_price, test_parse_quantity, test_parse_decimal
...
#### `parse_price(value: &str, field_name: &str)`


#### `parse_quantity(value: &str, field_name: &str)`


#### `parse_decimal(value: &str, field_name: &str)`
