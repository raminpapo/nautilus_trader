...
- **Path**: `crates/adapters/dydx/src/schemas/ws.rs`
- **Size**: 10,215 bytes
- **Lines**: 329
- **Language**: Rust
...
This file is part of the NautilusTrader repository. 18 class(es).
...
- **`DydxBlockHeightSubscribedContents`**: Class defined in this file
- **`DydxWsBlockHeightSubscribedData`**: Class defined in this file
- **`DydxBlockHeightChannelContents`**: Class defined in this file
- **`DydxWsBlockHeightChannelData`**: Class defined in this file
- **`DydxOraclePriceMarket`**: Class defined in this file
- **`DydxMarketMessageContents`**: Class defined in this file
- **`DydxWsMarketChannelData`**: Class defined in this file
- **`DydxWsMarketSubscribedData`**: Class defined in this file
- **`DydxAssetBalance`**: Class defined in this file
- **`DydxPerpetualPosition`**: Class defined in this file
- **`DydxWsOrderSubaccountMessageContents`**: Class defined in this file
...
- **`DydxSubaccountInfo`**: Class defined in this file
- **`DydxWsSubaccountsSubscribed`**: Class defined in this file
- **`DydxWsSubaccountsChannelContents`**: Class defined in this file
- **`DydxWsSubaccountsChannelData`**: Class defined in this file
...
**Enums**: `DydxWsMessageType`
**Structs**: `DydxAssetBalance`, `DydxBlockHeightChannelContents`, `DydxBlockHeightSubscribedContents`, `DydxMarketMessageContents`, `DydxOraclePriceMarket`, `DydxPerpetualPosition`, `DydxSubaccountInfo`, `DydxWsBlockHeightChannelData`, `DydxWsBlockHeightSubscribedData`, `DydxWsFillSubaccountMessageContents`, `DydxWsMarketChannelData`, `DydxWsMarketSubscribedData`, `DydxWsMessageGeneral`, `DydxWsOrderSubaccountMessageContents`, `DydxWsSubaccountsChannelContents`, `DydxWsSubaccountsChannelData`, `DydxWsSubaccountsSubscribed`, `DydxWsSubaccountsSubscribedContents`

## Related Files

This file is located in `crates/adapters/dydx/src/schemas/`. Related files may include:
...
---
*Generated on 2025-11-18T21:54:59.909165Z*
