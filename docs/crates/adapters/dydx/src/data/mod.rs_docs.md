# Documentation: `crates/adapters/dydx/src/data/mod.rs`
**Generated:** 2025-11-15T19:40:00.911411Z
**File Size:** 14196 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/adapters/dydx/src/data/mod.rs` within the repository.

**Classes defined:** DydxDataClient, DydxDataClient, DataClient, DydxDataClient

**Functions defined:** new, venue, is_connected, bootstrap_instruments, client_id, venue, start, stop, reset, dispose and 10 more
...
#### `start_instrument_refresh_task(&mut self, interval: Duration)`


#### `get_instrument(&self, symbol: &str)`
...
**Directory:** `crates/adapters/dydx/src/data`
