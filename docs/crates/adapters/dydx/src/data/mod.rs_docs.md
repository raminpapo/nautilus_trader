...
- **Path**: `crates/adapters/dydx/src/data/mod.rs`
- **Size**: 274,284 bytes
- **Lines**: 7,566
- **Language**: Rust
...
This file is part of the NautilusTrader repository. It defines 157 function(s) and 12 class(es).

## Detailed Walkthrough

### Functions
- **`map_bar_spec_to_resolution()`**: Function defined in this file
- **`new()`**: Function defined in this file
- **`venue()`**: Function defined in this file
- **`ws_client()`**: Function defined in this file
- **`ws_client_mut()`**: Function defined in this file
- **`is_connected()`**: Function defined in this file
- **`spawn_ws()`**: Function defined in this file
- **`bootstrap_instruments()`**: Function defined in this file
...
- **`unsubscribe_instruments()`**: Function defined in this file
- **`unsubscribe_instrument()`**: Function defined in this file

*...and 137 more functions*

### Classes
- **`WsMessageContext`**: Class defined in this file
- **`DydxDataClient`**: Class defined in this file
- **`OrderbookTestState`**: Class defined in this file
- **`TradesTestState`**: Class defined in this file
- **`CandlesTestState`**: Class defined in this file
- **`MalformedState`**: Class defined in this file
- **`MissingFieldsState`**: Class defined in this file
- **`InvalidTypesState`**: Class defined in this file
- **`UnexpectedState`**: Class defined in this file
- **`EmptyMarketsState`**: Class defined in this file
- **`NullValuesState`**: Class defined in this file
- **`VenueTestState`**: Class defined in this file


## Keywords and Identifiers

Total unique keywords extracted: 170


**Enums**: `let`
**Functions**: `bootstrap_instruments`, `candle_to_bar`, `client_id`, `connect`, `create_test_instrument_any`, `datetime_to_unix_nanos`, `disconnect`, `dispose`, `empty_markets_handler`, `ensure_order_book`, `get_instrument`, `get_instruments`, `handle_candles`, `handle_data_message`, `handle_deltas_message`, `handle_oracle_prices`, `handle_orderbook`, `handle_trades`, `handle_ws_message`, `invalid_types_handler`, `is_connected`, `is_disconnected`, `malformed_markets_handler`, `map_bar_spec_to_resolution`, `missing_fields_handler`, `new`, `null_values_handler`, `parse_orderbook_snapshot`, `request_bars`, `request_instrument` *(+125 more)*
**Impls**: `DataClient`, `DydxDataClient`
**Structs**: `CandlesTestState`, `DydxDataClient`, `EmptyMarketsState`, `InvalidTypesState`, `MalformedState`, `MissingFieldsState`, `NullValuesState`, `OrderbookTestState`, `TradesTestState`, `UnexpectedState`, `VenueTestState`, `WsMessageContext`
**Traits**: `for`

## Related Files

This file is located in `crates/adapters/dydx/src/data/`. Related files may include:
...
---
*Generated on 2025-11-18T21:54:59.823299Z*
