...
### Functions
- **`is_error()`**: Function defined in this file
- **`is_subscribed()`**: Function defined in this file
- **`is_unsubscribed()`**: Function defined in this file
- **`is_connected()`**: Function defined in this file
- **`is_channel_data()`**: Function defined in this file
- **`is_channel_batch_data()`**: Function defined in this file

### Classes
- **`DydxSubscription`**: Class defined in this file
- **`DydxWsSubscriptionMsg`**: Class defined in this file
- **`DydxWsConnectedMsg`**: Class defined in this file
- **`DydxWsChannelDataMsg`**: Class defined in this file
- **`DydxWsChannelBatchDataMsg`**: Class defined in this file
- **`DydxWsGenericMsg`**: Class defined in this file
- **`DydxTrade`**: Class defined in this file
- **`DydxTradeContents`**: Class defined in this file
- **`DydxCandle`**: Class defined in this file
- **`DydxOrderbookContents`**: Class defined in this file
- **`DydxPriceLevel`**: Class defined in this file
- **`DydxOrderbookSnapshotContents`**: Class defined in this file
- **`DydxOraclePriceMarket`**: Class defined in this file
- **`DydxMarketsContents`**: Class defined in this file
...
**Enums**: `DydxWsMessage`, `NautilusWsMessage`, `contains`
**Functions**: `is_channel_batch_data`, `is_channel_data`, `is_connected`, `is_error`, `is_subscribed`, `is_unsubscribed`
**Impls**: `DydxWsGenericMsg`
**Structs**: `DydxCandle`, `DydxMarketsContents`, `DydxOraclePriceMarket`, `DydxOrderbookContents`, `DydxOrderbookSnapshotContents`, `DydxPriceLevel`, `DydxSubscription`, `DydxTrade`, `DydxTradeContents`, `DydxWsChannelBatchDataMsg`, `DydxWsChannelDataMsg`, `DydxWsConnectedMsg`, `DydxWsGenericMsg`, `DydxWsSubscriptionMsg`
...
---
*Generated on 2025-11-18T21:54:59.928486Z*
