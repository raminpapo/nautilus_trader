...
- **Path**: `crates/adapters/dydx/src/websocket/types.rs`
- **Size**: 4,522 bytes
- **Lines**: 137
- **Language**: Rust
...
**Structs**: `DydxCandle`, `DydxMarketsContents`, `DydxOraclePriceMarket`, `DydxOrderbookContents`, `DydxOrderbookSnapshotContents`, `DydxPriceLevel`, `DydxTrade`, `DydxTradeContents`
...
---
*Generated on 2025-11-18T21:54:59.940094Z*
