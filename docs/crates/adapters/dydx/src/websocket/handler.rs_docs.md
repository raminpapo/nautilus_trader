...
- **Path**: `crates/adapters/dydx/src/websocket/handler.rs`
- **Size**: 33,924 bytes
- **Lines**: 853
- **Language**: Rust
...
- **`process_raw_message()`**: Function defined in this file
- **`handle_dydx_message()`**: Function defined in this file
- **`handle_command()`**: Function defined in this file
- **`register_bar_type()`**: Function defined in this file
- **`unregister_bar_type()`**: Function defined in this file
- **`handle_message()`**: Function defined in this file
- **`handle_channel_data()`**: Function defined in this file
- **`handle_channel_batch_data()`**: Function defined in this file
- **`parse_trades()`**: Function defined in this file
- **`parse_orderbook()`**: Function defined in this file
- **`parse_orderbook_batch()`**: Function defined in this file
- **`parse_orderbook_snapshot()`**: Function defined in this file
- **`parse_orderbook_deltas()`**: Function defined in this file
- **`parse_orderbook_deltas_with_flag()`**: Function defined in this file
- **`parse_candles()`**: Function defined in this file
- **`parse_markets()`**: Function defined in this file
- **`parse_subaccounts()`**: Function defined in this file
...
**Functions**: `fmt`, `get_instrument`, `handle_channel_batch_data`, `handle_channel_data`, `handle_command`, `handle_dydx_message`, `handle_message`, `new`, `parse_candles`, `parse_instrument_id`, `parse_markets`, `parse_orderbook`, `parse_orderbook_batch`, `parse_orderbook_deltas`, `parse_orderbook_deltas_with_flag`, `parse_orderbook_snapshot`, `parse_subaccounts`, `parse_subaccounts_subscribed`, `parse_trades`, `process_raw_message`, `register_bar_type`, `run`, `unregister_bar_type`
**Impls**: `Debug`, `FeedHandler`
**Structs**: `FeedHandler`
...
---
*Generated on 2025-11-18T21:54:59.925061Z*
