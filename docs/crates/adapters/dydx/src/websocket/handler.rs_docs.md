# Documentation: `crates/adapters/dydx/src/websocket/handler.rs`
**Generated:** 2025-11-15T19:40:00.967651Z
**File Size:** 31537 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/adapters/dydx/src/websocket/handler.rs` within the repository.

**Classes defined:** FeedHandler, Debug, FeedHandler

**Functions defined:** fmt, new, run, process_raw_message, handle_dydx_message, handle_command, register_bar_type, unregister_bar_type, handle_message, handle_channel_data and 12 more
...
#### `process_raw_message(&self, msg: Message)`


#### `handle_dydx_message(&self, msg: DydxWsMessage)`


#### `handle_command(&mut self, command: HandlerCommand)`


#### `register_bar_type(&mut self, topic: String, bar_type: BarType)`


#### `unregister_bar_type(&mut self, topic: &str)`


#### `handle_message(&self, msg: DydxWsMessage)`
...
#### `parse_trades(&self, data: &DydxWsChannelDataMsg)`
...
#### `parse_instrument_id(&self, symbol: &str)`
