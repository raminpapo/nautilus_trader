...
- **`from_value()`**: Function defined in this file
- **`fmt()`**: Function defined in this file

### Classes
- **`DydxWebSocketError`**: Class defined in this file
...
**Enums**: `DydxWsError`
**Functions**: `fmt`, `from`, `from_message`, `from_value`
**Impls**: `Display`, `DydxWebSocketError`, `From`, `std`
**Structs**: `DydxWebSocketError`
...
---
*Generated on 2025-11-18T21:54:59.919695Z*
