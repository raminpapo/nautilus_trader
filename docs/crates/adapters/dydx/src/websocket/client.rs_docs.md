# Documentation: `crates/adapters/dydx/src/websocket/client.rs`
**Generated:** 2025-11-15T19:40:00.960436Z
**File Size:** 23356 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/adapters/dydx/src/websocket/client.rs` within the repository.

**Classes defined:** DydxWebSocketClient, Clone, DydxWebSocketClient

**Functions defined:** clone, new_public, new_private, credential, is_connected, url, connection_mode_atomic, set_account_id, account_id, cache_instrument and 20 more
...
#### `new_public(url: String, _heartbeat: Option<u64>)`
...
#### `get_instrument(&self, symbol: &Ustr)`
...
#### `send_text_inner(&self, text: &str)`


#### `ticker_from_instrument_id(instrument_id: &InstrumentId)`
...
#### `subscribe_orderbook(&self, instrument_id: InstrumentId)`


#### `unsubscribe_orderbook(&self, instrument_id: InstrumentId)`
...
#### `subscribe_markets(&self)`


#### `unsubscribe_markets(&self)`
...
#### `subscribe_block_height(&self)`


#### `unsubscribe_block_height(&self)`
