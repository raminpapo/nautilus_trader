...
- **Path**: `crates/adapters/dydx/src/websocket/client.rs`
- **Size**: 23,272 bytes
- **Lines**: 642
- **Language**: Rust
...
This file is part of the NautilusTrader repository. It defines 30 function(s) and 1 class(es).
...
- **`take_receiver()`**: Function defined in this file
- **`connect()`**: Function defined in this file
- **`disconnect()`**: Function defined in this file
- **`send_text_inner()`**: Function defined in this file
- **`ticker_from_instrument_id()`**: Function defined in this file
...
### Classes
- **`DydxWebSocketClient`**: Class defined in this file
...
**Functions**: `account_id`, `cache_instrument`, `cache_instruments`, `clone`, `connect`, `connection_mode_atomic`, `credential`, `disconnect`, `get_instrument`, `instruments`, `is_connected`, `new_private`, `new_public`, `send_text_inner`, `set_account_id`, `subscribe_block_height`, `subscribe_candles`, `subscribe_markets`, `subscribe_orderbook`, `subscribe_subaccount`, `subscribe_trades`, `take_receiver`, `ticker_from_instrument_id`, `unsubscribe_block_height`, `unsubscribe_candles`, `unsubscribe_markets`, `unsubscribe_orderbook`, `unsubscribe_subaccount`, `unsubscribe_trades`, `url`
**Impls**: `Clone`, `DydxWebSocketClient`
**Structs**: `DydxWebSocketClient`
...
---
*Generated on 2025-11-18T21:54:59.916029Z*
