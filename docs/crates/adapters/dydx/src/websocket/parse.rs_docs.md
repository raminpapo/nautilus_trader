...
- **Path**: `crates/adapters/dydx/src/websocket/parse.rs`
- **Size**: 45,575 bytes
- **Lines**: 1,273
- **Language**: Rust
...
### Functions
- **`parse_ws_order_report()`**: Function defined in this file
- **`convert_ws_order_to_http()`**: Function defined in this file
- **`parse_ws_fill_report()`**: Function defined in this file
- **`convert_ws_fill_to_http()`**: Function defined in this file
- **`parse_ws_position_report()`**: Function defined in this file
- **`convert_ws_position_to_http()`**: Function defined in this file
- **`create_test_instrument()`**: Function defined in this file
- **`test_convert_ws_order_to_http_basic()`**: Function defined in this file
- **`test_parse_ws_order_report_success()`**: Function defined in this file
- **`test_parse_ws_order_report_missing_instrument()`**: Function defined in this file
- **`test_convert_ws_fill_to_http()`**: Function defined in this file
- **`test_parse_ws_fill_report_success()`**: Function defined in this file
- **`test_parse_ws_fill_report_missing_instrument()`**: Function defined in this file
- **`test_convert_ws_position_to_http()`**: Function defined in this file
- **`test_parse_ws_position_report_success()`**: Function defined in this file
- **`test_parse_ws_position_report_short()`**: Function defined in this file
- **`test_parse_ws_position_report_missing_instrument()`**: Function defined in this file
- **`test_parse_ws_order_various_statuses()`**: Function defined in this file
- **`test_parse_ws_order_with_trigger_price()`**: Function defined in this file
- **`test_parse_ws_order_market_type()`**: Function defined in this file
...
**Enums**: `mapping`
**Functions**: `convert_ws_fill_to_http`, `convert_ws_order_to_http`, `convert_ws_position_to_http`, `create_test_instrument`, `parse_ws_fill_report`, `parse_ws_order_report`, `parse_ws_position_report`, `test_convert_ws_fill_to_http`, `test_convert_ws_order_to_http_basic`, `test_convert_ws_position_to_http`, `test_parse_ws_fill_report_missing_instrument`, `test_parse_ws_fill_report_success`, `test_parse_ws_fill_taker_with_fee`, `test_parse_ws_fill_with_maker_rebate`, `test_parse_ws_order_invalid_clob_pair_id`, `test_parse_ws_order_market_type`, `test_parse_ws_order_report_missing_instrument`, `test_parse_ws_order_report_success`, `test_parse_ws_order_various_statuses`, `test_parse_ws_order_with_trigger_price`, `test_parse_ws_position_closed`, `test_parse_ws_position_report_missing_instrument`, `test_parse_ws_position_report_short`, `test_parse_ws_position_report_success`
...
---
*Generated on 2025-11-18T21:54:59.937991Z*
