...
- **Path**: `crates/adapters/dydx/src/execution/submitter.rs`
- **Size**: 12,235 bytes
- **Lines**: 367
- **Language**: Rust
...
- **`submit_market_order()`**: Function defined in this file
- **`submit_limit_order()`**: Function defined in this file
- **`cancel_order()`**: Function defined in this file
- **`cancel_orders_batch()`**: Function defined in this file
- **`submit_stop_market_order()`**: Function defined in this file
- **`submit_stop_limit_order()`**: Function defined in this file
- **`submit_take_profit_market_order()`**: Function defined in this file
- **`submit_take_profit_limit_order()`**: Function defined in this file
- **`submit_trailing_stop_order()`**: Function defined in this file
- **`extract_market_params()`**: Function defined in this file
- **`handle_exchange_response()`**: Function defined in this file
- **`parse_venue_order_id()`**: Function defined in this file
- **`store_order_id_mapping()`**: Function defined in this file
- **`get_venue_order_id()`**: Function defined in this file
- **`generate_order_accepted()`**: Function defined in this file
- **`generate_order_rejected()`**: Function defined in this file

### Classes
- **`OrderSubmitter`**: Class defined in this file
...
**Enums**: `ProtoOrderSide`, `ProtoTimeInForce`
**Functions**: `cancel_order`, `cancel_orders_batch`, `extract_market_params`, `generate_order_accepted`, `generate_order_rejected`, `get_venue_order_id`, `handle_exchange_response`, `new`, `parse_venue_order_id`, `store_order_id_mapping`, `submit_limit_order`, `submit_market_order`, `submit_stop_limit_order`, `submit_stop_market_order`, `submit_take_profit_limit_order`, `submit_take_profit_market_order`, `submit_trailing_stop_order`
**Impls**: `OrderSubmitter`
**Structs**: `OrderSubmitter`
...
---
*Generated on 2025-11-18T21:54:59.846743Z*
