# Documentation: `crates/adapters/dydx/src/execution/mod.rs`
**Generated:** 2025-11-15T19:40:00.915079Z
**File Size:** 11196 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/adapters/dydx/src/execution/mod.rs` within the repository.

**Classes defined:** DydxExecutionClient, DydxExecutionClient, ExecutionClient, LiveExecutionClient, LiveExecutionClientExt

**Functions defined:** new, generate_client_order_id_int, get_client_order_id_int, get_client_order_id, is_connected, client_id, account_id, venue, oms_type, get_account and 20 more
...
#### `generate_client_order_id_int(&self, client_order_id: &str)`


#### `get_client_order_id_int(&self, client_order_id: &str)`


#### `get_client_order_id(&self, client_order_id_int: u32)`
...
**Directory:** `crates/adapters/dydx/src/execution`
