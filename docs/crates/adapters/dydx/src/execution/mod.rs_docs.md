...
- **Path**: `crates/adapters/dydx/src/execution/mod.rs`
- **Size**: 75,824 bytes
- **Lines**: 1,908
- **Language**: Rust
...
- **`generate_client_order_id_int()`**: Function defined in this file
- **`get_client_order_id_int()`**: Function defined in this file
- **`get_client_order_id()`**: Function defined in this file
- **`cache_instruments_from_http()`**: Function defined in this file
- **`get_instrument_by_market()`**: Function defined in this file
- **`get_instrument_by_clob_pair_id()`**: Function defined in this file
- **`log_missing_instrument_for_clob_pair_id()`**: Function defined in this file
- **`spawn_task()`**: Function defined in this file
- **`spawn_order_task()`**: Function defined in this file
...
### Classes
- **`DydxExecutionClient`**: Class defined in this file
...
**Enums**: `ExecutionReport`, `groups`
**Functions**: `abort_pending_tasks`, `account_id`, `batch_cancel_orders`, `cache_instruments_from_http`, `cancel_all_orders`, `cancel_order`, `client_id`, `connect`, `disconnect`, `dispatch_account_state`, `dispatch_execution_report`, `generate_account_state`, `generate_client_order_id_int`, `generate_fill_reports`, `generate_mass_status`, `generate_order_status_report`, `generate_order_status_reports`, `generate_position_status_reports`, `get_account`, `get_client_order_id`, `get_client_order_id_int`, `get_clock`, `get_instrument_by_clob_pair_id`, `get_instrument_by_market`, `get_message_channel`, `is_connected`, `log_missing_instrument_for_clob_pair_id`, `modify_order`, `new`, `oms_type` *(+21 more)*
**Impls**: `DydxExecutionClient`, `ExecutionClient`, `LiveExecutionClient`, `LiveExecutionClientExt`
**Structs**: `DydxExecutionClient`

## Related Files

This file is located in `crates/adapters/dydx/src/execution/`. Related files may include:
...
---
*Generated on 2025-11-18T21:54:59.842405Z*
