# Documentation: data_integration.rs

## File Metadata

- **Path**: `crates/adapters/dydx/tests/data_integration.rs`
- **Size**: 19,690 bytes
- **Lines**: 632
- **Language**: Rust
...
### Functions
- **`integration_enabled()`**: Function defined in this file
- **`dydx_testnet_connect_and_subscribe_btc_usd()`**: Function defined in this file
- **`dydx_testnet_request_historical_bars()`**: Function defined in this file
- **`dydx_testnet_orderbook_snapshot_refresh()`**: Function defined in this file
- **`dydx_testnet_complete_data_flow()`**: Function defined in this file
- **`dydx_testnet_crossed_orderbook_live_detection()`**: Function defined in this file
...
**Functions**: `dydx_testnet_complete_data_flow`, `dydx_testnet_connect_and_subscribe_btc_usd`, `dydx_testnet_crossed_orderbook_live_detection`, `dydx_testnet_orderbook_snapshot_refresh`, `dydx_testnet_request_historical_bars`, `integration_enabled`

## Related Files

This file is located in `crates/adapters/dydx/tests/`. Related files may include:
...
```bash
# For Python
pytest crates/adapters/dydx/tests/data_integration.rs
...
---
*Generated on 2025-11-18T21:54:59.943897Z*
