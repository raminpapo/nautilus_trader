# Documentation: replay.rs

## File Metadata

- **Path**: `crates/adapters/tardis/src/replay.rs`
- **Size**: 21,883 bytes
- **Lines**: 614
- **Language**: Rust
...
- **`gather_instruments_info()`**: Function defined in this file
- **`run_tardis_machine_replay_from_config()`**: Function defined in this file
- **`handle_deltas_msg()`**: Function defined in this file
- **`handle_depth10_msg()`**: Function defined in this file
- **`handle_quote_msg()`**: Function defined in this file
- **`handle_trade_msg()`**: Function defined in this file
- **`handle_bar_msg()`**: Function defined in this file
- **`batch_and_write_deltas()`**: Function defined in this file
- **`batch_and_write_depths()`**: Function defined in this file
- **`batch_and_write_quotes()`**: Function defined in this file
- **`batch_and_write_trades()`**: Function defined in this file
- **`batch_and_write_bars()`**: Function defined in this file
- **`assert_post_epoch()`**: Function defined in this file
- **`iso_timestamp_to_file_timestamp()`**: Function defined in this file
- **`timestamps_to_filename()`**: Function defined in this file
- **`parquet_filepath()`**: Function defined in this file
- **`parquet_filepath_bars()`**: Function defined in this file
- **`write_batch()`**: Function defined in this file
- **`write_parquet_local()`**: Function defined in this file

*...and 1 more functions*

### Classes
- **`DateCursor`**: Class defined in this file
...
**Functions**: `assert_post_epoch`, `batch_and_write_bars`, `batch_and_write_deltas`, `batch_and_write_depths`, `batch_and_write_quotes`, `batch_and_write_trades`, `gather_instruments_info`, `handle_bar_msg`, `handle_deltas_msg`, `handle_depth10_msg`, `handle_quote_msg`, `handle_trade_msg`, `iso_timestamp_to_file_timestamp`, `new`, `parquet_filepath`, `parquet_filepath_bars`, `run_tardis_machine_replay_from_config`, `test_date_cursor`, `timestamps_to_filename`, `write_batch`, `write_parquet_local`
**Impls**: `DateCursor`
**Structs**: `DateCursor`
...
---
*Generated on 2025-11-18T21:55:00.741315Z*
