# Documentation: `crates/adapters/tardis/src/replay.rs`
**Generated:** 2025-11-15T19:40:01.497299Z
**File Size:** 21883 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/adapters/tardis/src/replay.rs` within the repository.

**Classes defined:** DateCursor, DateCursor

**Functions defined:** new, gather_instruments_info, run_tardis_machine_replay_from_config, handle_deltas_msg, handle_depth10_msg, handle_quote_msg, handle_trade_msg, handle_bar_msg, batch_and_write_deltas, batch_and_write_depths and 11 more
...
#### `new(current_ns: UnixNanos)`


#### `gather_instruments_info(
    config: &TardisReplayConfig,
    http_client: &TardisHttpClient,
)`


#### `run_tardis_machine_replay_from_config(config_filepath: &Path)`
...
#### `batch_and_write_bars(bars: Vec<Bar>, bar_type: &BarType, date: NaiveDate, path: &Path)`


#### `assert_post_epoch(date: NaiveDate)`
...
#### `parquet_filepath(typename: &str, instrument_id: &InstrumentId, date: NaiveDate)`


#### `parquet_filepath_bars(bar_type: &BarType, date: NaiveDate)`
...
#### `write_parquet_local(batch: RecordBatch, file_path: &Path)`
