# Documentation: `crates/adapters/tardis/src/csv/stream.rs`
**Generated:** 2025-11-15T19:40:01.450231Z
**File Size:** 71547 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/adapters/tardis/src/csv/stream.rs` within the repository.

**Classes defined:** DeltaStreamIterator, BatchedDeltasStreamIterator, QuoteStreamIterator, TradeStreamIterator, Depth10StreamIterator, FundingRateStreamIterator, DeltaStreamIterator, Iterator, Iterator, BatchedDeltasStreamIterator and 15 more

**Functions defined:** detect_precision_from_sample, next, detect_precision_from_sample, next, detect_precision_from_sample, next, detect_precision_from_sample, next, process_snapshot5, process_snapshot25 and 18 more
...
#### `process_snapshot5(&mut self, data: TardisOrderBookSnapshot5Record)`


#### `process_snapshot25(&mut self, data: TardisOrderBookSnapshot25Record)`
...
#### `test_infer_precision(#[case] input: f64, #[case] expected: u8)`


#### `test_stream_deltas_chunked()`


#### `test_stream_quotes_chunked()`


#### `test_stream_trades_chunked()`


#### `test_stream_trades_with_zero_sized_trade()`


#### `test_stream_depth10_from_snapshot5_chunked()`


#### `test_stream_depth10_from_snapshot25_chunked()`
...
#### `test_stream_precision_consistency()`


#### `test_stream_trades_from_local_file()`


#### `test_stream_deltas_from_local_file()`


#### `test_stream_deltas_with_limit()`


#### `test_stream_quotes_with_limit()`


#### `test_stream_trades_with_limit()`
...
**Directory:** `crates/adapters/tardis/src/csv`
