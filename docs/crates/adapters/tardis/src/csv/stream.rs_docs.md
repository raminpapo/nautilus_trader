# Documentation: stream.rs

## File Metadata

- **Path**: `crates/adapters/tardis/src/csv/stream.rs`
- **Size**: 71,547 bytes
- **Lines**: 1,880
- **Language**: Rust
...
This file is part of the NautilusTrader repository. It defines 41 function(s) and 6 class(es).

## Detailed Walkthrough

### Functions
- **`new()`**: Function defined in this file
- **`detect_precision_from_sample()`**: Function defined in this file
- **`next()`**: Function defined in this file
- **`stream_deltas()`**: Function defined in this file
- **`new()`**: Function defined in this file
- **`detect_precision_from_sample()`**: Function defined in this file
- **`next()`**: Function defined in this file
- **`stream_batched_deltas()`**: Function defined in this file
- **`new()`**: Function defined in this file
- **`detect_precision_from_sample()`**: Function defined in this file
- **`next()`**: Function defined in this file
- **`stream_quotes()`**: Function defined in this file
- **`new()`**: Function defined in this file
- **`detect_precision_from_sample()`**: Function defined in this file
- **`next()`**: Function defined in this file
- **`stream_trades()`**: Function defined in this file
- **`new()`**: Function defined in this file
- **`process_snapshot5()`**: Function defined in this file
- **`process_snapshot25()`**: Function defined in this file
- **`detect_precision_from_sample()`**: Function defined in this file

*...and 21 more functions*

### Classes
- **`DeltaStreamIterator`**: Class defined in this file
- **`BatchedDeltasStreamIterator`**: Class defined in this file
- **`QuoteStreamIterator`**: Class defined in this file
- **`TradeStreamIterator`**: Class defined in this file
- **`Depth10StreamIterator`**: Class defined in this file
- **`FundingRateStreamIterator`**: Class defined in this file
...
**Functions**: `detect_precision_from_sample`, `new`, `next`, `process_snapshot25`, `process_snapshot5`, `stream_batched_deltas`, `stream_deltas`, `stream_depth10_from_snapshot25`, `stream_depth10_from_snapshot5`, `stream_funding_rates`, `stream_quotes`, `stream_trades`, `test_infer_precision`, `test_stream_deltas_chunked`, `test_stream_deltas_from_local_file`, `test_stream_deltas_with_limit`, `test_stream_depth10_from_snapshot25_chunked`, `test_stream_depth10_from_snapshot5_chunked`, `test_stream_empty_file`, `test_stream_error_handling`, `test_stream_precision_consistency`, `test_stream_quotes_chunked`, `test_stream_quotes_with_limit`, `test_stream_trades_chunked`, `test_stream_trades_from_local_file`, `test_stream_trades_with_limit`, `test_stream_trades_with_zero_sized_trade`
**Impls**: `BatchedDeltasStreamIterator`, `DeltaStreamIterator`, `Depth10StreamIterator`, `FundingRateStreamIterator`, `Iterator`, `QuoteStreamIterator`, `TradeStreamIterator`
**Structs**: `BatchedDeltasStreamIterator`, `DeltaStreamIterator`, `Depth10StreamIterator`, `FundingRateStreamIterator`, `QuoteStreamIterator`, `TradeStreamIterator`

## Related Files

This file is located in `crates/adapters/tardis/src/csv/`. Related files may include:
...
---
*Generated on 2025-11-18T21:55:00.673075Z*
