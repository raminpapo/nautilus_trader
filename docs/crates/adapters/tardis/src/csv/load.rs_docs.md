# Documentation: `crates/adapters/tardis/src/csv/load.rs`
**Generated:** 2025-11-15T19:40:01.439462Z
**File Size:** 47119 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/adapters/tardis/src/csv/load.rs` within the repository.

**Functions defined:** update_precision_if_needed, update_deltas_precision, update_quotes_precision, update_trades_precision, test_infer_precision, test_dynamic_precision_inference, test_read_deltas, test_read_depth10s_from_snapshot5, test_read_depth10s_from_snapshot25, test_read_quotes and 7 more
...
#### `update_precision_if_needed(current: &mut u8, value: f64, explicit: Option<u8>)`
...
#### `test_dynamic_precision_inference()`
...
#### `test_read_depth10s_from_snapshot25(
        #[case] price_precision: Option<u8>,
        #[case] size_precision: Option<u8>,
    )`
...
#### `test_load_trades_with_zero_sized_trade()`


#### `test_load_trades_from_local_file()`


#### `test_load_deltas_from_local_file()`


#### `test_load_depth10_from_snapshot5_comprehensive()`


#### `test_load_depth10_from_snapshot25_comprehensive()`


#### `test_snapshot_csv_field_order_interleaved()`
