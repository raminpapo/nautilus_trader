# Documentation: load.rs

## File Metadata

- **Path**: `crates/adapters/tardis/src/csv/load.rs`
- **Size**: 47,119 bytes
- **Lines**: 1,283
- **Language**: Rust
...
### Functions
- **`update_precision_if_needed()`**: Function defined in this file
- **`update_deltas_precision()`**: Function defined in this file
- **`update_quotes_precision()`**: Function defined in this file
- **`update_trades_precision()`**: Function defined in this file
- **`load_deltas()`**: Function defined in this file
- **`load_depth10_from_snapshot5()`**: Function defined in this file
- **`load_depth10_from_snapshot25()`**: Function defined in this file
- **`load_quotes()`**: Function defined in this file
- **`load_trades()`**: Function defined in this file
- **`load_funding_rates()`**: Function defined in this file
- **`test_infer_precision()`**: Function defined in this file
- **`test_dynamic_precision_inference()`**: Function defined in this file
- **`test_read_deltas()`**: Function defined in this file
- **`test_read_depth10s_from_snapshot5()`**: Function defined in this file
- **`test_read_depth10s_from_snapshot25()`**: Function defined in this file
- **`test_read_quotes()`**: Function defined in this file
- **`test_read_trades()`**: Function defined in this file
- **`test_load_trades_with_zero_sized_trade()`**: Function defined in this file
- **`test_load_trades_from_local_file()`**: Function defined in this file
- **`test_load_deltas_from_local_file()`**: Function defined in this file
...
**Functions**: `load_deltas`, `load_depth10_from_snapshot25`, `load_depth10_from_snapshot5`, `load_funding_rates`, `load_quotes`, `load_trades`, `test_dynamic_precision_inference`, `test_infer_precision`, `test_load_deltas_from_local_file`, `test_load_depth10_from_snapshot25_comprehensive`, `test_load_depth10_from_snapshot5_comprehensive`, `test_load_trades_from_local_file`, `test_load_trades_with_zero_sized_trade`, `test_read_deltas`, `test_read_depth10s_from_snapshot25`, `test_read_depth10s_from_snapshot5`, `test_read_quotes`, `test_read_trades`, `test_snapshot_csv_field_order_interleaved`, `update_deltas_precision`, `update_precision_if_needed`, `update_quotes_precision`, `update_trades_precision`
...
---
*Generated on 2025-11-18T21:55:00.655369Z*
