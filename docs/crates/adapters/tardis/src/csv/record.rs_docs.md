# Documentation: `crates/adapters/tardis/src/csv/record.rs`
**Generated:** 2025-11-15T19:40:01.444412Z
**File Size:** 15683 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/adapters/tardis/src/csv/record.rs` within the repository.

**Classes defined:** TardisBookUpdateRecord, TardisOrderBookSnapshot5Record, TardisOrderBookSnapshot25Record, TardisQuoteRecord, TardisTradeRecord, TardisDerivativeTickerRecord
...
#### `TardisBookUpdateRecord`

**Type:** struct


#### `TardisOrderBookSnapshot5Record`

**Type:** struct


#### `TardisOrderBookSnapshot25Record`
