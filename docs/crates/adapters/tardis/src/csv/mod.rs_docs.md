...
- **Path**: `crates/adapters/tardis/src/csv/mod.rs`
- **Size**: 10,111 bytes
- **Lines**: 314
- **Language**: Rust
...
### Functions
- **`infer_precision()`**: Function defined in this file
- **`create_csv_reader()`**: Function defined in this file
- **`open_file_with_retry()`**: Function defined in this file
- **`create_book_order()`**: Function defined in this file
- **`parse_delta_record()`**: Function defined in this file
- **`parse_quote_record()`**: Function defined in this file
- **`parse_trade_record()`**: Function defined in this file
- **`parse_derivative_ticker_record()`**: Function defined in this file
...
**Functions**: `create_book_order`, `create_csv_reader`, `infer_precision`, `open_file_with_retry`, `parse_delta_record`, `parse_derivative_ticker_record`, `parse_quote_record`, `parse_trade_record`
...
---
*Generated on 2025-11-18T21:55:00.658435Z*
