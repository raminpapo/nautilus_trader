# Documentation: `crates/adapters/tardis/src/csv/mod.rs`
**Generated:** 2025-11-15T19:40:01.442048Z
**File Size:** 10111 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/adapters/tardis/src/csv/mod.rs` within the repository.

**Functions defined:** infer_precision, create_book_order, parse_delta_record, parse_quote_record, parse_trade_record, parse_derivative_ticker_record
...
#### `parse_derivative_ticker_record(
    data: &TardisDerivativeTickerRecord,
    instrument_id: Option<InstrumentId>,
)`
