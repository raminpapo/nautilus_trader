# Documentation: `crates/adapters/tardis/src/python/http.rs`
**Generated:** 2025-11-15T19:40:01.489583Z
...
- **Path:** `crates/adapters/tardis/src/python/http.rs`
- **Size:** 4,150 bytes
- **Lines:** 101
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/adapters/tardis/src/python/http.rs` within the repository.

**Classes defined:** TardisHttpClient

**Functions defined:** py_new, py_instruments
