# Documentation: `crates/adapters/tardis/src/python/machine.rs`
**Generated:** 2025-11-15T19:40:01.491965Z
...
This file is located at `crates/adapters/tardis/src/python/machine.rs` within the repository.

**Classes defined:** ReplayNormalizedRequestOptions, StreamNormalizedRequestOptions, TardisMachineClient

**Functions defined:** py_from_json, py_from_json_array, py_from_json, py_from_json_array, py_new, py_is_closed, py_close, py_replay, py_replay_bars, py_stream and 3 more
...
#### `py_from_json_array(data: Vec<u8>)`
...
#### `py_new(base_url: Option<&str>, normalize_symbols: bool)`
