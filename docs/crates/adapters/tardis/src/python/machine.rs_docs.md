# Documentation: machine.rs

## File Metadata

- **Path**: `crates/adapters/tardis/src/python/machine.rs`
- **Size**: 11,182 bytes
- **Lines**: 308
- **Language**: Rust
...
- **`py_from_json_array()`**: Function defined in this file
- **`py_from_json()`**: Function defined in this file
- **`py_from_json_array()`**: Function defined in this file
- **`py_new()`**: Function defined in this file
- **`py_is_closed()`**: Function defined in this file
- **`py_close()`**: Function defined in this file
- **`py_replay()`**: Function defined in this file
- **`py_replay_bars()`**: Function defined in this file
- **`py_stream()`**: Function defined in this file
- **`py_run_tardis_machine_replay()`**: Function defined in this file
- **`handle_python_stream()`**: Function defined in this file
...
**Functions**: `call_python`, `handle_python_stream`, `py_close`, `py_from_json`, `py_from_json_array`, `py_is_closed`, `py_new`, `py_replay`, `py_replay_bars`, `py_run_tardis_machine_replay`, `py_stream`
**Impls**: `ReplayNormalizedRequestOptions`, `StreamNormalizedRequestOptions`, `TardisMachineClient`
...
---
*Generated on 2025-11-18T21:55:00.734694Z*
