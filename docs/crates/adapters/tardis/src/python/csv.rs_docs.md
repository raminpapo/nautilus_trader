# Documentation: csv.rs

## File Metadata

- **Path**: `crates/adapters/tardis/src/python/csv.rs`
- **Size**: 13,335 bytes
- **Lines**: 445
- **Language**: Rust
...
- **`py_load_tardis_deltas()`**: Function defined in this file
- **`py_load_tardis_depth10_from_snapshot5()`**: Function defined in this file
- **`py_load_tardis_depth10_from_snapshot25()`**: Function defined in this file
- **`py_load_tardis_quotes()`**: Function defined in this file
- **`py_load_tardis_trades()`**: Function defined in this file
- **`py_load_tardis_funding_rates()`**: Function defined in this file
- **`py_stream_tardis_deltas()`**: Function defined in this file
- **`fmt()`**: Function defined in this file
- **`__iter__()`**: Function defined in this file
- **`__next__()`**: Function defined in this file
- **`py_stream_tardis_batched_deltas()`**: Function defined in this file
- **`py_stream_tardis_quotes()`**: Function defined in this file
- **`py_stream_tardis_trades()`**: Function defined in this file
- **`py_stream_tardis_depth10_from_snapshot5()`**: Function defined in this file
- **`py_stream_tardis_depth10_from_snapshot25()`**: Function defined in this file
- **`py_stream_tardis_funding_rates()`**: Function defined in this file

### Classes
- **`TardisBatchedDeltasStreamIterator`**: Class defined in this file
...
**Functions**: `__iter__`, `__next__`, `fmt`, `py_load_tardis_deltas`, `py_load_tardis_depth10_from_snapshot25`, `py_load_tardis_depth10_from_snapshot5`, `py_load_tardis_funding_rates`, `py_load_tardis_quotes`, `py_load_tardis_trades`, `py_stream_tardis_batched_deltas`, `py_stream_tardis_deltas`, `py_stream_tardis_depth10_from_snapshot25`, `py_stream_tardis_depth10_from_snapshot5`, `py_stream_tardis_funding_rates`, `py_stream_tardis_quotes`, `py_stream_tardis_trades`
**Impls**: `Debug`, `TardisBatchedDeltasStreamIterator`
**Structs**: `TardisBatchedDeltasStreamIterator`
...
---
*Generated on 2025-11-18T21:55:00.727639Z*
