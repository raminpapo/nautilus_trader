# Documentation: instruments.rs

## File Metadata

- **Path**: `crates/adapters/tardis/src/http/instruments.rs`
- **Size**: 18,236 bytes
- **Lines**: 580
- **Language**: Rust
...
- **`create_currency_pair()`**: Function defined in this file
- **`create_crypto_perpetual()`**: Function defined in this file
- **`create_crypto_future()`**: Function defined in this file
- **`create_crypto_option()`**: Function defined in this file
- **`is_available()`**: Function defined in this file
- **`create_test_instrument()`**: Function defined in this file
- **`test_is_available()`**: Function defined in this file
- **`test_infinite_available_to()`**: Function defined in this file
- **`test_available_offset_effects()`**: Function defined in this file
- **`test_with_real_dates()`**: Function defined in this file
- **`test_complex_scenarios()`**: Function defined in this file
- **`test_edge_cases()`**: Function defined in this file
...
**Functions**: `create_crypto_future`, `create_crypto_option`, `create_crypto_perpetual`, `create_currency_pair`, `create_test_instrument`, `get_currency`, `is_available`, `test_available_offset_effects`, `test_complex_scenarios`, `test_edge_cases`, `test_infinite_available_to`, `test_is_available`, `test_with_real_dates`
...
---
*Generated on 2025-11-18T21:55:00.685814Z*
