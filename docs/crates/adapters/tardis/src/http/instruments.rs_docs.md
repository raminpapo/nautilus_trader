# Documentation: `crates/adapters/tardis/src/http/instruments.rs`
**Generated:** 2025-11-15T19:40:01.458193Z
**File Size:** 18236 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/adapters/tardis/src/http/instruments.rs` within the repository.

**Functions defined:** get_currency, create_currency_pair, create_crypto_perpetual, create_crypto_future, create_crypto_option, is_available, create_test_instrument, test_is_available, test_infinite_available_to, test_available_offset_effects and 3 more
...
#### `test_infinite_available_to()`


#### `test_available_offset_effects()`
