...
- **`handle_error_response()`**: Function defined in this file
- **`instruments_info()`**: Function defined in this file
- **`instruments()`**: Function defined in this file

### Classes
- **`TardisHttpClient`**: Class defined in this file
...
**Functions**: `handle_error_response`, `instruments`, `instruments_info`, `new`
**Impls**: `TardisHttpClient`
**Structs**: `TardisHttpClient`
...
---
*Generated on 2025-11-18T21:55:00.679074Z*
