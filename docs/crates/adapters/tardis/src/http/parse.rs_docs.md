# Documentation: `crates/adapters/tardis/src/http/parse.rs`
**Generated:** 2025-11-15T19:40:01.464769Z
**File Size:** 38759 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/adapters/tardis/src/http/parse.rs` within the repository.

**Functions defined:** parse_instrument_any, parse_spot_instrument, parse_perp_instrument, parse_future_instrument, parse_option_instrument, parse_price_increment, parse_size_increment, parse_spot_size_increment, parse_multiplier, parse_fee_rate and 8 more
...
#### `parse_price_increment(value: f64)`


#### `parse_size_increment(value: f64)`


#### `parse_spot_size_increment(value: f64, currency: Currency)`


#### `parse_multiplier(value: Option<f64>)`


#### `parse_fee_rate(value: f64)`


#### `parse_datetime_to_unix_nanos(value: Option<DateTime<Utc>>)`


#### `parse_settlement_currency(info: &TardisInstrumentInfo, is_inverse: bool)`


#### `test_parse_instrument_spot()`


#### `test_parse_instrument_perpetual()`


#### `test_parse_instrument_future()`


#### `test_parse_instrument_perpetual_current()`


#### `test_parse_instrument_combo()`


#### `test_parse_instrument_option()`
