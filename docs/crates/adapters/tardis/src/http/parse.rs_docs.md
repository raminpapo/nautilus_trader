...
- **Path**: `crates/adapters/tardis/src/http/parse.rs`
- **Size**: 38,759 bytes
- **Lines**: 971
- **Language**: Rust
...
- **`parse_perp_instrument()`**: Function defined in this file
- **`parse_future_instrument()`**: Function defined in this file
- **`parse_option_instrument()`**: Function defined in this file
- **`parse_price_increment()`**: Function defined in this file
- **`parse_size_increment()`**: Function defined in this file
- **`parse_spot_size_increment()`**: Function defined in this file
- **`parse_multiplier()`**: Function defined in this file
- **`parse_fee_rate()`**: Function defined in this file
- **`parse_datetime_to_unix_nanos()`**: Function defined in this file
- **`parse_settlement_currency()`**: Function defined in this file
- **`test_parse_instrument_spot()`**: Function defined in this file
- **`test_parse_instrument_perpetual()`**: Function defined in this file
- **`test_parse_instrument_future()`**: Function defined in this file
- **`test_parse_instrument_perpetual_current()`**: Function defined in this file
- **`test_parse_instrument_combo()`**: Function defined in this file
- **`test_parse_instrument_option()`**: Function defined in this file
...
**Functions**: `parse_datetime_to_unix_nanos`, `parse_fee_rate`, `parse_future_instrument`, `parse_instrument_any`, `parse_multiplier`, `parse_option_instrument`, `parse_perp_instrument`, `parse_price_increment`, `parse_settlement_currency`, `parse_size_increment`, `parse_spot_instrument`, `parse_spot_size_increment`, `test_parse_instrument_combo`, `test_parse_instrument_future`, `test_parse_instrument_option`, `test_parse_instrument_perpetual`, `test_parse_instrument_perpetual_current`, `test_parse_instrument_spot`
...
---
*Generated on 2025-11-18T21:55:00.696593Z*
