# Documentation: `crates/adapters/tardis/src/enums.rs`
**Generated:** 2025-11-15T19:40:01.452700Z
**File Size:** 11243 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/adapters/tardis/src/enums.rs` within the repository.

**Classes defined:** TardisExchange

**Functions defined:** is_option_exchange, from_venue_str, as_venue_str, as_venue, test_exchange_to_venue_mapping, test_venue_to_exchange_mapping_bidirectional
...
#### `is_option_exchange(&self)`


#### `from_venue_str(s: &str)`
