# Documentation: `crates/adapters/tardis/src/machine/parse.rs`
**Generated:** 2025-11-15T19:40:01.477405Z
...
This file is located at `crates/adapters/tardis/src/machine/parse.rs` within the repository.

**Functions defined:** parse_tardis_ws_message, parse_tardis_ws_message_funding_rate, parse_book_change_msg_as_deltas, parse_book_snapshot_msg_as_deltas, parse_book_msg_as_deltas, parse_book_level, parse_book_snapshot_msg_as_quote, parse_trade_msg, parse_bar_msg, parse_derivative_ticker_msg and 5 more
...
#### `parse_book_change_msg_as_deltas(
    msg: BookChangeMsg,
    price_precision: u8,
    size_precision: u8,
    instrument_id: InstrumentId,
...
#### `parse_book_snapshot_msg_as_deltas(
    msg: BookSnapshotMsg,
    price_precision: u8,
    size_precision: u8,
    instrument_id: InstrumentId,
...
#### `test_parse_book_change_message()`


#### `test_parse_book_snapshot_message_as_deltas()`


#### `test_parse_book_snapshot_message_as_quote()`


#### `test_parse_trade_message()`


#### `test_parse_bar_message()`
...
**Directory:** `crates/adapters/tardis/src/machine`
