...
- **Path**: `crates/adapters/tardis/src/machine/parse.rs`
- **Size**: 21,093 bytes
- **Lines**: 603
- **Language**: Rust
...
### Functions
- **`parse_tardis_ws_message()`**: Function defined in this file
- **`parse_tardis_ws_message_funding_rate()`**: Function defined in this file
- **`parse_book_change_msg_as_deltas()`**: Function defined in this file
- **`parse_book_snapshot_msg_as_deltas()`**: Function defined in this file
- **`parse_book_msg_as_deltas()`**: Function defined in this file
- **`parse_book_level()`**: Function defined in this file
- **`parse_book_snapshot_msg_as_quote()`**: Function defined in this file
- **`parse_trade_msg()`**: Function defined in this file
- **`parse_bar_msg()`**: Function defined in this file
- **`parse_derivative_ticker_msg()`**: Function defined in this file
- **`test_parse_book_change_message()`**: Function defined in this file
- **`test_parse_book_snapshot_message_as_deltas()`**: Function defined in this file
- **`test_parse_book_snapshot_message_as_quote()`**: Function defined in this file
- **`test_parse_trade_message()`**: Function defined in this file
- **`test_parse_bar_message()`**: Function defined in this file
...
**Functions**: `parse_bar_msg`, `parse_book_change_msg_as_deltas`, `parse_book_level`, `parse_book_msg_as_deltas`, `parse_book_snapshot_msg_as_deltas`, `parse_book_snapshot_msg_as_quote`, `parse_derivative_ticker_msg`, `parse_tardis_ws_message`, `parse_tardis_ws_message_funding_rate`, `parse_trade_msg`, `test_parse_bar_message`, `test_parse_book_change_message`, `test_parse_book_snapshot_message_as_deltas`, `test_parse_book_snapshot_message_as_quote`, `test_parse_trade_message`
...
---
*Generated on 2025-11-18T21:55:00.715882Z*
