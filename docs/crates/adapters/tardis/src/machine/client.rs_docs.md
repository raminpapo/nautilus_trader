# Documentation: `crates/adapters/tardis/src/machine/client.rs`
**Generated:** 2025-11-15T19:40:01.470207Z
...
- **Path:** `crates/adapters/tardis/src/machine/client.rs`
- **Size:** 7,801 bytes
- **Lines:** 216
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/adapters/tardis/src/machine/client.rs` within the repository.

**Classes defined:** TardisMachineClient, TardisMachineClient, Stream, Stream, Stream

**Functions defined:** new, add_instrument_info, is_closed, close, replay, stream, handle_ws_stream, determine_instrument_info
...
#### `new(base_url: Option<&str>, normalize_symbols: bool)`


#### `add_instrument_info(&mut self, info: TardisInstrumentMiniInfo)`
