...
- **`add_instrument_info()`**: Function defined in this file
- **`is_closed()`**: Function defined in this file
- **`close()`**: Function defined in this file
- **`replay()`**: Function defined in this file
- **`stream()`**: Function defined in this file
- **`handle_ws_stream()`**: Function defined in this file
- **`determine_instrument_info()`**: Function defined in this file

### Classes
- **`TardisMachineClient`**: Class defined in this file
...
**Functions**: `add_instrument_info`, `close`, `determine_instrument_info`, `handle_ws_stream`, `is_closed`, `new`, `replay`, `stream`
**Impls**: `Stream`, `TardisMachineClient`
**Structs**: `TardisMachineClient`
...
---
*Generated on 2025-11-18T21:55:00.704976Z*
