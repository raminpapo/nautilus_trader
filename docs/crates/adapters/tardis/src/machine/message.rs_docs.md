...
- **Path**: `crates/adapters/tardis/src/machine/message.rs`
- **Size**: 13,142 bytes
- **Lines**: 346
- **Language**: Rust
...
This file is part of the NautilusTrader repository. It defines 6 function(s) and 7 class(es).

## Detailed Walkthrough

### Functions
- **`test_parse_book_change_message()`**: Function defined in this file
- **`test_parse_book_snapshot_message()`**: Function defined in this file
- **`test_parse_trade_message()`**: Function defined in this file
- **`test_parse_derivative_ticker_message()`**: Function defined in this file
- **`test_parse_bar_message()`**: Function defined in this file
- **`test_parse_disconnect_message()`**: Function defined in this file

### Classes
- **`BookLevel`**: Class defined in this file
- **`BookChangeMsg`**: Class defined in this file
- **`BookSnapshotMsg`**: Class defined in this file
- **`TradeMsg`**: Class defined in this file
- **`DerivativeTickerMsg`**: Class defined in this file
- **`BarMsg`**: Class defined in this file
- **`DisconnectMsg`**: Class defined in this file
...
**Enums**: `WsMessage`
**Functions**: `test_parse_bar_message`, `test_parse_book_change_message`, `test_parse_book_snapshot_message`, `test_parse_derivative_ticker_message`, `test_parse_disconnect_message`, `test_parse_trade_message`
**Structs**: `BarMsg`, `BookChangeMsg`, `BookLevel`, `BookSnapshotMsg`, `DerivativeTickerMsg`, `DisconnectMsg`, `TradeMsg`
...
---
*Generated on 2025-11-18T21:55:00.708252Z*
