# Documentation: `crates/adapters/tardis/src/machine/message.rs`
**Generated:** 2025-11-15T19:40:01.472454Z
**File Size:** 13142 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/adapters/tardis/src/machine/message.rs` within the repository.

**Classes defined:** BookLevel, BookChangeMsg, BookSnapshotMsg, TradeMsg, DerivativeTickerMsg, BarMsg, DisconnectMsg

**Functions defined:** test_parse_book_change_message, test_parse_book_snapshot_message, test_parse_trade_message, test_parse_derivative_ticker_message, test_parse_bar_message, test_parse_disconnect_message
...
#### `test_parse_derivative_ticker_message()`


#### `test_parse_bar_message()`


#### `test_parse_disconnect_message()`
