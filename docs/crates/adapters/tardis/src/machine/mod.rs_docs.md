# Documentation: `crates/adapters/tardis/src/machine/mod.rs`
**Generated:** 2025-11-15T19:40:01.474517Z
...
- **Path:** `crates/adapters/tardis/src/machine/mod.rs`
- **Size:** 9,038 bytes
- **Lines:** 242
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/adapters/tardis/src/machine/mod.rs` within the repository.

**Classes defined:** Stream, Stream, Stream

**Functions defined:** replay_normalized, stream_normalized, stream_from_websocket, handle_connection_response, heartbeat
...
#### `handle_connection_response(ws_resp: tungstenite::http::Response<Option<Vec<u8>>>)`
