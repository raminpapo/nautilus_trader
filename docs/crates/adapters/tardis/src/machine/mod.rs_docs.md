...
### Functions
- **`replay_normalized()`**: Function defined in this file
- **`stream_normalized()`**: Function defined in this file
- **`stream_from_websocket()`**: Function defined in this file
- **`handle_connection_response()`**: Function defined in this file
- **`heartbeat()`**: Function defined in this file
...
**Enums**: `Error`
**Functions**: `handle_connection_response`, `heartbeat`, `replay_normalized`, `stream_from_websocket`, `stream_normalized`
**Impls**: `Stream`
...
---
*Generated on 2025-11-18T21:55:00.711283Z*
