# Documentation: `crates/adapters/tardis/src/parse.rs`
**Generated:** 2025-11-15T19:40:01.482173Z
...
This file is located at `crates/adapters/tardis/src/parse.rs` within the repository.

**Functions defined:** deserialize_uppercase, deserialize_trade_id, normalize_symbol_str, append_suffix, parse_instrument_id, normalize_instrument_id, normalize_amount, parse_price, parse_order_side, parse_aggressor_side and 17 more
...
#### `deserialize_uppercase(deserializer: D)`


#### `deserialize_trade_id(deserializer: D)`
...
#### `append_suffix(symbol: Ustr, suffix: &str)`


#### `parse_instrument_id(exchange: &TardisExchange, symbol: Ustr)`
...
#### `normalize_amount(amount: f64, precision: u8)`


#### `parse_price(value: f64, precision: u8)`


#### `parse_order_side(value: &str)`


#### `parse_aggressor_side(value: &str)`


#### `parse_option_kind(value: TardisOptionType)`


#### `parse_timestamp(value_us: u64)`


#### `parse_book_action(is_snapshot: bool, amount: f64)`


#### `parse_bar_spec(value: &str)`


#### `bar_spec_to_tardis_trade_bar_string(bar_spec: &BarSpecification)`
...
#### `test_normalize_amount(#[case] amount: f64, #[case] precision: u8, #[case] expected: f64)`


#### `test_parse_order_side(#[case] input: &str, #[case] expected: OrderSide)`


#### `test_parse_aggressor_side(#[case] input: &str, #[case] expected: AggressorSide)`


#### `test_parse_timestamp()`


#### `test_parse_book_action(
        #[case] is_snapshot: bool,
        #[case] amount: f64,
        #[case] expected: BookAction,
    )`
...
#### `test_parse_bar_spec_invalid_suffix(#[case] value: &str)`


#### `test_parse_bar_spec_empty(#[case] value: &str)`


#### `test_parse_bar_spec_invalid_step(#[case] value: &str)`


#### `test_to_tardis_string(#[case] bar_spec: BarSpecification, #[case] expected: &str)`
