...
- **Path**: `crates/adapters/tardis/src/parse.rs`
- **Size**: 14,938 bytes
- **Lines**: 450
- **Language**: Rust
...
### Functions
- **`deserialize_uppercase()`**: Function defined in this file
- **`deserialize_trade_id()`**: Function defined in this file
- **`normalize_symbol_str()`**: Function defined in this file
- **`append_suffix()`**: Function defined in this file
- **`parse_instrument_id()`**: Function defined in this file
- **`normalize_instrument_id()`**: Function defined in this file
- **`normalize_amount()`**: Function defined in this file
...
- **`parse_timestamp()`**: Function defined in this file
- **`parse_book_action()`**: Function defined in this file
- **`parse_bar_spec()`**: Function defined in this file
- **`bar_spec_to_tardis_trade_bar_string()`**: Function defined in this file
- **`test_parse_instrument_id()`**: Function defined in this file
- **`test_normalize_instrument_id()`**: Function defined in this file
- **`test_normalize_amount()`**: Function defined in this file
- **`test_parse_order_side()`**: Function defined in this file
- **`test_parse_aggressor_side()`**: Function defined in this file
...
**Functions**: `append_suffix`, `bar_spec_to_tardis_trade_bar_string`, `deserialize_trade_id`, `deserialize_uppercase`, `normalize_amount`, `normalize_instrument_id`, `normalize_symbol_str`, `parse_aggressor_side`, `parse_bar_spec`, `parse_book_action`, `parse_instrument_id`, `parse_option_kind`, `parse_order_side`, `parse_price`, `parse_timestamp`, `test_normalize_amount`, `test_normalize_instrument_id`, `test_parse_aggressor_side`, `test_parse_bar_spec`, `test_parse_bar_spec_empty`, `test_parse_bar_spec_invalid_step`, `test_parse_bar_spec_invalid_suffix`, `test_parse_book_action`, `test_parse_instrument_id`, `test_parse_order_side`, `test_parse_timestamp`, `test_to_tardis_string`
...
---
*Generated on 2025-11-18T21:55:00.722089Z*
