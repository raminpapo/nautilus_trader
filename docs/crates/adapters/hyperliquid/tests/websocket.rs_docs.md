...
- **Path**: `crates/adapters/hyperliquid/tests/websocket.rs`
- **Size**: 43,641 bytes
- **Lines**: 1,382
- **Language**: Rust
...
This file is part of the NautilusTrader repository. It defines 40 function(s) and 1 class(es).
...
- **`cache_test_instruments()`**: Function defined in this file
- **`wait_until_active()`**: Function defined in this file
...
- **`test_is_active_lifecycle()`**: Function defined in this file
- **`test_is_active_false_after_close()`**: Function defined in this file
...
**Functions**: `cache_test_instruments`, `clear_subscription_events`, `connect_client`, `data_path`, `default`, `fail_next_subscription`, `handle_socket`, `handle_ws_upgrade`, `load_json`, `pop_fail_subscription`, `start_ws_server`, `subscription_events`, `test_candle_subscription_survives_reconnection`, `test_client_creation`, `test_close_connection`, `test_heartbeat_timeout_reconnection`, `test_is_active_false_after_close`, `test_is_active_false_during_reconnection`, `test_is_active_lifecycle`, `test_multiple_partial_subscription_failures`, `test_multiple_subscriptions`, `test_rapid_consecutive_reconnections`, `test_reconnection_race_condition`, `test_reconnection_retries_failed_subscriptions`, `test_reconnection_scenario`, `test_sends_pong_for_control_ping`, `test_subscribe_after_next_event_call`, `test_subscribe_orderbook`, `test_subscribe_quotes`, `test_subscribe_trades` *(+10 more)*
**Impls**: `Default`, `TestServerState`
**Structs**: `TestServerState`

## Related Files

This file is located in `crates/adapters/hyperliquid/tests/`. Related files may include:
...
```bash
# For Python
pytest crates/adapters/hyperliquid/tests/websocket.rs
...
---
*Generated on 2025-11-18T21:55:00.140333Z*
