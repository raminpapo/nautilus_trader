# Documentation: `crates/adapters/hyperliquid/tests/websocket.rs`
**Generated:** 2025-11-15T19:40:01.111694Z
**File Size:** 43641 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/adapters/hyperliquid/tests/websocket.rs` within the repository.

**Classes defined:** TestServerState, Default, TestServerState

**Functions defined:** default, clear_subscription_events, subscription_events, fail_next_subscription, pop_fail_subscription, data_path, load_json, handle_ws_upgrade, handle_socket, start_ws_server and 30 more
...
#### `fail_next_subscription(&self, sub_type: &str)`


#### `pop_fail_subscription(&self, sub_type: &str)`
...
#### `connect_client(ws_url: &str, account_id: Option<AccountId>)`


#### `cache_test_instruments(client: &mut HyperliquidWebSocketClient)`
...
#### `test_subscribe_after_next_event_call()`


#### `test_sends_pong_for_control_ping()`


#### `test_unsubscribed_channel_not_resubscribed_after_disconnect()`


#### `test_candle_subscription_survives_reconnection()`
...
**Directory:** `crates/adapters/hyperliquid/tests`
