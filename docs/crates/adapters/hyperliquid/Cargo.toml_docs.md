...
- **Path**: `crates/adapters/hyperliquid/Cargo.toml`
- **Size**: 3,556 bytes
- **Lines**: 135
- **Language**: TOML
...
**Keys**: `ahash`, `all-features`, `alloy`, `alloy-primitives`, `alloy-signer`, `alloy-signer-local`, `alloy-sol-types`, `anyhow`, `arc-swap`, `async-stream`, `async-trait`, `aws-lc-rs`, `axum`, `base64`, `bytes`, `chrono`, `crate-type`, `criterion`, `dashmap`, `default`, `derive_builder`, `description`, `extension-module`, `futures-util`, `hex`, `indexmap`, `log`, `name`, `nautilus-common`, `nautilus-core` *(+36 more)*
**Sections**: `[bin`, `dependencies`, `dev-dependencies`, `features`, `lib`, `lints`, `package`, `package.metadata.docs.rs`

## Related Files

This file is located in `crates/adapters/hyperliquid/`. Related files may include:
...
---
*Generated on 2025-11-18T21:54:59.945492Z*
