# Documentation: signers.rs

## File Metadata

- **Path**: `crates/adapters/hyperliquid/src/signing/signers.rs`
- **Size**: 15,858 bytes
- **Lines**: 435
- **Language**: Rust
...
This file is part of the NautilusTrader repository. It defines 18 function(s) and 7 class(es).
...
- **`sign_l1_action()`**: Function defined in this file
- **`compute_connection_id()`**: Function defined in this file
- **`sign_user_signed_action()`**: Function defined in this file
- **`get_domain_hash()`**: Function defined in this file
- **`hash_typed_data()`**: Function defined in this file
- **`create_eip712_hash()`**: Function defined in this file
- **`sign_hash()`**: Function defined in this file
- **`canonicalize_action()`**: Function defined in this file
- **`canonicalize_address()`**: Function defined in this file
- **`canonicalize_decimal()`**: Function defined in this file
- **`address()`**: Function defined in this file
- **`test_address_canonicalization()`**: Function defined in this file
- **`test_decimal_canonicalization()`**: Function defined in this file
- **`test_action_canonicalization()`**: Function defined in this file
- **`test_sign_request_l1_action()`**: Function defined in this file
- **`test_sign_request_user_action()`**: Function defined in this file

### Classes
- **`for`**: Class defined in this file
- **`Agent`**: Class defined in this file
- **`SignRequest`**: Class defined in this file
- **`SignatureBundle`**: Class defined in this file
- **`HyperliquidEip712Signer`**: Class defined in this file
- **`with`**: Class defined in this file
- **`let`**: Class defined in this file
...
**Functions**: `address`, `canonicalize_action`, `canonicalize_address`, `canonicalize_decimal`, `compute_connection_id`, `create_eip712_hash`, `get_domain_hash`, `hash_typed_data`, `new`, `sign`, `sign_hash`, `sign_l1_action`, `sign_user_signed_action`, `test_action_canonicalization`, `test_address_canonicalization`, `test_decimal_canonicalization`, `test_sign_request_l1_action`, `test_sign_request_user_action`
**Impls**: `HyperliquidEip712Signer`
**Structs**: `Agent`, `HyperliquidEip712Signer`, `SignRequest`, `SignatureBundle`, `for`, `let`, `with`
...
---
*Generated on 2025-11-18T21:55:00.077826Z*
