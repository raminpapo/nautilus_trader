# Documentation: `crates/adapters/hyperliquid/src/websocket/client.rs`
**Generated:** 2025-11-15T19:40:01.077294Z
...
- **Path:** `crates/adapters/hyperliquid/src/websocket/client.rs`
- **Size:** 37,525 bytes
- **Lines:** 934
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/adapters/hyperliquid/src/websocket/client.rs` within the repository.

**Classes defined:** HyperliquidWebSocketClient, Clone, HyperliquidWebSocketClient

**Functions defined:** clone, new, connect, disconnect, is_active, url, subscribe_order_updates, subscribe_user_events, subscribe_all_user_channels, subscribe_trades and 28 more
...
#### `subscribe_order_updates(&self, user: &str)`


#### `subscribe_user_events(&self, user: &str)`


#### `subscribe_all_user_channels(&self, user: &str)`


#### `subscribe_trades(&self, instrument_id: InstrumentId)`


#### `unsubscribe_trades(&self, instrument_id: InstrumentId)`


#### `subscribe_quotes(&self, instrument_id: InstrumentId)`


#### `unsubscribe_quotes(&self, instrument_id: InstrumentId)`


#### `subscribe_book(&self, instrument_id: InstrumentId)`


#### `unsubscribe_book(&self, instrument_id: InstrumentId)`


#### `subscribe_bars(&self, bar_type: BarType)`


#### `unsubscribe_bars(&self, bar_type: BarType)`


#### `subscribe_mark_prices(&self, instrument_id: InstrumentId)`


#### `unsubscribe_mark_prices(&self, instrument_id: InstrumentId)`


#### `subscribe_index_prices(&self, instrument_id: InstrumentId)`
...
#### `subscribe_funding_rates(&self, instrument_id: InstrumentId)`
...
#### `cache_instruments(&mut self, instruments: Vec<InstrumentAny>)`


#### `cache_instrument(&self, instrument: InstrumentAny)`


#### `get_instrument(&self, id: &InstrumentId)`


#### `get_instrument_by_symbol(&self, symbol: &Ustr)`


#### `subscription_count(&self)`


#### `get_bar_type(&self, coin: &str, interval: &str)`


#### `next_event(&mut self)`


#### `subscription_from_topic(topic: &str)`


#### `subscription_topic(sub: &SubscriptionRequest)`
...
#### `test_subscription_reconstruction(#[case] subscription: SubscriptionRequest)`
