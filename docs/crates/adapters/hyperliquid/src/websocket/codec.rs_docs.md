# Documentation: codec.rs

## File Metadata

- **Path**: `crates/adapters/hyperliquid/src/websocket/codec.rs`
- **Size**: 18,610 bytes
- **Lines**: 548
- **Language**: Rust
...
- **`validate_url()`**: Function defined in this file
- **`encode()`**: Function defined in this file
- **`decode()`**: Function defined in this file
- **`serialize_decimal()`**: Function defined in this file
- **`deserialize_decimal()`**: Function defined in this file
- **`encode_outbound()`**: Function defined in this file
- **`decode_inbound()`**: Function defined in this file

### Classes
- **`provides`**: Class defined in this file
- **`HyperliquidCodec`**: Class defined in this file
- **`SubArg`**: Class defined in this file
- **`SubResp`**: Class defined in this file
- **`Notice`**: Class defined in this file
- **`PostAck`**: Class defined in this file
- **`WsTrade`**: Class defined in this file
- **`WsBbo`**: Class defined in this file
- **`WsCandle`**: Class defined in this file
- **`WsBook`**: Class defined in this file
- **`Level`**: Class defined in this file
- **`WsMid`**: Class defined in this file
- **`WsFill`**: Class defined in this file
- **`WsFunding`**: Class defined in this file
- **`WsUserEvent`**: Class defined in this file
...
**Enums**: `Side`, `WsInbound`, `WsOutbound`
**Functions**: `decode`, `decode_inbound`, `deserialize_decimal`, `encode`, `encode_outbound`, `new`, `serialize_decimal`, `validate_url`
**Impls**: `HyperliquidCodec`
**Structs**: `HyperliquidCodec`, `Level`, `Notice`, `PostAck`, `SubArg`, `SubResp`, `WsBbo`, `WsBook`, `WsCandle`, `WsFill`, `WsFunding`, `WsMid`, `WsTrade`, `WsUserEvent`, `provides`
...
---
*Generated on 2025-11-18T21:55:00.093924Z*
