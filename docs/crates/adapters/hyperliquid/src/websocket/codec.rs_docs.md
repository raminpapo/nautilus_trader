# Documentation: `crates/adapters/hyperliquid/src/websocket/codec.rs`
**Generated:** 2025-11-15T19:40:01.080652Z
**File Size:** 18610 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/adapters/hyperliquid/src/websocket/codec.rs` within the repository.

**Classes defined:** provides, HyperliquidCodec, SubArg, SubResp, Notice, PostAck, WsTrade, WsBbo, WsCandle, WsBook and 6 more

**Functions defined:** new, validate_url, encode, decode, serialize_decimal, encode_outbound, decode_inbound
...
#### `encode(&self, request: &HyperliquidWsRequest)`


#### `decode(&self, data: &[u8])`


#### `serialize_decimal(d: &Decimal, s: S)`


#### `encode_outbound(msg: &WsOutbound)`


#### `decode_inbound(msg: &HyperliquidWsMessage)`
