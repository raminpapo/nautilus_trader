# Documentation: `crates/adapters/hyperliquid/src/websocket/messages.rs`
**Generated:** 2025-11-15T19:40:01.092155Z
**File Size:** 27425 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/adapters/hyperliquid/src/websocket/messages.rs` within the repository.

**Classes defined:** ActionPayload, SignatureData, OrderRequest, CancelRequest, CancelByCloidRequest, ModifyRequest, SubscriptionResponseData, PostResponse, AllMidsData, NotificationData and 31 more

**Functions defined:** order, cancel, cancel_by_cloid, modify, format_offset, test_subscription_request_serialization, test_hyperliquid_ws_request_serialization, test_order_request_serialization, test_ws_trade_data_deserialization, test_ws_book_data_deserialization and 3 more
...
#### `order(orders: Vec<OrderRequest>, grouping: impl Into<String>)`


#### `cancel(cancels: Vec<CancelRequest>)`


#### `cancel_by_cloid(cancels: Vec<CancelByCloidRequest>)`


#### `modify(modifies: Vec<ModifyRequest>)`


#### `format_offset(&self, offset: &str)`
