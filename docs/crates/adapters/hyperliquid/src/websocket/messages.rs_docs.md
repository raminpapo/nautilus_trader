...
- **Path**: `crates/adapters/hyperliquid/src/websocket/messages.rs`
- **Size**: 27,425 bytes
- **Lines**: 982
- **Language**: Rust
...
This file is part of the NautilusTrader repository. It defines 13 function(s) and 38 class(es).

## Detailed Walkthrough

### Functions
- **`order()`**: Function defined in this file
- **`cancel()`**: Function defined in this file
- **`cancel_by_cloid()`**: Function defined in this file
- **`modify()`**: Function defined in this file
- **`format_offset()`**: Function defined in this file
- **`test_subscription_request_serialization()`**: Function defined in this file
- **`test_hyperliquid_ws_request_serialization()`**: Function defined in this file
- **`test_order_request_serialization()`**: Function defined in this file
- **`test_ws_trade_data_deserialization()`**: Function defined in this file
- **`test_ws_book_data_deserialization()`**: Function defined in this file
- **`test_ws_trailing_stop_data_deserialization()`**: Function defined in this file
- **`test_ws_trigger_activated_data_deserialization()`**: Function defined in this file
- **`test_ws_trigger_triggered_data_deserialization()`**: Function defined in this file

### Classes
- **`ActionPayload`**: Class defined in this file
- **`SignatureData`**: Class defined in this file
- **`OrderRequest`**: Class defined in this file
- **`CancelRequest`**: Class defined in this file
- **`CancelByCloidRequest`**: Class defined in this file
- **`ModifyRequest`**: Class defined in this file
- **`SubscriptionResponseData`**: Class defined in this file
- **`PostResponse`**: Class defined in this file
- **`AllMidsData`**: Class defined in this file
- **`NotificationData`**: Class defined in this file
- **`CandleData`**: Class defined in this file
- **`WsBookData`**: Class defined in this file
- **`WsLevelData`**: Class defined in this file
- **`WsTradeData`**: Class defined in this file
- **`WsOrderData`**: Class defined in this file
- **`WsBasicOrderData`**: Class defined in this file
- **`WsTrailingStopData`**: Class defined in this file
- **`WsFillData`**: Class defined in this file
- **`FillLiquidationData`**: Class defined in this file
- **`WsUserFundingData`**: Class defined in this file
...
Total unique keywords extracted: 67


**Enums**: `ActionRequest`, `ExecutionReport`, `HyperliquidWsMessage`, `HyperliquidWsRequest`, `NautilusWsMessage`, `OrderTypeRequest`, `PostRequest`, `PostResponsePayload`, `SubscriptionRequest`, `TimeInForceRequest`, `TpSlRequest`, `TrailingOffsetType`, `WsActiveAssetCtxData`, `WsUserEventData`, `allows`
**Functions**: `cancel`, `cancel_by_cloid`, `format_offset`, `modify`, `order`, `test_hyperliquid_ws_request_serialization`, `test_order_request_serialization`, `test_subscription_request_serialization`, `test_ws_book_data_deserialization`, `test_ws_trade_data_deserialization`, `test_ws_trailing_stop_data_deserialization`, `test_ws_trigger_activated_data_deserialization`, `test_ws_trigger_triggered_data_deserialization`
**Impls**: `ActionRequest`, `Into`, `TrailingOffsetType`
**Structs**: `ActionPayload`, `AllMidsData`, `CancelByCloidRequest`, `CancelRequest`, `CandleData`, `FillLiquidationData`, `LeverageData`, `ModifyRequest`, `NotificationData`, `OrderRequest`, `PerpsAssetCtx`, `PostResponse`, `SharedAssetCtx`, `SignatureData`, `SpotAssetCtx`, `SubscriptionResponseData`, `TwapStateData`, `TwapStatusData`, `WsActiveAssetData`, `WsBasicOrderData`, `WsBboData`, `WsBookData`, `WsFillData`, `WsLevelData`, `WsLiquidationData`, `WsNonUserCancelData`, `WsOrderData`, `WsTradeData`, `WsTrailingStopData`, `WsTriggerActivatedData` *(+8 more)*
...
---
*Generated on 2025-11-18T21:55:00.109775Z*
