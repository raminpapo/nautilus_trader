# Documentation: `crates/adapters/hyperliquid/src/websocket/enums.rs`
**Generated:** 2025-11-15T19:40:01.083083Z
**File Size:** 8104 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/adapters/hyperliquid/src/websocket/enums.rs` within the repository.

**Classes defined:** HyperliquidWsChannel

**Functions defined:** as_str, is_public, is_private, test_channel_serialization, test_channel_deserialization, test_as_str_method, test_display_trait, test_is_public_channel, test_is_private_channel, test_enum_iter and 1 more
...
#### `test_channel_serialization(#[case] channel: HyperliquidWsChannel, #[case] expected: &str)`


#### `test_channel_deserialization(#[case] json: &str, #[case] expected: HyperliquidWsChannel)`


#### `test_as_str_method(#[case] channel: HyperliquidWsChannel, #[case] expected: &str)`
