...
- **Path**: `crates/adapters/hyperliquid/src/websocket/parse.rs`
- **Size**: 23,516 bytes
- **Lines**: 691
- **Language**: Rust
...
- **`parse_ws_order_book_deltas()`**: Function defined in this file
- **`parse_ws_quote_tick()`**: Function defined in this file
- **`parse_ws_candle()`**: Function defined in this file
- **`parse_ws_order_status_report()`**: Function defined in this file
- **`parse_ws_fill_report()`**: Function defined in this file
- **`parse_ws_asset_context()`**: Function defined in this file
- **`parse_f64_price()`**: Function defined in this file
- **`create_test_instrument()`**: Function defined in this file
- **`test_parse_ws_order_status_report_basic()`**: Function defined in this file
- **`test_parse_ws_fill_report_basic()`**: Function defined in this file
- **`test_parse_ws_order_book_deltas_snapshot_behavior()`**: Function defined in this file
- **`test_parse_ws_asset_context_perp()`**: Function defined in this file
- **`test_parse_ws_asset_context_spot()`**: Function defined in this file
...
**Functions**: `create_test_instrument`, `parse_f64_price`, `parse_price`, `parse_quantity`, `parse_ws_asset_context`, `parse_ws_candle`, `parse_ws_fill_report`, `parse_ws_order_book_deltas`, `parse_ws_order_status_report`, `parse_ws_quote_tick`, `parse_ws_trade_tick`, `test_parse_ws_asset_context_perp`, `test_parse_ws_asset_context_spot`, `test_parse_ws_fill_report_basic`, `test_parse_ws_order_book_deltas_snapshot_behavior`, `test_parse_ws_order_status_report_basic`
...
---
*Generated on 2025-11-18T21:55:00.116251Z*
