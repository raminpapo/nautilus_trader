...
- **Path**: `crates/adapters/hyperliquid/src/websocket/handler.rs`
- **Size**: 29,616 bytes
- **Lines**: 710
- **Language**: Rust
...
- **`handle_order_updates()`**: Function defined in this file
- **`handle_user_fills()`**: Function defined in this file
- **`handle_trades()`**: Function defined in this file
- **`handle_bbo()`**: Function defined in this file
- **`handle_l2_book()`**: Function defined in this file
- **`handle_candle()`**: Function defined in this file
- **`handle_asset_context()`**: Function defined in this file
- **`subscription_to_key()`**: Function defined in this file
- **`should_retry_hyperliquid_error()`**: Function defined in this file
- **`create_hyperliquid_timeout_error()`**: Function defined in this file
...
**Functions**: `create_hyperliquid_timeout_error`, `handle_asset_context`, `handle_bbo`, `handle_candle`, `handle_l2_book`, `handle_order_updates`, `handle_trades`, `handle_user_fills`, `is_stopped`, `new`, `next`, `parse_to_nautilus_messages`, `send`, `send_with_retry`, `should_retry_hyperliquid_error`, `subscription_to_key`
**Impls**: `FeedHandler`
**Structs**: `FeedHandler`
...
---
*Generated on 2025-11-18T21:55:00.104023Z*
