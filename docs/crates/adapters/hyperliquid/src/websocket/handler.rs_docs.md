# Documentation: `crates/adapters/hyperliquid/src/websocket/handler.rs`
**Generated:** 2025-11-15T19:40:01.088314Z
...
This file is located at `crates/adapters/hyperliquid/src/websocket/handler.rs` within the repository.

**Classes defined:** FeedHandler, FeedHandler

**Functions defined:** new, send, is_stopped, send_with_retry, next, parse_to_nautilus_messages, handle_order_updates, handle_user_fills, handle_trades, handle_bbo and 6 more
...
#### `subscription_to_key(sub: &SubscriptionRequest)`


#### `should_retry_hyperliquid_error(error: &HyperliquidWsError)`


#### `create_hyperliquid_timeout_error(msg: String)`
