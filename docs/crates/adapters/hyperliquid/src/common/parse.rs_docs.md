...
- **Path**: `crates/adapters/hyperliquid/src/common/parse.rs`
- **Size**: 42,285 bytes
- **Lines**: 1,192
- **Language**: Rust
...
This file is part of the NautilusTrader repository. It defines 47 function(s) and 1 class(es).

## Detailed Walkthrough

### Functions
- **`serialize_decimal_as_str()`**: Function defined in this file
- **`deserialize_decimal_from_str()`**: Function defined in this file
- **`serialize_optional_decimal_as_str()`**: Function defined in this file
- **`deserialize_optional_decimal_from_str()`**: Function defined in this file
- **`serialize_vec_decimal_as_str()`**: Function defined in this file
- **`deserialize_vec_decimal_from_str()`**: Function defined in this file
- **`round_down_to_tick()`**: Function defined in this file
- **`round_down_to_step()`**: Function defined in this file
- **`ensure_min_notional()`**: Function defined in this file
- **`normalize_price()`**: Function defined in this file
- **`normalize_quantity()`**: Function defined in this file
- **`normalize_order()`**: Function defined in this file
- **`parse_millis_to_nanos()`**: Function defined in this file
- **`time_in_force_to_hyperliquid_tif()`**: Function defined in this file
- **`extract_asset_id_from_symbol()`**: Function defined in this file
- **`determine_tpsl_type()`**: Function defined in this file
- **`bar_type_to_interval()`**: Function defined in this file
- **`order_to_hyperliquid_request()`**: Function defined in this file
- **`orders_to_hyperliquid_requests()`**: Function defined in this file
- **`orders_to_hyperliquid_action_value()`**: Function defined in this file
...
**Enums**: `type`
**Functions**: `bar_type_to_interval`, `client_order_id_to_cancel_request`, `deserialize_decimal_from_str`, `deserialize_optional_decimal_from_str`, `deserialize_vec_decimal_from_str`, `determine_tpsl_type`, `ensure_min_notional`, `extract_asset_id_from_symbol`, `extract_error_message`, `format_trailing_stop_info`, `is_conditional_order_data`, `is_response_successful`, `normalize_order`, `normalize_price`, `normalize_quantity`, `order_any_to_hyperliquid_request`, `order_to_hyperliquid_request`, `orders_to_hyperliquid_action_value`, `orders_to_hyperliquid_requests`, `parse_account_balances_and_margins`, `parse_millis_to_nanos`, `parse_order_status_with_trigger`, `parse_trigger_order_type`, `parse_trigger_price`, `round_down_to_step`, `round_down_to_tick`, `serialize_decimal_as_str`, `serialize_optional_decimal_as_str`, `serialize_vec_decimal_as_str`, `test_decimal_precision_preservation` *(+17 more)*
**Structs**: `TestStruct`
...
---
*Generated on 2025-11-18T21:54:59.998089Z*
