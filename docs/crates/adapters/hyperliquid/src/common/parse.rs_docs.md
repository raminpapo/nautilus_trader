# Documentation: `crates/adapters/hyperliquid/src/common/parse.rs`
**Generated:** 2025-11-15T19:40:01.011354Z
**File Size:** 42889 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/adapters/hyperliquid/src/common/parse.rs` within the repository.

**Classes defined:** TestStruct

**Functions defined:** serialize_decimal_as_str, deserialize_decimal_from_str, serialize_optional_decimal_as_str, deserialize_optional_decimal_from_str, serialize_vec_decimal_as_str, deserialize_vec_decimal_from_str, round_down_to_tick, round_down_to_step, ensure_min_notional, normalize_price and 37 more
...
#### `serialize_decimal_as_str(decimal: &Decimal, serializer: S)`


#### `deserialize_decimal_from_str(deserializer: D)`
...
#### `deserialize_vec_decimal_from_str(deserializer: D)`


#### `round_down_to_tick(price: Decimal, tick_size: Decimal)`


#### `round_down_to_step(qty: Decimal, step_size: Decimal)`
...
#### `normalize_price(price: Decimal, decimals: u8)`


#### `normalize_quantity(qty: Decimal, decimals: u8)`
...
#### `parse_millis_to_nanos(millis: u64)`
...
#### `extract_asset_id_from_symbol(symbol: &str)`
...
#### `bar_type_to_interval(bar_type: &BarType)`
...
#### `orders_to_hyperliquid_action_value(orders: &[&OrderAny])`
...
#### `is_response_successful(response: &HyperliquidExchangeResponse)`


#### `extract_error_message(response: &HyperliquidExchangeResponse)`


#### `is_conditional_order_data(trigger_px: Option<&str>, tpsl: Option<&HyperliquidTpSl>)`


#### `parse_trigger_order_type(is_market: bool, tpsl: &HyperliquidTpSl)`
...
#### `parse_trigger_price(trigger_px: &str)`
