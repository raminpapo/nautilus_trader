# Documentation: `crates/adapters/hyperliquid/src/common/converters.rs`
**Generated:** 2025-11-15T19:40:00.989659Z
**File Size:** 16445 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/adapters/hyperliquid/src/common/converters.rs` within the repository.

**Functions defined:** nautilus_order_type_to_hyperliquid, hyperliquid_order_type_to_nautilus, hyperliquid_conditional_to_nautilus, nautilus_to_hyperliquid_conditional, nautilus_time_in_force_to_hyperliquid, hyperliquid_time_in_force_to_nautilus, determine_tpsl_type, test_nautilus_to_hyperliquid_limit_order, test_nautilus_to_hyperliquid_stop_market, test_nautilus_to_hyperliquid_stop_limit and 10 more
...
#### `hyperliquid_order_type_to_nautilus(hl_order_type: &HyperliquidOrderType)`
...
#### `nautilus_time_in_force_to_hyperliquid(tif: TimeInForce)`


#### `hyperliquid_time_in_force_to_nautilus(hl_tif: HyperliquidTimeInForce)`


#### `determine_tpsl_type(order_type: OrderType, is_buy: bool)`
