# Documentation: converters.rs

## File Metadata

- **Path**: `crates/adapters/hyperliquid/src/common/converters.rs`
- **Size**: 16,445 bytes
- **Lines**: 491
- **Language**: Rust
...
### Functions
- **`nautilus_order_type_to_hyperliquid()`**: Function defined in this file
- **`hyperliquid_order_type_to_nautilus()`**: Function defined in this file
- **`hyperliquid_conditional_to_nautilus()`**: Function defined in this file
- **`nautilus_to_hyperliquid_conditional()`**: Function defined in this file
- **`nautilus_time_in_force_to_hyperliquid()`**: Function defined in this file
- **`hyperliquid_time_in_force_to_nautilus()`**: Function defined in this file
- **`determine_tpsl_type()`**: Function defined in this file
- **`test_nautilus_to_hyperliquid_limit_order()`**: Function defined in this file
- **`test_nautilus_to_hyperliquid_stop_market()`**: Function defined in this file
- **`test_nautilus_to_hyperliquid_stop_limit()`**: Function defined in this file
- **`test_nautilus_to_hyperliquid_take_profit_market()`**: Function defined in this file
- **`test_nautilus_to_hyperliquid_take_profit_limit()`**: Function defined in this file
- **`test_hyperliquid_to_nautilus_limit()`**: Function defined in this file
- **`test_hyperliquid_to_nautilus_stop_market()`**: Function defined in this file
- **`test_hyperliquid_to_nautilus_stop_limit()`**: Function defined in this file
- **`test_hyperliquid_to_nautilus_take_profit_market()`**: Function defined in this file
- **`test_hyperliquid_to_nautilus_take_profit_limit()`**: Function defined in this file
- **`test_time_in_force_conversions()`**: Function defined in this file
- **`test_conditional_order_type_conversions()`**: Function defined in this file
- **`test_determine_tpsl_type()`**: Function defined in this file
...
**Functions**: `determine_tpsl_type`, `hyperliquid_conditional_to_nautilus`, `hyperliquid_order_type_to_nautilus`, `hyperliquid_time_in_force_to_nautilus`, `nautilus_order_type_to_hyperliquid`, `nautilus_time_in_force_to_hyperliquid`, `nautilus_to_hyperliquid_conditional`, `test_conditional_order_type_conversions`, `test_determine_tpsl_type`, `test_hyperliquid_to_nautilus_limit`, `test_hyperliquid_to_nautilus_stop_limit`, `test_hyperliquid_to_nautilus_stop_market`, `test_hyperliquid_to_nautilus_take_profit_limit`, `test_hyperliquid_to_nautilus_take_profit_market`, `test_nautilus_to_hyperliquid_limit_order`, `test_nautilus_to_hyperliquid_stop_limit`, `test_nautilus_to_hyperliquid_stop_market`, `test_nautilus_to_hyperliquid_take_profit_limit`, `test_nautilus_to_hyperliquid_take_profit_market`, `test_time_in_force_conversions`
...
---
*Generated on 2025-11-18T21:54:59.966023Z*
