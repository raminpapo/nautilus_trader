...
- **Path**: `crates/adapters/hyperliquid/src/common/models.rs`
- **Size**: 52,427 bytes
- **Lines**: 1,492
- **Language**: Rust
...
This file is part of the NautilusTrader repository. It defines 62 function(s) and 7 class(es).

## Detailed Walkthrough

### Functions
- **`new()`**: Function defined in this file
- **`with_metadata()`**: Function defined in this file
- **`with_precision()`**: Function defined in this file
- **`default_crypto()`**: Function defined in this file
- **`new()`**: Function defined in this file
- **`insert()`**: Function defined in this file
- **`get()`**: Function defined in this file
- **`get_all()`**: Function defined in this file
- **`contains()`**: Function defined in this file
- **`len()`**: Function defined in this file
- **`is_empty()`**: Function defined in this file
- **`clear()`**: Function defined in this file
- **`default()`**: Function defined in this file
- **`new()`**: Function defined in this file
- **`create_latency_model()`**: Function defined in this file
- **`create_default_latency_model()`**: Function defined in this file
- **`normalize_order_for_symbol()`**: Function defined in this file
- **`configure_instrument()`**: Function defined in this file
- **`get_config()`**: Function defined in this file
- **`convert_http_snapshot()`**: Function defined in this file

*...and 42 more functions*

### Classes
- **`HyperliquidInstrumentInfo`**: Class defined in this file
- **`HyperliquidInstrumentCache`**: Class defined in this file
- **`HyperliquidDataConverter`**: Class defined in this file
- **`is`**: Class defined in this file
- **`HyperliquidPositionData`**: Class defined in this file
- **`HyperliquidBalance`**: Class defined in this file
- **`HyperliquidAccountState`**: Class defined in this file


## Keywords and Identifiers

Total unique keywords extracted: 74


**Enums**: `ConversionError`, `HyperliquidAccountEvent`, `HyperliquidTradeKey`, `represents`
**Functions**: `account_value`, `apply`, `clear`, `configure_instrument`, `contains`, `convert_delta_update`, `convert_http_snapshot`, `convert_ws_snapshot`, `create_default_latency_model`, `create_latency_model`, `default`, `default_crypto`, `fmt`, `from`, `get`, `get_all`, `get_balance`, `get_config`, `insert`, `is_empty`, `is_flat`, `is_long`, `is_short`, `len`, `load_test_data`, `locked`, `new`, `normalize_order_for_symbol`, `parse_level`, `parse_position_status_report` *(+28 more)*
**Impls**: `Default`, `Display`, `From`, `HyperliquidAccountState`, `HyperliquidBalance`, `HyperliquidDataConverter`, `HyperliquidInstrumentCache`, `HyperliquidInstrumentInfo`, `HyperliquidPositionData`, `std`
**Structs**: `HyperliquidAccountState`, `HyperliquidBalance`, `HyperliquidDataConverter`, `HyperliquidInstrumentCache`, `HyperliquidInstrumentInfo`, `HyperliquidPositionData`, `is`
**Traits**: `works`
...
---
*Generated on 2025-11-18T21:54:59.987629Z*
