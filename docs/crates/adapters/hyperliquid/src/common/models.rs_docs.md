# Documentation: `crates/adapters/hyperliquid/src/common/models.rs`
**Generated:** 2025-11-15T19:40:01.005108Z
**File Size:** 52406 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/adapters/hyperliquid/src/common/models.rs` within the repository.

**Classes defined:** HyperliquidInstrumentInfo, HyperliquidInstrumentCache, HyperliquidDataConverter, is, HyperliquidPositionData, HyperliquidBalance, HyperliquidAccountState, HyperliquidInstrumentInfo, HyperliquidInstrumentCache, Default and 8 more

**Functions defined:** new, with_metadata, with_precision, default_crypto, new, insert, get, get_all, contains, len and 52 more
...
#### `new(instrument_id: InstrumentId, price_decimals: u8, size_decimals: u8)`
...
#### `default_crypto(instrument_id: InstrumentId)`


#### `new()`


#### `insert(&mut self, symbol: &str, info: HyperliquidInstrumentInfo)`
...
#### `create_default_latency_model(&self)`
...
#### `configure_instrument(&mut self, symbol: &str, config: HyperliquidInstrumentInfo)`


#### `get_config(&self, symbol: &Ustr)`
...
#### `apply(&mut self, event: HyperliquidAccountEvent)`
