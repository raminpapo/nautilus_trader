...
- **Path**: `crates/adapters/hyperliquid/src/python/websocket.rs`
- **Size**: 22,759 bytes
- **Lines**: 605
- **Language**: Rust
...
- **`py_url()`**: Function defined in this file
- **`py_is_active()`**: Function defined in this file
- **`py_is_closed()`**: Function defined in this file
- **`py_connect()`**: Function defined in this file
- **`py_wait_until_active()`**: Function defined in this file
- **`py_close()`**: Function defined in this file
- **`py_subscribe_trades()`**: Function defined in this file
- **`py_unsubscribe_trades()`**: Function defined in this file
- **`py_subscribe_book()`**: Function defined in this file
- **`py_unsubscribe_book()`**: Function defined in this file
- **`py_subscribe_book_deltas()`**: Function defined in this file
- **`py_unsubscribe_book_deltas()`**: Function defined in this file
- **`py_subscribe_book_snapshots()`**: Function defined in this file
- **`py_subscribe_quotes()`**: Function defined in this file
- **`py_unsubscribe_quotes()`**: Function defined in this file
- **`py_subscribe_bars()`**: Function defined in this file
- **`py_unsubscribe_bars()`**: Function defined in this file
- **`py_subscribe_order_updates()`**: Function defined in this file
- **`py_subscribe_user_events()`**: Function defined in this file
...
**Functions**: `py_close`, `py_connect`, `py_is_active`, `py_is_closed`, `py_new`, `py_subscribe_bars`, `py_subscribe_book`, `py_subscribe_book_deltas`, `py_subscribe_book_snapshots`, `py_subscribe_funding_rates`, `py_subscribe_index_prices`, `py_subscribe_mark_prices`, `py_subscribe_order_updates`, `py_subscribe_quotes`, `py_subscribe_trades`, `py_subscribe_user_events`, `py_unsubscribe_bars`, `py_unsubscribe_book`, `py_unsubscribe_book_deltas`, `py_unsubscribe_funding_rates`, `py_unsubscribe_index_prices`, `py_unsubscribe_mark_prices`, `py_unsubscribe_quotes`, `py_unsubscribe_trades`, `py_url`, `py_wait_until_active`
**Impls**: `HyperliquidWebSocketClient`
...
---
*Generated on 2025-11-18T21:55:00.069859Z*
