# Documentation: `crates/adapters/hyperliquid/src/python/http.rs`
**Generated:** 2025-11-15T19:40:01.058661Z
**File Size:** 16055 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/adapters/hyperliquid/src/python/http.rs` within the repository.

**Classes defined:** HyperliquidHttpClient

**Functions defined:** py_new, py_from_env, py_from_credentials, py_get_perp_meta, py_get_spot_meta, py_get_l2_book, py_load_instrument_definitions, py_submit_order, py_cancel_order, py_submit_orders and 8 more
...
#### `py_get_perp_meta(&self, py: Python<'py>)`


#### `py_get_spot_meta(&self, py: Python<'py>)`


#### `py_get_l2_book(&self, py: Python<'py>, coin: &str)`
...
#### `py_get_open_orders(&self, py: Python<'py>)`


#### `py_get_clearinghouse_state(&self, py: Python<'py>)`


#### `py_cache_instrument(&self, py: Python<'_>, instrument: Py<PyAny>)`


#### `py_set_account_id(&mut self, account_id: &str)`


#### `py_get_user_address(&self)`
