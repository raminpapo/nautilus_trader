...
- **Path**: `crates/adapters/hyperliquid/src/python/http.rs`
- **Size**: 15,571 bytes
- **Lines**: 438
- **Language**: Rust
...
- **`py_from_credentials()`**: Function defined in this file
- **`py_cache_instrument()`**: Function defined in this file
- **`py_set_account_id()`**: Function defined in this file
- **`py_get_user_address()`**: Function defined in this file
- **`py_get_perp_meta()`**: Function defined in this file
- **`py_get_spot_meta()`**: Function defined in this file
- **`py_get_l2_book()`**: Function defined in this file
- **`py_load_instrument_definitions()`**: Function defined in this file
- **`py_request_quote_ticks()`**: Function defined in this file
- **`py_request_trade_ticks()`**: Function defined in this file
...
- **`py_submit_orders()`**: Function defined in this file
- **`py_get_open_orders()`**: Function defined in this file
- **`py_get_clearinghouse_state()`**: Function defined in this file
...
**Functions**: `py_cache_instrument`, `py_cancel_order`, `py_from_credentials`, `py_from_env`, `py_get_clearinghouse_state`, `py_get_l2_book`, `py_get_open_orders`, `py_get_perp_meta`, `py_get_spot_meta`, `py_get_user_address`, `py_load_instrument_definitions`, `py_new`, `py_request_bars`, `py_request_fill_reports`, `py_request_order_status_reports`, `py_request_position_status_reports`, `py_request_quote_ticks`, `py_request_trade_ticks`, `py_set_account_id`, `py_submit_order`, `py_submit_orders`
**Impls**: `HyperliquidHttpClient`
...
---
*Generated on 2025-11-18T21:55:00.062793Z*
