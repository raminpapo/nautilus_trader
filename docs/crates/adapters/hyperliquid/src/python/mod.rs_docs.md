# Documentation: `crates/adapters/hyperliquid/src/python/mod.rs`
**Generated:** 2025-11-15T19:40:01.060476Z
...
This file is located at `crates/adapters/hyperliquid/src/python/mod.rs` within the repository.

**Functions defined:** py_hyperliquid_product_type_from_symbol, hyperliquid
...
#### `hyperliquid(m: &Bound<'_, PyModule>)`
