# Documentation: `crates/adapters/hyperliquid/src/data/mod.rs`
**Generated:** 2025-11-15T19:40:01.019372Z
...
- **Path:** `crates/adapters/hyperliquid/src/data/mod.rs`
- **Size:** 35,520 bytes
- **Lines:** 967
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/adapters/hyperliquid/src/data/mod.rs` within the repository.

**Classes defined:** HyperliquidDataClient, HyperliquidDataClient, HyperliquidDataClient, DataClient

**Functions defined:** new, venue, bootstrap_instruments, spawn_ws, handle_ws_message, get_instrument, datetime_to_unix_nanos, send_data, client_id, venue and 24 more
...
#### `new(client_id: ClientId, config: HyperliquidDataClientConfig)`
...
#### `subscribe_trades(&mut self, subscription: &SubscribeTrades)`


#### `unsubscribe_trades(&mut self, unsubscription: &UnsubscribeTrades)`


#### `subscribe_book_deltas(&mut self, subscription: &SubscribeBookDeltas)`
...
#### `subscribe_quotes(&mut self, subscription: &SubscribeQuotes)`


#### `unsubscribe_quotes(&mut self, unsubscription: &UnsubscribeQuotes)`


#### `subscribe_bars(&mut self, subscription: &SubscribeBars)`


#### `unsubscribe_bars(&mut self, unsubscription: &UnsubscribeBars)`
...
**Directory:** `crates/adapters/hyperliquid/src/data`
