...
- **`request_instruments()`**: Function defined in this file
- **`request_instrument()`**: Function defined in this file

*...and 14 more functions*

### Classes
- **`HyperliquidDataClient`**: Class defined in this file
...
**Functions**: `bootstrap_instruments`, `candle_to_bar`, `client_id`, `connect`, `datetime_to_unix_nanos`, `disconnect`, `dispose`, `get_instrument`, `handle_ws_message`, `is_connected`, `is_disconnected`, `new`, `request_bars`, `request_bars_from_http`, `request_instrument`, `request_instruments`, `request_trades`, `reset`, `send_data`, `spawn_ws`, `start`, `stop`, `subscribe_bars`, `subscribe_book_deltas`, `subscribe_book_snapshots`, `subscribe_quotes`, `subscribe_trades`, `unsubscribe_bars`, `unsubscribe_book_deltas`, `unsubscribe_book_snapshots` *(+3 more)*
**Impls**: `DataClient`, `HyperliquidDataClient`
**Structs**: `HyperliquidDataClient`

## Related Files

This file is located in `crates/adapters/hyperliquid/src/data/`. Related files may include:
...
---
*Generated on 2025-11-18T21:55:00.007325Z*
