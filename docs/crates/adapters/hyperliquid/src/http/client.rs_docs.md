# Documentation: `crates/adapters/hyperliquid/src/http/client.rs`
**Generated:** 2025-11-15T19:40:01.032828Z
...
This file is located at `crates/adapters/hyperliquid/src/http/client.rs` within the repository.

**Classes defined:** HyperliquidHttpClient, with, with, Default, HyperliquidHttpClient

**Functions defined:** default, new, with_credentials, from_env, from_credentials, with_rate_limits, is_testnet, get_user_address, cache_instrument, get_or_create_instrument and 35 more
...
#### `set_account_id(&mut self, account_id: AccountId)`
...
#### `get_perp_meta_and_ctxs(&self)`


#### `get_spot_meta_and_ctxs(&self)`


#### `request_instruments(&self)`


#### `load_perp_meta(&self)`


#### `info_l2_book(&self, coin: &str)`


#### `info_user_fills(&self, user: &str)`


#### `info_order_status(&self, user: &str, oid: u64)`


#### `info_open_orders(&self, user: &str)`


#### `info_frontend_open_orders(&self, user: &str)`


#### `info_clearinghouse_state(&self, user: &str)`
...
#### `send_info_request_raw(&self, request: &InfoRequest)`


#### `send_info_request(&self, request: &InfoRequest)`
...
#### `parse_retry_after_simple(&self, headers: &HashMap<String, String>)`
...
**Security:** This file may contain sensitive patterns: secret, token, private_key, credential, auth. Ensure proper handling of secrets.
