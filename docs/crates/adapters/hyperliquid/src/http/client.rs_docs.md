...
- **Path**: `crates/adapters/hyperliquid/src/http/client.rs`
- **Size**: 80,511 bytes
- **Lines**: 2,048
- **Language**: Rust
...
This file is part of the NautilusTrader repository. It defines 64 function(s) and 4 class(es).
...
- **`from_env()`**: Function defined in this file
- **`from_credentials()`**: Function defined in this file
- **`with_rate_limits()`**: Function defined in this file
- **`is_testnet()`**: Function defined in this file
- **`get_user_address()`**: Function defined in this file
- **`default_headers()`**: Function defined in this file
- **`signer_id()`**: Function defined in this file
- **`parse_retry_after_simple()`**: Function defined in this file
- **`info_meta()`**: Function defined in this file
- **`get_spot_meta()`**: Function defined in this file
- **`get_perp_meta_and_ctxs()`**: Function defined in this file
- **`get_spot_meta_and_ctxs()`**: Function defined in this file
- **`load_perp_meta()`**: Function defined in this file
- **`info_l2_book()`**: Function defined in this file
- **`info_user_fills()`**: Function defined in this file
- **`info_order_status()`**: Function defined in this file
- **`info_open_orders()`**: Function defined in this file
- **`info_frontend_open_orders()`**: Function defined in this file

*...and 44 more functions*

### Classes
- **`HyperliquidRawHttpClient`**: Class defined in this file
- **`with`**: Class defined in this file
- **`with`**: Class defined in this file
- **`HyperliquidHttpClient`**: Class defined in this file
...
**Functions**: `cache_instrument`, `cancel_order`, `create_order_status_report`, `default`, `default_headers`, `from_credentials`, `from_env`, `get_or_create_instrument`, `get_perp_meta_and_ctxs`, `get_spot_meta`, `get_spot_meta_and_ctxs`, `get_user_address`, `http_roundtrip_exchange`, `http_roundtrip_info`, `info_candle_snapshot`, `info_clearinghouse_state`, `info_frontend_open_orders`, `info_l2_book`, `info_meta`, `info_open_orders`, `info_order_status`, `info_pretty_shape`, `info_user_fills`, `is_testnet`, `load_perp_meta`, `new`, `parse_retry_after_simple`, `post_action`, `post_action_exec`, `request_bars` *(+16 more)*
**Impls**: `Default`, `HyperliquidHttpClient`, `HyperliquidRawHttpClient`
**Structs**: `HyperliquidHttpClient`, `HyperliquidRawHttpClient`, `with`
...
---
*Generated on 2025-11-18T21:55:00.028482Z*
