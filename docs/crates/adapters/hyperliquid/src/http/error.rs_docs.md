# Documentation: `crates/adapters/hyperliquid/src/http/error.rs`
**Generated:** 2025-11-15T19:40:01.035910Z
...
This file is located at `crates/adapters/hyperliquid/src/http/error.rs` within the repository.

**Classes defined:** Error, Into, Into, Into, Into, Into, Into, Into

**Functions defined:** transport, auth, rate_limit, nonce_window, bad_request, exchange, decode, http, from_http_status, from_reqwest and 7 more
...
#### `transport(msg: impl Into<String>)`


#### `auth(msg: impl Into<String>)`


#### `rate_limit(scope: &'static str, weight: u32, retry_after_ms: Option<u64>)`


#### `nonce_window(msg: impl Into<String>)`


#### `bad_request(msg: impl Into<String>)`


#### `exchange(msg: impl Into<String>)`


#### `decode(msg: impl Into<String>)`


#### `http(status: u16, message: impl Into<String>)`


#### `from_http_status(status: reqwest::StatusCode, body: &[u8])`


#### `from_reqwest(error: reqwest::Error)`


#### `from_http_client(error: nautilus_network::http::HttpClientError)`
