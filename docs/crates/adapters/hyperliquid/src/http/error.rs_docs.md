...
- **Path**: `crates/adapters/hyperliquid/src/http/error.rs`
- **Size**: 8,160 bytes
- **Lines**: 244
- **Language**: Rust
...
### Functions
- **`transport()`**: Function defined in this file
- **`auth()`**: Function defined in this file
- **`rate_limit()`**: Function defined in this file
- **`nonce_window()`**: Function defined in this file
- **`bad_request()`**: Function defined in this file
- **`exchange()`**: Function defined in this file
- **`decode()`**: Function defined in this file
- **`http()`**: Function defined in this file
- **`from_http_status()`**: Function defined in this file
- **`from_reqwest()`**: Function defined in this file
- **`from_http_client()`**: Function defined in this file
- **`is_retryable()`**: Function defined in this file
- **`is_rate_limited()`**: Function defined in this file
- **`is_auth_error()`**: Function defined in this file
- **`test_error_constructors()`**: Function defined in this file
- **`test_error_display()`**: Function defined in this file
- **`test_retryable_errors()`**: Function defined in this file
...
**Enums**: `Error`
**Functions**: `auth`, `bad_request`, `decode`, `exchange`, `from_http_client`, `from_http_status`, `from_reqwest`, `http`, `is_auth_error`, `is_rate_limited`, `is_retryable`, `nonce_window`, `rate_limit`, `test_error_constructors`, `test_error_display`, `test_retryable_errors`, `transport`
**Impls**: `Error`, `Into`
...
---
*Generated on 2025-11-18T21:55:00.031441Z*
