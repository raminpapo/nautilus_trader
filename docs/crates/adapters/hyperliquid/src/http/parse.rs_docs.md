# Documentation: `crates/adapters/hyperliquid/src/http/parse.rs`
**Generated:** 2025-11-15T19:40:01.046144Z
**File Size:** 28545 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/adapters/hyperliquid/src/http/parse.rs` within the repository.

**Classes defined:** HyperliquidInstrumentDef

**Functions defined:** parse_perp_instruments, parse_spot_instruments, pow10_neg, get_currency, create_instrument_from_def, instruments_from_defs, instruments_from_defs_owned, parse_fill_side, parse_order_status_report_from_ws, parse_order_status_report_from_basic and 10 more
...
#### `parse_perp_instruments(meta: &PerpMeta)`


#### `parse_spot_instruments(meta: &SpotMeta)`


#### `pow10_neg(decimals: u32)`
...
#### `instruments_from_defs_owned(defs: Vec<HyperliquidInstrumentDef>)`


#### `parse_fill_side(side: &HyperliquidSide)`
