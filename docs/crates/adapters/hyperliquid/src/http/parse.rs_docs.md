...
- **Path**: `crates/adapters/hyperliquid/src/http/parse.rs`
- **Size**: 28,370 bytes
- **Lines**: 838
- **Language**: Rust
...
### Functions
- **`parse_perp_instruments()`**: Function defined in this file
- **`parse_spot_instruments()`**: Function defined in this file
- **`pow10_neg()`**: Function defined in this file
- **`get_currency()`**: Function defined in this file
- **`create_instrument_from_def()`**: Function defined in this file
- **`instruments_from_defs()`**: Function defined in this file
- **`instruments_from_defs_owned()`**: Function defined in this file
- **`parse_fill_side()`**: Function defined in this file
- **`parse_order_status_report_from_ws()`**: Function defined in this file
- **`parse_order_status_report_from_basic()`**: Function defined in this file
- **`parse_fill_report()`**: Function defined in this file
- **`parse_position_status_report()`**: Function defined in this file
- **`test_parse_fill_side()`**: Function defined in this file
- **`test_pow10_neg()`**: Function defined in this file
- **`test_parse_perp_instruments()`**: Function defined in this file
- **`load_test_data()`**: Function defined in this file
- **`test_parse_perp_instruments_from_real_data()`**: Function defined in this file
- **`test_deserialize_l2_book_from_real_data()`**: Function defined in this file
- **`test_parse_spot_instruments()`**: Function defined in this file
- **`test_price_decimals_clamping()`**: Function defined in this file

### Classes
- **`HyperliquidInstrumentDef`**: Class defined in this file
...
**Enums**: `HyperliquidMarketType`
**Functions**: `create_instrument_from_def`, `get_currency`, `instruments_from_defs`, `instruments_from_defs_owned`, `load_test_data`, `parse_fill_report`, `parse_fill_side`, `parse_order_status_report_from_basic`, `parse_order_status_report_from_ws`, `parse_perp_instruments`, `parse_position_status_report`, `parse_spot_instruments`, `pow10_neg`, `test_deserialize_l2_book_from_real_data`, `test_parse_fill_side`, `test_parse_perp_instruments`, `test_parse_perp_instruments_from_real_data`, `test_parse_spot_instruments`, `test_pow10_neg`, `test_price_decimals_clamping`
**Structs**: `HyperliquidInstrumentDef`
...
---
*Generated on 2025-11-18T21:55:00.045899Z*
