# Documentation: `crates/adapters/hyperliquid/src/http/rate_limits.rs`
**Generated:** 2025-11-15T19:40:01.051641Z
**File Size:** 11299 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/adapters/hyperliquid/src/http/rate_limits.rs` within the repository.

**Classes defined:** WeightedLimiter, State, RateLimitSnapshot, with, WeightedLimiter

**Functions defined:** per_minute, acquire, debit_extra, snapshot, refill_locked, backoff_full_jitter, info_base_weight, info_extra_weight, exchange_weight, test_exchange_weight_order_steps_every_40 and 6 more
...
#### `per_minute(capacity: u32)`


#### `acquire(&self, weight: u32)`


#### `debit_extra(&self, extra: u32)`


#### `snapshot(&self)`


#### `refill_locked(st: &mut State, per_sec: f64, cap: f64)`


#### `backoff_full_jitter(attempt: u32, base: Duration, cap: Duration)`


#### `info_base_weight(req: &crate::http::query::InfoRequest)`


#### `info_extra_weight(req: &crate::http::query::InfoRequest, json: &Value)`


#### `exchange_weight(action: &crate::http::query::ExchangeAction)`
...
#### `test_backoff_full_jitter_increases(#[case] attempt: u32, #[case] max_expected_ms: u64)`
