# Documentation: rate_limits.rs

## File Metadata

- **Path**: `crates/adapters/hyperliquid/src/http/rate_limits.rs`
- **Size**: 11,299 bytes
- **Lines**: 346
- **Language**: Rust
...
### Functions
- **`per_minute()`**: Function defined in this file
- **`acquire()`**: Function defined in this file
- **`debit_extra()`**: Function defined in this file
- **`snapshot()`**: Function defined in this file
- **`refill_locked()`**: Function defined in this file
- **`backoff_full_jitter()`**: Function defined in this file
- **`info_base_weight()`**: Function defined in this file
- **`info_extra_weight()`**: Function defined in this file
- **`exchange_weight()`**: Function defined in this file
- **`test_exchange_weight_order_steps_every_40()`**: Function defined in this file
- **`test_exchange_weight_cancel()`**: Function defined in this file
- **`test_exchange_weight_non_batch_action()`**: Function defined in this file
- **`test_limiter_roughly_caps_to_capacity()`**: Function defined in this file
- **`test_limiter_debit_extra_works()`**: Function defined in this file
- **`test_backoff_full_jitter_increases()`**: Function defined in this file
- **`test_backoff_full_jitter_respects_cap()`**: Function defined in this file

### Classes
- **`WeightedLimiter`**: Class defined in this file
- **`State`**: Class defined in this file
- **`RateLimitSnapshot`**: Class defined in this file
...
**Functions**: `acquire`, `backoff_full_jitter`, `debit_extra`, `exchange_weight`, `info_base_weight`, `info_extra_weight`, `per_minute`, `refill_locked`, `snapshot`, `test_backoff_full_jitter_increases`, `test_backoff_full_jitter_respects_cap`, `test_exchange_weight_cancel`, `test_exchange_weight_non_batch_action`, `test_exchange_weight_order_steps_every_40`, `test_limiter_debit_extra_works`, `test_limiter_roughly_caps_to_capacity`
**Impls**: `WeightedLimiter`
**Structs**: `RateLimitSnapshot`, `State`, `WeightedLimiter`, `with`
...
---
*Generated on 2025-11-18T21:55:00.053457Z*
