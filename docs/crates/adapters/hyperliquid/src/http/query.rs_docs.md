...
- **Path**: `crates/adapters/hyperliquid/src/http/query.rs`
- **Size**: 17,186 bytes
- **Lines**: 547
- **Language**: Rust
...
This file is part of the NautilusTrader repository. It defines 29 function(s) and 14 class(es).

## Detailed Walkthrough

### Functions
- **`as_ref()`**: Function defined in this file
- **`meta()`**: Function defined in this file
- **`spot_meta()`**: Function defined in this file
- **`meta_and_asset_ctxs()`**: Function defined in this file
- **`spot_meta_and_asset_ctxs()`**: Function defined in this file
- **`l2_book()`**: Function defined in this file
- **`user_fills()`**: Function defined in this file
- **`order_status()`**: Function defined in this file
- **`open_orders()`**: Function defined in this file
- **`frontend_open_orders()`**: Function defined in this file
- **`clearinghouse_state()`**: Function defined in this file
- **`candle_snapshot()`**: Function defined in this file
- **`serialize_action_type()`**: Function defined in this file
...
- **`update_leverage()`**: Function defined in this file
- **`update_isolated_margin()`**: Function defined in this file
- **`test_info_request_meta()`**: Function defined in this file

*...and 9 more functions*

### Classes
- **`OrderParams`**: Class defined in this file
- **`CancelParams`**: Class defined in this file
- **`ModifyParams`**: Class defined in this file
- **`UpdateLeverageParams`**: Class defined in this file
- **`UpdateIsolatedMarginParams`**: Class defined in this file
- **`L2BookParams`**: Class defined in this file
- **`UserFillsParams`**: Class defined in this file
- **`OrderStatusParams`**: Class defined in this file
- **`OpenOrdersParams`**: Class defined in this file
- **`ClearinghouseStateParams`**: Class defined in this file
- **`CandleSnapshotReq`**: Class defined in this file
- **`CandleSnapshotParams`**: Class defined in this file
- **`InfoRequest`**: Class defined in this file
- **`ExchangeAction`**: Class defined in this file
...
**Enums**: `ExchangeActionParams`, `ExchangeActionType`, `InfoRequestParams`
**Functions**: `as_ref`, `cancel`, `cancel_by_cloid`, `candle_snapshot`, `clearinghouse_state`, `frontend_open_orders`, `l2_book`, `meta`, `meta_and_asset_ctxs`, `modify`, `open_orders`, `order`, `order_status`, `serialize_action_type`, `spot_meta`, `spot_meta_and_asset_ctxs`, `test_cancel_by_cloid_serialization`, `test_exchange_action_cancel`, `test_exchange_action_order`, `test_exchange_action_serialization`, `test_exchange_action_type_as_ref`, `test_info_request_l2_book`, `test_info_request_meta`, `test_modify_serialization`, `test_update_isolated_margin_serialization`, `test_update_leverage_serialization`, `update_isolated_margin`, `update_leverage`, `user_fills`
**Impls**: `AsRef`, `ExchangeAction`, `InfoRequest`
**Structs**: `CancelParams`, `CandleSnapshotParams`, `CandleSnapshotReq`, `ClearinghouseStateParams`, `ExchangeAction`, `InfoRequest`, `L2BookParams`, `ModifyParams`, `OpenOrdersParams`, `OrderParams`, `OrderStatusParams`, `UpdateIsolatedMarginParams`, `UpdateLeverageParams`, `UserFillsParams`
...
---
*Generated on 2025-11-18T21:55:00.049649Z*
