# Documentation: `crates/adapters/hyperliquid/src/http/query.rs`
**Generated:** 2025-11-15T19:40:01.049060Z
**File Size:** 17215 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/adapters/hyperliquid/src/http/query.rs` within the repository.

**Classes defined:** OrderParams, CancelParams, ModifyParams, UpdateLeverageParams, UpdateIsolatedMarginParams, L2BookParams, UserFillsParams, OrderStatusParams, OpenOrdersParams, ClearinghouseStateParams and 7 more

**Functions defined:** as_ref, meta, spot_meta, meta_and_asset_ctxs, spot_meta_and_asset_ctxs, l2_book, user_fills, order_status, open_orders, frontend_open_orders and 19 more
...
#### `order_status(user: &str, oid: u64)`


#### `open_orders(user: &str)`


#### `frontend_open_orders(user: &str)`


#### `clearinghouse_state(user: &str)`
...
#### `order(orders: Vec<HyperliquidExecPlaceOrderRequest>)`


#### `cancel(cancels: Vec<HyperliquidExecCancelByCloidRequest>)`


#### `cancel_by_cloid(cancels: Vec<HyperliquidExecCancelByCloidRequest>)`


#### `modify(oid: u64, order: HyperliquidExecModifyOrderRequest)`


#### `update_leverage(asset: u32, is_cross: bool, leverage: u32)`


#### `update_isolated_margin(asset: u32, is_buy: bool, ntli: i64)`
...
**Directory:** `crates/adapters/hyperliquid/src/http`
