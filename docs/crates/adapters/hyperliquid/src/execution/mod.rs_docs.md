...
- **Path**: `crates/adapters/hyperliquid/src/execution/mod.rs`
- **Size**: 40,926 bytes
- **Lines**: 1,134
- **Language**: Rust
...
This file is part of the NautilusTrader repository. It defines 38 function(s) and 6 class(es).

## Detailed Walkthrough

### Functions
- **`config()`**: Function defined in this file
- **`validate_order_submission()`**: Function defined in this file
...
### Classes
- **`HyperliquidExecutionClient`**: Class defined in this file
- **`let`**: Class defined in this file
- **`let`**: Class defined in this file
- **`let`**: Class defined in this file
- **`let`**: Class defined in this file
- **`definition`**: Class defined in this file
...
**Functions**: `abort_pending_tasks`, `account_id`, `batch_cancel_orders`, `cancel_all_orders`, `cancel_order`, `client_id`, `config`, `connect`, `disconnect`, `dispatch_execution_report`, `ensure_instruments_initialized`, `ensure_instruments_initialized_async`, `generate_account_state`, `generate_fill_reports`, `generate_mass_status`, `generate_order_status_report`, `generate_order_status_reports`, `generate_position_status_reports`, `get_account`, `get_clock`, `get_message_channel`, `get_user_address`, `is_connected`, `modify_order`, `new`, `oms_type`, `query_account`, `query_order`, `refresh_account_state`, `spawn_task` *(+8 more)*
**Impls**: `ExecutionClient`, `HyperliquidExecutionClient`, `LiveExecutionClient`, `LiveExecutionClientExt`
**Structs**: `HyperliquidExecutionClient`, `definition`, `let`

## Related Files

This file is located in `crates/adapters/hyperliquid/src/execution/`. Related files may include:
...
---
*Generated on 2025-11-18T21:55:00.013284Z*
