# Documentation: `crates/adapters/bitmex/src/http/query.rs`
**Generated:** 2025-11-15T19:40:00.356409Z
**File Size:** 20079 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/adapters/bitmex/src/http/query.rs` within the repository.

**Classes defined:** GetTradeParams, GetTradeBucketedParams, GetOrderParams, PostOrderParams, DeleteOrderParams, DeleteAllOrdersParams, PutOrderParams, GetExecutionParams, PostPositionLeverageParams, GetPositionParams and 1 more

**Functions defined:** serialize_json_as_string, serialize_string_vec_as_json, is_exec_inst_empty, serialize_exec_instructions_optional, build_validated
...
#### `serialize_json_as_string(value: &Option<Value>, serializer: S)`
...
#### `is_exec_inst_empty(exec_inst: &Option<Vec<BitmexExecInstruction>>)`
