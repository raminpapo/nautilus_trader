...
- **Path**: `crates/adapters/bitmex/src/http/query.rs`
- **Size**: 20,079 bytes
- **Lines**: 431
- **Language**: Rust
...
This file is part of the NautilusTrader repository. It defines 5 function(s) and 10 class(es).

## Detailed Walkthrough

### Functions
- **`serialize_json_as_string()`**: Function defined in this file
- **`serialize_string_vec_as_json()`**: Function defined in this file
- **`is_exec_inst_empty()`**: Function defined in this file
- **`serialize_exec_instructions_optional()`**: Function defined in this file
- **`build_validated()`**: Function defined in this file

### Classes
- **`GetTradeParams`**: Class defined in this file
- **`GetTradeBucketedParams`**: Class defined in this file
- **`GetOrderParams`**: Class defined in this file
- **`PostOrderParams`**: Class defined in this file
- **`DeleteOrderParams`**: Class defined in this file
- **`DeleteAllOrdersParams`**: Class defined in this file
- **`PutOrderParams`**: Class defined in this file
- **`GetExecutionParams`**: Class defined in this file
- **`PostPositionLeverageParams`**: Class defined in this file
- **`GetPositionParams`**: Class defined in this file
...
**Functions**: `build_validated`, `is_exec_inst_empty`, `serialize_exec_instructions_optional`, `serialize_json_as_string`, `serialize_string_vec_as_json`
**Impls**: `DeleteOrderParamsBuilder`
**Structs**: `DeleteAllOrdersParams`, `DeleteOrderParams`, `GetExecutionParams`, `GetOrderParams`, `GetPositionParams`, `GetTradeBucketedParams`, `GetTradeParams`, `PostOrderParams`, `PostPositionLeverageParams`, `PutOrderParams`
...
---
*Generated on 2025-11-18T21:54:59.033275Z*
