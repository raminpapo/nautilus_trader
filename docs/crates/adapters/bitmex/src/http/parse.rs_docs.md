...
- **Path**: `crates/adapters/bitmex/src/http/parse.rs`
- **Size**: 111,635 bytes
- **Lines**: 2,929
- **Language**: Rust
...
This file is part of the NautilusTrader repository. It defines 46 function(s).

## Detailed Walkthrough

### Functions
- **`get_position_multiplier()`**: Function defined in this file
- **`parse_instrument_any()`**: Function defined in this file
- **`parse_index_instrument()`**: Function defined in this file
- **`parse_spot_instrument()`**: Function defined in this file
- **`parse_perpetual_instrument()`**: Function defined in this file
- **`parse_futures_instrument()`**: Function defined in this file
- **`parse_trade()`**: Function defined in this file
- **`parse_trade_bin()`**: Function defined in this file
- **`parse_order_status_report()`**: Function defined in this file
- **`parse_fill_report()`**: Function defined in this file
- **`parse_position_report()`**: Function defined in this file
- **`get_currency()`**: Function defined in this file
- **`test_perp_instrument_deserialization()`**: Function defined in this file
- **`test_parse_orders()`**: Function defined in this file
- **`test_parse_executions()`**: Function defined in this file
- **`test_parse_positions()`**: Function defined in this file
- **`test_parse_trades()`**: Function defined in this file
- **`test_parse_wallet()`**: Function defined in this file
- **`test_parse_trade_bins()`**: Function defined in this file
- **`test_parse_trade_bin_to_bar()`**: Function defined in this file
...
**Functions**: `create_test_futures_instrument`, `create_test_perpetual_instrument`, `create_test_spot_instrument`, `get_currency`, `get_position_multiplier`, `parse_fill_report`, `parse_futures_instrument`, `parse_index_instrument`, `parse_instrument_any`, `parse_order_status_report`, `parse_perpetual_instrument`, `parse_position_report`, `parse_spot_instrument`, `parse_trade`, `parse_trade_bin`, `test_parse_executions`, `test_parse_fill_report`, `test_parse_fill_report_with_missing_trd_match_id`, `test_parse_futures_instrument`, `test_parse_order_status_report`, `test_parse_order_status_report_canceled_missing_all_quantities`, `test_parse_order_status_report_minimal`, `test_parse_order_status_report_missing_ord_status_infers_canceled`, `test_parse_order_status_report_missing_ord_status_infers_filled`, `test_parse_order_status_report_missing_ord_status_no_quantities_fails`, `test_parse_order_status_report_missing_ord_status_with_leaves_qty_fails`, `test_parse_order_status_report_missing_order_qty_fails`, `test_parse_order_status_report_missing_order_qty_reconstructed`, `test_parse_order_status_report_rejected_with_reason`, `test_parse_order_status_report_rejected_with_text_fallback` *(+16 more)*
...
---
*Generated on 2025-11-18T21:54:59.028772Z*
