# Documentation: `crates/adapters/bitmex/src/http/error.rs`
**Generated:** 2025-11-15T19:40:00.338903Z
**File Size:** 7188 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/adapters/bitmex/src/http/error.rs` within the repository.

**Classes defined:** BitmexErrorResponse, BitmexErrorMessage, From, From, From, From

**Functions defined:** from, from, from, from, test_bitmex_build_error_display, test_bitmex_error_response_from_json, test_bitmex_http_error_from_error_response, test_bitmex_http_error_from_json_error, test_bitmex_http_error_from_string, test_unexpected_status_error
...
#### `from(error: BitmexErrorResponse)`
