...
- **Path**: `crates/adapters/bitmex/src/http/models.rs`
- **Size**: 29,851 bytes
- **Lines**: 885
- **Language**: Rust
...
This file is part of the NautilusTrader repository. It defines 4 function(s) and 34 class(es).

## Detailed Walkthrough

### Functions
- **`deserialize_exec_instructions()`**: Function defined in this file
- **`test_deserialize_exec_instructions()`**: Function defined in this file
- **`test_deserialize_exec_instructions_with_spaces()`**: Function defined in this file
- **`test_deserialize_order_with_exec_instructions()`**: Function defined in this file

### Classes
- **`BitmexInstrument`**: Class defined in this file
- **`BitmexExecution`**: Class defined in this file
- **`BitmexFunding`**: Class defined in this file
- **`BitmexInstrumentInterval`**: Class defined in this file
- **`BitmexIndexComposite`**: Class defined in this file
- **`BitmexInsurance`**: Class defined in this file
- **`BitmexLiquidation`**: Class defined in this file
- **`BitmexOrder`**: Class defined in this file
- **`BitmexOrderBookL2`**: Class defined in this file
- **`BitmexPosition`**: Class defined in this file
- **`BitmexQuote`**: Class defined in this file
- **`BitmexSettlement`**: Class defined in this file
- **`BitmexStats`**: Class defined in this file
- **`BitmexStatsHistory`**: Class defined in this file
- **`BitmexStatsUSD`**: Class defined in this file
- **`BitmexTrade`**: Class defined in this file
- **`BitmexTradeBin`**: Class defined in this file
- **`BitmexWallet`**: Class defined in this file
- **`BitmexTransaction`**: Class defined in this file
- **`BitmexAnnouncement`**: Class defined in this file
...
**Functions**: `deserialize_exec_instructions`, `test_deserialize_exec_instructions`, `test_deserialize_exec_instructions_with_spaces`, `test_deserialize_order_with_exec_instructions`
**Structs**: `BitmexAPIKey`, `BitmexAccessToken`, `BitmexAnnouncement`, `BitmexApiInfo`, `BitmexCommunicationToken`, `BitmexEventMetaEventMeta`, `BitmexExecution`, `BitmexFunding`, `BitmexGlobalNotification`, `BitmexIndexComposite`, `BitmexInstrument`, `BitmexInstrumentInterval`, `BitmexInsurance`, `BitmexLiquidation`, `BitmexMargin`, `BitmexOrder`, `BitmexOrderBookBinning`, `BitmexOrderBookL2`, `BitmexPosition`, `BitmexQuote`, `BitmexQuoteFillRatio`, `BitmexSettlement`, `BitmexStats`, `BitmexStatsHistory`, `BitmexStatsUSD`, `BitmexTrade`, `BitmexTradeBin`, `BitmexTransaction`, `BitmexUser`, `BitmexUserEvent` *(+3 more)*
...
---
*Generated on 2025-11-18T21:54:59.013257Z*
