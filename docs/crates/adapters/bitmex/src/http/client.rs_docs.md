...
- **Path**: `crates/adapters/bitmex/src/http/client.rs`
- **Size**: 85,183 bytes
- **Lines**: 2,424
- **Language**: Rust
...
This file is part of the NautilusTrader repository. It defines 70 function(s) and 3 class(es).
...
- **`default_quota()`**: Function defined in this file
...
- **`get_wallet()`**: Function defined in this file
- **`get_margin()`**: Function defined in this file
- **`get_trades()`**: Function defined in this file
- **`get_trade_bucketed()`**: Function defined in this file
- **`get_orders()`**: Function defined in this file
- **`place_order()`**: Function defined in this file

*...and 50 more functions*

### Classes
- **`BitmexResponse`**: Class defined in this file
- **`BitmexRawHttpClient`**: Class defined in this file
- **`BitmexHttpClient`**: Class defined in this file
...
**Functions**: `amend_order`, `api_key`, `base_url`, `build_report`, `cache_instrument`, `cancel_all_orders`, `cancel_all_requests`, `cancel_order`, `cancel_orders`, `cancellation_token`, `clone`, `default`, `default_headers`, `default_quota`, `from_env`, `generate_ts_init`, `get_executions`, `get_instrument`, `get_instruments`, `get_margin`, `get_orders`, `get_positions`, `get_price_precision`, `get_server_time`, `get_trade_bucketed`, `get_trades`, `get_wallet`, `instrument_from_cache`, `is_contingent_order`, `is_parent_contingency` *(+27 more)*
**Impls**: `BitmexHttpClient`, `BitmexRawHttpClient`, `Clone`, `Default`
**Structs**: `BitmexHttpClient`, `BitmexRawHttpClient`, `BitmexResponse`
...
---
*Generated on 2025-11-18T21:54:59.003886Z*
