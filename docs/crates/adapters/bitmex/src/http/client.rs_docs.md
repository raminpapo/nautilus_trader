# Documentation: `crates/adapters/bitmex/src/http/client.rs`
**Generated:** 2025-11-15T19:40:00.336627Z
**File Size:** 85183 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/adapters/bitmex/src/http/client.rs` within the repository.

**Classes defined:** BitmexResponse, BitmexRawHttpClient, BitmexHttpClient, Default, BitmexRawHttpClient, Clone, Default, BitmexHttpClient

**Functions defined:** default, new, with_credentials, default_headers, default_quota, rate_limiter_quotas, rate_limit_keys, cancel_all_requests, cancellation_token, sign_request and 60 more
...
#### `default_quota(max_requests_per_second: u32)`
...
#### `place_order(&self, params: PostOrderParams)`


#### `cancel_orders(&self, params: DeleteOrderParams)`


#### `amend_order(&self, params: PutOrderParams)`
...
#### `is_contingent_order(contingency_type: ContingencyType)`


#### `is_parent_contingency(contingency_type: ContingencyType)`


#### `populate_linked_order_ids(reports: &mut [OrderStatusReport])`
...
#### `instrument_from_cache(&self, symbol: Ustr)`


#### `get_price_precision(&self, symbol: Ustr)`
