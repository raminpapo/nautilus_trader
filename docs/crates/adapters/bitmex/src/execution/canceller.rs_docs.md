# Documentation: `crates/adapters/bitmex/src/execution/canceller.rs`
**Generated:** 2025-11-15T19:40:00.319938Z
**File Size:** 60361 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/adapters/bitmex/src/execution/canceller.rs` within the repository.

**Classes defined:** CancelBroadcasterConfig, TransportClient, CancelBroadcaster, BroadcasterMetrics, ClientStats, MockExecutor, CancelExecutor, Default, Debug, TransportClient and 4 more

**Functions defined:** add_instrument, health_check, cancel_order, cancel_orders, cancel_all_orders, add_instrument, health_check, cancel_order, cancel_orders, cancel_all_orders and 54 more
...
#### `new(config: CancelBroadcasterConfig)`
...
#### `is_idempotent_success(&self, error_message: &str)`
