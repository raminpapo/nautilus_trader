# Documentation: canceller.rs

## File Metadata

- **Path**: `crates/adapters/bitmex/src/execution/canceller.rs`
- **Size**: 60,361 bytes
- **Lines**: 1,659
- **Language**: Rust
...
This file is part of the NautilusTrader repository. It defines 64 function(s) and 6 class(es).
...
- **`cancel_orders()`**: Function defined in this file
...
- **`get_cancel_count()`**: Function defined in this file
...
### Classes
- **`CancelBroadcasterConfig`**: Class defined in this file
- **`TransportClient`**: Class defined in this file
- **`CancelBroadcaster`**: Class defined in this file
...
**Functions**: `add_instrument`, `broadcast_batch_cancel`, `broadcast_cancel`, `broadcast_cancel_all`, `cache_instrument`, `cancel_all_orders`, `cancel_order`, `cancel_orders`, `clone_for_async`, `create_stub_transport`, `create_test_report`, `default`, `fmt`, `get_cancel_count`, `get_client_stats`, `get_client_stats_async`, `get_error_count`, `get_metrics`, `get_metrics_async`, `health_check`, `is_expected_reject`, `is_healthy`, `is_idempotent_success`, `mark_healthy`, `mark_unhealthy`, `new`, `new_with_transports`, `process_cancel_results`, `run_health_checks`, `start` *(+20 more)*
**Impls**: `CancelBroadcaster`, `CancelExecutor`, `Debug`, `Default`, `FnOnce`, `MockExecutor`, `TransportClient`
**Structs**: `BroadcasterMetrics`, `CancelBroadcaster`, `CancelBroadcasterConfig`, `ClientStats`, `MockExecutor`, `TransportClient`
**Traits**: `CancelExecutor`, `abstracts`, `does`, `object`, `to`
...
---
*Generated on 2025-11-18T21:54:58.976860Z*
