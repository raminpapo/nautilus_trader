...
- **Path**: `crates/adapters/bitmex/src/execution/mod.rs`
- **Size**: 27,476 bytes
- **Lines**: 807
- **Language**: Rust
...
- **`start_ws_stream()`**: Function defined in this file
...
### Classes
- **`BitmexExecutionClient`**: Class defined in this file
...
**Functions**: `abort_pending_tasks`, `account_id`, `batch_cancel_orders`, `cancel_all_orders`, `cancel_order`, `client_id`, `connect`, `disconnect`, `dispatch_account_state`, `dispatch_fill_report`, `dispatch_order_event`, `dispatch_order_status_report`, `dispatch_position_status_report`, `dispatch_ws_message`, `ensure_instruments_initialized`, `ensure_instruments_initialized_async`, `generate_account_state`, `generate_fill_reports`, `generate_mass_status`, `generate_order_status_report`, `generate_order_status_reports`, `generate_position_status_reports`, `get_account`, `get_clock`, `get_message_channel`, `is_connected`, `modify_order`, `new`, `oms_type`, `query_account` *(+10 more)*
**Impls**: `BitmexExecutionClient`, `ExecutionClient`, `LiveExecutionClient`, `LiveExecutionClientExt`
**Structs**: `BitmexExecutionClient`
...
---
*Generated on 2025-11-18T21:54:58.982511Z*
