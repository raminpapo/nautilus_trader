# Documentation: `crates/adapters/bitmex/src/execution/mod.rs`
**Generated:** 2025-11-15T19:40:00.323540Z
**File Size:** 27475 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/adapters/bitmex/src/execution/mod.rs` within the repository.

**Classes defined:** BitmexExecutionClient, BitmexExecutionClient, ExecutionClient, LiveExecutionClient, LiveExecutionClientExt

**Functions defined:** new, spawn_task, abort_pending_tasks, ensure_instruments_initialized_async, ensure_instruments_initialized, refresh_account_state, update_account_state, start_ws_stream, is_connected, client_id and 30 more
...
#### `new(core: ExecutionClientCore, config: BitmexExecClientConfig)`


#### `spawn_task(&self, label: &'static str, fut: F)`
...
#### `dispatch_order_status_report(report: OrderStatusReport)`


#### `dispatch_fill_report(report: FillReport)`
