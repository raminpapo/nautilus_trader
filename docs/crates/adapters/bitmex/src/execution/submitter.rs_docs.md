# Documentation: submitter.rs

## File Metadata

- **Path**: `crates/adapters/bitmex/src/execution/submitter.rs`
- **Size**: 58,509 bytes
- **Lines**: 1,693
- **Language**: Rust
...
This file is part of the NautilusTrader repository. It defines 61 function(s) and 8 class(es).

## Detailed Walkthrough

### Functions
- **`add_instrument()`**: Function defined in this file
- **`health_check()`**: Function defined in this file
...
- **`is_healthy()`**: Function defined in this file
- **`mark_healthy()`**: Function defined in this file
- **`mark_unhealthy()`**: Function defined in this file
- **`get_submit_count()`**: Function defined in this file
- **`get_error_count()`**: Function defined in this file
- **`health_check()`**: Function defined in this file
- **`submit_order()`**: Function defined in this file
- **`new()`**: Function defined in this file
- **`start()`**: Function defined in this file
- **`stop()`**: Function defined in this file
- **`run_health_checks()`**: Function defined in this file

*...and 41 more functions*

### Classes
- **`SubmitBroadcasterConfig`**: Class defined in this file
- **`TransportClient`**: Class defined in this file
- **`SubmitBroadcaster`**: Class defined in this file
- **`BroadcasterMetrics`**: Class defined in this file
- **`ClientStats`**: Class defined in this file
- **`MockExecutor`**: Class defined in this file
- **`CaptureExecutor`**: Class defined in this file
- **`CaptureAndFailExecutor`**: Class defined in this file
...
**Functions**: `add_instrument`, `broadcast_submit`, `cache_instrument`, `clone_for_async`, `create_stub_transport`, `create_test_report`, `default`, `fmt`, `get_client_stats`, `get_client_stats_async`, `get_error_count`, `get_metrics`, `get_metrics_async`, `get_submit_count`, `health_check`, `is_expected_reject`, `is_healthy`, `mark_healthy`, `mark_unhealthy`, `new`, `new_with_transports`, `process_submit_results`, `run_health_checks`, `start`, `stop`, `submit_order`, `test_broadcast_submit_all_failures`, `test_broadcast_submit_duplicate_clordid_expected`, `test_broadcast_submit_immediate_success`, `test_broadcast_submit_metrics_increment` *(+15 more)*
**Impls**: `Debug`, `Default`, `MockExecutor`, `SubmitBroadcaster`, `SubmitExecutor`, `TransportClient`
**Structs**: `BroadcasterMetrics`, `CaptureAndFailExecutor`, `CaptureExecutor`, `ClientStats`, `MockExecutor`, `SubmitBroadcaster`, `SubmitBroadcasterConfig`, `TransportClient`
**Traits**: `SubmitExecutor`, `abstracts`, `does`, `object`, `to`

## Related Files

This file is located in `crates/adapters/bitmex/src/execution/`. Related files may include:
...
---
*Generated on 2025-11-18T21:54:58.991998Z*
