# Documentation: `crates/adapters/bitmex/src/execution/submitter.rs`
**Generated:** 2025-11-15T19:40:00.329045Z
**File Size:** 58509 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/adapters/bitmex/src/execution/submitter.rs` within the repository.

**Classes defined:** SubmitBroadcasterConfig, TransportClient, SubmitBroadcaster, BroadcasterMetrics, ClientStats, MockExecutor, CaptureExecutor, CaptureAndFailExecutor, SubmitExecutor, Default and 7 more

**Functions defined:** add_instrument, health_check, submit_order, add_instrument, health_check, submit_order, default, fmt, new, is_healthy and 51 more
...
#### `add_instrument(&self, instrument: InstrumentAny)`
...
#### `new(executor: E, client_id: String)`
...
#### `get_submit_count(&self)`


#### `get_error_count(&self)`


#### `health_check(&self, timeout_secs: u64)`
...
#### `new(config: SubmitBroadcasterConfig)`
...
#### `is_expected_reject(&self, error_message: &str)`
...
#### `get_metrics_async(&self)`


#### `get_client_stats(&self)`


#### `get_client_stats_async(&self)`


#### `cache_instrument(&self, instrument: InstrumentAny)`


#### `clone_for_async(&self)`
...
#### `add_instrument(&self, _instrument: InstrumentAny)`


#### `create_test_report(venue_order_id: &str)`


#### `create_stub_transport(client_id: &str, handler: F)`
...
**Directory:** `crates/adapters/bitmex/src/execution`
