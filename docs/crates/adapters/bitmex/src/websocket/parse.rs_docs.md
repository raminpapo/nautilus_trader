...
- **Path**: `crates/adapters/bitmex/src/websocket/parse.rs`
- **Size**: 67,840 bytes
- **Lines**: 1,878
- **Language**: Rust
...
This file is part of the NautilusTrader repository. It defines 58 function(s).

## Detailed Walkthrough

### Functions
- **`is_index_symbol()`**: Function defined in this file
- **`parse_book_msg_vec()`**: Function defined in this file
- **`parse_book10_msg_vec()`**: Function defined in this file
- **`parse_trade_msg_vec()`**: Function defined in this file
- **`parse_trade_bin_msg_vec()`**: Function defined in this file
- **`parse_book_msg()`**: Function defined in this file
- **`parse_book10_msg()`**: Function defined in this file
- **`parse_quote_msg()`**: Function defined in this file
- **`parse_trade_msg()`**: Function defined in this file
- **`parse_trade_bin_msg()`**: Function defined in this file
- **`bar_spec_from_topic()`**: Function defined in this file
- **`topic_from_bar_spec()`**: Function defined in this file
- **`infer_order_type_from_msg()`**: Function defined in this file
- **`parse_order_msg()`**: Function defined in this file
- **`parse_order_update_msg()`**: Function defined in this file
- **`parse_execution_msg()`**: Function defined in this file
- **`parse_position_msg()`**: Function defined in this file
- **`parse_instrument_msg()`**: Function defined in this file
- **`parse_funding_msg()`**: Function defined in this file
- **`parse_wallet_msg()`**: Function defined in this file
...
**Functions**: `bar_spec_from_topic`, `create_test_perpetual_instrument`, `create_test_perpetual_instrument_with_precisions`, `infer_order_type_from_msg`, `is_index_symbol`, `parse_book10_msg`, `parse_book10_msg_vec`, `parse_book_msg`, `parse_book_msg_vec`, `parse_execution_msg`, `parse_funding_msg`, `parse_instrument_msg`, `parse_margin_msg`, `parse_order_msg`, `parse_order_update_msg`, `parse_position_msg`, `parse_quote_msg`, `parse_trade_bin_msg`, `parse_trade_bin_msg_vec`, `parse_trade_msg`, `parse_trade_msg_vec`, `parse_wallet_msg`, `test_orderbook10_message`, `test_orderbook_l2_message`, `test_parse_cancel_reject_execution`, `test_parse_execution_msg`, `test_parse_execution_msg_bankruptcy`, `test_parse_execution_msg_funding`, `test_parse_execution_msg_insurance`, `test_parse_execution_msg_liquidation` *(+28 more)*
...
---
*Generated on 2025-11-18T21:54:59.098490Z*
