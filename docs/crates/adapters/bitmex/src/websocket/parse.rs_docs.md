# Documentation: `crates/adapters/bitmex/src/websocket/parse.rs`
**Generated:** 2025-11-15T19:40:00.398187Z
**File Size:** 67852 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/adapters/bitmex/src/websocket/parse.rs` within the repository.

**Functions defined:** is_index_symbol, parse_book_msg_vec, parse_book10_msg_vec, parse_trade_msg_vec, parse_trade_bin_msg_vec, parse_book_msg, parse_book10_msg, parse_quote_msg, parse_trade_msg, parse_trade_bin_msg and 48 more
...
#### `bar_spec_from_topic(topic: &BitmexWsTopic)`


#### `topic_from_bar_spec(spec: BarSpecification)`


#### `infer_order_type_from_msg(msg: &BitmexOrderMsg)`
...
#### `parse_funding_msg(msg: BitmexFundingMsg, ts_init: UnixNanos)`


#### `parse_wallet_msg(msg: BitmexWalletMsg, ts_init: UnixNanos)`


#### `parse_margin_msg(msg: BitmexMarginMsg, instrument_id: InstrumentId)`
