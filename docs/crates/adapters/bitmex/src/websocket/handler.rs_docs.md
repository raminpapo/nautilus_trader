...
- **Path**: `crates/adapters/bitmex/src/websocket/handler.rs`
- **Size**: 40,396 bytes
- **Lines**: 1,025
- **Language**: Rust
...
This file is part of the NautilusTrader repository. It defines 27 function(s) and 1 class(es).
...
- **`is_heartbeat_message()`**: Function defined in this file
- **`handle_subscription_ack()`**: Function defined in this file
- **`handle_unsubscribe_ack()`**: Function defined in this file
- **`topics_from_request()`**: Function defined in this file
- **`handle_orderbook_l2()`**: Function defined in this file
- **`handle_orderbook_10()`**: Function defined in this file
- **`handle_quote()`**: Function defined in this file
- **`handle_trade()`**: Function defined in this file
- **`handle_trade_bin()`**: Function defined in this file
- **`handle_order()`**: Function defined in this file
- **`handle_execution()`**: Function defined in this file
- **`handle_position()`**: Function defined in this file
- **`handle_wallet()`**: Function defined in this file
...
**Functions**: `create_bitmex_timeout_error`, `get_instrument`, `handle_execution`, `handle_funding`, `handle_instrument`, `handle_order`, `handle_orderbook_10`, `handle_orderbook_l2`, `handle_position`, `handle_quote`, `handle_subscription_ack`, `handle_subscription_message`, `handle_trade`, `handle_trade_bin`, `handle_unsubscribe_ack`, `handle_wallet`, `is_heartbeat_message`, `is_stopped`, `is_terminal_order_status`, `new`, `next`, `parse_raw_message`, `send`, `send_with_retry`, `should_retry_bitmex_error`, `test_is_heartbeat_message_detection`, `topics_from_request`
**Impls**: `FeedHandler`
**Structs**: `FeedHandler`
...
---
*Generated on 2025-11-18T21:54:59.074864Z*
