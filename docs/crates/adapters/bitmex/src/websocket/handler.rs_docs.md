# Documentation: `crates/adapters/bitmex/src/websocket/handler.rs`
**Generated:** 2025-11-15T19:40:00.384604Z
**File Size:** 40369 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/adapters/bitmex/src/websocket/handler.rs` within the repository.

**Classes defined:** FeedHandler, FeedHandler

**Functions defined:** new, is_stopped, send, send_with_retry, get_instrument, next, parse_raw_message, is_heartbeat_message, handle_subscription_ack, handle_unsubscribe_ack and 17 more
...
#### `handle_order(&mut self, data: Vec<OrderData>)`


#### `handle_execution(&mut self, data: Vec<BitmexExecutionMsg>)`


#### `handle_position(&self, data: Vec<BitmexPositionMsg>)`
...
#### `is_terminal_order_status(status: OrderStatus)`


#### `should_retry_bitmex_error(error: &BitmexWsError)`


#### `create_bitmex_timeout_error(msg: String)`
