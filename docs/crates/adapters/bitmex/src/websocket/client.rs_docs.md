...
- **Path**: `crates/adapters/bitmex/src/websocket/client.rs`
- **Size**: 59,211 bytes
- **Lines**: 1,544
- **Language**: Rust
...
This file is part of the NautilusTrader repository. It defines 58 function(s) and 1 class(es).
...
- **`connect_inner()`**: Function defined in this file
- **`authenticate()`**: Function defined in this file
...
### Classes
- **`BitmexWebSocketClient`**: Class defined in this file
...
**Functions**: `api_key`, `authenticate`, `cache_instrument`, `cache_instruments`, `close`, `connect`, `connect_inner`, `from_env`, `get_subscriptions`, `is_active`, `is_closed`, `new`, `send_cmd`, `set_account_id`, `stream`, `subscribe`, `subscribe_bars`, `subscribe_book`, `subscribe_book_25`, `subscribe_book_depth10`, `subscribe_executions`, `subscribe_funding_rates`, `subscribe_index_prices`, `subscribe_instrument`, `subscribe_instruments`, `subscribe_margin`, `subscribe_mark_prices`, `subscribe_orders`, `subscribe_positions`, `subscribe_quotes` *(+28 more)*
**Impls**: `BitmexWebSocketClient`, `Stream`
**Structs**: `BitmexWebSocketClient`
...
---
*Generated on 2025-11-18T21:54:59.063386Z*
