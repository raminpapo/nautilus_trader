# Documentation: `crates/adapters/bitmex/src/websocket/client.rs`
**Generated:** 2025-11-15T19:40:00.376980Z
**File Size:** 59211 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/adapters/bitmex/src/websocket/client.rs` within the repository.

**Classes defined:** BitmexWebSocketClient, BitmexWebSocketClient, Stream

**Functions defined:** new, from_env, url, api_key, is_active, is_closed, set_account_id, cache_instruments, cache_instrument, connect and 48 more
...
#### `subscribe(&self, topics: Vec<String>)`


#### `unsubscribe(&self, topics: Vec<String>)`
...
#### `subscribe_orders(&self)`


#### `subscribe_executions(&self)`


#### `subscribe_positions(&self)`


#### `subscribe_margin(&self)`


#### `subscribe_wallet(&self)`


#### `unsubscribe_orders(&self)`


#### `unsubscribe_executions(&self)`


#### `unsubscribe_positions(&self)`


#### `unsubscribe_margin(&self)`
...
**Security:** This file may contain sensitive patterns: secret, api_key, credential, auth, session. Ensure proper handling of secrets.
