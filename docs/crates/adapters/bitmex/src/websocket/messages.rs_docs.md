...
- **Path**: `crates/adapters/bitmex/src/websocket/messages.rs`
- **Size**: 37,271 bytes
- **Lines**: 1,082
- **Language**: Rust
...
This file is part of the NautilusTrader repository. It defines 5 function(s) and 19 class(es).

## Detailed Walkthrough

### Functions
- **`deserialize_exec_instructions()`**: Function defined in this file
- **`try_from()`**: Function defined in this file
- **`deserialize_order_data()`**: Function defined in this file
- **`test_try_from_instrument_msg_with_full_data_success()`**: Function defined in this file
- **`test_try_from_instrument_msg_with_partial_data_fails()`**: Function defined in this file

### Classes
- **`BitmexAuthentication`**: Class defined in this file
- **`BitmexSubscription`**: Class defined in this file
- **`BitmexHttpRequest`**: Class defined in this file
- **`BitmexRateLimit`**: Class defined in this file
- **`BitmexOrderBookMsg`**: Class defined in this file
- **`BitmexOrderBook10Msg`**: Class defined in this file
- **`BitmexQuoteMsg`**: Class defined in this file
- **`BitmexTradeMsg`**: Class defined in this file
- **`BitmexTradeBinMsg`**: Class defined in this file
- **`BitmexInstrumentMsg`**: Class defined in this file
- **`BitmexOrderUpdateMsg`**: Class defined in this file
- **`BitmexOrderMsg`**: Class defined in this file
- **`BitmexExecutionMsg`**: Class defined in this file
- **`BitmexPositionMsg`**: Class defined in this file
- **`BitmexWalletMsg`**: Class defined in this file
- **`BitmexMarginMsg`**: Class defined in this file
- **`BitmexFundingMsg`**: Class defined in this file
- **`BitmexInsuranceMsg`**: Class defined in this file
- **`BitmexLiquidationMsg`**: Class defined in this file
...
**Enums**: `BitmexTableMessage`, `BitmexWsMessage`, `NautilusWsMessage`, `OrderData`, `for`
**Functions**: `deserialize_exec_instructions`, `deserialize_order_data`, `test_try_from_instrument_msg_with_full_data_success`, `test_try_from_instrument_msg_with_partial_data_fails`, `try_from`
**Impls**: `TryFrom`
**Structs**: `BitmexAuthentication`, `BitmexExecutionMsg`, `BitmexFundingMsg`, `BitmexHttpRequest`, `BitmexInstrumentMsg`, `BitmexInsuranceMsg`, `BitmexLiquidationMsg`, `BitmexMarginMsg`, `BitmexOrderBook10Msg`, `BitmexOrderBookMsg`, `BitmexOrderMsg`, `BitmexOrderUpdateMsg`, `BitmexPositionMsg`, `BitmexQuoteMsg`, `BitmexRateLimit`, `BitmexSubscription`, `BitmexTradeBinMsg`, `BitmexTradeMsg`, `BitmexWalletMsg`

## Related Files

This file is located in `crates/adapters/bitmex/src/websocket/`. Related files may include:
...
---
*Generated on 2025-11-18T21:54:59.080750Z*
