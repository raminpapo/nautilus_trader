# Documentation: `crates/adapters/bitmex/src/websocket/messages.rs`
**Generated:** 2025-11-15T19:40:00.388713Z
**File Size:** 37271 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/adapters/bitmex/src/websocket/messages.rs` within the repository.

**Classes defined:** BitmexAuthentication, BitmexSubscription, BitmexHttpRequest, BitmexRateLimit, BitmexOrderBookMsg, BitmexOrderBook10Msg, BitmexQuoteMsg, BitmexTradeMsg, BitmexTradeBinMsg, BitmexInstrumentMsg and 10 more

**Functions defined:** deserialize_exec_instructions, try_from, deserialize_order_data, test_try_from_instrument_msg_with_full_data_success, test_try_from_instrument_msg_with_partial_data_fails
...
#### `try_from(msg: BitmexInstrumentMsg)`


#### `deserialize_order_data(deserializer: D)`
...
**Security:** This file may contain sensitive patterns: api_key, auth, session. Ensure proper handling of secrets.
