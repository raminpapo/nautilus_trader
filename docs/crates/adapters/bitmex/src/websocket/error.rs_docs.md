...
- **`from()`**: Function defined in this file
- **`test_bitmex_ws_error_display()`**: Function defined in this file
- **`test_bitmex_ws_error_from_json_error()`**: Function defined in this file
- **`test_bitmex_ws_error_from_tungstenite()`**: Function defined in this file
...
**Enums**: `BitmexWsError`
**Functions**: `from`, `test_bitmex_ws_error_display`, `test_bitmex_ws_error_from_json_error`, `test_bitmex_ws_error_from_tungstenite`
**Impls**: `From`
...
---
*Generated on 2025-11-18T21:54:59.068440Z*
