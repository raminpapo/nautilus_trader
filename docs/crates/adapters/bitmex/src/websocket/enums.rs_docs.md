...
- **Path**: `crates/adapters/bitmex/src/websocket/enums.rs`
- **Size**: 6,951 bytes
- **Lines**: 260
- **Language**: Rust
...
- **`as_aggressor_side()`**: Function defined in this file
- **`from()`**: Function defined in this file
- **`as_book_action()`**: Function defined in this file
...
**Enums**: `BitmexAction`, `BitmexInstrumentState`, `BitmexSide`, `BitmexTickDirection`, `BitmexWsAuthAction`, `BitmexWsAuthChannel`, `BitmexWsOperation`, `BitmexWsTopic`
**Functions**: `as_aggressor_side`, `as_book_action`, `as_order_side`, `from`
**Impls**: `BitmexAction`, `BitmexSide`, `From`
...
---
*Generated on 2025-11-18T21:54:59.066031Z*
