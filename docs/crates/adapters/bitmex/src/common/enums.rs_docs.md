# Documentation: `crates/adapters/bitmex/src/common/enums.rs`
**Generated:** 2025-11-15T19:40:00.297101Z
**File Size:** 32195 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/adapters/bitmex/src/common/enums.rs` within the repository.

**Classes defined:** TryFrom, BitmexSide, From, From, From, TryFrom, BitmexOrderType, From, From, TryFrom and 7 more

**Functions defined:** try_from, try_from_order_side, from, from, from, try_from, try_from_order_type, from, from, try_from and 20 more
...
#### `try_from(value: OrderSide)`


#### `try_from_order_side(value: OrderSide)`


#### `from(side: BitmexSide)`


#### `from(side: BitmexPositionSide)`


#### `from(side: PositionSide)`


#### `try_from(value: OrderType)`


#### `try_from_order_type(value: OrderType)`


#### `from(value: BitmexOrderType)`


#### `from(value: BitmexOrderStatus)`


#### `try_from(value: BitmexTimeInForce)`


#### `try_from(value: TimeInForce)`


#### `try_from_time_in_force(value: TimeInForce)`


#### `from(value: BitmexContingencyType)`


#### `try_from(value: ContingencyType)`


#### `join(instructions: &[Self])`


#### `from(value: BitmexLiquidityIndicator)`
