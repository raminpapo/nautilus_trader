...
- **Path**: `crates/adapters/bitmex/src/common/enums.rs`
- **Size**: 32,195 bytes
- **Lines**: 1,107
- **Language**: Rust
...
- **`try_from()`**: Function defined in this file
- **`try_from()`**: Function defined in this file
- **`try_from_time_in_force()`**: Function defined in this file
- **`from()`**: Function defined in this file
- **`try_from()`**: Function defined in this file
- **`join()`**: Function defined in this file
- **`from()`**: Function defined in this file
- **`to_subscription()`**: Function defined in this file
- **`deserialize()`**: Function defined in this file
- **`test_bitmex_side_deserialization()`**: Function defined in this file
- **`test_bitmex_order_type_deserialization()`**: Function defined in this file
...
**Enums**: `BitmexContingencyType`, `BitmexExecInstruction`, `BitmexExecType`, `BitmexFairMethod`, `BitmexInstrumentState`, `BitmexInstrumentType`, `BitmexLiquidityIndicator`, `BitmexMarkMethod`, `BitmexOrderStatus`, `BitmexOrderType`, `BitmexPegPriceType`, `BitmexPositionSide`, `BitmexProductType`, `BitmexSide`, `BitmexSymbolStatus`, `BitmexTickDirection`, `BitmexTimeInForce`
**Functions**: `deserialize`, `from`, `join`, `test_bitmex_order_type_deserialization`, `test_bitmex_side_deserialization`, `test_deserialization`, `test_error_cases`, `test_helper_methods`, `test_instrument_type_deserialization`, `test_instrument_type_serialization`, `test_order_side_try_from`, `test_order_type_try_from`, `test_serialization`, `test_subscription_strings`, `test_time_in_force_conversions`, `to_subscription`, `try_from`, `try_from_order_side`, `try_from_order_type`, `try_from_time_in_force`
**Impls**: `BitmexExecInstruction`, `BitmexOrderType`, `BitmexProductType`, `BitmexSide`, `BitmexTimeInForce`, `Deserialize`, `From`, `TryFrom`
...
---
*Generated on 2025-11-18T21:54:58.944360Z*
