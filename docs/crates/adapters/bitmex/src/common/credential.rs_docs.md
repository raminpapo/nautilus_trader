# Documentation: `crates/adapters/bitmex/src/common/credential.rs`
**Generated:** 2025-11-15T19:40:00.293295Z
...
- **Path:** `crates/adapters/bitmex/src/common/credential.rs`
- **Size:** 4,744 bytes
- **Lines:** 138
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/adapters/bitmex/src/common/credential.rs` within the repository.

**Classes defined:** Credential, Debug, Credential

**Functions defined:** fmt, new, sign, test_simple_get, test_get_with_query, test_post_with_data, test_debug_redacts_secret
...
#### `new(api_key: String, api_secret: String)`


#### `sign(&self, verb: &str, endpoint: &str, expires: i64, data: &str)`
