...
- **Path**: `crates/adapters/bitmex/src/common/parse.rs`
- **Size**: 34,251 bytes
- **Lines**: 907
- **Language**: Rust
...
### Functions
- **`clean_reason()`**: Function defined in this file
- **`parse_instrument_id()`**: Function defined in this file
- **`quantity_to_u32()`**: Function defined in this file
- **`parse_contracts_quantity()`**: Function defined in this file
- **`derive_contract_decimal_and_increment()`**: Function defined in this file
- **`convert_contract_quantity()`**: Function defined in this file
- **`parse_signed_contracts_quantity()`**: Function defined in this file
- **`parse_fractional_quantity()`**: Function defined in this file
- **`normalize_trade_bin_prices()`**: Function defined in this file
- **`normalize_trade_bin_volume()`**: Function defined in this file
- **`parse_optional_datetime_to_unix_nanos()`**: Function defined in this file
- **`parse_aggressor_side()`**: Function defined in this file
- **`parse_liquidity_side()`**: Function defined in this file
- **`parse_position_side()`**: Function defined in this file
- **`map_bitmex_currency()`**: Function defined in this file
- **`parse_account_state()`**: Function defined in this file
- **`test_clean_reason_strips_nautilus_trader()`**: Function defined in this file
- **`make_test_spot_instrument()`**: Function defined in this file
- **`test_quantity_to_u32_scaled()`**: Function defined in this file
- **`test_parse_contracts_quantity_scaled()`**: Function defined in this file
...
**Functions**: `clean_reason`, `convert_contract_quantity`, `derive_contract_decimal_and_increment`, `make_test_spot_instrument`, `map_bitmex_currency`, `normalize_trade_bin_prices`, `normalize_trade_bin_volume`, `parse_account_state`, `parse_aggressor_side`, `parse_contracts_quantity`, `parse_fractional_quantity`, `parse_instrument_id`, `parse_liquidity_side`, `parse_optional_datetime_to_unix_nanos`, `parse_position_side`, `parse_signed_contracts_quantity`, `quantity_to_u32`, `test_clean_reason_strips_nautilus_trader`, `test_convert_contract_quantity_scaling`, `test_derive_contract_decimal_defaults_to_one`, `test_parse_account_state`, `test_parse_account_state_usdt`, `test_parse_contracts_quantity_scaled`, `test_parse_margin_available_exceeds_wallet`, `test_parse_margin_message_with_both_standard_and_foreign`, `test_parse_margin_message_with_foreign_requirements`, `test_parse_margin_message_with_missing_fields`, `test_parse_margin_message_with_only_available_margin`, `test_quantity_to_u32_scaled`
...
---
*Generated on 2025-11-18T21:54:58.952139Z*
