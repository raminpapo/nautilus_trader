# Documentation: `crates/adapters/bitmex/src/common/parse.rs`
**Generated:** 2025-11-15T19:40:00.303177Z
**File Size:** 34251 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/adapters/bitmex/src/common/parse.rs` within the repository.

**Functions defined:** clean_reason, parse_instrument_id, quantity_to_u32, parse_contracts_quantity, derive_contract_decimal_and_increment, convert_contract_quantity, parse_signed_contracts_quantity, parse_fractional_quantity, normalize_trade_bin_prices, normalize_trade_bin_volume and 19 more
...
#### `clean_reason(reason: &str)`


#### `parse_instrument_id(symbol: Ustr)`


#### `quantity_to_u32(quantity: &Quantity, instrument: &InstrumentAny)`


#### `parse_contracts_quantity(value: u64, instrument: &InstrumentAny)`
...
#### `parse_signed_contracts_quantity(value: i64, instrument: &InstrumentAny)`


#### `parse_fractional_quantity(value: f64, instrument: &InstrumentAny)`
...
#### `normalize_trade_bin_volume(volume: Option<i64>, symbol: &Ustr)`
...
#### `parse_aggressor_side(side: &Option<BitmexSide>)`


#### `parse_liquidity_side(liquidity: &Option<BitmexLiquidityIndicator>)`


#### `parse_position_side(current_qty: Option<i64>)`


#### `map_bitmex_currency(bitmex_currency: &str)`
...
#### `make_test_spot_instrument(size_increment: f64, size_precision: u8)`
