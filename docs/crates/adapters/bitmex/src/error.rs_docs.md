...
- **Path**: `crates/adapters/bitmex/src/error.rs`
- **Size**: 13,287 bytes
- **Lines**: 403
- **Language**: Rust
...
- **`test_rate_limit_with_retry_after()`**: Function defined in this file
...
**Enums**: `BitmexError`, `BitmexFatalError`, `BitmexNonRetryableError`, `BitmexRetryableError`
**Functions**: `from`, `from_http_status`, `from_rate_limit_headers`, `is_fatal`, `is_retryable`, `retry_after`, `test_error_classification`, `test_rate_limit_parsing`, `test_rate_limit_with_retry_after`, `test_retry_after`
**Impls**: `BitmexError`, `From`

## Related Files

This file is located in `crates/adapters/bitmex/src/`. Related files may include:
...
---
*Generated on 2025-11-18T21:54:58.967312Z*
