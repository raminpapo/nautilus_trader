# Documentation: `crates/adapters/bitmex/src/error.rs`
**Generated:** 2025-11-15T19:40:00.314368Z
**File Size:** 13287 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/adapters/bitmex/src/error.rs` within the repository.

**Classes defined:** BitmexError, From, From

**Functions defined:** from_rate_limit_headers, from_http_status, is_retryable, is_fatal, retry_after, from, from, test_error_classification, test_rate_limit_parsing, test_rate_limit_with_retry_after and 1 more
...
#### `from_http_status(status: StatusCode, message: Option<String>)`
...
**Directory:** `crates/adapters/bitmex/src`
