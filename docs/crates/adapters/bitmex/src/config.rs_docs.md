...
### Classes
- **`BitmexDataClientConfig`**: Class defined in this file
- **`BitmexExecClientConfig`**: Class defined in this file
...
**Functions**: `default`, `has_api_credentials`, `http_base_url`, `new`, `ws_url`
**Impls**: `BitmexDataClientConfig`, `BitmexExecClientConfig`, `Default`
**Structs**: `BitmexDataClientConfig`, `BitmexExecClientConfig`
...
---
*Generated on 2025-11-18T21:54:58.957808Z*
