# Documentation: `crates/adapters/bitmex/src/data/mod.rs`
**Generated:** 2025-11-15T19:40:00.311897Z
**File Size:** 36325 bytes
**Extension:** .rs
**Type:** text
...
- **Path:** `crates/adapters/bitmex/src/data/mod.rs`
- **Size:** 36,325 bytes
- **Lines:** 1,035
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/adapters/bitmex/src/data/mod.rs` within the repository.

**Classes defined:** BitmexDataClient, BitmexDataClient, futures_util, DataClient

**Functions defined:** new, venue, ws_client, ws_client_mut, send_data, spawn_ws, spawn_stream_task, handle_ws_message, bootstrap_instruments, is_connected and 35 more
...
#### `new(client_id: ClientId, config: BitmexDataClientConfig)`
...
#### `subscribe_book_depth10(&mut self, cmd: &SubscribeBookDepth10)`
...
#### `unsubscribe_book_depth10(&mut self, cmd: &UnsubscribeBookDepth10)`
...
**Directory:** `crates/adapters/bitmex/src/data`
...
**Security:** This file may contain sensitive patterns: secret, token, api_key, auth. Ensure proper handling of secrets.
