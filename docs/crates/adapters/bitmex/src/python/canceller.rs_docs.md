# Documentation: `crates/adapters/bitmex/src/python/canceller.rs`
**Generated:** 2025-11-15T19:40:00.359860Z
...
This file is located at `crates/adapters/bitmex/src/python/canceller.rs` within the repository.

**Classes defined:** CancelBroadcaster

**Functions defined:** py_new, py_cache_instrument, py_start, py_stop, py_broadcast_cancel, py_broadcast_batch_cancel, py_broadcast_cancel_all, py_get_metrics, py_get_client_stats
...
#### `py_start(&self, py: Python<'py>)`


#### `py_stop(&self, py: Python<'py>)`
...
#### `py_get_metrics(&self, py: Python<'_>)`


#### `py_get_client_stats(&self, py: Python<'_>)`
