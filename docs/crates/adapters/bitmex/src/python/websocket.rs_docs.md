# Documentation: `crates/adapters/bitmex/src/python/websocket.rs`
**Generated:** 2025-11-15T19:40:00.371436Z
**File Size:** 24858 bytes
**Extension:** .rs
**Type:** text
...
- **Path:** `crates/adapters/bitmex/src/python/websocket.rs`
- **Size:** 24,858 bytes
- **Lines:** 723
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/adapters/bitmex/src/python/websocket.rs` within the repository.

**Classes defined:** BitmexWebSocketClient

**Functions defined:** py_new, py_from_env, py_url, py_api_key, py_is_active, py_is_closed, py_get_subscriptions, py_set_account_id, py_cache_instrument, py_connect and 35 more
...
#### `py_is_active(&mut self)`


#### `py_is_closed(&mut self)`


#### `py_get_subscriptions(&self, instrument_id: InstrumentId)`


#### `py_set_account_id(&mut self, account_id: AccountId)`


#### `py_cache_instrument(&self, py: Python, instrument: Py<PyAny>)`
...
#### `py_close(&self, py: Python<'py>)`


#### `py_subscribe_instruments(&self, py: Python<'py>)`
...
#### `py_unsubscribe_instruments(&self, py: Python<'py>)`
...
#### `py_subscribe_orders(&self, py: Python<'py>)`


#### `py_subscribe_executions(&self, py: Python<'py>)`


#### `py_subscribe_positions(&self, py: Python<'py>)`


#### `py_subscribe_margin(&self, py: Python<'py>)`


#### `py_subscribe_wallet(&self, py: Python<'py>)`


#### `py_unsubscribe_orders(&self, py: Python<'py>)`


#### `py_unsubscribe_executions(&self, py: Python<'py>)`


#### `py_unsubscribe_positions(&self, py: Python<'py>)`


#### `py_unsubscribe_margin(&self, py: Python<'py>)`


#### `py_unsubscribe_wallet(&self, py: Python<'py>)`
