# Documentation: `crates/adapters/bitmex/src/python/http.rs`
**Generated:** 2025-11-15T19:40:00.363998Z
**File Size:** 22956 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/adapters/bitmex/src/python/http.rs` within the repository.

**Classes defined:** BitmexHttpClient, From

**Functions defined:** py_new, py_from_env, py_base_url, py_api_key, py_update_position_leverage, py_request_instrument, py_request_instruments, py_request_trades, py_request_bars, py_query_order and 16 more
...
#### `py_cache_instrument(&mut self, py: Python, instrument: Py<PyAny>)`


#### `py_cancel_all_requests(&self)`


#### `py_get_margin(&self, py: Python<'py>, currency: String)`
