...
- **Path**: `crates/adapters/bitmex/src/python/http.rs`
- **Size**: 22,956 bytes
- **Lines**: 664
- **Language**: Rust
...
- **`py_update_position_leverage()`**: Function defined in this file
...
- **`py_request_fill_reports()`**: Function defined in this file
- **`py_request_position_status_reports()`**: Function defined in this file
- **`py_submit_order()`**: Function defined in this file
- **`py_cancel_order()`**: Function defined in this file
- **`py_cancel_orders()`**: Function defined in this file
...
**Functions**: `from`, `py_api_key`, `py_base_url`, `py_cache_instrument`, `py_cancel_all_orders`, `py_cancel_all_requests`, `py_cancel_order`, `py_cancel_orders`, `py_from_env`, `py_get_margin`, `py_get_server_time`, `py_modify_order`, `py_modify_orders_bulk`, `py_new`, `py_query_order`, `py_request_account_state`, `py_request_bars`, `py_request_fill_reports`, `py_request_instrument`, `py_request_instruments`, `py_request_order_status_reports`, `py_request_position_status_reports`, `py_request_trades`, `py_submit_order`, `py_submit_orders_bulk`, `py_update_position_leverage`
**Impls**: `BitmexHttpClient`, `From`
...
---
*Generated on 2025-11-18T21:54:59.043777Z*
