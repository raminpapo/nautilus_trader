# Documentation: `crates/adapters/bitmex/src/python/submitter.rs`
**Generated:** 2025-11-15T19:40:00.367180Z
...
- **Path:** `crates/adapters/bitmex/src/python/submitter.rs`
- **Size:** 7,374 bytes
- **Lines:** 206
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/adapters/bitmex/src/python/submitter.rs` within the repository.

**Classes defined:** SubmitBroadcaster

**Functions defined:** py_new, py_start, py_stop, py_broadcast_submit, py_get_metrics, py_get_client_stats, py_cache_instrument
