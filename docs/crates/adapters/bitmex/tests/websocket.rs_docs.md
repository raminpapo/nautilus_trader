...
- **Path**: `crates/adapters/bitmex/tests/websocket.rs`
- **Size**: 84,311 bytes
- **Lines**: 2,414
- **Language**: Rust
...
This file is part of the NautilusTrader repository. It defines 41 function(s) and 1 class(es).

## Detailed Walkthrough

### Functions
- **`fail_next_subscription()`**: Function defined in this file
- **`set_auth_response_delay_ms()`**: Function defined in this file
- **`clear_subscription_events()`**: Function defined in this file
- **`subscription_events()`**: Function defined in this file
- **`default()`**: Function defined in this file
- **`load_test_data()`**: Function defined in this file
- **`handle_websocket()`**: Function defined in this file
- **`handle_socket()`**: Function defined in this file
- **`create_test_router()`**: Function defined in this file
- **`wait_for_subscription_events()`**: Function defined in this file
- **`wait_for_connection_count()`**: Function defined in this file
- **`start_test_server()`**: Function defined in this file
- **`get_test_account_id()`**: Function defined in this file
- **`test_bitmex_websocket_client_creation()`**: Function defined in this file
- **`test_websocket_connection()`**: Function defined in this file
- **`test_client_replies_to_server_ping()`**: Function defined in this file
- **`test_subscribe_to_public_data()`**: Function defined in this file
- **`test_subscribe_to_orderbook()`**: Function defined in this file
- **`test_subscribe_to_private_data()`**: Function defined in this file
- **`test_reconnection_scenario()`**: Function defined in this file
...
**Functions**: `clear_subscription_events`, `create_test_router`, `default`, `fail_next_subscription`, `get_test_account_id`, `handle_socket`, `handle_websocket`, `load_test_data`, `set_auth_response_delay_ms`, `start_test_server`, `subscription_events`, `test_auth_and_subscription_restoration_order`, `test_bitmex_websocket_client_creation`, `test_client_replies_to_server_ping`, `test_heartbeat_timeout_reconnection`, `test_is_active_false_after_close`, `test_is_active_false_during_reconnection`, `test_is_active_lifecycle`, `test_login_failure_emits_error`, `test_multiple_partial_subscription_failures`, `test_multiple_symbols_subscription`, `test_rapid_consecutive_reconnections`, `test_reconnection_race_condition`, `test_reconnection_retries_failed_subscriptions`, `test_reconnection_scenario`, `test_reconnection_waits_for_delayed_auth_ack`, `test_sends_pong_for_control_ping`, `test_sends_pong_for_text_ping`, `test_subscribe_after_stream_call`, `test_subscribe_to_orderbook` *(+11 more)*
**Impls**: `Default`, `TestServerState`
**Structs**: `TestServerState`

## Related Files

This file is located in `crates/adapters/bitmex/tests/`. Related files may include:
...
```bash
# For Python
pytest crates/adapters/bitmex/tests/websocket.rs
...
---
*Generated on 2025-11-18T21:54:59.144475Z*
