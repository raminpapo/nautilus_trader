# Documentation: `crates/adapters/bitmex/tests/websocket.rs`
**Generated:** 2025-11-15T19:40:00.430061Z
...
This file is located at `crates/adapters/bitmex/tests/websocket.rs` within the repository.

**Classes defined:** TestServerState, TestServerState, Default

**Functions defined:** fail_next_subscription, set_auth_response_delay_ms, clear_subscription_events, subscription_events, default, load_test_data, handle_websocket, handle_socket, create_test_router, wait_for_subscription_events and 31 more
...
#### `fail_next_subscription(&self, topic: &str)`


#### `set_auth_response_delay_ms(&self, delay_ms: Option<u64>)`
...
**Directory:** `crates/adapters/bitmex/tests`
