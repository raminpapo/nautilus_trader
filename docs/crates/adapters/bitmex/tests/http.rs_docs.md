...
- **Path**: `crates/adapters/bitmex/tests/http.rs`
- **Size**: 19,211 bytes
- **Lines**: 670
- **Language**: Rust
...
This file is part of the NautilusTrader repository. It defines 24 function(s) and 1 class(es).
...
- **`handle_get_instrument()`**: Function defined in this file
- **`handle_get_wallet()`**: Function defined in this file
...
- **`handle_delete_order()`**: Function defined in this file
- **`create_test_router()`**: Function defined in this file
- **`start_test_server()`**: Function defined in this file
- **`test_get_instruments()`**: Function defined in this file
- **`test_get_instrument_single_result()`**: Function defined in this file
- **`test_request_instrument()`**: Function defined in this file
- **`test_get_wallet_requires_auth()`**: Function defined in this file
- **`test_get_orders()`**: Function defined in this file
- **`test_place_order()`**: Function defined in this file
- **`test_cancel_order()`**: Function defined in this file
- **`test_rate_limiting()`**: Function defined in this file
...
**Functions**: `create_test_router`, `default`, `handle_delete_order`, `handle_get_instrument`, `handle_get_instruments`, `handle_get_orders`, `handle_get_positions`, `handle_get_wallet`, `handle_post_order`, `load_test_data`, `start_test_server`, `test_cancel_order`, `test_client_creation`, `test_client_with_credentials`, `test_get_instrument_single_result`, `test_get_instruments`, `test_get_orders`, `test_get_positions_requires_credentials`, `test_get_wallet_requires_auth`, `test_http_500_internal_server_error`, `test_http_network_error`, `test_place_order`, `test_rate_limiting`, `test_request_instrument`
...
```bash
# For Python
pytest crates/adapters/bitmex/tests/http.rs
...
---
*Generated on 2025-11-18T21:54:59.133454Z*
