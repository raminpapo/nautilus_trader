# Documentation: `crates/adapters/bitmex/tests/http.rs`
**Generated:** 2025-11-15T19:40:00.423232Z
...
This file is located at `crates/adapters/bitmex/tests/http.rs` within the repository.

**Classes defined:** TestServerState, Default, IntoResponse, IntoResponse

**Functions defined:** default, load_test_data, handle_get_instruments, handle_get_instrument, handle_get_wallet, handle_get_positions, handle_get_orders, handle_post_order, handle_delete_order, create_test_router and 14 more
...
#### `handle_get_instrument(query: Query<HashMap<String, String>>)`


#### `handle_get_wallet(headers: axum::http::HeaderMap)`
...
#### `handle_post_order(headers: axum::http::HeaderMap, body: String)`


#### `handle_delete_order(headers: axum::http::HeaderMap, body: String)`
