# Documentation: `crates/adapters/coinbase_intx/src/common/credential.rs`
**Generated:** 2025-11-15T19:40:00.755423Z
...
- **Path:** `crates/adapters/coinbase_intx/src/common/credential.rs`
- **Size:** 5,200 bytes
- **Lines:** 144
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/adapters/coinbase_intx/src/common/credential.rs` within the repository.

**Classes defined:** Credential, Debug, Credential

**Functions defined:** fmt, new, sign, sign_ws, test_simple_get, test_debug_redacts_secret
