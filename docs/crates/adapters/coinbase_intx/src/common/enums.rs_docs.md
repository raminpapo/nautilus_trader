# Documentation: `crates/adapters/coinbase_intx/src/common/enums.rs`
**Generated:** 2025-11-15T19:40:00.757376Z
...
This file is located at `crates/adapters/coinbase_intx/src/common/enums.rs` within the repository.

**Classes defined:** From, From, From, From, From, From, From, From

**Functions defined:** from, from, from, from, from, from, from, from
...
#### `from(value: AggressorSide)`


#### `from(value: CoinbaseIntxSide)`


#### `from(value: CoinbaseIntxSide)`


#### `from(value: CoinbaseIntxOrderType)`


#### `from(value: OrderType)`


#### `from(time_in_force: TimeInForce)`


#### `from(coinbase_tif: CoinbaseIntxTimeInForce)`
