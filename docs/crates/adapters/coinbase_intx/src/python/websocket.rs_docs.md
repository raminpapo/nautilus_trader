...
- **Path**: `crates/adapters/coinbase_intx/src/python/websocket.rs`
- **Size**: 15,239 bytes
- **Lines**: 444
- **Language**: Rust
...
- **`py_subscribe_index_prices()`**: Function defined in this file
- **`py_subscribe_bars()`**: Function defined in this file
- **`py_unsubscribe_instruments()`**: Function defined in this file
...
**Functions**: `call_python`, `py_api_key`, `py_close`, `py_connect`, `py_get_subscriptions`, `py_is_active`, `py_is_closed`, `py_new`, `py_subscribe_bars`, `py_subscribe_book`, `py_subscribe_index_prices`, `py_subscribe_instruments`, `py_subscribe_mark_prices`, `py_subscribe_quotes`, `py_subscribe_trades`, `py_unsubscribe_bars`, `py_unsubscribe_book`, `py_unsubscribe_index_prices`, `py_unsubscribe_instruments`, `py_unsubscribe_mark_prices`, `py_unsubscribe_quotes`, `py_unsubscribe_trades`, `py_url`, `py_wait_until_active`
**Impls**: `CoinbaseIntxWebSocketClient`
...
---
*Generated on 2025-11-18T21:54:59.624448Z*
