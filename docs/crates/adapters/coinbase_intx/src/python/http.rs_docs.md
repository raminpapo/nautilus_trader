# Documentation: `crates/adapters/coinbase_intx/src/python/http.rs`
**Generated:** 2025-11-15T19:40:00.796115Z
...
This file is located at `crates/adapters/coinbase_intx/src/python/http.rs` within the repository.

**Classes defined:** CoinbaseIntxHttpClient

**Functions defined:** py_new, py_base_url, py_api_key, py_is_initialized, py_get_cached_symbols, py_add_instrument, py_list_portfolios, py_request_account_state, py_request_instruments, py_request_instrument and 9 more
...
#### `py_add_instrument(&mut self, py: Python<'_>, instrument: Py<PyAny>)`


#### `py_list_portfolios(&mut self, py: Python<'py>)`
...
#### `py_request_instruments(&self, py: Python<'py>)`
...
#### `py_request_order_status_report(
        &self,
        py: Python<'py>,
        account_id: AccountId,
        venue_order_id: VenueOrderId,
...
#### `py_request_position_status_report(
        &self,
        py: Python<'py>,
        account_id: AccountId,
        symbol: Symbol,
