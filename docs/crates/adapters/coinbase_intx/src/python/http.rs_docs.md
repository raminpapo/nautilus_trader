...
- **Path**: `crates/adapters/coinbase_intx/src/python/http.rs`
- **Size**: 12,538 bytes
- **Lines**: 379
- **Language**: Rust
...
- **`py_list_portfolios()`**: Function defined in this file
...
- **`py_request_order_status_report()`**: Function defined in this file
- **`py_request_order_status_reports()`**: Function defined in this file
- **`py_request_fill_reports()`**: Function defined in this file
- **`py_request_position_status_report()`**: Function defined in this file
...
**Functions**: `py_add_instrument`, `py_api_key`, `py_base_url`, `py_cancel_order`, `py_cancel_orders`, `py_get_cached_symbols`, `py_is_initialized`, `py_list_portfolios`, `py_modify_order`, `py_new`, `py_request_account_state`, `py_request_fill_reports`, `py_request_instrument`, `py_request_instruments`, `py_request_order_status_report`, `py_request_order_status_reports`, `py_request_position_status_report`, `py_request_position_status_reports`, `py_submit_order`
**Impls**: `CoinbaseIntxHttpClient`

## Related Files

This file is located in `crates/adapters/coinbase_intx/src/python/`. Related files may include:
...
---
*Generated on 2025-11-18T21:54:59.620071Z*
