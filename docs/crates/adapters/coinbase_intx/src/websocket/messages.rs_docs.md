...
- **Path**: `crates/adapters/coinbase_intx/src/websocket/messages.rs`
- **Size**: 13,755 bytes
- **Lines**: 390
- **Language**: Rust
...
This file is part of the NautilusTrader repository. It defines 6 function(s) and 14 class(es).

## Detailed Walkthrough

### Functions
- **`test_parse_asset_model()`**: Function defined in this file
- **`test_parse_ws_trade_msg()`**: Function defined in this file
- **`test_parse_ws_quote_msg()`**: Function defined in this file
- **`test_parse_ws_order_book_snapshot_msg()`**: Function defined in this file
- **`test_parse_ws_order_book_update_msg()`**: Function defined in this file
- **`test_parse_ws_candle_snapshot_msg()`**: Function defined in this file

### Classes
- **`CoinbaseIntxSubscription`**: Class defined in this file
- **`CoinbaseIntxWsRejectMsg`**: Class defined in this file
- **`CoinbaseIntxWsConfirmationMsg`**: Class defined in this file
- **`CoinbaseIntxWsChannelDetails`**: Class defined in this file
- **`CoinbaseIntxWsInstrumentMsg`**: Class defined in this file
- **`CoinbaseIntxWsFundingMsg`**: Class defined in this file
- **`CoinbaseIntxWsRiskMsg`**: Class defined in this file
- **`CoinbaseIntxWsOrderBookSnapshotMsg`**: Class defined in this file
- **`CoinbaseIntxWsOrderBookUpdateMsg`**: Class defined in this file
- **`CoinbaseIntxWsQuoteMsg`**: Class defined in this file
- **`CoinbaseIntxWsTradeMsg`**: Class defined in this file
- **`CoinbaseIntxWsCandle`**: Class defined in this file
- **`CoinbaseIntxWsCandleSnapshotMsg`**: Class defined in this file
- **`CoinbaseIntxWsCandleUpdateMsg`**: Class defined in this file
...
**Enums**: `CoinbaseIntxWsMessage`, `NautilusWsMessage`
**Functions**: `test_parse_asset_model`, `test_parse_ws_candle_snapshot_msg`, `test_parse_ws_order_book_snapshot_msg`, `test_parse_ws_order_book_update_msg`, `test_parse_ws_quote_msg`, `test_parse_ws_trade_msg`
**Structs**: `CoinbaseIntxSubscription`, `CoinbaseIntxWsCandle`, `CoinbaseIntxWsCandleSnapshotMsg`, `CoinbaseIntxWsCandleUpdateMsg`, `CoinbaseIntxWsChannelDetails`, `CoinbaseIntxWsConfirmationMsg`, `CoinbaseIntxWsFundingMsg`, `CoinbaseIntxWsInstrumentMsg`, `CoinbaseIntxWsOrderBookSnapshotMsg`, `CoinbaseIntxWsOrderBookUpdateMsg`, `CoinbaseIntxWsQuoteMsg`, `CoinbaseIntxWsRejectMsg`, `CoinbaseIntxWsRiskMsg`, `CoinbaseIntxWsTradeMsg`
...
---
*Generated on 2025-11-18T21:54:59.637653Z*
