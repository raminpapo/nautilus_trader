...
- **Path**: `crates/adapters/coinbase_intx/src/websocket/parse.rs`
- **Size**: 15,332 bytes
- **Lines**: 501
- **Language**: Rust
...
- **`parse_orderbook_snapshot_msg()`**: Function defined in this file
- **`parse_orderbook_update_msg()`**: Function defined in this file
...
**Functions**: `parse_candle_msg`, `parse_index_price_msg`, `parse_instrument_any`, `parse_mark_price_msg`, `parse_orderbook_snapshot_msg`, `parse_orderbook_update_msg`, `parse_perp_instrument`, `parse_quote_msg`, `parse_spot_instrument`, `parse_trade_msg`
...
---
*Generated on 2025-11-18T21:54:59.642667Z*
