# Documentation: `crates/adapters/coinbase_intx/src/websocket/client.rs`
**Generated:** 2025-11-15T19:40:00.804976Z
**File Size:** 38283 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/adapters/coinbase_intx/src/websocket/client.rs` within the repository.

**Classes defined:** CoinbaseIntxWebSocketClient, CoinbaseIntxFeedHandler, CoinbaseIntxWsMessageHandler, Default, CoinbaseIntxWebSocketClient, Stream, CoinbaseIntxFeedHandler, CoinbaseIntxWsMessageHandler

**Functions defined:** default, new, from_env, url, api_key, is_active, is_closed, cache_instruments, get_subscriptions, connect and 30 more
...
#### `instrument_ids_to_product_ids(instrument_ids: &[InstrumentId])`


#### `new(reader: MessageReader, signal: Arc<AtomicBool>)`
