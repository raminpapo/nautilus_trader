...
- **Path**: `crates/adapters/coinbase_intx/src/websocket/client.rs`
- **Size**: 38,284 bytes
- **Lines**: 997
- **Language**: Rust
...
This file is part of the NautilusTrader repository. It defines 40 function(s) and 3 class(es).
...
- **`get_subscriptions()`**: Function defined in this file
...
- **`resubscribe_all()`**: Function defined in this file
- **`subscribe_instruments()`**: Function defined in this file
- **`subscribe_funding_rates()`**: Function defined in this file
- **`subscribe_risk()`**: Function defined in this file
- **`subscribe_book()`**: Function defined in this file

*...and 20 more functions*

### Classes
- **`CoinbaseIntxWebSocketClient`**: Class defined in this file
- **`CoinbaseIntxFeedHandler`**: Class defined in this file
- **`CoinbaseIntxWsMessageHandler`**: Class defined in this file
...
**Functions**: `api_key`, `cache_instruments`, `close`, `connect`, `default`, `from_env`, `get_subscriptions`, `instrument_ids_to_product_ids`, `is_active`, `is_closed`, `new`, `next`, `resubscribe_all`, `run`, `stream`, `subscribe`, `subscribe_bars`, `subscribe_book`, `subscribe_funding_rates`, `subscribe_index_prices`, `subscribe_instruments`, `subscribe_mark_prices`, `subscribe_quotes`, `subscribe_risk`, `subscribe_trades`, `unsubscribe`, `unsubscribe_bars`, `unsubscribe_book`, `unsubscribe_funding`, `unsubscribe_index_prices` *(+7 more)*
**Impls**: `CoinbaseIntxFeedHandler`, `CoinbaseIntxWebSocketClient`, `CoinbaseIntxWsMessageHandler`, `Default`, `Stream`
**Structs**: `CoinbaseIntxFeedHandler`, `CoinbaseIntxWebSocketClient`, `CoinbaseIntxWsMessageHandler`
...
---
*Generated on 2025-11-18T21:54:59.630920Z*
