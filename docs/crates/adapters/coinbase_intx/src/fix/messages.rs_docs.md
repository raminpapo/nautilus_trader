# Documentation: `crates/adapters/coinbase_intx/src/fix/messages.rs`
**Generated:** 2025-11-15T19:40:00.767682Z
...
This file is located at `crates/adapters/coinbase_intx/src/fix/messages.rs` within the repository.

**Classes defined:** FixMessage, FixMessage, Into, Into

**Functions defined:** new, msg_type, msg_seq_num, get_field, add_field, parse, get_field_checked, set_field, to_bytes, create_logon and 4 more
...
#### `get_field(&self, tag: u32)`


#### `add_field(&mut self, tag: u32, value: impl Into<String>)`


#### `parse(data: &[u8])`


#### `get_field_checked(&self, tag: u32)`


#### `set_field(&mut self, tag: u32, value: impl Into<String>)`
...
**Directory:** `crates/adapters/coinbase_intx/src/fix`
