...
- **Path**: `crates/adapters/coinbase_intx/src/fix/messages.rs`
- **Size**: 13,345 bytes
- **Lines**: 372
- **Language**: Rust
...
- **`msg_type()`**: Function defined in this file
- **`msg_seq_num()`**: Function defined in this file
- **`get_field()`**: Function defined in this file
- **`add_field()`**: Function defined in this file
- **`parse()`**: Function defined in this file
- **`get_field_checked()`**: Function defined in this file
- **`set_field()`**: Function defined in this file
- **`to_bytes()`**: Function defined in this file
- **`create_logon()`**: Function defined in this file
- **`create_heartbeat()`**: Function defined in this file
- **`create_logout()`**: Function defined in this file
- **`test_fix_message_to_bytes_simple()`**: Function defined in this file
- **`test_fix_message_to_bytes_complete_logon()`**: Function defined in this file

### Classes
- **`FixMessage`**: Class defined in this file
...
**Functions**: `add_field`, `create_heartbeat`, `create_logon`, `create_logout`, `get_field`, `get_field_checked`, `msg_seq_num`, `msg_type`, `new`, `parse`, `set_field`, `test_fix_message_to_bytes_complete_logon`, `test_fix_message_to_bytes_simple`, `to_bytes`
**Impls**: `FixMessage`, `Into`
**Structs**: `FixMessage`

## Related Files

This file is located in `crates/adapters/coinbase_intx/src/fix/`. Related files may include:
...
---
*Generated on 2025-11-18T21:54:59.585357Z*
