...
- **Path**: `crates/adapters/coinbase_intx/src/fix/client.rs`
- **Size**: 20,481 bytes
- **Lines**: 532
- **Language**: Rust
...
- **`portfolio_id()`**: Function defined in this file
- **`sender_comp_id()`**: Function defined in this file
- **`target_comp_id()`**: Function defined in this file
- **`is_connected()`**: Function defined in this file
- **`is_logged_on()`**: Function defined in this file
- **`connect()`**: Function defined in this file
- **`close()`**: Function defined in this file
- **`send_logon()`**: Function defined in this file
- **`send_logout()`**: Function defined in this file
- **`call_python()`**: Function defined in this file

### Classes
- **`CoinbaseIntxFixClient`**: Class defined in this file
...
**Functions**: `api_key`, `call_python`, `close`, `connect`, `endpoint`, `from_env`, `is_connected`, `is_logged_on`, `new`, `portfolio_id`, `send_logon`, `send_logout`, `sender_comp_id`, `target_comp_id`
**Impls**: `CoinbaseIntxFixClient`
**Structs**: `CoinbaseIntxFixClient`
...
---
*Generated on 2025-11-18T21:54:59.582333Z*
