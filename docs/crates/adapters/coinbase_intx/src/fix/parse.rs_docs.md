# Documentation: `crates/adapters/coinbase_intx/src/fix/parse.rs`
**Generated:** 2025-11-15T19:40:00.771437Z
**File Size:** 10345 bytes
**Extension:** .rs
**Type:** text
...
- **Path:** `crates/adapters/coinbase_intx/src/fix/parse.rs`
- **Size:** 10,345 bytes
- **Lines:** 279
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/adapters/coinbase_intx/src/fix/parse.rs` within the repository.

**Functions defined:** convert_to_order_status_report, convert_to_fill_report, parse_fix_timestamp
...
#### `convert_to_order_status_report(
    message: &FixMessage,
    account_id: AccountId,
    ts_init: UnixNanos,
)`
...
#### `parse_fix_timestamp(timestamp: &str)`
