...
- **Path**: `crates/adapters/coinbase_intx/src/http/query.rs`
- **Size**: 8,362 bytes
- **Lines**: 211
- **Language**: Rust
...
### Classes
- **`CreateOrderParams`**: Class defined in this file
- **`GetOrderParams`**: Class defined in this file
- **`GetOrdersParams`**: Class defined in this file
- **`CancelOrderParams`**: Class defined in this file
- **`CancelOrdersParams`**: Class defined in this file
- **`ModifyOrderParams`**: Class defined in this file
- **`GetPortfolioFillsParams`**: Class defined in this file
...
**Structs**: `CancelOrderParams`, `CancelOrdersParams`, `CreateOrderParams`, `GetOrderParams`, `GetOrdersParams`, `GetPortfolioFillsParams`, `ModifyOrderParams`
...
---
*Generated on 2025-11-18T21:54:59.614374Z*
