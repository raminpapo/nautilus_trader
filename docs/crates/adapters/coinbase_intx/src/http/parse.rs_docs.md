# Documentation: `crates/adapters/coinbase_intx/src/http/parse.rs`
**Generated:** 2025-11-15T19:40:00.788086Z
...
This file is located at `crates/adapters/coinbase_intx/src/http/parse.rs` within the repository.

**Functions defined:** parse_spot_instrument, parse_perp_instrument, parse_instrument_any, parse_account_state, parse_order_status, parse_price, parse_quantity, parse_order_status_report, parse_fill_report, parse_position_status_report and 2 more
...
#### `parse_order_status(coinbase_order: &CoinbaseIntxOrder)`
