...
- **Path**: `crates/adapters/coinbase_intx/src/http/parse.rs`
- **Size**: 19,186 bytes
- **Lines**: 536
- **Language**: Rust
...
- **`test_parse_perp_instrument()`**: Function defined in this file
...
**Functions**: `parse_account_state`, `parse_fill_report`, `parse_instrument_any`, `parse_order_status`, `parse_order_status_report`, `parse_perp_instrument`, `parse_position_status_report`, `parse_price`, `parse_quantity`, `parse_spot_instrument`, `test_parse_perp_instrument`, `test_parse_spot_instrument`
...
---
*Generated on 2025-11-18T21:54:59.611539Z*
