...
- **Path**: `crates/adapters/coinbase_intx/src/http/client.rs`
- **Size**: 43,553 bytes
- **Lines**: 1,226
- **Language**: Rust
...
This file is part of the NautilusTrader repository. It defines 52 function(s) and 3 class(es).
...
- **`with_credentials()`**: Function defined in this file
- **`default_headers()`**: Function defined in this file
- **`sign_request()`**: Function defined in this file
- **`send_request()`**: Function defined in this file
- **`http_list_assets()`**: Function defined in this file
- **`http_get_asset_details()`**: Function defined in this file
- **`http_list_instruments()`**: Function defined in this file
- **`http_get_instrument_details()`**: Function defined in this file
- **`http_list_fee_rate_tiers()`**: Function defined in this file
- **`http_list_portfolios()`**: Function defined in this file
- **`http_get_portfolio()`**: Function defined in this file
- **`http_get_portfolio_details()`**: Function defined in this file
- **`http_get_portfolio_summary()`**: Function defined in this file
- **`http_list_portfolio_balances()`**: Function defined in this file
- **`http_get_portfolio_balance()`**: Function defined in this file
- **`http_list_portfolio_fills()`**: Function defined in this file
- **`http_list_portfolio_positions()`**: Function defined in this file
- **`http_get_portfolio_position()`**: Function defined in this file

*...and 32 more functions*

### Classes
- **`CoinbaseIntxResponse`**: Class defined in this file
- **`CoinbaseIntxHttpInnerClient`**: Class defined in this file
- **`CoinbaseIntxHttpClient`**: Class defined in this file
...
**Functions**: `add_instrument`, `add_instruments`, `api_key`, `base_url`, `cancel_order`, `cancel_orders`, `default`, `default_headers`, `from_env`, `generate_ts_init`, `get_cached_symbols`, `get_instrument_from_cache`, `http_cancel_order`, `http_cancel_orders`, `http_create_order`, `http_get_asset_details`, `http_get_instrument_details`, `http_get_order`, `http_get_portfolio`, `http_get_portfolio_balance`, `http_get_portfolio_details`, `http_get_portfolio_position`, `http_get_portfolio_summary`, `http_list_assets`, `http_list_fee_rate_tiers`, `http_list_instruments`, `http_list_open_orders`, `http_list_portfolio_balances`, `http_list_portfolio_fee_rates`, `http_list_portfolio_fills` *(+19 more)*
**Impls**: `CoinbaseIntxHttpClient`, `CoinbaseIntxHttpInnerClient`, `Default`
**Structs**: `CoinbaseIntxHttpClient`, `CoinbaseIntxHttpInnerClient`, `CoinbaseIntxResponse`
...
---
*Generated on 2025-11-18T21:54:59.596037Z*
