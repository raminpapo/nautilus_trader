# Documentation: `crates/adapters/coinbase_intx/src/http/client.rs`
**Generated:** 2025-11-15T19:40:00.776457Z
**File Size:** 43553 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/adapters/coinbase_intx/src/http/client.rs` within the repository.

**Classes defined:** CoinbaseIntxResponse, CoinbaseIntxHttpInnerClient, CoinbaseIntxHttpClient, Default, CoinbaseIntxHttpInnerClient, Default, CoinbaseIntxHttpClient

**Functions defined:** default, new, with_credentials, default_headers, sign_request, send_request, http_list_assets, http_get_asset_details, http_list_instruments, http_get_instrument_details and 42 more
...
#### `get_instrument_from_cache(&self, symbol: Ustr)`


#### `generate_ts_init(&self)`
...
#### `get_cached_symbols(&self)`


#### `add_instruments(&mut self, instruments: Vec<InstrumentAny>)`


#### `add_instrument(&mut self, instrument: InstrumentAny)`


#### `list_portfolios(&self)`
...
#### `request_instrument(&self, symbol: &Symbol)`
...
**Directory:** `crates/adapters/coinbase_intx/src/http`
