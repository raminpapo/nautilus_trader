...
- **Path**: `crates/adapters/coinbase_intx/src/http/models.rs`
- **Size**: 29,961 bytes
- **Lines**: 778
- **Language**: Rust
...
This file is part of the NautilusTrader repository. It defines 8 function(s) and 15 class(es).

## Detailed Walkthrough

### Functions
- **`empty_string_as_none()`**: Function defined in this file
- **`deserialize_optional_datetime()`**: Function defined in this file
- **`test_parse_asset_model()`**: Function defined in this file
- **`test_parse_spot_model()`**: Function defined in this file
- **`test_parse_perp_model()`**: Function defined in this file
- **`test_parse_fee_rate_tiers()`**: Function defined in this file
- **`test_parse_order()`**: Function defined in this file
- **`test_parse_position()`**: Function defined in this file

### Classes
- **`CoinbaseIntxAsset`**: Class defined in this file
- **`CoinbaseIntxInstrument`**: Class defined in this file
- **`CoinbaseIntxInstrumentQuote`**: Class defined in this file
- **`CoinbaseIntxFeeTier`**: Class defined in this file
- **`CoinbaseIntxPortfolioFeeRates`**: Class defined in this file
- **`CoinbaseIntxPortfolio`**: Class defined in this file
- **`CoinbaseIntxPortfolioDetails`**: Class defined in this file
- **`CoinbaseIntxPortfolioSummary`**: Class defined in this file
- **`CoinbaseIntxBalance`**: Class defined in this file
- **`CoinbaseIntxOrderList`**: Class defined in this file
- **`OrderListPagination`**: Class defined in this file
- **`CoinbaseIntxOrder`**: Class defined in this file
- **`CoinbaseIntxFillList`**: Class defined in this file
- **`CoinbaseIntxFill`**: Class defined in this file
- **`CoinbaseIntxPosition`**: Class defined in this file
...
**Functions**: `deserialize_optional_datetime`, `empty_string_as_none`, `test_parse_asset_model`, `test_parse_fee_rate_tiers`, `test_parse_order`, `test_parse_perp_model`, `test_parse_position`, `test_parse_spot_model`
**Structs**: `CoinbaseIntxAsset`, `CoinbaseIntxBalance`, `CoinbaseIntxFeeTier`, `CoinbaseIntxFill`, `CoinbaseIntxFillList`, `CoinbaseIntxInstrument`, `CoinbaseIntxInstrumentQuote`, `CoinbaseIntxOrder`, `CoinbaseIntxOrderList`, `CoinbaseIntxPortfolio`, `CoinbaseIntxPortfolioDetails`, `CoinbaseIntxPortfolioFeeRates`, `CoinbaseIntxPortfolioSummary`, `CoinbaseIntxPosition`, `OrderListPagination`
...
---
*Generated on 2025-11-18T21:54:59.607295Z*
