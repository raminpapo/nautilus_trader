# Documentation: http_post_orders.json
...
**Identifiers**: `BOTH`, `ETH`, `GTC`, `LIMIT`, `NEW`, `PERP`, `SELL`, `WORKING`
...
```bash
# For Python
pytest crates/adapters/coinbase_intx/test_data/http_post_orders.json
...
---
*Generated on 2025-11-18T21:54:59.661614Z*
