# Documentation: `crates/adapters/kraken/tests/http.rs`
**Generated:** 2025-11-15T19:40:01.201916Z
**File Size:** 20549 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/adapters/kraken/tests/http.rs` within the repository.

**Classes defined:** TestServerState

**Functions defined:** manifest_path, load_test_data, has_auth_headers, mock_server_time, mock_system_status, mock_asset_pairs, mock_ticker, mock_ohlc, mock_order_book, mock_trades and 19 more
...
#### `mock_websockets_token(headers: HeaderMap)`


#### `mock_rate_limit_error()`


#### `mock_handler(req: Request, state: Arc<TestServerState>)`


#### `create_router(state: Arc<TestServerState>)`


#### `test_http_get_server_time()`


#### `test_http_get_system_status()`


#### `test_http_get_asset_pairs()`


#### `test_http_request_instruments()`


#### `test_http_get_ticker()`


#### `test_http_get_order_book()`


#### `test_http_get_trades()`


#### `test_http_get_ohlc()`


#### `test_http_get_trades_with_since()`


#### `test_http_get_ohlc_with_interval()`


#### `test_http_get_websockets_token_requires_credentials()`


#### `test_http_get_websockets_token_with_credentials()`


#### `test_http_request_trades_with_domain_client()`


#### `test_http_request_bars_with_domain_client()`


#### `test_http_multiple_requests_increment_count()`
