...
- **Path**: `crates/adapters/kraken/tests/http.rs`
- **Size**: 30,946 bytes
- **Lines**: 940
- **Language**: Rust
...
- **`mock_server_time()`**: Function defined in this file
- **`mock_system_status()`**: Function defined in this file
- **`mock_asset_pairs()`**: Function defined in this file
- **`mock_ticker()`**: Function defined in this file
- **`mock_ohlc()`**: Function defined in this file
- **`mock_order_book()`**: Function defined in this file
- **`mock_trades()`**: Function defined in this file
- **`mock_websockets_token()`**: Function defined in this file
- **`mock_rate_limit_error()`**: Function defined in this file
- **`mock_futures_instruments()`**: Function defined in this file
- **`mock_futures_tickers()`**: Function defined in this file
- **`mock_futures_candles()`**: Function defined in this file
- **`mock_handler()`**: Function defined in this file
- **`create_router()`**: Function defined in this file
- **`test_http_get_server_time()`**: Function defined in this file
- **`test_http_get_system_status()`**: Function defined in this file
- **`test_http_get_asset_pairs()`**: Function defined in this file
...
**Functions**: `create_router`, `has_auth_headers`, `load_test_data`, `manifest_path`, `mock_asset_pairs`, `mock_futures_candles`, `mock_futures_instruments`, `mock_futures_tickers`, `mock_handler`, `mock_ohlc`, `mock_order_book`, `mock_rate_limit_error`, `mock_server_time`, `mock_system_status`, `mock_ticker`, `mock_trades`, `mock_websockets_token`, `test_http_get_asset_pairs`, `test_http_get_book_depth`, `test_http_get_instruments_futures`, `test_http_get_ohlc`, `test_http_get_ohlc_futures_mark`, `test_http_get_ohlc_futures_spot`, `test_http_get_ohlc_futures_trade`, `test_http_get_ohlc_with_interval`, `test_http_get_server_time`, `test_http_get_system_status`, `test_http_get_ticker`, `test_http_get_tickers_futures`, `test_http_get_trades` *(+10 more)*
...
```bash
# For Python
pytest crates/adapters/kraken/tests/http.rs
...
---
*Generated on 2025-11-18T21:55:00.282942Z*
