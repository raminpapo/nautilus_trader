# Documentation: authentication.rs
...
### Functions
- **`mock_get_websockets_token()`**: Function defined in this file
- **`mock_handler()`**: Function defined in this file
- **`test_http_client_get_websockets_token()`**: Function defined in this file
- **`test_websocket_client_authenticate()`**: Function defined in this file
- **`test_websocket_client_authenticate_without_credentials()`**: Function defined in this file
...
**Functions**: `mock_get_websockets_token`, `mock_handler`, `test_http_client_get_websockets_token`, `test_websocket_client_authenticate`, `test_websocket_client_authenticate_without_credentials`
...
```bash
# For Python
pytest crates/adapters/kraken/tests/authentication.rs
...
---
*Generated on 2025-11-18T21:55:00.278456Z*
