# Documentation: `crates/adapters/kraken/tests/websocket.rs`
**Generated:** 2025-11-15T19:40:01.205027Z
...
This file is located at `crates/adapters/kraken/tests/websocket.rs` within the repository.

**Classes defined:** TestServerState, TestServerState, IntoResponse

**Functions defined:** data_path, load_json, load_instruments, handle_message, websocket_handler, handle_socket, create_router, start_test_server, test_websocket_connection, test_websocket_is_active_lifecycle and 16 more
...
#### `websocket_handler(ws: WebSocketUpgrade, state: Arc<TestServerState>)`


#### `handle_socket(socket: WebSocket, state: Arc<TestServerState>)`
...
#### `test_websocket_is_active_lifecycle()`


#### `test_websocket_subscribe_quotes()`


#### `test_websocket_subscribe_trades()`


#### `test_websocket_subscribe_book()`


#### `test_websocket_subscribe_bars()`


#### `test_websocket_unsubscribe_quotes()`


#### `test_websocket_unsubscribe_trades()`


#### `test_websocket_unsubscribe_book()`


#### `test_websocket_unsubscribe_bars()`


#### `test_websocket_send_ping()`


#### `test_websocket_multiple_subscriptions()`


#### `test_websocket_get_subscriptions()`


#### `test_websocket_wait_until_active_timeout()`


#### `test_websocket_disconnect_and_close()`


#### `test_websocket_cancel_all_requests()`


#### `test_websocket_url_getter()`


#### `test_websocket_cache_instrument()`
