...
- **`test_credential_creation()`**: Function defined in this file

### Classes
- **`KrakenCredential`**: Class defined in this file
...
**Functions**: `api_key`, `new`, `sign_request`, `test_credential_creation`
**Impls**: `Into`, `KrakenCredential`
**Structs**: `KrakenCredential`
...
---
*Generated on 2025-11-18T21:55:00.151610Z*
