# Documentation: `crates/adapters/kraken/src/common/parse.rs`
**Generated:** 2025-11-15T19:40:01.131427Z
**File Size:** 15721 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/adapters/kraken/src/common/parse.rs` within the repository.

**Functions defined:** parse_decimal, parse_decimal_opt, parse_spot_instrument, parse_price, parse_quantity, get_currency, parse_trade_tick_from_array, parse_bar, parse_price_with_precision, parse_quantity_with_precision and 8 more
...
#### `parse_decimal(value: &str)`


#### `parse_decimal_opt(value: Option<&str>)`
...
#### `parse_price_with_precision(value: &str, precision: u8, field: &str)`
...
#### `parse_millis_timestamp(value: f64, field: &str)`


#### `load_test_json(filename: &str)`


#### `test_parse_decimal()`


#### `test_parse_decimal_opt()`


#### `test_parse_spot_instrument()`


#### `test_parse_trade_tick_from_array()`


#### `test_parse_bar()`


#### `test_parse_millis_timestamp()`
