...
- **Path**: `crates/adapters/kraken/src/common/parse.rs`
- **Size**: 25,056 bytes
- **Lines**: 726
- **Language**: Rust
...
### Functions
- **`parse_decimal()`**: Function defined in this file
- **`parse_decimal_opt()`**: Function defined in this file
...
- **`parse_trade_tick_from_array()`**: Function defined in this file
- **`parse_bar()`**: Function defined in this file
- **`parse_price_with_precision()`**: Function defined in this file
- **`parse_quantity_with_precision()`**: Function defined in this file
- **`parse_millis_timestamp()`**: Function defined in this file
- **`bar_type_to_spot_interval()`**: Function defined in this file
- **`bar_type_to_futures_resolution()`**: Function defined in this file
- **`load_test_json()`**: Function defined in this file
- **`test_parse_decimal()`**: Function defined in this file
- **`test_parse_decimal_opt()`**: Function defined in this file
- **`test_parse_spot_instrument()`**: Function defined in this file
- **`test_parse_futures_instrument()`**: Function defined in this file
- **`test_parse_trade_tick_from_array()`**: Function defined in this file
...
**Functions**: `bar_type_to_futures_resolution`, `bar_type_to_spot_interval`, `get_currency`, `load_test_json`, `parse_bar`, `parse_decimal`, `parse_decimal_opt`, `parse_futures_instrument`, `parse_millis_timestamp`, `parse_price`, `parse_price_with_precision`, `parse_quantity`, `parse_quantity_with_precision`, `parse_spot_instrument`, `parse_trade_tick_from_array`, `test_bar_type_to_futures_resolution`, `test_bar_type_to_futures_resolution_unsupported`, `test_bar_type_to_spot_interval`, `test_bar_type_to_spot_interval_unsupported`, `test_parse_bar`, `test_parse_decimal`, `test_parse_decimal_opt`, `test_parse_futures_instrument`, `test_parse_millis_timestamp`, `test_parse_spot_instrument`, `test_parse_trade_tick_from_array`
...
---
*Generated on 2025-11-18T21:55:00.166110Z*
