# Documentation: `crates/adapters/kraken/src/python/http.rs`
**Generated:** 2025-11-15T19:40:01.151479Z
...
This file is located at `crates/adapters/kraken/src/python/http.rs` within the repository.

**Classes defined:** KrakenHttpClient, From

**Functions defined:** py_new, py_base_url, py_api_key, py_cache_instrument, py_cancel_all_requests, py_get_server_time, py_get_system_status, py_get_asset_pairs, py_get_ticker, py_get_ohlc and 6 more
...
#### `py_get_system_status(&self, py: Python<'py>)`
