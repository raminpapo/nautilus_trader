...
- **Path**: `crates/adapters/kraken/src/python/websocket.rs`
- **Size**: 11,175 bytes
- **Lines**: 364
- **Language**: Rust
...
- **`py_authenticate()`**: Function defined in this file
...
**Functions**: `call_python`, `py_authenticate`, `py_cache_instrument`, `py_cancel_all_requests`, `py_close`, `py_connect`, `py_disconnect`, `py_get_subscriptions`, `py_is_active`, `py_is_closed`, `py_is_connected`, `py_new`, `py_send_ping`, `py_subscribe_bars`, `py_subscribe_book`, `py_subscribe_quotes`, `py_subscribe_trades`, `py_unsubscribe_bars`, `py_unsubscribe_book`, `py_unsubscribe_quotes`, `py_unsubscribe_trades`, `py_url`, `py_wait_until_active`
**Impls**: `KrakenWebSocketClient`
...
---
*Generated on 2025-11-18T21:55:00.203608Z*
