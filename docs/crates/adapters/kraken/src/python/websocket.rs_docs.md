# Documentation: `crates/adapters/kraken/src/python/websocket.rs`
**Generated:** 2025-11-15T19:40:01.157420Z
**File Size:** 11175 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/adapters/kraken/src/python/websocket.rs` within the repository.

**Classes defined:** KrakenWebSocketClient

**Functions defined:** py_new, py_url, py_is_connected, py_is_active, py_is_closed, py_get_subscriptions, py_cache_instrument, py_cancel_all_requests, py_connect, py_wait_until_active and 13 more
...
#### `py_authenticate(&self, py: Python<'py>)`
...
#### `py_send_ping(&self, py: Python<'py>)`
