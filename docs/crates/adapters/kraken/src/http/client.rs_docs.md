...
- **Path**: `crates/adapters/kraken/src/http/client.rs`
- **Size**: 37,039 bytes
- **Lines**: 1,095
- **Language**: Rust
...
This file is part of the NautilusTrader repository. It defines 48 function(s) and 3 class(es).
...
- **`base_url()`**: Function defined in this file
- **`credential()`**: Function defined in this file
...
- **`send_futures_request()`**: Function defined in this file
- **`generate_ts_init()`**: Function defined in this file
- **`get_server_time()`**: Function defined in this file
- **`get_system_status()`**: Function defined in this file
- **`get_asset_pairs()`**: Function defined in this file
- **`get_ticker()`**: Function defined in this file
- **`get_ohlc()`**: Function defined in this file

*...and 28 more functions*

### Classes
- **`KrakenResponse`**: Class defined in this file
- **`KrakenRawHttpClient`**: Class defined in this file
- **`KrakenHttpClient`**: Class defined in this file
...
**Functions**: `base_url`, `cache_instrument`, `cache_instruments`, `cancel_all_requests`, `cancellation_token`, `clone`, `credential`, `default`, `default_headers`, `fmt`, `generate_ts_init`, `get_asset_pairs`, `get_book_depth`, `get_cached_instrument`, `get_instruments_futures`, `get_ohlc`, `get_ohlc_futures`, `get_server_time`, `get_system_status`, `get_ticker`, `get_tickers_futures`, `get_trades`, `get_websockets_token`, `is_futures`, `new`, `rate_limit_keys`, `rate_limiter_quotas`, `request_bars`, `request_bars_with_tick_type`, `request_index_price` *(+11 more)*
**Impls**: `Clone`, `Debug`, `Default`, `KrakenHttpClient`, `KrakenRawHttpClient`
**Structs**: `KrakenHttpClient`, `KrakenRawHttpClient`, `KrakenResponse`
...
---
*Generated on 2025-11-18T21:55:00.180308Z*
