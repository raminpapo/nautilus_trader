# Documentation: `crates/adapters/kraken/src/http/client.rs`
**Generated:** 2025-11-15T19:40:01.139796Z
**File Size:** 27965 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/adapters/kraken/src/http/client.rs` within the repository.

**Classes defined:** KrakenResponse, KrakenRawHttpClient, KrakenHttpClient, Default, Debug, KrakenRawHttpClient, Clone, Default, Debug, KrakenHttpClient

**Functions defined:** default, fmt, base_url, credential, cancel_all_requests, cancellation_token, new, with_credentials, default_headers, rate_limiter_quotas and 31 more
...
#### `test_raw_client_with_credentials()`
