...
- **Path**: `crates/adapters/kraken/src/http/models.rs`
- **Size**: 11,757 bytes
- **Lines**: 397
- **Language**: Rust
...
This file is part of the NautilusTrader repository. It defines 8 function(s) and 18 class(es).

## Detailed Walkthrough

### Functions
- **`load_test_data()`**: Function defined in this file
- **`test_parse_server_time()`**: Function defined in this file
- **`test_parse_system_status()`**: Function defined in this file
- **`test_parse_asset_pairs()`**: Function defined in this file
- **`test_parse_ticker()`**: Function defined in this file
- **`test_parse_ohlc()`**: Function defined in this file
- **`test_parse_order_book()`**: Function defined in this file
- **`test_parse_trades()`**: Function defined in this file

### Classes
- **`AssetPairInfo`**: Class defined in this file
- **`TickerInfo`**: Class defined in this file
- **`OhlcData`**: Class defined in this file
- **`OhlcResponse`**: Class defined in this file
- **`TradeData`**: Class defined in this file
- **`TradesResponse`**: Class defined in this file
- **`OrderBookLevel`**: Class defined in this file
- **`OrderBookData`**: Class defined in this file
- **`SystemStatus`**: Class defined in this file
- **`ServerTime`**: Class defined in this file
- **`WebSocketToken`**: Class defined in this file
- **`FuturesMarginLevel`**: Class defined in this file
- **`FuturesInstrument`**: Class defined in this file
- **`FuturesInstrumentsResponse`**: Class defined in this file
- **`FuturesTicker`**: Class defined in this file
- **`FuturesTickersResponse`**: Class defined in this file
- **`FuturesCandle`**: Class defined in this file
- **`FuturesCandlesResponse`**: Class defined in this file
...
**Functions**: `load_test_data`, `test_parse_asset_pairs`, `test_parse_ohlc`, `test_parse_order_book`, `test_parse_server_time`, `test_parse_system_status`, `test_parse_ticker`, `test_parse_trades`
**Structs**: `AssetPairInfo`, `FuturesCandle`, `FuturesCandlesResponse`, `FuturesInstrument`, `FuturesInstrumentsResponse`, `FuturesMarginLevel`, `FuturesTicker`, `FuturesTickersResponse`, `OhlcData`, `OhlcResponse`, `OrderBookData`, `OrderBookLevel`, `ServerTime`, `SystemStatus`, `TickerInfo`, `TradeData`, `TradesResponse`, `WebSocketToken`
...
---
*Generated on 2025-11-18T21:55:00.188427Z*
