# Documentation: `crates/adapters/kraken/src/http/models.rs`
**Generated:** 2025-11-15T19:40:01.145993Z
**File Size:** 8332 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/adapters/kraken/src/http/models.rs` within the repository.

**Classes defined:** AssetPairInfo, TickerInfo, OhlcData, OhlcResponse, TradeData, TradesResponse, OrderBookLevel, OrderBookData, SystemStatus, ServerTime and 1 more

**Functions defined:** load_test_data, test_parse_server_time, test_parse_system_status, test_parse_asset_pairs, test_parse_ticker, test_parse_ohlc, test_parse_order_book, test_parse_trades
...
#### `test_parse_server_time()`


#### `test_parse_system_status()`


#### `test_parse_asset_pairs()`
