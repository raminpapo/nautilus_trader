...
- **Path**: `crates/adapters/kraken/src/websocket/messages.rs`
- **Size**: 10,528 bytes
- **Lines**: 319
- **Language**: Rust
...
- **`test_parse_subscribe_response()`**: Function defined in this file
- **`test_parse_pong()`**: Function defined in this file
- **`test_parse_ticker_snapshot()`**: Function defined in this file
- **`test_parse_trade_update()`**: Function defined in this file
- **`test_parse_book_snapshot()`**: Function defined in this file
- **`test_parse_book_update()`**: Function defined in this file
- **`test_parse_ohlc_update()`**: Function defined in this file

### Classes
- **`KrakenWsRequest`**: Class defined in this file
- **`KrakenWsParams`**: Class defined in this file
- **`KrakenWsPong`**: Class defined in this file
- **`KrakenWsSubscribeResponse`**: Class defined in this file
- **`KrakenWsUnsubscribeResponse`**: Class defined in this file
- **`KrakenWsSubscriptionResult`**: Class defined in this file
- **`KrakenWsMessage`**: Class defined in this file
- **`KrakenWsTickerData`**: Class defined in this file
- **`KrakenWsTradeData`**: Class defined in this file
- **`KrakenWsBookData`**: Class defined in this file
- **`KrakenWsBookLevel`**: Class defined in this file
- **`KrakenWsOhlcData`**: Class defined in this file
...
**Enums**: `KrakenWsResponse`, `NautilusWsMessage`
**Functions**: `load_test_data`, `test_parse_book_snapshot`, `test_parse_book_update`, `test_parse_ohlc_update`, `test_parse_pong`, `test_parse_subscribe_response`, `test_parse_ticker_snapshot`, `test_parse_trade_update`
**Structs**: `KrakenWsBookData`, `KrakenWsBookLevel`, `KrakenWsMessage`, `KrakenWsOhlcData`, `KrakenWsParams`, `KrakenWsPong`, `KrakenWsRequest`, `KrakenWsSubscribeResponse`, `KrakenWsSubscriptionResult`, `KrakenWsTickerData`, `KrakenWsTradeData`, `KrakenWsUnsubscribeResponse`
...
---
*Generated on 2025-11-18T21:55:00.218957Z*
