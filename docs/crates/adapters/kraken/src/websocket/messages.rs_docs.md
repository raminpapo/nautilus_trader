# Documentation: `crates/adapters/kraken/src/websocket/messages.rs`
**Generated:** 2025-11-15T19:40:01.170369Z
**File Size:** 10528 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/adapters/kraken/src/websocket/messages.rs` within the repository.

**Classes defined:** KrakenWsRequest, KrakenWsParams, KrakenWsPong, KrakenWsSubscribeResponse, KrakenWsUnsubscribeResponse, KrakenWsSubscriptionResult, KrakenWsMessage, KrakenWsTickerData, KrakenWsTradeData, KrakenWsBookData and 2 more

**Functions defined:** load_test_data, test_parse_subscribe_response, test_parse_pong, test_parse_ticker_snapshot, test_parse_trade_update, test_parse_book_snapshot, test_parse_book_update, test_parse_ohlc_update
...
#### `KrakenWsSubscribeResponse`

**Type:** struct


#### `KrakenWsUnsubscribeResponse`

**Type:** struct


#### `KrakenWsSubscriptionResult`
...
#### `test_parse_trade_update()`


#### `test_parse_book_snapshot()`


#### `test_parse_book_update()`


#### `test_parse_ohlc_update()`
