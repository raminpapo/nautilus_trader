...
- **Path**: `crates/adapters/kraken/src/websocket/client.rs`
- **Size**: 18,714 bytes
- **Lines**: 537
- **Language**: Rust
...
- **`get_next_req_id()`**: Function defined in this file
...
- **`send_ping()`**: Function defined in this file
...
### Classes
- **`KrakenWebSocketClient`**: Class defined in this file
...
**Functions**: `authenticate`, `cache_instrument`, `cache_instruments`, `cancel_all_requests`, `cancellation_token`, `clone`, `close`, `connect`, `disconnect`, `get_next_req_id`, `get_subscriptions`, `is_active`, `is_closed`, `is_connected`, `new`, `send_ping`, `send_request`, `stream`, `subscribe`, `subscribe_bars`, `subscribe_book`, `subscribe_quotes`, `subscribe_trades`, `unsubscribe`, `unsubscribe_bars`, `unsubscribe_book`, `unsubscribe_quotes`, `unsubscribe_trades`, `url`, `wait_until_active`
**Impls**: `Clone`, `KrakenWebSocketClient`, `futures_util`
**Structs**: `KrakenWebSocketClient`
...
---
*Generated on 2025-11-18T21:55:00.208594Z*
