# Documentation: `crates/adapters/kraken/src/websocket/client.rs`
**Generated:** 2025-11-15T19:40:01.160946Z
...
This file is located at `crates/adapters/kraken/src/websocket/client.rs` within the repository.

**Classes defined:** KrakenWebSocketClient, Clone, KrakenWebSocketClient, futures_util

**Functions defined:** clone, new, get_next_req_id, connect, disconnect, close, wait_until_active, authenticate, cache_instruments, cache_instrument and 20 more
...
#### `new(config: KrakenDataClientConfig, cancellation_token: CancellationToken)`


#### `get_next_req_id(&self)`
...
#### `send_request(&self, request: &KrakenWsRequest)`
