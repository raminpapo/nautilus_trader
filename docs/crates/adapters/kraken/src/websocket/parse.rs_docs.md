# Documentation: `crates/adapters/kraken/src/websocket/parse.rs`
**Generated:** 2025-11-15T19:40:01.174356Z
...
This file is located at `crates/adapters/kraken/src/websocket/parse.rs` within the repository.

**Functions defined:** parse_quote_tick, parse_trade_tick, parse_book_deltas, parse_book_level, parse_rfc3339_timestamp, load_test_json, create_mock_instrument, test_parse_quote_tick, test_parse_trade_tick, test_parse_book_deltas_snapshot and 2 more
...
#### `parse_rfc3339_timestamp(value: &str, field: &str)`
...
#### `test_parse_quote_tick()`


#### `test_parse_trade_tick()`


#### `test_parse_book_deltas_snapshot()`


#### `test_parse_book_deltas_update()`


#### `test_parse_rfc3339_timestamp()`
