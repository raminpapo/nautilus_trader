...
- **Path**: `crates/adapters/kraken/src/websocket/parse.rs`
- **Size**: 12,473 bytes
- **Lines**: 376
- **Language**: Rust
...
### Functions
- **`parse_quote_tick()`**: Function defined in this file
- **`parse_trade_tick()`**: Function defined in this file
- **`parse_book_deltas()`**: Function defined in this file
...
- **`create_mock_instrument()`**: Function defined in this file
- **`test_parse_quote_tick()`**: Function defined in this file
- **`test_parse_trade_tick()`**: Function defined in this file
- **`test_parse_book_deltas_snapshot()`**: Function defined in this file
- **`test_parse_book_deltas_update()`**: Function defined in this file
- **`test_parse_rfc3339_timestamp()`**: Function defined in this file
...
**Functions**: `create_mock_instrument`, `load_test_json`, `parse_book_deltas`, `parse_book_level`, `parse_quote_tick`, `parse_rfc3339_timestamp`, `parse_trade_tick`, `test_parse_book_deltas_snapshot`, `test_parse_book_deltas_update`, `test_parse_quote_tick`, `test_parse_rfc3339_timestamp`, `test_parse_trade_tick`
...
---
*Generated on 2025-11-18T21:55:00.223927Z*
