# Documentation: `crates/adapters/kraken/src/websocket/handler.rs`
**Generated:** 2025-11-15T19:40:01.167621Z
**File Size:** 15051 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/adapters/kraken/src/websocket/handler.rs` within the repository.

**Classes defined:** FeedHandler, FeedHandler

**Functions defined:** new, is_stopped, get_instrument, next, parse_message, handle_data_message, handle_book_message, handle_ticker_message, handle_trade_message, handle_ohlc_message
...
#### `parse_message(&mut self, text: &str, ts_init: UnixNanos)`
