...
- **Path**: `crates/adapters/kraken/src/websocket/handler.rs`
- **Size**: 15,051 bytes
- **Lines**: 395
- **Language**: Rust
...
- **`parse_message()`**: Function defined in this file
- **`handle_data_message()`**: Function defined in this file
- **`handle_book_message()`**: Function defined in this file
- **`handle_ticker_message()`**: Function defined in this file
- **`handle_trade_message()`**: Function defined in this file
- **`handle_ohlc_message()`**: Function defined in this file
...
**Functions**: `get_instrument`, `handle_book_message`, `handle_data_message`, `handle_ohlc_message`, `handle_ticker_message`, `handle_trade_message`, `is_stopped`, `new`, `next`, `parse_message`
**Impls**: `FeedHandler`
**Structs**: `FeedHandler`
...
---
*Generated on 2025-11-18T21:55:00.216075Z*
