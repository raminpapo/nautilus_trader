# Documentation: `crates/adapters/databento/bin/node_test.rs`
**Generated:** 2025-11-15T19:40:00.840604Z
...
This file is located at `crates/adapters/databento/bin/node_test.rs` within the repository.

**Classes defined:** DatabentoSubscriberActorConfig, DatabentoSubscriberActor, DatabentoSubscriberActorConfig, Deref, DerefMut, DataActor, DatabentoSubscriberActor

**Functions defined:** main, new, deref, deref_mut, on_start, on_stop, on_time_event, on_quote, on_trade, new and 2 more
...
#### `DatabentoSubscriberActorConfig`

**Type:** struct


#### `DatabentoSubscriberActor`
...
#### `new(client_id: ClientId, instrument_ids: Vec<InstrumentId>)`
...
#### `new(config: DatabentoSubscriberActorConfig)`
