# Documentation: `crates/adapters/databento/src/decode.rs`
**Generated:** 2025-11-15T19:40:00.855084Z
**File Size:** 78387 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/adapters/databento/src/decode.rs` within the repository.

**Classes defined:** std

**Functions defined:** parse_optional_bool, parse_order_side, parse_aggressor_side, parse_book_action, parse_option_kind, parse_currency_or_usd_default, parse_cfi_iso10926, parse_status_reason, parse_status_trading_event, decode_raw_price_with_precision and 75 more
...
#### `parse_optional_bool(c: c_char)`


#### `parse_order_side(c: c_char)`


#### `parse_aggressor_side(c: c_char)`


#### `parse_book_action(c: c_char)`


#### `parse_option_kind(c: c_char)`


#### `parse_currency_or_usd_default(value: Result<&str, impl std::error::Error>)`
...
#### `parse_status_reason(value: u16)`


#### `parse_status_trading_event(value: u16)`


#### `decode_raw_price_with_precision(value: i64, precision: u8)`


#### `decode_price(value: i64, precision: u8)`


#### `decode_price_increment(value: i64, precision: u8)`


#### `decode_optional_price(value: i64, precision: u8)`


#### `decode_quantity(value: u64)`


#### `decode_optional_quantity(value: i64)`


#### `decode_multiplier(value: i64)`


#### `decode_lot_size(value: i32)`


#### `is_trade_msg(action: c_char)`
...
#### `decode_ts_event_adjustment(msg: &dbn::OhlcvMsg)`
...
#### `determine_timestamp(ts_init: Option<UnixNanos>, msg_timestamp: UnixNanos)`
...
#### `test_parse_optional_bool(#[case] input: c_char, #[case] expected: Option<bool>)`


#### `test_parse_order_side(#[case] input: c_char, #[case] expected: OrderSide)`


#### `test_parse_aggressor_side(#[case] input: c_char, #[case] expected: AggressorSide)`


#### `test_is_trade_msg(#[case] action: c_char, #[case] expected: bool)`


#### `test_parse_book_action(#[case] input: c_char, #[case] expected: Result<BookAction, &str>)`


#### `test_parse_option_kind(#[case] input: c_char, #[case] expected: Result<OptionKind, &str>)`


#### `test_parse_currency_or_usd_default(
        #[case] input: Result<&str, &'static str>, // Using `&'static str` for errors
        #[case] expected: Currency,
    )`


#### `test_parse_cfi_iso10926(
        #[case] input: &str,
        #[case] expected: Result<(Option<AssetClass>, Option<InstrumentClass>)`
