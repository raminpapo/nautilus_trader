# Documentation: decode.rs

## File Metadata

- **Path**: `crates/adapters/databento/src/decode.rs`
- **Size**: 78,387 bytes
- **Lines**: 2,219
- **Language**: Rust
...
This file is part of the NautilusTrader repository. It defines 85 function(s).

## Detailed Walkthrough

### Functions
- **`parse_optional_bool()`**: Function defined in this file
- **`parse_order_side()`**: Function defined in this file
- **`parse_aggressor_side()`**: Function defined in this file
- **`parse_book_action()`**: Function defined in this file
- **`parse_option_kind()`**: Function defined in this file
- **`parse_currency_or_usd_default()`**: Function defined in this file
- **`parse_cfi_iso10926()`**: Function defined in this file
- **`parse_status_reason()`**: Function defined in this file
- **`parse_status_trading_event()`**: Function defined in this file
- **`decode_raw_price_with_precision()`**: Function defined in this file
- **`decode_price()`**: Function defined in this file
- **`decode_price_increment()`**: Function defined in this file
- **`decode_optional_price()`**: Function defined in this file
- **`decode_quantity()`**: Function defined in this file
- **`decode_optional_quantity()`**: Function defined in this file
- **`decode_multiplier()`**: Function defined in this file
- **`decode_lot_size()`**: Function defined in this file
- **`is_trade_msg()`**: Function defined in this file
- **`decode_mbo_msg()`**: Function defined in this file
- **`decode_trade_msg()`**: Function defined in this file
...
**Enums**: `variant`
**Functions**: `decode_bar_type`, `decode_bbo_msg`, `decode_cbbo_msg`, `decode_cmbp1_msg`, `decode_equity`, `decode_futures_contract`, `decode_futures_spread`, `decode_imbalance_msg`, `decode_instrument_def_msg`, `decode_lot_size`, `decode_mbo_msg`, `decode_mbp10_msg`, `decode_mbp1_msg`, `decode_multiplier`, `decode_ohlcv_msg`, `decode_option_contract`, `decode_option_spread`, `decode_optional_price`, `decode_optional_quantity`, `decode_price`, `decode_price_increment`, `decode_quantity`, `decode_raw_price_with_precision`, `decode_record`, `decode_statistics_msg`, `decode_status_msg`, `decode_tbbo_msg`, `decode_tcbbo_msg`, `decode_trade_msg`, `decode_ts_event_adjustment` *(+55 more)*
**Impls**: `std`
...
---
*Generated on 2025-11-18T21:54:59.695962Z*
