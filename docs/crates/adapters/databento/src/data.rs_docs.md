# Documentation: `crates/adapters/databento/src/data.rs`
**Generated:** 2025-11-15T19:40:00.847930Z
**File Size:** 30270 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/adapters/databento/src/data.rs` within the repository.

**Classes defined:** DatabentoDataClientConfig, DatabentoDataClient, DatabentoDataClientConfig, DatabentoDataClient, DataClient

**Functions defined:** new, new, get_dataset_for_venue, get_or_create_feed_handler, send_command_to_dataset, initialize_live_feed, client_id, venue, start, stop and 18 more
...
#### `get_or_create_feed_handler(&self, dataset: &str)`


#### `send_command_to_dataset(&self, dataset: &str, cmd: LiveCommand)`
...
**Security:** This file may contain sensitive patterns: token, api_key. Ensure proper handling of secrets.
