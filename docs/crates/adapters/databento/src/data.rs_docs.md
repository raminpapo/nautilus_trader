...
- **Path**: `crates/adapters/databento/src/data.rs`
- **Size**: 30,270 bytes
- **Lines**: 838
- **Language**: Rust
...
This file is part of the NautilusTrader repository. It defines 28 function(s) and 2 class(es).
...
- **`get_or_create_feed_handler()`**: Function defined in this file
- **`send_command_to_dataset()`**: Function defined in this file
- **`initialize_live_feed()`**: Function defined in this file
...
- **`subscribe_instrument_status()`**: Function defined in this file

*...and 8 more functions*

### Classes
- **`DatabentoDataClientConfig`**: Class defined in this file
- **`DatabentoDataClient`**: Class defined in this file
...
**Functions**: `client_id`, `connect`, `disconnect`, `dispose`, `get_dataset_for_venue`, `get_or_create_feed_handler`, `initialize_live_feed`, `is_connected`, `is_disconnected`, `new`, `request_bars`, `request_instruments`, `request_quotes`, `request_trades`, `reset`, `send_command_to_dataset`, `start`, `stop`, `subscribe_book_deltas`, `subscribe_instrument_status`, `subscribe_quotes`, `subscribe_trades`, `unsubscribe_book_deltas`, `unsubscribe_instrument_status`, `unsubscribe_quotes`, `unsubscribe_trades`, `venue`
**Impls**: `DataClient`, `DatabentoDataClient`, `DatabentoDataClientConfig`
**Structs**: `DatabentoDataClient`, `DatabentoDataClientConfig`
...
---
*Generated on 2025-11-18T21:54:59.684420Z*
