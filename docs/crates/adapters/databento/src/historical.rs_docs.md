# Documentation: `crates/adapters/databento/src/historical.rs`
**Generated:** 2025-11-15T19:40:00.862179Z
**File Size:** 27339 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/adapters/databento/src/historical.rs` within the repository.

**Classes defined:** DatabentoHistoricalClient, RangeQueryParams, DatasetRange, DatabentoHistoricalClient

**Functions defined:** new, get_dataset_range, get_range_instruments, get_range_quotes, get_range_order_book_depth10, get_range_trades, get_range_bars, get_range_imbalance, get_range_statistics, get_range_status and 1 more
...
#### `prepare_symbols_from_instrument_ids(
        &self,
        instrument_ids: &[InstrumentId],
    )`
