# Documentation: historical.rs

## File Metadata

- **Path**: `crates/adapters/databento/src/historical.rs`
- **Size**: 27,339 bytes
- **Lines**: 760
- **Language**: Rust
...
- **`get_dataset_range()`**: Function defined in this file
- **`get_range_instruments()`**: Function defined in this file
- **`get_range_quotes()`**: Function defined in this file
- **`get_range_order_book_depth10()`**: Function defined in this file
- **`get_range_trades()`**: Function defined in this file
- **`get_range_bars()`**: Function defined in this file
- **`get_range_imbalance()`**: Function defined in this file
- **`get_range_statistics()`**: Function defined in this file
- **`get_range_status()`**: Function defined in this file
- **`prepare_symbols_from_instrument_ids()`**: Function defined in this file

### Classes
- **`DatabentoHistoricalClient`**: Class defined in this file
- **`RangeQueryParams`**: Class defined in this file
- **`DatasetRange`**: Class defined in this file
...
**Functions**: `get_dataset_range`, `get_range_bars`, `get_range_imbalance`, `get_range_instruments`, `get_range_order_book_depth10`, `get_range_quotes`, `get_range_statistics`, `get_range_status`, `get_range_trades`, `new`, `prepare_symbols_from_instrument_ids`
**Impls**: `DatabentoHistoricalClient`
**Structs**: `DatabentoHistoricalClient`, `DatasetRange`, `RangeQueryParams`
...
---
*Generated on 2025-11-18T21:54:59.704654Z*
