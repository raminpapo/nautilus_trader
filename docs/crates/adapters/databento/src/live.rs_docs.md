# Documentation: `crates/adapters/databento/src/live.rs`
**Generated:** 2025-11-15T19:40:00.867383Z
...
This file is located at `crates/adapters/databento/src/live.rs` within the repository.

**Classes defined:** DatabentoFeedHandler, DatabentoFeedHandler

**Functions defined:** new, run, run_session, send_msg, read_symbol_venue_map, handle_error_msg, handle_system_msg, handle_symbol_mapping_msg, update_instrument_id_map_with_exchange, update_instrument_id_map and 11 more
...
#### `run_session(&mut self, attempt: usize)`


#### `send_msg(&mut self, msg: LiveMessage)`


#### `read_symbol_venue_map(
        &self,
    )`


#### `handle_error_msg(msg: &dbn::ErrorMsg)`


#### `handle_system_msg(msg: &dbn::SystemMsg)`


#### `handle_symbol_mapping_msg(
    msg: &dbn::SymbolMappingMsg,
    symbol_map: &mut PitSymbolMap,
    instrument_id_map: &mut AHashMap<u32, InstrumentId>,
)`
...
#### `create_test_handler(reconnect_timeout_mins: Option<u64>)`


#### `test_backoff_initialization(#[case] reconnect_timeout_mins: Option<u64>)`


#### `test_subscription_with_and_without_start()`


#### `test_handler_initialization_state()`


#### `test_handler_with_no_timeout()`


#### `test_handler_with_zero_timeout()`
