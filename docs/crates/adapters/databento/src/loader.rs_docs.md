# Documentation: `crates/adapters/databento/src/loader.rs`
**Generated:** 2025-11-15T19:40:00.871960Z
**File Size:** 41339 bytes
**Extension:** .rs
**Type:** text
...
- **Path:** `crates/adapters/databento/src/loader.rs`
- **Size:** 41,339 bytes
- **Lines:** 1,135
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/adapters/databento/src/loader.rs` within the repository.

**Classes defined:** DatabentoDataLoader, DatabentoDataLoader, Iterator, Iterator, Iterator, Iterator, Iterator

**Functions defined:** new, load_publishers, get_publishers, set_dataset_for_venue, get_dataset_for_venue, get_venue_for_publisher, schema_from_file, read_definition_records, read_records, load_instruments and 33 more
...
#### `new(publishers_filepath: Option<PathBuf>)`


#### `load_publishers(&mut self, filepath: PathBuf)`


#### `get_publishers(&self)`


#### `set_dataset_for_venue(&mut self, dataset: Dataset, venue: Venue)`


#### `get_dataset_for_venue(&self, venue: &Venue)`


#### `get_venue_for_publisher(&self, publisher_id: PublisherId)`


#### `schema_from_file(&self, filepath: &Path)`


#### `read_definition_records(
        &mut self,
        filepath: &Path,
        use_exchange_as_venue: bool,
    )`
...
#### `test_set_dataset_venue_mapping(mut loader: DatabentoDataLoader)`


#### `test_load_instruments(mut loader: DatabentoDataLoader, #[case] path: PathBuf)`


#### `test_load_order_book_deltas(loader: DatabentoDataLoader)`


#### `test_load_order_book_depth10(loader: DatabentoDataLoader)`


#### `test_load_quotes(loader: DatabentoDataLoader)`


#### `test_load_bbo_quotes(loader: DatabentoDataLoader, #[case] path: PathBuf)`


#### `test_load_cmbp_quotes(loader: DatabentoDataLoader)`


#### `test_load_cbbo_quotes(loader: DatabentoDataLoader)`


#### `test_load_tbbo_trades(loader: DatabentoDataLoader)`


#### `test_load_tcbbo_trades(loader: DatabentoDataLoader)`


#### `test_load_trades(loader: DatabentoDataLoader)`


#### `test_load_bars(loader: DatabentoDataLoader, #[case] path: PathBuf)`


#### `test_load_bars_timestamp_on_close_true(loader: DatabentoDataLoader, #[case] path: PathBuf)`


#### `test_load_bars_timestamp_on_close_false(loader: DatabentoDataLoader, #[case] path: PathBuf)`


#### `test_load_bars_timestamp_comparison(
        loader: DatabentoDataLoader,
        #[case] path: PathBuf,
        #[case] bar_index: usize,
    )`
...
#### `test_load_status_records(loader: DatabentoDataLoader)`


#### `test_read_imbalance_records(loader: DatabentoDataLoader)`


#### `test_read_statistics_records(loader: DatabentoDataLoader)`
