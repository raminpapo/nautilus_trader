# Documentation: symbology.rs

## File Metadata

- **Path**: `crates/adapters/databento/src/symbology.rs`
- **Size**: 9,965 bytes
- **Lines**: 276
- **Language**: Rust
...
- **`symbol_map_for_date()`**: Function defined in this file
- **`instrument_id_to_symbol_string()`**: Function defined in this file
- **`decode_nautilus_instrument_id()`**: Function defined in this file
- **`get_nautilus_instrument_id_for_record()`**: Function defined in this file
- **`infer_symbology_type()`**: Function defined in this file
- **`check_consistent_symbology()`**: Function defined in this file
- **`test_infer_symbology_type()`**: Function defined in this file
- **`test_check_consistent_symbology_when_empty_symbols()`**: Function defined in this file
- **`test_instrument_id_to_symbol_string_updates_map()`**: Function defined in this file
- **`test_check_consistent_symbology_when_inconsistent()`**: Function defined in this file
- **`test_check_consistent_symbology_when_consistent()`**: Function defined in this file

### Classes
- **`MetadataCache`**: Class defined in this file
...
**Functions**: `check_consistent_symbology`, `decode_nautilus_instrument_id`, `get_nautilus_instrument_id_for_record`, `infer_symbology_type`, `instrument_id_to_symbol_string`, `new`, `symbol_map_for_date`, `test_check_consistent_symbology_when_consistent`, `test_check_consistent_symbology_when_empty_symbols`, `test_check_consistent_symbology_when_inconsistent`, `test_infer_symbology_type`, `test_instrument_id_to_symbol_string_updates_map`
**Impls**: `MetadataCache`
**Structs**: `MetadataCache`
...
---
*Generated on 2025-11-18T21:54:59.738713Z*
