# Documentation: `crates/adapters/databento/src/symbology.rs`
**Generated:** 2025-11-15T19:40:00.889890Z
**File Size:** 9965 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/adapters/databento/src/symbology.rs` within the repository.

**Classes defined:** MetadataCache, MetadataCache

**Functions defined:** new, symbol_map_for_date, instrument_id_to_symbol_string, decode_nautilus_instrument_id, get_nautilus_instrument_id_for_record, infer_symbology_type, check_consistent_symbology, test_infer_symbology_type, test_check_consistent_symbology_when_empty_symbols, test_instrument_id_to_symbol_string_updates_map and 2 more
...
#### `new(metadata: dbn::Metadata)`


#### `symbol_map_for_date(&mut self, date: time::Date)`
...
#### `infer_symbology_type(symbol: &str)`


#### `check_consistent_symbology(symbols: &[&str])`


#### `test_infer_symbology_type(#[case] symbol: String, #[case] expected: SType)`


#### `test_check_consistent_symbology_when_empty_symbols()`


#### `test_instrument_id_to_symbol_string_updates_map()`


#### `test_check_consistent_symbology_when_inconsistent()`


#### `test_check_consistent_symbology_when_consistent(#[case] symbols: Vec<&str>)`
