# Documentation: loader.rs

## File Metadata

- **Path**: `crates/adapters/databento/src/python/loader.rs`
- **Size**: 17,701 bytes
- **Lines**: 520
- **Language**: Rust
...
This file is part of the NautilusTrader repository. It defines 32 function(s).

## Detailed Walkthrough

### Functions
- **`py_new()`**: Function defined in this file
- **`py_load_publishers()`**: Function defined in this file
- **`py_get_publishers()`**: Function defined in this file
- **`py_set_dataset_for_venue()`**: Function defined in this file
- **`py_get_dataset_for_venue()`**: Function defined in this file
- **`py_get_venue_for_publisher()`**: Function defined in this file
- **`py_schema_for_file()`**: Function defined in this file
- **`py_load_instruments()`**: Function defined in this file
- **`py_load_order_book_deltas()`**: Function defined in this file
- **`py_load_order_book_deltas_as_pycapsule()`**: Function defined in this file
- **`py_load_order_book_depth10()`**: Function defined in this file
- **`py_load_order_book_depth10_as_pycapsule()`**: Function defined in this file
- **`py_load_quotes()`**: Function defined in this file
- **`py_load_quotes_as_pycapsule()`**: Function defined in this file
- **`py_load_bbo_quotes()`**: Function defined in this file
- **`py_load_bbo_quotes_as_pycapsule()`**: Function defined in this file
- **`py_load_cmbp_quotes()`**: Function defined in this file
- **`py_load_cmbp_quotes_as_pycapsule()`**: Function defined in this file
- **`py_load_cbbo_quotes()`**: Function defined in this file
- **`py_load_cbbo_quotes_as_pycapsule()`**: Function defined in this file
...
**Functions**: `exhaust_data_iter_to_pycapsule`, `py_get_dataset_for_venue`, `py_get_publishers`, `py_get_venue_for_publisher`, `py_load_bars`, `py_load_bars_as_pycapsule`, `py_load_bbo_quotes`, `py_load_bbo_quotes_as_pycapsule`, `py_load_cbbo_quotes`, `py_load_cbbo_quotes_as_pycapsule`, `py_load_cmbp_quotes`, `py_load_cmbp_quotes_as_pycapsule`, `py_load_imbalance`, `py_load_instruments`, `py_load_order_book_deltas`, `py_load_order_book_deltas_as_pycapsule`, `py_load_order_book_depth10`, `py_load_order_book_depth10_as_pycapsule`, `py_load_publishers`, `py_load_quotes`, `py_load_quotes_as_pycapsule`, `py_load_statistics`, `py_load_status`, `py_load_tbbo_trades`, `py_load_tbbo_trades_as_pycapsule`, `py_load_tcbbo_trades`, `py_load_tcbbo_trades_as_pycapsule`, `py_load_trades`, `py_load_trades_as_pycapsule`, `py_new` *(+2 more)*
**Impls**: `DatabentoDataLoader`, `Iterator`
...
---
*Generated on 2025-11-18T21:54:59.732448Z*
