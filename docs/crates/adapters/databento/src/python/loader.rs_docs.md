# Documentation: `crates/adapters/databento/src/python/loader.rs`
**Generated:** 2025-11-15T19:40:00.883405Z
**File Size:** 17701 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/adapters/databento/src/python/loader.rs` within the repository.

**Classes defined:** DatabentoDataLoader, Iterator

**Functions defined:** py_new, py_load_publishers, py_get_publishers, py_set_dataset_for_venue, py_get_dataset_for_venue, py_get_venue_for_publisher, py_schema_for_file, py_load_instruments, py_load_order_book_deltas, py_load_order_book_deltas_as_pycapsule and 22 more
...
#### `py_new(publishers_filepath: Option<PathBuf>)`


#### `py_load_publishers(&mut self, publishers_filepath: PathBuf)`


#### `py_get_publishers(&self)`


#### `py_set_dataset_for_venue(&mut self, dataset: String, venue: Venue)`


#### `py_get_dataset_for_venue(&self, venue: &Venue)`


#### `py_get_venue_for_publisher(&self, publisher_id: PublisherId)`


#### `py_schema_for_file(&self, filepath: PathBuf)`
...
#### `py_load_order_book_deltas_as_pycapsule(
        &self,
        py: Python,
        filepath: PathBuf,
        instrument_id: Option<InstrumentId>,
...
#### `py_load_order_book_depth10_as_pycapsule(
        &self,
        py: Python,
        filepath: PathBuf,
        instrument_id: Option<InstrumentId>,
...
#### `py_load_bbo_quotes_as_pycapsule(
        &self,
        py: Python,
        filepath: PathBuf,
        instrument_id: Option<InstrumentId>,
...
#### `py_load_cmbp_quotes_as_pycapsule(
        &self,
        py: Python,
        filepath: PathBuf,
        instrument_id: Option<InstrumentId>,
...
#### `py_load_cbbo_quotes_as_pycapsule(
        &self,
        py: Python,
        filepath: PathBuf,
        instrument_id: Option<InstrumentId>,
...
#### `py_load_tcbbo_trades_as_pycapsule(
        &self,
        py: Python,
        filepath: PathBuf,
        instrument_id: Option<InstrumentId>,
...
#### `exhaust_data_iter_to_pycapsule(
    py: Python,
    iter: impl Iterator<Item = anyhow::Result<(Option<Data>, Option<Data>)`
