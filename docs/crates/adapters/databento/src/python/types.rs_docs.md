# Documentation: `crates/adapters/databento/src/python/types.rs`
**Generated:** 2025-11-15T19:40:00.887631Z
...
This file is located at `crates/adapters/databento/src/python/types.rs` within the repository.

**Classes defined:** DatabentoImbalance, DatabentoStatistics

**Functions defined:** __richcmp__, __hash__, __repr__, __str__, py_instrument_id, py_ref_price, py_cont_book_clr_price, py_auct_interest_clr_price, py_paired_qty, py_total_imbalance_qty and 26 more
...
#### `py_cont_book_clr_price(&self)`


#### `py_auct_interest_clr_price(&self)`


#### `py_paired_qty(&self)`


#### `py_total_imbalance_qty(&self)`


#### `py_side(&self)`


#### `py_significant_imbalance(&self)`
