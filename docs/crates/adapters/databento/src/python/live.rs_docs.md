# Documentation: `crates/adapters/databento/src/python/live.rs`
**Generated:** 2025-11-15T19:40:00.880770Z
...
This file is located at `crates/adapters/databento/src/python/live.rs` within the repository.

**Classes defined:** DatabentoLiveClient, DatabentoLiveClient, DatabentoLiveClient

**Functions defined:** is_closed, process_messages, send_command, call_python, py_new, py_is_running, py_is_closed, py_subscribe, py_start, py_close
...
#### `send_command(&self, cmd: LiveCommand)`
