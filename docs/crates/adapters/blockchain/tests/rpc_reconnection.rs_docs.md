# Documentation: rpc_reconnection.rs

## File Metadata

- **Path**: `crates/adapters/blockchain/tests/rpc_reconnection.rs`
- **Size**: 14,338 bytes
- **Lines**: 320
- **Language**: Rust
...
### Functions
- **`blockchain_rpc_server()`**: Function defined in this file
- **`test_rpc_basic_subscription()`**: Function defined in this file
- **`test_rpc_reconnection_resubscribes()`**: Function defined in this file
...
**Functions**: `blockchain_rpc_server`, `test_rpc_basic_subscription`, `test_rpc_reconnection_resubscribes`

## Related Files

This file is located in `crates/adapters/blockchain/tests/`. Related files may include:
...
```bash
# For Python
pytest crates/adapters/blockchain/tests/rpc_reconnection.rs
...
---
*Generated on 2025-11-18T21:54:59.342647Z*
