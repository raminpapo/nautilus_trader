...
- **`to_pool_swap()`**: Function defined in this file

### Classes
- **`captures`**: Class defined in this file
- **`SwapEvent`**: Class defined in this file
...
**Functions**: `new`, `to_pool_swap`
**Impls**: `SwapEvent`
**Structs**: `SwapEvent`, `captures`
...
---
*Generated on 2025-11-18T21:54:59.233126Z*
