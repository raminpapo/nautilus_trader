...
- **`to_pool_liquidity_update()`**: Function defined in this file

### Classes
- **`BurnEvent`**: Class defined in this file
...
**Functions**: `new`, `to_pool_liquidity_update`
**Impls**: `BurnEvent`
**Structs**: `BurnEvent`
...
---
*Generated on 2025-11-18T21:54:59.221438Z*
