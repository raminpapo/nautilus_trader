# Documentation: erc20.rs

## File Metadata

- **Path**: `crates/adapters/blockchain/src/contracts/erc20.rs`
- **Size**: 23,392 bytes
- **Lines**: 676
- **Language**: Rust
...
This file is part of the NautilusTrader repository. It defines 27 function(s) and 3 class(es).

## Detailed Walkthrough

### Functions
- **`new()`**: Function defined in this file
- **`fetch_token_info()`**: Function defined in this file
- **`batch_fetch_token_info()`**: Function defined in this file
- **`balance_of()`**: Function defined in this file
- **`decode_revert_reason()`**: Function defined in this file
- **`parse_erc20_string_result()`**: Function defined in this file
- **`parse_erc20_decimals_result()`**: Function defined in this file
- **`parse_batch_token_results()`**: Function defined in this file
- **`token_address()`**: Function defined in this file
- **`successful_name_result()`**: Function defined in this file
- **`successful_symbol_result()`**: Function defined in this file
- **`failed_name_result()`**: Function defined in this file
- **`failed_token_address()`**: Function defined in this file
- **`success_but_empty_result()`**: Function defined in this file
- **`empty_token_address()`**: Function defined in this file
- **`non_abi_encoded_string_result()`**: Function defined in this file
- **`non_abi_encoded_token_address()`**: Function defined in this file
- **`non_standard_selector_result()`**: Function defined in this file
- **`non_abi_encoded_long_string_result()`**: Function defined in this file
- **`test_parse_erc20_string_result_name_success()`**: Function defined in this file

*...and 7 more functions*

### Classes
- **`TokenInfo`**: Class defined in this file
- **`provides`**: Class defined in this file
- **`Erc20Contract`**: Class defined in this file
...
**Enums**: `Erc20Field`, `TokenInfoError`
**Functions**: `balance_of`, `batch_fetch_token_info`, `decode_revert_reason`, `empty_token_address`, `failed_name_result`, `failed_token_address`, `fetch_token_info`, `new`, `non_abi_encoded_long_string_result`, `non_abi_encoded_string_result`, `non_abi_encoded_token_address`, `non_standard_selector_result`, `parse_batch_token_results`, `parse_erc20_decimals_result`, `parse_erc20_string_result`, `success_but_empty_result`, `successful_name_result`, `successful_symbol_result`, `test_parse_erc20_decimals_result_success_but_empty`, `test_parse_erc20_string_result_name_failed_with_specific_address`, `test_parse_erc20_string_result_name_success`, `test_parse_erc20_string_result_success_but_empty_name`, `test_parse_erc20_string_result_symbol_success`, `test_parse_non_abi_encoded_long_string`, `test_parse_non_abi_encoded_string`, `test_parse_non_standard_selector_return`, `token_address`
**Impls**: `Erc20Contract`
**Structs**: `Erc20Contract`, `TokenInfo`, `provides`

## Related Files

This file is located in `crates/adapters/blockchain/src/contracts/`. Related files may include:
...
---
*Generated on 2025-11-18T21:54:59.184689Z*
