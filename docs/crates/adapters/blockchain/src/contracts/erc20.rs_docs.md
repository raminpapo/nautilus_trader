# Documentation: `crates/adapters/blockchain/src/contracts/erc20.rs`
**Generated:** 2025-11-15T19:40:00.464955Z
...
This file is located at `crates/adapters/blockchain/src/contracts/erc20.rs` within the repository.

**Classes defined:** TokenInfo, provides, Erc20Contract, Erc20Contract

**Functions defined:** new, fetch_token_info, batch_fetch_token_info, balance_of, decode_revert_reason, parse_erc20_string_result, parse_erc20_decimals_result, parse_batch_token_results, token_address, successful_name_result and 17 more
...
#### `new(client: Arc<BlockchainHttpRpcClient>, enforce_token_fields: bool)`
...
#### `decode_revert_reason(data: &Bytes)`
...
**Directory:** `crates/adapters/blockchain/src/contracts`
