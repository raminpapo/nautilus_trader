...
- **Path**: `crates/adapters/blockchain/src/contracts/base.rs`
- **Size**: 6,220 bytes
- **Lines**: 181
- **Language**: Rust
...
This file is part of the NautilusTrader repository. It defines 5 function(s) and 6 class(es).

## Detailed Walkthrough

### Functions
- **`new()`**: Function defined in this file
- **`client()`**: Function defined in this file
- **`execute_call()`**: Function defined in this file
- **`execute_multicall()`**: Function defined in this file
- **`decode_hex_response()`**: Function defined in this file

### Classes
- **`Call`**: Class defined in this file
- **`Call3`**: Class defined in this file
- **`Result`**: Class defined in this file
- **`provides`**: Class defined in this file
- **`BaseContract`**: Class defined in this file
- **`ContractCall`**: Class defined in this file
...
**Functions**: `client`, `decode_hex_response`, `execute_call`, `execute_multicall`, `new`
**Impls**: `BaseContract`
**Structs**: `BaseContract`, `Call`, `Call3`, `ContractCall`, `Result`, `provides`
...
---
*Generated on 2025-11-18T21:54:59.180894Z*
