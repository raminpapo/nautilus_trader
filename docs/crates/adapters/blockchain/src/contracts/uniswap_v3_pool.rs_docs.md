# Documentation: `crates/adapters/blockchain/src/contracts/uniswap_v3_pool.rs`
**Generated:** 2025-11-15T19:40:00.468772Z
**File Size:** 16433 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/adapters/blockchain/src/contracts/uniswap_v3_pool.rs` within the repository.

**Classes defined:** containing, Slot0Data, TickInfo, PositionInfo, provides, UniswapV3PoolContract, UniswapV3PoolContract

**Functions defined:** new, get_global_state, get_tick, batch_get_ticks, compute_position_key, batch_get_positions, fetch_snapshot
...
#### `new(client: Arc<BlockchainHttpRpcClient>)`
...
#### `compute_position_key(owner: &Address, tick_lower: i32, tick_upper: i32)`
