# Documentation: uniswap_v3_pool.rs

## File Metadata

- **Path**: `crates/adapters/blockchain/src/contracts/uniswap_v3_pool.rs`
- **Size**: 16,438 bytes
- **Lines**: 452
- **Language**: Rust
...
This file is part of the NautilusTrader repository. It defines 7 function(s) and 6 class(es).

## Detailed Walkthrough

### Functions
- **`new()`**: Function defined in this file
- **`get_global_state()`**: Function defined in this file
- **`get_tick()`**: Function defined in this file
- **`batch_get_ticks()`**: Function defined in this file
- **`compute_position_key()`**: Function defined in this file
- **`batch_get_positions()`**: Function defined in this file
- **`fetch_snapshot()`**: Function defined in this file

### Classes
- **`containing`**: Class defined in this file
- **`Slot0Data`**: Class defined in this file
- **`TickInfo`**: Class defined in this file
- **`PositionInfo`**: Class defined in this file
- **`provides`**: Class defined in this file
- **`UniswapV3PoolContract`**: Class defined in this file
...
**Enums**: `UniswapV3PoolError`
**Functions**: `batch_get_positions`, `batch_get_ticks`, `compute_position_key`, `fetch_snapshot`, `get_global_state`, `get_tick`, `new`
**Impls**: `UniswapV3PoolContract`
**Structs**: `PositionInfo`, `Slot0Data`, `TickInfo`, `UniswapV3PoolContract`, `containing`, `provides`
...
---
*Generated on 2025-11-18T21:54:59.189535Z*
