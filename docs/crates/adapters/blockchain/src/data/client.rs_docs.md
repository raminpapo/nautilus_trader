# Documentation: `crates/adapters/blockchain/src/data/client.rs`
**Generated:** 2025-11-15T19:40:00.472869Z
**File Size:** 45176 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/adapters/blockchain/src/data/client.rs` within the repository.

**Classes defined:** BlockchainDataClient, BlockchainDataClient, DataClient

**Functions defined:** new, spawn_process_task, handle_subscribe_command, handle_unsubscribe_command, handle_request_command, await_process_task_close, client_id, venue, start, stop and 19 more
...
#### `new(config: BlockchainDataClientConfig)`


#### `spawn_process_task(&mut self)`
...
#### `await_process_task_close(&mut self)`
