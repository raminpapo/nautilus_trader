# Documentation: core.rs

## File Metadata

- **Path**: `crates/adapters/blockchain/src/data/core.rs`
- **Size**: 66,592 bytes
- **Lines**: 1,695
- **Language**: Rust
...
This file is part of the NautilusTrader repository. It defines 27 function(s) and 2 class(es).

## Detailed Walkthrough

### Functions
- **`new()`**: Function defined in this file
- **`initialize_cache_database()`**: Function defined in this file
- **`initialize_rpc_client()`**: Function defined in this file
- **`connect()`**: Function defined in this file
- **`sync_blocks_checked()`**: Function defined in this file
- **`sync_blocks()`**: Function defined in this file
- **`sync_pool_events()`**: Function defined in this file
- **`flush_event_batches()`**: Function defined in this file
- **`process_pool_swap_event()`**: Function defined in this file
- **`process_pool_mint_event()`**: Function defined in this file
- **`process_pool_burn_event()`**: Function defined in this file
- **`process_pool_collect_event()`**: Function defined in this file
- **`process_pool_flash_event()`**: Function defined in this file
- **`sync_exchange_pools()`**: Function defined in this file
- **`fetch_and_cache_tokens_in_memory()`**: Function defined in this file
- **`construct_pools_batch()`**: Function defined in this file
- **`register_dex_exchange()`**: Function defined in this file
- **`bootstrap_latest_pool_profiler()`**: Function defined in this file
- **`construct_pool_profiler_from_hypersync_rpc()`**: Function defined in this file
- **`check_snapshot_validity()`**: Function defined in this file

*...and 7 more functions*

### Classes
- **`encapsulates`**: Class defined in this file
- **`BlockchainDataClientCore`**: Class defined in this file
...
**Functions**: `bootstrap_latest_pool_profiler`, `check_snapshot_validity`, `connect`, `construct_pool_profiler_from_hypersync_rpc`, `construct_pools_batch`, `determine_from_block`, `disconnect`, `fetch_and_cache_tokens_in_memory`, `flush_event_batches`, `get_dex_extended`, `get_on_chain_snapshot`, `get_pool`, `initialize_cache_database`, `initialize_rpc_client`, `new`, `process_pool_burn_event`, `process_pool_collect_event`, `process_pool_flash_event`, `process_pool_mint_event`, `process_pool_swap_event`, `register_dex_exchange`, `replay_pool_events`, `send_data`, `sync_blocks`, `sync_blocks_checked`, `sync_exchange_pools`, `sync_pool_events`
**Impls**: `BlockchainDataClientCore`
**Structs**: `BlockchainDataClientCore`, `encapsulates`
...
---
*Generated on 2025-11-18T21:54:59.210810Z*
