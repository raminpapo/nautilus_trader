# Documentation: `crates/adapters/blockchain/src/data/core.rs`
**Generated:** 2025-11-15T19:40:00.480827Z
**File Size:** 66600 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/adapters/blockchain/src/data/core.rs` within the repository.

**Classes defined:** encapsulates, BlockchainDataClientCore, BlockchainDataClientCore

**Functions defined:** new, initialize_cache_database, initialize_rpc_client, connect, sync_blocks_checked, sync_blocks, sync_pool_events, flush_event_batches, process_pool_swap_event, process_pool_mint_event and 17 more
...
#### `initialize_cache_database(&mut self)`
...
#### `register_dex_exchange(&mut self, dex_id: DexType)`
...
#### `get_on_chain_snapshot(&self, profiler: &PoolProfiler)`


#### `replay_pool_events(&self, pool: &Pool, dex: &SharedDex)`


#### `determine_from_block(&self)`


#### `get_dex_extended(&self, dex_id: &DexType)`


#### `get_pool(&self, pool_address: &Address)`


#### `send_data(&self, data: DataEvent)`
