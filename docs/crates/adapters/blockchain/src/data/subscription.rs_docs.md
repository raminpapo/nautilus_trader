# Documentation: `crates/adapters/blockchain/src/data/subscription.rs`
**Generated:** 2025-11-15T19:40:00.485740Z
**File Size:** 26159 bytes
**Extension:** .rs
**Type:** text
...
- **Path:** `crates/adapters/blockchain/src/data/subscription.rs`
- **Size:** 26,159 bytes
- **Lines:** 656
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/adapters/blockchain/src/data/subscription.rs` within the repository.

**Classes defined:** DefiDataSubscriptionManager, Default, DefiDataSubscriptionManager

**Functions defined:** default, new, get_subscribed_dex_contract_addresses, get_subscribed_dex_event_signatures, get_dex_pool_swap_event_signature, get_dex_pool_mint_event_signature, get_dex_pool_burn_event_signature, get_dex_pool_collect_event_signature, normalize_topic, register_dex_for_subscriptions and 25 more
...
#### `get_subscribed_dex_contract_addresses(&self, dex: &DexType)`


#### `get_subscribed_dex_event_signatures(&self, dex: &DexType)`


#### `get_dex_pool_swap_event_signature(&self, dex: &DexType)`


#### `get_dex_pool_mint_event_signature(&self, dex: &DexType)`


#### `get_dex_pool_burn_event_signature(&self, dex: &DexType)`


#### `get_dex_pool_collect_event_signature(&self, dex: &DexType)`


#### `normalize_topic(sig: &str)`
...
#### `subscribe_swaps(&mut self, dex: DexType, address: Address)`


#### `subscribe_mints(&mut self, dex: DexType, address: Address)`


#### `subscribe_burns(&mut self, dex: DexType, address: Address)`


#### `unsubscribe_swaps(&mut self, dex: DexType, address: Address)`


#### `unsubscribe_mints(&mut self, dex: DexType, address: Address)`


#### `unsubscribe_burns(&mut self, dex: DexType, address: Address)`


#### `subscribe_collects(&mut self, dex: DexType, address: Address)`


#### `unsubscribe_collects(&mut self, dex: DexType, address: Address)`


#### `subscribe_flashes(&mut self, dex: DexType, address: Address)`


#### `unsubscribe_flashes(&mut self, dex: DexType, address: Address)`
...
#### `test_new_creates_empty_manager(manager: DefiDataSubscriptionManager)`


#### `test_register_dex_for_subscriptions(registered_manager: DefiDataSubscriptionManager)`


#### `test_subscribe_and_get_addresses(mut registered_manager: DefiDataSubscriptionManager)`


#### `test_subscribe_to_unregistered_dex(mut manager: DefiDataSubscriptionManager)`


#### `test_unsubscribe_removes_address(mut registered_manager: DefiDataSubscriptionManager)`


#### `test_get_event_signatures(registered_manager: DefiDataSubscriptionManager)`


#### `test_multiple_subscriptions_same_pool(mut registered_manager: DefiDataSubscriptionManager)`
...
#### `test_event_signature_encoding(registered_manager: DefiDataSubscriptionManager)`


#### `test_complete_subscription_workflow(#[case] dex_type: DexType)`
...
**Directory:** `crates/adapters/blockchain/src/data`
