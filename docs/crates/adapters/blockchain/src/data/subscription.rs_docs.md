...
- **`get_subscribed_dex_contract_addresses()`**: Function defined in this file
- **`get_subscribed_dex_event_signatures()`**: Function defined in this file
- **`get_dex_pool_swap_event_signature()`**: Function defined in this file
- **`get_dex_pool_mint_event_signature()`**: Function defined in this file
- **`get_dex_pool_burn_event_signature()`**: Function defined in this file
- **`get_dex_pool_collect_event_signature()`**: Function defined in this file
- **`normalize_topic()`**: Function defined in this file
- **`register_dex_for_subscriptions()`**: Function defined in this file
- **`subscribe_swaps()`**: Function defined in this file
- **`subscribe_mints()`**: Function defined in this file
- **`subscribe_burns()`**: Function defined in this file
- **`unsubscribe_swaps()`**: Function defined in this file
- **`unsubscribe_mints()`**: Function defined in this file
- **`unsubscribe_burns()`**: Function defined in this file
- **`subscribe_collects()`**: Function defined in this file
- **`unsubscribe_collects()`**: Function defined in this file
- **`subscribe_flashes()`**: Function defined in this file
- **`unsubscribe_flashes()`**: Function defined in this file

*...and 15 more functions*

### Classes
- **`DefiDataSubscriptionManager`**: Class defined in this file
...
**Functions**: `default`, `get_dex_pool_burn_event_signature`, `get_dex_pool_collect_event_signature`, `get_dex_pool_mint_event_signature`, `get_dex_pool_swap_event_signature`, `get_subscribed_dex_contract_addresses`, `get_subscribed_dex_event_signatures`, `manager`, `new`, `normalize_topic`, `register_dex_for_subscriptions`, `registered_manager`, `subscribe_burns`, `subscribe_collects`, `subscribe_flashes`, `subscribe_mints`, `subscribe_swaps`, `test_complete_subscription_workflow`, `test_event_signature_encoding`, `test_get_combined_addresses_from_all_events`, `test_get_event_signatures`, `test_multiple_subscriptions_same_pool`, `test_new_creates_empty_manager`, `test_register_dex_for_subscriptions`, `test_register_with_pre_encoded_signatures`, `test_register_with_pre_encoded_signatures_no_prefix`, `test_register_with_raw_signatures`, `test_subscribe_and_get_addresses`, `test_subscribe_to_unregistered_dex`, `test_unsubscribe_removes_address` *(+5 more)*
**Impls**: `Default`, `DefiDataSubscriptionManager`
**Structs**: `DefiDataSubscriptionManager`

## Related Files

This file is located in `crates/adapters/blockchain/src/data/`. Related files may include:
...
---
*Generated on 2025-11-18T21:54:59.217199Z*
