# Documentation: math.rs

## File Metadata

- **Path**: `crates/adapters/blockchain/src/math.rs`
- **Size**: 13,131 bytes
- **Lines**: 349
- **Language**: Rust
...
### Functions
- **`convert_i256_to_f64()`**: Function defined in this file
- **`convert_u256_to_f64()`**: Function defined in this file
- **`test_convert_positive_i256_to_f64()`**: Function defined in this file
- **`test_convert_negative_i256_to_f64()`**: Function defined in this file
- **`test_convert_zero_i256_to_f64()`**: Function defined in this file
- **`test_convert_fractional_amounts()`**: Function defined in this file
- **`test_convert_large_i256_values()`**: Function defined in this file
- **`test_convert_with_different_decimals()`**: Function defined in this file
- **`test_convert_edge_cases()`**: Function defined in this file
- **`test_convert_real_world_examples()`**: Function defined in this file
- **`test_precision_boundaries()`**: Function defined in this file
- **`test_convert_positive_u256_to_f64()`**: Function defined in this file
- **`test_convert_zero_u256_to_f64()`**: Function defined in this file
- **`test_convert_fractional_u256_amounts()`**: Function defined in this file
- **`test_convert_large_u256_values()`**: Function defined in this file
- **`test_convert_u256_with_different_decimals()`**: Function defined in this file
- **`test_convert_u256_edge_cases()`**: Function defined in this file
- **`test_convert_u256_real_world_examples()`**: Function defined in this file
- **`test_convert_u256_precision_boundaries()`**: Function defined in this file
- **`test_convert_u256_vs_i256_consistency()`**: Function defined in this file
...
**Functions**: `convert_i256_to_f64`, `convert_u256_to_f64`, `test_convert_edge_cases`, `test_convert_fractional_amounts`, `test_convert_fractional_u256_amounts`, `test_convert_large_i256_values`, `test_convert_large_u256_values`, `test_convert_negative_i256_to_f64`, `test_convert_positive_i256_to_f64`, `test_convert_positive_u256_to_f64`, `test_convert_real_world_examples`, `test_convert_u256_edge_cases`, `test_convert_u256_max_values`, `test_convert_u256_precision_boundaries`, `test_convert_u256_real_world_examples`, `test_convert_u256_vs_i256_consistency`, `test_convert_u256_with_different_decimals`, `test_convert_with_different_decimals`, `test_convert_zero_i256_to_f64`, `test_convert_zero_u256_to_f64`, `test_precision_boundaries`

## Related Files

This file is located in `crates/adapters/blockchain/src/`. Related files may include:
...
---
*Generated on 2025-11-18T21:54:59.313411Z*
