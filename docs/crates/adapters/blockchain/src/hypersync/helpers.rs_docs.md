# Documentation: `crates/adapters/blockchain/src/hypersync/helpers.rs`
**Generated:** 2025-11-15T19:40:00.561026Z
...
This file is located at `crates/adapters/blockchain/src/hypersync/helpers.rs` within the repository.

**Functions defined:** extract_address_from_topic, extract_transaction_hash, extract_transaction_index, extract_log_index, extract_block_number, extract_event_signature, extract_event_signature_bytes, validate_event_signature_hash, swap_log_1, swap_log_2 and 20 more
...
#### `extract_transaction_index(log: &hypersync_client::simple_types::Log)`


#### `extract_log_index(log: &hypersync_client::simple_types::Log)`


#### `extract_block_number(log: &hypersync_client::simple_types::Log)`
...
#### `test_validate_event_signature_hash_success(swap_log_1: Log)`


#### `test_validate_event_signature_hash_success_log2(swap_log_2: Log)`


#### `test_validate_event_signature_hash_mismatch(swap_log_1: Log)`


#### `test_validate_event_signature_hash_missing_topic0(log_without_topics: Log)`


#### `test_validate_event_signature_hash_none_topic0(log_with_none_topic0: Log)`
...
#### `test_extract_address_from_topic_success(swap_log_1: Log)`


#### `test_extract_address_from_topic_success_log2(swap_log_2: Log)`


#### `test_extract_address_from_topic_missing_topic(swap_log_1: Log)`


#### `test_extract_address_from_topic_none_topic(swap_log_1: Log)`


#### `test_extract_address_from_topic_no_topics(log_without_topics: Log)`
...
**Directory:** `crates/adapters/blockchain/src/hypersync`
