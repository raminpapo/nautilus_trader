# Documentation: helpers.rs

## File Metadata

- **Path**: `crates/adapters/blockchain/src/hypersync/helpers.rs`
- **Size**: 17,880 bytes
- **Lines**: 515
- **Language**: Rust
...
This file is part of the NautilusTrader repository. It defines 30 function(s).

## Detailed Walkthrough

### Functions
- **`extract_address_from_topic()`**: Function defined in this file
- **`extract_transaction_hash()`**: Function defined in this file
- **`extract_transaction_index()`**: Function defined in this file
- **`extract_log_index()`**: Function defined in this file
- **`extract_block_number()`**: Function defined in this file
- **`extract_event_signature()`**: Function defined in this file
- **`extract_event_signature_bytes()`**: Function defined in this file
- **`validate_event_signature_hash()`**: Function defined in this file
- **`swap_log_1()`**: Function defined in this file
- **`swap_log_2()`**: Function defined in this file
- **`log_without_topics()`**: Function defined in this file
- **`log_with_none_topic0()`**: Function defined in this file
- **`test_validate_event_signature_hash_success()`**: Function defined in this file
- **`test_validate_event_signature_hash_success_log2()`**: Function defined in this file
- **`test_validate_event_signature_hash_mismatch()`**: Function defined in this file
- **`test_validate_event_signature_hash_missing_topic0()`**: Function defined in this file
- **`test_validate_event_signature_hash_none_topic0()`**: Function defined in this file
- **`test_extract_transaction_hash_success()`**: Function defined in this file
- **`test_extract_transaction_hash_missing()`**: Function defined in this file
- **`test_extract_transaction_index_success()`**: Function defined in this file
...
**Functions**: `extract_address_from_topic`, `extract_block_number`, `extract_event_signature`, `extract_event_signature_bytes`, `extract_log_index`, `extract_transaction_hash`, `extract_transaction_index`, `log_with_none_topic0`, `log_without_topics`, `swap_log_1`, `swap_log_2`, `test_extract_address_from_topic_missing_topic`, `test_extract_address_from_topic_no_topics`, `test_extract_address_from_topic_none_topic`, `test_extract_address_from_topic_success`, `test_extract_address_from_topic_success_log2`, `test_extract_block_number_missing`, `test_extract_block_number_success`, `test_extract_log_index_missing`, `test_extract_log_index_success`, `test_extract_transaction_hash_missing`, `test_extract_transaction_hash_success`, `test_extract_transaction_index_missing`, `test_extract_transaction_index_success`, `test_validate_event_signature_hash_mismatch`, `test_validate_event_signature_hash_missing_topic0`, `test_validate_event_signature_hash_none_topic0`, `test_validate_event_signature_hash_success`, `test_validate_event_signature_hash_success_log2`, `validate_event_signature_hash`

## Related Files

This file is located in `crates/adapters/blockchain/src/hypersync/`. Related files may include:
...
---
*Generated on 2025-11-18T21:54:59.305271Z*
