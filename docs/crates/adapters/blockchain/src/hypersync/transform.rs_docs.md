# Documentation: `crates/adapters/blockchain/src/hypersync/transform.rs`
**Generated:** 2025-11-15T19:40:00.563868Z
...
- **Path:** `crates/adapters/blockchain/src/hypersync/transform.rs`
- **Size:** 4,247 bytes
- **Lines:** 113
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/adapters/blockchain/src/hypersync/transform.rs` within the repository.

**Functions defined:** transform_hypersync_block
