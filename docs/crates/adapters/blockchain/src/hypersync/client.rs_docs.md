...
- **Path**: `crates/adapters/blockchain/src/hypersync/client.rs`
- **Size**: 20,483 bytes
- **Lines**: 510
- **Language**: Rust
...
- **`get_pool_address()`**: Function defined in this file
- **`process_block_dex_contract_events()`**: Function defined in this file
- **`request_contract_events_stream()`**: Function defined in this file
- **`disconnect()`**: Function defined in this file
- **`current_block()`**: Function defined in this file
- **`request_blocks_stream()`**: Function defined in this file
- **`subscribe_blocks()`**: Function defined in this file
- **`construct_block_query()`**: Function defined in this file
- **`construct_contract_events_query()`**: Function defined in this file
- **`unsubscribe_blocks()`**: Function defined in this file

### Classes
- **`HyperSyncClient`**: Class defined in this file
...
**Functions**: `construct_block_query`, `construct_contract_events_query`, `current_block`, `disconnect`, `get_pool_address`, `new`, `process_block_dex_contract_events`, `request_blocks_stream`, `request_contract_events_stream`, `subscribe_blocks`, `unsubscribe_blocks`
**Impls**: `HyperSyncClient`, `Stream`
**Structs**: `HyperSyncClient`
...
---
*Generated on 2025-11-18T21:54:59.301886Z*
