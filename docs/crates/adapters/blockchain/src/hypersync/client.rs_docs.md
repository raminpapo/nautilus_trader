# Documentation: `crates/adapters/blockchain/src/hypersync/client.rs`
**Generated:** 2025-11-15T19:40:00.558396Z
**File Size:** 20483 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/adapters/blockchain/src/hypersync/client.rs` within the repository.

**Classes defined:** HyperSyncClient, HyperSyncClient, Stream, Stream

**Functions defined:** new, get_pool_address, process_block_dex_contract_events, request_contract_events_stream, disconnect, current_block, request_blocks_stream, subscribe_blocks, construct_block_query, construct_contract_events_query and 1 more
...
#### `get_pool_address(&self, instrument_id: InstrumentId)`


#### `process_block_dex_contract_events(
        &mut self,
        dex: &DexType,
        block: u64,
        contract_addresses: Vec<Address>,
...
#### `construct_block_query(from_block: u64, to_block: Option<u64>)`


#### `construct_contract_events_query(
        from_block: u64,
        to_block: Option<u64>,
        contract_addresses: Vec<Address>,
        topics: Vec<&str>,
