# Documentation: rows.rs

## File Metadata

- **Path**: `crates/adapters/blockchain/src/cache/rows.rs`
- **Size**: 16,528 bytes
- **Lines**: 421
- **Language**: Rust
...
- **`from_row()`**: Function defined in this file
- **`from_row()`**: Function defined in this file
- **`transform_row_to_dex_pool_data()`**: Function defined in this file

### Classes
- **`TokenRow`**: Class defined in this file
- **`PoolRow`**: Class defined in this file
- **`BlockTimestampRow`**: Class defined in this file
...
**Enums**: `variant`
**Functions**: `from_row`, `transform_row_to_dex_pool_data`
**Impls**: `FromRow`
**Structs**: `BlockTimestampRow`, `PoolRow`, `TokenRow`
**Traits**: `to`
...
---
*Generated on 2025-11-18T21:54:59.175140Z*
