# Documentation: database.rs

## File Metadata

- **Path**: `crates/adapters/blockchain/src/cache/database.rs`
- **Size**: 88,808 bytes
- **Lines**: 2,215
- **Language**: Rust
...
This file is part of the NautilusTrader repository. It defines 43 function(s) and 1 class(es).

## Detailed Walkthrough

### Functions
- **`init()`**: Function defined in this file
- **`seed_chain()`**: Function defined in this file
- **`create_block_partition()`**: Function defined in this file
- **`create_token_partition()`**: Function defined in this file
- **`get_block_consistency_status()`**: Function defined in this file
- **`add_block()`**: Function defined in this file
- **`add_blocks_batch()`**: Function defined in this file
- **`add_blocks_copy()`**: Function defined in this file
- **`add_tokens_copy()`**: Function defined in this file
- **`add_pools_copy()`**: Function defined in this file
- **`add_pool_swaps_copy()`**: Function defined in this file
- **`add_pool_liquidity_updates_copy()`**: Function defined in this file
- **`copy_pool_fee_collects_batch()`**: Function defined in this file
- **`load_block_timestamps()`**: Function defined in this file
- **`add_dex()`**: Function defined in this file
- **`add_pool()`**: Function defined in this file
- **`add_pools_batch()`**: Function defined in this file
- **`add_pool_swaps_batch()`**: Function defined in this file
- **`add_pool_liquidity_updates_batch()`**: Function defined in this file
- **`add_token()`**: Function defined in this file

*...and 23 more functions*

### Classes
- **`BlockchainCacheDatabase`**: Class defined in this file
...
**Functions**: `add_block`, `add_blocks_batch`, `add_blocks_copy`, `add_dex`, `add_invalid_token`, `add_pool`, `add_pool_collects_batch`, `add_pool_flash_batch`, `add_pool_liquidity_update`, `add_pool_liquidity_updates_batch`, `add_pool_liquidity_updates_copy`, `add_pool_positions_batch`, `add_pool_snapshot`, `add_pool_swaps_batch`, `add_pool_swaps_copy`, `add_pool_ticks_batch`, `add_pools_batch`, `add_pools_copy`, `add_swap`, `add_token`, `add_tokens_copy`, `copy_pool_fee_collects_batch`, `create_block_partition`, `create_token_partition`, `get_block_consistency_status`, `get_dex_last_synced_block`, `get_pool_last_synced_block`, `get_table_last_block`, `init`, `load_block_timestamps` *(+13 more)*
**Impls**: `BlockchainCacheDatabase`
**Structs**: `BlockchainCacheDatabase`
...
---
*Generated on 2025-11-18T21:54:59.167030Z*
