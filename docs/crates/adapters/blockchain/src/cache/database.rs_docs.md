# Documentation: `crates/adapters/blockchain/src/cache/database.rs`
**Generated:** 2025-11-15T19:40:00.450031Z
**File Size:** 88808 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/adapters/blockchain/src/cache/database.rs` within the repository.

**Classes defined:** BlockchainCacheDatabase, BlockchainCacheDatabase

**Functions defined:** init, seed_chain, create_block_partition, create_token_partition, get_block_consistency_status, add_block, add_blocks_batch, add_blocks_copy, add_tokens_copy, add_pools_copy and 33 more
...
#### `init(pg_options: PgConnectOptions)`


#### `seed_chain(&self, chain: &Chain)`


#### `create_block_partition(&self, chain: &Chain)`


#### `create_token_partition(&self, chain: &Chain)`
...
#### `add_block(&self, chain_id: u32, block: &Block)`


#### `add_blocks_batch(&self, chain_id: u32, blocks: &[Block])`


#### `add_blocks_copy(&self, chain_id: u32, blocks: &[Block])`


#### `add_tokens_copy(&self, chain_id: u32, tokens: &[Token])`


#### `add_pools_copy(&self, chain_id: u32, pools: &[Pool])`
...
#### `add_dex(&self, dex: SharedDex)`


#### `add_pool(&self, pool: &Pool)`


#### `add_pools_batch(&self, pools: &[Pool])`
...
#### `add_swap(&self, chain_id: u32, swap: &PoolSwap)`
...
#### `load_tokens(&self, chain: SharedChain)`
...
#### `toggle_perf_sync_settings(&self, enable: bool)`
