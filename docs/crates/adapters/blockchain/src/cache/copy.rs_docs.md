# Documentation: copy.rs

## File Metadata

- **Path**: `crates/adapters/blockchain/src/cache/copy.rs`
- **Size**: 40,965 bytes
- **Lines**: 1,033
- **Language**: Rust
...
### Functions
- **`format_scientific_to_decimal()`**: Function defined in this file
- **`format_numeric()`**: Function defined in this file
- **`new()`**: Function defined in this file
- **`copy_blocks()`**: Function defined in this file
- **`copy_tokens()`**: Function defined in this file
- **`copy_pools()`**: Function defined in this file
- **`copy_pool_swaps()`**: Function defined in this file
- **`copy_pool_liquidity_updates()`**: Function defined in this file
- **`write_copy_header()`**: Function defined in this file
- **`write_block_binary()`**: Function defined in this file
- **`write_pool_swap_binary()`**: Function defined in this file
- **`write_pool_liquidity_update_binary()`**: Function defined in this file
- **`copy_pool_collects()`**: Function defined in this file
- **`write_pool_fee_collect_binary()`**: Function defined in this file
- **`write_token_binary()`**: Function defined in this file
- **`write_pool_binary()`**: Function defined in this file
- **`write_copy_trailer()`**: Function defined in this file

### Classes
- **`PostgresCopyHandler`**: Class defined in this file
...
**Functions**: `copy_blocks`, `copy_pool_collects`, `copy_pool_liquidity_updates`, `copy_pool_swaps`, `copy_pools`, `copy_tokens`, `format_numeric`, `format_scientific_to_decimal`, `new`, `write_block_binary`, `write_copy_header`, `write_copy_trailer`, `write_pool_binary`, `write_pool_fee_collect_binary`, `write_pool_liquidity_update_binary`, `write_pool_swap_binary`, `write_token_binary`
**Impls**: `PostgresCopyHandler`
**Structs**: `PostgresCopyHandler`
...
---
*Generated on 2025-11-18T21:54:59.157309Z*
