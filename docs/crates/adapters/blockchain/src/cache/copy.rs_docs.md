# Documentation: `crates/adapters/blockchain/src/cache/copy.rs`
**Generated:** 2025-11-15T19:40:00.442789Z
**File Size:** 40965 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/adapters/blockchain/src/cache/copy.rs` within the repository.

**Classes defined:** PostgresCopyHandler

**Functions defined:** format_scientific_to_decimal, format_numeric, new, copy_blocks, copy_tokens, copy_pools, copy_pool_swaps, copy_pool_liquidity_updates, write_copy_header, write_block_binary and 7 more
...
#### `format_scientific_to_decimal(s: &str)`


#### `format_numeric(value: &T)`


#### `new(pool: &'a PgPool)`


#### `copy_blocks(&self, chain_id: u32, blocks: &[Block])`


#### `copy_tokens(&self, chain_id: u32, tokens: &[Token])`


#### `copy_pools(&self, chain_id: u32, pools: &[Pool])`


#### `copy_pool_swaps(&self, chain_id: u32, swaps: &[PoolSwap])`


#### `copy_pool_liquidity_updates(
        &self,
        chain_id: u32,
        updates: &[PoolLiquidityUpdate],
    )`
