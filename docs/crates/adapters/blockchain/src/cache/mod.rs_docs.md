# Documentation: `crates/adapters/blockchain/src/cache/mod.rs`
**Generated:** 2025-11-15T19:40:00.454048Z
**File Size:** 29338 bytes
**Extension:** .rs
**Type:** text
...
- **Path:** `crates/adapters/blockchain/src/cache/mod.rs`
- **Size:** 29,338 bytes
- **Lines:** 833
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/adapters/blockchain/src/cache/mod.rs` within the repository.

**Classes defined:** BlockchainCache, BlockchainCache

**Functions defined:** new, get_cache_block_consistency_status, min_dex_creation_block, get_block_timestamp, initialize_database, toggle_performance_settings, initialize_chain, connect, load_tokens, load_pools and 29 more
...
#### `min_dex_creation_block(&self)`


#### `get_block_timestamp(&self, block_number: u64)`


#### `initialize_database(&mut self, pg_connect_options: PgConnectOptions)`


#### `toggle_performance_settings(&self, enable: bool)`


#### `initialize_chain(&mut self)`


#### `connect(&mut self, from_block: u64)`


#### `load_tokens(&mut self)`


#### `load_pools(&mut self, dex_id: &DexType)`


#### `load_blocks(&mut self, from_block: u64)`


#### `add_block(&mut self, block: Block)`
...
#### `add_dex(&mut self, dex: SharedDex)`


#### `add_pool(&mut self, pool: Pool)`


#### `add_pools_batch(&mut self, pools: Vec<Pool>)`


#### `add_token(&mut self, token: Token)`


#### `add_tokens_batch(&mut self, tokens: Vec<Token>)`


#### `insert_token_in_memory(&mut self, token: Token)`


#### `insert_invalid_token_in_memory(&mut self, address: Address)`
...
#### `add_pool_swap(&self, swap: &PoolSwap)`
...
#### `add_pool_flash_batch(&self, flash_events: &[PoolFlash])`
...
#### `get_dex(&self, dex_id: &DexType)`


#### `get_registered_dexes(&self)`


#### `get_pool(&self, address: &Address)`


#### `get_token(&self, address: &Address)`


#### `is_invalid_token(&self, address: &Address)`
...
#### `get_dex_last_synced_block(&self, dex: &DexType)`
