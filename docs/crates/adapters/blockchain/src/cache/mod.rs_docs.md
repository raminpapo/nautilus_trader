...
- **`get_cache_block_consistency_status()`**: Function defined in this file
- **`min_dex_creation_block()`**: Function defined in this file
- **`get_block_timestamp()`**: Function defined in this file
- **`initialize_database()`**: Function defined in this file
- **`toggle_performance_settings()`**: Function defined in this file
- **`initialize_chain()`**: Function defined in this file
- **`connect()`**: Function defined in this file
- **`load_tokens()`**: Function defined in this file
- **`load_pools()`**: Function defined in this file
- **`load_blocks()`**: Function defined in this file
...
- **`add_tokens_batch()`**: Function defined in this file
- **`insert_token_in_memory()`**: Function defined in this file
- **`insert_invalid_token_in_memory()`**: Function defined in this file

*...and 19 more functions*

### Classes
- **`BlockchainCache`**: Class defined in this file
...
**Functions**: `add_block`, `add_blocks_batch`, `add_dex`, `add_invalid_token`, `add_liquidity_update`, `add_pool`, `add_pool_fee_collects_batch`, `add_pool_flash_batch`, `add_pool_liquidity_updates_batch`, `add_pool_snapshot`, `add_pool_swap`, `add_pool_swaps_batch`, `add_pools_batch`, `add_token`, `add_tokens_batch`, `connect`, `get_block_timestamp`, `get_cache_block_consistency_status`, `get_dex`, `get_dex_last_synced_block`, `get_pool`, `get_pool_event_tables_last_block`, `get_pool_last_synced_block`, `get_registered_dexes`, `get_token`, `initialize_chain`, `initialize_database`, `insert_invalid_token_in_memory`, `insert_token_in_memory`, `is_invalid_token` *(+9 more)*
**Impls**: `BlockchainCache`
**Structs**: `BlockchainCache`
...
---
*Generated on 2025-11-18T21:54:59.171949Z*
