# Documentation: extended.rs

## File Metadata

- **Path**: `crates/adapters/blockchain/src/exchanges/extended.rs`
- **Size**: 8,860 bytes
- **Lines**: 232
- **Language**: Rust
...
- **`set_pool_created_event_parsing()`**: Function defined in this file
- **`set_initialize_event_parsing()`**: Function defined in this file
- **`set_swap_event_parsing()`**: Function defined in this file
- **`set_mint_event_parsing()`**: Function defined in this file
- **`set_burn_event_parsing()`**: Function defined in this file
- **`set_collect_event_parsing()`**: Function defined in this file
- **`set_flash_event_parsing()`**: Function defined in this file
- **`parse_pool_created_event()`**: Function defined in this file
- **`parse_swap_event()`**: Function defined in this file
- **`parse_mint_event()`**: Function defined in this file
- **`parse_burn_event()`**: Function defined in this file
- **`needs_initialization()`**: Function defined in this file
- **`parse_initialize_event()`**: Function defined in this file
- **`parse_collect_event()`**: Function defined in this file
- **`deref()`**: Function defined in this file

### Classes
- **`DexExtended`**: Class defined in this file
...
**Functions**: `deref`, `needs_initialization`, `new`, `parse_burn_event`, `parse_collect_event`, `parse_initialize_event`, `parse_mint_event`, `parse_pool_created_event`, `parse_swap_event`, `set_burn_event_parsing`, `set_collect_event_parsing`, `set_flash_event_parsing`, `set_initialize_event_parsing`, `set_mint_event_parsing`, `set_pool_created_event_parsing`, `set_swap_event_parsing`
**Impls**: `Deref`, `DexExtended`
**Structs**: `DexExtended`
...
---
*Generated on 2025-11-18T21:54:59.279374Z*
