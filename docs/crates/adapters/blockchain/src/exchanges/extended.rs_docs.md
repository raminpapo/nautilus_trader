# Documentation: `crates/adapters/blockchain/src/exchanges/extended.rs`
**Generated:** 2025-11-15T19:40:00.538355Z
**File Size:** 8860 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/adapters/blockchain/src/exchanges/extended.rs` within the repository.

**Classes defined:** DexExtended, DexExtended, Deref

**Functions defined:** new, set_pool_created_event_parsing, set_initialize_event_parsing, set_swap_event_parsing, set_mint_event_parsing, set_burn_event_parsing, set_collect_event_parsing, set_flash_event_parsing, parse_pool_created_event, parse_swap_event and 6 more
...
#### `set_pool_created_event_parsing(
        &mut self,
        parse_pool_created_event: fn(Log)`


#### `set_initialize_event_parsing(
        &mut self,
        parse_initialize_event: fn(SharedDex, Log)`


#### `set_swap_event_parsing(
        &mut self,
        parse_swap_event: fn(SharedDex, Log)`


#### `set_mint_event_parsing(
        &mut self,
        parse_mint_event: fn(SharedDex, Log)`


#### `set_burn_event_parsing(
        &mut self,
        parse_burn_event: fn(SharedDex, Log)`


#### `set_collect_event_parsing(
        &mut self,
        parse_collect_event: fn(SharedDex, Log)`


#### `set_flash_event_parsing(
        &mut self,
        parse_flash_event: fn(SharedDex, Log)`


#### `parse_pool_created_event(&self, log: Log)`


#### `parse_swap_event(&self, log: Log)`


#### `parse_mint_event(&self, log: Log)`


#### `parse_burn_event(&self, log: Log)`


#### `needs_initialization(&self)`


#### `parse_initialize_event(&self, log: Log)`


#### `parse_collect_event(&self, log: Log)`
