# Documentation: `crates/adapters/blockchain/src/exchanges/parsing/uniswap_v3/collect.rs`
**Generated:** 2025-11-15T19:40:00.545066Z
...
- **Path:** `crates/adapters/blockchain/src/exchanges/parsing/uniswap_v3/collect.rs`
- **Size:** 4,221 bytes
- **Lines:** 111
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/adapters/blockchain/src/exchanges/parsing/uniswap_v3/collect.rs` within the repository.

**Classes defined:** CollectEventData, let

**Functions defined:** parse_collect_event
...
#### `parse_collect_event(dex: SharedDex, log: Log)`
