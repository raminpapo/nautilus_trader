# Documentation: `crates/adapters/blockchain/src/exchanges/parsing/uniswap_v3/flash.rs`
**Generated:** 2025-11-15T19:40:00.546870Z
**File Size:** 3511 bytes
**Extension:** .rs
**Type:** text
...
- **Path:** `crates/adapters/blockchain/src/exchanges/parsing/uniswap_v3/flash.rs`
- **Size:** 3,511 bytes
- **Lines:** 96
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/adapters/blockchain/src/exchanges/parsing/uniswap_v3/flash.rs` within the repository.

**Classes defined:** FlashEventData, let

**Functions defined:** parse_flash_event
...
#### `parse_flash_event(dex: SharedDex, log: Log)`
