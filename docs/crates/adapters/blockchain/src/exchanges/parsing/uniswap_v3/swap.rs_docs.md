# Documentation: `crates/adapters/blockchain/src/exchanges/parsing/uniswap_v3/swap.rs`
**Generated:** 2025-11-15T19:40:00.554270Z
...
- **Path:** `crates/adapters/blockchain/src/exchanges/parsing/uniswap_v3/swap.rs`
- **Size:** 3,568 bytes
- **Lines:** 97
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/adapters/blockchain/src/exchanges/parsing/uniswap_v3/swap.rs` within the repository.

**Classes defined:** SwapEventData, let

**Functions defined:** parse_swap_event
...
#### `parse_swap_event(dex: SharedDex, log: Log)`
