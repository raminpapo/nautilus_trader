# Documentation: `crates/adapters/blockchain/src/exchanges/parsing/uniswap_v3/burn.rs`
**Generated:** 2025-11-15T19:40:00.542962Z
...
- **Path:** `crates/adapters/blockchain/src/exchanges/parsing/uniswap_v3/burn.rs`
- **Size:** 4,158 bytes
- **Lines:** 111
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/adapters/blockchain/src/exchanges/parsing/uniswap_v3/burn.rs` within the repository.

**Classes defined:** BurnEventData, let

**Functions defined:** parse_burn_event
...
#### `parse_burn_event(dex: SharedDex, log: Log)`
