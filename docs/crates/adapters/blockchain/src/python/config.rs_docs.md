# Documentation: `crates/adapters/blockchain/src/python/config.rs`
**Generated:** 2025-11-15T19:40:00.569531Z
**File Size:** 4978 bytes
**Extension:** .rs
**Type:** text
...
- **Path:** `crates/adapters/blockchain/src/python/config.rs`
- **Size:** 4,978 bytes
- **Lines:** 142
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/adapters/blockchain/src/python/config.rs` within the repository.

**Classes defined:** DexPoolFilters, BlockchainDataClientConfig

**Functions defined:** py_new, py_new, chain, http_rpc_url, wss_rpc_url, rpc_requests_per_second, use_hypersync_for_live_data, from_block, __repr__
...
#### `py_new(remove_pools_with_empty_erc20_fields: Option<bool>)`
...
#### `use_hypersync_for_live_data(&self)`
