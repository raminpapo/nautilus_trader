# Documentation: `crates/adapters/blockchain/src/decode.rs`
**Generated:** 2025-11-15T19:40:00.487634Z
...
This file is located at `crates/adapters/blockchain/src/decode.rs` within the repository.

**Functions defined:** u256_to_quantity, u256_to_price, test_quantity_from_wei, test_quantity_from_small_decimals, test_price_from_wei, test_price_precision_clamp
...
#### `u256_to_quantity(amount: U256, decimals: u8)`


#### `u256_to_price(amount: U256, decimals: u8)`
