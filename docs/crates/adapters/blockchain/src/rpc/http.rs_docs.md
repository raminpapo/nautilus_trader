...
- **`send_rpc_request()`**: Function defined in this file
- **`execute_eth_call()`**: Function defined in this file
- **`construct_eth_call()`**: Function defined in this file

### Classes
- **`BlockchainHttpRpcClient`**: Class defined in this file
...
**Functions**: `construct_eth_call`, `execute_eth_call`, `new`, `send_rpc_request`
**Impls**: `BlockchainHttpRpcClient`
**Structs**: `BlockchainHttpRpcClient`
...
---
*Generated on 2025-11-18T21:54:59.334660Z*
