# Documentation: `crates/adapters/blockchain/src/rpc/http.rs`
**Generated:** 2025-11-15T19:40:00.586049Z
**File Size:** 6461 bytes
**Extension:** .rs
**Type:** text
...
- **Path:** `crates/adapters/blockchain/src/rpc/http.rs`
- **Size:** 6,461 bytes
- **Lines:** 174
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/adapters/blockchain/src/rpc/http.rs` within the repository.

**Classes defined:** BlockchainHttpRpcClient, BlockchainHttpRpcClient

**Functions defined:** new, send_rpc_request, execute_eth_call, construct_eth_call
...
#### `new(http_rpc_url: String, rpc_request_per_second: Option<u32>)`
