# Documentation: `crates/adapters/blockchain/src/rpc/chains/base.rs`
**Generated:** 2025-11-15T19:40:00.576481Z
...
- **Path:** `crates/adapters/blockchain/src/rpc/chains/base.rs`
- **Size:** 1,970 bytes
- **Lines:** 53
- **Extension:** `.rs`
- **Type:** text
...
impl BaseRpcClient {
    pub fn new(wss_rpc_url: String) -> Self {
        let base_client = CoreBlockchainRpcClient::new(chains::BASE.clone(), wss_rpc_url);
...
This file is located at `crates/adapters/blockchain/src/rpc/chains/base.rs` within the repository.

**Classes defined:** BaseRpcClient, BaseRpcClient, BlockchainRpcClient
