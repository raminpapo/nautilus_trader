# Documentation: `crates/adapters/blockchain/src/rpc/utils.rs`
**Generated:** 2025-11-15T19:40:00.591543Z
...
- **Path:** `crates/adapters/blockchain/src/rpc/utils.rs`
- **Size:** 4,275 bytes
- **Lines:** 103
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/adapters/blockchain/src/rpc/utils.rs` within the repository.

**Functions defined:** is_subscription_confirmation_response, is_subscription_event, extract_rpc_subscription_id, subscription_confirmation, subscription_event, test_is_subscription_confirmation_response, test_is_subscription_event, test_extract_subscription_id
...
#### `is_subscription_confirmation_response(json: &serde_json::Value)`


#### `is_subscription_event(json: &serde_json::Value)`


#### `extract_rpc_subscription_id(json: &serde_json::Value)`
...
#### `test_is_subscription_confirmation_response(subscription_confirmation: serde_json::Value)`


#### `test_is_subscription_event(subscription_event: serde_json::Value)`


#### `test_extract_subscription_id(subscription_event: serde_json::Value)`
