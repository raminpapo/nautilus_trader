...
### Functions
- **`is_subscription_confirmation_response()`**: Function defined in this file
- **`is_subscription_event()`**: Function defined in this file
- **`extract_rpc_subscription_id()`**: Function defined in this file
- **`subscription_confirmation()`**: Function defined in this file
- **`subscription_event()`**: Function defined in this file
- **`test_is_subscription_confirmation_response()`**: Function defined in this file
- **`test_is_subscription_event()`**: Function defined in this file
- **`test_extract_subscription_id()`**: Function defined in this file
...
**Functions**: `extract_rpc_subscription_id`, `is_subscription_confirmation_response`, `is_subscription_event`, `subscription_confirmation`, `subscription_event`, `test_extract_subscription_id`, `test_is_subscription_confirmation_response`, `test_is_subscription_event`
...
---
*Generated on 2025-11-18T21:54:59.339281Z*
