# Documentation: `crates/adapters/blockchain/src/rpc/core.rs`
**Generated:** 2025-11-15T19:40:00.582844Z
...
- **Path:** `crates/adapters/blockchain/src/rpc/core.rs`
- **Size:** 16,879 bytes
- **Lines:** 402
- **Extension:** `.rs`
- **Type:** text
...
This file is located at `crates/adapters/blockchain/src/rpc/core.rs` within the repository.

**Classes defined:** CoreBlockchainRpcClient, Debug, CoreBlockchainRpcClient

**Functions defined:** fmt, new, connect, subscribe_events, resubscribe_all, unsubscribe_events, wait_on_rpc_channel, next_rpc_message, subscribe_blocks, unsubscribe_blocks
...
#### `new(chain: Chain, wss_rpc_url: String)`
