# Documentation: `crates/adapters/blockchain/bin/node_test.rs`
**Generated:** 2025-11-15T19:40:00.437155Z
**File Size:** 11259 bytes
**Extension:** .rs
**Type:** text
...
This file is located at `crates/adapters/blockchain/bin/node_test.rs` within the repository.

**Classes defined:** BlockchainSubscriberActorConfig, BlockchainSubscriberActor, BlockchainSubscriberActorConfig, BlockchainSubscriberActorConfig, Deref, DerefMut, DataActor, BlockchainSubscriberActor

**Functions defined:** main, new, py_new, __repr__, client_id, chain, pools, deref, deref_mut, on_start and 8 more
...
#### `BlockchainSubscriberActorConfig`

**Type:** struct


#### `BlockchainSubscriberActor`
...
#### `new(client_id: ClientId, chain: Blockchain, pools: Vec<InstrumentId>)`


#### `py_new(client_id: ClientId, chain: Blockchain, pools: Vec<InstrumentId>)`
...
#### `new(config: BlockchainSubscriberActorConfig)`
...
#### `pool_swap_count(&self)`


#### `pool_liquidity_update_count(&self)`
...
**Directory:** `crates/adapters/blockchain/bin`
