# Documentation: node_test.rs

## File Metadata

- **Path**: `crates/adapters/blockchain/bin/node_test.rs`
- **Size**: 11,259 bytes
- **Lines**: 335
- **Language**: Rust
...
- **`on_block()`**: Function defined in this file
- **`on_pool_swap()`**: Function defined in this file
- **`new()`**: Function defined in this file
- **`block_count()`**: Function defined in this file
- **`pool_count()`**: Function defined in this file
- **`pool_swap_count()`**: Function defined in this file
- **`pool_liquidity_update_count()`**: Function defined in this file

### Classes
- **`BlockchainSubscriberActorConfig`**: Class defined in this file
- **`BlockchainSubscriberActor`**: Class defined in this file
...
**Functions**: `__repr__`, `block_count`, `chain`, `client_id`, `deref`, `deref_mut`, `main`, `new`, `on_block`, `on_pool_swap`, `on_start`, `on_stop`, `pool_count`, `pool_liquidity_update_count`, `pool_swap_count`, `pools`, `py_new`
**Impls**: `BlockchainSubscriberActor`, `BlockchainSubscriberActorConfig`, `DataActor`, `Deref`, `DerefMut`
**Structs**: `BlockchainSubscriberActor`, `BlockchainSubscriberActorConfig`
**Traits**: `to`

## Related Files

This file is located in `crates/adapters/blockchain/bin/`. Related files may include:
...
```bash
# For Python
pytest crates/adapters/blockchain/bin/node_test.rs
...
---
*Generated on 2025-11-18T21:54:59.150518Z*
