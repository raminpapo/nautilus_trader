# Documentation: `crates/trading/src/sessions.rs`
**Generated:** 2025-11-15T19:40:03.797993Z
...
This file is located at `crates/trading/src/sessions.rs` within the repository.

**Classes defined:** ForexSession

**Functions defined:** timezone, session_times, fx_local_from_utc, fx_next_start, fx_prev_start, fx_next_end, fx_prev_end, test_fx_local_from_utc, test_fx_next_start, test_fx_prev_start and 7 more
...
#### `fx_local_from_utc(session: ForexSession, time_now: DateTime<Utc>)`


#### `fx_next_start(session: ForexSession, time_now: DateTime<Utc>)`


#### `fx_prev_start(session: ForexSession, time_now: DateTime<Utc>)`


#### `fx_next_end(session: ForexSession, time_now: DateTime<Utc>)`


#### `fx_prev_end(session: ForexSession, time_now: DateTime<Utc>)`


#### `test_fx_local_from_utc(#[case] session: ForexSession, #[case] expected: &str)`


#### `test_fx_next_start(#[case] session: ForexSession, #[case] expected: &str)`


#### `test_fx_prev_start(#[case] session: ForexSession, #[case] expected: &str)`


#### `test_fx_next_end(#[case] session: ForexSession, #[case] expected: &str)`


#### `test_fx_prev_end(#[case] session: ForexSession, #[case] expected: &str)`


#### `test_fx_next_start_on_weekend()`


#### `test_fx_next_start_during_active_session()`


#### `test_fx_prev_start_before_session()`


#### `test_fx_next_end_crossing_midnight()`
