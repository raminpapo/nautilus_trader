# Documentation: `crates/trading/src/python/sessions.rs`
**Generated:** 2025-11-15T19:40:03.795904Z
...
This file is located at `crates/trading/src/python/sessions.rs` within the repository.

**Classes defined:** ForexSession

**Functions defined:** py_new, __hash__, __repr__, __str__, name, value, variants, py_from_str, py_no_position_side, py_flat and 7 more
...
#### `variants(_: &Bound<'_, PyType>, py: Python<'_>)`
...
#### `py_fx_local_from_utc(session: ForexSession, time_now: DateTime<Utc>)`


#### `py_fx_next_start(session: ForexSession, time_now: DateTime<Utc>)`


#### `py_fx_next_end(session: ForexSession, time_now: DateTime<Utc>)`


#### `py_fx_prev_start(session: ForexSession, time_now: DateTime<Utc>)`


#### `py_fx_prev_end(session: ForexSession, time_now: DateTime<Utc>)`
