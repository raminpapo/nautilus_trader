...
**Generated:** 2025-11-15T19:40:05.412777Z
**File Size:** 10441 bytes
**Extension:** .toml
**Type:** text
...
select = [
  ...
  "SIM", # flake8-simplify
  "B", # flake8-bugbear
  "PERF102", # - When using only dict values use the values() method
  "FURB122", # - Use writelines instead of write in a loop
  "FURB166", # - int() on sliced str
  "FURB188", # - Use removeprefix/removesuffix instead of slicing
  # "ARG",
  # "ERA",
  "PD",
  "PGH",
...
This file is located at `pyproject.toml` within the repository.

This is a Python package configuration file used for building and distributing the package.
...
**Security:** This file may contain sensitive patterns: password, auth, session. Ensure proper handling of secrets.
