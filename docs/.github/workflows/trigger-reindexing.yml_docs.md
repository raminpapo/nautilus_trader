# Documentation: trigger-reindexing.yml

## File Metadata

- **Path**: `.github/workflows/trigger-reindexing.yml`
- **Size**: 984 bytes
- **Lines**: 31
- **Language**: YAML
...
**Identifiers**: `Accept`, `Api`, `Authorization`, `Bearer`, `Content`, `GitHub`, `POST`, `Principle`, `REPOSITORY_ACCESS_TOKEN`, `Trigger`, `Type`, `Version`
...
---
*Generated on 2025-11-18T21:54:58.830028Z*
