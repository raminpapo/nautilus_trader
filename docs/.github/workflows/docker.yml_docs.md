...
**Identifiers**: `BUILD_MODE`, `Build`, `Buildx`, `COMMON_ALLOWED_ENDPOINTS`, `Cargo`, `Checkout`, `Container`, `Create`, `DOCKER_METADATA_OUTPUT_JSON`, `Debian`, `Determine`, `Docker`, `Dockerfile`, `Download`, `Export`, `Free`, `GHCR`, `GITHUB_OUTPUT`, `GITHUB_REF`, `GIT_TAG`, `Generate`, `Get`, `GitHub`, `Hub`, `Inspect`, `Login`, `PACKAGES_TOKEN`, `Prepare`, `Principle`, `Production` *(+11 more)*
...
---
*Generated on 2025-11-18T21:54:58.825629Z*
