# Documentation: orders.json

## File Metadata

- **Path**: `tests/test_data/dydx/http/orders.json`
- **Size**: 721 bytes
- **Lines**: 26
- **Language**: JSON
...
**Identifiers**: `BUY`, `ETH`, `FILLED`, `IOC`, `LIMIT`, `USD`
...
```bash
# For Python
pytest tests/test_data/dydx/http/orders.json
...
---
*Generated on 2025-11-18T21:55:08.438444Z*
