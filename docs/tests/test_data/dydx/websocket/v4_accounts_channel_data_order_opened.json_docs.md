# Documentation: v4_accounts_channel_data_order_opened.json
...
**Identifiers**: `BEST_EFFORT_OPENED`, `BUY`, `ETH`, `IOC`, `LIMIT`, `USD`
...
```bash
# For Python
pytest tests/test_data/dydx/websocket/v4_accounts_channel_data_order_opened.json
...
---
*Generated on 2025-11-18T21:55:08.457635Z*
