# Documentation: `tests/acceptance_tests/test_blackbox.py`
**Generated:** 2025-11-15T19:40:05.551585Z
**File Size:** 12729 bytes
**Extension:** .py
**Type:** text
...
This file is located at `tests/acceptance_tests/test_blackbox.py` within the repository.

**Classes defined:** MACDStrategyConfig, MACDStrategy

**Functions defined:** __init__, on_start, on_stop, on_order_accepted, on_order_filled, on_trade_tick, check_for_entry, check_for_exit, on_position_opened, on_position_changed and 4 more
...
#### `__init__(self, config: MACDStrategyConfig)`
...
#### `check_for_entry(self, tick: TradeTick)`
...
#### `test_cash_account_trades_macd_event_sequencing()`
...
```python
from tests.acceptance_tests.test_blackbox import MACDStrategyConfig
```
