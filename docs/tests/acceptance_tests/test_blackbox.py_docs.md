# Documentation: test_blackbox.py

## File Metadata

- **Path**: `tests/acceptance_tests/test_blackbox.py`
- **Size**: 12,725 bytes
- **Lines**: 323
- **Language**: Python
...
### Functions
- **`create_engine()`**: Function defined in this file
- **`test_cash_account_trades_macd_event_sequencing()`**: Function defined in this file

### Classes
- **`MACDStrategyConfig`**: Class defined in this file
- **`MACDStrategy`**: Class defined in this file
...
**Classs**: `MACDStrategy`, `MACDStrategyConfig`
**Functions**: `create_engine`, `test_cash_account_trades_macd_event_sequencing`
**Imports**: `nautilus_trader.backtest.engine`, `nautilus_trader.config`, `nautilus_trader.core.message`, `nautilus_trader.core.rust.common`, `nautilus_trader.core.rust.model`, `nautilus_trader.indicators`, `nautilus_trader.model`, `nautilus_trader.model.currencies`, `nautilus_trader.model.enums`, `nautilus_trader.model.events`, `nautilus_trader.model.objects`, `nautilus_trader.persistence.wranglers`, `nautilus_trader.test_kit.providers`, `nautilus_trader.trading.strategy`, `pandas`
...
```bash
# For Python
pytest tests/acceptance_tests/test_blackbox.py
...
---
*Generated on 2025-11-18T21:55:06.183828Z*
