# Documentation: `tests/acceptance_tests/test_backtest.py`
**Generated:** 2025-11-15T19:40:05.547491Z
**File Size:** 87759 bytes
**Extension:** .py
**Type:** text
...
This file is located at `tests/acceptance_tests/test_backtest.py` within the repository.

**Classes defined:** TestBacktestAcceptanceTestsUSDJPY, TestBacktestAcceptanceTestsGBPUSDBarsInternal, TestBacktestAcceptanceTestsGBPUSDBarsExternal, TestBacktestAcceptanceTestsBTCUSDTEmaCrossTWAP, TestBacktestAcceptanceTestsAUDUSD, TestBacktestAcceptanceTestsETHUSDT, TestBacktestAcceptanceTestsOrderBookImbalance, TestBacktestAcceptanceTestsMarketMaking, TestBacktestNodeWithBacktestDataIterator, OptionConfig and 8 more

**Functions defined:** setup, teardown, test_run_ema_cross_strategy, test_rerun_ema_cross_strategy_returns_identical_performance, test_run_multiple_strategies, setup, teardown, test_run_ema_cross_with_five_minute_bar_spec, test_run_ema_cross_stop_entry_trail_strategy, test_run_ema_cross_stop_entry_trail_strategy_with_emulation and 57 more
...
#### `TestBacktestAcceptanceTestsUSDJPY`


#### `TestBacktestAcceptanceTestsGBPUSDBarsInternal`


#### `TestBacktestAcceptanceTestsGBPUSDBarsExternal`


#### `TestBacktestAcceptanceTestsBTCUSDTEmaCrossTWAP`


#### `TestBacktestAcceptanceTestsAUDUSD`


#### `TestBacktestAcceptanceTestsETHUSDT`


#### `TestBacktestAcceptanceTestsOrderBookImbalance`


#### `TestBacktestAcceptanceTestsMarketMaking`


#### `TestBacktestNodeWithBacktestDataIterator`
...
#### `MultiCycleTestStrategy`

**Inherits from:** Strategy


#### `PositionFlipStrategy`
...
#### `test_run_ema_cross_strategy(self)`


#### `test_rerun_ema_cross_strategy_returns_identical_performance(self)`


#### `test_run_multiple_strategies(self)`
...
#### `test_run_ema_cross_with_five_minute_bar_spec(self)`


#### `test_run_ema_cross_stop_entry_trail_strategy(self)`


#### `test_run_ema_cross_stop_entry_trail_strategy_with_emulation(self)`
...
#### `test_run_ema_cross_with_minute_bar_spec(self)`
...
#### `test_run_ema_cross_with_minute_trade_bars(self)`


#### `test_run_ema_cross_with_trade_ticks_from_bar_data(self)`
...
#### `test_run_ema_cross_with_tick_bar_spec(self)`
...
#### `test_run_order_book_imbalance(self)`
...
#### `test_run_market_maker(self)`


#### `test_backtest_same_with_and_without_data_configs(self)`


#### `test_spread_execution_functionality(self)`


#### `_validate_spread_math_consistency(self, combo_fills: list, leg_fills: list)`


#### `_validate_spread_quote_format(self, spread_quotes: list)`


#### `run_backtest(test_callback=None, with_data=True, log_path=None)`


#### `__init__(self, config: OptionConfig)`
...
#### `display_greeks(self, alert=None)`


#### `submit_market_order(self, instrument_id, quantity)`


#### `submit_limit_order(self, instrument_id, price, quantity)`


#### `on_stop(self)`


#### `user_log(self, msg, color=LogColor.GREEN)`


#### `__init__(self, config: StratTestConfig | None = None)`
...
```python
from tests.acceptance_tests.test_backtest import TestBacktestAcceptanceTestsUSDJPY
```
...
**Directory:** `tests/acceptance_tests`
