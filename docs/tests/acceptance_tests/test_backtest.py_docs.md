# Documentation: test_backtest.py

## File Metadata

- **Path**: `tests/acceptance_tests/test_backtest.py`
- **Size**: 87,759 bytes
- **Lines**: 2,274
- **Language**: Python
...
This file is part of the NautilusTrader repository. It defines 3 function(s) and 15 class(es).

## Detailed Walkthrough

### Functions
- **`run_backtest()`**: Function defined in this file
- **`test_correct_account_balance_from_issue_2632()`**: Function defined in this file
- **`run_backtest_and_return_engine()`**: Function defined in this file

### Classes
- **`TestBacktestAcceptanceTestsUSDJPY`**: Class defined in this file
- **`TestBacktestAcceptanceTestsGBPUSDBarsInternal`**: Class defined in this file
- **`TestBacktestAcceptanceTestsGBPUSDBarsExternal`**: Class defined in this file
- **`TestBacktestAcceptanceTestsBTCUSDTEmaCrossTWAP`**: Class defined in this file
- **`TestBacktestAcceptanceTestsAUDUSD`**: Class defined in this file
- **`TestBacktestAcceptanceTestsETHUSDT`**: Class defined in this file
- **`TestBacktestAcceptanceTestsOrderBookImbalance`**: Class defined in this file
- **`TestBacktestAcceptanceTestsMarketMaking`**: Class defined in this file
- **`TestBacktestNodeWithBacktestDataIterator`**: Class defined in this file
- **`OptionConfig`**: Class defined in this file
- **`OptionStrategy`**: Class defined in this file
- **`StratTestConfig`**: Class defined in this file
- **`StratTest`**: Class defined in this file
- **`TestBacktestPnLAlignmentAcceptance`**: Class defined in this file
- **`TestBarsWithFillsVisualization`**: Class defined in this file
...
**Classs**: `OptionConfig`, `OptionStrategy`, `StratTest`, `StratTestConfig`, `TestBacktestAcceptanceTestsAUDUSD`, `TestBacktestAcceptanceTestsBTCUSDTEmaCrossTWAP`, `TestBacktestAcceptanceTestsETHUSDT`, `TestBacktestAcceptanceTestsGBPUSDBarsExternal`, `TestBacktestAcceptanceTestsGBPUSDBarsInternal`, `TestBacktestAcceptanceTestsMarketMaking`, `TestBacktestAcceptanceTestsOrderBookImbalance`, `TestBacktestAcceptanceTestsUSDJPY`, `TestBacktestNodeWithBacktestDataIterator`, `TestBacktestPnLAlignmentAcceptance`, `TestBarsWithFillsVisualization`
**Functions**: `run_backtest`, `run_backtest_and_return_engine`, `test_correct_account_balance_from_issue_2632`
**Imports**: `decimal`, `fsspec.implementations.local`, `nautilus_trader`, `nautilus_trader.accounting.accounts.margin`, `nautilus_trader.adapters.databento.data_utils`, `nautilus_trader.backtest.engine`, `nautilus_trader.backtest.modules`, `nautilus_trader.backtest.node`, `nautilus_trader.common.enums`, `nautilus_trader.config`, `nautilus_trader.core.datetime`, `nautilus_trader.data.engine`, `nautilus_trader.examples.algorithms.twap`, `nautilus_trader.examples.strategies.ema_cross`, `nautilus_trader.examples.strategies.ema_cross_stop_entry`, `nautilus_trader.examples.strategies.ema_cross_trailing_stop`, `nautilus_trader.examples.strategies.ema_cross_twap`, `nautilus_trader.examples.strategies.market_maker`, `nautilus_trader.examples.strategies.orderbook_imbalance`, `nautilus_trader.execution.config`, `nautilus_trader.model`, `nautilus_trader.model.currencies`, `nautilus_trader.model.data`, `nautilus_trader.model.enums`, `nautilus_trader.model.events`, `nautilus_trader.model.greeks_data`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.instruments`, `nautilus_trader.model.instruments.betting`, `nautilus_trader.model.objects` *(+10 more)*

## Related Files

This file is located in `tests/acceptance_tests/`. Related files may include:
...
```bash
# For Python
pytest tests/acceptance_tests/test_backtest.py
...
---
*Generated on 2025-11-18T21:55:06.180850Z*
