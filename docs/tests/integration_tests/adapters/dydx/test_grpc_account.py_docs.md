# Documentation: `tests/integration_tests/adapters/dydx/test_grpc_account.py`
**Generated:** 2025-11-15T19:40:07.760340Z
**File Size:** 4037 bytes
**Extension:** .py
**Type:** text
...
This file is located at `tests/integration_tests/adapters/dydx/test_grpc_account.py` within the repository.

**Functions defined:** order_builder, test_calculate_quantums, test_calculate_subticks, test_create_order_id, test_create_order
...
#### `test_calculate_quantums(order_builder: OrderBuilder)`


#### `test_calculate_subticks(order_builder: OrderBuilder)`


#### `test_create_order_id(order_builder: OrderBuilder)`


#### `test_create_order(order_builder: OrderBuilder)`
...
```python
from tests.integration_tests.adapters.dydx.test_grpc_account import order_builder
```
