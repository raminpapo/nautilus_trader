# Documentation: test_http_endpoints.py

## File Metadata

- **Path**: `tests/integration_tests/adapters/dydx/test_http_endpoints.py`
- **Size**: 26,234 bytes
- **Lines**: 727
- **Language**: Python
...
This file is part of the NautilusTrader repository. It defines 29 function(s).

## Detailed Walkthrough

### Functions
- **`list_perpetual_markets_response()`**: Function defined in this file
- **`addresses_response()`**: Function defined in this file
- **`subaccount_response()`**: Function defined in this file
- **`asset_positions_response()`**: Function defined in this file
- **`perpetual_positions_response()`**: Function defined in this file
- **`orders_response()`**: Function defined in this file
- **`order_response()`**: Function defined in this file
- **`conditional_order_response()`**: Function defined in this file
- **`fills_response()`**: Function defined in this file
- **`test_addresses()`**: Function defined in this file
- **`test_subaccount()`**: Function defined in this file
- **`test_asset_positions()`**: Function defined in this file
- **`test_perpetual_positions()`**: Function defined in this file
- **`test_perpetual_positions_into_margin_balance()`**: Function defined in this file
- **`test_closed_perpetual_positions_into_margin_balance()`**: Function defined in this file
- **`test_orders()`**: Function defined in this file
- **`test_order()`**: Function defined in this file
- **`test_fills()`**: Function defined in this file
- **`test_fills_with_affiliate_rev_share()`**: Function defined in this file
- **`test_parse_to_position_status_report()`**: Function defined in this file
...
**Functions**: `addresses_response`, `asset_positions_response`, `conditional_order_response`, `fills_response`, `list_perpetual_markets_response`, `order_response`, `orders_response`, `perpetual_positions_response`, `subaccount_response`, `test_addresses`, `test_asset_positions`, `test_closed_perpetual_positions_into_margin_balance`, `test_fills`, `test_fills_with_affiliate_rev_share`, `test_list_perpetual_markets`, `test_list_perpetual_markets_base_currency`, `test_list_perpetual_markets_null_oracle_price`, `test_list_perpetual_markets_quote_currency`, `test_list_perpetual_markets_v8`, `test_order`, `test_order_parse_to_conditional_order_status_report`, `test_order_parse_to_order_status_report`, `test_orders`, `test_parse_to_fill_report`, `test_parse_to_instrument`, `test_parse_to_position_status_report`, `test_perpetual_positions`, `test_perpetual_positions_into_margin_balance`, `test_subaccount`
**Imports**: `decimal`, `msgspec`, `nautilus_trader.adapters.dydx.common.constants`, `nautilus_trader.adapters.dydx.common.enums`, `nautilus_trader.adapters.dydx.common.symbol`, `nautilus_trader.adapters.dydx.endpoints.market.instruments_info`, `nautilus_trader.adapters.dydx.schemas.account.address`, `nautilus_trader.adapters.dydx.schemas.account.asset_positions`, `nautilus_trader.adapters.dydx.schemas.account.fills`, `nautilus_trader.adapters.dydx.schemas.account.orders`, `nautilus_trader.adapters.dydx.schemas.account.perpetual_positions`, `nautilus_trader.core.nautilus_pyo3`, `nautilus_trader.core.uuid`, `nautilus_trader.execution.reports`, `nautilus_trader.model.enums`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.instruments`, `nautilus_trader.model.objects`, `pathlib`, `pytest`
...
```bash
# For Python
pytest tests/integration_tests/adapters/dydx/test_http_endpoints.py
...
---
*Generated on 2025-11-18T21:55:06.849513Z*
