# Documentation: `tests/integration_tests/adapters/dydx/test_http_endpoints.py`
**Generated:** 2025-11-15T19:40:07.764355Z
...
This file is located at `tests/integration_tests/adapters/dydx/test_http_endpoints.py` within the repository.

**Functions defined:** list_perpetual_markets_response, addresses_response, subaccount_response, asset_positions_response, perpetual_positions_response, orders_response, order_response, conditional_order_response, fills_response, test_addresses and 19 more
...
#### `test_addresses(addresses_response: DYDXAddressResponse)`


#### `test_subaccount(subaccount_response: DYDXSubaccountResponse)`


#### `test_asset_positions(asset_positions_response: DYDXAssetPositionsResponse)`


#### `test_perpetual_positions(perpetual_positions_response: DYDXPerpetualPositionsResponse)`
...
#### `test_orders(orders_response: list[DYDXOrderResponse])`


#### `test_order(order_response: DYDXOrderResponse)`


#### `test_fills(fills_response: DYDXFillsResponse)`
...
#### `test_parse_to_fill_report(fills_response: DYDXFillsResponse)`


#### `test_order_parse_to_order_status_report(order_response: DYDXOrderResponse)`
...
```python
from tests.integration_tests.adapters.dydx.test_http_endpoints import list_perpetual_markets_response
```
