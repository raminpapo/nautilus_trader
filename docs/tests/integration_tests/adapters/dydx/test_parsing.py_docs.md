# Documentation: `tests/integration_tests/adapters/dydx/test_parsing.py`
**Generated:** 2025-11-15T19:40:07.766719Z
**File Size:** 10154 bytes
**Extension:** .py
**Type:** text
...
This file is located at `tests/integration_tests/adapters/dydx/test_parsing.py` within the repository.

**Functions defined:** enum_parser, test_parse_order_type, test_parse_nautilus_order_type, test_parse_order_side, test_parse_nautilus_order_side, test_parse_order_status, test_parse_order_time_in_force, test_parse_dydx_liquidity_side, test_parse_dydx_position_side, test_parse_dydx_kline_correct and 2 more
...
#### `test_parse_dydx_kline_incorrect(bar_type: str)`
...
```python
from tests.integration_tests.adapters.dydx.test_parsing import enum_parser
```
