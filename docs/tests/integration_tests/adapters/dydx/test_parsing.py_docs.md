...
- **Path**: `tests/integration_tests/adapters/dydx/test_parsing.py`
- **Size**: 10,154 bytes
- **Lines**: 310
- **Language**: Python
...
### Functions
- **`enum_parser()`**: Function defined in this file
- **`test_parse_order_type()`**: Function defined in this file
- **`test_parse_nautilus_order_type()`**: Function defined in this file
- **`test_parse_order_side()`**: Function defined in this file
- **`test_parse_nautilus_order_side()`**: Function defined in this file
- **`test_parse_order_status()`**: Function defined in this file
- **`test_parse_order_time_in_force()`**: Function defined in this file
- **`test_parse_dydx_liquidity_side()`**: Function defined in this file
- **`test_parse_dydx_position_side()`**: Function defined in this file
- **`test_parse_dydx_kline_correct()`**: Function defined in this file
- **`test_parse_dydx_kline_incorrect()`**: Function defined in this file
- **`test_order_type_bidirectional_mapping_consistency()`**: Function defined in this file
...
**Functions**: `enum_parser`, `test_order_type_bidirectional_mapping_consistency`, `test_parse_dydx_kline_correct`, `test_parse_dydx_kline_incorrect`, `test_parse_dydx_liquidity_side`, `test_parse_dydx_position_side`, `test_parse_nautilus_order_side`, `test_parse_nautilus_order_type`, `test_parse_order_side`, `test_parse_order_status`, `test_parse_order_time_in_force`, `test_parse_order_type`
**Imports**: `nautilus_trader.adapters.dydx.common.enums`, `nautilus_trader.adapters.dydx.common.parsing`, `nautilus_trader.core.nautilus_pyo3`, `nautilus_trader.model.data`, `nautilus_trader.model.enums`, `pytest`
...
```bash
# For Python
pytest tests/integration_tests/adapters/dydx/test_parsing.py
...
---
*Generated on 2025-11-18T21:55:06.851863Z*
