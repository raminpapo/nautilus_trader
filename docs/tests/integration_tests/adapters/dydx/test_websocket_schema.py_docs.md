# Documentation: test_websocket_schema.py

## File Metadata

- **Path**: `tests/integration_tests/adapters/dydx/test_websocket_schema.py`
- **Size**: 44,146 bytes
- **Lines**: 1,251
- **Language**: Python
...
### Functions
- **`test_general_message()`**: Function defined in this file
- **`test_block_height_subscribed_message()`**: Function defined in this file
- **`test_block_height_channel_data_message()`**: Function defined in this file
- **`test_account_subscribed_message()`**: Function defined in this file
- **`test_markets_subscribed_message()`**: Function defined in this file
- **`test_markets_channel_message()`**: Function defined in this file
- **`test_markets_channel_message_v8()`**: Function defined in this file
- **`test_markets_channel_market_type()`**: Function defined in this file
- **`test_markets_channel_trade_message()`**: Function defined in this file
- **`test_markets_channel_oracle_price_message()`**: Function defined in this file
- **`test_account_parse_to_account_balances()`**: Function defined in this file
- **`test_account_parse_to_account_balances_order_best_effort_canceled()`**: Function defined in this file
- **`test_account_parse_to_margin_balances()`**: Function defined in this file
- **`test_account_parse_to_position_status_report()`**: Function defined in this file
- **`test_account_channel_data_msg()`**: Function defined in this file
- **`test_account_channel_data_msg_affiliate_rev_share_fill()`**: Function defined in this file
- **`test_account_channel_data_msg_order_expired()`**: Function defined in this file
- **`test_account_channel_data_transfers()`**: Function defined in this file
- **`test_account_channel_data_rewards()`**: Function defined in this file
- **`test_account_channel_data_fills()`**: Function defined in this file
...
**Functions**: `test_account_channel_data_fills`, `test_account_channel_data_msg`, `test_account_channel_data_msg_affiliate_rev_share_fill`, `test_account_channel_data_msg_order_expired`, `test_account_channel_data_new_conditional_order_opened`, `test_account_channel_data_new_order`, `test_account_channel_data_new_order_opened`, `test_account_channel_data_order_best_effort_canceled`, `test_account_channel_data_order_canceled`, `test_account_channel_data_rewards`, `test_account_channel_data_transfers`, `test_account_parse_to_account_balances`, `test_account_parse_to_account_balances_order_best_effort_canceled`, `test_account_parse_to_margin_balances`, `test_account_parse_to_position_status_report`, `test_account_subscribed_message`, `test_block_height_channel_data_message`, `test_block_height_subscribed_message`, `test_general_message`, `test_klines_channel_data`, `test_klines_subscribed_data`, `test_klines_subscribed_data_parsing`, `test_markets_channel_market_type`, `test_markets_channel_message`, `test_markets_channel_message_v8`, `test_markets_channel_oracle_price_message`, `test_markets_channel_trade_message`, `test_markets_subscribed_message`, `test_orderbook`, `test_orderbook_batched_data` *(+3 more)*
**Imports**: `decimal`, `msgspec`, `nautilus_trader.adapters.dydx.common.constants`, `nautilus_trader.adapters.dydx.common.enums`, `nautilus_trader.adapters.dydx.common.symbol`, `nautilus_trader.adapters.dydx.schemas.ws`, `nautilus_trader.core.nautilus_pyo3`, `nautilus_trader.core.uuid`, `nautilus_trader.execution.reports`, `nautilus_trader.model.data`, `nautilus_trader.model.enums`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.objects`, `pathlib`, `pytest`
...
```bash
# For Python
pytest tests/integration_tests/adapters/dydx/test_websocket_schema.py
...
---
*Generated on 2025-11-18T21:55:06.858492Z*
