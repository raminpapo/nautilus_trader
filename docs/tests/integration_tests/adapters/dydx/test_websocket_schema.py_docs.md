# Documentation: `tests/integration_tests/adapters/dydx/test_websocket_schema.py`
**Generated:** 2025-11-15T19:40:07.772018Z
**File Size:** 44154 bytes
**Extension:** .py
**Type:** text
...
This file is located at `tests/integration_tests/adapters/dydx/test_websocket_schema.py` within the repository.

**Functions defined:** test_general_message, test_block_height_subscribed_message, test_block_height_channel_data_message, test_account_subscribed_message, test_markets_subscribed_message, test_markets_channel_message, test_markets_channel_message_v8, test_markets_channel_market_type, test_markets_channel_trade_message, test_markets_channel_oracle_price_message and 23 more
...
#### `test_general_message(file_path: str)`
...
#### `test_klines_subscribed_data(instrument_id: InstrumentId)`


#### `test_klines_subscribed_data_parsing(file_path: str)`


#### `test_klines_channel_data(instrument_id: InstrumentId)`


#### `test_orderbook(instrument_id: InstrumentId)`


#### `test_orderbook_snapshot(instrument_id: InstrumentId)`


#### `test_orderbook_batched_data(instrument_id: InstrumentId)`


#### `test_trades(instrument_id: InstrumentId)`


#### `test_trades_deleveraged(instrument_id: InstrumentId)`
...
```python
from tests.integration_tests.adapters.dydx.test_websocket_schema import test_general_message
```
