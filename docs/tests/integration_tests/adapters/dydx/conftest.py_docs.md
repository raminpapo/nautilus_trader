...
- **`http_client()`**: Function defined in this file
...
**Functions**: `account_state`, `data_client`, `exec_client`, `http_client`, `instrument`, `instrument_id`, `live_clock`, `pytest_ignore_collect`, `symbol`, `venue`
**Imports**: `pytest`, `sys`
...
```bash
# For Python
pytest tests/integration_tests/adapters/dydx/conftest.py
...
---
*Generated on 2025-11-18T21:55:06.832002Z*
