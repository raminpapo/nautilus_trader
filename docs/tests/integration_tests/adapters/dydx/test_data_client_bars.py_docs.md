# Documentation: `tests/integration_tests/adapters/dydx/test_data_client_bars.py`
**Generated:** 2025-11-15T19:40:07.755982Z
**File Size:** 25144 bytes
**Extension:** .py
**Type:** text
...
This file is located at `tests/integration_tests/adapters/dydx/test_data_client_bars.py` within the repository.

**Classes defined:** TestDYDXDataClientBarPartitioning

**Functions defined:** setup_method, teardown_method, create_request_bars, create_mock_candle, test_partitioning_threshold_boundary_conditions, test_partitioning_with_different_timeframes, mock_api_call, test_partitioning_edge_cases
...
#### `setup_method(self, session_event_loop)`
...
#### `test_partitioning_threshold_boundary_conditions(self, bars_count, max_bars, expected)`


#### `test_partitioning_with_different_timeframes(self)`


#### `mock_api_call(**kwargs)`


#### `test_partitioning_edge_cases(self)`
...
```python
from tests.integration_tests.adapters.dydx.test_data_client_bars import TestDYDXDataClientBarPartitioning
```
