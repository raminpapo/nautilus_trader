# Documentation: test_data_client_bars.py

## File Metadata

- **Path**: `tests/integration_tests/adapters/dydx/test_data_client_bars.py`
- **Size**: 25,165 bytes
- **Lines**: 662
- **Language**: Python
...
### Classes
- **`TestDYDXDataClientBarPartitioning`**: Class defined in this file
...
**Classs**: `TestDYDXDataClientBarPartitioning`
**Imports**: `asyncio`, `datetime`, `decimal`, `nautilus_trader.adapters.dydx.common.symbol`, `nautilus_trader.adapters.dydx.config`, `nautilus_trader.adapters.dydx.data`, `nautilus_trader.adapters.dydx.endpoints.market.candles`, `nautilus_trader.adapters.dydx.http.client`, `nautilus_trader.adapters.dydx.providers`, `nautilus_trader.adapters.dydx.schemas.ws`, `nautilus_trader.cache.cache`, `nautilus_trader.common.component`, `nautilus_trader.core.uuid`, `nautilus_trader.data.messages`, `nautilus_trader.model.data`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.instruments`, `nautilus_trader.model.objects`, `nautilus_trader.test_kit.mocks.cache_database`, `pytest`, `unittest.mock`
...
```bash
# For Python
pytest tests/integration_tests/adapters/dydx/test_data_client_bars.py
...
---
*Generated on 2025-11-18T21:55:06.838506Z*
