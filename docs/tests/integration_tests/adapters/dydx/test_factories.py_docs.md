# Documentation: `tests/integration_tests/adapters/dydx/test_factories.py`
**Generated:** 2025-11-15T19:40:07.758976Z
...
This file is located at `tests/integration_tests/adapters/dydx/test_factories.py` within the repository.

**Functions defined:** test_get_http_base_url, test_get_ws_base_url, test_grpc_base_url, test_create_dydx_live_data_client
...
#### `test_get_http_base_url(is_testnet: bool, expected: str)`


#### `test_get_ws_base_url(is_testnet: bool, expected: str)`


#### `test_grpc_base_url(is_testnet: bool, expected: str)`


#### `test_create_dydx_live_data_client(event_loop_for_setup)`
...
```python
from tests.integration_tests.adapters.dydx.test_factories import test_get_http_base_url
```
