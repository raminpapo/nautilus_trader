...
- **Path**: `tests/integration_tests/adapters/dydx/test_factories.py`
- **Size**: 3,442 bytes
- **Lines**: 102
- **Language**: Python
...
### Functions
- **`test_get_http_base_url()`**: Function defined in this file
- **`test_get_ws_base_url()`**: Function defined in this file
- **`test_grpc_base_url()`**: Function defined in this file
- **`test_create_dydx_live_data_client()`**: Function defined in this file
...
**Functions**: `test_create_dydx_live_data_client`, `test_get_http_base_url`, `test_get_ws_base_url`, `test_grpc_base_url`
**Imports**: `nautilus_trader.adapters.dydx.common.urls`, `nautilus_trader.adapters.dydx.config`, `nautilus_trader.adapters.dydx.data`, `nautilus_trader.adapters.dydx.factories`, `nautilus_trader.cache.cache`, `nautilus_trader.common.component`, `nautilus_trader.model.identifiers`, `nautilus_trader.test_kit.mocks.cache_database`, `pytest`
...
```bash
# For Python
pytest tests/integration_tests/adapters/dydx/test_factories.py
...
---
*Generated on 2025-11-18T21:55:06.842136Z*
