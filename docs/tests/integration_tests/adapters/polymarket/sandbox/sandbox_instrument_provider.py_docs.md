...
**Imports**: `asyncio`, `nautilus_trader.adapters.polymarket.factories`, `nautilus_trader.adapters.polymarket.providers`, `nautilus_trader.common.component`
...
```bash
# For Python
pytest tests/integration_tests/adapters/polymarket/sandbox/sandbox_instrument_provider.py
...
---
*Generated on 2025-11-18T21:55:07.157787Z*
