...
- **Path**: `tests/integration_tests/adapters/polymarket/test_loaders.py`
- **Size**: 10,822 bytes
- **Lines**: 336
- **Language**: Python
...
### Functions
- **`markets_list_data()`**: Function defined in this file
- **`market_details_data()`**: Function defined in this file
- **`orderbook_history_data()`**: Function defined in this file
- **`price_history_data()`**: Function defined in this file
- **`test_instrument()`**: Function defined in this file
- **`loader()`**: Function defined in this file
- **`test_parse_orderbook_snapshots()`**: Function defined in this file
- **`test_parse_orderbook_snapshots_uses_instrument_precision()`**: Function defined in this file
- **`test_parse_price_history()`**: Function defined in this file
- **`test_parse_price_history_aggressor_side_logic()`**: Function defined in this file
- **`test_parse_price_history_uses_instrument_precision()`**: Function defined in this file
...
**Functions**: `loader`, `market_details_data`, `markets_list_data`, `orderbook_history_data`, `price_history_data`, `test_instrument`, `test_parse_orderbook_snapshots`, `test_parse_orderbook_snapshots_uses_instrument_precision`, `test_parse_price_history`, `test_parse_price_history_aggressor_side_logic`, `test_parse_price_history_uses_instrument_precision`
**Imports**: `msgspec.json`, `nautilus_trader.adapters.polymarket.common.parsing`, `nautilus_trader.adapters.polymarket.loaders`, `nautilus_trader.core`, `nautilus_trader.model.data`, `nautilus_trader.model.enums`, `pkgutil`, `pytest`, `unittest.mock`
...
```bash
# For Python
pytest tests/integration_tests/adapters/polymarket/test_loaders.py
...
---
*Generated on 2025-11-18T21:55:07.177949Z*
