# Documentation: `tests/integration_tests/adapters/polymarket/test_loaders.py`
**Generated:** 2025-11-15T19:40:07.946345Z
**File Size:** 10822 bytes
**Extension:** .py
**Type:** text
...
This file is located at `tests/integration_tests/adapters/polymarket/test_loaders.py` within the repository.

**Functions defined:** markets_list_data, market_details_data, orderbook_history_data, price_history_data, test_instrument, loader, test_parse_orderbook_snapshots, test_parse_orderbook_snapshots_uses_instrument_precision, test_parse_price_history, test_parse_price_history_aggressor_side_logic and 1 more
...
#### `test_instrument(market_details_data)`


#### `loader(test_instrument)`


#### `test_parse_orderbook_snapshots(loader, orderbook_history_data)`
...
#### `test_parse_price_history(loader, price_history_data)`


#### `test_parse_price_history_aggressor_side_logic(loader, price_history_data)`
...
```python
from tests.integration_tests.adapters.polymarket.test_loaders import markets_list_data
```
