# Documentation: test_gamma_markets.py
...
### Functions
- **`test_normalize_gamma_market_to_clob_format()`**: Function defined in this file
- **`test_normalize_gamma_market_with_defaults()`**: Function defined in this file
- **`test_parse_clob_token_ids_and_outcomes()`**: Function defined in this file
...
**Functions**: `test_normalize_gamma_market_to_clob_format`, `test_normalize_gamma_market_with_defaults`, `test_parse_clob_token_ids_and_outcomes`
**Imports**: `json`, `nautilus_trader.adapters.polymarket.common.gamma_markets`
...
```bash
# For Python
pytest tests/integration_tests/adapters/polymarket/test_gamma_markets.py
...
---
*Generated on 2025-11-18T21:55:07.175799Z*
