# Documentation: `tests/integration_tests/adapters/polymarket/test_gamma_markets.py`
**Generated:** 2025-11-15T19:40:07.944346Z
...
- **Path:** `tests/integration_tests/adapters/polymarket/test_gamma_markets.py`
- **Size:** 6,507 bytes
- **Lines:** 150
- **Extension:** `.py`
- **Type:** text
...
This file is located at `tests/integration_tests/adapters/polymarket/test_gamma_markets.py` within the repository.

**Functions defined:** test_normalize_gamma_market_to_clob_format, test_normalize_gamma_market_with_defaults, test_parse_clob_token_ids_and_outcomes
...
```python
from tests.integration_tests.adapters.polymarket.test_gamma_markets import test_normalize_gamma_market_to_clob_format
```
