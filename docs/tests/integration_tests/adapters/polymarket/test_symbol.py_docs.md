...
### Classes
- **`TestPolymarketSymbol`**: Class defined in this file
...
**Classs**: `TestPolymarketSymbol`
**Imports**: `nautilus_trader.adapters.polymarket.common.constants`, `nautilus_trader.adapters.polymarket.common.symbol`, `nautilus_trader.model.identifiers`, `pytest`
...
```bash
# For Python
pytest tests/integration_tests/adapters/polymarket/test_symbol.py
...
---
*Generated on 2025-11-18T21:55:07.186591Z*
