# Documentation: `tests/integration_tests/adapters/polymarket/test_data_client.py`
**Generated:** 2025-11-15T19:40:07.937873Z
...
This file is located at `tests/integration_tests/adapters/polymarket/test_data_client.py` within the repository.

**Classes defined:** _RecordingPolymarketDataClient

**Functions defined:** __init__, _handle_data, _make_binary_option, _build_snapshot, test_tick_size_change_rebuilds_local_book_precision
...
**Inherits from:** PolymarketDataClient
...
#### `_handle_data(self, data: Any)`


#### `_make_binary_option(price_inc: str)`


#### `_build_snapshot(prices: tuple[str, str, str, str])`


#### `test_tick_size_change_rebuilds_local_book_precision(event_loop)`
...
```python
from tests.integration_tests.adapters.polymarket.test_data_client import _RecordingPolymarketDataClient
```
