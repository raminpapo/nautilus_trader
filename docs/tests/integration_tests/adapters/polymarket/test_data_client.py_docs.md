...
- **Path**: `tests/integration_tests/adapters/polymarket/test_data_client.py`
- **Size**: 6,202 bytes
- **Lines**: 166
- **Language**: Python
...
### Functions
- **`_make_binary_option()`**: Function defined in this file
- **`_build_snapshot()`**: Function defined in this file
- **`test_tick_size_change_rebuilds_local_book_precision()`**: Function defined in this file

### Classes
- **`_RecordingPolymarketDataClient`**: Class defined in this file
...
**Classs**: `_RecordingPolymarketDataClient`
**Functions**: `_build_snapshot`, `_make_binary_option`, `test_tick_size_change_rebuilds_local_book_precision`
**Imports**: `decimal`, `nautilus_trader.adapters.polymarket.config`, `nautilus_trader.adapters.polymarket.data`, `nautilus_trader.adapters.polymarket.providers`, `nautilus_trader.adapters.polymarket.schemas.book`, `nautilus_trader.cache.cache`, `nautilus_trader.common.component`, `nautilus_trader.model.book`, `nautilus_trader.model.currencies`, `nautilus_trader.model.data`, `nautilus_trader.model.enums`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.instruments`, `nautilus_trader.model.objects`, `typing`, `unittest.mock`
...
```bash
# For Python
pytest tests/integration_tests/adapters/polymarket/test_data_client.py
...
---
*Generated on 2025-11-18T21:55:07.164704Z*
