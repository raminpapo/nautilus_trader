...
### Classes
- **`TestPolymarketExecutionClient`**: Class defined in this file
...
**Classs**: `TestPolymarketExecutionClient`
**Imports**: `asyncio`, `msgspec`, `nautilus_trader.adapters.polymarket.common.cache`, `nautilus_trader.adapters.polymarket.common.constants`, `nautilus_trader.adapters.polymarket.common.credentials`, `nautilus_trader.adapters.polymarket.common.enums`, `nautilus_trader.adapters.polymarket.common.symbol`, `nautilus_trader.adapters.polymarket.config`, `nautilus_trader.adapters.polymarket.execution`, `nautilus_trader.adapters.polymarket.http.conversion`, `nautilus_trader.adapters.polymarket.providers`, `nautilus_trader.common.component`, `nautilus_trader.core.uuid`, `nautilus_trader.data.engine`, `nautilus_trader.execution.engine`, `nautilus_trader.execution.messages`, `nautilus_trader.model.currencies`, `nautilus_trader.model.enums`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.instruments`, `nautilus_trader.model.objects`, `nautilus_trader.portfolio.portfolio`, `nautilus_trader.risk.engine`, `nautilus_trader.test_kit.providers`, `nautilus_trader.test_kit.stubs.component`, `nautilus_trader.test_kit.stubs.identifiers`, `nautilus_trader.trading.strategy`, `pkgutil`, `py_clob_client.client`, `pytest` *(+1 more)*
...
```bash
# For Python
pytest tests/integration_tests/adapters/polymarket/test_execution.py
...
---
*Generated on 2025-11-18T21:55:07.173372Z*
