# Documentation: `tests/integration_tests/adapters/polymarket/test_execution.py`
**Generated:** 2025-11-15T19:40:07.942435Z
**File Size:** 49654 bytes
**Extension:** .py
**Type:** text
...
- **Path:** `tests/integration_tests/adapters/polymarket/test_execution.py`
- **Size:** 49,654 bytes
- **Lines:** 1,291
- **Extension:** `.py`
- **Type:** text
...
This file is located at `tests/integration_tests/adapters/polymarket/test_execution.py` within the repository.

**Classes defined:** TestPolymarketExecutionClient

**Functions defined:** setup, _setup_test_order_with_venue_id, test_handle_ws_order_placement_message, test_handle_ws_order_cancellation_message, test_handle_ws_trade_message_maker_flow, test_handle_ws_trade_message_taker_flow, test_order_filled_by_polymarket_order_book_balancing_system, test_multiple_user_order_fills_in_same_trade_message_correctly_identified, test_parse_trades_response_handles_multiple_user_fills, test_handle_ws_message_invalid_json and 5 more
...
#### `test_handle_ws_order_placement_message(self)`


#### `test_handle_ws_order_cancellation_message(self)`


#### `test_handle_ws_trade_message_maker_flow(self)`


#### `test_handle_ws_trade_message_taker_flow(self)`


#### `test_order_filled_by_polymarket_order_book_balancing_system(self)`


#### `test_multiple_user_order_fills_in_same_trade_message_correctly_identified(self)`


#### `test_parse_trades_response_handles_multiple_user_fills(self)`


#### `test_handle_ws_message_invalid_json(self)`


#### `test_handle_ws_message_decode_failure(self)`


#### `test_handle_ws_message_with_logging_enabled(self)`


#### `test_add_trade_to_cache(self)`


#### `test_handle_unknown_instrument_gracefully(self)`


#### `test_order_branching_logic(self)`
...
```python
from tests.integration_tests.adapters.polymarket.test_execution import TestPolymarketExecutionClient
```
...
**Security:** This file may contain sensitive patterns: token, api_key, credential, auth. Ensure proper handling of secrets.
