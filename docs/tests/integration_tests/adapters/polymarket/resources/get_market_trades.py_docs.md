# Documentation: get_market_trades.py
...
```bash
# For Python
pytest tests/integration_tests/adapters/polymarket/resources/get_market_trades.py
...
---
*Generated on 2025-11-18T21:55:07.090817Z*
