# Documentation: user_trade1.json
...
**Identifiers**: `BUY`, `MAKER`, `MINED`, `TRADE`, `Yes`
...
```bash
# For Python
pytest tests/integration_tests/adapters/polymarket/resources/ws_messages/user_trade1.json
...
---
*Generated on 2025-11-18T21:55:07.148566Z*
