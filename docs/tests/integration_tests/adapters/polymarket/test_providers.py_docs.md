# Documentation: `tests/integration_tests/adapters/polymarket/test_providers.py`
**Generated:** 2025-11-15T19:40:07.951569Z
...
- **Path:** `tests/integration_tests/adapters/polymarket/test_providers.py`
- **Size:** 14,216 bytes
- **Lines:** 417
- **Extension:** `.py`
- **Type:** text
...
This file is located at `tests/integration_tests/adapters/polymarket/test_providers.py` within the repository.

**Functions defined:** mock_clob_client, live_clock, instrument_provider
...
#### `instrument_provider(mock_clob_client, live_clock)`
...
```python
from tests.integration_tests.adapters.polymarket.test_providers import mock_clob_client
```
