...
### Functions
- **`mock_clob_client()`**: Function defined in this file
...
**Functions**: `instrument_provider`, `live_clock`, `mock_clob_client`
**Imports**: `nautilus_trader.adapters.polymarket.providers`, `nautilus_trader.common.component`, `nautilus_trader.config`, `nautilus_trader.model.identifiers`, `pytest`, `unittest.mock`
...
```bash
# For Python
pytest tests/integration_tests/adapters/polymarket/test_providers.py
...
---
*Generated on 2025-11-18T21:55:07.184940Z*
