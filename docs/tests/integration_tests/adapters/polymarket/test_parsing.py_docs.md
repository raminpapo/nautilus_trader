...
- **Path**: `tests/integration_tests/adapters/polymarket/test_parsing.py`
- **Size**: 21,583 bytes
- **Lines**: 584
- **Language**: Python
...
### Functions
- **`test_parse_instruments()`**: Function defined in this file
- **`test_parse_order_book_snapshots()`**: Function defined in this file
- **`test_parse_order_book_deltas()`**: Function defined in this file
- **`test_parse_quote_ticks()`**: Function defined in this file
- **`test_parse_trade_tick()`**: Function defined in this file
- **`test_parse_order_placement()`**: Function defined in this file
- **`test_parse_order_cancel()`**: Function defined in this file
- **`test_parse_user_trade()`**: Function defined in this file
- **`test_parse_user_trade_to_dict()`**: Function defined in this file
- **`test_parse_tick_size_change()`**: Function defined in this file
- **`test_parse_book_snapshot_to_quote_empty_bids()`**: Function defined in this file
- **`test_parse_book_snapshot_to_quote_empty_asks()`**: Function defined in this file
- **`test_parse_book_snapshot_to_quote_both_empty()`**: Function defined in this file
- **`test_parse_empty_book_snapshot_returns_none()`**: Function defined in this file
- **`test_parse_empty_book_snapshot_in_backtest_engine()`**: Function defined in this file
...
**Functions**: `test_parse_book_snapshot_to_quote_both_empty`, `test_parse_book_snapshot_to_quote_empty_asks`, `test_parse_book_snapshot_to_quote_empty_bids`, `test_parse_empty_book_snapshot_in_backtest_engine`, `test_parse_empty_book_snapshot_returns_none`, `test_parse_instruments`, `test_parse_order_book_deltas`, `test_parse_order_book_snapshots`, `test_parse_order_cancel`, `test_parse_order_placement`, `test_parse_quote_ticks`, `test_parse_tick_size_change`, `test_parse_trade_tick`, `test_parse_user_trade`, `test_parse_user_trade_to_dict`
**Imports**: `msgspec`, `nautilus_trader.adapters.polymarket.common.constants`, `nautilus_trader.adapters.polymarket.common.parsing`, `nautilus_trader.adapters.polymarket.schemas.book`, `nautilus_trader.adapters.polymarket.schemas.user`, `nautilus_trader.backtest.engine`, `nautilus_trader.config`, `nautilus_trader.model.currencies`, `nautilus_trader.model.data`, `nautilus_trader.model.enums`, `nautilus_trader.model.instruments`, `nautilus_trader.model.objects`, `nautilus_trader.test_kit.providers`, `pkgutil`, `pytest`
...
```bash
# For Python
pytest tests/integration_tests/adapters/polymarket/test_parsing.py
...
---
*Generated on 2025-11-18T21:55:07.181627Z*
