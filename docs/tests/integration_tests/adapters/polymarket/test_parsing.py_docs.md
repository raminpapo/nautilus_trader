# Documentation: `tests/integration_tests/adapters/polymarket/test_parsing.py`
**Generated:** 2025-11-15T19:40:07.949041Z
**File Size:** 21583 bytes
**Extension:** .py
**Type:** text
...
This file is located at `tests/integration_tests/adapters/polymarket/test_parsing.py` within the repository.

**Functions defined:** test_parse_instruments, test_parse_order_book_snapshots, test_parse_order_book_deltas, test_parse_quote_ticks, test_parse_trade_tick, test_parse_order_placement, test_parse_order_cancel, test_parse_user_trade, test_parse_user_trade_to_dict, test_parse_tick_size_change and 5 more
...
#### `test_parse_user_trade(data_file: str)`
...
```python
from tests.integration_tests.adapters.polymarket.test_parsing import test_parse_instruments
```
