# Documentation: `tests/integration_tests/adapters/bitmex/conftest.py`
**Generated:** 2025-11-15T19:40:07.712024Z
...
This file is located at `tests/integration_tests/adapters/bitmex/conftest.py` within the repository.

**Functions defined:** venue, account_id, instrument, account_state, mock_http_client, mock_ws_client, mock_submitter, mock_canceller, mock_instrument_provider, exec_client and 2 more
...
```python
from tests.integration_tests.adapters.bitmex.conftest import venue
```
