# Documentation: `tests/integration_tests/adapters/bitmex/test_execution.py`
**Generated:** 2025-11-15T19:40:07.716357Z
**File Size:** 26591 bytes
**Extension:** .py
**Type:** text
...
This file is located at `tests/integration_tests/adapters/bitmex/test_execution.py` within the repository.
...
```python
import tests.integration_tests.adapters.bitmex.test_execution
```
