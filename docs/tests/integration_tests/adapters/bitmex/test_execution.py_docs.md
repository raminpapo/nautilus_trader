...
- **Path**: `tests/integration_tests/adapters/bitmex/test_execution.py`
- **Size**: 26,591 bytes
- **Lines**: 847
- **Language**: Python
...
**Imports**: `nautilus_trader.core`, `nautilus_trader.execution.messages`, `nautilus_trader.model.enums`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.objects`, `nautilus_trader.model.orders`, `nautilus_trader.test_kit.stubs.identifiers`, `pytest`, `unittest.mock`
...
```bash
# For Python
pytest tests/integration_tests/adapters/bitmex/test_execution.py
...
---
*Generated on 2025-11-18T21:55:06.787466Z*
