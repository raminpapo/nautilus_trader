# Documentation: `tests/integration_tests/adapters/bitmex/test_data.py`
**Generated:** 2025-11-15T19:40:07.713653Z
**File Size:** 5431 bytes
**Extension:** .py
**Type:** text
...
This file is located at `tests/integration_tests/adapters/bitmex/test_data.py` within the repository.

**Functions defined:** bitmex_data_client
...
```python
from tests.integration_tests.adapters.bitmex.test_data import bitmex_data_client
```
