...
- **Path**: `tests/integration_tests/adapters/bitmex/test_data.py`
- **Size**: 5,429 bytes
- **Lines**: 176
- **Language**: Python
...
### Functions
- **`bitmex_data_client()`**: Function defined in this file
...
**Functions**: `bitmex_data_client`
**Imports**: `nautilus_trader.adapters.bitmex.config`, `nautilus_trader.adapters.bitmex.constants`, `nautilus_trader.adapters.bitmex.data`, `nautilus_trader.model.enums`, `nautilus_trader.model.identifiers`, `pytest`, `types`
...
```bash
# For Python
pytest tests/integration_tests/adapters/bitmex/test_data.py
...
---
*Generated on 2025-11-18T21:55:06.783740Z*
