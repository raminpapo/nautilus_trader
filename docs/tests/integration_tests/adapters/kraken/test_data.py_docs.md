...
**Imports**: `nautilus_trader.adapters.kraken.config`, `nautilus_trader.adapters.kraken.constants`, `nautilus_trader.adapters.kraken.data`, `nautilus_trader.model.enums`, `nautilus_trader.model.identifiers`, `nautilus_trader.test_kit.stubs.identifiers`, `pytest`, `tests.integration_tests.adapters.kraken.conftest`, `types`, `unittest.mock`
...
```bash
# For Python
pytest tests/integration_tests/adapters/kraken/test_data.py
...
---
*Generated on 2025-11-18T21:55:07.044022Z*
