...
**Imports**: `nautilus_trader.adapters.kraken.providers`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.objects`, `pytest`, `unittest.mock`
...
```bash
# For Python
pytest tests/integration_tests/adapters/kraken/test_providers.py
...
---
*Generated on 2025-11-18T21:55:07.046102Z*
