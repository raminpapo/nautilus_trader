# Documentation: `tests/integration_tests/adapters/databento/test_loaders.py`
**Generated:** 2025-11-15T19:40:07.746305Z
...
This file is located at `tests/integration_tests/adapters/databento/test_loaders.py` within the repository.

**Functions defined:** test_get_publishers, test_loader_definition_glbx_futures, test_loader_definition_xcme_futures, test_loader_definition_glbx_options, test_loader_definition_opra_pillar, test_loader_xnasitch_definition, test_loader_mbo, test_loader_mbo_pyo3, test_loader_mbp_1, test_loader_mbp_1_pyo3 and 29 more
...
```python
from tests.integration_tests.adapters.databento.test_loaders import test_get_publishers
```
