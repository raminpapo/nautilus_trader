...
**Functions**: `account_state`, `data_client`, `exec_client`, `get_test_data_path`, `instrument`, `instrument_provider`
**Imports**: `nautilus_trader`, `pathlib`, `pytest`
...
```bash
# For Python
pytest tests/integration_tests/adapters/tardis/conftest.py
...
---
*Generated on 2025-11-18T21:55:07.197150Z*
