# Documentation: `tests/integration_tests/adapters/tardis/sandbox/instrument_provider.py`
**Generated:** 2025-11-15T19:40:07.970939Z
**File Size:** 4041 bytes
**Extension:** .py
**Type:** text
...
This file is located at `tests/integration_tests/adapters/tardis/sandbox/instrument_provider.py` within the repository.
...
```python
import tests.integration_tests.adapters.tardis.sandbox.instrument_provider
```
