# Documentation: run_streaming.py

## File Metadata

- **Path**: `tests/integration_tests/adapters/tardis/sandbox/run_streaming.py`
- **Size**: 5,751 bytes
- **Lines**: 163
- **Language**: Python
...
### Functions
- **`download_tardis_csv()`**: Function defined in this file
- **`run()`**: Function defined in this file

### Classes
- **`OrderBookActor`**: Class defined in this file
...
**Classs**: `OrderBookActor`
**Functions**: `download_tardis_csv`, `run`
**Imports**: `nautilus_trader.adapters.tardis.loaders`, `nautilus_trader.backtest.engine`, `nautilus_trader.common.actor`, `nautilus_trader.common.component`, `nautilus_trader.common.enums`, `nautilus_trader.core`, `nautilus_trader.core.nautilus_pyo3.network`, `nautilus_trader.model.currencies`, `nautilus_trader.model.enums`, `nautilus_trader.model.instruments`, `nautilus_trader.model.objects`, `nautilus_trader.test_kit.providers`, `os`, `pathlib`
...
```bash
# For Python
pytest tests/integration_tests/adapters/tardis/sandbox/run_streaming.py
...
---
*Generated on 2025-11-18T21:55:07.211946Z*
