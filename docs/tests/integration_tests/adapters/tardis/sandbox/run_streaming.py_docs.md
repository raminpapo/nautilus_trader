# Documentation: `tests/integration_tests/adapters/tardis/sandbox/run_streaming.py`
**Generated:** 2025-11-15T19:40:07.976759Z
**File Size:** 5751 bytes
**Extension:** .py
**Type:** text
...
This file is located at `tests/integration_tests/adapters/tardis/sandbox/run_streaming.py` within the repository.

**Classes defined:** OrderBookActor

**Functions defined:** __init__, on_start, on_order_book_deltas, on_stop, download_tardis_csv, run
...
#### `__init__(self, instrument: Instrument)`


#### `on_start(self)`


#### `on_order_book_deltas(self, order_book_deltas: nautilus_pyo3.OrderBookDeltas)`


#### `on_stop(self)`


#### `download_tardis_csv(api_key: str, data_dir: Path)`
...
```python
from tests.integration_tests.adapters.tardis.sandbox.run_streaming import OrderBookActor
```
