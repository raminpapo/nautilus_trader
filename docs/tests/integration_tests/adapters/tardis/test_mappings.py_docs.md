# Documentation: `tests/integration_tests/adapters/tardis/test_mappings.py`
**Generated:** 2025-11-15T19:40:07.989184Z
**File Size:** 8746 bytes
**Extension:** .py
**Type:** text
...
This file is located at `tests/integration_tests/adapters/tardis/test_mappings.py` within the repository.

**Functions defined:** test_all_tardis_exchanges_map_to_valid_venues, test_venue_exchange_bidirectional_mapping, test_exchange_to_venue_individual, test_exchange_strings_are_lowercase_kebab_case, test_venue_strings_are_uppercase_snake_case, test_no_empty_exchange_or_venue_mappings, test_exchange_inference_from_csv_data, test_comprehensive_exchange_venue_coverage, test_symbol_venue_consistency_with_stub_data, test_invalid_exchange_names and 1 more
...
#### `test_exchange_to_venue_individual(exchange)`
...
```python
from tests.integration_tests.adapters.tardis.test_mappings import test_all_tardis_exchanges_map_to_valid_venues
```
