...
- **Path**: `tests/integration_tests/adapters/tardis/test_loaders.py`
- **Size**: 69,860 bytes
- **Lines**: 1,829
- **Language**: Python
...
### Functions
- **`test_csv_loader_with_malformed_data()`**: Function defined in this file
- **`test_tardis_load_deltas()`**: Function defined in this file
- **`test_tardis_load_depth10_from_snapshot5()`**: Function defined in this file
- **`test_tardis_load_depth10_from_snapshot25()`**: Function defined in this file
- **`test_tardis_load_quotes()`**: Function defined in this file
- **`test_tardis_load_trades()`**: Function defined in this file
- **`test_dynamic_precision_inference_optimization()`**: Function defined in this file
- **`test_tardis_stream_deltas()`**: Function defined in this file
- **`test_tardis_stream_deltas_memory_efficient()`**: Function defined in this file
- **`test_tardis_stream_quotes()`**: Function defined in this file
- **`test_tardis_stream_trades()`**: Function defined in this file
- **`test_tardis_stream_depth10_snapshot5()`**: Function defined in this file
- **`_generate_quotes_csv()`**: Function defined in this file
- **`_generate_trades_csv()`**: Function defined in this file
- **`_generate_deltas_csv()`**: Function defined in this file
- **`_generate_depth10_snapshot5_csv()`**: Function defined in this file
- **`_generate_depth10_snapshot25_csv()`**: Function defined in this file
- **`_test_memory_efficiency_for_type()`**: Function defined in this file
- **`test_tardis_stream_memory_efficiency_all_types()`**: Function defined in this file
- **`test_tardis_load_trades_from_stub_data()`**: Function defined in this file
...
**Functions**: `_generate_deltas_csv`, `_generate_depth10_snapshot25_csv`, `_generate_depth10_snapshot5_csv`, `_generate_quotes_csv`, `_generate_trades_csv`, `_test_memory_efficiency_for_type`, `test_csv_loader_with_malformed_data`, `test_deltas_specific_price_size_values_from_stub_data`, `test_dynamic_precision_inference_optimization`, `test_inferred_price_and_size_precision_from_stub_data`, `test_precision_inference_funding_rates`, `test_precision_inference_with_minimal_data`, `test_price_and_size_precision_from_stub_data`, `test_tardis_load_deltas`, `test_tardis_load_deltas_from_stub_data`, `test_tardis_load_deltas_with_limit`, `test_tardis_load_depth10_from_snapshot25`, `test_tardis_load_depth10_from_snapshot5`, `test_tardis_load_depth10_with_limit`, `test_tardis_load_funding_rates_from_stub_data`, `test_tardis_load_funding_rates_with_limit`, `test_tardis_load_funding_rates_with_precision`, `test_tardis_load_quotes`, `test_tardis_load_quotes_with_limit`, `test_tardis_load_trades`, `test_tardis_load_trades_from_stub_data`, `test_tardis_load_trades_with_limit`, `test_tardis_stream_batched_deltas_with_limit`, `test_tardis_stream_deltas`, `test_tardis_stream_deltas_from_stub_data` *(+13 more)*
**Imports**: `decimal`, `nautilus_trader.adapters.tardis.loaders`, `nautilus_trader.model.data`, `nautilus_trader.model.enums`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.objects`, `nautilus_trader.test_kit.providers`, `os`, `psutil`, `pytest`, `sys`, `tempfile`, `tests.integration_tests.adapters.tardis.conftest`, `time`
...
```bash
# For Python
pytest tests/integration_tests/adapters/tardis/test_loaders.py
...
---
*Generated on 2025-11-18T21:55:07.225686Z*
