# Documentation: `tests/integration_tests/adapters/tardis/test_loaders.py`
**Generated:** 2025-11-15T19:40:07.986689Z
**File Size:** 69860 bytes
**Extension:** .py
**Type:** text
...
This file is located at `tests/integration_tests/adapters/tardis/test_loaders.py` within the repository.

**Functions defined:** test_csv_loader_with_malformed_data, test_tardis_load_deltas, test_tardis_load_depth10_from_snapshot5, test_tardis_load_depth10_from_snapshot25, test_tardis_load_quotes, test_tardis_load_trades, test_dynamic_precision_inference_optimization, test_tardis_stream_deltas, test_tardis_stream_deltas_memory_efficient, test_tardis_stream_quotes and 33 more
...
#### `_generate_quotes_csv(num_records)`


#### `_generate_trades_csv(num_records)`


#### `_generate_deltas_csv(num_records)`


#### `_generate_depth10_snapshot5_csv(num_records)`


#### `_generate_depth10_snapshot25_csv(num_records)`
...
```python
from tests.integration_tests.adapters.tardis.test_loaders import test_csv_loader_with_malformed_data
```
