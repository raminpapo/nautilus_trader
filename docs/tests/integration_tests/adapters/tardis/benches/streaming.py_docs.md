# Documentation: `tests/integration_tests/adapters/tardis/benches/streaming.py`
**Generated:** 2025-11-15T19:40:07.961377Z
...
This file is located at `tests/integration_tests/adapters/tardis/benches/streaming.py` within the repository.

**Functions defined:** fetch_instruments, bench_data_streaming_iterators
...
```python
from tests.integration_tests.adapters.tardis.benches.streaming import fetch_instruments
```
...
**Directory:** `tests/integration_tests/adapters/tardis/benches`
