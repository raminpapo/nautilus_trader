# Documentation: `tests/integration_tests/adapters/bybit/test_data.py`
**Generated:** 2025-11-15T19:40:07.722897Z
...
This file is located at `tests/integration_tests/adapters/bybit/test_data.py` within the repository.
...
```python
from tests.integration_tests.adapters.bybit.test_data import data_client_builder
```
