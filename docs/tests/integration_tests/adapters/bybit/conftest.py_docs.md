# Documentation: `tests/integration_tests/adapters/bybit/conftest.py`
**Generated:** 2025-11-15T19:40:07.721028Z
...
This file is located at `tests/integration_tests/adapters/bybit/conftest.py` within the repository.

**Functions defined:** live_clock, live_logger, venue, account_id, instrument, account_state, mock_http_client, _create_ws_mock, mock_ws_clients, mock_instrument_provider and 6 more
...
#### `create_bybit_spot_instrument(base_currency, quote_currency)`
...
```python
from tests.integration_tests.adapters.bybit.conftest import live_clock
```
