# Documentation: `tests/integration_tests/adapters/bybit/test_execution.py`
**Generated:** 2025-11-15T19:40:07.726205Z
**File Size:** 36557 bytes
**Extension:** .py
**Type:** text
...
This file is located at `tests/integration_tests/adapters/bybit/test_execution.py` within the repository.

**Functions defined:** exec_client_builder, builder
...
```python
from tests.integration_tests.adapters.bybit.test_execution import exec_client_builder
```
