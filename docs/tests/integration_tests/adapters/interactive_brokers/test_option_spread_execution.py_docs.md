# Documentation: test_option_spread_execution.py
...
### Classes
- **`MockIBExecution`**: Class defined in this file
- **`MockIBCommissionReport`**: Class defined in this file
- **`MockIBContract`**: Class defined in this file
- **`TestOptionSpreadExecution`**: Class defined in this file
...
**Classs**: `MockIBCommissionReport`, `MockIBContract`, `MockIBExecution`, `TestOptionSpreadExecution`
**Imports**: `decimal`, `nautilus_trader.cache.cache`, `nautilus_trader.common.component`, `nautilus_trader.core.uuid`, `nautilus_trader.execution.engine`, `nautilus_trader.model.currencies`, `nautilus_trader.model.enums`, `nautilus_trader.model.events.order`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.objects`, `nautilus_trader.model.orders`, `nautilus_trader.portfolio.portfolio`, `nautilus_trader.test_kit.mocks.cache_database`, `nautilus_trader.test_kit.stubs.events`, `nautilus_trader.test_kit.stubs.identifiers`
...
```bash
# For Python
pytest tests/integration_tests/adapters/interactive_brokers/test_option_spread_execution.py
...
---
*Generated on 2025-11-18T21:55:07.030682Z*
