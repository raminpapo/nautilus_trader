# Documentation: `tests/integration_tests/adapters/interactive_brokers/test_option_spread_execution.py`
**Generated:** 2025-11-15T19:40:07.848908Z
**File Size:** 16540 bytes
**Extension:** .py
**Type:** text
...
- **Path:** `tests/integration_tests/adapters/interactive_brokers/test_option_spread_execution.py`
- **Size:** 16,540 bytes
- **Lines:** 419
- **Extension:** `.py`
- **Type:** text
...
This file is located at `tests/integration_tests/adapters/interactive_brokers/test_option_spread_execution.py` within the repository.

**Classes defined:** MockIBExecution, MockIBCommissionReport, MockIBContract, TestOptionSpreadExecution

**Functions defined:** __init__, __init__, __init__, setup_method, test_spread_execution_generates_combo_and_leg_fills, test_leg_fill_generation_with_correct_quantities, test_leg_fills_create_positions_in_execution_engine, test_no_spread_positions_in_portfolio
...
#### `__init__(self, order_id, shares, price, side="BOT")`


#### `__init__(self, commission=1.0, currency="USD")`


#### `__init__(self, con_id, symbol, sec_type="FOP", exchange="CME")`


#### `setup_method(self)`


#### `test_spread_execution_generates_combo_and_leg_fills(self)`


#### `test_leg_fill_generation_with_correct_quantities(self)`


#### `test_leg_fills_create_positions_in_execution_engine(self)`


#### `test_no_spread_positions_in_portfolio(self)`
...
```python
from tests.integration_tests.adapters.interactive_brokers.test_option_spread_execution import MockIBExecution
```
