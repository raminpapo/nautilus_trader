# Documentation: `tests/integration_tests/adapters/interactive_brokers/test_instrument_parsing_spreads.py`
**Generated:** 2025-11-15T19:40:07.842818Z
...
- **Path:** `tests/integration_tests/adapters/interactive_brokers/test_instrument_parsing_spreads.py`
- **Size:** 11,680 bytes
- **Lines:** 300
- **Extension:** `.py`
- **Type:** text
...
This file is located at `tests/integration_tests/adapters/interactive_brokers/test_instrument_parsing_spreads.py` within the repository.

**Classes defined:** TestSpreadInstrumentParsing, TestOptionSpreadParsing

**Functions defined:** test_parse_spread_instrument_id_basic_spread, test_parse_spread_instrument_id_ratio_spread, test_parse_spread_instrument_id_butterfly, test_parse_spread_instrument_id_iron_condor, test_parse_spread_instrument_id_invalid, test_parse_option_spread_basic, test_parse_option_spread_iron_condor, test_parse_option_spread_butterfly, _create_bag_contract_details, test_spread_instrument_parsing_integration
...
#### `test_parse_spread_instrument_id_basic_spread(self)`


#### `test_parse_spread_instrument_id_ratio_spread(self)`


#### `test_parse_spread_instrument_id_butterfly(self)`


#### `test_parse_spread_instrument_id_iron_condor(self)`


#### `test_parse_spread_instrument_id_invalid(self)`


#### `test_parse_option_spread_basic(self)`


#### `test_parse_option_spread_iron_condor(self)`


#### `test_parse_option_spread_butterfly(self)`
...
```python
from tests.integration_tests.adapters.interactive_brokers.test_instrument_parsing_spreads import TestSpreadInstrumentParsing
```
