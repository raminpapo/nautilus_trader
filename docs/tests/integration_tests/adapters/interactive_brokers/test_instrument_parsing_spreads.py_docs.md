# Documentation: test_instrument_parsing_spreads.py
...
### Functions
- **`test_spread_instrument_parsing_integration()`**: Function defined in this file

### Classes
- **`TestSpreadInstrumentParsing`**: Class defined in this file
- **`TestOptionSpreadParsing`**: Class defined in this file
...
**Classs**: `TestOptionSpreadParsing`, `TestSpreadInstrumentParsing`
**Functions**: `test_spread_instrument_parsing_integration`
**Imports**: `nautilus_trader.adapters.interactive_brokers.common`, `nautilus_trader.adapters.interactive_brokers.parsing.instruments`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.instruments`, `nautilus_trader.model.objects`, `pytest`
...
```bash
# For Python
pytest tests/integration_tests/adapters/interactive_brokers/test_instrument_parsing_spreads.py
...
---
*Generated on 2025-11-18T21:55:07.024406Z*
