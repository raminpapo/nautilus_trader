# Documentation: `tests/integration_tests/adapters/interactive_brokers/test_execution.py`
**Generated:** 2025-11-15T19:40:07.834198Z
**File Size:** 20035 bytes
**Extension:** .py
**Type:** text
...
This file is located at `tests/integration_tests/adapters/interactive_brokers/test_execution.py` within the repository.

**Functions defined:** contract_details, contract, instrument_setup, order_setup, account_summary_setup, on_open_order_setup, on_cancel_order_setup
...
#### `instrument_setup(exec_client, cache, instrument=None, contract_details=None)`
...
#### `account_summary_setup(client, **kwargs)`


#### `on_open_order_setup(client, status, order_id, contract, order)`


#### `on_cancel_order_setup(client, status, order_id, manual_cancel_order_time)`
...
```python
from tests.integration_tests.adapters.interactive_brokers.test_execution import contract_details
```
