...
- **Path**: `tests/integration_tests/adapters/interactive_brokers/test_execution.py`
- **Size**: 19,995 bytes
- **Lines**: 675
- **Language**: Python
...
### Functions
- **`contract_details()`**: Function defined in this file
- **`contract()`**: Function defined in this file
- **`instrument_setup()`**: Function defined in this file
- **`order_setup()`**: Function defined in this file
- **`account_summary_setup()`**: Function defined in this file
- **`on_open_order_setup()`**: Function defined in this file
- **`on_cancel_order_setup()`**: Function defined in this file
...
**Functions**: `account_summary_setup`, `contract`, `contract_details`, `instrument_setup`, `on_cancel_order_setup`, `on_open_order_setup`, `order_setup`
**Imports**: `asyncio`, `decimal`, `functools`, `ibapi.order_state`, `nautilus_trader.adapters.interactive_brokers.common`, `nautilus_trader.adapters.interactive_brokers.factories`, `nautilus_trader.adapters.interactive_brokers.parsing.instruments`, `nautilus_trader.model.enums`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.objects`, `nautilus_trader.test_kit.stubs.commands`, `nautilus_trader.test_kit.stubs.execution`, `nautilus_trader.test_kit.stubs.identifiers`, `pytest`, `tests.integration_tests.adapters.interactive_brokers.test_kit`
...
```bash
# For Python
pytest tests/integration_tests/adapters/interactive_brokers/test_execution.py
...
---
*Generated on 2025-11-18T21:55:07.014462Z*
