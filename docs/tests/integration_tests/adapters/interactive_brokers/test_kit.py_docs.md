# Documentation: `tests/integration_tests/adapters/interactive_brokers/test_kit.py`
**Generated:** 2025-11-15T19:40:07.846059Z
**File Size:** 30300 bytes
**Extension:** .py
**Type:** text
...
- **Path:** `tests/integration_tests/adapters/interactive_brokers/test_kit.py`
- **Size:** 30,300 bytes
- **Lines:** 790
- **Extension:** `.py`
- **Type:** text
...
This file is located at `tests/integration_tests/adapters/interactive_brokers/test_kit.py` within the repository.

**Classes defined:** IBTestIncomingMessages, IBTestContractStubs, IBTestDataStubs, IBTestExecStubs

**Functions defined:** set_attributes, get_msg, create_contract, convert_contract_to_ib_contract, create_contract_details, convert_contract_details_to_ib_contract_details, create_instrument, aapl_equity_contract, aapl_equity_ib_contract, aapl_equity_contract_details and 20 more
...
#### `set_attributes(obj, params: dict)`


#### `get_msg(msg_type: str)`
...
#### `convert_contract_to_ib_contract(contract: Contract)`
...
#### `convert_contract_details_to_ib_contract_details(
        contract_details: ContractDetails,
    )`


#### `create_instrument(contract_details: ContractDetails)`


#### `aapl_equity_contract()`


#### `aapl_equity_ib_contract()`


#### `aapl_equity_contract_details()`


#### `aapl_equity_ib_contract_details()`


#### `cl_future_contract()`


#### `cl_future_contract_details()`


#### `es_future_option_contract()`


#### `es_future_option_contract_details(cls)`


#### `eurusd_forex_contract()`


#### `eurusd_forex_contract_details()`


#### `tsla_option_contract()`


#### `tsla_option_contract_details()`
...
#### `account_values(fn: str = "account_values.json")`


#### `market_depth(name: str = "eurusd")`


#### `tickers(name: str = "eurusd")`
...
#### `ib_order_state(state: str = "PreSubmitted")`
