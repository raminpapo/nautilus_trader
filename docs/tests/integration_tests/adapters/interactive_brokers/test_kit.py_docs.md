...
This file is part of the NautilusTrader repository. It defines 2 function(s) and 4 class(es).

## Detailed Walkthrough

### Functions
- **`set_attributes()`**: Function defined in this file
- **`filter_out_options()`**: Function defined in this file

### Classes
- **`IBTestIncomingMessages`**: Class defined in this file
- **`IBTestContractStubs`**: Class defined in this file
- **`IBTestDataStubs`**: Class defined in this file
- **`IBTestExecStubs`**: Class defined in this file
...
**Classs**: `IBTestContractStubs`, `IBTestDataStubs`, `IBTestExecStubs`, `IBTestIncomingMessages`
**Functions**: `filter_out_options`, `set_attributes`
**Imports**: `datetime`, `decimal`, `gzip`, `ibapi.commission_report`, `ibapi.common`, `ibapi.contract`, `ibapi.execution`, `ibapi.order`, `ibapi.order_state`, `ibapi.softdollartier`, `ibapi.tag_value`, `msgspec`, `nautilus_trader.adapters.interactive_brokers.common`, `nautilus_trader.adapters.interactive_brokers.parsing.instruments`, `nautilus_trader.model.instruments`, `pandas`, `pickle`, `pytz`, `tests`
...
```bash
# For Python
pytest tests/integration_tests/adapters/interactive_brokers/test_kit.py
...
---
*Generated on 2025-11-18T21:55:07.028063Z*
