# Documentation: `tests/integration_tests/adapters/interactive_brokers/test_execution_reconciliation.py`
**Generated:** 2025-11-15T19:40:07.839513Z
...
This file is located at `tests/integration_tests/adapters/interactive_brokers/test_execution_reconciliation.py` within the repository.
...
```python
from tests.integration_tests.adapters.interactive_brokers.test_execution_reconciliation import instrument_setup
```
