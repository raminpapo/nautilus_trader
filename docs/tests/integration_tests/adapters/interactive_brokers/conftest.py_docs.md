# Documentation: `tests/integration_tests/adapters/interactive_brokers/conftest.py`
**Generated:** 2025-11-15T19:40:07.789590Z
...
This file is located at `tests/integration_tests/adapters/interactive_brokers/conftest.py` within the repository.

**Functions defined:** pytest_ignore_collect, mocked_ib_client, venue, instrument, gateway_config, data_client_config, exec_client_config, ib_client, ib_client_running, instrument_provider and 3 more
...
#### `ib_client(data_client_config, event_loop, msgbus, cache, clock)`


#### `ib_client_running(ib_client)`


#### `instrument_provider(ib_client)`


#### `data_client(data_client_config, venue, event_loop, msgbus, cache, clock)`


#### `exec_client(exec_client_config, venue, event_loop, msgbus, cache, clock)`


#### `account_state(venue: Venue)`
...
```python
from tests.integration_tests.adapters.interactive_brokers.conftest import pytest_ignore_collect
```
