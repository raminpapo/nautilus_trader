# Documentation: test_execution_order_transform.py

## File Metadata

- **Path**: `tests/integration_tests/adapters/interactive_brokers/test_execution_order_transform.py`
- **Size**: 31,160 bytes
- **Lines**: 950
- **Language**: Python
...
**Imports**: `nautilus_trader.adapters.interactive_brokers.common`, `nautilus_trader.core.uuid`, `nautilus_trader.model.enums`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.orders.limit`, `nautilus_trader.model.orders.stop_market`, `nautilus_trader.test_kit.stubs.data`, `nautilus_trader.test_kit.stubs.execution`, `nautilus_trader.test_kit.stubs.identifiers`, `pytest`
...
```bash
# For Python
pytest tests/integration_tests/adapters/interactive_brokers/test_execution_order_transform.py
...
---
*Generated on 2025-11-18T21:55:07.018436Z*
