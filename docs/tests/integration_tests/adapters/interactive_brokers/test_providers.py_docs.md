# Documentation: `tests/integration_tests/adapters/interactive_brokers/test_providers.py`
**Generated:** 2025-11-15T19:40:07.853394Z
...
- **Path:** `tests/integration_tests/adapters/interactive_brokers/test_providers.py`
- **Size:** 7,969 bytes
- **Lines:** 229
- **Extension:** `.py`
- **Type:** text
...
This file is located at `tests/integration_tests/adapters/interactive_brokers/test_providers.py` within the repository.

**Functions defined:** mock_ib_contract_calls
...
#### `mock_ib_contract_calls(mocker, instrument_provider, contract_details: ContractDetails)`
...
```python
from tests.integration_tests.adapters.interactive_brokers.test_providers import mock_ib_contract_calls
```
