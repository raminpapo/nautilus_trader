...
### Functions
- **`mock_ib_contract_calls()`**: Function defined in this file
...
**Functions**: `mock_ib_contract_calls`
**Imports**: `ibapi.contract`, `nautilus_trader.adapters.interactive_brokers.common`, `nautilus_trader.model.enums`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.objects`, `pytest`, `tests.integration_tests.adapters.interactive_brokers.test_kit`, `unittest.mock`
...
```bash
# For Python
pytest tests/integration_tests/adapters/interactive_brokers/test_providers.py
...
---
*Generated on 2025-11-18T21:55:07.035919Z*
