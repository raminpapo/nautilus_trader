# Documentation: test_spread_execution.py
...
### Classes
- **`TestSpreadExecutionDetection`**: Class defined in this file
- **`TestSpreadLegExtraction`**: Class defined in this file
- **`TestSpreadFillCreation`**: Class defined in this file
- **`TestSpreadFillTracking`**: Class defined in this file
- **`TestSpreadExecutionIntegration`**: Class defined in this file
...
**Classs**: `TestSpreadExecutionDetection`, `TestSpreadExecutionIntegration`, `TestSpreadFillCreation`, `TestSpreadFillTracking`, `TestSpreadLegExtraction`
**Imports**: `nautilus_trader.adapters.interactive_brokers.execution`, `nautilus_trader.core.uuid`, `nautilus_trader.model.enums`, `nautilus_trader.model.events`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.objects`, `unittest.mock`
...
```bash
# For Python
pytest tests/integration_tests/adapters/interactive_brokers/test_spread_execution.py
...
---
*Generated on 2025-11-18T21:55:07.039295Z*
