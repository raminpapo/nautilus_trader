# Documentation: `tests/integration_tests/adapters/interactive_brokers/test_spread_execution.py`
**Generated:** 2025-11-15T19:40:07.856283Z
**File Size:** 23049 bytes
**Extension:** .py
**Type:** text
...
- **Path:** `tests/integration_tests/adapters/interactive_brokers/test_spread_execution.py`
- **Size:** 23,049 bytes
- **Lines:** 613
- **Extension:** `.py`
- **Type:** text
...
This file is located at `tests/integration_tests/adapters/interactive_brokers/test_spread_execution.py` within the repository.

**Classes defined:** TestSpreadExecutionDetection, TestSpreadLegExtraction, TestSpreadFillCreation, TestSpreadFillTracking, TestSpreadExecutionIntegration

**Functions defined:** test_is_spread_instrument_with_spread_formats, test_is_spread_instrument_edge_cases, _is_spread_instrument, test_extract_leg_instrument_id_standard_spread, test_extract_leg_instrument_id_ratio_spread, test_extract_leg_instrument_id_fallback, test_extract_leg_instrument_id_invalid_format, _extract_leg_instrument_id, setup_method, create_test_leg_fill and 16 more
...
#### `test_is_spread_instrument_with_spread_formats(self)`


#### `test_is_spread_instrument_edge_cases(self)`


#### `_is_spread_instrument(self, instrument_id)`


#### `test_extract_leg_instrument_id_standard_spread(self)`


#### `test_extract_leg_instrument_id_ratio_spread(self)`


#### `test_extract_leg_instrument_id_fallback(self)`


#### `test_extract_leg_instrument_id_invalid_format(self)`


#### `_extract_leg_instrument_id(self, leg_fill)`


#### `setup_method(self)`


#### `create_test_leg_fill(
        self,
        instrument_id_str: str,
        side: OrderSide,
        qty: int,
...
#### `test_create_combo_fill_basic_spread(self)`


#### `test_create_combo_fill_ratio_spread(self)`


#### `test_create_leg_fill_basic_spread(self)`


#### `test_create_leg_fill_ratio_spread(self)`


#### `_create_combo_fill(self, leg_fill: OrderFilled, contract=None)`


#### `_create_leg_fill(self, leg_fill: OrderFilled, contract=None)`


#### `_extract_leg_instrument_id(self, leg_fill: OrderFilled)`
...
#### `test_fill_tracking_deduplication(self)`


#### `test_multiple_orders_tracking(self)`


#### `test_multiple_fills_same_order(self)`


#### `setup_method(self)`


#### `test_handle_spread_execution_deduplication(self)`


#### `test_handle_spread_execution_error_handling(self)`


#### `_create_test_fill(self, instrument_id_str: str)`


#### `_handle_spread_execution(self, leg_fill: OrderFilled)`
...
```python
from tests.integration_tests.adapters.interactive_brokers.test_spread_execution import TestSpreadExecutionDetection
```
