# Documentation: `tests/integration_tests/adapters/interactive_brokers/test_parsing.py`
**Generated:** 2025-11-15T19:40:07.851506Z
...
This file is located at `tests/integration_tests/adapters/interactive_brokers/test_parsing.py` within the repository.

**Functions defined:** test_ib_contract_to_instrument_id_simplified_symbology, test_ib_contract_to_instrument_id_raw_symbology, test_instrument_id_to_ib_contract_simplified_symbology, test_instrument_id_to_ib_contract_raw_symbology, test_verified_venues_registered, test_regular_expression_forex, test_regular_expression_crypto, test_regular_expression_option, test_regular_expression_index, test_regular_expression_future and 8 more
...
#### `test_ib_contract_to_instrument_id_simplified_symbology(contract, instrument_id)`


#### `test_ib_contract_to_instrument_id_raw_symbology(contract, instrument_id)`


#### `test_instrument_id_to_ib_contract_simplified_symbology(instrument_id, contract)`


#### `test_instrument_id_to_ib_contract_raw_symbology(instrument_id, contract)`
...
#### `test_regular_expression_option(symbol, expected)`


#### `test_regular_expression_index(symbol, expected)`


#### `test_regular_expression_future(symbol, expected)`


#### `test_regular_expression_future_original(symbol, expected)`


#### `test_regular_expression_future_options(symbol, expected)`


#### `test_regular_expression_future_options_original(symbol, expected)`


#### `test_bar_spec_to_bar_size(bar_spec, expected)`


#### `test_timedelta_to_duration_str(timedelta, expected)`


#### `test_tick_size_to_precision(tick_size: float | Decimal, expected: int)`


#### `test_expiry_timestring_to_datetime(expiry: str, expected: pd.Timestamp)`
...
```python
from tests.integration_tests.adapters.interactive_brokers.test_parsing import test_ib_contract_to_instrument_id_simplified_symbology
```
