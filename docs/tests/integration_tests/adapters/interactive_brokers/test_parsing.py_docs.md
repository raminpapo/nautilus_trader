...
- **Path**: `tests/integration_tests/adapters/interactive_brokers/test_parsing.py`
- **Size**: 17,654 bytes
- **Lines**: 410
- **Language**: Python
...
### Functions
- **`test_ib_contract_to_instrument_id_simplified_symbology()`**: Function defined in this file
- **`test_ib_contract_to_instrument_id_raw_symbology()`**: Function defined in this file
- **`test_instrument_id_to_ib_contract_simplified_symbology()`**: Function defined in this file
- **`test_instrument_id_to_ib_contract_raw_symbology()`**: Function defined in this file
- **`test_verified_venues_registered()`**: Function defined in this file
- **`test_regular_expression_forex()`**: Function defined in this file
- **`test_regular_expression_crypto()`**: Function defined in this file
- **`test_regular_expression_option()`**: Function defined in this file
- **`test_regular_expression_index()`**: Function defined in this file
- **`test_regular_expression_future()`**: Function defined in this file
- **`test_regular_expression_future_original()`**: Function defined in this file
- **`test_regular_expression_future_options()`**: Function defined in this file
- **`test_regular_expression_future_options_original()`**: Function defined in this file
- **`test_bar_spec_to_bar_size()`**: Function defined in this file
- **`test_timedelta_to_duration_str()`**: Function defined in this file
- **`test_tick_size_to_precision()`**: Function defined in this file
- **`test_expiry_timestring_to_datetime()`**: Function defined in this file
- **`test_parse_instrument_future_option()`**: Function defined in this file
...
**Functions**: `test_bar_spec_to_bar_size`, `test_expiry_timestring_to_datetime`, `test_ib_contract_to_instrument_id_raw_symbology`, `test_ib_contract_to_instrument_id_simplified_symbology`, `test_instrument_id_to_ib_contract_raw_symbology`, `test_instrument_id_to_ib_contract_simplified_symbology`, `test_parse_instrument_future_option`, `test_regular_expression_crypto`, `test_regular_expression_forex`, `test_regular_expression_future`, `test_regular_expression_future_options`, `test_regular_expression_future_options_original`, `test_regular_expression_future_original`, `test_regular_expression_index`, `test_regular_expression_option`, `test_tick_size_to_precision`, `test_timedelta_to_duration_str`, `test_verified_venues_registered`
**Imports**: `datetime`, `decimal`, `nautilus_trader.adapters.interactive_brokers.common`, `nautilus_trader.adapters.interactive_brokers.config`, `nautilus_trader.adapters.interactive_brokers.parsing.data`, `nautilus_trader.adapters.interactive_brokers.parsing.instruments`, `nautilus_trader.model.data`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.instruments`, `pandas`, `pytest`, `tests.integration_tests.adapters.interactive_brokers.test_kit`
...
```bash
# For Python
pytest tests/integration_tests/adapters/interactive_brokers/test_parsing.py
...
---
*Generated on 2025-11-18T21:55:07.033683Z*
