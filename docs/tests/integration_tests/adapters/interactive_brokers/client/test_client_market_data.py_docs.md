# Documentation: test_client_market_data.py

## File Metadata

- **Path**: `tests/integration_tests/adapters/interactive_brokers/client/test_client_market_data.py`
- **Size**: 29,861 bytes
- **Lines**: 932
- **Language**: Python
...
**Imports**: `asyncio`, `copy`, `decimal`, `functools`, `ibapi.common`, `nautilus_trader.adapters.interactive_brokers.client.common`, `nautilus_trader.adapters.interactive_brokers.parsing.data`, `nautilus_trader.model.data`, `nautilus_trader.model.enums`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.objects`, `pandas`, `pytest`, `tests.integration_tests.adapters.interactive_brokers.test_kit`, `unittest.mock`
...
```bash
# For Python
pytest tests/integration_tests/adapters/interactive_brokers/client/test_client_market_data.py
...
---
*Generated on 2025-11-18T21:55:06.872704Z*
