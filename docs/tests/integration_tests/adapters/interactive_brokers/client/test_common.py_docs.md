# Documentation: `tests/integration_tests/adapters/interactive_brokers/client/test_common.py`
**Generated:** 2025-11-15T19:40:07.787910Z
...
This file is located at `tests/integration_tests/adapters/interactive_brokers/client/test_common.py` within the repository.

**Classes defined:** ConcreteBase

**Functions defined:** get, base, subscriptions, requests, mock_handle, mock_cancel, test_add_req_id, test_remove_req_id_existing, test_remove_req_id_non_existing, test_remove_by_req_id and 8 more
...
#### `get(self, req_id=None, name=None)`
...
#### `test_add_req_id(base, mock_handle, mock_cancel)`


#### `test_remove_req_id_existing(base, mock_handle, mock_cancel)`


#### `test_remove_req_id_non_existing(base)`


#### `test_remove_by_req_id(base, mock_handle, mock_cancel)`


#### `test_remove_by_name(base, mock_handle, mock_cancel)`


#### `test_add_subscription(subscriptions, mock_handle, mock_cancel)`


#### `test_remove_subscription_by_req_id(subscriptions, mock_handle, mock_cancel)`


#### `test_remove_subscription_by_name(subscriptions, mock_handle, mock_cancel)`


#### `test_update_last(subscriptions, mock_handle, mock_cancel)`


#### `test_add_request(requests, mock_handle, mock_cancel)`


#### `test_remove_request_by_req_id(requests, mock_handle, mock_cancel)`


#### `test_remove_request_by_name(requests, mock_handle, mock_cancel)`
...
```python
from tests.integration_tests.adapters.interactive_brokers.client.test_common import ConcreteBase
```
