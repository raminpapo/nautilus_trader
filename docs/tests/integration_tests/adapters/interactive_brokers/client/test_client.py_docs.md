...
### Functions
- **`test_start_tasks()`**: Function defined in this file
- **`test_degrade()`**: Function defined in this file
- **`test_subscribe_event()`**: Function defined in this file
- **`test_unsubscribe_event()`**: Function defined in this file
- **`test_next_req_id()`**: Function defined in this file
...
**Functions**: `test_degrade`, `test_next_req_id`, `test_start_tasks`, `test_subscribe_event`, `test_unsubscribe_event`
**Imports**: `asyncio`, `nautilus_trader.test_kit.functions`, `pytest`, `unittest.mock`
...
```bash
# For Python
pytest tests/integration_tests/adapters/interactive_brokers/client/test_client.py
...
---
*Generated on 2025-11-18T21:55:06.861651Z*
