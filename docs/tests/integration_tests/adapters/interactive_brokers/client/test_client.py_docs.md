# Documentation: `tests/integration_tests/adapters/interactive_brokers/client/test_client.py`
**Generated:** 2025-11-15T19:40:07.775154Z
...
- **Path:** `tests/integration_tests/adapters/interactive_brokers/client/test_client.py`
- **Size:** 6,324 bytes
- **Lines:** 223
- **Extension:** `.py`
- **Type:** text
...
This file is located at `tests/integration_tests/adapters/interactive_brokers/client/test_client.py` within the repository.

**Functions defined:** test_start_tasks, test_degrade, test_subscribe_event, sample_handler, test_unsubscribe_event, test_next_req_id
...
#### `test_start_tasks(ib_client)`


#### `test_degrade(ib_client_running)`


#### `test_subscribe_event(ib_client)`


#### `sample_handler()`


#### `test_unsubscribe_event(ib_client)`


#### `test_next_req_id(ib_client)`
...
```python
from tests.integration_tests.adapters.interactive_brokers.client.test_client import test_start_tasks
```
