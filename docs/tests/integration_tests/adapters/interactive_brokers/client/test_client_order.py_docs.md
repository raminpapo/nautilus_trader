# Documentation: test_client_order.py

## File Metadata

- **Path**: `tests/integration_tests/adapters/interactive_brokers/client/test_client_order.py`
- **Size**: 11,741 bytes
- **Lines**: 372
- **Language**: Python
...
- **`test_cancel_all_orders()`**: Function defined in this file
- **`test_next_order_id()`**: Function defined in this file
...
**Functions**: `test_cancel_all_orders`, `test_cancel_order`, `test_next_order_id`, `test_place_order`
**Imports**: `collections`, `decimal`, `ibapi.order_cancel`, `nautilus_trader.adapters.interactive_brokers.client.common`, `nautilus_trader.adapters.interactive_brokers.common`, `pytest`, `tests.integration_tests.adapters.interactive_brokers.test_kit`, `unittest.mock`
...
```bash
# For Python
pytest tests/integration_tests/adapters/interactive_brokers/client/test_client_order.py
...
---
*Generated on 2025-11-18T21:55:06.875123Z*
