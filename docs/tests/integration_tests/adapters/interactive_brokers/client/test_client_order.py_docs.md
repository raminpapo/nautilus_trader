# Documentation: `tests/integration_tests/adapters/interactive_brokers/client/test_client_order.py`
**Generated:** 2025-11-15T19:40:07.786108Z
...
This file is located at `tests/integration_tests/adapters/interactive_brokers/client/test_client_order.py` within the repository.

**Functions defined:** test_place_order, test_cancel_order, test_cancel_all_orders, test_next_order_id
...
#### `test_place_order(ib_client)`


#### `test_cancel_order(ib_client)`


#### `test_cancel_all_orders(ib_client)`


#### `test_next_order_id(ib_client)`
...
```python
from tests.integration_tests.adapters.interactive_brokers.client.test_client_order import test_place_order
```
