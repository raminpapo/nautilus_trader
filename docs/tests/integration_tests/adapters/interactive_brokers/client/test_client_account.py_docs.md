# Documentation: `tests/integration_tests/adapters/interactive_brokers/client/test_client_account.py`
**Generated:** 2025-11-15T19:40:07.776786Z
**File Size:** 5479 bytes
**Extension:** .py
**Type:** text
...
This file is located at `tests/integration_tests/adapters/interactive_brokers/client/test_client_account.py` within the repository.

**Functions defined:** test_accounts, test_subscribe_account_summary, test_subscribe_positions, test_unsubscribe_positions, test_unsubscribe_account_summary
...
#### `test_accounts(ib_client)`


#### `test_subscribe_account_summary(ib_client)`


#### `test_subscribe_positions(ib_client)`


#### `test_unsubscribe_positions(ib_client)`


#### `test_unsubscribe_account_summary(ib_client)`
...
```python
from tests.integration_tests.adapters.interactive_brokers.client.test_client_account import test_accounts
```
