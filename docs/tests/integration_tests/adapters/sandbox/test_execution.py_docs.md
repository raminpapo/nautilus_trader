# Documentation: `tests/integration_tests/adapters/sandbox/test_execution.py`
**Generated:** 2025-11-15T19:40:07.957388Z
**File Size:** 11159 bytes
**Extension:** .py
**Type:** text
...
This file is located at `tests/integration_tests/adapters/sandbox/test_execution.py` within the repository.

**Functions defined:** _make_quote_tick, _make_equity_with_increment
...
#### `_make_quote_tick(instrument)`


#### `_make_equity_with_increment(instrument: Equity, price_increment: str)`
...
```python
from tests.integration_tests.adapters.sandbox.test_execution import _make_quote_tick
```
