# Documentation: sandbox_http_spot_instrument_provider.py
...
**Imports**: `nautilus_trader.adapters.binance.common.enums`, `nautilus_trader.adapters.binance.factories`, `nautilus_trader.adapters.binance.spot.providers`, `nautilus_trader.common.component`, `os`, `pytest`
...
```bash
# For Python
pytest tests/integration_tests/adapters/binance/sandbox/sandbox_http_spot_instrument_provider.py
...
---
*Generated on 2025-11-18T21:55:06.733982Z*
