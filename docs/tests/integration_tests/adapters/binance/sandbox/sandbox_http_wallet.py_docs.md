# Documentation: sandbox_http_wallet.py

## File Metadata

- **Path**: `tests/integration_tests/adapters/binance/sandbox/sandbox_http_wallet.py`
- **Size**: 1,697 bytes
- **Lines**: 41
- **Language**: Python
...
**Imports**: `json`, `nautilus_trader.adapters.binance.common.enums`, `nautilus_trader.adapters.binance.factories`, `nautilus_trader.adapters.binance.spot.http.wallet`, `nautilus_trader.common.component`, `os`, `pytest`
...
```bash
# For Python
pytest tests/integration_tests/adapters/binance/sandbox/sandbox_http_wallet.py
...
---
*Generated on 2025-11-18T21:55:06.736813Z*
