# Documentation: sandbox_http_futures_testnet_instrument_provider.py
...
**Imports**: `nautilus_trader.adapters.binance.common.constants`, `nautilus_trader.adapters.binance.common.enums`, `nautilus_trader.adapters.binance.factories`, `nautilus_trader.adapters.binance.futures.providers`, `nautilus_trader.common.component`, `nautilus_trader.model.identifiers`, `os`, `pytest`
...
```bash
# For Python
pytest tests/integration_tests/adapters/binance/sandbox/sandbox_http_futures_testnet_instrument_provider.py
...
---
*Generated on 2025-11-18T21:55:06.728870Z*
