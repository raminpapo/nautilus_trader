# Documentation: sandbox_ws_spot_user.py
...
**Imports**: `asyncio`, `nautilus_trader.adapters.binance.common.enums`, `nautilus_trader.adapters.binance.factories`, `nautilus_trader.adapters.binance.spot.http.user`, `nautilus_trader.adapters.binance.websocket.client`, `nautilus_trader.common.component`, `os`, `pytest`
...
```bash
# For Python
pytest tests/integration_tests/adapters/binance/sandbox/sandbox_ws_spot_user.py
...
---
*Generated on 2025-11-18T21:55:06.741478Z*
