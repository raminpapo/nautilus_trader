# Documentation: `tests/integration_tests/adapters/binance/sandbox/sandbox_http_spot_user.py`
**Generated:** 2025-11-15T19:40:07.676640Z
...
This file is located at `tests/integration_tests/adapters/binance/sandbox/sandbox_http_spot_user.py` within the repository.
...
```python
import tests.integration_tests.adapters.binance.sandbox.sandbox_http_spot_user
```
