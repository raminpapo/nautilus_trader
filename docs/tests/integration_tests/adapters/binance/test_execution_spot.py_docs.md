# Documentation: `tests/integration_tests/adapters/binance/test_execution_spot.py`
**Generated:** 2025-11-15T19:40:07.697428Z
**File Size:** 14021 bytes
**Extension:** .py
**Type:** text
...
This file is located at `tests/integration_tests/adapters/binance/test_execution_spot.py` within the repository.

**Classes defined:** TestBinanceSpotExecutionClient
...
```python
from tests.integration_tests.adapters.binance.test_execution_spot import TestBinanceSpotExecutionClient
```
