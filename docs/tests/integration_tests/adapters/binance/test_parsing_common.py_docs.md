# Documentation: test_parsing_common.py
...
### Functions
- **`test_binance_futures_parse_to_balances()`**: Function defined in this file

### Classes
- **`TestBinanceCommonParsing`**: Class defined in this file
...
**Classs**: `TestBinanceCommonParsing`
**Functions**: `test_binance_futures_parse_to_balances`
**Imports**: `nautilus_trader.adapters.binance.common.enums`, `nautilus_trader.adapters.binance.common.schemas.market`, `nautilus_trader.adapters.binance.futures.enums`, `nautilus_trader.adapters.binance.futures.schemas.account`, `nautilus_trader.adapters.binance.spot.enums`, `nautilus_trader.core.datetime`, `nautilus_trader.model.data`, `nautilus_trader.model.enums`, `nautilus_trader.model.identifiers`, `nautilus_trader.test_kit.providers`, `pytest`
...
```bash
# For Python
pytest tests/integration_tests/adapters/binance/test_parsing_common.py
...
---
*Generated on 2025-11-18T21:55:06.771834Z*
