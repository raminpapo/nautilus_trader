# Documentation: `tests/integration_tests/adapters/binance/test_parsing_common.py`
**Generated:** 2025-11-15T19:40:07.702528Z
**File Size:** 13564 bytes
**Extension:** .py
**Type:** text
...
- **Path:** `tests/integration_tests/adapters/binance/test_parsing_common.py`
- **Size:** 13,564 bytes
- **Lines:** 366
- **Extension:** `.py`
- **Type:** text
...
This file is located at `tests/integration_tests/adapters/binance/test_parsing_common.py` within the repository.

**Classes defined:** TestBinanceCommonParsing

**Functions defined:** setup, test_parse_order_type, test_parse_parse_bar_ws, test_parse_position_id_to_binance_futures_position_side, test_binance_futures_parse_to_balances
...
#### `test_parse_order_type(self, order_type, expected)`


#### `test_parse_parse_bar_ws(self, resolution, expected_type)`


#### `test_parse_position_id_to_binance_futures_position_side(self, position_id, expected)`
...
```python
from tests.integration_tests.adapters.binance.test_parsing_common import TestBinanceCommonParsing
```
