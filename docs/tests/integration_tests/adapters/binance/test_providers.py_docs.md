# Documentation: `tests/integration_tests/adapters/binance/test_providers.py`
**Generated:** 2025-11-15T19:40:07.707682Z
...
This file is located at `tests/integration_tests/adapters/binance/test_providers.py` within the repository.

**Classes defined:** TestBinanceInstrumentProvider
...
```python
from tests.integration_tests.adapters.binance.test_providers import TestBinanceInstrumentProvider
```
