# Documentation: test_execution_futures.py

## File Metadata

- **Path**: `tests/integration_tests/adapters/binance/test_execution_futures.py`
- **Size**: 54,757 bytes
- **Lines**: 1,421
- **Language**: Python
...
### Classes
- **`TestBinanceFuturesExecutionClient`**: Class defined in this file
...
**Classs**: `TestBinanceFuturesExecutionClient`
**Imports**: `decimal`, `nautilus_trader.adapters.binance.common.constants`, `nautilus_trader.adapters.binance.common.enums`, `nautilus_trader.adapters.binance.config`, `nautilus_trader.adapters.binance.futures.execution`, `nautilus_trader.adapters.binance.futures.providers`, `nautilus_trader.adapters.binance.futures.schemas.account`, `nautilus_trader.adapters.binance.http.client`, `nautilus_trader.common.component`, `nautilus_trader.config`, `nautilus_trader.core.nautilus_pyo3`, `nautilus_trader.core.uuid`, `nautilus_trader.data.engine`, `nautilus_trader.execution.engine`, `nautilus_trader.execution.messages`, `nautilus_trader.model.enums`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.objects`, `nautilus_trader.portfolio.portfolio`, `nautilus_trader.risk.engine`, `nautilus_trader.test_kit.functions`, `nautilus_trader.test_kit.providers`, `nautilus_trader.test_kit.stubs.component`, `nautilus_trader.test_kit.stubs.identifiers`, `nautilus_trader.trading.strategy`, `pytest`
...
```bash
# For Python
pytest tests/integration_tests/adapters/binance/test_execution_futures.py
...
---
*Generated on 2025-11-18T21:55:06.756018Z*
