# Documentation: `tests/integration_tests/adapters/binance/test_execution_futures.py`
**Generated:** 2025-11-15T19:40:07.691199Z
**File Size:** 54812 bytes
**Extension:** .py
**Type:** text
...
This file is located at `tests/integration_tests/adapters/binance/test_execution_futures.py` within the repository.

**Classes defined:** TestBinanceFuturesExecutionClient

**Functions defined:** setup, get_instrument_id
...
```python
from tests.integration_tests.adapters.binance.test_execution_futures import TestBinanceFuturesExecutionClient
```
