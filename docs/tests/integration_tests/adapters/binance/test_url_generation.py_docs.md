# Documentation: test_url_generation.py
...
- **`test_get_ws_base_url_coin_futures_testnet_raises_error()`**: Function defined in this file
...
**Functions**: `test_get_http_base_url`, `test_get_ws_base_url`, `test_get_ws_base_url_coin_futures_testnet_raises_error`
**Imports**: `nautilus_trader.adapters.binance.common.enums`, `nautilus_trader.adapters.binance.common.urls`, `pytest`
...
```bash
# For Python
pytest tests/integration_tests/adapters/binance/test_url_generation.py
...
---
*Generated on 2025-11-18T21:55:06.778579Z*
