# Documentation: test_core_types.py

## File Metadata

- **Path**: `tests/integration_tests/adapters/binance/test_core_types.py`
- **Size**: 15,708 bytes
- **Lines**: 402
- **Language**: Python
...
### Functions
- **`test_binance_ticker_repr()`**: Function defined in this file
- **`test_binance_ticker_pickle()`**: Function defined in this file
- **`test_binance_ticker_to_from_dict()`**: Function defined in this file
- **`test_binance_bar_repr()`**: Function defined in this file
- **`test_binance_bar_to_from_dict()`**: Function defined in this file
- **`test_binance_bar_pickling()`**: Function defined in this file
- **`test_binance_mark_price_to_from_dict()`**: Function defined in this file
- **`test_binance_mark_price_pickling()`**: Function defined in this file
- **`catalog()`**: Function defined in this file
- **`test_binance_bar_data_catalog_serialization()`**: Function defined in this file
...
**Functions**: `catalog`, `test_binance_bar_data_catalog_serialization`, `test_binance_bar_pickling`, `test_binance_bar_repr`, `test_binance_bar_to_from_dict`, `test_binance_mark_price_pickling`, `test_binance_mark_price_to_from_dict`, `test_binance_ticker_pickle`, `test_binance_ticker_repr`, `test_binance_ticker_to_from_dict`
**Imports**: `decimal`, `nautilus_trader.adapters.binance.common.types`, `nautilus_trader.adapters.binance.futures.types`, `nautilus_trader.model.data`, `nautilus_trader.model.objects`, `nautilus_trader.persistence.catalog.parquet`, `nautilus_trader.test_kit.mocks.data`, `nautilus_trader.test_kit.stubs.data`, `nautilus_trader.test_kit.stubs.identifiers`, `pickle`, `pytest`
...
```bash
# For Python
pytest tests/integration_tests/adapters/binance/test_core_types.py
...
---
*Generated on 2025-11-18T21:55:06.748853Z*
