# Documentation: `tests/integration_tests/adapters/binance/test_core_types.py`
**Generated:** 2025-11-15T19:40:07.684993Z
**File Size:** 15708 bytes
**Extension:** .py
**Type:** text
...
This file is located at `tests/integration_tests/adapters/binance/test_core_types.py` within the repository.

**Functions defined:** test_binance_ticker_repr, test_binance_ticker_pickle, test_binance_ticker_to_from_dict, test_binance_bar_repr, test_binance_bar_to_from_dict, test_binance_bar_pickling, test_binance_mark_price_to_from_dict, test_binance_mark_price_pickling, catalog, test_binance_bar_data_catalog_serialization
...
#### `test_binance_bar_data_catalog_serialization(catalog: ParquetDataCatalog)`
...
```python
from tests.integration_tests.adapters.binance.test_core_types import test_binance_ticker_repr
```
