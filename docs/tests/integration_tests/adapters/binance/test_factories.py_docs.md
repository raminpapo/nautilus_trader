# Documentation: `tests/integration_tests/adapters/binance/test_factories.py`
**Generated:** 2025-11-15T19:40:07.699381Z
**File Size:** 10863 bytes
**Extension:** .py
**Type:** text
...
- **Path:** `tests/integration_tests/adapters/binance/test_factories.py`
- **Size:** 10,863 bytes
- **Lines:** 318
- **Extension:** `.py`
- **Type:** text
...
This file is located at `tests/integration_tests/adapters/binance/test_factories.py` within the repository.

**Classes defined:** TestBinanceFactories

**Functions defined:** setup, test_get_http_base_url, test_get_ws_base_url, test_create_binance_live_spot_data_client, test_create_binance_live_futures_data_client, test_create_binance_spot_exec_client, test_create_binance_futures_exec_client
...
#### `test_get_http_base_url(self, account_type, is_testnet, is_us, expected)`


#### `test_get_ws_base_url(self, account_type, is_testnet, is_us, expected)`


#### `test_create_binance_live_spot_data_client(self, binance_http_client)`


#### `test_create_binance_live_futures_data_client(self, binance_http_client)`


#### `test_create_binance_spot_exec_client(self, binance_http_client)`


#### `test_create_binance_futures_exec_client(self, binance_http_client)`
...
```python
from tests.integration_tests.adapters.binance.test_factories import TestBinanceFactories
```
...
**Security:** This file may contain sensitive patterns: password, secret, api_key. Ensure proper handling of secrets.
