# Documentation: ws_futures_order_update_new_limit_if_touched_price_match.json
...
**Identifiers**: `BUY`, `CONTRACT_PRICE`, `ETHUSDT`, `GTC`, `LONG`, `NEW`, `ORDER_TRADE_UPDATE`, `TAKE_PROFIT`
...
```bash
# For Python
pytest tests/integration_tests/adapters/binance/resources/ws_messages/ws_futures_order_update_new_limit_if_touched_price_match.json
...
---
*Generated on 2025-11-18T21:55:06.672814Z*
