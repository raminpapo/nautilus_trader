# Documentation: test_config_validation.py
...
### Functions
- **`default_data_config()`**: Function defined in this file
- **`default_exec_config()`**: Function defined in this file
- **`test_data_client_config_documentation_accuracy()`**: Function defined in this file
- **`test_exec_client_config_documentation_accuracy()`**: Function defined in this file
- **`test_data_client_config_with_valid_parameters()`**: Function defined in this file
- **`test_exec_client_config_with_valid_parameters()`**: Function defined in this file
- **`test_config_frozen_behavior()`**: Function defined in this file
- **`test_exec_config_optional_parameters_none()`**: Function defined in this file
...
**Functions**: `default_data_config`, `default_exec_config`, `test_config_frozen_behavior`, `test_data_client_config_documentation_accuracy`, `test_data_client_config_with_valid_parameters`, `test_exec_client_config_documentation_accuracy`, `test_exec_client_config_with_valid_parameters`, `test_exec_config_optional_parameters_none`
**Imports**: `nautilus_trader.adapters.binance.config`, `pytest`
...
```bash
# For Python
pytest tests/integration_tests/adapters/binance/test_config_validation.py
...
---
*Generated on 2025-11-18T21:55:06.743982Z*
