# Documentation: test_parsing_ws.py
...
### Classes
- **`TestBinanceWebSocketParsing`**: Class defined in this file
...
**Classs**: `TestBinanceWebSocketParsing`
**Imports**: `msgspec`, `nautilus_trader.adapters.binance.common.enums`, `nautilus_trader.adapters.binance.common.schemas.market`, `nautilus_trader.adapters.binance.futures.schemas.user`, `nautilus_trader.adapters.binance.spot.schemas.user`, `nautilus_trader.test_kit.providers`, `pkgutil`
...
```bash
# For Python
pytest tests/integration_tests/adapters/binance/test_parsing_ws.py
...
---
*Generated on 2025-11-18T21:55:06.775210Z*
