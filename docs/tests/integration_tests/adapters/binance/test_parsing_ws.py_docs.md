# Documentation: `tests/integration_tests/adapters/binance/test_parsing_ws.py`
**Generated:** 2025-11-15T19:40:07.705918Z
**File Size:** 11242 bytes
**Extension:** .py
**Type:** text
...
- **Path:** `tests/integration_tests/adapters/binance/test_parsing_ws.py`
- **Size:** 11,242 bytes
- **Lines:** 265
- **Extension:** `.py`
- **Type:** text
...
This file is located at `tests/integration_tests/adapters/binance/test_parsing_ws.py` within the repository.

**Classes defined:** TestBinanceWebSocketParsing

**Functions defined:** test_parse_ticker, test_parse_trade_lite, test_parse_spot_execution_report_binance_us, test_parse_to_order_status_report_with_filled_status, test_parse_to_order_status_report_with_rejected_status, test_parse_to_order_status_report_with_pending_cancel_status, test_parse_spot_execution_report_trade_with_l_zero, test_parse_spot_execution_report_calculated, test_parse_spot_execution_report_trade_prevention
...
#### `test_parse_ticker(self)`


#### `test_parse_trade_lite(self)`


#### `test_parse_spot_execution_report_binance_us(self)`


#### `test_parse_to_order_status_report_with_filled_status(self)`


#### `test_parse_to_order_status_report_with_rejected_status(self)`


#### `test_parse_to_order_status_report_with_pending_cancel_status(self)`


#### `test_parse_spot_execution_report_trade_with_l_zero(self)`


#### `test_parse_spot_execution_report_calculated(self)`


#### `test_parse_spot_execution_report_trade_prevention(self)`
...
```python
from tests.integration_tests.adapters.binance.test_parsing_ws import TestBinanceWebSocketParsing
```
