# Documentation: test_execution_handlers.py
...
### Classes
- **`TestBinanceSpotExecutionHandlers`**: Class defined in this file
- **`TestBinanceFuturesExecutionHandlers`**: Class defined in this file
...
**Classs**: `TestBinanceFuturesExecutionHandlers`, `TestBinanceSpotExecutionHandlers`
**Imports**: `json`, `msgspec`, `nautilus_trader.adapters.binance.futures.schemas.user`, `nautilus_trader.adapters.binance.spot.schemas.user`, `nautilus_trader.model.enums`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.objects`, `nautilus_trader.test_kit.providers`, `pkgutil`, `unittest.mock`
...
```bash
# For Python
pytest tests/integration_tests/adapters/binance/test_execution_handlers.py
...
---
*Generated on 2025-11-18T21:55:06.761003Z*
