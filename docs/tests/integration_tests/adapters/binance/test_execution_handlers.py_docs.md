# Documentation: `tests/integration_tests/adapters/binance/test_execution_handlers.py`
**Generated:** 2025-11-15T19:40:07.695037Z
...
- **Path:** `tests/integration_tests/adapters/binance/test_execution_handlers.py`
- **Size:** 36,192 bytes
- **Lines:** 759
- **Extension:** `.py`
- **Type:** text
...
This file is located at `tests/integration_tests/adapters/binance/test_execution_handlers.py` within the repository.

**Classes defined:** TestBinanceSpotExecutionHandlers, TestBinanceFuturesExecutionHandlers

**Functions defined:** test_trade_execution_generates_fill_with_correct_params, test_trade_execution_with_l_zero_filled_generates_fill_with_warning, test_trade_execution_with_l_zero_canceled_generates_order_canceled, test_trade_execution_with_l_zero_expired_generates_order_expired, test_trade_execution_with_l_zero_non_terminal_skips_fill, test_calculated_execution_generates_fill_with_taker_side, test_trade_prevention_logs_but_no_fill, test_canceled_execution_generates_order_canceled, test_expired_execution_generates_order_expired, test_rejected_execution_generates_order_rejected_with_post_only_flag and 11 more
...
#### `test_trade_execution_generates_fill_with_correct_params(self, mocker)`


#### `test_trade_execution_with_l_zero_filled_generates_fill_with_warning(self, mocker)`


#### `test_trade_execution_with_l_zero_canceled_generates_order_canceled(self, mocker)`


#### `test_trade_execution_with_l_zero_expired_generates_order_expired(self, mocker)`


#### `test_trade_execution_with_l_zero_non_terminal_skips_fill(self, mocker)`


#### `test_calculated_execution_generates_fill_with_taker_side(self, mocker)`


#### `test_trade_prevention_logs_but_no_fill(self, mocker)`


#### `test_canceled_execution_generates_order_canceled(self, mocker)`


#### `test_expired_execution_generates_order_expired(self, mocker)`


#### `test_rejected_execution_generates_order_rejected_with_post_only_flag(self, mocker)`


#### `test_new_execution_limit_order_price_match_generates_order_updated(self, mocker)`


#### `test_new_execution_stop_limit_order_price_match_preserves_trigger_price(self, mocker)`


#### `test_new_execution_limit_if_touched_order_price_match_preserves_trigger_price(self, mocker)`


#### `test_liquidation_order_sends_order_status_then_fill_report(self, mocker)`


#### `test_adl_order_sends_order_status_then_fill_report(self, mocker)`


#### `test_settlement_order_sends_order_status_then_fill_report(self, mocker)`


#### `test_liquidation_order_zero_quantity_skipped(self, mocker)`


#### `test_liquidation_fill_commission_calculated_when_not_provided(self, mocker)`
...
```python
from tests.integration_tests.adapters.binance.test_execution_handlers import TestBinanceSpotExecutionHandlers
```
