# Documentation: test_parsing_http.py
...
### Classes
- **`TestBinanceHttpParsing`**: Class defined in this file
...
**Classs**: `TestBinanceHttpParsing`
**Imports**: `msgspec`, `nautilus_trader.adapters.binance.common.schemas.market`, `nautilus_trader.adapters.binance.futures.schemas.account`, `nautilus_trader.model.objects`, `nautilus_trader.test_kit.providers`, `pkgutil`
...
```bash
# For Python
pytest tests/integration_tests/adapters/binance/test_parsing_http.py
...
---
*Generated on 2025-11-18T21:55:06.773198Z*
