# Documentation: list_current_orders_single.json
...
**Identifiers**: `AND`, `AUTHORITY`, `BACK`, `EXECUTABLE`, `GAMBLING`, `LAPSE`, `LIMIT`, `LOTTERIES`, `MALTA`
...
```bash
# For Python
pytest tests/integration_tests/adapters/betfair/resources/responses/list_current_orders_single.json
...
---
*Generated on 2025-11-18T21:55:06.236302Z*
