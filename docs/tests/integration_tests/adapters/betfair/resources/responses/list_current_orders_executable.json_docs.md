# Documentation: list_current_orders_executable.json
...
```bash
# For Python
pytest tests/integration_tests/adapters/betfair/resources/responses/list_current_orders_executable.json
...
---
*Generated on 2025-11-18T21:55:06.232101Z*
