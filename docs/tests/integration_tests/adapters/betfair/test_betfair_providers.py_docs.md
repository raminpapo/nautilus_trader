# Documentation: test_betfair_providers.py
...
### Classes
- **`TestBetfairInstrumentProvider`**: Class defined in this file
...
**Classs**: `TestBetfairInstrumentProvider`
**Imports**: `betfair_parser.spec.betting`, `betfair_parser.spec.streaming`, `msgspec`, `nautilus_trader.adapters.betfair.parsing.core`, `nautilus_trader.adapters.betfair.providers`, `nautilus_trader.common.component`, `nautilus_trader.model.enums`, `pytest`, `sys`, `tests.integration_tests.adapters.betfair.test_kit`
...
```bash
# For Python
pytest tests/integration_tests/adapters/betfair/test_betfair_providers.py
...
---
*Generated on 2025-11-18T21:55:06.582832Z*
