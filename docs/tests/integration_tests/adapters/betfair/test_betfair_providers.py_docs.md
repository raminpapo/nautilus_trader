# Documentation: `tests/integration_tests/adapters/betfair/test_betfair_providers.py`
**Generated:** 2025-11-15T19:40:07.568596Z
**File Size:** 6230 bytes
**Extension:** .py
**Type:** text
...
- **Path:** `tests/integration_tests/adapters/betfair/test_betfair_providers.py`
- **Size:** 6,230 bytes
- **Lines:** 160
- **Extension:** `.py`
- **Type:** text
...
This file is located at `tests/integration_tests/adapters/betfair/test_betfair_providers.py` within the repository.

**Classes defined:** TestBetfairInstrumentProvider

**Functions defined:** setup, test_market_update_runner_removed, test_list_market_catalogue_parsing
...
#### `test_market_update_runner_removed(self)`


#### `test_list_market_catalogue_parsing(self)`
...
```python
from tests.integration_tests.adapters.betfair.test_betfair_providers import TestBetfairInstrumentProvider
```
