# Documentation: test_betfair_session_errors.py

## File Metadata

- **Path**: `tests/integration_tests/adapters/betfair/test_betfair_session_errors.py`
- **Size**: 11,651 bytes
- **Lines**: 381
- **Language**: Python
...
**Imports**: `betfair_parser.exceptions`, `nautilus_trader.core.uuid`, `nautilus_trader.execution.messages`, `nautilus_trader.model.identifiers`, `pytest`, `unittest.mock`
...
```bash
# For Python
pytest tests/integration_tests/adapters/betfair/test_betfair_session_errors.py
...
---
*Generated on 2025-11-18T21:55:06.585168Z*
