# Documentation: test_betting_tick_scheme.py

## File Metadata

- **Path**: `tests/integration_tests/adapters/betfair/test_betting_tick_scheme.py`
- **Size**: 6,997 bytes
- **Lines**: 249
- **Language**: Python
...
### Functions
- **`test_betfair_tick_scheme_attrs()`**: Function defined in this file
- **`test_betfair_tick_scheme_build_ticks()`**: Function defined in this file
- **`test_betfair_tick_scheme_find_tick_idx()`**: Function defined in this file
- **`test_betfair_tick_scheme_tick_price_precision()`**: Function defined in this file
- **`test_betfair_tick_scheme_next_ask_price()`**: Function defined in this file
- **`test_betfair_tick_scheme_next_bid_price()`**: Function defined in this file
...
- **`test_betting_instrument_tick_scheme_next_ask_prices()`**: Function defined in this file
- **`test_betting_instrument_tick_scheme_next_bid_prices()`**: Function defined in this file
- **`test_next_prices()`**: Function defined in this file
...
**Functions**: `test_betfair_tick_scheme_attrs`, `test_betfair_tick_scheme_build_ticks`, `test_betfair_tick_scheme_find_tick_idx`, `test_betfair_tick_scheme_next_ask_price`, `test_betfair_tick_scheme_next_bid_price`, `test_betfair_tick_scheme_tick_price_precision`, `test_betting_instrument_tick_scheme_next_ask_prices`, `test_betting_instrument_tick_scheme_next_bid_prices`, `test_bitmex_spot_tick_scheme_next_ask_price`, `test_bitmex_spot_tick_scheme_next_bid_price`, `test_next_prices`, `test_topix100_tick_scheme_attrs`, `test_topix100_tick_scheme_next_ask_price`, `test_topix100_tick_scheme_next_bid_price`
**Imports**: `decimal`, `nautilus_trader.model.objects`, `nautilus_trader.model.tick_scheme`, `pytest`, `tests.integration_tests.adapters.betfair.test_kit`
...
```bash
# For Python
pytest tests/integration_tests/adapters/betfair/test_betting_tick_scheme.py
...
---
*Generated on 2025-11-18T21:55:06.591760Z*
