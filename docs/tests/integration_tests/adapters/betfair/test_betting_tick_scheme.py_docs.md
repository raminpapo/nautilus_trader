# Documentation: `tests/integration_tests/adapters/betfair/test_betting_tick_scheme.py`
**Generated:** 2025-11-15T19:40:07.575878Z
...
This file is located at `tests/integration_tests/adapters/betfair/test_betting_tick_scheme.py` within the repository.

**Functions defined:** test_betfair_tick_scheme_attrs, test_betfair_tick_scheme_build_ticks, test_betfair_tick_scheme_find_tick_idx, test_betfair_tick_scheme_tick_price_precision, test_betfair_tick_scheme_next_ask_price, test_betfair_tick_scheme_next_bid_price, test_topix100_tick_scheme_attrs, test_topix100_tick_scheme_next_ask_price, test_topix100_tick_scheme_next_bid_price, test_bitmex_spot_tick_scheme_next_ask_price and 4 more
...
#### `test_betfair_tick_scheme_find_tick_idx(value, expected)`


#### `test_betfair_tick_scheme_tick_price_precision(value, expected)`


#### `test_betfair_tick_scheme_next_ask_price(value, n, expected)`


#### `test_betfair_tick_scheme_next_bid_price(value, n, expected)`
...
#### `test_next_prices(instrument, expected_bids, expected_asks)`
...
```python
from tests.integration_tests.adapters.betfair.test_betting_tick_scheme import test_betfair_tick_scheme_attrs
```
