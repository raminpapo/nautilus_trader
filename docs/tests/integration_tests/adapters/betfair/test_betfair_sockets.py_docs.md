# Documentation: test_betfair_sockets.py

## File Metadata

- **Path**: `tests/integration_tests/adapters/betfair/test_betfair_sockets.py`
- **Size**: 9,969 bytes
- **Lines**: 341
- **Language**: Python
...
This file is part of the NautilusTrader repository. It defines 9 function(s) and 1 class(es).

## Detailed Walkthrough

### Functions
- **`message_collector()`**: Function defined in this file
- **`test_stream_client_message_handler_receives_raw_bytes()`**: Function defined in this file
- **`test_message_handler_processes_market_heartbeat()`**: Function defined in this file
- **`test_message_handler_processes_status_message()`**: Function defined in this file
- **`test_message_handler_processes_order_change_message()`**: Function defined in this file
- **`test_betfair_messages_not_mistaken_for_fix()`**: Function defined in this file
- **`test_various_message_types_decoded_correctly()`**: Function defined in this file
- **`test_multiple_messages_processed_in_sequence()`**: Function defined in this file
- **`test_malformed_message_handling()`**: Function defined in this file

### Classes
- **`TestBetfairSockets`**: Class defined in this file
...
**Classs**: `TestBetfairSockets`
**Functions**: `message_collector`, `test_betfair_messages_not_mistaken_for_fix`, `test_malformed_message_handling`, `test_message_handler_processes_market_heartbeat`, `test_message_handler_processes_order_change_message`, `test_message_handler_processes_status_message`, `test_multiple_messages_processed_in_sequence`, `test_stream_client_message_handler_receives_raw_bytes`, `test_various_message_types_decoded_correctly`
**Imports**: `betfair_parser.spec.streaming`, `collections.abc`, `msgspec`, `nautilus_trader.adapters.betfair.sockets`, `platform`, `pytest`, `sys`, `tests.integration_tests.adapters.betfair.test_kit`
...
```bash
# For Python
pytest tests/integration_tests/adapters/betfair/test_betfair_sockets.py
...
---
*Generated on 2025-11-18T21:55:06.587499Z*
