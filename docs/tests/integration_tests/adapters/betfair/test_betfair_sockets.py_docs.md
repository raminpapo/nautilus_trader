# Documentation: `tests/integration_tests/adapters/betfair/test_betfair_sockets.py`
**Generated:** 2025-11-15T19:40:07.571236Z
**File Size:** 9963 bytes
**Extension:** .py
**Type:** text
...
This file is located at `tests/integration_tests/adapters/betfair/test_betfair_sockets.py` within the repository.

**Classes defined:** TestBetfairSockets

**Functions defined:** setup, _build_stream_client, test_unique_id, message_collector, handler, test_stream_client_message_handler_receives_raw_bytes, test_message_handler_processes_market_heartbeat, test_message_handler_processes_status_message, test_message_handler_processes_order_change_message, test_betfair_messages_not_mistaken_for_fix and 3 more
...
#### `handler(raw_bytes: bytes)`


#### `test_stream_client_message_handler_receives_raw_bytes(message_collector)`


#### `test_message_handler_processes_market_heartbeat(message_collector)`


#### `test_message_handler_processes_status_message(message_collector)`


#### `test_message_handler_processes_order_change_message(message_collector)`


#### `test_betfair_messages_not_mistaken_for_fix()`


#### `test_various_message_types_decoded_correctly(raw_message, expected_type)`


#### `test_multiple_messages_processed_in_sequence(message_collector)`


#### `test_malformed_message_handling(message_collector)`
...
```python
from tests.integration_tests.adapters.betfair.test_betfair_sockets import TestBetfairSockets
```
