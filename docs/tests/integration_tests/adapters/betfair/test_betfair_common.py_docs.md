# Documentation: test_betfair_common.py

## File Metadata

- **Path**: `tests/integration_tests/adapters/betfair/test_betfair_common.py`
- **Size**: 5,662 bytes
- **Lines**: 161
- **Language**: Python
...
### Functions
- **`test_betfair_sequence_completed_str_repr()`**: Function defined in this file
- **`test_is_session_error_returns_true()`**: Function defined in this file
- **`test_is_session_error_returns_false()`**: Function defined in this file

### Classes
- **`TestBetfairCommon`**: Class defined in this file
- **`TestBettingInstrument`**: Class defined in this file
...
**Classs**: `TestBetfairCommon`, `TestBettingInstrument`
**Functions**: `test_betfair_sequence_completed_str_repr`, `test_is_session_error_returns_false`, `test_is_session_error_returns_true`
**Imports**: `betfair_parser.exceptions`, `decimal`, `nautilus_trader.adapters.betfair.common`, `nautilus_trader.adapters.betfair.orderbook`, `nautilus_trader.adapters.betfair.parsing.core`, `nautilus_trader.model.instruments`, `nautilus_trader.model.objects`, `pytest`, `tests.integration_tests.adapters.betfair.test_kit`
...
```bash
# For Python
pytest tests/integration_tests/adapters/betfair/test_betfair_common.py
...
---
*Generated on 2025-11-18T21:55:06.562308Z*
