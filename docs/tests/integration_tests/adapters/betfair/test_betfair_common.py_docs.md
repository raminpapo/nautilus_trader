# Documentation: `tests/integration_tests/adapters/betfair/test_betfair_common.py`
**Generated:** 2025-11-15T19:40:07.550937Z
...
This file is located at `tests/integration_tests/adapters/betfair/test_betfair_common.py` within the repository.

**Classes defined:** TestBetfairCommon, TestBettingInstrument

**Functions defined:** setup, test_min_max_bet, test_betfair_ticks, setup, test_notional_value, test_next_ask_price, test_next_bid_price, test_min_max_price, test_to_dict, test_betting_instrument_notional_value and 1 more
...
#### `test_min_max_bet(self)`


#### `test_betfair_ticks(self)`


#### `setup(self)`


#### `test_notional_value(self)`


#### `test_next_ask_price(self, value, n, expected)`


#### `test_next_bid_price(self, value, n, expected)`


#### `test_min_max_price(self)`


#### `test_to_dict(self)`


#### `test_betting_instrument_notional_value(self, price, quantity, expected)`
...
```python
from tests.integration_tests.adapters.betfair.test_betfair_common import TestBetfairCommon
```
