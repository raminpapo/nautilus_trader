# Documentation: `tests/integration_tests/adapters/betfair/test_betfair_data.py`
**Generated:** 2025-11-15T19:40:07.553741Z
...
This file is located at `tests/integration_tests/adapters/betfair/test_betfair_data.py` within the repository.

**Functions defined:** instrument_list, test_market_heartbeat, test_stream_latency, test_market_update, test_market_update_md, test_market_update_live_image, test_market_update_live_update, test_market_bsp, test_orderbook_repr, test_orderbook_updates and 9 more
...
#### `instrument_list(mock_load_markets_metadata)`


#### `test_market_heartbeat(data_client)`


#### `test_stream_latency(mock_degrade, data_client)`


#### `test_market_update(data_client, mock_data_engine_process)`


#### `test_market_update_md(data_client, mock_data_engine_process)`


#### `test_market_update_live_image(data_client, mock_data_engine_process)`


#### `test_market_update_live_update(data_client, mock_data_engine_process)`


#### `test_market_bsp(data_client, mock_data_engine_process)`


#### `test_orderbook_repr(data_client, mock_data_engine_process)`


#### `test_orderbook_updates(data_client, parser)`


#### `test_instrument_opening_events(data_client, parser)`


#### `test_instrument_in_play_events(data_client, parser)`


#### `test_instrument_update(data_client, cache, parser)`


#### `test_instrument_closing_events(data_client, parser)`


#### `test_betfair_ticker(data_client, mock_data_engine_process)`


#### `test_betfair_ticker_sp(data_client, mock_data_engine_process)`


#### `test_betfair_starting_price(data_client, mock_data_engine_process)`


#### `test_betfair_orderbook(data_client, parser)`


#### `test_bsp_deltas_apply(data_client, instrument)`
...
```python
from tests.integration_tests.adapters.betfair.test_betfair_data import instrument_list
```
