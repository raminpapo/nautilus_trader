# Documentation: test_betfair_data.py

## File Metadata

- **Path**: `tests/integration_tests/adapters/betfair/test_betfair_data.py`
- **Size**: 19,770 bytes
- **Lines**: 558
- **Language**: Python
...
This file is part of the NautilusTrader repository. It defines 19 function(s).

## Detailed Walkthrough

### Functions
- **`instrument_list()`**: Function defined in this file
- **`test_market_heartbeat()`**: Function defined in this file
- **`test_stream_latency()`**: Function defined in this file
- **`test_market_update()`**: Function defined in this file
- **`test_market_update_md()`**: Function defined in this file
- **`test_market_update_live_image()`**: Function defined in this file
- **`test_market_update_live_update()`**: Function defined in this file
- **`test_market_bsp()`**: Function defined in this file
- **`test_orderbook_repr()`**: Function defined in this file
- **`test_orderbook_updates()`**: Function defined in this file
- **`test_instrument_opening_events()`**: Function defined in this file
- **`test_instrument_in_play_events()`**: Function defined in this file
- **`test_instrument_update()`**: Function defined in this file
- **`test_instrument_closing_events()`**: Function defined in this file
- **`test_betfair_ticker()`**: Function defined in this file
- **`test_betfair_ticker_sp()`**: Function defined in this file
- **`test_betfair_starting_price()`**: Function defined in this file
- **`test_betfair_orderbook()`**: Function defined in this file
- **`test_bsp_deltas_apply()`**: Function defined in this file
...
**Functions**: `instrument_list`, `test_betfair_orderbook`, `test_betfair_starting_price`, `test_betfair_ticker`, `test_betfair_ticker_sp`, `test_bsp_deltas_apply`, `test_instrument_closing_events`, `test_instrument_in_play_events`, `test_instrument_opening_events`, `test_instrument_update`, `test_market_bsp`, `test_market_heartbeat`, `test_market_update`, `test_market_update_live_image`, `test_market_update_live_update`, `test_market_update_md`, `test_orderbook_repr`, `test_orderbook_updates`, `test_stream_latency`
**Imports**: `asyncio`, `betfair_parser.spec.streaming`, `collections`, `msgspec`, `nautilus_trader.adapters.betfair.constants`, `nautilus_trader.adapters.betfair.data`, `nautilus_trader.adapters.betfair.data_types`, `nautilus_trader.adapters.betfair.orderbook`, `nautilus_trader.adapters.betfair.providers`, `nautilus_trader.core.rust.model`, `nautilus_trader.core.uuid`, `nautilus_trader.data.messages`, `nautilus_trader.model.book`, `nautilus_trader.model.data`, `nautilus_trader.model.enums`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.instruments`, `nautilus_trader.model.objects`, `nautilus_trader.test_kit.stubs.data`, `pytest`, `tests.integration_tests.adapters.betfair.test_kit`, `unittest.mock`
...
```bash
# For Python
pytest tests/integration_tests/adapters/betfair/test_betfair_data.py
...
---
*Generated on 2025-11-18T21:55:06.565923Z*
