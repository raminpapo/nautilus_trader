# Documentation: `tests/integration_tests/adapters/betfair/test_kit.py`
**Generated:** 2025-11-15T19:40:07.580538Z
**File Size:** 31400 bytes
**Extension:** .py
**Type:** text
...
This file is located at `tests/integration_tests/adapters/betfair/test_kit.py` within the repository.

**Classes defined:** BetfairTestStubs, BetfairRequests, BetfairResponses, BetfairStreaming, BetfairDataProvider

**Functions defined:** mock_betfair_request, trader_id, instrument_provider, betfair_client, make_order_place_response, parse_betfair, betfair_venue_config, streaming_config, backtest_run_config, load and 81 more
...
#### `mock_betfair_request(obj, response)`
...
#### `betting_place_order_handicap()`


#### `betting_place_order_bsp()`


#### `betting_replace_order()`
...
#### `account_funds_no_exposure()`


#### `account_funds_with_exposure()`


#### `account_funds_error()`


#### `betting_cancel_orders_success()`


#### `betting_cancel_orders_error()`


#### `betting_place_order_error()`


#### `betting_place_order_success()`


#### `betting_place_orders_old()`


#### `betting_replace_orders_success()`


#### `betting_replace_orders_success_multi()`
...
#### `list_current_orders_executable()`


#### `list_current_orders_on_close_execution_complete()`


#### `list_current_orders_execution_complete()`


#### `list_current_orders_empty()`


#### `list_current_orders_custom(
        market_id: str,
        selection_id: int,
        customer_order_ref: str = "",
        customer_strategy_ref: str = "",
...
#### `betting_list_market_catalogue(filter_: MarketFilter | None = None)`
...
#### `market_definition_closed()`


#### `decode(raw: bytes, iterate: bool = False)`


#### `load(filename, iterate: bool = False)`
...
#### `market_definition_runner_removed()`
...
**Security:** This file may contain sensitive patterns: password, token, auth, session. Ensure proper handling of secrets.
