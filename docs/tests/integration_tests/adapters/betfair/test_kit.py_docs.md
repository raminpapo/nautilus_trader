# Documentation: test_kit.py

## File Metadata

- **Path**: `tests/integration_tests/adapters/betfair/test_kit.py`
- **Size**: 31,400 bytes
- **Lines**: 903
- **Language**: Python
...
This file is part of the NautilusTrader repository. It defines 4 function(s) and 5 class(es).

## Detailed Walkthrough

### Functions
- **`mock_betfair_request()`**: Function defined in this file
- **`betting_instrument()`**: Function defined in this file
- **`betting_instrument_handicap()`**: Function defined in this file
- **`load_betfair_data()`**: Function defined in this file

### Classes
- **`BetfairTestStubs`**: Class defined in this file
- **`BetfairRequests`**: Class defined in this file
- **`BetfairResponses`**: Class defined in this file
- **`BetfairStreaming`**: Class defined in this file
- **`BetfairDataProvider`**: Class defined in this file
...
**Classs**: `BetfairDataProvider`, `BetfairRequests`, `BetfairResponses`, `BetfairStreaming`, `BetfairTestStubs`
**Functions**: `betting_instrument`, `betting_instrument_handicap`, `load_betfair_data`, `mock_betfair_request`
**Imports**: `aiohttp`, `betfair_parser.spec.betting.type_definitions`, `betfair_parser.spec.common`, `betfair_parser.spec.streaming`, `bz2`, `gzip`, `msgspec`, `nautilus_trader`, `nautilus_trader.adapters.betfair.client`, `nautilus_trader.adapters.betfair.common`, `nautilus_trader.adapters.betfair.constants`, `nautilus_trader.adapters.betfair.data`, `nautilus_trader.adapters.betfair.parsing.core`, `nautilus_trader.adapters.betfair.providers`, `nautilus_trader.config`, `nautilus_trader.core.nautilus_pyo3`, `nautilus_trader.model.currencies`, `nautilus_trader.model.data`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.instruments.betting`, `nautilus_trader.model.objects`, `nautilus_trader.persistence.catalog`, `pandas`, `pathlib`, `unittest.mock`
...
```bash
# For Python
pytest tests/integration_tests/adapters/betfair/test_kit.py
...
---
*Generated on 2025-11-18T21:55:06.595523Z*
