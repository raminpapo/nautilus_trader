# Documentation: test_betfair_parsing.py
...
### Functions
- **`request_id()`**: Function defined in this file
- **`test_bsp_orders_use_stake_units_not_liability()`**: Function defined in this file
- **`test_bsp_order_book_delta_to_batch_with_clear_action()`**: Function defined in this file
- **`test_bsp_order_status_report_uses_stake_units()`**: Function defined in this file

### Classes
- **`TestBetfairParsingStreaming`**: Class defined in this file
- **`TestBetfairParsing`**: Class defined in this file
...
**Classs**: `TestBetfairParsing`, `TestBetfairParsingStreaming`
**Functions**: `request_id`, `test_bsp_order_book_delta_to_batch_with_clear_action`, `test_bsp_order_status_report_uses_stake_units`, `test_bsp_orders_use_stake_units_not_liability`
**Imports**: `betfair_parser.spec.betting.enums`, `betfair_parser.spec.betting.orders`, `betfair_parser.spec.betting.type_definitions`, `betfair_parser.spec.common`, `betfair_parser.spec.common.messages`, `betfair_parser.spec.streaming`, `collections`, `copy`, `datetime`, `msgspec`, `nautilus_trader.adapters.betfair.common`, `nautilus_trader.adapters.betfair.data_types`, `nautilus_trader.adapters.betfair.orderbook`, `nautilus_trader.adapters.betfair.parsing.common`, `nautilus_trader.adapters.betfair.parsing.core`, `nautilus_trader.adapters.betfair.parsing.requests`, `nautilus_trader.adapters.betfair.parsing.streaming`, `nautilus_trader.common.component`, `nautilus_trader.core.data`, `nautilus_trader.core.uuid`, `nautilus_trader.model.book`, `nautilus_trader.model.currencies`, `nautilus_trader.model.data`, `nautilus_trader.model.enums`, `nautilus_trader.model.events.account`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.objects`, `nautilus_trader.test_kit.providers`, `nautilus_trader.test_kit.stubs.commands`, `nautilus_trader.test_kit.stubs.execution` *(+2 more)*
...
```bash
# For Python
pytest tests/integration_tests/adapters/betfair/test_betfair_parsing.py
...
---
*Generated on 2025-11-18T21:55:06.579507Z*
