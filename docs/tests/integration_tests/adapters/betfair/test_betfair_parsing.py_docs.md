# Documentation: `tests/integration_tests/adapters/betfair/test_betfair_parsing.py`
**Generated:** 2025-11-15T19:40:07.564289Z
**File Size:** 46876 bytes
**Extension:** .py
**Type:** text
...
- **Path:** `tests/integration_tests/adapters/betfair/test_betfair_parsing.py`
- **Size:** 46,876 bytes
- **Lines:** 813
- **Extension:** `.py`
- **Type:** text
...
This file is located at `tests/integration_tests/adapters/betfair/test_betfair_parsing.py` within the repository.

**Classes defined:** TestBetfairParsingStreaming, TestBetfairParsing

**Functions defined:** setup, test_market_definition_to_instrument_status, test_market_definition_to_instrument_close_price, test_market_definition_to_betfair_starting_price, test_market_definition_to_instrument_updates, test_market_change_bsp_updates, test_market_change_ticker, test_parsing_streaming_file, test_parsing_streaming_file_message_counts, test_order_book_integrity and 23 more
...
#### `test_market_definition_to_instrument_status(self)`


#### `test_market_definition_to_instrument_close_price(self)`


#### `test_market_definition_to_betfair_starting_price(self)`


#### `test_market_definition_to_instrument_updates(self)`


#### `test_market_change_bsp_updates(self)`


#### `test_market_change_ticker(self)`


#### `test_parsing_streaming_file(self, filename, num_msgs)`


#### `test_parsing_streaming_file_message_counts(self)`


#### `test_order_book_integrity(self, filename, book_count)`


#### `test_betfair_trade_sizes(self)`


#### `setup(self, session_event_loop)`


#### `test_order_side_parser_to_betfair(self)`


#### `test_order_side_parser_round_trip(self)`


#### `test_order_submit_to_betfair(self)`


#### `test_order_update_to_betfair(self)`


#### `test_order_cancel_to_betfair(self)`


#### `test_make_order_limit(self)`


#### `test_make_order_limit_on_close(self)`


#### `test_make_order_market_buy(self)`


#### `test_make_order_market_sell(self)`


#### `test_make_order_market_on_close(self, side, liability)`


#### `test_determine_order_status(self, status, size, matched, cancelled, expected)`


#### `test_parse_line(self)`


#### `test_mcm(self)`


#### `test_mcm_bsp_example1(self)`


#### `test_mcm_bsp_example2(self)`


#### `test_persistence_types(
        self,
        time_in_force,
        expected_time_in_force,
        expected_persistence_type,
...
#### `test_persistence_encoding(self)`


#### `test_customer_order_ref(self)`


#### `test_encode_place_orders(self)`
...
```python
from tests.integration_tests.adapters.betfair.test_betfair_parsing import TestBetfairParsingStreaming
```
