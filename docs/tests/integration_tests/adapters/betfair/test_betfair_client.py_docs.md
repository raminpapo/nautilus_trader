# Documentation: test_betfair_client.py

## File Metadata

- **Path**: `tests/integration_tests/adapters/betfair/test_betfair_client.py`
- **Size**: 16,332 bytes
- **Lines**: 421
- **Language**: Python
...
**Imports**: `betfair_parser.exceptions`, `betfair_parser.spec.accounts.enums`, `betfair_parser.spec.accounts.operations`, `betfair_parser.spec.accounts.type_definitions`, `betfair_parser.spec.betting.enums`, `betfair_parser.spec.betting.listings`, `betfair_parser.spec.betting.orders`, `betfair_parser.spec.betting.type_definitions`, `betfair_parser.spec.common`, `betfair_parser.spec.identity`, `betfair_parser.spec.navigation`, `nautilus_trader.adapters.betfair.orderbook`, `nautilus_trader.adapters.betfair.parsing.requests`, `nautilus_trader.core.uuid`, `nautilus_trader.execution.messages`, `nautilus_trader.model.enums`, `nautilus_trader.model.identifiers`, `nautilus_trader.test_kit.stubs.commands`, `nautilus_trader.test_kit.stubs.execution`, `nautilus_trader.test_kit.stubs.identifiers`, `pytest`, `tests.integration_tests.adapters.betfair.test_kit`
...
```bash
# For Python
pytest tests/integration_tests/adapters/betfair/test_betfair_client.py
...
---
*Generated on 2025-11-18T21:55:06.560542Z*
