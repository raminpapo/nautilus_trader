# Documentation: `tests/integration_tests/adapters/betfair/test_betfair_client.py`
**Generated:** 2025-11-15T19:40:07.549015Z
**File Size:** 16403 bytes
**Extension:** .py
**Type:** text
...
This file is located at `tests/integration_tests/adapters/betfair/test_betfair_client.py` within the repository.
...
```python
import tests.integration_tests.adapters.betfair.test_betfair_client
```
