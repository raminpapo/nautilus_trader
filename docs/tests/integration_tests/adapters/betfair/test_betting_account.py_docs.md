# Documentation: `tests/integration_tests/adapters/betfair/test_betting_account.py`
**Generated:** 2025-11-15T19:40:07.573710Z
**File Size:** 10593 bytes
**Extension:** .py
**Type:** text
...
- **Path:** `tests/integration_tests/adapters/betfair/test_betting_account.py`
- **Size:** 10,593 bytes
- **Lines:** 296
- **Extension:** `.py`
- **Type:** text
...
This file is located at `tests/integration_tests/adapters/betfair/test_betting_account.py` within the repository.

**Classes defined:** TestBettingAccount

**Functions defined:** setup, _make_account_state, _make_fill, test_instantiated_accounts_basic_properties, test_instantiate_single_asset_cash_account, test_apply_given_new_state_event_updates_correctly, test_calculate_balance_locked, test_calculate_pnls_for_single_currency_cash_account, test_calculate_pnls_partially_closed, test_calculate_commission_when_given_liquidity_side_none_raises_value_error and 1 more
...
#### `_make_account_state(starting_balance: float)`


#### `_make_fill(self, price="0.5", volume=10, side="BUY", position_id="P-123456")`
...
#### `test_calculate_balance_locked(self, price, quantity, side, locked_balance)`


#### `test_calculate_pnls_for_single_currency_cash_account(self)`


#### `test_calculate_pnls_partially_closed(self)`
...
#### `test_balance_impact(self, side, price, quantity, expected)`
...
```python
from tests.integration_tests.adapters.betfair.test_betting_account import TestBettingAccount
```
