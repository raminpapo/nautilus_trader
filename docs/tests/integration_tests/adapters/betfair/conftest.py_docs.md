# Documentation: `tests/integration_tests/adapters/betfair/conftest.py`
**Generated:** 2025-11-15T19:40:05.567263Z
...
This file is located at `tests/integration_tests/adapters/betfair/conftest.py` within the repository.

**Functions defined:** instrument, venue, account_state, betfair_client, instrument_provider, data_client, exec_client, data_catalog, parser
...
#### `betfair_client(event_loop)`


#### `instrument_provider(betfair_client)`
...
```python
from tests.integration_tests.adapters.betfair.conftest import instrument
```
...
**Security:** This file may contain sensitive patterns: password, token, auth. Ensure proper handling of secrets.
