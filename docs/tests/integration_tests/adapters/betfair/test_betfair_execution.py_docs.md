# Documentation: `tests/integration_tests/adapters/betfair/test_betfair_execution.py`
**Generated:** 2025-11-15T19:40:07.557913Z
**File Size:** 37853 bytes
**Extension:** .py
**Type:** text
...
This file is located at `tests/integration_tests/adapters/betfair/test_betfair_execution.py` within the repository.

**Classes defined:** _StubUnmatchedOrder

**Functions defined:** setup_order_state, setup_order_state_fills, submit_order, accept_order, fill_order, test_order, order_and_cache, _make_unmatched_order, test_invalid_price_is_skipped
...
**Inherits from:** SimpleNamespace


### Functions

#### `setup_order_state(exec_client, cache, strategy, trade_id, venue_order_id)`


#### `setup_order_state_fills(setup_order_state)`


#### `submit_order(exec_client, strategy, cache)`


#### `accept_order(exec_client, strategy, cache)`
...
#### `test_order(instrument, strategy_id)`


#### `order_and_cache(exec_client, monkeypatch)`


#### `_make_unmatched_order(order, *, price: float = _NEGATIVE_PRICE)`
...
```python
from tests.integration_tests.adapters.betfair.test_betfair_execution import _StubUnmatchedOrder
```
