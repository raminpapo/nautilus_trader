# Documentation: test_betfair_execution.py

## File Metadata

- **Path**: `tests/integration_tests/adapters/betfair/test_betfair_execution.py`
- **Size**: 48,508 bytes
- **Lines**: 1,449
- **Language**: Python
...
### Functions
- **`setup_order_state()`**: Function defined in this file
- **`setup_order_state_fills()`**: Function defined in this file
...
- **`order_and_cache()`**: Function defined in this file
- **`_make_unmatched_order()`**: Function defined in this file
- **`test_invalid_price_is_skipped()`**: Function defined in this file
- **`test_get_matched_timestamp_fallback()`**: Function defined in this file

### Classes
- **`_StubUnmatchedOrder`**: Class defined in this file
...
**Classs**: `_StubUnmatchedOrder`
**Functions**: `_make_unmatched_order`, `accept_order`, `fill_order`, `order_and_cache`, `setup_order_state`, `setup_order_state_fills`, `submit_order`, `test_get_matched_timestamp_fallback`, `test_invalid_price_is_skipped`, `test_order`
**Imports**: `__future__`, `asyncio`, `betfair_parser.spec.streaming`, `functools`, `logging`, `msgspec`, `nautilus_trader.adapters.betfair.client`, `nautilus_trader.adapters.betfair.constants`, `nautilus_trader.adapters.betfair.data`, `nautilus_trader.adapters.betfair.execution`, `nautilus_trader.adapters.betfair.orderbook`, `nautilus_trader.adapters.betfair.parsing.common`, `nautilus_trader.core.rust.model`, `nautilus_trader.core.uuid`, `nautilus_trader.execution.messages`, `nautilus_trader.execution.reports`, `nautilus_trader.model.currencies`, `nautilus_trader.model.enums`, `nautilus_trader.model.events.order`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.instruments`, `nautilus_trader.model.instruments.betting`, `nautilus_trader.model.objects`, `nautilus_trader.test_kit.stubs.commands`, `nautilus_trader.test_kit.stubs.execution`, `pytest`, `tests.integration_tests.adapters.betfair.test_kit`, `types`, `unittest.mock`
...
```bash
# For Python
pytest tests/integration_tests/adapters/betfair/test_betfair_execution.py
...
---
*Generated on 2025-11-18T21:55:06.571727Z*
