...
- **Path**: `tests/integration_tests/adapters/okx/conftest.py`
- **Size**: 9,722 bytes
- **Lines**: 308
- **Language**: Python
...
**Functions**: `_create_currency`, `_create_ws_mock`, `account_id`, `account_state`, `data_client`, `eth_usdt_instrument`, `exec_client`, `instrument`, `mock_http_client`, `mock_instrument_provider`, `mock_ws_clients`, `venue`
**Imports**: `decimal`, `nautilus_trader.adapters.okx.config`, `nautilus_trader.adapters.okx.constants`, `nautilus_trader.adapters.okx.execution`, `nautilus_trader.adapters.okx.providers`, `nautilus_trader.core`, `nautilus_trader.core.nautilus_pyo3`, `nautilus_trader.model.currencies`, `nautilus_trader.model.enums`, `nautilus_trader.model.events`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.instruments.currency_pair`, `nautilus_trader.model.objects`, `nautilus_trader.test_kit.stubs.identifiers`, `pytest`, `unittest.mock`

## Related Files

This file is located in `tests/integration_tests/adapters/okx/`. Related files may include:
...
```bash
# For Python
pytest tests/integration_tests/adapters/okx/conftest.py
...
---
*Generated on 2025-11-18T21:55:07.062285Z*
