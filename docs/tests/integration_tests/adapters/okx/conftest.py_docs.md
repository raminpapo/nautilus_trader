# Documentation: `tests/integration_tests/adapters/okx/conftest.py`
**Generated:** 2025-11-15T19:40:07.865046Z
**File Size:** 9742 bytes
**Extension:** .py
**Type:** text
...
This file is located at `tests/integration_tests/adapters/okx/conftest.py` within the repository.

**Functions defined:** _create_currency, venue, account_id, instrument, eth_usdt_instrument, account_state, mock_http_client, _create_ws_mock, mock_ws_clients, mock_instrument_provider and 3 more
...
#### `mock_instrument_provider(instrument)`
...
#### `ws_with_credentials(*args, **kwargs)`
...
**Directory:** `tests/integration_tests/adapters/okx`
