...
- **Path**: `tests/integration_tests/adapters/okx/test_execution.py`
- **Size**: 47,421 bytes
- **Lines**: 1,380
- **Language**: Python
...
**Functions**: `exec_client_builder`
**Imports**: `nautilus_trader.adapters.okx.config`, `nautilus_trader.adapters.okx.constants`, `nautilus_trader.adapters.okx.execution`, `nautilus_trader.core`, `nautilus_trader.execution.messages`, `nautilus_trader.model.enums`, `nautilus_trader.model.events`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.objects`, `nautilus_trader.model.orders`, `nautilus_trader.test_kit.providers`, `nautilus_trader.test_kit.stubs.events`, `nautilus_trader.test_kit.stubs.execution`, `nautilus_trader.test_kit.stubs.identifiers`, `pytest`, `tests.integration_tests.adapters.okx.conftest`, `types`, `unittest.mock`
...
---
*Generated on 2025-11-18T21:55:07.077361Z*
