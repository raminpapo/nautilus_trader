# Documentation: `tests/integration_tests/adapters/okx/test_execution.py`
**Generated:** 2025-11-15T19:40:07.878941Z
**File Size:** 47427 bytes
**Extension:** .py
**Type:** text
...
This file is located at `tests/integration_tests/adapters/okx/test_execution.py` within the repository.

**Functions defined:** exec_client_builder, builder, _capture, _capture, _capture, _capture, _capture, _capture, _capture
...
```python
from tests.integration_tests.adapters.okx.test_execution import exec_client_builder
```
