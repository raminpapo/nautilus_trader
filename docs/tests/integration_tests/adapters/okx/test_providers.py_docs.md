# Documentation: `tests/integration_tests/adapters/okx/test_providers.py`
**Generated:** 2025-11-15T19:40:07.881386Z
**File Size:** 7938 bytes
**Extension:** .py
**Type:** text
...
This file is located at `tests/integration_tests/adapters/okx/test_providers.py` within the repository.
...
```python
import tests.integration_tests.adapters.okx.test_providers
```
