# Documentation: `tests/integration_tests/adapters/okx/test_data.py`
**Generated:** 2025-11-15T19:40:07.874193Z
...
This file is located at `tests/integration_tests/adapters/okx/test_data.py` within the repository.

**Functions defined:** data_client_builder, builder, fake_from_str
...
```python
from tests.integration_tests.adapters.okx.test_data import data_client_builder
```
