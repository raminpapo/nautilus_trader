...
- **Path**: `tests/integration_tests/adapters/okx/test_data.py`
- **Size**: 11,214 bytes
- **Lines**: 344
- **Language**: Python
...
### Functions
- **`data_client_builder()`**: Function defined in this file
...
**Functions**: `data_client_builder`
**Imports**: `nautilus_trader.adapters.okx.config`, `nautilus_trader.adapters.okx.constants`, `nautilus_trader.adapters.okx.data`, `nautilus_trader.core`, `nautilus_trader.core.uuid`, `nautilus_trader.data.messages`, `nautilus_trader.model.enums`, `nautilus_trader.model.identifiers`, `pytest`, `tests.integration_tests.adapters.okx.conftest`, `types`, `unittest.mock`
...
```bash
# For Python
pytest tests/integration_tests/adapters/okx/test_data.py
...
---
*Generated on 2025-11-18T21:55:07.071267Z*
