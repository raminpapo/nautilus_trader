# Documentation: `tests/integration_tests/adapters/okx/sandbox/bars_request_pagination.py`
**Generated:** 2025-11-15T19:40:07.868545Z
...
- **Path:** `tests/integration_tests/adapters/okx/sandbox/bars_request_pagination.py`
- **Size:** 10,544 bytes
- **Lines:** 290
- **Extension:** `.py`
- **Type:** text
...
This file is located at `tests/integration_tests/adapters/okx/sandbox/bars_request_pagination.py` within the repository.

**Functions defined:** utc_now, assert_chronological
...
#### `assert_chronological(bars: list)`
...
```python
from tests.integration_tests.adapters.okx.sandbox.bars_request_pagination import utc_now
```
...
**Directory:** `tests/integration_tests/adapters/okx/sandbox`
