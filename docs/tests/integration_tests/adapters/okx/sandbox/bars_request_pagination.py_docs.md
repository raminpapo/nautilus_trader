# Documentation: bars_request_pagination.py
...
- **`assert_chronological()`**: Function defined in this file
...
**Functions**: `assert_chronological`, `utc_now`
**Imports**: `__future__`, `argparse`, `asyncio`, `nautilus_trader.adapters.okx.factories`, `nautilus_trader.common.component`, `nautilus_trader.common.enums`, `nautilus_trader.core`, `pandas`
...
```bash
# For Python
pytest tests/integration_tests/adapters/okx/sandbox/bars_request_pagination.py
...
---
*Generated on 2025-11-18T21:55:07.066333Z*
