# Documentation: `tests/integration_tests/adapters/okx/sandbox/execution_reports.py`
**Generated:** 2025-11-15T19:40:07.870424Z
...
This file is located at `tests/integration_tests/adapters/okx/sandbox/execution_reports.py` within the repository.
...
```python
import tests.integration_tests.adapters.okx.sandbox.execution_reports
```
