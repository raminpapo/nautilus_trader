# Documentation: `tests/integration_tests/adapters/okx/sandbox/position_reports.py`
**Generated:** 2025-11-15T19:40:07.872075Z
...
This file is located at `tests/integration_tests/adapters/okx/sandbox/position_reports.py` within the repository.
...
```python
import tests.integration_tests.adapters.okx.sandbox.position_reports
```
