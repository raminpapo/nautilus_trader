# Documentation: `tests/integration_tests/adapters/okx/test_spot_cash_position_reports.py`
**Generated:** 2025-11-15T19:40:07.883713Z
...
This file is located at `tests/integration_tests/adapters/okx/test_spot_cash_position_reports.py` within the repository.

**Functions defined:** exec_client_with_spot_positions
...
```python
from tests.integration_tests.adapters.okx.test_spot_cash_position_reports import exec_client_with_spot_positions
```
