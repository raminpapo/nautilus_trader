# Documentation: test_spot_cash_position_reports.py

## File Metadata

- **Path**: `tests/integration_tests/adapters/okx/test_spot_cash_position_reports.py`
- **Size**: 17,848 bytes
- **Lines**: 540
- **Language**: Python
...
### Functions
- **`exec_client_with_spot_positions()`**: Function defined in this file
...
```bash
# For Python
pytest tests/integration_tests/adapters/okx/test_spot_cash_position_reports.py
...
---
*Generated on 2025-11-18T21:55:07.081921Z*
