# Documentation: `tests/integration_tests/network/test_websocket.py`
**Generated:** 2025-11-15T19:40:08.014296Z
...
- **Path:** `tests/integration_tests/network/test_websocket.py`
- **Size:** 4,510 bytes
- **Lines:** 137
- **Extension:** `.py`
- **Type:** text
...
This file is located at `tests/integration_tests/network/test_websocket.py` within the repository.

**Functions defined:** _server_url
...
```python
from tests.integration_tests.network.test_websocket import _server_url
```
