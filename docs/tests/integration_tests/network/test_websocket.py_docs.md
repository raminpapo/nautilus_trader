# Documentation: test_websocket.py
...
### Functions
- **`_server_url()`**: Function defined in this file
...
**Functions**: `_server_url`
**Imports**: `aiohttp.test_utils`, `asyncio`, `msgspec`, `nautilus_trader.core.nautilus_pyo3`, `nautilus_trader.test_kit.functions`, `pytest`, `sys`
...
```bash
# For Python
pytest tests/integration_tests/network/test_websocket.py
...
---
*Generated on 2025-11-18T21:55:07.260445Z*
