# Documentation: test_cache_database_postgres.py

## File Metadata

- **Path**: `tests/integration_tests/infrastructure/test_cache_database_postgres.py`
- **Size**: 29,644 bytes
- **Lines**: 781
- **Language**: Python
...
### Classes
- **`TestCachePostgresAdapter`**: Class defined in this file
...
**Classs**: `TestCachePostgresAdapter`
**Imports**: `asyncio`, `nautilus_trader.cache.adapter`, `nautilus_trader.common.component`, `nautilus_trader.common.signal`, `nautilus_trader.core`, `nautilus_trader.core.nautilus_pyo3`, `nautilus_trader.core.uuid`, `nautilus_trader.model.data`, `nautilus_trader.model.enums`, `nautilus_trader.model.events`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.instruments`, `nautilus_trader.model.objects`, `nautilus_trader.model.position`, `nautilus_trader.portfolio.portfolio`, `nautilus_trader.test_kit.functions`, `nautilus_trader.test_kit.providers`, `nautilus_trader.test_kit.stubs.component`, `nautilus_trader.test_kit.stubs.data`, `nautilus_trader.test_kit.stubs.events`, `nautilus_trader.test_kit.stubs.execution`, `nautilus_trader.test_kit.stubs.identifiers`, `nautilus_trader.trading.strategy`, `os`, `pytest`, `sys`
...
```bash
# For Python
pytest tests/integration_tests/infrastructure/test_cache_database_postgres.py
...
---
*Generated on 2025-11-18T21:55:07.234094Z*
