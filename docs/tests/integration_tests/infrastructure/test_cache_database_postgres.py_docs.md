# Documentation: `tests/integration_tests/infrastructure/test_cache_database_postgres.py`
**Generated:** 2025-11-15T19:40:07.995163Z
...
This file is located at `tests/integration_tests/infrastructure/test_cache_database_postgres.py` within the repository.

**Classes defined:** TestCachePostgresAdapter

**Functions defined:** setup, teardown
...
```python
from tests.integration_tests.infrastructure.test_cache_database_postgres import TestCachePostgresAdapter
```
