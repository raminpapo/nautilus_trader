# Documentation: test_cache_database_redis.py

## File Metadata

- **Path**: `tests/integration_tests/infrastructure/test_cache_database_redis.py`
- **Size**: 37,920 bytes
- **Lines**: 1,220
- **Language**: Python
...
### Classes
- **`TestCacheDatabaseAdapter`**: Class defined in this file
- **`TestRedisCacheDatabaseIntegrity`**: Class defined in this file
...
**Classs**: `TestCacheDatabaseAdapter`, `TestRedisCacheDatabaseIntegrity`
**Imports**: `asyncio`, `decimal`, `msgspec`, `nautilus_trader.backtest.engine`, `nautilus_trader.cache.database`, `nautilus_trader.common.component`, `nautilus_trader.config`, `nautilus_trader.core.uuid`, `nautilus_trader.data.engine`, `nautilus_trader.examples.strategies.ema_cross`, `nautilus_trader.execution.engine`, `nautilus_trader.model.currencies`, `nautilus_trader.model.enums`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.objects`, `nautilus_trader.model.orders`, `nautilus_trader.model.position`, `nautilus_trader.persistence.wranglers`, `nautilus_trader.portfolio.portfolio`, `nautilus_trader.risk.engine`, `nautilus_trader.serialization.serializer`, `nautilus_trader.test_kit.functions`, `nautilus_trader.test_kit.mocks.actors`, `nautilus_trader.test_kit.mocks.strategies`, `nautilus_trader.test_kit.providers`, `nautilus_trader.test_kit.stubs.component`, `nautilus_trader.test_kit.stubs.data`, `nautilus_trader.test_kit.stubs.events`, `nautilus_trader.test_kit.stubs.execution`, `nautilus_trader.test_kit.stubs.identifiers` *(+4 more)*

## Related Files

This file is located in `tests/integration_tests/infrastructure/`. Related files may include:
...
```bash
# For Python
pytest tests/integration_tests/infrastructure/test_cache_database_redis.py
...
---
*Generated on 2025-11-18T21:55:07.239502Z*
