# Documentation: test_live_reconciliation.py

## File Metadata

- **Path**: `tests/integration_tests/live/test_live_reconciliation.py`
- **Size**: 67,497 bytes
- **Lines**: 2,062
- **Language**: Python
...
- **`fixture_order_factory()`**: Function defined in this file
...
**Functions**: `fixture_account_id`, `fixture_cache`, `fixture_clock`, `fixture_exec_client`, `fixture_exec_engine`, `fixture_instrument_provider`, `fixture_msgbus`, `fixture_order_factory`, `fixture_portfolio`, `fixture_strategy`, `fixture_trader_id`
**Imports**: `asyncio`, `decimal`, `nautilus_trader.common.component`, `nautilus_trader.common.factories`, `nautilus_trader.common.providers`, `nautilus_trader.config`, `nautilus_trader.core.uuid`, `nautilus_trader.execution.reports`, `nautilus_trader.live.execution_engine`, `nautilus_trader.model.currencies`, `nautilus_trader.model.enums`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.objects`, `nautilus_trader.portfolio.portfolio`, `nautilus_trader.test_kit.functions`, `nautilus_trader.test_kit.mocks.exec_clients`, `nautilus_trader.test_kit.providers`, `nautilus_trader.test_kit.stubs.component`, `nautilus_trader.test_kit.stubs.events`, `nautilus_trader.test_kit.stubs.identifiers`, `nautilus_trader.trading.strategy`, `pytest`, `unittest.mock`
...
```bash
# For Python
pytest tests/integration_tests/live/test_live_reconciliation.py
...
---
*Generated on 2025-11-18T21:55:07.251038Z*
