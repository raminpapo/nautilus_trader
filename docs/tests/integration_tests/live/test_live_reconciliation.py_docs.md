# Documentation: `tests/integration_tests/live/test_live_reconciliation.py`
**Generated:** 2025-11-15T19:40:08.007372Z
**File Size:** 67529 bytes
**Extension:** .py
**Type:** text
...
This file is located at `tests/integration_tests/live/test_live_reconciliation.py` within the repository.

**Functions defined:** fixture_clock, fixture_trader_id, fixture_account_id, fixture_msgbus, fixture_cache, fixture_portfolio, fixture_instrument_provider, fixture_exec_client, fixture_exec_engine, fixture_strategy and 1 more
...
#### `fixture_exec_engine(event_loop, msgbus, cache, clock, exec_client, portfolio)`


#### `fixture_strategy(trader_id, portfolio, msgbus, cache, clock)`


#### `fixture_order_factory(trader_id, strategy, clock)`
...
```python
from tests.integration_tests.live.test_live_reconciliation import fixture_clock
```
