# Documentation: `tests/mem_leak_tests/tracemalloc_quote_ticks.py`
**Generated:** 2025-11-15T19:40:08.032787Z
...
This file is located at `tests/mem_leak_tests/tracemalloc_quote_ticks.py` within the repository.
...
```python
from tests.mem_leak_tests.tracemalloc_quote_ticks import run_repr
```
