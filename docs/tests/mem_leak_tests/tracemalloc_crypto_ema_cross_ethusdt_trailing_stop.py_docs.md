# Documentation: tracemalloc_crypto_ema_cross_ethusdt_trailing_stop.py

## File Metadata

- **Path**: `tests/mem_leak_tests/tracemalloc_crypto_ema_cross_ethusdt_trailing_stop.py`
- **Size**: 4,305 bytes
- **Lines**: 114
- **Language**: Python
...
**Functions**: `run`
**Imports**: `decimal`, `nautilus_trader.backtest.engine`, `nautilus_trader.config`, `nautilus_trader.examples.strategies.ema_cross_trailing_stop`, `nautilus_trader.model.currencies`, `nautilus_trader.model.data`, `nautilus_trader.model.enums`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.objects`, `nautilus_trader.persistence.wranglers`, `nautilus_trader.test_kit.providers`, `tests.mem_leak_tests.conftest`
...
```bash
# For Python
pytest tests/mem_leak_tests/tracemalloc_crypto_ema_cross_ethusdt_trailing_stop.py
...
---
*Generated on 2025-11-18T21:55:07.273670Z*
