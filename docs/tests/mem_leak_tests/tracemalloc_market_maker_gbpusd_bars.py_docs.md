# Documentation: tracemalloc_market_maker_gbpusd_bars.py

## File Metadata

- **Path**: `tests/mem_leak_tests/tracemalloc_market_maker_gbpusd_bars.py`
- **Size**: 5,130 bytes
- **Lines**: 134
- **Language**: Python
...
**Functions**: `run`
**Imports**: `datetime`, `decimal`, `nautilus_trader.backtest.engine`, `nautilus_trader.backtest.models`, `nautilus_trader.backtest.modules`, `nautilus_trader.config`, `nautilus_trader.examples.strategies.volatility_market_maker`, `nautilus_trader.model.currencies`, `nautilus_trader.model.data`, `nautilus_trader.model.enums`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.objects`, `nautilus_trader.persistence.wranglers`, `nautilus_trader.test_kit.providers`, `tests.mem_leak_tests.conftest`
...
```bash
# For Python
pytest tests/mem_leak_tests/tracemalloc_market_maker_gbpusd_bars.py
...
---
*Generated on 2025-11-18T21:55:07.275250Z*
