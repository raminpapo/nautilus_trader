# Documentation: `tests/mem_leak_tests/tracemalloc_trade_ticks.py`
**Generated:** 2025-11-15T19:40:08.033843Z
...
- **Path:** `tests/mem_leak_tests/tracemalloc_trade_ticks.py`
- **Size:** 1,458 bytes
- **Lines:** 37
- **Extension:** `.py`
- **Type:** text
...
This file is located at `tests/mem_leak_tests/tracemalloc_trade_ticks.py` within the repository.
...
```python
from tests.mem_leak_tests.tracemalloc_trade_ticks import run_repr
```
