# Documentation: tracemalloc_orderbook_depth.py
...
**Imports**: `nautilus_trader.core`, `nautilus_trader.model.data`, `nautilus_trader.test_kit.stubs.data`, `tests.mem_leak_tests.conftest`
...
```bash
# For Python
pytest tests/mem_leak_tests/tracemalloc_orderbook_depth.py
...
---
*Generated on 2025-11-18T21:55:07.278820Z*
