# Documentation: `tests/mem_leak_tests/tracemalloc_orderbook_depth.py`
**Generated:** 2025-11-15T19:40:08.031654Z
...
- **Path:** `tests/mem_leak_tests/tracemalloc_orderbook_depth.py`
- **Size:** 1,531 bytes
- **Lines:** 37
- **Extension:** `.py`
- **Type:** text
...
This file is located at `tests/mem_leak_tests/tracemalloc_orderbook_depth.py` within the repository.
...
```python
from tests.mem_leak_tests.tracemalloc_orderbook_depth import run_repr
```
