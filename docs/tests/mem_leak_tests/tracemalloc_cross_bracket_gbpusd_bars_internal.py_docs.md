# Documentation: tracemalloc_cross_bracket_gbpusd_bars_internal.py

## File Metadata

- **Path**: `tests/mem_leak_tests/tracemalloc_cross_bracket_gbpusd_bars_internal.py`
- **Size**: 5,264 bytes
- **Lines**: 137
- **Language**: Python
...
**Functions**: `run`
**Imports**: `decimal`, `nautilus_trader.backtest.engine`, `nautilus_trader.backtest.models`, `nautilus_trader.backtest.modules`, `nautilus_trader.config`, `nautilus_trader.examples.strategies.ema_cross_bracket`, `nautilus_trader.model.currencies`, `nautilus_trader.model.data`, `nautilus_trader.model.enums`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.objects`, `nautilus_trader.persistence.wranglers`, `nautilus_trader.test_kit.providers`, `tests.mem_leak_tests.conftest`
...
```bash
# For Python
pytest tests/mem_leak_tests/tracemalloc_cross_bracket_gbpusd_bars_internal.py
...
---
*Generated on 2025-11-18T21:55:07.271893Z*
