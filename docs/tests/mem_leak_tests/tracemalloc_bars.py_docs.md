# Documentation: `tests/mem_leak_tests/tracemalloc_bars.py`
**Generated:** 2025-11-15T19:40:08.023494Z
...
This file is located at `tests/mem_leak_tests/tracemalloc_bars.py` within the repository.
...
```python
from tests.mem_leak_tests.tracemalloc_bars import run_repr
```
