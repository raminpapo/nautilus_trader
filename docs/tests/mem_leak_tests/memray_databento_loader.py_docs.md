# Documentation: memray_databento_loader.py
...
**Imports**: `nautilus_trader.adapters.databento.loaders`, `nautilus_trader.model.identifiers`, `tests.integration_tests.adapters.databento.test_loaders`
...
```bash
# For Python
pytest tests/mem_leak_tests/memray_databento_loader.py
...
---
*Generated on 2025-11-18T21:55:07.269419Z*
