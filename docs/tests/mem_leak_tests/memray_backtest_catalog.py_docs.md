# Documentation: memray_backtest_catalog.py
...
### Functions
- **`setup_catalog_with_data()`**: Function defined in this file
...
**Functions**: `setup_catalog_with_data`
**Imports**: `decimal`, `nautilus_trader.backtest.node`, `nautilus_trader.config`, `nautilus_trader.core.datetime`, `nautilus_trader.model.data`, `nautilus_trader.model.identifiers`, `nautilus_trader.persistence.catalog`, `nautilus_trader.persistence.wranglers`, `nautilus_trader.test_kit.providers`, `pathlib`, `shutil`, `tempfile`
...
```bash
# For Python
pytest tests/mem_leak_tests/memray_backtest_catalog.py
...
---
*Generated on 2025-11-18T21:55:07.267104Z*
