# Documentation: `tests/performance_tests/test_perf_orderbook.py`
**Generated:** 2025-11-15T19:40:08.052154Z
...
This file is located at `tests/performance_tests/test_perf_orderbook.py` within the repository.

**Functions defined:** test_orderbook_spy_xnas_itch_mbo_l3, _apply_deltas, test_own_book_audit
...
#### `test_orderbook_spy_xnas_itch_mbo_l3(benchmark)`


#### `_apply_deltas()`


#### `test_own_book_audit(benchmark)`
...
```python
from tests.performance_tests.test_perf_orderbook import test_orderbook_spy_xnas_itch_mbo_l3
```
