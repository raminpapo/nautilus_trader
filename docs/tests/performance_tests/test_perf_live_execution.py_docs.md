# Documentation: test_perf_live_execution.py
...
### Classes
- **`TestLiveExecutionPerformance`**: Class defined in this file
...
```bash
# For Python
pytest tests/performance_tests/test_perf_live_execution.py
...
---
*Generated on 2025-11-18T21:55:07.309637Z*
