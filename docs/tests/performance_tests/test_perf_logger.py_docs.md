# Documentation: test_perf_logger.py
...
### Functions
- **`test_logging()`**: Function defined in this file
...
**Functions**: `test_logging`
**Imports**: `nautilus_trader.common.component`, `nautilus_trader.common.enums`, `random`
...
```bash
# For Python
pytest tests/performance_tests/test_perf_logger.py
...
---
*Generated on 2025-11-18T21:55:07.311030Z*
