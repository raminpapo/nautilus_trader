# Documentation: test_perf_identifiers.py
...
**Functions**: `test_symbol_equality`, `test_venue_equality`
...
```bash
# For Python
pytest tests/performance_tests/test_perf_identifiers.py
...
---
*Generated on 2025-11-18T21:55:07.308192Z*
