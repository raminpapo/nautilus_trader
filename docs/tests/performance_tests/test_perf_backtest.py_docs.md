# Documentation: `tests/performance_tests/test_perf_backtest.py`
**Generated:** 2025-11-15T19:40:08.036917Z
...
This file is located at `tests/performance_tests/test_perf_backtest.py` within the repository.

**Functions defined:** test_run_with_empty_strategy, test_run_for_tick_processing, test_run_with_ema_cross_strategy
...
#### `test_run_with_empty_strategy(benchmark)`


#### `test_run_for_tick_processing(benchmark)`


#### `test_run_with_ema_cross_strategy(benchmark)`
...
```python
from tests.performance_tests.test_perf_backtest import test_run_with_empty_strategy
```
