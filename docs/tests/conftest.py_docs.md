# Documentation: `tests/conftest.py`
**Generated:** 2025-11-15T19:40:05.554707Z
...
This file is located at `tests/conftest.py` within the repository.

**Functions defined:** event_loop_policy, session_event_loop, pytest_pycollect_makeitem, _env_flag, verify_test_parquet_integrity, bypass_logging, event_loop_for_setup, fixture_audusd_instrument, fixture_data_provider, fixture_audusd_quote_ticks and 1 more
...
#### `session_event_loop(event_loop_policy)`


#### `pytest_pycollect_makeitem(collector, name, obj)`


#### `_env_flag(name: str, *, default: bool = False)`


#### `verify_test_parquet_integrity()`


#### `bypass_logging()`


#### `event_loop_for_setup(event_loop)`


#### `fixture_audusd_instrument()`


#### `fixture_data_provider()`


#### `fixture_audusd_quote_ticks(
    data_provider: TestDataProvider,
    audusd_instrument: CurrencyPair,
)`


#### `cleanup_event_loop_tasks(event_loop)`
...
```python
from tests.conftest import event_loop_policy
```
