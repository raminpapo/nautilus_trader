...
### Functions
- **`event_loop_policy()`**: Function defined in this file
- **`session_event_loop()`**: Function defined in this file
- **`pytest_pycollect_makeitem()`**: Function defined in this file
- **`_env_flag()`**: Function defined in this file
- **`verify_test_parquet_integrity()`**: Function defined in this file
- **`bypass_logging()`**: Function defined in this file
- **`event_loop_for_setup()`**: Function defined in this file
- **`fixture_audusd_instrument()`**: Function defined in this file
- **`fixture_data_provider()`**: Function defined in this file
- **`fixture_audusd_quote_ticks()`**: Function defined in this file
- **`cleanup_event_loop_tasks()`**: Function defined in this file
...
**Functions**: `_env_flag`, `bypass_logging`, `cleanup_event_loop_tasks`, `event_loop_for_setup`, `event_loop_policy`, `fixture_audusd_instrument`, `fixture_audusd_quote_ticks`, `fixture_data_provider`, `pytest_pycollect_makeitem`, `session_event_loop`, `verify_test_parquet_integrity`
**Imports**: `asyncio`, `inspect`, `nautilus_trader.common.component`, `nautilus_trader.common.enums`, `nautilus_trader.model.data`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.instruments`, `nautilus_trader.persistence.wranglers`, `nautilus_trader.test_kit.providers`, `os`, `pathlib`, `pytest`, `sys`

## Related Files

This file is located in `tests/`. Related files may include:
...
---
*Generated on 2025-11-18T21:55:06.186195Z*
