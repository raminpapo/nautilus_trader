# Documentation: test_bus.py

## File Metadata

- **Path**: `tests/unit_tests/msgbus/test_bus.py`
- **Size**: 14,772 bytes
- **Lines**: 582
- **Language**: Python
...
This file is part of the NautilusTrader repository. It defines 41 function(s).
...
- **`bus()`**: Function defined in this file
- **`test_instantiate_message_bus()`**: Function defined in this file
- **`test_endpoints_with_none_registered_returns_empty_list()`**: Function defined in this file
- **`test_topics_with_no_subscribers_returns_empty_list()`**: Function defined in this file
- **`test_subscriptions_with_no_subscribers_returns_empty_list()`**: Function defined in this file
- **`test_has_subscribers_with_no_subscribers_returns_false()`**: Function defined in this file
- **`test_register_adds_endpoint()`**: Function defined in this file
- **`test_deregister_removes_endpoint()`**: Function defined in this file
- **`test_send_when_no_endpoint_at_address_logs_error()`**: Function defined in this file
- **`test_send_when_endpoint_at_address_sends_message_to_handler()`**: Function defined in this file
- **`test_request_when_endpoint_not_registered_logs_error()`**: Function defined in this file
- **`test_request_response_when_correlation_id_registered_handles_response()`**: Function defined in this file
- **`test_subscribe_then_returns_topics_list_including_topic()`**: Function defined in this file
- **`test_has_subscribers_when_subscribers_returns_true()`**: Function defined in this file
- **`test_subscribe_when_handler_already_subscribed_does_not_add_subscription()`**: Function defined in this file
- **`test_subscribe_then_subscriptions_list_includes_handler()`**: Function defined in this file
- **`test_subscribe_to_all_then_subscriptions_list_includes_handler()`**: Function defined in this file
- **`test_subscribe_all_when_handler_already_subscribed_does_not_add_subscription()`**: Function defined in this file
...
**Functions**: `bus`, `clock`, `test_add_listener_receives_byte_messages`, `test_deregister_removes_endpoint`, `test_duplicate_request_id_not_processed`, `test_endpoints_with_none_registered_returns_empty_list`, `test_has_subscribers_when_subscribers_returns_true`, `test_has_subscribers_with_no_subscribers_returns_false`, `test_instantiate_message_bus`, `test_is_matching_given_various_topic_pattern_combos`, `test_is_subscribed_lifecycle`, `test_msgbus_for_system_events_using_component_id`, `test_publish_invokes_handlers_in_priority_order`, `test_publish_question_mark_pattern`, `test_publish_with_both_channel_and_all_sub_sends_to_subscribers`, `test_publish_with_header_sends_to_handler`, `test_publish_with_header_sends_to_handler_after_published`, `test_publish_with_matching_subset_header_then_sends_to_subscriber`, `test_publish_with_multiple_subscribers_sends_to_handlers`, `test_publish_with_no_subscribers_does_nothing`, `test_publish_with_none_matching_header_then_filters_from_subscriber`, `test_publish_with_subscriber_sends_to_handler`, `test_register_adds_endpoint`, `test_request_response_when_correlation_id_registered_handles_response`, `test_request_when_endpoint_not_registered_logs_error`, `test_send_when_endpoint_at_address_sends_message_to_handler`, `test_send_when_no_endpoint_at_address_logs_error`, `test_streaming_type_registration`, `test_subscribe_all_when_handler_already_subscribed_does_not_add_subscription`, `test_subscribe_prior_to_publish_then_receives_message_on_topic` *(+11 more)*
**Imports**: `nautilus_trader.common.component`, `nautilus_trader.core.message`, `nautilus_trader.core.uuid`, `nautilus_trader.test_kit.stubs.identifiers`, `pytest`
...
---
*Generated on 2025-11-18T21:55:11.691138Z*
