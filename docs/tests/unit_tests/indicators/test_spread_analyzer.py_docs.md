# Documentation: test_spread_analyzer.py
...
### Classes
- **`TestSpreadAnalyzer`**: Class defined in this file
...
**Classs**: `TestSpreadAnalyzer`
**Imports**: `nautilus_trader.indicators`, `nautilus_trader.model.data`, `nautilus_trader.model.objects`, `nautilus_trader.test_kit.providers`, `nautilus_trader.test_kit.stubs.data`, `pytest`
...
```bash
# For Python
pytest tests/unit_tests/indicators/test_spread_analyzer.py
...
---
*Generated on 2025-11-18T21:55:11.449109Z*
