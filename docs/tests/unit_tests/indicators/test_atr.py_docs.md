# Documentation: `tests/unit_tests/indicators/test_atr.py`
**Generated:** 2025-11-15T19:40:09.175551Z
...
This file is located at `tests/unit_tests/indicators/test_atr.py` within the repository.

**Classes defined:** TestAverageTrueRange

**Functions defined:** setup, test_name_returns_expected_string, test_str_repr_returns_expected_string, test_period, test_initialized_without_inputs_returns_false, test_initialized_with_required_inputs_returns_true, test_handle_bar_updates_indicator, test_value_with_no_inputs_returns_zero, test_value_with_epsilon_input, test_value_with_one_ones_input and 7 more
...
#### `test_value_with_no_inputs_returns_zero(self)`


#### `test_value_with_epsilon_input(self)`


#### `test_value_with_one_ones_input(self)`
...
#### `test_value_with_close_on_high(self)`


#### `test_value_with_close_on_low(self)`


#### `test_floor_with_ten_ones_inputs(self)`


#### `test_floor_with_exponentially_decreasing_high_inputs(self)`
...
```python
from tests.unit_tests.indicators.test_atr import TestAverageTrueRange
```
