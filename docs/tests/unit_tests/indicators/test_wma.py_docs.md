...
### Classes
- **`TestWeightedMovingAverage`**: Class defined in this file
...
**Classs**: `TestWeightedMovingAverage`
...
```bash
# For Python
pytest tests/unit_tests/indicators/test_wma.py
...
---
*Generated on 2025-11-18T21:55:11.459468Z*
