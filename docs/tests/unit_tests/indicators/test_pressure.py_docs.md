# Documentation: test_pressure.py
...
### Classes
- **`TestPressure`**: Class defined in this file
...
**Classs**: `TestPressure`
**Imports**: `nautilus_trader.indicators`, `nautilus_trader.test_kit.providers`, `nautilus_trader.test_kit.stubs.data`, `pytest`
...
```bash
# For Python
pytest tests/unit_tests/indicators/test_pressure.py
...
---
*Generated on 2025-11-18T21:55:11.440610Z*
