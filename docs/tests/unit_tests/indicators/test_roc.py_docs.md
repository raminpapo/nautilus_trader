# Documentation: `tests/unit_tests/indicators/test_roc.py`
**Generated:** 2025-11-15T19:40:09.205989Z
**File Size:** 4463 bytes
**Extension:** .py
**Type:** text
...
- **Path:** `tests/unit_tests/indicators/test_roc.py`
- **Size:** 4,463 bytes
- **Lines:** 146
- **Extension:** `.py`
- **Type:** text
...
This file is located at `tests/unit_tests/indicators/test_roc.py` within the repository.

**Classes defined:** TestRateOfChange

**Functions defined:** setup, test_name_returns_expected_string, test_str_repr_returns_expected_string, test_period, test_initialized_without_inputs_returns_false, test_initialized_with_required_inputs_returns_true, test_handle_bar_updates_indicator, test_value_with_one_input, test_value_with_efficient_higher_inputs, test_value_with_oscillating_inputs_returns_zero and 4 more
...
#### `test_log_returns_value_with_noisy_inputs(self)`
...
```python
from tests.unit_tests.indicators.test_roc import TestRateOfChange
```
