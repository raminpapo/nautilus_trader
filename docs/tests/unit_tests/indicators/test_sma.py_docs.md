# Documentation: `tests/unit_tests/indicators/test_sma.py`
**Generated:** 2025-11-15T19:40:09.209927Z
...
- **Path:** `tests/unit_tests/indicators/test_sma.py`
- **Size:** 5,492 bytes
- **Lines:** 176
- **Extension:** `.py`
- **Type:** text
...
This file is located at `tests/unit_tests/indicators/test_sma.py` within the repository.

**Classes defined:** TestSimpleMovingAverage
...
#### `test_handle_quote_tick_updates_with_expected_value(self)`


#### `test_handle_trade_tick_updates_with_expected_value(self)`
...
```python
from tests.unit_tests.indicators.test_sma import TestSimpleMovingAverage
```
