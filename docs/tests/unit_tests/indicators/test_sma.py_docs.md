...
### Classes
- **`TestSimpleMovingAverage`**: Class defined in this file
...
**Classs**: `TestSimpleMovingAverage`
...
```bash
# For Python
pytest tests/unit_tests/indicators/test_sma.py
...
---
*Generated on 2025-11-18T21:55:11.447782Z*
