# Documentation: `tests/unit_tests/indicators/test_bollinger_bands.py`
**Generated:** 2025-11-15T19:40:09.178354Z
...
- **Path:** `tests/unit_tests/indicators/test_bollinger_bands.py`
- **Size:** 4,794 bytes
- **Lines:** 146
- **Extension:** `.py`
- **Type:** text
...
This file is located at `tests/unit_tests/indicators/test_bollinger_bands.py` within the repository.

**Classes defined:** TestBollingerBands

**Functions defined:** test_name_returns_expected_name, test_str_repr_returns_expected_string, test_properties_after_instantiation, test_initialized_with_required_inputs_returns_true, test_handle_quote_tick_updates_indicator, test_handle_trade_tick_updates_indicator, test_handle_bar_updates_indicator, test_value_with_one_input_returns_expected_value, test_value_with_three_inputs_returns_expected_value, test_reset_successfully_returns_indicator_to_fresh_state
...
#### `test_properties_after_instantiation(self)`
...
```python
from tests.unit_tests.indicators.test_bollinger_bands import TestBollingerBands
```
