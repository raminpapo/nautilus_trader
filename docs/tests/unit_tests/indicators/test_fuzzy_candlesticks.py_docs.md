# Documentation: `tests/unit_tests/indicators/test_fuzzy_candlesticks.py`
**Generated:** 2025-11-15T19:40:09.191211Z
...
- **Path:** `tests/unit_tests/indicators/test_fuzzy_candlesticks.py`
- **Size:** 10,281 bytes
- **Lines:** 257
- **Extension:** `.py`
- **Type:** text
...
This file is located at `tests/unit_tests/indicators/test_fuzzy_candlesticks.py` within the repository.

**Classes defined:** TestFuzzyCandlesticks

**Functions defined:** setup, test_fuzzy_candle_equality, test_fuzzy_str_and_repr, test_name_returns_expected_name, test_str_returns_expected_string, test_period_returns_expected_value, test_handle_bar_updates_indicator, test_values_with_doji_bars_returns_expected_results, test_values_with_stub_bars_returns_expected_results, test_values_with_down_market_returns_expected_results and 4 more
...
#### `test_fuzzy_candle_equality(self)`


#### `test_fuzzy_str_and_repr(self)`


#### `test_name_returns_expected_name(self)`


#### `test_str_returns_expected_string(self)`
...
#### `test_values_with_doji_bars_returns_expected_results(self)`


#### `test_values_with_stub_bars_returns_expected_results(self)`


#### `test_values_with_down_market_returns_expected_results(self)`


#### `test_reset_successfully_returns_indicator_to_fresh_state(self)`


#### `test_body_percent_calculation_issue(self)`


#### `test_length_indexing_issue(self)`


#### `test_doji_bar_body_zero_issue(self)`
...
```python
from tests.unit_tests.indicators.test_fuzzy_candlesticks import TestFuzzyCandlesticks
```
