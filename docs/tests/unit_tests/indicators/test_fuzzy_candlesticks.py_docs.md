# Documentation: test_fuzzy_candlesticks.py
...
### Classes
- **`TestFuzzyCandlesticks`**: Class defined in this file
...
**Classs**: `TestFuzzyCandlesticks`
**Imports**: `nautilus_trader.indicators`, `nautilus_trader.test_kit.providers`, `nautilus_trader.test_kit.stubs.data`, `numpy`
...
```bash
# For Python
pytest tests/unit_tests/indicators/test_fuzzy_candlesticks.py
...
---
*Generated on 2025-11-18T21:55:11.426795Z*
