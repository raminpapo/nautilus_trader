# Documentation: `tests/unit_tests/indicators/test_ma_factory.py`
**Generated:** 2025-11-15T19:40:09.199200Z
...
This file is located at `tests/unit_tests/indicators/test_ma_factory.py` within the repository.

**Classes defined:** TestMaFactory

**Functions defined:** test_simple_returns_expected_indicator, test_exponential_returns_expected_indicator, test_hull_returns_expected_indicator, test_weighted_returns_expected_indicator, test_wilde_returns_expected_indicator, test_double_exponential_returns_expected_indicator, test_variable_index_dynamic_returns_expected_indicator
...
#### `test_simple_returns_expected_indicator(self)`


#### `test_exponential_returns_expected_indicator(self)`


#### `test_hull_returns_expected_indicator(self)`


#### `test_weighted_returns_expected_indicator(self)`


#### `test_wilde_returns_expected_indicator(self)`


#### `test_double_exponential_returns_expected_indicator(self)`


#### `test_variable_index_dynamic_returns_expected_indicator(self)`
...
```python
from tests.unit_tests.indicators.test_ma_factory import TestMaFactory
```
