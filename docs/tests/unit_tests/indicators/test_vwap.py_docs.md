...
### Classes
- **`TestVolumeWeightedAveragePrice`**: Class defined in this file
...
**Classs**: `TestVolumeWeightedAveragePrice`
**Imports**: `datetime`, `nautilus_trader.indicators`, `nautilus_trader.test_kit.providers`, `nautilus_trader.test_kit.stubs.data`, `pytest`
...
```bash
# For Python
pytest tests/unit_tests/indicators/test_vwap.py
...
---
*Generated on 2025-11-18T21:55:11.457826Z*
