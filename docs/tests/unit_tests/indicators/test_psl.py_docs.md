...
### Classes
- **`TestPsychologicalLine`**: Class defined in this file
...
```bash
# For Python
pytest tests/unit_tests/indicators/test_psl.py
...
---
*Generated on 2025-11-18T21:55:11.441977Z*
