...
### Classes
- **`TestOnBalanceVolume`**: Class defined in this file
...
```bash
# For Python
pytest tests/unit_tests/indicators/test_obv.py
...
---
*Generated on 2025-11-18T21:55:11.439123Z*
