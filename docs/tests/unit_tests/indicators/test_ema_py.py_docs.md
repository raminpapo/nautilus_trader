# Documentation: `tests/unit_tests/indicators/test_ema_py.py`
**Generated:** 2025-11-15T19:40:09.189408Z
**File Size:** 4330 bytes
**Extension:** .py
**Type:** text
...
- **Path:** `tests/unit_tests/indicators/test_ema_py.py`
- **Size:** 4,330 bytes
- **Lines:** 134
- **Extension:** `.py`
- **Type:** text
...
This file is located at `tests/unit_tests/indicators/test_ema_py.py` within the repository.

**Classes defined:** TestExponentialMovingAverage

**Functions defined:** setup, test_name_returns_expected_string, test_str_repr_returns_expected_string, test_period_returns_expected_value, test_multiplier_returns_expected_value, test_initialized_without_inputs_returns_false, test_initialized_with_required_inputs_returns_true, test_handle_quote_tick_updates_indicator, test_handle_trade_tick_updates_indicator, test_handle_bar_updates_indicator and 3 more
...
#### `test_multiplier_returns_expected_value(self)`
...
```python
from tests.unit_tests.indicators.test_ema_py import TestExponentialMovingAverage
```
