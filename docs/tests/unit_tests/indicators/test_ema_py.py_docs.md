...
### Classes
- **`TestExponentialMovingAverage`**: Class defined in this file
...
**Classs**: `TestExponentialMovingAverage`
**Imports**: `nautilus_trader.examples.indicators.ema_python`, `nautilus_trader.model.enums`, `nautilus_trader.test_kit.providers`, `nautilus_trader.test_kit.stubs.data`
...
```bash
# For Python
pytest tests/unit_tests/indicators/test_ema_py.py
...
---
*Generated on 2025-11-18T21:55:11.424891Z*
