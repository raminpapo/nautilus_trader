...
### Classes
- **`TestSwings`**: Class defined in this file
...
**Classs**: `TestSwings`
**Imports**: `nautilus_trader.indicators`, `nautilus_trader.model.data`, `nautilus_trader.model.enums`, `nautilus_trader.model.objects`, `nautilus_trader.test_kit.stubs.data`, `nautilus_trader.test_kit.stubs.identifiers`
...
```bash
# For Python
pytest tests/unit_tests/indicators/test_swings.py
...
---
*Generated on 2025-11-18T21:55:11.452306Z*
