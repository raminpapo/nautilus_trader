# Documentation: `tests/unit_tests/indicators/test_donchian_channel.py`
**Generated:** 2025-11-15T19:40:09.184950Z
...
- **Path:** `tests/unit_tests/indicators/test_donchian_channel.py`
- **Size:** 4,386 bytes
- **Lines:** 134
- **Extension:** `.py`
- **Type:** text
...
This file is located at `tests/unit_tests/indicators/test_donchian_channel.py` within the repository.

**Classes defined:** TestDonchianChannel

**Functions defined:** setup, test_name_returns_expected_name, test_str_repr_returns_expected_string, test_period_returns_expected_value, test_initialized_without_inputs_returns_false, test_initialized_with_required_inputs_returns_true, test_handle_quote_tick_updates_indicator, test_handle_trade_tick_updates_indicator, test_handle_bar_updates_indicator, test_value_with_one_input_returns_expected_value and 2 more
...
```python
from tests.unit_tests.indicators.test_donchian_channel import TestDonchianChannel
```
