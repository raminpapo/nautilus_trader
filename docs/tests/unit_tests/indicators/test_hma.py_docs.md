# Documentation: `tests/unit_tests/indicators/test_hma.py`
**Generated:** 2025-11-15T19:40:09.192686Z
**File Size:** 4391 bytes
**Extension:** .py
**Type:** text
...
- **Path:** `tests/unit_tests/indicators/test_hma.py`
- **Size:** 4,391 bytes
- **Lines:** 137
- **Extension:** `.py`
- **Type:** text
...
This file is located at `tests/unit_tests/indicators/test_hma.py` within the repository.

**Classes defined:** TestHullMovingAverage

**Functions defined:** setup, test_name_returns_expected_string, test_str_repr_returns_expected_string, test_initialized_with_required_inputs_returns_true, test_handle_quote_tick_updates_indicator, test_handle_trade_tick_updates_indicator, test_handle_bar_updates_indicator, test_value_with_one_input_returns_expected_value, test_value_with_three_inputs_returns_expected_value, test_value_with_ten_inputs_returns_expected_value and 1 more
...
```python
from tests.unit_tests.indicators.test_hma import TestHullMovingAverage
```
