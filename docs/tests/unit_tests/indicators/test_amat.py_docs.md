...
### Classes
- **`TestArcherMovingAveragesTrends`**: Class defined in this file
...
**Classs**: `TestArcherMovingAveragesTrends`
...
```bash
# For Python
pytest tests/unit_tests/indicators/test_amat.py
...
---
*Generated on 2025-11-18T21:55:11.408305Z*
