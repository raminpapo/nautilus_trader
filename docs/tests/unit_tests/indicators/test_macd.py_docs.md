...
### Classes
- **`TestMovingAverageConvergenceDivergence`**: Class defined in this file
...
**Classs**: `TestMovingAverageConvergenceDivergence`
**Imports**: `nautilus_trader.indicators`, `nautilus_trader.model.enums`, `nautilus_trader.test_kit.providers`, `nautilus_trader.test_kit.stubs.data`, `pytest`
...
```bash
# For Python
pytest tests/unit_tests/indicators/test_macd.py
...
---
*Generated on 2025-11-18T21:55:11.437665Z*
