# Documentation: `tests/unit_tests/trading/test_strategy.py`
**Generated:** 2025-11-15T19:40:09.510965Z
**File Size:** 65269 bytes
**Extension:** .py
**Type:** text
...
- **Path:** `tests/unit_tests/trading/test_strategy.py`
- **Size:** 65,269 bytes
- **Lines:** 2,061
- **Extension:** `.py`
- **Type:** text
...
This file is located at `tests/unit_tests/trading/test_strategy.py` within the repository.

**Classes defined:** TestStrategy

**Functions defined:** setup, test_strategy_to_importable_config_with_no_specific_config, test_strategy_to_importable_config, test_strategy_equality, test_str_and_repr, test_id, test_initialization, test_on_save_when_not_overridden_does_nothing, test_on_load_when_not_overridden_does_nothing, test_save_when_not_registered_logs_error and 54 more
...
#### `test_strategy_to_importable_config_with_no_specific_config(self)`


#### `test_strategy_to_importable_config(self)`


#### `test_strategy_equality(self)`
...
#### `test_on_save_when_not_overridden_does_nothing(self)`


#### `test_on_load_when_not_overridden_does_nothing(self)`


#### `test_save_when_not_registered_logs_error(self)`


#### `test_save_when_user_code_raises_error_logs_and_reraises(self)`


#### `test_load_when_user_code_raises_error_logs_and_reraises(self)`
...
#### `test_dispose_cancels_all_timers(self)`


#### `test_save_load(self)`


#### `test_register_indicator_for_quote_ticks_when_already_registered(self)`


#### `test_register_indicator_for_trade_ticks_when_already_registered(self)`


#### `test_register_indicator_for_bars_when_already_registered(self)`


#### `test_register_indicator_for_multiple_data_sources(self)`


#### `test_handle_quote_tick_updates_indicator_registered_for_quote_ticks(self)`


#### `test_handle_quote_ticks_with_no_ticks_logs_and_continues(self)`


#### `test_handle_quote_ticks_updates_indicator_registered_for_quote_ticks(self)`


#### `test_handle_trade_tick_updates_indicator_registered_for_trade_ticks(self)`


#### `test_handle_trade_ticks_updates_indicator_registered_for_trade_ticks(self)`


#### `test_handle_trade_ticks_with_no_ticks_logs_and_continues(self)`


#### `test_handle_bar_updates_indicator_registered_for_bars(self)`


#### `test_handle_bars_updates_indicator_registered_for_bars(self)`


#### `test_handle_bars_with_no_bars_logs_and_continues(self)`


#### `test_stop_cancels_a_running_time_alert(self)`


#### `test_stop_cancels_a_running_timer(self)`


#### `test_start_when_manage_gtd_reactivates_timers(self)`


#### `test_start_when_manage_gtd_and_order_past_expiration_then_cancels(self)`


#### `test_submit_order_when_duplicate_id_then_denies(self)`


#### `test_submit_order_with_valid_order_successfully_submits(self)`


#### `test_submit_order_with_managed_gtd_starts_timer(self)`


#### `test_submit_order_with_managed_gtd_when_immediately_filled_cancels_timer(self)`


#### `test_submit_order_list_with_duplicate_order_list_id_then_denies(self)`


#### `test_submit_order_list_with_duplicate_order_id_then_denies(self)`


#### `test_submit_order_list_with_valid_order_successfully_submits(self)`


#### `test_submit_order_list_with_managed_gtd_starts_timer(self)`


#### `test_submit_order_list_with_managed_gtd_when_immediately_filled_cancels_timer(self)`


#### `test_cancel_gtd_expiry(self)`


#### `test_cancel_order(self)`


#### `test_cancel_order_when_pending_cancel_does_not_submit_command(self)`


#### `test_cancel_order_when_closed_does_not_submit_command(self)`


#### `test_modify_order_when_pending_cancel_does_not_submit_command(self)`


#### `test_modify_order_when_closed_does_not_submit_command(self)`


#### `test_modify_order_when_no_changes_does_not_submit_command(self)`
...
```python
from tests.unit_tests.trading.test_strategy import TestStrategy
```
