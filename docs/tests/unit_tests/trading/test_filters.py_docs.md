# Documentation: `tests/unit_tests/trading/test_filters.py`
**Generated:** 2025-11-15T19:40:09.504888Z
...
- **Path:** `tests/unit_tests/trading/test_filters.py`
- **Size:** 9,328 bytes
- **Lines:** 248
- **Extension:** `.py`
- **Type:** text
...
This file is located at `tests/unit_tests/trading/test_filters.py` within the repository.

**Classes defined:** TestForexSessionFilter, TestEconomicNewsEventFilter

**Functions defined:** test_local_from_utc_given_various_sessions_returns_expected_datetime, test_next_start_given_various_sessions_returns_expected_datetime, test_next_start_on_weekend_returns_expected_datetime_monday, test_next_in_session_returns_expected_datetime_next_day, test_prev_start_given_various_sessions_returns_expected_datetime, test_next_end_given_various_sessions_returns_expected_datetime, test_prev_end_given_various_sessions_returns_expected_datetime, setup, test_initialize_filter, test_initialize_filter_with_no_currencies_or_impacts_returns_none and 6 more
...
#### `TestForexSessionFilter`


#### `TestEconomicNewsEventFilter`


### Functions

#### `test_local_from_utc_given_various_sessions_returns_expected_datetime(
        self,
        session,
        expected,
    )`
...
#### `test_next_start_given_various_sessions_returns_expected_datetime(self, session, expected)`


#### `test_next_start_on_weekend_returns_expected_datetime_monday(self)`


#### `test_next_in_session_returns_expected_datetime_next_day(self)`


#### `test_prev_start_given_various_sessions_returns_expected_datetime(self, session, expected)`


#### `test_next_end_given_various_sessions_returns_expected_datetime(self, session, expected)`


#### `test_prev_end_given_various_sessions_returns_expected_datetime(self, session, expected)`


#### `setup(self)`


#### `test_initialize_filter(self)`


#### `test_initialize_filter_with_no_currencies_or_impacts_returns_none(self)`


#### `test_next_event_given_time_now_before_data_raises_value_error(self)`


#### `test_next_event_given_time_now_after_data_raises_value_error(self)`


#### `test_prev_event_given_time_now_before_data_raises_value_error(self)`


#### `test_prev_event_given_time_now_after_data_raises_value_error(self)`


#### `test_next_event_given_valid_date_returns_expected_news_event(self)`


#### `test_prev_event_given_valid_date_returns_expected_news_event(self)`
...
```python
from tests.unit_tests.trading.test_filters import TestForexSessionFilter
```
