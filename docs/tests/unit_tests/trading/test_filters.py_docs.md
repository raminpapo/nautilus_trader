...
### Classes
- **`TestForexSessionFilter`**: Class defined in this file
- **`TestEconomicNewsEventFilter`**: Class defined in this file
...
**Classs**: `TestEconomicNewsEventFilter`, `TestForexSessionFilter`
**Imports**: `datetime`, `nautilus_trader`, `nautilus_trader.core`, `nautilus_trader.core.datetime`, `nautilus_trader.trading.filters`, `pandas`, `pytest`, `pytz`
...
```bash
# For Python
pytest tests/unit_tests/trading/test_filters.py
...
---
*Generated on 2025-11-18T21:55:11.790393Z*
