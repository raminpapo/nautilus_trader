# Documentation: `tests/unit_tests/trading/test_trader.py`
**Generated:** 2025-11-15T19:40:09.514209Z
**File Size:** 17419 bytes
**Extension:** .py
**Type:** text
...
- **Path:** `tests/unit_tests/trading/test_trader.py`
- **Size:** 17,419 bytes
- **Lines:** 540
- **Extension:** `.py`
- **Type:** text
...
This file is located at `tests/unit_tests/trading/test_trader.py` within the repository.

**Classes defined:** TestTrader

**Functions defined:** setup, test_initialize_trader, test_add_strategy, test_start_actor_when_not_exists, test_start_actor, test_start_actor_when_already_started, test_stop_actor, test_stop_actor_when_already_stopped, test_remove_actor, test_start_strategy_when_not_exists and 21 more
...
#### `test_initialize_trader(self)`


#### `test_add_strategy(self)`


#### `test_start_actor_when_not_exists(self)`


#### `test_start_actor(self)`


#### `test_start_actor_when_already_started(self)`


#### `test_stop_actor(self)`


#### `test_stop_actor_when_already_stopped(self)`


#### `test_remove_actor(self)`


#### `test_start_strategy_when_not_exists(self)`


#### `test_start_strategy(self)`


#### `test_start_strategy_when_already_started(self)`


#### `test_stop(self)`


#### `test_stop_strategy_when_already_stopped(self)`


#### `test_remove_strategy(self)`


#### `test_add_strategies_with_no_order_id_tags(self)`


#### `test_add_strategies_with_duplicate_order_id_tags_raises_runtime_error(self)`


#### `test_add_strategies(self)`
...
#### `test_add_actors(self)`


#### `test_clear_actors(self)`


#### `test_get_strategy_states(self)`


#### `test_add_exec_algorithm(self)`


#### `test_change_exec_algorithms(self)`


#### `test_clear_exec_algorithms(self)`


#### `test_change_strategies(self)`


#### `test_start_a_trader(self)`


#### `test_stop_a_running_trader(self)`


#### `test_subscribe_to_msgbus_topic_adds_subscription(self)`


#### `test_unsubscribe_from_msgbus_topic_removes_subscription(self)`
...
```python
from tests.unit_tests.trading.test_trader import TestTrader
```
