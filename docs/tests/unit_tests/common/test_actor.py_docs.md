# Documentation: `tests/unit_tests/common/test_actor.py`
**Generated:** 2025-11-15T19:40:09.036381Z
**File Size:** 81235 bytes
**Extension:** .py
**Type:** text
...
- **Path:** `tests/unit_tests/common/test_actor.py`
- **Size:** 81,235 bytes
- **Lines:** 2,715
- **Extension:** `.py`
- **Type:** text
...
This file is located at `tests/unit_tests/common/test_actor.py` within the repository.

**Classes defined:** TestActor

**Functions defined:** _create_composite_bar_type, setup_method, test_actor_fully_qualified_name, test_id, test_pre_initialization, test_initialization, test_register_warning_event, test_deregister_warning_event, test_handle_event, test_on_start_when_not_overridden_does_nothing and 126 more
...
#### `_create_composite_bar_type()`


#### `setup_method(self, tmp_path)`


#### `test_actor_fully_qualified_name(self)`


#### `test_id(self)`


#### `test_pre_initialization(self)`


#### `test_initialization(self)`


#### `test_register_warning_event(self)`


#### `test_deregister_warning_event(self)`


#### `test_handle_event(self)`


#### `test_on_start_when_not_overridden_does_nothing(self)`


#### `test_on_stop_when_not_overridden_does_nothing(self)`


#### `test_on_resume_when_not_overridden_does_nothing(self)`


#### `test_on_reset_when_not_overridden_does_nothing(self)`


#### `test_on_dispose_when_not_overridden_does_nothing(self)`


#### `test_on_degrade_when_not_overridden_does_nothing(self)`


#### `test_on_fault_when_not_overridden_does_nothing(self)`


#### `test_on_instrument_when_not_overridden_does_nothing(self)`


#### `test_on_order_book_when_not_overridden_does_nothing(self)`


#### `test_on_order_book_delta_when_not_overridden_does_nothing(self)`


#### `test_on_instrument_status_when_not_overridden_does_nothing(self)`


#### `test_on_event_when_not_overridden_does_nothing(self)`


#### `test_on_quote_tick_when_not_overridden_does_nothing(self)`


#### `test_on_trade_tick_when_not_overridden_does_nothing(self)`


#### `test_on_bar_when_not_overridden_does_nothing(self)`


#### `test_on_historical_data_when_not_overridden_does_nothing(self)`


#### `test_on_data_when_not_overridden_does_nothing(self)`


#### `test_on_signal_when_not_overridden_does_nothing(self)`


#### `test_start_when_invalid_state_does_not_start(self)`


#### `test_stop_when_invalid_state_does_not_stop(self)`


#### `test_resume_when_invalid_state_does_not_resume(self)`


#### `test_reset_when_invalid_state_does_not_reset(self)`


#### `test_dispose_when_invalid_state_does_not_dispose(self)`


#### `test_degrade_when_invalid_state_does_not_degrade(self)`


#### `test_fault_when_invalid_state_does_not_fault(self)`


#### `test_start_when_user_code_raises_error_logs_and_reraises(self)`


#### `test_stop_when_user_code_raises_error_logs_and_reraises(self)`


#### `test_resume_when_user_code_raises_error_logs_and_reraises(self)`


#### `test_reset_when_user_code_raises_error_logs_and_reraises(self)`


#### `test_dispose_when_user_code_raises_error_logs_and_reraises(self)`


#### `test_degrade_when_user_code_raises_error_logs_and_reraises(self)`


#### `test_fault_when_user_code_raises_error_logs_and_reraises(self)`


#### `test_handle_quote_tick_when_user_code_raises_exception_logs_and_reraises(self)`


#### `test_handle_trade_tick_when_user_code_raises_exception_logs_and_reraises(self)`


#### `test_handle_bar_when_user_code_raises_exception_logs_and_reraises(self)`


#### `test_handle_data_when_user_code_raises_exception_logs_and_reraises(self)`


#### `test_handle_event_when_user_code_raises_exception_logs_and_reraises(self)`
...
```python
from tests.unit_tests.common.test_actor import TestActor
```
