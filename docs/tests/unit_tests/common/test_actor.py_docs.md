...
### Functions
- **`_create_composite_bar_type()`**: Function defined in this file

### Classes
- **`TestActor`**: Class defined in this file
...
**Classs**: `TestActor`
**Functions**: `_create_composite_bar_type`
**Imports**: `datetime`, `nautilus_trader.backtest.data_client`, `nautilus_trader.common.actor`, `nautilus_trader.common.component`, `nautilus_trader.common.enums`, `nautilus_trader.common.executor`, `nautilus_trader.common.messages`, `nautilus_trader.common.signal`, `nautilus_trader.config`, `nautilus_trader.core.data`, `nautilus_trader.core.message`, `nautilus_trader.core.uuid`, `nautilus_trader.data.engine`, `nautilus_trader.data.messages`, `nautilus_trader.execution.engine`, `nautilus_trader.model.currencies`, `nautilus_trader.model.data`, `nautilus_trader.model.enums`, `nautilus_trader.model.events`, `nautilus_trader.model.identifiers`, `nautilus_trader.persistence.writer`, `nautilus_trader.portfolio.portfolio`, `nautilus_trader.test_kit.mocks.actors`, `nautilus_trader.test_kit.mocks.data`, `nautilus_trader.test_kit.providers`, `nautilus_trader.test_kit.stubs.component`, `nautilus_trader.test_kit.stubs.data`, `nautilus_trader.test_kit.stubs.events`, `nautilus_trader.test_kit.stubs.execution`, `nautilus_trader.test_kit.stubs.identifiers` *(+2 more)*
...
```bash
# For Python
pytest tests/unit_tests/common/test_actor.py
...
---
*Generated on 2025-11-18T21:55:11.256247Z*
