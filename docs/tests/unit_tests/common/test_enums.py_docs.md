...
### Classes
- **`TestComponentState`**: Class defined in this file
- **`TestComponentTrigger`**: Class defined in this file
...
**Classs**: `TestComponentState`, `TestComponentTrigger`
**Imports**: `nautilus_trader.common.enums`, `pytest`
...
```bash
# For Python
pytest tests/unit_tests/common/test_enums.py
...
---
*Generated on 2025-11-18T21:55:11.268570Z*
