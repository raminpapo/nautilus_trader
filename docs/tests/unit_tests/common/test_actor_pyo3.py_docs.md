# Documentation: test_actor_pyo3.py

## File Metadata

- **Path**: `tests/unit_tests/common/test_actor_pyo3.py`
- **Size**: 15,151 bytes
- **Lines**: 474
- **Language**: Python
...
This file is part of the NautilusTrader repository. It defines 26 function(s).
...
- **`bar_specification()`**: Function defined in this file
- **`bar_type()`**: Function defined in this file
- **`data_type()`**: Function defined in this file
- **`test_actor_creation()`**: Function defined in this file
- **`test_actor_inheritance()`**: Function defined in this file
- **`test_inheritance_preserves_functionality()`**: Function defined in this file
- **`test_efficient_rust_implementation()`**: Function defined in this file
- **`test_unregistered_actor_properties_work()`**: Function defined in this file
- **`test_subscription_methods_exist()`**: Function defined in this file
- **`test_lifecycle_methods_exist_on_instance()`**: Function defined in this file
- **`test_subscription_method_signatures_exist()`**: Function defined in this file
- **`test_specialized_subscription_methods_exist()`**: Function defined in this file
- **`test_request_methods_exist()`**: Function defined in this file
- **`test_unsubscribe_methods_exist()`**: Function defined in this file
- **`test_shutdown_system_method_exists()`**: Function defined in this file
...
**Functions**: `bar_specification`, `bar_type`, `client_id`, `data_type`, `instrument_id`, `symbol`, `test_actor_creation`, `test_actor_inheritance`, `test_all_request_methods_match_legacy_api`, `test_all_subscription_methods_match_legacy_api`, `test_api_style_consistency_with_legacy`, `test_efficient_rust_implementation`, `test_inheritance_preserves_functionality`, `test_lifecycle_methods_exist_on_instance`, `test_method_signatures_compatible`, `test_request_methods_exist`, `test_shutdown_system_method_exists`, `test_specialized_subscription_methods_exist`, `test_subscribe_book_at_interval_invalid_interval_raises_error`, `test_subscription_method_signatures_exist`, `test_subscription_methods_exist`, `test_unregistered_actor_properties_work`, `test_unsubscribe_book_at_interval_invalid_interval_raises_error`, `test_unsubscribe_methods_exist`, `trader_id`, `venue`
**Imports**: `nautilus_trader.core.nautilus_pyo3`, `pytest`
...
```bash
# For Python
pytest tests/unit_tests/common/test_actor_pyo3.py
...
---
*Generated on 2025-11-18T21:55:11.259031Z*
