# Documentation: `tests/unit_tests/common/test_actor_pyo3.py`
**Generated:** 2025-11-15T19:40:09.039413Z
**File Size:** 15151 bytes
**Extension:** .py
**Type:** text
...
This file is located at `tests/unit_tests/common/test_actor_pyo3.py` within the repository.

**Classes defined:** TestDataActorImplementation, MyDataActor

**Functions defined:** trader_id, client_id, venue, symbol, instrument_id, bar_specification, bar_type, data_type, test_actor_creation, test_actor_inheritance and 22 more
...
#### `TestDataActorImplementation`

**Inherits from:** DataActor
...
#### `bar_type(instrument_id, bar_specification)`
...
#### `test_inheritance_preserves_functionality()`
...
#### `test_efficient_rust_implementation()`


#### `test_unregistered_actor_properties_work()`


#### `test_subscription_methods_exist(venue, instrument_id, data_type)`


#### `test_lifecycle_methods_exist_on_instance()`


#### `test_subscription_method_signatures_exist(venue, instrument_id, data_type, client_id, bar_type)`


#### `test_specialized_subscription_methods_exist(instrument_id, client_id)`


#### `test_request_methods_exist(instrument_id, client_id, data_type)`


#### `test_unsubscribe_methods_exist(client_id, data_type)`


#### `test_shutdown_system_method_exists()`


#### `test_subscribe_book_at_interval_invalid_interval_raises_error(instrument_id, client_id)`


#### `test_unsubscribe_book_at_interval_invalid_interval_raises_error(instrument_id, client_id)`


#### `test_all_subscription_methods_match_legacy_api()`


#### `test_all_request_methods_match_legacy_api()`


#### `test_method_signatures_compatible(instrument_id, client_id, data_type)`


#### `test_api_style_consistency_with_legacy()`
...
```python
from tests.unit_tests.common.test_actor_pyo3 import TestDataActorImplementation
```
