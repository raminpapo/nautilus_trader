# Documentation: `tests/unit_tests/common/test_factories.py`
**Generated:** 2025-11-15T19:40:09.053944Z
...
- **Path:** `tests/unit_tests/common/test_factories.py`
- **Size:** 5,421 bytes
- **Lines:** 156
- **Extension:** `.py`
- **Type:** text
...
This file is located at `tests/unit_tests/common/test_factories.py` within the repository.

**Classes defined:** TestOrderFactory

**Functions defined:** setup, test_counts, test_generate_client_order_id, test_generate_uuid_client_order_id, test_generate_client_order_id_with_hyphens_removed, test_generate_uuid_client_order_id_with_hyphens_removed, test_generate_order_list_id, test_set_client_order_id_count, test_set_order_list_id_count, test_create_list
...
#### `test_generate_client_order_id(self)`


#### `test_generate_uuid_client_order_id(self)`


#### `test_generate_client_order_id_with_hyphens_removed(self)`


#### `test_generate_uuid_client_order_id_with_hyphens_removed(self)`


#### `test_generate_order_list_id(self)`


#### `test_set_client_order_id_count(self)`


#### `test_set_order_list_id_count(self)`


#### `test_create_list(self)`
