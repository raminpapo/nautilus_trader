...
### Classes
- **`TestOrderFactory`**: Class defined in this file
...
**Classs**: `TestOrderFactory`
**Imports**: `nautilus_trader.common.component`, `nautilus_trader.common.factories`, `nautilus_trader.model.enums`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.objects`, `nautilus_trader.test_kit.providers`, `nautilus_trader.test_kit.stubs.identifiers`
...
```bash
# For Python
pytest tests/unit_tests/common/test_factories.py
...
---
*Generated on 2025-11-18T21:55:11.273833Z*
