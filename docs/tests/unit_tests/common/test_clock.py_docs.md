# Documentation: `tests/unit_tests/common/test_clock.py`
**Generated:** 2025-11-15T19:40:09.043555Z
**File Size:** 34434 bytes
**Extension:** .py
**Type:** text
...
- **Path:** `tests/unit_tests/common/test_clock.py`
- **Size:** 34,434 bytes
- **Lines:** 1,115
- **Extension:** `.py`
- **Type:** text
...
This file is located at `tests/unit_tests/common/test_clock.py` within the repository.

**Classes defined:** TestTestClock, TestLiveClock

**Functions defined:** setup, teardown, test_instantiated_clock, test_utc_now_when_no_time_set, test_utc_now_when_time_set, test_local_now, test_set_time_alert_advance_clock_within_next_alert, test_set_time_alert_advance_clock_beyond_next_alert_yields_event, test_cancel_time_alert, test_set_multiple_time_alerts and 58 more
...
#### `test_instantiated_clock(self)`


#### `test_utc_now_when_no_time_set(self)`


#### `test_utc_now_when_time_set(self)`


#### `test_local_now(self)`


#### `test_set_time_alert_advance_clock_within_next_alert(self)`


#### `test_set_time_alert_advance_clock_beyond_next_alert_yields_event(self)`


#### `test_cancel_time_alert(self)`


#### `test_set_multiple_time_alerts(self)`


#### `test_set_timer_with_immediate_start_time(self)`


#### `test_set_timer(self)`


#### `test_set_timer_with_stop_time(self)`


#### `test_cancel_timer(self)`


#### `test_set_repeating_timer(self)`


#### `test_cancel_repeating_timer(self)`


#### `test_set_two_repeating_timers(self)`


#### `test_instantiate_has_expected_time_and_properties(self)`


#### `test_timestamp_returns_expected_datetime(self)`


#### `test_timestamp_ms_returns_expected_datetime(self)`


#### `test_timestamp_us_returns_expected_datetime(self)`


#### `test_timestamp_ns_returns_expected_datetime(self)`


#### `test_timestamp_returns_expected_double(self)`


#### `test_timestamp_ns_returns_expected_int64(self)`


#### `test_set_time_changes_time(self)`


#### `test_advance_time_changes_time_produces_empty_list(self)`


#### `test_advance_time_given_time_in_past_raises_value_error(self)`


#### `test_cancel_timer_when_no_timers_raises_key_error(self)`


#### `test_cancel_timers_when_no_timers_does_nothing(self)`


#### `test_set_time_alert2(self)`


#### `test_cancel_time_alert_when_timer_removes_timer(self)`


#### `test_cancel_timers_when_multiple_times_removes_all_timers(self)`


#### `test_set_timer2(self)`


#### `test_advance_time_with_set_time_alert_triggers_event(self)`


#### `test_advance_time_with_multiple_set_time_alerts_triggers_event(self)`


#### `test_advance_time_with_set_timer_triggers_events(self)`


#### `test_advance_time_with_multiple_set_timers_triggers_events(self)`


#### `test_set_timer_with_fire_immediately_true(self)`


#### `test_set_timer_with_fire_immediately_false(self)`


#### `test_cython_validation_prevents_rust_panic_for_time_alert(self)`


#### `test_cython_validation_prevents_rust_panic_for_timer_fire_immediately(self)`


#### `test_cython_validation_prevents_rust_panic_for_timer_next_event_past(self)`


#### `test_cython_validation_allows_valid_timer_with_past_start_but_future_next_event(self)`


#### `test_cython_validation_allows_zero_start_time_regardless_of_allow_past(self)`


#### `test_cython_validation_error_message_format(self)`
...
#### `test_timestamp_is_monotonic(self)`


#### `test_timestamp_ms_is_monotonic(self)`
...
```python
from tests.unit_tests.common.test_clock import TestTestClock
```
