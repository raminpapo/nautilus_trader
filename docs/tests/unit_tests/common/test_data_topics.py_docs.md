# Documentation: test_data_topics.py
...
### Classes
- **`TestTopicCache`**: Class defined in this file
...
**Classs**: `TestTopicCache`
**Imports**: `nautilus_trader.common.data_topics`, `nautilus_trader.model.data`, `nautilus_trader.model.identifiers`, `nautilus_trader.test_kit.providers`, `nautilus_trader.test_kit.stubs.data`
...
```bash
# For Python
pytest tests/unit_tests/common/test_data_topics.py
...
---
*Generated on 2025-11-18T21:55:11.266903Z*
