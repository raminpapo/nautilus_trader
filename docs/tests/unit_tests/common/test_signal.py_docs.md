...
### Classes
- **`TestSignalSerialization`**: Class defined in this file
- **`TestSignalMessageBusIntegration`**: Class defined in this file
...
**Classs**: `TestSignalMessageBusIntegration`, `TestSignalSerialization`
**Imports**: `nautilus_trader.common.component`, `nautilus_trader.common.signal`, `nautilus_trader.core.data`, `nautilus_trader.core.uuid`, `nautilus_trader.model.identifiers`, `pytest`
...
```bash
# For Python
pytest tests/unit_tests/common/test_signal.py
...
---
*Generated on 2025-11-18T21:55:11.298929Z*
