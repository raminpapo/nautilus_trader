# Documentation: `tests/unit_tests/common/test_signal.py`
**Generated:** 2025-11-15T19:40:09.065659Z
**File Size:** 11620 bytes
**Extension:** .py
**Type:** text
...
- **Path:** `tests/unit_tests/common/test_signal.py`
- **Size:** 11,620 bytes
- **Lines:** 311
- **Extension:** `.py`
- **Type:** text
...
This file is located at `tests/unit_tests/common/test_signal.py` within the repository.

**Classes defined:** TestSignalSerialization, TestSignalMessageBusIntegration

**Functions defined:** test_generate_signal_class_creates_data_subclass, test_signal_instance_has_required_properties, test_signal_has_serialization_methods, test_signal_serialization_roundtrip, test_signal_to_dict_includes_type_field, test_signal_from_dict_ignores_extra_fields, test_signal_public_methods_delegate_to_c_methods, test_different_signal_types_have_unique_names, test_signal_serialization_preserves_precision, test_signal_with_zero_timestamps and 8 more
...
#### `TestSignalSerialization`


#### `TestSignalMessageBusIntegration`


### Functions

#### `test_generate_signal_class_creates_data_subclass(self)`


#### `test_signal_instance_has_required_properties(self)`


#### `test_signal_has_serialization_methods(self)`


#### `test_signal_serialization_roundtrip(self, value_type, test_value, signal_name)`


#### `test_signal_to_dict_includes_type_field(self)`


#### `test_signal_from_dict_ignores_extra_fields(self)`


#### `test_signal_public_methods_delegate_to_c_methods(self)`


#### `test_different_signal_types_have_unique_names(self)`


#### `test_signal_serialization_preserves_precision(self)`


#### `test_signal_with_zero_timestamps(self)`


#### `test_signal_with_large_timestamps(self)`


#### `setup_method(self)`


#### `test_signal_can_be_published_to_message_bus(self)`


#### `handler(msg)`


#### `test_multiple_signal_types_can_be_published(self)`


#### `handler(msg)`


#### `test_signal_wildcard_subscription_works(self)`
...
```python
from tests.unit_tests.common.test_signal import TestSignalSerialization
```
