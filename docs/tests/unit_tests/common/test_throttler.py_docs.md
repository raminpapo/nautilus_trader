# Documentation: test_throttler.py
...
### Classes
- **`TestBufferingThrottler`**: Class defined in this file
- **`TestDroppingThrottler`**: Class defined in this file
...
**Classs**: `TestBufferingThrottler`, `TestDroppingThrottler`
**Imports**: `datetime`, `nautilus_trader.common.component`
...
```bash
# For Python
pytest tests/unit_tests/common/test_throttler.py
...
---
*Generated on 2025-11-18T21:55:11.300766Z*
