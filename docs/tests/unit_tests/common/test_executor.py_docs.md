# Documentation: test_executor.py

## File Metadata

- **Path**: `tests/unit_tests/common/test_executor.py`
- **Size**: 14,206 bytes
- **Lines**: 467
- **Language**: Python
...
### Functions
- **`test_task_id_creation()`**: Function defined in this file
- **`test_task_id_repr()`**: Function defined in this file
- **`logger()`**: Function defined in this file
...
**Functions**: `logger`, `test_task_id_creation`, `test_task_id_repr`
**Imports**: `asyncio`, `concurrent.futures`, `contextlib`, `nautilus_trader.common.executor`, `nautilus_trader.core.uuid`, `nautilus_trader.test_kit.functions`, `pytest`, `pytest_asyncio`, `unittest.mock`
...
```bash
# For Python
pytest tests/unit_tests/common/test_executor.py
...
---
*Generated on 2025-11-18T21:55:11.272174Z*
