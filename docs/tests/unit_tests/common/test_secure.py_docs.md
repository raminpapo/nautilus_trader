# Documentation: `tests/unit_tests/common/test_secure.py`
**Generated:** 2025-11-15T19:40:09.063590Z
...
- **Path:** `tests/unit_tests/common/test_secure.py`
- **Size:** 7,490 bytes
- **Lines:** 273
- **Extension:** `.py`
- **Type:** text
...
This file is located at `tests/unit_tests/common/test_secure.py` within the repository.

**Classes defined:** TestSecureString, TestMaskApiKey

**Functions defined:** test_init_with_valid_string, test_init_with_invalid_type_raises, test_get_redacted_with_long_string, test_get_redacted_with_custom_visible_chars, test_get_redacted_with_short_string, test_get_redacted_with_empty_string, test_str_returns_redacted, test_repr_returns_redacted, test_clear_removes_value, test_equality_with_another_secure_string and 14 more
...
#### `test_init_with_valid_string(self)`


#### `test_init_with_invalid_type_raises(self)`


#### `test_get_redacted_with_long_string(self)`


#### `test_get_redacted_with_custom_visible_chars(self)`


#### `test_get_redacted_with_short_string(self)`


#### `test_get_redacted_with_empty_string(self)`


#### `test_str_returns_redacted(self)`


#### `test_repr_returns_redacted(self)`


#### `test_clear_removes_value(self)`


#### `test_equality_with_another_secure_string(self)`


#### `test_equality_with_string(self)`


#### `test_equality_after_clear(self)`


#### `test_from_env_with_existing_variable(self)`


#### `test_from_env_with_custom_name(self)`


#### `test_from_env_with_missing_variable_raises(self)`


#### `test_bool_returns_false_for_empty_string(self)`


#### `test_bool_returns_false_after_clear(self)`


#### `test_multiple_clears_are_safe(self)`


#### `test_memory_clearing_on_deletion(self)`


#### `test_mask_long_api_key(self)`


#### `test_mask_with_custom_visible_chars(self)`


#### `test_mask_short_api_key(self)`


#### `test_mask_empty_api_key(self)`


#### `test_mask_none_api_key(self)`
...
```python
from tests.unit_tests.common.test_secure import TestSecureString
```
...
**Security:** This file may contain sensitive patterns: secret, token, api_key, credential. Ensure proper handling of secrets.
