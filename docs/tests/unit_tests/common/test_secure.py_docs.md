...
### Classes
- **`TestSecureString`**: Class defined in this file
- **`TestMaskApiKey`**: Class defined in this file
...
**Classs**: `TestMaskApiKey`, `TestSecureString`
**Imports**: `nautilus_trader.common.secure`, `os`, `pytest`
...
```bash
# For Python
pytest tests/unit_tests/common/test_secure.py
...
---
*Generated on 2025-11-18T21:55:11.296845Z*
