# Documentation: `tests/unit_tests/backtest/test_data_client.py`
**Generated:** 2025-11-15T19:40:08.944714Z
...
- **Path:** `tests/unit_tests/backtest/test_data_client.py`
- **Size:** 11,138 bytes
- **Lines:** 288
- **Extension:** `.py`
- **Type:** text
...
This file is located at `tests/unit_tests/backtest/test_data_client.py` within the repository.

**Classes defined:** TestBacktestMarketDataClient

**Functions defined:** setup_method, test_initialization, test_request_instrument_creates_spread_from_components, test_request_instrument_with_missing_component_logs_error, test_request_instrument_with_non_spread_instrument_works_normally, test_request_instrument_with_unknown_instrument_logs_error, test_subscribe_order_book_depth_with_valid_instrument, test_subscribe_order_book_depth_with_missing_instrument_logs_error, test_unsubscribe_order_book_depth
...
#### `test_request_instrument_creates_spread_from_components(self)`


#### `test_request_instrument_with_missing_component_logs_error(self)`


#### `test_request_instrument_with_non_spread_instrument_works_normally(self)`


#### `test_request_instrument_with_unknown_instrument_logs_error(self)`


#### `test_subscribe_order_book_depth_with_valid_instrument(self)`


#### `test_subscribe_order_book_depth_with_missing_instrument_logs_error(self)`


#### `test_unsubscribe_order_book_depth(self)`
...
```python
from tests.unit_tests.backtest.test_data_client import TestBacktestMarketDataClient
```
