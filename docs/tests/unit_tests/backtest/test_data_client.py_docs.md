...
### Classes
- **`TestBacktestMarketDataClient`**: Class defined in this file
...
**Classs**: `TestBacktestMarketDataClient`
**Imports**: `nautilus_trader.backtest.data_client`, `nautilus_trader.cache.cache`, `nautilus_trader.common.component`, `nautilus_trader.core.uuid`, `nautilus_trader.data.messages`, `nautilus_trader.model.data`, `nautilus_trader.model.enums`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.instruments.option_contract`, `nautilus_trader.model.instruments.option_spread`, `nautilus_trader.model.objects`, `nautilus_trader.test_kit.providers`, `nautilus_trader.test_kit.stubs.component`, `nautilus_trader.test_kit.stubs.identifiers`
...
```bash
# For Python
pytest tests/unit_tests/backtest/test_data_client.py
...
---
*Generated on 2025-11-18T21:55:11.158938Z*
