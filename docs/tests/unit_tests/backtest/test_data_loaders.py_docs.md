# Documentation: `tests/unit_tests/backtest/test_data_loaders.py`
**Generated:** 2025-11-15T19:40:08.950851Z
...
- **Path:** `tests/unit_tests/backtest/test_data_loaders.py`
- **Size:** 3,454 bytes
- **Lines:** 83
- **Extension:** `.py`
- **Type:** text
...
This file is located at `tests/unit_tests/backtest/test_data_loaders.py` within the repository.

**Classes defined:** TestBacktestLoaders, TestParquetTickDataLoaders

**Functions defined:** test_default_fx_with_5_dp_returns_expected_instrument, test_default_fx_with_3_dp_returns_expected_instrument, test_btcusdt_trade_ticks_from_parquet_loader_return_expected_row, test_btcusdt_quote_ticks_from_parquet_loader_return_expected_row
...
#### `TestParquetTickDataLoaders`


### Functions

#### `test_default_fx_with_5_dp_returns_expected_instrument(self)`


#### `test_default_fx_with_3_dp_returns_expected_instrument(self)`


#### `test_btcusdt_trade_ticks_from_parquet_loader_return_expected_row(self)`


#### `test_btcusdt_quote_ticks_from_parquet_loader_return_expected_row(self)`
...
```python
from tests.unit_tests.backtest.test_data_loaders import TestBacktestLoaders
```
