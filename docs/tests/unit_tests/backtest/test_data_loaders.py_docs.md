# Documentation: test_data_loaders.py
...
### Classes
- **`TestBacktestLoaders`**: Class defined in this file
- **`TestParquetTickDataLoaders`**: Class defined in this file
...
**Classs**: `TestBacktestLoaders`, `TestParquetTickDataLoaders`
**Imports**: `nautilus_trader`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.objects`, `nautilus_trader.persistence.loaders`, `nautilus_trader.test_kit.providers`
...
```bash
# For Python
pytest tests/unit_tests/backtest/test_data_loaders.py
...
---
*Generated on 2025-11-18T21:55:11.166117Z*
