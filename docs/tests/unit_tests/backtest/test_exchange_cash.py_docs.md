# Documentation: test_exchange_cash.py
...
### Classes
- **`TestSimulatedExchangeCashAccount`**: Class defined in this file
...
**Classs**: `TestSimulatedExchangeCashAccount`
...
```bash
# For Python
pytest tests/unit_tests/backtest/test_exchange_cash.py
...
---
*Generated on 2025-11-18T21:55:11.193518Z*
