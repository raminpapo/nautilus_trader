# Documentation: `tests/unit_tests/backtest/test_exchange_cash.py`
**Generated:** 2025-11-15T19:40:08.976262Z
**File Size:** 14053 bytes
**Extension:** .py
**Type:** text
...
- **Path:** `tests/unit_tests/backtest/test_exchange_cash.py`
- **Size:** 14,053 bytes
- **Lines:** 433
- **Extension:** `.py`
- **Type:** text
...
This file is located at `tests/unit_tests/backtest/test_exchange_cash.py` within the repository.

**Classes defined:** TestSimulatedExchangeCashAccount

**Functions defined:** setup, test_repr, test_equity_short_selling_will_reject, test_equity_selling_will_not_reject_with_cash_netting, test_equity_order_fills_for_entry, test_equity_order_fills_with_partial_exit, test_equity_order_multiple_entry_fills, test_book_depth_can_fill
...
#### `TestSimulatedExchangeCashAccount`
...
#### `test_equity_short_selling_will_reject(self)`


#### `test_equity_selling_will_not_reject_with_cash_netting(self)`


#### `test_equity_order_fills_for_entry(
        self,
        entry_side: OrderSide,
        expected_usd: Money,
    )`
...
#### `test_equity_order_fills_with_partial_exit(
        self,
        entry_side: OrderSide,
        exit_side: OrderSide,
        expected_usd: Money,
...
#### `test_equity_order_multiple_entry_fills(
        self,
        entry_side: OrderSide,
        exit_side: OrderSide,
        expected_usd: Money,
...
```python
from tests.unit_tests.backtest.test_exchange_cash import TestSimulatedExchangeCashAccount
```
