...
### Functions
- **`test_fixed_fee_model()`**: Function defined in this file
- **`test_per_contract_fee_model()`**: Function defined in this file

### Classes
- **`TestFillModel`**: Class defined in this file
- **`TestExchangeLatency`**: Class defined in this file
...
**Classs**: `TestExchangeLatency`, `TestFillModel`
**Functions**: `test_fixed_fee_model`, `test_per_contract_fee_model`
**Imports**: `nautilus_trader.backtest.models`, `nautilus_trader.common.component`, `nautilus_trader.common.factories`, `nautilus_trader.model.currencies`, `nautilus_trader.model.enums`, `nautilus_trader.model.objects`, `nautilus_trader.test_kit.providers`, `nautilus_trader.test_kit.stubs.identifiers`
...
```bash
# For Python
pytest tests/unit_tests/backtest/test_models.py
...
---
*Generated on 2025-11-18T21:55:11.226315Z*
