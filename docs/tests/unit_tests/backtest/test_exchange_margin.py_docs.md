# Documentation: `tests/unit_tests/backtest/test_exchange_margin.py`
**Generated:** 2025-11-15T19:40:08.993611Z
**File Size:** 116582 bytes
**Extension:** .py
**Type:** text
...
- **Path:** `tests/unit_tests/backtest/test_exchange_margin.py`
- **Size:** 116,582 bytes
- **Lines:** 3,605
- **Extension:** `.py`
- **Type:** text
...
This file is located at `tests/unit_tests/backtest/test_exchange_margin.py` within the repository.

**Classes defined:** TestSimulatedExchangeMarginAccount, TestSimulatedExchangeL1, TradeTickFillModule

**Functions defined:** setup, test_repr, test_set_fill_model, test_update_instrument_for_existing_matching_engine, test_update_instrument_for_new_matching_engine, test_get_matching_engines_when_engine_returns_expected_dict, test_get_matching_engine_when_no_engine_for_instrument_returns_none, test_get_books_with_one_instrument_returns_one_book, test_get_open_orders_when_no_orders_returns_empty_list, test_get_open_bid_orders_when_no_orders_returns_empty_list and 100 more

**Import statements:** 60
...
#### `TestSimulatedExchangeMarginAccount`


#### `TestSimulatedExchangeL1`
...
#### `setup(self, bar_adaptive_high_low_ordering=False)`


#### `test_repr(self)`


#### `test_set_fill_model(self)`


#### `test_update_instrument_for_existing_matching_engine(self)`


#### `test_update_instrument_for_new_matching_engine(self)`


#### `test_get_matching_engines_when_engine_returns_expected_dict(self)`


#### `test_get_matching_engine_when_no_engine_for_instrument_returns_none(self)`


#### `test_get_books_with_one_instrument_returns_one_book(self)`


#### `test_get_open_orders_when_no_orders_returns_empty_list(self)`


#### `test_get_open_bid_orders_when_no_orders_returns_empty_list(self)`


#### `test_get_open_ask_orders_when_no_orders_returns_empty_list(self)`


#### `test_get_open_bid_orders_with_instrument_when_no_orders_returns_empty_list(self)`


#### `test_get_open_ask_orders_with_instrument_when_no_orders_returns_empty_list(self)`


#### `test_process_quote_tick_updates_market(self)`


#### `test_process_trade_tick_updates_market(self)`


#### `test_submit_limit_order_with_no_market_accepts_order(
        self,
        side: OrderSide,
    )`


#### `test_submit_limit_order_with_immediate_modify(
        self,
        side: OrderSide,
        price: Price,
        new_price: Price,
...
#### `test_submit_multiple_limit_orders_then_accepts_both(self)`


#### `test_submit_limit_order_with_immediate_cancel(
        self,
        side: OrderSide,
        price: Price,
    )`
...
#### `test_submit_market_order_with_no_market_rejects_order(
        self,
        side: OrderSide,
    )`


#### `test_submit_sell_market_order_with_no_market_rejects_order(
        self,
        side: OrderSide,
    )`


#### `test_submit_order_with_invalid_price_gets_rejected(self)`


#### `test_submit_order_when_quantity_below_min_then_gets_denied(self)`


#### `test_submit_order_when_quantity_above_max_then_gets_denied(self)`


#### `test_submit_market_order(self)`


#### `test_submit_market_order_with_bar(self)`


#### `test_submit_limit_order_with_bar(self)`


#### `test_submit_two_limit_orders_with_bar(
        self,
        bar_adaptive_high_low_ordering,
        expected_fill_prices,
    )`
...
#### `test_submit_market_order_then_immediately_cancel_submits_and_fills(self)`


#### `test_submit_market_order_with_fok_time_in_force_cancels_immediately(self)`


#### `test_submit_limit_order_with_fok_time_in_force_cancels_immediately(self)`


#### `test_submit_market_order_with_ioc_time_in_force_cancels_remaining_qty(self)`


#### `test_submit_limit_order_then_immediately_cancel_submits_then_cancels(self)`


#### `test_submit_post_only_limit_order_when_marketable_then_rejects(self)`


#### `test_submit_limit_order(self)`


#### `test_submit_limit_order_with_ioc_time_in_force_immediately_cancels(self)`


#### `test_submit_limit_order_with_fok_time_in_force_immediately_cancels(self)`


#### `test_submit_market_to_limit_order_less_than_available_top_of_book(self)`


#### `test_submit_market_to_limit_order_greater_than_available_top_of_book(self)`


#### `test_submit_market_order_ioc_cancels_remaining(self)`


#### `test_submit_market_order_fok_cancels_when_cannot_fill_full_size(self)`


#### `test_submit_limit_order_fok_cancels_when_cannot_fill_full_size(self)`


#### `test_modify_market_to_limit_order_after_filling_initial_quantity(self)`


#### `test_submit_market_to_limit_order_becomes_limit_then_fills_remaining(self)`


#### `test_submit_market_if_touched_order(self)`


#### `test_submit_limit_if_touched_order(self)`


#### `test_submit_limit_order_when_marketable_then_fills(self)`


#### `test_process_limit_order_buy_l1_taker_exhausting_book_volume(self)`


#### `test_process_limit_order_sell_l1_taker_exhausting_book_volume(self)`


#### `test_process_limit_order_buy_l1_maker_quotes_exhausting_book_volume(
        self,
        ask_price: float,
        event_count: int,
        order_status: OrderStatus,
...
```python
from tests.unit_tests.backtest.test_exchange_margin import TestSimulatedExchangeMarginAccount
```
