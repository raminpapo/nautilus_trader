# Documentation: `tests/unit_tests/backtest/test_backtest_long_request.py`
**Generated:** 2025-11-15T19:40:08.937453Z
**File Size:** 15379 bytes
**Extension:** .py
**Type:** text
...
This file is located at `tests/unit_tests/backtest/test_backtest_long_request.py` within the repository.

**Classes defined:** TestBacktestLongRequest, LongRequestStrategyConfig, LongRequestStrategy, TestBacktestRequestJoin, RequestJoinStrategyConfig, RequestJoinStrategy

**Functions defined:** test_long_request_with_time_range_generator, run_backtest_long_request, __init__, on_start, on_historical_data, user_log, test_request_join_with_multiple_instruments, run_backtest_request_join, __init__, on_start and 2 more
...
#### `TestBacktestLongRequest`


#### `LongRequestStrategyConfig`
...
#### `TestBacktestRequestJoin`


#### `RequestJoinStrategyConfig`
...
#### `test_long_request_with_time_range_generator(self)`


#### `run_backtest_long_request(test_callback=None)`


#### `__init__(self, config: LongRequestStrategyConfig)`
...
#### `user_log(self, msg, log_color=LogColor.GREEN)`


#### `test_request_join_with_multiple_instruments(self)`


#### `run_backtest_request_join(test_callback=None)`


#### `__init__(self, config: RequestJoinStrategyConfig)`
...
```python
from tests.unit_tests.backtest.test_backtest_long_request import TestBacktestLongRequest
```
