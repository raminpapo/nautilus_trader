# Documentation: test_backtest_long_request.py

## File Metadata

- **Path**: `tests/unit_tests/backtest/test_backtest_long_request.py`
- **Size**: 15,399 bytes
- **Lines**: 457
- **Language**: Python
...
This file is part of the NautilusTrader repository. It defines 2 function(s) and 6 class(es).

## Detailed Walkthrough

### Functions
- **`run_backtest_long_request()`**: Function defined in this file
- **`run_backtest_request_join()`**: Function defined in this file

### Classes
- **`TestBacktestLongRequest`**: Class defined in this file
- **`LongRequestStrategyConfig`**: Class defined in this file
- **`LongRequestStrategy`**: Class defined in this file
- **`TestBacktestRequestJoin`**: Class defined in this file
- **`RequestJoinStrategyConfig`**: Class defined in this file
- **`RequestJoinStrategy`**: Class defined in this file
...
**Classs**: `LongRequestStrategy`, `LongRequestStrategyConfig`, `RequestJoinStrategy`, `RequestJoinStrategyConfig`, `TestBacktestLongRequest`, `TestBacktestRequestJoin`
**Functions**: `run_backtest_long_request`, `run_backtest_request_join`
**Imports**: `nautilus_trader`, `nautilus_trader.adapters.databento.data_utils`, `nautilus_trader.backtest.node`, `nautilus_trader.common.enums`, `nautilus_trader.config`, `nautilus_trader.core.datetime`, `nautilus_trader.model.data`, `nautilus_trader.model.identifiers`, `nautilus_trader.persistence.config`, `nautilus_trader.trading.strategy`, `pandas`, `pytest`
...
```bash
# For Python
pytest tests/unit_tests/backtest/test_backtest_long_request.py
...
---
*Generated on 2025-11-18T21:55:11.152092Z*
