# Documentation: `tests/unit_tests/backtest/test_matching_engine.py`
**Generated:** 2025-11-15T19:40:09.005846Z
**File Size:** 17042 bytes
**Extension:** .py
**Type:** text
...
- **Path:** `tests/unit_tests/backtest/test_matching_engine.py`
- **Size:** 17,042 bytes
- **Lines:** 440
- **Extension:** `.py`
- **Type:** text
...
This file is located at `tests/unit_tests/backtest/test_matching_engine.py` within the repository.

**Classes defined:** TestOrderMatchingEngine

**Functions defined:** setup, test_repr, test_set_fill_model, test_update_instrument, test_process_instrument_status, test_process_market_on_close_order, test_instrument_close_expiry_closes_position, test_process_order_book_depth_10, test_process_trade_buyer_aggressor, test_process_trade_seller_aggressor and 7 more
...
#### `test_update_instrument(self)`


#### `test_process_instrument_status(self)`


#### `test_process_market_on_close_order(self)`


#### `test_instrument_close_expiry_closes_position(self)`


#### `test_process_order_book_depth_10(self)`


#### `test_process_trade_buyer_aggressor(self)`


#### `test_process_trade_seller_aggressor(self)`


#### `test_process_trade_tick_no_aggressor_above_ask(self)`


#### `test_process_trade_tick_no_aggressor_within_spread(self)`


#### `test_process_trade_tick_no_aggressor_below_bid(self)`


#### `test_process_trade_tick_no_aggressor_at_bid_and_ask(self)`


#### `test_process_trade_tick_with_trade_execution_disabled(self)`


#### `test_trade_execution_difference_buyer_aggressor(self)`


#### `test_fill_order_with_non_positive_qty_returns_early(self)`
...
```python
from tests.unit_tests.backtest.test_matching_engine import TestOrderMatchingEngine
```
