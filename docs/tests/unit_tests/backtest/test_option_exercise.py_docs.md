# Documentation: test_option_exercise.py
...
### Classes
- **`TestOptionExerciseModule`**: Class defined in this file
...
**Classs**: `TestOptionExerciseModule`
**Imports**: `nautilus_trader.backtest.option_exercise`, `nautilus_trader.core.datetime`, `nautilus_trader.core.uuid`, `nautilus_trader.model.currencies`, `nautilus_trader.model.data`, `nautilus_trader.model.enums`, `nautilus_trader.model.events`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.instruments`, `nautilus_trader.model.objects`, `nautilus_trader.model.position`, `pandas`, `unittest.mock`
...
```bash
# For Python
pytest tests/unit_tests/backtest/test_option_exercise.py
...
---
*Generated on 2025-11-18T21:55:11.232647Z*
