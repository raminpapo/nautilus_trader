# Documentation: `tests/unit_tests/backtest/test_option_exercise.py`
**Generated:** 2025-11-15T19:40:09.014147Z
**File Size:** 22218 bytes
**Extension:** .py
**Type:** text
...
- **Path:** `tests/unit_tests/backtest/test_option_exercise.py`
- **Size:** 22,218 bytes
- **Lines:** 579
- **Extension:** `.py`
- **Type:** text
...
This file is located at `tests/unit_tests/backtest/test_option_exercise.py` within the repository.

**Classes defined:** TestOptionExerciseModule

**Functions defined:** setup_method, test_module_initialization, test_pre_process_quote_tick, test_is_option_itm_call, test_is_option_otm_call, test_is_option_itm_put, test_is_option_otm_put, test_calculate_underlying_position_call_long, test_calculate_underlying_position_put_long, test_reset and 4 more
...
#### `test_module_initialization(self)`


#### `test_pre_process_quote_tick(self)`


#### `test_is_option_itm_call(self)`


#### `test_is_option_otm_call(self)`


#### `test_is_option_itm_put(self)`


#### `test_is_option_otm_put(self)`


#### `test_calculate_underlying_position_call_long(self)`


#### `test_calculate_underlying_position_put_long(self)`


#### `test_reset(self)`


#### `test_process_disabled(self)`


#### `test_cash_settlement_exercise(self)`


#### `test_otm_option_expiry_pnl_behavior(self)`


#### `test_comprehensive_option_expiry_pnl_all_cases(self)`
...
```python
from tests.unit_tests.backtest.test_option_exercise import TestOptionExerciseModule
```
