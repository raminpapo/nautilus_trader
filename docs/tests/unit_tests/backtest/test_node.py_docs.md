...
### Classes
- **`TestBacktestNode`**: Class defined in this file
...
**Classs**: `TestBacktestNode`
**Imports**: `msgspec`, `nautilus_trader.backtest.engine`, `nautilus_trader.backtest.node`, `nautilus_trader.common.config`, `nautilus_trader.config`, `nautilus_trader.model.data`, `nautilus_trader.model.identifiers`, `nautilus_trader.test_kit.mocks.data`, `pytest`
...
```bash
# For Python
pytest tests/unit_tests/backtest/test_node.py
...
---
*Generated on 2025-11-18T21:55:11.229533Z*
