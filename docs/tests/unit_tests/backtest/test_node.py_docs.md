# Documentation: `tests/unit_tests/backtest/test_node.py`
**Generated:** 2025-11-15T19:40:09.011294Z
**File Size:** 9201 bytes
**Extension:** .py
**Type:** text
...
- **Path:** `tests/unit_tests/backtest/test_node.py`
- **Size:** 9,201 bytes
- **Lines:** 259
- **Extension:** `.py`
- **Type:** text
...
This file is located at `tests/unit_tests/backtest/test_node.py` within the repository.

**Classes defined:** TestBacktestNode

**Functions defined:** setup_method, test_init, test_order_book_with_depth_data_config_validation, test_run, test_backtest_run_batch_sync, test_backtest_run_results, test_node_config_from_raw, test_backtest_result_total_positions_matches_tearsheet_hedging, test_backtest_result_total_positions_matches_tearsheet_netting
...
#### `test_order_book_with_depth_data_config_validation(self, book_type: str)`


#### `test_run(self)`


#### `test_backtest_run_batch_sync(self)`


#### `test_backtest_run_results(self)`


#### `test_node_config_from_raw(self)`


#### `test_backtest_result_total_positions_matches_tearsheet_hedging(self)`


#### `test_backtest_result_total_positions_matches_tearsheet_netting(self)`
...
```python
from tests.unit_tests.backtest.test_node import TestBacktestNode
```
