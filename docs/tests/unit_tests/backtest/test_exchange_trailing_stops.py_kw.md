# Keywords: test_exchange_trailing_stops.py

## File Path
`tests/unit_tests/backtest/test_exchange_trailing_stops.py`
...
- **Type**: class
- **File**: [tests/unit_tests/backtest/test_exchange_trailing_stops.py](../test_exchange_trailing_stops.py_docs.md)
...
---
*Generated on 2025-11-18T21:55:11.222141Z*
