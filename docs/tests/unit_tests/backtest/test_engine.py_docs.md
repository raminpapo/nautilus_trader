# Documentation: `tests/unit_tests/backtest/test_engine.py`
**Generated:** 2025-11-15T19:40:08.959390Z
**File Size:** 61774 bytes
**Extension:** .py
**Type:** text
...
- **Path:** `tests/unit_tests/backtest/test_engine.py`
- **Size:** 61,774 bytes
- **Lines:** 1,717
- **Extension:** `.py`
- **Type:** text
...
This file is located at `tests/unit_tests/backtest/test_engine.py` within the repository.

**Classes defined:** TestBacktestEngine, TestBacktestEngineCashAccount, TestBacktestEngineData, TestBacktestWithAddedBars, TestBacktestEngineStreaming, TestBacktestEngineDataSorting

**Functions defined:** setup, create_engine, teardown, test_initialization, test_reset_engine, test_clear_actors_with_no_actors, test_clear_actors, test_clear_strategies_with_no_strategies, test_clear_strategies, test_clear_exec_algorithms_no_exec_algorithms and 66 more
...
#### `TestBacktestEngineCashAccount`


#### `TestBacktestEngineData`


#### `TestBacktestWithAddedBars`


#### `TestBacktestEngineStreaming`


#### `TestBacktestEngineDataSorting`
...
#### `create_engine(self, config: BacktestEngineConfig | None = None)`
...
#### `test_reset_engine(self)`


#### `test_clear_actors_with_no_actors(self)`


#### `test_clear_actors(self)`


#### `test_clear_strategies_with_no_strategies(self)`


#### `test_clear_strategies(self)`


#### `test_clear_exec_algorithms_no_exec_algorithms(self)`


#### `test_clear_exec_algorithms(self)`


#### `test_run_with_no_strategies(self)`


#### `test_run(self)`


#### `test_change_fill_model(self)`


#### `test_account_state_timestamp(self)`


#### `test_persistence_files_cleaned_up(self, tmp_path: Path)`


#### `test_run_with_venue_config_raises_invalid_config(
        self,
        config: BacktestEngineConfig | None = None,
    )`


#### `test_multiple_runs(self)`


#### `test_strategy_timestamps(self)`


#### `test_set_instance_id(self)`
...
#### `test_adding_currency_pair_for_single_currency_cash_account_raises_exception(self)`


#### `setup(self)`


#### `test_add_pyo3_data_raises_type_error(self)`


#### `test_add_custom_data_adds_to_engine(self)`


#### `test_add_instrument_when_no_venue_raises_exception(self)`


#### `test_add_order_book_deltas_adds_to_engine(self)`


#### `test_add_order_book_depth10_adds_to_engine(self)`


#### `test_add_quote_ticks_adds_to_engine(self)`


#### `test_add_trade_ticks_adds_to_engine(self)`


#### `test_add_bars_adds_to_engine(self)`


#### `test_add_instrument_status_to_engine(self)`
...
#### `test_run_ema_cross_with_added_bars(self)`


#### `test_dump_pickled_data(self)`


#### `test_load_pickled_data(self)`


#### `setup_method(self)`


#### `create_data_iterator(self, name: str, start_ts: int, count: int, interval: int)`


#### `data_generator()`


#### `create_sparse_iterator(self, name: str, start_ts: int, count: int)`


#### `sparse_generator()`


#### `create_dense_iterator(self, name: str, start_ts: int, count: int)`


#### `dense_generator()`


#### `test_streaming_workflow_small_batches(self)`


#### `test_streaming_workflow_large_chunks(self)`


#### `test_streaming_workflow_simple(self)`
...
```python
from tests.unit_tests.backtest.test_engine import TestBacktestEngine
```
