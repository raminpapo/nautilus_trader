...
This file is part of the NautilusTrader repository. 6 class(es).

## Detailed Walkthrough


### Classes
- **`TestBacktestEngine`**: Class defined in this file
- **`TestBacktestEngineCashAccount`**: Class defined in this file
- **`TestBacktestEngineData`**: Class defined in this file
- **`TestBacktestWithAddedBars`**: Class defined in this file
- **`TestBacktestEngineStreaming`**: Class defined in this file
- **`TestBacktestEngineDataSorting`**: Class defined in this file
...
**Classs**: `TestBacktestEngine`, `TestBacktestEngineCashAccount`, `TestBacktestEngineData`, `TestBacktestEngineDataSorting`, `TestBacktestEngineStreaming`, `TestBacktestWithAddedBars`
**Imports**: `decimal`, `nautilus_trader`, `nautilus_trader.backtest.engine`, `nautilus_trader.backtest.models`, `nautilus_trader.common.actor`, `nautilus_trader.config`, `nautilus_trader.core.uuid`, `nautilus_trader.examples.strategies.ema_cross`, `nautilus_trader.examples.strategies.signal_strategy`, `nautilus_trader.execution.algorithm`, `nautilus_trader.model.currencies`, `nautilus_trader.model.data`, `nautilus_trader.model.enums`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.objects`, `nautilus_trader.persistence`, `nautilus_trader.persistence.catalog.parquet`, `nautilus_trader.persistence.wranglers`, `nautilus_trader.test_kit.providers`, `nautilus_trader.test_kit.stubs.component`, `nautilus_trader.test_kit.stubs.config`, `nautilus_trader.test_kit.stubs.data`, `nautilus_trader.trading.messages`, `nautilus_trader.trading.strategy`, `pandas`, `pathlib`, `pickle`, `pytest`, `sys`
...
```bash
# For Python
pytest tests/unit_tests/backtest/test_engine.py
...
---
*Generated on 2025-11-18T21:55:11.177653Z*
