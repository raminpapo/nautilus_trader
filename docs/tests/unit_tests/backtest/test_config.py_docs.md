# Documentation: `tests/unit_tests/backtest/test_config.py`
**Generated:** 2025-11-15T19:40:08.942433Z
...
- **Path:** `tests/unit_tests/backtest/test_config.py`
- **Size:** 21,854 bytes
- **Lines:** 607
- **Extension:** `.py`
- **Type:** text
...
This file is located at `tests/unit_tests/backtest/test_config.py` within the repository.

**Classes defined:** TestBacktestConfig, TestBacktestConfigParsing, TestParseFiltersExpr

**Functions defined:** setup, test_backtest_config_pickle, test_backtest_data_config_load, test_backtest_data_config_custom_data, test_backtest_data_config_filters, test_backtest_data_config_status_updates, test_resolve_cls, test_models_to_json, test_backtest_config_to_json, setup and 20 more
...
#### `TestBacktestConfigParsing`


#### `TestParseFiltersExpr`
...
#### `test_backtest_config_pickle(self)`


#### `test_backtest_data_config_load(self)`


#### `test_backtest_data_config_custom_data(self)`


#### `test_backtest_data_config_filters(self)`


#### `test_backtest_data_config_status_updates(self)`


#### `test_resolve_cls(self)`


#### `test_models_to_json(self, model: NautilusConfig)`


#### `test_backtest_config_to_json(self)`


#### `setup(self, tmp_path)`


#### `test_run_config_to_json(self)`


#### `test_run_config_parse_obj(self)`


#### `test_backtest_data_config_to_dict(self)`


#### `test_backtest_obj_data_config_to_dict(self)`


#### `test_backtest_run_config_id(self)`


#### `test_tokenize_config(self, config_func, keys, kw, expected)`


#### `test_backtest_main_cli(self, mocker)`


#### `test_simulation_modules(self)`


#### `test_parse_filters_expr_none_input(self)`


#### `test_parse_filters_expr_empty_string(self)`


#### `test_parse_filters_expr_valid_expression(self, expr)`


#### `test_parse_filters_expr_security_blocks_malicious_code(self, expr)`


#### `test_parse_filters_expr_security_blocks_arbitrary_functions(self, expr)`


#### `test_parse_filters_expr_security_blocks_attribute_access(self, expr)`


#### `test_parse_filters_expr_security_blocks_imports(self, expr)`


#### `test_parse_filters_expr_whitespace_handling(self, expr, is_valid)`


#### `test_parse_filters_expr_complex_valid_expressions(self)`


#### `test_parse_filters_expr_invalid_syntax(self, expr)`


#### `test_backtest_venue_config_allow_cash_borrowing_default(self)`


#### `test_backtest_venue_config_allow_cash_borrowing_enabled(self)`
...
```python
from tests.unit_tests.backtest.test_config import TestBacktestConfig
```
