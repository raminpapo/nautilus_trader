...
### Classes
- **`TestBacktestConfig`**: Class defined in this file
- **`TestBacktestConfigParsing`**: Class defined in this file
- **`TestParseFiltersExpr`**: Class defined in this file
...
**Classs**: `TestBacktestConfig`, `TestBacktestConfigParsing`, `TestParseFiltersExpr`
**Imports**: `click.testing`, `msgspec`, `nautilus_trader.backtest.config`, `nautilus_trader.backtest.modules`, `nautilus_trader.backtest.node`, `nautilus_trader.config`, `nautilus_trader.model.currencies`, `nautilus_trader.model.data`, `nautilus_trader.model.enums`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.objects`, `nautilus_trader.test_kit.mocks.data`, `nautilus_trader.test_kit.providers`, `nautilus_trader.test_kit.stubs.config`, `nautilus_trader.test_kit.stubs.persistence`, `pandas`, `pickle`, `pyarrow.dataset`, `pytest`, `sys`
...
```bash
# For Python
pytest tests/unit_tests/backtest/test_config.py
...
---
*Generated on 2025-11-18T21:55:11.156612Z*
