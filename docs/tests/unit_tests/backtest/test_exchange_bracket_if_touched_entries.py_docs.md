# Documentation: `tests/unit_tests/backtest/test_exchange_bracket_if_touched_entries.py`
**Generated:** 2025-11-15T19:40:08.968082Z
**File Size:** 32314 bytes
**Extension:** .py
**Type:** text
...
- **Path:** `tests/unit_tests/backtest/test_exchange_bracket_if_touched_entries.py`
- **Size:** 32,314 bytes
- **Lines:** 883
- **Extension:** `.py`
- **Type:** text
...
This file is located at `tests/unit_tests/backtest/test_exchange_bracket_if_touched_entries.py` within the repository.

**Classes defined:** TestSimulatedExchangeEmulatedContingencyOrders

**Functions defined:** setup, test_bracket_market_entry_accepts_sl_and_tp, test_bracket_market_if_touched_entry_triggers_passively_then_sl_tp_working, test_bracket_limit_if_touched_entry_triggers_passively_then_limit_working, test_bracket_limit_if_touched_entry_triggers_passively_and_fills_passively, test_bracket_limit_if_touched_entry_triggers_passively_and_fills_immediately, test_bracket_limit_if_touched_entry_triggers_immediately_and_fills_passively, test_bracket_limit_if_touched_entry_triggers_immediately_and_fills_immediately
...
#### `TestSimulatedExchangeEmulatedContingencyOrders`
...
#### `test_bracket_market_if_touched_entry_triggers_passively_then_sl_tp_working(
        self,
        emulation_trigger: TriggerType,
        order_side: OrderSide,
        entry_trigger_price: Price,
...
#### `test_bracket_limit_if_touched_entry_triggers_passively_then_limit_working(
        self,
        emulation_trigger: TriggerType,
        order_side: OrderSide,
        entry_trigger_price: Price,
...
#### `test_bracket_limit_if_touched_entry_triggers_passively_and_fills_passively(
        self,
        emulation_trigger: TriggerType,
        order_side: OrderSide,
        entry_trigger_price: Price,
...
#### `test_bracket_limit_if_touched_entry_triggers_passively_and_fills_immediately(
        self,
        emulation_trigger: TriggerType,
        order_side: OrderSide,
        entry_trigger_price: Price,
...
```python
from tests.unit_tests.backtest.test_exchange_bracket_if_touched_entries import TestSimulatedExchangeEmulatedContingencyOrders
```
