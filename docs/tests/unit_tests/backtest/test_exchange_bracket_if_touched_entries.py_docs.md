# Documentation: test_exchange_bracket_if_touched_entries.py
...
### Classes
- **`TestSimulatedExchangeEmulatedContingencyOrders`**: Class defined in this file
...
**Classs**: `TestSimulatedExchangeEmulatedContingencyOrders`
...
```bash
# For Python
pytest tests/unit_tests/backtest/test_exchange_bracket_if_touched_entries.py
...
---
*Generated on 2025-11-18T21:55:11.185823Z*
