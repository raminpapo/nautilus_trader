# Documentation: test_data_iterator.py
...
### Classes
- **`TestBacktestDataIterator`**: Class defined in this file
- **`TestBacktestDataIteratorPresorted`**: Class defined in this file
...
**Classs**: `TestBacktestDataIterator`, `TestBacktestDataIteratorPresorted`
**Imports**: `nautilus_trader.backtest.engine`, `nautilus_trader.test_kit.stubs.data`, `pytest`
...
```bash
# For Python
pytest tests/unit_tests/backtest/test_data_iterator.py
...
---
*Generated on 2025-11-18T21:55:11.164773Z*
