# Documentation: `tests/unit_tests/backtest/test_data_iterator.py`
**Generated:** 2025-11-15T19:40:08.949002Z
**File Size:** 28776 bytes
**Extension:** .py
**Type:** text
...
- **Path:** `tests/unit_tests/backtest/test_data_iterator.py`
- **Size:** 28,776 bytes
- **Lines:** 851
- **Extension:** `.py`
- **Type:** text
...
This file is located at `tests/unit_tests/backtest/test_data_iterator.py` within the repository.

**Classes defined:** TestBacktestDataIterator, TestBacktestDataIteratorPresorted

**Functions defined:** test_iterate_multiple_streams_sorted, test_partial_consumption_then_complete, test_all_data_returns_mapping, test_remove_stream_effect, test_remove_all_streams_yields_empty, test_single_data_mode_basic_functionality, test_append_data_priority_changes_order, test_set_index_and_data_accessor_and_is_done_empty, test_all_data_order_and_add_empty_list, test_readding_data_replaces_old and 50 more
...
#### `TestBacktestDataIterator`


#### `TestBacktestDataIteratorPresorted`


### Functions

#### `test_iterate_multiple_streams_sorted(self)`


#### `test_partial_consumption_then_complete(self)`


#### `test_all_data_returns_mapping(self)`


#### `test_remove_stream_effect(self)`


#### `test_remove_all_streams_yields_empty(self)`


#### `test_single_data_mode_basic_functionality(self)`


#### `test_append_data_priority_changes_order(self)`


#### `test_set_index_and_data_accessor_and_is_done_empty(self)`


#### `test_all_data_order_and_add_empty_list(self)`


#### `test_readding_data_replaces_old(self)`


#### `test_single_stream_yields_in_order(self)`


#### `test_multiple_streams_merge_order(self)`


#### `test_prepend_priority_with_equal_timestamps(self)`


#### `test_remove_data_basic_functionality(self)`


#### `test_set_index_behavior(self)`


#### `test_init_data_basic_functionality(self)`


#### `data_generator()`


#### `test_init_data_empty_data_provider(self)`


#### `empty_generator()`


#### `test_init_data_multiple_streams(self)`
...
#### `test_init_data_append_priority(self)`
...
#### `test_init_data_replace_existing_stream(self)`
...
#### `test_consecutive_data_addition_single_stream(self)`


#### `chunked_generator()`


#### `test_consecutive_data_addition_multiple_streams(self)`
...
#### `test_consecutive_data_addition_with_state(self)`


#### `stateful_generator()`


#### `test_data_update_function_complete_removal(self)`


#### `provider_generator()`


#### `test_data_update_function_with_remove_data(self)`


#### `provider_generator()`


#### `test_data_update_function_mixed_with_static_data(self)`


#### `dynamic_provider_generator()`


#### `test_data_update_function_error_handling(self)`


#### `failing_provider_generator()`


#### `test_mixed_add_data_and_init_data_basic(self)`


#### `dynamic_provider_generator()`


#### `test_mixed_add_data_and_init_data_priority(self)`


#### `dynamic_provider_generator()`


#### `test_mixed_add_data_and_init_data_single_run_behavior(self)`


#### `single_call_provider_generator()`


#### `test_mixed_add_data_and_init_data_remove_behavior(self)`
...
```python
from tests.unit_tests.backtest.test_data_iterator import TestBacktestDataIterator
```
