# Documentation: `tests/unit_tests/backtest/test_exchange_contingencies.py`
**Generated:** 2025-11-15T19:40:08.979765Z
...
- **Path:** `tests/unit_tests/backtest/test_exchange_contingencies.py`
- **Size:** 31,248 bytes
- **Lines:** 796
- **Extension:** `.py`
- **Type:** text
...
This file is located at `tests/unit_tests/backtest/test_exchange_contingencies.py` within the repository.

**Classes defined:** TestSimulatedExchangeContingencyAdvancedOrders

**Functions defined:** setup, test_submit_bracket_market_entry_buy_accepts_sl_and_tp, test_submit_bracket_market_entry_sell_accepts_sl_and_tp, test_submit_bracket_market_entry_with_immediate_modify_accepts_sl_and_tp, test_submit_bracket_limit_entry_with_immediate_modify_accepts_sl_and_tp, test_submit_bracket_market_entry_with_immediate_cancel, test_submit_bracket_limit_entry_buy_has_sl_tp_pending, test_submit_bracket_limit_entry_sell_has_sl_tp_pending, test_submit_bracket_limit_entry_buy_fills_then_triggers_sl_and_tp, test_submit_bracket_limit_entry_sell_fills_then_triggers_sl_and_tp and 7 more
...
#### `TestSimulatedExchangeContingencyAdvancedOrders`
...
#### `test_submit_bracket_market_entry_buy_accepts_sl_and_tp(self)`


#### `test_submit_bracket_market_entry_sell_accepts_sl_and_tp(self)`


#### `test_submit_bracket_market_entry_with_immediate_modify_accepts_sl_and_tp(self)`


#### `test_submit_bracket_limit_entry_with_immediate_modify_accepts_sl_and_tp(self)`


#### `test_submit_bracket_market_entry_with_immediate_cancel(self)`


#### `test_submit_bracket_limit_entry_buy_has_sl_tp_pending(self)`


#### `test_submit_bracket_limit_entry_sell_has_sl_tp_pending(self)`


#### `test_submit_bracket_limit_entry_buy_fills_then_triggers_sl_and_tp(self)`


#### `test_submit_bracket_limit_entry_sell_fills_then_triggers_sl_and_tp(self)`


#### `test_reject_bracket_entry_then_rejects_sl_and_tp(self)`


#### `test_filling_bracket_sl_cancels_tp_order(self)`


#### `test_filling_bracket_tp_cancels_sl_order(self)`


#### `test_partial_fill_bracket_tp_updates_sl_order(self)`


#### `test_modifying_bracket_tp_updates_sl_order(self)`


#### `test_closing_position_cancels_bracket_ocos(self)`


#### `test_partially_filling_position_updates_bracket_ocos(self)`
...
```python
from tests.unit_tests.backtest.test_exchange_contingencies import TestSimulatedExchangeContingencyAdvancedOrders
```
