# Keywords: test_exchange_bitmex.py

## File Path
`tests/unit_tests/backtest/test_exchange_bitmex.py`
...
- **Type**: class
- **File**: [tests/unit_tests/backtest/test_exchange_bitmex.py](../test_exchange_bitmex.py_docs.md)
...
---
*Generated on 2025-11-18T21:55:11.182020Z*
