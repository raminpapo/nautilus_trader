# Documentation: `tests/unit_tests/backtest/test_exchange_l2_mbp.py`
**Generated:** 2025-11-15T19:40:08.984597Z
**File Size:** 15482 bytes
**Extension:** .py
**Type:** text
...
- **Path:** `tests/unit_tests/backtest/test_exchange_l2_mbp.py`
- **Size:** 15,482 bytes
- **Lines:** 429
- **Extension:** `.py`
- **Type:** text
...
This file is located at `tests/unit_tests/backtest/test_exchange_l2_mbp.py` within the repository.

**Classes defined:** TestL2OrderBookExchange

**Functions defined:** setup, test_submit_limit_order_aggressive_multiple_levels, test_aggressive_partial_fill, test_post_only_insert, test_post_only_reject_would_take, test_passive_partial_fill_sell, test_passive_partial_fill_buy, test_passive_multiple_fills_sell, test_passive_multiple_fills_buy
...
#### `test_submit_limit_order_aggressive_multiple_levels(self)`


#### `test_aggressive_partial_fill(self)`


#### `test_post_only_insert(self)`


#### `test_post_only_reject_would_take(self)`


#### `test_passive_partial_fill_sell(self)`


#### `test_passive_partial_fill_buy(self)`


#### `test_passive_multiple_fills_sell(self)`


#### `test_passive_multiple_fills_buy(self)`
...
```python
from tests.unit_tests.backtest.test_exchange_l2_mbp import TestL2OrderBookExchange
```
