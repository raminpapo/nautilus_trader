# Documentation: test_exchange_bitmex.py
...
### Classes
- **`TestBitmexExchange`**: Class defined in this file
...
```bash
# For Python
pytest tests/unit_tests/backtest/test_exchange_bitmex.py
...
---
*Generated on 2025-11-18T21:55:11.181968Z*
