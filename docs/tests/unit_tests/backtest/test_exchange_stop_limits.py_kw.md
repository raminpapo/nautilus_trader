# Keywords: test_exchange_stop_limits.py

## File Path
`tests/unit_tests/backtest/test_exchange_stop_limits.py`
...
- **Type**: class
- **File**: [tests/unit_tests/backtest/test_exchange_stop_limits.py](../test_exchange_stop_limits.py_docs.md)
...
---
*Generated on 2025-11-18T21:55:11.215313Z*
