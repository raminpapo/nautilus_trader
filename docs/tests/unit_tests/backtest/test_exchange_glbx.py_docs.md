# Documentation: `tests/unit_tests/backtest/test_exchange_glbx.py`
**Generated:** 2025-11-15T19:40:08.982290Z
...
- **Path:** `tests/unit_tests/backtest/test_exchange_glbx.py`
- **Size:** 11,386 bytes
- **Lines:** 324
- **Extension:** `.py`
- **Type:** text
...
This file is located at `tests/unit_tests/backtest/test_exchange_glbx.py` within the repository.

**Classes defined:** TestSimulatedExchangeGlbx

**Functions defined:** setup, test_repr, test_process_order_within_expiration_submits, test_process_order_prior_to_activation_rejects, test_process_order_after_expiration_rejects, test_process_exchange_past_instrument_expiration_cancels_open_order, test_process_exchange_past_instrument_expiration_closed_open_position, test_process_exchange_after_expiration_not_raise_exception_when_no_open_position
...
#### `test_process_order_within_expiration_submits(self)`


#### `test_process_order_prior_to_activation_rejects(self)`


#### `test_process_order_after_expiration_rejects(self)`


#### `test_process_exchange_past_instrument_expiration_cancels_open_order(self)`


#### `test_process_exchange_past_instrument_expiration_closed_open_position(self)`


#### `test_process_exchange_after_expiration_not_raise_exception_when_no_open_position(
        self,
    )`
...
```python
from tests.unit_tests.backtest.test_exchange_glbx import TestSimulatedExchangeGlbx
```
