# Documentation: `tests/unit_tests/backtest/test_exchange_bracket_quantity_independence.py`
**Generated:** 2025-11-15T19:40:08.971184Z
**File Size:** 22934 bytes
**Extension:** .py
**Type:** text
...
- **Path:** `tests/unit_tests/backtest/test_exchange_bracket_quantity_independence.py`
- **Size:** 22,934 bytes
- **Lines:** 583
- **Extension:** `.py`
- **Type:** text
...
This file is located at `tests/unit_tests/backtest/test_exchange_bracket_quantity_independence.py` within the repository.

**Classes defined:** TestSimulatedExchangeBracketQuantityIndependence

**Functions defined:** setup, test_multiple_bracket_orders_maintain_independent_quantities, test_partial_fills_update_child_orders_independently, test_standalone_reduce_only_without_parent_uses_position_quantity, test_extreme_position_reduction_caps_all_bracket_children
...
#### `TestSimulatedExchangeBracketQuantityIndependence`
...
#### `test_multiple_bracket_orders_maintain_independent_quantities(self)`


#### `test_partial_fills_update_child_orders_independently(self)`


#### `test_standalone_reduce_only_without_parent_uses_position_quantity(self)`


#### `test_extreme_position_reduction_caps_all_bracket_children(self)`
...
```python
from tests.unit_tests.backtest.test_exchange_bracket_quantity_independence import TestSimulatedExchangeBracketQuantityIndependence
```
