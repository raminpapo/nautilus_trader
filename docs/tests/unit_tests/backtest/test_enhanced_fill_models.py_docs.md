# Documentation: test_enhanced_fill_models.py
...
### Classes
- **`TestEnhancedFillModels`**: Class defined in this file
...
**Classs**: `TestEnhancedFillModels`
**Imports**: `nautilus_trader.backtest.models`, `nautilus_trader.common.component`, `nautilus_trader.core.rust.model`, `nautilus_trader.model.book`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.objects`, `nautilus_trader.test_kit.providers`, `nautilus_trader.test_kit.stubs.execution`
...
```bash
# For Python
pytest tests/unit_tests/backtest/test_enhanced_fill_models.py
...
---
*Generated on 2025-11-18T21:55:11.179696Z*
