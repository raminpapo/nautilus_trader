# Documentation: `tests/unit_tests/backtest/test_exchange_bracket_trailing_stop_orders.py`
**Generated:** 2025-11-15T19:40:08.973592Z
**File Size:** 11904 bytes
**Extension:** .py
**Type:** text
...
This file is located at `tests/unit_tests/backtest/test_exchange_bracket_trailing_stop_orders.py` within the repository.

**Classes defined:** TestSimulatedExchangeEmulatedContingencyOrders

**Functions defined:** setup, test_bracket_accepts_trailing_stop_market_order_tp, test_bracket_accepts_trailing_stop_market_order_sl
...
#### `test_bracket_accepts_trailing_stop_market_order_tp(
        self,
        emulation_trigger: TriggerType,
    )`


#### `test_bracket_accepts_trailing_stop_market_order_sl(
        self,
        emulation_trigger: TriggerType,
    )`
...
```python
from tests.unit_tests.backtest.test_exchange_bracket_trailing_stop_orders import TestSimulatedExchangeEmulatedContingencyOrders
```
