# Documentation: test_exchange_bracket_trailing_stop_orders.py

## File Metadata

- **Path**: `tests/unit_tests/backtest/test_exchange_bracket_trailing_stop_orders.py`
- **Size**: 11,890 bytes
- **Lines**: 335
- **Language**: Python
...
**Imports**: `decimal`, `nautilus_trader.backtest.engine`, `nautilus_trader.backtest.execution_client`, `nautilus_trader.backtest.models`, `nautilus_trader.common.component`, `nautilus_trader.data.engine`, `nautilus_trader.execution.emulator`, `nautilus_trader.execution.engine`, `nautilus_trader.model.currencies`, `nautilus_trader.model.enums`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.objects`, `nautilus_trader.portfolio.portfolio`, `nautilus_trader.risk.engine`, `nautilus_trader.test_kit.mocks.strategies`, `nautilus_trader.test_kit.providers`, `nautilus_trader.test_kit.stubs.component`, `nautilus_trader.test_kit.stubs.data`, `nautilus_trader.test_kit.stubs.identifiers`, `pytest`
...
```bash
# For Python
pytest tests/unit_tests/backtest/test_exchange_bracket_trailing_stop_orders.py
...
---
*Generated on 2025-11-18T21:55:11.191109Z*
