# Documentation: `tests/unit_tests/risk/test_sizing.py`
**Generated:** 2025-11-15T19:40:09.472184Z
...
- **Path:** `tests/unit_tests/risk/test_sizing.py`
- **Size:** 6,539 bytes
- **Lines:** 213
- **Extension:** `.py`
- **Type:** text
...
This file is located at `tests/unit_tests/risk/test_sizing.py` within the repository.

**Classes defined:** TestPositionSizer, TestFixedRiskSizer

**Functions defined:** test_update_instrument, setup, test_calculate_with_zero_equity_returns_quantity_zero, test_calculate_with_zero_exchange_rate_returns_quantity_zero, test_calculate_with_zero_risk_returns_quantity_zero, test_calculate_single_unit_size, test_calculate_single_unit_with_exchange_rate, test_calculate_single_unit_size_when_risk_too_high, test_impose_hard_limit, test_calculate_multiple_unit_size and 2 more
...
#### `test_calculate_with_zero_equity_returns_quantity_zero(self)`


#### `test_calculate_with_zero_exchange_rate_returns_quantity_zero(self)`


#### `test_calculate_with_zero_risk_returns_quantity_zero(self)`


#### `test_calculate_single_unit_size(self)`


#### `test_calculate_single_unit_with_exchange_rate(self)`


#### `test_calculate_single_unit_size_when_risk_too_high(self)`


#### `test_impose_hard_limit(self)`


#### `test_calculate_multiple_unit_size(self)`


#### `test_calculate_multiple_unit_size_larger_batches(self)`


#### `test_calculate_for_usdjpy_with_commission(self)`
...
```python
from tests.unit_tests.risk.test_sizing import TestPositionSizer
```
