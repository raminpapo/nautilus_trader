...
### Classes
- **`TestPositionSizer`**: Class defined in this file
- **`TestFixedRiskSizer`**: Class defined in this file
...
**Classs**: `TestFixedRiskSizer`, `TestPositionSizer`
**Imports**: `decimal`, `nautilus_trader.model.currencies`, `nautilus_trader.model.objects`, `nautilus_trader.risk.sizing`, `nautilus_trader.test_kit.providers`
...
```bash
# For Python
pytest tests/unit_tests/risk/test_sizing.py
...
---
*Generated on 2025-11-18T21:55:11.757786Z*
