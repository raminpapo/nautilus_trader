# Documentation: `tests/unit_tests/risk/test_engine.py`
**Generated:** 2025-11-15T19:40:09.468088Z
**File Size:** 102106 bytes
**Extension:** .py
**Type:** text
...
- **Path:** `tests/unit_tests/risk/test_engine.py`
- **Size:** 102,106 bytes
- **Lines:** 3,215
- **Extension:** `.py`
- **Type:** text
...
This file is located at `tests/unit_tests/risk/test_engine.py` within the repository.

**Classes defined:** TestRiskEngineWithCashAccount, TestRiskEngineWithBettingAccount, TestRiskEngineWithCryptoCashAccount

**Functions defined:** setup, test_config_risk_engine, test_risk_engine_on_stop, test_process_event_then_handles, test_trading_state_after_instantiation_returns_active, test_set_trading_state_when_no_change_logs_warning, test_set_trading_state_changes_value_and_publishes_event, test_max_order_submit_rate_when_no_risk_config_returns_100_per_second, test_max_order_modify_rate_when_no_risk_config_returns_100_per_second, test_max_notionals_per_order_when_no_risk_config_returns_empty_dict and 55 more
...
#### `TestRiskEngineWithCashAccount`


#### `TestRiskEngineWithBettingAccount`


#### `TestRiskEngineWithCryptoCashAccount`
...
#### `test_config_risk_engine(self)`


#### `test_risk_engine_on_stop(self)`


#### `test_process_event_then_handles(self)`


#### `test_trading_state_after_instantiation_returns_active(self)`


#### `test_set_trading_state_when_no_change_logs_warning(self)`


#### `test_set_trading_state_changes_value_and_publishes_event(self)`


#### `test_max_order_submit_rate_when_no_risk_config_returns_100_per_second(self)`


#### `test_max_order_modify_rate_when_no_risk_config_returns_100_per_second(self)`


#### `test_max_notionals_per_order_when_no_risk_config_returns_empty_dict(self)`


#### `test_max_notional_per_order_when_no_risk_config_returns_none(self)`


#### `test_set_max_notional_per_order_changes_setting(self)`


#### `test_given_random_command_then_logs_and_continues(self)`


#### `test_given_random_event_then_logs_and_continues(self)`


#### `test_submit_order_with_default_settings_then_sends_to_client(self)`


#### `test_submit_order_when_risk_bypassed_sends_to_execution_engine(self)`


#### `test_submit_reduce_only_order_when_closing_full_cash_position_allows(self)`


#### `test_submit_reduce_only_order_with_missing_position_denies_cash(self)`


#### `test_submit_reduce_only_order_when_quantity_exceeds_position_denies_cash(self)`


#### `test_submit_reduce_only_order_when_position_already_closed_then_denies(self)`


#### `test_submit_reduce_only_order_when_position_would_be_increased_then_denies(self)`


#### `test_submit_order_reduce_only_order_with_custom_position_id_not_open_then_denies(self)`


#### `test_submit_order_when_instrument_not_in_cache_then_denies(self)`


#### `test_submit_order_when_invalid_price_precision_then_denies(self)`


#### `test_submit_order_when_invalid_negative_price_and_not_option_then_denies(self)`


#### `test_submit_order_when_negative_price_for_futures_spread_then_allows(self)`


#### `test_submit_order_when_negative_price_for_option_spread_then_allows(self)`


#### `test_submit_order_when_invalid_trigger_price_then_denies(self)`


#### `test_submit_order_when_invalid_quantity_precision_then_denies(self)`


#### `test_submit_order_when_invalid_quantity_exceeds_maximum_then_denies(self)`


#### `test_submit_order_when_invalid_quantity_less_than_minimum_then_denies(self)`


#### `test_submit_order_when_market_order_and_no_market_then_logs_warning(self)`


#### `test_submit_order_when_less_than_min_notional_for_instrument_then_denies(
        self,
        order_side: OrderSide,
    )`


#### `test_submit_order_when_greater_than_max_notional_for_instrument_then_denies(
        self,
        order_side: OrderSide,
    )`


#### `test_submit_order_when_buy_market_order_and_over_max_notional_then_denies(self)`


#### `test_submit_order_when_sell_market_order_and_over_max_notional_then_denies(self)`


#### `test_submit_order_when_market_order_and_over_free_balance_then_denies(self)`


#### `test_submit_order_list_buys_when_over_free_balance_then_denies(self)`


#### `test_submit_order_list_sells_when_over_free_balance_then_denies(self)`


#### `test_submit_sell_order_cash_account_checks_base_currency_not_quote(self)`


#### `test_submit_order_when_quote_quantity_buy_within_balance_then_allows(self)`


#### `test_submit_order_when_quote_quantity_buy_over_balance_then_denies(self)`


#### `test_submit_order_with_quote_quantity_validates_against_effective_quantity(self)`


#### `test_submit_order_with_quote_quantity_exceeds_max_after_conversion(self)`


#### `test_submit_order_list_sells_when_multi_currency_cash_account_over_cumulative_notional(
        self,
    )`


#### `test_submit_order_when_reducing_and_buy_order_adds_then_denies(self)`


#### `test_submit_order_when_reducing_and_sell_order_adds_then_denies(self)`


#### `test_submit_order_when_trading_halted_then_denies_order(self)`


#### `test_submit_order_beyond_rate_limit_then_denies_order(self)`


#### `test_submit_order_list_when_trading_halted_then_denies_orders(self)`
...
```python
from tests.unit_tests.risk.test_engine import TestRiskEngineWithCashAccount
```
...
**Directory:** `tests/unit_tests/risk`
