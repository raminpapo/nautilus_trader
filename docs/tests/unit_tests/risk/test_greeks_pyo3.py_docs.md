# Documentation: `tests/unit_tests/risk/test_greeks_pyo3.py`
**Generated:** 2025-11-15T19:40:09.470622Z
...
This file is located at `tests/unit_tests/risk/test_greeks_pyo3.py` within the repository.

**Functions defined:** test_greeks_accuracy_call, price0, test_greeks_accuracy_put, price0, test_imply_vol_and_greeks_accuracy_call, test_imply_vol_and_greeks_accuracy_put
...
```python
from tests.unit_tests.risk.test_greeks_pyo3 import test_greeks_accuracy_call
```
