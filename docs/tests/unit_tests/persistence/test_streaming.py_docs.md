# Documentation: test_streaming.py
...
### Classes
- **`TestPersistenceStreaming`**: Class defined in this file
...
**Classs**: `TestPersistenceStreaming`
**Imports**: `collections`, `copy`, `nautilus_trader.backtest.node`, `nautilus_trader.backtest.results`, `nautilus_trader.common.signal`, `nautilus_trader.config`, `nautilus_trader.core.data`, `nautilus_trader.core.rust.model`, `nautilus_trader.model.book`, `nautilus_trader.model.data`, `nautilus_trader.model.identifiers`, `nautilus_trader.persistence.catalog.parquet`, `nautilus_trader.test_kit.mocks.data`, `nautilus_trader.test_kit.stubs.persistence`, `tests.integration_tests.adapters.betfair.test_kit`
...
```bash
# For Python
pytest tests/unit_tests/persistence/test_streaming.py
...
---
*Generated on 2025-11-18T21:55:11.715583Z*
