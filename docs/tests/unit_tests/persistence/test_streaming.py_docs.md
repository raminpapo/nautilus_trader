# Documentation: `tests/unit_tests/persistence/test_streaming.py`
**Generated:** 2025-11-15T19:40:09.429001Z
**File Size:** 22742 bytes
**Extension:** .py
**Type:** text
...
- **Path:** `tests/unit_tests/persistence/test_streaming.py`
- **Size:** 22,742 bytes
- **Lines:** 629
- **Extension:** `.py`
- **Type:** text
...
This file is located at `tests/unit_tests/persistence/test_streaming.py` within the repository.

**Classes defined:** TestPersistenceStreaming

**Functions defined:** setup, _run_default_backtest, test_feather_writer, test_feather_writer_custom_data, test_feather_writer_include_types, test_feather_writer_stream_to_data, test_stream_to_data_directory, test_feather_writer_signal_data, test_generate_signal_class, test_config_write and 6 more
...
#### `test_feather_writer(self, catalog_betfair: ParquetDataCatalog)`


#### `test_feather_writer_custom_data(
        self,
        catalog_betfair: ParquetDataCatalog,
    )`


#### `test_feather_writer_include_types(
        self,
        catalog_betfair: ParquetDataCatalog,
    )`


#### `test_feather_writer_stream_to_data(
        self,
        catalog_betfair: ParquetDataCatalog,
    )`


#### `test_stream_to_data_directory(self, catalog_betfair: ParquetDataCatalog)`


#### `test_feather_writer_signal_data(
        self,
        catalog_betfair: ParquetDataCatalog,
    )`


#### `test_generate_signal_class(self)`
...
#### `test_feather_reader_returns_cython_objects(
        self,
        catalog_betfair: ParquetDataCatalog,
    )`


#### `test_feather_reader_order_book_deltas(
        self,
        catalog_betfair: ParquetDataCatalog,
    )`
...
#### `test_feather_writer_per_bar_type(
        self,
        catalog_betfair: ParquetDataCatalog,
    )`


#### `test_convert_stream_to_data_with_identifiers(
        self,
        catalog_betfair: ParquetDataCatalog,
    )`


#### `test_convert_stream_to_data_internal_to_external(
        self,
        catalog_betfair: ParquetDataCatalog,
    )`
...
```python
from tests.unit_tests.persistence.test_streaming import TestPersistenceStreaming
```
