# Documentation: `tests/unit_tests/persistence/test_wranglers_v2.py`
**Generated:** 2025-11-15T19:40:09.433422Z
...
This file is located at `tests/unit_tests/persistence/test_wranglers_v2.py` within the repository.

**Functions defined:** test_quote_tick_data_wrangler, test_trade_tick_data_wrangler
...
#### `test_quote_tick_data_wrangler()`


#### `test_trade_tick_data_wrangler()`
...
```python
from tests.unit_tests.persistence.test_wranglers_v2 import test_quote_tick_data_wrangler
```
