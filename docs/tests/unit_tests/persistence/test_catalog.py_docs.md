# Documentation: `tests/unit_tests/persistence/test_catalog.py`
**Generated:** 2025-11-15T19:40:09.419092Z
**File Size:** 78869 bytes
**Extension:** .py
**Type:** text
...
This file is located at `tests/unit_tests/persistence/test_catalog.py` within the repository.

**Classes defined:** TestCustomData, TestConsolidateDataByPeriod

**Functions defined:** test_list_data_types, test_catalog_query_filtered, test_catalog_query_custom_filtered, test_catalog_instruments_df, test_catalog_instruments_filtered_df, test_catalog_currency_with_null_max_price_loads, test_catalog_instrument_ids_correctly_unmapped, test_catalog_with_databento_instruments, test_catalog_filter, test_catalog_orderbook_deltas_precision and 67 more
...
#### `TestConsolidateDataByPeriod`


### Functions

#### `test_list_data_types(catalog_betfair: ParquetDataCatalog)`


#### `test_catalog_query_filtered(
    catalog_betfair: ParquetDataCatalog,
)`


#### `test_catalog_query_custom_filtered(
    catalog_betfair: ParquetDataCatalog,
)`


#### `test_catalog_instruments_df(
    catalog_betfair: ParquetDataCatalog,
)`


#### `test_catalog_instruments_filtered_df(
    catalog_betfair: ParquetDataCatalog,
)`


#### `test_catalog_currency_with_null_max_price_loads(
    catalog_betfair: ParquetDataCatalog,
)`


#### `test_catalog_instrument_ids_correctly_unmapped(catalog: ParquetDataCatalog)`


#### `test_catalog_with_databento_instruments(catalog: ParquetDataCatalog)`
...
#### `test_catalog_orderbook_deltas_precision(
    catalog_betfair: ParquetDataCatalog,
)`


#### `test_catalog_custom_data(catalog: ParquetDataCatalog)`


#### `test_catalog_bars_querying_by_bar_type(catalog: ParquetDataCatalog)`


#### `test_catalog_bars_querying_by_instrument_id(catalog: ParquetDataCatalog)`


#### `test_catalog_write_pyo3_order_book_depth10(catalog: ParquetDataCatalog)`


#### `test_catalog_write_pyo3_quote_ticks(catalog: ParquetDataCatalog)`


#### `test_catalog_write_pyo3_trade_ticks(catalog: ParquetDataCatalog)`


#### `test_catalog_multiple_bar_types(catalog: ParquetDataCatalog)`


#### `test_catalog_bar_query_instrument_id(
    catalog_betfair: ParquetDataCatalog,
)`


#### `test_catalog_persists_equity(
    catalog: ParquetDataCatalog,
)`
...
#### `test_catalog_query_with_static_metadata(catalog: ParquetDataCatalog)`


#### `test_catalog_query_with_callable_metadata(catalog: ParquetDataCatalog)`


#### `metadata_func(data_item)`


#### `test_catalog_query_without_metadata_parameter(catalog: ParquetDataCatalog)`
...
#### `_get_bar_type_identifier(self)`


#### `_get_quote_type_identifier(self)`


#### `_get_realistic_timestamps(self, count: int, interval_hours: int = 1)`


#### `test_consolidate_basic_functionality(self)`


#### `test_consolidate_with_time_range(self)`


#### `test_consolidate_empty_data(self)`


#### `test_consolidate_different_periods(self)`


#### `test_prepare_consolidation_queries_with_splits(self)`


#### `test_consolidate_multiple_instruments(self)`


#### `test_consolidate_ensure_contiguous_files_false(self)`


#### `test_consolidate_default_parameters(self)`


#### `test_consolidate_with_contiguous_timestamps(self)`


#### `test_consolidate_large_period(self)`


#### `test_consolidate_all_instruments(self)`


#### `test_consolidate_file_operations_integration(self)`


#### `test_consolidate_preserves_data_across_periods(self)`


#### `test_consolidate_mixed_data_types_integration(self)`


#### `test_consolidate_boundary_conditions(self)`


#### `test_consolidate_catalog_by_period(catalog: ParquetDataCatalog)`


#### `test_extract_data_cls_and_identifier_from_path(catalog: ParquetDataCatalog)`
...
```python
from tests.unit_tests.persistence.test_catalog import TestCustomData
```
