# Documentation: test_catalog.py

## File Metadata

- **Path**: `tests/unit_tests/persistence/test_catalog.py`
- **Size**: 78,867 bytes
- **Lines**: 2,259
- **Language**: Python
...
This file is part of the NautilusTrader repository. It defines 54 function(s) and 2 class(es).

## Detailed Walkthrough

### Functions
- **`test_list_data_types()`**: Function defined in this file
- **`test_catalog_query_filtered()`**: Function defined in this file
- **`test_catalog_query_custom_filtered()`**: Function defined in this file
- **`test_catalog_instruments_df()`**: Function defined in this file
- **`test_catalog_instruments_filtered_df()`**: Function defined in this file
- **`test_catalog_currency_with_null_max_price_loads()`**: Function defined in this file
- **`test_catalog_instrument_ids_correctly_unmapped()`**: Function defined in this file
- **`test_catalog_with_databento_instruments()`**: Function defined in this file
- **`test_catalog_filter()`**: Function defined in this file
- **`test_catalog_orderbook_deltas_precision()`**: Function defined in this file
- **`test_catalog_custom_data()`**: Function defined in this file
- **`test_catalog_bars_querying_by_bar_type()`**: Function defined in this file
- **`test_catalog_bars_querying_by_instrument_id()`**: Function defined in this file
- **`test_catalog_write_pyo3_order_book_depth10()`**: Function defined in this file
- **`test_catalog_write_pyo3_quote_ticks()`**: Function defined in this file
- **`test_catalog_write_pyo3_trade_ticks()`**: Function defined in this file
- **`test_catalog_multiple_bar_types()`**: Function defined in this file
- **`test_catalog_bar_query_instrument_id()`**: Function defined in this file
- **`test_catalog_persists_equity()`**: Function defined in this file
- **`test_list_backtest_runs()`**: Function defined in this file

*...and 34 more functions*

### Classes
- **`TestCustomData`**: Class defined in this file
- **`TestConsolidateDataByPeriod`**: Class defined in this file


## Keywords and Identifiers

Total unique keywords extracted: 82


**Classs**: `TestConsolidateDataByPeriod`, `TestCustomData`
**Functions**: `test_backend_session_table_naming_multiple_instruments`, `test_backend_session_table_naming_special_characters`, `test_catalog_bar_query_instrument_id`, `test_catalog_bars_querying_by_bar_type`, `test_catalog_bars_querying_by_instrument_id`, `test_catalog_currency_with_null_max_price_loads`, `test_catalog_custom_data`, `test_catalog_filter`, `test_catalog_instrument_ids_correctly_unmapped`, `test_catalog_instruments_df`, `test_catalog_instruments_filtered_df`, `test_catalog_multiple_bar_types`, `test_catalog_orderbook_deltas_precision`, `test_catalog_persists_equity`, `test_catalog_query_custom_filtered`, `test_catalog_query_filtered`, `test_catalog_query_with_callable_metadata`, `test_catalog_query_with_static_metadata`, `test_catalog_query_without_metadata_parameter`, `test_catalog_with_databento_instruments`, `test_catalog_write_pyo3_order_book_depth10`, `test_catalog_write_pyo3_quote_ticks`, `test_catalog_write_pyo3_trade_ticks`, `test_consolidate_catalog_by_period`, `test_delete_catalog_range_boundary_conditions`, `test_delete_catalog_range_complete_deletion`, `test_delete_catalog_range_empty_catalog`, `test_delete_catalog_range_multiple_data_types`, `test_delete_catalog_range_multiple_instruments`, `test_delete_catalog_range_no_intersection` *(+24 more)*
**Imports**: `datetime`, `nautilus_trader`, `nautilus_trader.adapters.betfair.constants`, `nautilus_trader.adapters.databento.loaders`, `nautilus_trader.core`, `nautilus_trader.core.data`, `nautilus_trader.core.datetime`, `nautilus_trader.core.rust.model`, `nautilus_trader.model.custom`, `nautilus_trader.model.data`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.instruments`, `nautilus_trader.model.objects`, `nautilus_trader.persistence.catalog.parquet`, `nautilus_trader.persistence.wranglers_v2`, `nautilus_trader.test_kit.mocks.data`, `nautilus_trader.test_kit.providers`, `nautilus_trader.test_kit.rust.data_pyo3`, `nautilus_trader.test_kit.stubs.data`, `nautilus_trader.test_kit.stubs.persistence`, `pandas`, `pyarrow.dataset`, `pytest`, `sys`, `tempfile`, `unittest.mock`
...
```bash
# For Python
pytest tests/unit_tests/persistence/test_catalog.py
...
---
*Generated on 2025-11-18T21:55:11.705820Z*
