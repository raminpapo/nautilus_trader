# Documentation: `tests/unit_tests/persistence/test_catalog_pyo3.py`
**Generated:** 2025-11-15T19:40:09.424625Z
**File Size:** 41562 bytes
**Extension:** .py
**Type:** text
...
- **Path:** `tests/unit_tests/persistence/test_catalog_pyo3.py`
- **Size:** 41,562 bytes
- **Lines:** 1,305
- **Extension:** `.py`
- **Type:** text
...
This file is located at `tests/unit_tests/persistence/test_catalog_pyo3.py` within the repository.

**Functions defined:** bar, test_write_2_bars_to_catalog, test_append_data_to_catalog, test_consolidate_catalog, test_consolidate_catalog_with_time_range, test_get_missing_intervals, test_reset_file_names, test_extend_file_name, test_reset_all_file_names, quote_tick and 50 more
...
#### `test_write_2_bars_to_catalog(catalog: ParquetDataCatalog)`


#### `test_append_data_to_catalog(catalog: ParquetDataCatalog)`


#### `test_consolidate_catalog(catalog: ParquetDataCatalog)`


#### `test_consolidate_catalog_with_time_range(catalog: ParquetDataCatalog)`


#### `test_get_missing_intervals(catalog: ParquetDataCatalog)`


#### `test_reset_file_names(catalog: ParquetDataCatalog)`


#### `test_extend_file_name(catalog: ParquetDataCatalog)`


#### `test_reset_all_file_names(catalog: ParquetDataCatalog)`
...
#### `index_price_update(t)`


#### `test_write_quote_ticks(catalog: ParquetDataCatalog)`


#### `test_write_trade_ticks(catalog: ParquetDataCatalog)`


#### `test_write_order_book_deltas(catalog: ParquetDataCatalog)`


#### `test_write_mark_price_updates(catalog: ParquetDataCatalog)`


#### `test_write_index_price_updates(catalog: ParquetDataCatalog)`


#### `test_query_files(catalog: ParquetDataCatalog)`


#### `test_query_files_with_multiple_files(catalog: ParquetDataCatalog)`


#### `test_get_intervals_empty(catalog: ParquetDataCatalog)`


#### `test_query_bars(catalog: ParquetDataCatalog)`


#### `test_query_quote_ticks(catalog: ParquetDataCatalog)`


#### `test_query_trade_ticks(catalog: ParquetDataCatalog)`


#### `test_query_order_book_deltas(catalog: ParquetDataCatalog)`


#### `test_query_mark_price_updates(catalog: ParquetDataCatalog)`


#### `test_query_index_price_updates(catalog: ParquetDataCatalog)`


#### `test_query_bars_with_time_range(catalog: ParquetDataCatalog)`


#### `test_query_bars_empty_result(catalog: ParquetDataCatalog)`


#### `test_query_bars_with_where_clause(catalog: ParquetDataCatalog)`


#### `test_query_quote_ticks_with_time_range(catalog: ParquetDataCatalog)`


#### `test_query_trade_ticks_with_time_range(catalog: ParquetDataCatalog)`


#### `test_consolidate_catalog_by_period_basic(catalog: ParquetDataCatalog)`


#### `test_consolidate_catalog_by_period_empty_catalog(catalog: ParquetDataCatalog)`


#### `test_consolidate_catalog_by_period_mixed_data_types(catalog: ParquetDataCatalog)`


#### `test_consolidate_data_by_period_basic(catalog: ParquetDataCatalog)`


#### `test_consolidate_data_by_period_with_time_range(catalog: ParquetDataCatalog)`


#### `test_consolidate_data_by_period_empty_data(catalog: ParquetDataCatalog)`


#### `test_consolidate_data_by_period_default_parameters(catalog: ParquetDataCatalog)`


#### `test_consolidate_data_by_period_different_periods(catalog: ParquetDataCatalog)`


#### `test_consolidate_data_by_period_ensure_contiguous_files_true(catalog: ParquetDataCatalog)`


#### `test_query_functions_data_integrity(catalog: ParquetDataCatalog)`


#### `test_delete_data_range_complete_file_deletion(catalog: ParquetDataCatalog)`


#### `test_delete_data_range_partial_file_overlap_start(catalog: ParquetDataCatalog)`


#### `test_delete_data_range_partial_file_overlap_end(catalog: ParquetDataCatalog)`


#### `test_delete_data_range_partial_file_overlap_middle(catalog: ParquetDataCatalog)`


#### `test_delete_data_range_no_data(catalog: ParquetDataCatalog)`


#### `test_delete_data_range_no_intersection(catalog: ParquetDataCatalog)`
...
```python
from tests.unit_tests.persistence.test_catalog_pyo3 import bar
```
