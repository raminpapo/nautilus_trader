# Documentation: test_catalog_pyo3.py
...
This file is part of the NautilusTrader repository. It defines 60 function(s).

## Detailed Walkthrough

### Functions
- **`bar()`**: Function defined in this file
- **`test_write_2_bars_to_catalog()`**: Function defined in this file
- **`test_append_data_to_catalog()`**: Function defined in this file
- **`test_consolidate_catalog()`**: Function defined in this file
- **`test_consolidate_catalog_with_time_range()`**: Function defined in this file
- **`test_get_missing_intervals()`**: Function defined in this file
- **`test_reset_file_names()`**: Function defined in this file
- **`test_extend_file_name()`**: Function defined in this file
- **`test_reset_all_file_names()`**: Function defined in this file
- **`quote_tick()`**: Function defined in this file
- **`trade_tick()`**: Function defined in this file
- **`order_book_delta()`**: Function defined in this file
- **`order_book_depth()`**: Function defined in this file
- **`mark_price_update()`**: Function defined in this file
- **`index_price_update()`**: Function defined in this file
- **`test_write_quote_ticks()`**: Function defined in this file
- **`test_write_trade_ticks()`**: Function defined in this file
- **`test_write_order_book_deltas()`**: Function defined in this file
- **`test_write_mark_price_updates()`**: Function defined in this file
- **`test_write_index_price_updates()`**: Function defined in this file
...
**Functions**: `bar`, `index_price_update`, `mark_price_update`, `order_book_delta`, `order_book_depth`, `quote_tick`, `test_append_data_to_catalog`, `test_consolidate_catalog`, `test_consolidate_catalog_by_period_basic`, `test_consolidate_catalog_by_period_empty_catalog`, `test_consolidate_catalog_by_period_mixed_data_types`, `test_consolidate_catalog_with_time_range`, `test_consolidate_data_by_period_basic`, `test_consolidate_data_by_period_default_parameters`, `test_consolidate_data_by_period_different_periods`, `test_consolidate_data_by_period_empty_data`, `test_consolidate_data_by_period_ensure_contiguous_files_true`, `test_consolidate_data_by_period_with_time_range`, `test_delete_catalog_range_complete_deletion`, `test_delete_catalog_range_empty_catalog`, `test_delete_catalog_range_multiple_data_types`, `test_delete_catalog_range_open_boundaries`, `test_delete_data_range_complete_file_deletion`, `test_delete_data_range_file_contiguity_verification`, `test_delete_data_range_nanosecond_precision_boundaries`, `test_delete_data_range_no_data`, `test_delete_data_range_no_intersection`, `test_delete_data_range_partial_file_overlap_end`, `test_delete_data_range_partial_file_overlap_middle`, `test_delete_data_range_partial_file_overlap_start` *(+30 more)*
**Imports**: `nautilus_trader.core.nautilus_pyo3`, `nautilus_trader.persistence.catalog`, `nautilus_trader.test_kit.rust.data_pyo3`, `nautilus_trader.test_kit.rust.identifiers_pyo3`, `os`, `pytest`, `sys`
...
```bash
# For Python
pytest tests/unit_tests/persistence/test_catalog_pyo3.py
...
---
*Generated on 2025-11-18T21:55:11.710983Z*
