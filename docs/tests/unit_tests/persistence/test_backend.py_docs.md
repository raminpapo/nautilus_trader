# Documentation: `tests/unit_tests/persistence/test_backend.py`
**Generated:** 2025-11-15T19:40:09.411351Z
**File Size:** 6868 bytes
**Extension:** .py
**Type:** text
...
This file is located at `tests/unit_tests/persistence/test_backend.py` within the repository.

**Functions defined:** test_backend_session_order_book_deltas, test_backend_session_quotes, test_backend_session_trades, test_backend_session_bars, test_backend_session_multiple_types, test_backend_session_register_object_store_from_uri_local_file, test_backend_session_register_object_store_from_uri_invalid_uri, test_backend_session_register_object_store_from_uri_nonexistent_path
...
#### `test_backend_session_order_book_deltas()`


#### `test_backend_session_quotes()`


#### `test_backend_session_trades()`


#### `test_backend_session_bars()`


#### `test_backend_session_multiple_types()`


#### `test_backend_session_register_object_store_from_uri_local_file()`


#### `test_backend_session_register_object_store_from_uri_invalid_uri()`
...
```python
from tests.unit_tests.persistence.test_backend import test_backend_session_order_book_deltas
```
