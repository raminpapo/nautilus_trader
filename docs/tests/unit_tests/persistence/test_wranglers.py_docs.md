# Documentation: `tests/unit_tests/persistence/test_wranglers.py`
**Generated:** 2025-11-15T19:40:09.432131Z
**File Size:** 5705 bytes
**Extension:** .py
**Type:** text
...
This file is located at `tests/unit_tests/persistence/test_wranglers.py` within the repository.

**Functions defined:** test_load_deltas, test_quote_bar_data_wrangler, test_trade_bar_data_wrangler, test_trade_bar_data_wrangler_size_precision
...
#### `test_trade_bar_data_wrangler_size_precision(is_raw: bool)`
...
```python
from tests.unit_tests.persistence.test_wranglers import test_load_deltas
```
