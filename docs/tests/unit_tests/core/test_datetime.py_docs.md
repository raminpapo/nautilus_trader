# Documentation: `tests/unit_tests/core/test_datetime.py`
**Generated:** 2025-11-15T19:40:09.079543Z
**File Size:** 18833 bytes
**Extension:** .py
**Type:** text
...
- **Path:** `tests/unit_tests/core/test_datetime.py`
- **Size:** 18,833 bytes
- **Lines:** 578
- **Extension:** `.py`
- **Type:** text
...
This file is located at `tests/unit_tests/core/test_datetime.py` within the repository.

**Classes defined:** TestDatetimeFunctions

**Functions defined:** test_secs_to_nanos, test_secs_to_millis, test_millis_to_nanos, test_micros_to_nanos, test_nanos_to_secs, test_nanos_to_millis, test_nanos_to_micros, test_unix_nanos_to_dt, test_maybe_unix_nanos_to_dt, test_dt_to_unix_nanos and 25 more
...
#### `test_secs_to_nanos(self, value, expected)`


#### `test_secs_to_millis(self, value, expected)`


#### `test_millis_to_nanos(self, value, expected)`


#### `test_micros_to_nanos(self, value, expected)`


#### `test_nanos_to_secs(self, value, expected)`


#### `test_nanos_to_millis(self, value, expected)`


#### `test_nanos_to_micros(self, value, expected)`


#### `test_unix_nanos_to_dt(self, value, expected)`


#### `test_maybe_unix_nanos_to_dt(self, value, expected)`


#### `test_dt_to_unix_nanos(self, value, expected)`


#### `test_maybe_dt_to_unix_nanos(self, value, expected)`


#### `test_iso8601_to_unix_nanos_given_iso8601_datetime_string(self, value, expected)`


#### `test_is_datetime_utc_given_tz_naive_datetime_returns_false(self)`


#### `test_is_datetime_utc_given_utc_datetime_returns_true(self)`


#### `test_is_tz_awareness_given_unrecognized_type_raises_exception(self)`


#### `test_is_tz_awareness_with_various_aware_objects_returns_true(self)`


#### `test_is_tz_awareness_with_various_objects_returns_false(self)`


#### `test_format_iso8601(self)`


#### `test_format_optional_iso8601(self, value: pd.Timestamp | None, expected: str)`


#### `test_datetime_and_pd_timestamp_equality(self)`


#### `test_as_utc_timestamp_given_tz_naive_datetime(self, tzinfo=UTC)`


#### `test_as_utc_timestamp_given_tz_naive_pandas_timestamp(self)`


#### `test_as_utc_timestamp_given_tz_aware_datetime(self, tzinfo=UTC)`


#### `test_as_utc_timestamp_given_tz_aware_pandas(self)`


#### `test_as_utc_timestamp_equality(self)`


#### `test_as_utc_index_given_empty_dataframe_returns_empty_dataframe(self)`


#### `test_with_utc_index_given_tz_unaware_dataframe(self)`


#### `test_with_utc_index_given_tz_aware_dataframe(self)`


#### `test_with_utc_index_given_tz_aware_different_timezone_dataframe(self)`


#### `test_ensure_pydatetime_utc_given_none_returns_none(self)`


#### `test_ensure_pydatetime_utc_unix_epoch(self)`


#### `test_ensure_pydatetime_utc_given_utc_timestamp_returns_pydatetime(self, tzinfo=UTC)`


#### `test_ensure_pydatetime_utc_given_non_utc_timestamp_converts_to_utc(self)`


#### `test_ensure_pydatetime_utc_given_naive_timestamp_raises_error(self)`


#### `test_ensure_pydatetime_utc_timezone_conversion(self, timezone, expected_hour)`
...
```python
from tests.unit_tests.core.test_datetime import TestDatetimeFunctions
```
