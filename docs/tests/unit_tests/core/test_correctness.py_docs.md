# Documentation: test_correctness.py
...
### Classes
- **`TestCondition`**: Class defined in this file
...
**Classs**: `TestCondition`
**Imports**: `decimal`, `nautilus_trader.core.correctness`, `pytest`
...
```bash
# For Python
pytest tests/unit_tests/core/test_correctness.py
...
---
*Generated on 2025-11-18T21:55:11.308045Z*
