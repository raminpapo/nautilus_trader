# Documentation: `tests/unit_tests/core/test_correctness.py`
**Generated:** 2025-11-15T19:40:09.075599Z
**File Size:** 12736 bytes
**Extension:** .py
**Type:** text
...
- **Path:** `tests/unit_tests/core/test_correctness.py`
- **Size:** 12,736 bytes
- **Lines:** 332
- **Extension:** `.py`
- **Type:** text
...
This file is located at `tests/unit_tests/core/test_correctness.py` within the repository.

**Classes defined:** TestCondition

**Functions defined:** test_raises_custom_exception, test_true_when_predicate_false_raises_value_error, test_true_when_predicate_true_does_nothing, test_false_when_predicate_true_raises_value_error, test_false_when_predicate_false_does_nothing, test_is_none_when_arg_not_none_raises_type_error, test_is_none_when_arg_is_none_does_nothing, test_not_none_when_arg_none_raises_type_error, test_not_none_when_arg_not_none_does_nothing, test_type_when_type_is_incorrect_raises_type_error and 42 more
...
#### `test_raises_custom_exception(self)`


#### `test_true_when_predicate_false_raises_value_error(self)`


#### `test_true_when_predicate_true_does_nothing(self)`


#### `test_false_when_predicate_true_raises_value_error(self)`


#### `test_false_when_predicate_false_does_nothing(self)`


#### `test_is_none_when_arg_not_none_raises_type_error(self)`


#### `test_is_none_when_arg_is_none_does_nothing(self)`


#### `test_not_none_when_arg_none_raises_type_error(self)`


#### `test_not_none_when_arg_not_none_does_nothing(self)`


#### `test_type_when_type_is_incorrect_raises_type_error(self)`


#### `test_type_when_type_is_correct_does_nothing(self)`


#### `test_type_or_none_when_type_is_incorrect_raises_type_error(self)`


#### `test_type_or_none_when_type_is_correct_or_none_does_nothing(self)`


#### `test_callable_when_arg_not_callable_raises_type_error(self)`


#### `test_callable_when_arg_is_callable_does_nothing(self)`


#### `test_callable_or_none_when_arg_not_callable_raises_type_error(self)`


#### `test_callable_or_none_when_arg_is_callable_or_none_does_nothing(self, value)`


#### `test_equal_when_args_not_equal_raises_value_error(self, id1, id2)`


#### `test_equal_when_args_are_equal_does_nothing(self)`


#### `test_not_equal_when_args_not_equal_raises_value_error(self)`


#### `test_not_equal_when_args_are_not_equal_does_nothing(self)`


#### `test_list_type_when_contains_incorrect_types_raises_type_error(self)`


#### `test_list_type_when_contains_correct_types_or_none_does_nothing(self, value, list_type)`


#### `test_dict_types_when_contains_incorrect_types_raises_type_error(self, value)`


#### `test_dict_types_when_contains_correct_types_or_none_does_nothing(self, value)`


#### `test_is_in_when_item_not_in_list_raises_type_error(self)`


#### `test_is_in_when_item_is_in_list_does_nothing(self)`


#### `test_not_in_when_item_is_in_list_raises_value_error(self)`


#### `test_not_in_when_item_not_in_list_does_nothing(self)`


#### `test_key_is_in_when_key_not_in_dictionary_raises_key_error(self)`


#### `test_key_is_in_when_key_is_in_dictionary_does_nothing(self)`


#### `test_key_not_in_when_key_is_in_dictionary_raises_key_error(self)`


#### `test_key_not_in_when_key_not_in_dictionary_does_nothing(self)`


#### `test_not_empty_when_collection_empty_raises_value_error(self)`


#### `test_not_empty_when_collection_not_empty_does_nothing(self)`


#### `test_empty_when_collection_not_empty_raises_value_error(self)`


#### `test_empty_when_collection_empty_does_nothing(self)`


#### `test_not_negative_when_arg_negative_raises_value_error(self, value)`


#### `test_not_negative_when_args_zero_or_positive_does_nothing(self, value)`


#### `test_not_negative_int_when_arg_negative_raises_value_error(self)`


#### `test_not_negative_int_when_args_zero_or_positive_does_nothing(self, value)`


#### `test_positive_when_args_negative_or_zero_raises_value_error(self, value)`


#### `test_positive_when_args_positive_does_nothing(self, value)`


#### `test_positive_int_when_args_negative_or_zero_raises_value_error(self, value)`


#### `test_positive_int_when_args_positive_does_nothing(self)`


#### `test_in_range_when_arg_out_of_range_raises_value_error(self, value, start, end)`


#### `test_in_range_when_args_in_range_does_nothing(self, value, start, end)`


#### `test_in_range_int_when_arg_out_of_range_raises_value_error(self, value, start, end)`


#### `test_in_range_int_when_args_in_range_does_nothing(self, value, start, end)`


#### `test_valid_string_given_none_raises_type_error(self)`
...
```python
from tests.unit_tests.core.test_correctness import TestCondition
```
