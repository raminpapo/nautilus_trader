...
**Classs**: `TestUUID`
**Imports**: `nautilus_trader.core.uuid`, `pickle`, `pytest`
...
```bash
# For Python
pytest tests/unit_tests/core/test_uuid.py
...
---
*Generated on 2025-11-18T21:55:11.318340Z*
