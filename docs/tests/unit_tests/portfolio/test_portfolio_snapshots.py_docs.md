# Documentation: `tests/unit_tests/portfolio/test_portfolio_snapshots.py`
**Generated:** 2025-11-15T19:40:09.457700Z
**File Size:** 69492 bytes
**Extension:** .py
**Type:** text
...
This file is located at `tests/unit_tests/portfolio/test_portfolio_snapshots.py` within the repository.

**Functions defined:** test_portfolio_calculates_realized_pnl_with_position_snapshots, test_portfolio_reset_clears_all_state, test_portfolio_dispose_releases_resources, test_netting_oms_position_lifecycle_with_snapshots, test_pnl_aggregation_multiple_position_cycles, test_incremental_caching_avoids_redundant_unpickling, test_cache_rebuild_on_purge, test_multiple_instruments_cached_independently, test_no_snapshots_returns_zero_pnl, test_incremental_processing_with_active_position and 12 more
...
#### `test_portfolio_calculates_realized_pnl_with_position_snapshots(
    portfolio,
    cache,
    exec_engine,
    clock,
...
#### `test_portfolio_reset_clears_all_state(
    portfolio,
    exec_engine,
    clock,
    account_id,
...
#### `test_netting_oms_position_lifecycle_with_snapshots(
    portfolio,
    cache,
    exec_engine,
    clock,
...
#### `test_pnl_aggregation_multiple_position_cycles(
    portfolio,
    cache,
    exec_engine,
    clock,
...
#### `test_incremental_caching_avoids_redundant_unpickling(
    portfolio,
    cache,
    exec_engine,
    clock,
...
#### `test_multiple_instruments_cached_independently(
    portfolio,
    cache,
    exec_engine,
    clock,
...
#### `test_no_snapshots_returns_zero_pnl(
    portfolio,
    cache,
    exec_engine,
    clock,
...
#### `test_incremental_processing_with_active_position(
    portfolio,
    cache,
    exec_engine,
    clock,
...
#### `test_snapshot_equality_edge_case(
    portfolio,
    cache,
    exec_engine,
    clock,
...
#### `test_mixed_currency_conversion(
    portfolio,
    cache,
    exec_engine,
    clock,
...
#### `test_cache_invalidation_on_position_update(
    portfolio,
    cache,
    exec_engine,
    clock,
...
#### `test_incremental_snapshot_processing(
    portfolio,
    cache,
    exec_engine,
    clock,
...
#### `test_closed_position_matches_last_snapshot_no_double_count(
    portfolio,
    cache,
    exec_engine,
    clock,
...
#### `test_closed_position_new_cycle_not_in_snapshots_adds_sum_plus_realized(
    portfolio,
    cache,
    exec_engine,
    clock,
...
#### `test_hedging_closed_positions_with_snapshots_single_count_per_cycle(
    portfolio,
    cache,
    exec_engine,
    clock,
...
#### `test_snapshot_conversion_to_base_currency_mid_rate(
    portfolio,
    cache,
    exec_engine,
    clock,
...
#### `test_realized_pnl_cache_invalidated_on_update(
    portfolio,
    cache,
    exec_engine,
    clock,
...
#### `test_last_snapshot_equals_current_with_precision_tolerance(
    portfolio,
    cache,
    exec_engine,
    clock,
...
#### `test_snapshot_conversion_with_mark_xrates(
    portfolio,
    cache,
    exec_engine,
    clock,
...
```python
from tests.unit_tests.portfolio.test_portfolio_snapshots import test_portfolio_calculates_realized_pnl_with_position_snapshots
```
