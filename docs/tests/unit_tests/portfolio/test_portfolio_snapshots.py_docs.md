# Documentation: test_portfolio_snapshots.py

## File Metadata

- **Path**: `tests/unit_tests/portfolio/test_portfolio_snapshots.py`
- **Size**: 69,492 bytes
- **Lines**: 2,361
- **Language**: Python
...
### Functions
- **`test_portfolio_calculates_realized_pnl_with_position_snapshots()`**: Function defined in this file
- **`test_portfolio_reset_clears_all_state()`**: Function defined in this file
- **`test_portfolio_dispose_releases_resources()`**: Function defined in this file
- **`test_netting_oms_position_lifecycle_with_snapshots()`**: Function defined in this file
- **`test_pnl_aggregation_multiple_position_cycles()`**: Function defined in this file
- **`test_incremental_caching_avoids_redundant_unpickling()`**: Function defined in this file
- **`test_cache_rebuild_on_purge()`**: Function defined in this file
- **`test_multiple_instruments_cached_independently()`**: Function defined in this file
- **`test_no_snapshots_returns_zero_pnl()`**: Function defined in this file
- **`test_incremental_processing_with_active_position()`**: Function defined in this file
- **`test_snapshot_equality_edge_case()`**: Function defined in this file
- **`test_mixed_currency_conversion()`**: Function defined in this file
- **`test_cache_invalidation_on_position_update()`**: Function defined in this file
- **`test_incremental_snapshot_processing()`**: Function defined in this file
- **`test_closed_position_matches_last_snapshot_no_double_count()`**: Function defined in this file
- **`test_closed_position_new_cycle_not_in_snapshots_adds_sum_plus_realized()`**: Function defined in this file
- **`test_hedging_closed_positions_with_snapshots_single_count_per_cycle()`**: Function defined in this file
- **`test_snapshot_conversion_to_base_currency_mid_rate()`**: Function defined in this file
- **`test_realized_pnl_cache_invalidated_on_update()`**: Function defined in this file
- **`test_last_snapshot_equals_current_with_precision_tolerance()`**: Function defined in this file
...
**Functions**: `test_cache_invalidation_on_position_update`, `test_cache_rebuild_on_purge`, `test_closed_position_matches_last_snapshot_no_double_count`, `test_closed_position_new_cycle_not_in_snapshots_adds_sum_plus_realized`, `test_hedging_closed_positions_with_snapshots_single_count_per_cycle`, `test_incremental_caching_avoids_redundant_unpickling`, `test_incremental_processing_with_active_position`, `test_incremental_snapshot_processing`, `test_last_snapshot_equals_current_with_precision_tolerance`, `test_mixed_currency_conversion`, `test_multiple_instruments_cached_independently`, `test_netting_oms_position_lifecycle_with_snapshots`, `test_no_snapshots_returns_zero_pnl`, `test_pnl_aggregation_multiple_position_cycles`, `test_portfolio_calculates_realized_pnl_with_position_snapshots`, `test_portfolio_dispose_releases_resources`, `test_portfolio_reset_clears_all_state`, `test_realized_pnl_cache_invalidated_on_update`, `test_snapshot_conversion_failure_no_xrate_available`, `test_snapshot_conversion_to_base_currency_mid_rate`, `test_snapshot_conversion_with_mark_xrates`, `test_snapshot_equality_edge_case`
**Imports**: `decimal`, `nautilus_trader.core.uuid`, `nautilus_trader.model.currencies`, `nautilus_trader.model.data`, `nautilus_trader.model.enums`, `nautilus_trader.model.events.account`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.objects`, `nautilus_trader.model.position`, `nautilus_trader.test_kit.providers`, `nautilus_trader.test_kit.stubs.events`, `nautilus_trader.test_kit.stubs.execution`
...
```bash
# For Python
pytest tests/unit_tests/portfolio/test_portfolio_snapshots.py
...
---
*Generated on 2025-11-18T21:55:11.745176Z*
