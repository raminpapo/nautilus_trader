# Documentation: `tests/unit_tests/portfolio/test_portfolio_mark.py`
**Generated:** 2025-11-15T19:40:09.451999Z
...
This file is located at `tests/unit_tests/portfolio/test_portfolio_mark.py` within the repository.

**Classes defined:** TestPortfolioMarkPrices

**Functions defined:** setup, test_opening_one_long_position_with_mark_prices_updates_portfolio
...
#### `test_opening_one_long_position_with_mark_prices_updates_portfolio(self)`
...
```python
from tests.unit_tests.portfolio.test_portfolio_mark import TestPortfolioMarkPrices
```
