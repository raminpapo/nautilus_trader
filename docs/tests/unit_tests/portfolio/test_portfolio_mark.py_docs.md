# Documentation: test_portfolio_mark.py

## File Metadata

- **Path**: `tests/unit_tests/portfolio/test_portfolio_mark.py`
- **Size**: 7,170 bytes
- **Lines**: 172
- **Language**: Python
...
### Classes
- **`TestPortfolioMarkPrices`**: Class defined in this file
...
**Classs**: `TestPortfolioMarkPrices`
**Imports**: `decimal`, `nautilus_trader.accounting.factory`, `nautilus_trader.common.component`, `nautilus_trader.common.factories`, `nautilus_trader.core.uuid`, `nautilus_trader.execution.engine`, `nautilus_trader.model.currencies`, `nautilus_trader.model.data`, `nautilus_trader.model.enums`, `nautilus_trader.model.events`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.objects`, `nautilus_trader.model.position`, `nautilus_trader.portfolio.config`, `nautilus_trader.portfolio.portfolio`, `nautilus_trader.test_kit.providers`, `nautilus_trader.test_kit.stubs.component`, `nautilus_trader.test_kit.stubs.events`, `nautilus_trader.test_kit.stubs.identifiers`
...
```bash
# For Python
pytest tests/unit_tests/portfolio/test_portfolio_mark.py
...
---
*Generated on 2025-11-18T21:55:11.737811Z*
