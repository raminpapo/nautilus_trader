# Documentation: `tests/unit_tests/portfolio/test_portfolio_extensions.py`
**Generated:** 2025-11-15T19:40:09.447872Z
**File Size:** 8656 bytes
**Extension:** .py
**Type:** text
...
This file is located at `tests/unit_tests/portfolio/test_portfolio_extensions.py` within the repository.

**Functions defined:** test_portfolio_calculates_realized_pnl_with_position_snapshots, test_portfolio_reset_clears_all_state, test_portfolio_dispose_releases_resources, test_netting_oms_position_lifecycle_with_snapshots
...
```python
from tests.unit_tests.portfolio.test_portfolio_extensions import test_portfolio_calculates_realized_pnl_with_position_snapshots
```
