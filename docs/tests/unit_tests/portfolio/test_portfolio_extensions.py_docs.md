# Documentation: test_portfolio_extensions.py

## File Metadata

- **Path**: `tests/unit_tests/portfolio/test_portfolio_extensions.py`
- **Size**: 8,656 bytes
- **Lines**: 282
- **Language**: Python
...
**Functions**: `test_netting_oms_position_lifecycle_with_snapshots`, `test_portfolio_calculates_realized_pnl_with_position_snapshots`, `test_portfolio_dispose_releases_resources`, `test_portfolio_reset_clears_all_state`
**Imports**: `nautilus_trader.core.uuid`, `nautilus_trader.model.currencies`, `nautilus_trader.model.enums`, `nautilus_trader.model.events.account`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.objects`, `nautilus_trader.model.position`, `nautilus_trader.test_kit.providers`, `nautilus_trader.test_kit.stubs.events`, `nautilus_trader.test_kit.stubs.execution`
...
```bash
# For Python
pytest tests/unit_tests/portfolio/test_portfolio_extensions.py
...
---
*Generated on 2025-11-18T21:55:11.734509Z*
