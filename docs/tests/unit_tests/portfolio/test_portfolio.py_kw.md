# Keywords: test_portfolio.py

## File Path
`tests/unit_tests/portfolio/test_portfolio.py`
...
- **Type**: class
- **File**: [tests/unit_tests/portfolio/test_portfolio.py](../test_portfolio.py_docs.md)
...
### nautilus_trader.accounting.error
...
### nautilus_trader.portfolio.config
...
---
*Generated on 2025-11-18T21:55:11.732630Z*
