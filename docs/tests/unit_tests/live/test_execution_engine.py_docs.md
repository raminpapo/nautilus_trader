# Documentation: `tests/unit_tests/live/test_execution_engine.py`
**Generated:** 2025-11-15T19:40:09.237640Z
**File Size:** 41558 bytes
**Extension:** .py
**Type:** text
...
- **Path:** `tests/unit_tests/live/test_execution_engine.py`
- **Size:** 41,558 bytes
- **Lines:** 1,229
- **Extension:** `.py`
- **Type:** text
...
This file is located at `tests/unit_tests/live/test_execution_engine.py` within the repository.

**Classes defined:** TestLiveExecutionEngine

**Functions defined:** setup, mock_execute_command, mock_execute_command, mock_handle_event, mock_handle_event, test_is_within_single_unit_tolerance_integer_precision, test_is_within_single_unit_tolerance_fractional_precision, test_is_within_single_unit_tolerance_handles_mixed_precision, test_check_position_discrepancy_both_flat, test_check_position_discrepancy_exact_match and 6 more
...
#### `mock_execute_command(command)`


#### `mock_execute_command(command)`


#### `mock_handle_event(event)`


#### `mock_handle_event(event)`


#### `test_is_within_single_unit_tolerance_integer_precision(self)`


#### `test_is_within_single_unit_tolerance_fractional_precision(self)`


#### `test_is_within_single_unit_tolerance_handles_mixed_precision(self)`


#### `test_check_position_discrepancy_both_flat(self)`


#### `test_check_position_discrepancy_exact_match(self)`


#### `test_check_position_discrepancy_within_tolerance_fractional(self)`


#### `test_check_position_discrepancy_within_tolerance_cached_zero(self)`


#### `test_check_position_discrepancy_exceeds_tolerance(self)`


#### `test_check_position_discrepancy_integer_precision_requires_exact_match(self)`


#### `test_check_position_discrepancy_cached_nonzero_venue_none(self)`


#### `test_check_position_discrepancy_instrument_not_in_cache(self)`
...
```python
from tests.unit_tests.live.test_execution_engine import TestLiveExecutionEngine
```
