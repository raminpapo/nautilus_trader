# Documentation: test_execution_engine.py
...
### Classes
- **`TestLiveExecutionEngine`**: Class defined in this file
...
**Classs**: `TestLiveExecutionEngine`
**Imports**: `decimal`, `nautilus_trader.common.component`, `nautilus_trader.common.factories`, `nautilus_trader.common.providers`, `nautilus_trader.config`, `nautilus_trader.core.uuid`, `nautilus_trader.execution.emulator`, `nautilus_trader.execution.messages`, `nautilus_trader.execution.reports`, `nautilus_trader.live.data_engine`, `nautilus_trader.live.execution_engine`, `nautilus_trader.live.reconciliation`, `nautilus_trader.live.risk_engine`, `nautilus_trader.model.currencies`, `nautilus_trader.model.enums`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.objects`, `nautilus_trader.portfolio.portfolio`, `nautilus_trader.test_kit.functions`, `nautilus_trader.test_kit.mocks.exec_clients`, `nautilus_trader.test_kit.providers`, `nautilus_trader.test_kit.stubs.component`, `nautilus_trader.test_kit.stubs.events`, `nautilus_trader.test_kit.stubs.identifiers`, `nautilus_trader.trading.strategy`, `pytest`, `unittest.mock`
...
```bash
# For Python
pytest tests/unit_tests/live/test_execution_engine.py
...
---
*Generated on 2025-11-18T21:55:11.475341Z*
