# Documentation: test_data_engine.py

## File Metadata

- **Path**: `tests/unit_tests/live/test_data_engine.py`
- **Size**: 24,912 bytes
- **Lines**: 734
- **Language**: Python
...
### Classes
- **`TestLiveDataEngine`**: Class defined in this file
...
**Classs**: `TestLiveDataEngine`
**Imports**: `asyncio`, `nautilus_trader.common.component`, `nautilus_trader.config`, `nautilus_trader.core.data`, `nautilus_trader.core.uuid`, `nautilus_trader.data.messages`, `nautilus_trader.live.data_engine`, `nautilus_trader.model.data`, `nautilus_trader.model.identifiers`, `nautilus_trader.portfolio.portfolio`, `nautilus_trader.test_kit.functions`, `nautilus_trader.test_kit.providers`, `nautilus_trader.test_kit.stubs.component`, `nautilus_trader.test_kit.stubs.data`, `nautilus_trader.test_kit.stubs.identifiers`, `pandas`, `pytest`, `unittest.mock`
...
```bash
# For Python
pytest tests/unit_tests/live/test_data_engine.py
...
---
*Generated on 2025-11-18T21:55:11.467387Z*
