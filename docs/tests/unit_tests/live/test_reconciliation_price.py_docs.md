# Documentation: test_reconciliation_price.py

## File Metadata

- **Path**: `tests/unit_tests/live/test_reconciliation_price.py`
- **Size**: 64,932 bytes
- **Lines**: 1,809
- **Language**: Python
...
### Functions
- **`eurusd_instrument()`**: Function defined in this file
- **`test_reconciliation_price_calculations()`**: Function defined in this file
- **`test_reconciliation_price_returns_none()`**: Function defined in this file
- **`test_reconciliation_price_flat_position_logic()`**: Function defined in this file
- **`test_reconciliation_price_precision_handling()`**: Function defined in this file
- **`test_reconciliation_price_zero_quantity_difference_after_precision()`**: Function defined in this file
- **`ethusdt_instrument()`**: Function defined in this file
- **`test_adjust_fills_no_position_report()`**: Function defined in this file
- **`test_adjust_fills_complete_lifecycle_no_adjustment()`**: Function defined in this file
- **`test_adjust_fills_incomplete_lifecycle_adds_synthetic_fill()`**: Function defined in this file
- **`test_adjust_fills_with_zero_crossings()`**: Function defined in this file
- **`test_adjust_fills_current_lifecycle_mismatch_creates_synthetic()`**: Function defined in this file
- **`test_adjust_fills_oldest_lifecycle_incomplete_adds_synthetic()`**: Function defined in this file
- **`test_adjust_fills_short_position()`**: Function defined in this file
- **`test_adjust_fills_flat_position_after_zero_crossings()`**: Function defined in this file
- **`test_adjust_fills_position_flip_in_current_lifecycle()`**: Function defined in this file
- **`test_adjust_fills_multi_instrument_preserves_all_fills()`**: Function defined in this file
- **`test_adjust_fills_missing_order_reports_uses_fill_side()`**: Function defined in this file
- **`test_adjust_fills_filter_to_current_lifecycle_preserves_working_orders()`**: Function defined in this file
- **`test_adjust_fills_replace_current_lifecycle_reuses_venue_order_id()`**: Function defined in this file
...
**Functions**: `ethusdt_instrument`, `eurusd_instrument`, `test_adjust_fills_complete_lifecycle_no_adjustment`, `test_adjust_fills_current_lifecycle_mismatch_creates_synthetic`, `test_adjust_fills_filter_to_current_lifecycle_preserves_working_orders`, `test_adjust_fills_flat_position_after_zero_crossings`, `test_adjust_fills_incomplete_lifecycle_adds_synthetic_fill`, `test_adjust_fills_missing_order_reports_uses_fill_side`, `test_adjust_fills_multi_instrument_preserves_all_fills`, `test_adjust_fills_no_position_report`, `test_adjust_fills_oldest_lifecycle_incomplete_adds_synthetic`, `test_adjust_fills_position_flip_in_current_lifecycle`, `test_adjust_fills_replace_current_lifecycle_reuses_venue_order_id`, `test_adjust_fills_short_position`, `test_adjust_fills_with_zero_crossings`, `test_reconciliation_price_calculations`, `test_reconciliation_price_flat_position_logic`, `test_reconciliation_price_precision_handling`, `test_reconciliation_price_returns_none`, `test_reconciliation_price_zero_quantity_difference_after_precision`
**Imports**: `decimal`, `nautilus_trader.core.uuid`, `nautilus_trader.execution.reports`, `nautilus_trader.live.reconciliation`, `nautilus_trader.model.currencies`, `nautilus_trader.model.enums`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.instruments`, `nautilus_trader.model.objects`, `pytest`
...
```bash
# For Python
pytest tests/unit_tests/live/test_reconciliation_price.py
...
---
*Generated on 2025-11-18T21:55:11.515236Z*
