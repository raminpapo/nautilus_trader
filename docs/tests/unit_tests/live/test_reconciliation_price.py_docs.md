# Documentation: `tests/unit_tests/live/test_reconciliation_price.py`
**Generated:** 2025-11-15T19:40:09.261052Z
**File Size:** 64959 bytes
**Extension:** .py
**Type:** text
...
This file is located at `tests/unit_tests/live/test_reconciliation_price.py` within the repository.

**Functions defined:** eurusd_instrument, test_reconciliation_price_calculations, test_reconciliation_price_returns_none, test_reconciliation_price_flat_position_logic, test_reconciliation_price_precision_handling, test_reconciliation_price_zero_quantity_difference_after_precision, ethusdt_instrument, test_adjust_fills_no_position_report, test_adjust_fills_complete_lifecycle_no_adjustment, test_adjust_fills_incomplete_lifecycle_adds_synthetic_fill and 10 more
...
#### `test_reconciliation_price_returns_none(
    eurusd_instrument,
    current_qty,
    current_avg_px,
    target_qty,
...
#### `test_reconciliation_price_flat_position_logic(eurusd_instrument)`


#### `test_reconciliation_price_precision_handling(eurusd_instrument)`
...
#### `test_adjust_fills_no_position_report(ethusdt_instrument)`


#### `test_adjust_fills_complete_lifecycle_no_adjustment(ethusdt_instrument)`


#### `test_adjust_fills_incomplete_lifecycle_adds_synthetic_fill(ethusdt_instrument)`


#### `test_adjust_fills_with_zero_crossings(ethusdt_instrument)`


#### `test_adjust_fills_current_lifecycle_mismatch_creates_synthetic(ethusdt_instrument)`


#### `test_adjust_fills_oldest_lifecycle_incomplete_adds_synthetic(ethusdt_instrument)`


#### `test_adjust_fills_short_position(ethusdt_instrument)`


#### `test_adjust_fills_flat_position_after_zero_crossings(ethusdt_instrument)`


#### `test_adjust_fills_position_flip_in_current_lifecycle(ethusdt_instrument)`


#### `test_adjust_fills_multi_instrument_preserves_all_fills(eurusd_instrument, ethusdt_instrument)`


#### `test_adjust_fills_missing_order_reports_uses_fill_side(ethusdt_instrument)`


#### `test_adjust_fills_filter_to_current_lifecycle_preserves_working_orders(eurusd_instrument)`


#### `test_adjust_fills_replace_current_lifecycle_reuses_venue_order_id(eurusd_instrument)`
...
```python
from tests.unit_tests.live.test_reconciliation_price import eurusd_instrument
```
