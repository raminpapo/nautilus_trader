# Documentation: test_execution_order_checks.py

## File Metadata

- **Path**: `tests/unit_tests/live/test_execution_order_checks.py`
- **Size**: 93,520 bytes
- **Lines**: 3,055
- **Language**: Python
...
- **`fixture_instrument_provider()`**: Function defined in this file
- **`fixture_exec_client()`**: Function defined in this file
- **`fixture_exec_engine_open_check()`**: Function defined in this file
- **`fixture_exec_engine_inflight_check()`**: Function defined in this file
- **`fixture_exec_engine_basic()`**: Function defined in this file
- **`fixture_exec_engine_alias()`**: Function defined in this file
- **`fixture_exec_engine_combined()`**: Function defined in this file
- **`fixture_exec_engine_open_check_custom_threshold()`**: Function defined in this file
- **`fixture_exec_engine_continuous()`**: Function defined in this file
- **`test_validate_open_orders_consistency_no_issues()`**: Function defined in this file
- **`test_validate_open_orders_consistency_detects_inconsistency()`**: Function defined in this file
...
**Functions**: `fixture_account_id`, `fixture_cache`, `fixture_clock`, `fixture_exec_client`, `fixture_exec_engine_alias`, `fixture_exec_engine_basic`, `fixture_exec_engine_combined`, `fixture_exec_engine_continuous`, `fixture_exec_engine_inflight_check`, `fixture_exec_engine_open_check`, `fixture_exec_engine_open_check_custom_threshold`, `fixture_instrument_provider`, `fixture_msgbus`, `fixture_trader_id`, `test_validate_open_orders_consistency_detects_inconsistency`, `test_validate_open_orders_consistency_no_issues`
**Imports**: `asyncio`, `contextlib`, `decimal`, `nautilus_trader.common.component`, `nautilus_trader.common.providers`, `nautilus_trader.config`, `nautilus_trader.core.uuid`, `nautilus_trader.execution.messages`, `nautilus_trader.execution.reports`, `nautilus_trader.live.execution_engine`, `nautilus_trader.model.currencies`, `nautilus_trader.model.enums`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.objects`, `nautilus_trader.test_kit.functions`, `nautilus_trader.test_kit.mocks.exec_clients`, `nautilus_trader.test_kit.providers`, `nautilus_trader.test_kit.stubs.component`, `nautilus_trader.test_kit.stubs.events`, `nautilus_trader.test_kit.stubs.execution`, `nautilus_trader.test_kit.stubs.identifiers`, `pytest`
...
```bash
# For Python
pytest tests/unit_tests/live/test_execution_order_checks.py
...
---
*Generated on 2025-11-18T21:55:11.485306Z*
