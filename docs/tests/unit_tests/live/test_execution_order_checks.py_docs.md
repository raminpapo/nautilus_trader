# Documentation: `tests/unit_tests/live/test_execution_order_checks.py`
**Generated:** 2025-11-15T19:40:09.243600Z
**File Size:** 73983 bytes
**Extension:** .py
**Type:** text
...
This file is located at `tests/unit_tests/live/test_execution_order_checks.py` within the repository.

**Functions defined:** fixture_clock, fixture_trader_id, fixture_account_id, fixture_msgbus, fixture_cache, fixture_instrument_provider, fixture_exec_client, fixture_exec_engine_open_check, fixture_exec_engine_inflight_check, fixture_exec_engine_basic and 12 more
...
#### `fixture_instrument_provider()`


#### `fixture_exec_client(event_loop, msgbus, cache, clock, instrument_provider)`


#### `fixture_exec_engine_open_check(event_loop, msgbus, cache, clock, exec_client)`


#### `fixture_exec_engine_inflight_check(event_loop, msgbus, cache, clock, exec_client)`


#### `fixture_exec_engine_basic(event_loop, msgbus, cache, clock)`


#### `fixture_exec_engine_alias(exec_engine_continuous)`


#### `fixture_exec_engine_combined(event_loop, msgbus, cache, clock, exec_client)`


#### `fixture_exec_engine_open_check_custom_threshold(event_loop, msgbus, cache, clock, exec_client)`
...
#### `fixture_exec_engine_continuous(event_loop, msgbus, cache, clock, exec_client)`


#### `capture_execute(command)`


#### `capture_reconcile(report, trades, **kwargs)`
...
```python
from tests.unit_tests.live.test_execution_order_checks import fixture_clock
```
