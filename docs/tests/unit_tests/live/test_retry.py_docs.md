# Documentation: `tests/unit_tests/live/test_retry.py`
**Generated:** 2025-11-15T19:40:09.263523Z
**File Size:** 8596 bytes
**Extension:** .py
**Type:** text
...
This file is located at `tests/unit_tests/live/test_retry.py` within the repository.

**Functions defined:** mock_logger, test_retry_backoff, test_retry_manager_repr, retry_check
...
#### `test_retry_manager_repr()`


#### `retry_check(exception)`
...
```python
from tests.unit_tests.live.test_retry import mock_logger
```
