# Documentation: test_retry.py

## File Metadata

- **Path**: `tests/unit_tests/live/test_retry.py`
- **Size**: 8,596 bytes
- **Lines**: 309
- **Language**: Python
...
### Functions
- **`mock_logger()`**: Function defined in this file
- **`test_retry_backoff()`**: Function defined in this file
- **`test_retry_manager_repr()`**: Function defined in this file
...
**Functions**: `mock_logger`, `test_retry_backoff`, `test_retry_manager_repr`
**Imports**: `asyncio`, `nautilus_trader.common.component`, `nautilus_trader.live.retry`, `pytest`, `random`, `typing`, `unittest.mock`
...
```bash
# For Python
pytest tests/unit_tests/live/test_retry.py
...
---
*Generated on 2025-11-18T21:55:11.517267Z*
