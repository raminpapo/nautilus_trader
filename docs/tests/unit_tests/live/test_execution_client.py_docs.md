# Documentation: `tests/unit_tests/live/test_execution_client.py`
**Generated:** 2025-11-15T19:40:09.233673Z
...
This file is located at `tests/unit_tests/live/test_execution_client.py` within the repository.

**Classes defined:** TestExecutionClientImpl, TestLiveExecutionClient
...
#### `TestExecutionClientImpl`

**Inherits from:** LiveExecutionClient


#### `TestLiveExecutionClient`
...
```python
from tests.unit_tests.live.test_execution_client import TestExecutionClientImpl
```
