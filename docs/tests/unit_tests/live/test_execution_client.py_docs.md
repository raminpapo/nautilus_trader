# Documentation: test_execution_client.py

## File Metadata

- **Path**: `tests/unit_tests/live/test_execution_client.py`
- **Size**: 9,039 bytes
- **Lines**: 257
- **Language**: Python
...
### Classes
- **`TestExecutionClientImpl`**: Class defined in this file
- **`TestLiveExecutionClient`**: Class defined in this file
...
**Classs**: `TestExecutionClientImpl`, `TestLiveExecutionClient`
**Imports**: `asyncio`, `nautilus_trader.common.component`, `nautilus_trader.common.providers`, `nautilus_trader.live.execution_client`, `nautilus_trader.model.enums`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.objects`, `nautilus_trader.test_kit.functions`, `nautilus_trader.test_kit.stubs.component`, `nautilus_trader.test_kit.stubs.identifiers`, `pytest`
...
```bash
# For Python
pytest tests/unit_tests/live/test_execution_client.py
...
---
*Generated on 2025-11-18T21:55:11.471042Z*
