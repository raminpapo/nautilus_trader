# Documentation: test_execution_recon.py

## File Metadata

- **Path**: `tests/unit_tests/live/test_execution_recon.py`
- **Size**: 163,224 bytes
- **Lines**: 4,601
- **Language**: Python
...
This file is part of the NautilusTrader repository. It defines 12 function(s) and 4 class(es).

## Detailed Walkthrough

### Functions
- **`live_exec_engine()`**: Function defined in this file
- **`exec_client()`**: Function defined in this file
- **`account_id()`**: Function defined in this file
- **`cache()`**: Function defined in this file
- **`test_is_within_single_unit_tolerance_boundaries()`**: Function defined in this file
- **`test_is_within_single_unit_tolerance_zero_values()`**: Function defined in this file
- **`test_is_within_single_unit_tolerance_symmetric()`**: Function defined in this file
- **`test_get_existing_fill_for_trade_id_returns_none_when_no_fills_exist()`**: Function defined in this file
- **`test_get_existing_fill_for_trade_id_returns_none_when_trade_id_not_found()`**: Function defined in this file
- **`test_get_existing_fill_for_trade_id_returns_fill_when_trade_id_found()`**: Function defined in this file
- **`test_get_existing_fill_for_trade_id_returns_correct_fill_when_multiple_fills_exist()`**: Function defined in this file
- **`test_get_existing_fill_for_trade_id_ignores_non_fill_events()`**: Function defined in this file

### Classes
- **`TestLiveExecutionReconciliation`**: Class defined in this file
- **`TestReconciliationEdgeCases`**: Class defined in this file
- **`TestReconciliationFiltering`**: Class defined in this file
- **`TestLiveExecutionReconciliationEdgeCases`**: Class defined in this file
...
**Classs**: `TestLiveExecutionReconciliation`, `TestLiveExecutionReconciliationEdgeCases`, `TestReconciliationEdgeCases`, `TestReconciliationFiltering`
**Functions**: `account_id`, `cache`, `exec_client`, `live_exec_engine`, `test_get_existing_fill_for_trade_id_ignores_non_fill_events`, `test_get_existing_fill_for_trade_id_returns_correct_fill_when_multiple_fills_exist`, `test_get_existing_fill_for_trade_id_returns_fill_when_trade_id_found`, `test_get_existing_fill_for_trade_id_returns_none_when_no_fills_exist`, `test_get_existing_fill_for_trade_id_returns_none_when_trade_id_not_found`, `test_is_within_single_unit_tolerance_boundaries`, `test_is_within_single_unit_tolerance_symmetric`, `test_is_within_single_unit_tolerance_zero_values`
**Imports**: `asyncio`, `decimal`, `nautilus_trader.common.component`, `nautilus_trader.common.factories`, `nautilus_trader.common.providers`, `nautilus_trader.core.uuid`, `nautilus_trader.execution.reports`, `nautilus_trader.live.config`, `nautilus_trader.live.data_engine`, `nautilus_trader.live.execution_engine`, `nautilus_trader.live.reconciliation`, `nautilus_trader.live.risk_engine`, `nautilus_trader.model.currencies`, `nautilus_trader.model.enums`, `nautilus_trader.model.events`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.objects`, `nautilus_trader.model.position`, `nautilus_trader.portfolio.portfolio`, `nautilus_trader.test_kit.mocks.exec_clients`, `nautilus_trader.test_kit.providers`, `nautilus_trader.test_kit.stubs.component`, `nautilus_trader.test_kit.stubs.data`, `nautilus_trader.test_kit.stubs.events`, `nautilus_trader.test_kit.stubs.execution`, `nautilus_trader.test_kit.stubs.identifiers`, `pandas`, `pytest`
...
---
*Generated on 2025-11-18T21:55:11.507442Z*
