# Documentation: `tests/unit_tests/live/test_execution_recon.py`
**Generated:** 2025-11-15T19:40:09.254106Z
**File Size:** 118030 bytes
**Extension:** .py
**Type:** text
...
This file is located at `tests/unit_tests/live/test_execution_recon.py` within the repository.

**Classes defined:** TestLiveExecutionReconciliation, TestReconciliationEdgeCases, TestReconciliationFiltering, TestLiveExecutionReconciliationEdgeCases

**Functions defined:** setup, live_exec_engine, spy_handle_event, spy_reconcile, spy_reconcile, spy_reconcile, spy_reconcile, spy_reconcile, spy_reconcile, spy_reconcile and 15 more
...
#### `TestLiveExecutionReconciliation`


#### `TestReconciliationEdgeCases`


#### `TestReconciliationFiltering`


#### `TestLiveExecutionReconciliationEdgeCases`
...
#### `live_exec_engine(self, event_loop)`


#### `spy_handle_event(event)`


#### `spy_reconcile(order_report, trades, is_external=True)`
...
#### `_get_exec_engine(self, config: LiveExecEngineConfig)`
...
```python
from tests.unit_tests.live.test_execution_recon import TestLiveExecutionReconciliation
```
