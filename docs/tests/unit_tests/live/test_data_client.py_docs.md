# Documentation: `tests/unit_tests/live/test_data_client.py`
**Generated:** 2025-11-15T19:40:09.226893Z
**File Size:** 11064 bytes
**Extension:** .py
**Type:** text
...
This file is located at `tests/unit_tests/live/test_data_client.py` within the repository.

**Classes defined:** TestDataClientImpl, TestMarketDataClientImpl, TestLiveDataClientTests, TestLiveMarketDataClientTests

**Functions defined:** setup, test_dummy_test, setup, test_dummy_test
...
#### `TestMarketDataClientImpl`

**Inherits from:** LiveMarketDataClient


#### `TestLiveDataClientTests`


#### `TestLiveMarketDataClientTests`
...
```python
from tests.unit_tests.live.test_data_client import TestDataClientImpl
```
