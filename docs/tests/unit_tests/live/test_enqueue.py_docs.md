...
**Functions**: `clock`, `logger`, `test_properties`
**Imports**: `asyncio`, `nautilus_trader.common.component`, `nautilus_trader.live.enqueue`, `nautilus_trader.test_kit.functions`, `pytest`, `unittest.mock`
...
```bash
# For Python
pytest tests/unit_tests/live/test_enqueue.py
...
---
*Generated on 2025-11-18T21:55:11.469172Z*
