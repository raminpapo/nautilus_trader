# Documentation: test_cancellation.py

## File Metadata

- **Path**: `tests/unit_tests/live/test_cancellation.py`
- **Size**: 6,019 bytes
- **Lines**: 221
- **Language**: Python
...
**Imports**: `asyncio`, `contextlib`, `nautilus_trader.common.component`, `nautilus_trader.live.cancellation`, `nautilus_trader.test_kit.functions`, `pytest`, `weakref`
...
```bash
# For Python
pytest tests/unit_tests/live/test_cancellation.py
...
---
*Generated on 2025-11-18T21:55:11.462112Z*
