# Documentation: `tests/unit_tests/execution/test_engine.py`
**Generated:** 2025-11-15T19:40:09.153776Z
**File Size:** 137594 bytes
**Extension:** .py
**Type:** text
...
- **Path:** `tests/unit_tests/execution/test_engine.py`
- **Size:** 137,594 bytes
- **Lines:** 3,917
- **Extension:** `.py`
- **Type:** text
...
This file is located at `tests/unit_tests/execution/test_engine.py` within the repository.

**Classes defined:** TestExecutionEngine

**Functions defined:** setup, test_registered_clients_returns_expected, test_register_exec_client_for_routing, test_execute_skips_commands_for_external_clients, test_register_venue_routing, test_register_strategy_with_external_order_claims_when_claim, test_register_strategy_with_external_order_claims_when_no_claim, test_register_external_order_claims_conflict, test_deregister_client_removes_client, test_check_connected_when_client_disconnected_returns_false and 62 more
...
#### `test_registered_clients_returns_expected(self)`


#### `test_register_exec_client_for_routing(self)`


#### `test_execute_skips_commands_for_external_clients(self)`


#### `test_register_venue_routing(self)`


#### `test_register_strategy_with_external_order_claims_when_claim(self)`


#### `test_register_strategy_with_external_order_claims_when_no_claim(self)`


#### `test_register_external_order_claims_conflict(self)`


#### `test_deregister_client_removes_client(self)`
...
#### `test_check_integrity_calls_check_on_cache(self)`


#### `test_setting_of_position_id_counts(self)`


#### `test_given_random_command_logs_and_continues(self)`


#### `test_submit_order_with_duplicate_client_order_id_logs(self)`


#### `test_submit_order_for_random_venue_logs(self)`


#### `test_order_filled_with_unrecognized_strategy_id(self)`
...
#### `test_submit_order(self)`


#### `test_submit_order_with_cleared_cache_logs_error(self)`


#### `test_when_applying_event_to_order_with_invalid_state_trigger_logs(self)`


#### `test_duplicate_order_accepted_event_logs_debug_not_warning(self)`


#### `test_order_filled_event_when_order_not_found_in_cache_logs(self)`


#### `test_cancel_order_for_already_closed_order_logs_and_does_nothing(self)`


#### `test_cancel_order_then_filled_reopens_order(self)`


#### `test_cancel_order_then_partially_filled_reopens_order(self)`


#### `test_process_event_with_no_venue_order_id_logs_and_does_nothing(self)`


#### `test_modify_order_for_already_closed_order_logs_and_does_nothing(self)`


#### `test_handle_order_event_with_random_client_order_id_and_order_id_cached(self)`
...
#### `test_handle_duplicate_order_events_logs_error_and_does_not_apply(self)`


#### `test_handle_order_fill_event_with_no_position_id_correctly_handles_fill(self)`


#### `test_handle_order_fill_event(self)`


#### `test_handle_multiple_partial_fill_events(self)`


#### `test_handle_position_opening_with_position_id_none(self)`


#### `test_add_to_existing_position_on_order_fill(self)`


#### `test_close_position_on_order_fill(self)`


#### `test_multiple_strategy_positions_opened(self)`


#### `test_multiple_strategy_positions_one_active_one_closed(self)`


#### `test_flip_position_on_opposite_filled_same_position_sell(self)`


#### `test_flip_position_on_opposite_filled_same_position_buy(self)`


#### `test_flip_position_on_flat_position_then_filled_reusing_position_id(self)`


#### `test_flip_position_when_netting_oms(self)`


#### `test_handle_updated_order_event(self)`


#### `test_submit_order_with_quote_quantity_and_no_prices_denies(self)`


#### `test_submit_bracket_order_with_quote_quantity_and_no_prices_denies(self)`
...
```python
from tests.unit_tests.execution.test_engine import TestExecutionEngine
```
