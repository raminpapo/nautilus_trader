# Documentation: `tests/unit_tests/execution/test_emulator_list.py`
**Generated:** 2025-11-15T19:40:09.142894Z
**File Size:** 57573 bytes
**Extension:** .py
**Type:** text
...
- **Path:** `tests/unit_tests/execution/test_emulator_list.py`
- **Size:** 57,573 bytes
- **Lines:** 1,527
- **Extension:** `.py`
- **Type:** text
...
This file is located at `tests/unit_tests/execution/test_emulator_list.py` within the repository.

**Classes defined:** TestOrderEmulatorWithOrderLists

**Functions defined:** setup, test_submit_stop_order_bulk_then_emulates, test_submit_bracket_order_with_limit_entry_then_emulates_sl_tp, test_submit_bracket_order_with_stop_limit_entry_then_emulates_sl_tp, test_submit_bracket_order_with_market_entry_immediately_submits_then_emulates_sl_tp, test_submit_bracket_when_entry_filled_then_emulates_sl_and_tp, test_modify_emulated_sl_quantity_also_updates_tp, test_modify_emulated_tp_price, test_submit_bracket_when_stop_limit_entry_filled_then_emulates_sl_and_tp, test_rejected_oto_entry_cancels_contingencies and 17 more
...
#### `TestOrderEmulatorWithOrderLists`
...
#### `test_submit_stop_order_bulk_then_emulates(self)`


#### `test_submit_bracket_order_with_limit_entry_then_emulates_sl_tp(self)`


#### `test_submit_bracket_order_with_stop_limit_entry_then_emulates_sl_tp(self)`


#### `test_submit_bracket_order_with_market_entry_immediately_submits_then_emulates_sl_tp(
        self,
    )`


#### `test_submit_bracket_when_entry_filled_then_emulates_sl_and_tp(self)`


#### `test_modify_emulated_sl_quantity_also_updates_tp(self)`


#### `test_modify_emulated_tp_price(self)`


#### `test_submit_bracket_when_stop_limit_entry_filled_then_emulates_sl_and_tp(self)`
...
#### `test_cancel_oto_entry_cancels_contingencies(
        self,
        contingency_type: ContingencyType,
    )`


#### `test_expired_oto_entry_then_cancels_contingencies(
        self,
        contingency_type: ContingencyType,
    )`


#### `test_update_oto_entry_updates_quantity_of_contingencies(
        self,
        contingency_type: ContingencyType,
    )`


#### `test_triggered_sl_submits_market_order(
        self,
        contingency_type: ContingencyType,
    )`


#### `test_triggered_stop_limit_tp_submits_limit_order(
        self,
        contingency_type: ContingencyType,
    )`


#### `test_triggered_then_filled_tp_cancels_sl(
        self,
        contingency_type: ContingencyType,
    )`


#### `test_triggered_then_partially_filled_oco_sl_cancels_tp(self)`


#### `test_triggered_then_partially_filled_ouo_sl_updated_tp(self)`


#### `test_released_order_with_quote_quantity_sets_contingent_orders_to_base_quantity(
        self,
    )`


#### `test_restart_emulator_with_emulated_parent(self)`


#### `test_restart_emulator_with_partially_filled_parent(self)`


#### `test_restart_emulator_then_cancel_bracket(self)`


#### `test_restart_emulator_with_closed_parent_position(self)`


#### `test_managed_contingent_orders_with_canceled_bracket(self)`


#### `test_managed_contingent_orders_with_modified_open_order(self)`


#### `test_managed_contingent_orders_with_modified_emulated_order(self)`
...
```python
from tests.unit_tests.execution.test_emulator_list import TestOrderEmulatorWithOrderLists
```
