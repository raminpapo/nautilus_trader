# Documentation: test_reports_pyo3.py

## File Metadata

- **Path**: `tests/unit_tests/execution/test_reports_pyo3.py`
- **Size**: 13,306 bytes
- **Lines**: 379
- **Language**: Python
...
### Functions
- **`test_instantiate_order_status_report()`**: Function defined in this file
- **`test_instantiate_fill_report()`**: Function defined in this file
- **`test_instantiate_position_status_report()`**: Function defined in this file
- **`test_instantiate_execution_mass_status_report()`**: Function defined in this file
- **`test_add_order_status_reports()`**: Function defined in this file
- **`test_add_fill_reports()`**: Function defined in this file
- **`test_add_position_state_reports()`**: Function defined in this file
...
**Functions**: `test_add_fill_reports`, `test_add_order_status_reports`, `test_add_position_state_reports`, `test_instantiate_execution_mass_status_report`, `test_instantiate_fill_report`, `test_instantiate_order_status_report`, `test_instantiate_position_status_report`
**Imports**: `decimal`, `nautilus_trader.core.nautilus_pyo3`, `nautilus_trader.test_kit.rust.identifiers_pyo3`
...
```bash
# For Python
pytest tests/unit_tests/execution/test_reports_pyo3.py
...
---
*Generated on 2025-11-18T21:55:11.404634Z*
