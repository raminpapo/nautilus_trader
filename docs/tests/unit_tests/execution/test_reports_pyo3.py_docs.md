# Documentation: `tests/unit_tests/execution/test_reports_pyo3.py`
**Generated:** 2025-11-15T19:40:09.167851Z
**File Size:** 13306 bytes
**Extension:** .py
**Type:** text
...
This file is located at `tests/unit_tests/execution/test_reports_pyo3.py` within the repository.

**Functions defined:** test_instantiate_order_status_report, test_instantiate_fill_report, test_instantiate_position_status_report, test_instantiate_execution_mass_status_report, test_add_order_status_reports, test_add_fill_reports, test_add_position_state_reports
...
#### `test_instantiate_order_status_report()`


#### `test_instantiate_fill_report()`


#### `test_instantiate_position_status_report()`


#### `test_instantiate_execution_mass_status_report()`


#### `test_add_order_status_reports()`


#### `test_add_fill_reports()`


#### `test_add_position_state_reports()`
...
```python
from tests.unit_tests.execution.test_reports_pyo3 import test_instantiate_order_status_report
```
