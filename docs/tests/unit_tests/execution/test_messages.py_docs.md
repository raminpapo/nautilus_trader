# Documentation: `tests/unit_tests/execution/test_messages.py`
**Generated:** 2025-11-15T19:40:09.160328Z
...
- **Path:** `tests/unit_tests/execution/test_messages.py`
- **Size:** 32,449 bytes
- **Lines:** 704
- **Extension:** `.py`
- **Type:** text
...
class TestCommands:
    ...
    def test_modify_order_command_to_from_dict_and_str_repr(self):
        ...
        assert (
            repr(command)
            == f"ModifyOrder(client_id=None, trader_id=TRADER-001, strategy_id=S-001, instrument_id=AUD/USD.SIM, client_order_id=O-123456, venue_order_id=001, quantity=100_000, price=1.00000, trigger_price=1.00010, command_id={uuid}, correlation_id=None, ts_init=0)"
        )
    ...
    def test_modify_order_command_with_none_venue_order_id_to_from_dict_and_str_repr(self):
        ...
        assert (
            repr(command)
            == f"ModifyOrder(client_id=None, trader_id=TRADER-001, strategy_id=S-001, instrument_id=AUD/USD.SIM, client_order_id=O-123456, venue_order_id=None, quantity=100_000, price=1.00000, trigger_price=1.00010, command_id={uuid}, correlation_id=None, ts_init=0)"
        )
    ...
    def test_cancel_order_command_to_from_dict_and_str_repr(self):
        ...
        assert (
            repr(command)
            == f"CancelOrder(client_id=SIM, trader_id=TRADER-001, strategy_id=S-001, instrument_id=AUD/USD.SIM, client_order_id=O-123456, venue_order_id=001, command_id={uuid}, correlation_id=None, ts_init=0)"
        )
    ...
    def test_cancel_order_command_with_none_venue_order_id_to_from_dict_and_str_repr(self):
        ...
        assert (
            repr(command)
            == f"CancelOrder(client_id=SIM, trader_id=TRADER-001, strategy_id=S-001, instrument_id=AUD/USD.SIM, client_order_id=O-123456, venue_order_id=None, command_id={uuid}, correlation_id=None, ts_init=0)"
        )
    ...
    def test_cancel_all_orders_command_to_from_dict_and_str_repr(self):
        ...
        assert (
            repr(command)
            == f"CancelAllOrders(client_id=None, trader_id=TRADER-001, strategy_id=S-001, instrument_id=AUD/USD.SIM, order_side=NO_ORDER_SIDE, command_id={uuid}, correlation_id=None, ts_init=0)"
        )
    ...
    def test_query_order_command_to_from_dict_and_str_repr(self):
        ...
        assert (
            repr(command)
            == f"QueryOrder(client_id=SIM, trader_id=TRADER-001, strategy_id=S-001, instrument_id=AUD/USD.SIM, client_order_id=O-123456, venue_order_id=001, command_id={uuid}, correlation_id=None, ts_init=0)"
        )
    ...
    def test_query_order_command_with_none_venue_order_id_to_from_dict_and_str_repr(self):
        ...
        assert (
            repr(command)
            == f"QueryOrder(client_id=SIM, trader_id=TRADER-001, strategy_id=S-001, instrument_id=AUD/USD.SIM, client_order_id=O-123456, venue_order_id=None, command_id={uuid}, correlation_id=None, ts_init=0)"
        )
    ...
    def test_generate_order_status_reports_command_to_from_dict_and_str_repr(self):
        ...
        assert (
            repr(command)
            == f"GenerateOrderStatusReports(instrument_id=AUD/USD.SIM, start={start_time}, end={end_time}, open_only=True, command_id={uuid}, correlation_id=None, ts_init=0)"
        )
    ...
    def test_generate_fill_reports_command_with_none_venue_order_id_to_from_dict_and_str_repr(self):
        ...
        assert (
            repr(command)
            == f"GenerateFillReports(instrument_id=AUD/USD.SIM, venue_order_id=None, start={start_time}, end={end_time}, command_id={uuid}, correlation_id=None, ts_init=0)"
        )
...
This file is located at `tests/unit_tests/execution/test_messages.py` within the repository.

**Classes defined:** TestCommands

**Functions defined:** setup, test_submit_order_command_from_dict_and_str_repr, test_submit_order_command_with_exec_algorithm_from_dict_and_str_repr, test_submit_bracket_order_command_to_from_dict_and_str_repr, test_submit_bracket_order_command_with_exec_algorithm_to_from_dict_and_str_repr, test_modify_order_command_to_from_dict_and_str_repr, test_modify_order_command_with_none_venue_order_id_to_from_dict_and_str_repr, test_cancel_order_command_to_from_dict_and_str_repr, test_cancel_order_command_with_none_venue_order_id_to_from_dict_and_str_repr, test_cancel_all_orders_command_to_from_dict_and_str_repr and 14 more
...
#### `test_submit_order_command_from_dict_and_str_repr(self)`


#### `test_submit_order_command_with_exec_algorithm_from_dict_and_str_repr(self)`


#### `test_submit_bracket_order_command_to_from_dict_and_str_repr(self)`


#### `test_submit_bracket_order_command_with_exec_algorithm_to_from_dict_and_str_repr(self)`


#### `test_modify_order_command_to_from_dict_and_str_repr(self)`


#### `test_modify_order_command_with_none_venue_order_id_to_from_dict_and_str_repr(self)`


#### `test_cancel_order_command_to_from_dict_and_str_repr(self)`


#### `test_cancel_order_command_with_none_venue_order_id_to_from_dict_and_str_repr(self)`


#### `test_cancel_all_orders_command_to_from_dict_and_str_repr(self)`


#### `test_batch_cancel_orders_command_to_from_dict_and_str_repr(self)`


#### `test_query_order_command_to_from_dict_and_str_repr(self)`


#### `test_query_order_command_with_none_venue_order_id_to_from_dict_and_str_repr(self)`


#### `test_query_account_command_to_from_dict_and_str_repr(self)`


#### `test_generate_order_status_report_command_to_from_dict_and_str_repr(self)`


#### `test_generate_order_status_report_command_with_none_venue_order_id_to_from_dict_and_str_repr(
        self,
    )`


#### `test_generate_order_status_reports_command_to_from_dict_and_str_repr(self)`


#### `test_generate_order_status_reports_command_with_none_instrument_id_to_from_dict_and_str_repr(
        self,
    )`


#### `test_generate_fill_reports_command_to_from_dict_and_str_repr(self)`


#### `test_generate_fill_reports_command_with_none_venue_order_id_to_from_dict_and_str_repr(self)`


#### `test_generate_position_status_reports_command_to_from_dict_and_str_repr(self)`


#### `test_generate_position_status_reports_command_with_none_instrument_id_to_from_dict_and_str_repr(
        self,
    )`


#### `test_generate_execution_mass_status_command_to_from_dict_and_str_repr(self)`


#### `test_generate_execution_mass_status_command_with_params_to_from_dict_and_str_repr(self)`
...
```python
from tests.unit_tests.execution.test_messages import TestCommands
```
...
**Directory:** `tests/unit_tests/execution`
