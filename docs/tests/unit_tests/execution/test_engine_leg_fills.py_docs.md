# Documentation: `tests/unit_tests/execution/test_engine_leg_fills.py`
**Generated:** 2025-11-15T19:40:09.156949Z
**File Size:** 13049 bytes
**Extension:** .py
**Type:** text
...
- **Path:** `tests/unit_tests/execution/test_engine_leg_fills.py`
- **Size:** 13,049 bytes
- **Lines:** 338
- **Extension:** `.py`
- **Type:** text
...
This file is located at `tests/unit_tests/execution/test_engine_leg_fills.py` within the repository.

**Classes defined:** TestExecutionEngineLegFills

**Functions defined:** setup_method, create_leg_fill, test_handle_leg_fill_without_order_creates_position, test_handle_leg_fill_without_order_updates_existing_position, test_handle_leg_fill_without_order_missing_instrument, test_process_leg_fill_when_order_not_found, test_ratio_spread_leg_fills_create_separate_positions
...
#### `test_handle_leg_fill_without_order_creates_position(self)`


#### `test_handle_leg_fill_without_order_updates_existing_position(self)`


#### `test_handle_leg_fill_without_order_missing_instrument(self)`


#### `test_process_leg_fill_when_order_not_found(self)`


#### `test_ratio_spread_leg_fills_create_separate_positions(self)`
...
```python
from tests.unit_tests.execution.test_engine_leg_fills import TestExecutionEngineLegFills
```
