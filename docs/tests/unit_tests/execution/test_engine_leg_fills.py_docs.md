# Documentation: test_engine_leg_fills.py
...
### Classes
- **`TestExecutionEngineLegFills`**: Class defined in this file
...
**Classs**: `TestExecutionEngineLegFills`
**Imports**: `nautilus_trader.cache.cache`, `nautilus_trader.common.component`, `nautilus_trader.core.uuid`, `nautilus_trader.execution.engine`, `nautilus_trader.model.currencies`, `nautilus_trader.model.enums`, `nautilus_trader.model.events.order`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.instruments`, `nautilus_trader.model.objects`, `nautilus_trader.portfolio.portfolio`, `nautilus_trader.test_kit.mocks.cache_database`, `nautilus_trader.test_kit.stubs.events`, `nautilus_trader.test_kit.stubs.identifiers`
...
```bash
# For Python
pytest tests/unit_tests/execution/test_engine_leg_fills.py
...
---
*Generated on 2025-11-18T21:55:11.392114Z*
