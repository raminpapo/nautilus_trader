...
### Classes
- **`TestExecutionReports`**: Class defined in this file
...
**Classs**: `TestExecutionReports`
**Imports**: `decimal`, `nautilus_trader.core`, `nautilus_trader.core.uuid`, `nautilus_trader.execution.reports`, `nautilus_trader.model.currencies`, `nautilus_trader.model.enums`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.objects`, `nautilus_trader.test_kit.stubs.identifiers`
...
```bash
# For Python
pytest tests/unit_tests/execution/test_reports.py
...
---
*Generated on 2025-11-18T21:55:11.402382Z*
