# Documentation: `tests/unit_tests/execution/test_reports.py`
**Generated:** 2025-11-15T19:40:09.165410Z
**File Size:** 54546 bytes
**Extension:** .py
**Type:** text
...
- **Path:** `tests/unit_tests/execution/test_reports.py`
- **Size:** 54,546 bytes
- **Lines:** 1,290
- **Extension:** `.py`
- **Type:** text
...
This file is located at `tests/unit_tests/execution/test_reports.py` within the repository.

**Classes defined:** TestExecutionReports

**Functions defined:** test_order_status_report_to_pyo3_with_trailing_offset_type_none, test_order_status_report_to_pyo3_with_trailing_offset_type_set, test_execution_mass_status_to_pyo3_with_non_trailing_order, test_instantiate_order_status_report, test_instantiate_fill_report, test_instantiate_position_status_report_long_and_short, test_position_status_report_create_flat, test_position_status_report_create_flat_without_report_id, test_instantiate_execution_mass_status_report, test_add_order_status_reports and 26 more
...
#### `test_order_status_report_to_pyo3_with_trailing_offset_type_none(self)`


#### `test_order_status_report_to_pyo3_with_trailing_offset_type_set(self)`


#### `test_execution_mass_status_to_pyo3_with_non_trailing_order(self)`


#### `test_instantiate_order_status_report(self)`


#### `test_instantiate_fill_report(self)`


#### `test_instantiate_position_status_report_long_and_short(self)`


#### `test_position_status_report_create_flat(self)`


#### `test_position_status_report_create_flat_without_report_id(self)`


#### `test_instantiate_execution_mass_status_report(self)`


#### `test_add_order_status_reports(self)`


#### `test_add_fill_reports(self)`


#### `test_add_position_state_reports(self)`


#### `test_order_status_report_serialization(self)`


#### `test_fill_report_serialization(self)`


#### `test_position_status_report_serialization(self)`


#### `test_execution_mass_status_serialization(self)`


#### `test_order_status_report_from_pyo3_with_all_fields(self)`


#### `test_order_status_report_from_pyo3_with_minimal_fields(self)`


#### `test_fill_report_from_pyo3_with_all_fields(self)`


#### `test_fill_report_from_pyo3_without_venue_position_id(self)`


#### `test_position_status_report_from_pyo3(self)`


#### `test_position_status_report_from_pyo3_short_position(self)`


#### `test_position_status_report_with_avg_px_open(self)`


#### `test_position_status_report_avg_px_open_none(self)`


#### `test_position_status_report_with_avg_px_open_serialization(self)`


#### `test_position_status_report_avg_px_open_from_pyo3(self)`


#### `test_position_status_report_different_avg_px_open_values(self)`


#### `test_order_status_report_leaves_qty_clamped_to_zero_when_overfilled(self)`


#### `test_execution_mass_status_to_from_dict(self)`


#### `test_position_status_report_flat_position(self)`


#### `test_fill_report_with_zero_commission(self)`


#### `test_order_status_report_with_trigger_price_but_not_triggered(self)`


#### `test_position_status_report_to_pyo3_round_trip(self)`


#### `test_order_status_report_to_pyo3_round_trip(self)`


#### `test_fill_report_to_pyo3_round_trip(self)`


#### `test_execution_mass_status_to_pyo3_round_trip(self)`
...
```python
from tests.unit_tests.execution.test_reports import TestExecutionReports
```
