# Documentation: `tests/unit_tests/execution/test_algorithm.py`
**Generated:** 2025-11-15T19:40:09.131342Z
**File Size:** 39953 bytes
**Extension:** .py
**Type:** text
...
- **Path:** `tests/unit_tests/execution/test_algorithm.py`
- **Size:** 39,953 bytes
- **Lines:** 1,022
- **Extension:** `.py`
- **Type:** text
...
This file is located at `tests/unit_tests/execution/test_algorithm.py` within the repository.

**Classes defined:** TestExecAlgorithm

**Functions defined:** setup, test_exec_algorithm_reset, test_exec_algorithm_to_importable_config, test_exec_algorithm_spawn_market_order_with_quantity_too_high, test_exec_algorithm_spawn_market_order, test_exec_algorithm_spawn_limit_order, test_exec_algorithm_spawned_order_caches_client_id, test_exec_algorithm_spawn_market_to_limit_order, test_exec_algorithm_modify_order_in_place, test_exec_algorithm_modify_order and 6 more

**Import statements:** 48
...
#### `test_exec_algorithm_reset(self)`


#### `test_exec_algorithm_to_importable_config(self)`


#### `test_exec_algorithm_spawn_market_order_with_quantity_too_high(self)`


#### `test_exec_algorithm_spawn_market_order(self)`


#### `test_exec_algorithm_spawn_limit_order(self)`


#### `test_exec_algorithm_spawned_order_caches_client_id(self)`


#### `test_exec_algorithm_spawn_market_to_limit_order(self)`


#### `test_exec_algorithm_modify_order_in_place(self)`


#### `test_exec_algorithm_modify_order(self)`


#### `test_exec_algorithm_cancel_order(self)`


#### `test_exec_algorithm_on_order(self)`


#### `test_exec_algorithm_on_order_with_small_interval_and_size_precision_zero(self)`


#### `test_exec_algorithm_on_order_list_emulated_with_entry_exec_algorithm(self)`


#### `test_exec_algorithm_on_emulated_bracket_with_exec_algo_entry(self)`


#### `test_exec_algorithm_on_emulated_bracket_with_partially_multi_filled_sl(self)`
...
```python
from tests.unit_tests.execution.test_algorithm import TestExecAlgorithm
```
