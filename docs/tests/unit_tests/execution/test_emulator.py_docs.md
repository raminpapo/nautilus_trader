# Documentation: test_emulator.py
...
### Classes
- **`TestOrderEmulatorWithSingleOrders`**: Class defined in this file
...
**Classs**: `TestOrderEmulatorWithSingleOrders`
**Imports**: `decimal`, `nautilus_trader.backtest.data_client`, `nautilus_trader.cache.cache`, `nautilus_trader.common.component`, `nautilus_trader.config`, `nautilus_trader.core.uuid`, `nautilus_trader.data.engine`, `nautilus_trader.execution.emulator`, `nautilus_trader.execution.engine`, `nautilus_trader.execution.messages`, `nautilus_trader.model.currencies`, `nautilus_trader.model.data`, `nautilus_trader.model.enums`, `nautilus_trader.model.events`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.objects`, `nautilus_trader.portfolio.portfolio`, `nautilus_trader.risk.engine`, `nautilus_trader.test_kit.mocks.cache_database`, `nautilus_trader.test_kit.mocks.exec_clients`, `nautilus_trader.test_kit.providers`, `nautilus_trader.test_kit.stubs.data`, `nautilus_trader.test_kit.stubs.events`, `nautilus_trader.test_kit.stubs.identifiers`, `nautilus_trader.trading.strategy`, `pytest`
...
```bash
# For Python
pytest tests/unit_tests/execution/test_emulator.py
...
---
*Generated on 2025-11-18T21:55:11.370227Z*
