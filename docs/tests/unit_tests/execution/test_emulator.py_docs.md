# Documentation: `tests/unit_tests/execution/test_emulator.py`
**Generated:** 2025-11-15T19:40:09.137572Z
**File Size:** 47762 bytes
**Extension:** .py
**Type:** text
...
- **Path:** `tests/unit_tests/execution/test_emulator.py`
- **Size:** 47,762 bytes
- **Lines:** 1,318
- **Extension:** `.py`
- **Type:** text
...
This file is located at `tests/unit_tests/execution/test_emulator.py` within the repository.

**Classes defined:** TestOrderEmulatorWithSingleOrders

**Functions defined:** setup, test_emulator_reset, test_emulator_dispose, test_create_matching_core_twice_raises_exception, test_subscribed_quotes_when_nothing_subscribed_returns_empty_list, test_subscribed_trades_when_nothing_subscribed_returns_empty_list, test_get_submit_order_commands_when_no_emulations_returns_empty_dict, test_get_matching_core_when_no_emulations_returns_none, test_process_quote_tick_when_no_matching_core_setup_logs_and_does_nothing, test_process_trade_tick_when_no_matching_core_setup_logs_and_does_nothing and 25 more
...
#### `TestOrderEmulatorWithSingleOrders`
...
#### `test_emulator_reset(self)`


#### `test_emulator_dispose(self)`


#### `test_create_matching_core_twice_raises_exception(self)`


#### `test_subscribed_quotes_when_nothing_subscribed_returns_empty_list(self)`


#### `test_subscribed_trades_when_nothing_subscribed_returns_empty_list(self)`


#### `test_get_submit_order_commands_when_no_emulations_returns_empty_dict(self)`


#### `test_get_matching_core_when_no_emulations_returns_none(self)`


#### `test_process_quote_tick_when_no_matching_core_setup_logs_and_does_nothing(self)`


#### `test_process_trade_tick_when_no_matching_core_setup_logs_and_does_nothing(self)`


#### `test_execute_unrecognized_command_logs_and_continues(self)`


#### `test_submit_limit_order_with_emulation_trigger_not_supported_then_cancels(self)`


#### `test_submit_limit_order_with_instrument_not_found_then_cancels(self)`


#### `test_submit_limit_order_with_emulation_trigger_default_and_bid_ask_subscribes_to_data(
        self,
        emulation_trigger: TriggerType,
    )`


#### `test_submit_order_with_emulation_trigger_last_subscribes_to_data(self)`


#### `test_emulator_restart_reactivates_emulated_orders(self)`


#### `test_cancel_all_with_emulated_order_cancels_order(self)`


#### `test_cancel_all_buy_orders_with_emulated_orders_cancels_buy_order(self)`


#### `test_cancel_all_sell_orders_with_emulated_orders_cancels_sell_order(self)`
...
#### `test_submit_limit_order_bid_ask_then_triggered_releases_market_order(
        self,
        order_side: OrderSide,
        trigger_price: TriggerType,
    )`
...
#### `test_submit_limit_if_touched_then_triggered_releases_limit_order(
        self,
        order_side: OrderSide,
        trigger_price: TriggerType,
    )`
...
#### `test_submit_stop_limit_order_then_triggered_releases_limit_order(
        self,
        order_side: OrderSide,
        trigger_price: TriggerType,
    )`
...
#### `test_submit_stop_limit_order_then_triggered_from_deltas_releases_limit_order(
        self,
        order_side: OrderSide,
        trigger_price: TriggerType,
    )`
...
#### `test_submit_market_if_touched_order_then_triggered_releases_market_order(
        self,
        order_side: OrderSide,
        trigger_price: TriggerType,
    )`
...
#### `test_submit_trailing_stop_market_order_with_no_trigger_price_then_updates(
        self,
        order_side: OrderSide,
        expected_trigger_price: Price,
    )`
...
#### `test_submit_trailing_stop_market_order_with_trigger_price_then_updates(
        self,
        order_side: OrderSide,
        trigger_price: Price,
        expected_trigger_price: Price,
...
#### `test_submit_trailing_stop_market_order_with_trigger_price_then_triggers(
        self,
        order_side: OrderSide,
        trigger_price: Price,
    )`
...
#### `test_submit_trailing_stop_limit_order_with_no_trigger_price_then_updates(
        self,
        order_side: OrderSide,
        price: Price,
        expected_trigger_price: Price,
...
#### `test_submit_trailing_stop_limit_order_with_trigger_price_then_updates(
        self,
        order_side: OrderSide,
        price: Price,
        trigger_price: TriggerType,
...
#### `test_submit_trailing_stop_limit_order_with_trigger_price_then_triggers(
        self,
        order_side: OrderSide,
        price: Price,
    )`
...
#### `test_submit_limit_if_touched_immediately_triggered_releases_limit_order(
        self,
        order_side: OrderSide,
        trigger_price: TriggerType,
        price: Price,
...
#### `test_submit_limit_order_bid_ask_with_synthetic_instrument_trigger(
        self,
        order_side: OrderSide,
    )`
...
```python
from tests.unit_tests.execution.test_emulator import TestOrderEmulatorWithSingleOrders
```
