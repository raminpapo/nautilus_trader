# Documentation: `tests/unit_tests/serialization/test_msgpack.py`
**Generated:** 2025-11-15T19:40:09.485083Z
**File Size:** 56356 bytes
**Extension:** .py
**Type:** text
...
- **Path:** `tests/unit_tests/serialization/test_msgpack.py`
- **Size:** 56,356 bytes
- **Lines:** 1,693
- **Extension:** `.py`
- **Type:** text
...
This file is located at `tests/unit_tests/serialization/test_msgpack.py` within the repository.

**Classes defined:** TestMsgSpecSerializer

**Functions defined:** setup, test_serialize_and_deserialize_fx_instrument, test_serialize_and_deserialize_crypto_perpetual_instrument, test_serialize_and_deserialize_crypto_future_instrument, test_serialize_and_deserialize_index_instrument, test_serialize_and_deserialize_commodity_instrument, test_serialize_and_deserialize_crypto_option_instrument, test_pack_and_unpack_market_orders, test_pack_and_unpack_limit_orders, test_pack_and_unpack_limit_orders_with_expiration and 52 more
...
#### `test_serialize_and_deserialize_fx_instrument(self)`


#### `test_serialize_and_deserialize_crypto_perpetual_instrument(self)`


#### `test_serialize_and_deserialize_crypto_future_instrument(self)`


#### `test_serialize_and_deserialize_index_instrument(self)`


#### `test_serialize_and_deserialize_commodity_instrument(self)`


#### `test_serialize_and_deserialize_crypto_option_instrument(self)`


#### `test_pack_and_unpack_market_orders(self)`


#### `test_pack_and_unpack_limit_orders(self)`


#### `test_pack_and_unpack_limit_orders_with_expiration(self)`


#### `test_pack_and_unpack_stop_market_orders(self)`


#### `test_pack_and_unpack_stop_market_orders_with_expiration(self)`


#### `test_pack_and_unpack_stop_limit_orders(self)`


#### `test_pack_and_unpack_market_to_limit__orders(self)`


#### `test_pack_and_unpack_market_if_touched_orders(self)`


#### `test_pack_and_unpack_limit_if_touched_orders(self)`


#### `test_pack_and_unpack_stop_limit_orders_with_expiration(self)`


#### `test_pack_and_unpack_trailing_stop_market_orders_with_expiration(self)`


#### `test_pack_and_unpack_trailing_stop_market_orders_no_initial_prices(self)`


#### `test_pack_and_unpack_trailing_stop_limit_orders_with_expiration(self)`


#### `test_pack_and_unpack_trailing_stop_limit_orders_with_no_initial_prices(self)`


#### `test_serialize_and_deserialize_submit_order_commands(self)`


#### `test_serialize_and_deserialize_submit_order_list_commands(self)`


#### `test_serialize_and_deserialize_modify_order_commands(self)`


#### `test_serialize_and_deserialize_cancel_order_commands(self)`


#### `test_serialize_and_deserialize_generate_order_status_report_command(self)`


#### `test_serialize_and_deserialize_generate_order_status_reports_command(self)`


#### `test_serialize_and_deserialize_generate_fill_reports_command(self)`


#### `test_serialize_and_deserialize_generate_position_status_reports_command(self)`


#### `test_serialize_and_deserialize_generate_execution_mass_status_command(self)`


#### `test_serialize_and_deserialize_shutdown_system_commands(self)`


#### `test_serialize_and_deserialize_component_state_changed_events(self)`


#### `test_serialize_and_deserialize_order_status_report(self)`


#### `test_serialize_and_deserialize_fill_report(self)`


#### `test_serialize_and_deserialize_position_status_report(self)`


#### `test_serialize_and_deserialize_execution_mass_status(self)`


#### `test_serialize_and_deserialize_account_state_with_base_currency_events(self)`


#### `test_serialize_and_deserialize_account_state_without_base_currency_events(self)`


#### `test_serialize_and_deserialize_market_order_initialized_events(self)`


#### `test_serialize_and_deserialize_limit_order_initialized_events(self)`


#### `test_serialize_and_deserialize_stop_market_order_initialized_events(self)`


#### `test_serialize_and_deserialize_stop_limit_order_initialized_events(self)`


#### `test_serialize_and_deserialize_order_denied_events(self)`


#### `test_serialize_and_deserialize_order_emulated_events(self)`


#### `test_serialize_and_deserialize_order_released_events(self)`


#### `test_serialize_and_deserialize_order_submitted_events(self)`


#### `test_serialize_and_deserialize_order_accepted_events(self)`


#### `test_serialize_and_deserialize_order_rejected_events(self)`


#### `test_serialize_and_deserialize_order_rejected_with_due_post_only(self)`


#### `test_serialize_and_deserialize_order_pending_cancel_events(self)`
...
```python
from tests.unit_tests.serialization.test_msgpack import TestMsgSpecSerializer
```
