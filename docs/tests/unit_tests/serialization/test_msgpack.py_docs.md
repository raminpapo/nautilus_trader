...
### Classes
- **`TestMsgSpecSerializer`**: Class defined in this file
...
**Classs**: `TestMsgSpecSerializer`
**Imports**: `base64`, `decimal`, `msgspec`, `nautilus_trader.common.component`, `nautilus_trader.common.enums`, `nautilus_trader.common.factories`, `nautilus_trader.common.messages`, `nautilus_trader.core.uuid`, `nautilus_trader.execution.messages`, `nautilus_trader.execution.reports`, `nautilus_trader.model.currencies`, `nautilus_trader.model.enums`, `nautilus_trader.model.events`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.instruments.commodity`, `nautilus_trader.model.instruments.crypto_option`, `nautilus_trader.model.instruments.index`, `nautilus_trader.model.objects`, `nautilus_trader.model.orders`, `nautilus_trader.model.position`, `nautilus_trader.serialization.serializer`, `nautilus_trader.test_kit.providers`, `nautilus_trader.test_kit.stubs.events`, `nautilus_trader.test_kit.stubs.identifiers`, `pandas`
...
```bash
# For Python
pytest tests/unit_tests/serialization/test_msgpack.py
...
---
*Generated on 2025-11-18T21:55:11.771318Z*
