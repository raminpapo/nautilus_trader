...
### Classes
- **`TestArrowSerializer`**: Class defined in this file
...
**Classs**: `TestArrowSerializer`
**Imports**: `copy`, `nautilus_trader.common.component`, `nautilus_trader.common.factories`, `nautilus_trader.common.messages`, `nautilus_trader.core.uuid`, `nautilus_trader.model.currencies`, `nautilus_trader.model.data`, `nautilus_trader.model.enums`, `nautilus_trader.model.events`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.objects`, `nautilus_trader.model.position`, `nautilus_trader.persistence.catalog.parquet`, `nautilus_trader.serialization.arrow.serializer`, `nautilus_trader.test_kit.providers`, `nautilus_trader.test_kit.stubs.data`, `nautilus_trader.test_kit.stubs.events`, `nautilus_trader.test_kit.stubs.execution`, `nautilus_trader.test_kit.stubs.identifiers`, `pytest`, `sys`, `tests`, `tests.unit_tests.serialization.conftest`, `typing`
...
```bash
# For Python
pytest tests/unit_tests/serialization/test_arrow.py
...
---
*Generated on 2025-11-18T21:55:11.763938Z*
