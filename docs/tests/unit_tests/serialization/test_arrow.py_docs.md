# Documentation: `tests/unit_tests/serialization/test_arrow.py`
**Generated:** 2025-11-15T19:40:09.478527Z
**File Size:** 38434 bytes
**Extension:** .py
**Type:** text
...
- **Path:** `tests/unit_tests/serialization/test_arrow.py`
- **Size:** 38,434 bytes
- **Lines:** 1,151
- **Extension:** `.py`
- **Type:** text
...
This file is located at `tests/unit_tests/serialization/test_arrow.py` within the repository.

**Classes defined:** TestArrowSerializer

**Functions defined:** setup_method, _test_serialization, test_serialize_and_deserialize_tick, test_serialize_and_deserialize_order_book_delta, test_serialize_and_deserialize_order_book_deltas, test_serialize_and_deserialize_order_book_deltas_grouped, test_serialize_and_deserialize_shutdown_system_commands, test_serialize_and_deserialize_component_state_changed_events, test_serialize_and_deserialize_trading_state_changed_events, test_serialize_and_deserialize_account_state_events and 31 more
...
#### `_test_serialization(self, obj: Any)`


#### `test_serialize_and_deserialize_tick(self, data)`


#### `test_serialize_and_deserialize_order_book_delta(self)`


#### `test_serialize_and_deserialize_order_book_deltas(self)`


#### `test_serialize_and_deserialize_order_book_deltas_grouped(self)`
...
#### `test_serialize_and_deserialize_trading_state_changed_events(self)`


#### `test_serialize_and_deserialize_account_state_events(self, event)`


#### `test_serialize_and_deserialize_order_events_base(self, event_func)`


#### `test_serialize_and_deserialize_order_updated_events(self)`


#### `test_serialize_and_deserialize_order_events_post_accepted(self, event_func)`


#### `test_serialize_and_deserialize_order_events_filled(self, event_func)`


#### `test_serialize_and_deserialize_position_events_open_changed(self, position_func)`
...
#### `test_serialize_and_deserialize_account_state_with_margin_none_instrument_id(self)`
...
#### `test_serialize_and_deserialize_order_pending_replace_events(self)`


#### `test_serialize_and_deserialize_order_canceled_events(self)`


#### `test_serialize_and_deserialize_order_update_reject_events(self)`


#### `test_serialize_and_deserialize_order_cancel_reject_events(self)`


#### `test_serialize_and_deserialize_order_modify_events(self)`


#### `test_serialize_and_deserialize_order_expired_events(self)`


#### `test_serialize_and_deserialize_order_triggered_events(self)`


#### `test_serialize_and_deserialize_order_partially_filled_events(self)`


#### `test_serialize_and_deserialize_order_filled_events(self)`


#### `test_serialize_and_deserialize_position_events_closed(self, position_func)`


#### `test_serialize_and_deserialize_instruments(self, instrument)`


#### `test_serialize_and_deserialize_all(self, obj)`
...
```python
from tests.unit_tests.serialization.test_arrow import TestArrowSerializer
```
