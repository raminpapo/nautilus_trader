# Documentation: `tests/unit_tests/serialization/conftest.py`
**Generated:** 2025-11-15T19:40:09.474570Z
...
This file is located at `tests/unit_tests/serialization/conftest.py` within the repository.

**Functions defined:** _make_order_events, nautilus_objects
...
#### `_make_order_events(order, **kwargs)`
...
```python
from tests.unit_tests.serialization.conftest import _make_order_events
```
