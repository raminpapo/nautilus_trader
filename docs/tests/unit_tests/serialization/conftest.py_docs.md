...
- **Path**: `tests/unit_tests/serialization/conftest.py`
- **Size**: 3,807 bytes
- **Lines**: 94
- **Language**: Python
...
### Functions
- **`_make_order_events()`**: Function defined in this file
- **`nautilus_objects()`**: Function defined in this file
...
**Functions**: `_make_order_events`, `nautilus_objects`
**Imports**: `nautilus_trader.model.enums`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.position`, `nautilus_trader.test_kit.providers`, `nautilus_trader.test_kit.stubs.data`, `nautilus_trader.test_kit.stubs.events`, `nautilus_trader.test_kit.stubs.execution`, `typing`
...
```bash
# For Python
pytest tests/unit_tests/serialization/conftest.py
...
---
*Generated on 2025-11-18T21:55:11.760135Z*
