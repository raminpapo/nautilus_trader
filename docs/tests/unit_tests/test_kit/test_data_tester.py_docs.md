# Documentation: `tests/unit_tests/test_kit/test_data_tester.py`
**Generated:** 2025-11-15T19:40:09.491298Z
...
This file is located at `tests/unit_tests/test_kit/test_data_tester.py` within the repository.

**Functions defined:** clock, trader_id, msgbus, cache, portfolio, data_engine, instrument, instrument_id, create_tester_factory, _create_tester and 55 more
...
#### `data_engine(msgbus, cache, clock)`
...
#### `create_tester_factory(trader_id, msgbus, cache, clock, portfolio)`


#### `_create_tester(config)`


#### `test_config_default_values()`


#### `test_config_subscribe_flags(subscribe_flag, value)`


#### `test_config_request_flags(request_flag, value)`


#### `test_config_book_types(book_type_value)`


#### `test_on_start_subscribes_to_quotes(
    trader_id, msgbus, cache, clock, portfolio, instrument, instrument_id,
)`


#### `test_on_start_subscribes_to_trades(
    trader_id, msgbus, cache, clock, portfolio, instrument, instrument_id,
)`


#### `test_on_start_subscribes_to_mark_prices(
    trader_id,
    msgbus,
    cache,
    clock,
...
#### `test_on_start_subscribes_to_index_prices(
    trader_id,
    msgbus,
    cache,
    clock,
...
#### `test_on_start_subscribes_to_funding_rates(
    trader_id,
    msgbus,
    cache,
    clock,
...
#### `test_on_start_subscribes_to_instrument(
    trader_id,
    msgbus,
    cache,
    clock,
...
#### `test_on_start_subscribes_to_instrument_status(
    trader_id,
    msgbus,
    cache,
    clock,
...
#### `test_on_start_subscribes_to_instrument_close(
    trader_id,
    msgbus,
    cache,
    clock,
...
#### `test_on_start_subscribes_to_book_deltas(
    trader_id,
    msgbus,
    cache,
    clock,
...
#### `test_on_start_subscribes_to_book_depth(
    trader_id,
    msgbus,
    cache,
    clock,
...
#### `test_on_start_subscribes_to_book_at_interval(
    trader_id,
    msgbus,
    cache,
    clock,
...
#### `test_on_start_subscribes_to_bars(
    trader_id, msgbus, cache, clock, portfolio, instrument, instrument_id,
)`


#### `test_on_start_with_multiple_instruments_subscribes_all(
    trader_id,
    msgbus,
    cache,
    clock,
...
#### `test_on_start_with_client_id(
    trader_id, msgbus, cache, clock, portfolio, instrument, instrument_id,
)`


#### `test_on_start_with_subscribe_params(
    trader_id,
    msgbus,
    cache,
    clock,
...
#### `test_setup_book_creates_legacy_book(
    trader_id,
    msgbus,
    cache,
    clock,
...
#### `test_setup_book_pyo3_creates_pyo3_book(
    trader_id,
    msgbus,
    cache,
    clock,
...
#### `test_on_start_manages_book_when_configured(
    trader_id,
    msgbus,
    cache,
    clock,
...
#### `test_on_start_manages_pyo3_book_when_configured(
    trader_id,
    msgbus,
    cache,
    clock,
...
#### `test_on_start_requests_instruments(trader_id, msgbus, cache, clock, portfolio, instrument)`
...
#### `test_on_start_requests_trades(
    trader_id, msgbus, cache, clock, portfolio, instrument, instrument_id,
)`


#### `test_on_start_requests_bars(
    trader_id, msgbus, cache, clock, portfolio, instrument, instrument_id,
)`


#### `test_on_start_requests_start_delta_uses_custom_delta(
    trader_id,
    msgbus,
    cache,
    clock,
...
#### `test_on_start_with_request_params(
    trader_id, msgbus, cache, clock, portfolio, instrument, instrument_id,
)`


#### `test_on_stop_unsubscribes_from_quotes(
    trader_id,
    msgbus,
    cache,
    clock,
...
#### `test_on_stop_unsubscribes_from_trades(
    trader_id,
    msgbus,
    cache,
    clock,
...
#### `test_on_stop_unsubscribes_from_mark_prices(
    trader_id,
    msgbus,
    cache,
    clock,
...
#### `test_on_stop_unsubscribes_from_index_prices(
    trader_id,
    msgbus,
    cache,
    clock,
...
#### `test_on_stop_unsubscribes_from_funding_rates(
    trader_id,
    msgbus,
    cache,
    clock,
...
#### `test_on_stop_unsubscribes_from_instrument(
    trader_id,
    msgbus,
    cache,
    clock,
...
#### `test_on_stop_unsubscribes_from_instrument_status(
    trader_id,
    msgbus,
    cache,
    clock,
...
#### `test_on_stop_unsubscribes_from_instrument_close(
    trader_id,
    msgbus,
    cache,
    clock,
...
#### `test_on_stop_unsubscribes_from_book_deltas(
    trader_id,
    msgbus,
    cache,
    clock,
...
#### `test_on_stop_unsubscribes_from_book_depth(
    trader_id,
    msgbus,
    cache,
    clock,
...
#### `test_on_stop_unsubscribes_from_book_at_interval(
    trader_id,
    msgbus,
    cache,
    clock,
...
```python
from tests.unit_tests.test_kit.test_data_tester import clock
```
...
**Directory:** `tests/unit_tests/test_kit`
