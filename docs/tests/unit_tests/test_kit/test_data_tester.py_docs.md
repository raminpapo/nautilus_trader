# Documentation: test_data_tester.py

## File Metadata

- **Path**: `tests/unit_tests/test_kit/test_data_tester.py`
- **Size**: 47,108 bytes
- **Lines**: 2,083
- **Language**: Python
...
This file is part of the NautilusTrader repository. It defines 64 function(s).
...
- **`create_tester_factory()`**: Function defined in this file
- **`test_config_default_values()`**: Function defined in this file
- **`test_config_subscribe_flags()`**: Function defined in this file
- **`test_config_request_flags()`**: Function defined in this file
- **`test_config_book_types()`**: Function defined in this file
- **`test_on_start_subscribes_to_quotes()`**: Function defined in this file
- **`test_on_start_subscribes_to_trades()`**: Function defined in this file
- **`test_on_start_subscribes_to_mark_prices()`**: Function defined in this file
- **`test_on_start_subscribes_to_index_prices()`**: Function defined in this file
- **`test_on_start_subscribes_to_funding_rates()`**: Function defined in this file
- **`test_on_start_subscribes_to_instrument()`**: Function defined in this file
- **`test_on_start_subscribes_to_instrument_status()`**: Function defined in this file
...
Total unique keywords extracted: 80


**Functions**: `cache`, `clock`, `create_tester_factory`, `data_engine`, `instrument`, `instrument_id`, `msgbus`, `portfolio`, `test_config_book_types`, `test_config_default_values`, `test_config_request_flags`, `test_config_subscribe_flags`, `test_on_bar_calls_without_error`, `test_on_funding_rate_calls_without_error`, `test_on_historical_data_calls_without_error`, `test_on_index_price_calls_without_error`, `test_on_instrument_calls_without_error`, `test_on_instruments_calls_without_error`, `test_on_mark_price_calls_without_error`, `test_on_order_book_calls_without_error`, `test_on_order_book_deltas_updates_book_when_managing`, `test_on_order_book_deltas_without_book_management_calls_without_error`, `test_on_order_book_depth_calls_without_error`, `test_on_quote_tick_calls_without_error`, `test_on_start_manages_book_when_configured`, `test_on_start_manages_pyo3_book_when_configured`, `test_on_start_requests_bars`, `test_on_start_requests_instruments`, `test_on_start_requests_quotes`, `test_on_start_requests_start_delta_uses_custom_delta` *(+34 more)*
**Imports**: `nautilus_trader.common.component`, `nautilus_trader.core`, `nautilus_trader.data.engine`, `nautilus_trader.model.data`, `nautilus_trader.model.enums`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.objects`, `nautilus_trader.portfolio.portfolio`, `nautilus_trader.test_kit.providers`, `nautilus_trader.test_kit.strategies.tester_data`, `nautilus_trader.test_kit.stubs.component`, `nautilus_trader.test_kit.stubs.data`, `nautilus_trader.test_kit.stubs.identifiers`, `pandas`, `pytest`, `unittest.mock`

## Related Files

This file is located in `tests/unit_tests/test_kit/`. Related files may include:
...
```bash
# For Python
pytest tests/unit_tests/test_kit/test_data_tester.py
...
---
*Generated on 2025-11-18T21:55:11.777741Z*
