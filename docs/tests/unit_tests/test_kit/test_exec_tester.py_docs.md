# Documentation: test_exec_tester.py

## File Metadata

- **Path**: `tests/unit_tests/test_kit/test_exec_tester.py`
- **Size**: 76,208 bytes
- **Lines**: 3,102
- **Language**: Python
...
This file is part of the NautilusTrader repository. It defines 70 function(s).
...
- **`setup_environment()`**: Function defined in this file
- **`create_tester_factory()`**: Function defined in this file
- **`test_on_start_initializes_instrument()`**: Function defined in this file
- **`test_maintains_buy_order_on_quote_tick()`**: Function defined in this file
- **`test_maintains_sell_order_on_quote_tick()`**: Function defined in this file
- **`test_maintains_both_orders_on_quote_tick()`**: Function defined in this file
- **`test_bracket_buy_order_on_quote_tick()`**: Function defined in this file
- **`test_bracket_and_stop_orders_can_run_together()`**: Function defined in this file
- **`test_post_only_with_test_reject()`**: Function defined in this file
- **`test_order_with_expiry_time()`**: Function defined in this file
...
Total unique keywords extracted: 89


**Functions**: `cache`, `clock`, `create_tester_factory`, `data_engine`, `exec_engine`, `instrument`, `instrument_id`, `msgbus`, `portfolio`, `risk_engine`, `setup_environment`, `test_both_regular_and_stop_orders_together`, `test_bracket_and_stop_orders_can_run_together`, `test_bracket_buy_order_on_quote_tick`, `test_cancel_replace_when_price_moves_with_cancel_replace_flag`, `test_dry_run_mode_prevents_order_submission`, `test_emulation_trigger_configuration`, `test_emulation_trigger_types_parametrized`, `test_invalid_emulation_trigger_raises_key_error`, `test_limit_if_touched_order_with_limit_offset`, `test_maintains_both_orders_on_quote_tick`, `test_maintains_buy_order_on_quote_tick`, `test_maintains_sell_order_on_quote_tick`, `test_market_if_touched_buy_order_below_market`, `test_market_if_touched_sell_order_above_market`, `test_modifies_order_when_price_moves_with_modify_flag`, `test_no_instrument_stops_strategy`, `test_no_modify_when_order_pending_cancel`, `test_no_modify_when_order_pending_update`, `test_no_unsubscription_when_disabled` *(+40 more)*
**Imports**: `decimal`, `nautilus_trader.common.component`, `nautilus_trader.data.engine`, `nautilus_trader.execution.engine`, `nautilus_trader.model.enums`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.objects`, `nautilus_trader.model.orders`, `nautilus_trader.portfolio.portfolio`, `nautilus_trader.risk.engine`, `nautilus_trader.test_kit.providers`, `nautilus_trader.test_kit.strategies.tester_exec`, `nautilus_trader.test_kit.stubs.component`, `nautilus_trader.test_kit.stubs.data`, `nautilus_trader.test_kit.stubs.events`, `nautilus_trader.test_kit.stubs.identifiers`, `pandas`, `pytest`, `unittest.mock`
...
```bash
# For Python
pytest tests/unit_tests/test_kit/test_exec_tester.py
...
---
*Generated on 2025-11-18T21:55:11.785894Z*
