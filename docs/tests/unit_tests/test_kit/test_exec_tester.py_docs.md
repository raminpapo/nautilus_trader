# Documentation: `tests/unit_tests/test_kit/test_exec_tester.py`
**Generated:** 2025-11-15T19:40:09.499709Z
**File Size:** 76185 bytes
**Extension:** .py
**Type:** text
...
This file is located at `tests/unit_tests/test_kit/test_exec_tester.py` within the repository.

**Functions defined:** clock, trader_id, msgbus, cache, portfolio, data_engine, exec_engine, risk_engine, instrument, instrument_id and 64 more
...
#### `exec_engine(msgbus, cache, clock)`


#### `risk_engine(portfolio, msgbus, cache, clock)`
...
#### `setup_environment(cache, instrument, data_engine, exec_engine, risk_engine)`


#### `create_tester_factory(trader_id, portfolio, msgbus, cache, clock, setup_environment)`


#### `_create_tester(config)`


#### `test_on_start_initializes_instrument(
    trader_id,
    portfolio,
    msgbus,
    cache,
...
#### `test_maintains_buy_order_on_quote_tick(
    trader_id,
    portfolio,
    msgbus,
    cache,
...
#### `test_maintains_sell_order_on_quote_tick(
    trader_id,
    portfolio,
    msgbus,
    cache,
...
#### `test_maintains_both_orders_on_quote_tick(
    trader_id,
    portfolio,
    msgbus,
    cache,
...
#### `test_bracket_buy_order_on_quote_tick(
    trader_id,
    portfolio,
    msgbus,
    cache,
...
#### `test_bracket_and_stop_orders_can_run_together(
    trader_id,
    portfolio,
    msgbus,
    cache,
...
#### `test_post_only_with_test_reject(
    trader_id,
    portfolio,
    msgbus,
    cache,
...
#### `test_dry_run_mode_prevents_order_submission(
    trader_id,
    portfolio,
    msgbus,
    cache,
...
#### `test_on_order_book_maintains_orders(
    trader_id,
    portfolio,
    msgbus,
    cache,
...
#### `test_no_instrument_stops_strategy(
    trader_id,
    portfolio,
    msgbus,
    cache,
...
#### `test_modifies_order_when_price_moves_with_modify_flag(
    trader_id,
    portfolio,
    msgbus,
    cache,
...
#### `test_cancel_replace_when_price_moves_with_cancel_replace_flag(
    trader_id,
    portfolio,
    msgbus,
    cache,
...
#### `test_resubmits_order_when_not_active(
    trader_id,
    portfolio,
    msgbus,
    cache,
...
#### `test_on_stop_cancels_orders_individually(
    trader_id,
    portfolio,
    msgbus,
    cache,
...
#### `test_on_stop_batch_cancels_orders(
    trader_id,
    portfolio,
    msgbus,
    cache,
...
#### `test_on_stop_cancel_all_orders(
    trader_id,
    portfolio,
    msgbus,
    cache,
...
#### `test_on_stop_respects_can_unsubscribe_flag(
    trader_id,
    portfolio,
    msgbus,
    cache,
...
#### `test_open_position_on_start_with_buy_side(
    trader_id,
    portfolio,
    msgbus,
    cache,
...
#### `test_open_position_on_start_with_sell_side(
    trader_id,
    portfolio,
    msgbus,
    cache,
...
#### `test_invalid_emulation_trigger_raises_key_error(
    trader_id,
    portfolio,
    msgbus,
    cache,
...
#### `test_emulation_trigger_types_parametrized(
    trader_id,
    portfolio,
    msgbus,
    cache,
...
#### `test_order_creation_by_side_parametrized(
    trader_id,
    portfolio,
    msgbus,
    cache,
...
#### `test_post_only_flag_set_correctly(
    trader_id,
    portfolio,
    msgbus,
    cache,
...
#### `test_order_expiry_time_within_tolerance(
    trader_id,
    portfolio,
    msgbus,
    cache,
...
#### `test_use_quote_quantity_with_correct_precision(
    trader_id,
    portfolio,
    msgbus,
    cache,
...
#### `test_subscription_parameters_passed_correctly(
    trader_id,
    portfolio,
    msgbus,
    cache,
...
#### `test_subscription_setup_on_start_parametrized(
    trader_id,
    portfolio,
    msgbus,
    cache,
...
#### `test_unsubscription_behavior_on_stop(
    trader_id,
    portfolio,
    msgbus,
    cache,
...
#### `test_no_unsubscription_when_disabled(
    trader_id,
    portfolio,
    msgbus,
    cache,
...
#### `test_no_modify_when_order_pending_update(
    trader_id,
    portfolio,
    msgbus,
    cache,
...
```python
from tests.unit_tests.test_kit.test_exec_tester import clock
```
