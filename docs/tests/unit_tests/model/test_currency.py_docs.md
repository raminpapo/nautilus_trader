# Documentation: `tests/unit_tests/model/test_currency.py`
**Generated:** 2025-11-15T19:40:09.320547Z
**File Size:** 7999 bytes
**Extension:** .py
**Type:** text
...
This file is located at `tests/unit_tests/model/test_currency.py` within the repository.
...
#### `test_from_str_in_strict_mode_given_unknown_code_returns_none(self)`
...
```python
from tests.unit_tests.model.test_currency import TestCurrency
```
