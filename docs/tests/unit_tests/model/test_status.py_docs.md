# Documentation: `tests/unit_tests/model/test_status.py`
**Generated:** 2025-11-15T19:40:09.393648Z
...
This file is located at `tests/unit_tests/model/test_status.py` within the repository.

**Classes defined:** TestVenue

**Functions defined:** test_instrument_status, test_instrument_status_to_pyo3, test_instrument_status_from_pyo3, test_instrument_close
...
#### `test_instrument_status(self)`


#### `test_instrument_status_to_pyo3(self)`


#### `test_instrument_status_from_pyo3(self)`


#### `test_instrument_close(self)`
...
```python
from tests.unit_tests.model.test_status import TestVenue
```
