# Documentation: `tests/unit_tests/model/test_position_pyo3.py`
**Generated:** 2025-11-15T19:40:09.391163Z
**File Size:** 69161 bytes
**Extension:** .py
**Type:** text
...
This file is located at `tests/unit_tests/model/test_position_pyo3.py` within the repository.

**Functions defined:** test_position_hash_str_repr, test_position_snapshot, test_position_to_from_dict, test_position_filled_with_buy_order, test_position_filled_with_sell_order, test_position_partial_fills_with_buy_order, test_position_partial_fills_with_sell_order, test_position_filled_with_buy_order_then_sell_order, test_position_filled_with_sell_order_then_buy_order, test_position_filled_with_no_change and 28 more
...
#### `test_position_hash_str_repr()`


#### `test_position_snapshot()`


#### `test_position_to_from_dict()`
...
#### `test_position_partial_fills_with_sell_order()`
...
#### `test_position_adjustment_creation_and_serialization()`


#### `test_position_with_adjustments_tracking()`


#### `test_position_adjustment_funding_only_no_quantity_change()`


#### `test_position_adjustment_json_serialization_round_trip()`


#### `test_position_adjustment_funding_json_serialization()`


#### `test_position_close_and_reopen_clears_adjustments()`


#### `test_position_purge_events_clears_adjustments()`


#### `test_position_sell_base_currency_commission_reduces_short()`


#### `test_position_flattens_with_quote_currency_commission_on_close()`


#### `test_position_flattens_with_base_currency_commission_on_close()`


#### `test_position_flip_short_to_long_applies_full_commission()`


#### `test_position_flip_long_to_short_applies_full_commission()`
...
```python
from tests.unit_tests.model.test_position_pyo3 import test_position_hash_str_repr
```
