# Documentation: test_position_pyo3.py

## File Metadata

- **Path**: `tests/unit_tests/model/test_position_pyo3.py`
- **Size**: 69,157 bytes
- **Lines**: 1,870
- **Language**: Python
...
This file is part of the NautilusTrader repository. It defines 38 function(s).

## Detailed Walkthrough

### Functions
- **`test_position_hash_str_repr()`**: Function defined in this file
- **`test_position_snapshot()`**: Function defined in this file
- **`test_position_to_from_dict()`**: Function defined in this file
- **`test_position_filled_with_buy_order()`**: Function defined in this file
- **`test_position_filled_with_sell_order()`**: Function defined in this file
- **`test_position_partial_fills_with_buy_order()`**: Function defined in this file
- **`test_position_partial_fills_with_sell_order()`**: Function defined in this file
- **`test_position_filled_with_buy_order_then_sell_order()`**: Function defined in this file
- **`test_position_filled_with_sell_order_then_buy_order()`**: Function defined in this file
- **`test_position_filled_with_no_change()`**: Function defined in this file
- **`test_position_long_with_multiple_filled_orders()`**: Function defined in this file
- **`test_pnl_calculation_from_trading_technologies_example()`**: Function defined in this file
- **`test_position_closed_and_reopened()`**: Function defined in this file
- **`test_position_realized_pnl_with_interleaved_order_sides()`**: Function defined in this file
- **`test_calculate_pnl_when_given_position_side_flat_returns_zero()`**: Function defined in this file
- **`test_calculate_pnl_for_long_position_win()`**: Function defined in this file
- **`test_calculate_pnl_for_long_position_loss()`**: Function defined in this file
- **`test_calculate_pnl_for_short_position_winning()`**: Function defined in this file
- **`test_calculate_pnl_for_short_position_loss()`**: Function defined in this file
- **`test_calculate_pnl_for_inverse1()`**: Function defined in this file
...
**Functions**: `test_calculate_pnl_for_inverse1`, `test_calculate_pnl_for_inverse2`, `test_calculate_pnl_for_long_position_loss`, `test_calculate_pnl_for_long_position_win`, `test_calculate_pnl_for_short_position_loss`, `test_calculate_pnl_for_short_position_winning`, `test_calculate_pnl_when_given_position_side_flat_returns_zero`, `test_calculate_unrealized_pnl_for_long`, `test_calculate_unrealized_pnl_for_long_inverse`, `test_calculate_unrealized_pnl_for_short`, `test_calculate_unrealized_pnl_for_short_inverse`, `test_pnl_calculation_from_trading_technologies_example`, `test_position_adjustment_creation_and_serialization`, `test_position_adjustment_funding_json_serialization`, `test_position_adjustment_funding_only_no_quantity_change`, `test_position_adjustment_json_serialization_round_trip`, `test_position_close_and_reopen_clears_adjustments`, `test_position_closed_and_reopened`, `test_position_filled_with_buy_order`, `test_position_filled_with_buy_order_then_sell_order`, `test_position_filled_with_no_change`, `test_position_filled_with_sell_order`, `test_position_filled_with_sell_order_then_buy_order`, `test_position_flattens_with_base_currency_commission_on_close`, `test_position_flattens_with_quote_currency_commission_on_close`, `test_position_flip_long_to_short_applies_full_commission`, `test_position_flip_short_to_long_applies_full_commission`, `test_position_hash_str_repr`, `test_position_long_with_multiple_filled_orders`, `test_position_partial_fills_with_buy_order` *(+8 more)*
**Imports**: `decimal`, `nautilus_trader.core.nautilus_pyo3`, `nautilus_trader.test_kit.rust.accounting_pyo3`, `nautilus_trader.test_kit.rust.events_pyo3`, `nautilus_trader.test_kit.rust.identifiers_pyo3`, `nautilus_trader.test_kit.rust.instruments_pyo3`, `nautilus_trader.test_kit.rust.orders_pyo3`, `pytest`
...
```bash
# For Python
pytest tests/unit_tests/model/test_position_pyo3.py
...
---
*Generated on 2025-11-18T21:55:11.675944Z*
