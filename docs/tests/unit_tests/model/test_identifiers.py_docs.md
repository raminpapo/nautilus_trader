# Documentation: test_identifiers.py

## File Metadata

- **Path**: `tests/unit_tests/model/test_identifiers.py`
- **Size**: 15,010 bytes
- **Lines**: 524
- **Language**: Python
...
This file is part of the NautilusTrader repository. It defines 40 function(s).

## Detailed Walkthrough

### Functions
- **`test_trader_identifier()`**: Function defined in this file
- **`test_account_identifier()`**: Function defined in this file
- **`test_symbol_equality()`**: Function defined in this file
...
- **`test_symbol_str()`**: Function defined in this file
- **`test_symbol_repr()`**: Function defined in this file
- **`test_symbol_pickling()`**: Function defined in this file
- **`test_venue_equality()`**: Function defined in this file
- **`test_venue_str()`**: Function defined in this file
- **`test_venue_from_code_when_not_found()`**: Function defined in this file
- **`test_venue_from_code()`**: Function defined in this file
- **`test_venue_repr()`**: Function defined in this file
- **`test_venue_pickling()`**: Function defined in this file
- **`test_instrument_id_equality()`**: Function defined in this file
- **`test_instrument_id_str()`**: Function defined in this file
- **`test_instrument_id_pickling()`**: Function defined in this file
- **`test_instrument_id_repr()`**: Function defined in this file
- **`test_instrument_id_from_str()`**: Function defined in this file
...
**Functions**: `test_account_identifier`, `test_exec_algorithm_id`, `test_identifier_equality_with_none_returns_false`, `test_identifier_ordering_comparison_with_none_raises_type_error`, `test_instrument_id_equality`, `test_instrument_id_from_str`, `test_instrument_id_from_str_when_invalid`, `test_instrument_id_from_str_with_utf8_symbol`, `test_instrument_id_is_spread_false_for_simple_symbol`, `test_instrument_id_is_spread_true_for_spread_symbol`, `test_instrument_id_is_spread_true_for_symbol_with_underscore`, `test_instrument_id_new_spread_empty_list_raises_error`, `test_instrument_id_new_spread_mismatched_venues_raises_error`, `test_instrument_id_new_spread_multiple_instruments_sorted`, `test_instrument_id_new_spread_single_negative_ratio`, `test_instrument_id_new_spread_single_positive_ratio`, `test_instrument_id_new_spread_to_list_roundtrip`, `test_instrument_id_new_spread_zero_ratio_raises_error`, `test_instrument_id_pickling`, `test_instrument_id_repr`, `test_instrument_id_str`, `test_instrument_id_to_list_invalid_format_raises_error`, `test_instrument_id_to_list_multiple_instruments`, `test_instrument_id_to_list_single_negative_ratio`, `test_instrument_id_to_list_single_positive_ratio`, `test_symbol_equality`, `test_symbol_is_composite`, `test_symbol_pickling`, `test_symbol_repr`, `test_symbol_root` *(+10 more)*
**Imports**: `nautilus_trader.model.identifiers`, `pickle`, `pytest`
...
```bash
# For Python
pytest tests/unit_tests/model/test_identifiers.py
...
---
*Generated on 2025-11-18T21:55:11.615946Z*
