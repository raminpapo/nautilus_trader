# Documentation: test_orderbook.py
...
### Classes
- **`TestOrderBook`**: Class defined in this file
...
**Classs**: `TestOrderBook`
**Imports**: `copy`, `nautilus_trader`, `nautilus_trader.adapters.databento.loaders`, `nautilus_trader.model.book`, `nautilus_trader.model.data`, `nautilus_trader.model.enums`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.objects`, `nautilus_trader.test_kit.providers`, `nautilus_trader.test_kit.stubs.data`, `nautilus_trader.test_kit.stubs.identifiers`, `pandas`, `pickle`, `pytest`
...
```bash
# For Python
pytest tests/unit_tests/model/test_orderbook.py
...
---
*Generated on 2025-11-18T21:55:11.627787Z*
