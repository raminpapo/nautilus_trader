# Documentation: `tests/unit_tests/model/test_orderbook.py`
**Generated:** 2025-11-15T19:40:09.354309Z
**File Size:** 25463 bytes
**Extension:** .py
**Type:** text
...
- **Path:** `tests/unit_tests/model/test_orderbook.py`
- **Size:** 25,463 bytes
- **Lines:** 822
- **Extension:** `.py`
- **Type:** text
...
This file is located at `tests/unit_tests/model/test_orderbook.py` within the repository.

**Classes defined:** TestOrderBook

**Functions defined:** setup, test_order_book_pickleable, make_sample_book, test_create_level_1_order_book, test_create_level_2_order_book, test_create_level_3_order_book, test_best_bid_or_ask_price_with_no_orders_returns_none, test_best_bid_or_ask_qty_with_no_orders_returns_none, test_spread_with_no_orders_returns_none, test_get_avg_px_for_quantity_when_no_market and 22 more
...
#### `test_order_book_pickleable(self)`


#### `make_sample_book(self)`


#### `test_create_level_1_order_book(self)`


#### `test_create_level_2_order_book(self)`


#### `test_create_level_3_order_book(self)`


#### `test_best_bid_or_ask_price_with_no_orders_returns_none(self)`


#### `test_best_bid_or_ask_qty_with_no_orders_returns_none(self)`


#### `test_spread_with_no_orders_returns_none(self)`


#### `test_get_avg_px_for_quantity_when_no_market(self, order_side: OrderSide)`


#### `test_get_avg_px_for_quantity(self, order_side: OrderSide, expected: float)`


#### `test_add_orders_to_book(self)`


#### `test_repr(self)`


#### `test_pprint_when_no_orders(self)`
...
#### `test_orderbook_operation_update(self)`


#### `test_orderbook_operation_add(self)`


#### `test_orderbook_operations(self)`


#### `test_orderbook_midpoint(self)`


#### `test_orderbook_midpoint_empty(self)`


#### `test_l3_get_avg_px_for_quantity(self)`


#### `test_get_quantity_for_price(self, is_buy, price, expected)`


#### `test_l2_update(self)`


#### `test_book_order_pickle_round_trip(self)`


#### `test_orderbook_deep_copy(self)`


#### `make_delta(side: OrderSide, price: float, size: float, ts: int)`


#### `test_orderbook_esh4_glbx_20231224_mbo_l3(self)`


#### `test_check_integrity_when_book_crossed(self, book_type: BookType)`


#### `test_update_quote_tick_other_than_l1_raises_exception(
        self,
        book_type: BookType,
    )`


#### `test_update_trade_tick_other_than_l1_raises_exception(
        self,
        book_type: BookType,
    )`
...
```python
from tests.unit_tests.model.test_orderbook import TestOrderBook
```
