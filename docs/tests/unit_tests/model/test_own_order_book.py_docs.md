# Documentation: `tests/unit_tests/model/test_own_order_book.py`
**Generated:** 2025-11-15T19:40:09.372110Z
**File Size:** 42586 bytes
**Extension:** .py
**Type:** text
...
This file is located at `tests/unit_tests/model/test_own_order_book.py` within the repository.

**Functions defined:** test_own_book_order_creation, test_own_book_order_exposure, test_own_book_order_signed_size, test_own_book_order_repr, test_own_order_book_creation, test_own_order_book_add_update_delete, test_own_order_book_clear, test_own_order_book_bids_asks_as_map, test_own_order_book_fifo_same_price, test_own_order_book_price_change and 15 more
...
#### `test_own_book_order_creation()`


#### `test_own_book_order_exposure()`


#### `test_own_book_order_signed_size(side, expected)`


#### `test_own_book_order_repr()`


#### `test_own_order_book_creation()`


#### `test_own_order_book_add_update_delete()`


#### `test_own_order_book_clear()`


#### `test_own_order_book_bids_asks_as_map(side)`


#### `test_own_order_book_fifo_same_price()`


#### `test_own_order_book_price_change()`
...
#### `test_own_order_book_quantities_parametrized(
    orders,
    expected_bid_quantities,
    expected_ask_quantities,
)`
...
#### `test_bids_to_dict_with_status_filter()`


#### `test_bid_quantity_with_status_filter()`


#### `test_mixed_status_filtering()`


#### `test_bid_quantity_with_depth_limit()`


#### `test_ask_quantity_with_depth_limit()`


#### `test_bid_quantity_with_grouping()`


#### `test_ask_quantity_with_grouping()`


#### `test_bid_quantity_with_grouping_and_depth()`


#### `test_quantity_methods_with_status_and_grouping()`


#### `test_own_order_book_pprint()`


#### `test_own_order_book_pprint_empty()`


#### `test_own_order_book_pprint_with_group_size()`
...
```python
from tests.unit_tests.model.test_own_order_book import test_own_book_order_creation
```
