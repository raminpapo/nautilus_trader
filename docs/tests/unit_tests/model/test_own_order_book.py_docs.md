# Documentation: test_own_order_book.py

## File Metadata

- **Path**: `tests/unit_tests/model/test_own_order_book.py`
- **Size**: 42,037 bytes
- **Lines**: 1,286
- **Language**: Python
...
### Functions
- **`test_own_book_order_creation()`**: Function defined in this file
- **`test_own_book_order_exposure()`**: Function defined in this file
- **`test_own_book_order_signed_size()`**: Function defined in this file
- **`test_own_book_order_repr()`**: Function defined in this file
- **`test_own_order_book_creation()`**: Function defined in this file
- **`test_own_order_book_add_update_delete()`**: Function defined in this file
- **`test_own_order_book_clear()`**: Function defined in this file
- **`test_own_order_book_bids_asks_as_map()`**: Function defined in this file
- **`test_own_order_book_fifo_same_price()`**: Function defined in this file
- **`test_own_order_book_price_change()`**: Function defined in this file
- **`test_own_order_book_bid_ask_quantity()`**: Function defined in this file
- **`test_own_order_book_quantity_empty_levels()`**: Function defined in this file
- **`test_own_order_book_quantities_parametrized()`**: Function defined in this file
- **`test_bids_to_dict_with_status_filter()`**: Function defined in this file
- **`test_bid_quantity_with_status_filter()`**: Function defined in this file
- **`test_mixed_status_filtering()`**: Function defined in this file
- **`test_bid_quantity_with_depth_limit()`**: Function defined in this file
- **`test_ask_quantity_with_depth_limit()`**: Function defined in this file
- **`test_bid_quantity_with_grouping()`**: Function defined in this file
- **`test_ask_quantity_with_grouping()`**: Function defined in this file
...
**Functions**: `test_ask_quantity_with_depth_limit`, `test_ask_quantity_with_grouping`, `test_bid_quantity_with_depth_limit`, `test_bid_quantity_with_grouping`, `test_bid_quantity_with_grouping_and_depth`, `test_bid_quantity_with_status_filter`, `test_bids_to_dict_with_status_filter`, `test_mixed_status_filtering`, `test_own_book_order_creation`, `test_own_book_order_exposure`, `test_own_book_order_repr`, `test_own_book_order_signed_size`, `test_own_order_book_add_update_delete`, `test_own_order_book_bid_ask_quantity`, `test_own_order_book_bids_asks_as_map`, `test_own_order_book_clear`, `test_own_order_book_creation`, `test_own_order_book_fifo_same_price`, `test_own_order_book_pprint`, `test_own_order_book_pprint_empty`, `test_own_order_book_pprint_with_group_size`, `test_own_order_book_price_change`, `test_own_order_book_quantities_parametrized`, `test_own_order_book_quantity_empty_levels`, `test_quantity_methods_with_status_and_grouping`
**Imports**: `decimal`, `nautilus_trader.core.nautilus_pyo3`, `pytest`
...
```bash
# For Python
pytest tests/unit_tests/model/test_own_order_book.py
...
---
*Generated on 2025-11-18T21:55:11.648717Z*
