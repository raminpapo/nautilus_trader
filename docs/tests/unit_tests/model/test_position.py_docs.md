# Documentation: `tests/unit_tests/model/test_position.py`
**Generated:** 2025-11-15T19:40:09.383300Z
**File Size:** 117360 bytes
**Extension:** .py
**Type:** text
...
- **Path:** `tests/unit_tests/model/test_position.py`
- **Size:** 117,360 bytes
- **Lines:** 3,326
- **Extension:** `.py`
- **Type:** text
...
This file is located at `tests/unit_tests/model/test_position.py` within the repository.

**Classes defined:** TestPosition

**Functions defined:** setup, test_side_from_order_side_given_invalid_value, test_side_from_order_side_given_valid_sides, test_position_hash_str_repr, test_position_to_dict, test_long_position_to_dict_equity, test_short_position_to_dict_equity, test_position_filled_with_duplicate_trade_id_different_trade, test_position_filled_with_duplicate_trade_id_and_same_trade, test_position_filled_with_buy_order and 56 more
...
#### `test_side_from_order_side_given_invalid_value(self)`


#### `test_side_from_order_side_given_valid_sides(
        self,
        order_side: OrderSide,
        expected: PositionSide,
    )`
...
#### `test_position_hash_str_repr(self)`


#### `test_position_to_dict(self)`


#### `test_long_position_to_dict_equity(self)`


#### `test_short_position_to_dict_equity(self)`


#### `test_position_filled_with_duplicate_trade_id_different_trade(
        self,
        side1: OrderSide,
        side2: OrderSide,
        last_px1: Price,
...
#### `test_position_filled_with_duplicate_trade_id_and_same_trade(self)`


#### `test_position_filled_with_buy_order(self)`


#### `test_position_filled_with_sell_order(self)`


#### `test_position_partial_fills_with_buy_order(self)`


#### `test_position_partial_fills_with_sell_order(self)`


#### `test_position_filled_with_buy_order_then_sell_order(self)`


#### `test_position_filled_with_sell_order_then_buy_order(self)`


#### `test_position_filled_with_no_change(self)`


#### `test_position_long_with_multiple_filled_orders(self)`


#### `test_pnl_calculation_from_trading_technologies_example(self)`


#### `test_position_closed_and_reopened(self)`


#### `test_position_realized_pnl_with_interleaved_order_sides(self)`


#### `test_calculate_pnl_when_given_position_side_flat_returns_zero(self)`


#### `test_calculate_pnl_for_long_position_win(self)`


#### `test_calculate_pnl_for_long_position_loss(self)`


#### `test_calculate_pnl_for_short_position_winning(self)`


#### `test_calculate_pnl_for_short_position_loss(self)`


#### `test_calculate_pnl_for_inverse1(self)`


#### `test_calculate_pnl_for_inverse2(self)`


#### `test_calculate_pnl_for_inverse3(
        self,
        quantity: Quantity,
        last_px: Price,
        mark_price: Price,
...
#### `test_calculate_unrealized_pnl_for_long(self)`


#### `test_calculate_unrealized_pnl_for_short(self)`


#### `test_calculate_unrealized_pnl_for_long_inverse(self)`


#### `test_calculate_unrealized_pnl_for_short_inverse(self)`
...
#### `test_purge_order_events(self)`


#### `test_purge_all_events_returns_none_for_last_event_and_trade_id(self)`


#### `test_revive_from_empty_shell(self)`


#### `test_empty_shell_position_invariants(self)`


#### `test_commission_accumulation_single_currency(self)`


#### `test_commission_accumulation_multiple_fills(self)`


#### `test_realized_return_calculation_long_position(self)`


#### `test_realized_return_calculation_short_position(self)`


#### `test_duration_calculation(self)`


#### `test_is_opposite_side_method(self)`


#### `test_avg_px_calculations_multiple_fills(self)`


#### `test_closing_order_side_for_different_position_sides(self)`


#### `test_signed_decimal_qty_for_different_sides(self)`


#### `test_notional_value_calculation(self)`


#### `test_partial_close_updates_quantities_correctly(self)`


#### `test_id_list_deduplication_and_sorting(self)`


#### `test_position_equality_and_hash_semantics(self)`
...
```python
from tests.unit_tests.model.test_position import TestPosition
```
