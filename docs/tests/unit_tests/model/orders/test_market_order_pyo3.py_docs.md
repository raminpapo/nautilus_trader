# Documentation: test_market_order_pyo3.py

## File Metadata

- **Path**: `tests/unit_tests/model/orders/test_market_order_pyo3.py`
- **Size**: 5,371 bytes
- **Lines**: 148
- **Language**: Python
...
### Functions
- **`test_opposite_side_returns_expected_sides()`**: Function defined in this file
- **`test_closing_side_returns_expected_sides()`**: Function defined in this file
- **`test_would_reduce_only_with_various_values_returns_expected()`**: Function defined in this file
- **`test_market_order_with_quantity_zero_raises_value_error()`**: Function defined in this file
- **`test_market_order_with_invalid_tif_raises_value_error()`**: Function defined in this file
...
**Functions**: `test_closing_side_returns_expected_sides`, `test_market_order_with_invalid_tif_raises_value_error`, `test_market_order_with_quantity_zero_raises_value_error`, `test_opposite_side_returns_expected_sides`, `test_pyo3_cython_conversion`, `test_would_reduce_only_with_various_values_returns_expected`
**Imports**: `nautilus_trader.core`, `nautilus_trader.core.nautilus_pyo3`, `nautilus_trader.model.orders`, `nautilus_trader.test_kit.rust.orders_pyo3`, `pytest`
...
```bash
# For Python
pytest tests/unit_tests/model/orders/test_market_order_pyo3.py
...
---
*Generated on 2025-11-18T21:55:11.579409Z*
