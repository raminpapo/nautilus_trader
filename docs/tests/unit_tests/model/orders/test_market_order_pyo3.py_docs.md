# Documentation: `tests/unit_tests/model/orders/test_market_order_pyo3.py`
**Generated:** 2025-11-15T19:40:09.306648Z
...
This file is located at `tests/unit_tests/model/orders/test_market_order_pyo3.py` within the repository.

**Functions defined:** test_opposite_side_returns_expected_sides, test_closing_side_returns_expected_sides, test_would_reduce_only_with_various_values_returns_expected, test_market_order_with_quantity_zero_raises_value_error, test_market_order_with_invalid_tif_raises_value_error, test_pyo3_cython_conversion
...
#### `test_opposite_side_returns_expected_sides(side, expected)`


#### `test_closing_side_returns_expected_sides(
    side: PositionSide,
    expected: OrderSide,
)`
...
#### `test_market_order_with_quantity_zero_raises_value_error()`
...
```python
from tests.unit_tests.model.orders.test_market_order_pyo3 import test_opposite_side_returns_expected_sides
```
