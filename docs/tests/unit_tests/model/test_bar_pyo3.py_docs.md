# Documentation: test_bar_pyo3.py
...
**Imports**: `datetime`, `nautilus_trader.core.nautilus_pyo3`, `pickle`, `pytest`
...
```bash
# For Python
pytest tests/unit_tests/model/test_bar_pyo3.py
...
---
*Generated on 2025-11-18T21:55:11.587872Z*
