# Documentation: `tests/unit_tests/model/test_bar_pyo3.py`
**Generated:** 2025-11-15T19:40:09.315668Z
**File Size:** 23239 bytes
**Extension:** .py
**Type:** text
...
- **Path:** `tests/unit_tests/model/test_bar_pyo3.py`
- **Size:** 23,239 bytes
- **Lines:** 693
- **Extension:** `.py`
- **Type:** text
...
This file is located at `tests/unit_tests/model/test_bar_pyo3.py` within the repository.

**Classes defined:** TestBarSpecification, TestBarType, TestBar

**Functions defined:** test_bar_spec_equality, test_bar_spec_comparison, test_bar_spec_pickle, test_bar_spec_hash_str_and_repr, test_timedelta_for_unsupported_aggregations_raises_value_error, test_timedelta_given_various_values_returns_expected, test_from_str_given_various_invalid_strings_raises_value_error, test_from_str_given_various_valid_string_returns_expected_specification, test_aggregation_queries, test_properties and 22 more
...
#### `test_timedelta_for_unsupported_aggregations_raises_value_error(self, aggregation)`


#### `test_timedelta_given_various_values_returns_expected(
        self,
        step,
        aggregation,
        expected,
...
```python
from tests.unit_tests.model.test_bar_pyo3 import TestBarSpecification
```
