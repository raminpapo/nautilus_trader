# Documentation: `tests/unit_tests/model/instruments/test_crypto_future_pyo3.py`
**Generated:** 2025-11-15T19:40:09.272205Z
**File Size:** 7914 bytes
**Extension:** .py
**Type:** text
...
This file is located at `tests/unit_tests/model/instruments/test_crypto_future_pyo3.py` within the repository.

**Functions defined:** test_equality, test_hash, test_to_dict, test_pyo3_cython_conversion, test_get_base_currency_linear, test_get_base_currency_inverse, test_get_cost_currency_linear, test_get_cost_currency_inverse, test_get_cost_currency_quanto, test_notional_value_linear and 3 more
...
#### `test_get_base_currency_linear()`


#### `test_get_base_currency_inverse()`


#### `test_get_cost_currency_linear()`


#### `test_get_cost_currency_inverse()`


#### `test_get_cost_currency_quanto()`


#### `test_notional_value_linear()`


#### `test_notional_value_inverse()`


#### `test_notional_value_inverse_with_quote_override()`


#### `test_notional_value_quanto()`
...
```python
from tests.unit_tests.model.instruments.test_crypto_future_pyo3 import test_equality
```
