# Documentation: test_crypto_perpetual_pyo3.py

## File Metadata

- **Path**: `tests/unit_tests/model/instruments/test_crypto_perpetual_pyo3.py`
- **Size**: 6,285 bytes
- **Lines**: 170
- **Language**: Python
...
**Functions**: `test_equality`, `test_get_cost_currency_inverse`, `test_get_cost_currency_linear`, `test_get_cost_currency_quanto`, `test_hash`, `test_notional_value_inverse`, `test_notional_value_inverse_with_quote_override`, `test_notional_value_linear`, `test_notional_value_quanto`, `test_pyo3_cython_conversion`, `test_to_dict`
**Imports**: `decimal`, `nautilus_trader.core`, `nautilus_trader.model.instruments`, `nautilus_trader.model.objects`, `nautilus_trader.test_kit.rust.instruments_pyo3`
...
```bash
# For Python
pytest tests/unit_tests/model/instruments/test_crypto_perpetual_pyo3.py
...
---
*Generated on 2025-11-18T21:55:11.530296Z*
