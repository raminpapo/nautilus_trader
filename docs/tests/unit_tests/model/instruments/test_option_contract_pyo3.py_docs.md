# Documentation: `tests/unit_tests/model/instruments/test_option_contract_pyo3.py`
**Generated:** 2025-11-15T19:40:09.281712Z
...
- **Path:** `tests/unit_tests/model/instruments/test_option_contract_pyo3.py`
- **Size:** 3,182 bytes
- **Lines:** 85
- **Extension:** `.py`
- **Type:** text
...
This file is located at `tests/unit_tests/model/instruments/test_option_contract_pyo3.py` within the repository.

**Functions defined:** test_equality, test_hash, test_to_dict, test_legacy_option_contract_from_pyo3, test_pyo3_cython_conversion
...
#### `test_legacy_option_contract_from_pyo3()`
...
```python
from tests.unit_tests.model.instruments.test_option_contract_pyo3 import test_equality
```
