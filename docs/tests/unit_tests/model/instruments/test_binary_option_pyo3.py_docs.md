# Documentation: test_binary_option_pyo3.py
...
**Functions**: `test_equality`, `test_hash`, `test_to_dict`
**Imports**: `nautilus_trader.core`, `nautilus_trader.test_kit.rust.instruments_pyo3`
...
```bash
# For Python
pytest tests/unit_tests/model/instruments/test_binary_option_pyo3.py
...
---
*Generated on 2025-11-18T21:55:11.525079Z*
