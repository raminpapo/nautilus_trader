# Documentation: `tests/unit_tests/model/instruments/test_binary_option_pyo3.py`
**Generated:** 2025-11-15T19:40:09.270729Z
...
- **Path:** `tests/unit_tests/model/instruments/test_binary_option_pyo3.py`
- **Size:** 3,115 bytes
- **Lines:** 74
- **Extension:** `.py`
- **Type:** text
...
This file is located at `tests/unit_tests/model/instruments/test_binary_option_pyo3.py` within the repository.
...
```python
from tests.unit_tests.model.instruments.test_binary_option_pyo3 import test_equality
```
