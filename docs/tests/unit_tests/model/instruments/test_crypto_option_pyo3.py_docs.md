# Documentation: `tests/unit_tests/model/instruments/test_crypto_option_pyo3.py`
**Generated:** 2025-11-15T19:40:09.273796Z
...
This file is located at `tests/unit_tests/model/instruments/test_crypto_option_pyo3.py` within the repository.

**Functions defined:** test_equality, test_hash, test_to_dict, test_pyo3_cython_conversion, test_get_base_currency_linear, test_get_base_currency_inverse, test_get_cost_currency_linear, test_get_cost_currency_inverse, test_notional_value_linear, test_notional_value_inverse and 1 more
...
```python
from tests.unit_tests.model.instruments.test_crypto_option_pyo3 import test_equality
```
