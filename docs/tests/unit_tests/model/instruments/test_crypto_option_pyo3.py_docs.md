# Documentation: test_crypto_option_pyo3.py

## File Metadata

- **Path**: `tests/unit_tests/model/instruments/test_crypto_option_pyo3.py`
- **Size**: 7,200 bytes
- **Lines**: 187
- **Language**: Python
...
**Functions**: `test_equality`, `test_get_base_currency_inverse`, `test_get_base_currency_linear`, `test_get_cost_currency_inverse`, `test_get_cost_currency_linear`, `test_hash`, `test_notional_value_inverse`, `test_notional_value_inverse_with_quote_override`, `test_notional_value_linear`, `test_pyo3_cython_conversion`, `test_to_dict`
...
```bash
# For Python
pytest tests/unit_tests/model/instruments/test_crypto_option_pyo3.py
...
---
*Generated on 2025-11-18T21:55:11.528726Z*
