# Documentation: `tests/unit_tests/model/test_tick_pyo3.py`
**Generated:** 2025-11-15T19:40:09.399788Z
...
- **Path:** `tests/unit_tests/model/test_tick_pyo3.py`
- **Size:** 8,676 bytes
- **Lines:** 261
- **Extension:** `.py`
- **Type:** text
...
This file is located at `tests/unit_tests/model/test_tick_pyo3.py` within the repository.

**Classes defined:** TestQuoteTick, TestTradeTick

**Functions defined:** test_pickling_instrument_id_round_trip, test_fully_qualified_name, test_tick_hash_str_and_repr, test_extract_price_with_various_price_types_returns_expected_values, test_extract_size_with_various_price_types_returns_expected_values, test_to_dict_returns_expected_dict, test_from_dict_returns_expected_tick, test_pickling_round_trip_results_in_expected_tick, test_fully_qualified_name, test_hash_str_and_repr and 3 more
...
#### `test_pickling_instrument_id_round_trip(self)`


#### `test_fully_qualified_name(self)`


#### `test_tick_hash_str_and_repr(self)`


#### `test_extract_price_with_various_price_types_returns_expected_values(self)`


#### `test_extract_size_with_various_price_types_returns_expected_values(self)`
...
#### `test_pickling_round_trip_results_in_expected_tick(self)`
...
```python
from tests.unit_tests.model.test_tick_pyo3 import TestQuoteTick
```
