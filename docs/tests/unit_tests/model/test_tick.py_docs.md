# Documentation: `tests/unit_tests/model/test_tick.py`
**Generated:** 2025-11-15T19:40:09.398048Z
...
- **Path:** `tests/unit_tests/model/test_tick.py`
- **Size:** 13,096 bytes
- **Lines:** 402
- **Extension:** `.py`
- **Type:** text
...
#### `test_from_raw_returns_expected_tick(self)`
...
```python
from tests.unit_tests.model.test_tick import TestQuoteTick
```
