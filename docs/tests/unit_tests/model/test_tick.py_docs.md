...
### Classes
- **`TestQuoteTick`**: Class defined in this file
...
**Classs**: `TestQuoteTick`, `TestTradeTick`
**Imports**: `nautilus_trader.core`, `nautilus_trader.model`, `nautilus_trader.model.data`, `nautilus_trader.model.enums`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.objects`, `nautilus_trader.test_kit.providers`, `nautilus_trader.test_kit.rust.data_pyo3`, `pickle`
...
```bash
# For Python
pytest tests/unit_tests/model/test_tick.py
...
---
*Generated on 2025-11-18T21:55:11.682919Z*
