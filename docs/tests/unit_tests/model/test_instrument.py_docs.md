# Documentation: `tests/unit_tests/model/test_instrument.py`
**Generated:** 2025-11-15T19:40:09.349032Z
**File Size:** 27623 bytes
**Extension:** .py
**Type:** text
...
- **Path:** `tests/unit_tests/model/test_instrument.py`
- **Size:** 27,623 bytes
- **Lines:** 815
- **Extension:** `.py`
- **Type:** text
...
This file is located at `tests/unit_tests/model/test_instrument.py` within the repository.

**Classes defined:** TestInstrument

**Functions defined:** test_equality, test_str_repr_returns_expected, test_hash, test_symbol_returns_expected_symbol, test_base_to_dict_returns_expected_dict, test_base_from_dict_returns_expected_instrument, test_betting_instrument_to_dict, test_crypto_perpetual_instrument_to_dict, test_crypto_future_instrument_to_dict, test_equity_instrument_to_dict and 29 more
...
#### `test_equality(self, instrument1, instrument2, expected1, expected2)`


#### `test_str_repr_returns_expected(self)`


#### `test_hash(self)`


#### `test_symbol_returns_expected_symbol(self)`


#### `test_base_to_dict_returns_expected_dict(self)`


#### `test_base_from_dict_returns_expected_instrument(self)`


#### `test_betting_instrument_to_dict(self)`


#### `test_crypto_perpetual_instrument_to_dict(self)`


#### `test_crypto_future_instrument_to_dict(self)`


#### `test_equity_instrument_to_dict(self)`


#### `test_future_instrument_to_dict(self)`


#### `test_option_instrument_to_dict(self)`


#### `test_make_price_with_various_values_returns_expected(
        self,
        value,
        expected_str,
    )`
...
#### `test_make_qty_when_non_zero_value_rounded_to_zero_raises_exception(self)`


#### `test_make_qty_with_various_values_returns_expected(
        self,
        value,
        expected_str,
    )`
...
#### `test_make_qty_with_round_down_parameter(
        self,
        value,
        round_down,
        expected_str,
...
#### `test_make_price_with_lower_precision_minimum_increment(
            self,
            value: float,
            expected: Decimal,
        )`
...
#### `test_base_currency_for_various_instruments(self, instrument, expected)`


#### `test_settlement_currency_for_various_instruments(self, instrument, expected)`


#### `test_calculate_notional_value(self)`


#### `test_calculate_notional_value_for_inverse(self, use_quote_for_inverse, expected)`


#### `test_calculate_base_quantity_audusd(self)`


#### `test_next_bid_price_when_no_tick_scheme(self)`


#### `test_next_ask_price_when_no_tick_scheme(self)`


#### `test_set_tick_scheme_name_enables_tick_scheme(self)`


#### `test_next_ask_price(self, instrument, value, n, expected)`


#### `test_next_bid_price(self, instrument, value, n, expected)`


#### `test_option_attributes(self)`


#### `test_next_bid_prices_when_no_tick_scheme(self)`


#### `test_next_ask_prices_when_no_tick_scheme(self)`


#### `test_next_ask_prices_length(self, instrument, value, num_ticks, expected_len)`


#### `test_next_bid_prices_length(self, instrument, value, num_ticks, expected_len)`


#### `test_next_ask_prices_values(
        self,
        instrument,
        value,
        num_ticks,
...
#### `test_pyo3_equity_to_legacy_equity()`


#### `test_pyo3_future_to_legacy_future()`


#### `test_pyo3_option_to_legacy_option()`


#### `test_binary_option_dict_round_trip()`


#### `test_betting_instrument_dict_round_trip()`
...
```python
from tests.unit_tests.model.test_instrument import TestInstrument
```
