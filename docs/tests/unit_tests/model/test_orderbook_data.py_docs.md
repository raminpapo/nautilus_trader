# Documentation: `tests/unit_tests/model/test_orderbook_data.py`
**Generated:** 2025-11-15T19:40:09.357802Z
**File Size:** 25685 bytes
**Extension:** .py
**Type:** text
...
This file is located at `tests/unit_tests/model/test_orderbook_data.py` within the repository.

**Functions defined:** test_book_order_init, test_signed_size, test_exposure, test_hash_str_and_repr, test_to_dict_returns_expected_dict, test_from_dict_returns_expected_order, test_book_order_from_raw, test_delta_fully_qualified_name, test_delta_from_raw, test_delta_pickle_round_trip and 24 more
...
#### `test_book_order_init(side: OrderSide)`
...
#### `test_hash_str_and_repr()`


#### `test_to_dict_returns_expected_dict()`


#### `test_from_dict_returns_expected_order()`


#### `test_book_order_from_raw()`


#### `test_delta_fully_qualified_name()`


#### `test_delta_from_raw()`


#### `test_delta_pickle_round_trip()`


#### `test_delta_hash_str_and_repr()`


#### `test_delta_with_null_book_order()`


#### `test_delta_clear()`


#### `test_delta_to_dict_with_order_returns_expected_dict()`


#### `test_delta_from_dict_returns_expected_delta()`


#### `test_delta_from_dict_returns_expected_clear()`


#### `test_deltas_fully_qualified_name()`
...
#### `test_deltas_hash_str_and_repr()`


#### `test_deltas_batching()`


#### `test_deltas_batching_with_remainder()`


#### `test_deltas_to_dict_from_dict_round_trip()`


#### `test_deltas_from_dict_returns_expected_dict()`


#### `test_deltas_from_pyo3()`


#### `test_deltas_from_pyo3_list()`


#### `test_depth10_fully_qualified_name()`


#### `test_depth10_new()`


#### `test_depth10_partial_levels()`


#### `test_depth10_pickle_round_trip()`


#### `test_depth10_hash_str_repr()`


#### `test_depth10_to_dict_from_dict_round_trip()`


#### `test_depth10_from_pyo3()`
...
```python
from tests.unit_tests.model.test_orderbook_data import test_book_order_init
```
