# Documentation: test_orderbook_data.py

## File Metadata

- **Path**: `tests/unit_tests/model/test_orderbook_data.py`
- **Size**: 25,685 bytes
- **Lines**: 838
- **Language**: Python
...
This file is part of the NautilusTrader repository. It defines 34 function(s).

## Detailed Walkthrough

### Functions
- **`test_book_order_init()`**: Function defined in this file
- **`test_signed_size()`**: Function defined in this file
- **`test_exposure()`**: Function defined in this file
- **`test_hash_str_and_repr()`**: Function defined in this file
- **`test_to_dict_returns_expected_dict()`**: Function defined in this file
- **`test_from_dict_returns_expected_order()`**: Function defined in this file
- **`test_book_order_from_raw()`**: Function defined in this file
- **`test_delta_fully_qualified_name()`**: Function defined in this file
- **`test_delta_from_raw()`**: Function defined in this file
- **`test_delta_pickle_round_trip()`**: Function defined in this file
- **`test_delta_hash_str_and_repr()`**: Function defined in this file
- **`test_delta_with_null_book_order()`**: Function defined in this file
- **`test_delta_clear()`**: Function defined in this file
- **`test_delta_to_dict_with_order_returns_expected_dict()`**: Function defined in this file
- **`test_delta_from_dict_returns_expected_delta()`**: Function defined in this file
- **`test_delta_from_dict_returns_expected_clear()`**: Function defined in this file
- **`test_deltas_fully_qualified_name()`**: Function defined in this file
- **`test_deltas_pickle_round_trip()`**: Function defined in this file
- **`test_deltas_to_pyo3()`**: Function defined in this file
- **`test_deltas_capsule_round_trip()`**: Function defined in this file
...
**Functions**: `test_book_order_from_raw`, `test_book_order_init`, `test_delta_clear`, `test_delta_from_dict_returns_expected_clear`, `test_delta_from_dict_returns_expected_delta`, `test_delta_from_raw`, `test_delta_fully_qualified_name`, `test_delta_hash_str_and_repr`, `test_delta_pickle_round_trip`, `test_delta_to_dict_with_order_returns_expected_dict`, `test_delta_with_null_book_order`, `test_deltas_batching`, `test_deltas_batching_with_remainder`, `test_deltas_capsule_round_trip`, `test_deltas_from_dict_returns_expected_dict`, `test_deltas_from_pyo3`, `test_deltas_from_pyo3_list`, `test_deltas_fully_qualified_name`, `test_deltas_hash_str_and_repr`, `test_deltas_pickle_round_trip`, `test_deltas_to_dict_from_dict_round_trip`, `test_deltas_to_pyo3`, `test_depth10_from_pyo3`, `test_depth10_fully_qualified_name`, `test_depth10_hash_str_repr`, `test_depth10_new`, `test_depth10_partial_levels`, `test_depth10_pickle_round_trip`, `test_depth10_to_dict_from_dict_round_trip`, `test_exposure` *(+4 more)*
**Imports**: `nautilus_trader.core`, `nautilus_trader.model`, `nautilus_trader.model.data`, `nautilus_trader.model.enums`, `nautilus_trader.model.objects`, `nautilus_trader.test_kit.rust.data_pyo3`, `nautilus_trader.test_kit.stubs.data`, `nautilus_trader.test_kit.stubs.identifiers`, `pickle`, `pytest`
...
```bash
# For Python
pytest tests/unit_tests/model/test_orderbook_data.py
...
---
*Generated on 2025-11-18T21:55:11.631149Z*
