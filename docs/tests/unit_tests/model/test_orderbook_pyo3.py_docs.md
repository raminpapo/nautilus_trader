# Documentation: `tests/unit_tests/model/test_orderbook_pyo3.py`
**Generated:** 2025-11-15T19:40:09.359499Z
...
- **Path:** `tests/unit_tests/model/test_orderbook_pyo3.py`
- **Size:** 4,844 bytes
- **Lines:** 142
- **Extension:** `.py`
- **Type:** text
...
This file is located at `tests/unit_tests/model/test_orderbook_pyo3.py` within the repository.

**Functions defined:** fixture_book, populate_book, test_order_book, test_group_bids_asks_empty, test_group_bids_asks_with_depth_limit, test_group_bids_asks
...
#### `test_order_book(book: nautilus_pyo3.OrderBook)`


#### `test_group_bids_asks_empty(book: nautilus_pyo3.OrderBook)`


#### `test_group_bids_asks_with_depth_limit(book: nautilus_pyo3.OrderBook)`


#### `test_group_bids_asks(book: nautilus_pyo3.OrderBook)`
...
```python
from tests.unit_tests.model.test_orderbook_pyo3 import fixture_book
```
