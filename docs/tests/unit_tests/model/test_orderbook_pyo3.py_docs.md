# Documentation: test_orderbook_pyo3.py
...
### Functions
- **`fixture_book()`**: Function defined in this file
- **`populate_book()`**: Function defined in this file
- **`test_order_book()`**: Function defined in this file
- **`test_group_bids_asks_empty()`**: Function defined in this file
- **`test_group_bids_asks_with_depth_limit()`**: Function defined in this file
- **`test_group_bids_asks()`**: Function defined in this file
...
**Functions**: `fixture_book`, `populate_book`, `test_group_bids_asks`, `test_group_bids_asks_empty`, `test_group_bids_asks_with_depth_limit`, `test_order_book`
**Imports**: `decimal`, `nautilus_trader.core`, `pytest`
...
```bash
# For Python
pytest tests/unit_tests/model/test_orderbook_pyo3.py
...
---
*Generated on 2025-11-18T21:55:11.632631Z*
