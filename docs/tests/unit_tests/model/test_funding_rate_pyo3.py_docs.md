# Documentation: test_funding_rate_pyo3.py
...
**Imports**: `decimal`, `nautilus_trader.core.nautilus_pyo3`, `pickle`
...
```bash
# For Python
pytest tests/unit_tests/model/test_funding_rate_pyo3.py
...
---
*Generated on 2025-11-18T21:55:11.613567Z*
