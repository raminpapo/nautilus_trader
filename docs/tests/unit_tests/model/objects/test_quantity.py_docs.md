# Documentation: `tests/unit_tests/model/objects/test_quantity.py`
**Generated:** 2025-11-15T19:40:09.298601Z
**File Size:** 25885 bytes
**Extension:** .py
**Type:** text
...
- **Path:** `tests/unit_tests/model/objects/test_quantity.py`
- **Size:** 25,885 bytes
- **Lines:** 809
- **Extension:** `.py`
- **Type:** text
...
This file is located at `tests/unit_tests/model/objects/test_quantity.py` within the repository.

**Classes defined:** TestQuantity

**Functions defined:** test_instantiate_with_nan_raises_value_error, test_instantiate_with_none_value_raises_type_error, test_instantiate_with_negative_precision_raises_overflow_error, test_instantiate_with_precision_over_maximum_raises_value_error, test_instantiate_with_value_exceeding_limit_raises_value_error, test_instantiate_base_decimal_from_int, test_instantiate_base_decimal_from_float, test_instantiate_base_decimal_from_decimal, test_instantiate_base_decimal_from_str, test_round_with_various_digits_returns_expected_decimal and 37 more
...
#### `test_instantiate_with_precision_over_maximum_raises_value_error(self)`


#### `test_instantiate_with_value_exceeding_limit_raises_value_error(self)`
...
#### `test_calling_new_returns_an_expected_zero_quantity(self)`


#### `test_from_raw_returns_expected_quantity(self)`


#### `test_zero_returns_zero_quantity(self)`


#### `test_from_int_returns_expected_value(self)`


#### `test_from_str_returns_expected_value(self)`
...
#### `test_from_str_with_negative_value_raises_value_error(self)`
...
#### `test_from_str_boundary_values(self)`


#### `test_str_and_to_str(self, value, expected)`
...
```python
from tests.unit_tests.model.objects.test_quantity import TestQuantity
```
