# Documentation: test_money_pyo3.py
...
**Classs**: `TestMoney`
**Imports**: `math`, `nautilus_trader.core.nautilus_pyo3`, `nautilus_trader.model`, `nautilus_trader.model.objects`, `pickle`, `pytest`, `typing`
...
```bash
# For Python
pytest tests/unit_tests/model/objects/test_money_pyo3.py
...
---
*Generated on 2025-11-18T21:55:11.558034Z*
