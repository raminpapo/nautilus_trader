# Documentation: `tests/unit_tests/model/objects/test_money.py`
**Generated:** 2025-11-15T19:40:09.287894Z
**File Size:** 15025 bytes
**Extension:** .py
**Type:** text
...
- **Path:** `tests/unit_tests/model/objects/test_money.py`
- **Size:** 15,025 bytes
- **Lines:** 456
- **Extension:** `.py`
- **Type:** text
...
This file is located at `tests/unit_tests/model/objects/test_money.py` within the repository.

**Classes defined:** TestMoney, TestAccountBalance, TestMarginBalance

**Functions defined:** test_instantiate_with_nan_raises_value_error, test_instantiate_with_none_currency_raises_type_error, test_instantiate_with_value_exceeding_positive_limit_raises_value_error, test_instantiate_with_value_exceeding_negative_limit_raises_value_error, test_instantiate_with_none_value_returns_money_with_zero_amount, test_instantiate_with_various_valid_inputs_returns_expected_money, test_pickling, test_as_double_returns_expected_result, test_initialized_with_many_decimals_rounds_to_currency_precision, test_equality_with_different_currencies_raises_value_error and 17 more
...
#### `test_instantiate_with_none_currency_raises_type_error(self)`
...
#### `test_instantiate_with_none_value_returns_money_with_zero_amount(self)`
...
#### `test_as_double_returns_expected_result(self)`


#### `test_initialized_with_many_decimals_rounds_to_currency_precision(self)`


#### `test_equality_with_different_currencies_raises_value_error(self)`
...
#### `test_from_str_when_malformed_raises_value_error(self)`


#### `test_from_raw_given_valid_values_returns_expected_result(
        self,
        value: str,
        currency: Currency,
        expected: Money,
...
#### `test_from_str_given_valid_strings_returns_expected_result(
        self,
        value: str,
        expected: Money,
    )`
...
#### `test_from_str_comprehensive(self, value, expected_amount, expected_currency)`


#### `test_from_str_invalid_input_raises_value_error(self, invalid_input)`


#### `test_from_str_precision_handling(self)`
...
#### `test_instantiate_str_repr(self)`


#### `test_equality(self)`


#### `test_instantiate_str_repr_with_instrument_id(self)`


#### `test_instantiate_str_repr_without_instrument_id(self)`
...
```python
from tests.unit_tests.model.objects.test_money import TestMoney
```
