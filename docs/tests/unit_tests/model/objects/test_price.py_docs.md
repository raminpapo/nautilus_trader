# Documentation: `tests/unit_tests/model/objects/test_price.py`
**Generated:** 2025-11-15T19:40:09.292782Z
**File Size:** 26767 bytes
**Extension:** .py
**Type:** text
...
- **Path:** `tests/unit_tests/model/objects/test_price.py`
- **Size:** 26,767 bytes
- **Lines:** 847
- **Extension:** `.py`
- **Type:** text
...
This file is located at `tests/unit_tests/model/objects/test_price.py` within the repository.

**Classes defined:** TestPrice

**Functions defined:** test_instantiate_with_nan_raises_value_error, test_instantiate_with_none_value_raises_type_error, test_instantiate_with_negative_precision_raises_overflow_error, test_instantiate_with_precision_over_maximum_raises_overflow_error, test_instantiate_with_value_exceeding_positive_limit_raises_value_error, test_instantiate_with_value_exceeding_negative_limit_raises_value_error, test_instantiate_base_decimal_from_int, test_instantiate_base_decimal_from_float, test_instantiate_base_decimal_from_decimal, test_instantiate_base_decimal_from_str and 38 more
...
#### `test_instantiate_with_nan_raises_value_error(self)`


#### `test_instantiate_with_none_value_raises_type_error(self)`


#### `test_instantiate_with_negative_precision_raises_overflow_error(self)`


#### `test_instantiate_with_precision_over_maximum_raises_overflow_error(self)`


#### `test_instantiate_with_value_exceeding_positive_limit_raises_value_error(self)`


#### `test_instantiate_with_value_exceeding_negative_limit_raises_value_error(self)`


#### `test_instantiate_base_decimal_from_int(self)`


#### `test_instantiate_base_decimal_from_float(self)`


#### `test_instantiate_base_decimal_from_decimal(self)`


#### `test_instantiate_base_decimal_from_str(self)`


#### `test_round_with_various_digits_returns_expected_decimal(self, value, precision, expected)`


#### `test_abs_with_various_values_returns_expected_decimal(self, value, expected)`


#### `test_pos_with_various_values_returns_expected_decimal(self, value, expected)`


#### `test_neg_with_various_values_returns_expected_decimal(self, value, expected)`


#### `test_instantiate_with_various_valid_inputs_returns_expected_decimal(self, value, expected)`


#### `test_instantiate_with_various_precisions_returns_expected_decimal(
        self,
        value,
        precision,
        expected,
...
#### `test_equality_with_various_values_returns_expected_result(self, value1, value2, expected)`


#### `test_equality_with_various_int_returns_expected_result(self, value1, value2, expected)`


#### `test_equality_with_various_decimals_returns_expected_result(self, value1, value2, expected)`


#### `test_comparisons_with_various_values_returns_expected_result(
        self,
        value1,
        value2,
        expected1,
...
#### `test_addition_with_various_types_returns_expected_result(
        self,
        value1,
        value2,
        expected_type,
...
#### `test_subtraction_with_various_types_returns_expected_result(
        self,
        value1,
        value2,
        expected_type,
...
#### `test_multiplication_with_various_types_returns_expected_result(
        self,
        value1,
        value2,
        expected_type,
...
#### `test_division_with_various_types_returns_expected_result(
        self,
        value1,
        value2,
        expected_type,
...
#### `test_floor_division_with_various_types_returns_expected_result(
        self,
        value1,
        value2,
        expected_type,
...
#### `test_mod_with_various_types_returns_expected_result(
        self,
        value1,
        value2,
        expected_type,
...
#### `test_max_with_various_types_returns_expected_result(
        self,
        value1,
        value2,
        expected,
...
#### `test_min_with_various_types_returns_expected_result(
        self,
        value1,
        value2,
        expected,
...
#### `test_int(self, value, expected)`


#### `test_hash(self)`


#### `test_str_with_various_values_returns_expected_string(
        self,
        value,
        precision,
        expected,
...
#### `test_as_decimal_with_various_values_returns_expected_value(
        self,
        value,
        precision,
        expected,
...
#### `test_as_double_with_various_values_returns_expected_value(self, value, expected)`


#### `test_calling_new_returns_an_expected_zero_price(self)`


#### `test_from_raw_returns_expected_price(self)`


#### `test_equality(self)`


#### `test_from_int_returns_expected_value(self)`


#### `test_from_str_returns_expected_value(self, value, string, precision)`


#### `test_from_str_comprehensive(self, value, expected_str, expected_precision)`


#### `test_from_str_invalid_input_raises_value_error(self, invalid_input)`


#### `test_from_str_with_precision_exceeding_max_raises_value_error(self)`


#### `test_from_str_precision_preservation(self)`


#### `test_from_str_rounding_behavior(self, input_val, expected)`


#### `test_from_str_boundary_values(self, input_val, expected_str)`


#### `test_from_str_zero_values(self, input_val, expected_str)`


#### `test_str_repr(self)`


#### `test_pickle_dumps_and_loads(self)`
...
```python
from tests.unit_tests.model.objects.test_price import TestPrice
```
