# Documentation: `tests/unit_tests/model/objects/test_quantity_pyo3.py`
**Generated:** 2025-11-15T19:40:09.301607Z
...
- **Path:** `tests/unit_tests/model/objects/test_quantity_pyo3.py`
- **Size:** 24,033 bytes
- **Lines:** 901
- **Extension:** `.py`
- **Type:** text
...
#### `test_str_and_to_formatted_str(self, value, expected)`
...
```python
from tests.unit_tests.model.objects.test_quantity_pyo3 import TestQuantity
```
