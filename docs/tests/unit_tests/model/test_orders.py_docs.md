# Documentation: `tests/unit_tests/model/test_orders.py`
**Generated:** 2025-11-15T19:40:09.366980Z
**File Size:** 97252 bytes
**Extension:** .py
**Type:** text
...
- **Path:** `tests/unit_tests/model/test_orders.py`
- **Size:** 97,252 bytes
- **Lines:** 2,475
- **Extension:** `.py`
- **Type:** text
...
This file is located at `tests/unit_tests/model/test_orders.py` within the repository.

**Classes defined:** TestOrders

**Functions defined:** setup, test_opposite_side_given_invalid_value_raises_value_error, test_flatten_side_given_invalid_value_or_flat_raises_value_error, test_opposite_side_returns_expected_sides, test_closing_side_returns_expected_sides, test_would_reduce_only_with_various_values_returns_expected, test_market_order_with_quantity_zero_raises_value_error, test_market_order_with_invalid_tif_raises_value_error, test_stop_market_order_with_gtd_and_expiration_none_raises_type_error, test_stop_limit_buy_order_with_gtd_and_expiration_none_raises_type_error and 61 more
...
#### `test_opposite_side_given_invalid_value_raises_value_error(self)`


#### `test_flatten_side_given_invalid_value_or_flat_raises_value_error(self)`


#### `test_opposite_side_returns_expected_sides(self, side, expected)`


#### `test_closing_side_returns_expected_sides(self, side, expected)`


#### `test_would_reduce_only_with_various_values_returns_expected(
        self,
        order_side,
        position_side,
        position_qty,
...
#### `test_market_order_with_quantity_zero_raises_value_error(self)`


#### `test_market_order_with_invalid_tif_raises_value_error(self)`


#### `test_stop_market_order_with_gtd_and_expiration_none_raises_type_error(self)`


#### `test_stop_limit_buy_order_with_gtd_and_expiration_none_raises_type_error(self)`


#### `test_market_to_limit_order_with_invalid_tif_raises_value_error(self)`


#### `test_overfill_limit_buy_order_raises_value_error(self)`


#### `test_reset_order_factory(self)`


#### `test_initialize_buy_market_order(self)`


#### `test_initialize_sell_market_order(self)`


#### `test_order_equality(self)`


#### `test_order_hash_str_and_repr(self)`


#### `test_market_order_to_dict(self)`


#### `test_initialize_limit_order(self)`


#### `test_limit_order_to_dict(self)`


#### `test_initialize_limit_order_with_expiration(self)`


#### `test_initialize_stop_market_order(self)`


#### `test_stop_market_order_to_dict(self)`


#### `test_initialize_stop_limit_order(self)`


#### `test_stop_limit_order_to_dict(self)`


#### `test_initialize_market_to_limit_order(self)`


#### `test_market_to_limit_order_to_dict(self)`


#### `test_initialize_market_if_touched_order(self)`


#### `test_market_if_touched_order_to_dict(self)`


#### `test_initialize_limit_if_touched_order(self)`


#### `test_limit_if_touched_order_to_dict(self)`


#### `test_initialize_trailing_stop_market_order(self)`


#### `test_initialize_trailing_stop_market_order_with_no_initial_trigger(self)`


#### `test_initialize_trailing_stop_market_order_with_activation_price(self)`


#### `test_initialize_trailing_stop_market_order_with_activation_price_and_trigger(self)`


#### `test_trailing_stop_market_order_to_dict(self)`


#### `test_trailing_stop_market_order_with_no_initial_trigger_to_dict(self)`


#### `test_initialize_trailing_stop_limit_order(self)`


#### `test_initialize_trailing_stop_limit_order_with_no_initial_prices(self)`


#### `test_initialize_trailing_stop_limit_order_with_activation_price(self)`


#### `test_initialize_trailing_stop_market_order_with_activation_price_and_no_initial_price(self)`


#### `test_trailing_stop_limit_order_to_dict(self)`


#### `test_trailing_stop_limit_order_with_no_initial_prices_to_dict(self)`


#### `test_order_list_equality(self)`


#### `test_bracket_market_entry_order_list(self)`


#### `test_bracket_limit_entry_order_list(self)`


#### `test_bracket_limit_if_touched_entry_stop_limit_tp_order_list(self)`


#### `test_bracket_stop_limit_entry_stop_limit_tp_order_list(self)`


#### `test_order_list_str_and_repr(self)`


#### `test_apply_order_denied_event(self)`
