# Documentation: `tests/unit_tests/model/test_currency_pyo3.py`
**Generated:** 2025-11-15T19:40:09.322555Z
**File Size:** 10875 bytes
**Extension:** .py
**Type:** text
...
- **Path:** `tests/unit_tests/model/test_currency_pyo3.py`
- **Size:** 10,875 bytes
- **Lines:** 347
- **Extension:** `.py`
- **Type:** text
...
This file is located at `tests/unit_tests/model/test_currency_pyo3.py` within the repository.

**Classes defined:** TestCurrency

**Functions defined:** test_currency_with_negative_precision_raises_overflow_error, test_currency_with_precision_over_maximum_raises_value_error, test_currency_properties, test_currency_equality, test_currency_hash, test_str_repr, test_currency_pickle, test_register_adds_currency_to_internal_currency_map, test_register_when_overwrite_false_does_not_overwrite_internal_currency_map, test_from_internal_map_when_unknown and 12 more
...
#### `test_currency_with_negative_precision_raises_overflow_error(self)`


#### `test_currency_with_precision_over_maximum_raises_value_error(self)`


#### `test_currency_properties(self)`


#### `test_currency_equality(self)`


#### `test_currency_hash(self)`


#### `test_str_repr(self)`


#### `test_currency_pickle(self)`


#### `test_register_adds_currency_to_internal_currency_map(self)`


#### `test_register_when_overwrite_false_does_not_overwrite_internal_currency_map(self)`


#### `test_from_internal_map_when_unknown(self)`


#### `test_from_internal_map_when_exists(self)`


#### `test_from_str_in_strict_mode_given_unknown_code_raises_value_error(self)`


#### `test_from_str_not_in_strict_mode_returns_crypto(self)`


#### `test_from_str(self, string, expected)`


#### `test_is_fiat(self, string, expected)`


#### `test_is_crypto(self, string, expected)`


#### `test_is_commodity_backed(self, string, expected)`


#### `test_register_currency_helper_makes_available_to_both()`


#### `test_cython_from_str_only_registers_in_cython_map()`


#### `test_pyo3_from_str_only_registers_in_pyo3_map()`


#### `test_pyo3_register_makes_available_to_pyo3_only()`


#### `test_cython_register_makes_available_to_cython_only()`
...
```python
from tests.unit_tests.model.test_currency_pyo3 import TestCurrency
```
