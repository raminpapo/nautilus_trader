# Documentation: test_currency_pyo3.py
...
### Functions
- **`test_register_currency_helper_makes_available_to_both()`**: Function defined in this file
- **`test_cython_from_str_only_registers_in_cython_map()`**: Function defined in this file
- **`test_pyo3_from_str_only_registers_in_pyo3_map()`**: Function defined in this file
- **`test_pyo3_register_makes_available_to_pyo3_only()`**: Function defined in this file
- **`test_cython_register_makes_available_to_cython_only()`**: Function defined in this file
...
**Classs**: `TestCurrency`
**Functions**: `test_cython_from_str_only_registers_in_cython_map`, `test_cython_register_makes_available_to_cython_only`, `test_pyo3_from_str_only_registers_in_pyo3_map`, `test_pyo3_register_makes_available_to_pyo3_only`, `test_register_currency_helper_makes_available_to_both`
**Imports**: `nautilus_trader.core.nautilus_pyo3`, `nautilus_trader.model.currencies`, `nautilus_trader.model.objects`, `pickle`, `pytest`
...
```bash
# For Python
pytest tests/unit_tests/model/test_currency_pyo3.py
...
---
*Generated on 2025-11-18T21:55:11.595154Z*
