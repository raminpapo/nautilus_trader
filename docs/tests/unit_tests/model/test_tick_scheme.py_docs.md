# Documentation: `tests/unit_tests/model/test_tick_scheme.py`
**Generated:** 2025-11-15T19:40:09.402431Z
**File Size:** 19507 bytes
**Extension:** .py
**Type:** text
...
This file is located at `tests/unit_tests/model/test_tick_scheme.py` within the repository.

**Functions defined:** test_round_down, test_round_up, test_fixed_tick_scheme_attrs, test_fixed_tick_scheme_next_ask_price, test_fixed_tick_scheme_next_bid_price, test_topix100_tick_scheme_attrs, test_topix100_tick_scheme_next_ask_price, test_topix100_tick_scheme_next_bid_price, test_bitmex_spot_tick_scheme_next_ask_price, test_bitmex_spot_tick_scheme_next_bid_price and 33 more
...
#### `test_round_down(value, precision, expected)`


#### `test_round_up(value, precision, expected)`


#### `test_fixed_tick_scheme_attrs()`


#### `test_fixed_tick_scheme_next_ask_price(value, expected)`


#### `test_fixed_tick_scheme_next_bid_price(value, expected)`


#### `test_topix100_tick_scheme_attrs()`


#### `test_topix100_tick_scheme_next_ask_price(value, n, expected)`


#### `test_topix100_tick_scheme_next_bid_price(value, n, expected)`


#### `test_bitmex_spot_tick_scheme_next_ask_price(value, n, expected)`


#### `test_bitmex_spot_tick_scheme_next_bid_price(value, n, expected)`


#### `test_fixed_tick_scheme_negative_n_raises_error()`


#### `test_fixed_tick_scheme_out_of_bounds_returns_none()`


#### `test_fixed_tick_scheme_max_price_comparison_bug()`


#### `test_fixed_tick_scheme_precision_zero()`


#### `test_fixed_tick_scheme_bounds_enforced_after_rounding()`


#### `test_round_up_down_with_small_base()`
...
#### `test_tiered_tick_scheme_minimum_tick_bid_price()`


#### `test_tiered_tick_scheme_boundary_tick_equality()`


#### `test_tiered_tick_scheme_out_of_bounds_returns_none()`


#### `test_tiered_tick_scheme_negative_n_raises_error()`


#### `test_round_extreme_magnitudes()`


#### `test_fixed_tick_scheme_extreme_magnitude()`


#### `test_fixed_tick_scheme_micro_tick_precision()`


#### `test_tiered_tick_scheme_tier_boundaries()`


#### `test_tiered_tick_scheme_multiple_tier_transitions()`


#### `test_fixed_tick_scheme_large_n_overflow()`


#### `test_tiered_tick_scheme_large_n_beyond_bounds()`


#### `test_fixed_tick_scheme_n_boundary_exact()`


#### `test_tiered_tick_scheme_invalid_negative_increment()`


#### `test_tiered_tick_scheme_invalid_zero_increment()`


#### `test_tiered_tick_scheme_invalid_increment_larger_than_range()`


#### `test_tiered_tick_scheme_invalid_start_equals_stop()`


#### `test_tiered_tick_scheme_invalid_start_greater_than_stop()`
...
#### `test_fixed_tick_scheme_infinity()`


#### `test_fixed_tick_scheme_nan()`


#### `test_fixed_tick_scheme_idempotent_on_grid()`


#### `test_fixed_tick_scheme_ask_bid_symmetry()`


#### `test_tiered_tick_scheme_consistency()`


#### `test_fixed_tick_scheme_deterministic()`
...
```python
from tests.unit_tests.model.test_tick_scheme import test_round_down
```
