# Documentation: test_tick_scheme.py

## File Metadata

- **Path**: `tests/unit_tests/model/test_tick_scheme.py`
- **Size**: 19,521 bytes
- **Lines**: 672
- **Language**: Python
...
This file is part of the NautilusTrader repository. It defines 43 function(s).

## Detailed Walkthrough

### Functions
- **`test_round_down()`**: Function defined in this file
- **`test_round_up()`**: Function defined in this file
- **`test_fixed_tick_scheme_attrs()`**: Function defined in this file
- **`test_fixed_tick_scheme_next_ask_price()`**: Function defined in this file
- **`test_fixed_tick_scheme_next_bid_price()`**: Function defined in this file
- **`test_topix100_tick_scheme_attrs()`**: Function defined in this file
- **`test_topix100_tick_scheme_next_ask_price()`**: Function defined in this file
- **`test_topix100_tick_scheme_next_bid_price()`**: Function defined in this file
- **`test_bitmex_spot_tick_scheme_next_ask_price()`**: Function defined in this file
- **`test_bitmex_spot_tick_scheme_next_bid_price()`**: Function defined in this file
- **`test_fixed_tick_scheme_negative_n_raises_error()`**: Function defined in this file
- **`test_fixed_tick_scheme_out_of_bounds_returns_none()`**: Function defined in this file
- **`test_fixed_tick_scheme_max_price_comparison_bug()`**: Function defined in this file
- **`test_fixed_tick_scheme_precision_zero()`**: Function defined in this file
- **`test_fixed_tick_scheme_bounds_enforced_after_rounding()`**: Function defined in this file
- **`test_round_up_down_with_small_base()`**: Function defined in this file
- **`test_round_does_not_accept_values_half_tick_off()`**: Function defined in this file
- **`test_round_base_validation()`**: Function defined in this file
- **`test_tiered_tick_scheme_minimum_tick_bid_price()`**: Function defined in this file
- **`test_tiered_tick_scheme_boundary_tick_equality()`**: Function defined in this file
...
**Functions**: `test_bitmex_spot_tick_scheme_next_ask_price`, `test_bitmex_spot_tick_scheme_next_bid_price`, `test_fixed_tick_scheme_ask_bid_symmetry`, `test_fixed_tick_scheme_attrs`, `test_fixed_tick_scheme_bounds_enforced_after_rounding`, `test_fixed_tick_scheme_deterministic`, `test_fixed_tick_scheme_extreme_magnitude`, `test_fixed_tick_scheme_idempotent_on_grid`, `test_fixed_tick_scheme_infinity`, `test_fixed_tick_scheme_large_n_overflow`, `test_fixed_tick_scheme_max_price_comparison_bug`, `test_fixed_tick_scheme_micro_tick_precision`, `test_fixed_tick_scheme_n_boundary_exact`, `test_fixed_tick_scheme_nan`, `test_fixed_tick_scheme_negative_n_raises_error`, `test_fixed_tick_scheme_next_ask_price`, `test_fixed_tick_scheme_next_bid_price`, `test_fixed_tick_scheme_out_of_bounds_returns_none`, `test_fixed_tick_scheme_precision_zero`, `test_round_base_validation`, `test_round_does_not_accept_values_half_tick_off`, `test_round_down`, `test_round_extreme_magnitudes`, `test_round_infinity`, `test_round_nan`, `test_round_up`, `test_round_up_down_with_small_base`, `test_tiered_tick_scheme_boundary_tick_equality`, `test_tiered_tick_scheme_consistency`, `test_tiered_tick_scheme_invalid_increment_larger_than_range` *(+13 more)*
**Imports**: `math`, `nautilus_trader.model.objects`, `nautilus_trader.model.tick_scheme`, `nautilus_trader.model.tick_scheme.base`, `nautilus_trader.test_kit.providers`, `pytest`
...
```bash
# For Python
pytest tests/unit_tests/model/test_tick_scheme.py
...
---
*Generated on 2025-11-18T21:55:11.687635Z*
