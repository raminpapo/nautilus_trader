# Documentation: `tests/unit_tests/model/test_events.py`
**Generated:** 2025-11-15T19:40:09.333490Z
**File Size:** 43874 bytes
**Extension:** .py
**Type:** text
...
- **Path:** `tests/unit_tests/model/test_events.py`
- **Size:** 43,874 bytes
- **Lines:** 974
- **Extension:** `.py`
- **Type:** text
...
This file is located at `tests/unit_tests/model/test_events.py` within the repository.

**Classes defined:** TestModelEvents, TestPositionEvents

**Functions defined:** test_account_state_event_to_from_dict_and_str_repr, test_account_state_with_margin_event_to_from_dict_and_str_repr, test_order_initialized_event_to_from_dict_and_str_repr, test_order_denied_event_to_from_dict_and_str_repr, test_order_emulated_event_to_from_dict_and_str_repr, test_order_released_event_to_from_dict_and_str_repr, test_order_submitted_event_to_from_dict_and_str_repr, test_order_accepted_event_to_from_dict_and_str_repr, test_order_rejected_event_to_from_dict_and_str_repr, test_order_rejected_with_due_post_only and 21 more
...
#### `test_account_state_event_to_from_dict_and_str_repr(self)`


#### `test_account_state_with_margin_event_to_from_dict_and_str_repr(self)`


#### `test_order_initialized_event_to_from_dict_and_str_repr(self)`


#### `test_order_denied_event_to_from_dict_and_str_repr(self)`


#### `test_order_emulated_event_to_from_dict_and_str_repr(self)`


#### `test_order_released_event_to_from_dict_and_str_repr(self)`


#### `test_order_submitted_event_to_from_dict_and_str_repr(self)`


#### `test_order_accepted_event_to_from_dict_and_str_repr(self)`


#### `test_order_rejected_event_to_from_dict_and_str_repr(self)`


#### `test_order_rejected_with_due_post_only(self)`


#### `test_order_rejected_default_due_post_only(self)`


#### `test_order_canceled_event_to_from_dict_and_str_repr(self)`


#### `test_order_expired_event_to_from_dict_and_str_repr(self)`


#### `test_order_triggered_event_to_from_dict_and_str_repr(self)`


#### `test_order_pending_update_event_to_from_dict_and_str_repr(self)`


#### `test_order_pending_update_event_with_none_venue_order_id_to_from_dict_and_str_repr(self)`


#### `test_order_pending_cancel_event_to_from_dict_and_str_repr(self)`


#### `test_order_pending_cancel_event_with_none_venue_order_id_to_from_dict_and_str_repr(self)`


#### `test_order_modify_rejected_event_to_from_dict_and_str_repr(self)`


#### `test_order_modify_rejected_event_with_none_venue_order_id_to_from_dict_and_str_repr(self)`


#### `test_order_cancel_rejected_event_to_from_dict_and_str_repr(self)`


#### `test_order_cancel_rejected_with_none_venue_order_id_event_to_from_dict_and_str_repr(self)`
...
#### `test_account_state_copies_balance_objects(self)`


#### `setup(self)`


#### `test_position_opened_event_to_from_dict_and_str_repr(self)`


#### `test_position_changed_event_to_from_dict_and_str_repr(self)`


#### `test_position_closed_event_to_from_dict_and_str_repr(self)`


#### `test_position_adjusted_commission_to_from_dict(self)`


#### `test_position_adjusted_funding_to_from_dict(self)`
...
```python
from tests.unit_tests.model.test_events import TestModelEvents
```
