# Documentation: test_events_pyo3.py

## File Metadata

- **Path**: `tests/unit_tests/model/test_events_pyo3.py`
- **Size**: 15,211 bytes
- **Lines**: 324
- **Language**: Python
...
### Functions
- **`test_order_denied()`**: Function defined in this file
- **`test_order_filled()`**: Function defined in this file
- **`test_order_initialized()`**: Function defined in this file
- **`test_order_rejected()`**: Function defined in this file
- **`test_order_triggered()`**: Function defined in this file
- **`test_order_submitted()`**: Function defined in this file
- **`test_order_emulated()`**: Function defined in this file
- **`test_order_released()`**: Function defined in this file
- **`test_order_updated()`**: Function defined in this file
- **`test_order_pending_update()`**: Function defined in this file
- **`test_order_pending_cancel()`**: Function defined in this file
- **`test_order_modified_rejected()`**: Function defined in this file
- **`test_order_accepted()`**: Function defined in this file
- **`test_order_cancel_rejected()`**: Function defined in this file
- **`test_order_canceled()`**: Function defined in this file
- **`test_order_expired()`**: Function defined in this file
...
**Functions**: `test_order_accepted`, `test_order_cancel_rejected`, `test_order_canceled`, `test_order_denied`, `test_order_emulated`, `test_order_expired`, `test_order_filled`, `test_order_initialized`, `test_order_modified_rejected`, `test_order_pending_cancel`, `test_order_pending_update`, `test_order_rejected`, `test_order_released`, `test_order_submitted`, `test_order_triggered`, `test_order_updated`
**Imports**: `nautilus_trader.core.nautilus_pyo3`, `nautilus_trader.test_kit.rust.events_pyo3`
...
```bash
# For Python
pytest tests/unit_tests/model/test_events_pyo3.py
...
---
*Generated on 2025-11-18T21:55:11.609606Z*
