# Documentation: `tests/unit_tests/model/test_events_pyo3.py`
**Generated:** 2025-11-15T19:40:09.335944Z
**File Size:** 15260 bytes
**Extension:** .py
**Type:** text
...
This file is located at `tests/unit_tests/model/test_events_pyo3.py` within the repository.

**Functions defined:** test_order_denied, test_order_filled, test_order_initialized, test_order_rejected, test_order_triggered, test_order_submitted, test_order_emulated, test_order_released, test_order_updated, test_order_pending_update and 6 more
...
#### `test_order_pending_update()`


#### `test_order_pending_cancel()`
...
```python
from tests.unit_tests.model.test_events_pyo3 import test_order_denied
```
