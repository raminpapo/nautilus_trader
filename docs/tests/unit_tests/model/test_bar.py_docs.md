...
### Classes
- **`TestBarSpecification`**: Class defined in this file
- **`TestBarType`**: Class defined in this file
- **`TestBar`**: Class defined in this file
...
**Classs**: `TestBar`, `TestBarSpecification`, `TestBarType`
**Imports**: `nautilus_trader.core`, `nautilus_trader.model`, `nautilus_trader.model.data`, `nautilus_trader.model.enums`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.objects`, `nautilus_trader.test_kit.rust.data_pyo3`, `nautilus_trader.test_kit.stubs.data`, `nautilus_trader.test_kit.stubs.identifiers`, `pandas`, `pickle`, `pytest`
...
```bash
# For Python
pytest tests/unit_tests/model/test_bar.py
...
---
*Generated on 2025-11-18T21:55:11.584789Z*
