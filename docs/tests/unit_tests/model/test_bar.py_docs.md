# Documentation: `tests/unit_tests/model/test_bar.py`
**Generated:** 2025-11-15T19:40:09.312117Z
**File Size:** 35071 bytes
**Extension:** .py
**Type:** text
...
- **Path:** `tests/unit_tests/model/test_bar.py`
- **Size:** 35,071 bytes
- **Lines:** 999
- **Extension:** `.py`
- **Type:** text
...
This file is located at `tests/unit_tests/model/test_bar.py` within the repository.

**Classes defined:** TestBarSpecification, TestBarType, TestBar

**Functions defined:** test_bar_spec_equality, test_bar_spec_comparison, test_bar_spec_pickle, test_bar_spec_hash_str_and_repr, test_instantiate_given_invalid_step_raises_value_error, test_instantiate_given_correct_step_passes, test_from_str_given_various_invalid_strings_raises_value_error, test_from_str_given_various_valid_string_returns_expected_specification, test_aggregation_queries, test_get_interval_ns_and_timedelta_valid_aggregations and 29 more
...
#### `test_bar_spec_equality(self)`


#### `test_bar_spec_comparison(self)`


#### `test_bar_spec_pickle(self)`


#### `test_bar_spec_hash_str_and_repr(self)`


#### `test_instantiate_given_invalid_step_raises_value_error(
        self,
        bar_aggregation: BarAggregation,
        step: int,
        expected_msg: str,
...
#### `test_instantiate_given_correct_step_passes(self, step, aggregation)`


#### `test_from_str_given_various_invalid_strings_raises_value_error(self, value)`


#### `test_from_str_given_various_valid_string_returns_expected_specification(
        self,
        value,
        expected,
    )`
...
#### `test_get_interval_ns_and_timedelta_valid_aggregations(
        self,
        step: int,
        aggregation: BarAggregation,
        expected_timedelta: pd.Timedelta,
...
#### `test_get_interval_ns_and_timedelta_non_time_aggregations_raise_error(
        self,
        aggregation: BarAggregation,
    )`


#### `test_get_interval_ns_and_timedelta_month_year_proxy_values(
        self,
        step: int,
        aggregation: BarAggregation,
        expected_timedelta: pd.Timedelta,
...
#### `test_bar_type_equality(self)`


#### `test_bar_type_comparison(self)`


#### `test_bar_type_pickle(self)`


#### `test_bar_type_hash_str_and_repr(self)`


#### `test_bar_type_from_str_with_invalid_values(self, input: str, expected_err: str)`
...
#### `test_bar_type_from_str_with_utf8_symbol(self)`
...
#### `test_validation_when_high_below_open_raises_value_error(self)`


#### `test_validation_when_high_below_low_raises_value_error(self)`


#### `test_validation_when_high_below_close_raises_value_error(self)`


#### `test_validation_when_low_above_close_raises_value_error(self)`


#### `test_validation_when_low_above_open_raises_value_error(self)`


#### `test_equality(self)`


#### `test_hash_str_repr(self)`


#### `test_is_single_price(self)`


#### `test_to_dict(self)`


#### `test_from_raw_returns_expected_bar(self)`


#### `test_from_dict_returns_expected_bar(self)`
...
#### `test_pickle_bar(self)`


#### `test_bar_type_composite_parse_valid(self)`
...
```python
from tests.unit_tests.model.test_bar import TestBarSpecification
```
