# Documentation: `tests/unit_tests/model/test_enums.py`
**Generated:** 2025-11-15T19:40:09.329309Z
...
- **Path:** `tests/unit_tests/model/test_enums.py`
- **Size:** 35,353 bytes
- **Lines:** 1,079
- **Extension:** `.py`
- **Type:** text
...
This file is located at `tests/unit_tests/model/test_enums.py` within the repository.

**Classes defined:** TestAccountType, TestAggregationSource, TestAggressorSide, TestAssetClass, TestInstrumentClass, TestBarAggregation, TestBookAction, TestBookType, TestContingencyType, TestCurrencyType and 16 more

**Functions defined:** test_account_type_to_str, test_account_type_from_str, test_instantiate_from_string, test_aggregation_source_to_str, test_aggregation_source_from_str, test_aggressor_side_to_str, test_aggressor_side_from_str, test_asset_class_to_str, test_asset_class_from_str, test_instrument_class_to_str and 43 more
...
#### `test_account_type_to_str(self, enum, expected)`


#### `test_account_type_from_str(self, string, expected)`


#### `test_instantiate_from_string(self)`


#### `test_aggregation_source_to_str(self, enum, expected)`


#### `test_aggregation_source_from_str(self, string, expected)`


#### `test_aggressor_side_to_str(self, enum, expected)`


#### `test_aggressor_side_from_str(self, string, expected)`


#### `test_asset_class_to_str(self, enum, expected)`


#### `test_asset_class_from_str(self, string, expected)`


#### `test_instrument_class_to_str(self, enum, expected)`


#### `test_instrument_class_from_str(self, string, expected)`


#### `test_bar_aggregation_to_str(self, enum, expected)`


#### `test_bar_aggregation_from_str(self, string, expected)`


#### `test_book_action_to_str(self, enum, expected)`


#### `test_book_action_from_str(self, string, expected)`


#### `test_orderbook_level_to_str(self, enum, expected)`


#### `test_orderbook_level_from_str(self, string, expected)`


#### `test_contingency_type_to_str(self, enum, expected)`


#### `test_contingency_type_from_str(self, string, expected)`


#### `test_currency_type_to_str(self, enum, expected)`


#### `test_currency_type_from_str(self, string, expected)`


#### `test_option_kind_to_str(self, enum, expected)`


#### `test_option_kind_from_str(self, string, expected)`


#### `test_instrument_close_type_to_str(self, enum, expected)`


#### `test_instrument_close_type_from_str(self, string, expected)`


#### `test_liquidity_side_to_str(self, enum, expected)`


#### `test_liquidity_side_from_str(self, string, expected)`


#### `test_market_status_to_str(self, enum, expected)`


#### `test_market_status_from_str(self, string, expected)`


#### `test_market_status_action_to_str(self, enum, expected)`


#### `test_market_status_action_from_str(self, string, expected)`


#### `test_oms_type_to_str(self, enum, expected)`


#### `test_oms_type_from_str(self, string, expected)`


#### `test_order_side_to_str(self, enum, expected)`


#### `test_order_side_from_str(self, string, expected)`


#### `test_order_status_to_str(self, enum, expected)`


#### `test_order_status_from_str(self, string, expected)`


#### `test_order_type_to_str(self, enum, expected)`


#### `test_order_type_from_str(self, string, expected)`


#### `test_record_flag_to_str(self, enum, expected)`


#### `test_record_flag_from_str(self, string, expected)`


#### `test_position_side_to_str(self, enum, expected)`


#### `test_position_side_from_str(self, string, expected)`


#### `test_price_type_to_str(self, enum, expected)`


#### `test_price_type_from_str(self, string, expected)`


#### `test_time_in_force_to_str(self, enum, expected)`


#### `test_time_in_force_from_str(self, string, expected)`


#### `test_trading_state_to_str(self, enum, expected)`


#### `test_trading_state_from_str(self, string, expected)`


#### `test_trailing_offset_type_to_str(self, enum, expected)`
...
```python
from tests.unit_tests.model.test_enums import TestAccountType
```
