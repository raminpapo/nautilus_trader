# Documentation: test_funding_rate.py
...
### Classes
- **`TestFundingRateUpdate`**: Class defined in this file
...
**Classs**: `TestFundingRateUpdate`
**Imports**: `decimal`, `nautilus_trader.core`, `nautilus_trader.model.data`, `nautilus_trader.test_kit.providers`
...
```bash
# For Python
pytest tests/unit_tests/model/test_funding_rate.py
...
---
*Generated on 2025-11-18T21:55:11.611738Z*
