# Documentation: `tests/unit_tests/model/test_identifiers_pyo3.py`
**Generated:** 2025-11-15T19:40:09.344273Z
**File Size:** 7506 bytes
**Extension:** .py
**Type:** text
...
This file is located at `tests/unit_tests/model/test_identifiers_pyo3.py` within the repository.

**Functions defined:** test_trader_identifier, test_account_identifier, test_symbol_equality, test_symbol_is_composite, test_symbol_root, test_symbol_topic, test_symbol_str, test_symbol_repr, test_symbol_pickling, test_venue_equality and 11 more
...
```python
from tests.unit_tests.model.test_identifiers_pyo3 import test_trader_identifier
```
