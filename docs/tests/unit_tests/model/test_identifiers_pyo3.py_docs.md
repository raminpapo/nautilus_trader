# Documentation: test_identifiers_pyo3.py

## File Metadata

- **Path**: `tests/unit_tests/model/test_identifiers_pyo3.py`
- **Size**: 7,502 bytes
- **Lines**: 289
- **Language**: Python
...
- **`test_instrument_id_from_str_with_utf8_symbol()`**: Function defined in this file
- **`test_instrument_id_from_str_when_invalid()`**: Function defined in this file
...
**Functions**: `test_account_identifier`, `test_exec_algorithm_id`, `test_instrument_id_equality`, `test_instrument_id_from_str`, `test_instrument_id_from_str_when_invalid`, `test_instrument_id_from_str_with_utf8_symbol`, `test_instrument_id_pickling`, `test_instrument_id_repr`, `test_instrument_id_str`, `test_symbol_equality`, `test_symbol_is_composite`, `test_symbol_pickling`, `test_symbol_repr`, `test_symbol_root`, `test_symbol_str`, `test_symbol_topic`, `test_trader_identifier`, `test_venue_equality`, `test_venue_pickling`, `test_venue_repr`, `test_venue_str`
**Imports**: `nautilus_trader.core.nautilus_pyo3`, `pickle`, `pytest`
...
```bash
# For Python
pytest tests/unit_tests/model/test_identifiers_pyo3.py
...
---
*Generated on 2025-11-18T21:55:11.617672Z*
