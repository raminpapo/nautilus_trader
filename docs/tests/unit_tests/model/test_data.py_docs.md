...
### Classes
- **`TestDataType`**: Class defined in this file
...
**Classs**: `TestDataType`
**Imports**: `nautilus_trader.core.data`, `nautilus_trader.model.currencies`, `nautilus_trader.model.data`, `nautilus_trader.trading.filters`
...
```bash
# For Python
pytest tests/unit_tests/model/test_data.py
...
---
*Generated on 2025-11-18T21:55:11.598077Z*
