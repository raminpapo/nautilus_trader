# Documentation: `tests/unit_tests/model/test_data.py`
**Generated:** 2025-11-15T19:40:09.325471Z
...
- **Path:** `tests/unit_tests/model/test_data.py`
- **Size:** 5,891 bytes
- **Lines:** 155
- **Extension:** `.py`
- **Type:** text
...
This file is located at `tests/unit_tests/model/test_data.py` within the repository.

**Classes defined:** TestDataType

**Functions defined:** test_data_type_instantiation, test_data_type_instantiation_when_no_metadata, test_data_type_instantiation_with_multiple_metadata, test_data_type_equality_and_hash, test_data_type_comparison, test_data_type_as_key_in_dict, test_data_instantiation, test_equality_when_types_not_equal_returns_false, test_equality_when_types_equal_returns_true, test_equality_when_definitions_different_returns_false and 3 more
...
#### `test_data_type_instantiation(self)`


#### `test_data_type_instantiation_when_no_metadata(self)`


#### `test_data_type_instantiation_with_multiple_metadata(self)`


#### `test_data_type_equality_and_hash(self)`


#### `test_data_type_comparison(self)`


#### `test_data_type_as_key_in_dict(self)`


#### `test_data_instantiation(self)`


#### `test_equality_when_types_not_equal_returns_false(self)`


#### `test_equality_when_types_equal_returns_true(self)`


#### `test_equality_when_definitions_different_returns_false(self)`


#### `test_equality_when_definitions_equal_returns_false(self)`
...
```python
from tests.unit_tests.model.test_data import TestDataType
```
