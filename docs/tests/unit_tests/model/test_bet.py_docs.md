# Documentation: `tests/unit_tests/model/test_bet.py`
**Generated:** 2025-11-15T19:40:09.318588Z
**File Size:** 15032 bytes
**Extension:** .py
**Type:** text
...
This file is located at `tests/unit_tests/model/test_bet.py` within the repository.

**Functions defined:** test_bet_exposure, test_bet_profit_and_payoffs, test_hedging_functions, test_betposition_methods, dec, test_bet_creation, test_bet_exposure_back, test_bet_exposure_lay, test_bet_liability_back, test_bet_liability_lay and 34 more
...
#### `test_bet_profit_and_payoffs()`


#### `test_hedging_functions()`


#### `test_betposition_methods()`
...
```python
from tests.unit_tests.model.test_bet import test_bet_exposure
```
