# Documentation: test_bet.py

## File Metadata

- **Path**: `tests/unit_tests/model/test_bet.py`
- **Size**: 15,012 bytes
- **Lines**: 430
- **Language**: Python
...
### Functions
- **`test_bet_exposure()`**: Function defined in this file
- **`test_bet_profit_and_payoffs()`**: Function defined in this file
- **`test_hedging_functions()`**: Function defined in this file
- **`test_betposition_methods()`**: Function defined in this file
- **`dec()`**: Function defined in this file
- **`test_bet_creation()`**: Function defined in this file
- **`test_bet_exposure_back()`**: Function defined in this file
- **`test_bet_exposure_lay()`**: Function defined in this file
- **`test_bet_liability_back()`**: Function defined in this file
- **`test_bet_liability_lay()`**: Function defined in this file
- **`test_bet_profit_back()`**: Function defined in this file
- **`test_bet_profit_lay()`**: Function defined in this file
- **`test_outcome_win_payoff_back()`**: Function defined in this file
- **`test_outcome_win_payoff_lay()`**: Function defined in this file
- **`test_outcome_lose_payoff_back()`**: Function defined in this file
- **`test_outcome_lose_payoff_lay()`**: Function defined in this file
- **`test_hedging_stake_back()`**: Function defined in this file
- **`test_hedging_bet_lay()`**: Function defined in this file
- **`test_bet_position_initialization()`**: Function defined in this file
- **`test_bet_position_side_none()`**: Function defined in this file
...
**Functions**: `dec`, `test_bet_creation`, `test_bet_exposure`, `test_bet_exposure_back`, `test_bet_exposure_lay`, `test_bet_liability_back`, `test_bet_liability_lay`, `test_bet_position_back_and_lay`, `test_bet_position_initialization`, `test_bet_position_side_back`, `test_bet_position_side_lay`, `test_bet_position_side_none`, `test_bet_profit_and_payoffs`, `test_bet_profit_back`, `test_bet_profit_lay`, `test_betposition_methods`, `test_calc_bets_pnl_mixed_bets`, `test_calc_bets_pnl_multiple_bets`, `test_calc_bets_pnl_no_bets`, `test_calc_bets_pnl_single_back_bet`, `test_calc_bets_pnl_single_lay_bet`, `test_calc_bets_pnl_zero_outcome`, `test_flattening_bet_back_hack`, `test_flattening_bet_back_profit`, `test_flattening_bet_lay`, `test_hedging_bet_lay`, `test_hedging_functions`, `test_hedging_stake_back`, `test_inverse_probability_to_bet`, `test_inverse_probability_to_bet_example2` *(+14 more)*
...
```bash
# For Python
pytest tests/unit_tests/model/test_bet.py
...
---
*Generated on 2025-11-18T21:55:11.591111Z*
