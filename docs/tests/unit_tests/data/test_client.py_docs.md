# Documentation: `tests/unit_tests/data/test_client.py`
**Generated:** 2025-11-15T19:40:09.105425Z
**File Size:** 9683 bytes
**Extension:** .py
**Type:** text
...
- **Path:** `tests/unit_tests/data/test_client.py`
- **Size:** 9,683 bytes
- **Lines:** 328
- **Extension:** `.py`
- **Type:** text
...
This file is located at `tests/unit_tests/data/test_client.py` within the repository.

**Classes defined:** TestDataClient, TestMarketDataClient

**Functions defined:** setup, test_subscribe_when_not_implemented_logs_error, test_unsubscribe_when_not_implemented_logs_error, test_request_when_not_implemented_logs_error, test_handle_data_sends_to_data_engine, test_handle_data_response_sends_to_data_engine, setup, test_handle_instrument_sends_to_data_engine, test_handle_order_book_snapshot_sends_to_data_engine, test_handle_order_book_operations_sends_to_data_engine and 7 more
...
#### `test_subscribe_when_not_implemented_logs_error(self)`


#### `test_unsubscribe_when_not_implemented_logs_error(self)`


#### `test_request_when_not_implemented_logs_error(self)`


#### `test_handle_data_sends_to_data_engine(self)`


#### `test_handle_data_response_sends_to_data_engine(self)`


#### `setup(self)`


#### `test_handle_instrument_sends_to_data_engine(self)`


#### `test_handle_order_book_snapshot_sends_to_data_engine(self)`


#### `test_handle_order_book_operations_sends_to_data_engine(self)`


#### `test_handle_quote_tick_sends_to_data_engine(self)`


#### `test_handle_trade_tick_sends_to_data_engine(self)`


#### `test_handle_bar_sends_to_data_engine(self)`


#### `test_handle_quote_ticks_sends_to_data_engine(self)`


#### `test_handle_trade_ticks_sends_to_data_engine(self)`


#### `test_handle_bars_sends_to_data_engine(self)`


#### `test_handle_order_book_depths_sends_to_data_engine(self)`
...
```python
from tests.unit_tests.data.test_client import TestDataClient
```
