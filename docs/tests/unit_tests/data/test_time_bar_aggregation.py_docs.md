# Documentation: test_time_bar_aggregation.py

## File Metadata

- **Path**: `tests/unit_tests/data/test_time_bar_aggregation.py`
- **Size**: 18,628 bytes
- **Lines**: 504
- **Language**: Python
...
### Functions
- **`test_time_bar_aggregation()`**: Function defined in this file
- **`test_year_bar_aggregation()`**: Function defined in this file
- **`test_month_bar_aggregation()`**: Function defined in this file

### Classes
- **`BarAggregationStrategy`**: Class defined in this file
- **`YearBarAggregationStrategy`**: Class defined in this file
- **`MonthBarAggregationStrategy`**: Class defined in this file
...
**Classs**: `BarAggregationStrategy`, `MonthBarAggregationStrategy`, `YearBarAggregationStrategy`
**Functions**: `test_month_bar_aggregation`, `test_time_bar_aggregation`, `test_year_bar_aggregation`
**Imports**: `decimal`, `nautilus_trader.backtest.engine`, `nautilus_trader.config`, `nautilus_trader.core.datetime`, `nautilus_trader.core.nautilus_pyo3`, `nautilus_trader.model.currencies`, `nautilus_trader.model.data`, `nautilus_trader.model.enums`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.objects`, `nautilus_trader.test_kit.providers`, `nautilus_trader.trading.strategy`, `pandas`
...
```bash
# For Python
pytest tests/unit_tests/data/test_time_bar_aggregation.py
...
---
*Generated on 2025-11-18T21:55:11.358220Z*
