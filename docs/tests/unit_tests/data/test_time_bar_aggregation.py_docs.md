# Documentation: `tests/unit_tests/data/test_time_bar_aggregation.py`
**Generated:** 2025-11-15T19:40:09.126472Z
...
This file is located at `tests/unit_tests/data/test_time_bar_aggregation.py` within the repository.

**Classes defined:** BarAggregationStrategy, YearBarAggregationStrategy, MonthBarAggregationStrategy

**Functions defined:** __init__, on_start, on_bar, test_time_bar_aggregation, __init__, on_start, on_bar, test_year_bar_aggregation, __init__, on_start and 2 more
...
#### `BarAggregationStrategy`

**Inherits from:** Strategy


#### `YearBarAggregationStrategy`

**Inherits from:** Strategy


#### `MonthBarAggregationStrategy`
...
#### `__init__(self, bar_type_1min_external: BarType, bar_type_5min_composite_internal: BarType)`
...
#### `test_time_bar_aggregation()`


#### `__init__(self, bar_type_day_external: BarType, bar_type_year_composite_internal: BarType)`
...
#### `test_year_bar_aggregation()`


#### `__init__(self, bar_type_day_external: BarType, bar_type_month_composite_internal: BarType)`
...
```python
from tests.unit_tests.data.test_time_bar_aggregation import BarAggregationStrategy
```
