# Documentation: test_aggregation.py
...
### Classes
- **`TestBarBuilder`**: Class defined in this file
- **`TestTickBarAggregator`**: Class defined in this file
- **`TestVolumeBarAggregator`**: Class defined in this file
- **`TestTestValueBarAggregator`**: Class defined in this file
- **`TestRenkoBarAggregator`**: Class defined in this file
- **`TestTimeBarAggregator`**: Class defined in this file
- **`TestSpreadQuoteAggregator`**: Class defined in this file
- **`TestTimeBarAggregatorHistoricalMode`**: Class defined in this file
...
**Classs**: `TestBarBuilder`, `TestRenkoBarAggregator`, `TestSpreadQuoteAggregator`, `TestTestValueBarAggregator`, `TestTickBarAggregator`, `TestTimeBarAggregator`, `TestTimeBarAggregatorHistoricalMode`, `TestVolumeBarAggregator`
**Imports**: `datetime`, `decimal`, `nautilus_trader`, `nautilus_trader.backtest.models.aggregator`, `nautilus_trader.cache.cache`, `nautilus_trader.common.component`, `nautilus_trader.core.datetime`, `nautilus_trader.data.aggregation`, `nautilus_trader.model.data`, `nautilus_trader.model.enums`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.instruments.futures_contract`, `nautilus_trader.model.instruments.option_contract`, `nautilus_trader.model.instruments.option_spread`, `nautilus_trader.model.objects`, `nautilus_trader.model.tick_scheme`, `nautilus_trader.persistence.loaders`, `nautilus_trader.persistence.wranglers`, `nautilus_trader.test_kit.providers`, `nautilus_trader.test_kit.stubs.data`, `nautilus_trader.test_kit.stubs.identifiers`, `pandas`, `pytest`

## Related Files

This file is located in `tests/unit_tests/data/`. Related files may include:
...
```bash
# For Python
pytest tests/unit_tests/data/test_aggregation.py
...
---
*Generated on 2025-11-18T21:55:11.334616Z*
