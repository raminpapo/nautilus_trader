# Documentation: `tests/unit_tests/data/test_aggregation.py`
**Generated:** 2025-11-15T19:40:09.100883Z
**File Size:** 142787 bytes
**Extension:** .py
**Type:** text
...
- **Path:** `tests/unit_tests/data/test_aggregation.py`
- **Size:** 142,787 bytes
- **Lines:** 3,961
- **Extension:** `.py`
- **Type:** text
...
This file is located at `tests/unit_tests/data/test_aggregation.py` within the repository.

**Classes defined:** TestBarBuilder, TestTickBarAggregator, TestVolumeBarAggregator, TestTestValueBarAggregator, TestRenkoBarAggregator, TestTimeBarAggregator, TestSpreadQuoteAggregator, TestTimeBarAggregatorHistoricalMode

**Functions defined:** test_instantiate, test_str_repr, test_single_update_results_in_expected_properties, test_single_bar_update_results_in_expected_properties, test_single_update_when_timestamp_less_than_last_update_ignores, test_single_bar_update_when_timestamp_less_than_last_update_ignores, test_multiple_updates_correctly_increments_count, test_multiple_bar_updates_correctly_increments_count, test_build_when_no_updates_raises_exception, test_build_when_received_updates_returns_expected_bar and 75 more
...
#### `TestTickBarAggregator`


#### `TestVolumeBarAggregator`


#### `TestTestValueBarAggregator`


#### `TestRenkoBarAggregator`


#### `TestTimeBarAggregator`


#### `TestSpreadQuoteAggregator`


#### `TestTimeBarAggregatorHistoricalMode`


### Functions

#### `test_instantiate(self)`


#### `test_str_repr(self)`


#### `test_single_update_results_in_expected_properties(self)`


#### `test_single_bar_update_results_in_expected_properties(self)`


#### `test_single_update_when_timestamp_less_than_last_update_ignores(self)`


#### `test_single_bar_update_when_timestamp_less_than_last_update_ignores(self)`


#### `test_multiple_updates_correctly_increments_count(self)`


#### `test_multiple_bar_updates_correctly_increments_count(self)`


#### `test_build_when_no_updates_raises_exception(self)`


#### `test_build_when_received_updates_returns_expected_bar(self)`


#### `test_build_when_received_bar_updates_returns_expected_bar(self)`


#### `test_build_with_previous_close(self)`


#### `test_handle_quote_tick_when_count_below_threshold_updates(self)`


#### `test_handle_trade_tick_when_count_below_threshold_updates(self)`


#### `test_handle_bar_when_count_below_threshold_updates(self)`


#### `test_handle_quote_tick_when_count_at_threshold_sends_bar_to_handler(self)`


#### `test_handle_trade_tick_when_count_at_threshold_sends_bar_to_handler(self)`


#### `test_handle_bar_when_count_at_threshold_sends_bar_to_handler(self)`


#### `test_run_quote_ticks_through_aggregator_results_in_expected_bars(self)`


#### `test_run_trade_ticks_through_aggregator_results_in_expected_bars(self)`


#### `test_run_bars_through_aggregator_results_in_expected_bars(self)`


#### `test_handle_quote_tick_when_volume_below_threshold_updates(self)`


#### `test_handle_trade_tick_when_volume_below_threshold_updates(self)`


#### `test_handle_bar_when_volume_below_threshold_updates(self)`


#### `test_handle_quote_tick_when_volume_at_threshold_sends_bar_to_handler(self)`


#### `test_handle_trade_tick_when_volume_at_threshold_sends_bar_to_handler(self)`


#### `test_handle_bar_when_volume_at_threshold_sends_bar_to_handler(self)`


#### `test_handle_quote_tick_when_volume_beyond_threshold_sends_bars_to_handler(self)`


#### `test_handle_trade_tick_when_volume_beyond_threshold_sends_bars_to_handler(self)`


#### `test_handle_bar_when_volume_beyond_threshold_sends_bars_to_handler(self)`
...
#### `test_handle_quote_tick_when_value_below_threshold_updates(self)`


#### `test_handle_trade_tick_when_value_below_threshold_updates(self)`


#### `test_handle_bar_when_value_below_threshold_updates(self)`


#### `test_handle_quote_tick_when_value_beyond_threshold_sends_bar_to_handler(self)`


#### `test_handle_trade_tick_when_volume_beyond_threshold_sends_bars_to_handler(self)`


#### `test_handle_bar_when_value_beyond_threshold_sends_bars_to_handler(self)`
...
#### `test_handle_quote_tick_when_price_below_brick_size_updates(self)`


#### `test_handle_quote_tick_when_price_exceeds_brick_size_creates_bar(self)`


#### `test_handle_quote_tick_multiple_bricks_in_one_update(self)`


#### `test_handle_quote_tick_downward_movement(self)`


#### `test_get_brick_size(self)`


#### `test_handle_bar_when_price_below_brick_size_updates(self)`


#### `test_handle_bar_when_price_exceeds_brick_size_creates_bar(self)`


#### `test_handle_bar_multiple_bricks_in_one_update(self)`
...
```python
from tests.unit_tests.data.test_aggregation import TestBarBuilder
```
