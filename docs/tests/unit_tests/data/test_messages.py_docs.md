...
### Classes
- **`TestDataMessage`**: Class defined in this file
...
**Classs**: `TestDataMessage`
**Imports**: `nautilus_trader.common.component`, `nautilus_trader.core.data`, `nautilus_trader.core.uuid`, `nautilus_trader.data.messages`, `nautilus_trader.model.data`, `nautilus_trader.model.enums`, `nautilus_trader.model.identifiers`, `pandas`, `pytest`
...
```bash
# For Python
pytest tests/unit_tests/data/test_messages.py
...
---
*Generated on 2025-11-18T21:55:11.355239Z*
