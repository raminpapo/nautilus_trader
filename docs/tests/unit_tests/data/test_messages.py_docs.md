# Documentation: `tests/unit_tests/data/test_messages.py`
**Generated:** 2025-11-15T19:40:09.123846Z
...
- **Path:** `tests/unit_tests/data/test_messages.py`
- **Size:** 13,449 bytes
- **Lines:** 360
- **Extension:** `.py`
- **Type:** text
...
This file is located at `tests/unit_tests/data/test_messages.py` within the repository.

**Classes defined:** TestDataMessage

**Functions defined:** setup, test_data_messages_when_client_id_and_venue_none_raise_value_error, test_data_command_str_and_repr, test_venue_data_command_str_and_repr, test_data_request_message_str_and_repr, test_venue_data_request_message_str_and_repr, test_data_response_message_str_and_repr, test_venue_data_response_message_str_and_repr, test_subscribe_order_book_to_request_conversion, test_subscribe_order_book_to_request_conversion_with_invalid_data_type_raises_error
...
#### `test_data_messages_when_client_id_and_venue_none_raise_value_error(self)`


#### `test_data_command_str_and_repr(self)`


#### `test_venue_data_command_str_and_repr(self)`


#### `test_data_request_message_str_and_repr(self)`


#### `test_venue_data_request_message_str_and_repr(self)`


#### `test_data_response_message_str_and_repr(self)`


#### `test_venue_data_response_message_str_and_repr(self)`


#### `test_subscribe_order_book_to_request_conversion(self)`


#### `test_subscribe_order_book_to_request_conversion_with_invalid_data_type_raises_error(self)`
...
```python
from tests.unit_tests.data.test_messages import TestDataMessage
```
