# Documentation: `tests/unit_tests/data/test_engine.py`
**Generated:** 2025-11-15T19:40:09.120035Z
**File Size:** 195593 bytes
**Extension:** .py
**Type:** text
...
- **Path:** `tests/unit_tests/data/test_engine.py`
- **Size:** 195,593 bytes
- **Lines:** 5,665
- **Extension:** `.py`
- **Type:** text
...
This file is located at `tests/unit_tests/data/test_engine.py` within the repository.

**Classes defined:** TestDataEngine, TestDataEngineQuoteFromDepth, TestDataBufferEngine, TestDataEngineQuoteFromBook, TestTimeRangeGenerator

**Functions defined:** setup_method, test_registered_venues, test_subscribed_instruments_when_nothing_subscribed_returns_empty_list, test_subscribed_quote_ticks_when_nothing_subscribed_returns_empty_list, test_subscribed_trade_ticks_when_nothing_subscribed_returns_empty_list, test_subscribed_bars_when_nothing_subscribed_returns_empty_list, test_register_client_successfully_adds_client, test_deregister_client_successfully_removes_client, test_reset, test_stop_and_resume and 120 more
...
#### `TestDataEngineQuoteFromDepth`


#### `TestDataBufferEngine`


#### `TestDataEngineQuoteFromBook`


#### `TestTimeRangeGenerator`
...
#### `test_registered_venues(self)`


#### `test_subscribed_instruments_when_nothing_subscribed_returns_empty_list(self)`


#### `test_subscribed_quote_ticks_when_nothing_subscribed_returns_empty_list(self)`


#### `test_subscribed_trade_ticks_when_nothing_subscribed_returns_empty_list(self)`


#### `test_subscribed_bars_when_nothing_subscribed_returns_empty_list(self)`


#### `test_register_client_successfully_adds_client(self)`


#### `test_deregister_client_successfully_removes_client(self)`


#### `test_reset(self)`


#### `test_stop_and_resume(self)`


#### `test_dispose(self)`


#### `test_check_connected_when_client_disconnected_returns_false(self)`


#### `test_check_connected_when_client_connected_returns_true(self)`


#### `test_check_disconnected_when_client_disconnected_returns_true(self)`


#### `test_check_disconnected_when_client_connected_returns_false(self)`


#### `test_execute_unrecognized_message_logs_and_does_nothing(self)`


#### `test_send_request_when_no_data_clients_registered_does_nothing(self)`


#### `test_send_data_request_when_data_type_unrecognized_logs_and_does_nothing(self)`


#### `test_send_data_request_with_duplicate_ids_logs_and_does_not_handle_second(self)`


#### `test_execute_subscribe_when_data_type_not_implemented_logs_and_does_nothing(self)`


#### `test_execute_subscribe_custom_data(self)`


#### `test_execute_unsubscribe_custom_data(self)`


#### `test_execute_unsubscribe_when_data_type_unrecognized_logs_and_does_nothing(self)`


#### `test_execute_unsubscribe_when_not_subscribed_logs_and_does_nothing(self)`


#### `test_receive_response_when_no_data_clients_registered_does_nothing(self)`


#### `test_process_unrecognized_data_type_logs_and_does_nothing(self)`


#### `test_process_data_places_data_on_queue(self)`


#### `test_execute_subscribe_instruments_then_adds_handler(self)`


#### `test_execute_unsubscribe_instruments_then_removes_handler(self)`


#### `test_execute_subscribe_instrument_then_adds_handler(self)`


#### `test_execute_subscribe_instrument_synthetic_logs_error(self)`


#### `test_execute_unsubscribe_instrument_then_removes_handler(self)`


#### `test_execute_unsubscribe_synthetic_instrument_logs_error(self)`


#### `test_process_instrument_when_subscriber_then_sends_to_registered_handler(self)`


#### `test_process_instrument_when_subscribers_then_sends_to_registered_handlers(
        self,
    )`


#### `test_execute_subscribe_order_book_snapshots_then_adds_handler(self)`


#### `test_execute_subscribe_order_book_deltas_then_adds_handler(self)`


#### `test_execute_subscribe_order_book_intervals_then_adds_handler(self)`


#### `test_execute_unsubscribe_order_book_deltas_then_removes_handler(self)`


#### `test_execute_unsubscribe_order_book_at_interval_then_removes_handler(self)`


#### `test_order_book_snapshots_when_book_not_updated_does_not_send_(self)`


#### `test_process_order_book_snapshot_when_one_subscriber_then_sends_to_registered_handler(
        self,
    )`


#### `test_process_order_book_delta_then_sends_to_registered_handler(self)`


#### `test_process_order_book_deltas_then_sends_to_registered_handler(self)`


#### `test_process_order_book_deltas_with_composite_symbol(self)`


#### `test_process_order_book_snapshots_when_multiple_subscribers_then_sends_to_registered_handlers(
        self,
    )`


#### `test_process_order_book_depth_when_multiple_subscribers_then_sends_to_registered_handlers(
        self,
    )`


#### `test_order_book_delta_creates_book(self)`


#### `test_unsubscribe_order_book_interval_cancels_snapshot_timer(self)`


#### `test_execute_subscribe_quote_ticks(self)`
...
```python
from tests.unit_tests.data.test_engine import TestDataEngine
```
...
**Directory:** `tests/unit_tests/data`
