...
### Classes
- **`TestCache`**: Class defined in this file
- **`TestExecutionCacheIntegrityCheck`**: Class defined in this file
...
**Classs**: `TestCache`, `TestExecutionCacheIntegrityCheck`
**Imports**: `decimal`, `nautilus_trader.backtest.engine`, `nautilus_trader.cache.cache`, `nautilus_trader.common.component`, `nautilus_trader.config`, `nautilus_trader.core.uuid`, `nautilus_trader.data.engine`, `nautilus_trader.examples.strategies.ema_cross`, `nautilus_trader.execution.engine`, `nautilus_trader.model.currencies`, `nautilus_trader.model.data`, `nautilus_trader.model.enums`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.objects`, `nautilus_trader.model.position`, `nautilus_trader.persistence.wranglers`, `nautilus_trader.portfolio.portfolio`, `nautilus_trader.risk.engine`, `nautilus_trader.test_kit.mocks.actors`, `nautilus_trader.test_kit.providers`, `nautilus_trader.test_kit.stubs.events`, `nautilus_trader.test_kit.stubs.execution`, `nautilus_trader.test_kit.stubs.identifiers`, `nautilus_trader.trading.strategy`, `pickle`, `pytest`

## Related Files

This file is located in `tests/unit_tests/cache/`. Related files may include:
...
```bash
# For Python
pytest tests/unit_tests/cache/test_execution.py
...
---
*Generated on 2025-11-18T21:55:11.246747Z*
