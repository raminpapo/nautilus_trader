# Documentation: `tests/unit_tests/cache/test_execution.py`
**Generated:** 2025-11-15T19:40:09.027141Z
**File Size:** 80970 bytes
**Extension:** .py
**Type:** text
...
- **Path:** `tests/unit_tests/cache/test_execution.py`
- **Size:** 80,970 bytes
- **Lines:** 2,256
- **Extension:** `.py`
- **Type:** text
...
This file is located at `tests/unit_tests/cache/test_execution.py` within the repository.

**Classes defined:** TestCache, TestExecutionCacheIntegrityCheck

**Functions defined:** setup, test_cache_general_with_no_objects, test_cache_currencies_with_no_currencies, test_cache_instruments_with_no_instruments, test_cache_accounts_with_no_accounts, test_cache_orders_with_no_orders, test_cache_order_lists_with_no_orders, test_orders_for_position_when_no_position_returns_empty_list, test_cache_positions_with_no_positions, test_build_index_with_no_objects and 69 more
...
#### `TestExecutionCacheIntegrityCheck`
...
#### `test_cache_general_with_no_objects(self)`


#### `test_cache_currencies_with_no_currencies(self)`


#### `test_cache_instruments_with_no_instruments(self)`


#### `test_cache_accounts_with_no_accounts(self)`


#### `test_cache_orders_with_no_orders(self)`


#### `test_cache_order_lists_with_no_orders(self)`


#### `test_orders_for_position_when_no_position_returns_empty_list(self)`


#### `test_cache_positions_with_no_positions(self)`


#### `test_build_index_with_no_objects(self)`


#### `test_add_currency(self)`


#### `test_add_account(self)`


#### `test_load_instrument(self)`


#### `test_load_account(self)`


#### `test_account_for_venue(self)`


#### `test_accounts_when_no_accounts_returns_empty_list(self)`


#### `test_get_actor_ids_with_no_ids_returns_empty_set(self)`


#### `test_get_strategy_ids_with_no_ids_returns_empty_set(self)`


#### `test_get_exec_algorithm_ids_with_no_ids_returns_empty_set(self)`


#### `test_get_order_ids_with_no_ids_returns_empty_set(self)`


#### `test_get_actor_ids_with_id_returns_correct_set(self)`


#### `test_get_strategy_ids_with_id_returns_correct_set(self)`


#### `test_orders_for_exec_spawn_when_not_found(self)`


#### `test_orders_for_exec_algorithm_when_not_found(self)`


#### `test_exec_spawn_total_quantity_when_not_found(self)`


#### `test_exec_spawn_total_filled_qty_when_not_found(self)`


#### `test_exec_spawn_total_leaves_qty_when_not_found(self)`


#### `test_position_for_order_when_no_position_returns_none(self)`


#### `test_position_exists_when_no_position_returns_false(self)`


#### `test_order_exists_when_no_order_returns_false(self)`


#### `test_order_list_exists_when_no_order_returns_false(self)`


#### `test_order_list_ids_when_no_order_lists_returns_empty_set(self)`


#### `test_order_lists_when_no_order_lists_returns_empty_list(self)`


#### `test_position_when_no_position_returns_none(self)`


#### `test_order_when_no_order_returns_none(self)`


#### `test_strategy_id_for_position_when_no_strategy_registered_returns_none(self)`


#### `test_add_market_order(self)`


#### `test_add_emulated_limit_order(self)`


#### `test_load_order(self)`


#### `test_add_position(self)`


#### `test_snapshot_position(self)`


#### `test_snapshot_multiple_netted_positions(self)`


#### `test_load_position(self)`


#### `test_update_order_for_submitted_order(self)`


#### `test_update_order_for_accepted_order(self)`


#### `test_update_order_for_closed_order(self)`


#### `test_update_position_for_open_position(self)`


#### `test_update_position_for_closed_position(self)`


#### `test_positions_queries_with_multiple_open_returns_expected_positions(self)`


#### `test_positions_queries_with_one_closed_returns_expected_positions(self)`
...
```python
from tests.unit_tests.cache.test_execution import TestCache
```
