...
**Classs**: `TestCache`
**Imports**: `decimal`, `nautilus_trader.core`, `nautilus_trader.core.rust.model`, `nautilus_trader.model.currencies`, `nautilus_trader.model.data`, `nautilus_trader.model.enums`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.objects`, `nautilus_trader.test_kit.providers`, `nautilus_trader.test_kit.stubs.component`, `nautilus_trader.test_kit.stubs.data`, `pytest`
...
```bash
# For Python
pytest tests/unit_tests/cache/test_data.py
...
---
*Generated on 2025-11-18T21:55:11.238184Z*
