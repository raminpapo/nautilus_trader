# Documentation: `tests/unit_tests/cache/test_data.py`
**Generated:** 2025-11-15T19:40:09.019767Z
**File Size:** 39114 bytes
**Extension:** .py
**Type:** text
...
- **Path:** `tests/unit_tests/cache/test_data.py`
- **Size:** 39,114 bytes
- **Lines:** 1,220
- **Extension:** `.py`
- **Type:** text
...
This file is located at `tests/unit_tests/cache/test_data.py` within the repository.

**Classes defined:** TestCache

**Functions defined:** setup, test_reset_an_empty_cache, test_instrument_ids_when_no_instruments_returns_empty_list, test_instruments_when_no_instruments_returns_empty_list, test_quote_ticks_for_unknown_instrument_returns_empty_list, test_trade_ticks_for_unknown_instrument_returns_empty_list, test_bars_for_unknown_bar_type_returns_empty_list, test_instrument_when_no_instruments_returns_none, test_order_book_for_unknown_instrument_returns_none, test_own_order_book_for_unknown_instrument_returns_none and 72 more
...
#### `test_reset_an_empty_cache(self)`


#### `test_instrument_ids_when_no_instruments_returns_empty_list(self)`


#### `test_instruments_when_no_instruments_returns_empty_list(self)`


#### `test_quote_ticks_for_unknown_instrument_returns_empty_list(self)`


#### `test_trade_ticks_for_unknown_instrument_returns_empty_list(self)`


#### `test_bars_for_unknown_bar_type_returns_empty_list(self)`


#### `test_instrument_when_no_instruments_returns_none(self)`


#### `test_order_book_for_unknown_instrument_returns_none(self)`


#### `test_own_order_book_for_unknown_instrument_returns_none(self)`


#### `test_audit_own_order_books_with_no_orders(self)`


#### `test_update_own_order_book_with_market_order_does_not_raise(self)`


#### `test_force_remove_from_own_order_book_cleans_up_indexes(self)`


#### `test_audit_own_order_books_preserves_inflight_orders(self)`


#### `test_audit_own_order_books_removes_closed_orders(self)`


#### `test_price_when_no_prices_returns_none(self, price_type: PriceType)`


#### `test_prices_when_no_prices_returns_empty_map(self, price_type: PriceType)`


#### `test_quote_tick_when_no_ticks_returns_none(self)`


#### `test_trade_tick_when_no_ticks_returns_none(self)`


#### `test_bar_when_no_bars_returns_none(self)`


#### `test_quote_tick_count_for_unknown_instrument_returns_zero(self)`


#### `test_trade_tick_count_for_unknown_instrument_returns_zero(self)`


#### `test_has_order_book_for_unknown_instrument_returns_false(self)`


#### `test_has_quote_ticks_for_unknown_instrument_returns_false(self)`


#### `test_has_trade_ticks_for_unknown_instrument_returns_false(self)`


#### `test_has_bars_for_unknown_bar_type_returns_false(self)`


#### `test_instrument_ids_when_one_instrument_returns_expected_list(self)`


#### `test_instrument_ids_given_same_venue_returns_expected_list(self)`


#### `test_instrument_ids_given_different_venue_returns_empty_list(self)`


#### `test_instruments_when_one_instrument_returns_expected_list(self)`


#### `test_instruments_given_same_venue_returns_expected_list(self)`


#### `test_instruments_given_different_venue_returns_empty_list(self)`


#### `test_instruments_with_underlying_returns_expected(self)`


#### `test_synthetic_ids_when_one_synthetic_instrument_returns_expected_list(self)`


#### `test_synthetics_when_one_synthetic_instrument_returns_expected_list(self)`


#### `test_add_mark_price(self)`


#### `test_add_mark_price_as_map(self)`


#### `test_add_funding_rate(self)`


#### `test_funding_rate_when_no_funding_rate_returns_none(self)`


#### `test_add_funding_rate_updates_existing(self)`


#### `test_reset_clears_funding_rates(self)`


#### `test_quote_ticks_when_one_tick_returns_expected_list(self)`


#### `test_add_quote_ticks_when_identical_ticks_does_not_add(self)`


#### `test_add_quote_ticks_when_older_quotes(self)`


#### `test_trade_ticks_when_one_tick_returns_expected_list(self)`


#### `test_add_trade_ticks_when_identical_ticks_does_not_add(self)`


#### `test_add_trade_ticks_when_older_trades(self)`


#### `test_bars_when_one_bar_returns_expected_list(self)`


#### `test_add_bars_when_already_identical_bar_does_not_add(self)`


#### `test_add_bars_when_older_cached_bars(self)`
...
```python
from tests.unit_tests.cache.test_data import TestCache
```
...
**Directory:** `tests/unit_tests/cache`
