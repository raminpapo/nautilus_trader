# Documentation: test_calculators.py
...
### Classes
- **`TestExchangeRateCalculator`**: Class defined in this file
- **`TestRolloverInterestCalculator`**: Class defined in this file
...
**Classs**: `TestExchangeRateCalculator`, `TestRolloverInterestCalculator`
**Imports**: `datetime`, `nautilus_trader`, `nautilus_trader.accounting.calculators`, `nautilus_trader.core`, `nautilus_trader.model.currencies`, `nautilus_trader.test_kit.stubs.data`, `nautilus_trader.test_kit.stubs.identifiers`, `pandas`, `pytest`
...
```bash
# For Python
pytest tests/unit_tests/accounting/test_calculators.py
...
---
*Generated on 2025-11-18T21:55:11.099316Z*
