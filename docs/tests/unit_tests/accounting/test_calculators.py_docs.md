# Documentation: `tests/unit_tests/accounting/test_calculators.py`
**Generated:** 2025-11-15T19:40:08.887873Z
**File Size:** 7215 bytes
**Extension:** .py
**Type:** text
...
- **Path:** `tests/unit_tests/accounting/test_calculators.py`
- **Size:** 7,215 bytes
- **Lines:** 255
- **Extension:** `.py`
- **Type:** text
...
This file is located at `tests/unit_tests/accounting/test_calculators.py` within the repository.

**Classes defined:** TestExchangeRateCalculator, TestRolloverInterestCalculator

**Functions defined:** test_get_rate_when_from_currency_equals_to_currency_returns_one, test_get_rate_when_no_currency_rate_returns_zero, test_get_rate, test_get_rate_when_symbol_has_slash, test_get_rate_for_inverse1, test_get_rate_for_inverse2, test_calculate_exchange_rate_by_inference, test_calculate_exchange_rate_for_mid_price_type, test_calculate_exchange_rate_for_mid_price_type2, setup and 4 more
...
#### `TestExchangeRateCalculator`


#### `TestRolloverInterestCalculator`


### Functions

#### `test_get_rate_when_from_currency_equals_to_currency_returns_one(self)`


#### `test_get_rate_when_no_currency_rate_returns_zero(self)`


#### `test_get_rate(self)`


#### `test_get_rate_when_symbol_has_slash(self)`


#### `test_get_rate_for_inverse1(self)`


#### `test_get_rate_for_inverse2(self)`


#### `test_calculate_exchange_rate_by_inference(self)`


#### `test_calculate_exchange_rate_for_mid_price_type(self)`


#### `test_calculate_exchange_rate_for_mid_price_type2(self)`


#### `setup(self)`


#### `test_rate_dataframe_returns_correct_dataframe(self)`


#### `test_calc_overnight_fx_rate_with_audusd_on_unix_epoch_returns_correct_rate(
        self,
    )`


#### `test_calc_overnight_fx_rate_with_audusd_on_later_date_returns_correct_rate(
        self,
    )`


#### `test_calc_overnight_fx_rate_with_audusd_on_impossible_dates_returns_zero(self)`
...
```python
from tests.unit_tests.accounting.test_calculators import TestExchangeRateCalculator
```
