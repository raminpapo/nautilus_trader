...
This file is part of the NautilusTrader repository. It defines 13 function(s) and 2 class(es).

## Detailed Walkthrough

### Functions
- **`test_cash_account_eth_usdt_balance_calculation()`**: Function defined in this file
- **`test_cash_account_update_with_fill_to_zero()`**: Function defined in this file
- **`test_cash_account_calculate_balance_locked()`**: Function defined in this file
- **`test_cash_account_calculate_commission()`**: Function defined in this file
- **`test_cash_account_calculate_pnls()`**: Function defined in this file
- **`test_cash_account_balance_impact()`**: Function defined in this file
- **`test_cash_account_clear_balance_locked_resets_locked_balance()`**: Function defined in this file
- **`test_accounts_manager_update_balance_locked_with_base_currency_multiple_orders()`**: Function defined in this file
- **`test_accounts_manager_update_balances_with_reduce_only_orders()`**: Function defined in this file
- **`test_accounts_manager_update_balances_with_unpriced_orders()`**: Function defined in this file
- **`test_accounts_manager_locks_correct_currency_for_fx_orders()`**: Function defined in this file
- **`test_accounts_manager_locks_correct_currency_for_multiple_crypto_spot_orders()`**: Function defined in this file
- **`test_accounts_manager_with_base_currency_converts_locks()`**: Function defined in this file

### Classes
- **`TestCashAccount`**: Class defined in this file
- **`TestCashAccountPurge`**: Class defined in this file
...
**Classs**: `TestCashAccount`, `TestCashAccountPurge`
**Functions**: `test_accounts_manager_locks_correct_currency_for_fx_orders`, `test_accounts_manager_locks_correct_currency_for_multiple_crypto_spot_orders`, `test_accounts_manager_update_balance_locked_with_base_currency_multiple_orders`, `test_accounts_manager_update_balances_with_reduce_only_orders`, `test_accounts_manager_update_balances_with_unpriced_orders`, `test_accounts_manager_with_base_currency_converts_locks`, `test_cash_account_balance_impact`, `test_cash_account_calculate_balance_locked`, `test_cash_account_calculate_commission`, `test_cash_account_calculate_pnls`, `test_cash_account_clear_balance_locked_resets_locked_balance`, `test_cash_account_eth_usdt_balance_calculation`, `test_cash_account_update_with_fill_to_zero`
**Imports**: `decimal`, `nautilus_trader.accounting.accounts.cash`, `nautilus_trader.accounting.manager`, `nautilus_trader.cache.cache`, `nautilus_trader.common.component`, `nautilus_trader.common.factories`, `nautilus_trader.core.uuid`, `nautilus_trader.model.currencies`, `nautilus_trader.model.enums`, `nautilus_trader.model.events`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.objects`, `nautilus_trader.model.position`, `nautilus_trader.test_kit.providers`, `nautilus_trader.test_kit.stubs.component`, `nautilus_trader.test_kit.stubs.events`, `nautilus_trader.test_kit.stubs.execution`, `nautilus_trader.test_kit.stubs.identifiers`, `pytest`
...
```bash
# For Python
pytest tests/unit_tests/accounting/test_cash.py
...
---
*Generated on 2025-11-18T21:55:11.104820Z*
