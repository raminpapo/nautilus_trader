# Documentation: `tests/unit_tests/accounting/test_cash.py`
**Generated:** 2025-11-15T19:40:08.892645Z
**File Size:** 50850 bytes
**Extension:** .py
**Type:** text
...
- **Path:** `tests/unit_tests/accounting/test_cash.py`
- **Size:** 50,850 bytes
- **Lines:** 1,617
- **Extension:** `.py`
- **Type:** text
...
This file is located at `tests/unit_tests/accounting/test_cash.py` within the repository.

**Classes defined:** TestCashAccount, TestCashAccountPurge

**Functions defined:** setup, test_instantiated_accounts_basic_properties, test_is_unleveraged_returns_true, test_instantiate_single_asset_cash_account, test_instantiate_multi_asset_cash_account, test_apply_given_new_state_event_updates_correctly, test_calculate_balance_locked_buy, test_calculate_balance_locked_sell, test_calculate_balance_locked_sell_no_base_currency, test_calculate_pnls_for_single_currency_cash_account and 26 more
...
#### `test_instantiated_accounts_basic_properties(self)`


#### `test_is_unleveraged_returns_true(self)`


#### `test_instantiate_single_asset_cash_account(self)`


#### `test_instantiate_multi_asset_cash_account(self)`


#### `test_apply_given_new_state_event_updates_correctly(self)`


#### `test_calculate_balance_locked_buy(self)`


#### `test_calculate_balance_locked_sell(self)`


#### `test_calculate_balance_locked_sell_no_base_currency(self)`


#### `test_calculate_pnls_for_single_currency_cash_account(self)`


#### `test_calculate_pnls_for_multi_currency_cash_account_btcusdt(self)`


#### `test_calculate_pnls_for_multi_currency_cash_account_adabtc(self)`


#### `test_calculate_commission_when_given_liquidity_side_none_raises_value_error(
        self,
    )`


#### `test_calculate_commission_for_inverse_maker_crypto(self, use_quote_for_inverse, expected)`


#### `test_calculate_commission_for_taker_fx(self)`


#### `test_calculate_commission_crypto_taker(self)`


#### `test_calculate_commission_fx_taker(self)`


#### `test_cash_account_eth_usdt_balance_calculation()`


#### `test_cash_account_update_with_fill_to_zero()`


#### `test_cash_account_calculate_balance_locked()`


#### `test_cash_account_calculate_commission()`


#### `test_cash_account_calculate_pnls()`


#### `test_cash_account_balance_impact()`


#### `test_cash_account_clear_balance_locked_resets_locked_balance()`


#### `test_accounts_manager_update_balance_locked_with_base_currency_multiple_orders()`


#### `test_purge_account_events_retains_latest_when_all_events_purged(self)`


#### `test_cash_account_borrowing_disabled_by_default(self)`


#### `test_cash_account_with_borrowing_enabled(self)`


#### `test_cash_account_rejects_negative_balance_when_borrowing_disabled(self)`


#### `test_cash_account_accepts_negative_balance_when_borrowing_enabled(self)`


#### `test_cash_account_update_balances_respects_borrowing_setting(self)`


#### `test_accounts_manager_update_balances_with_reduce_only_orders()`


#### `test_accounts_manager_update_balances_with_unpriced_orders()`


#### `test_accounts_manager_locks_correct_currency_for_fx_orders()`


#### `test_accounts_manager_locks_correct_currency_for_multiple_crypto_spot_orders()`


#### `test_accounts_manager_with_base_currency_converts_locks()`
...
```python
from tests.unit_tests.accounting.test_cash import TestCashAccount
```
