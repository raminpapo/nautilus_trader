# Documentation: `tests/unit_tests/accounting/test_margin.py`
**Generated:** 2025-11-15T19:40:08.898183Z
**File Size:** 28478 bytes
**Extension:** .py
**Type:** text
...
- **Path:** `tests/unit_tests/accounting/test_margin.py`
- **Size:** 28,478 bytes
- **Lines:** 890
- **Extension:** `.py`
- **Type:** text
...
This file is located at `tests/unit_tests/accounting/test_margin.py` within the repository.

**Classes defined:** TestMarginAccount

**Functions defined:** setup, test_instantiated_accounts_basic_properties, test_set_default_leverage, test_set_leverage, test_is_unleveraged_with_leverage_returns_false, test_is_unleveraged_with_no_leverage_returns_true, test_is_unleveraged_with_default_leverage_of_1_returns_true, test_update_margin_init, test_update_margin_maint, test_calculate_margin_init_with_leverage and 21 more
...
#### `test_set_default_leverage(self)`


#### `test_set_leverage(self)`


#### `test_is_unleveraged_with_leverage_returns_false(self)`


#### `test_is_unleveraged_with_no_leverage_returns_true(self)`


#### `test_is_unleveraged_with_default_leverage_of_1_returns_true(self)`


#### `test_update_margin_init(self)`


#### `test_update_margin_maint(self)`


#### `test_calculate_margin_init_with_leverage(self)`


#### `test_calculate_margin_init_with_default_leverage(self)`
...
#### `test_calculate_margin_maint_with_no_leverage(self)`


#### `test_calculate_margin_maint_with_leverage_fx_instrument(self)`


#### `test_calculate_margin_maint_with_leverage_inverse_instrument(self)`


#### `test_calculate_pnls_with_no_position_returns_empty_list(self)`


#### `test_calculate_pnls_with_flat_position_returns_empty_list(self)`


#### `test_calculate_pnls_with_same_side_fill_returns_empty_list(self)`


#### `test_calculate_pnls_with_reducing_fill_calculates_pnl(self)`


#### `test_calculate_pnls_with_fill_larger_than_position_limits_correctly(self)`


#### `test_calculate_pnls_with_short_position_reducing_fill(self)`


#### `test_calculate_pnls_multiple_partial_reductions(self)`


#### `test_calculate_pnls_consistency_with_position_calculate_pnl(self)`


#### `test_calculate_pnls_github_issue_2657_reproduction(self)`


#### `test_balance_impact_buy_order(self)`


#### `test_balance_impact_sell_order(self)`


#### `test_margin_account_calculate_initial_margin(self)`


#### `test_margin_account_calculate_maintenance_margin(self)`


#### `test_margin_account_calculate_balance_locked_with_leverage(self)`


#### `test_margin_account_calculate_commission_on_trade(self)`


#### `test_margin_account_update_commissions(self)`
...
```python
from tests.unit_tests.accounting.test_margin import TestMarginAccount
```
