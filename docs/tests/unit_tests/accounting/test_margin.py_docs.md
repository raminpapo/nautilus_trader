...
### Classes
- **`TestMarginAccount`**: Class defined in this file
...
```bash
# For Python
pytest tests/unit_tests/accounting/test_margin.py
...
---
*Generated on 2025-11-18T21:55:11.110539Z*
