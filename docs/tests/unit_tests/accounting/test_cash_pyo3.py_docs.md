# Documentation: test_cash_pyo3.py

## File Metadata

- **Path**: `tests/unit_tests/accounting/test_cash_pyo3.py`
- **Size**: 10,141 bytes
- **Lines**: 261
- **Language**: Python
...
- **`test_instantiate_single_asset_cash_account()`**: Function defined in this file
- **`test_instantiate_multi_asset_cash_account()`**: Function defined in this file
- **`test_apply_given_new_state_event_updates_correctly()`**: Function defined in this file
- **`test_calculate_balance_locked_buy()`**: Function defined in this file
- **`test_calculate_balance_locked_sell()`**: Function defined in this file
- **`test_calculate_balance_locked_sell_no_base_currency()`**: Function defined in this file
- **`test_calculate_pnls_for_single_currency_cash_account()`**: Function defined in this file
- **`test_calculate_commission_when_given_liquidity_side_none_raises_value_error()`**: Function defined in this file
- **`test_calculate_commission_for_inverse_maker_crypto()`**: Function defined in this file
- **`test_calculate_commission_for_taker_fx()`**: Function defined in this file
- **`test_calculate_commission_crypto_taker()`**: Function defined in this file
- **`test_calculate_commission_fx_taker()`**: Function defined in this file
...
**Functions**: `test_apply_given_new_state_event_updates_correctly`, `test_calculate_balance_locked_buy`, `test_calculate_balance_locked_sell`, `test_calculate_balance_locked_sell_no_base_currency`, `test_calculate_commission_crypto_taker`, `test_calculate_commission_for_inverse_maker_crypto`, `test_calculate_commission_for_taker_fx`, `test_calculate_commission_fx_taker`, `test_calculate_commission_when_given_liquidity_side_none_raises_value_error`, `test_calculate_pnls_for_single_currency_cash_account`, `test_instantiate_multi_asset_cash_account`, `test_instantiate_single_asset_cash_account`, `test_instantiated_account_basic_properties`, `test_pyo3_cython_conversion`
**Imports**: `nautilus_trader.accounting.accounts.cash`, `nautilus_trader.core.nautilus_pyo3`, `nautilus_trader.test_kit.rust.accounting_pyo3`, `nautilus_trader.test_kit.rust.events_pyo3`, `nautilus_trader.test_kit.rust.identifiers_pyo3`, `nautilus_trader.test_kit.rust.instruments_pyo3`, `nautilus_trader.test_kit.rust.orders_pyo3`, `pytest`
...
```bash
# For Python
pytest tests/unit_tests/accounting/test_cash_pyo3.py
...
---
*Generated on 2025-11-18T21:55:11.106911Z*
