# Documentation: `tests/unit_tests/accounting/test_cash_pyo3.py`
**Generated:** 2025-11-15T19:40:08.895017Z
...
This file is located at `tests/unit_tests/accounting/test_cash_pyo3.py` within the repository.

**Functions defined:** test_instantiated_account_basic_properties, test_instantiate_single_asset_cash_account, test_instantiate_multi_asset_cash_account, test_apply_given_new_state_event_updates_correctly, test_calculate_balance_locked_buy, test_calculate_balance_locked_sell, test_calculate_balance_locked_sell_no_base_currency, test_calculate_pnls_for_single_currency_cash_account, test_calculate_commission_when_given_liquidity_side_none_raises_value_error, test_calculate_commission_for_inverse_maker_crypto and 4 more
...
#### `test_calculate_commission_for_inverse_maker_crypto(use_quote_for_inverse, expected)`
...
```python
from tests.unit_tests.accounting.test_cash_pyo3 import test_instantiated_account_basic_properties
```
