# Documentation: `tests/unit_tests/accounting/test_margin_models.py`
**Generated:** 2025-11-15T19:40:08.900454Z
**File Size:** 11735 bytes
**Extension:** .py
**Type:** text
...
- **Path:** `tests/unit_tests/accounting/test_margin_models.py`
- **Size:** 11,735 bytes
- **Lines:** 333
- **Extension:** `.py`
- **Type:** text
...
This file is located at `tests/unit_tests/accounting/test_margin_models.py` within the repository.

**Classes defined:** TestStandardMarginModel, TestLeveragedMarginModel, TestMarginAccountWithModels, TestCustomMarginModelConfig, TestCustomMarginModel, TestLeveragedMarginModelEdgeCases

**Functions defined:** test_calculate_margin_init_ignores_leverage, test_calculate_margin_maint_ignores_leverage, test_calculate_margin_init_applies_leverage, test_calculate_margin_maint_applies_leverage, test_margin_account_with_standard_model, test_margin_account_with_leveraged_model_default, test_margin_account_with_standard_model_set, test_custom_model_receives_config, __init__, calculate_margin_init and 5 more
...
#### `TestStandardMarginModel`


#### `TestLeveragedMarginModel`


#### `TestMarginAccountWithModels`


#### `TestCustomMarginModelConfig`


#### `TestCustomMarginModel`

**Inherits from:** MarginModel


#### `TestLeveragedMarginModelEdgeCases`


### Functions

#### `test_calculate_margin_init_ignores_leverage(self)`


#### `test_calculate_margin_maint_ignores_leverage(self)`


#### `test_calculate_margin_init_applies_leverage(self)`


#### `test_calculate_margin_maint_applies_leverage(self)`


#### `test_margin_account_with_standard_model(self)`


#### `test_margin_account_with_leveraged_model_default(self)`


#### `test_margin_account_with_standard_model_set(self)`


#### `test_custom_model_receives_config(self)`


#### `__init__(self, config)`


#### `calculate_margin_init(
                self,
                instrument,
                quantity,
                price,
...
#### `test_calculate_margin_init_zero_leverage_raises_error(self)`


#### `test_calculate_margin_init_negative_leverage_raises_error(self)`


#### `test_calculate_margin_maint_zero_leverage_raises_error(self)`


#### `test_calculate_margin_maint_negative_leverage_raises_error(self)`
...
```python
from tests.unit_tests.accounting.test_margin_models import TestStandardMarginModel
```
