# Documentation: test_margin_models.py
...
### Classes
- **`TestStandardMarginModel`**: Class defined in this file
- **`TestLeveragedMarginModel`**: Class defined in this file
- **`TestMarginAccountWithModels`**: Class defined in this file
- **`TestCustomMarginModelConfig`**: Class defined in this file
- **`TestLeveragedMarginModelEdgeCases`**: Class defined in this file
...
**Classs**: `TestCustomMarginModelConfig`, `TestLeveragedMarginModel`, `TestLeveragedMarginModelEdgeCases`, `TestMarginAccountWithModels`, `TestStandardMarginModel`
**Imports**: `decimal`, `nautilus_trader.backtest.models`, `nautilus_trader.core.rust.model`, `nautilus_trader.model.objects`, `nautilus_trader.test_kit.providers`
...
```bash
# For Python
pytest tests/unit_tests/accounting/test_margin_models.py
...
---
*Generated on 2025-11-18T21:55:11.112630Z*
