...
- **Path**: `tests/unit_tests/config/test_common.py`
- **Size**: 11,728 bytes
- **Lines**: 484
- **Language**: Python
...
This file is part of the NautilusTrader repository. It defines 36 function(s).

## Detailed Walkthrough

### Functions
- **`test_repr_with_redacted_password()`**: Function defined in this file
- **`test_equality_hash_repr()`**: Function defined in this file
- **`test_config_id()`**: Function defined in this file
- **`test_fully_qualified_name()`**: Function defined in this file
- **`test_json_schema()`**: Function defined in this file
- **`test_dict()`**: Function defined in this file
- **`test_json()`**: Function defined in this file
- **`test_json_primitives()`**: Function defined in this file
- **`test_importable_config_simple()`**: Function defined in this file
- **`test_importable_strategy_config_typing()`**: Function defined in this file
- **`test_register_custom_encodings()`**: Function defined in this file
- **`test_register_custom_decodings()`**: Function defined in this file
- **`test_encoding_unsupported_type()`**: Function defined in this file
- **`test_decoding_unsupported_type()`**: Function defined in this file
- **`test_encoding_uuid4()`**: Function defined in this file
- **`test_decoding_uuid4()`**: Function defined in this file
- **`test_encoding_component_id()`**: Function defined in this file
- **`test_decoding_component_id()`**: Function defined in this file
- **`test_encoding_instrument_id()`**: Function defined in this file
- **`test_decoding_instrument_id()`**: Function defined in this file
...
**Functions**: `test_config_id`, `test_decoding_bar_spec`, `test_decoding_bar_type`, `test_decoding_component_id`, `test_decoding_environment`, `test_decoding_instrument_id`, `test_decoding_price`, `test_decoding_quantity`, `test_decoding_timedelta`, `test_decoding_timestamp`, `test_decoding_unsupported_type`, `test_decoding_uuid4`, `test_dict`, `test_encoding_bar_spec`, `test_encoding_bar_type`, `test_encoding_component_id`, `test_encoding_environment`, `test_encoding_instrument_id`, `test_encoding_price`, `test_encoding_quatity`, `test_encoding_timedelta`, `test_encoding_timestamp`, `test_encoding_type_with_fully_qualified_name`, `test_encoding_type_without_fully_qualified_name`, `test_encoding_unsupported_type`, `test_encoding_uuid4`, `test_equality_hash_repr`, `test_fully_qualified_name`, `test_importable_config_simple`, `test_importable_strategy_config_typing` *(+6 more)*
**Imports**: `decimal`, `msgspec`, `nautilus_trader.backtest.config`, `nautilus_trader.common`, `nautilus_trader.common.config`, `nautilus_trader.config`, `nautilus_trader.core.uuid`, `nautilus_trader.examples.strategies.ema_cross`, `nautilus_trader.live.config`, `nautilus_trader.model.data`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.objects`, `nautilus_trader.test_kit.providers`, `nautilus_trader.trading.config`, `pandas`, `pytest`

## Related Files

This file is located in `tests/unit_tests/config/`. Related files may include:
...
```bash
# For Python
pytest tests/unit_tests/config/test_common.py
...
---
*Generated on 2025-11-18T21:55:11.303683Z*
