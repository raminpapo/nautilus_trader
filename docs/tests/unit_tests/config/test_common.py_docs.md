# Documentation: `tests/unit_tests/config/test_common.py`
**Generated:** 2025-11-15T19:40:09.071010Z
**File Size:** 11732 bytes
**Extension:** .py
**Type:** text
...
This file is located at `tests/unit_tests/config/test_common.py` within the repository.

**Functions defined:** test_repr_with_redacted_password, test_equality_hash_repr, test_config_id, test_fully_qualified_name, test_json_schema, test_dict, test_json, test_json_primitives, test_importable_config_simple, test_importable_strategy_config_typing and 26 more
...
#### `test_repr_with_redacted_password()`


#### `test_equality_hash_repr()`
...
#### `test_importable_strategy_config_typing()`


#### `test_register_custom_encodings()`


#### `test_register_custom_decodings()`


#### `test_encoding_unsupported_type()`


#### `test_decoding_unsupported_type()`
...
#### `test_encoding_component_id()`


#### `test_decoding_component_id()`


#### `test_encoding_instrument_id()`


#### `test_decoding_instrument_id()`


#### `test_encoding_bar_spec()`


#### `test_decoding_bar_spec()`


#### `test_encoding_bar_type()`


#### `test_decoding_bar_type()`
...
#### `test_encoding_quatity()`


#### `test_decoding_quantity()`


#### `test_encoding_timestamp()`


#### `test_decoding_timestamp()`


#### `test_encoding_timedelta()`


#### `test_decoding_timedelta()`


#### `test_encoding_environment()`


#### `test_decoding_environment()`


#### `test_encoding_type_with_fully_qualified_name()`


#### `test_encoding_type_without_fully_qualified_name()`
...
```python
from tests.unit_tests.config.test_common import test_repr_with_redacted_password
```
...
**Directory:** `tests/unit_tests/config`
...
**Security:** This file may contain sensitive patterns: password, api_key. Ensure proper handling of secrets.
