# Documentation: test_statistics_sharpe_ratio.py
...
### Classes
- **`TestSharpeRatioPortfolioStatistic`**: Class defined in this file
...
**Classs**: `TestSharpeRatioPortfolioStatistic`
**Imports**: `math`, `nautilus_trader.analysis`, `numpy`, `pandas`, `tests.unit_tests.analysis.conftest`
...
```bash
# For Python
pytest tests/unit_tests/analysis/test_statistics_sharpe_ratio.py
...
---
*Generated on 2025-11-18T21:55:11.137028Z*
