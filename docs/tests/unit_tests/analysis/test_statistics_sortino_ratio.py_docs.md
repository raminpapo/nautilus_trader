# Documentation: test_statistics_sortino_ratio.py
...
### Classes
- **`TestSortinoRatioPortfolioStatistic`**: Class defined in this file
...
**Classs**: `TestSortinoRatioPortfolioStatistic`
...
```bash
# For Python
pytest tests/unit_tests/analysis/test_statistics_sortino_ratio.py
...
---
*Generated on 2025-11-18T21:55:11.138474Z*
