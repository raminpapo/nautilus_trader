...
### Functions
- **`convert_series_to_dict()`**: Function defined in this file
...
**Functions**: `convert_series_to_dict`
**Imports**: `pandas`
...
```bash
# For Python
pytest tests/unit_tests/analysis/conftest.py
...
---
*Generated on 2025-11-18T21:55:11.116326Z*
