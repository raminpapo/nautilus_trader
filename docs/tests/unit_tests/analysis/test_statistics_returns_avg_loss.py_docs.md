# Documentation: test_statistics_returns_avg_loss.py
...
### Classes
- **`TestReturnsAverageLossPortfolioStatistic`**: Class defined in this file
...
**Classs**: `TestReturnsAverageLossPortfolioStatistic`
...
```bash
# For Python
pytest tests/unit_tests/analysis/test_statistics_returns_avg_loss.py
...
---
*Generated on 2025-11-18T21:55:11.131696Z*
