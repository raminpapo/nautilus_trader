# Documentation: test_statistics_loser_min.py
...
### Classes
- **`TestMinLoserPortfolioStatistic`**: Class defined in this file
...
**Classs**: `TestMinLoserPortfolioStatistic`
...
```bash
# For Python
pytest tests/unit_tests/analysis/test_statistics_loser_min.py
...
---
*Generated on 2025-11-18T21:55:11.128232Z*
