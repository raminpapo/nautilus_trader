# Documentation: test_statistics_winner_max.py
...
### Classes
- **`TestMaxWinnerPortfolioStatistic`**: Class defined in this file
...
**Classs**: `TestMaxWinnerPortfolioStatistic`
...
```bash
# For Python
pytest tests/unit_tests/analysis/test_statistics_winner_max.py
...
---
*Generated on 2025-11-18T21:55:11.141874Z*
