# Documentation: `tests/unit_tests/analysis/test_statistics_winner_max.py`
**Generated:** 2025-11-15T19:40:08.929216Z
...
- **Path:** `tests/unit_tests/analysis/test_statistics_winner_max.py`
- **Size:** 2,062 bytes
- **Lines:** 64
- **Extension:** `.py`
- **Type:** text
...
This file is located at `tests/unit_tests/analysis/test_statistics_winner_max.py` within the repository.

**Classes defined:** TestMaxWinnerPortfolioStatistic
...
#### `TestMaxWinnerPortfolioStatistic`
...
```python
from tests.unit_tests.analysis.test_statistics_winner_max import TestMaxWinnerPortfolioStatistic
```
