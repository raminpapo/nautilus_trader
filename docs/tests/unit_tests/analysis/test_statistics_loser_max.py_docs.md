# Documentation: `tests/unit_tests/analysis/test_statistics_loser_max.py`
**Generated:** 2025-11-15T19:40:08.914644Z
...
This file is located at `tests/unit_tests/analysis/test_statistics_loser_max.py` within the repository.

**Classes defined:** TestMaxLoserPortfolioStatistic
...
#### `TestMaxLoserPortfolioStatistic`
...
```python
from tests.unit_tests.analysis.test_statistics_loser_max import TestMaxLoserPortfolioStatistic
```
