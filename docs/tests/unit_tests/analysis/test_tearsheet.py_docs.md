# Documentation: test_tearsheet.py

## File Metadata

- **Path**: `tests/unit_tests/analysis/test_tearsheet.py`
- **Size**: 23,795 bytes
- **Lines**: 891
- **Language**: Python
...
This file is part of the NautilusTrader repository. It defines 44 function(s).

## Detailed Walkthrough

### Functions
- **`sample_returns()`**: Function defined in this file
- **`sample_stats()`**: Function defined in this file
- **`test_create_equity_curve_with_valid_data()`**: Function defined in this file
- **`test_create_equity_curve_without_output_path()`**: Function defined in this file
- **`test_create_equity_curve_with_empty_returns()`**: Function defined in this file
- **`test_create_drawdown_chart_with_valid_data()`**: Function defined in this file
- **`test_create_drawdown_chart_calculates_correctly()`**: Function defined in this file
- **`test_create_drawdown_chart_handles_initial_losses()`**: Function defined in this file
- **`test_create_monthly_returns_heatmap_with_valid_data()`**: Function defined in this file
- **`test_create_monthly_returns_heatmap_with_empty_returns()`**: Function defined in this file
- **`test_create_returns_distribution_with_valid_data()`**: Function defined in this file
- **`test_create_tearsheet_raises_import_error_when_plotly_not_available()`**: Function defined in this file
- **`test_create_stats_table()`**: Function defined in this file
- **`test_create_stats_table_formats_numpy_floats()`**: Function defined in this file
- **`test_create_stats_table_handles_booleans()`**: Function defined in this file
- **`test_create_tearsheet_figure_with_valid_data()`**: Function defined in this file
- **`test_create_tearsheet_figure_includes_pnl_stats()`**: Function defined in this file
- **`test_create_tearsheet_from_stats()`**: Function defined in this file
- **`test_create_tearsheet_from_stats_saves_file()`**: Function defined in this file
- **`test_get_theme_with_valid_name()`**: Function defined in this file
...
**Functions**: `sample_returns`, `sample_stats`, `test_create_drawdown_chart_calculates_correctly`, `test_create_drawdown_chart_handles_initial_losses`, `test_create_drawdown_chart_with_valid_data`, `test_create_equity_curve_with_empty_returns`, `test_create_equity_curve_with_valid_data`, `test_create_equity_curve_without_output_path`, `test_create_monthly_returns_heatmap_with_empty_returns`, `test_create_monthly_returns_heatmap_with_valid_data`, `test_create_returns_distribution_with_valid_data`, `test_create_stats_table`, `test_create_stats_table_formats_numpy_floats`, `test_create_stats_table_handles_booleans`, `test_create_tearsheet_figure_includes_pnl_stats`, `test_create_tearsheet_figure_with_valid_data`, `test_create_tearsheet_from_stats`, `test_create_tearsheet_from_stats_saves_file`, `test_create_tearsheet_raises_import_error_when_plotly_not_available`, `test_get_chart_fuzzy_matching_suggests_similar_names`, `test_get_chart_with_invalid_name_raises_error`, `test_get_theme_fuzzy_matching_suggests_similar_names`, `test_get_theme_with_invalid_name_raises_error`, `test_get_theme_with_valid_name`, `test_grid_layout_with_custom_dimensions`, `test_list_charts_returns_all_registered_charts`, `test_list_themes_returns_all_registered_themes`, `test_multi_currency_pnl_stats`, `test_register_chart_and_retrieve`, `test_register_theme_with_custom_theme` *(+14 more)*
**Imports**: `nautilus_trader.analysis.config`, `nautilus_trader.analysis.tearsheet`, `nautilus_trader.analysis.themes`, `nautilus_trader.model.currencies`, `numpy`, `pandas`, `plotly.graph_objects`, `pytest`
...
```bash
# For Python
pytest tests/unit_tests/analysis/test_tearsheet.py
...
---
*Generated on 2025-11-18T21:55:11.146151Z*
