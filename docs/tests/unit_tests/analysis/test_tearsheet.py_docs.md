# Documentation: `tests/unit_tests/analysis/test_tearsheet.py`
**Generated:** 2025-11-15T19:40:08.933309Z
...
This file is located at `tests/unit_tests/analysis/test_tearsheet.py` within the repository.

**Classes defined:** MockEngine, MockPortfolio, MockAnalyzer

**Functions defined:** sample_returns, sample_stats, test_create_equity_curve_with_valid_data, test_create_equity_curve_without_output_path, test_create_equity_curve_with_empty_returns, test_create_drawdown_chart_with_valid_data, test_create_drawdown_chart_calculates_correctly, test_create_drawdown_chart_handles_initial_losses, test_create_monthly_returns_heatmap_with_valid_data, test_create_monthly_returns_heatmap_with_empty_returns and 38 more
...
#### `test_create_equity_curve_with_valid_data(sample_returns, tmp_path)`


#### `test_create_equity_curve_without_output_path(sample_returns)`


#### `test_create_equity_curve_with_empty_returns()`


#### `test_create_drawdown_chart_with_valid_data(sample_returns, tmp_path)`


#### `test_create_drawdown_chart_calculates_correctly(sample_returns)`


#### `test_create_drawdown_chart_handles_initial_losses()`


#### `test_create_monthly_returns_heatmap_with_valid_data(sample_returns, tmp_path)`


#### `test_create_monthly_returns_heatmap_with_empty_returns()`


#### `test_create_returns_distribution_with_valid_data(sample_returns, tmp_path)`


#### `test_create_tearsheet_raises_import_error_when_plotly_not_available(monkeypatch)`


#### `get_performance_stats_returns(self)`


#### `get_performance_stats_general(self)`


#### `returns(self)`


#### `test_create_stats_table(sample_stats)`


#### `test_create_stats_table_formats_numpy_floats()`


#### `test_create_stats_table_handles_booleans()`


#### `test_create_tearsheet_figure_with_valid_data(sample_returns, sample_stats)`


#### `test_create_tearsheet_figure_includes_pnl_stats(sample_returns)`


#### `test_create_tearsheet_from_stats(sample_returns, sample_stats)`


#### `test_create_tearsheet_from_stats_saves_file(sample_returns, sample_stats, tmp_path)`


#### `test_get_theme_with_valid_name()`


#### `test_get_theme_with_invalid_name_raises_error()`


#### `test_get_theme_fuzzy_matching_suggests_similar_names()`


#### `test_list_themes_returns_all_registered_themes()`


#### `test_register_theme_with_custom_theme()`


#### `test_theme_normalization_provides_table_color_defaults()`


#### `test_theme_normalization_preserves_existing_table_colors()`


#### `test_theme_normalization_handles_dark_backgrounds()`


#### `test_register_chart_and_retrieve()`


#### `custom_chart(returns, output_path=None, title="Custom", theme="plotly_white")`


#### `test_get_chart_with_invalid_name_raises_error()`


#### `test_get_chart_fuzzy_matching_suggests_similar_names()`


#### `test_list_charts_returns_all_registered_charts()`


#### `test_tearsheet_config_with_defaults()`


#### `test_tearsheet_config_with_custom_values()`


#### `test_grid_layout_with_custom_dimensions()`


#### `test_tearsheet_config_with_grid_layout()`


#### `test_single_currency_pnl_stats(sample_returns)`


#### `test_multi_currency_pnl_stats(sample_returns)`


#### `test_run_info_filtered_when_no_metadata(sample_returns)`


#### `test_run_info_kept_when_metadata_provided(sample_returns)`


#### `test_run_info_kept_when_account_info_provided(sample_returns)`


#### `test_tearsheet_with_benchmark_overlay(sample_returns)`


#### `test_tearsheet_with_custom_grid_layout(sample_returns)`


#### `test_tearsheet_with_multi_currency_stats(sample_returns)`


#### `test_tearsheet_with_all_themes(sample_returns)`
...
```python
from tests.unit_tests.analysis.test_tearsheet import MockEngine
```
