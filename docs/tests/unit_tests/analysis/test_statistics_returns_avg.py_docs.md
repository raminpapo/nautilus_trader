# Documentation: test_statistics_returns_avg.py
...
### Classes
- **`TestReturnsAveragePortfolioStatistic`**: Class defined in this file
...
**Classs**: `TestReturnsAveragePortfolioStatistic`
...
```bash
# For Python
pytest tests/unit_tests/analysis/test_statistics_returns_avg.py
...
---
*Generated on 2025-11-18T21:55:11.130564Z*
