# Documentation: test_statistics_winner_min.py
...
### Classes
- **`TestMinWinnerPortfolioStatistic`**: Class defined in this file
...
**Classs**: `TestMinWinnerPortfolioStatistic`
...
```bash
# For Python
pytest tests/unit_tests/analysis/test_statistics_winner_min.py
...
---
*Generated on 2025-11-18T21:55:11.143034Z*
