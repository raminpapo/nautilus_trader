# Documentation: `tests/unit_tests/analysis/test_statistics_winner_min.py`
**Generated:** 2025-11-15T19:40:08.930291Z
...
- **Path:** `tests/unit_tests/analysis/test_statistics_winner_min.py`
- **Size:** 2,062 bytes
- **Lines:** 64
- **Extension:** `.py`
- **Type:** text
...
This file is located at `tests/unit_tests/analysis/test_statistics_winner_min.py` within the repository.

**Classes defined:** TestMinWinnerPortfolioStatistic

**Functions defined:** test_name_returns_expected_returns_expected, test_calculate_given_empty_series_returns_zero, test_calculate_given_mix_of_pnls1_returns_expected, test_calculate_given_mix_of_pnls2_returns_expected
...
#### `TestMinWinnerPortfolioStatistic`
...
```python
from tests.unit_tests.analysis.test_statistics_winner_min import TestMinWinnerPortfolioStatistic
```
