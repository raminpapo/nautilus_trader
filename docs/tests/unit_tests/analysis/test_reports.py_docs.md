# Documentation: `tests/unit_tests/analysis/test_reports.py`
**Generated:** 2025-11-15T19:40:08.908343Z
**File Size:** 17121 bytes
**Extension:** .py
**Type:** text
...
- **Path:** `tests/unit_tests/analysis/test_reports.py`
- **Size:** 17,121 bytes
- **Lines:** 463
- **Extension:** `.py`
- **Type:** text
...
This file is located at `tests/unit_tests/analysis/test_reports.py` within the repository.

**Classes defined:** TestReportProvider

**Functions defined:** setup, test_generate_accounts_report_with_initial_account_state_returns_expected, test_generate_orders_report_with_no_order_returns_empty_dataframe, test_generate_orders_fills_report_with_no_order_returns_empty_dataframe, test_generate_fills_report_with_no_fills_returns_empty_dataframe, test_generate_positions_report_with_no_positions_returns_empty_dataframe, test_generate_orders_report, test_generate_order_fills_report, test_generate_fills_report, test_generate_positions_report and 1 more
...
#### `test_generate_accounts_report_with_initial_account_state_returns_expected(self)`


#### `test_generate_orders_report_with_no_order_returns_empty_dataframe(self)`


#### `test_generate_orders_fills_report_with_no_order_returns_empty_dataframe(self)`


#### `test_generate_fills_report_with_no_fills_returns_empty_dataframe(self)`


#### `test_generate_positions_report_with_no_positions_returns_empty_dataframe(self)`


#### `test_generate_orders_report(self)`


#### `test_generate_order_fills_report(self)`


#### `test_generate_fills_report(self)`


#### `test_generate_positions_report(self)`


#### `test_generate_positions_report_with_snapshots(self)`
...
```python
from tests.unit_tests.analysis.test_reports import TestReportProvider
```
