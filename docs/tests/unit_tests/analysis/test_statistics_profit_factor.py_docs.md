# Documentation: test_statistics_profit_factor.py
...
### Classes
- **`TestProfitFactorPortfolioStatistic`**: Class defined in this file
...
**Classs**: `TestProfitFactorPortfolioStatistic`
...
```bash
# For Python
pytest tests/unit_tests/analysis/test_statistics_profit_factor.py
...
---
*Generated on 2025-11-18T21:55:11.129418Z*
