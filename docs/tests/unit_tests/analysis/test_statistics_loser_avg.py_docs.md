# Documentation: test_statistics_loser_avg.py
...
### Classes
- **`TestAvgLoserPortfolioStatistic`**: Class defined in this file
...
**Classs**: `TestAvgLoserPortfolioStatistic`
...
```bash
# For Python
pytest tests/unit_tests/analysis/test_statistics_loser_avg.py
...
---
*Generated on 2025-11-18T21:55:11.125558Z*
