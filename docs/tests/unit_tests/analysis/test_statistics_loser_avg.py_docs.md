# Documentation: `tests/unit_tests/analysis/test_statistics_loser_avg.py`
**Generated:** 2025-11-15T19:40:08.913373Z
...
- **Path:** `tests/unit_tests/analysis/test_statistics_loser_avg.py`
- **Size:** 1,763 bytes
- **Lines:** 53
- **Extension:** `.py`
- **Type:** text
...
This file is located at `tests/unit_tests/analysis/test_statistics_loser_avg.py` within the repository.

**Classes defined:** TestAvgLoserPortfolioStatistic
...
#### `TestAvgLoserPortfolioStatistic`
...
```python
from tests.unit_tests.analysis.test_statistics_loser_avg import TestAvgLoserPortfolioStatistic
```
