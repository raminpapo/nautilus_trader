# Documentation: `tests/unit_tests/analysis/test_statistics_winner_avg.py`
**Generated:** 2025-11-15T19:40:08.928137Z
...
- **Path:** `tests/unit_tests/analysis/test_statistics_winner_avg.py`
- **Size:** 2,077 bytes
- **Lines:** 64
- **Extension:** `.py`
- **Type:** text
...
This file is located at `tests/unit_tests/analysis/test_statistics_winner_avg.py` within the repository.

**Classes defined:** TestAvgWinnerPortfolioStatistic
...
#### `TestAvgWinnerPortfolioStatistic`
...
```python
from tests.unit_tests.analysis.test_statistics_winner_avg import TestAvgWinnerPortfolioStatistic
```
