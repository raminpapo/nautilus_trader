# Documentation: test_statistics_winner_avg.py
...
### Classes
- **`TestAvgWinnerPortfolioStatistic`**: Class defined in this file
...
**Classs**: `TestAvgWinnerPortfolioStatistic`
...
```bash
# For Python
pytest tests/unit_tests/analysis/test_statistics_winner_avg.py
...
---
*Generated on 2025-11-18T21:55:11.140767Z*
