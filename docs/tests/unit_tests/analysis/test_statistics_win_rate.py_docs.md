# Documentation: `tests/unit_tests/analysis/test_statistics_win_rate.py`
**Generated:** 2025-11-15T19:40:08.926992Z
...
- **Path:** `tests/unit_tests/analysis/test_statistics_win_rate.py`
- **Size:** 2,048 bytes
- **Lines:** 64
- **Extension:** `.py`
- **Type:** text
...
This file is located at `tests/unit_tests/analysis/test_statistics_win_rate.py` within the repository.

**Classes defined:** TestWinRatePortfolioStatistic
...
```python
from tests.unit_tests.analysis.test_statistics_win_rate import TestWinRatePortfolioStatistic
```
