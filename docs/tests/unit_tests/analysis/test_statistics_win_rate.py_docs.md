# Documentation: test_statistics_win_rate.py
...
### Classes
- **`TestWinRatePortfolioStatistic`**: Class defined in this file
...
**Classs**: `TestWinRatePortfolioStatistic`
...
```bash
# For Python
pytest tests/unit_tests/analysis/test_statistics_win_rate.py
...
---
*Generated on 2025-11-18T21:55:11.139629Z*
