...
**Identifiers**: `AGGREGATION_SOURCE`, `AGGRESSOR_SIDE`, `ASSET_CLASS`, `BAR_AGGREGATION`, `BIGINT`, `BIGSERIAL`, `BLOCKCHAIN`, `BOOLEAN`, `BYTEA`, `CASCADE`, `CREATE`, `CURRENCY_TYPE`, `CURRENT_TIMESTAMP`, `DEFAULT`, `DELETE`, `DOUBLE`, `EXISTS`, `FALSE`, `FOREIGN`, `I128`, `I256`, `INDEX`, `INTEGER`, `JSONB`, `KEY`, `LIST`, `NOT`, `NULL`, `NUMERIC`, `PARTITION` *(+16 more)*
...
---
*Generated on 2025-11-18T21:55:06.121708Z*
