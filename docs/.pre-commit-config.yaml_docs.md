...
**Generated:** 2025-11-15T19:40:00.223580Z
**File Size:** 10371 bytes
**Extension:** .yaml
**Type:** text
...
repos:
  ...
  - repo: https://github.com/astral-sh/uv-pre-commit
    rev: 0.9.9 # Must match uv-version file
    hooks:
      - id: uv-lock
...
This file is located at `.pre-commit-config.yaml` within the repository.
