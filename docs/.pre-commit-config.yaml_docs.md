...
repos:
  ...
  - repo: https://github.com/astral-sh/uv-pre-commit
    rev: 0.9.10 # Must match uv-version file
    hooks:
      - id: uv-lock
...
**Identifiers**: `Actions`, `Arabic`, `CJK`, `CLA`, `CONTRIBUTING`, `Cargo`, `Check`, `Checks`, `Clippy`, `ComPWA`, `Custom`, `Cyrillic`, `Cython`, `DavidAnson`, `Detect`, `Detects`, `Disabling`, `Dockerfile`, `Dockerfiles`, `EmbarkStudios`, `Enforces`, `English`, `Ensures`, `Fail`, `Format`, `General`, `GitHub`, `Latin`, `Lint`, `Markdown` *(+13 more)*
...
---
*Generated on 2025-11-18T21:54:58.837949Z*
