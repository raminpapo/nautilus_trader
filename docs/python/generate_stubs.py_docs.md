# Documentation: `python/generate_stubs.py`
**Generated:** 2025-11-15T19:40:05.426698Z
...
This file is located at `python/generate_stubs.py` within the repository.

**Classes defined:** StubFixup

**Functions defined:** run_command, load_pyproject, resolve_python_stub_root, generate_stubs, relocate_package_stubs, _reassign_module_names, relocate_class_stubs, extract_class_blocks, rename_methods, normalize_type_hints and 3 more
...
#### `run_command(cmd, cwd=None, check=True)`


#### `load_pyproject()`


#### `resolve_python_stub_root(pyproject: dict)`


#### `generate_stubs()`


#### `relocate_package_stubs(dest_dir: Path)`


#### `_reassign_module_names()`


#### `relocate_class_stubs(root: Path)`


#### `extract_class_blocks(source: str, class_names: tuple[str, ...])`


#### `rename_methods(block: str)`


#### `normalize_type_hints(content: str)`
...
```python
from python.generate_stubs import StubFixup
```
