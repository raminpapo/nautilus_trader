# Documentation: generate_stubs.py

## File Metadata

- **Path**: `python/generate_stubs.py`
- **Size**: 11,095 bytes
- **Lines**: 380
- **Language**: Python
...
### Functions
- **`run_command()`**: Function defined in this file
- **`load_pyproject()`**: Function defined in this file
- **`resolve_python_stub_root()`**: Function defined in this file
- **`generate_stubs()`**: Function defined in this file
- **`relocate_package_stubs()`**: Function defined in this file
- **`_reassign_module_names()`**: Function defined in this file
- **`relocate_class_stubs()`**: Function defined in this file
- **`extract_class_blocks()`**: Function defined in this file
- **`rename_methods()`**: Function defined in this file
- **`normalize_type_hints()`**: Function defined in this file
- **`apply_runtime_module_fixups()`**: Function defined in this file
- **`build_extension()`**: Function defined in this file
- **`main()`**: Function defined in this file

### Classes
- **`StubFixup`**: Class defined in this file
...
**Classs**: `StubFixup`
**Functions**: `_reassign_module_names`, `apply_runtime_module_fixups`, `build_extension`, `extract_class_blocks`, `generate_stubs`, `load_pyproject`, `main`, `normalize_type_hints`, `relocate_class_stubs`, `relocate_package_stubs`, `rename_methods`, `resolve_python_stub_root`, `run_command`
**Imports**: `argparse`, `dataclasses`, `pathlib`, `re`, `subprocess`, `sys`, `tomllib`

## Related Files

This file is located in `python/`. Related files may include:
...
---
*Generated on 2025-11-18T21:55:06.051789Z*
