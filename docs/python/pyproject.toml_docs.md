...
**Keys**: `authors`, `build-backend`, `classifiers`, `dependencies`, `description`, `dev`, `disallow_incomplete_defs`, `docs`, `dummy-variable-rgx`, `exclude`, `explicit_package_bases`, `features`, `fixable`, `force-single-line`, `force-sort-within-sections`, `homepage`, `ignore`, `ignore_missing_imports`, `include`, `known-first-party`, `license`, `line-length`, `lines-after-imports`, `manifest-path`, `max-complexity`, `module-name`, `name`, `namespace_packages`, `pre-build`, `python-source` *(+15 more)*
**Sections**: `build-system`, `dependency-groups`, `project`, `project.urls`, `tool.maturin`, `tool.maturin.scripts`, `tool.mypy`, `tool.ruff`, `tool.ruff.lint`, `tool.ruff.lint.isort`, `tool.ruff.lint.mccabe`
...
---
*Generated on 2025-11-18T21:55:06.098029Z*
