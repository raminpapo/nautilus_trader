# Documentation: `python/examples/blockchain/node_test_factory.py`
**Generated:** 2025-11-15T19:40:05.423736Z
...
This file is located at `python/examples/blockchain/node_test_factory.py` within the repository.

**Functions defined:** test_factory_approach
...
```python
from python.examples.blockchain.node_test_factory import test_factory_approach
```
