# Documentation: `python/examples/blockchain/actors.py`
**Generated:** 2025-11-15T19:40:05.419044Z
...
- **Path:** `python/examples/blockchain/actors.py`
- **Size:** 6,559 bytes
- **Lines:** 156
- **Extension:** `.py`
- **Type:** text
...
This file is located at `python/examples/blockchain/actors.py` within the repository.

**Classes defined:** BlockchainActorConfig, BlockchainActor

**Functions defined:** __post_init__, __init__, on_start, on_stop, on_time_event, on_pool, on_block, on_pool_swap, on_pool_liquidity_update, on_pool_fee_collect and 1 more
...
#### `BlockchainActorConfig`

**Inherits from:** DataActorConfig
...
#### `__init__(self, config: BlockchainActorConfig | None = None)`
...
#### `on_time_event(self, event)`


#### `on_pool(self, pool)`


#### `on_block(self, block: Block)`


#### `on_pool_swap(self, swap: PoolSwap)`


#### `on_pool_liquidity_update(self, update: PoolLiquidityUpdate)`


#### `on_pool_fee_collect(self, update: PoolFeeCollect)`


#### `on_pool_flash(self, event: PoolFlash)`
...
```python
from python.examples.blockchain.actors import BlockchainActorConfig
```
...
**Directory:** `python/examples/blockchain`
