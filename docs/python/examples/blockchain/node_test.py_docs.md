...
**Functions**: `main`
**Imports**: `dotenv`, `nautilus_trader.adapters.blockchain`, `nautilus_trader.common`, `nautilus_trader.infrastructure`, `nautilus_trader.live`, `nautilus_trader.model`, `os`
...
```bash
# For Python
pytest python/examples/blockchain/node_test.py
...
---
*Generated on 2025-11-18T21:55:06.048618Z*
