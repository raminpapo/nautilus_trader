...
**Identifiers**: `Arguments`, `BurntSushi`, `Check`, `Create`, `DRY`, `DRY_RUN`, `Detect`, `EOF`, `ESCAPED_PATTERN`, `ESCAPED_REPLACEMENT`, `EXIT`, `Error`, `Escape`, `Examples`, `Expected`, `Find`, `Found`, `IFS`, `Install`, `Linux`, `OPTIONS`, `OSTYPE`, `Options`, `PATH`, `PATTERN`, `Parse`, `Perform`, `REPLACEMENT`, `RUN`, `Read` *(+12 more)*
...
---
*Generated on 2025-11-18T21:55:06.158590Z*
