# Documentation: curate-dataset.sh

## File Metadata

- **Path**: `scripts/curate-dataset.sh`
- **Size**: 2,422 bytes
- **Lines**: 76
- **Language**: Shell
...
**Identifiers**: `Compute`, `Create`, `Curate`, `Dataset`, `Download`, `Downloading`, `Example`, `JSON`, `LICENCE`, `LICENSE`, `Licence`, `NautilusTrader`, `Notes`, `Only`, `Original`, `Output`, `Positional`, `SHA`, `The`, `This`, `URL`, `Usage`, `Write`
...
---
*Generated on 2025-11-18T21:55:06.157171Z*
