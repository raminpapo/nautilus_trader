# Documentation: publish-wheels-generate-index.sh

## File Metadata

- **Path**: `scripts/ci/publish-wheels-generate-index.sh`
- **Size**: 3,624 bytes
- **Lines**: 95
- **Language**: Shell
...
**Identifiers**: `BASH_REMATCH`, `CLOUDFLARE_R2_BUCKET_NAME`, `CLOUDFLARE_R2_PREFIX`, `CLOUDFLARE_R2_URL`, `Calculated`, `Could`, `Create`, `DOCTYPE`, `Download`, `EXIT`, `Existing`, `Extract`, `Extracting`, `First`, `For`, `Found`, `Generate`, `Generating`, `Get`, `IFS`, `Index`, `Map`, `NautilusTrader`, `Only`, `Packages`, `Sort`, `TEMP_DIR`, `These`, `Using`, `Warning`
...
---
*Generated on 2025-11-18T21:55:06.146013Z*
