# Documentation: publish-cli-r2-upload.sh

## File Metadata

- **Path**: `scripts/ci/publish-cli-r2-upload.sh`
- **Size**: 5,991 bytes
- **Lines**: 204
- **Language**: Shell
...
**Identifiers**: `ART_DIR`, `Artifacts`, `BASE_HTTP`, `BASE_VERSION`, `BRANCH_NAME`, `BUCKET`, `Base`, `CLI`, `CLOUDFLARE_R2_BUCKET_NAME`, `CLOUDFLARE_R2_PREFIX`, `CLOUDFLARE_R2_URL`, `Cargo`, `Cloudflare`, `Computed`, `Copy`, `Create`, `Ensure`, `Extract`, `FILES`, `Failed`, `Found`, `GITHUB_REF_NAME`, `GITHUB_RUN_NUMBER`, `LATEST_CACHE_CONTROL`, `LATEST_LIST`, `MANIFEST`, `Normalize`, `PREFIX`, `Prepare`, `Publish` *(+7 more)*
...
---
*Generated on 2025-11-18T21:55:06.142184Z*
