# Documentation: check_non_latin_text.sh

## File Metadata

- **Path**: `.pre-commit-hooks/check_non_latin_text.sh`
- **Size**: 1,313 bytes
- **Lines**: 44
- **Language**: Shell
...
**Identifiers**: `AC00`, `Arabic`, `CJK`, `Check`, `Contains`, `Cyrillic`, `D7AF`, `ERROR`, `English`, `Highlights`, `Latin`, `Linux`, `Skip`, `The`, `This`, `UTF`, `Use`, `Uses`, `WARNING`
...
---
*Generated on 2025-11-18T21:54:58.848263Z*
