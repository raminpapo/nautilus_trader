# Documentation: `.pre-commit-hooks/check_hidden_chars.sh`
**Generated:** 2025-11-15T19:40:00.228458Z
...
This file is located at `.pre-commit-hooks/check_hidden_chars.sh` within the repository.
