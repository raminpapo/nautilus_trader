# Documentation: `nautilus_trader/analysis/themes.py`
**Generated:** 2025-11-15T19:40:04.530046Z
**File Size:** 6392 bytes
**Extension:** .py
**Type:** text
...
- **Path:** `nautilus_trader/analysis/themes.py`
- **Size:** 6,392 bytes
- **Lines:** 195
- **Extension:** `.py`
- **Type:** text
...
This file is located at `nautilus_trader/analysis/themes.py` within the repository.

**Functions defined:** get_theme, register_theme, list_themes
...
#### `register_theme(name: str, template: str, colors: dict[str, str])`
