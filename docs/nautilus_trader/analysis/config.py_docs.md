# Documentation: `nautilus_trader/analysis/config.py`
**Generated:** 2025-11-15T19:40:04.517961Z
...
- **Path:** `nautilus_trader/analysis/config.py`
- **Size:** 4,281 bytes
- **Lines:** 113
- **Extension:** `.py`
- **Type:** text
...
This file is located at `nautilus_trader/analysis/config.py` within the repository.

**Classes defined:** GridLayout, TearsheetConfig

**Functions defined:** _default_heights, _default_charts
...
**Inherits from:** msgspec.Struct, frozen=True, kw_only=True


#### `TearsheetConfig`

**Inherits from:** NautilusConfig, frozen=True, kw_only=True
