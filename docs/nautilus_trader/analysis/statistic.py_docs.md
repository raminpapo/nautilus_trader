# Documentation: `nautilus_trader/analysis/statistic.py`
**Generated:** 2025-11-15T19:40:04.521795Z
...
This file is located at `nautilus_trader/analysis/statistic.py` within the repository.

**Classes defined:** PortfolioStatistic

**Functions defined:** fully_qualified_name, name, calculate_from_returns, calculate_from_realized_pnls, calculate_from_orders, calculate_from_positions, _check_valid_returns, _downsample_to_daily_bins
...
#### `calculate_from_returns(self, returns: pd.Series)`


#### `calculate_from_realized_pnls(self, realized_pnls: pd.Series)`


#### `calculate_from_orders(self, orders: list[Order])`


#### `calculate_from_positions(self, positions: list[Position])`


#### `_check_valid_returns(self, returns: pd.Series)`


#### `_downsample_to_daily_bins(self, returns: pd.Series)`
