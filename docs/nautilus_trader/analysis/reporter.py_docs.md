# Documentation: `nautilus_trader/analysis/reporter.py`
**Generated:** 2025-11-15T19:40:04.519980Z
...
- **Path:** `nautilus_trader/analysis/reporter.py`
- **Size:** 6,309 bytes
- **Lines:** 206
- **Extension:** `.py`
- **Type:** text
...
This file is located at `nautilus_trader/analysis/reporter.py` within the repository.

**Classes defined:** ReportProvider

**Functions defined:** generate_orders_report, generate_order_fills_report, generate_fills_report, generate_positions_report, generate_account_report
...
#### `generate_orders_report(orders: list[Order])`


#### `generate_order_fills_report(orders: list[Order])`


#### `generate_fills_report(orders: list[Order])`
...
#### `generate_account_report(account: Account)`
