# Documentation: tearsheet.py

## File Metadata

- **Path**: `nautilus_trader/analysis/tearsheet.py`
- **Size**: 58,920 bytes
- **Lines**: 2,002
- **Language**: Python
...
### Functions
- **`_hex_to_rgba()`**: Function defined in this file
- **`_normalize_theme_config()`**: Function defined in this file
- **`_calculate_drawdown()`**: Function defined in this file
- **`register_chart()`**: Function defined in this file
- **`get_chart()`**: Function defined in this file
- **`list_charts()`**: Function defined in this file
- **`create_tearsheet()`**: Function defined in this file
- **`create_tearsheet_from_stats()`**: Function defined in this file
- **`create_equity_curve()`**: Function defined in this file
- **`create_drawdown_chart()`**: Function defined in this file
- **`create_monthly_returns_heatmap()`**: Function defined in this file
- **`create_returns_distribution()`**: Function defined in this file
- **`create_rolling_sharpe()`**: Function defined in this file
- **`create_yearly_returns()`**: Function defined in this file
- **`_create_tearsheet_figure()`**: Function defined in this file
- **`_create_stats_table()`**: Function defined in this file
- **`_render_run_info()`**: Function defined in this file
- **`_render_stats_table()`**: Function defined in this file
- **`_render_equity()`**: Function defined in this file
- **`_render_drawdown()`**: Function defined in this file
...
**Functions**: `_add_fill_scatter_trace`, `_calculate_drawdown`, `_calculate_grid_layout`, `_create_stats_table`, `_create_tearsheet_figure`, `_hex_to_rgba`, `_normalize_theme_config`, `_register_tearsheet_chart`, `_render_bars_with_fills`, `_render_distribution`, `_render_drawdown`, `_render_equity`, `_render_monthly_returns`, `_render_rolling_sharpe`, `_render_run_info`, `_render_stats_table`, `_render_yearly_returns`, `create_bars_with_fills`, `create_drawdown_chart`, `create_equity_curve`, `create_monthly_returns_heatmap`, `create_returns_distribution`, `create_rolling_sharpe`, `create_tearsheet`, `create_tearsheet_from_stats`, `create_yearly_returns`, `get_chart`, `list_charts`, `register_chart`
**Imports**: `__future__`, `collections.abc`, `difflib`, `nautilus_trader.core.correctness`, `nautilus_trader.model.data`, `numbers`, `pandas`, `typing`
...
---
*Generated on 2025-11-18T21:55:05.025597Z*
