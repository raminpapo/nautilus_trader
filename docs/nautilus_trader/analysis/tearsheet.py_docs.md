# Documentation: `nautilus_trader/analysis/tearsheet.py`
**Generated:** 2025-11-15T19:40:04.527938Z
**File Size:** 58920 bytes
**Extension:** .py
**Type:** text
...
This file is located at `nautilus_trader/analysis/tearsheet.py` within the repository.

**Functions defined:** _hex_to_rgba, _normalize_theme_config, _calculate_drawdown, register_chart, decorator, get_chart, list_charts, create_tearsheet, create_tearsheet_from_stats, create_equity_curve and 22 more
...
#### `_hex_to_rgba(hex_color: str, alpha: float = 1.0)`


#### `_normalize_theme_config(theme_config: dict[str, Any])`


#### `_calculate_drawdown(returns: pd.Series)`


#### `register_chart(name: str, func: Callable | None = None)`
...
#### `add_section(title: str, section_stats: dict[str, Any])`
...
#### `add_section(title: str, section_data: dict[str, Any])`
...
```python
from nautilus_trader.analysis.tearsheet import _hex_to_rgba
```
