# Documentation: `nautilus_trader/analysis/analyzer.py`
**Generated:** 2025-11-15T19:40:04.516354Z
**File Size:** 16824 bytes
**Extension:** .py
**Type:** text
...
- **Path:** `nautilus_trader/analysis/analyzer.py`
- **Size:** 16,824 bytes
- **Lines:** 519
- **Extension:** `.py`
- **Type:** text
...
This file is located at `nautilus_trader/analysis/analyzer.py` within the repository.

**Classes defined:** PortfolioAnalyzer

**Functions defined:** __init__, register_statistic, deregister_statistic, deregister_statistics, reset, _get_max_length_name, currencies, statistic, returns, calculate_statistics and 12 more
...
#### `register_statistic(self, statistic: PortfolioStatistic)`


#### `deregister_statistic(self, statistic: PortfolioStatistic)`


#### `deregister_statistics(self)`


#### `reset(self)`


#### `_get_max_length_name(self)`
...
#### `calculate_statistics(self, account: Account, positions: list[Position])`


#### `add_positions(self, positions: list[Position])`


#### `add_trade(self, position_id: PositionId, realized_pnl: Money)`


#### `add_return(self, timestamp: datetime, value: float)`


#### `realized_pnls(self, currency: Currency | None = None)`
...
**Directory:** `nautilus_trader/analysis`
