# Documentation: averages.pyx

## File Metadata

- **Path**: `nautilus_trader/indicators/averages.pyx`
- **Size**: 27,115 bytes
- **Lines**: 951
- **Language**: Unknown
...
**Identifiers**: `AMA`, `ANY`, `AdaptiveMovingAverage`, `Alan`, `All`, `Average`, `BASIS`, `Bar`, `CMO`, `CONDITIONS`, `Calculate`, `Chande`, `ChandeMomentumOscillator`, `Check`, `Condition`, `Copyright`, `Create`, `DOUBLE_EXPONENTIAL`, `Developed`, `Double`, `DoubleExponentialMovingAverage`, `Dynamic`, `EMA`, `EXPONENTIAL`, `EfficiencyRatio`, `Exponential`, `ExponentialMovingAverage`, `GNU`, `General`, `HMA` *(+60 more)*
...
---
*Generated on 2025-11-18T21:55:05.533830Z*
