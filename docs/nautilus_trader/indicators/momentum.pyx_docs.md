# Documentation: momentum.pyx

## File Metadata

- **Path**: `nautilus_trader/indicators/momentum.pyx`
- **Size**: 22,807 bytes
- **Lines**: 818
- **Language**: Unknown
...
**Identifiers**: `ADAPTIVE`, `ANY`, `Add`, `All`, `Attempts`, `BASIS`, `Bar`, `CONDITIONS`, `Calculate`, `ChandeMomentumOscillator`, `Channel`, `Check`, `Commodity`, `CommodityChannelIndex`, `Condition`, `Copyright`, `DOUBLE_EXPONENTIAL`, `Divide`, `EXPONENTIAL`, `Efficiency`, `EfficiencyRatio`, `False`, `GNU`, `General`, `HULL`, `Helper`, `Index`, `Indicator`, `Initialization`, `Instead` *(+45 more)*
...
---
*Generated on 2025-11-18T21:55:05.548882Z*
