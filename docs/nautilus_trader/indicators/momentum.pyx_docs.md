# Documentation: `nautilus_trader/indicators/momentum.pyx`
**Generated:** 2025-11-15T19:40:04.960486Z
**File Size:** 22807 bytes
**Extension:** .pyx
**Type:** text
...
This file is located at `nautilus_trader/indicators/momentum.pyx` within the repository.
...
#### `__init__(self, int period, bint use_log=False)`
...
#### `__init__(self, int period_k, int period_d)`
