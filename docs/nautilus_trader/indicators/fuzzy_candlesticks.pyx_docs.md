# Documentation: fuzzy_candlesticks.pyx

## File Metadata

- **Path**: `nautilus_trader/indicators/fuzzy_candlesticks.pyx`
- **Size**: 12,436 bytes
- **Lines**: 368
- **Language**: Unknown
...
**Identifiers**: `ANY`, `All`, `BASIS`, `BODY_LARGE`, `BODY_MEDIUM`, `BODY_NONE`, `BODY_SMALL`, `BODY_TREND`, `Bar`, `CONDITIONS`, `Calculate`, `CandleBodySize`, `CandleDirection`, `CandleSize`, `CandleWickSize`, `Condition`, `Copyright`, `Create`, `DIRECTION_BEAR`, `DIRECTION_BULL`, `DIRECTION_NONE`, `Determine`, `False`, `Fuzzify`, `FuzzyCandle`, `FuzzyCandlesticks`, `GNU`, `General`, `Indicator`, `Initialization` *(+37 more)*
...
---
*Generated on 2025-11-18T21:55:05.541433Z*
