# Documentation: trend.pyx

## File Metadata

- **Path**: `nautilus_trader/indicators/trend.pyx`
- **Size**: 22,326 bytes
- **Lines**: 768
- **Language**: Unknown
...
**Identifiers**: `ADAPTIVE`, `ANY`, `All`, `Archer`, `ArcherMovingAveragesTrends`, `Aroon`, `AroonDown`, `AroonOscillator`, `AroonUp`, `Averages`, `BASIS`, `Bar`, `Bias`, `CONDITIONS`, `Calculate`, `Chande`, `Compute`, `Condition`, `Convert`, `Copyright`, `DOUBLE_EXPONENTIAL`, `Different`, `DirectionalMovement`, `EXPONENTIAL`, `False`, `GNU`, `General`, `HULL`, `Indicator`, `Initialization` *(+48 more)*
...
---
*Generated on 2025-11-18T21:55:05.555494Z*
