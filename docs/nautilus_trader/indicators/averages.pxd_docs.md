...
**Identifiers**: `ADAPTIVE`, `ANY`, `AdaptiveMovingAverage`, `All`, `BASIS`, `CONDITIONS`, `ChandeMomentumOscillator`, `Copyright`, `DOUBLE_EXPONENTIAL`, `DoubleExponentialMovingAverage`, `EXPONENTIAL`, `EfficiencyRatio`, `ExponentialMovingAverage`, `GNU`, `General`, `HULL`, `HullMovingAverage`, `Indicator`, `KIND`, `Lesser`, `License`, `Licensed`, `Ltd`, `MovingAverage`, `MovingAverageFactory`, `MovingAverageType`, `Nautech`, `PriceType`, `Pty`, `Public` *(+16 more)*
...
---
*Generated on 2025-11-18T21:55:05.530135Z*
