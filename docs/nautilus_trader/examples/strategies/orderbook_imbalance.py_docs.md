# Documentation: orderbook_imbalance.py

## File Metadata

- **Path**: `nautilus_trader/examples/strategies/orderbook_imbalance.py`
- **Size**: 9,646 bytes
- **Lines**: 237
- **Language**: Python
...
**Imports**: `datetime`, `decimal`, `nautilus_trader.config`, `nautilus_trader.core.rust.common`, `nautilus_trader.model.book`, `nautilus_trader.model.data`, `nautilus_trader.model.enums`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.instruments`, `nautilus_trader.model.objects`, `nautilus_trader.trading.strategy`
...
---
*Generated on 2025-11-18T21:55:05.450445Z*
