# Documentation: `nautilus_trader/examples/strategies/simpler_quoter.py`
**Generated:** 2025-11-15T19:40:04.884038Z
**File Size:** 4643 bytes
**Extension:** .py
**Type:** text
...
This file is located at `nautilus_trader/examples/strategies/simpler_quoter.py` within the repository.

**Classes defined:** SimpleQuoterStrategyConfig, SimpleQuoterStrategy

**Functions defined:** __init__, on_start, on_quote_tick, on_event, on_stop
...
#### `SimpleQuoterStrategyConfig`

**Inherits from:** StrategyConfig, frozen=True


#### `SimpleQuoterStrategy`
...
#### `__init__(self, config: SimpleQuoterStrategyConfig)`
