# Documentation: `nautilus_trader/examples/strategies/volatility_market_maker.py`
**Generated:** 2025-11-15T19:40:04.888372Z
**File Size:** 13370 bytes
**Extension:** .py
**Type:** text
...
- **Path:** `nautilus_trader/examples/strategies/volatility_market_maker.py`
- **Size:** 13,370 bytes
- **Lines:** 380
- **Extension:** `.py`
- **Type:** text
...
This file is located at `nautilus_trader/examples/strategies/volatility_market_maker.py` within the repository.

**Classes defined:** VolatilityMarketMakerConfig, VolatilityMarketMaker

**Functions defined:** __init__, on_start, on_data, on_instrument, on_order_book, on_order_book_deltas, on_quote_tick, on_trade_tick, on_mark_price, on_index_price and 6 more
...
#### `__init__(self, config: VolatilityMarketMakerConfig)`
...
#### `create_buy_order(self, last: QuoteTick)`


#### `create_sell_order(self, last: QuoteTick)`
