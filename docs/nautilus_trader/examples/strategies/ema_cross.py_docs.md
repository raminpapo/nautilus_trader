# Documentation: `nautilus_trader/examples/strategies/ema_cross.py`
**Generated:** 2025-11-15T19:40:04.858062Z
**File Size:** 13173 bytes
**Extension:** .py
**Type:** text
...
This file is located at `nautilus_trader/examples/strategies/ema_cross.py` within the repository.

**Classes defined:** EMACrossConfig, EMACross

**Functions defined:** __init__, on_start, on_instrument, on_order_book_deltas, on_order_book, on_quote_tick, on_trade_tick, on_bar, buy, sell and 8 more
...
#### `__init__(self, config: EMACrossConfig)`
