# Documentation: `nautilus_trader/examples/strategies/ema_cross_trailing_stop.py`
**Generated:** 2025-11-15T19:40:04.872610Z
...
This file is located at `nautilus_trader/examples/strategies/ema_cross_trailing_stop.py` within the repository.

**Classes defined:** EMACrossTrailingStopConfig, EMACrossTrailingStop

**Functions defined:** __init__, on_start, on_stop, on_reset, on_instrument, on_order_book, on_quote_tick, on_trade_tick, on_bar, entry_buy and 8 more
...
#### `__init__(self, config: EMACrossTrailingStopConfig)`
