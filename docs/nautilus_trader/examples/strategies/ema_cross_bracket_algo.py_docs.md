# Documentation: `nautilus_trader/examples/strategies/ema_cross_bracket_algo.py`
**Generated:** 2025-11-15T19:40:04.862622Z
**File Size:** 13733 bytes
**Extension:** .py
**Type:** text
...
This file is located at `nautilus_trader/examples/strategies/ema_cross_bracket_algo.py` within the repository.

**Classes defined:** EMACrossBracketAlgoConfig, EMACrossBracketAlgo

**Functions defined:** __init__, on_start, on_quote_tick, on_bar, buy, sell, on_data, on_event, on_stop, on_reset and 3 more
...
#### `__init__(self, config: EMACrossBracketAlgoConfig)`
...
#### `buy(self, last_bar: Bar)`


#### `sell(self, last_bar: Bar)`
