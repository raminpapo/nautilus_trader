# Documentation: ema_cross_bracket_algo.py

## File Metadata

- **Path**: `nautilus_trader/examples/strategies/ema_cross_bracket_algo.py`
- **Size**: 13,733 bytes
- **Lines**: 360
- **Language**: Python
...
### Classes
- **`EMACrossBracketAlgoConfig`**: Class defined in this file
- **`EMACrossBracketAlgo`**: Class defined in this file
...
**Classs**: `EMACrossBracketAlgo`, `EMACrossBracketAlgoConfig`
**Imports**: `datetime`, `decimal`, `nautilus_trader.common.enums`, `nautilus_trader.config`, `nautilus_trader.core.correctness`, `nautilus_trader.core.data`, `nautilus_trader.core.message`, `nautilus_trader.indicators`, `nautilus_trader.model.data`, `nautilus_trader.model.enums`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.instruments`, `nautilus_trader.model.objects`, `nautilus_trader.model.orders`, `nautilus_trader.trading.strategy`, `typing`
...
---
*Generated on 2025-11-18T21:55:05.435683Z*
