# Documentation: `nautilus_trader/examples/strategies/ema_cross_hedge_mode.py`
**Generated:** 2025-11-15T19:40:04.865102Z
**File Size:** 11988 bytes
**Extension:** .py
**Type:** text
...
This file is located at `nautilus_trader/examples/strategies/ema_cross_hedge_mode.py` within the repository.
...
```python
from nautilus_trader.examples.strategies.ema_cross_hedge_mode import EMACrossConfig
```
