# Documentation: `nautilus_trader/examples/strategies/ema_cross_long_only.py`
**Generated:** 2025-11-15T19:40:04.867467Z
...
This file is located at `nautilus_trader/examples/strategies/ema_cross_long_only.py` within the repository.

**Classes defined:** EMACrossLongOnlyConfig, EMACrossLongOnly

**Functions defined:** __init__, on_start, on_instrument, on_order_book_deltas, on_order_book, on_quote_tick, on_trade_tick, on_bar, buy, on_data and 6 more
...
#### `__init__(self, config: EMACrossLongOnlyConfig)`
