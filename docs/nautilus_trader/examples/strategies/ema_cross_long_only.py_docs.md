# Documentation: ema_cross_long_only.py

## File Metadata

- **Path**: `nautilus_trader/examples/strategies/ema_cross_long_only.py`
- **Size**: 11,034 bytes
- **Lines**: 334
- **Language**: Python
...
### Classes
- **`EMACrossLongOnlyConfig`**: Class defined in this file
- **`EMACrossLongOnly`**: Class defined in this file
...
**Classs**: `EMACrossLongOnly`, `EMACrossLongOnlyConfig`
**Imports**: `decimal`, `nautilus_trader.common.enums`, `nautilus_trader.config`, `nautilus_trader.core.correctness`, `nautilus_trader.core.data`, `nautilus_trader.core.message`, `nautilus_trader.indicators`, `nautilus_trader.model.book`, `nautilus_trader.model.data`, `nautilus_trader.model.enums`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.instruments`, `nautilus_trader.model.orders`, `nautilus_trader.trading.strategy`, `pandas`
...
---
*Generated on 2025-11-18T21:55:05.439950Z*
