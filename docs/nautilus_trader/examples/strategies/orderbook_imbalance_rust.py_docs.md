# Documentation: `nautilus_trader/examples/strategies/orderbook_imbalance_rust.py`
**Generated:** 2025-11-15T19:40:04.881302Z
**File Size:** 8874 bytes
**Extension:** .py
**Type:** text
...
- **Path:** `nautilus_trader/examples/strategies/orderbook_imbalance_rust.py`
- **Size:** 8,874 bytes
- **Lines:** 217
- **Extension:** `.py`
- **Type:** text
...
This file is located at `nautilus_trader/examples/strategies/orderbook_imbalance_rust.py` within the repository.

**Classes defined:** OrderBookImbalanceConfig, OrderBookImbalance

**Functions defined:** __init__, on_start, on_order_book_deltas, on_quote_tick, on_order_book, check_trigger, on_stop
...
#### `__init__(self, config: OrderBookImbalanceConfig)`


#### `on_start(self)`


#### `on_order_book_deltas(self, pyo3_deltas: nautilus_pyo3.OrderBookDeltas)`
