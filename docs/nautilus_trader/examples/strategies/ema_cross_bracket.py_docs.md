# Documentation: ema_cross_bracket.py

## File Metadata

- **Path**: `nautilus_trader/examples/strategies/ema_cross_bracket.py`
- **Size**: 11,545 bytes
- **Lines**: 322
- **Language**: Python
...
### Classes
- **`EMACrossBracketConfig`**: Class defined in this file
- **`EMACrossBracket`**: Class defined in this file
...
**Classs**: `EMACrossBracket`, `EMACrossBracketConfig`
**Imports**: `datetime`, `decimal`, `nautilus_trader.common.enums`, `nautilus_trader.config`, `nautilus_trader.core.correctness`, `nautilus_trader.core.data`, `nautilus_trader.core.message`, `nautilus_trader.indicators`, `nautilus_trader.model.data`, `nautilus_trader.model.enums`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.instruments`, `nautilus_trader.model.orders.list`, `nautilus_trader.trading.strategy`
...
---
*Generated on 2025-11-18T21:55:05.433072Z*
