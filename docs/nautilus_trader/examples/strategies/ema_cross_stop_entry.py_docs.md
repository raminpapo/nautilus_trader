# Documentation: `nautilus_trader/examples/strategies/ema_cross_stop_entry.py`
**Generated:** 2025-11-15T19:40:04.870048Z
...
This file is located at `nautilus_trader/examples/strategies/ema_cross_stop_entry.py` within the repository.

**Classes defined:** EMACrossStopEntryConfig, EMACrossStopEntry

**Functions defined:** __init__, on_start, on_instrument, on_order_book, on_quote_tick, on_trade_tick, on_bar, entry_buy, entry_sell, trailing_stop_buy and 8 more
...
#### `__init__(self, config: EMACrossStopEntryConfig)`
...
#### `entry_buy(self, last_bar: Bar)`


#### `entry_sell(self, last_bar: Bar)`


#### `trailing_stop_buy(self)`


#### `trailing_stop_sell(self)`
