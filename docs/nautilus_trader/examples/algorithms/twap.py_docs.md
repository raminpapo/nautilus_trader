...
### Classes
- **`TWAPExecAlgorithmConfig`**: Class defined in this file
- **`TWAPExecAlgorithm`**: Class defined in this file
...
**Classs**: `TWAPExecAlgorithm`, `TWAPExecAlgorithmConfig`
**Imports**: `datetime`, `decimal`, `math`, `nautilus_trader.common.enums`, `nautilus_trader.common.events`, `nautilus_trader.config`, `nautilus_trader.core.correctness`, `nautilus_trader.execution.algorithm`, `nautilus_trader.model.enums`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.instruments`, `nautilus_trader.model.objects`, `nautilus_trader.model.orders`

## Related Files

This file is located in `nautilus_trader/examples/algorithms/`. Related files may include:
...
---
*Generated on 2025-11-18T21:55:05.423700Z*
