# Documentation: `nautilus_trader/examples/algorithms/twap.py`
**Generated:** 2025-11-15T19:40:04.850101Z
**File Size:** 11236 bytes
**Extension:** .py
**Type:** text
...
- **Path:** `nautilus_trader/examples/algorithms/twap.py`
- **Size:** 11,236 bytes
- **Lines:** 317
- **Extension:** `.py`
- **Type:** text
...
This file is located at `nautilus_trader/examples/algorithms/twap.py` within the repository.

**Classes defined:** TWAPExecAlgorithmConfig, TWAPExecAlgorithm

**Functions defined:** __init__, on_start, on_stop, on_reset, on_save, on_load, round_decimal_down, on_order, on_time_event, complete_sequence
...
#### `__init__(self, config: TWAPExecAlgorithmConfig | None = None)`
...
#### `round_decimal_down(self, amount: Decimal, precision: int)`


#### `on_order(self, order: Order)`


#### `on_time_event(self, event: TimeEvent)`


#### `complete_sequence(self, exec_spawn_id: ClientOrderId)`
...
```python
from nautilus_trader.examples.algorithms.twap import TWAPExecAlgorithmConfig
```
