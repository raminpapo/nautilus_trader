# Documentation: `nautilus_trader/data/engine.pyx`
**Generated:** 2025-11-15T19:40:04.831318Z
...
- **Path:** `nautilus_trader/data/engine.pyx`
- **Size:** 114,167 bytes
- **Lines:** 2,840
- **Extension:** `.pyx`
- **Type:** text
...
This file is located at `nautilus_trader/data/engine.pyx` within the repository.

**Functions defined:** __init__, registered_clients, default_client, routing_map, connect, disconnect, register_catalog, _log_request_warning, _update_catalog, register_time_range_generator and 2 more
...
#### `register_catalog(self, catalog: ParquetDataCatalog, name: str = "catalog_0")`


#### `_log_request_warning(self, RequestData request)`
...
#### `register_time_range_generator(name: str, function: TimeRangeGenerator)`


#### `get_time_range_generator(name: str)`
