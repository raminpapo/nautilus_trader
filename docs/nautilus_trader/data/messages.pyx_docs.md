...
- **Path**: `nautilus_trader/data/messages.pyx`
- **Size**: 87,916 bytes
- **Lines**: 2,935
- **Language**: Unknown
...
**Identifiers**: `ANY`, `Additional`, `All`, `Any`, `BASIS`, `Bar`, `BarType`, `BookType`, `Both`, `CONDITIONS`, `Callable`, `Cannot`, `ClientId`, `Command`, `Condition`, `Convert`, `Copyright`, `Data`, `DataCommand`, `DataResponse`, `DataType`, `FundingRateUpdate`, `GNU`, `General`, `Generic`, `IDs`, `IndexPriceUpdate`, `Instrument`, `InstrumentClose`, `InstrumentId` *(+72 more)*
...
---
*Generated on 2025-11-18T21:55:05.417425Z*
