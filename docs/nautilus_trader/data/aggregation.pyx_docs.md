# Documentation: aggregation.pyx

## File Metadata

- **Path**: `nautilus_trader/data/aggregation.pyx`
- **Size**: 39,484 bytes
- **Lines**: 1,111
- **Language**: Unknown
...
Total unique keywords extracted: 104


**Identifiers**: `ANY`, `Advance`, `Aggregation`, `All`, `Always`, `BASIS`, `Bar`, `BarAggregation`, `BarAggregator`, `BarBuilder`, `BarType`, `Build`, `CONDITIONS`, `Calculate`, `Calculated`, `Callable`, `Check`, `Clock`, `Close`, `Closing`, `Computing`, `Condition`, `Copyright`, `Cumulative`, `DAY`, `DateOffset`, `Decimal`, `Decrement`, `Design`, `Determines` *(+74 more)*
...
---
*Generated on 2025-11-18T21:55:05.377962Z*
