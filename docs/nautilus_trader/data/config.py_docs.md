# Documentation: `nautilus_trader/data/config.py`
**Generated:** 2025-11-15T19:40:04.818986Z
...
- **Path:** `nautilus_trader/data/config.py`
- **Size:** 3,776 bytes
- **Lines:** 73
- **Extension:** `.py`
- **Type:** text
...
This file is located at `nautilus_trader/data/config.py` within the repository.

**Classes defined:** DataEngineConfig
