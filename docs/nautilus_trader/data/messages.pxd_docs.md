...
- **Path**: `nautilus_trader/data/messages.pxd`
- **Size**: 6,603 bytes
- **Lines**: 220
- **Language**: Unknown
...
**Identifiers**: `ANY`, `Additional`, `All`, `BASIS`, `BarType`, `BookType`, `CONDITIONS`, `ClientId`, `Command`, `Copyright`, `DataCommand`, `DataResponse`, `DataType`, `GNU`, `General`, `IDs`, `InstrumentId`, `KIND`, `Lesser`, `License`, `Licensed`, `Ltd`, `Nautech`, `None`, `Pty`, `Public`, `Request`, `RequestBars`, `RequestData`, `RequestInstrument` *(+42 more)*
...
---
*Generated on 2025-11-18T21:55:05.407931Z*
