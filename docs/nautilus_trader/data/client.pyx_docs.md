# Documentation: `nautilus_trader/data/client.pyx`
**Generated:** 2025-11-15T19:40:04.817316Z
**File Size:** 50517 bytes
**Extension:** .pyx
**Type:** text
...
- **Path:** `nautilus_trader/data/client.pyx`
- **Size:** 50,517 bytes
- **Lines:** 1,269
- **Extension:** `.pyx`
- **Type:** text
...
This file is located at `nautilus_trader/data/client.pyx` within the repository.

**Functions defined:** __init__, __repr__, _handle_data_py, _handle_data_response_py, __init__, _handle_data_py, _handle_instrument_py, _handle_instruments_py, _handle_quote_ticks_py, _handle_trade_ticks_py and 3 more
...
#### `_handle_data_py(self, Data data)`


#### `_handle_data_response_py(self, DataType data_type, data, UUID4 correlation_id, datetime start, datetime end, dict[str, object] params)`
...
#### `_handle_instrument_py(self, Instrument instrument, UUID4 correlation_id, datetime start, datetime end, dict[str, object] params = None)`


#### `_handle_instruments_py(self, Venue venue, list instruments, UUID4 correlation_id, datetime start, datetime end, dict[str, object] params = None)`


#### `_handle_quote_ticks_py(self, InstrumentId instrument_id, list ticks, UUID4 correlation_id, datetime start, datetime end, dict[str, object] params = None)`


#### `_handle_trade_ticks_py(self, InstrumentId instrument_id, list ticks, UUID4 correlation_id, datetime start, datetime end, dict[str, object] params = None)`


#### `_handle_bars_py(self, BarType bar_type, list bars, UUID4 correlation_id, datetime start, datetime end, dict[str, object] params = None)`


#### `_handle_order_book_depths_py(self, InstrumentId instrument_id, list depths, UUID4 correlation_id, datetime start, datetime end, dict[str, object] params = None)`


#### `_handle_data_response_py(self, DataType data_type, data, UUID4 correlation_id, datetime start, datetime end, dict[str, object] params = None)`
