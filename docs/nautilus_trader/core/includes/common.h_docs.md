...
- **Path**: `nautilus_trader/core/includes/common.h`
- **Size**: 20,014 bytes
- **Lines**: 714
- **Language**: C Header
...
**Identifiers**: `All`, `Assumes`, `BLUE`, `Behavior`, `CVec`, `CYAN`, `ComponentState`, `ComponentTrigger`, `Counting`, `Creates`, `Cython`, `DEBUG`, `DEGRADE`, `DEGRADED`, `DEGRADE_COMPLETED`, `DEGRADING`, `DISPOSE`, `DISPOSED`, `DISPOSE_COMPLETED`, `DISPOSING`, `Deref`, `DerefMut`, `Don`, `ERROR`, `Error`, `FAULT`, `FAULTED`, `FAULTING`, `FAULT_COMPLETED`, `FFI` *(+85 more)*
...
---
*Generated on 2025-11-18T21:55:05.294216Z*
