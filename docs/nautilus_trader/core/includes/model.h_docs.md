...
- **Path**: `nautilus_trader/core/includes/model.h`
- **Size**: 89,265 bytes
- **Lines**: 3,263
- **Language**: C Header
...
Total unique keywords extracted: 395


**Identifiers**: `ACCEPTED`, `ACTIVE`, `ADD`, `ALTERNATIVE`, `AMM`, `ASCII`, `ASK`, `ATC`, `ATO`, `AT_THE_CLOSE`, `AT_THE_OPEN`, `AccountId_t`, `AccountType`, `Aggregated`, `AggregationSource`, `AggressorSide`, `Alternative`, `AssetClass`, `Assumes`, `BAR`, `BASIS_POINTS`, `BETTING`, `BID`, `BID_ASK`, `BINARY_OPTION`, `BOND`, `BUY`, `BUYER`, `Bar`, `BarAggregation` *(+365 more)*
...
---
*Generated on 2025-11-18T21:55:05.307124Z*
