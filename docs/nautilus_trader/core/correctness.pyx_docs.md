# Documentation: `nautilus_trader/core/correctness.pyx`
**Generated:** 2025-11-15T19:40:04.720167Z
**File Size:** 37169 bytes
**Extension:** .pyx
**Type:** text
...
- **Path:** `nautilus_trader/core/correctness.pyx`
- **Size:** 37,169 bytes
- **Lines:** 1,340
- **Extension:** `.pyx`
- **Type:** text
...
This file is located at `nautilus_trader/core/correctness.pyx` within the repository.

**Classes defined:** PyCondition

**Functions defined:** is_true, is_false, none, not_none, type, type_or_none, callable, callable_or_none, equal, not_equal and 13 more
...
#### `is_true(bint predicate, str fail_msg, ex_type = None)`


#### `is_false(bint predicate, str fail_msg, ex_type = None)`


#### `none(argument, str param, ex_type = None)`


#### `not_none(argument, str param, ex_type = None)`


#### `type(argument, expected, str param, ex_type = None)`


#### `type_or_none(argument, expected, str param, ex_type = None)`


#### `callable(argument, str param, ex_type = None)`


#### `callable_or_none(argument, str param, ex_type = None)`


#### `equal(argument1, argument2, str param1, str param2, ex_type = None)`


#### `not_equal(argument1, argument2, str param1, str param2, ex_type = None)`


#### `list_type(argument, expected_type, str param, ex_type = None)`


#### `dict_types(argument, key_type, value_type, str param, ex_type = None)`


#### `is_in(object element, collection, str param1, str param2, ex_type = None)`


#### `not_in(object element, collection, str param1, str param2, ex_type = None)`


#### `not_empty(argument, str param, ex_type = None)`


#### `empty(argument, str param, ex_type = None)`


#### `positive(double value, str param, ex_type = None)`


#### `positive_int(value: int, str param, ex_type = None)`


#### `not_negative(double value, str param, ex_type = None)`


#### `not_negative_int(value: int, str param, ex_type = None)`


#### `in_range(double value, double start, double end, str param, ex_type = None)`


#### `in_range_int(value: int, start: int, end: int, param, ex_type = None)`


#### `valid_string(str argument, str param, ex_type = None)`
