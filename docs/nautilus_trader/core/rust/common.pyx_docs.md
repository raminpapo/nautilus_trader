# Documentation: common.pyx

## File Metadata

- **Path**: `nautilus_trader/core/rust/common.pyx`
- **Size**: 1,222 bytes
- **Lines**: 22
- **Language**: Unknown
...
**Identifiers**: `ANY`, `All`, `Allows`, `BASIS`, `CONDITIONS`, `ComponentState`, `ComponentTrigger`, `Copyright`, `GNU`, `General`, `KIND`, `Lesser`, `License`, `Licensed`, `LogColor`, `LogLevel`, `Ltd`, `Nautech`, `Pty`, `Public`, `Python`, `See`, `Systems`, `Unless`, `Version`, `WARRANTIES`, `WITHOUT`, `You`
...
---
*Generated on 2025-11-18T21:55:05.345574Z*
