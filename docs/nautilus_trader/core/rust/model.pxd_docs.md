# Documentation: model.pxd

## File Metadata

- **Path**: `nautilus_trader/core/rust/model.pxd`
- **Size**: 83,991 bytes
- **Lines**: 2,231
- **Language**: Unknown
...
Total unique keywords extracted: 396


**Identifiers**: `ACCEPTED`, `ACTIVE`, `ADD`, `ALTERNATIVE`, `AMM`, `ASCII`, `ASK`, `ATC`, `ATO`, `AT_THE_CLOSE`, `AT_THE_OPEN`, `AccountId_t`, `AccountType`, `Aggregated`, `AggregationSource`, `AggressorSide`, `Alternative`, `AssetClass`, `Assumes`, `BAR`, `BASIS_POINTS`, `BETTING`, `BID`, `BID_ASK`, `BINARY_OPTION`, `BOND`, `BUY`, `BUYER`, `Bar`, `BarAggregation` *(+366 more)*
...
---
*Generated on 2025-11-18T21:55:05.356970Z*
