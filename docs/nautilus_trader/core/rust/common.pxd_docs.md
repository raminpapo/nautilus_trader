# Documentation: common.pxd

## File Metadata

- **Path**: `nautilus_trader/core/rust/common.pxd`
- **Size**: 20,101 bytes
- **Lines**: 542
- **Language**: Unknown
...
Total unique keywords extracted: 114


**Identifiers**: `All`, `Assumes`, `BLUE`, `Behavior`, `CVec`, `CYAN`, `ComponentState`, `ComponentTrigger`, `Counting`, `Creates`, `Cython`, `DEBUG`, `DEGRADE`, `DEGRADED`, `DEGRADE_COMPLETED`, `DEGRADING`, `DISPOSE`, `DISPOSED`, `DISPOSE_COMPLETED`, `DISPOSING`, `Deref`, `DerefMut`, `Don`, `ERROR`, `Error`, `FAULT`, `FAULTED`, `FAULTING`, `FAULT_COMPLETED`, `FFI` *(+84 more)*
...
---
*Generated on 2025-11-18T21:55:05.344091Z*
