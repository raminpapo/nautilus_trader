# Documentation: nautilus_pyo3.pyi

## File Metadata

- **Path**: `nautilus_trader/core/nautilus_pyo3.pyi`
- **Size**: 254,410 bytes
- **Lines**: 8,112
- **Language**: Unknown
...
Total unique keywords extracted: 677


**Identifiers**: `ACCEPTED`, `ACTIVE`, `ADD`, `ADDED`, `ALTERNATIVE`, `ANY`, `ASK`, `AT_THE_CLOSE`, `AT_THE_OPEN`, `Account`, `AccountBalance`, `AccountId`, `AccountState`, `AccountType`, `Accounting`, `Actor`, `ActorId`, `Adapters`, `AdaptiveMovingAverage`, `Add`, `AdjustmentType`, `AggregationSource`, `AggressorSide`, `All`, `Analysis`, `Any`, `ArcherMovingAveragesTrends`, `AroonOscillator`, `AssetClass`, `AverageTrueRange` *(+647 more)*
...
---
*Generated on 2025-11-18T21:55:05.335233Z*
