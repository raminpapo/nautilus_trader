# Documentation: fsm.pyx

## File Metadata

- **Path**: `nautilus_trader/core/fsm.pyx`
- **Size**: 4,364 bytes
- **Lines**: 130
- **Language**: Unknown
...
**Identifiers**: `ANY`, `All`, `BASIS`, `CONDITIONS`, `Callable`, `Condition`, `Copyright`, `Defines`, `Enum`, `Exception`, `FSM`, `FSMs`, `Finite`, `FiniteStateMachine`, `GNU`, `General`, `Invalid`, `InvalidStateTrigger`, `KIND`, `Lesser`, `License`, `Licensed`, `Ltd`, `Machine`, `Nautech`, `None`, `Parameters`, `Process`, `Provides`, `Pty` *(+16 more)*
...
---
*Generated on 2025-11-18T21:55:05.290009Z*
