# Documentation: fsm.pxd

## File Metadata

- **Path**: `nautilus_trader/core/fsm.pxd`
- **Size**: 1,230 bytes
- **Lines**: 31
- **Language**: Unknown
...
**Identifiers**: `ANY`, `All`, `BASIS`, `CONDITIONS`, `Copyright`, `Enum`, `Exception`, `FSM`, `FiniteStateMachine`, `GNU`, `General`, `InvalidStateTrigger`, `KIND`, `Lesser`, `License`, `Licensed`, `Ltd`, `Nautech`, `Pty`, `Public`, `See`, `Systems`, `The`, `Unless`, `Version`, `WARRANTIES`, `WITHOUT`, `You`
...
---
*Generated on 2025-11-18T21:55:05.288628Z*
