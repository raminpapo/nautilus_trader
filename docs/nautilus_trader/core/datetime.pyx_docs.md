# Documentation: `nautilus_trader/core/datetime.pyx`
**Generated:** 2025-11-15T19:40:04.727370Z
**File Size:** 12684 bytes
**Extension:** .pyx
**Type:** text
...
- **Path:** `nautilus_trader/core/datetime.pyx`
- **Size:** 12,684 bytes
- **Lines:** 453
- **Extension:** `.pyx`
- **Type:** text
...
This file is located at `nautilus_trader/core/datetime.pyx` within the repository.

**Functions defined:** max_date, min_date, ensure_pydatetime_utc
...
#### `max_date(date1: pd.Timestamp | str | int | None = None, date2: str | int | None = None)`


#### `min_date(date1: pd.Timestamp | str | int | None = None, date2: str | int | None = None)`


#### `ensure_pydatetime_utc(timestamp: pd.Timestamp)`
