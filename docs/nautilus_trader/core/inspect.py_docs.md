...
### Functions
- **`is_nautilus_class()`**: Function defined in this file
- **`get_size_of()`**: Function defined in this file
...
**Functions**: `get_size_of`, `is_nautilus_class`
**Imports**: `gc`, `sys`, `typing`
...
---
*Generated on 2025-11-18T21:55:05.309730Z*
