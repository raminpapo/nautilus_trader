# Documentation: string.pxd

## File Metadata

- **Path**: `nautilus_trader/core/string.pxd`
- **Size**: 3,870 bytes
- **Lines**: 92
- **Language**: Unknown
...
**Identifiers**: `ANY`, `All`, `Assumes`, `BASIS`, `CONDITIONS`, `CString`, `Convert`, `Copyright`, `GNU`, `General`, `KIND`, `Lesser`, `License`, `Licensed`, `Ltd`, `NUL`, `NULL`, `Nautech`, `New`, `Pty`, `Public`, `PyBytes_AsString`, `PyBytes_Check`, `PyBytes_FromString`, `PyBytes_FromStringAndSize`, `PyUnicode_AsUTF8AndSize`, `PyUnicode_FromString`, `PyUnicode_FromUnicode`, `Py_ssize_t`, `Python` *(+16 more)*
...
---
*Generated on 2025-11-18T21:55:05.364660Z*
