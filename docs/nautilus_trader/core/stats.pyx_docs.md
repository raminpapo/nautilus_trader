# Documentation: stats.pyx

## File Metadata

- **Path**: `nautilus_trader/core/stats.pyx`
- **Size**: 5,710 bytes
- **Lines**: 247
- **Language**: Unknown
...
**Identifiers**: `ANY`, `All`, `BASIS`, `CONDITIONS`, `Copyright`, `False`, `GNU`, `General`, `KIND`, `Lesser`, `License`, `Licensed`, `Ltd`, `Nautech`, `None`, `Notes`, `Parameters`, `Pty`, `Public`, `Return`, `Returns`, `See`, `Systems`, `The`, `True`, `Unless`, `ValueError`, `Version`, `WARRANTIES`, `WITHOUT` *(+1 more)*
...
---
*Generated on 2025-11-18T21:55:05.363036Z*
