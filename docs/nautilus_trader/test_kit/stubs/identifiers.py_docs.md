...
### Classes
- **`TestIdStubs`**: Class defined in this file
...
**Classs**: `TestIdStubs`
**Imports**: `nautilus_trader.core.uuid`, `nautilus_trader.model.identifiers`
...
```bash
# For Python
pytest nautilus_trader/test_kit/stubs/identifiers.py
...
---
*Generated on 2025-11-18T21:55:06.014994Z*
