# Documentation: `nautilus_trader/test_kit/stubs/execution.py`
**Generated:** 2025-11-15T19:40:05.386165Z
**File Size:** 9533 bytes
**Extension:** .py
**Type:** text
...
This file is located at `nautilus_trader/test_kit/stubs/execution.py` within the repository.

**Classes defined:** TestExecStubs

**Functions defined:** cash_account, margin_account, betting_account, limit_order, limit_with_stop_market, market_order, make_submitted_order, make_accepted_order, make_filled_order
...
#### `cash_account(account_id: AccountId | None = None)`


#### `margin_account(account_id: AccountId | None = None)`


#### `betting_account(account_id: AccountId | None = None)`
...
#### `make_filled_order(instrument: Instrument, **kwargs)`
