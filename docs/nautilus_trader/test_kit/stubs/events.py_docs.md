# Documentation: `nautilus_trader/test_kit/stubs/events.py`
**Generated:** 2025-11-15T19:40:05.384133Z
**File Size:** 15356 bytes
**Extension:** .py
**Type:** text
...
This file is located at `nautilus_trader/test_kit/stubs/events.py` within the repository.

**Classes defined:** TestEventStubs

**Functions defined:** component_state_changed, trading_state_changed, cash_account_state, margin_account_state, betting_account_state, order_released, order_submitted, order_accepted, order_rejected, order_pending_update and 9 more
...
#### `margin_account_state(account_id: AccountId | None = None)`


#### `betting_account_state(
        balance: float = 10_000,
        currency: Currency = GBP,
        account_id: AccountId | None = None,
    )`
...
#### `position_changed(position: Position)`
