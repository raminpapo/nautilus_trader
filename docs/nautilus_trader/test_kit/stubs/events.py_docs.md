# Documentation: events.py

## File Metadata

- **Path**: `nautilus_trader/test_kit/stubs/events.py`
- **Size**: 15,354 bytes
- **Lines**: 438
- **Language**: Python
...
### Classes
- **`TestEventStubs`**: Class defined in this file
...
```bash
# For Python
pytest nautilus_trader/test_kit/stubs/events.py
...
---
*Generated on 2025-11-18T21:55:06.011634Z*
