...
### Classes
- **`TestConfigStubs`**: Class defined in this file
...
**Classs**: `TestConfigStubs`
**Imports**: `nautilus_trader.config`, `nautilus_trader.core.data`, `nautilus_trader.model.data`, `nautilus_trader.model.identifiers`, `nautilus_trader.persistence.catalog.parquet`, `nautilus_trader.test_kit.providers`, `nautilus_trader.test_kit.stubs.identifiers`
...
```bash
# For Python
pytest nautilus_trader/test_kit/stubs/config.py
...
---
*Generated on 2025-11-18T21:55:06.005510Z*
