# Documentation: `nautilus_trader/test_kit/stubs/data.py`
**Generated:** 2025-11-15T19:40:05.381254Z
...
- **Path:** `nautilus_trader/test_kit/stubs/data.py`
- **Size:** 24,174 bytes
- **Lines:** 703
- **Extension:** `.py`
- **Type:** text
...
This file is located at `nautilus_trader/test_kit/stubs/data.py` within the repository.

**Classes defined:** TestDataStubs, MyData

**Functions defined:** quote_tick, trade_tick, quote_ticks_usdjpy, bar_spec_1min_bid, bar_spec_5min_bid, bar_spec_1min_ask, bar_spec_1min_last, bar_spec_1min_mid, bar_spec_1sec_mid, bar_spec_100tick_last and 38 more
...
#### `bar_spec_100tick_last()`


#### `bar_spec_month_mid()`


#### `bartype_audusd_1min_bid()`


#### `bartype_audusd_5min_bid()`


#### `bartype_audusd_month_mid()`


#### `bartype_audusd_1min_ask()`


#### `bartype_gbpusd_1min_bid()`


#### `bartype_gbpusd_1min_ask()`


#### `bartype_gbpusd_1sec_mid()`


#### `bartype_usdjpy_1min_bid()`


#### `bartype_usdjpy_1min_ask()`


#### `bartype_btcusdt_binance_100tick_last()`


#### `bartype_adabtc_binance_1min_last()`


#### `bar_5decimal(ts_event=0, ts_init=0)`


#### `bar_5decimal_5min_bid()`
...
#### `l2_feed(filename: PathLike[str] | str)`


#### `parse_line(d)`


#### `l3_feed(filename: PathLike[str] | str)`
...
#### `binance_bars_from_csv(filename: str, bar_type: BarType, instrument: Instrument)`
