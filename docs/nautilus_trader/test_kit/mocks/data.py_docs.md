# Documentation: `nautilus_trader/test_kit/mocks/data.py`
**Generated:** 2025-11-15T19:40:05.338974Z
**File Size:** 6650 bytes
**Extension:** .py
**Type:** text
...
This file is located at `nautilus_trader/test_kit/mocks/data.py` within the repository.

**Classes defined:** MockMarketDataClient, NewsEventData

**Functions defined:** __init__, request_instrument, request_instruments, request_quote_ticks, request_trade_ticks, request_bars, request_order_book_depth, setup_catalog, load_catalog_with_stub_quote_ticks_audusd, load_catalog_with_stub_trade_ticks_ethusdt
...
#### `load_catalog_with_stub_quote_ticks_audusd(catalog: ParquetDataCatalog)`


#### `load_catalog_with_stub_trade_ticks_ethusdt(catalog: ParquetDataCatalog)`
