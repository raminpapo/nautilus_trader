...
- **Path**: `nautilus_trader/test_kit/mocks/data.py`
- **Size**: 6,650 bytes
- **Lines**: 192
- **Language**: Python
...
### Functions
- **`setup_catalog()`**: Function defined in this file
- **`load_catalog_with_stub_quote_ticks_audusd()`**: Function defined in this file
- **`load_catalog_with_stub_trade_ticks_ethusdt()`**: Function defined in this file

### Classes
- **`MockMarketDataClient`**: Class defined in this file
- **`NewsEventData`**: Class defined in this file
...
**Classs**: `MockMarketDataClient`, `NewsEventData`
**Functions**: `load_catalog_with_stub_quote_ticks_audusd`, `load_catalog_with_stub_trade_ticks_ethusdt`, `setup_catalog`
**Imports**: `nautilus_trader.cache.cache`, `nautilus_trader.common.component`, `nautilus_trader.data.client`, `nautilus_trader.data.messages`, `nautilus_trader.model.data`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.instruments`, `nautilus_trader.persistence.catalog.parquet`, `nautilus_trader.persistence.catalog.singleton`, `nautilus_trader.persistence.wranglers`, `nautilus_trader.test_kit.providers`, `nautilus_trader.trading.filters`, `pathlib`, `typing`
...
```bash
# For Python
pytest nautilus_trader/test_kit/mocks/data.py
...
---
*Generated on 2025-11-18T21:55:05.966202Z*
