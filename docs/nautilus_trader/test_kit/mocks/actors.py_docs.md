...
### Classes
- **`MockActorConfig`**: Class defined in this file
- **`MockActor`**: Class defined in this file
- **`KaboomActor`**: Class defined in this file
...
**Classs**: `KaboomActor`, `MockActor`, `MockActorConfig`
**Imports**: `inspect`, `nautilus_trader.common.actor`, `nautilus_trader.config`, `nautilus_trader.core.data`, `nautilus_trader.core.message`, `nautilus_trader.model.data`, `nautilus_trader.model.events`, `nautilus_trader.model.instruments`, `typing`
...
```bash
# For Python
pytest nautilus_trader/test_kit/mocks/actors.py
...
---
*Generated on 2025-11-18T21:55:05.960756Z*
