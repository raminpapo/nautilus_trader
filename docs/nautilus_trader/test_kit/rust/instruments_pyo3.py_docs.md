# Documentation: `nautilus_trader/test_kit/rust/instruments_pyo3.py`
**Generated:** 2025-11-15T19:40:05.359899Z
...
- **Path:** `nautilus_trader/test_kit/rust/instruments_pyo3.py`
- **Size:** 19,493 bytes
- **Lines:** 515
- **Extension:** `.py`
- **Type:** text
...
This file is located at `nautilus_trader/test_kit/rust/instruments_pyo3.py` within the repository.

**Classes defined:** TestInstrumentProviderPyo3

**Functions defined:** default_fx_ccy, audusd_sim, betting_instrument, binary_option, ethusdt_perp_binance, ethusdt_binance, xbtusd_bitmex, ethusd_bitmex, btcusdt_future_binance, btcusd_option_deribit and 6 more
