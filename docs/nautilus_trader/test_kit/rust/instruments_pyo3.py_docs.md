# Documentation: instruments_pyo3.py
...
### Classes
- **`TestInstrumentProviderPyo3`**: Class defined in this file
...
**Classs**: `TestInstrumentProviderPyo3`
**Imports**: `decimal`, `nautilus_trader.core`, `nautilus_trader.core.nautilus_pyo3`, `pandas`, `pytz`
...
```bash
# For Python
pytest nautilus_trader/test_kit/rust/instruments_pyo3.py
...
---
*Generated on 2025-11-18T21:55:05.988451Z*
