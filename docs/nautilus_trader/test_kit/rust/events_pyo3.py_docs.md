# Documentation: `nautilus_trader/test_kit/rust/events_pyo3.py`
**Generated:** 2025-11-15T19:40:05.355511Z
**File Size:** 20005 bytes
**Extension:** .py
**Type:** text
...
- **Path:** `nautilus_trader/test_kit/rust/events_pyo3.py`
- **Size:** 20,005 bytes
- **Lines:** 494
- **Extension:** `.py`
- **Type:** text
...
This file is located at `nautilus_trader/test_kit/rust/events_pyo3.py` within the repository.

**Classes defined:** TestEventsProviderPyo3

**Functions defined:** cash_account_state, cash_account_state_million_usd, cash_account_state_multi, cash_account_state_multi_changed_btc, margin_account_state, order_denied_max_submit_rate, order_rejected_insufficient_margin, order_filled_buy_limit, order_initialized, order_triggered and 12 more
