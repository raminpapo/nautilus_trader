# Documentation: identifiers_pyo3.py
...
### Classes
- **`TestIdProviderPyo3`**: Class defined in this file
...
```bash
# For Python
pytest nautilus_trader/test_kit/rust/identifiers_pyo3.py
...
---
*Generated on 2025-11-18T21:55:05.985640Z*
