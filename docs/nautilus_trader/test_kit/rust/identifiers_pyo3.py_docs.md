# Documentation: `nautilus_trader/test_kit/rust/identifiers_pyo3.py`
**Generated:** 2025-11-15T19:40:05.357344Z
...
- **Path:** `nautilus_trader/test_kit/rust/identifiers_pyo3.py`
- **Size:** 3,921 bytes
- **Lines:** 111
- **Extension:** `.py`
- **Type:** text
...
This file is located at `nautilus_trader/test_kit/rust/identifiers_pyo3.py` within the repository.

**Classes defined:** TestIdProviderPyo3

**Functions defined:** uuid, trader_id, account_id, strategy_id, position_id, btcusdt_binance_id, ethusdt_binance_id, adabtc_binance_id, audusd_id, gbpusd_id and 9 more
