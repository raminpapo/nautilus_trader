# Documentation: `nautilus_trader/test_kit/rust/orders_pyo3.py`
**Generated:** 2025-11-15T19:40:05.361588Z
...
- **Path:** `nautilus_trader/test_kit/rust/orders_pyo3.py`
- **Size:** 5,508 bytes
- **Lines:** 121
- **Extension:** `.py`
- **Type:** text
...
This file is located at `nautilus_trader/test_kit/rust/orders_pyo3.py` within the repository.

**Classes defined:** TestOrderProviderPyo3

**Functions defined:** market_order, limit_order, stop_limit_order
