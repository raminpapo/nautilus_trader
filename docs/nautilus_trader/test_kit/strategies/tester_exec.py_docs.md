# Documentation: `nautilus_trader/test_kit/strategies/tester_exec.py`
**Generated:** 2025-11-15T19:40:05.371164Z
**File Size:** 32428 bytes
**Extension:** .py
**Type:** text
...
- **Path:** `nautilus_trader/test_kit/strategies/tester_exec.py`
- **Size:** 32,428 bytes
- **Lines:** 796
- **Extension:** `.py`
- **Type:** text
...
This file is located at `nautilus_trader/test_kit/strategies/tester_exec.py` within the repository.

**Classes defined:** ExecTesterConfig, ExecTester

**Functions defined:** __init__, on_start, on_order_book, on_order_book_deltas, on_quote_tick, on_trade_tick, on_mark_price, on_index_price, on_bar, maintain_orders and 12 more
...
#### `__init__(self, config: ExecTesterConfig)`


#### `on_start(self)`


#### `on_order_book(self, book: OrderBook)`


#### `on_order_book_deltas(self, deltas: OrderBookDeltas)`


#### `on_quote_tick(self, quote: QuoteTick)`


#### `on_trade_tick(self, trade: TradeTick)`


#### `on_mark_price(self, update: MarkPriceUpdate)`


#### `on_index_price(self, update: MarkPriceUpdate)`


#### `on_bar(self, bar: Bar)`


#### `maintain_orders(self, best_bid: Price, best_ask: Price)`
...
#### `open_position(self, net_qty: Decimal)`


#### `get_price_offset(self, instrument: Instrument)`


#### `is_order_active(self, order: Order)`


#### `submit_limit_order(self, order_side: OrderSide, price: Price)`
...
#### `get_order_trigger_price(self, order: Order)`
...
**Directory:** `nautilus_trader/test_kit/strategies`
