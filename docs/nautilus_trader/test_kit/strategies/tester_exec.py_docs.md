...
### Classes
- **`ExecTesterConfig`**: Class defined in this file
- **`ExecTester`**: Class defined in this file
...
**Classs**: `ExecTester`, `ExecTesterConfig`
**Imports**: `decimal`, `nautilus_trader.common.enums`, `nautilus_trader.config`, `nautilus_trader.model.book`, `nautilus_trader.model.data`, `nautilus_trader.model.enums`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.instruments`, `nautilus_trader.model.objects`, `nautilus_trader.model.orders`, `nautilus_trader.trading.strategy`, `pandas`, `typing`

## Related Files

This file is located in `nautilus_trader/test_kit/strategies/`. Related files may include:
...
```bash
# For Python
pytest nautilus_trader/test_kit/strategies/tester_exec.py
...
---
*Generated on 2025-11-18T21:55:05.999025Z*
