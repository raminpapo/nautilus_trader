...
### Classes
- **`DataTesterConfig`**: Class defined in this file
- **`DataTester`**: Class defined in this file
...
**Classs**: `DataTester`, `DataTesterConfig`
**Imports**: `decimal`, `nautilus_trader.common.actor`, `nautilus_trader.common.config`, `nautilus_trader.common.enums`, `nautilus_trader.core`, `nautilus_trader.model.book`, `nautilus_trader.model.data`, `nautilus_trader.model.enums`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.instruments`, `pandas`, `typing`
...
```bash
# For Python
pytest nautilus_trader/test_kit/strategies/tester_data.py
...
---
*Generated on 2025-11-18T21:55:05.994960Z*
