# Documentation: `nautilus_trader/test_kit/strategies/tester_data.py`
**Generated:** 2025-11-15T19:40:05.366970Z
**File Size:** 16862 bytes
**Extension:** .py
**Type:** text
...
- **Path:** `nautilus_trader/test_kit/strategies/tester_data.py`
- **Size:** 16,862 bytes
- **Lines:** 442
- **Extension:** `.py`
- **Type:** text
...
This file is located at `nautilus_trader/test_kit/strategies/tester_data.py` within the repository.

**Classes defined:** DataTesterConfig, DataTester

**Functions defined:** __init__, on_start, setup_book, setup_book_pyo3, on_stop, on_historical_data, on_instrument, on_instruments, on_order_book_deltas, on_order_book_depth and 7 more
...
#### `__init__(self, config: DataTesterConfig)`


#### `on_start(self)`


#### `setup_book(self, instrument_id: InstrumentId)`


#### `setup_book_pyo3(self, instrument_id: InstrumentId)`


#### `on_stop(self)`


#### `on_historical_data(self, data: Any)`
...
#### `on_order_book_depth(self, depth: OrderBookDepth10)`
...
#### `on_mark_price(self, mark_price: MarkPriceUpdate)`


#### `on_index_price(self, index_price: IndexPriceUpdate)`


#### `on_funding_rate(self, funding_rate: FundingRateUpdate)`
