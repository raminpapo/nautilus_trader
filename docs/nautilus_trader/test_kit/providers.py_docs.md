...
- **Path**: `nautilus_trader/test_kit/providers.py`
- **Size**: 45,331 bytes
- **Lines**: 1,278
- **Language**: Python
...
### Functions
- **`first_friday_two_years_six_months_ago()`**: Function defined in this file
- **`third_friday_of_month()`**: Function defined in this file
- **`get_contract_month_code()`**: Function defined in this file
- **`get_test_data_large_path()`**: Function defined in this file
...
- **`ensure_data_exists_tardis_deribit_book_l2()`**: Function defined in this file
- **`ensure_data_exists_tardis_binance_snapshot5()`**: Function defined in this file
- **`ensure_data_exists_tardis_binance_snapshot25()`**: Function defined in this file
- **`ensure_data_exists_tardis_huobi_quotes()`**: Function defined in this file
- **`ensure_data_exists_tardis_bitmex_trades()`**: Function defined in this file

### Classes
- **`TestInstrumentProvider`**: Class defined in this file
- **`TestDataProvider`**: Class defined in this file
- **`TestDataGenerator`**: Class defined in this file
...
**Classs**: `TestDataGenerator`, `TestDataProvider`, `TestInstrumentProvider`
**Functions**: `ensure_data_exists_tardis_binance_snapshot25`, `ensure_data_exists_tardis_binance_snapshot5`, `ensure_data_exists_tardis_bitmex_trades`, `ensure_data_exists_tardis_deribit_book_l2`, `ensure_data_exists_tardis_huobi_quotes`, `ensure_test_data_exists`, `first_friday_two_years_six_months_ago`, `get_contract_month_code`, `get_test_data_large_checksums_filepath`, `get_test_data_large_path`, `third_friday_of_month`
**Imports**: `datetime`, `decimal`, `fsspec`, `fsspec.implementations.local`, `nautilus_trader`, `nautilus_trader.core`, `nautilus_trader.core.correctness`, `nautilus_trader.core.datetime`, `nautilus_trader.core.uuid`, `nautilus_trader.model.currencies`, `nautilus_trader.model.data`, `nautilus_trader.model.enums`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.instruments`, `nautilus_trader.model.instruments.betting`, `nautilus_trader.model.objects`, `nautilus_trader.persistence.loaders`, `numpy`, `pandas`, `pathlib`, `pytz`, `random`, `typing`
...
```bash
# For Python
pytest nautilus_trader/test_kit/providers.py
...
---
*Generated on 2025-11-18T21:55:05.977297Z*
