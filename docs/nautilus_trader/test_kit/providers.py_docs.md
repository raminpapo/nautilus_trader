# Documentation: `nautilus_trader/test_kit/providers.py`
**Generated:** 2025-11-15T19:40:05.348506Z
**File Size:** 45359 bytes
**Extension:** .py
**Type:** text
...
This file is located at `nautilus_trader/test_kit/providers.py` within the repository.

**Classes defined:** TestInstrumentProvider, TestDataProvider, TestDataGenerator

**Functions defined:** adabtc_binance, adausdt_binance, btcusdt_binance, btcusdt_perp_binance, ethusdt_binance, ethusdt_perp_binance, btcusdt_future_binance, xrpusdt_linear_bybit, xbtusd_bitmex, ethusd_bitmex and 44 more
...
#### `onethousandrats_perp_binance()`


#### `default_fx_ccy(symbol: str, venue: Venue | None = None)`


#### `audusd_cfd()`


#### `equity(symbol: str = "AAPL", venue: str = "XNAS")`
...
#### `betting_instrument(venue: str | None = None)`
...
#### `first_friday_two_years_six_months_ago(year: int, month: int)`


#### `third_friday_of_month(year: int, month: int)`


#### `get_contract_month_code(expiry_month: int)`


#### `__init__(self, branch: str = "develop")`


#### `_test_data_directory()`


#### `_determine_filesystem(self)`


#### `_make_uri(self, path: str)`


#### `read(self, path: str)`


#### `read_csv(self, path: str, **kwargs: Any)`


#### `read_csv_ticks(self, path: str)`


#### `read_csv_bars(self, path: str)`


#### `read_parquet_ticks(self, path: str, timestamp_column: str = "timestamp")`


#### `read_parquet_bars(self, path: str)`


#### `simulate_value_diffs(
        count: int,
        max_diff: float = 10,
        prob_increase: float = 0.25,
        prob_decrease: float = 0.25,
...
#### `ensure_test_data_exists(filename: str, url: str)`
