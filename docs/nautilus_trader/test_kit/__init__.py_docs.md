# Documentation: `nautilus_trader/test_kit/__init__.py`
**Generated:** 2025-11-15T19:40:05.328928Z
...
- **Path:** `nautilus_trader/test_kit/__init__.py`
- **Size:** 1,034 bytes
- **Lines:** 18
- **Extension:** `.py`
- **Type:** text
...
This file is located at `nautilus_trader/test_kit/__init__.py` within the repository.
...
```python
import nautilus_trader.test_kit.__init__
```
