# Documentation: transformers.py

## File Metadata

- **Path**: `nautilus_trader/cache/transformers.py`
- **Size**: 20,929 bytes
- **Lines**: 434
- **Language**: Python
...
This file is part of the NautilusTrader repository. It defines 28 function(s).

## Detailed Walkthrough

### Functions
- **`transform_currency_from_pyo3()`**: Function defined in this file
- **`transform_currency_to_pyo3()`**: Function defined in this file
- **`transform_instrument_to_pyo3()`**: Function defined in this file
- **`transform_instrument_from_pyo3()`**: Function defined in this file
- **`transform_order_event_to_pyo3()`**: Function defined in this file
- **`from_order_initialized_cython_to_order_pyo3()`**: Function defined in this file
- **`from_order_initialized_pyo3_to_order_cython()`**: Function defined in this file
- **`transform_order_event_from_pyo3()`**: Function defined in this file
- **`transform_order_to_pyo3()`**: Function defined in this file
- **`transform_order_from_pyo3()`**: Function defined in this file
- **`transform_order_to_snapshot_pyo3()`**: Function defined in this file
- **`transform_position_to_snapshot_pyo3()`**: Function defined in this file
- **`transform_account_state_cython_to_pyo3()`**: Function defined in this file
- **`transform_account_state_pyo3_to_cython()`**: Function defined in this file
- **`from_account_state_pyo3_to_account_cython()`**: Function defined in this file
- **`from_account_state_cython_to_account_pyo3()`**: Function defined in this file
- **`transform_account_to_pyo3()`**: Function defined in this file
- **`transform_account_from_pyo3()`**: Function defined in this file
- **`transform_trade_tick_to_pyo3()`**: Function defined in this file
- **`transform_trade_tick_from_pyo3()`**: Function defined in this file
...
**Functions**: `from_account_state_cython_to_account_pyo3`, `from_account_state_pyo3_to_account_cython`, `from_order_initialized_cython_to_order_pyo3`, `from_order_initialized_pyo3_to_order_cython`, `transform_account_from_pyo3`, `transform_account_state_cython_to_pyo3`, `transform_account_state_pyo3_to_cython`, `transform_account_to_pyo3`, `transform_bar_to_pyo3`, `transform_currency_from_pyo3`, `transform_currency_to_pyo3`, `transform_custom_data_from_pyo3`, `transform_custom_data_to_pyo3`, `transform_data_type_from_pyo3`, `transform_data_type_to_pyo3`, `transform_instrument_from_pyo3`, `transform_instrument_to_pyo3`, `transform_order_event_from_pyo3`, `transform_order_event_to_pyo3`, `transform_order_from_pyo3`, `transform_order_to_pyo3`, `transform_order_to_snapshot_pyo3`, `transform_position_to_snapshot_pyo3`, `transform_quote_tick_to_pyo3`, `transform_signal_from_pyo3`, `transform_signal_to_pyo3`, `transform_trade_tick_from_pyo3`, `transform_trade_tick_to_pyo3`
**Imports**: `msgspec`, `nautilus_trader.accounting.accounts.base`, `nautilus_trader.accounting.accounts.cash`, `nautilus_trader.accounting.accounts.margin`, `nautilus_trader.core`, `nautilus_trader.core.data`, `nautilus_trader.model.data`, `nautilus_trader.model.enums`, `nautilus_trader.model.events`, `nautilus_trader.model.events.account`, `nautilus_trader.model.instruments`, `nautilus_trader.model.objects`, `nautilus_trader.model.orders`, `nautilus_trader.model.orders.unpacker`, `nautilus_trader.model.position`
...
---
*Generated on 2025-11-18T21:55:05.193658Z*
