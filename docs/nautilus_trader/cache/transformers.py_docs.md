# Documentation: `nautilus_trader/cache/transformers.py`
**Generated:** 2025-11-15T19:40:04.648373Z
**File Size:** 20929 bytes
**Extension:** .py
**Type:** text
...
This file is located at `nautilus_trader/cache/transformers.py` within the repository.

**Functions defined:** transform_currency_from_pyo3, transform_currency_to_pyo3, transform_instrument_to_pyo3, transform_instrument_from_pyo3, transform_order_event_to_pyo3, from_order_initialized_cython_to_order_pyo3, from_order_initialized_pyo3_to_order_cython, transform_order_event_from_pyo3, transform_order_to_pyo3, transform_order_from_pyo3 and 18 more
...
#### `transform_currency_from_pyo3(currency: nautilus_pyo3.Currency)`


#### `transform_currency_to_pyo3(currency: Currency)`


#### `transform_instrument_to_pyo3(instrument: Instrument)`


#### `transform_instrument_from_pyo3(instrument_pyo3)`
...
#### `transform_order_to_pyo3(order: Order)`


#### `transform_order_from_pyo3(order_pyo3)`


#### `transform_order_to_snapshot_pyo3(order: Order)`


#### `transform_position_to_snapshot_pyo3(
    position: Position,
    unrealized_pnl: Money | None = None,
)`


#### `transform_account_state_cython_to_pyo3(
    account_state: AccountState,
)`
...
#### `from_account_state_pyo3_to_account_cython(
    account_state_pyo3: nautilus_pyo3.AccountState,
    calculate_account_state: bool,
)`


#### `from_account_state_cython_to_account_pyo3(
    account_state: AccountState,
    calculate_account_state: bool,
)`


#### `transform_account_to_pyo3(account: Account)`


#### `transform_account_from_pyo3(account_pyo3)`


#### `transform_trade_tick_to_pyo3(trade: TradeTick)`


#### `transform_trade_tick_from_pyo3(trade_pyo3: nautilus_pyo3.TradeTick)`


#### `transform_quote_tick_to_pyo3(quote: QuoteTick)`


#### `transform_bar_to_pyo3(bar: Bar)`


#### `transform_signal_to_pyo3(signal: Data)`


#### `transform_signal_from_pyo3(signal_cls: type, signal_pyo3: nautilus_pyo3.Signal)`


#### `transform_data_type_to_pyo3(data_type: DataType)`


#### `transform_data_type_from_pyo3(data_type_pyo3: nautilus_pyo3.DataType)`


#### `transform_custom_data_to_pyo3(data: CustomData)`


#### `transform_custom_data_from_pyo3(data: nautilus_pyo3.CustomData)`
