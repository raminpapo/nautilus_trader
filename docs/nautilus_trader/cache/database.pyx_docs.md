# Documentation: database.pyx

## File Metadata

- **Path**: `nautilus_trader/cache/database.pyx`
- **Size**: 42,472 bytes
- **Lines**: 1,289
- **Language**: Unknown
...
**Identifiers**: `ANY`, `Account`, `AccountFactory`, `AccountId`, `Actor`, `Add`, `Added`, `All`, `Any`, `Assumes`, `BASIS`, `BLUE`, `BacktestEngine`, `COMMANDS`, `CONDITIONS`, `CPU`, `CacheConfig`, `CacheDatabaseAdapter`, `CacheDatabaseFacade`, `Cannot`, `Check`, `ClientId`, `ClientOrderId`, `Close`, `Closed`, `Closing`, `ComponentId`, `Condition`, `Configuration`, `Copyright` *(+93 more)*
...
---
*Generated on 2025-11-18T21:55:05.184031Z*
