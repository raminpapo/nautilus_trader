# Documentation: facade.pxd

## File Metadata

- **Path**: `nautilus_trader/cache/facade.pxd`
- **Size**: 5,286 bytes
- **Lines**: 107
- **Language**: Unknown
...
**Identifiers**: `ANY`, `Account`, `AccountId`, `Actor`, `All`, `BASIS`, `Bar`, `BarType`, `CONDITIONS`, `CacheDatabaseFacade`, `ClientId`, `ClientOrderId`, `ComponentId`, `Copyright`, `Currency`, `ExecAlgorithmId`, `GNU`, `General`, `Instrument`, `InstrumentId`, `KIND`, `Lesser`, `License`, `Licensed`, `Logger`, `Ltd`, `Money`, `Nautech`, `Order`, `OrderBook` *(+27 more)*
...
---
*Generated on 2025-11-18T21:55:05.186620Z*
