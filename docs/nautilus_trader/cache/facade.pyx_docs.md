# Documentation: facade.pyx

## File Metadata

- **Path**: `nautilus_trader/cache/facade.pyx`
- **Size**: 12,877 bytes
- **Lines**: 241
- **Language**: Unknown
...
**Identifiers**: `ANY`, `Abstract`, `Account`, `AccountId`, `Actor`, `All`, `BASIS`, `Bar`, `BarType`, `CONDITIONS`, `CacheConfig`, `CacheDatabaseFacade`, `ClientId`, `ClientOrderId`, `ComponentId`, `Copyright`, `Currency`, `ExecAlgorithmId`, `GNU`, `General`, `Instrument`, `InstrumentId`, `KIND`, `Lesser`, `License`, `Licensed`, `Logger`, `Ltd`, `Money`, `Nautech` *(+31 more)*
...
---
*Generated on 2025-11-18T21:55:05.189686Z*
