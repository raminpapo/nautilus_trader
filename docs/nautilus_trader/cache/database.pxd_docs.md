# Documentation: database.pxd

## File Metadata

- **Path**: `nautilus_trader/cache/database.pxd`
- **Size**: 1,104 bytes
- **Lines**: 23
- **Language**: Unknown
...
**Identifiers**: `ANY`, `All`, `BASIS`, `CONDITIONS`, `CacheDatabaseAdapter`, `CacheDatabaseFacade`, `Copyright`, `GNU`, `General`, `KIND`, `Lesser`, `License`, `Licensed`, `Ltd`, `Nautech`, `Pty`, `Public`, `See`, `Serializer`, `Systems`, `Unless`, `Version`, `WARRANTIES`, `WITHOUT`, `You`
...
---
*Generated on 2025-11-18T21:55:05.179133Z*
