# Documentation: cache.pxd

## File Metadata

- **Path**: `nautilus_trader/cache/cache.pxd`
- **Size**: 10,094 bytes
- **Lines**: 223
- **Language**: Unknown
...
**Identifiers**: `ANY`, `Account`, `AccountId`, `Actor`, `All`, `BASIS`, `Bar`, `BarType`, `CONDITIONS`, `Cache`, `CacheDatabaseFacade`, `CacheFacade`, `ClientId`, `ClientOrderId`, `Copyright`, `Currency`, `Decimal`, `FundingRateUpdate`, `GNU`, `General`, `IndexPriceUpdate`, `Instrument`, `InstrumentId`, `KIND`, `Lesser`, `License`, `Licensed`, `Logger`, `Ltd`, `MarkPriceUpdate` *(+29 more)*
...
---
*Generated on 2025-11-18T21:55:05.136240Z*
