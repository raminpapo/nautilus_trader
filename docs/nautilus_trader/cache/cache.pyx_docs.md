# Documentation: cache.pyx

## File Metadata

- **Path**: `nautilus_trader/cache/cache.pyx`
- **Size**: 178,655 bytes
- **Lines**: 5,436
- **Language**: Unknown
...
Total unique keywords extracted: 228


**Identifiers**: `ACCEPTED`, `ACCOUNT`, `ALGORITHM`, `ANY`, `ASK`, `Account`, `AccountId`, `Actor`, `Add`, `Added`, `AggregationSource`, `All`, `Always`, `Ask`, `Assign`, `Assigned`, `Audit`, `BASIS`, `BID`, `BLUE`, `Bar`, `BarAggregation`, `BarSpecification`, `BarType`, `Before`, `Bid`, `Brokers`, `Build`, `Building`, `COMMANDS` *(+198 more)*
...
---
*Generated on 2025-11-18T21:55:05.164209Z*
