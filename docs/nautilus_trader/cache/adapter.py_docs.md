# Documentation: `nautilus_trader/cache/adapter.py`
**Generated:** 2025-11-15T19:40:04.609350Z
**File Size:** 9665 bytes
**Extension:** .py
**Type:** text
...
- **Path:** `nautilus_trader/cache/adapter.py`
- **Size:** 9,665 bytes
- **Lines:** 211
- **Extension:** `.py`
- **Type:** text
...
This file is located at `nautilus_trader/cache/adapter.py` within the repository.

**Classes defined:** CachePostgresAdapter

**Functions defined:** __init__, dispose, flush, load, load_currencies, load_currency, load_instrument, load_order, load_orders, load_account and 21 more
...
#### `add_order_snapshot(self, order: Order)`
...
#### `update_account(self, account: Account)`
