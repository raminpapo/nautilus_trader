# Documentation: `nautilus_trader/live/data_engine.py`
**Generated:** 2025-11-15T19:40:04.988697Z
**File Size:** 17492 bytes
**Extension:** .py
**Type:** text
...
- **Path:** `nautilus_trader/live/data_engine.py`
- **Size:** 17,492 bytes
- **Lines:** 493
- **Extension:** `.py`
- **Type:** text
...
This file is located at `nautilus_trader/live/data_engine.py` within the repository.

**Classes defined:** LiveDataEngine

**Functions defined:** __init__, connect, disconnect, get_cmd_queue_task, get_req_queue_task, get_res_queue_task, get_data_queue_task, cmd_qsize, req_qsize, res_qsize and 10 more
...
#### `get_req_queue_task(self)`


#### `get_res_queue_task(self)`


#### `get_data_queue_task(self)`
...
#### `response(self, response: DataResponse)`
