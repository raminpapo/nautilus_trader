# Documentation: `nautilus_trader/live/retry.py`
**Generated:** 2025-11-15T19:40:05.014206Z
**File Size:** 13000 bytes
**Extension:** .py
**Type:** text
...
- **Path:** `nautilus_trader/live/retry.py`
- **Size:** 13,000 bytes
- **Lines:** 370
- **Extension:** `.py`
- **Type:** text
...
This file is located at `nautilus_trader/live/retry.py` within the repository.

**Functions defined:** get_exponential_backoff, __init__, __repr__, cancel, clear, _cancel, _log_retry, _log_error, _details_str, __init__ and 2 more
...
#### `_log_retry(self, retry_delay_ms: int)`
