# Documentation: `nautilus_trader/live/risk_engine.py`
**Generated:** 2025-11-15T19:40:05.016462Z
**File Size:** 10605 bytes
**Extension:** .py
**Type:** text
...
- **Path:** `nautilus_trader/live/risk_engine.py`
- **Size:** 10,605 bytes
- **Lines:** 299
- **Extension:** `.py`
- **Type:** text
...
This file is located at `nautilus_trader/live/risk_engine.py` within the repository.

**Classes defined:** LiveRiskEngine

**Functions defined:** __init__, get_cmd_queue_task, get_evt_queue_task, cmd_qsize, evt_qsize, kill, execute, process, _handle_queue_exception, _enqueue_sentinel and 2 more
