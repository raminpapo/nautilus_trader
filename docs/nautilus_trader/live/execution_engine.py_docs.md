# Documentation: `nautilus_trader/live/execution_engine.py`
**Generated:** 2025-11-15T19:40:05.002952Z
**File Size:** 130835 bytes
**Extension:** .py
**Type:** text
...
- **Path:** `nautilus_trader/live/execution_engine.py`
- **Size:** 130,835 bytes
- **Lines:** 3,041
- **Extension:** `.py`
- **Type:** text
...
This file is located at `nautilus_trader/live/execution_engine.py` within the repository.

**Classes defined:** LiveExecutionEngine

**Functions defined:** __init__, reconciliation, connect, disconnect, get_cmd_queue_task, get_evt_queue_task, get_own_books_audit_task, get_reconciliation_task, cmd_qsize, evt_qsize and 41 more
...
#### `get_cmd_queue_task(self)`


#### `get_evt_queue_task(self)`


#### `get_own_books_audit_task(self)`


#### `get_reconciliation_task(self)`
...
#### `process(self, event: OrderEvent)`


#### `_handle_queue_exception(self, e: Exception, queue_name: str)`


#### `_enqueue_sentinel(self)`


#### `_record_local_activity(self, event: OrderEvent | None)`


#### `_clear_recon_tracking(
        self,
        client_order_id: ClientOrderId,
        *,
        drop_last_query: bool = True,
...
#### `_prune_recent_fills_cache(self, ttl_secs: float = 60.0)`


#### `_handle_event_with_tracking(self, event: OrderEvent)`
...
#### `_resolve_inflight_order(self, order: Order)`


#### `_consider_for_reconciliation(self, instrument_id: InstrumentId)`


#### `_log_reconciliation_result(self, value: ClientId | InstrumentId, result: bool)`


#### `_log_skipping_reconciliation_on_instrument_id(self, report: ExecutionReport)`


#### `_log_skipping_reconciliation_on_client_order_id(self, report: ExecutionReport)`


#### `generate_execution_mass_status(self, command: GenerateExecutionMassStatus)`


#### `reconcile_execution_report(self, report: ExecutionReport)`


#### `reconcile_execution_mass_status(self, report: ExecutionMassStatus)`
...
#### `_reconcile_fill_report_single(self, report: FillReport)`


#### `_reconcile_fill_report(
        self,
        order: Order,
        report: FillReport,
        instrument: Instrument,
...
#### `_get_existing_fill_for_trade_id(
        self,
        order: Order,
        trade_id: TradeId,
    )`
...
#### `_fill_reports_equal(self, cached_fill: OrderFilled, report: FillReport)`


#### `_is_within_single_unit_tolerance(
        self,
        value1: Decimal,
        value2: Decimal,
        precision: int,
...
#### `_reconcile_position_report(self, report: PositionStatusReport)`


#### `_reconcile_position_report_hedging(self, report: PositionStatusReport)`


#### `_reconcile_position_report_netting(
        self,
        report: PositionStatusReport,
    )`


#### `_generate_client_order_id(self)`
...
#### `_generate_order_rejected(self, order: Order, report: OrderStatusReport)`


#### `_generate_order_accepted(self, order: Order, report: OrderStatusReport)`


#### `_generate_order_triggered(self, order: Order, report: OrderStatusReport)`


#### `_generate_order_updated(self, order: Order, report: OrderStatusReport)`


#### `_generate_order_canceled(self, order: Order, report: OrderStatusReport)`


#### `_generate_order_expired(self, order: Order, report: OrderStatusReport)`
