# Documentation: reconciliation.py

## File Metadata

- **Path**: `nautilus_trader/live/reconciliation.py`
- **Size**: 20,789 bytes
- **Lines**: 656
- **Language**: Python
...
### Functions
- **`is_within_single_unit_tolerance()`**: Function defined in this file
- **`get_existing_fill_for_trade_id()`**: Function defined in this file
- **`create_order_rejected_event()`**: Function defined in this file
- **`create_order_canceled_event()`**: Function defined in this file
- **`create_order_expired_event()`**: Function defined in this file
- **`create_order_accepted_event()`**: Function defined in this file
- **`create_order_triggered_event()`**: Function defined in this file
- **`create_order_updated_event()`**: Function defined in this file
- **`create_order_filled_event()`**: Function defined in this file
- **`create_inferred_order_filled_event()`**: Function defined in this file
- **`calculate_reconciliation_price()`**: Function defined in this file
- **`adjust_fills_for_partial_window_single()`**: Function defined in this file
...
**Functions**: `adjust_fills_for_partial_window`, `adjust_fills_for_partial_window_single`, `calculate_reconciliation_price`, `create_inferred_order_filled_event`, `create_order_accepted_event`, `create_order_canceled_event`, `create_order_expired_event`, `create_order_filled_event`, `create_order_rejected_event`, `create_order_triggered_event`, `create_order_updated_event`, `get_existing_fill_for_trade_id`, `is_within_single_unit_tolerance`
**Imports**: `decimal`, `nautilus_trader.cache.transformers`, `nautilus_trader.common.component`, `nautilus_trader.core`, `nautilus_trader.core.uuid`, `nautilus_trader.execution.reports`, `nautilus_trader.model.currencies`, `nautilus_trader.model.enums`, `nautilus_trader.model.events`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.instruments`, `nautilus_trader.model.objects`, `nautilus_trader.model.orders`
...
---
*Generated on 2025-11-18T21:55:05.608968Z*
