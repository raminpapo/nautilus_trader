# Documentation: `nautilus_trader/live/reconciliation.py`
**Generated:** 2025-11-15T19:40:05.011950Z
**File Size:** 19453 bytes
**Extension:** .py
**Type:** text
...
This file is located at `nautilus_trader/live/reconciliation.py` within the repository.

**Functions defined:** create_order_rejected_event, create_order_canceled_event, create_order_expired_event, create_order_accepted_event, create_order_triggered_event, create_order_updated_event, create_order_filled_event, create_inferred_order_filled_event, calculate_reconciliation_price, adjust_fills_for_partial_window_single and 1 more
...
#### `adjust_fills_for_partial_window_single(
    mass_status: ExecutionMassStatus,
    instrument: Instrument,
    logger: Logger | None = None,
)`
