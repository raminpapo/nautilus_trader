# Documentation: `nautilus_trader/live/node.py`
**Generated:** 2025-11-15T19:40:05.007703Z
**File Size:** 16084 bytes
**Extension:** .py
**Type:** text
...
- **Path:** `nautilus_trader/live/node.py`
- **Size:** 16,084 bytes
- **Lines:** 493
- **Extension:** `.py`
- **Type:** text
...
This file is located at `nautilus_trader/live/node.py` within the repository.

**Classes defined:** TradingNode

**Functions defined:** __init__, trader_id, machine_id, instance_id, trader, cache, portfolio, is_running, is_built, get_event_loop and 12 more
...
#### `add_stream_processor(self, callback: Callable)`
...
#### `run(self, raise_exception: bool = False)`


#### `publish_bus_message(self, bus_msg: nautilus_pyo3.BusMessage)`
...
#### `_handle_run_task_result(self, task: asyncio.Task)`


#### `_handle_streaming_exception(self, task: asyncio.Future)`
