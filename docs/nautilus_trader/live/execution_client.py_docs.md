# Documentation: `nautilus_trader/live/execution_client.py`
**Generated:** 2025-11-15T19:40:04.993274Z
**File Size:** 21011 bytes
**Extension:** .py
**Type:** text
...
- **Path:** `nautilus_trader/live/execution_client.py`
- **Size:** 21,011 bytes
- **Lines:** 603
- **Extension:** `.py`
- **Type:** text
...
This file is located at `nautilus_trader/live/execution_client.py` within the repository.

**Classes defined:** LiveExecutionClient

**Functions defined:** __init__, create_task, _on_task_completed, connect, disconnect, submit_order, submit_order_list, modify_order, cancel_order, cancel_all_orders and 4 more
