# Documentation: `nautilus_trader/live/data_client.py`
**Generated:** 2025-11-15T19:40:04.985948Z
**File Size:** 42433 bytes
**Extension:** .py
**Type:** text
...
- **Path:** `nautilus_trader/live/data_client.py`
- **Size:** 42,433 bytes
- **Lines:** 1,076
- **Extension:** `.py`
- **Type:** text
...
This file is located at `nautilus_trader/live/data_client.py` within the repository.

**Classes defined:** LiveDataClient, LiveMarketDataClient

**Functions defined:** __init__, create_task, _on_task_completed, connect, disconnect, subscribe, unsubscribe, request, __init__, create_task and 38 more
...
#### `subscribe(self, command: SubscribeData)`


#### `unsubscribe(self, command: UnsubscribeData)`


#### `request(self, request: RequestData)`
...
#### `subscribe_instruments(self, command: SubscribeInstruments)`


#### `subscribe_instrument(self, command: SubscribeInstrument)`


#### `subscribe_order_book_deltas(self, command: SubscribeOrderBook)`


#### `subscribe_order_book_snapshots(self, command: SubscribeOrderBook)`


#### `subscribe_quote_ticks(self, command: SubscribeQuoteTicks)`


#### `subscribe_trade_ticks(self, command: SubscribeTradeTicks)`


#### `subscribe_mark_prices(self, command: SubscribeMarkPrices)`


#### `subscribe_index_prices(self, command: SubscribeIndexPrices)`


#### `subscribe_funding_rates(self, command: SubscribeFundingRates)`


#### `subscribe_bars(self, command: SubscribeBars)`


#### `subscribe_instrument_status(self, command: SubscribeInstrumentStatus)`


#### `subscribe_instrument_close(self, command: SubscribeInstrumentClose)`


#### `unsubscribe(self, command: UnsubscribeData)`


#### `unsubscribe_instruments(self, command: UnsubscribeInstruments)`


#### `unsubscribe_instrument(self, command: UnsubscribeInstrument)`


#### `unsubscribe_order_book_deltas(self, command: UnsubscribeOrderBook)`


#### `unsubscribe_order_book_snapshots(self, command: UnsubscribeOrderBook)`


#### `unsubscribe_quote_ticks(self, command: UnsubscribeQuoteTicks)`


#### `unsubscribe_trade_ticks(self, command: UnsubscribeTradeTicks)`


#### `unsubscribe_mark_prices(self, command: UnsubscribeMarkPrices)`


#### `unsubscribe_index_prices(self, command: UnsubscribeIndexPrices)`


#### `unsubscribe_funding_rates(self, command: UnsubscribeFundingRates)`


#### `unsubscribe_bars(self, command: UnsubscribeBars)`


#### `unsubscribe_instrument_status(self, command: UnsubscribeInstrumentStatus)`


#### `unsubscribe_instrument_close(self, command: UnsubscribeInstrumentClose)`
...
#### `request_quote_ticks(self, request: RequestQuoteTicks)`


#### `request_trade_ticks(self, request: RequestTradeTicks)`


#### `request_bars(self, request: RequestBars)`


#### `request_order_book_snapshot(self, request: RequestOrderBookSnapshot)`


#### `request_order_book_depth(self, request: RequestOrderBookDepth)`
