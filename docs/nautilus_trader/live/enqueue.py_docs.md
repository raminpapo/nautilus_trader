# Documentation: `nautilus_trader/live/enqueue.py`
**Generated:** 2025-11-15T19:40:04.990388Z
...
- **Path:** `nautilus_trader/live/enqueue.py`
- **Size:** 4,915 bytes
- **Lines:** 156
- **Extension:** `.py`
- **Type:** text
...
This file is located at `nautilus_trader/live/enqueue.py` within the repository.

**Functions defined:** __init__, qname, size, capacity, enqueue, cancel_pending_tasks, _handle_task_exception, _enqueue_nowait_safely
...
#### `cancel_pending_tasks(self)`


#### `_handle_task_exception(self, task: asyncio.Task)`


#### `_enqueue_nowait_safely(self, queue: asyncio.Queue, msg: T)`
...
```python
from nautilus_trader.live.enqueue import __init__
```
