# Documentation: `nautilus_trader/live/config.py`
**Generated:** 2025-11-15T19:40:04.981601Z
...
This file is located at `nautilus_trader/live/config.py` within the repository.

**Classes defined:** LiveDataEngineConfig, LiveRiskEngineConfig, LiveExecEngineConfig, RoutingConfig, LiveDataClientConfig, LiveExecClientConfig, ControllerConfig, ControllerFactory, TradingNodeConfig

**Functions defined:** create, __post_init__
...
**Inherits from:** DataEngineConfig, frozen=True


#### `LiveRiskEngineConfig`

**Inherits from:** RiskEngineConfig, frozen=True


#### `LiveExecEngineConfig`

**Inherits from:** ExecEngineConfig, frozen=True
...
**Inherits from:** ActorConfig, kw_only=True, frozen=True
