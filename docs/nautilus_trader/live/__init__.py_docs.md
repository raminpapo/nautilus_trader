# Documentation: `nautilus_trader/live/__init__.py`
**Generated:** 2025-11-15T19:40:04.977061Z
...
- **Path:** `nautilus_trader/live/__init__.py`
- **Size:** 1,155 bytes
- **Lines:** 22
- **Extension:** `.py`
- **Type:** text
...
This file is located at `nautilus_trader/live/__init__.py` within the repository.
...
```python
import nautilus_trader.live.__init__
```
