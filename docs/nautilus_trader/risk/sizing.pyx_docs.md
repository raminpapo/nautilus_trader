# Documentation: sizing.pyx

## File Metadata

- **Path**: `nautilus_trader/risk/sizing.pyx`
- **Size**: 7,059 bytes
- **Lines**: 206
- **Language**: Unknown
...
**Identifiers**: `ANY`, `Abstract`, `All`, `BASIS`, `Batch`, `CONDITIONS`, `Calculate`, `Condition`, `Copyright`, `Decimal`, `Divide`, `FixedRiskSizer`, `GNU`, `General`, `Instrument`, `KIND`, `Lesser`, `License`, `Licensed`, `Limit`, `Ltd`, `Money`, `Nautech`, `None`, `NotImplementedError`, `Parameters`, `PositionSizer`, `Price`, `Provides`, `Pty` *(+17 more)*
...
---
*Generated on 2025-11-18T21:55:05.909677Z*
