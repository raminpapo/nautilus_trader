# Documentation: `nautilus_trader/risk/__init__.py`
**Generated:** 2025-11-15T19:40:05.285177Z
...
- **Path:** `nautilus_trader/risk/__init__.py`
- **Size:** 1,084 bytes
- **Lines:** 21
- **Extension:** `.py`
- **Type:** text
...
This file is located at `nautilus_trader/risk/__init__.py` within the repository.
...
```python
import nautilus_trader.risk.__init__
```
