# Documentation: `nautilus_trader/persistence/loaders.py`
**Generated:** 2025-11-15T19:40:05.255543Z
...
This file is located at `nautilus_trader/persistence/loaders.py` within the repository.

**Classes defined:** CSVTickDataLoader, CSVBarDataLoader, ParquetTickDataLoader, ParquetBarDataLoader, InterestRateProviderConfig, InterestRateProvider

**Functions defined:** load, load, load, load, __init__, on_start, update_interest_rate, on_stop, import_interest_rates, next_month_start_from_timestamp
...
#### `load(file_path: PathLike[str] | str)`


#### `__init__(self, config: InterestRateProviderConfig)`
