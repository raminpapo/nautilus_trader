# Documentation: loaders.py

## File Metadata

- **Path**: `nautilus_trader/persistence/loaders.py`
- **Size**: 8,884 bytes
- **Lines**: 287
- **Language**: Python
...
### Functions
- **`import_interest_rates()`**: Function defined in this file
- **`next_month_start_from_timestamp()`**: Function defined in this file

### Classes
- **`CSVTickDataLoader`**: Class defined in this file
- **`CSVBarDataLoader`**: Class defined in this file
- **`ParquetTickDataLoader`**: Class defined in this file
- **`ParquetBarDataLoader`**: Class defined in this file
- **`InterestRateProviderConfig`**: Class defined in this file
- **`InterestRateProvider`**: Class defined in this file
...
**Classs**: `CSVBarDataLoader`, `CSVTickDataLoader`, `InterestRateProvider`, `InterestRateProviderConfig`, `ParquetBarDataLoader`, `ParquetTickDataLoader`
**Functions**: `import_interest_rates`, `next_month_start_from_timestamp`
**Imports**: `nautilus_trader.common.actor`, `nautilus_trader.common.config`, `nautilus_trader.core.datetime`, `nautilus_trader.model.data`, `nautilus_trader.model.greeks_data`, `numpy`, `os`, `pandas`, `typing`
...
---
*Generated on 2025-11-18T21:55:05.867068Z*
