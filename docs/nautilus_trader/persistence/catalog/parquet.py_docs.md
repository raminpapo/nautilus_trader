# Documentation: parquet.py

## File Metadata

- **Path**: `nautilus_trader/persistence/catalog/parquet.py`
- **Size**: 98,145 bytes
- **Lines**: 2,545
- **Language**: Python
...
### Functions
- **`_timestamps_to_filename()`**: Function defined in this file
- **`_iso_timestamp_to_file_timestamp()`**: Function defined in this file
- **`_query_intersects_filename()`**: Function defined in this file
- **`_parse_filename_timestamps()`**: Function defined in this file
- **`_file_timestamp_to_iso_timestamp()`**: Function defined in this file
- **`_are_intervals_disjoint()`**: Function defined in this file
- **`_are_intervals_contiguous()`**: Function defined in this file
- **`_query_interval_diff()`**: Function defined in this file
- **`_get_integer_interval_set()`**: Function defined in this file
- **`_extract_sql_safe_filename()`**: Function defined in this file

### Classes
- **`FeatherFile`**: Class defined in this file
...
**Classs**: `FeatherFile`, `ParquetDataCatalog`
**Functions**: `_are_intervals_contiguous`, `_are_intervals_disjoint`, `_extract_sql_safe_filename`, `_file_timestamp_to_iso_timestamp`, `_get_integer_interval_set`, `_iso_timestamp_to_file_timestamp`, `_parse_filename_timestamps`, `_query_intersects_filename`, `_query_interval_diff`, `_timestamps_to_filename`
**Imports**: `__future__`, `collections`, `collections.abc`, `fsspec`, `fsspec.implementations.local`, `fsspec.implementations.memory`, `fsspec.utils`, `itertools`, `nautilus_trader.core`, `nautilus_trader.core.correctness`, `nautilus_trader.core.data`, `nautilus_trader.core.datetime`, `nautilus_trader.core.inspect`, `nautilus_trader.core.message`, `nautilus_trader.core.nautilus_pyo3`, `nautilus_trader.model.data`, `nautilus_trader.model.instruments`, `nautilus_trader.persistence.catalog.base`, `nautilus_trader.persistence.funcs`, `nautilus_trader.serialization.arrow.serializer`, `os`, `pandas`, `pathlib`, `platform`, `portion`, `pyarrow`, `pyarrow.dataset`, `pyarrow.parquet`, `re`, `typing`
...
---
*Generated on 2025-11-18T21:55:05.859981Z*
