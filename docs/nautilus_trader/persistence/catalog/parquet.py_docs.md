# Documentation: `nautilus_trader/persistence/catalog/parquet.py`
**Generated:** 2025-11-15T19:40:05.247735Z
**File Size:** 98145 bytes
**Extension:** .py
**Type:** text
...
This file is located at `nautilus_trader/persistence/catalog/parquet.py` within the repository.

**Classes defined:** FeatherFile, ParquetDataCatalog

**Functions defined:** __init__, from_env, from_uri, write_data, identifier_function, obj_to_type, _write_chunk, _objects_to_table, extend_file_name, reset_all_file_names and 53 more
...
#### `identifier_function(obj: Any)`


#### `obj_to_type(obj: Data)`
...
#### `_objects_to_table(self, data: list[Data], data_cls: type)`
...
#### `reset_all_file_names(self)`


#### `reset_data_file_names(
        self,
        data_cls: type,
        identifier: str | None = None,
    )`
...
#### `_reset_file_names(self, directory: str)`


#### `_min_max_from_parquet_metadata(self, file_path: str, column_name: str)`
...
#### `_deduplicate_table(table: pa.Table)`
...
#### `consolidate_data_by_period(  # noqa: C901
        self,
        data_cls: type,
        identifier: str | None = None,
        period: pd.Timedelta = pd.Timedelta(days=1)`
...
#### `_prepare_consolidation_queries(  # noqa: C901
        self,
        data_cls: type,
        identifier: str | None,
        intervals: list[tuple[int, int]],
...
#### `_find_leaf_data_directories(self)`


#### `_extract_data_cls_and_identifier_from_path(
        self,
        directory: str,
    )`


#### `delete_data_range(  # noqa: C901
        self,
        data_cls: type,
        identifier: str | None = None,
        start: TimestampLike | None = None,
...
#### `_build_file_uri(self, file: str)`


#### `_register_object_store_with_session(self, session: DataBackendSession)`


#### `_nautilus_data_cls_to_data_type(data_cls: type)`
...
#### `_get_directory_intervals(self, directory: str)`
...
#### `list_data_types(self)`


#### `list_backtest_runs(self)`


#### `list_live_runs(self)`


#### `read_live_run(self, instance_id: str, **kwargs: Any)`


#### `read_backtest(self, instance_id: str, **kwargs: Any)`
...
```python
from nautilus_trader.persistence.catalog.parquet import FeatherFile
```
...
**Security:** This file may contain sensitive patterns: secret, token, session. Ensure proper handling of secrets.
