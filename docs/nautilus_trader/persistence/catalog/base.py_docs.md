# Documentation: `nautilus_trader/persistence/catalog/base.py`
**Generated:** 2025-11-15T19:40:05.239400Z
**File Size:** 6837 bytes
**Extension:** .py
**Type:** text
...
- **Path:** `nautilus_trader/persistence/catalog/base.py`
- **Size:** 6,837 bytes
- **Lines:** 213
- **Extension:** `.py`
- **Type:** text
...
This file is located at `nautilus_trader/persistence/catalog/base.py` within the repository.

**Classes defined:** _CombinedMeta, BaseDataCatalog

**Functions defined:** from_env, from_uri, instruments, _query_subclasses, instrument_status, instrument_closes, order_book_deltas, order_book_depth10, quote_ticks, trade_ticks and 10 more
...
**Inherits from:** Singleton, ABCMeta


#### `BaseDataCatalog`

**Inherits from:** ABC, metaclass=_CombinedMeta
...
#### `from_uri(cls, uri: str, storage_options: dict[str, str] | None = None)`
...
```python
from nautilus_trader.persistence.catalog.base import _CombinedMeta
```
