# Documentation: `nautilus_trader/persistence/writer.py`
**Generated:** 2025-11-15T19:40:05.266929Z
**File Size:** 21252 bytes
**Extension:** .py
**Type:** text
...
- **Path:** `nautilus_trader/persistence/writer.py`
- **Size:** 21,252 bytes
- **Lines:** 576
- **Extension:** `.py`
- **Type:** text
...
This file is located at `nautilus_trader/persistence/writer.py` within the repository.

**Classes defined:** RotationMode, StreamingFeatherWriter

**Functions defined:** __init__, _create_writers, write, _check_file_rotation, _update_next_rotation_time, _rotate_identifier_file, _rotate_regular_file, _create_identifier_writer, _create_writer, _extract_obj_metadata and 6 more
...
#### `_create_writers(self)`


#### `write(self, obj: object)`


#### `_check_file_rotation(self, table_name: str | tuple[str, str])`


#### `_update_next_rotation_time(self, table_name: str | tuple[str, str])`


#### `_rotate_identifier_file(self, cls: type, obj: Any)`


#### `_rotate_regular_file(self, table_name: str, cls: type)`


#### `_create_identifier_writer(self, cls: type, obj: Any)`
...
#### `get_current_file_info(self)`


#### `get_next_rotation_time(
        self,
        table_name: str | tuple[str, str],
    )`
