...
### Classes
- **`RotationMode`**: Class defined in this file
- **`StreamingFeatherWriter`**: Class defined in this file
...
**Classs**: `RotationMode`, `StreamingFeatherWriter`
**Imports**: `datetime`, `enum`, `fsspec`, `fsspec.compression`, `io`, `nautilus_trader.cache.cache`, `nautilus_trader.common.component`, `nautilus_trader.core.correctness`, `nautilus_trader.model.data`, `nautilus_trader.persistence.funcs`, `nautilus_trader.serialization.arrow.serializer`, `pandas`, `pyarrow`, `pytz`, `typing`
...
---
*Generated on 2025-11-18T21:55:05.878789Z*
