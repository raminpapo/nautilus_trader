# Documentation: `nautilus_trader/persistence/wranglers_v2.py`
**Generated:** 2025-11-15T19:40:05.263914Z
**File Size:** 30259 bytes
**Extension:** .py
**Type:** text
...
- **Path:** `nautilus_trader/persistence/wranglers_v2.py`
- **Size:** 30,259 bytes
- **Lines:** 850
- **Extension:** `.py`
- **Type:** text
...
This file is located at `nautilus_trader/persistence/wranglers_v2.py` within the repository.

**Classes defined:** WranglerBase, OrderBookDeltaDataWranglerV2, OrderBookDepth10DataWranglerV2, QuoteTickDataWranglerV2, TradeTickDataWranglerV2, BarDataWranglerV2

**Functions defined:** from_instrument, from_schema, decode, __init__, from_arrow, from_pandas, __init__, from_arrow, _process_price_column, _process_size_column and 13 more
...
#### `OrderBookDeltaDataWranglerV2`

**Inherits from:** WranglerBase


#### `OrderBookDepth10DataWranglerV2`

**Inherits from:** WranglerBase


#### `QuoteTickDataWranglerV2`
...
#### `_process_price_column(self, df: pd.DataFrame, col_name: str, default_bytes: bytes)`


#### `_process_size_column(self, df: pd.DataFrame, col_name: str, default_bytes: bytes)`


#### `_process_count_column(self, df: pd.DataFrame, col_name: str)`
...
#### `__init__(self, instrument_id: str, price_precision: int, size_precision: int)`
...
```python
from nautilus_trader.persistence.wranglers_v2 import WranglerBase
```
