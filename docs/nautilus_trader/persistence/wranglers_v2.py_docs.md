...
This file is part of the NautilusTrader repository. It defines 1 function(s) and 6 class(es).

## Detailed Walkthrough

### Functions
- **`_map_aggressor_side()`**: Function defined in this file

### Classes
- **`WranglerBase`**: Class defined in this file
- **`OrderBookDeltaDataWranglerV2`**: Class defined in this file
- **`OrderBookDepth10DataWranglerV2`**: Class defined in this file
- **`QuoteTickDataWranglerV2`**: Class defined in this file
- **`TradeTickDataWranglerV2`**: Class defined in this file
- **`BarDataWranglerV2`**: Class defined in this file
...
**Classs**: `BarDataWranglerV2`, `OrderBookDeltaDataWranglerV2`, `OrderBookDepth10DataWranglerV2`, `QuoteTickDataWranglerV2`, `TradeTickDataWranglerV2`, `WranglerBase`
**Functions**: `_map_aggressor_side`
**Imports**: `abc`, `nautilus_trader.core`, `nautilus_trader.model.instruments`, `nautilus_trader.model.objects`, `pandas`, `pyarrow`, `typing`
...
---
*Generated on 2025-11-18T21:55:05.875692Z*
