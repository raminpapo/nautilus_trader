...
### Functions
- **`class_to_filename()`**: Function defined in this file
- **`filename_to_class()`**: Function defined in this file
- **`urisafe_identifier()`**: Function defined in this file
- **`combine_filters()`**: Function defined in this file
...
**Functions**: `class_to_filename`, `combine_filters`, `filename_to_class`, `urisafe_identifier`
**Imports**: `nautilus_trader.core.inspect`, `nautilus_trader.core.nautilus_pyo3`, `nautilus_trader.model.data`, `nautilus_trader.model.identifiers`, `nautilus_trader.serialization.arrow.serializer`
...
---
*Generated on 2025-11-18T21:55:05.865178Z*
