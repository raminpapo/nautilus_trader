...
**Identifiers**: `ANY`, `Add`, `AggressorSide`, `All`, `BAR_COLUMNS`, `BAR_PRICES`, `BASIS`, `BUY`, `BUYER`, `Bar`, `BarDataWrangler`, `BarType`, `BookAction`, `BookOrder`, `Build`, `CONDITIONS`, `Calculate`, `Can`, `Cannot`, `Condition`, `Convert`, `Copyright`, `Create`, `DataFrame`, `DatetimeIndex`, `Drop`, `Ensure`, `Ensures`, `Expects`, `FIXED_SCALAR` *(+60 more)*
...
---
*Generated on 2025-11-18T21:55:05.871646Z*
