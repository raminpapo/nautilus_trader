# Documentation: `nautilus_trader/persistence/wranglers.pyx`
**Generated:** 2025-11-15T19:40:05.260242Z
**File Size:** 28504 bytes
**Extension:** .pyx
**Type:** text
...
- **Path:** `nautilus_trader/persistence/wranglers.pyx`
- **Size:** 28,504 bytes
- **Lines:** 791
- **Extension:** `.pyx`
- **Type:** text
...
This file is located at `nautilus_trader/persistence/wranglers.pyx` within the repository.

**Functions defined:** preprocess_bar_data, calculate_bar_price_offsets, calculate_volume_quarter, align_bid_ask_bar_data, prepare_event_and_init_timestamps, __init__, process, __init__, process, process_bar_data and 8 more
...
#### `calculate_bar_price_offsets(num_records, timestamp_is_close: bool, offset_interval_ms: int, random_seed=None)`


#### `calculate_volume_quarter(volume: np.ndarray, precision: int, size_increment: float)`


#### `align_bid_ask_bar_data(bid_data: pd.DataFrame, ask_data: pd.DataFrame)`


#### `prepare_event_and_init_timestamps(
    index: pd.DatetimeIndex,
    ts_init_delta: int,
)`


#### `__init__(self, Instrument instrument not None)`


#### `process(self, data: pd.DataFrame, ts_init_delta: int=0, bint is_raw=False)`
...
#### `_create_side_if_not_exist(self, data)`
