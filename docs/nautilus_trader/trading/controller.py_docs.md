# Documentation: `nautilus_trader/trading/controller.py`
**Generated:** 2025-11-15T19:40:05.395166Z
...
- **Path:** `nautilus_trader/trading/controller.py`
- **Size:** 12,476 bytes
- **Lines:** 423
- **Extension:** `.py`
- **Type:** text
...
This file is located at `nautilus_trader/trading/controller.py` within the repository.

**Classes defined:** Controller

**Functions defined:** __init__, register_base, execute, create_actor, create_strategy, start_actor, start_strategy, stop_actor, stop_strategy, remove_actor and 9 more
...
#### `create_actor(self, actor: Actor, start: bool = True)`


#### `create_strategy(self, strategy: Strategy, start: bool = True)`


#### `start_actor(self, actor: Actor)`


#### `start_strategy(self, strategy: Strategy)`


#### `stop_actor(self, actor: Actor)`


#### `stop_strategy(self, strategy: Strategy)`


#### `remove_actor(self, actor: Actor)`


#### `remove_strategy(self, strategy: Strategy)`
...
#### `start_actor_from_id(self, actor_id: ComponentId)`


#### `start_strategy_from_id(self, strategy_id: StrategyId)`


#### `stop_actor_from_id(self, actor_id: ComponentId)`


#### `stop_strategy_from_id(self, strategy_id: StrategyId)`


#### `remove_actor_from_id(self, actor_id: ComponentId)`


#### `remove_strategy_from_id(self, strategy_id: StrategyId)`
