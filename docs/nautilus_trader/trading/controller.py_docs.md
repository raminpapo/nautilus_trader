...
### Classes
- **`Controller`**: Class defined in this file
...
**Classs**: `Controller`
**Imports**: `nautilus_trader.cache.base`, `nautilus_trader.common.actor`, `nautilus_trader.common.component`, `nautilus_trader.common.config`, `nautilus_trader.core.correctness`, `nautilus_trader.core.message`, `nautilus_trader.model.identifiers`, `nautilus_trader.portfolio.base`, `nautilus_trader.trading.config`, `nautilus_trader.trading.messages`, `nautilus_trader.trading.strategy`, `nautilus_trader.trading.trader`
...
---
*Generated on 2025-11-18T21:55:06.021772Z*
