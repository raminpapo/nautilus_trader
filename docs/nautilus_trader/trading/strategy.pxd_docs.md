# Documentation: strategy.pxd

## File Metadata

- **Path**: `nautilus_trader/trading/strategy.pxd`
- **Size**: 9,474 bytes
- **Lines**: 181
- **Language**: Unknown
...
**Identifiers**: `ABSTRACT`, `ANY`, `AccountId`, `Actor`, `All`, `BASIS`, `COMMANDS`, `CONDITIONS`, `CacheFacade`, `CancelOrder`, `ClientId`, `ClientOrderId`, `Clock`, `Copyright`, `EVENTS`, `GNU`, `GTD`, `General`, `IDs`, `InstrumentId`, `KIND`, `Lesser`, `License`, `Licensed`, `Ltd`, `METHODS`, `MessageBus`, `ModifyOrder`, `Nautech`, `OmsType` *(+50 more)*
...
---
*Generated on 2025-11-18T21:55:06.027137Z*
