# Documentation: `nautilus_trader/trading/trader.py`
**Generated:** 2025-11-15T19:40:05.409554Z
**File Size:** 25848 bytes
**Extension:** .py
**Type:** text
...
- **Path:** `nautilus_trader/trading/trader.py`
- **Size:** 25,848 bytes
- **Lines:** 876
- **Extension:** `.py`
- **Type:** text
...
This file is located at `nautilus_trader/trading/trader.py` within the repository.

**Classes defined:** Trader

**Functions defined:** __init__, instance_id, actors, strategies, exec_algorithms, actor_ids, strategy_ids, exec_algorithm_ids, actor_states, strategy_states and 30 more
...
#### `exec_algorithm_ids(self)`


#### `actor_states(self)`


#### `strategy_states(self)`


#### `exec_algorithm_states(self)`
...
#### `add_actor(self, actor: Actor)`


#### `add_actors(self, actors: list[Actor])`


#### `add_strategy(self, strategy: Strategy)`


#### `add_strategies(self, strategies: list[Strategy])`


#### `add_exec_algorithm(self, exec_algorithm: Any)`


#### `add_exec_algorithms(self, exec_algorithms: list[Any])`


#### `start_actor(self, actor_id: ComponentId)`


#### `start_strategy(self, strategy_id: StrategyId)`


#### `stop_actor(self, actor_id: ComponentId)`


#### `stop_strategy(self, strategy_id: StrategyId)`


#### `remove_actor(self, actor_id: ComponentId)`


#### `remove_strategy(self, strategy_id: StrategyId)`
...
#### `subscribe(self, topic: str, handler: Callable[[Any], None])`


#### `unsubscribe(self, topic: str, handler: Callable[[Any], None])`
