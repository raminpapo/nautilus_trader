# Documentation: `nautilus_trader/trading/filters.py`
**Generated:** 2025-11-15T19:40:05.397057Z
**File Size:** 7868 bytes
**Extension:** .py
**Type:** text
...
This file is located at `nautilus_trader/trading/filters.py` within the repository.

**Classes defined:** NewsImpact, NewsEvent, EconomicNewsEventFilter

**Functions defined:** __init__, impact, name, currency, ts_event, ts_init, __repr__, __init__, unfiltered_data_start, unfiltered_data_end and 4 more
...
#### `unfiltered_data_start(self)`


#### `unfiltered_data_end(self)`
...
#### `next_event(self, time_now: datetime)`


#### `prev_event(self, time_now: datetime)`
