# Documentation: strategy.pyx

## File Metadata

- **Path**: `nautilus_trader/trading/strategy.pyx`
- **Size**: 65,342 bytes
- **Lines**: 1,802
- **Language**: Unknown
...
Total unique keywords extracted: 196


**Identifiers**: `ABSTRACT`, `ACTION`, `ANY`, `API`, `AccountId`, `Actions`, `Actor`, `Additional`, `All`, `Already`, `Always`, `Any`, `Assign`, `BASIS`, `BLUE`, `Bar`, `BarType`, `Batch`, `BatchCancelOrders`, `COMMANDS`, `CONDITIONS`, `Cache`, `CacheFacade`, `Cancel`, `CancelAllOrders`, `CancelOrder`, `Canceling`, `Cannot`, `Change`, `Check` *(+166 more)*
...
---
*Generated on 2025-11-18T21:55:06.033692Z*
