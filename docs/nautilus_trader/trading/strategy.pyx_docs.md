# Documentation: `nautilus_trader/trading/strategy.pyx`
**Generated:** 2025-11-15T19:40:05.405740Z
**File Size:** 65342 bytes
**Extension:** .pyx
**Type:** text
...
This file is located at `nautilus_trader/trading/strategy.pyx` within the repository.

**Functions defined:** __init__, _parse_external_order_claims, to_importable_config
...
#### `__init__(self, config: StrategyConfig | None = None)`


#### `_parse_external_order_claims(
        self,
        config_claims: list[str] | None,
    )`
