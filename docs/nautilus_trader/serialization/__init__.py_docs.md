# Documentation: `nautilus_trader/serialization/__init__.py`
**Generated:** 2025-11-15T19:40:05.297072Z
...
- **Path:** `nautilus_trader/serialization/__init__.py`
- **Size:** 1,224 bytes
- **Lines:** 27
- **Extension:** `.py`
- **Type:** text
...
This file is located at `nautilus_trader/serialization/__init__.py` within the repository.
...
```python
import nautilus_trader.serialization.__init__
```
