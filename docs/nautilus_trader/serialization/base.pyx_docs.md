...
- **Path**: `nautilus_trader/serialization/base.pyx`
- **Size**: 15,657 bytes
- **Lines**: 347
- **Language**: Unknown
...
**Identifiers**: `ANY`, `Abstract`, `AccountState`, `All`, `Any`, `BASIS`, `Bar`, `BatchCancelOrders`, `BettingInstrument`, `BinaryOption`, `CONDITIONS`, `Callable`, `CancelAllOrders`, `CancelOrder`, `Cfd`, `Commodity`, `ComponentStateChanged`, `Condition`, `Copyright`, `CryptoFuture`, `CryptoOption`, `CryptoPerpetual`, `CurrencyPair`, `Default`, `Equity`, `ExecutionMassStatus`, `FillReport`, `FuturesContract`, `FuturesSpread`, `GNU` *(+72 more)*

## Related Files

This file is located in `nautilus_trader/serialization/`. Related files may include:
...
---
*Generated on 2025-11-18T21:55:05.933084Z*
