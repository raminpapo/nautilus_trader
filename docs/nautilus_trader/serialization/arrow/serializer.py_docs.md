# Documentation: `nautilus_trader/serialization/arrow/serializer.py`
**Generated:** 2025-11-15T19:40:05.312945Z
...
This file is located at `nautilus_trader/serialization/arrow/serializer.py` within the repository.

**Classes defined:** ArrowSerializer

**Functions defined:** get_schema, list_schemas, register_arrow, _unpack_container_objects, rust_defined_to_record_batch, serialize, serialize_batch, deserialize, _deserialize_rust, make_dict_serializer and 4 more
...
#### `_unpack_container_objects(data_cls: type, data: list[Any])`


#### `rust_defined_to_record_batch(  # noqa: C901 (too complex)`
...
#### `deserialize(data_cls: type, batch: pa.RecordBatch | pa.Table)`


#### `_deserialize_rust(data_cls: type, table: pa.Table)`


#### `make_dict_serializer(schema: pa.Schema)`


#### `inner(data: list[Data | Event])`


#### `make_dict_deserializer(data_cls)`


#### `inner(table: pa.Table)`


#### `dicts_to_record_batch(data: list[dict], schema: pa.Schema)`
...
**Directory:** `nautilus_trader/serialization/arrow`
