...
- **Path**: `nautilus_trader/serialization/arrow/serializer.py`
- **Size**: 16,073 bytes
- **Lines**: 448
- **Language**: Python
...
- **`list_schemas()`**: Function defined in this file
- **`register_arrow()`**: Function defined in this file
- **`make_dict_serializer()`**: Function defined in this file
- **`make_dict_deserializer()`**: Function defined in this file
- **`dicts_to_record_batch()`**: Function defined in this file

### Classes
- **`ArrowSerializer`**: Class defined in this file
...
**Classs**: `ArrowSerializer`
**Functions**: `dicts_to_record_batch`, `get_schema`, `list_schemas`, `make_dict_deserializer`, `make_dict_serializer`, `register_arrow`
**Imports**: `collections.abc`, `io`, `nautilus_trader.common.messages`, `nautilus_trader.core`, `nautilus_trader.core.correctness`, `nautilus_trader.core.data`, `nautilus_trader.core.message`, `nautilus_trader.model.data`, `nautilus_trader.model.events`, `nautilus_trader.model.instruments`, `nautilus_trader.persistence.wranglers_v2`, `nautilus_trader.serialization.arrow.implementations`, `nautilus_trader.serialization.arrow.schema`, `pyarrow`, `typing`

## Related Files

This file is located in `nautilus_trader/serialization/arrow/`. Related files may include:
...
---
*Generated on 2025-11-18T21:55:05.928874Z*
