...
### Functions
- **`infer_dtype()`**: Function defined in this file
...
**Functions**: `infer_dtype`
**Imports**: `msgspec`, `nautilus_trader.common.messages`, `nautilus_trader.core`, `nautilus_trader.model.data`, `nautilus_trader.model.events`, `pyarrow`
...
---
*Generated on 2025-11-18T21:55:05.926403Z*
