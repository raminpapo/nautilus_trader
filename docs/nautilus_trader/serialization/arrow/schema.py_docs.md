# Documentation: `nautilus_trader/serialization/arrow/schema.py`
**Generated:** 2025-11-15T19:40:05.310152Z
**File Size:** 17055 bytes
**Extension:** .py
**Type:** text
...
- **Path:** `nautilus_trader/serialization/arrow/schema.py`
- **Size:** 17,055 bytes
- **Lines:** 429
- **Extension:** `.py`
- **Type:** text
...
This file is located at `nautilus_trader/serialization/arrow/schema.py` within the repository.

**Functions defined:** infer_dtype
...
```python
from nautilus_trader.serialization.arrow.schema import infer_dtype
```
