# Documentation: `nautilus_trader/serialization/arrow/implementations/instruments.py`
**Generated:** 2025-11-15T19:40:05.305100Z
...
- **Path:** `nautilus_trader/serialization/arrow/implementations/instruments.py`
- **Size:** 19,893 bytes
- **Lines:** 441
- **Extension:** `.py`
- **Type:** text
...
This file is located at `nautilus_trader/serialization/arrow/implementations/instruments.py` within the repository.
...
#### `serialize(obj: Instrument)`


#### `deserialize(batch: pa.RecordBatch)`
...
```python
from nautilus_trader.serialization.arrow.implementations.instruments import serialize
```
