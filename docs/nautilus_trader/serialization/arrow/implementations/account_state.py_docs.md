# Documentation: `nautilus_trader/serialization/arrow/implementations/account_state.py`
**Generated:** 2025-11-15T19:40:05.300558Z
**File Size:** 5446 bytes
**Extension:** .py
**Type:** text
...
- **Path:** `nautilus_trader/serialization/arrow/implementations/account_state.py`
- **Size:** 5,446 bytes
- **Lines:** 161
- **Extension:** `.py`
- **Type:** text
...
This file is located at `nautilus_trader/serialization/arrow/implementations/account_state.py` within the repository.

**Functions defined:** serialize, _deserialize, deserialize
...
#### `serialize(state: AccountState)`


#### `_deserialize(values: list[Any])`


#### `deserialize(data: pa.RecordBatch)`
...
```python
from nautilus_trader.serialization.arrow.implementations.account_state import serialize
```
