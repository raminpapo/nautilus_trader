# Documentation: serializer.pyx

## File Metadata

- **Path**: `nautilus_trader/serialization/serializer.pyx`
- **Size**: 5,792 bytes
- **Lines**: 171
- **Language**: Unknown
...
**Identifiers**: `ANY`, `All`, `Any`, `BASIS`, `CONDITIONS`, `Callable`, `Check`, `Condition`, `Copyright`, `Deserialize`, `Else`, `False`, `GNU`, `General`, `ISO`, `Instrument`, `JSON`, `KIND`, `Lesser`, `License`, `Licensed`, `Ltd`, `MessagePack`, `MsgSpecSerializer`, `Nautech`, `None`, `Parameters`, `Provides`, `Pty`, `Public` *(+15 more)*
...
---
*Generated on 2025-11-18T21:55:05.935937Z*
