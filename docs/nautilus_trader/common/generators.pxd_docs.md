# Documentation: generators.pxd

## File Metadata

- **Path**: `nautilus_trader/common/generators.pxd`
- **Size**: 2,388 bytes
- **Lines**: 63
- **Language**: Unknown
...
**Identifiers**: `ANY`, `All`, `BASIS`, `CONDITIONS`, `ClientOrderId`, `ClientOrderIdGenerator`, `Clock`, `Copyright`, `GNU`, `General`, `IDs`, `IdentifierGenerator`, `KIND`, `Lesser`, `License`, `Licensed`, `Ltd`, `Nautech`, `OrderListId`, `OrderListIdGenerator`, `PositionId`, `PositionIdGenerator`, `Pty`, `Public`, `See`, `StrategyId`, `Systems`, `The`, `UUID4`, `Unless` *(+4 more)*
...
---
*Generated on 2025-11-18T21:55:05.254978Z*
