# Documentation: actor.pyx

## File Metadata

- **Path**: `nautilus_trader/common/actor.pyx`
- **Size**: 149,597 bytes
- **Lines**: 4,330
- **Language**: Unknown
...
Total unique keywords extracted: 211


**Identifiers**: `ABSTRACT`, `ACTION`, `ACTOR`, `ANY`, `AbstractEventLoop`, `Actions`, `Actor`, `ActorConfig`, `ActorExecutor`, `Add`, `Additional`, `All`, `Any`, `Assigned`, `BASIS`, `BLUE`, `Bar`, `BarType`, `Because`, `BookType`, `CMD`, `COMMANDS`, `CONDITIONS`, `CacheFacade`, `Call`, `Callable`, `Calls`, `Can`, `Cancel`, `Canceled` *(+181 more)*
...
---
*Generated on 2025-11-18T21:55:05.213652Z*
