# Documentation: actor.pxd

## File Metadata

- **Path**: `nautilus_trader/common/actor.pxd`
- **Size**: 17,485 bytes
- **Lines**: 382
- **Language**: Unknown
...
**Identifiers**: `ABSTRACT`, `ACTOR`, `ANY`, `Actor`, `All`, `BASIS`, `Bar`, `BarType`, `BookType`, `COMMANDS`, `CONDITIONS`, `CacheFacade`, `ClientId`, `Clock`, `Component`, `Copyright`, `Data`, `DataCommand`, `DataResponse`, `DataType`, `EGRESS`, `Event`, `FundingRateUpdate`, `GNU`, `General`, `GreeksCalculator`, `HANDLERS`, `IndexPriceUpdate`, `Indicator`, `Instrument` *(+40 more)*
...
---
*Generated on 2025-11-18T21:55:05.199501Z*
