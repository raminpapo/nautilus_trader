# Documentation: `nautilus_trader/common/functions.py`
**Generated:** 2025-11-15T19:40:04.697482Z
...
This file is located at `nautilus_trader/common/functions.py` within the repository.

**Functions defined:** get_event_loop, format_utc_timerange
...
#### `format_utc_timerange(start: pd.Timestamp | None, end: pd.Timestamp | None)`
