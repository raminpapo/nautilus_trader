# Documentation: data_topics.pyx

## File Metadata

- **Path**: `nautilus_trader/common/data_topics.pyx`
- **Size**: 10,988 bytes
- **Lines**: 259
- **Language**: Unknown
...
**Identifiers**: `ANY`, `All`, `BASIS`, `BarType`, `CONDITIONS`, `Copyright`, `DataType`, `False`, `GNU`, `General`, `Get`, `Handle`, `Initialize`, `InstrumentId`, `Invalid`, `KIND`, `Lesser`, `License`, `Licensed`, `Ltd`, `Nautech`, `None`, `OrderBookDelta`, `OrderBookDepth10`, `Parameters`, `Provides`, `Pty`, `Public`, `Returns`, `See` *(+12 more)*
...
---
*Generated on 2025-11-18T21:55:05.238189Z*
