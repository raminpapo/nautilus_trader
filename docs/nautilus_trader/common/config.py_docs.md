...
- **Path**: `nautilus_trader/common/config.py`
- **Size**: 21,528 bytes
- **Lines**: 644
- **Language**: Python
...
This file is part of the NautilusTrader repository. It defines 8 function(s) and 12 class(es).

## Detailed Walkthrough

### Functions
- **`resolve_path()`**: Function defined in this file
- **`resolve_config_path()`**: Function defined in this file
- **`nautilus_schema_hook()`**: Function defined in this file
- **`msgspec_encoding_hook()`**: Function defined in this file
- **`msgspec_decoding_hook()`**: Function defined in this file
- **`register_config_encoding()`**: Function defined in this file
- **`register_config_decoding()`**: Function defined in this file
- **`tokenize_config()`**: Function defined in this file

### Classes
- **`InvalidConfiguration`**: Class defined in this file
- **`NautilusConfig`**: Class defined in this file
- **`DatabaseConfig`**: Class defined in this file
- **`MessageBusConfig`**: Class defined in this file
- **`InstrumentProviderConfig`**: Class defined in this file
- **`OrderEmulatorConfig`**: Class defined in this file
- **`ActorConfig`**: Class defined in this file
- **`ImportableActorConfig`**: Class defined in this file
- **`ActorFactory`**: Class defined in this file
- **`LoggingConfig`**: Class defined in this file
- **`ImportableFactoryConfig`**: Class defined in this file
- **`ImportableConfig`**: Class defined in this file
...
**Classs**: `ActorConfig`, `ActorFactory`, `DatabaseConfig`, `ImportableActorConfig`, `ImportableConfig`, `ImportableFactoryConfig`, `InstrumentProviderConfig`, `InvalidConfiguration`, `LoggingConfig`, `MessageBusConfig`, `NautilusConfig`, `OrderEmulatorConfig`
**Functions**: `msgspec_decoding_hook`, `msgspec_encoding_hook`, `nautilus_schema_hook`, `register_config_decoding`, `register_config_encoding`, `resolve_config_path`, `resolve_path`, `tokenize_config`
**Imports**: `__future__`, `collections.abc`, `decimal`, `hashlib`, `importlib`, `io`, `msgspec`, `nautilus_trader.common`, `nautilus_trader.core.correctness`, `nautilus_trader.core.uuid`, `nautilus_trader.model.data`, `nautilus_trader.model.enums`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.objects`, `pandas`, `typing`
...
---
*Generated on 2025-11-18T21:55:05.234687Z*
