# Documentation: `nautilus_trader/common/config.py`
**Generated:** 2025-11-15T19:40:04.681046Z
**File Size:** 21477 bytes
**Extension:** .py
**Type:** text
...
This file is located at `nautilus_trader/common/config.py` within the repository.

**Classes defined:** InvalidConfiguration, NautilusConfig, DatabaseConfig, MessageBusConfig, InstrumentProviderConfig, OrderEmulatorConfig, ActorConfig, ImportableActorConfig, ActorFactory, LoggingConfig and 2 more

**Functions defined:** resolve_path, resolve_config_path, nautilus_schema_hook, msgspec_encoding_hook, msgspec_decoding_hook, register_config_encoding, register_config_decoding, tokenize_config, id, fully_qualified_name and 13 more
...
**Inherits from:** NautilusConfig, kw_only=True, frozen=True
...
#### `nautilus_schema_hook(type_: type[Any])`
