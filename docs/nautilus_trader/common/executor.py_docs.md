# Documentation: `nautilus_trader/common/executor.py`
**Generated:** 2025-11-15T19:40:04.688345Z
**File Size:** 11936 bytes
**Extension:** .py
**Type:** text
...
- **Path:** `nautilus_trader/common/executor.py`
- **Size:** 11,936 bytes
- **Lines:** 382
- **Extension:** `.py`
- **Type:** text
...
This file is located at `nautilus_trader/common/executor.py` within the repository.

**Classes defined:** TaskId, ActorExecutor

**Functions defined:** __repr__, create, __init__, reset, get_future, _shutdown_executor, _drain_queue, _add_active_task, _remove_done_task, _submit_to_executor and 8 more
...
#### `get_future(self, task_id: TaskId)`
...
#### `_add_active_task(self, task_id: TaskId, task: Future[Any])`


#### `_remove_done_task(self, task: Future[Any])`
