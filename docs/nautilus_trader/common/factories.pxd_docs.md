# Documentation: factories.pxd

## File Metadata

- **Path**: `nautilus_trader/common/factories.pxd`
- **Size**: 10,941 bytes
- **Lines**: 303
- **Language**: Unknown
...
**Identifiers**: `ANY`, `All`, `BASIS`, `CONDITIONS`, `CacheFacade`, `ClientOrderId`, `ClientOrderIdGenerator`, `Clock`, `ContingencyType`, `Copyright`, `Decimal`, `ExecAlgorithmId`, `GNU`, `General`, `InstrumentId`, `KIND`, `Lesser`, `License`, `Licensed`, `LimitIfTouchedOrder`, `LimitOrder`, `Ltd`, `MarketIfTouchedOrder`, `MarketOrder`, `MarketToLimitOrder`, `Nautech`, `OrderFactory`, `OrderList`, `OrderListId`, `OrderListIdGenerator` *(+24 more)*
...
---
*Generated on 2025-11-18T21:55:05.244572Z*
