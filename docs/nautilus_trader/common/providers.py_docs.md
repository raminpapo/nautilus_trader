# Documentation: `nautilus_trader/common/providers.py`
**Generated:** 2025-11-15T19:40:04.706767Z
...
- **Path:** `nautilus_trader/common/providers.py`
- **Size:** 11,540 bytes
- **Lines:** 380
- **Extension:** `.py`
- **Type:** text
...
This file is located at `nautilus_trader/common/providers.py` within the repository.

**Classes defined:** InstrumentProvider

**Functions defined:** __init__, count, load_all, load_ids, load, add_currency, add, add_bulk, list_all, get_all and 3 more
...
#### `__init__(self, config: InstrumentProviderConfig | None = None)`


#### `count(self)`


#### `load_all(self, filters: dict | None = None)`
...
#### `add(self, instrument: Instrument)`


#### `add_bulk(self, instruments: list[Instrument])`
...
#### `currency(self, code: str)`


#### `find(self, instrument_id: InstrumentId)`
