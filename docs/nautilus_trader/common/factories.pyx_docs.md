# Documentation: factories.pyx

## File Metadata

- **Path**: `nautilus_trader/common/factories.pyx`
- **Size**: 74,453 bytes
- **Lines**: 1,708
- **Language**: Unknown
...
**Identifiers**: `ANY`, `AT_THE_CLOSE`, `AT_THE_OPEN`, `Additional`, `All`, `Any`, `BASIS`, `BID_ASK`, `BUY`, `CONDITIONS`, `CacheFacade`, `ClientOrderId`, `ClientOrderIdGenerator`, `Clock`, `Condition`, `ContingencyType`, `Copyright`, `Create`, `DAY`, `DEFAULT`, `Decimal`, `Disables`, `ENTRY`, `Emulated`, `Enables`, `Entry`, `ExecAlgorithmId`, `FOK`, `False`, `GNU` *(+88 more)*
...
---
*Generated on 2025-11-18T21:55:05.251456Z*
