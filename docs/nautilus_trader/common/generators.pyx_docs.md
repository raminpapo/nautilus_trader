# Documentation: generators.pyx

## File Metadata

- **Path**: `nautilus_trader/common/generators.pyx`
- **Size**: 9,031 bytes
- **Lines**: 331
- **Language**: Unknown
...
**Identifiers**: `ANY`, `All`, `BASIS`, `CONDITIONS`, `ClientOrderId`, `ClientOrderIdGenerator`, `Clock`, `Condition`, `Copyright`, `False`, `GNU`, `General`, `IdentifierGenerator`, `KIND`, `Lesser`, `License`, `Licensed`, `Ltd`, `Nautech`, `None`, `OrderListId`, `OrderListIdGenerator`, `Parameters`, `PositionId`, `PositionIdGenerator`, `Provides`, `Pty`, `Public`, `Raises`, `Reset` *(+17 more)*
...
---
*Generated on 2025-11-18T21:55:05.257115Z*
