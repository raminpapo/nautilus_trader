# Documentation: `nautilus_trader/common/secure.py`
**Generated:** 2025-11-15T19:40:04.708940Z
...
- **Path:** `nautilus_trader/common/secure.py`
- **Size:** 6,735 bytes
- **Lines:** 235
- **Extension:** `.py`
- **Type:** text
...
This file is located at `nautilus_trader/common/secure.py` within the repository.

**Classes defined:** SecureString

**Functions defined:** __init__, get_value, get_redacted, clear, __del__, __str__, __repr__, __eq__, __bool__, __len__ and 2 more
...
#### `__init__(self, value: str, name: str = "credential")`


#### `get_value(self)`


#### `get_redacted(self, visible_chars: int = 4)`
...
#### `from_env(cls, env_var: str, name: str | None = None)`


#### `mask_api_key(api_key: str, visible_chars: int = 4)`
...
**Security:** This file may contain sensitive patterns: password, secret, token, api_key, credential. Ensure proper handling of secrets.
