...
**Identifiers**: `ANY`, `All`, `Any`, `BASIS`, `CONDITIONS`, `Command`, `ComponentId`, `ComponentState`, `ComponentStateChanged`, `Condition`, `Copyright`, `Event`, `False`, `GNU`, `General`, `Identifier`, `KIND`, `Lesser`, `License`, `Licensed`, `Ltd`, `Nautech`, `None`, `Parameters`, `Pty`, `Public`, `Represents`, `Return`, `Returns`, `RiskEngine` *(+15 more)*
...
---
*Generated on 2025-11-18T21:55:05.262332Z*
