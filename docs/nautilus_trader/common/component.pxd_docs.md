# Documentation: component.pxd

## File Metadata

- **Path**: `nautilus_trader/common/component.pxd`
- **Size**: 11,635 bytes
- **Lines**: 362
- **Language**: Unknown
...
**Identifiers**: `ABSTRACT`, `ANY`, `All`, `BASIS`, `CMD`, `COMMANDS`, `CONDITIONS`, `CVec`, `Callable`, `Clock`, `Component`, `ComponentFSMFactory`, `ComponentId`, `ComponentState`, `ComponentTrigger`, `Copyright`, `DOC`, `EVT`, `Event`, `FORCE_STOP`, `FiniteStateMachine`, `GNU`, `General`, `Global`, `Identifier`, `KIND`, `LOGGING_PYO3`, `Lesser`, `License`, `Licensed` *(+39 more)*
...
---
*Generated on 2025-11-18T21:55:05.218102Z*
