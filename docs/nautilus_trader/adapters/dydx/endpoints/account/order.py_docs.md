# Documentation: `nautilus_trader/adapters/dydx/endpoints/account/order.py`
**Generated:** 2025-11-15T19:40:04.261216Z
**File Size:** 2469 bytes
**Extension:** .py
**Type:** text
...
This file is located at `nautilus_trader/adapters/dydx/endpoints/account/order.py` within the repository.

**Classes defined:** DYDXGetOrderGetParams, DYDXGetOrderEndpoint
