# Documentation: instruments_info.py

## File Metadata

- **Path**: `nautilus_trader/adapters/dydx/endpoints/market/instruments_info.py`
- **Size**: 7,147 bytes
- **Lines**: 204
- **Language**: Python
...
### Classes
- **`ListPerpetualMarketsGetParams`**: Class defined in this file
- **`DYDXPerpetualMarketResponseObject`**: Class defined in this file
- **`DYDXListPerpetualMarketsResponse`**: Class defined in this file
- **`DYDXListPerpetualMarketsEndpoint`**: Class defined in this file
...
**Classs**: `DYDXListPerpetualMarketsEndpoint`, `DYDXListPerpetualMarketsResponse`, `DYDXPerpetualMarketResponseObject`, `ListPerpetualMarketsGetParams`
**Imports**: `decimal`, `msgspec`, `nautilus_trader.adapters.dydx.common.constants`, `nautilus_trader.adapters.dydx.common.enums`, `nautilus_trader.adapters.dydx.common.symbol`, `nautilus_trader.adapters.dydx.endpoints.endpoint`, `nautilus_trader.adapters.dydx.http.client`, `nautilus_trader.core.correctness`, `nautilus_trader.core.nautilus_pyo3`, `nautilus_trader.model.enums`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.instruments`, `nautilus_trader.model.objects`
...
---
*Generated on 2025-11-18T21:55:04.742790Z*
