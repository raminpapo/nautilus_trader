# Documentation: `nautilus_trader/adapters/dydx/endpoints/market/instruments_info.py`
**Generated:** 2025-11-15T19:40:04.275209Z
...
This file is located at `nautilus_trader/adapters/dydx/endpoints/market/instruments_info.py` within the repository.

**Classes defined:** ListPerpetualMarketsGetParams, DYDXPerpetualMarketResponseObject, DYDXListPerpetualMarketsResponse, DYDXListPerpetualMarketsEndpoint

**Functions defined:** parse_base_currency, parse_quote_currency, parse_to_instrument, __init__
...
**Inherits from:** msgspec.Struct, omit_defaults=True


#### `DYDXPerpetualMarketResponseObject`
...
#### `parse_base_currency(self)`


#### `parse_quote_currency(self)`
