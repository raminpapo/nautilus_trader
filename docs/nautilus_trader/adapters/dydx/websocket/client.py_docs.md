# Documentation: `nautilus_trader/adapters/dydx/websocket/client.py`
**Generated:** 2025-11-15T19:40:04.318293Z
...
This file is located at `nautilus_trader/adapters/dydx/websocket/client.py` within the repository.

**Classes defined:** DYDXWebsocketClient

**Functions defined:** __init__, is_connected, is_disconnected, subscriptions, has_subscription, _handle_msg, _handle_ping, reconnect
...
#### `has_subscription(self, channel: DYDXChannel, channel_id: str | None = None)`


#### `_handle_msg(self, raw: bytes)`


#### `_handle_ping(self, raw: bytes)`
...
**Directory:** `nautilus_trader/adapters/dydx/websocket`
