...
- **Path**: `nautilus_trader/adapters/dydx/websocket/client.py`
- **Size**: 18,935 bytes
- **Lines**: 586
- **Language**: Python
...
**Classs**: `DYDXWebsocketClient`
**Imports**: `asyncio`, `collections`, `collections.abc`, `msgspec`, `nautilus_trader.adapters.dydx.common.enums`, `nautilus_trader.adapters.dydx.http.errors`, `nautilus_trader.adapters.dydx.schemas.ws`, `nautilus_trader.common.component`, `nautilus_trader.common.enums`, `nautilus_trader.core.nautilus_pyo3`, `nautilus_trader.live.cancellation`, `nautilus_trader.live.retry`, `typing`, `weakref`

## Related Files

This file is located in `nautilus_trader/adapters/dydx/websocket/`. Related files may include:
...
---
*Generated on 2025-11-18T21:55:04.789778Z*
