...
### Classes
- **`ClientOrderIdHelper`**: Class defined in this file
...
**Classs**: `ClientOrderIdHelper`, `DYDXExecutionClient`
**Imports**: `asyncio`, `collections`, `decimal`, `grpc.aio._call`, `msgspec`, `nautilus_trader.adapters.dydx.common.common`, `nautilus_trader.adapters.dydx.common.constants`, `nautilus_trader.adapters.dydx.common.credentials`, `nautilus_trader.adapters.dydx.common.enums`, `nautilus_trader.adapters.dydx.common.symbol`, `nautilus_trader.adapters.dydx.config`, `nautilus_trader.adapters.dydx.grpc.account`, `nautilus_trader.adapters.dydx.grpc.errors`, `nautilus_trader.adapters.dydx.grpc.order_builder`, `nautilus_trader.adapters.dydx.http.account`, `nautilus_trader.adapters.dydx.http.client`, `nautilus_trader.adapters.dydx.http.errors`, `nautilus_trader.adapters.dydx.providers`, `nautilus_trader.adapters.dydx.schemas.ws`, `nautilus_trader.adapters.dydx.websocket.client`, `nautilus_trader.cache.cache`, `nautilus_trader.common.component`, `nautilus_trader.common.enums`, `nautilus_trader.core.correctness`, `nautilus_trader.core.datetime`, `nautilus_trader.core.uuid`, `nautilus_trader.execution.messages`, `nautilus_trader.execution.reports`, `nautilus_trader.live.execution_client`, `nautilus_trader.live.retry` *(+10 more)*
...
---
*Generated on 2025-11-18T21:55:04.750976Z*
