# Documentation: `nautilus_trader/adapters/dydx/execution.py`
**Generated:** 2025-11-15T19:40:04.281973Z
**File Size:** 63470 bytes
**Extension:** .py
**Type:** text
...
- **Path:** `nautilus_trader/adapters/dydx/execution.py`
- **Size:** 63,470 bytes
- **Lines:** 1,567
- **Extension:** `.py`
- **Type:** text
...
This file is located at `nautilus_trader/adapters/dydx/execution.py` within the repository.

**Classes defined:** ClientOrderIdHelper, DYDXExecutionClient

**Functions defined:** __init__, generate_client_order_id_int, get_client_order_id_int, get_client_order_id, __init__, _stop, _handle_ws_message, _handle_block_height_subscribed, _handle_block_height_channel_data, _handle_markets and 7 more

**Import statements:** 88
...
#### `__init__(self, cache: Cache)`


#### `generate_client_order_id_int(self, client_order_id: ClientOrderId)`


#### `get_client_order_id_int(self, client_order_id: ClientOrderId)`


#### `get_client_order_id(self, client_order_id_int: int)`
...
#### `_handle_ws_message(self, raw: bytes)`


#### `_handle_block_height_subscribed(self, raw: bytes)`


#### `_handle_block_height_channel_data(self, raw: bytes)`


#### `_handle_markets(self, raw: bytes)`


#### `_handle_markets_subscribed(self, raw: bytes)`


#### `_handle_subaccounts_subscribed(self, raw: bytes)`


#### `_handle_subaccounts_channel_data(self, raw: bytes)`


#### `_handle_order_message(
        self,
        order_msg: DYDXWsOrderSubaccountMessageContents,
    )`


#### `_handle_fill_message(self, fill_msg: DYDXWsFillSubaccountMessageContents)`


#### `_get_order_builder(self, instrument: Instrument)`


#### `_parse_order_tags(self, order: Order)`
...
**Security:** This file may contain sensitive patterns: secret, credential. Ensure proper handling of secrets.
