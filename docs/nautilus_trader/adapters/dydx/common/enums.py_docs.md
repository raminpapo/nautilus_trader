# Documentation: `nautilus_trader/adapters/dydx/common/enums.py`
**Generated:** 2025-11-15T19:40:04.242950Z
...
- **Path:** `nautilus_trader/adapters/dydx/common/enums.py`
- **Size:** 10,712 bytes
- **Lines:** 359
- **Extension:** `.py`
- **Type:** text
...
This file is located at `nautilus_trader/adapters/dydx/common/enums.py` within the repository.

**Classes defined:** DYDXChannel, DYDXLiquidity, DYDXFillType, DYDXMarketType, DYDXPerpetualPositionStatus, DYDXOrderStatus, DYDXTimeInForce, DYDXPositionSide, DYDXEndpointType, DYDXPerpetualMarketStatus and 6 more

**Functions defined:** __init__, parse_dydx_order_type, parse_nautilus_order_type, parse_dydx_order_side, parse_nautilus_order_side, parse_dydx_order_status, parse_dydx_time_in_force, parse_dydx_liquidity_side, parse_dydx_position_side, parse_dydx_kline
...
#### `DYDXPerpetualMarketStatus`

**Inherits from:** Enum


#### `DYDXPerpetualMarketType`
...
#### `parse_dydx_order_type(self, order_type: DYDXOrderType)`


#### `parse_nautilus_order_type(self, order_type: OrderType)`


#### `parse_dydx_order_side(self, order_side: DYDXOrderSide | None)`


#### `parse_nautilus_order_side(self, order_side: OrderSide)`


#### `parse_dydx_order_status(self, order_status: DYDXOrderStatus)`


#### `parse_dydx_time_in_force(self, time_in_force: DYDXTimeInForce)`


#### `parse_dydx_liquidity_side(self, liquidity_side: DYDXLiquidity)`


#### `parse_dydx_position_side(self, position_side: DYDXPositionSide)`


#### `parse_dydx_kline(self, bar_type: BarType)`
