...
This file is part of the NautilusTrader repository. 16 class(es).

## Detailed Walkthrough


### Classes
- **`DYDXChannel`**: Class defined in this file
- **`DYDXLiquidity`**: Class defined in this file
- **`DYDXFillType`**: Class defined in this file
- **`DYDXMarketType`**: Class defined in this file
- **`DYDXPerpetualPositionStatus`**: Class defined in this file
- **`DYDXOrderStatus`**: Class defined in this file
- **`DYDXTimeInForce`**: Class defined in this file
- **`DYDXPositionSide`**: Class defined in this file
- **`DYDXEndpointType`**: Class defined in this file
- **`DYDXPerpetualMarketStatus`**: Class defined in this file
- **`DYDXPerpetualMarketType`**: Class defined in this file
- **`DYDXOrderSide`**: Class defined in this file
- **`DYDXOrderType`**: Class defined in this file
- **`DYDXCandlesResolution`**: Class defined in this file
- **`DYDXTransferType`**: Class defined in this file
- **`DYDXEnumParser`**: Class defined in this file
...
**Classs**: `DYDXCandlesResolution`, `DYDXChannel`, `DYDXEndpointType`, `DYDXEnumParser`, `DYDXFillType`, `DYDXLiquidity`, `DYDXMarketType`, `DYDXOrderSide`, `DYDXOrderStatus`, `DYDXOrderType`, `DYDXPerpetualMarketStatus`, `DYDXPerpetualMarketType`, `DYDXPerpetualPositionStatus`, `DYDXPositionSide`, `DYDXTimeInForce`, `DYDXTransferType`
**Imports**: `enum`, `nautilus_trader.core.nautilus_pyo3`, `nautilus_trader.model.data`, `nautilus_trader.model.enums`
...
---
*Generated on 2025-11-18T21:55:04.710279Z*
