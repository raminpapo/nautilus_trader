# Documentation: `nautilus_trader/adapters/dydx/data.py`
**Generated:** 2025-11-15T19:40:04.252924Z
**File Size:** 42430 bytes
**Extension:** .py
**Type:** text
...
- **Path:** `nautilus_trader/adapters/dydx/data.py`
- **Size:** 42,430 bytes
- **Lines:** 1,075
- **Extension:** `.py`
- **Type:** text
...
This file is located at `nautilus_trader/adapters/dydx/data.py` within the repository.

**Classes defined:** DYDXDataClient

**Functions defined:** __init__, _send_all_instruments_to_data_engine, _handle_ws_message, _handle_trade, _handle_trade_subscribed, _handle_orderbook, _handle_orderbook_batched, _handle_orderbook_snapshot, _resolve_crossed_order_book, _handle_deltas and 7 more
...
#### `_send_all_instruments_to_data_engine(self)`


#### `_handle_ws_message(self, raw: bytes)`


#### `_handle_trade(self, raw: bytes)`


#### `_handle_trade_subscribed(self, raw: bytes)`


#### `_handle_orderbook(self, raw: bytes)`


#### `_handle_orderbook_batched(self, raw: bytes)`


#### `_handle_orderbook_snapshot(self, raw: bytes)`


#### `_resolve_crossed_order_book(
        self,
        book: OrderBook,
        venue_deltas: OrderBookDeltas,
        instrument_id: InstrumentId,
...
#### `_handle_deltas(self, instrument_id: InstrumentId, deltas: OrderBookDeltas)`


#### `_handle_kline(self, raw: bytes)`


#### `_handle_kline_subscribed(self, raw: bytes)`


#### `_handle_kline_unsubscribed(self, msg: DYDXWsMessageGeneral)`
...
#### `_should_partition_bars_request(self, request: RequestBars, max_bars: int)`
