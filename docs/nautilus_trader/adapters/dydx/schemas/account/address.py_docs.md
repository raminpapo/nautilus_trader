# Documentation: address.py

## File Metadata

- **Path**: `nautilus_trader/adapters/dydx/schemas/account/address.py`
- **Size**: 5,561 bytes
- **Lines**: 177
- **Language**: Python
...
- **`DYDXAssetPosition`**: Class defined in this file
- **`DYDXSubaccount`**: Class defined in this file
- **`DYDXSubaccountResponse`**: Class defined in this file
- **`DYDXAddressResponse`**: Class defined in this file
...
**Classs**: `DYDXAddressResponse`, `DYDXAssetPosition`, `DYDXPerpetualPosition`, `DYDXSubaccount`, `DYDXSubaccountResponse`
**Imports**: `datetime`, `decimal`, `msgspec`, `nautilus_trader.adapters.dydx.common.constants`, `nautilus_trader.adapters.dydx.common.enums`, `nautilus_trader.adapters.dydx.common.symbol`, `nautilus_trader.core.datetime`, `nautilus_trader.core.uuid`, `nautilus_trader.execution.reports`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.objects`
...
---
*Generated on 2025-11-18T21:55:04.776320Z*
