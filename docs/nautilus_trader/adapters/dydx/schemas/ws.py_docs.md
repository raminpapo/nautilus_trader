...
- **Path**: `nautilus_trader/adapters/dydx/schemas/ws.py`
- **Size**: 30,512 bytes
- **Lines**: 994
- **Language**: Python
...
This file is part of the NautilusTrader repository. 35 class(es).

## Detailed Walkthrough


### Classes
- **`DYDXCandle`**: Class defined in this file
- **`DYDXWsCandlesChannelData`**: Class defined in this file
- **`DYDXWsCandlesMessageContents`**: Class defined in this file
- **`DYDXWsCandlesSubscribedData`**: Class defined in this file
- **`DYDXWsMessageGeneral`**: Class defined in this file
- **`DYDXTrade`**: Class defined in this file
- **`DYDXWsTradeMessageContents`**: Class defined in this file
- **`DYDXWsTradeChannelData`**: Class defined in this file
- **`DYDXWsOrderbookMessageContents`**: Class defined in this file
- **`DYDXWsOrderbookChannelData`**: Class defined in this file
- **`PriceLevel`**: Class defined in this file
- **`DYDXWsOrderbookMessageSnapshotContents`**: Class defined in this file
- **`DYDXWsOrderbookSnapshotChannelData`**: Class defined in this file
- **`DYDXWsOrderbookBatchedData`**: Class defined in this file
- **`DYDXWsSubaccountsSubscribedContents`**: Class defined in this file
- **`DYDXWsSubaccountsSubscribed`**: Class defined in this file
- **`DYDXWalletAddress`**: Class defined in this file
- **`DYDXWsTransferSubaccountMessageContents`**: Class defined in this file
- **`DYDXWsFillEventId`**: Class defined in this file
- **`DYDXWsFillSubaccountMessageContents`**: Class defined in this file
...
**Classs**: `DYDXBlockHeightChannelContents`, `DYDXBlockHeightSubscribedContents`, `DYDXCandle`, `DYDXMarketMessageContents`, `DYDXOraclePriceMarket`, `DYDXTrade`, `DYDXTradingPerpetualMarketMessage`, `DYDXTradingReward`, `DYDXWalletAddress`, `DYDXWsAssetPositionSubaccountMessageContents`, `DYDXWsBlockHeightChannelData`, `DYDXWsBlockHeightSubscribedData`, `DYDXWsCandlesChannelData`, `DYDXWsCandlesMessageContents`, `DYDXWsCandlesSubscribedData`, `DYDXWsFillEventId`, `DYDXWsFillSubaccountMessageContents`, `DYDXWsMarketChannelData`, `DYDXWsMarketSubscribedData`, `DYDXWsMessageGeneral`, `DYDXWsOrderSubaccountMessageContents`, `DYDXWsOrderbookBatchedData`, `DYDXWsOrderbookChannelData`, `DYDXWsOrderbookMessageContents`, `DYDXWsOrderbookMessageSnapshotContents`, `DYDXWsOrderbookSnapshotChannelData`, `DYDXWsPerpetualPositionSubaccountMessageContents`, `DYDXWsSubaccountMessageContents`, `DYDXWsSubaccountsChannelData`, `DYDXWsSubaccountsSubscribed` *(+5 more)*
**Imports**: `datetime`, `decimal`, `msgspec`, `nautilus_trader.adapters.dydx.common.constants`, `nautilus_trader.adapters.dydx.common.enums`, `nautilus_trader.adapters.dydx.common.symbol`, `nautilus_trader.adapters.dydx.endpoints.market.instruments_info`, `nautilus_trader.adapters.dydx.schemas.account.address`, `nautilus_trader.adapters.dydx.schemas.account.orders`, `nautilus_trader.core.datetime`, `nautilus_trader.core.uuid`, `nautilus_trader.execution.reports`, `nautilus_trader.model.data`, `nautilus_trader.model.enums`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.objects`

## Related Files

This file is located in `nautilus_trader/adapters/dydx/schemas/`. Related files may include:
...
---
*Generated on 2025-11-18T21:55:04.785732Z*
