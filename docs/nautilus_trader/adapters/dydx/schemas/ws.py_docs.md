# Documentation: `nautilus_trader/adapters/dydx/schemas/ws.py`
**Generated:** 2025-11-15T19:40:04.314388Z
...
This file is located at `nautilus_trader/adapters/dydx/schemas/ws.py` within the repository.

**Classes defined:** DYDXCandle, DYDXWsCandlesChannelData, DYDXWsCandlesMessageContents, DYDXWsCandlesSubscribedData, DYDXWsMessageGeneral, DYDXTrade, DYDXWsTradeMessageContents, DYDXWsTradeChannelData, DYDXWsOrderbookMessageContents, DYDXWsOrderbookChannelData and 25 more

**Functions defined:** parse_to_bar, parse_to_trade_tick, parse_to_deltas, parse_to_snapshot, parse_to_snapshot, parse_to_deltas, parse_to_account_balances, parse_to_order_status_report
...
#### `DYDXWsOrderbookMessageContents`
...
#### `DYDXWsTransferSubaccountMessageContents`
...
#### `DYDXWsAssetPositionSubaccountMessageContents`

**Inherits from:** msgspec.Struct, forbid_unknown_fields=False


#### `DYDXWsPerpetualPositionSubaccountMessageContents`
...
#### `DYDXWsSubaccountMessageContents`
...
#### `DYDXTradingPerpetualMarketMessage`
...
**Directory:** `nautilus_trader/adapters/dydx/schemas`
