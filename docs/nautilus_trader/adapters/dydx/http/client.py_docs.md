# Documentation: `nautilus_trader/adapters/dydx/http/client.py`
**Generated:** 2025-11-15T19:40:04.296294Z
...
This file is located at `nautilus_trader/adapters/dydx/http/client.py` within the repository.

**Classes defined:** DYDXHttpClient

**Functions defined:** __init__, base_url, headers, _urlencode
...
#### `_urlencode(self, payload: dict[str, Any])`
