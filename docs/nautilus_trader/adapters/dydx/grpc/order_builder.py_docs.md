# Documentation: `nautilus_trader/adapters/dydx/grpc/order_builder.py`
**Generated:** 2025-11-15T19:40:04.291397Z
...
- **Path:** `nautilus_trader/adapters/dydx/grpc/order_builder.py`
- **Size:** 10,568 bytes
- **Lines:** 304
- **Extension:** `.py`
- **Type:** text
...
This file is located at `nautilus_trader/adapters/dydx/grpc/order_builder.py` within the repository.

**Classes defined:** OrderFlags, OrderExecution, DYDXGRPCOrderType, OrderHelper, OrderBuilder

**Functions defined:** round_down, calculate_time_in_force, calculate_client_metadata, calculate_condition_type, __init__, calculate_quantums, calculate_subticks, create_order_id, create_order
...
#### `round_down(input_value: float, base: int)`


#### `calculate_time_in_force(  # noqa: C901
        order_type: DYDXGRPCOrderType,
        time_in_force: Order.TimeInForce,
        post_only: bool = False,
        execution: OrderExecution = OrderExecution.DEFAULT,
...
#### `calculate_client_metadata(order_type: DYDXGRPCOrderType)`


#### `calculate_condition_type(order_type: DYDXGRPCOrderType)`
...
#### `calculate_quantums(self, size: float)`


#### `calculate_subticks(self, price: float)`
