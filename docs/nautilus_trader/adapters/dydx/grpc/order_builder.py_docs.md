# Documentation: order_builder.py
...
This file is part of the NautilusTrader repository. It defines 1 function(s) and 5 class(es).

## Detailed Walkthrough

### Functions
- **`round_down()`**: Function defined in this file

### Classes
- **`OrderFlags`**: Class defined in this file
- **`OrderExecution`**: Class defined in this file
- **`DYDXGRPCOrderType`**: Class defined in this file
- **`OrderHelper`**: Class defined in this file
...
**Classs**: `DYDXGRPCOrderType`, `OrderBuilder`, `OrderExecution`, `OrderFlags`, `OrderHelper`
**Functions**: `round_down`
**Imports**: `enum`, `math`, `v4_proto.dydxprotocol.clob.order_pb2`, `v4_proto.dydxprotocol.subaccounts.subaccount_pb2`
...
---
*Generated on 2025-11-18T21:55:04.762130Z*
