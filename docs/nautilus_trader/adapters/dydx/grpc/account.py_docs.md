# Documentation: `nautilus_trader/adapters/dydx/grpc/account.py`
**Generated:** 2025-11-15T19:40:04.288177Z
**File Size:** 18433 bytes
**Extension:** .py
**Type:** text
...
This file is located at `nautilus_trader/adapters/dydx/grpc/account.py` within the repository.

**Classes defined:** Wallet, TransactionBuilder, DYDXAccountGRPCAPI

**Functions defined:** as_any, get_signer_info, get_signature, bytes_from_mnemonic, from_mnemonic, __init__, public_key, address, __init__, coin and 5 more

**Import statements:** 46
...
#### `as_any(message: Message)`


#### `get_signer_info(public_key: PubKey, sequence: int)`
...
#### `bytes_from_mnemonic(mnemonic: str)`


#### `from_mnemonic(mnemonic: str)`


#### `__init__(self, mnemonic: str, account_number: int, sequence: int)`
...
#### `__init__(self, chain_id: str, denomination: str, memo: str | None = None)`


#### `coin(self, amount: int)`


#### `fee(self, gas_limit: int, *amount: list[Coin])`


#### `build_transaction(self, wallet: Wallet, messages: list[Message], fee: Fee)`


#### `build(self, wallet: Wallet, message: Message, fee: Fee = DEFAULT_FEE)`


#### `__init__(self, channel_url: str, transaction_builder: TransactionBuilder)`
