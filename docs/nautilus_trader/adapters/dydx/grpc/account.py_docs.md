...
- **Path**: `nautilus_trader/adapters/dydx/grpc/account.py`
- **Size**: 18,433 bytes
- **Lines**: 557
- **Language**: Python
...
This file is part of the NautilusTrader repository. It defines 5 function(s) and 3 class(es).

## Detailed Walkthrough

### Functions
- **`as_any()`**: Function defined in this file
- **`get_signer_info()`**: Function defined in this file
- **`get_signature()`**: Function defined in this file
- **`bytes_from_mnemonic()`**: Function defined in this file
- **`from_mnemonic()`**: Function defined in this file

### Classes
- **`Wallet`**: Class defined in this file
- **`TransactionBuilder`**: Class defined in this file
- **`DYDXAccountGRPCAPI`**: Class defined in this file
...
**Classs**: `DYDXAccountGRPCAPI`, `TransactionBuilder`, `Wallet`
**Functions**: `as_any`, `bytes_from_mnemonic`, `from_mnemonic`, `get_signature`, `get_signer_info`
**Imports**: `Crypto.Hash`, `asyncio`, `bech32`, `bip_utils`, `ecdsa`, `ecdsa.util`, `functools`, `google`, `google._upb._message`, `grpc`, `hashlib`, `msgspec`, `nautilus_trader.adapters.dydx.common.constants`, `nautilus_trader.adapters.dydx.grpc.errors`, `v4_proto.cosmos.auth.v1beta1`, `v4_proto.cosmos.auth.v1beta1.auth_pb2`, `v4_proto.cosmos.auth.v1beta1.query_pb2`, `v4_proto.cosmos.bank.v1beta1`, `v4_proto.cosmos.base.tendermint.v1beta1`, `v4_proto.cosmos.base.v1beta1.coin_pb2`, `v4_proto.cosmos.crypto.secp256k1.keys_pb2`, `v4_proto.cosmos.tx.signing.v1beta1.signing_pb2`, `v4_proto.cosmos.tx.v1beta1`, `v4_proto.cosmos.tx.v1beta1.service_pb2`, `v4_proto.cosmos.tx.v1beta1.tx_pb2`, `v4_proto.dydxprotocol.clob.order_pb2`, `v4_proto.dydxprotocol.clob.tx_pb2`, `v4_proto.dydxprotocol.feetiers`, `v4_proto.dydxprotocol.subaccounts.subaccount_pb2`
...
---
*Generated on 2025-11-18T21:55:04.757928Z*
