...
- **Path**: `nautilus_trader/adapters/interactive_brokers/historical/client.py`
- **Size**: 24,394 bytes
- **Lines**: 605
- **Language**: Python
...
### Classes
- **`HistoricInteractiveBrokersClient`**: Class defined in this file
...
**Classs**: `HistoricInteractiveBrokersClient`
**Imports**: `datetime`, `ibapi.common`, `msgspec`, `nautilus_trader.adapters.interactive_brokers.client`, `nautilus_trader.adapters.interactive_brokers.common`, `nautilus_trader.adapters.interactive_brokers.config`, `nautilus_trader.adapters.interactive_brokers.parsing.instruments`, `nautilus_trader.adapters.interactive_brokers.providers`, `nautilus_trader.cache.cache`, `nautilus_trader.cache.config`, `nautilus_trader.cache.database`, `nautilus_trader.common.component`, `nautilus_trader.common.functions`, `nautilus_trader.core.datetime`, `nautilus_trader.core.uuid`, `nautilus_trader.model.data`, `nautilus_trader.model.enums`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.instruments`, `nautilus_trader.serialization.serializer`, `pandas`, `re`, `typing`

## Related Files

This file is located in `nautilus_trader/adapters/interactive_brokers/historical/`. Related files may include:
...
---
*Generated on 2025-11-18T21:55:04.861781Z*
