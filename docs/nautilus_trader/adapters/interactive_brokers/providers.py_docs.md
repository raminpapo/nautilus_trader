...
### Classes
- **`InteractiveBrokersInstrumentProvider`**: Class defined in this file
...
**Classs**: `InteractiveBrokersInstrumentProvider`
**Imports**: `copy`, `ibapi.contract`, `nautilus_trader.adapters.interactive_brokers.client`, `nautilus_trader.adapters.interactive_brokers.common`, `nautilus_trader.adapters.interactive_brokers.config`, `nautilus_trader.adapters.interactive_brokers.parsing.instruments`, `nautilus_trader.common.component`, `nautilus_trader.common.providers`, `nautilus_trader.config`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.instruments`, `pandas`
...
---
*Generated on 2025-11-18T21:55:04.879972Z*
