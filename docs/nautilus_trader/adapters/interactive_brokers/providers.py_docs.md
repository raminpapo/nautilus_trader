# Documentation: `nautilus_trader/adapters/interactive_brokers/providers.py`
**Generated:** 2025-11-15T19:40:04.400829Z
...
- **Path:** `nautilus_trader/adapters/interactive_brokers/providers.py`
- **Size:** 29,489 bytes
- **Lines:** 751
- **Extension:** `.py`
- **Type:** text
...
This file is located at `nautilus_trader/adapters/interactive_brokers/providers.py` within the repository.

**Classes defined:** InteractiveBrokersInstrumentProvider

**Functions defined:** __init__, _is_filtered_sec_type, filter_sec_types, get_price_magnifier, _create_spread_instrument, determine_venue_from_contract, _process_contract_details
...
#### `_is_filtered_sec_type(self, sec_type: str | None)`


#### `filter_sec_types(self)`


#### `get_price_magnifier(self, instrument_id: InstrumentId)`
...
#### `determine_venue_from_contract(self, contract: IBContract)`


#### `_process_contract_details(
        self,
        contract_details: list[ContractDetails],
        venue: str,
        force_instrument_update: bool = False,
