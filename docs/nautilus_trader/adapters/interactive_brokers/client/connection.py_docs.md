# Documentation: `nautilus_trader/adapters/interactive_brokers/client/connection.py`
**Generated:** 2025-11-15T19:40:04.343530Z
...
- **Path:** `nautilus_trader/adapters/interactive_brokers/client/connection.py`
- **Size:** 9,368 bytes
- **Lines:** 243
- **Extension:** `.py`
- **Type:** text
...
This file is located at `nautilus_trader/adapters/interactive_brokers/client/connection.py` within the repository.

**Classes defined:** InteractiveBrokersClientConnectionMixin

**Functions defined:** _msgspec_decoding_hook, _initialize_connection_params, _connect_socket_safe, _process_server_version, process_connection_closed
...
#### `_msgspec_decoding_hook(self, byte_data: bytes)`


#### `_initialize_connection_params(self)`


#### `_connect_socket_safe(self)`


#### `_process_server_version(self, fields: list[str])`


#### `process_connection_closed(self)`
