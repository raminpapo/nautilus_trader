...
### Classes
- **`InteractiveBrokersEWrapper`**: Class defined in this file
...
**Classs**: `InteractiveBrokersEWrapper`
**Imports**: `__future__`, `decimal`, `functools`, `ibapi.commission_report`, `ibapi.common`, `ibapi.contract`, `ibapi.execution`, `ibapi.order`, `ibapi.order_state`, `ibapi.ticktype`, `ibapi.utils`, `ibapi.wrapper`, `nautilus_trader.common.component`, `typing`
...
---
*Generated on 2025-11-18T21:55:04.836639Z*
