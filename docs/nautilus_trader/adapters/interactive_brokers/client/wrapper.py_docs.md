# Documentation: `nautilus_trader/adapters/interactive_brokers/client/wrapper.py`
**Generated:** 2025-11-15T19:40:04.359890Z
**File Size:** 44315 bytes
**Extension:** .py
**Type:** text
...
- **Path:** `nautilus_trader/adapters/interactive_brokers/client/wrapper.py`
- **Size:** 44,315 bytes
- **Lines:** 1,379
- **Extension:** `.py`
- **Type:** text
...
This file is located at `nautilus_trader/adapters/interactive_brokers/client/wrapper.py` within the repository.

**Classes defined:** InteractiveBrokersEWrapper

**Functions defined:** __init__, logAnswer, error, winError, connectAck, marketDataType, tickPrice, tickSize, tickSnapshotEnd, tickGeneric and 80 more
...
#### `logAnswer(self, fnName, fnParams)`
...
#### `winError(self, text: str, lastError: int)`


#### `connectAck(self)`


#### `marketDataType(self, reqId: TickerId, marketDataType: int)`
...
#### `tickSize(self, reqId: TickerId, tickType: TickType, size: Decimal)`


#### `tickSnapshotEnd(self, reqId: int)`


#### `tickGeneric(self, reqId: TickerId, tickType: TickType, value: float)`


#### `tickString(self, reqId: TickerId, tickType: TickType, value: str)`
...
#### `accountDownloadEnd(self, accountName: str)`


#### `nextValidId(self, orderId: int)`


#### `contractDetails(self, reqId: int, contractDetails: ContractDetails)`


#### `bondContractDetails(self, reqId: int, contractDetails: ContractDetails)`


#### `contractDetailsEnd(self, reqId: int)`


#### `execDetails(self, reqId: int, contract: Contract, execution: Execution)`
...
#### `receiveFA(self, faData: FaDataType, cxml: str)`


#### `historicalData(self, reqId: int, bar: BarData)`


#### `historicalDataEnd(self, reqId: int, start: str, end: str)`
...
#### `fundamentalData(self, reqId: TickerId, data: str)`
...
#### `commissionReport(self, commissionReport: CommissionReport)`
...
#### `verifyCompleted(self, isSuccessful: bool, errorText: str)`


#### `verifyAndAuthMessageAPI(self, apiData: str, xyzChallenge: str)`


#### `verifyAndAuthCompleted(self, isSuccessful: bool, errorText: str)`


#### `displayGroupList(self, reqId: int, groups: str)`


#### `displayGroupUpdated(self, reqId: int, contractInfo: str)`
...
**Directory:** `nautilus_trader/adapters/interactive_brokers/client`
...
**Security:** This file may contain sensitive patterns: auth, session. Ensure proper handling of secrets.
