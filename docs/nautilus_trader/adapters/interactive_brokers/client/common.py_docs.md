# Documentation: `nautilus_trader/adapters/interactive_brokers/client/common.py`
**Generated:** 2025-11-15T19:40:04.341605Z
**File Size:** 16551 bytes
**Extension:** .py
**Type:** text
...
This file is located at `nautilus_trader/adapters/interactive_brokers/client/common.py` within the repository.

**Classes defined:** AccountOrderRef, IBPosition, Request, Subscription, Base, Subscriptions, Requests, BaseMixin, IBKRBookLevel

**Functions defined:** __hash__, __hash__, __init__, __repr__, _name_to_req_id, _validation_check, add_req_id, remove_req_id, remove, get_all and 11 more
...
#### `_name_to_req_id(self, name: Any)`


#### `_validation_check(self, req_id: int, name: Any)`
...
#### `remove_req_id(self, req_id: int)`


#### `remove(
        self,
        req_id: int | None = None,
        name: InstrumentId | (BarType | str)`
...
#### `remove(self, req_id: int | None = None, name: str | tuple | None = None)`
...
#### `update_last(self, req_id: int, value: Any)`
