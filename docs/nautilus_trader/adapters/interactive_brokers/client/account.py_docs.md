# Documentation: `nautilus_trader/adapters/interactive_brokers/client/account.py`
**Generated:** 2025-11-15T19:40:04.335602Z
...
- **Path:** `nautilus_trader/adapters/interactive_brokers/client/account.py`
- **Size:** 8,052 bytes
- **Lines:** 241
- **Extension:** `.py`
- **Type:** text
...
This file is located at `nautilus_trader/adapters/interactive_brokers/client/account.py` within the repository.

**Classes defined:** InteractiveBrokersClientAccountMixin

**Functions defined:** accounts, subscribe_account_summary, subscribe_positions, unsubscribe_positions, unsubscribe_account_summary
...
#### `subscribe_account_summary(self)`
...
#### `unsubscribe_account_summary(self, account_id: str)`
