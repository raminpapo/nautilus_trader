...
- **Path**: `nautilus_trader/adapters/interactive_brokers/client/contract.py`
- **Size**: 7,243 bytes
- **Lines**: 217
- **Language**: Python
...
### Classes
- **`InteractiveBrokersClientContractMixin`**: Class defined in this file
...
**Classs**: `InteractiveBrokersClientContractMixin`
**Imports**: `functools`, `ibapi.common`, `ibapi.contract`, `nautilus_trader.adapters.interactive_brokers.client.common`, `nautilus_trader.adapters.interactive_brokers.common`, `typing`
...
---
*Generated on 2025-11-18T21:55:04.819136Z*
