# Documentation: `nautilus_trader/adapters/interactive_brokers/client/order.py`
**Generated:** 2025-11-15T19:40:04.354894Z
...
- **Path:** `nautilus_trader/adapters/interactive_brokers/client/order.py`
- **Size:** 15,896 bytes
- **Lines:** 438
- **Extension:** `.py`
- **Type:** text
...
This file is located at `nautilus_trader/adapters/interactive_brokers/client/order.py` within the repository.

**Classes defined:** InteractiveBrokersClientOrderMixin

**Functions defined:** place_order, place_order_list, cancel_order, cancel_all_orders, next_order_id
...
#### `place_order(self, order: IBOrder)`


#### `place_order_list(self, orders: list[IBOrder])`


#### `cancel_order(self, order_id: int, order_cancel: IBOrderCancel = None)`
