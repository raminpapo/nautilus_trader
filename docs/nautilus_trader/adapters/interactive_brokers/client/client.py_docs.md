...
- **Path**: `nautilus_trader/adapters/interactive_brokers/client/client.py`
- **Size**: 27,557 bytes
- **Lines**: 745
- **Language**: Python
...
### Classes
- **`InteractiveBrokersClient`**: Class defined in this file
...
**Classs**: `InteractiveBrokersClient`
**Imports**: `asyncio`, `collections.abc`, `functools`, `ibapi`, `ibapi.client`, `ibapi.commission_report`, `ibapi.common`, `ibapi.const`, `ibapi.errors`, `ibapi.execution`, `ibapi.utils`, `inspect`, `nautilus_trader.adapters.interactive_brokers.client.account`, `nautilus_trader.adapters.interactive_brokers.client.common`, `nautilus_trader.adapters.interactive_brokers.client.connection`, `nautilus_trader.adapters.interactive_brokers.client.contract`, `nautilus_trader.adapters.interactive_brokers.client.error`, `nautilus_trader.adapters.interactive_brokers.client.market_data`, `nautilus_trader.adapters.interactive_brokers.client.order`, `nautilus_trader.adapters.interactive_brokers.client.wrapper`, `nautilus_trader.adapters.interactive_brokers.common`, `nautilus_trader.cache.cache`, `nautilus_trader.common.component`, `nautilus_trader.common.enums`, `nautilus_trader.model.identifiers`, `os`, `typing`

## Related Files

This file is located in `nautilus_trader/adapters/interactive_brokers/client/`. Related files may include:
...
---
*Generated on 2025-11-18T21:55:04.812356Z*
