# Documentation: `nautilus_trader/adapters/interactive_brokers/client/client.py`
**Generated:** 2025-11-15T19:40:04.338868Z
**File Size:** 27557 bytes
**Extension:** .py
**Type:** text
...
This file is located at `nautilus_trader/adapters/interactive_brokers/client/client.py` within the repository.

**Classes defined:** InteractiveBrokersClient

**Functions defined:** __init__, _start, _start_tws_incoming_msg_reader, _start_internal_msg_queue_processor, _start_connection_watchdog, _stop, _reset, _resume, _degrade, _create_task and 8 more

**Import statements:** 34
...
#### `_start_tws_incoming_msg_reader(self)`


#### `_start_internal_msg_queue_processor(self)`


#### `_start_connection_watchdog(self)`
...
#### `subscribe_event(self, name: str, handler: Callable)`


#### `unsubscribe_event(self, name: str)`
...
#### `submit_to_msg_handler_queue(self, task: Callable[..., Any])`
