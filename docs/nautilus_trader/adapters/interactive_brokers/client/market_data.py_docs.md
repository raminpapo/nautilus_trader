# Documentation: `nautilus_trader/adapters/interactive_brokers/client/market_data.py`
**Generated:** 2025-11-15T19:40:04.352083Z
**File Size:** 58102 bytes
**Extension:** .py
**Type:** text
...
This file is located at `nautilus_trader/adapters/interactive_brokers/client/market_data.py` within the repository.

**Classes defined:** InteractiveBrokersClientMarketDataMixin

**Functions defined:** _aggregate_order_book_by_price
...
#### `_aggregate_order_book_by_price(
        self,
        book: dict[str, dict[int, IBKRBookLevel]],
    )`
