# Documentation: market_data.py

## File Metadata

- **Path**: `nautilus_trader/adapters/interactive_brokers/client/market_data.py`
- **Size**: 58,102 bytes
- **Lines**: 1,604
- **Language**: Python
...
### Classes
- **`InteractiveBrokersClientMarketDataMixin`**: Class defined in this file
...
**Classs**: `InteractiveBrokersClientMarketDataMixin`
**Imports**: `asyncio`, `collections`, `collections.abc`, `decimal`, `functools`, `ibapi.common`, `inspect`, `nautilus_trader.adapters.interactive_brokers.client.common`, `nautilus_trader.adapters.interactive_brokers.common`, `nautilus_trader.adapters.interactive_brokers.parsing.data`, `nautilus_trader.adapters.interactive_brokers.parsing.price_conversion`, `nautilus_trader.core.data`, `nautilus_trader.model.data`, `nautilus_trader.model.enums`, `nautilus_trader.model.identifiers`, `pandas`, `pytz`, `typing`, `zoneinfo`
...
---
*Generated on 2025-11-18T21:55:04.827627Z*
