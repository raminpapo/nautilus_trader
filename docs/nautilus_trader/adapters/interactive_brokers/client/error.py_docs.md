...
- **Path**: `nautilus_trader/adapters/interactive_brokers/client/error.py`
- **Size**: 9,020 bytes
- **Lines**: 239
- **Language**: Python
...
### Classes
- **`InteractiveBrokersClientErrorMixin`**: Class defined in this file
...
**Classs**: `InteractiveBrokersClientErrorMixin`
**Imports**: `inspect`, `nautilus_trader.adapters.interactive_brokers.client.common`, `nautilus_trader.common.enums`, `typing`
...
---
*Generated on 2025-11-18T21:55:04.821156Z*
