...
- **Path**: `nautilus_trader/adapters/interactive_brokers/data.py`
- **Size**: 22,221 bytes
- **Lines**: 549
- **Language**: Python
...
### Classes
- **`InteractiveBrokersDataClient`**: Class defined in this file
...
**Classs**: `InteractiveBrokersDataClient`
**Imports**: `__future__`, `asyncio`, `nautilus_trader.adapters.interactive_brokers.client`, `nautilus_trader.adapters.interactive_brokers.common`, `nautilus_trader.adapters.interactive_brokers.config`, `nautilus_trader.adapters.interactive_brokers.parsing.data`, `nautilus_trader.adapters.interactive_brokers.providers`, `nautilus_trader.cache.cache`, `nautilus_trader.common.component`, `nautilus_trader.data.messages`, `nautilus_trader.live.data_client`, `nautilus_trader.model.data`, `nautilus_trader.model.enums`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.instruments`, `nautilus_trader.model.instruments.currency_pair`, `operator`, `pandas`
...
---
*Generated on 2025-11-18T21:55:04.844232Z*
