...
### Functions
- **`_price_condition_str()`**: Function defined in this file

### Classes
- **`InteractiveBrokersExecutionClient`**: Class defined in this file
...
**Classs**: `InteractiveBrokersExecutionClient`
**Functions**: `_price_condition_str`
**Imports**: `asyncio`, `decimal`, `ibapi.commission_report`, `ibapi.const`, `ibapi.execution`, `ibapi.order`, `ibapi.order_condition`, `ibapi.order_state`, `json`, `nautilus_trader.adapters.interactive_brokers.client`, `nautilus_trader.adapters.interactive_brokers.client.common`, `nautilus_trader.adapters.interactive_brokers.common`, `nautilus_trader.adapters.interactive_brokers.config`, `nautilus_trader.adapters.interactive_brokers.parsing.execution`, `nautilus_trader.adapters.interactive_brokers.parsing.price_conversion`, `nautilus_trader.adapters.interactive_brokers.providers`, `nautilus_trader.cache.cache`, `nautilus_trader.common.component`, `nautilus_trader.core.correctness`, `nautilus_trader.core.rust.common`, `nautilus_trader.core.uuid`, `nautilus_trader.execution.messages`, `nautilus_trader.execution.reports`, `nautilus_trader.live.execution_client`, `nautilus_trader.model.enums`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.instruments`, `nautilus_trader.model.objects`, `nautilus_trader.model.orders.base`, `nautilus_trader.model.orders.limit_if_touched` *(+6 more)*
...
---
*Generated on 2025-11-18T21:55:04.853006Z*
