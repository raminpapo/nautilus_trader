# Documentation: `nautilus_trader/adapters/interactive_brokers/execution.py`
**Generated:** 2025-11-15T19:40:04.374437Z
**File Size:** 75209 bytes
**Extension:** .py
**Type:** text
...
- **Path:** `nautilus_trader/adapters/interactive_brokers/execution.py`
- **Size:** 75,209 bytes
- **Lines:** 1,795
- **Extension:** `.py`
- **Type:** text
...
This file is located at `nautilus_trader/adapters/interactive_brokers/execution.py` within the repository.

**Classes defined:** InteractiveBrokersExecutionClient

**Functions defined:** _price_condition_str, __init__, instrument_provider, _create_fill_report, _transform_order_to_ib_order, _attach_order_tags, _create_ib_conditions, _create_price_condition, _create_time_condition, _create_margin_condition and 14 more

**Import statements:** 86
...
#### `_transform_order_to_ib_order(self, order: Order)`


#### `_attach_order_tags(self, ib_order: IBOrder, order: Order)`


#### `_create_ib_conditions(
        self,
        conditions_data: list[dict],
    )`


#### `_create_price_condition(self, condition_dict: dict)`


#### `_create_time_condition(self, condition_dict: dict)`


#### `_create_margin_condition(self, condition_dict: dict)`


#### `_create_execution_condition(self, condition_dict: dict)`


#### `_create_volume_condition(self, condition_dict: dict)`


#### `_create_percent_change_condition(
        self,
        condition_dict: dict,
    )`


#### `_on_account_summary(self, tag: str, value: str, currency: str)`


#### `_handle_order_event(  # noqa: C901
        self,
        status: OrderStatus,
        order: Order,
        order_id: int | None = None,
...
#### `_on_open_order(self, order_ref: str, order: IBOrder, order_state: IBOrderState)`
...
#### `_get_leg_instrument_id_and_ratio(
        self,
        spread_instrument_id: InstrumentId,
        contract: IBContract,
    )`
...
#### `_update_position_tracking_from_execution(self, contract: IBContract, execution)`


#### `_on_position_update(self, ib_position)`
