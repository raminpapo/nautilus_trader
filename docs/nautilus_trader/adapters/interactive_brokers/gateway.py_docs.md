...
### Classes
- **`ContainerStatus`**: Class defined in this file
- **`DockerizedIBGateway`**: Class defined in this file
- **`ContainerExists`**: Class defined in this file
- **`NoContainer`**: Class defined in this file
- **`UnknownContainerStatus`**: Class defined in this file
- **`GatewayLoginFailure`**: Class defined in this file
...
**Classs**: `ContainerExists`, `ContainerStatus`, `DockerizedIBGateway`, `GatewayLoginFailure`, `NoContainer`, `UnknownContainerStatus`
**Imports**: `enum`, `logging`, `nautilus_trader.adapters.interactive_brokers.config`, `nautilus_trader.common.component`, `nautilus_trader.common.secure`, `os`, `time`, `typing`
...
---
*Generated on 2025-11-18T21:55:04.857157Z*
