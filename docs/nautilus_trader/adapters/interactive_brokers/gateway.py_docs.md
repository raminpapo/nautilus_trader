# Documentation: `nautilus_trader/adapters/interactive_brokers/gateway.py`
**Generated:** 2025-11-15T19:40:04.380333Z
**File Size:** 7925 bytes
**Extension:** .py
**Type:** text
...
- **Path:** `nautilus_trader/adapters/interactive_brokers/gateway.py`
- **Size:** 7,925 bytes
- **Lines:** 240
- **Extension:** `.py`
- **Type:** text
...
This file is located at `nautilus_trader/adapters/interactive_brokers/gateway.py` within the repository.

**Classes defined:** ContainerStatus, DockerizedIBGateway, ContainerExists, NoContainer, UnknownContainerStatus, GatewayLoginFailure

**Functions defined:** __init__, __repr__, container_name, container_status, container, is_logged_in, start, safe_start, stop, __enter__ and 1 more
...
#### `__init__(self, config: DockerizedIBGatewayConfig)`
...
#### `is_logged_in(container)`


#### `start(self, wait: int | None = None)`


#### `safe_start(self, wait: int | None = None)`
...
```python
from nautilus_trader.adapters.interactive_brokers.gateway import ContainerStatus
```
