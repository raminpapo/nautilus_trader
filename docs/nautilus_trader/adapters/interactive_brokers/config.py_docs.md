...
- **Path**: `nautilus_trader/adapters/interactive_brokers/config.py`
- **Size**: 13,941 bytes
- **Lines**: 286
- **Language**: Python
...
### Classes
- **`SymbologyMethod`**: Class defined in this file
- **`DockerizedIBGatewayConfig`**: Class defined in this file
- **`InteractiveBrokersInstrumentProviderConfig`**: Class defined in this file
- **`InteractiveBrokersDataClientConfig`**: Class defined in this file
- **`InteractiveBrokersExecClientConfig`**: Class defined in this file
...
**Classs**: `DockerizedIBGatewayConfig`, `InteractiveBrokersDataClientConfig`, `InteractiveBrokersExecClientConfig`, `InteractiveBrokersInstrumentProviderConfig`, `SymbologyMethod`
**Imports**: `__future__`, `enum`, `ibapi.common`, `nautilus_trader.adapters.interactive_brokers.common`, `nautilus_trader.config`, `typing`
...
---
*Generated on 2025-11-18T21:55:04.841260Z*
