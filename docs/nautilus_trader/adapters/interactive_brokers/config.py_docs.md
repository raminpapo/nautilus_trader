# Documentation: `nautilus_trader/adapters/interactive_brokers/config.py`
**Generated:** 2025-11-15T19:40:04.364712Z
...
This file is located at `nautilus_trader/adapters/interactive_brokers/config.py` within the repository.

**Classes defined:** SymbologyMethod, DockerizedIBGatewayConfig, InteractiveBrokersInstrumentProviderConfig, InteractiveBrokersDataClientConfig, InteractiveBrokersExecClientConfig

**Functions defined:** __repr__, _mask_sensitive_info, __eq__, __hash__
...
**Inherits from:** InstrumentProviderConfig, frozen=True
...
#### `_mask_sensitive_info(value: str | None)`
...
**Security:** This file may contain sensitive patterns: password, session. Ensure proper handling of secrets.
