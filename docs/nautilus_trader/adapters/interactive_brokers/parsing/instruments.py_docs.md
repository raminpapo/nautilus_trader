# Documentation: instruments.py

## File Metadata

- **Path**: `nautilus_trader/adapters/interactive_brokers/parsing/instruments.py`
- **Size**: 43,911 bytes
- **Lines**: 1,142
- **Language**: Python
...
This file is part of the NautilusTrader repository. It defines 27 function(s).

## Detailed Walkthrough

### Functions
- **`sec_type_to_asset_class()`**: Function defined in this file
- **`contract_details_to_ib_contract_details()`**: Function defined in this file
- **`parse_instrument()`**: Function defined in this file
- **`parse_equity_contract()`**: Function defined in this file
- **`_extract_isin()`**: Function defined in this file
- **`parse_index_contract()`**: Function defined in this file
- **`parse_futures_contract()`**: Function defined in this file
- **`parse_option_contract()`**: Function defined in this file
- **`expiry_timestring_to_datetime()`**: Function defined in this file
- **`parse_forex_contract()`**: Function defined in this file
- **`parse_crypto_contract()`**: Function defined in this file
- **`parse_cfd_contract()`**: Function defined in this file
- **`parse_commodity_contract()`**: Function defined in this file
- **`parse_option_spread()`**: Function defined in this file
- **`parse_spread_instrument_id()`**: Function defined in this file
- **`contract_details_to_dict()`**: Function defined in this file
- **`_serialize_for_json()`**: Function defined in this file
- **`_tick_size_to_precision()`**: Function defined in this file
- **`decade_digit()`**: Function defined in this file
- **`ib_contract_to_instrument_id()`**: Function defined in this file
...
**Functions**: `_extract_isin`, `_serialize_for_json`, `_tick_size_to_precision`, `bag_contract_to_instrument_id`, `contract_details_to_dict`, `contract_details_to_ib_contract_details`, `decade_digit`, `expiry_timestring_to_datetime`, `ib_contract_to_instrument_id`, `ib_contract_to_instrument_id_raw_symbology`, `ib_contract_to_instrument_id_simplified_symbology`, `instrument_id_to_bag_contract`, `instrument_id_to_ib_contract`, `instrument_id_to_ib_contract_raw_symbology`, `instrument_id_to_ib_contract_simplified_symbology`, `parse_cfd_contract`, `parse_commodity_contract`, `parse_crypto_contract`, `parse_equity_contract`, `parse_forex_contract`, `parse_futures_contract`, `parse_index_contract`, `parse_instrument`, `parse_option_contract`, `parse_option_spread`, `parse_spread_instrument_id`, `sec_type_to_asset_class`
**Imports**: `datetime`, `decimal`, `enum`, `ibapi.contract`, `nautilus_trader.adapters.interactive_brokers.common`, `nautilus_trader.adapters.interactive_brokers.config`, `nautilus_trader.core.correctness`, `nautilus_trader.model.enums`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.instruments`, `nautilus_trader.model.instruments.option_spread`, `nautilus_trader.model.objects`, `pandas`, `re`, `time`, `typing`
...
---
*Generated on 2025-11-18T21:55:04.873496Z*
