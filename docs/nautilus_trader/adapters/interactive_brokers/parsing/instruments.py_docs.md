# Documentation: `nautilus_trader/adapters/interactive_brokers/parsing/instruments.py`
**Generated:** 2025-11-15T19:40:04.395168Z
**File Size:** 43916 bytes
**Extension:** .py
**Type:** text
...
This file is located at `nautilus_trader/adapters/interactive_brokers/parsing/instruments.py` within the repository.

**Functions defined:** sec_type_to_asset_class, contract_details_to_ib_contract_details, parse_instrument, parse_equity_contract, _extract_isin, parse_index_contract, parse_futures_contract, parse_option_contract, expiry_timestring_to_datetime, parse_forex_contract and 17 more
...
#### `sec_type_to_asset_class(sec_type: str)`


#### `contract_details_to_ib_contract_details(details: ContractDetails)`
...
#### `parse_equity_contract(
    details: IBContractDetails,
    instrument_id: InstrumentId,
)`


#### `_extract_isin(details: IBContractDetails)`


#### `parse_index_contract(
    details: IBContractDetails,
    instrument_id: InstrumentId,
)`
...
#### `expiry_timestring_to_datetime(expiry: str)`


#### `parse_forex_contract(
    details: IBContractDetails,
    instrument_id: InstrumentId,
)`
...
#### `contract_details_to_dict(details: IBContractDetails)`


#### `_serialize_for_json(obj: object)`


#### `_tick_size_to_precision(tick_size: float | Decimal)`


#### `decade_digit(last_digit: str, contract: IBContract)`
...
#### `ib_contract_to_instrument_id_simplified_symbology(  # noqa: C901 (too complex)`


#### `bag_contract_to_instrument_id(
    contract: IBContract,
    venue: str,
    contract_details_map: dict[int, IBContractDetails] | None = None,
)`
...
#### `ib_contract_to_instrument_id_raw_symbology(
    contract: IBContract,
    venue: str,
)`
...
#### `instrument_id_to_ib_contract_simplified_symbology(  # noqa: C901 (too complex)`


#### `instrument_id_to_bag_contract(
    instrument_id: InstrumentId,
    exchange: str,
    contract_details_map: dict[InstrumentId, IBContractDetails] | None = None,
)`
...
#### `instrument_id_to_ib_contract_raw_symbology(instrument_id: InstrumentId)`
...
```python
from nautilus_trader.adapters.interactive_brokers.parsing.instruments import sec_type_to_asset_class
```
