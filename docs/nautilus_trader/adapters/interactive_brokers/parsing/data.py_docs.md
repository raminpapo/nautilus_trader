# Documentation: `nautilus_trader/adapters/interactive_brokers/parsing/data.py`
**Generated:** 2025-11-15T19:40:04.388653Z
...
- **Path:** `nautilus_trader/adapters/interactive_brokers/parsing/data.py`
- **Size:** 3,540 bytes
- **Lines:** 98
- **Extension:** `.py`
- **Type:** text
...
This file is located at `nautilus_trader/adapters/interactive_brokers/parsing/data.py` within the repository.

**Functions defined:** what_to_show, generate_trade_id, bar_spec_to_bar_size, timedelta_to_duration_str
...
#### `what_to_show(bar_type: BarType)`


#### `generate_trade_id(ts_event: int, price: float, size: Decimal)`


#### `bar_spec_to_bar_size(bar_spec: BarSpecification)`


#### `timedelta_to_duration_str(duration: datetime.timedelta)`
