...
### Functions
- **`what_to_show()`**: Function defined in this file
- **`generate_trade_id()`**: Function defined in this file
- **`bar_spec_to_bar_size()`**: Function defined in this file
- **`timedelta_to_duration_str()`**: Function defined in this file
...
**Functions**: `bar_spec_to_bar_size`, `generate_trade_id`, `timedelta_to_duration_str`, `what_to_show`
**Imports**: `datetime`, `decimal`, `nautilus_trader.core.datetime`, `nautilus_trader.model.data`, `nautilus_trader.model.enums`, `nautilus_trader.model.identifiers`
...
---
*Generated on 2025-11-18T21:55:04.864646Z*
