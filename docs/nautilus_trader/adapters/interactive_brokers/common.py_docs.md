...
- **Path**: `nautilus_trader/adapters/interactive_brokers/common.py`
- **Size**: 11,209 bytes
- **Lines**: 354
- **Language**: Python
...
### Functions
- **`dict_to_contract_details()`**: Function defined in this file
- **`_deserialize_enum_from_value()`**: Function defined in this file

### Classes
- **`ContractId`**: Class defined in this file
- **`ComboLeg`**: Class defined in this file
- **`DeltaNeutralContract`**: Class defined in this file
- **`IBContract`**: Class defined in this file
- **`IBOrderTags`**: Class defined in this file
- **`IBContractDetails`**: Class defined in this file
...
**Classs**: `ComboLeg`, `ContractId`, `DeltaNeutralContract`, `IBContract`, `IBContractDetails`, `IBOrderTags`
**Functions**: `_deserialize_enum_from_value`, `dict_to_contract_details`
**Imports**: `decimal`, `ibapi.const`, `ibapi.contract`, `ibapi.tag_value`, `nautilus_trader.config`, `nautilus_trader.model.identifiers`, `typing`
...
---
*Generated on 2025-11-18T21:55:04.839145Z*
