# Documentation: `nautilus_trader/adapters/interactive_brokers/common.py`
**Generated:** 2025-11-15T19:40:04.362461Z
...
This file is located at `nautilus_trader/adapters/interactive_brokers/common.py` within the repository.

**Classes defined:** ContractId, ComboLeg, DeltaNeutralContract, IBContract, IBOrderTags, IBContractDetails

**Functions defined:** value, __str__, dict_to_contract_details, _deserialize_enum_from_value
...
**Inherits from:** NautilusConfig, frozen=True, omit_defaults=True, repr_omit_defaults=True
...
#### `dict_to_contract_details(dict_details: dict)`
