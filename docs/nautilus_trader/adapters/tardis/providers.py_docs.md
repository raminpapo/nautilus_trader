...
- **Path**: `nautilus_trader/adapters/tardis/providers.py`
- **Size**: 8,053 bytes
- **Lines**: 191
- **Language**: Python
...
### Classes
- **`TardisInstrumentProvider`**: Class defined in this file
...
**Classs**: `TardisInstrumentProvider`
**Imports**: `collections`, `msgspec`, `nautilus_trader.common.providers`, `nautilus_trader.config`, `nautilus_trader.core`, `nautilus_trader.core.correctness`, `nautilus_trader.core.datetime`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.instruments`, `pandas`, `time`
...
---
*Generated on 2025-11-18T21:55:05.010834Z*
