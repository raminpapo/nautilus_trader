# Documentation: `nautilus_trader/adapters/tardis/loaders.py`
**Generated:** 2025-11-15T19:40:04.510458Z
**File Size:** 23753 bytes
**Extension:** .py
**Type:** text
...
- **Path:** `nautilus_trader/adapters/tardis/loaders.py`
- **Size:** 23,753 bytes
- **Lines:** 665
- **Extension:** `.py`
- **Type:** text
...
This file is located at `nautilus_trader/adapters/tardis/loaders.py` within the repository.

**Classes defined:** TardisCSVDataLoader

**Functions defined:** __init__, load_deltas, load_depth10, load_quotes, load_trades, load_funding_rates, stream_deltas, stream_batched_deltas, stream_quotes, stream_trades and 2 more
