...
### Functions
- **`get_tardis_http_client()`**: Function defined in this file
- **`get_tardis_instrument_provider()`**: Function defined in this file

### Classes
- **`TardisLiveDataClientFactory`**: Class defined in this file
...
**Classs**: `TardisLiveDataClientFactory`
**Functions**: `get_tardis_http_client`, `get_tardis_instrument_provider`
**Imports**: `asyncio`, `functools`, `nautilus_trader.adapters.tardis.config`, `nautilus_trader.adapters.tardis.data`, `nautilus_trader.adapters.tardis.providers`, `nautilus_trader.cache.cache`, `nautilus_trader.common.component`, `nautilus_trader.config`, `nautilus_trader.core.nautilus_pyo3`, `nautilus_trader.live.factories`
...
---
*Generated on 2025-11-18T21:55:05.005734Z*
