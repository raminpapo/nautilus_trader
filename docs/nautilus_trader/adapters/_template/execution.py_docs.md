...
- **Path**: `nautilus_trader/adapters/_template/execution.py`
- **Size**: 6,968 bytes
- **Lines**: 149
- **Language**: Python
...
### Classes
- **`TemplateLiveExecutionClient`**: Class defined in this file
...
**Classs**: `TemplateLiveExecutionClient`
**Imports**: `nautilus_trader.execution.messages`, `nautilus_trader.execution.reports`, `nautilus_trader.live.execution_client`
...
---
*Generated on 2025-11-18T21:55:04.445492Z*
