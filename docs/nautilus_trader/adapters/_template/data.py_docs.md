# Documentation: `nautilus_trader/adapters/_template/data.py`
**Generated:** 2025-11-15T19:40:04.011943Z
**File Size:** 16550 bytes
**Extension:** .py
**Type:** text
...
- **Path:** `nautilus_trader/adapters/_template/data.py`
- **Size:** 16,550 bytes
- **Lines:** 340
- **Extension:** `.py`
- **Type:** text
...
This file is located at `nautilus_trader/adapters/_template/data.py` within the repository.

**Classes defined:** TemplateLiveDataClient, TemplateLiveMarketDataClient
...
```python
from nautilus_trader.adapters._template.data import TemplateLiveDataClient
```
