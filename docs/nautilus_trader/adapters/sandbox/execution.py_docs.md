...
- **Path**: `nautilus_trader/adapters/sandbox/execution.py`
- **Size**: 8,881 bytes
- **Lines**: 226
- **Language**: Python
...
### Classes
- **`SandboxExecutionClient`**: Class defined in this file
...
**Classs**: `SandboxExecutionClient`
**Imports**: `asyncio`, `nautilus_trader.adapters.sandbox.config`, `nautilus_trader.backtest.engine`, `nautilus_trader.backtest.execution_client`, `nautilus_trader.backtest.models`, `nautilus_trader.cache.cache`, `nautilus_trader.common.component`, `nautilus_trader.common.providers`, `nautilus_trader.core.data`, `nautilus_trader.execution.messages`, `nautilus_trader.execution.reports`, `nautilus_trader.live.execution_client`, `nautilus_trader.model.data`, `nautilus_trader.model.enums`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.instruments`, `nautilus_trader.model.objects`, `nautilus_trader.portfolio.base`
...
---
*Generated on 2025-11-18T21:55:04.992385Z*
