# Documentation: `nautilus_trader/adapters/kraken/data.py`
**Generated:** 2025-11-15T19:40:04.408485Z
**File Size:** 19268 bytes
**Extension:** .py
**Type:** text
...
This file is located at `nautilus_trader/adapters/kraken/data.py` within the repository.

**Classes defined:** KrakenDataClient

**Functions defined:** __init__, instrument_provider, _determine_ws_url, _cache_instruments, _send_all_instruments_to_data_engine, _handle_msg, _handle_instrument_update
...
#### `_determine_ws_url(self, config: KrakenDataClientConfig)`
...
#### `_handle_instrument_update(self, pyo3_instrument: KrakenInstrument)`
