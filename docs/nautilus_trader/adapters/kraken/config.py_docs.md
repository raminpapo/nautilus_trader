# Documentation: `nautilus_trader/adapters/kraken/config.py`
**Generated:** 2025-11-15T19:40:04.405221Z
...
- **Path:** `nautilus_trader/adapters/kraken/config.py`
- **Size:** 3,267 bytes
- **Lines:** 74
- **Extension:** `.py`
- **Type:** text
...
This file is located at `nautilus_trader/adapters/kraken/config.py` within the repository.

**Classes defined:** KrakenDataClientConfig
