# Documentation: `nautilus_trader/adapters/kraken/factories.py`
**Generated:** 2025-11-15T19:40:04.410251Z
...
This file is located at `nautilus_trader/adapters/kraken/factories.py` within the repository.

**Classes defined:** KrakenLiveDataClientFactory

**Functions defined:** get_kraken_http_client, get_kraken_instrument_provider, create
...
#### `get_kraken_instrument_provider(
    client: nautilus_pyo3.KrakenHttpClient,
    product_types: tuple[str, ...],
    config: InstrumentProviderConfig,
)`
