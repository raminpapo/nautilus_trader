...
- **Path**: `nautilus_trader/adapters/kraken/factories.py`
- **Size**: 5,804 bytes
- **Lines**: 179
- **Language**: Python
...
### Functions
- **`get_kraken_http_client()`**: Function defined in this file
- **`get_kraken_instrument_provider()`**: Function defined in this file

### Classes
- **`KrakenLiveDataClientFactory`**: Class defined in this file
...
**Classs**: `KrakenLiveDataClientFactory`
**Functions**: `get_kraken_http_client`, `get_kraken_instrument_provider`
**Imports**: `asyncio`, `functools`, `nautilus_trader.adapters.kraken.config`, `nautilus_trader.adapters.kraken.data`, `nautilus_trader.adapters.kraken.providers`, `nautilus_trader.cache.cache`, `nautilus_trader.common.component`, `nautilus_trader.config`, `nautilus_trader.core`, `nautilus_trader.live.factories`
...
---
*Generated on 2025-11-18T21:55:04.889674Z*
