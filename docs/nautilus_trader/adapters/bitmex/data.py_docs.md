...
- **Path**: `nautilus_trader/adapters/bitmex/data.py`
- **Size**: 21,058 bytes
- **Lines**: 492
- **Language**: Python
...
**Classs**: `BitmexDataClient`
**Imports**: `asyncio`, `nautilus_trader.adapters.bitmex.config`, `nautilus_trader.adapters.bitmex.constants`, `nautilus_trader.adapters.bitmex.providers`, `nautilus_trader.adapters.bitmex.types`, `nautilus_trader.cache.cache`, `nautilus_trader.cache.transformers`, `nautilus_trader.common.component`, `nautilus_trader.common.enums`, `nautilus_trader.core`, `nautilus_trader.core.datetime`, `nautilus_trader.data.messages`, `nautilus_trader.live.cancellation`, `nautilus_trader.live.data_client`, `nautilus_trader.model.data`, `nautilus_trader.model.enums`, `nautilus_trader.model.identifiers`, `typing`
...
---
*Generated on 2025-11-18T21:55:04.624706Z*
