...
- **Path**: `nautilus_trader/adapters/bitmex/factories.py`
- **Size**: 9,154 bytes
- **Lines**: 271
- **Language**: Python
...
### Functions
- **`get_bitmex_http_client()`**: Function defined in this file
- **`get_bitmex_instrument_provider()`**: Function defined in this file

### Classes
- **`BitmexLiveDataClientFactory`**: Class defined in this file
- **`BitmexLiveExecClientFactory`**: Class defined in this file
...
**Classs**: `BitmexLiveDataClientFactory`, `BitmexLiveExecClientFactory`
**Functions**: `get_bitmex_http_client`, `get_bitmex_instrument_provider`
**Imports**: `asyncio`, `functools`, `nautilus_trader.adapters.bitmex.config`, `nautilus_trader.adapters.bitmex.data`, `nautilus_trader.adapters.bitmex.execution`, `nautilus_trader.adapters.bitmex.providers`, `nautilus_trader.cache.cache`, `nautilus_trader.common.component`, `nautilus_trader.config`, `nautilus_trader.core`, `nautilus_trader.live.factories`
...
---
*Generated on 2025-11-18T21:55:04.630784Z*
