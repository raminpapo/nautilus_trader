# Documentation: `nautilus_trader/adapters/bitmex/factories.py`
**Generated:** 2025-11-15T19:40:04.176730Z
...
This file is located at `nautilus_trader/adapters/bitmex/factories.py` within the repository.

**Classes defined:** BitmexLiveDataClientFactory, BitmexLiveExecClientFactory

**Functions defined:** get_bitmex_http_client, get_bitmex_instrument_provider, create, create
...
#### `get_bitmex_instrument_provider(
    client: nautilus_pyo3.BitmexHttpClient,
    active_only: bool,
    config: InstrumentProviderConfig,
)`
