...
- **Path**: `nautilus_trader/adapters/bitmex/providers.py`
- **Size**: 4,265 bytes
- **Lines**: 119
- **Language**: Python
...
### Classes
- **`BitmexInstrumentProvider`**: Class defined in this file
...
**Classs**: `BitmexInstrumentProvider`
**Imports**: `nautilus_trader.adapters.bitmex.constants`, `nautilus_trader.common.providers`, `nautilus_trader.config`, `nautilus_trader.core`, `nautilus_trader.core.correctness`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.instruments`, `typing`
...
---
*Generated on 2025-11-18T21:55:04.632286Z*
