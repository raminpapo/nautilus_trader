# Documentation: `nautilus_trader/adapters/bitmex/execution.py`
**Generated:** 2025-11-15T19:40:04.174688Z
**File Size:** 41424 bytes
**Extension:** .py
**Type:** text
...
- **Path:** `nautilus_trader/adapters/bitmex/execution.py`
- **Size:** 41,424 bytes
- **Lines:** 1,004
- **Extension:** `.py`
- **Type:** text
...
This file is located at `nautilus_trader/adapters/bitmex/execution.py` within the repository.

**Classes defined:** BitmexExecutionClient

**Functions defined:** __init__, _log_runtime_error, instrument_provider, _cache_instruments, _cache_instrument, _parse_submit_tries, _handle_account_state, _handle_msg, _handle_instrument_update, _handle_fill_reports_list and 9 more
...
#### `_log_runtime_error(self, message: str)`


#### `instrument_provider(self)`


#### `_cache_instruments(self)`


#### `_cache_instrument(self, instrument: Any)`


#### `_parse_submit_tries(self, params: dict | None)`


#### `_handle_account_state(self, msg: nautilus_pyo3.AccountState)`


#### `_handle_msg(self, msg: Any)`


#### `_handle_instrument_update(self, pyo3_instrument: BitmexInstrument)`


#### `_handle_fill_reports_list(self, reports: list)`
...
#### `_handle_position_status_report_pyo3(
        self,
        pyo3_report: nautilus_pyo3.PositionStatusReport,
    )`
