# Documentation: `nautilus_trader/adapters/bitmex/config.py`
**Generated:** 2025-11-15T19:40:04.166530Z
**File Size:** 8698 bytes
**Extension:** .py
**Type:** text
...
- **Path:** `nautilus_trader/adapters/bitmex/config.py`
- **Size:** 8,698 bytes
- **Lines:** 174
- **Extension:** `.py`
- **Type:** text
...
This file is located at `nautilus_trader/adapters/bitmex/config.py` within the repository.

**Classes defined:** BitmexDataClientConfig, BitmexExecClientConfig
