# Documentation: `nautilus_trader/adapters/bybit/config.py`
**Generated:** 2025-11-15T19:40:04.182467Z
...
- **Path:** `nautilus_trader/adapters/bybit/config.py`
- **Size:** 8,933 bytes
- **Lines:** 189
- **Extension:** `.py`
- **Type:** text
...
This file is located at `nautilus_trader/adapters/bybit/config.py` within the repository.

**Classes defined:** BybitDataClientConfig, BybitExecClientConfig
