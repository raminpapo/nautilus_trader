# Documentation: `nautilus_trader/adapters/bybit/types.py`
**Generated:** 2025-11-15T19:40:04.199726Z
...
- **Path:** `nautilus_trader/adapters/bybit/types.py`
- **Size:** 1,459 bytes
- **Lines:** 40
- **Extension:** `.py`
- **Type:** text
...
This file is located at `nautilus_trader/adapters/bybit/types.py` within the repository.
...
```python
import nautilus_trader.adapters.bybit.types
```
