# Documentation: `nautilus_trader/adapters/bybit/execution.py`
**Generated:** 2025-11-15T19:40:04.191710Z
**File Size:** 53253 bytes
**Extension:** .py
**Type:** text
...
- **Path:** `nautilus_trader/adapters/bybit/execution.py`
- **Size:** 53,253 bytes
- **Lines:** 1,277
- **Extension:** `.py`
- **Type:** text
...
This file is located at `nautilus_trader/adapters/bybit/execution.py` within the repository.

**Classes defined:** BybitExecutionClient

**Functions defined:** __init__, bybit_instrument_provider, _check_order_validity, _handle_msg, _handle_account_state, _handle_order_rejected_pyo3, _handle_order_cancel_rejected_pyo3, _handle_order_modify_rejected_pyo3, _handle_order_status_report_pyo3, _handle_fill_report_pyo3 and 3 more
...
#### `bybit_instrument_provider(self)`


#### `_check_order_validity(
        self,
        order: Order,
        product_type: BybitProductType,
    )`
...
#### `_handle_order_rejected_pyo3(self, msg: nautilus_pyo3.OrderRejected)`


#### `_handle_order_cancel_rejected_pyo3(self, msg: nautilus_pyo3.OrderCancelRejected)`


#### `_handle_order_modify_rejected_pyo3(self, msg: nautilus_pyo3.OrderModifyRejected)`
...
#### `_handle_position_status_report_pyo3(self, msg: nautilus_pyo3.PositionStatusReport)`
