# Documentation: `nautilus_trader/adapters/bybit/data.py`
**Generated:** 2025-11-15T19:40:04.186824Z
**File Size:** 25251 bytes
**Extension:** .py
**Type:** text
...
- **Path:** `nautilus_trader/adapters/bybit/data.py`
- **Size:** 25,251 bytes
- **Lines:** 577
- **Extension:** `.py`
- **Type:** text
...
This file is located at `nautilus_trader/adapters/bybit/data.py` within the repository.

**Classes defined:** BybitDataClient

**Functions defined:** __init__, instrument_provider, _cache_instruments, _send_all_instruments_to_data_engine, _get_ws_client_for_instrument, _bar_spec_to_bybit_interval, _handle_msg
...
#### `_get_ws_client_for_instrument(
        self,
        instrument_id: nautilus_pyo3.InstrumentId,
    )`


#### `_bar_spec_to_bybit_interval(self, bar_spec)`
