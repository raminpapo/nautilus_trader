# Documentation: `nautilus_trader/adapters/bybit/constants.py`
**Generated:** 2025-11-15T19:40:04.183931Z
...
- **Path:** `nautilus_trader/adapters/bybit/constants.py`
- **Size:** 1,446 bytes
- **Lines:** 34
- **Extension:** `.py`
- **Type:** text
...
This file is located at `nautilus_trader/adapters/bybit/constants.py` within the repository.
...
```python
import nautilus_trader.adapters.bybit.constants
```
