# Documentation: `nautilus_trader/adapters/binance/futures/providers.py`
**Generated:** 2025-11-15T19:40:04.104194Z
**File Size:** 18232 bytes
**Extension:** .py
**Type:** text
...
This file is located at `nautilus_trader/adapters/binance/futures/providers.py` within the repository.

**Classes defined:** BinanceFuturesInstrumentProvider

**Functions defined:** _symbol_info_to_dict, _convert_value, _convert_dict, __init__, _parse_instrument
...
#### `_symbol_info_to_dict(symbol_info: BinanceFuturesSymbolInfo)`


#### `_convert_value(value: Any)`


#### `_convert_dict(d: dict)`
