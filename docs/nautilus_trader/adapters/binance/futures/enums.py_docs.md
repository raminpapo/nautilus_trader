...
- **Path**: `nautilus_trader/adapters/binance/futures/enums.py`
- **Size**: 6,628 bytes
- **Lines**: 203
- **Language**: Python
...
### Classes
- **`BinanceFuturesContractType`**: Class defined in this file
- **`BinanceFuturesContractStatus`**: Class defined in this file
- **`BinanceFuturesWorkingType`**: Class defined in this file
- **`BinanceFuturesMarginType`**: Class defined in this file
- **`BinanceFuturesPositionUpdateReason`**: Class defined in this file
- **`BinanceFuturesEventType`**: Class defined in this file
- **`BinanceFuturesEnumParser`**: Class defined in this file
...
**Classs**: `BinanceFuturesContractStatus`, `BinanceFuturesContractType`, `BinanceFuturesEnumParser`, `BinanceFuturesEventType`, `BinanceFuturesMarginType`, `BinanceFuturesPositionUpdateReason`, `BinanceFuturesWorkingType`
**Imports**: `decimal`, `enum`, `nautilus_trader.adapters.binance.common.enums`, `nautilus_trader.model.enums`, `nautilus_trader.model.orders`
...
---
*Generated on 2025-11-18T21:55:04.537449Z*
