# Documentation: `nautilus_trader/adapters/binance/futures/data.py`
**Generated:** 2025-11-15T19:40:04.087609Z
...
- **Path:** `nautilus_trader/adapters/binance/futures/data.py`
- **Size:** 7,733 bytes
- **Lines:** 187
- **Extension:** `.py`
- **Type:** text
...
This file is located at `nautilus_trader/adapters/binance/futures/data.py` within the repository.

**Classes defined:** BinanceFuturesDataClient

**Functions defined:** __init__, _handle_book_partial_update, _handle_trade, _handle_mark_price_data, _handle_mark_price, _handle_mark_price_all
...
#### `_handle_mark_price_data(self, data: BinanceFuturesMarkPriceData)`


#### `_handle_mark_price(self, raw: bytes)`


#### `_handle_mark_price_all(self, raw: bytes)`
