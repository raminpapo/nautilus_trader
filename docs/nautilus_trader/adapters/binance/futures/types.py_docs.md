# Documentation: `nautilus_trader/adapters/binance/futures/types.py`
**Generated:** 2025-11-15T19:40:04.116465Z
**File Size:** 5122 bytes
**Extension:** .py
**Type:** text
...
- **Path:** `nautilus_trader/adapters/binance/futures/types.py`
- **Size:** 5,122 bytes
- **Lines:** 159
- **Extension:** `.py`
- **Type:** text
...
This file is located at `nautilus_trader/adapters/binance/futures/types.py` within the repository.

**Classes defined:** BinanceFuturesMarkPriceUpdate

**Functions defined:** __init__, __repr__, ts_event, ts_init, from_dict, to_dict
...
#### `to_dict(obj: BinanceFuturesMarkPriceUpdate)`
