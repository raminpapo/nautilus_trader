# Documentation: `nautilus_trader/adapters/binance/futures/execution.py`
**Generated:** 2025-11-15T19:40:04.092597Z
**File Size:** 20830 bytes
**Extension:** .py
**Type:** text
...
This file is located at `nautilus_trader/adapters/binance/futures/execution.py` within the repository.

**Classes defined:** BinanceFuturesExecutionClient

**Functions defined:** __init__, _check_order_validity, _filter_valid_cancels, _generate_cancel_rejected_events, _handle_user_ws_message, _handle_account_update, _handle_order_trade_update, _handle_margin_call, _handle_account_config_update, _handle_listen_key_expired and 1 more
...
#### `_filter_valid_cancels(self, cancels: list[CancelOrder])`


#### `_generate_cancel_rejected_events(self, cancels: list[CancelOrder], reason: str)`


#### `_handle_user_ws_message(self, raw: bytes)`


#### `_handle_account_update(self, raw: bytes)`


#### `_handle_order_trade_update(self, raw: bytes)`


#### `_handle_margin_call(self, raw: bytes)`


#### `_handle_account_config_update(self, raw: bytes)`


#### `_handle_listen_key_expired(self, raw: bytes)`


#### `_handle_trade_lite(self, raw: bytes)`
...
**Directory:** `nautilus_trader/adapters/binance/futures`
