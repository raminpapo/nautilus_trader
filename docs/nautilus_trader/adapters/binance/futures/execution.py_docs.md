...
- **Path**: `nautilus_trader/adapters/binance/futures/execution.py`
- **Size**: 20,830 bytes
- **Lines**: 465
- **Language**: Python
...
### Classes
- **`BinanceFuturesExecutionClient`**: Class defined in this file
...
**Classs**: `BinanceFuturesExecutionClient`
**Imports**: `asyncio`, `decimal`, `msgspec`, `nautilus_trader.accounting.accounts.margin`, `nautilus_trader.adapters.binance.common.enums`, `nautilus_trader.adapters.binance.config`, `nautilus_trader.adapters.binance.execution`, `nautilus_trader.adapters.binance.futures.enums`, `nautilus_trader.adapters.binance.futures.http.account`, `nautilus_trader.adapters.binance.futures.http.market`, `nautilus_trader.adapters.binance.futures.http.user`, `nautilus_trader.adapters.binance.futures.providers`, `nautilus_trader.adapters.binance.futures.schemas.account`, `nautilus_trader.adapters.binance.futures.schemas.user`, `nautilus_trader.adapters.binance.http.client`, `nautilus_trader.adapters.binance.http.error`, `nautilus_trader.cache.cache`, `nautilus_trader.common.component`, `nautilus_trader.common.enums`, `nautilus_trader.core.correctness`, `nautilus_trader.core.datetime`, `nautilus_trader.core.uuid`, `nautilus_trader.execution.messages`, `nautilus_trader.execution.reports`, `nautilus_trader.model.enums`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.orders`

## Related Files

This file is located in `nautilus_trader/adapters/binance/futures/`. Related files may include:
...
---
*Generated on 2025-11-18T21:55:04.540399Z*
