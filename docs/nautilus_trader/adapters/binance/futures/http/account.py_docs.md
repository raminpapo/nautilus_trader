# Documentation: `nautilus_trader/adapters/binance/futures/http/account.py`
**Generated:** 2025-11-15T19:40:04.096996Z
**File Size:** 23568 bytes
**Extension:** .py
**Type:** text
...
This file is located at `nautilus_trader/adapters/binance/futures/http/account.py` within the repository.

**Classes defined:** BinanceFuturesPositionModeHttp, GetParameters, PostParameters, BinanceFuturesAllOpenOrdersHttp, DeleteParameters, BinanceFuturesCancelMultipleOrdersHttp, DeleteParameters, BinanceFuturesAccountHttp, GetParameters, BinanceFuturesPositionRiskHttp and 8 more

**Functions defined:** __init__, __init__, __init__, __init__, __init__, __init__, __init__, __init__, __init__
...
```python
from nautilus_trader.adapters.binance.futures.http.account import BinanceFuturesPositionModeHttp
```
