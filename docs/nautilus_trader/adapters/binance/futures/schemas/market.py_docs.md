...
- **Path**: `nautilus_trader/adapters/binance/futures/schemas/market.py`
- **Size**: 8,141 bytes
- **Lines**: 260
- **Language**: Python
...
This file is part of the NautilusTrader repository. 10 class(es).

## Detailed Walkthrough


### Classes
- **`BinanceFuturesAsset`**: Class defined in this file
- **`BinanceFuturesSymbolInfo`**: Class defined in this file
- **`BinanceFuturesExchangeInfo`**: Class defined in this file
- **`BinanceFuturesMarkFunding`**: Class defined in this file
- **`BinanceFuturesFundRate`**: Class defined in this file
- **`BinanceFuturesTradeData`**: Class defined in this file
- **`BinanceFuturesTradeMsg`**: Class defined in this file
- **`BinanceFuturesMarkPriceData`**: Class defined in this file
- **`BinanceFuturesMarkPriceMsg`**: Class defined in this file
- **`BinanceFuturesMarkPriceAllMsg`**: Class defined in this file
...
**Classs**: `BinanceFuturesAsset`, `BinanceFuturesExchangeInfo`, `BinanceFuturesFundRate`, `BinanceFuturesMarkFunding`, `BinanceFuturesMarkPriceAllMsg`, `BinanceFuturesMarkPriceData`, `BinanceFuturesMarkPriceMsg`, `BinanceFuturesSymbolInfo`, `BinanceFuturesTradeData`, `BinanceFuturesTradeMsg`
**Imports**: `decimal`, `msgspec`, `nautilus_trader.adapters.binance.common.enums`, `nautilus_trader.adapters.binance.common.schemas.market`, `nautilus_trader.adapters.binance.futures.enums`, `nautilus_trader.adapters.binance.futures.types`, `nautilus_trader.core.datetime`, `nautilus_trader.model.data`, `nautilus_trader.model.enums`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.objects`
...
---
*Generated on 2025-11-18T21:55:04.560032Z*
