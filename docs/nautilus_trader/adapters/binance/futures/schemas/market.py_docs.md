# Documentation: `nautilus_trader/adapters/binance/futures/schemas/market.py`
**Generated:** 2025-11-15T19:40:04.109820Z
...
This file is located at `nautilus_trader/adapters/binance/futures/schemas/market.py` within the repository.

**Classes defined:** BinanceFuturesAsset, BinanceFuturesSymbolInfo, BinanceFuturesExchangeInfo, BinanceFuturesMarkFunding, BinanceFuturesFundRate, BinanceFuturesTradeData, BinanceFuturesTradeMsg, BinanceFuturesMarkPriceData, BinanceFuturesMarkPriceMsg, BinanceFuturesMarkPriceAllMsg

**Functions defined:** parse_to_base_currency, parse_to_quote_currency, parse_to_trade_tick, parse_to_binance_futures_mark_price_update
...
#### `parse_to_binance_futures_mark_price_update(
        self,
        instrument_id: InstrumentId,
        ts_init: int,
    )`
...
```python
from nautilus_trader.adapters.binance.futures.schemas.market import BinanceFuturesAsset
```
