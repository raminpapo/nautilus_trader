# Documentation: `nautilus_trader/adapters/binance/futures/schemas/user.py`
**Generated:** 2025-11-15T19:40:04.113189Z
**File Size:** 28601 bytes
**Extension:** .py
**Type:** text
...
This file is located at `nautilus_trader/adapters/binance/futures/schemas/user.py` within the repository.

**Classes defined:** BinanceFuturesUserMsgData, BinanceFuturesUserMsgWrapper, MarginCallPosition, BinanceFuturesMarginCallMsg, BinanceFuturesBalance, BinanceFuturesPosition, BinanceFuturesAccountUpdateData, BinanceFuturesAccountUpdateMsg, BinanceFuturesAccountUpdateWrapper, BinanceFuturesOrderData and 4 more

**Functions defined:** parse_to_account_balance, parse_to_account_balances, handle_account_update, parse_to_order_status_report, handle_order_trade_update, to_order_data
...
**Inherits from:** msgspec.Struct, kw_only=True, frozen=True
...
#### `handle_account_update(self, exec_client: BinanceCommonExecutionClient)`
...
#### `handle_order_trade_update(  # noqa: C901 (too complex)`
...
**Directory:** `nautilus_trader/adapters/binance/futures/schemas`
