...
- **Path**: `nautilus_trader/adapters/binance/futures/schemas/user.py`
- **Size**: 28,601 bytes
- **Lines**: 696
- **Language**: Python
...
This file is part of the NautilusTrader repository. 14 class(es).

## Detailed Walkthrough


### Classes
- **`BinanceFuturesUserMsgData`**: Class defined in this file
- **`BinanceFuturesUserMsgWrapper`**: Class defined in this file
- **`MarginCallPosition`**: Class defined in this file
- **`BinanceFuturesMarginCallMsg`**: Class defined in this file
- **`BinanceFuturesBalance`**: Class defined in this file
- **`BinanceFuturesPosition`**: Class defined in this file
- **`BinanceFuturesAccountUpdateData`**: Class defined in this file
- **`BinanceFuturesAccountUpdateMsg`**: Class defined in this file
- **`BinanceFuturesAccountUpdateWrapper`**: Class defined in this file
- **`BinanceFuturesOrderData`**: Class defined in this file
- **`BinanceFuturesOrderUpdateMsg`**: Class defined in this file
- **`BinanceFuturesOrderUpdateWrapper`**: Class defined in this file
- **`BinanceFuturesTradeLiteMsg`**: Class defined in this file
- **`BinanceFuturesTradeLiteWrapper`**: Class defined in this file
...
**Classs**: `BinanceFuturesAccountUpdateData`, `BinanceFuturesAccountUpdateMsg`, `BinanceFuturesAccountUpdateWrapper`, `BinanceFuturesBalance`, `BinanceFuturesMarginCallMsg`, `BinanceFuturesOrderData`, `BinanceFuturesOrderUpdateMsg`, `BinanceFuturesOrderUpdateWrapper`, `BinanceFuturesPosition`, `BinanceFuturesTradeLiteMsg`, `BinanceFuturesTradeLiteWrapper`, `BinanceFuturesUserMsgData`, `BinanceFuturesUserMsgWrapper`, `MarginCallPosition`
**Imports**: `decimal`, `msgspec`, `nautilus_trader.adapters.binance.common.enums`, `nautilus_trader.adapters.binance.execution`, `nautilus_trader.adapters.binance.futures.enums`, `nautilus_trader.core.datetime`, `nautilus_trader.core.uuid`, `nautilus_trader.execution.reports`, `nautilus_trader.model.enums`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.objects`

## Related Files

This file is located in `nautilus_trader/adapters/binance/futures/schemas/`. Related files may include:
...
---
*Generated on 2025-11-18T21:55:04.564336Z*
