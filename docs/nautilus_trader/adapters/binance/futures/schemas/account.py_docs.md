# Documentation: `nautilus_trader/adapters/binance/futures/schemas/account.py`
**Generated:** 2025-11-15T19:40:04.107473Z
**File Size:** 9770 bytes
**Extension:** .py
**Type:** text
...
This file is located at `nautilus_trader/adapters/binance/futures/schemas/account.py` within the repository.

**Classes defined:** BinanceFuturesBalanceInfo, BinanceFuturesAccountInfo, BinanceFuturesPositionRisk, BinanceFuturesDualSidePosition, BinanceFuturesFeeRates, BinanceFuturesLeverage, BinanceFuturesSymbolConfig, BinanceFuturesMarginTypeResponse

**Functions defined:** parse_to_account_balance, parse_to_margin_balance, parse_to_account_balances, parse_to_margin_balances, parse_to_position_status_report
...
#### `parse_to_margin_balance(self)`


#### `parse_to_account_balances(self)`


#### `parse_to_margin_balances(self)`
