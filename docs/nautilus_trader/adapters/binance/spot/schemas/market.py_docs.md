...
### Classes
- **`BinanceSpotSymbolInfo`**: Class defined in this file
- **`BinanceSpotExchangeInfo`**: Class defined in this file
- **`BinanceSpotAvgPrice`**: Class defined in this file
- **`BinanceSpotOrderBookPartialDepthData`**: Class defined in this file
- **`BinanceSpotOrderBookPartialDepthMsg`**: Class defined in this file
- **`BinanceSpotTradeData`**: Class defined in this file
- **`BinanceSpotTradeMsg`**: Class defined in this file
...
**Classs**: `BinanceSpotAvgPrice`, `BinanceSpotExchangeInfo`, `BinanceSpotOrderBookPartialDepthData`, `BinanceSpotOrderBookPartialDepthMsg`, `BinanceSpotSymbolInfo`, `BinanceSpotTradeData`, `BinanceSpotTradeMsg`
**Imports**: `msgspec`, `nautilus_trader.adapters.binance.common.enums`, `nautilus_trader.adapters.binance.common.schemas.market`, `nautilus_trader.core.datetime`, `nautilus_trader.model.data`, `nautilus_trader.model.enums`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.objects`
...
---
*Generated on 2025-11-18T21:55:04.608124Z*
