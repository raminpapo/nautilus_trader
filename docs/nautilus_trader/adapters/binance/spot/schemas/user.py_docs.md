# Documentation: `nautilus_trader/adapters/binance/spot/schemas/user.py`
**Generated:** 2025-11-15T19:40:04.157406Z
...
This file is located at `nautilus_trader/adapters/binance/spot/schemas/user.py` within the repository.

**Classes defined:** BinanceSpotUserMsgData, BinanceSpotUserMsgWrapper, BinanceSpotBalance, BinanceSpotAccountUpdateMsg, BinanceSpotAccountUpdateWrapper, BinanceSpotOrderUpdateData, BinanceSpotOrderUpdateWrapper

**Functions defined:** parse_to_account_balance, parse_to_account_balances, handle_account_update, parse_to_order_status_report, handle_execution_report
...
#### `BinanceSpotOrderUpdateData`

**Inherits from:** msgspec.Struct, kw_only=True
...
#### `handle_execution_report(  # noqa: C901 (too complex)`
