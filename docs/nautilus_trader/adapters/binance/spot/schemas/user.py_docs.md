...
- **Path**: `nautilus_trader/adapters/binance/spot/schemas/user.py`
- **Size**: 16,672 bytes
- **Lines**: 401
- **Language**: Python
...
This file is part of the NautilusTrader repository. 7 class(es).

## Detailed Walkthrough


### Classes
- **`BinanceSpotUserMsgData`**: Class defined in this file
- **`BinanceSpotUserMsgWrapper`**: Class defined in this file
- **`BinanceSpotBalance`**: Class defined in this file
- **`BinanceSpotAccountUpdateMsg`**: Class defined in this file
- **`BinanceSpotAccountUpdateWrapper`**: Class defined in this file
- **`BinanceSpotOrderUpdateData`**: Class defined in this file
- **`BinanceSpotOrderUpdateWrapper`**: Class defined in this file
...
**Classs**: `BinanceSpotAccountUpdateMsg`, `BinanceSpotAccountUpdateWrapper`, `BinanceSpotBalance`, `BinanceSpotOrderUpdateData`, `BinanceSpotOrderUpdateWrapper`, `BinanceSpotUserMsgData`, `BinanceSpotUserMsgWrapper`
**Imports**: `decimal`, `msgspec`, `nautilus_trader.adapters.binance.common.enums`, `nautilus_trader.adapters.binance.execution`, `nautilus_trader.adapters.binance.spot.enums`, `nautilus_trader.core.datetime`, `nautilus_trader.core.uuid`, `nautilus_trader.execution.reports`, `nautilus_trader.model.enums`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.objects`
...
---
*Generated on 2025-11-18T21:55:04.610910Z*
