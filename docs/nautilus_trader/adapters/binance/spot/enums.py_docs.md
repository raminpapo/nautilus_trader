# Documentation: `nautilus_trader/adapters/binance/spot/enums.py`
**Generated:** 2025-11-15T19:40:04.136022Z
...
- **Path:** `nautilus_trader/adapters/binance/spot/enums.py`
- **Size:** 5,555 bytes
- **Lines:** 160
- **Extension:** `.py`
- **Type:** text
...
This file is located at `nautilus_trader/adapters/binance/spot/enums.py` within the repository.

**Classes defined:** BinanceSpotPermissions, BinanceSpotSymbolStatus, BinanceSpotEventType, BinanceSpotEnumParser

**Functions defined:** __init__, parse_binance_order_type, parse_internal_order_type
...
#### `BinanceSpotEventType`

**Inherits from:** Enum


#### `BinanceSpotEnumParser`
