# Documentation: `nautilus_trader/adapters/binance/spot/execution.py`
**Generated:** 2025-11-15T19:40:04.137902Z
**File Size:** 11023 bytes
**Extension:** .py
**Type:** text
...
This file is located at `nautilus_trader/adapters/binance/spot/execution.py` within the repository.

**Classes defined:** BinanceSpotExecutionClient

**Functions defined:** __init__, _check_order_validity, _handle_user_ws_message, _handle_account_update, _handle_execution_report, _handle_list_status, _handle_balance_update
...
#### `_handle_execution_report(self, raw: bytes)`


#### `_handle_list_status(self, raw: bytes)`


#### `_handle_balance_update(self, raw: bytes)`
...
**Directory:** `nautilus_trader/adapters/binance/spot`
