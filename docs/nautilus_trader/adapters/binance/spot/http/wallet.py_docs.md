# Documentation: `nautilus_trader/adapters/binance/spot/http/wallet.py`
**Generated:** 2025-11-15T19:40:04.147578Z
...
This file is located at `nautilus_trader/adapters/binance/spot/http/wallet.py` within the repository.

**Classes defined:** BinanceSpotTradeFeeHttp, GetParameters, BinanceSpotWalletHttpAPI
...
```python
from nautilus_trader.adapters.binance.spot.http.wallet import BinanceSpotTradeFeeHttp
```
