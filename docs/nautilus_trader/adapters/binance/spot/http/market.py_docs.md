# Documentation: `nautilus_trader/adapters/binance/spot/http/market.py`
**Generated:** 2025-11-15T19:40:04.144505Z
**File Size:** 6643 bytes
**Extension:** .py
**Type:** text
...
This file is located at `nautilus_trader/adapters/binance/spot/http/market.py` within the repository.

**Classes defined:** BinanceSpotExchangeInfoHttp, GetParameters, BinanceSpotAvgPriceHttp, GetParameters, BinanceSpotMarketHttpAPI

**Functions defined:** __init__, __init__, __init__
...
```python
from nautilus_trader.adapters.binance.spot.http.market import BinanceSpotExchangeInfoHttp
```
