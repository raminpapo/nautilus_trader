# Documentation: `nautilus_trader/adapters/binance/spot/http/account.py`
**Generated:** 2025-11-15T19:40:04.142561Z
**File Size:** 26139 bytes
**Extension:** .py
**Type:** text
...
This file is located at `nautilus_trader/adapters/binance/spot/http/account.py` within the repository.

**Classes defined:** BinanceSpotOpenOrdersHttp, DeleteParameters, BinanceSpotOrderOcoHttp, PostParameters, BinanceSpotOrderListHttp, GetParameters, DeleteParameters, BinanceSpotAllOrderListHttp, GetParameters, BinanceSpotOpenOrderListHttp and 6 more
...
```python
from nautilus_trader.adapters.binance.spot.http.account import BinanceSpotOpenOrdersHttp
```
