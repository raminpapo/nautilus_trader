...
- **Path**: `nautilus_trader/adapters/binance/execution.py`
- **Size**: 58,607 bytes
- **Lines**: 1,364
- **Language**: Python
...
### Functions
- **`_is_post_only_rejection()`**: Function defined in this file

### Classes
- **`BinanceCommonExecutionClient`**: Class defined in this file
...
**Classs**: `BinanceCommonExecutionClient`
**Functions**: `_is_post_only_rejection`
**Imports**: `asyncio`, `collections.abc`, `decimal`, `nautilus_trader.adapters.binance.common.constants`, `nautilus_trader.adapters.binance.common.enums`, `nautilus_trader.adapters.binance.common.schemas.account`, `nautilus_trader.adapters.binance.common.schemas.user`, `nautilus_trader.adapters.binance.common.symbol`, `nautilus_trader.adapters.binance.config`, `nautilus_trader.adapters.binance.http.account`, `nautilus_trader.adapters.binance.http.client`, `nautilus_trader.adapters.binance.http.error`, `nautilus_trader.adapters.binance.http.market`, `nautilus_trader.adapters.binance.http.user`, `nautilus_trader.adapters.binance.websocket.client`, `nautilus_trader.cache.cache`, `nautilus_trader.common.component`, `nautilus_trader.common.enums`, `nautilus_trader.common.providers`, `nautilus_trader.core.correctness`, `nautilus_trader.core.datetime`, `nautilus_trader.core.uuid`, `nautilus_trader.execution.messages`, `nautilus_trader.execution.reports`, `nautilus_trader.live.execution_client`, `nautilus_trader.live.retry`, `nautilus_trader.model.enums`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.objects`, `nautilus_trader.model.orders` *(+2 more)*
...
---
*Generated on 2025-11-18T21:55:04.528338Z*
