# Documentation: `nautilus_trader/adapters/binance/execution.py`
**Generated:** 2025-11-15T19:40:04.081643Z
**File Size:** 58611 bytes
**Extension:** .py
**Type:** text
...
This file is located at `nautilus_trader/adapters/binance/execution.py` within the repository.

**Classes defined:** BinanceCommonExecutionClient

**Functions defined:** __init__, use_position_ids, treat_expired_as_canceled, _stop, _log_retry_error, _get_cache_active_symbols, _check_order_validity, _determine_time_in_force, _determine_good_till_date, _determine_reduce_only and 8 more
...
#### `use_position_ids(self)`


#### `treat_expired_as_canceled(self)`


#### `_stop(self)`


#### `_log_retry_error(self, message: str, exception: BaseException | None)`


#### `_get_cache_active_symbols(self)`


#### `_check_order_validity(self, order: Order)`


#### `_determine_time_in_force(self, order: Order)`


#### `_determine_good_till_date(
        self,
        order: Order,
        time_in_force: BinanceTimeInForce | None,
    )`
...
#### `_determine_reduce_only(self, order: Order)`


#### `_determine_reduce_only_str(self, order: Order)`


#### `_get_position_side_from_position_id(
        self,
        position_id: PositionId | None,
        exec_spawn_id: ClientOrderId | None,
    )`
...
#### `_deny_order_pre_submit(self, order: Order, reason: str)`


#### `_validate_order_pre_submit(self, order: Order)`


#### `_get_cached_instrument_id(self, symbol: str)`


#### `_handle_user_ws_message(self, raw: bytes)`


#### `_is_post_only_rejection(error: BinanceError)`
...
**Directory:** `nautilus_trader/adapters/binance`
