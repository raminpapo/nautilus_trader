...
- **Path**: `nautilus_trader/adapters/binance/http/error.py`
- **Size**: 3,448 bytes
- **Lines**: 103
- **Language**: Python
...
### Functions
- **`get_binance_error_code()`**: Function defined in this file
- **`should_retry()`**: Function defined in this file

### Classes
- **`BinanceError`**: Class defined in this file
- **`BinanceServerError`**: Class defined in this file
- **`BinanceClientError`**: Class defined in this file
...
**Classs**: `BinanceClientError`, `BinanceError`, `BinanceServerError`
**Functions**: `get_binance_error_code`, `should_retry`
**Imports**: `nautilus_trader.adapters.binance.common.constants`, `nautilus_trader.adapters.binance.common.enums`
...
---
*Generated on 2025-11-18T21:55:04.577321Z*
