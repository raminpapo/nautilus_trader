# Documentation: `nautilus_trader/adapters/binance/http/error.py`
**Generated:** 2025-11-15T19:40:04.125451Z
...
This file is located at `nautilus_trader/adapters/binance/http/error.py` within the repository.

**Classes defined:** BinanceError, BinanceServerError, BinanceClientError

**Functions defined:** __init__, __init__, __init__, get_binance_error_code, should_retry
...
#### `__init__(self, status, message, headers)`
...
#### `get_binance_error_code(error: BaseException)`
