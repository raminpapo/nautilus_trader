# Documentation: `nautilus_trader/adapters/binance/http/market.py`
**Generated:** 2025-11-15T19:40:04.128744Z
**File Size:** 32550 bytes
**Extension:** .py
**Type:** text
...
This file is located at `nautilus_trader/adapters/binance/http/market.py` within the repository.

**Classes defined:** BinancePingHttp, BinanceTimeHttp, BinanceDepthHttp, GetParameters, BinanceTradesHttp, GetParameters, BinanceHistoricalTradesHttp, GetParameters, BinanceAggTradesHttp, GetParameters and 9 more

**Functions defined:** __init__, __init__, __init__, __init__, __init__, __init__, __init__, __init__, __init__, __init__ and 2 more
...
#### `_calculate_next_end_time(start_time: int, end_time: int)`
...
```python
from nautilus_trader.adapters.binance.http.market import BinancePingHttp
```
