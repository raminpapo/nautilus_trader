# Documentation: `nautilus_trader/adapters/binance/http/client.py`
**Generated:** 2025-11-15T19:40:04.122644Z
**File Size:** 7765 bytes
**Extension:** .py
**Type:** text
...
- **Path:** `nautilus_trader/adapters/binance/http/client.py`
- **Size:** 7,765 bytes
- **Lines:** 223
- **Extension:** `.py`
- **Type:** text
...
This file is located at `nautilus_trader/adapters/binance/http/client.py` within the repository.

**Classes defined:** BinanceHttpClient

**Functions defined:** __init__, base_url, api_key, headers, _prepare_params, _get_sign
...
#### `_prepare_params(self, params: dict[str, Any])`


#### `_get_sign(self, data: str)`
...
**Security:** This file may contain sensitive patterns: secret, api_key, private_key. Ensure proper handling of secrets.
