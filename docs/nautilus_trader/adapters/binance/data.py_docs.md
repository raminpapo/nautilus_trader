# Documentation: `nautilus_trader/adapters/binance/data.py`
**Generated:** 2025-11-15T19:40:04.076308Z
...
This file is located at `nautilus_trader/adapters/binance/data.py` within the repository.

**Classes defined:** BinanceCommonDataClient

**Functions defined:** __init__, _should_retry, _aggregate_bar_to_trade_ticks, _send_all_instruments_to_data_engine, _get_cached_instrument_id, _handle_ws_message, _handle_book_diff_update, _handle_book_ticker, _handle_ticker, _handle_kline and 3 more

**Import statements:** 77
...
#### `_should_retry(self, error_code: BinanceErrorCode, retries: int)`


#### `_aggregate_bar_to_trade_ticks(
        self,
        instrument: Instrument,
        aggregator: BarAggregator,
        binance_bar: BinanceBar,
...
#### `_handle_book_diff_update(self, raw: bytes)`


#### `_handle_book_ticker(self, raw: bytes)`


#### `_handle_ticker(self, raw: bytes)`


#### `_handle_kline(self, raw: bytes)`


#### `_handle_book_partial_update(self, raw: bytes)`


#### `_handle_trade(self, raw: bytes)`


#### `_handle_agg_trade(self, raw: bytes)`
