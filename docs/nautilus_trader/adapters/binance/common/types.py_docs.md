# Documentation: `nautilus_trader/adapters/binance/common/types.py`
**Generated:** 2025-11-15T19:40:04.069258Z
**File Size:** 15588 bytes
**Extension:** .py
**Type:** text
...
- **Path:** `nautilus_trader/adapters/binance/common/types.py`
- **Size:** 15,588 bytes
- **Lines:** 453
- **Extension:** `.py`
- **Type:** text
...
This file is located at `nautilus_trader/adapters/binance/common/types.py` within the repository.

**Classes defined:** BinanceBar, BinanceTicker

**Functions defined:** __init__, __getstate__, __setstate__, __repr__, from_dict, to_dict, __init__, __eq__, __hash__, __repr__ and 4 more
