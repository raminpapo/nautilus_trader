...
- **Path**: `nautilus_trader/adapters/binance/common/schemas/account.py`
- **Size**: 10,922 bytes
- **Lines**: 262
- **Language**: Python
...
### Classes
- **`BinanceUserTrade`**: Class defined in this file
- **`BinanceOrder`**: Class defined in this file
- **`BinanceStatusCode`**: Class defined in this file
...
**Classs**: `BinanceOrder`, `BinanceStatusCode`, `BinanceUserTrade`
**Imports**: `decimal`, `msgspec`, `nautilus_trader.adapters.binance.common.enums`, `nautilus_trader.core.datetime`, `nautilus_trader.core.uuid`, `nautilus_trader.execution.reports`, `nautilus_trader.model.enums`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.objects`
...
---
*Generated on 2025-11-18T21:55:04.504715Z*
