...
- **Path**: `nautilus_trader/adapters/binance/common/schemas/market.py`
- **Size**: 22,649 bytes
- **Lines**: 746
- **Language**: Python
...
This file is part of the NautilusTrader repository. 24 class(es).

## Detailed Walkthrough


### Classes
- **`BinanceTime`**: Class defined in this file
- **`BinanceExchangeFilter`**: Class defined in this file
- **`BinanceRateLimit`**: Class defined in this file
- **`BinanceSymbolFilter`**: Class defined in this file
- **`BinanceDepth`**: Class defined in this file
- **`BinanceTrade`**: Class defined in this file
- **`BinanceAggTrade`**: Class defined in this file
- **`BinanceKline`**: Class defined in this file
- **`BinanceTicker24hr`**: Class defined in this file
- **`BinanceTickerPrice`**: Class defined in this file
- **`BinanceTickerBook`**: Class defined in this file
- **`BinanceDataMsgWrapper`**: Class defined in this file
- **`BinanceOrderBookDelta`**: Class defined in this file
- **`BinanceOrderBookData`**: Class defined in this file
- **`BinanceOrderBookMsg`**: Class defined in this file
- **`BinanceQuoteData`**: Class defined in this file
- **`BinanceQuoteMsg`**: Class defined in this file
- **`BinanceAggregatedTradeData`**: Class defined in this file
- **`BinanceAggregatedTradeMsg`**: Class defined in this file
- **`BinanceTickerData`**: Class defined in this file
...
**Classs**: `BinanceAggTrade`, `BinanceAggregatedTradeData`, `BinanceAggregatedTradeMsg`, `BinanceCandlestick`, `BinanceCandlestickData`, `BinanceCandlestickMsg`, `BinanceDataMsgWrapper`, `BinanceDepth`, `BinanceExchangeFilter`, `BinanceKline`, `BinanceOrderBookData`, `BinanceOrderBookDelta`, `BinanceOrderBookMsg`, `BinanceQuoteData`, `BinanceQuoteMsg`, `BinanceRateLimit`, `BinanceSymbolFilter`, `BinanceTicker24hr`, `BinanceTickerBook`, `BinanceTickerData`, `BinanceTickerMsg`, `BinanceTickerPrice`, `BinanceTime`, `BinanceTrade`
**Imports**: `decimal`, `msgspec`, `nautilus_trader.adapters.binance.common.enums`, `nautilus_trader.adapters.binance.common.types`, `nautilus_trader.core.datetime`, `nautilus_trader.model.data`, `nautilus_trader.model.enums`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.objects`

## Related Files

This file is located in `nautilus_trader/adapters/binance/common/schemas/`. Related files may include:
...
---
*Generated on 2025-11-18T21:55:04.508040Z*
