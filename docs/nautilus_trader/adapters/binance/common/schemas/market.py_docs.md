# Documentation: `nautilus_trader/adapters/binance/common/schemas/market.py`
**Generated:** 2025-11-15T19:40:04.063317Z
**File Size:** 22649 bytes
**Extension:** .py
**Type:** text
...
This file is located at `nautilus_trader/adapters/binance/common/schemas/market.py` within the repository.

**Classes defined:** BinanceTime, BinanceExchangeFilter, BinanceRateLimit, BinanceSymbolFilter, BinanceDepth, BinanceTrade, BinanceAggTrade, BinanceKline, BinanceTicker24hr, BinanceTickerPrice and 14 more

**Functions defined:** parse_to_order_book_snapshot, parse_to_trade_tick, parse_to_trade_tick, parse_to_binance_bar, parse_to_order_book_delta, parse_to_order_book_deltas, parse_to_quote_tick, parse_to_trade_tick, parse_to_binance_ticker, parse_to_binance_bar
...
**Inherits from:** msgspec.Struct, array_like=True
...
**Directory:** `nautilus_trader/adapters/binance/common/schemas`
