# Documentation: `nautilus_trader/adapters/binance/common/enums.py`
**Generated:** 2025-11-15T19:40:04.057050Z
...
This file is located at `nautilus_trader/adapters/binance/common/enums.py` within the repository.

**Classes defined:** BinanceKeyType, BinanceFuturesPositionSide, BinanceRateLimitType, BinanceRateLimitInterval, BinanceKlineInterval, BinanceExchangeFilterType, BinanceSymbolFilterType, BinanceAccountType, BinanceOrderSide, BinanceExecutionType and 7 more

**Functions defined:** is_spot, is_margin, is_spot_or_margin, is_futures, __init__, parse_binance_order_side, parse_internal_order_side, parse_binance_time_in_force, parse_internal_time_in_force, parse_binance_order_status and 7 more
...
#### `parse_binance_order_side(self, order_side: BinanceOrderSide)`


#### `parse_internal_order_side(self, order_side: OrderSide)`


#### `parse_binance_time_in_force(self, time_in_force: BinanceTimeInForce)`


#### `parse_internal_time_in_force(self, time_in_force: TimeInForce)`


#### `parse_binance_order_status(self, order_status: BinanceOrderStatus)`


#### `parse_binance_order_type(self, order_type: BinanceOrderType)`


#### `parse_internal_order_type(self, order: Order)`


#### `parse_binance_bar_agg(self, bar_agg: str)`


#### `parse_nautilus_bar_aggregation(self, bar_agg: BarAggregation)`


#### `parse_binance_kline_interval_to_bar_spec(
        self,
        kline_interval: BinanceKlineInterval,
    )`


#### `parse_binance_trigger_type(self, trigger_type: str)`


#### `parse_position_id_to_binance_futures_position_side(
        self,
        position_id: PositionId,
    )`
