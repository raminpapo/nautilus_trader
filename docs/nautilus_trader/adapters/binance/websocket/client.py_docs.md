# Documentation: `nautilus_trader/adapters/binance/websocket/client.py`
**Generated:** 2025-11-15T19:40:04.163345Z
**File Size:** 23489 bytes
**Extension:** .py
**Type:** text
...
- **Path:** `nautilus_trader/adapters/binance/websocket/client.py`
- **Size:** 23,489 bytes
- **Lines:** 706
- **Extension:** `.py`
- **Type:** text
...
This file is located at `nautilus_trader/adapters/binance/websocket/client.py` within the repository.

**Classes defined:** BinanceWebSocketClient

**Functions defined:** __init__, url, subscriptions, has_subscriptions, _get_client_for_stream, _get_client_id_for_new_subscription, _handle_ping, _handle_reconnect, _create_subscribe_msg, _create_unsubscribe_msg
...
#### `has_subscriptions(self)`


#### `_get_client_for_stream(self, stream: str)`


#### `_get_client_id_for_new_subscription(self)`


#### `_handle_ping(self, client_id: int, raw: bytes)`


#### `_handle_reconnect(self, client_id: int)`


#### `_create_subscribe_msg(self, streams: list[str])`


#### `_create_unsubscribe_msg(self, streams: list[str])`
...
**Directory:** `nautilus_trader/adapters/binance/websocket`
