...
### Classes
- **`BinanceWebSocketClient`**: Class defined in this file
...
**Classs**: `BinanceWebSocketClient`
**Imports**: `asyncio`, `collections.abc`, `msgspec`, `nautilus_trader.adapters.binance.common.symbol`, `nautilus_trader.common.component`, `nautilus_trader.common.enums`, `nautilus_trader.core.nautilus_pyo3`, `nautilus_trader.live.cancellation`, `typing`, `weakref`

## Related Files

This file is located in `nautilus_trader/adapters/binance/websocket/`. Related files may include:
...
---
*Generated on 2025-11-18T21:55:04.616631Z*
