...
- **Path**: `nautilus_trader/adapters/binance/factories.py`
- **Size**: 15,365 bytes
- **Lines**: 443
- **Language**: Python
...
This file is part of the NautilusTrader repository. It defines 3 function(s) and 2 class(es).

## Detailed Walkthrough

### Functions
- **`get_cached_binance_http_client()`**: Function defined in this file
- **`get_cached_binance_spot_instrument_provider()`**: Function defined in this file
- **`get_cached_binance_futures_instrument_provider()`**: Function defined in this file

### Classes
- **`BinanceLiveDataClientFactory`**: Class defined in this file
- **`BinanceLiveExecClientFactory`**: Class defined in this file
...
**Classs**: `BinanceLiveDataClientFactory`, `BinanceLiveExecClientFactory`
**Functions**: `get_cached_binance_futures_instrument_provider`, `get_cached_binance_http_client`, `get_cached_binance_spot_instrument_provider`
**Imports**: `asyncio`, `functools`, `nautilus_trader.adapters.binance.common.credentials`, `nautilus_trader.adapters.binance.common.enums`, `nautilus_trader.adapters.binance.common.urls`, `nautilus_trader.adapters.binance.config`, `nautilus_trader.adapters.binance.futures.data`, `nautilus_trader.adapters.binance.futures.execution`, `nautilus_trader.adapters.binance.futures.providers`, `nautilus_trader.adapters.binance.http.client`, `nautilus_trader.adapters.binance.spot.data`, `nautilus_trader.adapters.binance.spot.execution`, `nautilus_trader.adapters.binance.spot.providers`, `nautilus_trader.cache.cache`, `nautilus_trader.common.component`, `nautilus_trader.config`, `nautilus_trader.core.nautilus_pyo3`, `nautilus_trader.live.factories`, `nautilus_trader.model.identifiers`
...
---
*Generated on 2025-11-18T21:55:04.531984Z*
