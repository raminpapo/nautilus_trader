# Documentation: `nautilus_trader/adapters/binance/factories.py`
**Generated:** 2025-11-15T19:40:04.084356Z
**File Size:** 15365 bytes
**Extension:** .py
**Type:** text
...
This file is located at `nautilus_trader/adapters/binance/factories.py` within the repository.

**Classes defined:** BinanceLiveDataClientFactory, BinanceLiveExecClientFactory

**Functions defined:** get_cached_binance_http_client, get_cached_binance_spot_instrument_provider, get_cached_binance_futures_instrument_provider, create, create
...
**Security:** This file may contain sensitive patterns: secret, api_key, private_key, credential. Ensure proper handling of secrets.
