# Documentation: `nautilus_trader/adapters/hyperliquid/providers.py`
**Generated:** 2025-11-15T19:40:04.331653Z
**File Size:** 9478 bytes
**Extension:** .py
**Type:** text
...
- **Path:** `nautilus_trader/adapters/hyperliquid/providers.py`
- **Size:** 9,478 bytes
- **Lines:** 249
- **Extension:** `.py`
- **Type:** text
...
This file is located at `nautilus_trader/adapters/hyperliquid/providers.py` within the repository.

**Classes defined:** HyperliquidInstrumentProvider

**Functions defined:** __init__, instruments_pyo3, _reset_caches, _ingest_instruments, _instrument_product_type, _accept_instrument, _normalize
...
#### `_normalize(value: Any, *, to_lower: bool = False)`
