# Documentation: `nautilus_trader/adapters/databento/loaders.py`
**Generated:** 2025-11-15T19:40:04.231309Z
**File Size:** 18404 bytes
**Extension:** .py
**Type:** text
...
- **Path:** `nautilus_trader/adapters/databento/loaders.py`
- **Size:** 18,404 bytes
- **Lines:** 430
- **Extension:** `.py`
- **Type:** text
...
This file is located at `nautilus_trader/adapters/databento/loaders.py` within the repository.

**Classes defined:** DatabentoDataLoader

**Functions defined:** __init__, load_publishers, get_publishers, get_dataset_for_venue, from_dbn_file
...
#### `load_publishers(self, path: PathLike[str] | str)`
...
#### `from_dbn_file(  # noqa: C901 (too complex)`
