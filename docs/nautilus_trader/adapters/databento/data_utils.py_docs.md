# Documentation: data_utils.py

## File Metadata

- **Path**: `nautilus_trader/adapters/databento/data_utils.py`
- **Size**: 10,930 bytes
- **Lines**: 352
- **Language**: Python
...
### Functions
- **`init_databento_client()`**: Function defined in this file
- **`data_path()`**: Function defined in this file
- **`create_data_folder()`**: Function defined in this file
- **`databento_definition_dates()`**: Function defined in this file
- **`databento_cost()`**: Function defined in this file
- **`databento_data()`**: Function defined in this file
- **`save_data_to_catalog()`**: Function defined in this file
- **`load_catalog()`**: Function defined in this file
- **`query_catalog()`**: Function defined in this file
- **`load_databento_data()`**: Function defined in this file
- **`save_databento_data()`**: Function defined in this file
- **`next_day()`**: Function defined in this file
...
**Functions**: `create_data_folder`, `data_path`, `databento_cost`, `databento_data`, `databento_definition_dates`, `init_databento_client`, `load_catalog`, `load_databento_data`, `next_day`, `query_catalog`, `save_data_to_catalog`, `save_databento_data`
**Imports**: `datetime`, `nautilus_trader`, `nautilus_trader.adapters.databento.loaders`, `nautilus_trader.persistence.catalog`
...
---
*Generated on 2025-11-18T21:55:04.689968Z*
