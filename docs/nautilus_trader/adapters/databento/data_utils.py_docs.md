# Documentation: `nautilus_trader/adapters/databento/data_utils.py`
**Generated:** 2025-11-15T19:40:04.225998Z
**File Size:** 10930 bytes
**Extension:** .py
**Type:** text
...
This file is located at `nautilus_trader/adapters/databento/data_utils.py` within the repository.

**Functions defined:** init_databento_client, data_path, create_data_folder, databento_definition_dates, databento_cost, databento_data, save_data_to_catalog, load_catalog, query_catalog, load_databento_data and 2 more
...
#### `databento_cost(symbols, start_time, end_time, schema, dataset="GLBX.MDP3", **kwargs)`
