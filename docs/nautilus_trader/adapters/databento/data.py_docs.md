# Documentation: `nautilus_trader/adapters/databento/data.py`
**Generated:** 2025-11-15T19:40:04.223293Z
**File Size:** 50923 bytes
**Extension:** .py
**Type:** text
...
This file is located at `nautilus_trader/adapters/databento/data.py` within the repository.

**Classes defined:** DatabentoDataClient

**Functions defined:** __init__, _log_future_exception_callback, _get_live_client, _get_live_client_mbo, _send_all_instruments_to_data_engine, subscribe_order_book_deltas, _handle_msg_pyo3, _handle_msg
...
#### `_log_future_exception_callback(self, future: asyncio.Future)`


#### `_get_live_client(self, dataset: Dataset)`


#### `_get_live_client_mbo(self, dataset: Dataset)`
