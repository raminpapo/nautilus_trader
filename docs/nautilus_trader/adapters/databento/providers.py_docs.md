# Documentation: `nautilus_trader/adapters/databento/providers.py`
**Generated:** 2025-11-15T19:40:04.233299Z
**File Size:** 11352 bytes
**Extension:** .py
**Type:** text
...
This file is located at `nautilus_trader/adapters/databento/providers.py` within the repository.

**Classes defined:** DatabentoInstrumentProvider

**Functions defined:** __init__, receive_instruments, _check_all_datasets_equal
...
#### `receive_instruments(pyo3_instrument: Any)`


#### `_check_all_datasets_equal(self, instrument_ids: list[InstrumentId])`
