# Documentation: `nautilus_trader/adapters/polymarket/providers.py`
**Generated:** 2025-11-15T19:40:04.472475Z
...
This file is located at `nautilus_trader/adapters/polymarket/providers.py` within the repository.

**Classes defined:** PolymarketInstrumentProvider

**Functions defined:** _check_clob_response, __init__, _load_instrument
...
#### `_check_clob_response(response: dict[str, Any] | str)`
