...
- **Path**: `nautilus_trader/adapters/polymarket/config.py`
- **Size**: 7,650 bytes
- **Lines**: 157
- **Language**: Python
...
### Classes
- **`PolymarketDataClientConfig`**: Class defined in this file
- **`PolymarketExecClientConfig`**: Class defined in this file
...
**Classs**: `PolymarketDataClientConfig`, `PolymarketExecClientConfig`
**Imports**: `nautilus_trader.adapters.polymarket.common.constants`, `nautilus_trader.config`, `nautilus_trader.model.identifiers`
...
---
*Generated on 2025-11-18T21:55:04.942482Z*
