# Documentation: `nautilus_trader/adapters/polymarket/data.py`
**Generated:** 2025-11-15T19:40:04.454835Z
...
This file is located at `nautilus_trader/adapters/polymarket/data.py` within the repository.

**Classes defined:** PolymarketDataClient

**Functions defined:** __init__, _create_websocket_client, _create_local_book, _cleanup_expired_books, _send_all_instruments_to_data_engine, _handle_raw_ws_message, _handle_ws_message, _handle_book_snapshot, _handle_deltas, _handle_quotes and 5 more
...
#### `_create_local_book(self, instrument_id: InstrumentId)`


#### `_cleanup_expired_books(self)`


#### `_send_all_instruments_to_data_engine(self)`


#### `_handle_raw_ws_message(self, raw: bytes)`


#### `_handle_ws_message(self, msg: Any)`


#### `_handle_book_snapshot(
        self,
        instrument: BinaryOption,
        ws_message: PolymarketBookSnapshot,
    )`
...
#### `_handle_deltas(self, instrument: BinaryOption, deltas: OrderBookDeltas)`
...
#### `_reset_local_book_after_tick_size_change(
        self,
        instrument: BinaryOption,
        change: PolymarketTickSizeChange,
        old_book: OrderBook,
