# Documentation: gamma_markets.py
...
### Functions
- **`_normalize_base_url()`**: Function defined in this file
- **`build_markets_query()`**: Function defined in this file
- **`normalize_gamma_market_to_clob_format()`**: Function defined in this file
...
**Functions**: `_normalize_base_url`, `build_markets_query`, `normalize_gamma_market_to_clob_format`
**Imports**: `__future__`, `collections.abc`, `math`, `msgspec`, `nautilus_trader.core.nautilus_pyo3`, `os`, `typing`
...
---
*Generated on 2025-11-18T21:55:04.936095Z*
