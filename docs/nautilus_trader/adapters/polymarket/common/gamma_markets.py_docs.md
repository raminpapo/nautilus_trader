# Documentation: `nautilus_trader/adapters/polymarket/common/gamma_markets.py`
**Generated:** 2025-11-15T19:40:04.445691Z
**File Size:** 9422 bytes
**Extension:** .py
**Type:** text
...
- **Path:** `nautilus_trader/adapters/polymarket/common/gamma_markets.py`
- **Size:** 9,422 bytes
- **Lines:** 284
- **Extension:** `.py`
- **Type:** text
...
This file is located at `nautilus_trader/adapters/polymarket/common/gamma_markets.py` within the repository.

**Functions defined:** _normalize_base_url, build_markets_query, normalize_gamma_market_to_clob_format
...
#### `_normalize_base_url(base_url: str | None)`


#### `build_markets_query(filters: dict[str, Any] | None = None)`


#### `normalize_gamma_market_to_clob_format(gamma_market: dict[str, Any])`
...
```python
from nautilus_trader.adapters.polymarket.common.gamma_markets import _normalize_base_url
```
