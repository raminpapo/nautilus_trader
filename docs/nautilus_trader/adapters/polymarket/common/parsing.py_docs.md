...
### Functions
- **`validate_ethereum_address()`**: Function defined in this file
- **`parse_order_side()`**: Function defined in this file
- **`parse_liquidity_side()`**: Function defined in this file
- **`parse_time_in_force()`**: Function defined in this file
- **`parse_order_status()`**: Function defined in this file
- **`parse_polymarket_instrument()`**: Function defined in this file
- **`update_instrument()`**: Function defined in this file
...
**Functions**: `parse_liquidity_side`, `parse_order_side`, `parse_order_status`, `parse_polymarket_instrument`, `parse_time_in_force`, `update_instrument`, `validate_ethereum_address`
**Imports**: `decimal`, `nautilus_trader.adapters.polymarket.common.enums`, `nautilus_trader.adapters.polymarket.common.symbol`, `nautilus_trader.adapters.polymarket.schemas.book`, `nautilus_trader.model.currencies`, `nautilus_trader.model.enums`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.instruments`, `nautilus_trader.model.objects`, `pandas`, `time`, `typing`
...
---
*Generated on 2025-11-18T21:55:04.938081Z*
