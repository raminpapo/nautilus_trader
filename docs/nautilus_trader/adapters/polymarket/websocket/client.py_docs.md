# Documentation: `nautilus_trader/adapters/polymarket/websocket/client.py`
**Generated:** 2025-11-15T19:40:04.490624Z
**File Size:** 8355 bytes
**Extension:** .py
**Type:** text
...
- **Path:** `nautilus_trader/adapters/polymarket/websocket/client.py`
- **Size:** 8,355 bytes
- **Lines:** 262
- **Extension:** `.py`
- **Type:** text
...
This file is located at `nautilus_trader/adapters/polymarket/websocket/client.py` within the repository.

**Classes defined:** PolymarketWebSocketChannel, PolymarketWebSocketClient

**Functions defined:** __init__, url, is_connected, is_disconnected, market_subscriptions, asset_subscriptions, reconnect, subscribe_market, subscribe_book, _subscribe_asset and 2 more
...
#### `market_subscriptions(self)`


#### `asset_subscriptions(self)`


#### `reconnect(self)`


#### `subscribe_market(self, condition_id: str)`


#### `subscribe_book(self, asset: str)`


#### `_subscribe_asset(self, asset: str)`


#### `_create_subscribe_market_channel_msg(self, assets: list[str])`


#### `_create_subscribe_user_channel_msg(self, markets: list[str])`
