...
### Classes
- **`PolymarketWebSocketChannel`**: Class defined in this file
- **`PolymarketWebSocketClient`**: Class defined in this file
...
**Classs**: `PolymarketWebSocketChannel`, `PolymarketWebSocketClient`
**Imports**: `asyncio`, `collections.abc`, `enum`, `msgspec`, `nautilus_trader.adapters.polymarket.common.credentials`, `nautilus_trader.common.component`, `nautilus_trader.common.enums`, `nautilus_trader.core.nautilus_pyo3`, `nautilus_trader.live.cancellation`, `typing`, `weakref`

## Related Files

This file is located in `nautilus_trader/adapters/polymarket/websocket/`. Related files may include:
...
---
*Generated on 2025-11-18T21:55:04.986613Z*
