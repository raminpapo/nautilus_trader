# Documentation: `nautilus_trader/adapters/polymarket/factories.py`
**Generated:** 2025-11-15T19:40:04.464149Z
**File Size:** 8763 bytes
**Extension:** .py
**Type:** text
...
This file is located at `nautilus_trader/adapters/polymarket/factories.py` within the repository.

**Classes defined:** PolymarketLiveDataClientFactory, PolymarketLiveExecClientFactory

**Functions defined:** get_polymarket_http_client, get_polymarket_instrument_provider, create, create
...
**Security:** This file may contain sensitive patterns: secret, api_key, private_key, credential, auth. Ensure proper handling of secrets.
