...
- **Path**: `nautilus_trader/adapters/polymarket/factories.py`
- **Size**: 8,763 bytes
- **Lines**: 261
- **Language**: Python
...
### Functions
- **`get_polymarket_http_client()`**: Function defined in this file
- **`get_polymarket_instrument_provider()`**: Function defined in this file

### Classes
- **`PolymarketLiveDataClientFactory`**: Class defined in this file
- **`PolymarketLiveExecClientFactory`**: Class defined in this file
...
**Classs**: `PolymarketLiveDataClientFactory`, `PolymarketLiveExecClientFactory`
**Functions**: `get_polymarket_http_client`, `get_polymarket_instrument_provider`
**Imports**: `asyncio`, `functools`, `nautilus_trader.adapters.polymarket.common.credentials`, `nautilus_trader.adapters.polymarket.config`, `nautilus_trader.adapters.polymarket.data`, `nautilus_trader.adapters.polymarket.execution`, `nautilus_trader.adapters.polymarket.providers`, `nautilus_trader.cache.cache`, `nautilus_trader.common.component`, `nautilus_trader.common.config`, `nautilus_trader.live.factories`, `py_clob_client.client`, `py_clob_client.constants`
...
---
*Generated on 2025-11-18T21:55:04.958064Z*
