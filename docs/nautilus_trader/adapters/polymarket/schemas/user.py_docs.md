...
- **Path**: `nautilus_trader/adapters/polymarket/schemas/user.py`
- **Size**: 12,760 bytes
- **Lines**: 330
- **Language**: Python
...
### Classes
- **`PolymarketUserOrder`**: Class defined in this file
- **`PolymarketUserTrade`**: Class defined in this file
- **`PolymarketOpenOrder`**: Class defined in this file
...
**Classs**: `PolymarketOpenOrder`, `PolymarketUserOrder`, `PolymarketUserTrade`
**Imports**: `decimal`, `msgspec`, `nautilus_trader.adapters.polymarket.common.enums`, `nautilus_trader.adapters.polymarket.common.parsing`, `nautilus_trader.adapters.polymarket.schemas.order`, `nautilus_trader.core.datetime`, `nautilus_trader.core.stats`, `nautilus_trader.core.uuid`, `nautilus_trader.execution.reports`, `nautilus_trader.model.currencies`, `nautilus_trader.model.enums`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.instruments`, `nautilus_trader.model.objects`, `pandas`, `typing`
...
---
*Generated on 2025-11-18T21:55:04.975503Z*
