# Documentation: `nautilus_trader/adapters/polymarket/schemas/user.py`
**Generated:** 2025-11-15T19:40:04.480774Z
...
This file is located at `nautilus_trader/adapters/polymarket/schemas/user.py` within the repository.

**Classes defined:** PolymarketUserOrder, PolymarketUserTrade, PolymarketOpenOrder

**Functions defined:** venue_order_id, parse_to_order_status_report, parse_to_fill_report, to_dict, get_filled_user_order_ids, get_maker_order, get_asset_id, liquidity_side, order_side, venue_order_id and 6 more
...
**Inherits from:** msgspec.Struct, tag="order", tag_field="event_type", frozen=True


#### `PolymarketUserTrade`

**Inherits from:** msgspec.Struct, tag="trade", tag_field="event_type", frozen=True
...
#### `get_asset_id(self, filled_user_order_id: str)`
