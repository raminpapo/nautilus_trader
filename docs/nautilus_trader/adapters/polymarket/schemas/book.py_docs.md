# Documentation: `nautilus_trader/adapters/polymarket/schemas/book.py`
**Generated:** 2025-11-15T19:40:04.475583Z
**File Size:** 9958 bytes
**Extension:** .py
**Type:** text
...
This file is located at `nautilus_trader/adapters/polymarket/schemas/book.py` within the repository.

**Classes defined:** PolymarketBookLevel, PolymarketBookSnapshot, PolymarketQuote, PolymarketQuotes, PolymarketTrade, PolymarketTickSizeChange

**Functions defined:** parse_to_snapshot, parse_to_quote, parse_to_deltas, parse_to_quote_ticks, parse_to_trade_tick
...
**Inherits from:** msgspec.Struct, tag="book", tag_field="event_type", frozen=True
...
**Inherits from:** msgspec.Struct, tag="price_change", tag_field="event_type", frozen=True


#### `PolymarketTrade`

**Inherits from:** msgspec.Struct, tag="last_trade_price", tag_field="event_type", frozen=True
