# Documentation: book.py

## File Metadata

- **Path**: `nautilus_trader/adapters/polymarket/schemas/book.py`
- **Size**: 9,958 bytes
- **Lines**: 285
- **Language**: Python
...
### Classes
- **`PolymarketBookLevel`**: Class defined in this file
- **`PolymarketBookSnapshot`**: Class defined in this file
- **`PolymarketQuote`**: Class defined in this file
- **`PolymarketQuotes`**: Class defined in this file
- **`PolymarketTrade`**: Class defined in this file
- **`PolymarketTickSizeChange`**: Class defined in this file
...
**Classs**: `PolymarketBookLevel`, `PolymarketBookSnapshot`, `PolymarketQuote`, `PolymarketQuotes`, `PolymarketTickSizeChange`, `PolymarketTrade`
**Imports**: `msgspec`, `nautilus_trader.adapters.polymarket.common.constants`, `nautilus_trader.adapters.polymarket.common.enums`, `nautilus_trader.core.datetime`, `nautilus_trader.model.data`, `nautilus_trader.model.enums`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.instruments`, `uuid`

## Related Files

This file is located in `nautilus_trader/adapters/polymarket/schemas/`. Related files may include:
...
---
*Generated on 2025-11-18T21:55:04.970259Z*
