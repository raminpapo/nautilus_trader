# Documentation: `nautilus_trader/adapters/polymarket/scripts/set_allowances.py`
**Generated:** 2025-11-15T19:40:04.487750Z
...
- **Path:** `nautilus_trader/adapters/polymarket/scripts/set_allowances.py`
- **Size:** 6,287 bytes
- **Lines:** 155
- **Extension:** `.py`
- **Type:** text
...
This file is located at `nautilus_trader/adapters/polymarket/scripts/set_allowances.py` within the repository.
...
```python
import nautilus_trader.adapters.polymarket.scripts.set_allowances
```
...
**Security:** This file may contain sensitive patterns: token, private_key. Ensure proper handling of secrets.
