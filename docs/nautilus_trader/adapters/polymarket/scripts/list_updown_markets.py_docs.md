# Documentation: `nautilus_trader/adapters/polymarket/scripts/list_updown_markets.py`
**Generated:** 2025-11-15T19:40:04.486098Z
...
- **Path:** `nautilus_trader/adapters/polymarket/scripts/list_updown_markets.py`
- **Size:** 6,289 bytes
- **Lines:** 195
- **Extension:** `.py`
- **Type:** text
...
This file is located at `nautilus_trader/adapters/polymarket/scripts/list_updown_markets.py` within the repository.

**Functions defined:** filter_updown_markets, print_market_info, _print_no_updown_found, _print_updown_results
...
#### `filter_updown_markets(markets: list[dict], asset: str | None = None)`


#### `print_market_info(market: dict)`


#### `_print_no_updown_found(markets: list[dict])`


#### `_print_updown_results(btc_markets: list[dict], eth_markets: list[dict], other_updown: list[dict])`
...
```python
from nautilus_trader.adapters.polymarket.scripts.list_updown_markets import filter_updown_markets
```
