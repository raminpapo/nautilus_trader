# Documentation: execution.py

## File Metadata

- **Path**: `nautilus_trader/adapters/polymarket/execution.py`
- **Size**: 62,071 bytes
- **Lines**: 1,492
- **Language**: Python
...
### Classes
- **`PolymarketExecutionClient`**: Class defined in this file
...
**Classs**: `PolymarketExecutionClient`
**Imports**: `asyncio`, `collections`, `collections.abc`, `json`, `msgspec`, `nautilus_trader.adapters.polymarket.common.cache`, `nautilus_trader.adapters.polymarket.common.constants`, `nautilus_trader.adapters.polymarket.common.conversion`, `nautilus_trader.adapters.polymarket.common.credentials`, `nautilus_trader.adapters.polymarket.common.enums`, `nautilus_trader.adapters.polymarket.common.parsing`, `nautilus_trader.adapters.polymarket.common.symbol`, `nautilus_trader.adapters.polymarket.common.types`, `nautilus_trader.adapters.polymarket.config`, `nautilus_trader.adapters.polymarket.http.conversion`, `nautilus_trader.adapters.polymarket.http.errors`, `nautilus_trader.adapters.polymarket.providers`, `nautilus_trader.adapters.polymarket.schemas.trade`, `nautilus_trader.adapters.polymarket.schemas.user`, `nautilus_trader.adapters.polymarket.websocket.client`, `nautilus_trader.adapters.polymarket.websocket.types`, `nautilus_trader.cache.cache`, `nautilus_trader.common.component`, `nautilus_trader.common.enums`, `nautilus_trader.core.datetime`, `nautilus_trader.core.nautilus_pyo3`, `nautilus_trader.core.stats`, `nautilus_trader.core.uuid`, `nautilus_trader.execution.messages`, `nautilus_trader.execution.reports` *(+11 more)*

## Related Files

This file is located in `nautilus_trader/adapters/polymarket/`. Related files may include:
...
---
*Generated on 2025-11-18T21:55:04.955246Z*
