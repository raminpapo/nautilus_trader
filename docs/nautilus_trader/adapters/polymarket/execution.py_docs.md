# Documentation: `nautilus_trader/adapters/polymarket/execution.py`
**Generated:** 2025-11-15T19:40:04.461281Z
**File Size:** 59714 bytes
**Extension:** .py
**Type:** text
...
This file is located at `nautilus_trader/adapters/polymarket/execution.py` within the repository.

**Classes defined:** PolymarketExecutionClient

**Functions defined:** __init__, _stop, _create_websocket_client, _parse_trades_response_object, _get_neg_risk_for_instrument, _deny_market_order_quantity, _handle_ws_message, _add_trade_to_cache, _handle_ws_order_msg, _handle_ws_trade_msg and 1 more
...
#### `_get_neg_risk_for_instrument(self, instrument)`
...
#### `_add_trade_to_cache(self, msg: PolymarketUserTrade, raw: bytes)`


#### `_handle_ws_order_msg(self, msg: PolymarketUserOrder, wait_for_ack: bool)`


#### `_handle_ws_trade_msg(self, msg: PolymarketUserTrade, wait_for_ack: bool)`
