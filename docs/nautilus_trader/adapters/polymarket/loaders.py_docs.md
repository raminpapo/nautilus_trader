...
- **Path**: `nautilus_trader/adapters/polymarket/loaders.py`
- **Size**: 19,553 bytes
- **Lines**: 637
- **Language**: Python
...
### Classes
- **`PolymarketDataLoader`**: Class defined in this file
...
**Classs**: `PolymarketDataLoader`
**Imports**: `__future__`, `msgspec`, `nautilus_trader.adapters.polymarket.common.parsing`, `nautilus_trader.core`, `nautilus_trader.core.datetime`, `nautilus_trader.model.data`, `nautilus_trader.model.enums`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.instruments`, `pandas`, `typing`
...
---
*Generated on 2025-11-18T21:55:04.964808Z*
