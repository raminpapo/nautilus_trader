# Documentation: `nautilus_trader/adapters/betfair/data.py`
**Generated:** 2025-11-15T19:40:04.024756Z
...
This file is located at `nautilus_trader/adapters/betfair/data.py` within the repository.

**Classes defined:** BetfairDataClient

**Functions defined:** __init__, instrument_provider, _reset, _dispose, on_market_update, _on_market_update, _on_instrument, _check_stream_unhealthy, _handle_status_message
...
#### `on_market_update(self, raw: bytes)`


#### `_on_market_update(self, mcm: MCM)`


#### `_on_instrument(self, instrument: BettingInstrument)`


#### `_check_stream_unhealthy(self, update: MCM)`
