...
- **Path**: `nautilus_trader/adapters/betfair/data.py`
- **Size**: 14,740 bytes
- **Lines**: 338
- **Language**: Python
...
### Classes
- **`BetfairDataClient`**: Class defined in this file
...
**Classs**: `BetfairDataClient`
**Imports**: `asyncio`, `betfair_parser.exceptions`, `betfair_parser.spec.streaming`, `nautilus_trader.adapters.betfair.client`, `nautilus_trader.adapters.betfair.config`, `nautilus_trader.adapters.betfair.constants`, `nautilus_trader.adapters.betfair.data_types`, `nautilus_trader.adapters.betfair.parsing.common`, `nautilus_trader.adapters.betfair.parsing.core`, `nautilus_trader.adapters.betfair.providers`, `nautilus_trader.adapters.betfair.sockets`, `nautilus_trader.cache.cache`, `nautilus_trader.common.component`, `nautilus_trader.common.enums`, `nautilus_trader.data.messages`, `nautilus_trader.live.data_client`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.instruments.betting`
...
---
*Generated on 2025-11-18T21:55:04.463873Z*
