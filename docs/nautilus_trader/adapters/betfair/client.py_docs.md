...
- **Path**: `nautilus_trader/adapters/betfair/client.py`
- **Size**: 13,327 bytes
- **Lines**: 322
- **Language**: Python
...
### Classes
- **`BetfairHttpClient`**: Class defined in this file
...
**Classs**: `BetfairHttpClient`
**Imports**: `asyncio`, `betfair_parser.endpoints`, `betfair_parser.spec.accounts.operations`, `betfair_parser.spec.accounts.type_definitions`, `betfair_parser.spec.betting.enums`, `betfair_parser.spec.betting.listings`, `betfair_parser.spec.betting.orders`, `betfair_parser.spec.betting.type_definitions`, `betfair_parser.spec.common`, `betfair_parser.spec.identity`, `betfair_parser.spec.navigation`, `nautilus_trader`, `nautilus_trader.common.component`, `nautilus_trader.common.secure`, `nautilus_trader.core.nautilus_pyo3`, `nautilus_trader.core.rust.common`
...
---
*Generated on 2025-11-18T21:55:04.457169Z*
