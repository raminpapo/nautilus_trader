...
### Functions
- **`_to_utc_datetime()`**: Function defined in this file

### Classes
- **`BetfairExecutionClient`**: Class defined in this file
...
**Classs**: `BetfairExecutionClient`
**Functions**: `_to_utc_datetime`
**Imports**: `asyncio`, `betfair_parser.exceptions`, `betfair_parser.spec.accounts.type_definitions`, `betfair_parser.spec.betting.enums`, `betfair_parser.spec.betting.orders`, `betfair_parser.spec.betting.type_definitions`, `betfair_parser.spec.common`, `betfair_parser.spec.streaming`, `collections`, `datetime`, `nautilus_trader.accounting.factory`, `nautilus_trader.adapters.betfair.client`, `nautilus_trader.adapters.betfair.common`, `nautilus_trader.adapters.betfair.config`, `nautilus_trader.adapters.betfair.constants`, `nautilus_trader.adapters.betfair.orderbook`, `nautilus_trader.adapters.betfair.parsing.common`, `nautilus_trader.adapters.betfair.parsing.requests`, `nautilus_trader.adapters.betfair.providers`, `nautilus_trader.adapters.betfair.sockets`, `nautilus_trader.cache.cache`, `nautilus_trader.common.component`, `nautilus_trader.common.enums`, `nautilus_trader.core.correctness`, `nautilus_trader.core.datetime`, `nautilus_trader.core.uuid`, `nautilus_trader.execution.messages`, `nautilus_trader.execution.reports`, `nautilus_trader.live.execution_client`, `nautilus_trader.model.enums` *(+6 more)*
...
---
*Generated on 2025-11-18T21:55:04.472899Z*
