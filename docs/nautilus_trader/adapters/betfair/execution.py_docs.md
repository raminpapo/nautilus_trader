# Documentation: `nautilus_trader/adapters/betfair/execution.py`
**Generated:** 2025-11-15T19:40:04.031611Z
**File Size:** 55481 bytes
**Extension:** .py
**Type:** text
...
- **Path:** `nautilus_trader/adapters/betfair/execution.py`
- **Size:** 55,481 bytes
- **Lines:** 1,256
- **Extension:** `.py`
- **Type:** text
...
This file is located at `nautilus_trader/adapters/betfair/execution.py` within the repository.

**Classes defined:** BetfairExecutionClient

**Functions defined:** __init__, instrument_provider, _market_ids_filter, client, handle_order_stream_update, check_cache_against_order_image, _handle_stream_executable_order_update, _handle_stream_execution_complete_order_update, _handle_status_message, _determine_fill_price and 5 more

**Import statements:** 81
...
#### `_market_ids_filter(self)`


#### `client(self)`


#### `handle_order_stream_update(self, raw: bytes)`


#### `check_cache_against_order_image(self, order_change_message: OCM)`


#### `_handle_stream_executable_order_update(self, unmatched_order: UnmatchedOrder)`


#### `_handle_stream_execution_complete_order_update(  # noqa: C901 (too complex)`


#### `_handle_status_message(self, update: Status)`


#### `_determine_fill_price(self, unmatched_order: UnmatchedOrder, order: Order)`


#### `_determine_fill_qty(self, unmatched_order: UnmatchedOrder, order: Order)`


#### `_get_matched_timestamp(self, unmatched_order: UnmatchedOrder)`


#### `_get_canceled_timestamp(self, unmatched_order: UnmatchedOrder)`


#### `_get_cancel_quantity(self, unmatched_order: UnmatchedOrder)`


#### `_to_utc_datetime(timestamp: datetime | pd.Timestamp | None)`
