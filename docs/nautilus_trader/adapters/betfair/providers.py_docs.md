# Documentation: `nautilus_trader/adapters/betfair/providers.py`
**Generated:** 2025-11-15T19:40:04.047217Z
...
This file is located at `nautilus_trader/adapters/betfair/providers.py` within the repository.

**Classes defined:** BetfairInstrumentProviderConfig, BetfairInstrumentProvider

**Functions defined:** __init__, market_catalog_to_instruments, market_definition_to_instruments, make_instruments, check_market_filter_keys, parse_market_catalog, get_market_book
...
**Inherits from:** InstrumentProviderConfig, frozen=True, kw_only=True
...
#### `check_market_filter_keys(keys: Iterable[str])`


#### `parse_market_catalog(catalog: list[dict])`
