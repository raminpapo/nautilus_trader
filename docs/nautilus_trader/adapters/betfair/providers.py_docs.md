...
- **Path**: `nautilus_trader/adapters/betfair/providers.py`
- **Size**: 15,864 bytes
- **Lines**: 403
- **Language**: Python
...
This file is part of the NautilusTrader repository. It defines 6 function(s) and 2 class(es).

## Detailed Walkthrough

### Functions
- **`market_catalog_to_instruments()`**: Function defined in this file
- **`market_definition_to_instruments()`**: Function defined in this file
- **`make_instruments()`**: Function defined in this file
- **`check_market_filter_keys()`**: Function defined in this file
- **`parse_market_catalog()`**: Function defined in this file
- **`get_market_book()`**: Function defined in this file

### Classes
- **`BetfairInstrumentProviderConfig`**: Class defined in this file
- **`BetfairInstrumentProvider`**: Class defined in this file
...
**Classs**: `BetfairInstrumentProvider`, `BetfairInstrumentProviderConfig`
**Functions**: `check_market_filter_keys`, `get_market_book`, `make_instruments`, `market_catalog_to_instruments`, `market_definition_to_instruments`, `parse_market_catalog`
**Imports**: `betfair_parser.spec.betting.enums`, `betfair_parser.spec.betting.type_definitions`, `betfair_parser.spec.common`, `betfair_parser.spec.navigation`, `betfair_parser.spec.streaming`, `collections.abc`, `msgspec`, `nautilus_trader.adapters.betfair.client`, `nautilus_trader.adapters.betfair.common`, `nautilus_trader.adapters.betfair.constants`, `nautilus_trader.adapters.betfair.parsing.common`, `nautilus_trader.common.config`, `nautilus_trader.common.enums`, `nautilus_trader.common.providers`, `nautilus_trader.config`, `nautilus_trader.core.correctness`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.instruments`, `nautilus_trader.model.instruments.betting`, `nautilus_trader.model.objects`, `pandas`
...
---
*Generated on 2025-11-18T21:55:04.490553Z*
