# Documentation: `nautilus_trader/adapters/betfair/__init__.py`
**Generated:** 2025-11-15T19:40:04.016415Z
...
This file is located at `nautilus_trader/adapters/betfair/__init__.py` within the repository.
...
```python
import nautilus_trader.adapters.betfair.__init__
```
