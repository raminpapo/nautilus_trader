# Documentation: `nautilus_trader/adapters/betfair/common.py`
**Generated:** 2025-11-15T19:40:04.020011Z
**File Size:** 4271 bytes
**Extension:** .py
**Type:** text
...
This file is located at `nautilus_trader/adapters/betfair/common.py` within the repository.

**Classes defined:** OrderSideParser

**Functions defined:** to_nautilus, to_betfair
...
#### `to_nautilus(cls, side: Side | str)`


#### `to_betfair(order_side: OrderSide)`
