# Documentation: `nautilus_trader/adapters/betfair/data_types.py`
**Generated:** 2025-11-15T19:40:04.026821Z
...
This file is located at `nautilus_trader/adapters/betfair/data_types.py` within the repository.

**Classes defined:** SubscriptionStatus, BSPOrderBookDelta, BetfairTicker, BetfairStartingPrice, BetfairSequenceCompleted

**Functions defined:** from_batch, to_batch, schema, __init__, __eq__, __hash__, ts_event, ts_init, schema, from_dict and 8 more
...
#### `from_batch(batch: pa.RecordBatch)`


#### `to_batch(obj: BSPOrderBookDelta)`
...
#### `from_dict(cls, values: dict)`


#### `to_dict(obj: BetfairTicker)`
