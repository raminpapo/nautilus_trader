# Documentation: data_types.py

## File Metadata

- **Path**: `nautilus_trader/adapters/betfair/data_types.py`
- **Size**: 11,945 bytes
- **Lines**: 378
- **Language**: Python
...
### Classes
- **`SubscriptionStatus`**: Class defined in this file
- **`BSPOrderBookDelta`**: Class defined in this file
- **`BetfairTicker`**: Class defined in this file
- **`BetfairStartingPrice`**: Class defined in this file
- **`BetfairSequenceCompleted`**: Class defined in this file
...
**Classs**: `BSPOrderBookDelta`, `BetfairSequenceCompleted`, `BetfairStartingPrice`, `BetfairTicker`, `SubscriptionStatus`
**Imports**: `__future__`, `enum`, `nautilus_trader.core.correctness`, `nautilus_trader.core.data`, `nautilus_trader.model.custom`, `nautilus_trader.model.data`, `nautilus_trader.model.enums`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.objects`, `nautilus_trader.serialization.arrow.serializer`, `nautilus_trader.serialization.base`, `pyarrow`
...
---
*Generated on 2025-11-18T21:55:04.466071Z*
