...
### Classes
- **`BetfairStreamClient`**: Class defined in this file
- **`BetfairOrderStreamClient`**: Class defined in this file
- **`BetfairMarketStreamClient`**: Class defined in this file
...
**Classs**: `BetfairMarketStreamClient`, `BetfairOrderStreamClient`, `BetfairStreamClient`
**Imports**: `asyncio`, `collections.abc`, `itertools`, `msgspec`, `nautilus_trader.adapters.betfair.client`, `nautilus_trader.common.component`, `nautilus_trader.common.functions`, `nautilus_trader.core.nautilus_pyo3`, `os`
...
---
*Generated on 2025-11-18T21:55:04.492902Z*
