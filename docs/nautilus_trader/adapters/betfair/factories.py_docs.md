...
### Functions
- **`get_cached_betfair_client()`**: Function defined in this file
- **`get_cached_betfair_instrument_provider()`**: Function defined in this file

### Classes
- **`BetfairLiveDataClientFactory`**: Class defined in this file
- **`BetfairLiveExecClientFactory`**: Class defined in this file
...
**Classs**: `BetfairLiveDataClientFactory`, `BetfairLiveExecClientFactory`
**Functions**: `get_cached_betfair_client`, `get_cached_betfair_instrument_provider`
**Imports**: `asyncio`, `functools`, `nautilus_trader.adapters.betfair.client`, `nautilus_trader.adapters.betfair.config`, `nautilus_trader.adapters.betfair.data`, `nautilus_trader.adapters.betfair.execution`, `nautilus_trader.adapters.betfair.providers`, `nautilus_trader.cache.cache`, `nautilus_trader.common.component`, `nautilus_trader.live.factories`, `os`
...
---
*Generated on 2025-11-18T21:55:04.474928Z*
