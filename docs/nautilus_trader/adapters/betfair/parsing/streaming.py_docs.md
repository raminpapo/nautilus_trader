...
- **Path**: `nautilus_trader/adapters/betfair/parsing/streaming.py`
- **Size**: 21,099 bytes
- **Lines**: 608
- **Language**: Python
...
### Functions
- **`market_change_to_updates()`**: Function defined in this file
- **`market_definition_to_instrument_status()`**: Function defined in this file
- **`market_definition_to_instrument_closes()`**: Function defined in this file
- **`runner_to_instrument_close()`**: Function defined in this file
- **`market_definition_to_betfair_starting_prices()`**: Function defined in this file
- **`runner_to_betfair_starting_price()`**: Function defined in this file
- **`_price_volume_to_book_order()`**: Function defined in this file
- **`price_to_order_id()`**: Function defined in this file
- **`runner_change_to_order_book_snapshot()`**: Function defined in this file
- **`runner_change_to_trade_ticks()`**: Function defined in this file
- **`runner_change_to_order_book_deltas()`**: Function defined in this file
- **`runner_change_to_betfair_ticker()`**: Function defined in this file
- **`runner_change_to_bsp_order_book_deltas()`**: Function defined in this file
- **`_merge_order_book_deltas()`**: Function defined in this file
...
**Functions**: `_merge_order_book_deltas`, `_price_volume_to_book_order`, `market_change_to_updates`, `market_definition_to_betfair_starting_prices`, `market_definition_to_instrument_closes`, `market_definition_to_instrument_status`, `price_to_order_id`, `runner_change_to_betfair_ticker`, `runner_change_to_bsp_order_book_deltas`, `runner_change_to_order_book_deltas`, `runner_change_to_order_book_snapshot`, `runner_change_to_trade_ticks`, `runner_to_betfair_starting_price`, `runner_to_instrument_close`
**Imports**: `betfair_parser.spec.betting.type_definitions`, `betfair_parser.spec.streaming`, `betfair_parser.spec.streaming.type_definitions`, `collections`, `datetime`, `math`, `nautilus_trader.adapters.betfair.constants`, `nautilus_trader.adapters.betfair.data_types`, `nautilus_trader.adapters.betfair.orderbook`, `nautilus_trader.adapters.betfair.parsing.common`, `nautilus_trader.core.uuid`, `nautilus_trader.execution.reports`, `nautilus_trader.model.data`, `nautilus_trader.model.enums`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.objects`, `pandas`
...
---
*Generated on 2025-11-18T21:55:04.487605Z*
