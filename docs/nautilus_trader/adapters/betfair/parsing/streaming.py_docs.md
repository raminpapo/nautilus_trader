# Documentation: `nautilus_trader/adapters/betfair/parsing/streaming.py`
**Generated:** 2025-11-15T19:40:04.044925Z
**File Size:** 20809 bytes
**Extension:** .py
**Type:** text
...
This file is located at `nautilus_trader/adapters/betfair/parsing/streaming.py` within the repository.

**Functions defined:** market_change_to_updates, market_definition_to_instrument_status, market_definition_to_instrument_closes, runner_to_instrument_close, market_definition_to_betfair_starting_prices, runner_to_betfair_starting_price, _price_volume_to_book_order, price_to_order_id, runner_change_to_order_book_snapshot, runner_change_to_trade_ticks and 4 more
...
#### `market_change_to_updates(  # noqa: C901
    mc: MarketChange,
    traded_volumes: dict[InstrumentId, dict[float, float]],
    ts_event: int,
    ts_init: int,
...
#### `runner_to_betfair_starting_price(
    runner: RunnerDefinition,
    market_id: str,
    ts_event: int,
    ts_init: int,
...
#### `_price_volume_to_book_order(pv: PV, side: OrderSide)`


#### `price_to_order_id(price: Price)`


#### `runner_change_to_order_book_snapshot(
    rc: RunnerChange,
    instrument_id: InstrumentId,
    ts_event: int,
    ts_init: int,
...
#### `runner_change_to_bsp_order_book_deltas(
    rc: RunnerChange,
    instrument_id: InstrumentId,
    ts_event: int,
    ts_init: int,
...
#### `_merge_order_book_deltas(all_deltas: list[OrderBookDeltas])`
