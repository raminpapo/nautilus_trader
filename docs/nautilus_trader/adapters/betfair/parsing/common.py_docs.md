# Documentation: `nautilus_trader/adapters/betfair/parsing/common.py`
**Generated:** 2025-11-15T19:40:04.038230Z
...
This file is located at `nautilus_trader/adapters/betfair/parsing/common.py` within the repository.

**Functions defined:** betfair_instrument_id, instrument_id_betfair_ids, merge_instrument_fields, chunk, order_side_to_bet_side, bet_side_to_order_side, min_fill_size, hash_market_trade
...
#### `instrument_id_betfair_ids(
    instrument_id: InstrumentId,
)`


#### `merge_instrument_fields(
    old: BettingInstrument,
    new: BettingInstrument,
    logger,
)`
...
#### `order_side_to_bet_side(side: OrderSide)`


#### `bet_side_to_order_side(side: BetSide)`


#### `min_fill_size(time_in_force)`


#### `hash_market_trade(timestamp: int, price: float, volume: float)`
