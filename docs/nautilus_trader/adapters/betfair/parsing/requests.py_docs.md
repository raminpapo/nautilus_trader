# Documentation: `nautilus_trader/adapters/betfair/parsing/requests.py`
**Generated:** 2025-11-15T19:40:04.042187Z
**File Size:** 21433 bytes
**Extension:** .py
**Type:** text
...
This file is located at `nautilus_trader/adapters/betfair/parsing/requests.py` within the repository.

**Functions defined:** make_customer_order_ref, nautilus_limit_to_place_instructions, nautilus_limit_on_close_to_place_instructions, nautilus_market_to_place_instructions, nautilus_market_on_close_to_place_instructions, nautilus_order_to_place_instructions, order_submit_to_place_order_params, order_update_to_replace_order_params, order_update_to_cancel_order_params, order_cancel_to_cancel_order_params and 10 more
...
#### `make_customer_order_ref(client_order_id: ClientOrderId)`
...
#### `order_update_to_cancel_order_params(
    command: CancelOrder,
    instrument: BettingInstrument,
    size_reduction,
)`
...
#### `order_cancel_all_to_betfair(instrument: BettingInstrument)`


#### `betfair_account_to_account_state(
    account_detail: AccountDetailsResponse,
    account_funds: AccountFundsResponse,
    event_id,
    ts_event,
...
#### `determine_order_status(order: CurrentOrderSummary)`


#### `create_customer_ref(command: SubmitOrder | ModifyOrder | CancelOrder)`


#### `create_customer_strategy_ref(trader_id: str, strategy_id: str)`
...
#### `order_to_trade_id(uo: BetfairOrder)`


#### `current_order_summary_to_trade_id(order: CurrentOrderSummary)`
...
**Directory:** `nautilus_trader/adapters/betfair/parsing`
