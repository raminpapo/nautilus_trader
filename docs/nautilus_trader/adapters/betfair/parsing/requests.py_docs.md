# Documentation: requests.py

## File Metadata

- **Path**: `nautilus_trader/adapters/betfair/parsing/requests.py`
- **Size**: 22,146 bytes
- **Lines**: 592
- **Language**: Python
...
### Functions
- **`make_customer_order_ref()`**: Function defined in this file
- **`nautilus_limit_to_place_instructions()`**: Function defined in this file
- **`nautilus_limit_on_close_to_place_instructions()`**: Function defined in this file
- **`nautilus_market_to_place_instructions()`**: Function defined in this file
- **`nautilus_market_on_close_to_place_instructions()`**: Function defined in this file
- **`nautilus_order_to_place_instructions()`**: Function defined in this file
- **`order_submit_to_place_order_params()`**: Function defined in this file
- **`order_update_to_replace_order_params()`**: Function defined in this file
- **`order_update_to_cancel_order_params()`**: Function defined in this file
- **`order_cancel_to_cancel_order_params()`**: Function defined in this file
- **`order_cancel_all_to_betfair()`**: Function defined in this file
- **`betfair_account_to_account_state()`**: Function defined in this file
- **`bet_to_fill_report()`**: Function defined in this file
- **`bet_to_order_status_report()`**: Function defined in this file
- **`determine_order_status()`**: Function defined in this file
- **`create_customer_ref()`**: Function defined in this file
- **`create_customer_strategy_ref()`**: Function defined in this file
- **`hashed_trade_id()`**: Function defined in this file
- **`order_to_trade_id()`**: Function defined in this file
- **`current_order_summary_to_trade_id()`**: Function defined in this file
...
**Functions**: `bet_to_fill_report`, `bet_to_order_status_report`, `betfair_account_to_account_state`, `create_customer_ref`, `create_customer_strategy_ref`, `current_order_summary_to_trade_id`, `determine_order_status`, `hashed_trade_id`, `make_customer_order_ref`, `nautilus_limit_on_close_to_place_instructions`, `nautilus_limit_to_place_instructions`, `nautilus_market_on_close_to_place_instructions`, `nautilus_market_to_place_instructions`, `nautilus_order_to_place_instructions`, `order_cancel_all_to_betfair`, `order_cancel_to_cancel_order_params`, `order_submit_to_place_order_params`, `order_to_trade_id`, `order_update_to_cancel_order_params`, `order_update_to_replace_order_params`
**Imports**: `betfair_parser.spec.accounts.type_definitions`, `betfair_parser.spec.betting.enums`, `betfair_parser.spec.betting.orders`, `betfair_parser.spec.betting.type_definitions`, `betfair_parser.spec.common`, `betfair_parser.spec.streaming`, `functools`, `hashlib`, `msgspec`, `nautilus_trader.adapters.betfair.common`, `nautilus_trader.adapters.betfair.constants`, `nautilus_trader.adapters.betfair.parsing.common`, `nautilus_trader.core.datetime`, `nautilus_trader.execution.messages`, `nautilus_trader.execution.reports`, `nautilus_trader.model.enums`, `nautilus_trader.model.events.account`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.instruments.betting`, `nautilus_trader.model.objects`, `nautilus_trader.model.orders`, `pandas`, `typing`
...
---
*Generated on 2025-11-18T21:55:04.484468Z*
