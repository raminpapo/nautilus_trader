...
- **Path**: `nautilus_trader/adapters/betfair/parsing/core.py`
- **Size**: 5,573 bytes
- **Lines**: 146
- **Language**: Python
...
### Functions
- **`create_sequence_completed()`**: Function defined in this file
- **`iter_stream()`**: Function defined in this file
- **`parse_betfair_file()`**: Function defined in this file
- **`betting_instruments_from_file()`**: Function defined in this file

### Classes
- **`BetfairParser`**: Class defined in this file
...
**Classs**: `BetfairParser`
**Functions**: `betting_instruments_from_file`, `create_sequence_completed`, `iter_stream`, `parse_betfair_file`
**Imports**: `betfair_parser.spec.streaming`, `collections.abc`, `fsspec`, `msgspec`, `nautilus_trader.adapters.betfair.data_types`, `nautilus_trader.adapters.betfair.parsing.streaming`, `nautilus_trader.adapters.betfair.providers`, `nautilus_trader.core.datetime`, `nautilus_trader.model.data`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.instruments`, `nautilus_trader.model.objects`, `os`, `typing`
...
---
*Generated on 2025-11-18T21:55:04.481411Z*
