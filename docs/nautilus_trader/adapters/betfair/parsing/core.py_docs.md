# Documentation: `nautilus_trader/adapters/betfair/parsing/core.py`
**Generated:** 2025-11-15T19:40:04.039662Z
...
This file is located at `nautilus_trader/adapters/betfair/parsing/core.py` within the repository.

**Classes defined:** BetfairParser

**Functions defined:** __init__, parse, create_sequence_completed, iter_stream, parse_betfair_file, betting_instruments_from_file
...
#### `create_sequence_completed(ts_event: int, ts_init: int)`


#### `iter_stream(file_like: BinaryIO)`
