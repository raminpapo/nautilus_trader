...
- **Path**: `nautilus_trader/adapters/coinbase_intx/execution.py`
- **Size**: 32,475 bytes
- **Lines**: 750
- **Language**: Python
...
### Classes
- **`CoinbaseIntxExecutionClient`**: Class defined in this file
...
**Classs**: `CoinbaseIntxExecutionClient`
**Imports**: `__future__`, `asyncio`, `nautilus_trader.adapters.coinbase_intx.config`, `nautilus_trader.adapters.coinbase_intx.constants`, `nautilus_trader.adapters.coinbase_intx.providers`, `nautilus_trader.adapters.env`, `nautilus_trader.cache.cache`, `nautilus_trader.common.component`, `nautilus_trader.common.enums`, `nautilus_trader.core`, `nautilus_trader.core.correctness`, `nautilus_trader.core.datetime`, `nautilus_trader.execution.messages`, `nautilus_trader.execution.reports`, `nautilus_trader.live.cancellation`, `nautilus_trader.live.execution_client`, `nautilus_trader.model.enums`, `nautilus_trader.model.events`, `nautilus_trader.model.functions`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.orders`, `nautilus_trader.model.position`, `typing`
...
---
*Generated on 2025-11-18T21:55:04.662552Z*
