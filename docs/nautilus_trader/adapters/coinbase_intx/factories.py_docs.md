...
- **Path**: `nautilus_trader/adapters/coinbase_intx/factories.py`
- **Size**: 7,109 bytes
- **Lines**: 220
- **Language**: Python
...
### Functions
- **`get_coinbase_intx_http_client()`**: Function defined in this file
- **`get_coinbase_intx_instrument_provider()`**: Function defined in this file

### Classes
- **`CoinbaseIntxLiveDataClientFactory`**: Class defined in this file
- **`CoinbaseIntxLiveExecClientFactory`**: Class defined in this file
...
**Classs**: `CoinbaseIntxLiveDataClientFactory`, `CoinbaseIntxLiveExecClientFactory`
**Functions**: `get_coinbase_intx_http_client`, `get_coinbase_intx_instrument_provider`
**Imports**: `asyncio`, `functools`, `nautilus_trader.adapters.coinbase_intx.config`, `nautilus_trader.adapters.coinbase_intx.data`, `nautilus_trader.adapters.coinbase_intx.execution`, `nautilus_trader.adapters.coinbase_intx.providers`, `nautilus_trader.cache.cache`, `nautilus_trader.common.component`, `nautilus_trader.config`, `nautilus_trader.core`, `nautilus_trader.live.factories`
...
---
*Generated on 2025-11-18T21:55:04.665095Z*
