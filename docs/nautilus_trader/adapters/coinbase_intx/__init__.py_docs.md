# Documentation: `nautilus_trader/adapters/coinbase_intx/__init__.py`
**Generated:** 2025-11-15T19:40:04.201377Z
...
This file is located at `nautilus_trader/adapters/coinbase_intx/__init__.py` within the repository.
...
```python
import nautilus_trader.adapters.coinbase_intx.__init__
```
