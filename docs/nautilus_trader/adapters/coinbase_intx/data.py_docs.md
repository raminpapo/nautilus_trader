# Documentation: `nautilus_trader/adapters/coinbase_intx/data.py`
**Generated:** 2025-11-15T19:40:04.205972Z
...
- **Path:** `nautilus_trader/adapters/coinbase_intx/data.py`
- **Size:** 16,619 bytes
- **Lines:** 370
- **Extension:** `.py`
- **Type:** text
...
This file is located at `nautilus_trader/adapters/coinbase_intx/data.py` within the repository.

**Classes defined:** CoinbaseIntxDataClient

**Functions defined:** __init__, coinbase_intx_instrument_provider, _cache_instruments, _cache_instrument, _send_all_instruments_to_data_engine, _handle_msg
...
#### `coinbase_intx_instrument_provider(self)`


#### `_cache_instruments(self)`


#### `_cache_instrument(self, instrument: Instrument)`
