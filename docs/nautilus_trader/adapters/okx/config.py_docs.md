...
- **Path**: `nautilus_trader/adapters/okx/config.py`
- **Size**: 9,734 bytes
- **Lines**: 183
- **Language**: Python
...
**Classs**: `OKXDataClientConfig`, `OKXExecClientConfig`
**Imports**: `nautilus_trader.common.config`, `nautilus_trader.config`, `nautilus_trader.core.nautilus_pyo3`
...
---
*Generated on 2025-11-18T21:55:04.904480Z*
