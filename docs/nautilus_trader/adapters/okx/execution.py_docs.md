# Documentation: `nautilus_trader/adapters/okx/execution.py`
**Generated:** 2025-11-15T19:40:04.429236Z
**File Size:** 84247 bytes
**Extension:** .py
**Type:** text
...
- **Path:** `nautilus_trader/adapters/okx/execution.py`
- **Size:** 84,247 bytes
- **Lines:** 1,990
- **Extension:** `.py`
- **Type:** text
...
This file is located at `nautilus_trader/adapters/okx/execution.py` within the repository.

**Classes defined:** OKXExecutionClient

**Functions defined:** __init__, okx_instrument_provider, _derive_account_type, _derive_trade_mode, _build_spot_position_report_from_wallet_balance, _get_trade_mode_for_order, _deny_market_order_quantity, _is_external_order, _handle_msg, _handle_instrument_update and 15 more
...
#### `_build_spot_position_report_from_wallet_balance(
        self,
        instrument: CurrencyPair,
        wallet_balance: Decimal,
    )`
...
#### `_deny_market_order_quantity(self, order: Order, reason: str)`


#### `_is_external_order(self, client_order_id: ClientOrderId)`


#### `_handle_msg(self, msg: Any)`


#### `_handle_instrument_update(self, pyo3_instrument: OkxInstrument)`


#### `_handle_account_state(self, pyo3_account_state: nautilus_pyo3.AccountState)`


#### `_handle_order_rejected_pyo3(self, pyo3_event: nautilus_pyo3.OrderRejected)`


#### `_handle_order_cancel_rejected_pyo3(
        self,
        pyo3_event: nautilus_pyo3.OrderCancelRejected,
    )`


#### `_handle_order_modify_rejected_pyo3(
        self,
        pyo3_event: nautilus_pyo3.OrderModifyRejected,
    )`


#### `_handle_order_status_report_pyo3(  # noqa: C901 (too complex)`


#### `_handle_order_update(self, order: Any, report: OrderStatusReport)`


#### `_handle_fill_report_pyo3(self, pyo3_report: nautilus_pyo3.FillReport)`


#### `_resolve_client_order_ids(
        self,
        client_order_id: ClientOrderId | None,
    )`


#### `_canonical_client_order_id(
        self,
        client_order_id: ClientOrderId | None,
    )`


#### `_exchange_client_order_id(
        self,
        client_order_id: ClientOrderId | None,
    )`


#### `_register_client_order_aliases(
        self,
        parent_id: ClientOrderId | None,
        linked_order_ids: list[ClientOrderId] | None,
    )`
...
#### `_apply_client_order_alias(self, report: OrderStatusReport)`


#### `_clear_client_order_aliases(self, report: OrderStatusReport)`


#### `_clear_client_order_aliases_from_ids(
        self,
        ids: list[ClientOrderId | None],
    )`


#### `is_order_updated(order: Order, report: OrderStatusReport)`
...
**Directory:** `nautilus_trader/adapters/okx`
...
**Security:** This file may contain sensitive patterns: api_key, credential, auth. Ensure proper handling of secrets.
