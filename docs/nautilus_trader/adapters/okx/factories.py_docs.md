...
- **Path**: `nautilus_trader/adapters/okx/factories.py`
- **Size**: 9,115 bytes
- **Lines**: 270
- **Language**: Python
...
### Functions
- **`get_cached_okx_http_client()`**: Function defined in this file
- **`get_cached_okx_instrument_provider()`**: Function defined in this file

### Classes
- **`OKXLiveDataClientFactory`**: Class defined in this file
- **`OKXLiveExecClientFactory`**: Class defined in this file
...
**Classs**: `OKXLiveDataClientFactory`, `OKXLiveExecClientFactory`
**Functions**: `get_cached_okx_http_client`, `get_cached_okx_instrument_provider`
**Imports**: `asyncio`, `functools`, `nautilus_trader.adapters.okx.config`, `nautilus_trader.adapters.okx.data`, `nautilus_trader.adapters.okx.execution`, `nautilus_trader.adapters.okx.providers`, `nautilus_trader.cache.cache`, `nautilus_trader.common.component`, `nautilus_trader.config`, `nautilus_trader.core`, `nautilus_trader.core.nautilus_pyo3`, `nautilus_trader.live.factories`
...
---
*Generated on 2025-11-18T21:55:04.918734Z*
