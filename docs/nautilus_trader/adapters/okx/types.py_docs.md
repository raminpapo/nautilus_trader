# Documentation: `nautilus_trader/adapters/okx/types.py`
**Generated:** 2025-11-15T19:40:04.434472Z
...
This file is located at `nautilus_trader/adapters/okx/types.py` within the repository.
...
```python
import nautilus_trader.adapters.okx.types
```
