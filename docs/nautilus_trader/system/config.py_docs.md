...
- **Path**: `nautilus_trader/system/config.py`
- **Size**: 6,320 bytes
- **Lines**: 133
- **Language**: Python
...
### Classes
- **`NautilusKernelConfig`**: Class defined in this file
...
**Classs**: `NautilusKernelConfig`
**Imports**: `__future__`, `nautilus_trader.cache.config`, `nautilus_trader.common`, `nautilus_trader.common.config`, `nautilus_trader.core.uuid`, `nautilus_trader.data.config`, `nautilus_trader.execution.config`, `nautilus_trader.model.identifiers`, `nautilus_trader.persistence.config`, `nautilus_trader.portfolio.config`, `nautilus_trader.risk.config`, `nautilus_trader.trading.config`, `nautilus_trader.trading.strategy`
...
---
*Generated on 2025-11-18T21:55:05.938646Z*
