# Documentation: kernel.py

## File Metadata

- **Path**: `nautilus_trader/system/kernel.py`
- **Size**: 49,248 bytes
- **Lines**: 1,445
- **Language**: Python
...
**Classs**: `NautilusKernel`
**Imports**: `asyncio`, `collections.abc`, `concurrent.futures`, `datetime`, `msgspec`, `nautilus_trader.cache.base`, `nautilus_trader.cache.cache`, `nautilus_trader.cache.database`, `nautilus_trader.common`, `nautilus_trader.common.actor`, `nautilus_trader.common.component`, `nautilus_trader.common.config`, `nautilus_trader.common.enums`, `nautilus_trader.common.messages`, `nautilus_trader.config`, `nautilus_trader.core`, `nautilus_trader.core.correctness`, `nautilus_trader.core.datetime`, `nautilus_trader.core.uuid`, `nautilus_trader.data.engine`, `nautilus_trader.execution.algorithm`, `nautilus_trader.execution.emulator`, `nautilus_trader.execution.engine`, `nautilus_trader.live.data_engine`, `nautilus_trader.live.execution_engine`, `nautilus_trader.live.risk_engine`, `nautilus_trader.model.identifiers`, `nautilus_trader.persistence.catalog.parquet`, `nautilus_trader.persistence.writer`, `nautilus_trader.portfolio.base` *(+12 more)*

## Related Files

This file is located in `nautilus_trader/system/`. Related files may include:
...
---
*Generated on 2025-11-18T21:55:05.944174Z*
