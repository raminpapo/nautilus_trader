# Documentation: `nautilus_trader/system/kernel.py`
**Generated:** 2025-11-15T19:40:05.327252Z
**File Size:** 49251 bytes
**Extension:** .py
**Type:** text
...
This file is located at `nautilus_trader/system/kernel.py` within the repository.

**Classes defined:** NautilusKernel

**Functions defined:** __init__, __del__, _setup_loop, _loop_sig_handler, _setup_shutdown_handling, _setup_streaming, _on_shutdown_system, environment, loop, loop_sig_callback and 39 more

**Import statements:** 71
...
#### `__init__(  # noqa: C901 (too complex)`
...
#### `_loop_sig_handler(self, sig: signal.Signals)`


#### `_setup_shutdown_handling(self)`


#### `_setup_streaming(self, config: StreamingConfig)`


#### `_on_shutdown_system(self, command: ShutdownSystem)`
...
#### `msgbus_serializer(self)`


#### `msgbus_database(self)`
...
#### `_connect_clients(self)`


#### `_disconnect_clients(self)`


#### `_stop_clients(self)`


#### `_initialize_portfolio(self)`
...
**Directory:** `nautilus_trader/system`
