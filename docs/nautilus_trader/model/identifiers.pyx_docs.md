# Documentation: `nautilus_trader/model/identifiers.pyx`
**Generated:** 2025-11-15T19:40:05.092995Z
**File Size:** 34659 bytes
**Extension:** .pyx
**Type:** text
...
- **Path:** `nautilus_trader/model/identifiers.pyx`
- **Size:** 34,659 bytes
- **Lines:** 1,207
- **Extension:** `.pyx`
- **Type:** text
...
This file is located at `nautilus_trader/model/identifiers.pyx` within the repository.

**Functions defined:** __getstate__, __setstate__, __lt__, __le__, __gt__, __ge__, __str__, __repr__, value, __init__ and 77 more
...
#### `__lt__(self, Identifier other)`


#### `__le__(self, Identifier other)`


#### `__gt__(self, Identifier other)`


#### `__ge__(self, Identifier other)`
...
#### `__init__(self, str value not None)`
...
#### `__eq__(self, Symbol other)`


#### `__hash__(self)`


#### `__init__(self, str name not None)`
...
#### `__init__(self, Symbol symbol not None, Venue venue not None)`
...
#### `__eq__(self, InstrumentId other)`
...
#### `from_pyo3(pyo3_instrument_id)`


#### `new_spread(instrument_ratios: list[tuple[InstrumentId, int]])`
