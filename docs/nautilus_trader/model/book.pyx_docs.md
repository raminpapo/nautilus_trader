# Documentation: `nautilus_trader/model/book.pyx`
**Generated:** 2025-11-15T19:40:05.023784Z
**File Size:** 27246 bytes
**Extension:** .pyx
**Type:** text
...
- **Path:** `nautilus_trader/model/book.pyx`
- **Size:** 27,246 bytes
- **Lines:** 898
- **Extension:** `.pyx`
- **Type:** text
...
This file is located at `nautilus_trader/model/book.pyx` within the repository.

**Functions defined:** __init__, __del__, __repr__, __getstate__, __setstate__, instrument_id, book_type, sequence, ts_event, ts_init and 12 more
...
#### `__eq__(self, BookLevel other)`


#### `__lt__(self, BookLevel other)`


#### `__le__(self, BookLevel other)`


#### `__gt__(self, BookLevel other)`


#### `__ge__(self, BookLevel other)`
...
#### `py_should_handle_own_book_order(Order order)`
