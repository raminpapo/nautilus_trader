# Documentation: objects.pxd

## File Metadata

- **Path**: `nautilus_trader/model/objects.pxd`
- **Size**: 6,564 bytes
- **Lines**: 224
- **Language**: Unknown
...
**Identifiers**: `ANY`, `AccountBalance`, `All`, `BASIS`, `CONDITIONS`, `Copyright`, `Currency`, `CurrencyType`, `Currency_t`, `GNU`, `General`, `InstrumentId`, `KIND`, `Lesser`, `License`, `Licensed`, `Ltd`, `MarginBalance`, `Money`, `MoneyRaw`, `Money_t`, `Nautech`, `None`, `Price`, `PriceRaw`, `Price_t`, `Pty`, `Public`, `Quantity`, `QuantityRaw` *(+9 more)*
...
---
*Generated on 2025-11-18T21:55:05.765943Z*
