# Documentation: binary_option.pyx

## File Metadata

- **Path**: `nautilus_trader/model/instruments/binary_option.pyx`
- **Size**: 9,981 bytes
- **Lines**: 272
- **Language**: Unknown
...
**Identifiers**: `ANY`, `All`, `AssetClass`, `BASIS`, `BINARY_OPTION`, `BinaryOption`, `CONDITIONS`, `Condition`, `Copyright`, `Currency`, `Decimal`, `False`, `GNU`, `General`, `Instrument`, `InstrumentClass`, `InstrumentId`, `KIND`, `Lesser`, `License`, `Licensed`, `Ltd`, `Nautech`, `None`, `OptionKind`, `Parameters`, `Price`, `Pty`, `Public`, `Quantity` *(+17 more)*
...
---
*Generated on 2025-11-18T21:55:05.705859Z*
