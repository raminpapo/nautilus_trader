# Documentation: `nautilus_trader/model/instruments/synthetic.pyx`
**Generated:** 2025-11-15T19:40:05.156369Z
...
- **Path:** `nautilus_trader/model/instruments/synthetic.pyx`
- **Size:** 12,501 bytes
- **Lines:** 382
- **Extension:** `.pyx`
- **Type:** text
...
This file is located at `nautilus_trader/model/instruments/synthetic.pyx` within the repository.

**Functions defined:** __init__, __del__, __eq__, __hash__, price_precision, price_increment, components, formula, ts_event, ts_init and 2 more
...
#### `__eq__(self, SyntheticInstrument other)`
...
#### `to_dict(SyntheticInstrument obj)`
