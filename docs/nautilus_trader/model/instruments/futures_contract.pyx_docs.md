# Documentation: futures_contract.pyx
...
**Identifiers**: `ANY`, `All`, `AssetClass`, `BASIS`, `CONDITIONS`, `Code`, `Condition`, `Copyright`, `Currency`, `Cython`, `Decimal`, `FUTURE`, `False`, `FuturesContract`, `GNU`, `General`, `ISO`, `Identifier`, `Instrument`, `InstrumentClass`, `InstrumentId`, `KIND`, `Lesser`, `License`, `Licensed`, `Ltd`, `MIC`, `Market`, `Nautech`, `None` *(+23 more)*
...
---
*Generated on 2025-11-18T21:55:05.735865Z*
