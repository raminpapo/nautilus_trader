# Documentation: futures_spread.pxd

## File Metadata

- **Path**: `nautilus_trader/model/instruments/futures_spread.pxd`
- **Size**: 1,816 bytes
- **Lines**: 41
- **Language**: Unknown
...
**Identifiers**: `ANY`, `All`, `BASIS`, `CONDITIONS`, `Code`, `Copyright`, `FuturesSpread`, `GNU`, `General`, `ISO`, `Identifier`, `Instrument`, `KIND`, `Lesser`, `License`, `Licensed`, `Ltd`, `MIC`, `Market`, `Nautech`, `None`, `Pty`, `Public`, `See`, `Systems`, `The`, `UNIX`, `Unless`, `Version`, `WARRANTIES` *(+2 more)*
...
---
*Generated on 2025-11-18T21:55:05.737085Z*
