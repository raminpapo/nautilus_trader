# Documentation: `nautilus_trader/model/instruments/option_contract.pyx`
**Generated:** 2025-11-15T19:40:05.148472Z
**File Size:** 14228 bytes
**Extension:** .pyx
**Type:** text
...
- **Path:** `nautilus_trader/model/instruments/option_contract.pyx`
- **Size:** 14,228 bytes
- **Lines:** 360
- **Extension:** `.pyx`
- **Type:** text
...
This file is located at `nautilus_trader/model/instruments/option_contract.pyx` within the repository.

**Functions defined:** __init__, __repr__, activation_utc, expiration_utc, from_dict, to_dict, from_pyo3
...
#### `to_dict(OptionContract obj)`


#### `from_pyo3(pyo3_instrument)`
