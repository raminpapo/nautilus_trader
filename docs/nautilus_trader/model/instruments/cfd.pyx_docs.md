# Documentation: cfd.pyx

## File Metadata

- **Path**: `nautilus_trader/model/instruments/cfd.pyx`
- **Size**: 13,972 bytes
- **Lines**: 320
- **Language**: Unknown
...
**Identifiers**: `ANY`, `All`, `AssetClass`, `BASIS`, `CFD`, `CONDITIONS`, `Can`, `Cfd`, `Condition`, `Contract`, `Contract_for_difference`, `Copyright`, `Cryptocurrency`, `Currency`, `CurrencyType`, `Decimal`, `Difference`, `False`, `Fiat`, `GNU`, `General`, `Instrument`, `InstrumentClass`, `InstrumentId`, `KIND`, `Lesser`, `License`, `Licensed`, `Ltd`, `Money` *(+23 more)*
...
---
*Generated on 2025-11-18T21:55:05.709531Z*
