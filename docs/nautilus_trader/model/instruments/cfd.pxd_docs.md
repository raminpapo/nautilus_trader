# Documentation: cfd.pxd

## File Metadata

- **Path**: `nautilus_trader/model/instruments/cfd.pxd`
- **Size**: 1,449 bytes
- **Lines**: 34
- **Language**: Unknown
...
**Identifiers**: `ANY`, `All`, `BASIS`, `CONDITIONS`, `Cfd`, `Copyright`, `Currency`, `GNU`, `General`, `ISIN`, `Identification`, `Instrument`, `International`, `KIND`, `Lesser`, `License`, `Licensed`, `Ltd`, `Nautech`, `None`, `Number`, `Pty`, `Public`, `Securities`, `See`, `Systems`, `The`, `Unless`, `Version`, `WARRANTIES` *(+2 more)*
...
---
*Generated on 2025-11-18T21:55:05.707319Z*
