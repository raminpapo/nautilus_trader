# Documentation: currency_pair.pyx

## File Metadata

- **Path**: `nautilus_trader/model/instruments/currency_pair.pyx`
- **Size**: 14,176 bytes
- **Lines**: 332
- **Language**: Unknown
...
**Identifiers**: `ANY`, `All`, `AssetClass`, `BASIS`, `CONDITIONS`, `CRYPTO`, `CRYPTOCURRENCY`, `Can`, `Condition`, `Copyright`, `Cryptocurrency`, `Currency`, `CurrencyPair`, `CurrencyType`, `Decimal`, `Determine`, `False`, `Fiat`, `GNU`, `General`, `Instrument`, `InstrumentClass`, `InstrumentId`, `KIND`, `Lesser`, `License`, `Licensed`, `Ltd`, `Money`, `Nautech` *(+22 more)*
...
---
*Generated on 2025-11-18T21:55:05.729696Z*
