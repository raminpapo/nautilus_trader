# Documentation: crypto_perpetual.pyx

## File Metadata

- **Path**: `nautilus_trader/model/instruments/crypto_perpetual.pyx`
- **Size**: 17,023 bytes
- **Lines**: 418
- **Language**: Unknown
...
**Identifiers**: `ANY`, `All`, `AssetClass`, `BASIS`, `CONDITIONS`, `CRYPTOCURRENCY`, `Calculate`, `Condition`, `Copyright`, `CryptoPerpetual`, `Currency`, `Decimal`, `False`, `For`, `GNU`, `General`, `Has`, `Instrument`, `InstrumentClass`, `InstrumentId`, `Inverse`, `KIND`, `Lesser`, `License`, `Licensed`, `Ltd`, `Money`, `Nautech`, `None`, `Parameters` *(+27 more)*
...
---
*Generated on 2025-11-18T21:55:05.725818Z*
