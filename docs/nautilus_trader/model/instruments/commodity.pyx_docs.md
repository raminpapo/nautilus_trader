# Documentation: commodity.pyx

## File Metadata

- **Path**: `nautilus_trader/model/instruments/commodity.pyx`
- **Size**: 13,362 bytes
- **Lines**: 306
- **Language**: Unknown
...
**Identifiers**: `ANY`, `All`, `AssetClass`, `BASIS`, `CONDITIONS`, `Commodity`, `Condition`, `Copyright`, `Currency`, `CurrencyType`, `Decimal`, `False`, `GNU`, `General`, `Instrument`, `InstrumentClass`, `InstrumentId`, `KIND`, `Lesser`, `License`, `Licensed`, `Ltd`, `Money`, `Nautech`, `None`, `Parameters`, `Price`, `Pty`, `Public`, `Quantity` *(+16 more)*
...
---
*Generated on 2025-11-18T21:55:05.713177Z*
