...
- **Path**: `nautilus_trader/model/instruments/base.pxd`
- **Size**: 6,023 bytes
- **Lines**: 115
- **Language**: Unknown
...
**Identifiers**: `ANY`, `All`, `AssetClass`, `BASIS`, `CONDITIONS`, `Copyright`, `Currency`, `Data`, `Decimal`, `EXPIRING_INSTRUMENT_CLASSES`, `GNU`, `General`, `Instrument`, `InstrumentClass`, `InstrumentId`, `KIND`, `Lesser`, `License`, `Licensed`, `Ltd`, `Money`, `NEGATIVE_PRICE_INSTRUMENT_CLASSES`, `Nautech`, `None`, `Price`, `Pty`, `Public`, `Quantity`, `See`, `Symbol` *(+9 more)*
...
---
*Generated on 2025-11-18T21:55:05.695212Z*
