# Documentation: betting.pyx

## File Metadata

- **Path**: `nautilus_trader/model/instruments/betting.pyx`
- **Size**: 11,843 bytes
- **Lines**: 311
- **Language**: Unknown
...
Total unique keywords extracted: 72


**Identifiers**: `ALTERNATIVE`, `ANY`, `All`, `AssetClass`, `BACK`, `BASIS`, `BUY`, `Basketball`, `BetSide`, `BettingInstrument`, `Boston`, `CONDITIONS`, `Celtics`, `Competition`, `Condition`, `Copyright`, `Currency`, `Decimal`, `Event`, `False`, `GNU`, `General`, `Handicap`, `Info`, `Instrument`, `InstrumentClass`, `InstrumentId`, `Jazz`, `KIND`, `LAY` *(+42 more)*
...
---
*Generated on 2025-11-18T21:55:05.702468Z*
