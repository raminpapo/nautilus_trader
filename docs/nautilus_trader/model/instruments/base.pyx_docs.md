# Documentation: `nautilus_trader/model/instruments/base.pyx`
**Generated:** 2025-11-15T19:40:05.100852Z
**File Size:** 30015 bytes
**Extension:** .pyx
**Type:** text
...
This file is located at `nautilus_trader/model/instruments/base.pyx` within the repository.

**Functions defined:** __init__, __eq__, __hash__, __repr__, base_from_dict, base_to_dict, symbol, venue
...
#### `base_from_dict(dict values)`


#### `base_to_dict(Instrument obj)`
