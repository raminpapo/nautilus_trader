...
- **Path**: `nautilus_trader/model/instruments/base.pyx`
- **Size**: 30,066 bytes
- **Lines**: 828
- **Language**: Unknown
...
**Identifiers**: `ANY`, `All`, `AssetClass`, `Assign`, `BASIS`, `BettingInstrument`, `BinaryOption`, `CONDITIONS`, `Calculate`, `Check`, `Condition`, `Copyright`, `CryptoFuture`, `CryptoOption`, `CryptoPerpetual`, `Currency`, `CurrencyPair`, `Data`, `Decimal`, `EXPIRING_INSTRUMENT_CLASSES`, `Equity`, `Exception`, `FUTURE`, `FUTURES_SPREAD`, `False`, `FuturesContract`, `FuturesSpread`, `GNU`, `General`, `Instrument` *(+53 more)*
...
---
*Generated on 2025-11-18T21:55:05.698881Z*
