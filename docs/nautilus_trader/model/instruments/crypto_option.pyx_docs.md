# Documentation: crypto_option.pyx

## File Metadata

- **Path**: `nautilus_trader/model/instruments/crypto_option.pyx`
- **Size**: 20,381 bytes
- **Lines**: 501
- **Language**: Unknown
...
**Identifiers**: `ANY`, `All`, `AssetClass`, `BASIS`, `CALL`, `CONDITIONS`, `CRYPTOCURRENCY`, `Calculate`, `Condition`, `Copyright`, `CryptoOption`, `Currency`, `Cython`, `Decimal`, `False`, `For`, `GNU`, `General`, `Has`, `Instrument`, `InstrumentClass`, `InstrumentId`, `Inverse`, `KIND`, `Lesser`, `License`, `Licensed`, `Ltd`, `Money`, `Nautech` *(+33 more)*
...
---
*Generated on 2025-11-18T21:55:05.721956Z*
