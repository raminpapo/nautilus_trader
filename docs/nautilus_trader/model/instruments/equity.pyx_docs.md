# Documentation: equity.pyx

## File Metadata

- **Path**: `nautilus_trader/model/instruments/equity.pyx`
- **Size**: 10,007 bytes
- **Lines**: 251
- **Language**: Unknown
...
**Identifiers**: `ANY`, `All`, `AssetClass`, `BASIS`, `CONDITIONS`, `Can`, `Condition`, `Copyright`, `Currency`, `Cython`, `Decimal`, `EQUITY`, `Equity`, `False`, `GNU`, `General`, `ISIN`, `Identification`, `Instrument`, `InstrumentClass`, `InstrumentId`, `International`, `KIND`, `Lesser`, `License`, `Licensed`, `Ltd`, `Nautech`, `None`, `Number` *(+23 more)*
...
---
*Generated on 2025-11-18T21:55:05.732678Z*
