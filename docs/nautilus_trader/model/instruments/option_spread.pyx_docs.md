# Documentation: option_spread.pyx
...
**Identifiers**: `ANY`, `All`, `AssetClass`, `BASIS`, `CONDITIONS`, `Code`, `Condition`, `Copyright`, `Currency`, `Cython`, `Decimal`, `False`, `GNU`, `General`, `ISO`, `Identifier`, `Instrument`, `InstrumentClass`, `InstrumentId`, `KIND`, `Lesser`, `License`, `Licensed`, `Ltd`, `MIC`, `Market`, `Nautech`, `None`, `OPTION_SPREAD`, `OptionKind` *(+24 more)*
...
---
*Generated on 2025-11-18T21:55:05.760539Z*
