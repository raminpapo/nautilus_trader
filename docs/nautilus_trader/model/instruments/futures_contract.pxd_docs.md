# Documentation: futures_contract.pxd
...
**Identifiers**: `ANY`, `All`, `BASIS`, `CONDITIONS`, `Code`, `Copyright`, `FuturesContract`, `GNU`, `General`, `ISO`, `Identifier`, `Instrument`, `KIND`, `Lesser`, `License`, `Licensed`, `Ltd`, `MIC`, `Market`, `Nautech`, `None`, `Pty`, `Public`, `See`, `Systems`, `The`, `UNIX`, `Unless`, `Version`, `WARRANTIES` *(+2 more)*
...
---
*Generated on 2025-11-18T21:55:05.733859Z*
