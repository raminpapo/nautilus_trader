# Documentation: crypto_future.pyx
...
**Identifiers**: `ANY`, `All`, `AssetClass`, `BASIS`, `CONDITIONS`, `CRYPTOCURRENCY`, `Calculate`, `Condition`, `Copyright`, `CryptoFuture`, `Currency`, `Cython`, `Decimal`, `FUTURE`, `False`, `For`, `GNU`, `General`, `Has`, `Instrument`, `InstrumentClass`, `InstrumentId`, `Inverse`, `KIND`, `Lesser`, `License`, `Licensed`, `Ltd`, `Money`, `Nautech` *(+31 more)*
...
---
*Generated on 2025-11-18T21:55:05.717608Z*
