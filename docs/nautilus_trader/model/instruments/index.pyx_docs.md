# Documentation: index.pyx

## File Metadata

- **Path**: `nautilus_trader/model/instruments/index.pyx`
- **Size**: 7,647 bytes
- **Lines**: 211
- **Language**: Unknown
...
**Identifiers**: `ANY`, `All`, `AssetClass`, `BASIS`, `CFDs`, `CONDITIONS`, `Condition`, `Copyright`, `Currency`, `Cython`, `Decimal`, `ETFs`, `False`, `GNU`, `General`, `INDEX`, `IndexInstrument`, `Instrument`, `InstrumentClass`, `InstrumentId`, `KIND`, `Lesser`, `License`, `Licensed`, `Ltd`, `Nautech`, `None`, `Parameters`, `Price`, `Pty` *(+19 more)*
...
---
*Generated on 2025-11-18T21:55:05.753430Z*
