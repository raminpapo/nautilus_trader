# Documentation: book.pxd

## File Metadata

- **Path**: `nautilus_trader/model/book.pxd`
- **Size**: 3,807 bytes
- **Lines**: 85
- **Language**: Unknown
...
**Identifiers**: `ANY`, `All`, `BASIS`, `BookLevel`, `BookLevel_API`, `BookOrder`, `BookType`, `CONDITIONS`, `Copyright`, `Data`, `FOK`, `GNU`, `General`, `IOC`, `KIND`, `Lesser`, `License`, `Licensed`, `Ltd`, `Nautech`, `Order`, `OrderBook`, `OrderBookDelta`, `OrderBookDeltas`, `OrderBookDepth10`, `OrderBook_API`, `OrderSide`, `OrderStatus`, `OrderType`, `Price` *(+13 more)*
...
---
*Generated on 2025-11-18T21:55:05.617239Z*
