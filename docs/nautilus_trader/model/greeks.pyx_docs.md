# Documentation: `nautilus_trader/model/greeks.pyx`
**Generated:** 2025-11-15T19:40:05.084027Z
**File Size:** 25131 bytes
**Extension:** .pyx
**Type:** text
...
- **Path:** `nautilus_trader/model/greeks.pyx`
- **Size:** 25,131 bytes
- **Lines:** 542
- **Extension:** `.pyx`
- **Type:** text
...
This file is located at `nautilus_trader/model/greeks.pyx` within the repository.

**Functions defined:** __init__, instrument_greeks, modify_greeks, portfolio_greeks, subscribe_greeks
...
#### `subscribe_greeks(self, instrument_id: InstrumentId | None = None, handler: Callable[[GreeksData], None] = None)`
