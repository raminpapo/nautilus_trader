# Documentation: functions.pyx

## File Metadata

- **Path**: `nautilus_trader/model/functions.pyx`
- **Size**: 21,334 bytes
- **Lines**: 548
- **Language**: Unknown
...
Total unique keywords extracted: 107


**Identifiers**: `ACCEPTED`, `ANY`, `AT_THE_CLOSE`, `AT_THE_OPEN`, `AccountType`, `AggregationSource`, `AggressorSide`, `All`, `AssetClass`, `BASIS`, `BASIS_POINTS`, `BID_ASK`, `BUY`, `BarAggregation`, `BookAction`, `BookType`, `CANCELED`, `CONDITIONS`, `ContingencyType`, `Copyright`, `CurrencyType`, `DAY`, `DEFAULT`, `DENIED`, `DOUBLE_BID_ASK`, `DOUBLE_LAST`, `EMULATED`, `EXPIRED`, `FILLED`, `FLAT` *(+77 more)*
...
---
*Generated on 2025-11-18T21:55:05.678528Z*
