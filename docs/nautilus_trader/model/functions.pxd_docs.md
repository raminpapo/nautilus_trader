# Documentation: functions.pxd

## File Metadata

- **Path**: `nautilus_trader/model/functions.pxd`
- **Size**: 6,082 bytes
- **Lines**: 142
- **Language**: Unknown
...
**Identifiers**: `ANY`, `AccountType`, `AggregationSource`, `AggressorSide`, `All`, `AssetClass`, `BASIS`, `BarAggregation`, `BookAction`, `BookType`, `CONDITIONS`, `ContingencyType`, `Copyright`, `Currency`, `CurrencyType`, `GNU`, `General`, `InstrumentClass`, `InstrumentCloseType`, `KIND`, `Lesser`, `License`, `Licensed`, `LiquiditySide`, `Ltd`, `MarketStatus`, `MarketStatusAction`, `Nautech`, `OmsType`, `OptionKind` *(+20 more)*
...
---
*Generated on 2025-11-18T21:55:05.675461Z*
