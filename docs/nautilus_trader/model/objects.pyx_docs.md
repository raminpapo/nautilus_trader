# Documentation: `nautilus_trader/model/objects.pyx`
**Generated:** 2025-11-15T19:40:05.164142Z
**File Size:** 58252 bytes
**Extension:** .pyx
**Type:** text
...
- **Path:** `nautilus_trader/model/objects.pyx`
- **Size:** 58,252 bytes
- **Lines:** 1,906
- **Extension:** `.pyx`
- **Type:** text
...
This file is located at `nautilus_trader/model/objects.pyx` within the repository.

**Functions defined:** __init__, __getstate__, __setstate__, __eq__, __lt__, __le__, __gt__, __ge__, __add__, __radd__ and 120 more
...
#### `__init__(self, double value, uint8_t precision)`
...
#### `zero(uint8_t precision=0)`


#### `from_raw(raw: int, uint8_t precision)`
