# Documentation: order.pxd

## File Metadata

- **Path**: `nautilus_trader/model/events/order.pxd`
- **Size**: 12,302 bytes
- **Lines**: 368
- **Language**: Unknown
...
**Identifiers**: `ANY`, `Abstract`, `AccountId`, `All`, `Any`, `BASIS`, `CONDITIONS`, `ClientOrderId`, `ContingencyType`, `Copyright`, `Currency`, `Event`, `ExecAlgorithmId`, `GNU`, `General`, `InstrumentId`, `KIND`, `Lesser`, `License`, `Licensed`, `LiquiditySide`, `Ltd`, `MAKER`, `Money`, `Nautech`, `None`, `OrderAccepted`, `OrderAccepted_t`, `OrderCancelRejected`, `OrderCanceled` *(+43 more)*
...
---
*Generated on 2025-11-18T21:55:05.654892Z*
