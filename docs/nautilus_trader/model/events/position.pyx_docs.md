# Documentation: `nautilus_trader/model/events/position.pyx`
**Generated:** 2025-11-15T19:40:05.075533Z
**File Size:** 42598 bytes
**Extension:** .pyx
**Type:** text
...
- **Path:** `nautilus_trader/model/events/position.pyx`
- **Size:** 42,598 bytes
- **Lines:** 1,261
- **Extension:** `.pyx`
- **Type:** text
...
This file is located at `nautilus_trader/model/events/position.pyx` within the repository.

**Functions defined:** __init__, __eq__, __hash__, __str__, __repr__, id, ts_event, ts_init, __init__, create and 20 more
