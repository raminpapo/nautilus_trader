# Documentation: position.pxd

## File Metadata

- **Path**: `nautilus_trader/model/events/position.pxd`
- **Size**: 6,991 bytes
- **Lines**: 170
- **Language**: Unknown
...
**Identifiers**: `ANY`, `AccountId`, `All`, `BASIS`, `CONDITIONS`, `ClientOrderId`, `Copyright`, `Currency`, `Decimal`, `Event`, `GNU`, `General`, `InstrumentId`, `KIND`, `LONG`, `Lesser`, `License`, `Licensed`, `Ltd`, `Money`, `Nautech`, `None`, `Optional`, `OrderFilled`, `OrderSide`, `PnL`, `Position`, `PositionAdjusted`, `PositionAdjustmentType`, `PositionChanged` *(+22 more)*
...
---
*Generated on 2025-11-18T21:55:05.669052Z*
