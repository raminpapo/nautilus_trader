# Documentation: account.pyx

## File Metadata

- **Path**: `nautilus_trader/model/events/account.pyx`
- **Size**: 6,768 bytes
- **Lines**: 209
- **Language**: Unknown
...
**Identifiers**: `ANY`, `AccountBalance`, `AccountId`, `AccountState`, `AccountType`, `All`, `BASIS`, `CONDITIONS`, `Can`, `Condition`, `Copyright`, `Currency`, `Event`, `False`, `GNU`, `General`, `KIND`, `Lesser`, `License`, `Licensed`, `Ltd`, `MarginBalance`, `Nautech`, `None`, `Parameters`, `Pty`, `Public`, `Raises`, `Represents`, `Return` *(+13 more)*
...
---
*Generated on 2025-11-18T21:55:05.652847Z*
