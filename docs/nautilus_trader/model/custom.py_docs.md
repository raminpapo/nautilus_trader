# Documentation: `nautilus_trader/model/custom.py`
**Generated:** 2025-11-15T19:40:05.027180Z
...
- **Path:** `nautilus_trader/model/custom.py`
- **Size:** 6,046 bytes
- **Lines:** 181
- **Extension:** `.py`
- **Type:** text
...
This file is located at `nautilus_trader/model/custom.py` within the repository.

**Functions defined:** customdataclass, wrapper, __init__, __repr__, ts_event, ts_init, to_dict, from_dict, to_bytes, from_bytes and 2 more
...
#### `__init__(self, ts_event: int = 0, ts_init: int = 0, *args2, **kwargs2)`
...
#### `from_bytes(cls, data: bytes)`


#### `to_arrow(self)`


#### `from_arrow(cls, table: pa.Table)`
