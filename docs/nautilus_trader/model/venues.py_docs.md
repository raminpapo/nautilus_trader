# Documentation: `nautilus_trader/model/venues.py`
**Generated:** 2025-11-15T19:40:05.233727Z
...
- **Path:** `nautilus_trader/model/venues.py`
- **Size:** 1,333 bytes
- **Lines:** 29
- **Extension:** `.py`
- **Type:** text
...
This file is located at `nautilus_trader/model/venues.py` within the repository.
...
```python
import nautilus_trader.model.venues
```
