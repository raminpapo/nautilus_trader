# Documentation: `nautilus_trader/model/currencies.py`
**Generated:** 2025-11-15T19:40:05.025486Z
...
- **Path:** `nautilus_trader/model/currencies.py`
- **Size:** 6,669 bytes
- **Lines:** 135
- **Extension:** `.py`
- **Type:** text
...
This file is located at `nautilus_trader/model/currencies.py` within the repository.

**Functions defined:** register_currency
...
#### `register_currency(currency: Currency, overwrite: bool = False)`
