# Documentation: tiered.pyx

## File Metadata

- **Path**: `nautilus_trader/model/tick_scheme/implementations/tiered.pyx`
- **Size**: 6,056 bytes
- **Lines**: 193
- **Language**: Unknown
...
**Identifiers**: `ANY`, `All`, `BASIS`, `CONDITIONS`, `Condition`, `Copyright`, `Expand`, `GNU`, `General`, `Increment`, `KIND`, `Lesser`, `License`, `Licensed`, `Ltd`, `Mappings`, `Nautech`, `None`, `Parameters`, `Price`, `Pty`, `Public`, `Raises`, `Represents`, `Return`, `Returns`, `See`, `Should`, `Start`, `Systems` *(+12 more)*
...
---
*Generated on 2025-11-18T21:55:05.843298Z*
