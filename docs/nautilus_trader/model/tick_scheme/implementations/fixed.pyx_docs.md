# Documentation: fixed.pyx

## File Metadata

- **Path**: `nautilus_trader/model/tick_scheme/implementations/fixed.pyx`
- **Size**: 5,399 bytes
- **Lines**: 163
- **Language**: Unknown
...
**Identifiers**: `ANY`, `All`, `BASIS`, `CONDITIONS`, `Copyright`, `Crypto`, `FIXED_PRECISION`, `FIXED_PRECISION_`, `FOREX`, `FOREX_3DECIMAL`, `FOREX_3DECIMAL_TICK_SCHEME`, `FOREX_5DECIMAL`, `FOREX_5DECIMAL_TICK_SCHEME`, `FixedTickScheme`, `Forex`, `GNU`, `General`, `Generate`, `JPY`, `KIND`, `Lesser`, `License`, `Licensed`, `Ltd`, `Most`, `Nautech`, `None`, `PRICE_RAW_MAX`, `PRICE_RAW_MIN`, `Parameters` *(+17 more)*

## Related Files

This file is located in `nautilus_trader/model/tick_scheme/implementations/`. Related files may include:
...
---
*Generated on 2025-11-18T21:55:05.840362Z*
