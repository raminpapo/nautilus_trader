# Documentation: `nautilus_trader/model/data.pyx`
**Generated:** 2025-11-15T19:40:05.044153Z
**File Size:** 184656 bytes
**Extension:** .pyx
**Type:** text
...
- **Path:** `nautilus_trader/model/data.pyx`
- **Size:** 184,656 bytes
- **Lines:** 6,071
- **Extension:** `.pyx`
- **Type:** text
...
This file is located at `nautilus_trader/model/data.pyx` within the repository.

**Functions defined:** __init__, validate_step, __getstate__, __setstate__, __eq__, __lt__, __le__, __gt__, __ge__, __hash__ and 250 more
...
#### `validate_step(subunits: int, allow_equal: bool = False)`
...
#### `__eq__(self, BarSpecification other)`


#### `__lt__(self, BarSpecification other)`


#### `__le__(self, BarSpecification other)`


#### `__gt__(self, BarSpecification other)`


#### `__ge__(self, BarSpecification other)`
...
#### `from_timedelta(timedelta duration, PriceType price_type)`


#### `check_time_aggregated(BarAggregation aggregation)`


#### `check_threshold_aggregated(BarAggregation aggregation)`


#### `check_information_aggregated(BarAggregation aggregation)`
...
#### `__eq__(self, BarType other)`


#### `__lt__(self, BarType other)`


#### `__le__(self, BarType other)`


#### `__gt__(self, BarType other)`


#### `__ge__(self, BarType other)`
