# Documentation: `nautilus_trader/model/greeks_data.py`
**Generated:** 2025-11-15T19:40:05.087097Z
**File Size:** 6579 bytes
**Extension:** .py
**Type:** text
...
This file is located at `nautilus_trader/model/greeks_data.py` within the repository.

**Classes defined:** GreeksData, PortfolioGreeks, YieldCurveData

**Functions defined:** __repr__, from_delta, __rmul__, __repr__, __add__, __repr__, __call__, to_dict, from_dict
...
#### `__call__(self, expiry_in_years: float)`
