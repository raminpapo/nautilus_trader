# Documentation: `nautilus_trader/model/position.pyx`
**Generated:** 2025-11-15T19:40:05.219301Z
**File Size:** 31706 bytes
**Extension:** .pyx
**Type:** text
...
- **Path:** `nautilus_trader/model/position.pyx`
- **Size:** 31,706 bytes
- **Lines:** 961
- **Extension:** `.pyx`
- **Type:** text
...
This file is located at `nautilus_trader/model/position.pyx` within the repository.

**Functions defined:** __init__, __eq__, __hash__, __repr__, purge_events_for_order, symbol, venue, client_order_ids, venue_order_ids, trade_ids and 10 more
...
#### `purge_events_for_order(self, ClientOrderId client_order_id)`
...
#### `side_from_order_side(OrderSide side)`
