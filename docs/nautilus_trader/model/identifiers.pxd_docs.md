# Documentation: identifiers.pxd

## File Metadata

- **Path**: `nautilus_trader/model/identifiers.pxd`
- **Size**: 4,187 bytes
- **Lines**: 155
- **Language**: Unknown
...
**Identifiers**: `ANY`, `AccountId`, `AccountId_t`, `All`, `BASIS`, `CONDITIONS`, `ClientId`, `ClientId_t`, `ClientOrderId`, `ClientOrderId_t`, `ComponentId`, `ComponentId_t`, `Copyright`, `ExecAlgorithmId`, `ExecAlgorithmId_t`, `GNU`, `General`, `Identifier`, `InstrumentId`, `InstrumentId_t`, `KIND`, `Lesser`, `License`, `Licensed`, `Ltd`, `Nautech`, `OrderListId`, `OrderListId_t`, `PositionId`, `PositionId_t` *(+21 more)*
...
---
*Generated on 2025-11-18T21:55:05.686569Z*
