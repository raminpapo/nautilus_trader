# Documentation: market_to_limit.pyx

## File Metadata

- **Path**: `nautilus_trader/model/orders/market_to_limit.pyx`
- **Size**: 14,332 bytes
- **Lines**: 336
- **Language**: Unknown
...
**Identifiers**: `ANY`, `AT_THE_CLOSE`, `AT_THE_OPEN`, `All`, `Any`, `BASIS`, `BUY`, `CONDITIONS`, `ClientOrderId`, `Condition`, `ContingencyType`, `Copyright`, `Create`, `DAY`, `ExecAlgorithmId`, `FOK`, `False`, `GNU`, `GTC`, `GTD`, `General`, `IOC`, `InstrumentId`, `KIND`, `Lesser`, `License`, `Licensed`, `Limit`, `Ltd`, `MARKET_TO_LIMIT` *(+43 more)*
...
---
*Generated on 2025-11-18T21:55:05.805750Z*
