# Documentation: `nautilus_trader/model/orders/limit.pyx`
**Generated:** 2025-11-15T19:40:05.177526Z
**File Size:** 21792 bytes
**Extension:** .pyx
**Type:** text
...
- **Path:** `nautilus_trader/model/orders/limit.pyx`
- **Size:** 21,792 bytes
- **Lines:** 476
- **Extension:** `.pyx`
- **Type:** text
...
This file is located at `nautilus_trader/model/orders/limit.pyx` within the repository.

**Functions defined:** __init__, expire_time, from_pyo3, create, transform_py
...
#### `from_pyo3(pyo3_order)`


#### `create(OrderInitialized init)`


#### `transform_py(Order order, uint64_t ts_init, Price price = None)`
