# Documentation: market.pyx

## File Metadata

- **Path**: `nautilus_trader/model/orders/market.pyx`
- **Size**: 15,932 bytes
- **Lines**: 371
- **Language**: Unknown
...
**Identifiers**: `ANY`, `AT_THE_CLOSE`, `AT_THE_OPEN`, `All`, `Any`, `BASIS`, `BUY`, `CONDITIONS`, `ClientOrderId`, `Close`, `Condition`, `ContingencyType`, `Copyright`, `Create`, `DAY`, `ExecAlgorithmId`, `FOK`, `False`, `GNU`, `GTC`, `GTD`, `General`, `IOC`, `InstrumentId`, `KIND`, `Lesser`, `License`, `Licensed`, `Limit`, `Ltd` *(+44 more)*
...
---
*Generated on 2025-11-18T21:55:05.797769Z*
