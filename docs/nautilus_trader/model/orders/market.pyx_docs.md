# Documentation: `nautilus_trader/model/orders/market.pyx`
**Generated:** 2025-11-15T19:40:05.187453Z
**File Size:** 15932 bytes
**Extension:** .pyx
**Type:** text
...
This file is located at `nautilus_trader/model/orders/market.pyx` within the repository.

**Functions defined:** __init__, from_pyo3, create, transform_py
...
#### `transform_py(Order order, uint64_t ts_init)`
