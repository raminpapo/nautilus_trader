# Documentation: `nautilus_trader/model/orders/base.pyx`
**Generated:** 2025-11-15T19:40:05.173405Z
**File Size:** 41096 bytes
**Extension:** .pyx
**Type:** text
...
- **Path:** `nautilus_trader/model/orders/base.pyx`
- **Size:** 41,096 bytes
- **Lines:** 1,188
- **Extension:** `.pyx`
- **Type:** text
...
This file is located at `nautilus_trader/model/orders/base.pyx` within the repository.

**Functions defined:** __init__, __eq__, __hash__, __repr__, to_own_book_order, symbol, venue, status, init_event, last_event and 26 more
...
#### `__init__(self, OrderInitialized init not None)`


#### `__eq__(self, Order other)`
...
#### `has_trigger_price(self)`


#### `has_activation_price(self)`
...
#### `is_pending_update(self)`


#### `is_pending_cancel(self)`


#### `opposite_side(OrderSide side)`


#### `closing_side(PositionSide position_side)`
