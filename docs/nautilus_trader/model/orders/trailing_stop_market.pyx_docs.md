# Documentation: trailing_stop_market.pyx

## File Metadata

- **Path**: `nautilus_trader/model/orders/trailing_stop_market.pyx`
- **Size**: 19,088 bytes
- **Lines**: 408
- **Language**: Unknown
...
**Identifiers**: `ACCEPTED`, `ACTIVATION`, `ANY`, `AT_THE_CLOSE`, `AT_THE_OPEN`, `Additional`, `All`, `Any`, `BASIS`, `BID_ASK`, `BUY`, `CONDITIONS`, `ClientOrderId`, `Condition`, `ContingencyType`, `Copyright`, `Create`, `DAY`, `DEFAULT`, `Decimal`, `Disables`, `EMULATED`, `Emulated`, `Enables`, `ExecAlgorithmId`, `FOK`, `False`, `GNU`, `GTC`, `GTD` *(+62 more)*
...
---
*Generated on 2025-11-18T21:55:05.822947Z*
