# Documentation: stop_market.pyx

## File Metadata

- **Path**: `nautilus_trader/model/orders/stop_market.pyx`
- **Size**: 16,464 bytes
- **Lines**: 367
- **Language**: Unknown
...
**Identifiers**: `ANY`, `AT_THE_CLOSE`, `AT_THE_OPEN`, `Additional`, `All`, `Any`, `BASIS`, `BID_ASK`, `BUY`, `CONDITIONS`, `ClientOrderId`, `Condition`, `ContingencyType`, `Copyright`, `Create`, `DAY`, `DEFAULT`, `Disables`, `EMULATED`, `Emulated`, `Enables`, `ExecAlgorithmId`, `FOK`, `False`, `GNU`, `GTC`, `GTD`, `General`, `IOC`, `InstrumentId` *(+53 more)*
...
---
*Generated on 2025-11-18T21:55:05.814093Z*
