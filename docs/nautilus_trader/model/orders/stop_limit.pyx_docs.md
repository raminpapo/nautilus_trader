# Documentation: stop_limit.pyx

## File Metadata

- **Path**: `nautilus_trader/model/orders/stop_limit.pyx`
- **Size**: 20,709 bytes
- **Lines**: 441
- **Language**: Unknown
...
**Identifiers**: `ANY`, `AT_THE_CLOSE`, `AT_THE_OPEN`, `All`, `Any`, `BASIS`, `BUY`, `CONDITIONS`, `ClientOrderId`, `Condition`, `ContingencyType`, `Copyright`, `Create`, `DAY`, `EMULATED`, `EmulationTrigger`, `ExecAlgorithmId`, `FOK`, `False`, `GNU`, `GTC`, `GTD`, `General`, `IOC`, `InstrumentId`, `KIND`, `LIMIT`, `Lesser`, `License`, `Licensed` *(+50 more)*
...
---
*Generated on 2025-11-18T21:55:05.810031Z*
