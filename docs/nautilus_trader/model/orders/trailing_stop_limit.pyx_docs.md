# Documentation: trailing_stop_limit.pyx

## File Metadata

- **Path**: `nautilus_trader/model/orders/trailing_stop_limit.pyx`
- **Size**: 21,415 bytes
- **Lines**: 450
- **Language**: Unknown
...
Total unique keywords extracted: 94


**Identifiers**: `ACCEPTED`, `ACTIVATION`, `ANY`, `AT_THE_CLOSE`, `AT_THE_OPEN`, `Additional`, `All`, `Any`, `BASIS`, `BID_ASK`, `BUY`, `CONDITIONS`, `ClientOrderId`, `Condition`, `ContingencyType`, `Copyright`, `Create`, `DAY`, `DEFAULT`, `Decimal`, `Disables`, `EMULATED`, `Emulated`, `Enables`, `ExecAlgorithmId`, `FOK`, `False`, `GNU`, `GTC`, `GTD` *(+64 more)*
...
---
*Generated on 2025-11-18T21:55:05.818670Z*
