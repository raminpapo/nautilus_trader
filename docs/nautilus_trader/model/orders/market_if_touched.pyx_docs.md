# Documentation: market_if_touched.pyx

## File Metadata

- **Path**: `nautilus_trader/model/orders/market_if_touched.pyx`
- **Size**: 16,239 bytes
- **Lines**: 363
- **Language**: Unknown
...
**Identifiers**: `ANY`, `AT_THE_CLOSE`, `AT_THE_OPEN`, `Additional`, `All`, `Any`, `BASIS`, `BID_ASK`, `BUY`, `CONDITIONS`, `ClientOrderId`, `Condition`, `ContingencyType`, `Copyright`, `Create`, `DAY`, `DEFAULT`, `Disables`, `EMULATED`, `Emulated`, `Enables`, `ExecAlgorithmId`, `FOK`, `False`, `GNU`, `GTC`, `GTD`, `General`, `IOC`, `InstrumentId` *(+57 more)*
...
---
*Generated on 2025-11-18T21:55:05.801889Z*
