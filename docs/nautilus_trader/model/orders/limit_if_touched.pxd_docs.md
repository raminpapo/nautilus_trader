# Documentation: limit_if_touched.pxd

## File Metadata

- **Path**: `nautilus_trader/model/orders/limit_if_touched.pxd`
- **Size**: 2,171 bytes
- **Lines**: 43
- **Language**: Unknown
...
**Identifiers**: `ANY`, `All`, `BASIS`, `CONDITIONS`, `Copyright`, `GNU`, `General`, `KIND`, `LIMIT`, `Lesser`, `License`, `Licensed`, `LimitIfTouchedOrder`, `Ltd`, `Nautech`, `None`, `Order`, `OrderInitialized`, `Price`, `Pty`, `Public`, `Quantity`, `STOP`, `See`, `Systems`, `The`, `TriggerType`, `UNIX`, `Unless`, `Version` *(+3 more)*
...
---
*Generated on 2025-11-18T21:55:05.787980Z*
