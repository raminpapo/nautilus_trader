# Documentation: limit_if_touched.pyx

## File Metadata

- **Path**: `nautilus_trader/model/orders/limit_if_touched.pyx`
- **Size**: 18,033 bytes
- **Lines**: 402
- **Language**: Unknown
...
**Identifiers**: `ANY`, `AT_THE_CLOSE`, `AT_THE_OPEN`, `Additional`, `All`, `Any`, `BASIS`, `BID_ASK`, `BUY`, `CONDITIONS`, `ClientOrderId`, `Condition`, `ContingencyType`, `Copyright`, `Create`, `DAY`, `DEFAULT`, `Disables`, `EMULATED`, `Emulated`, `Enables`, `ExecAlgorithmId`, `FOK`, `False`, `GNU`, `GTC`, `GTD`, `General`, `IOC`, `InstrumentId` *(+59 more)*
...
---
*Generated on 2025-11-18T21:55:05.790791Z*
