# Documentation: limit.pxd

## File Metadata

- **Path**: `nautilus_trader/model/orders/limit.pxd`
- **Size**: 1,770 bytes
- **Lines**: 40
- **Language**: Unknown
...
**Identifiers**: `ANY`, `All`, `BASIS`, `CONDITIONS`, `Copyright`, `GNU`, `General`, `KIND`, `LIMIT`, `Lesser`, `License`, `Licensed`, `LimitOrder`, `Ltd`, `Nautech`, `None`, `Order`, `OrderInitialized`, `Price`, `Pty`, `Public`, `Quantity`, `See`, `Systems`, `The`, `UNIX`, `Unless`, `Version`, `WARRANTIES`, `WITHOUT` *(+1 more)*
...
---
*Generated on 2025-11-18T21:55:05.783521Z*
