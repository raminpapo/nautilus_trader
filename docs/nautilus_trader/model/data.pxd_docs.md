# Documentation: data.pxd

## File Metadata

- **Path**: `nautilus_trader/model/data.pxd`
- **Size**: 14,638 bytes
- **Lines**: 527
- **Language**: Unknown
...
**Identifiers**: `ANY`, `Additional`, `AggregationSource`, `AggressorSide`, `All`, `BASIS`, `Bar`, `BarAggregation`, `BarIntervalType`, `BarSpecification`, `BarSpecification_t`, `BarType`, `BarType_t`, `Bar_t`, `BookAction`, `BookOrder`, `BookOrder_t`, `BookType`, `CONDITIONS`, `CVec`, `Copyright`, `CustomData`, `DAY`, `Data`, `DataType`, `Decimal`, `FundingRateUpdate`, `Further`, `GNU`, `General` *(+67 more)*
...
---
*Generated on 2025-11-18T21:55:05.626240Z*
