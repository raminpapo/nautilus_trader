# Documentation: `nautilus_trader/model/enums.py`
**Generated:** 2025-11-15T19:40:05.047458Z
**File Size:** 12042 bytes
**Extension:** .py
**Type:** text
...
- **Path:** `nautilus_trader/model/enums.py`
- **Size:** 12,042 bytes
- **Lines:** 396
- **Extension:** `.py`
- **Type:** text
...
This file is located at `nautilus_trader/model/enums.py` within the repository.

**Classes defined:** AccountType, AggregationSource, AggressorSide, AssetClass, BookAction, BookType, ContingencyType, CurrencyType, InstrumentClass, InstrumentCloseType and 15 more
