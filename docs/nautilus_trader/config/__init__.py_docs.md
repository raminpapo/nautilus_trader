# Documentation: `nautilus_trader/config/__init__.py`
**Generated:** 2025-11-15T19:40:04.712359Z
**File Size:** 6635 bytes
**Extension:** .py
**Type:** text
...
This file is located at `nautilus_trader/config/__init__.py` within the repository.
...
```python
import nautilus_trader.config.__init__
```
...
**Directory:** `nautilus_trader/config`
