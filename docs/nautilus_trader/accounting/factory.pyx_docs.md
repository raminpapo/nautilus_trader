# Documentation: `nautilus_trader/accounting/factory.pyx`
**Generated:** 2025-11-15T19:40:04.000094Z
**File Size:** 4776 bytes
**Extension:** .pyx
**Type:** text
...
This file is located at `nautilus_trader/accounting/factory.pyx` within the repository.

**Functions defined:** register_account_type, register_calculated_account, register_cash_borrowing, create
...
#### `register_account_type(str issuer, type account_cls)`


#### `register_calculated_account(str issuer)`


#### `register_cash_borrowing(str issuer)`


#### `create(AccountState event)`
