# Documentation: calculators.pyx

## File Metadata

- **Path**: `nautilus_trader/accounting/calculators.pyx`
- **Size**: 4,785 bytes
- **Lines**: 121
- **Language**: Unknown
...
**Identifiers**: `ANY`, `AUD`, `AUS`, `All`, `BASIS`, `CAD`, `CAN`, `CHE`, `CHF`, `CHN`, `CNH`, `CNY`, `CONDITIONS`, `Condition`, `Copyright`, `Currency`, `DataFrame`, `Decimal`, `EA19`, `EUR`, `Extract`, `FutureWarning`, `GBP`, `GBR`, `GNU`, `General`, `InstrumentId`, `JPN`, `JPY`, `KIND` *(+42 more)*
...
---
*Generated on 2025-11-18T21:55:04.427486Z*
