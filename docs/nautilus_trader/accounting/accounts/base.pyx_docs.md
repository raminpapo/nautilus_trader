# Documentation: `nautilus_trader/accounting/accounts/base.pyx`
**Generated:** 2025-11-15T19:40:03.982499Z
...
This file is located at `nautilus_trader/accounting/accounts/base.pyx` within the repository.

**Functions defined:** __init__, __eq__, __hash__, __repr__, last_event, events, event_count
...
#### `__init__(self, AccountState event, bint calculate_account_state)`


#### `__eq__(self, Account other)`
