# Documentation: margin.pyx

## File Metadata

- **Path**: `nautilus_trader/accounting/accounts/margin.pyx`
- **Size**: 23,961 bytes
- **Lines**: 749
- **Language**: Unknown
...
Total unique keywords extracted: 78


**Identifiers**: `ANY`, `Account`, `AccountBalance`, `AccountState`, `AccountType`, `All`, `BASIS`, `BUY`, `CALCULATIONS`, `COMMANDS`, `CONDITIONS`, `Calculate`, `Clamp`, `Clear`, `Condition`, `Copyright`, `Currency`, `Decimal`, `Default`, `False`, `GNU`, `General`, `Instrument`, `InstrumentId`, `KIND`, `LONG`, `Lesser`, `LeveragedMarginModel`, `License`, `Licensed` *(+48 more)*
...
---
*Generated on 2025-11-18T21:55:04.424685Z*
