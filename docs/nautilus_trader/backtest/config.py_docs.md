...
- **Path**: `nautilus_trader/backtest/config.py`
- **Size**: 28,280 bytes
- **Lines**: 812
- **Language**: Python
...
This file is part of the NautilusTrader repository. It defines 1 function(s) and 20 class(es).

## Detailed Walkthrough

### Functions
- **`parse_filters_expr()`**: Function defined in this file

### Classes
- **`BacktestVenueConfig`**: Class defined in this file
- **`BacktestDataConfig`**: Class defined in this file
- **`BacktestEngineConfig`**: Class defined in this file
- **`BacktestRunConfig`**: Class defined in this file
- **`SimulationModuleConfig`**: Class defined in this file
- **`FillModelConfig`**: Class defined in this file
- **`ImportableFillModelConfig`**: Class defined in this file
- **`FillModelFactory`**: Class defined in this file
- **`LatencyModelConfig`**: Class defined in this file
- **`ImportableLatencyModelConfig`**: Class defined in this file
- **`LatencyModelFactory`**: Class defined in this file
- **`FeeModelConfig`**: Class defined in this file
- **`MakerTakerFeeModelConfig`**: Class defined in this file
- **`FixedFeeModelConfig`**: Class defined in this file
- **`PerContractFeeModelConfig`**: Class defined in this file
- **`ImportableFeeModelConfig`**: Class defined in this file
- **`FeeModelFactory`**: Class defined in this file
- **`FXRolloverInterestConfig`**: Class defined in this file
- **`MarginModelConfig`**: Class defined in this file
- **`MarginModelFactory`**: Class defined in this file
...
**Classs**: `BacktestDataConfig`, `BacktestEngineConfig`, `BacktestRunConfig`, `BacktestVenueConfig`, `FXRolloverInterestConfig`, `FeeModelConfig`, `FeeModelFactory`, `FillModelConfig`, `FillModelFactory`, `FixedFeeModelConfig`, `ImportableFeeModelConfig`, `ImportableFillModelConfig`, `ImportableLatencyModelConfig`, `LatencyModelConfig`, `LatencyModelFactory`, `MakerTakerFeeModelConfig`, `MarginModelConfig`, `MarginModelFactory`, `PerContractFeeModelConfig`, `SimulationModuleConfig`
**Functions**: `parse_filters_expr`
**Imports**: `__future__`, `msgspec`, `nautilus_trader.cache.config`, `nautilus_trader.common`, `nautilus_trader.common.config`, `nautilus_trader.core.correctness`, `nautilus_trader.core.datetime`, `nautilus_trader.data.config`, `nautilus_trader.execution.config`, `nautilus_trader.live.config`, `nautilus_trader.model.data`, `nautilus_trader.model.enums`, `nautilus_trader.model.identifiers`, `nautilus_trader.risk.config`, `nautilus_trader.system.config`, `pandas`, `sys`, `typing`
...
```bash
# For Python
pytest nautilus_trader/backtest/config.py
...
⚠️ **Security**: This file contains dynamic code execution. Validate all inputs carefully.

---
*Generated on 2025-11-18T21:55:05.035720Z*
