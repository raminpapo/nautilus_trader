# Documentation: `nautilus_trader/backtest/config.py`
**Generated:** 2025-11-15T19:40:04.538579Z
...
This file is located at `nautilus_trader/backtest/config.py` within the repository.

**Classes defined:** BacktestVenueConfig, BacktestDataConfig, BacktestEngineConfig, BacktestRunConfig, SimulationModuleConfig, FillModelConfig, ImportableFillModelConfig, FillModelFactory, LatencyModelConfig, ImportableLatencyModelConfig and 10 more

**Functions defined:** parse_filters_expr, data_type, query, start_time_nanos, end_time_nanos, __post_init__, create, create, create, create
...
**Inherits from:** NautilusKernelConfig, frozen=True
...
**Inherits from:** FeeModelConfig, frozen=True
...
#### `create(config: MarginModelConfig)`
