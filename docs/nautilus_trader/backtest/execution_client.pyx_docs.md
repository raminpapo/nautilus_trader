# Documentation: execution_client.pyx
...
**Identifiers**: `ANY`, `AccountFactory`, `AccountId`, `AccountType`, `All`, `BASIS`, `BacktestEngine`, `BacktestExecClient`, `BatchCancelOrders`, `CASH`, `COMMAND`, `CONDITIONS`, `Cache`, `CancelAllOrders`, `CancelOrder`, `ClientId`, `Condition`, `Connected`, `Connecting`, `Copyright`, `Disconnected`, `Disconnecting`, `ExecutionClient`, `False`, `GNU`, `General`, `HANDLERS`, `KIND`, `Lesser`, `License` *(+26 more)*
...
```bash
# For Python
pytest nautilus_trader/backtest/execution_client.pyx
...
---
*Generated on 2025-11-18T21:55:05.082721Z*
