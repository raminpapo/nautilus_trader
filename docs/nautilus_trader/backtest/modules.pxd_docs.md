...
**Identifiers**: `ANY`, `Actor`, `All`, `BASIS`, `CONDITIONS`, `Copyright`, `Data`, `FXRolloverInterestModule`, `GNU`, `General`, `KIND`, `Lesser`, `License`, `Licensed`, `Logger`, `Ltd`, `Nautech`, `Pty`, `Public`, `RolloverInterestCalculator`, `See`, `SimulatedExchange`, `SimulationModule`, `Systems`, `Unless`, `Version`, `WARRANTIES`, `WITHOUT`, `You`
...
```bash
# For Python
pytest nautilus_trader/backtest/modules.pxd
...
---
*Generated on 2025-11-18T21:55:05.101880Z*
