# Documentation: option_exercise.pyx
...
Total unique keywords extracted: 123


**Identifiers**: `ANY`, `All`, `BASIS`, `BUY`, `Base`, `CALL`, `CASH_SETTLE_`, `CONDITIONS`, `Calculate`, `Call`, `Cancel`, `Cannot`, `Cash`, `Check`, `Clean`, `Cleaned`, `ClientOrderId`, `Close`, `Closed`, `Copyright`, `Create`, `CryptoOption`, `Data`, `Determine`, `EXERCISE_`, `EXERCISE_CLOSE_`, `EXERCISE_OPEN_`, `EXPIRY`, `Equity`, `ExecEngine` *(+93 more)*
...
```bash
# For Python
pytest nautilus_trader/backtest/option_exercise.pyx
...
---
*Generated on 2025-11-18T21:55:05.117792Z*
