# Documentation: `nautilus_trader/backtest/option_exercise.pyx`
**Generated:** 2025-11-15T19:40:04.604015Z
**File Size:** 24771 bytes
**Extension:** .pyx
**Type:** text
...
- **Path:** `nautilus_trader/backtest/option_exercise.pyx`
- **Size:** 24,771 bytes
- **Lines:** 589
- **Extension:** `.pyx`
- **Type:** text
...
This file is located at `nautilus_trader/backtest/option_exercise.pyx` within the repository.

**Classes defined:** OptionExerciseConfig

**Functions defined:** __init__, on_position_event, _cleanup_timer_if_no_positions, _on_expiry_timer, _process_expiring_options, _process_option_expiry, _get_underlying_price, _should_exercise, _is_option_itm, _generate_otm_expiry_events and 9 more
...
**Inherits from:** SimulationModuleConfig, frozen=True


### Functions

#### `__init__(self, config: OptionExerciseConfig)`


#### `on_position_event(self, event)`


#### `_cleanup_timer_if_no_positions(self, expiry_ns: int)`


#### `_on_expiry_timer(self, event: TimeEvent)`


#### `_process_expiring_options(self, ts_now: int)`


#### `_process_option_expiry(self, option: OptionContract | CryptoOption, ts_now: int)`


#### `_get_underlying_price(self, option: OptionContract | CryptoOption)`


#### `_should_exercise(self, option: OptionContract | CryptoOption, underlying_price: Price)`
...
#### `_calculate_underlying_position(
        self,
        option: OptionContract | CryptoOption,
        position,
    )`
...
#### `_generate_cash_settlement_events(
        self,
        option: OptionContract | CryptoOption,
        position: Position,
        underlying_price: Price,
...
#### `_create_cash_settlement_fill(self, option, position, settlement_price: Price,
                                     trade_id_suffix: str, venue_id_suffix: str, ts_now: int)`


#### `_generate_physical_settlement_events(
        self,
        option: OptionContract | CryptoOption,
        position: Position,
        underlying_instrument,
...
#### `_calculate_settlement_price(self, option, underlying_price: Price)`


#### `_create_option_fill(self, option, position, trade_id_suffix: str, venue_id_suffix: str, ts_now: int, use_avg_price: bool = True)`


#### `_create_underlying_fill(self, position, underlying_instrument, quantity: Quantity, side: PositionSide,
                               price: Price, trade_id_suffix: str, venue_id_suffix: str, ts_now: int)`


#### `_send_events(self, events: list)`
