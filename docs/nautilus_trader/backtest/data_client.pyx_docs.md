# Documentation: data_client.pyx

## File Metadata

- **Path**: `nautilus_trader/backtest/data_client.pyx`
- **Size**: 26,583 bytes
- **Lines**: 652
- **Language**: Unknown
...
Total unique keywords extracted: 112


**Identifiers**: `AGGREGATORS`, `ANY`, `All`, `BASIS`, `BacktestDataClient`, `BacktestEngine`, `BacktestMarketDataClient`, `Bar`, `CONDITIONS`, `Cache`, `Cannot`, `Check`, `ClientId`, `Clock`, `Condition`, `Connected`, `Connecting`, `Copyright`, `Create`, `Created`, `DataClient`, `DataEngine`, `Disconnected`, `Disconnecting`, `Ensure`, `Exception`, `Failed`, `False`, `FundingRateUpdate`, `GNU` *(+82 more)*
...
```bash
# For Python
pytest nautilus_trader/backtest/data_client.pyx
...
---
*Generated on 2025-11-18T21:55:05.040512Z*
