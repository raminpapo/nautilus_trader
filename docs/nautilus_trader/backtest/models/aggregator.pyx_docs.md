# Documentation: aggregator.pyx

## File Metadata

- **Path**: `nautilus_trader/backtest/models/aggregator.pyx`
- **Size**: 9,468 bytes
- **Lines**: 223
- **Language**: Unknown
...
**Identifiers**: `ANY`, `All`, `Allow`, `BASIS`, `Bid`, `CONDITIONS`, `CacheFacade`, `Calculate`, `Callable`, `Cannot`, `Check`, `Clock`, `Component`, `Condition`, `Copyright`, `Create`, `Fallback`, `Filter`, `Fire`, `GNU`, `General`, `Get`, `GreeksCalculator`, `Instrument`, `InstrumentId`, `KIND`, `Lesser`, `License`, `Licensed`, `Logger` *(+27 more)*
...
```bash
# For Python
pytest nautilus_trader/backtest/models/aggregator.pyx
...
---
*Generated on 2025-11-18T21:55:05.089197Z*
