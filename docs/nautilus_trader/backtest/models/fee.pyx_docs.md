# Documentation: fee.pyx

## File Metadata

- **Path**: `nautilus_trader/backtest/models/fee.pyx`
- **Size**: 6,608 bytes
- **Lines**: 208
- **Language**: Unknown
...
**Identifiers**: `ANY`, `All`, `BASIS`, `CONDITIONS`, `Condition`, `Copyright`, `False`, `FeeModel`, `FixedFeeModel`, `FixedFeeModelConfig`, `GNU`, `General`, `Initialize`, `Instrument`, `KIND`, `Lesser`, `License`, `Licensed`, `LiquiditySide`, `Ltd`, `MAKER`, `MakerTakerFeeModel`, `MakerTakerFeeModelConfig`, `Method`, `Money`, `NANOSECONDS_IN_MILLISECOND`, `Nautech`, `None`, `Not`, `NotImplementedError` *(+26 more)*
...
```bash
# For Python
pytest nautilus_trader/backtest/models/fee.pyx
...
---
*Generated on 2025-11-18T21:55:05.092772Z*
