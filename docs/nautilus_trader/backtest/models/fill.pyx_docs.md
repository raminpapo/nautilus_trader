# Documentation: `nautilus_trader/backtest/models/fill.pyx`
**Generated:** 2025-11-15T19:40:04.589583Z
**File Size:** 26967 bytes
**Extension:** .pyx
**Type:** text
...
- **Path:** `nautilus_trader/backtest/models/fill.pyx`
- **Size:** 26,967 bytes
- **Lines:** 842
- **Extension:** `.pyx`
- **Type:** text
...
This file is located at `nautilus_trader/backtest/models/fill.pyx` within the repository.

**Classes defined:** BestPriceFillModel, OneTickSlippageFillModel, TwoTierFillModel, ProbabilisticFillModel, SizeAwareFillModel, LimitOrderPartialFillModel, ThreeTierFillModel, MarketHoursFillModel, VolumeSensitiveFillModel, CompetitionAwareFillModel

**Functions defined:** __init__, get_orderbook_for_fill_simulation, get_orderbook_for_fill_simulation, get_orderbook_for_fill_simulation, get_orderbook_for_fill_simulation, get_orderbook_for_fill_simulation, get_orderbook_for_fill_simulation, get_orderbook_for_fill_simulation, __init__, is_low_liquidity_period and 7 more
...
#### `set_recent_volume(self, volume: float)`
