...
**Identifiers**: `ANY`, `Add`, `All`, `Available`, `BASIS`, `BUY`, `BestPriceFillModel`, `BookOrder`, `BookType`, `CONDITIONS`, `Can`, `Check`, `CompetitionAwareFillModel`, `Condition`, `Copyright`, `Creates`, `Default`, `Distributes`, `During`, `Essential`, `False`, `Fill`, `FillModel`, `FillModelConfig`, `First`, `For`, `GNU`, `General`, `Ideal`, `Implements` *(+62 more)*
...
```bash
# For Python
pytest nautilus_trader/backtest/models/fill.pyx
...
---
*Generated on 2025-11-18T21:55:05.097675Z*
