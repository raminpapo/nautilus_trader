# Documentation: engine.pxd

## File Metadata

- **Path**: `nautilus_trader/backtest/engine.pxd`
- **Size**: 24,960 bytes
- **Lines**: 550
- **Language**: Unknown
...
**Identifiers**: `ANY`, `Account`, `AccountId`, `AccountType`, `AggressorSide`, `All`, `BASIS`, `BacktestDataIterator`, `BacktestEngine`, `BacktestExecClient`, `Bar`, `BatchCancelOrders`, `BookOrder`, `BookType`, `COMMANDS`, `CONDITIONS`, `CVec`, `Cache`, `CacheFacade`, `CancelAllOrders`, `CancelOrder`, `ClientOrderId`, `Clock`, `Copyright`, `Currency`, `DATA`, `Data`, `DataCommand`, `DataEngine`, `DataResponse` *(+86 more)*
...
```bash
# For Python
pytest nautilus_trader/backtest/engine.pxd
...
---
*Generated on 2025-11-18T21:55:05.043929Z*
