...
Total unique keywords extracted: 464


**Identifiers**: `ACCEPTED`, `ACCOUNT`, `ANY`, `API`, `ASK`, `AT_THE_CLOSE`, `AT_THE_OPEN`, `Account`, `AccountBalance`, `AccountError`, `AccountId`, `AccountType`, `Accounting`, `Activated`, `Actor`, `Add`, `Added`, `Adding`, `Adds`, `Adjust`, `Advance`, `AggregationSource`, `AggressorSide`, `All`, `Already`, `Also`, `Always`, `Apply`, `Applying`, `Architecture` *(+434 more)*
...
```bash
# For Python
pytest nautilus_trader/backtest/engine.pyx
...
---
*Generated on 2025-11-18T21:55:05.077043Z*
