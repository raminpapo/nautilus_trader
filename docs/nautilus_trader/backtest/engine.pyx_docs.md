# Documentation: `nautilus_trader/backtest/engine.pyx`
**Generated:** 2025-11-15T19:40:04.571220Z
**File Size:** 250791 bytes
**Extension:** .pyx
**Type:** text
...
- **Path:** `nautilus_trader/backtest/engine.pyx`
- **Size:** 250,791 bytes
- **Lines:** 6,456
- **Extension:** `.pyx`
- **Type:** text
...
This file is located at `nautilus_trader/backtest/engine.pyx` within the repository.

**Functions defined:** __init__, __del__, trader_id, machine_id, instance_id, kernel, logger, run_config_id, run_id, iteration and 52 more
...
#### `__init__(self, config: BacktestEngineConfig | None = None)`
...
#### `get_next_time_range(data_received)`
...
#### `add_exec_algorithm(self, exec_algorithm: ExecAlgorithm)`


#### `add_exec_algorithms(self, exec_algorithms: list[ExecAlgorithm])`
...
#### `_get_log_color_code(self)`


#### `_log_pre_run(self)`


#### `_log_run(self, start: pd.Timestamp, end: pd.Timestamp)`
