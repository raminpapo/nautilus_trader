# Documentation: modules.pyx

## File Metadata

- **Path**: `nautilus_trader/backtest/modules.pyx`
- **Size**: 8,547 bytes
- **Lines**: 222
- **Language**: Unknown
...
**Identifiers**: `ANY`, `Abstract`, `Actor`, `ActorConfig`, `All`, `AssetClass`, `BASIS`, `BacktestEngine`, `Book`, `CONDITIONS`, `Check`, `Condition`, `Copyright`, `Currency`, `Data`, `DataFrame`, `Eastern`, `FXRolloverInterestConfig`, `FXRolloverInterestModule`, `False`, `Fridays`, `GNU`, `General`, `Initialized`, `Instrument`, `InstrumentId`, `KIND`, `Lesser`, `License`, `Licensed` *(+43 more)*
...
```bash
# For Python
pytest nautilus_trader/backtest/modules.pyx
...
---
*Generated on 2025-11-18T21:55:05.104150Z*
