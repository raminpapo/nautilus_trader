# Documentation: `nautilus_trader/backtest/modules.pyx`
**Generated:** 2025-11-15T19:40:04.594992Z
...
This file is located at `nautilus_trader/backtest/modules.pyx` within the repository.

**Functions defined:** __init__, __repr__, __init__
...
#### `__init__(self, config: SimulationModuleConfig)`


#### `__repr__(self)`


#### `__init__(self, config: FXRolloverInterestConfig)`
