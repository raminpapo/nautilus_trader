# Documentation: `nautilus_trader/backtest/node.py`
**Generated:** 2025-11-15T19:40:04.598338Z
**File Size:** 30192 bytes
**Extension:** .py
**Type:** text
...
This file is located at `nautilus_trader/backtest/node.py` within the repository.

**Classes defined:** BacktestNode

**Functions defined:** __init__, configs, get_log_guard, get_engine, get_engines, dispose, _validate_configs, add_data_client_factory, build, setup_download_engine and 23 more
...
#### `__init__(self, configs: list[BacktestRunConfig])`
...
#### `get_engine(self, run_config_id: str)`
...
#### `_validate_configs(self, configs: list[BacktestRunConfig])`
...
#### `_create_engine(self, run_config_id: str)`


#### `_build_data_clients(self, run_config_id: str)`
...
#### `load_catalog(cls, config: BacktestDataConfig)`
...
#### `log_backtest_exception(self, e: Exception, config: BacktestRunConfig)`


#### `get_instrument_ids(config: BacktestDataConfig)`


#### `get_oms_type(config: BacktestVenueConfig)`


#### `get_account_type(config: BacktestVenueConfig)`


#### `get_book_type(config: BacktestVenueConfig)`


#### `get_starting_balances(config: BacktestVenueConfig)`


#### `get_base_currency(config: BacktestVenueConfig)`


#### `get_leverages(config: BacktestVenueConfig)`


#### `get_price_protection_points(config: BacktestVenueConfig)`


#### `get_fill_model(config: BacktestVenueConfig)`


#### `get_latency_model(config: BacktestVenueConfig)`


#### `get_fee_model(config: BacktestVenueConfig)`


#### `get_margin_model(config: BacktestVenueConfig)`
