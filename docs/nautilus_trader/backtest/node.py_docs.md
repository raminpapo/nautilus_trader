...
- **Path**: `nautilus_trader/backtest/node.py`
- **Size**: 30,192 bytes
- **Lines**: 834
- **Language**: Python
...
### Functions
- **`get_instrument_ids()`**: Function defined in this file
- **`get_oms_type()`**: Function defined in this file
- **`get_account_type()`**: Function defined in this file
- **`get_book_type()`**: Function defined in this file
- **`get_starting_balances()`**: Function defined in this file
- **`get_base_currency()`**: Function defined in this file
- **`get_leverages()`**: Function defined in this file
- **`get_price_protection_points()`**: Function defined in this file
- **`get_fill_model()`**: Function defined in this file
- **`get_latency_model()`**: Function defined in this file
- **`get_fee_model()`**: Function defined in this file
- **`get_margin_model()`**: Function defined in this file

### Classes
- **`BacktestNode`**: Class defined in this file
...
**Classs**: `BacktestNode`
**Functions**: `get_account_type`, `get_base_currency`, `get_book_type`, `get_fee_model`, `get_fill_model`, `get_instrument_ids`, `get_latency_model`, `get_leverages`, `get_margin_model`, `get_oms_type`, `get_price_protection_points`, `get_starting_balances`
**Imports**: `decimal`, `json`, `nautilus_trader.backtest.config`, `nautilus_trader.backtest.engine`, `nautilus_trader.backtest.models`, `nautilus_trader.backtest.node_builder`, `nautilus_trader.backtest.results`, `nautilus_trader.common.actor`, `nautilus_trader.common.component`, `nautilus_trader.common.config`, `nautilus_trader.common.enums`, `nautilus_trader.config`, `nautilus_trader.core`, `nautilus_trader.core.correctness`, `nautilus_trader.core.datetime`, `nautilus_trader.core.inspect`, `nautilus_trader.core.nautilus_pyo3`, `nautilus_trader.live.factories`, `nautilus_trader.model`, `nautilus_trader.model.data`, `nautilus_trader.model.enums`, `nautilus_trader.model.identifiers`, `nautilus_trader.model.objects`, `nautilus_trader.persistence.catalog.parquet`, `nautilus_trader.persistence.catalog.types`, `nautilus_trader.persistence.config`, `pandas`
...
```bash
# For Python
pytest nautilus_trader/backtest/node.py
...
---
*Generated on 2025-11-18T21:55:05.109529Z*
