# Documentation: portfolio.pyx

## File Metadata

- **Path**: `nautilus_trader/portfolio/portfolio.pyx`
- **Size**: 67,481 bytes
- **Lines**: 1,916
- **Language**: Unknown
...
Total unique keywords extracted: 187


**Identifiers**: `ANY`, `ASK`, `Account`, `AccountFactory`, `AccountId`, `AccountState`, `AccountType`, `AccountsManager`, `Accumulate`, `Actions`, `Add`, `Added`, `Adding`, `All`, `Already`, `Always`, `Apply`, `Applying`, `AvgLoser`, `AvgWinner`, `BASIS`, `BID`, `BLUE`, `BUY`, `Bar`, `Bet`, `BetPosition`, `BettingInstrument`, `Build`, `CLOSED` *(+157 more)*
...
---
*Generated on 2025-11-18T21:55:05.895537Z*
