...
- **Path**: `nautilus_trader/execution/messages.pxd`
- **Size**: 9,108 bytes
- **Lines**: 232
- **Language**: Unknown
...
**Identifiers**: `ANY`, `AccountId`, `Additional`, `All`, `BASIS`, `BatchCancelOrders`, `CONDITIONS`, `CancelAllOrders`, `CancelOrder`, `ClientId`, `ClientOrderId`, `Command`, `Copyright`, `ExecAlgorithmId`, `ExecutionReportCommand`, `GNU`, `General`, `GenerateExecutionMassStatus`, `GenerateFillReports`, `GenerateOrderStatusReport`, `GenerateOrderStatusReports`, `GeneratePositionStatusReports`, `InstrumentId`, `KIND`, `Lesser`, `License`, `Licensed`, `LogLevel`, `Ltd`, `ModifyOrder` *(+28 more)*
...
---
*Generated on 2025-11-18T21:55:05.510534Z*
