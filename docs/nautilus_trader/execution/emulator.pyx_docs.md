# Documentation: emulator.pyx

## File Metadata

- **Path**: `nautilus_trader/execution/emulator.pyx`
- **Size**: 39,183 bytes
- **Lines**: 982
- **Language**: Unknown
...
Total unique keywords extracted: 154


**Identifiers**: `ACTION`, `ANY`, `ASK`, `Actor`, `All`, `Already`, `BASIS`, `BID`, `BID_ASK`, `BLUE`, `BUY`, `CMD`, `CONDITIONS`, `CYAN`, `Cache`, `CancelAllOrders`, `CancelOrder`, `Canceling`, `Cannot`, `Cast`, `Check`, `ClientId`, `ClientOrderId`, `Clock`, `Condition`, `Configuration`, `ContingencyType`, `Copyright`, `Could`, `Counters` *(+124 more)*
...
---
*Generated on 2025-11-18T21:55:05.491317Z*
