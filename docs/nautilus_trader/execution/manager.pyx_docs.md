# Documentation: manager.pyx

## File Metadata

- **Path**: `nautilus_trader/execution/manager.pyx`
- **Size**: 24,589 bytes
- **Lines**: 600
- **Language**: Unknown
...
**Identifiers**: `ANY`, `Algorithm`, `All`, `Already`, `BASIS`, `CMD`, `CONDITIONS`, `Cache`, `Callable`, `Cancel`, `CancelAllOrders`, `CancelOrder`, `Canceling`, `Cannot`, `Check`, `ClientId`, `ClientOrderId`, `Clock`, `Command`, `Condition`, `ContingencyType`, `Copyright`, `Create`, `Creating`, `Determine`, `EGRESS`, `EVENT`, `EVT`, `Emulator`, `Event` *(+75 more)*
...
---
*Generated on 2025-11-18T21:55:05.504651Z*
