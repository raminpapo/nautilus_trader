# Documentation: client.pxd

## File Metadata

- **Path**: `nautilus_trader/execution/client.pxd`
- **Size**: 7,798 bytes
- **Lines**: 205
- **Language**: Unknown
...
**Identifiers**: `ANY`, `Account`, `AccountId`, `AccountState`, `AccountType`, `All`, `BASIS`, `BatchCancelOrders`, `COMMAND`, `CONDITIONS`, `Cache`, `CancelAllOrders`, `CancelOrder`, `ClientOrderId`, `Component`, `Copyright`, `Currency`, `EVENT`, `ExecutionClient`, `GNU`, `General`, `HANDLERS`, `InstrumentId`, `KIND`, `Lesser`, `License`, `Licensed`, `LiquiditySide`, `Ltd`, `ModifyOrder` *(+28 more)*
...
---
*Generated on 2025-11-18T21:55:05.479911Z*
