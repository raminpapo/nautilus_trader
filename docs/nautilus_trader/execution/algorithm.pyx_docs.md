# Documentation: algorithm.pyx

## File Metadata

- **Path**: `nautilus_trader/execution/algorithm.pyx`
- **Size**: 53,612 bytes
- **Lines**: 1,487
- **Language**: Unknown
...
Total unique keywords extracted: 175


**Identifiers**: `ACTION`, `ANY`, `API`, `AT_THE_CLOSE`, `AT_THE_OPEN`, `Actions`, `Actor`, `Additional`, `Algorithm`, `All`, `Already`, `Always`, `Any`, `Assign`, `BASIS`, `BID_ASK`, `BLUE`, `CMD`, `COMMANDS`, `CONDITIONS`, `CacheFacade`, `Cancel`, `CancelOrder`, `Cannot`, `ClientId`, `ClientOrderId`, `Clock`, `Command`, `ComponentState`, `Condition` *(+145 more)*
...
---
*Generated on 2025-11-18T21:55:05.477384Z*
