# Documentation: algorithm.pxd

## File Metadata

- **Path**: `nautilus_trader/execution/algorithm.pxd`
- **Size**: 8,570 bytes
- **Lines**: 193
- **Language**: Unknown
...
**Identifiers**: `ANY`, `Actor`, `All`, `BASIS`, `COMMANDS`, `CONDITIONS`, `CacheFacade`, `CancelOrder`, `ClientId`, `ClientOrderId`, `Clock`, `Command`, `ContingencyType`, `Copyright`, `EGRESS`, `EVENT`, `EVENTS`, `Event`, `ExecAlgorithm`, `GNU`, `General`, `HANDLERS`, `INTERNAL`, `KIND`, `Lesser`, `License`, `Licensed`, `LimitOrder`, `Ltd`, `MarketOrder` *(+49 more)*
...
---
*Generated on 2025-11-18T21:55:05.462814Z*
