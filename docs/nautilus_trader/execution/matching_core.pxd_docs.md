# Documentation: matching_core.pxd

## File Metadata

- **Path**: `nautilus_trader/execution/matching_core.pxd`
- **Size**: 3,797 bytes
- **Lines**: 87
- **Language**: Unknown
...
**Identifiers**: `ANY`, `All`, `BASIS`, `COMMANDS`, `CONDITIONS`, `ClientOrderId`, `Copyright`, `GNU`, `General`, `InstrumentId`, `KIND`, `Lesser`, `License`, `Licensed`, `LiquiditySide`, `Ltd`, `MATCHING`, `MatchingCore`, `Nautech`, `Order`, `OrderSide`, `Price`, `PriceRaw`, `Pty`, `Public`, `QUERIES`, `See`, `Systems`, `Unless`, `Version` *(+3 more)*
...
---
*Generated on 2025-11-18T21:55:05.506188Z*
