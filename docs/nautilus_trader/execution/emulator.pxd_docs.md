# Documentation: emulator.pxd

## File Metadata

- **Path**: `nautilus_trader/execution/emulator.pxd`
- **Size**: 4,108 bytes
- **Lines**: 78
- **Language**: Unknown
...
**Identifiers**: `ANY`, `Actor`, `All`, `BASIS`, `CONDITIONS`, `CancelAllOrders`, `CancelOrder`, `ClientId`, `Copyright`, `GNU`, `General`, `InstrumentId`, `KIND`, `Lesser`, `License`, `Licensed`, `Ltd`, `MatchingCore`, `ModifyOrder`, `Nautech`, `Order`, `OrderCanceled`, `OrderEmulator`, `OrderEvent`, `OrderExpired`, `OrderFilled`, `OrderManager`, `OrderRejected`, `OrderUpdated`, `PositionEvent` *(+17 more)*
...
---
*Generated on 2025-11-18T21:55:05.487214Z*
