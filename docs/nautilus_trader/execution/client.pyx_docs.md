# Documentation: client.pyx

## File Metadata

- **Path**: `nautilus_trader/execution/client.pyx`
- **Size**: 31,642 bytes
- **Lines**: 894
- **Language**: Unknown
...
Total unique keywords extracted: 118


**Identifiers**: `ANY`, `Account`, `AccountBalance`, `AccountId`, `AccountState`, `AccountType`, `All`, `BASIS`, `BUY`, `Batch`, `BatchCancelOrders`, `COMMAND`, `CONDITIONS`, `Cache`, `Cancel`, `CancelAllOrders`, `CancelOrder`, `Cannot`, `Check`, `ClientId`, `ClientOrderId`, `Clock`, `Component`, `Condition`, `Copyright`, `Currency`, `EVENT`, `ExecClient`, `ExecEngine`, `ExecutionClient` *(+88 more)*
...
---
*Generated on 2025-11-18T21:55:05.484061Z*
