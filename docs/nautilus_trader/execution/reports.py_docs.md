# Documentation: `nautilus_trader/execution/reports.py`
**Generated:** 2025-11-15T19:40:04.938562Z
**File Size:** 49774 bytes
**Extension:** .py
**Type:** text
...
- **Path:** `nautilus_trader/execution/reports.py`
- **Size:** 49,774 bytes
- **Lines:** 1,247
- **Extension:** `.py`
- **Type:** text
...
This file is located at `nautilus_trader/execution/reports.py` within the repository.

**Classes defined:** ExecutionReport, OrderStatusReport, FillReport, PositionStatusReport, ExecutionMassStatus

**Functions defined:** __init__, __init__, is_open, __eq__, __repr__, to_dict, from_dict, to_pyo3, from_pyo3, __init__ and 24 more

**Import statements:** 53
...
#### `from_dict(cls, values: dict[str, Any])`


#### `to_pyo3(self)`


#### `from_pyo3(pyo3_report: nautilus_pyo3.OrderStatusReport)`
...
#### `from_pyo3(pyo3_report: nautilus_pyo3.FillReport)`
...
#### `from_pyo3(pyo3_report: nautilus_pyo3.PositionStatusReport)`
...
#### `add_order_reports(self, reports: list[OrderStatusReport])`


#### `add_fill_reports(self, reports: list[FillReport])`


#### `add_position_reports(self, reports: list[PositionStatusReport])`
