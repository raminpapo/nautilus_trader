# Documentation: trailing.pyx

## File Metadata

- **Path**: `nautilus_trader/execution/trailing.pyx`
- **Size**: 16,759 bytes
- **Lines**: 345
- **Language**: Unknown
...
**Identifiers**: `ANY`, `ASK`, `All`, `BASIS`, `BASIS_POINTS`, `BID`, `BID_ASK`, `BUY`, `CONDITIONS`, `Condition`, `Copyright`, `DEFAULT`, `GNU`, `General`, `KIND`, `LAST`, `LAST_OR_BID_ASK`, `LAST_PRICE`, `Lesser`, `License`, `Licensed`, `Ltd`, `MARK_PRICE`, `Nautech`, `None`, `Offset`, `Order`, `OrderSide`, `OrderType`, `PRICE` *(+21 more)*
...
---
*Generated on 2025-11-18T21:55:05.526791Z*
