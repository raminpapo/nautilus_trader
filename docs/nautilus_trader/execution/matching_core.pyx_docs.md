# Documentation: matching_core.pyx

## File Metadata

- **Path**: `nautilus_trader/execution/matching_core.pyx`
- **Size**: 16,420 bytes
- **Lines**: 460
- **Language**: Unknown
...
Total unique keywords extracted: 70


**Identifiers**: `ANY`, `All`, `BASIS`, `BUY`, `COMMANDS`, `CONDITIONS`, `Callable`, `Check`, `ClientOrderId`, `Condition`, `Copyright`, `Event`, `False`, `GNU`, `General`, `Index`, `InstrumentId`, `KIND`, `LIMIT`, `LIMIT_IF_TOUCHED`, `Lesser`, `License`, `Licensed`, `LiquiditySide`, `Lists`, `Ltd`, `MAKER`, `MARKET`, `MARKET_IF_TOUCHED`, `MARKET_TO_LIMIT` *(+40 more)*
...
---
*Generated on 2025-11-18T21:55:05.508601Z*
