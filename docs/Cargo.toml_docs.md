...
Total unique keywords extracted: 203


**Keys**: `ahash`, `alloy`, `alloy-primitives`, `alloy-signer`, `alloy-signer-local`, `anyhow`, `arc-swap`, `arraydeque`, `arrow`, `async-stream`, `async-trait`, `authors`, `aws-lc-rs`, `axum`, `base64`, `binary-heap-plus`, `bip32`, `bytes`, `capnp`, `capnpc`, `cargo-audit`, `cargo-deny`, `cargo-llvm-cov`, `cargo-nextest`, `categories`, `cbindgen`, `chrono`, `chrono-tz`, `clap`, `cloned_instead_of_copied` *(+161 more)*
**Sections**: `profile.bench`, `profile.debug-pyo3`, `profile.dev`, `profile.nextest`, `profile.release`, `profile.release-debugging`, `profile.test`, `workspace`, `workspace.dependencies`, `workspace.lints.clippy`, `workspace.metadata.tools`, `workspace.package`
...
---
*Generated on 2025-11-18T21:54:58.879369Z*
